...
trait Anon_BodyHeadersOptionsProcessRequest extends js.Object {
...
object Anon_BodyHeadersOptionsProcessRequest {
  @scala.inline
  def apply(
    body: ProcessRequest,
  ...
  ): Anon_BodyHeadersOptionsProcessRequest = {
    val __obj = js.Dynamic.literal(body = body, resourceType = resourceType)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon_BodyHeadersOptionsProcessRequest]
  }
}
