...
import typings.fhir.fhirNs.ReferralRequest
...
trait Anon_BodyHeadersOptionsReferralRequest extends js.Object {
  ...
  var resourceType: typings.fhirDashKitDashClient.fhirDashKitDashClientStrings.ReferralRequest
}
...
object Anon_BodyHeadersOptionsReferralRequest {
  ...
  def apply(
    ...
    resourceType: typings.fhirDashKitDashClient.fhirDashKitDashClientStrings.ReferralRequest,
