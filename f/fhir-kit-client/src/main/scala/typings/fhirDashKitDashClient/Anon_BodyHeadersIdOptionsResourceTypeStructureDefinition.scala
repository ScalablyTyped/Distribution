...
trait Anon_BodyHeadersIdOptionsResourceTypeStructureDefinition extends js.Object {
...
object Anon_BodyHeadersIdOptionsResourceTypeStructureDefinition {
  @scala.inline
  def apply(
  ...
  ): Anon_BodyHeadersIdOptionsResourceTypeStructureDefinition = {
    val __obj = js.Dynamic.literal(body = body, id = id, resourceType = resourceType)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon_BodyHeadersIdOptionsResourceTypeStructureDefinition]
  }
}
