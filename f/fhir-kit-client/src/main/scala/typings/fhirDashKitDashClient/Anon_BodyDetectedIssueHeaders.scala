...
trait Anon_BodyDetectedIssueHeaders extends js.Object {
...
object Anon_BodyDetectedIssueHeaders {
  @scala.inline
  def apply(
    body: DetectedIssue,
    id: String,
  ...
  ): Anon_BodyDetectedIssueHeaders = {
    val __obj = js.Dynamic.literal(body = body, id = id, resourceType = resourceType)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon_BodyDetectedIssueHeaders]
  }
}
