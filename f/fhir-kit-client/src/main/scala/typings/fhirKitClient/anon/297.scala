...
object `297` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ServiceDefinition): `297` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`297`]
  }
  @scala.inline
  implicit class `297Ops`[Self <: `297`] (val x: Self) extends AnyVal {
    @scala.inline
