...
object `297` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `297` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "ServiceDefinition")
  ...
  extension [Self <: `297`](x: Self) {
    ...
    inline def setResourceType(value: ServiceDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
