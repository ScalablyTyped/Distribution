...
object `110` {
  ...
  inline def apply(id: String, version: String): `110` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "ClinicalImpression", version = version.asInstanceOf[js.Any])
