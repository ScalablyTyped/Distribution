...
object `193` {
  ...
  inline def apply(id: String, version: String): `193` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "RiskAssessment", version = version.asInstanceOf[js.Any])
