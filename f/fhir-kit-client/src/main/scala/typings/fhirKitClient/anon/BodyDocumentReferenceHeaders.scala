...
@js.native
trait BodyDocumentReferenceHeaders extends js.Object {
...
object BodyDocumentReferenceHeaders {
  ...
  @scala.inline
  implicit class BodyDocumentReferenceHeadersOps[Self <: BodyDocumentReferenceHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: DocumentReference): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.DocumentReference): Self = this.set("resourceType", value.asInstanceOf[js.Any])
