...
@js.native
trait HeadersIdStringJSONPatchArrayOptions extends js.Object {
...
object HeadersIdStringJSONPatchArrayOptions {
  ...
  @scala.inline
  implicit class HeadersIdStringJSONPatchArrayOptionsOps[Self <: HeadersIdStringJSONPatchArrayOptions] (val x: Self) extends AnyVal {
    @scala.inline
