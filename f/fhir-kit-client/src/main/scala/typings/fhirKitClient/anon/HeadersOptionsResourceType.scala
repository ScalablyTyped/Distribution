...
object HeadersOptionsResourceType {
  ...
  inline def apply(resourceType: typings.fhirKitClient.mod.ResourceType): HeadersOptionsResourceType = {
    val __obj = js.Dynamic.literal(resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeadersOptionsResourceType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: HeadersOptionsResourceType] (val x: Self) extends AnyVal {
