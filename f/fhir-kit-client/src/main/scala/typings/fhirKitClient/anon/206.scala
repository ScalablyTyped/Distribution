...
object `206` {
  ...
  inline def apply(id: String, version: String): `206` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Task", version = version.asInstanceOf[js.Any])
