...
trait BodyFamilyMemberHistory extends js.Object {
  ...
  var resourceType: typings.fhirKitClient.fhirKitClientStrings.FamilyMemberHistory = js.native
}
object BodyFamilyMemberHistory {
  ...
  @scala.inline
  implicit class BodyFamilyMemberHistoryOps[Self <: BodyFamilyMemberHistory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.FamilyMemberHistory): Self = this.set("resourceType", value.asInstanceOf[js.Any])
