...
object `168` {
  ...
  inline def apply(id: String, version: String): `168` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "NutritionOrder", version = version.asInstanceOf[js.Any])
