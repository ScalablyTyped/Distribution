...
object BodyHeadersOptions {
  ...
  @scala.inline
  implicit class BodyHeadersOptionsOps[Self <: BodyHeadersOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: AllergyIntolerance): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.AllergyIntolerance): Self = this.set("resourceType", value.asInstanceOf[js.Any])
