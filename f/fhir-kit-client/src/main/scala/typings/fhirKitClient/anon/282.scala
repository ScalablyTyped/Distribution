...
object `282` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `282` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "ProcedureRequest")
  ...
  extension [Self <: `282`](x: Self) {
    ...
    inline def setResourceType(value: ProcedureRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
