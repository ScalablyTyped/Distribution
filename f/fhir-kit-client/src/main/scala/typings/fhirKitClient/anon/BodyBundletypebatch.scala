...
object BodyBundletypebatch {
  ...
  @scala.inline
  implicit class BodyBundletypebatchOps[Self <: BodyBundletypebatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: Bundletypebatch): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
