...
@js.native
trait BodyDeviceRequestHeaders extends js.Object {
...
object BodyDeviceRequestHeaders {
  ...
  @scala.inline
  implicit class BodyDeviceRequestHeadersOps[Self <: BodyDeviceRequestHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.DeviceRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
