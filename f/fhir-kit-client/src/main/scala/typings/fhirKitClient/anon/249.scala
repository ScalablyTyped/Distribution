...
object `249` {
  ...
  @scala.inline
  implicit class `249Ops`[Self <: `249`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ImagingStudy): Self = this.set("resourceType", value.asInstanceOf[js.Any])
