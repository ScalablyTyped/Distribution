...
object `241` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `241` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "FamilyMemberHistory")
  ...
  extension [Self <: `241`](x: Self) {
    ...
    inline def setResourceType(value: FamilyMemberHistory): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
