...
object `271` {
  ...
  @scala.inline
  implicit class `271Ops`[Self <: `271`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: OperationOutcome): Self = this.set("resourceType", value.asInstanceOf[js.Any])
