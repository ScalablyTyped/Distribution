...
object BodyLibrary {
  ...
  @scala.inline
  implicit class BodyLibraryOps[Self <: BodyLibrary] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: Library): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Library): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
