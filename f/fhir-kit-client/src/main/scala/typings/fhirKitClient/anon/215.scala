...
object `215` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `215` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Composition")
  ...
  extension [Self <: `215`](x: Self) {
    ...
    inline def setResourceType(value: Composition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
