...
@js.native
trait JSONPatchArrayOptionsResourceType extends js.Object {
...
object JSONPatchArrayOptionsResourceType {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ChargeItem): JSONPatchArrayOptionsResourceType = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[JSONPatchArrayOptionsResourceType]
  }
  @scala.inline
  implicit class JSONPatchArrayOptionsResourceTypeOps[Self <: JSONPatchArrayOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: ChargeItem): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
