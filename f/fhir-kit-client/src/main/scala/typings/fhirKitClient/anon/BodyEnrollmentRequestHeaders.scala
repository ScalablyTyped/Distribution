...
object BodyEnrollmentRequestHeaders {
  ...
  inline def apply(body: EnrollmentRequest, id: String): BodyEnrollmentRequestHeaders = {
  ...
  extension [Self <: BodyEnrollmentRequestHeaders](x: Self) {
    
    inline def setBody(value: EnrollmentRequest): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    ...
    inline def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.EnrollmentRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
