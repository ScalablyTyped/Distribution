...
object Bundle {
  ...
  @scala.inline
  def apply[T /* <: String */](bundle: typings.fhir.fhir.Bundle with Type[T]): Bundle[T] = {
  ...
  implicit class BundleMutableBuilder[Self <: Bundle[_], T /* <: String */] (val x: Self with Bundle[T]) extends AnyVal {
    ...
    @scala.inline
    def setBundle(value: typings.fhir.fhir.Bundle with Type[T]): Self = StObject.set(x, "bundle", value.asInstanceOf[js.Any])
