...
object BodyNutritionOrderHeaders {
  ...
  @scala.inline
  def apply(body: NutritionOrder, id: String): BodyNutritionOrderHeaders = {
  ...
  implicit class BodyNutritionOrderHeadersMutableBuilder[Self <: BodyNutritionOrderHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.NutritionOrder): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
