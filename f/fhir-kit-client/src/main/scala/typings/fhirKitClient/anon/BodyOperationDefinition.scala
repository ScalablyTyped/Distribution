...
object BodyOperationDefinition {
  ...
  @scala.inline
  def apply(body: OperationDefinition): BodyOperationDefinition = {
  ...
  implicit class BodyOperationDefinitionMutableBuilder[Self <: BodyOperationDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.OperationDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
