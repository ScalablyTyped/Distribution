...
object `149` {
  ...
  @scala.inline
  def apply(id: String, version: String): `149` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "ImagingStudy", version = version.asInstanceOf[js.Any])
