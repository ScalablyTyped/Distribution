...
object BodyEndpointHeaders {
  ...
  inline def apply(body: Endpoint, id: String): BodyEndpointHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Endpoint")
    __obj.asInstanceOf[BodyEndpointHeaders]
  }
  
  extension [Self <: BodyEndpointHeaders](x: Self) {
