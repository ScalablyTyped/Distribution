...
object `114` {
  ...
  @scala.inline
  def apply(id: String, version: String): `114` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "CompartmentDefinition", version = version.asInstanceOf[js.Any])
