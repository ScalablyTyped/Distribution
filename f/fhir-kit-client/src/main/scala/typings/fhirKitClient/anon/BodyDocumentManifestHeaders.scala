...
@js.native
trait BodyDocumentManifestHeaders extends js.Object {
...
object BodyDocumentManifestHeaders {
  ...
  @scala.inline
  implicit class BodyDocumentManifestHeadersOps[Self <: BodyDocumentManifestHeaders] (val x: Self) extends AnyVal {
