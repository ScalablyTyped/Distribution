...
object `309` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `309` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "ValueSet")
  ...
  extension [Self <: `309`](x: Self) {
    ...
    inline def setResourceType(value: ValueSet): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
