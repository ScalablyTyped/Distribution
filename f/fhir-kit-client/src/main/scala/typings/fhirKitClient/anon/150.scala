...
object `150` {
  ...
  inline def apply(id: String, version: String): `150` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Immunization", version = version.asInstanceOf[js.Any])
