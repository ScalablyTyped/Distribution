...
@js.native
trait JSONPatchOptionsResourceType extends js.Object {
...
object JSONPatchOptionsResourceType {
  ...
  @scala.inline
  implicit class JSONPatchOptionsResourceTypeOps[Self <: JSONPatchOptionsResourceType] (val x: Self) extends AnyVal {
