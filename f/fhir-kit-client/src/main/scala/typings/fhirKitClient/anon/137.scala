...
object `137` {
  ...
  inline def apply(id: String, version: String): `137` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "EnrollmentResponse", version = version.asInstanceOf[js.Any])
