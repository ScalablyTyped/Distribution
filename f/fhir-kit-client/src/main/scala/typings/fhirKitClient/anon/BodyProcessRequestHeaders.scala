...
object BodyProcessRequestHeaders {
  ...
  @scala.inline
  def apply(body: ProcessRequest, id: String): BodyProcessRequestHeaders = {
  ...
  implicit class BodyProcessRequestHeadersMutableBuilder[Self <: BodyProcessRequestHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ProcessRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
