...
@js.native
trait BodyProcessRequestHeaders extends js.Object {
...
object BodyProcessRequestHeaders {
  ...
  @scala.inline
  implicit class BodyProcessRequestHeadersOps[Self <: BodyProcessRequestHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ProcessRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
