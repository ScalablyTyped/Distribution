...
object BodyDeviceUseStatementHeaders {
  ...
  inline def apply(body: DeviceUseStatement, id: String): BodyDeviceUseStatementHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "DeviceUseStatement")
    __obj.asInstanceOf[BodyDeviceUseStatementHeaders]
  }
  
  extension [Self <: BodyDeviceUseStatementHeaders](x: Self) {
