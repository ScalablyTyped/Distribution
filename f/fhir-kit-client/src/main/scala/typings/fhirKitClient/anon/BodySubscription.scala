...
object BodySubscription {
  ...
  @scala.inline
  implicit class BodySubscriptionOps[Self <: BodySubscription] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: Subscription): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Subscription): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
