...
object BodyDataElement {
  ...
  @scala.inline
  def apply(body: DataElement, resourceType: typings.fhirKitClient.fhirKitClientStrings.DataElement): BodyDataElement = {
  ...
  implicit class BodyDataElementOps[Self <: BodyDataElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.DataElement): Self = this.set("resourceType", value.asInstanceOf[js.Any])
