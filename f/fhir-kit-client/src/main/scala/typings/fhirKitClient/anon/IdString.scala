...
object IdString {
  ...
  def apply(id: String): IdString = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "BodySite")
  ...
  implicit class IdStringMutableBuilder[Self <: IdString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: BodySite): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
