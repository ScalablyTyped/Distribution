...
object `185` {
  ...
  inline def apply(id: String, version: String): `185` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Provenance", version = version.asInstanceOf[js.Any])
