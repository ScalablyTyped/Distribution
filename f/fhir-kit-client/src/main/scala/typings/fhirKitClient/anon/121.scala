...
object `121` {
  ...
  inline def apply(id: String, version: String): `121` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "DataElement", version = version.asInstanceOf[js.Any])
