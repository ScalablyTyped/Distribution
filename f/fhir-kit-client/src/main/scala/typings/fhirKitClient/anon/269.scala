...
object `269` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `269` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Observation")
  ...
  extension [Self <: `269`](x: Self) {
    ...
    inline def setResourceType(value: Observation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
