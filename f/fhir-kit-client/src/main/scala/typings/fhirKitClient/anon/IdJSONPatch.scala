...
object IdJSONPatch {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): IdJSONPatch = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "ActivityDefinition")
    __obj.asInstanceOf[IdJSONPatch]
  }
  
  extension [Self <: IdJSONPatch](x: Self) {
