...
object `124` {
  ...
  inline def apply(id: String, version: String): `124` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "DeviceComponent", version = version.asInstanceOf[js.Any])
