...
trait HeadersIdJSONPatch extends js.Object {
  ...
  var resourceType: AllergyIntolerance = js.native
}
object HeadersIdJSONPatch {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: AllergyIntolerance): HeadersIdJSONPatch = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeadersIdJSONPatch]
  }
  
  @scala.inline
  implicit class HeadersIdJSONPatchOps[Self <: HeadersIdJSONPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: AllergyIntolerance): Self = this.set("resourceType", value.asInstanceOf[js.Any])
