...
object BodyDocumentManifest {
  @scala.inline
  def apply(body: DocumentManifest, resourceType: typings.fhirKitClient.fhirKitClientStrings.DocumentManifest): BodyDocumentManifest = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyDocumentManifest]
  }
  @scala.inline
  implicit class BodyDocumentManifestOps[Self <: BodyDocumentManifest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: DocumentManifest): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.DocumentManifest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
