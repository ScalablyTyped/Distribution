...
object OptionsResourceTypeResourceType {
  ...
  inline def apply(resourceType: typings.fhirKitClient.mod.ResourceType): OptionsResourceTypeResourceType = {
  ...
  extension [Self <: OptionsResourceTypeResourceType](x: Self) {
