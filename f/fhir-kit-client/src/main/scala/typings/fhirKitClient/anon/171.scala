...
object `171` {
  ...
  inline def apply(id: String, version: String): `171` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "OperationOutcome", version = version.asInstanceOf[js.Any])
