...
object `283` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `283` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "ProcessRequest")
  ...
  extension [Self <: `283`](x: Self) {
    ...
    inline def setResourceType(value: ProcessRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
