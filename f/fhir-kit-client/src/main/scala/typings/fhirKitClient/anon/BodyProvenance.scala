...
object BodyProvenance {
  @scala.inline
  def apply(body: Provenance, resourceType: typings.fhirKitClient.fhirKitClientStrings.Provenance): BodyProvenance = {
  ...
  implicit class BodyProvenanceOps[Self <: BodyProvenance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Provenance): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
