...
object BodySchedule {
  ...
  @scala.inline
  implicit class BodyScheduleOps[Self <: BodySchedule] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: Schedule): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Schedule): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
