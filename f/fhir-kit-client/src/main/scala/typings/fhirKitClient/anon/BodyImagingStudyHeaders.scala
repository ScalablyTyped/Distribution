...
@js.native
trait BodyImagingStudyHeaders extends js.Object {
...
object BodyImagingStudyHeaders {
  ...
  @scala.inline
  implicit class BodyImagingStudyHeadersOps[Self <: BodyImagingStudyHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: ImagingStudy): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ImagingStudy): Self = this.set("resourceType", value.asInstanceOf[js.Any])
