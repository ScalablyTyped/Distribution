...
object `277` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `277` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Person")
  ...
  extension [Self <: `277`](x: Self) {
    ...
    inline def setResourceType(value: Person): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
