...
object `184` {
  ...
  inline def apply(id: String, version: String): `184` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "ProcessResponse", version = version.asInstanceOf[js.Any])
