...
object BodyClinicalImpressionHeaders {
  ...
  inline def apply(body: ClinicalImpression, id: String): BodyClinicalImpressionHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "ClinicalImpression")
    __obj.asInstanceOf[BodyClinicalImpressionHeaders]
  }
  
  extension [Self <: BodyClinicalImpressionHeaders](x: Self) {
