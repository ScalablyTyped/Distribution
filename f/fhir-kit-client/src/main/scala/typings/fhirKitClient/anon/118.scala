...
object `118` {
  ...
  inline def apply(id: String, version: String): `118` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Consent", version = version.asInstanceOf[js.Any])
