...
@js.native
trait BodyEnrollmentResponseHeaders extends js.Object {
...
object BodyEnrollmentResponseHeaders {
  ...
  @scala.inline
  implicit class BodyEnrollmentResponseHeadersOps[Self <: BodyEnrollmentResponseHeaders] (val x: Self) extends AnyVal {
