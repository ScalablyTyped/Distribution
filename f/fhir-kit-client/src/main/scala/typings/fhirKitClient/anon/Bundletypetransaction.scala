...
object Bundletypetransaction {
  ...
  inline def apply(`type`: code & transaction): Bundletypetransaction = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Bundletypetransaction]
  }
  
  extension [Self <: Bundletypetransaction](x: Self) {
    ...
    inline def setType(value: code & transaction): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
