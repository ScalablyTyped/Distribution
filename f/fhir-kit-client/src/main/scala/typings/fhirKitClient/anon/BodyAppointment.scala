...
@js.native
trait BodyAppointment extends js.Object {
...
object BodyAppointment {
  ...
  @scala.inline
  implicit class BodyAppointmentOps[Self <: BodyAppointment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Appointment): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Appointment): Self = this.set("resourceType", value.asInstanceOf[js.Any])
