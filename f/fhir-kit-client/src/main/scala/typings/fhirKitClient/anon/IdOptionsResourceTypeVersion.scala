...
object IdOptionsResourceTypeVersion {
  ...
  inline def apply(id: String, version: String): IdOptionsResourceTypeVersion = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "AllergyIntolerance", version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdOptionsResourceTypeVersion]
  }
  
  extension [Self <: IdOptionsResourceTypeVersion](x: Self) {
