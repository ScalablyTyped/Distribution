...
object `126` {
  ...
  @scala.inline
  def apply(id: String, resourceType: DeviceRequest, version: String): `126` = {
  ...
  implicit class `126Ops`[Self <: `126`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: DeviceRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
