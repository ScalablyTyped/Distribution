...
object BodyHeadersIdOptionsResourceType {
  ...
  inline def apply(body: AdverseEvent, id: String): BodyHeadersIdOptionsResourceType = {
  ...
  extension [Self <: BodyHeadersIdOptionsResourceType](x: Self) {
    
    inline def setBody(value: AdverseEvent): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    ...
    inline def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.AdverseEvent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
