...
trait Bundletypebatchresponse extends StObject {
  ...
  /**
    ...
    */
  var `type`: code & `batch-response`
}
object Bundletypebatchresponse {
  
  inline def apply(`type`: code & `batch-response`): Bundletypebatchresponse = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Bundletypebatchresponse]
  }
  
  extension [Self <: Bundletypebatchresponse](x: Self) {
    ...
    inline def setType(value: code & `batch-response`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
