...
object JSONPatchArray {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): JSONPatchArray = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "BodySite")
    __obj.asInstanceOf[JSONPatchArray]
  }
  
  extension [Self <: JSONPatchArray](x: Self) {
