...
object `164` {
  ...
  @scala.inline
  def apply(id: String, resourceType: MedicationStatement, version: String): `164` = {
  ...
  implicit class `164Ops`[Self <: `164`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: MedicationStatement): Self = this.set("resourceType", value.asInstanceOf[js.Any])
