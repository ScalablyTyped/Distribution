...
@js.native
trait BodyBinaryHeaders extends js.Object {
...
object BodyBinaryHeaders {
  @scala.inline
  def apply(body: Binary, id: String, resourceType: typings.fhirKitClient.fhirKitClientStrings.Binary): BodyBinaryHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyBinaryHeaders]
  }
  @scala.inline
  implicit class BodyBinaryHeadersOps[Self <: BodyBinaryHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Binary): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
