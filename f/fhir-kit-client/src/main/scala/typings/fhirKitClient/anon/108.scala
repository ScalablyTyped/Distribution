...
object `108` {
  ...
  inline def apply(id: String, version: String): `108` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Claim", version = version.asInstanceOf[js.Any])
