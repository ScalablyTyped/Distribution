...
object `181` {
  ...
  inline def apply(id: String, version: String): `181` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Procedure", version = version.asInstanceOf[js.Any])
