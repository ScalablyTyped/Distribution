...
object `158` {
  ...
  @scala.inline
  def apply(id: String, version: String): `158` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "MeasureReport", version = version.asInstanceOf[js.Any])
