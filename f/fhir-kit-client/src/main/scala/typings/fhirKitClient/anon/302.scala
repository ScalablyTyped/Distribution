...
object `302` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Subscription): `302` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`302`]
  }
  
  @scala.inline
  implicit class `302Ops`[Self <: `302`] (val x: Self) extends AnyVal {
