...
object `231` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `231` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "DomainResource")
  ...
  extension [Self <: `231`](x: Self) {
    ...
    inline def setResourceType(value: DomainResource): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
