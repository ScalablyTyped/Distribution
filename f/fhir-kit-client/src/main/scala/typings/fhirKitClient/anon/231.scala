...
object `231` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: DomainResource): `231` = {
  ...
  implicit class `231Ops`[Self <: `231`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: DomainResource): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
