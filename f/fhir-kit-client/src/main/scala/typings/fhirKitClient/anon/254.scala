...
object `254` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `254` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Linkage")
  ...
  extension [Self <: `254`](x: Self) {
    ...
    inline def setResourceType(value: Linkage): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
