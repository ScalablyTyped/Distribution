...
object BodyProcedureRequestHeaders {
  ...
  inline def apply(body: ProcedureRequest, id: String): BodyProcedureRequestHeaders = {
  ...
  extension [Self <: BodyProcedureRequestHeaders](x: Self) {
    
    inline def setBody(value: ProcedureRequest): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    ...
    inline def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ProcedureRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
