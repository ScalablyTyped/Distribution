...
@js.native
trait BodyProcedureRequestHeaders extends js.Object {
...
object BodyProcedureRequestHeaders {
  ...
  @scala.inline
  implicit class BodyProcedureRequestHeadersOps[Self <: BodyProcedureRequestHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: ProcedureRequest): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ProcedureRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
