...
object `222` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String): `222` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "DetectedIssue")
  ...
  implicit class `222MutableBuilder`[Self <: `222`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: DetectedIssue): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
