...
object `179` {
  @scala.inline
  def apply(id: String, resourceType: Practitioner, version: String): `179` = {
  ...
  implicit class `179Ops`[Self <: `179`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Practitioner): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
