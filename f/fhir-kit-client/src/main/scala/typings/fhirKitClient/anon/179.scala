...
object `179` {
  ...
  @scala.inline
  def apply(id: String, version: String): `179` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Practitioner", version = version.asInstanceOf[js.Any])
