...
@js.native
trait BodyExpansionProfileHeaders extends js.Object {
...
object BodyExpansionProfileHeaders {
  ...
  @scala.inline
  implicit class BodyExpansionProfileHeadersOps[Self <: BodyExpansionProfileHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: ExpansionProfile): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ExpansionProfile): Self = this.set("resourceType", value.asInstanceOf[js.Any])
