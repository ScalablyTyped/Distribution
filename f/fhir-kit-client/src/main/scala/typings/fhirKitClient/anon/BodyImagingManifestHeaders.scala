...
@js.native
trait BodyImagingManifestHeaders extends js.Object {
...
object BodyImagingManifestHeaders {
  ...
  @scala.inline
  implicit class BodyImagingManifestHeadersOps[Self <: BodyImagingManifestHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ImagingManifest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
