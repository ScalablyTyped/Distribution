...
object BodyValueSet {
  ...
  @scala.inline
  def apply(body: ValueSet): BodyValueSet = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = "ValueSet")
  ...
  implicit class BodyValueSetMutableBuilder[Self <: BodyValueSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ValueSet): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
