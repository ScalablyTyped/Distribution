...
object BodyCarePlan {
  ...
  @scala.inline
  implicit class BodyCarePlanOps[Self <: BodyCarePlan] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: CarePlan): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.CarePlan): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
