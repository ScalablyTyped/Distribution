...
object BodyProcedure {
  ...
  @scala.inline
  def apply(body: Procedure, resourceType: typings.fhirKitClient.fhirKitClientStrings.Procedure): BodyProcedure = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyProcedure]
  }
  
  @scala.inline
  implicit class BodyProcedureOps[Self <: BodyProcedure] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Procedure): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Procedure): Self = this.set("resourceType", value.asInstanceOf[js.Any])
