...
object `166` {
  ...
  inline def apply(id: String, version: String): `166` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "MessageHeader", version = version.asInstanceOf[js.Any])
