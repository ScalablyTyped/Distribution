...
object `252` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ImplementationGuide): `252` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`252`]
  }
  
  @scala.inline
  implicit class `252Ops`[Self <: `252`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ImplementationGuide): Self = this.set("resourceType", value.asInstanceOf[js.Any])
