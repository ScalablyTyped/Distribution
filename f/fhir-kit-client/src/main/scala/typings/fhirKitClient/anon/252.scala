...
object `252` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `252` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "ImplementationGuide")
  ...
  extension [Self <: `252`](x: Self) {
    ...
    inline def setResourceType(value: ImplementationGuide): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
