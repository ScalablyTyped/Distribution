...
object `153` {
  ...
  inline def apply(id: String, version: String): `153` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Library", version = version.asInstanceOf[js.Any])
