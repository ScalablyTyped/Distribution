...
object `261` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `261` = {
  ...
  extension [Self <: `261`](x: Self) {
    ...
    inline def setResourceType(value: MedicationAdministration): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
