...
@js.native
trait Bundletypehistory extends js.Object {
...
object Bundletypehistory {
  ...
  @scala.inline
  implicit class BundletypehistoryOps[Self <: Bundletypehistory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: code with history): Self = this.set("type", value.asInstanceOf[js.Any])
