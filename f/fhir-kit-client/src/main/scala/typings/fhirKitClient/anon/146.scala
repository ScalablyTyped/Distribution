...
object `146` {
  ...
  @scala.inline
  def apply(id: String, version: String): `146` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "GuidanceResponse", version = version.asInstanceOf[js.Any])
