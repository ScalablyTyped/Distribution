...
object Bundletypetransactionresp {
  ...
  inline def apply(`type`: code & `transaction-response`): Bundletypetransactionresp = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Bundletypetransactionresp]
  }
  
  extension [Self <: Bundletypetransactionresp](x: Self) {
    ...
    inline def setType(value: code & `transaction-response`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
