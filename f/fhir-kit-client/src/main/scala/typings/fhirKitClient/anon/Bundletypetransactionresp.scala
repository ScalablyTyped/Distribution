...
trait Bundletypetransactionresp extends StObject {
  ...
  /**
    ...
    */
  var `type`: code & `transaction-response`
}
object Bundletypetransactionresp {
  
  @scala.inline
  def apply(`type`: code & `transaction-response`): Bundletypetransactionresp = {
  ...
  @scala.inline
  implicit class BundletypetransactionrespMutableBuilder[Self <: Bundletypetransactionresp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: code & `transaction-response`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
