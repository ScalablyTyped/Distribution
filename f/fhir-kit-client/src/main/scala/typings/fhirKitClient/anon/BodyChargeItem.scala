...
object BodyChargeItem {
  ...
  @scala.inline
  implicit class BodyChargeItemOps[Self <: BodyChargeItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: ChargeItem): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ChargeItem): Self = this.set("resourceType", value.asInstanceOf[js.Any])
