...
@js.native
trait BodyDomainResourceHeaders extends js.Object {
  var body: DomainResource = js.native
  var headers: js.UndefOr[typings.request.mod.Headers] = js.native
  var id: String = js.native
  var options: js.UndefOr[typings.request.mod.Options] = js.native
  var resourceType: typings.fhirKitClient.fhirKitClientStrings.DomainResource = js.native
}
...
object BodyDomainResourceHeaders {
  ...
  @scala.inline
  implicit class BodyDomainResourceHeadersOps[Self <: BodyDomainResourceHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.DomainResource): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
