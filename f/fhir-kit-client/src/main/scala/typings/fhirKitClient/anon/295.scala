...
object `295` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String): `295` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "SearchParameter")
    __obj.asInstanceOf[`295`]
  }
  
  @scala.inline
  implicit class `295MutableBuilder`[Self <: `295`] (val x: Self) extends AnyVal {
