...
object `138` {
  ...
  inline def apply(id: String, version: String): `138` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "EpisodeOfCare", version = version.asInstanceOf[js.Any])
