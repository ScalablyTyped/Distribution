...
object JSONPatchArrayOptionsResourceTypeCustomResourceType {
  ...
  @scala.inline
  implicit class JSONPatchArrayOptionsResourceTypeCustomResourceTypeMutableBuilder[Self <: JSONPatchArrayOptionsResourceTypeCustomResourceType] (val x: Self) extends AnyVal {
