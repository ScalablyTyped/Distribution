...
object JSONPatchArrayOptionsResourceTypeCustomResourceType {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: CustomResourceType): JSONPatchArrayOptionsResourceTypeCustomResourceType = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[JSONPatchArrayOptionsResourceTypeCustomResourceType]
  }
  
  extension [Self <: JSONPatchArrayOptionsResourceTypeCustomResourceType](x: Self) {
