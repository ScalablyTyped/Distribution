...
object `104` {
  ...
  @scala.inline
  def apply(id: String, version: String): `104` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "CapabilityStatement", version = version.asInstanceOf[js.Any])
