...
object `104` {
  ...
  @scala.inline
  def apply(id: String, resourceType: CapabilityStatement, version: String): `104` = {
  ...
  implicit class `104Ops`[Self <: `104`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: CapabilityStatement): Self = this.set("resourceType", value.asInstanceOf[js.Any])
