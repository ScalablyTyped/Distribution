...
@js.native
trait HeadersIdStringOptionsResourceType extends js.Object {
...
object HeadersIdStringOptionsResourceType {
  ...
  @scala.inline
  implicit class HeadersIdStringOptionsResourceTypeOps[Self <: HeadersIdStringOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
