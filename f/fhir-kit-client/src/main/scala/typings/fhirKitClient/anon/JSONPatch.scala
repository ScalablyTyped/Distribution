...
object JSONPatch {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Account): JSONPatch = {
  ...
  implicit class JSONPatchOps[Self <: JSONPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Account): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
