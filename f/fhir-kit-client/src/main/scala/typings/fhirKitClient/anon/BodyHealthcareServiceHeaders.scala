...
@js.native
trait BodyHealthcareServiceHeaders extends js.Object {
...
object BodyHealthcareServiceHeaders {
  ...
  ): BodyHealthcareServiceHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyHealthcareServiceHeaders]
  }
  @scala.inline
  implicit class BodyHealthcareServiceHeadersOps[Self <: BodyHealthcareServiceHeaders] (val x: Self) extends AnyVal {
    @scala.inline
