...
object BodyImplementationGuideHeaders {
  ...
  @scala.inline
  def apply(body: ImplementationGuide, id: String): BodyImplementationGuideHeaders = {
  ...
  implicit class BodyImplementationGuideHeadersMutableBuilder[Self <: BodyImplementationGuideHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ImplementationGuide): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
