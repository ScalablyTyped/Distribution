...
object `178` {
  ...
  inline def apply(id: String, version: String): `178` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "PlanDefinition", version = version.asInstanceOf[js.Any])
