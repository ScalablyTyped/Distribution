...
trait `195` extends js.Object {
  ...
  var resourceType: SearchParameter = js.native
...
object `195` {
  ...
  @scala.inline
  def apply(id: String, resourceType: SearchParameter, version: String): `195` = {
  ...
  implicit class `195Ops`[Self <: `195`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: SearchParameter): Self = this.set("resourceType", value.asInstanceOf[js.Any])
