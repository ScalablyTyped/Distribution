...
object `229` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `229` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "DocumentManifest")
