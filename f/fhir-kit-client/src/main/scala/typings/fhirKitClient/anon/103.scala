...
object `103` {
  ...
  inline def apply(id: String, version: String): `103` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Bundle", version = version.asInstanceOf[js.Any])
