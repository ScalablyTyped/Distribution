...
object `113` {
  ...
  @scala.inline
  def apply(id: String, resourceType: CommunicationRequest, version: String): `113` = {
  ...
  implicit class `113Ops`[Self <: `113`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: CommunicationRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
