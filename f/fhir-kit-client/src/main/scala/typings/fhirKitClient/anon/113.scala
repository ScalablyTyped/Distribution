...
object `113` {
  ...
  inline def apply(id: String, version: String): `113` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "CommunicationRequest", version = version.asInstanceOf[js.Any])
