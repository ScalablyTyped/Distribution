...
object `246` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: GuidanceResponse): `246` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`246`]
  }
  @scala.inline
  implicit class `246Ops`[Self <: `246`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: GuidanceResponse): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
