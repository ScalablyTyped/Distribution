...
object `246` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String): `246` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "GuidanceResponse")
    __obj.asInstanceOf[`246`]
  }
  
  @scala.inline
  implicit class `246MutableBuilder`[Self <: `246`] (val x: Self) extends AnyVal {
