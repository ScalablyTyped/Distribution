...
object BodyBodySite {
  ...
  @scala.inline
  implicit class BodyBodySiteOps[Self <: BodyBodySite] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.BodySite): Self = this.set("resourceType", value.asInstanceOf[js.Any])
