...
object BodyBodySite {
  ...
  inline def apply(body: BodySite): BodyBodySite = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = "BodySite")
    __obj.asInstanceOf[BodyBodySite]
  }
  
  extension [Self <: BodyBodySite](x: Self) {
