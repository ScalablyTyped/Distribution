...
object `112` {
  ...
  inline def apply(id: String, version: String): `112` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Communication", version = version.asInstanceOf[js.Any])
