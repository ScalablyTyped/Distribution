...
object `298` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `298` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Slot")
  ...
  extension [Self <: `298`](x: Self) {
    ...
    inline def setResourceType(value: Slot): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
