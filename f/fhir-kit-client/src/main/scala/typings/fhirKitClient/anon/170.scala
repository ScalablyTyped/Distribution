...
object `170` {
  ...
  inline def apply(id: String, version: String): `170` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "OperationDefinition", version = version.asInstanceOf[js.Any])
