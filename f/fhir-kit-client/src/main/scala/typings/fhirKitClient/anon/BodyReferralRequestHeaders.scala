...
@js.native
trait BodyReferralRequestHeaders extends js.Object {
...
object BodyReferralRequestHeaders {
  ...
  @scala.inline
  implicit class BodyReferralRequestHeadersOps[Self <: BodyReferralRequestHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: ReferralRequest): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ReferralRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
