...
object `127` {
  ...
  inline def apply(id: String, version: String): `127` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "DeviceUseStatement", version = version.asInstanceOf[js.Any])
