...
object `267` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `267` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "NamingSystem")
