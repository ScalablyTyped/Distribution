...
object JSONPatchOptions {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): JSONPatchOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "AdverseEvent")
    __obj.asInstanceOf[JSONPatchOptions]
  }
  
  extension [Self <: JSONPatchOptions](x: Self) {
