...
object `117` {
  ...
  inline def apply(id: String, version: String): `117` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Condition", version = version.asInstanceOf[js.Any])
