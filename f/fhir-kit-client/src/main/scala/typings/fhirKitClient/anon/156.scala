...
object `156` {
  ...
  inline def apply(id: String, version: String): `156` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Location", version = version.asInstanceOf[js.Any])
