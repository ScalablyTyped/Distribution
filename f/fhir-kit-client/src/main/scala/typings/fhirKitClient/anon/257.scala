...
object `257` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `257` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Measure")
  ...
  extension [Self <: `257`](x: Self) {
    ...
    inline def setResourceType(value: Measure): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
