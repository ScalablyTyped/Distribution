...
object `152` {
  ...
  @scala.inline
  def apply(id: String, version: String): `152` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "ImplementationGuide", version = version.asInstanceOf[js.Any])
