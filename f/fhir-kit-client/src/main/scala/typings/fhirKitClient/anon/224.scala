...
trait `224` extends StObject {
  ...
  var resourceType: DeviceComponent = js.native
}
object `224` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: DeviceComponent): `224` = {
  ...
  implicit class `224MutableBuilder`[Self <: `224`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: DeviceComponent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
