...
object BodyDataElementHeaders {
  ...
  inline def apply(body: DataElement, id: String): BodyDataElementHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "DataElement")
    __obj.asInstanceOf[BodyDataElementHeaders]
  }
  
  extension [Self <: BodyDataElementHeaders](x: Self) {
