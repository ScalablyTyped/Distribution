...
object `105` {
  ...
  inline def apply(id: String, version: String): `105` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "CarePlan", version = version.asInstanceOf[js.Any])
