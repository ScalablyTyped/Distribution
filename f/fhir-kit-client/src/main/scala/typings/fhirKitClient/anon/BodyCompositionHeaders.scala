...
object BodyCompositionHeaders {
  ...
  inline def apply(body: Composition, id: String): BodyCompositionHeaders = {
  ...
  extension [Self <: BodyCompositionHeaders](x: Self) {
    
    inline def setBody(value: Composition): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    ...
    inline def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Composition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
