...
@js.native
trait BodyCompositionHeaders extends js.Object {
...
object BodyCompositionHeaders {
  ...
  @scala.inline
  implicit class BodyCompositionHeadersOps[Self <: BodyCompositionHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Composition): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Composition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
