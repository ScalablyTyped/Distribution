...
object BodySearchParameterHeaders {
  ...
  @scala.inline
  def apply(body: SearchParameter, id: String): BodySearchParameterHeaders = {
  ...
  @scala.inline
  implicit class BodySearchParameterHeadersMutableBuilder[Self <: BodySearchParameterHeaders] (val x: Self) extends AnyVal {
