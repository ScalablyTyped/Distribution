...
@js.native
trait BodySearchParameterHeaders extends js.Object {
...
object BodySearchParameterHeaders {
  ...
  ): BodySearchParameterHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodySearchParameterHeaders]
  }
  @scala.inline
  implicit class BodySearchParameterHeadersOps[Self <: BodySearchParameterHeaders] (val x: Self) extends AnyVal {
    @scala.inline
