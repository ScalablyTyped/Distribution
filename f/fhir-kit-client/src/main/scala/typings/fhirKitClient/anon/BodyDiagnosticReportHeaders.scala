...
@js.native
trait BodyDiagnosticReportHeaders extends js.Object {
...
object BodyDiagnosticReportHeaders {
  ...
  @scala.inline
  implicit class BodyDiagnosticReportHeadersOps[Self <: BodyDiagnosticReportHeaders] (val x: Self) extends AnyVal {
    @scala.inline
