...
object BodyDeviceMetricHeaders {
  ...
  inline def apply(body: DeviceMetric, id: String): BodyDeviceMetricHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "DeviceMetric")
    __obj.asInstanceOf[BodyDeviceMetricHeaders]
  }
  
  extension [Self <: BodyDeviceMetricHeaders](x: Self) {
