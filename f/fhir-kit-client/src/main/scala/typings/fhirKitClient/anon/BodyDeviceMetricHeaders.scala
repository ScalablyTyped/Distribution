...
@js.native
trait BodyDeviceMetricHeaders extends js.Object {
...
object BodyDeviceMetricHeaders {
  ...
  @scala.inline
  implicit class BodyDeviceMetricHeadersOps[Self <: BodyDeviceMetricHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: DeviceMetric): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.DeviceMetric): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
