...
@js.native
trait BodyPaymentNotice extends js.Object {
...
object BodyPaymentNotice {
  ...
  @scala.inline
  implicit class BodyPaymentNoticeOps[Self <: BodyPaymentNotice] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.PaymentNotice): Self = this.set("resourceType", value.asInstanceOf[js.Any])
