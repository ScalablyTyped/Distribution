...
object BodyCommunicationHeaders {
  ...
  inline def apply(body: Communication, id: String): BodyCommunicationHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Communication")
    __obj.asInstanceOf[BodyCommunicationHeaders]
  }
  
  extension [Self <: BodyCommunicationHeaders](x: Self) {
