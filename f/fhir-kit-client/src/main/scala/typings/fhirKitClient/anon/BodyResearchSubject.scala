...
object BodyResearchSubject {
  ...
  @scala.inline
  def apply(body: ResearchSubject, resourceType: typings.fhirKitClient.fhirKitClientStrings.ResearchSubject): BodyResearchSubject = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyResearchSubject]
  }
  
  @scala.inline
  implicit class BodyResearchSubjectOps[Self <: BodyResearchSubject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: ResearchSubject): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ResearchSubject): Self = this.set("resourceType", value.asInstanceOf[js.Any])
