...
object BodyResearchSubject {
  ...
  @scala.inline
  def apply(body: ResearchSubject): BodyResearchSubject = {
  ...
  implicit class BodyResearchSubjectMutableBuilder[Self <: BodyResearchSubject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.ResearchSubject): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
