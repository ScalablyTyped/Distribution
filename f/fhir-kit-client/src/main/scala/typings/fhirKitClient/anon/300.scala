...
object `300` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `300` = {
  ...
  extension [Self <: `300`](x: Self) {
    ...
    inline def setResourceType(value: StructureDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
