...
object `300` {
  ...
  @scala.inline
  implicit class `300Ops`[Self <: `300`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: StructureDefinition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
