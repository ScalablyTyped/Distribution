...
object `201` {
  ...
  inline def apply(id: String, version: String): `201` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "StructureMap", version = version.asInstanceOf[js.Any])
