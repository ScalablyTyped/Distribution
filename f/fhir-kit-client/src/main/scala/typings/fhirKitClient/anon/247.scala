...
object `247` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `247` = {
  ...
  extension [Self <: `247`](x: Self) {
    ...
    inline def setResourceType(value: HealthcareService): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
