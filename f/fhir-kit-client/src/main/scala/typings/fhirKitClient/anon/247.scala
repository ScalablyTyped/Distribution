...
object `247` {
  ...
  @scala.inline
  implicit class `247Ops`[Self <: `247`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: HealthcareService): Self = this.set("resourceType", value.asInstanceOf[js.Any])
