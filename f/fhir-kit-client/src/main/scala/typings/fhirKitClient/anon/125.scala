...
object `125` {
  ...
  inline def apply(id: String, version: String): `125` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "DeviceMetric", version = version.asInstanceOf[js.Any])
