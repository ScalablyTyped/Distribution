...
object BodyCompartmentDefinition {
  ...
  @scala.inline
  implicit class BodyCompartmentDefinitionOps[Self <: BodyCompartmentDefinition] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: CompartmentDefinition): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.CompartmentDefinition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
