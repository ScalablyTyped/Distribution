...
object BodyHeadersOptionsResourceType {
  ...
  @scala.inline
  implicit class BodyHeadersOptionsResourceTypeOps[Self <: BodyHeadersOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.AppointmentResponse): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
