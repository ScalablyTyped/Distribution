...
@js.native
trait `274` extends js.Object {
  var JSONPatch: js.Array[OpPatch] = js.native
  var headers: js.UndefOr[typings.request.mod.Headers] = js.native
  var id: String = js.native
  var options: js.UndefOr[typings.request.mod.Options] = js.native
  var resourceType: Patient = js.native
}

object `274` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Patient): `274` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`274`]
  }
  @scala.inline
  implicit class `274Ops`[Self <: `274`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: Patient): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
