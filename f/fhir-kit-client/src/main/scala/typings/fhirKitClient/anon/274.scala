...
object `274` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `274` = {
  ...
  extension [Self <: `274`](x: Self) {
    ...
    inline def setResourceType(value: Patient): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
