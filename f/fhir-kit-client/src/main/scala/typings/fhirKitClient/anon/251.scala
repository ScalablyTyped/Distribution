...
object `251` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `251` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "ImmunizationRecommendation")
  ...
  extension [Self <: `251`](x: Self) {
    ...
    inline def setResourceType(value: ImmunizationRecommendation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
