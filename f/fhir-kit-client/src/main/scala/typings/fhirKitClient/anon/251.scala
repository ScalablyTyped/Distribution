...
object `251` {
  ...
  @scala.inline
  implicit class `251Ops`[Self <: `251`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: ImmunizationRecommendation): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
