...
object `119` {
  ...
  inline def apply(id: String, version: String): `119` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Contract", version = version.asInstanceOf[js.Any])
