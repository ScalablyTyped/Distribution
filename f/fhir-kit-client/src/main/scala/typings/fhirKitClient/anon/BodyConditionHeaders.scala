...
object BodyConditionHeaders {
  ...
  inline def apply(body: Condition, id: String): BodyConditionHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Condition")
    __obj.asInstanceOf[BodyConditionHeaders]
  }
  
  extension [Self <: BodyConditionHeaders](x: Self) {
