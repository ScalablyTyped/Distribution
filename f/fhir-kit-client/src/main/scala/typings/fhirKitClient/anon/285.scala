...
object `285` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String): `285` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "Provenance")
    __obj.asInstanceOf[`285`]
  }
  
  @scala.inline
  implicit class `285MutableBuilder`[Self <: `285`] (val x: Self) extends AnyVal {
