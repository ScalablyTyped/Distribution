...
object BodyAuditEvent {
  ...
  @scala.inline
  def apply(body: AuditEvent, resourceType: typings.fhirKitClient.fhirKitClientStrings.AuditEvent): BodyAuditEvent = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyAuditEvent]
  }
  
  @scala.inline
  implicit class BodyAuditEventOps[Self <: BodyAuditEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: AuditEvent): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.AuditEvent): Self = this.set("resourceType", value.asInstanceOf[js.Any])
