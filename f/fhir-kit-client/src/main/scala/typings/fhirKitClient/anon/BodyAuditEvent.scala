...
object BodyAuditEvent {
  ...
  @scala.inline
  def apply(body: AuditEvent): BodyAuditEvent = {
  ...
  implicit class BodyAuditEventMutableBuilder[Self <: BodyAuditEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.AuditEvent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
