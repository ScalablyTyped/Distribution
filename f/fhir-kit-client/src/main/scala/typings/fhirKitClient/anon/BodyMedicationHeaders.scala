...
@js.native
trait BodyMedicationHeaders extends js.Object {
...
object BodyMedicationHeaders {
  @scala.inline
  def apply(body: Medication, id: String, resourceType: typings.fhirKitClient.fhirKitClientStrings.Medication): BodyMedicationHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyMedicationHeaders]
  }
  @scala.inline
  implicit class BodyMedicationHeadersOps[Self <: BodyMedicationHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.Medication): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
