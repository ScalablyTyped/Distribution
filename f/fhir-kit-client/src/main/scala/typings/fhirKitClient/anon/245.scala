...
trait `245` extends js.Object {
  ...
  var resourceType: Group = js.native
}
object `245` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Group): `245` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`245`]
  }
  
  @scala.inline
  implicit class `245Ops`[Self <: `245`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Group): Self = this.set("resourceType", value.asInstanceOf[js.Any])
