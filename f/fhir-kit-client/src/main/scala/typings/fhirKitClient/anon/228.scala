...
object `228` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `228` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "DiagnosticReport")
