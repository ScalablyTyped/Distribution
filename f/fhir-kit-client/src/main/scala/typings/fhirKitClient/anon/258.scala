...
object `258` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `258` = {
  ...
  extension [Self <: `258`](x: Self) {
    ...
    inline def setResourceType(value: MeasureReport): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
