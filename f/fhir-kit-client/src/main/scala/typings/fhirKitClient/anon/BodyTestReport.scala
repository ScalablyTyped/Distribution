...
object BodyTestReport {
  ...
  inline def apply(body: TestReport): BodyTestReport = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = "TestReport")
    __obj.asInstanceOf[BodyTestReport]
  }
  
  extension [Self <: BodyTestReport](x: Self) {
