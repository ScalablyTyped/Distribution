...
object `280` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `280` = {
  ...
  extension [Self <: `280`](x: Self) {
    ...
    inline def setResourceType(value: PractitionerRole): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
