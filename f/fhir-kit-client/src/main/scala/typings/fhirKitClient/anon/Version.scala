...
object Version {
  ...
  inline def apply(id: String, version: String): Version = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "Account", version = version.asInstanceOf[js.Any])
