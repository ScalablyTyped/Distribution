...
object `107` {
  ...
  inline def apply(id: String, version: String): `107` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "ChargeItem", version = version.asInstanceOf[js.Any])
