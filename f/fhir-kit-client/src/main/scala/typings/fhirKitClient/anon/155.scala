...
object `155` {
  ...
  inline def apply(id: String, version: String): `155` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "List", version = version.asInstanceOf[js.Any])
