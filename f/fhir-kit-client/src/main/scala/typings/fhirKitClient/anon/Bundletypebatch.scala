...
object Bundletypebatch {
  ...
  inline def apply(`type`: code & batch): Bundletypebatch = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Bundletypebatch]
  }
  
  extension [Self <: Bundletypebatch](x: Self) {
    ...
    inline def setType(value: code & batch): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
