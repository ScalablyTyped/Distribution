...
trait Bundletypebatch extends StObject {
...
object Bundletypebatch {
  ...
  @scala.inline
  def apply(`type`: code & batch): Bundletypebatch = {
  ...
  @scala.inline
  implicit class BundletypebatchMutableBuilder[Self <: Bundletypebatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: code & batch): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
