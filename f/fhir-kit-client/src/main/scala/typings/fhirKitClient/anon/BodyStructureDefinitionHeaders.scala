...
@js.native
trait BodyStructureDefinitionHeaders extends js.Object {
...
object BodyStructureDefinitionHeaders {
  ...
  @scala.inline
  implicit class BodyStructureDefinitionHeadersOps[Self <: BodyStructureDefinitionHeaders] (val x: Self) extends AnyVal {
    @scala.inline
