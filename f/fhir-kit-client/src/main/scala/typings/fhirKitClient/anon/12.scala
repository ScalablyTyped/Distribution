...
trait `12` extends js.Object {
  ...
  var resourceType: Coverage = js.native
}

object `12` {
  @scala.inline
  def apply(id: String, resourceType: Coverage): `12` = {
  ...
  implicit class `12Ops`[Self <: `12`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Coverage): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
