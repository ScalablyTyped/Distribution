...
object BodyMedicationRequestHeaders {
  ...
  @scala.inline
  def apply(body: MedicationRequest, id: String): BodyMedicationRequestHeaders = {
  ...
  @scala.inline
  implicit class BodyMedicationRequestHeadersMutableBuilder[Self <: BodyMedicationRequestHeaders] (val x: Self) extends AnyVal {
