...
@js.native
trait BodyMedicationRequestHeaders extends js.Object {
...
object BodyMedicationRequestHeaders {
  ...
  ): BodyMedicationRequestHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyMedicationRequestHeaders]
  }
  
  @scala.inline
  implicit class BodyMedicationRequestHeadersOps[Self <: BodyMedicationRequestHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: MedicationRequest): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typings.fhirKitClient.fhirKitClientStrings.MedicationRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
