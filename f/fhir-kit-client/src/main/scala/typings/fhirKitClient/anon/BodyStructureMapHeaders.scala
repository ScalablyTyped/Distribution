...
object BodyStructureMapHeaders {
  ...
  inline def apply(body: StructureMap, id: String): BodyStructureMapHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = "StructureMap")
    __obj.asInstanceOf[BodyStructureMapHeaders]
  }
  
  extension [Self <: BodyStructureMapHeaders](x: Self) {
