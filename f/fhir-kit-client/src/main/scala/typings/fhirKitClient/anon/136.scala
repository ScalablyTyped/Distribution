...
object `136` {
  ...
  inline def apply(id: String, version: String): `136` = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = "EnrollmentRequest", version = version.asInstanceOf[js.Any])
