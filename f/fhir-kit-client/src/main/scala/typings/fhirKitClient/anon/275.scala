...
object `275` {
  ...
  inline def apply(JSONPatch: js.Array[OpPatch], id: String): `275` = {
  ...
  extension [Self <: `275`](x: Self) {
    ...
    inline def setResourceType(value: PaymentNotice): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
