...
object `275` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: PaymentNotice): `275` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`275`]
  }
  @scala.inline
  implicit class `275Ops`[Self <: `275`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: PaymentNotice): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
