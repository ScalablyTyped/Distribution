...
trait AnonBodyHeadersOptionsQuestionnaireResponse extends js.Object {
...
object AnonBodyHeadersOptionsQuestionnaireResponse {
  @scala.inline
  def apply(
  ...
  ): AnonBodyHeadersOptionsQuestionnaireResponse = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    if (headers != null) __obj.updateDynamic("headers")(headers.asInstanceOf[js.Any])
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyHeadersOptionsQuestionnaireResponse]
  }
}
