...
object FluentBundleAddResourceOptions {
  ...
  implicit class FluentBundleAddResourceOptionsOps[Self <: FluentBundleAddResourceOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowOverrides(value: Boolean): Self = this.set("allowOverrides", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAllowOverrides: Self = this.set("allowOverrides", js.undefined)
  }
}
