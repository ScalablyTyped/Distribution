...
trait Anon_ButtonPropsClassName extends js.Object {
...
object Anon_ButtonPropsClassName {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_ButtonPropsClassName]
  }
}
