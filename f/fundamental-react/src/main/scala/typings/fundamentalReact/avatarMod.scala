...
object avatarMod extends Shortcut {
  ...
  object AvatarProps {
    ...
    @scala.inline
    def apply(placeholder: js.UndefOr[Boolean] & js.UndefOr[String]): AvatarProps = {
    ...
    implicit class AvatarPropsMutableBuilder[Self <: AvatarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPlaceholder(value: js.UndefOr[Boolean] & js.UndefOr[String]): Self = StObject.set(x, "placeholder", value.asInstanceOf[js.Any])
