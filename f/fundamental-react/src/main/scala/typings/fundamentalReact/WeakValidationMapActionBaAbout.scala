...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/ActionBar/ActionBar.ActionBarActionsProps> */
trait WeakValidationMapActionBaAbout extends js.Object {
...
object WeakValidationMapActionBaAbout {
  @scala.inline
  def apply(
  ...
  ): WeakValidationMapActionBaAbout = {
    ...
    __obj.asInstanceOf[WeakValidationMapActionBaAbout]
  }
}
