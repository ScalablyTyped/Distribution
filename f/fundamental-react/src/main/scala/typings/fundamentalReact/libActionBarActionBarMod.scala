...
object libActionBarActionBarMod {
  ...
  object default {
    ...
    inline def apply(props: ActionBarProps): ReactNode = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[ReactNode]
    inline def apply(props: ActionBarProps, context: Any): ReactNode = (^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[ReactNode]
    ...
    @JSImport("fundamental-react/lib/ActionBar/ActionBar", "default.displayName")
    @js.native
    def displayName: js.UndefOr[ActionBar | String] = js.native
    inline def displayName_=(x: js.UndefOr[ActionBar | String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("fundamental-react/lib/ActionBar/ActionBar", "default.propTypes")
    @js.native
  ...
  object ActionBar {
    ...
    @JSImport("fundamental-react/lib/ActionBar/ActionBar", "ActionBar.displayName")
    @js.native
    ...
    @JSImport("fundamental-react/lib/ActionBar/ActionBar", "ActionBar.propTypes")
    @js.native
    def propTypes: js.UndefOr[WeakValidationMapActionBa] = js.native
    inline def propTypes_=(x: js.UndefOr[WeakValidationMapActionBa]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("propTypes")(x.asInstanceOf[js.Any])
  }
  
  /* Inlined {  title :string,   actionClassName :string | undefined,   actionProps :any | undefined,   actions :react.react.ReactNode | undefined,   buttonContainerClassName :string | undefined,   buttonProps :any | undefined,   className :string | undefined,   description :string | undefined,   descriptionProps :any | undefined,   disableStyles :boolean | undefined,   headingLevel :any | undefined,   titleProps :any | undefined,   onBackClick :(args : ...any): any | undefined} & std.Pick<react.react.HTMLAttributes<std.HTMLDivElement>, std.Exclude<keyof react.react.HTMLAttributes<std.HTMLDivElement>, 'children'>> */
  ...
  object ActionBarProps {
    ...
    implicit open class MutableBuilder[Self <: ActionBarProps] (val x: Self) extends AnyVal {
      ...
      inline def setActionClassName(value: String): Self = StObject.set(x, "actionClassName", value.asInstanceOf[js.Any])
      ...
      inline def `setAria-autocomplete`(value: none | `inline` | list_ | both): Self = StObject.set(x, "aria-autocomplete", value.asInstanceOf[js.Any])
      ...
      inline def `setAria-current`(value: Boolean | page | step | location | date | time_): Self = StObject.set(x, "aria-current", value.asInstanceOf[js.Any])
      ...
      inline def `setAria-dropeffect`(value: none | copy | execute | link_ | move | popup): Self = StObject.set(x, "aria-dropeffect", value.asInstanceOf[js.Any])
      ...
      inline def setButtonContainerClassName(value: String): Self = StObject.set(x, "buttonContainerClassName", value.asInstanceOf[js.Any])
