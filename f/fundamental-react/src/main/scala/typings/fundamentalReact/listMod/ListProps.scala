...
trait ListProps extends js.Object {
  ...
  var footer: js.UndefOr[String | Element] = js.native
  
  var header: js.UndefOr[String | Element] = js.native
...
object ListProps {
  ...
  implicit class ListPropsOps[Self <: ListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFooter(value: String | Element): Self = this.set("footer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFooter: Self = this.set("footer", js.undefined)
    
    @scala.inline
    def setHeader(value: String | Element): Self = this.set("header", value.asInstanceOf[js.Any])
