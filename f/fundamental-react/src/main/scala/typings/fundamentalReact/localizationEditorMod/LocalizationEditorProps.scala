...
/* Inlined {  control :{  buttonProps :{[x: string] : any} | undefined,   inputProps :{[x: string] : any} | undefined,   labelProps :{[x: string] : any} | undefined,   label :string | undefined,   placeholder :string | undefined,   language :string | undefined},   menu :std.Array<{  inputProps :{[x: string] : any} | undefined,   placeholder :string | undefined,   language :string | undefined}>,   className :string | undefined,   compact :boolean | undefined,   disableStyles :boolean | undefined,   id :string | undefined,   inputClassName :string | undefined,   listProps :any | undefined,   popoverProps :any | undefined,   textarea :boolean | undefined} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
trait LocalizationEditorProps extends js.Object {
  ...
  var control: ButtonProps = js.native
  ...
  var menu: js.Array[InputProps] = js.native
  // Media Events
...
object LocalizationEditorProps {
  ...
  @scala.inline
  implicit class LocalizationEditorPropsOps[Self <: LocalizationEditorProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setControl(value: ButtonProps): Self = this.set("control", value.asInstanceOf[js.Any])
    @scala.inline
    def setMenuVarargs(value: InputProps*): Self = this.set("menu", js.Array(value :_*))
    @scala.inline
    def setMenu(value: js.Array[InputProps]): Self = this.set("menu", value.asInstanceOf[js.Any])
    @scala.inline
