...
object counterMod {
  ...
  object default {
    ...
    @scala.inline
    def displayName_=(x: js.UndefOr[Counter | String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  ...
  /* Inlined {  disableStyles :boolean | undefined,   localizedText :{  counterLabel :string | undefined} | undefined,   notification :boolean | undefined} & react.react.HTMLAttributes<std.HTMLSpanElement> */
  @js.native
  trait CounterProps extends StObject {
    ...
    var localizedText: js.UndefOr[CounterLabel] = js.native
  ...
  object CounterProps {
    ...
    @scala.inline
    def apply(): CounterProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CounterProps]
    }
    
    @scala.inline
    implicit class CounterPropsMutableBuilder[Self <: CounterProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocalizedText(value: CounterLabel): Self = StObject.set(x, "localizedText", value.asInstanceOf[js.Any])
