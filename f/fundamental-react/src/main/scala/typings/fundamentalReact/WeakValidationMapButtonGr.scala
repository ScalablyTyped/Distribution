...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/Button/ButtonGroup.ButtonGroupProps> */
trait WeakValidationMapButtonGr extends js.Object {
...
object WeakValidationMapButtonGr {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[WeakValidationMapButtonGr]
  }
}
