...
/* Inlined {  buttonProps :{[x: string] : any} | undefined,   className :string | undefined,   isExpanded :boolean | undefined,   onExpandAll :(args : ...any): any | undefined} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
trait TreeHeadProps extends js.Object {
...
object TreeHeadProps {
  ...
  @scala.inline
  implicit class TreeHeadPropsOps[Self <: TreeHeadProps] (val x: Self) extends AnyVal {
