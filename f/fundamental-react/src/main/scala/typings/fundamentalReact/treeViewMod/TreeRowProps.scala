...
/* Inlined {  isExpanded :boolean | undefined,   isParent :boolean | undefined,   rowId :string | undefined,   onExpandClick :(args : ...any): any | undefined} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
trait TreeRowProps extends js.Object {
...
object TreeRowProps {
  ...
  @scala.inline
  implicit class TreeRowPropsOps[Self <: TreeRowProps] (val x: Self) extends AnyVal {
