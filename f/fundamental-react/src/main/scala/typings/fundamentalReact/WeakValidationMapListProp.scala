...
trait WeakValidationMapListProp extends js.Object {
  ...
  var noBorder: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
...
object WeakValidationMapListProp {
  ...
  def apply(
    ...
    noBorder: Validator[js.UndefOr[Boolean | Null]] = null,
    ...
    if (noBorder != null) __obj.updateDynamic("noBorder")(noBorder.asInstanceOf[js.Any])
