...
object libFormsFormLegendMod extends Shortcut {
  ...
  object FormLegendProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: FormLegendProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `libFormsFormLegendMod.foo` */
