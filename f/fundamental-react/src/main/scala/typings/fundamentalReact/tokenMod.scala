...
@JSImport("fundamental-react/lib/Token/Token", JSImport.Namespace)
@js.native
object tokenMod extends js.Object {
  /* Inlined {  className ? :string,   compact ? :boolean,   disableStyles ? :boolean,   readOnly ? :boolean, onClick ? (event : react.react.MouseEvent<std.HTMLButtonElement, std.MouseEvent>): void} & react.react.HTMLAttributes<std.HTMLDivElement> */
  @js.native
  trait TokenProps extends js.Object {
    ...
    var onClick: js.UndefOr[
        (js.Function1[/* event */ typings.react.mod.MouseEvent[HTMLButtonElement, MouseEvent], Unit]) | MouseEventHandler[HTMLDivElement]
      ] = js.native
    // Composition Events
