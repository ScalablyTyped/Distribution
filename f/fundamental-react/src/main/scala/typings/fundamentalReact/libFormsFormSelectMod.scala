...
object libFormsFormSelectMod extends Shortcut {
  ...
  object FormSelectProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: FormSelectProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `libFormsFormSelectMod.foo` */
