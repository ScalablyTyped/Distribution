...
/* Inlined {  className :string | undefined,   cols :1 | 2 | 3 | 4 | 5 | 6 | undefined,   colSpan :any | undefined,   disableStyles :boolean | undefined,   nogap :boolean | undefined,   ref :react.react.Ref<std.HTMLDivElement> | undefined} & react.react.HTMLAttributes<std.HTMLAnchorElement> */
@js.native
trait LayoutGridProps extends js.Object {
  ...
  var colSpan: js.UndefOr[js.Any] = js.native
  
  var color: js.UndefOr[String] = js.native
  
  var cols: js.UndefOr[`1` | `2` | `3` | `4` | `5` | `6`] = js.native
  ...
  var nogap: js.UndefOr[Boolean] = js.native
...
object LayoutGridProps {
  ...
  @scala.inline
  implicit class LayoutGridPropsOps[Self <: LayoutGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCols(value: `1` | `2` | `3` | `4` | `5` | `6`): Self = this.set("cols", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNogap(value: Boolean): Self = this.set("nogap", value.asInstanceOf[js.Any])
