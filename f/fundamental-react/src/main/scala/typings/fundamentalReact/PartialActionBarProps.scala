...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/ActionBar/ActionBar.ActionBarProps> */
...
object PartialActionBarProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PartialActionBarProps]
  }
}
