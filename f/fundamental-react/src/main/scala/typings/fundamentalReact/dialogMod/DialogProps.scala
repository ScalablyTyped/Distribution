...
trait DialogProps extends js.Object {
  ...
  var actions: js.Array[ReactNode] = js.native
...
object DialogProps {
  ...
  @scala.inline
  def apply(actions: js.Array[ReactNode], title: String with js.UndefOr[String]): DialogProps = {
  ...
  implicit class DialogPropsOps[Self <: DialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentProps(value: js.Any): Self = this.set("contentProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFooterProps(value: js.Any): Self = this.set("footerProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHeaderProps(value: js.Any): Self = this.set("headerProps", value.asInstanceOf[js.Any])
