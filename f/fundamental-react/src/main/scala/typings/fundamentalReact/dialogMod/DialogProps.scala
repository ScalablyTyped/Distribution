package typings.fundamentalReact.dialogMod
...
/* Inlined {  actions  :std.Array<react.react.ReactNode>,   title  :string,   backdropClassName ? :string,   bodyProps ? :any,   className ? :string,   contentProps ? :any,   disableStyles ? :boolean,   footerProps ? :any,   header ? :string,   headerProps ? :any,   headingLevel ? :any,   show ? :boolean,   size ? :any,   subheader ? :string,   titleProps ? :any, onClose ? (args : ...any): any} & react.react.HTMLAttributes<std.HTMLSpanElement> */
...
object DialogProps {
  ...
  def apply(
    ...
    footerProps: js.Any = null,
    header: String = null,
    headerProps: js.Any = null,
