...
/* Inlined {  disableStyles ? :boolean,   ref ? :react.react.Ref<std.HTMLUListElement>} & std.Pick<react.react.HTMLAttributes<std.HTMLUListElement>, std.Exclude<keyof react.react.HTMLAttributes<std.HTMLUListElement>, 'className'>> */
