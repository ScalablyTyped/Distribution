...
trait AnonButtonPropsCompact
  ...
  var onBlur: js.UndefOr[js.Function1[/* hasDateFormattedDate */ AnonDateFormattedDate, Unit]] = js.undefined
}

object AnonButtonPropsCompact {
  @scala.inline
  def apply(
    ...
    onBlur: /* hasDateFormattedDate */ AnonDateFormattedDate => Unit = null
  ): AnonButtonPropsCompact = {
    ...
    __obj.asInstanceOf[AnonButtonPropsCompact]
  }
}
