...
object CounterProps {
  ...
  @scala.inline
  implicit class CounterPropsOps[Self <: CounterProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setLocalizedText(value: CounterLabel): Self = this.set("localizedText", value.asInstanceOf[js.Any])
    @scala.inline
