...
/* Inlined {  disableStyles ? :boolean,   localizedText ? :{  counterLabel ? :string},   notification ? :boolean} & react.react.HTMLAttributes<std.HTMLSpanElement> */
...
object CounterProps {
  ...
  def apply(
    ...
    lang: String = null,
    localizedText: CounterLabel = null,
