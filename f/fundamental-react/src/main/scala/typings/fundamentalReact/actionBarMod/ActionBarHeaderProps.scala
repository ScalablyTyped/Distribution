...
/* Inlined {  title  :string,   className ? :string,   description ? :string,   descriptionProps ? :{[x: string] : any},   headingLevel ? :1 | 2 | 3 | 4 | 5 | 6,   ref ? :react.react.Ref<std.HTMLDivElement>,   titleProps ? :{[x: string] : any}} & react.react.HTMLAttributes<std.HTMLDivElement> */
trait ActionBarHeaderProps extends js.Object {
  // RDFa Attributes
