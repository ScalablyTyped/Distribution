...
trait AnonCustomStylesDisableStylesExpandData extends js.Object {
...
object AnonCustomStylesDisableStylesExpandData {
  @scala.inline
  def apply(
  ...
  ): AnonCustomStylesDisableStylesExpandData = {
    ...
    __obj.asInstanceOf[AnonCustomStylesDisableStylesExpandData]
  }
}
