...
object libAvatarAvatarMod extends Shortcut {
  ...
  @js.native
  val default: FunctionComponent[AvatarProps] = js.native
  ...
  object AvatarProps {
    ...
    implicit open class MutableBuilder[Self <: AvatarProps] (val x: Self) extends AnyVal {
      ...
      inline def setColor(value: `1` | `2` | `3` | `4` | `5` | `6` | `7` | `8` | `9`): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.fundamentalReact.fundamentalReactStrings.xs
  ...
  */
  ...
  object AvatarSize {
    ...
    inline def xs: typings.fundamentalReact.fundamentalReactStrings.xs = "xs".asInstanceOf[typings.fundamentalReact.fundamentalReactStrings.xs]
  }
  ...
  object HTMLAttributesColorOmited {
    ...
    inline def apply(): HTMLAttributesColorOmited = {
      val __obj = js.Dynamic.literal()
  ...
  type _To = FunctionComponent[AvatarProps]
  
  /* This means you don't have to write `default`, but can instead just say `libAvatarAvatarMod.foo` */
  override def _to: FunctionComponent[AvatarProps] = default
}
