...
object fundamentalReactStrings {
  ...
  @scala.inline
  def FormGroup: FormGroup = "FormGroup".asInstanceOf[FormGroup]
  ...
  @scala.inline
  def ListDotFooter: ListDotFooter = "List.Footer".asInstanceOf[ListDotFooter]
  
  @js.native
  sealed trait ListDotHeader extends StObject
  @scala.inline
  def ListDotHeader: ListDotHeader = "List.Header".asInstanceOf[ListDotHeader]
  
  @js.native
  sealed trait ListDotIcon extends StObject
  @scala.inline
  def ListDotIcon: ListDotIcon = "List.Icon".asInstanceOf[ListDotIcon]
  ...
  @scala.inline
  def StepInput: StepInput = "StepInput".asInstanceOf[StepInput]
