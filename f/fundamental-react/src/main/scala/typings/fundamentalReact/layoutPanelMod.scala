...
object layoutPanelMod {
  ...
  object default {
    ...
    object Actions {
      ...
      inline def getDerivedStateFromError_=(x: js.UndefOr[GetDerivedStateFromError[HTMLAttributes[HTMLDivElement], ComponentState]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getDerivedStateFromError")(x.asInstanceOf[js.Any])
      ...
      inline def getDerivedStateFromProps_=(x: js.UndefOr[GetDerivedStateFromProps[HTMLAttributes[HTMLDivElement], ComponentState]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getDerivedStateFromProps")(x.asInstanceOf[js.Any])
    ...
    object Head {
      ...
      inline def getDerivedStateFromError_=(x: js.UndefOr[GetDerivedStateFromError[LayoutPanelHeadProps, ComponentState]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getDerivedStateFromError")(x.asInstanceOf[js.Any])
      ...
      inline def getDerivedStateFromProps_=(x: js.UndefOr[GetDerivedStateFromProps[LayoutPanelHeadProps, ComponentState]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getDerivedStateFromProps")(x.asInstanceOf[js.Any])
