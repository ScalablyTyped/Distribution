...
object breadcrumbMod {
  ...
  object default {
    ...
    @scala.inline
    def displayName_=(x: js.UndefOr[Breadcrumb | String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  ...
  /* Inlined {  className :string | undefined,   name :string | undefined,   url :string | undefined} & react.react.HTMLAttributes<std.HTMLLIElement> */
  @js.native
  ...
  object BreadcrumbProps {
    ...
    implicit class BreadcrumbPropsMutableBuilder[Self <: BreadcrumbProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: Ref[HTMLUListElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
