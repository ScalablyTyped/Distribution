package typings.fundamentalReact.modalMod

import org.scalablytyped.runtime.StringDictionary
import typings.fundamentalReact.AnonCloseButton
...
object ModalProps {
  ...
  def apply(
    ...
    onClose: /* event */ typings.react.mod.MouseEvent[HTMLButtonElement, MouseEvent] => Unit = null,
