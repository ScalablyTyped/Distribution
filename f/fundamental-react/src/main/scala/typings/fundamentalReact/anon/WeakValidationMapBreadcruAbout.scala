...
object WeakValidationMapBreadcruAbout {
  ...
  @scala.inline
  def apply(): WeakValidationMapBreadcruAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapBreadcruAbout]
  }
  
  @scala.inline
  implicit class WeakValidationMapBreadcruAboutMutableBuilder[Self <: WeakValidationMapBreadcruAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: Validator[js.UndefOr[MouseEventHandler[HTMLLIElement] | Null]]): Self = StObject.set(x, "onClick", value.asInstanceOf[js.Any])
