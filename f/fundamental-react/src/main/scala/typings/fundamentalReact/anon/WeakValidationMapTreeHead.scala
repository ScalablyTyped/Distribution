...
object WeakValidationMapTreeHead {
  ...
  implicit class WeakValidationMapTreeHeadMutableBuilder[Self <: WeakValidationMapTreeHead] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonProps(value: Validator[js.UndefOr[Null | StringDictionary[js.Any]]]): Self = StObject.set(x, "buttonProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnExpandAll(value: Validator[js.UndefOr[(js.Function1[/* repeated */ js.Any, js.Any]) | Null]]): Self = StObject.set(x, "onExpandAll", value.asInstanceOf[js.Any])
