...
trait WeakValidationMapButtonPr extends StObject {
  ...
  var ref: js.UndefOr[Validator[js.UndefOr[Null | RefObject[HTMLButtonElement]]]] = js.native
...
object WeakValidationMapButtonPr {
  ...
  implicit class WeakValidationMapButtonPrMutableBuilder[Self <: WeakValidationMapButtonPr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: Validator[js.UndefOr[Null | RefObject[HTMLButtonElement]]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
