...
trait WeakValidationMapTreeRowP extends StObject {
  ...
  var onExpandClick: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* repeated */ js.Any, js.Any]) | Null]]] = js.undefined
...
object WeakValidationMapTreeRowP {
  ...
  extension [Self <: WeakValidationMapTreeRowP](x: Self) {
    ...
    inline def setIsParent(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "isParent", value.asInstanceOf[js.Any])
    ...
    inline def setOnExpandClick(value: Validator[js.UndefOr[(js.Function1[/* repeated */ js.Any, js.Any]) | Null]]): Self = StObject.set(x, "onExpandClick", value.asInstanceOf[js.Any])
