...
trait WeakValidationMapTreeRowP extends StObject {
  ...
  var onExpandClick: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* repeated */ Any, Any]) | Null]]] = js.undefined
...
object WeakValidationMapTreeRowP {
  ...
  extension [Self <: WeakValidationMapTreeRowP](x: Self) {
    ...
    inline def setOnExpandClick(value: Validator[js.UndefOr[(js.Function1[/* repeated */ Any, Any]) | Null]]): Self = StObject.set(x, "onExpandClick", value.asInstanceOf[js.Any])
