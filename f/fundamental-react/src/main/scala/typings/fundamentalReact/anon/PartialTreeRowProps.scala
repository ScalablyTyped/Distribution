...
@js.native
trait PartialTreeRowProps extends js.Object {
...
object PartialTreeRowProps {
  ...
  @scala.inline
  implicit class PartialTreeRowPropsOps[Self <: PartialTreeRowProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnExpandClick(value: /* repeated */ js.Any => _): Self = this.set("onExpandClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnExpandClick: Self = this.set("onExpandClick", js.undefined)
