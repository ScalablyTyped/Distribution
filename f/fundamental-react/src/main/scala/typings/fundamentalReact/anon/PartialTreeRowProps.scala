...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/TreeView/TreeView.TreeRowProps> */
@js.native
trait PartialTreeRowProps extends StObject {
  ...
  var onExpandClick: js.UndefOr[js.Function1[/* repeated */ js.Any, _]] = js.native
...
object PartialTreeRowProps {
  
  @scala.inline
  def apply(): PartialTreeRowProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTreeRowProps]
  }
  
  @scala.inline
  implicit class PartialTreeRowPropsMutableBuilder[Self <: PartialTreeRowProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnExpandClick(value: /* repeated */ js.Any => _): Self = StObject.set(x, "onExpandClick", js.Any.fromFunction1(value))
