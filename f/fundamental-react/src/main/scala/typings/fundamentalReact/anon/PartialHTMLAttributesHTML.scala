...
@js.native
trait PartialHTMLAttributesHTML extends js.Object {
...
object PartialHTMLAttributesHTML {
  ...
  @scala.inline
  def apply(): PartialHTMLAttributesHTML = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialHTMLAttributesHTML]
  }
  
  @scala.inline
  implicit class PartialHTMLAttributesHTMLOps[Self <: PartialHTMLAttributesHTML] (val x: Self) extends AnyVal {
