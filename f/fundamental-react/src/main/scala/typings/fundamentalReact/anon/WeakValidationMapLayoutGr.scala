...
trait WeakValidationMapLayoutGr extends StObject {
  ...
  var colSpan: js.UndefOr[Validator[js.UndefOr[Any | Null]]] = js.undefined
...
object WeakValidationMapLayoutGr {
  ...
  extension [Self <: WeakValidationMapLayoutGr](x: Self) {
    ...
    inline def setColSpan(value: Validator[js.UndefOr[Any | Null]]): Self = StObject.set(x, "colSpan", value.asInstanceOf[js.Any])
