...
trait WeakValidationMapMenuGrou extends StObject {
  ...
  var titleProps: js.UndefOr[Validator[js.UndefOr[Null | StringDictionary[js.Any]]]] = js.undefined
...
object WeakValidationMapMenuGrou {
  ...
  extension [Self <: WeakValidationMapMenuGrou](x: Self) {
    ...
    inline def setTitleProps(value: Validator[js.UndefOr[Null | StringDictionary[js.Any]]]): Self = StObject.set(x, "titleProps", value.asInstanceOf[js.Any])
