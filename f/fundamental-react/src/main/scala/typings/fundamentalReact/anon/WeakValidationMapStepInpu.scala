...
trait WeakValidationMapStepInpu extends StObject {
  ...
  var onChange: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: null extends (stepValue : number): void | undefined ? react.react.Validator<(stepValue : number): void | undefined | null | undefined> : undefined extends (stepValue : number): void | undefined ? react.react.Validator<(stepValue : number): void | undefined | null | undefined> : react.react.Validator<(stepValue : number): void | undefined> */ js.Any
  ] = js.undefined
  ...
  var validationState: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: null extends {  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined ? react.react.Validator<{  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined | null | undefined> : undefined extends {  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined ? react.react.Validator<{  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined | null | undefined> : react.react.Validator<{  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined> */ js.Any
  ] = js.undefined
...
object WeakValidationMapStepInpu {
  ...
  implicit open class MutableBuilder[Self <: WeakValidationMapStepInpu] (val x: Self) extends AnyVal {
    ...
    inline def setOnChange(
      value: /* import warning: importer.ImportType#apply Failed type conversion: null extends (stepValue : number): void | undefined ? react.react.Validator<(stepValue : number): void | undefined | null | undefined> : undefined extends (stepValue : number): void | undefined ? react.react.Validator<(stepValue : number): void | undefined | null | undefined> : react.react.Validator<(stepValue : number): void | undefined> */ js.Any
    ...
    inline def setValidationState(
      value: /* import warning: importer.ImportType#apply Failed type conversion: null extends {  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined ? react.react.Validator<{  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined | null | undefined> : undefined extends {  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined ? react.react.Validator<{  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined | null | undefined> : react.react.Validator<{  state :'error' | 'warning' | 'information' | 'success' | undefined,   text :string | undefined} | undefined> */ js.Any
    ): Self = StObject.set(x, "validationState", value.asInstanceOf[js.Any])
