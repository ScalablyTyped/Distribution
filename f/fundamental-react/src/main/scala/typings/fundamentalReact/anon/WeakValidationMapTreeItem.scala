...
@js.native
trait WeakValidationMapTreeItem extends js.Object {
...
object WeakValidationMapTreeItem {
  @scala.inline
  def apply(): WeakValidationMapTreeItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapTreeItem]
  }
  @scala.inline
  implicit class WeakValidationMapTreeItemOps[Self <: WeakValidationMapTreeItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRowId(value: Validator[js.UndefOr[Null | String]]): Self = this.set("rowId", value.asInstanceOf[js.Any])
    @scala.inline
