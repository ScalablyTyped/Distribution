...
object WeakValidationMapTreeItem {
  ...
  extension [Self <: WeakValidationMapTreeItem](x: Self) {
    ...
    inline def setIsExpanded(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "isExpanded", value.asInstanceOf[js.Any])
    ...
    inline def setRowId(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "rowId", value.asInstanceOf[js.Any])
