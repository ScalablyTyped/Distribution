...
object WeakValidationMapTreeItem {
  ...
  @scala.inline
  implicit class WeakValidationMapTreeItemMutableBuilder[Self <: WeakValidationMapTreeItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRowId(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "rowId", value.asInstanceOf[js.Any])
