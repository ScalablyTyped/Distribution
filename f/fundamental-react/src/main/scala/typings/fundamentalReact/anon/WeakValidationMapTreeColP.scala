...
object WeakValidationMapTreeColP {
  ...
  @scala.inline
  implicit class WeakValidationMapTreeColPMutableBuilder[Self <: WeakValidationMapTreeColP] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: Validator[js.UndefOr[FormEventHandler[HTMLDivElement] | Null]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
