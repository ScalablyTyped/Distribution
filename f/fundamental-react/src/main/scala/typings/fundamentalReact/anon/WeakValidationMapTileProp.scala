...
trait WeakValidationMapTileProp extends StObject {
  ...
  var size: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: null extends 's' | undefined ? react.react.Validator<'s' | undefined | null | undefined> : undefined extends 's' | undefined ? react.react.Validator<'s' | undefined | null | undefined> : react.react.Validator<'s' | undefined> */ js.Any
  ] = js.undefined
}
object WeakValidationMapTileProp {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: WeakValidationMapTileProp] (val x: Self) extends AnyVal {
    ...
    ): Self = StObject.set(x, "isDouble", value.asInstanceOf[js.Any])
    ...
    inline def setSize(
      value: /* import warning: importer.ImportType#apply Failed type conversion: null extends 's' | undefined ? react.react.Validator<'s' | undefined | null | undefined> : undefined extends 's' | undefined ? react.react.Validator<'s' | undefined | null | undefined> : react.react.Validator<'s' | undefined> */ js.Any
