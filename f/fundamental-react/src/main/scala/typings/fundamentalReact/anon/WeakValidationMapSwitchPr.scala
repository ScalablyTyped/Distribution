...
object WeakValidationMapSwitchPr {
  ...
  implicit class WeakValidationMapSwitchPrMutableBuilder[Self <: WeakValidationMapSwitchPr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputProps(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "inputProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabelProps(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "labelProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelPropsUndefined: Self = StObject.set(x, "labelProps", js.undefined)
    
    @scala.inline
    def setOnChange(value: Validator[js.UndefOr[(js.Function1[/* repeated */ js.Any, js.Any]) | Null]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
