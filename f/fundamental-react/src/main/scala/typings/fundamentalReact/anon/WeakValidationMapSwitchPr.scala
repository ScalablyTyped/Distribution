...
object WeakValidationMapSwitchPr {
  ...
  extension [Self <: WeakValidationMapSwitchPr](x: Self) {
    ...
    inline def setInternalLabels(value: Validator[js.UndefOr[Checked | Null]]): Self = StObject.set(x, "internalLabels", value.asInstanceOf[js.Any])
    ...
    inline def setSemantic(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "semantic", value.asInstanceOf[js.Any])
