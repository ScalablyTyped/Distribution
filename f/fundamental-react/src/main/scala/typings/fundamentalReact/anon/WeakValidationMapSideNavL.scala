...
trait WeakValidationMapSideNavL extends StObject {
  ...
  var isUtility: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.native
  ...
  var onClick: js.UndefOr[Validator[js.UndefOr[MouseEventHandler[Element] | Null]]] = js.native
...
object WeakValidationMapSideNavL {
  ...
  implicit class WeakValidationMapSideNavLMutableBuilder[Self <: WeakValidationMapSideNavL] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnItemSelect(value: Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]): Self = StObject.set(x, "onItemSelect", value.asInstanceOf[js.Any])
