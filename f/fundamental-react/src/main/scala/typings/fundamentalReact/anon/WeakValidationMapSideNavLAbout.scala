...
object WeakValidationMapSideNavLAbout {
  ...
  @scala.inline
  implicit class WeakValidationMapSideNavLAboutMutableBuilder[Self <: WeakValidationMapSideNavLAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpandSubmenuLabel(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "expandSubmenuLabel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExpandSubmenuLabelUndefined: Self = StObject.set(x, "expandSubmenuLabel", js.undefined)
    
    @scala.inline
    def setExpanded(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "expanded", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIsSubItem(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "isSubItem", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUrl(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
