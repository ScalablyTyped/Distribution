...
trait WeakValidationMapSideNavLAbout extends StObject {
  ...
  var expandSubmenuLabel: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
...
object WeakValidationMapSideNavLAbout {
  ...
  inline def apply(): WeakValidationMapSideNavLAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapSideNavLAbout]
  }
  
  extension [Self <: WeakValidationMapSideNavLAbout](x: Self) {
    ...
    inline def setExpandSubmenuLabel(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "expandSubmenuLabel", value.asInstanceOf[js.Any])
    
    inline def setExpandSubmenuLabelUndefined: Self = StObject.set(x, "expandSubmenuLabel", js.undefined)
    
    inline def setExpanded(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "expanded", value.asInstanceOf[js.Any])
    ...
    inline def setIsSubItem(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "isSubItem", value.asInstanceOf[js.Any])
    ...
    inline def setUrl(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
