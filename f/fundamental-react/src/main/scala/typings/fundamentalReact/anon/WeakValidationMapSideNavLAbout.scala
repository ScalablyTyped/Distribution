...
object WeakValidationMapSideNavLAbout {
  ...
  implicit class WeakValidationMapSideNavLAboutOps[Self <: WeakValidationMapSideNavLAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsSubItem(value: Validator[js.UndefOr[Boolean | Null]]): Self = this.set("isSubItem", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUrl(value: Validator[js.UndefOr[Null | String]]): Self = this.set("url", value.asInstanceOf[js.Any])
