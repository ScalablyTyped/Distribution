...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/Menu/Menu.MenuGroupProps> */
@js.native
trait PartialMenuGroupProps extends StObject {
  ...
  var titleProps: js.UndefOr[StringDictionary[js.Any]] = js.native
...
object PartialMenuGroupProps {
  
  @scala.inline
  def apply(): PartialMenuGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuGroupProps]
  }
  
  @scala.inline
  implicit class PartialMenuGroupPropsMutableBuilder[Self <: PartialMenuGroupProps] (val x: Self) extends AnyVal {
