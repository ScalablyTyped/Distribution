...
@js.native
trait PartialMenuGroupProps extends js.Object {
...
object PartialMenuGroupProps {
  ...
  @scala.inline
  implicit class PartialMenuGroupPropsOps[Self <: PartialMenuGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTitleProps(value: StringDictionary[js.Any]): Self = this.set("titleProps", value.asInstanceOf[js.Any])
