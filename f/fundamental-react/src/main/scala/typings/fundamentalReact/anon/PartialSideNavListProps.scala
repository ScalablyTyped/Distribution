...
object PartialSideNavListProps {
  ...
  @scala.inline
  def apply(): PartialSideNavListProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSideNavListProps]
  }
  
  @scala.inline
  implicit class PartialSideNavListPropsMutableBuilder[Self <: PartialSideNavListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnAuxClick(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onAuxClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnContextMenu(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onContextMenu", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnMouseMove(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnMouseMoveUndefined: Self = StObject.set(x, "onMouseMove", js.undefined)
    
    @scala.inline
    def setOnMouseOut(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseOut", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnMouseOutUndefined: Self = StObject.set(x, "onMouseOut", js.undefined)
    
    @scala.inline
    def setOnMouseOver(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseOver", js.Any.fromFunction1(value))
