...
object PartialSideNavListProps {
  ...
  def apply(
    ...
    is: String = null,
    isUtility: js.UndefOr[Boolean] = js.undefined,
    itemID: String = null,
    ...
    if (!js.isUndefined(hasParent)) __obj.updateDynamic("hasParent")(hasParent.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hidden)) __obj.updateDynamic("hidden")(hidden.get.asInstanceOf[js.Any])
    if (id != null) __obj.updateDynamic("id")(id.asInstanceOf[js.Any])
    if (inlist != null) __obj.updateDynamic("inlist")(inlist.asInstanceOf[js.Any])
    if (inputMode != null) __obj.updateDynamic("inputMode")(inputMode.asInstanceOf[js.Any])
    if (is != null) __obj.updateDynamic("is")(is.asInstanceOf[js.Any])
    if (!js.isUndefined(isUtility)) __obj.updateDynamic("isUtility")(isUtility.get.asInstanceOf[js.Any])
