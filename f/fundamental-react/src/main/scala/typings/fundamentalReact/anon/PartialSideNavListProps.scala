...
object PartialSideNavListProps {
  ...
  @scala.inline
  implicit class PartialSideNavListPropsOps[Self <: PartialSideNavListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsUtility(value: Boolean): Self = this.set("isUtility", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnAuxClick(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = this.set("onAuxClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnContextMenu(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = this.set("onContextMenu", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnMouseMove(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = this.set("onMouseMove", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMouseMove: Self = this.set("onMouseMove", js.undefined)
    
    @scala.inline
    def setOnMouseOut(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = this.set("onMouseOut", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMouseOut: Self = this.set("onMouseOut", js.undefined)
    
    @scala.inline
    def setOnMouseOver(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = this.set("onMouseOver", js.Any.fromFunction1(value))
