...
object WeakValidationMapMenuItem {
  ...
  implicit class WeakValidationMapMenuItemOps[Self <: WeakValidationMapMenuItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddonProps(value: Validator[js.UndefOr[_ | Null]]): Self = this.set("addonProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUrlProps(value: Validator[js.UndefOr[_ | Null]]): Self = this.set("urlProps", value.asInstanceOf[js.Any])
