...
object WeakValidationMapMenuItem {
  ...
  implicit class WeakValidationMapMenuItemMutableBuilder[Self <: WeakValidationMapMenuItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddonProps(value: Validator[js.UndefOr[_ | Null]]): Self = StObject.set(x, "addonProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUrlProps(value: Validator[js.UndefOr[_ | Null]]): Self = StObject.set(x, "urlProps", value.asInstanceOf[js.Any])
