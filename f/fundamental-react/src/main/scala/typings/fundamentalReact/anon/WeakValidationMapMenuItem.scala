...
trait WeakValidationMapMenuItem extends StObject {
  ...
  var addonProps: js.UndefOr[Validator[js.UndefOr[Any | Null]]] = js.undefined
  ...
  var urlProps: js.UndefOr[Validator[js.UndefOr[Any | Null]]] = js.undefined
...
object WeakValidationMapMenuItem {
  ...
  extension [Self <: WeakValidationMapMenuItem](x: Self) {
    ...
    inline def setAddonProps(value: Validator[js.UndefOr[Any | Null]]): Self = StObject.set(x, "addonProps", value.asInstanceOf[js.Any])
    ...
    inline def setUrlProps(value: Validator[js.UndefOr[Any | Null]]): Self = StObject.set(x, "urlProps", value.asInstanceOf[js.Any])
