...
object WeakValidationMapLocaliza {
  ...
  implicit class WeakValidationMapLocalizaMutableBuilder[Self <: WeakValidationMapLocaliza] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setListProps(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "listProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPopoverProps(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "popoverProps", value.asInstanceOf[js.Any])
