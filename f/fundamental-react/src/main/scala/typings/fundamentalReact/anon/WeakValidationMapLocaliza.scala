...
trait WeakValidationMapLocaliza extends StObject {
  ...
  var listProps: js.UndefOr[Validator[js.UndefOr[Any | Null]]] = js.undefined
  ...
  var popoverProps: js.UndefOr[Validator[js.UndefOr[Any | Null]]] = js.undefined
...
object WeakValidationMapLocaliza {
  ...
  extension [Self <: WeakValidationMapLocaliza](x: Self) {
    ...
    inline def setListProps(value: Validator[js.UndefOr[Any | Null]]): Self = StObject.set(x, "listProps", value.asInstanceOf[js.Any])
    ...
    inline def setPopoverProps(value: Validator[js.UndefOr[Any | Null]]): Self = StObject.set(x, "popoverProps", value.asInstanceOf[js.Any])
