...
trait WeakValidationMapLocaliza extends StObject {
  ...
  var listProps: js.UndefOr[Validator[js.UndefOr[js.Any | Null]]] = js.undefined
  ...
  var popoverProps: js.UndefOr[Validator[js.UndefOr[js.Any | Null]]] = js.undefined
...
object WeakValidationMapLocaliza {
  ...
  extension [Self <: WeakValidationMapLocaliza](x: Self) {
    ...
    inline def setControl(value: Validator[js.UndefOr[ButtonProps | Null]]): Self = StObject.set(x, "control", value.asInstanceOf[js.Any])
    ...
    inline def setInputClassName(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "inputClassName", value.asInstanceOf[js.Any])
    ...
    inline def setListProps(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "listProps", value.asInstanceOf[js.Any])
    
    inline def setListPropsUndefined: Self = StObject.set(x, "listProps", js.undefined)
    
    inline def setMenu(value: Validator[js.UndefOr[js.Array[InputProps] | Null]]): Self = StObject.set(x, "menu", value.asInstanceOf[js.Any])
    ...
    inline def setPopoverProps(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "popoverProps", value.asInstanceOf[js.Any])
    ...
    inline def setTextarea(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "textarea", value.asInstanceOf[js.Any])
