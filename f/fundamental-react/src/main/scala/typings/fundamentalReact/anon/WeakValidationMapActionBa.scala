...
object WeakValidationMapActionBa {
  ...
  implicit class WeakValidationMapActionBaMutableBuilder[Self <: WeakValidationMapActionBa] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionProps(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "actionProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActionPropsUndefined: Self = StObject.set(x, "actionProps", js.undefined)
    
    @scala.inline
    def setActions(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDescriptionProps(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "descriptionProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHeadingLevel(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "headingLevel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBackClick(value: Validator[js.UndefOr[(js.Function1[/* repeated */ js.Any, js.Any]) | Null]]): Self = StObject.set(x, "onBackClick", value.asInstanceOf[js.Any])
