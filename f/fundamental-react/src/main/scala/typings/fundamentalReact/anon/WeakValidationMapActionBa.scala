...
object WeakValidationMapActionBa {
  ...
  extension [Self <: WeakValidationMapActionBa](x: Self) {
    ...
    inline def setActionClassName(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "actionClassName", value.asInstanceOf[js.Any])
    ...
    inline def setActions(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
    ...
    inline def setButtonContainerClassName(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "buttonContainerClassName", value.asInstanceOf[js.Any])
