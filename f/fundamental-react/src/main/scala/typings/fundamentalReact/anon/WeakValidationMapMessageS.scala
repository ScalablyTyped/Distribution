...
object WeakValidationMapMessageS {
  ...
  extension [Self <: WeakValidationMapMessageS](x: Self) {
    ...
    inline def setOnCloseClicked(value: Validator[js.UndefOr[(js.Function1[/* repeated */ js.Any, js.Any]) | Null]]): Self = StObject.set(x, "onCloseClicked", value.asInstanceOf[js.Any])
    
    inline def setOnCloseClickedUndefined: Self = StObject.set(x, "onCloseClicked", js.undefined)
    
    inline def setType(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
