...
object WeakValidationMapLayoutPa {
  ...
  @scala.inline
  def apply(): WeakValidationMapLayoutPa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapLayoutPa]
  }
  
  @scala.inline
  implicit class WeakValidationMapLayoutPaMutableBuilder[Self <: WeakValidationMapLayoutPa] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeadingStyle(value: Validator[js.UndefOr[`2` | `3` | `4` | `5` | `6` | Null]]): Self = StObject.set(x, "headingStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitle(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
