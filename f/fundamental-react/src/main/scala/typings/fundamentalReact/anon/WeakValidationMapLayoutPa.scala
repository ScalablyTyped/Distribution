...
trait WeakValidationMapLayoutPa extends StObject {
  ...
  var headingStyle: js.UndefOr[Validator[js.UndefOr[`2` | `3` | `4` | `5` | `6` | Null]]] = js.undefined
  ...
  var title: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
...
object WeakValidationMapLayoutPa {
  ...
  extension [Self <: WeakValidationMapLayoutPa](x: Self) {
    ...
    inline def setHeadingLevel(value: Validator[js.UndefOr[`2` | `3` | `4` | `5` | `6` | Null]]): Self = StObject.set(x, "headingLevel", value.asInstanceOf[js.Any])
    
    inline def setHeadingLevelUndefined: Self = StObject.set(x, "headingLevel", js.undefined)
    
    inline def setHeadingStyle(value: Validator[js.UndefOr[`2` | `3` | `4` | `5` | `6` | Null]]): Self = StObject.set(x, "headingStyle", value.asInstanceOf[js.Any])
    ...
    inline def setTitle(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
