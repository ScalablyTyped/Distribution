...
@js.native
trait WeakValidationMapLayoutPa extends js.Object {
...
object WeakValidationMapLayoutPa {
  ...
  @scala.inline
  implicit class WeakValidationMapLayoutPaOps[Self <: WeakValidationMapLayoutPa] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeadingStyle(value: Validator[js.UndefOr[`2` | `3` | `4` | `5` | `6` | Null]]): Self = this.set("headingStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitle(value: Validator[js.UndefOr[Boolean | Null]]): Self = this.set("title", value.asInstanceOf[js.Any])
