...
object WeakValidationMapSideNavLAbout {
  ...
  def apply(
    ...
    isSubItem: Validator[js.UndefOr[Boolean | Null]] = null,
  ...
  ): WeakValidationMapSideNavLAbout = {
    ...
    if (isSubItem != null) __obj.updateDynamic("isSubItem")(isSubItem.asInstanceOf[js.Any])
