...
object actionBarMod {
  ...
  object default {
    ...
    @scala.inline
    def displayName_=(x: js.UndefOr[ActionBar | String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  ...
  object ActionBarProps {
    ...
    @scala.inline
    def apply(title: String & js.UndefOr[String]): ActionBarProps = {
    ...
    implicit class ActionBarPropsMutableBuilder[Self <: ActionBarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnBackClick(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "onBackClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTitle(value: String & js.UndefOr[String]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
