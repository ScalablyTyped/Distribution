...
import typings.fontCarrier.fontfaceMod.FontFaceOptions
import typings.fontCarrier.glyphMod.GlyphOptions
...
object fontMod {
  ...
  @js.native
  trait Font
    extends typings.fontCarrier.baseMod.^[FontOptions] {
    
    /** 返回所有的字体对象集合 */
    def allGlyph(): Record[String, typings.fontCarrier.glyphMod.^] = js.native
    
    /** 将当前字体的所有字形清空 */
    def clean(): Font = js.native
    
    /** 获取对应的 fontface 对象 */
    def getFontface(): typings.fontCarrier.fontfaceMod.^ = js.native
    
    /** 获取指定文字（keys）的 glyph 对象, 如果是单个字就返回一个 glyph 对象，否则返回一个 hash 对象，key 是 unicode，value 是对应的 glyph 对象 */
    def getGlyph(keys: String): typings.fontCarrier.glyphMod.^ | (Record[String, typings.fontCarrier.glyphMod.^]) = js.native
    def getGlyph(keys: js.Array[String]): typings.fontCarrier.glyphMod.^ | (Record[String, typings.fontCarrier.glyphMod.^]) = js.native
    ...
    /** 设置对应的 fontface 对象 */
    def setFontface(fontFace: typings.fontCarrier.fontfaceMod.^): Unit = js.native
    
    /** 用于针对字设置对应的 glyph 对象 */
    def setGlyph(arg0: Record[String, typings.fontCarrier.glyphMod.^ | GlyphOptions]): Unit = js.native
    def setGlyph(key: String, value: GlyphOptions): Unit = js.native
    /** 用于针对字设置对应的 glyph 对象 */
    def setGlyph(key: String, value: typings.fontCarrier.glyphMod.^): Unit = js.native
