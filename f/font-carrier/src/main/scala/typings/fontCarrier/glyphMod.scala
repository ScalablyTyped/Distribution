...
object glyphMod {
  ...
  @js.native
  trait Glyph
    extends typings.fontCarrier.baseMod.^[GlyphOptions] {
    
    /**
      * 获取当前字形对应的字体对象
      */
    def getFont(): typings.fontCarrier.fontMod.^ = js.native
    
    /**
      * 设置当前 glyph 的字体，会按照新的字体做一系列的变换
      * @param font
      */
    def setFont(font: typings.fontCarrier.fontMod.^): Unit = js.native
