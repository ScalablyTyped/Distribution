...
object Key {
  @scala.inline
  def apply[/* <: / * keyof T * / java.lang.String */ K, T](key: K): Key[K, T] = {
    val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
    __obj.asInstanceOf[Key[K, T]]
  }
  @scala.inline
  implicit class KeyOps[Self <: Key[_, _], /* <: / * keyof T * / java.lang.String */ K, T] (val x: Self with (Key[K, T])) extends AnyVal {
    @scala.inline
