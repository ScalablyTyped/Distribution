...
object fuzzaldrinMod extends js.Object {
  ...
  def filter[T, K /* <: java.lang.String */](
    ...
    query: java.lang.String with (/* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(K))) */js.Any),
