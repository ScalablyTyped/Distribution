package typings
package atFeathersjsAuthenticationLib.authenticationMod.AuthHooksNs
...
trait Hooks extends js.Object {
  def authenticate(strategies: java.lang.String): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  def authenticate(strategies: js.Array[java.lang.String]): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           ...
           *
           */
  def hashPassword(): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           * The `hashPassword` hook will automatically hash the data coming in on the provided passwordField.
           * It is intended to be used as a before hook on the user service for the create, update, or patch methods.
           *
           */
  def hashPassword(options: HashPassOptions): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           ...
           *
           */
  def populateUser(): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           * The populateUser hook is for populating a user based on an id.
           * It can be used on any service method as either a before or after hook.
           * It is called internally after a token is created.
           *
           */
  def populateUser(options: js.Any): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           ...
           *
           */
  def restrictToAuthenticated(): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           ...
           *
           */
  def restrictToOwner(): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           * `restrictToOwner` is meant to be used as a before hook.
           * It only allows the user to retrieve resources that are owned by them.
           * It will return a *Forbidden* error without the proper permissions.
           ...
           *
           */
  def restrictToOwner(options: RestrictOptions): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           ...
           *
           */
  def verifyToken(): atFeathersjsFeathersLib.feathersMod.Hook = js.native
  /**
           * The `verifyToken` hook will attempt to verify a token.
           * If the token is missing or is invalid it returns an error.
           * If the token is valid it adds the decrypted payload to hook.params.payload which contains the user id.
           ...
           *
           */
  def verifyToken(options: js.Any): atFeathersjsFeathersLib.feathersMod.Hook = js.native
}
