...
object firebaseRemoteConfigMod {
  ...
  inline def getRemoteConfig(app: js.UndefOr[FirebaseApp]): typings.firebaseRemoteConfig.mod.RemoteConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("getRemoteConfig")(app.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseRemoteConfig.mod.RemoteConfig]
