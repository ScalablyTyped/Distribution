...
object LayersPanel {
  ...
  @scala.inline
  implicit class LayersPanelMutableBuilder[Self <: LayersPanel] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBuild(value: () => Unit): Self = StObject.set(x, "build", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCreateNode(value: (js.Object, HTMLElement) => Unit): Self = StObject.set(x, "createNode", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnImageClick(value: (js.Object, Event) => Unit): Self = StObject.set(x, "onImageClick", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setSetLayerVisible(value: (js.Object, Boolean) => Unit): Self = StObject.set(x, "setLayerVisible", js.Any.fromFunction2(value))
    
    @scala.inline
    def setShouldInclude(value: js.Object => Boolean): Self = StObject.set(x, "shouldInclude", js.Any.fromFunction1(value))
