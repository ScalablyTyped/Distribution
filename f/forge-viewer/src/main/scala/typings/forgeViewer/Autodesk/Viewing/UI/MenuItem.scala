...
object MenuItem {
  ...
  @scala.inline
  def apply(target: () => Unit | js.Array[MenuItem], title: String): MenuItem = {
  ...
  implicit class MenuItemMutableBuilder[Self <: MenuItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTarget(value: () => Unit | js.Array[MenuItem]): Self = StObject.set(x, "target", js.Any.fromFunction0(value))
