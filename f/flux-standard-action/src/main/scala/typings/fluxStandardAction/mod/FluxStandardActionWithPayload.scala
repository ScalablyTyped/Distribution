...
object FluxStandardActionWithPayload {
  ...
  @scala.inline
  implicit class FluxStandardActionWithPayloadOps[Self <: FluxStandardActionWithPayload[_, _, _], Type /* <: String */, Payload, Meta] (val x: Self with (FluxStandardActionWithPayload[Type, Payload, Meta])) extends AnyVal {
