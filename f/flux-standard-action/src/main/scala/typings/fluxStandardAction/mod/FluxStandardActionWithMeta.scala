...
object FluxStandardActionWithMeta {
  @scala.inline
  def apply[/* <: java.lang.String */ Type, Payload, Meta](meta: Meta, `type`: Type): FluxStandardActionWithMeta[Type, Payload, Meta] = {
    val __obj = js.Dynamic.literal(meta = meta.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[FluxStandardActionWithMeta[Type, Payload, Meta]]
  }
  @scala.inline
  implicit class FluxStandardActionWithMetaOps[Self <: FluxStandardActionWithMeta[_, _, _], /* <: java.lang.String */ Type, Payload, Meta] (val x: Self with (FluxStandardActionWithMeta[Type, Payload, Meta])) extends AnyVal {
    @scala.inline
