...
object mod {
  ...
  @scala.inline
  def apply(): F1 = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[F1]
  @scala.inline
  def apply(settings: F1Options): F1 = ^.asInstanceOf[js.Dynamic].apply(settings.asInstanceOf[js.Any]).asInstanceOf[F1]
  ...
  object F1Options {
    ...
    @scala.inline
    def apply(name: String, parsers: js.Any, states: js.Any, targets: js.Any, transitions: js.Array[js.Any]): F1Options = {
    ...
    implicit class F1OptionsMutableBuilder[Self <: F1Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTransitions(value: js.Array[js.Any]): Self = StObject.set(x, "transitions", value.asInstanceOf[js.Any])
