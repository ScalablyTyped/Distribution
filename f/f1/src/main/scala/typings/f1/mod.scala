...
object mod {
  ...
  trait F1
    ...
    def transitions(transitions: js.Array[js.Any]): F1 = js.native
  ...
  trait F1Options extends StObject {
    ...
    var transitions: js.Array[js.Any]
  }
  object F1Options {
    
    inline def apply(name: String, parsers: js.Any, states: js.Any, targets: js.Any, transitions: js.Array[js.Any]): F1Options = {
    ...
    extension [Self <: F1Options](x: Self) {
      ...
      inline def setOnState(value: /* repeated */ js.Any => Unit): Self = StObject.set(x, "onState", js.Any.fromFunction1(value))
      ...
      inline def setParsers(value: js.Any): Self = StObject.set(x, "parsers", value.asInstanceOf[js.Any])
      
      inline def setStates(value: js.Any): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
      
      inline def setTargets(value: js.Any): Self = StObject.set(x, "targets", value.asInstanceOf[js.Any])
      
      inline def setTransitions(value: js.Array[js.Any]): Self = StObject.set(x, "transitions", value.asInstanceOf[js.Any])
      
      inline def setTransitionsVarargs(value: js.Any*): Self = StObject.set(x, "transitions", js.Array(value :_*))
    }
  }
}
