...
import typings.fuseDotJs.Anon_Name
import typings.fuseDotJs.Anon_Score
...
trait FuseOptions[T] extends js.Object {
  ...
  var sortFn: js.UndefOr[js.Function2[/* a */ Anon_Score, /* b */ Anon_Score, Double]] = js.undefined
...
object FuseOptions {
  ...
  def apply[T](
    ...
    sortFn: (/* a */ Anon_Score, /* b */ Anon_Score) => Double = null,
