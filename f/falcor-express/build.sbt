...
name := "falcor-express"
version := "0.1.2-dt-20201002Z-3a409b"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "falcor" % "2.0-dt-20200515Z-fc4228",
  "org.scalablytyped" %%% "falcor-http-datasource" % "0.1.3-dt-20201002Z-2b6069",
  "org.scalablytyped" %%% "falcor-json-graph" % "1.1.7-dt-20201002Z-ab5e86",
