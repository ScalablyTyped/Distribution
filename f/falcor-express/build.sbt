...
name := "falcor-express"
version := "0.1.2-dt-20180214Z-71c3f2"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "falcor" % "0.1-dt-20180214Z-6405ab",
  "org.scalablytyped" %%% "falcor-http-datasource" % "0.1.3-dt-20180214Z-54c578",
  "org.scalablytyped" %%% "falcor-json-graph" % "1.1.7-dt-20180214Z-a1b665",
