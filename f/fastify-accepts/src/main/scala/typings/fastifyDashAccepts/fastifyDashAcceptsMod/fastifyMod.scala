...
import typings.fastifyDashAccepts.fastifyDashAcceptsBooleans.`false`
...
@js.native
object fastifyMod extends js.Object {
  @js.native
  ...
  trait FastifyRequest[HttpRequest] extends js.Object {
    @JSName("charset")
    var charset_Original: Fn_Charsets = js.native
    @JSName("charsets")
    var charsets_Original: Fn_Charsets = js.native
    @JSName("encoding")
    var encoding_Original: Fn_Encodings = js.native
    @JSName("encodings")
    var encodings_Original: Fn_Charsets = js.native
    @JSName("language")
    var language_Original: Fn_False = js.native
    @JSName("languages")
    var languages_Original: Fn_False = js.native
    @JSName("type")
    var type_Original: Fn_FalseTypes = js.native
    @JSName("types")
    var types_Original: Fn_FalseTypes = js.native
