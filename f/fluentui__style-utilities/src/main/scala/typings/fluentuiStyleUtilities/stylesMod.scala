...
import typings.fluentuiStyleUtilities.fluentuiStyleUtilitiesStrings.border
import typings.fluentuiStyleUtilities.fluentuiStyleUtilitiesStrings.borderBottom
...
object stylesMod {
  ...
  @JSImport("@fluentui/style-utilities/lib/styles", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "AnimationStyles")
  @js.native
  val AnimationStyles: IAnimationStyles = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "AnimationVariables")
  @js.native
  val AnimationVariables: IAnimationVariables = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "DefaultEffects")
  @js.native
  val DefaultEffects: IEffects = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "DefaultFontStyles")
  @js.native
  val DefaultFontStyles: IFontStyles = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "DefaultPalette")
  @js.native
  val DefaultPalette: IPalette = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "EdgeChromiumHighContrastSelector")
  @js.native
  ...
  object FontSizes {
    ...
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.icon")
    @js.native
    val icon: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.large")
    @js.native
    val large: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.medium")
    @js.native
    val medium: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.mediumPlus")
    @js.native
    val mediumPlus: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.mega")
    @js.native
    val mega: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.mini")
    @js.native
    val mini: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size10")
    @js.native
    val size10: /* "10px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size12")
    @js.native
    val size12: /* "12px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size14")
    @js.native
    val size14: /* "14px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size16")
    @js.native
    val size16: /* "16px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size18")
    @js.native
    val size18: /* "18px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size20")
    @js.native
    val size20: /* "20px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size24")
    @js.native
    val size24: /* "24px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size28")
    @js.native
    val size28: /* "28px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size32")
    @js.native
    val size32: /* "32px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size42")
    @js.native
    val size42: /* "42px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.size68")
    @js.native
    val size68: /* "68px" */ String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.small")
    @js.native
    val small: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.smallPlus")
    @js.native
    val smallPlus: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.superLarge")
    @js.native
    val superLarge: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.xLarge")
    @js.native
    val xLarge: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.xLargePlus")
    @js.native
    val xLargePlus: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.xSmall")
    @js.native
    val xSmall: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.xxLarge")
    @js.native
    val xxLarge: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontSizes.xxLargePlus")
    @js.native
  ...
  object FontWeights {
    ...
    @JSImport("@fluentui/style-utilities/lib/styles", "FontWeights.bold")
    @js.native
    val bold: IFontWeight = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontWeights.light")
    @js.native
    val light: IFontWeight = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontWeights.regular")
    @js.native
    val regular: IFontWeight = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontWeights.semibold")
    @js.native
    val semibold: IFontWeight = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "FontWeights.semilight")
    @js.native
    val semilight: IFontWeight = js.native
  }
  
  @JSImport("@fluentui/style-utilities/lib/styles", "HighContrastSelector")
  @js.native
  val HighContrastSelector: /* "@media screen and (-ms-high-contrast: active), screen and (forced-colors: active)" */ String = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "HighContrastSelectorBlack")
  @js.native
  ...
  @JSImport("@fluentui/style-utilities/lib/styles", "HighContrastSelectorWhite")
  @js.native
  ...
  object IconFontSizes {
    ...
    @JSImport("@fluentui/style-utilities/lib/styles", "IconFontSizes.large")
    @js.native
    val large: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "IconFontSizes.medium")
    @js.native
    val medium: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "IconFontSizes.small")
    @js.native
    val small: String = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "IconFontSizes.xSmall")
    @js.native
    val xSmall: String = js.native
  }
  ...
  object PulsingBeaconAnimationStyles {
    ...
    @JSImport("@fluentui/style-utilities/lib/styles", "PulsingBeaconAnimationStyles")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "PulsingBeaconAnimationStyles.continuousPulseAnimationDouble")
    @js.native
    ...
    @JSImport("@fluentui/style-utilities/lib/styles", "PulsingBeaconAnimationStyles.continuousPulseAnimationSingle")
    @js.native
    ...
    @JSImport("@fluentui/style-utilities/lib/styles", "PulsingBeaconAnimationStyles.createDefaultAnimation")
    @js.native
  ...
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMaxLarge")
  @js.native
  val ScreenWidthMaxLarge: Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMaxMedium")
  @js.native
  val ScreenWidthMaxMedium: Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMaxSmall")
  @js.native
  val ScreenWidthMaxSmall: Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMaxXLarge")
  @js.native
  val ScreenWidthMaxXLarge: Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMaxXXLarge")
  @js.native
  val ScreenWidthMaxXXLarge: Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMinLarge")
  @js.native
  val ScreenWidthMinLarge: /* 640 */ Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMinMedium")
  @js.native
  val ScreenWidthMinMedium: /* 480 */ Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMinSmall")
  @js.native
  val ScreenWidthMinSmall: /* 320 */ Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMinUhfMobile")
  @js.native
  val ScreenWidthMinUhfMobile: /* 768 */ Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMinXLarge")
  @js.native
  val ScreenWidthMinXLarge: /* 1024 */ Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMinXXLarge")
  @js.native
  val ScreenWidthMinXXLarge: /* 1366 */ Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ScreenWidthMinXXXLarge")
  @js.native
  val ScreenWidthMinXXXLarge: /* 1920 */ Double = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "ThemeSettingName")
  @js.native
  val ThemeSettingName: /* "theme" */ String = js.native
  
  object ZIndexes {
    
    @JSImport("@fluentui/style-utilities/lib/styles", "ZIndexes.Coachmark")
    @js.native
    val Coachmark: Double = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "ZIndexes.FocusStyle")
    @js.native
    val FocusStyle: Double = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "ZIndexes.KeytipLayer")
    @js.native
    val KeytipLayer: Double = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "ZIndexes.Layer")
    @js.native
    val Layer: Double = js.native
    
    @JSImport("@fluentui/style-utilities/lib/styles", "ZIndexes.Nav")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@fluentui/style-utilities/lib/styles", "ZIndexes.ScrollablePane")
    @js.native
  ...
  @JSImport("@fluentui/style-utilities/lib/styles", "hiddenContentStyle")
  @js.native
  ...
  @JSImport("@fluentui/style-utilities/lib/styles", "noWrap")
  @js.native
  val noWrap: IRawStyle = js.native
  
  @JSImport("@fluentui/style-utilities/lib/styles", "normalize")
  @js.native
