...
import typings.fluentuiStyleUtilities.fluentuiStyleUtilitiesNumbers.`0`
import typings.fluentuiStyleUtilities.fluentuiStyleUtilitiesNumbers.`1`
import typings.fluentuiStyleUtilities.fluentuiStyleUtilitiesNumbers.`2`
...
object mergeStylesMod {
  ...
  @JSImport("@fluentui/style-utilities/lib/MergeStyles", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object InjectionMode {
    
    @JSImport("@fluentui/style-utilities/lib/MergeStyles", "InjectionMode")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      */
    @JSImport("@fluentui/style-utilities/lib/MergeStyles", "InjectionMode.appendChild")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@fluentui/style-utilities/lib/MergeStyles", "InjectionMode.insertNode")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@fluentui/style-utilities/lib/MergeStyles", "InjectionMode.none")
    @js.native
    def none: `0` = js.native
    inline def none_=(x: `0`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("none")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("@fluentui/style-utilities/lib/MergeStyles", "Stylesheet")
  @js.native
  open class Stylesheet ()
    extends typings.fluentuiMergeStyles.mod.Stylesheet {
