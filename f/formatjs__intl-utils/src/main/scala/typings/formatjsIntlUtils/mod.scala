...
object mod extends js.Object {
  ...
  def selectUnit(from: Double): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Double, to: Double): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Double, to: Double, thresholds: PartialThresholds): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Double, to: Date): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Double, to: Date, thresholds: PartialThresholds): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Date): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Date, to: Double): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Date, to: Double, thresholds: PartialThresholds): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Date, to: Date): typings.formatjsIntlUtils.anon.Unit = js.native
  def selectUnit(from: Date, to: Date, thresholds: PartialThresholds): typings.formatjsIntlUtils.anon.Unit = js.native
