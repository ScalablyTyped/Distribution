package typings.formatjsIntlUtils.srcRelativeTimeTypesMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Inlined {[ f in @formatjs/intl-utils.@formatjs/intl-utils/src/relative-time-types.RelativeTimeField ]:? @formatjs/intl-utils.@formatjs/intl-utils/src/relative-time-types.FieldData} & {  nu :std.Array<string | null> | undefined} */
@js.native
