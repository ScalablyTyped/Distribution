...
import typings.formatjsIntlUtils.anon.LongRecordDecimalFormatNumLDM10000
...
trait RawNumberData extends js.Object {
  ...
  var decimal: Record[NumberingSystem, LongRecordDecimalFormatNumLDM10000] = js.native
...
object RawNumberData {
  ...
  def apply(
    ...
    decimal: Record[NumberingSystem, LongRecordDecimalFormatNumLDM10000],
    nu: js.Array[String],
  ...
  implicit class RawNumberDataOps[Self <: RawNumberData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDecimal(value: Record[NumberingSystem, LongRecordDecimalFormatNumLDM10000]): Self = this.set("decimal", value.asInstanceOf[js.Any])
    @scala.inline
