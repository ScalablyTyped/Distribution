...
trait DisplayNamesData extends js.Object {
  /**
    ...
    */
  var patterns: typings.formatjsIntlUtils.anon.Locale = js.native
  /**
...
object DisplayNamesData {
  @scala.inline
  def apply(patterns: typings.formatjsIntlUtils.anon.Locale, types: Currency): DisplayNamesData = {
  ...
  implicit class DisplayNamesDataOps[Self <: DisplayNamesData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPatterns(value: typings.formatjsIntlUtils.anon.Locale): Self = this.set("patterns", value.asInstanceOf[js.Any])
    @scala.inline
