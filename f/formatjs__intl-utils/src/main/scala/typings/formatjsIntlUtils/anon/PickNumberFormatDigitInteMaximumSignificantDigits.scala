...
/* Inlined std.Pick<@formatjs/intl-utils.@formatjs/intl-utils/lib/src/number-types.NumberFormatDigitInternalSlots, 'roundingType' | 'minimumSignificantDigits' | 'maximumSignificantDigits' | 'minimumIntegerDigits' | 'minimumFractionDigits' | 'maximumFractionDigits'> */
@js.native
trait PickNumberFormatDigitInteMaximumSignificantDigits extends js.Object {
...
object PickNumberFormatDigitInteMaximumSignificantDigits {
  @scala.inline
  def apply(minimumIntegerDigits: Double, roundingType: NumberFormatRoundingType): PickNumberFormatDigitInteMaximumSignificantDigits = {
    ...
    __obj.asInstanceOf[PickNumberFormatDigitInteMaximumSignificantDigits]
  }
  @scala.inline
  implicit class PickNumberFormatDigitInteMaximumSignificantDigitsOps[Self <: PickNumberFormatDigitInteMaximumSignificantDigits] (val x: Self) extends AnyVal {
    @scala.inline
