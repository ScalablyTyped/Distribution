...
import typings.formatjsIntlUtils.srcDisplaynamesTypesMod.CurrencyCode
...
@js.native
trait LongRecordNarrowRecordShortRecord extends js.Object {
...
object LongRecordNarrowRecordShortRecord {
  ...
  @scala.inline
  implicit class LongRecordNarrowRecordShortRecordOps[Self <: LongRecordNarrowRecordShortRecord] (val x: Self) extends AnyVal {
    @scala.inline
