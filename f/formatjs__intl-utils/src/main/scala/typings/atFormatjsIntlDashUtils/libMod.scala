...
import typings.atFormatjsIntlDashUtils.libResolveDashLocaleMod.ResolveLocaleResult
...
object libMod extends js.Object {
  ...
  def isMissingLocaleDataError(e: Error): /* is @formatjs/intl-utils.@formatjs/intl-utils/lib/resolve-locale.MissingLocaleDataError */ Boolean = js.native
