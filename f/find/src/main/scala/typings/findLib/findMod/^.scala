...
object ^ extends js.Object {
  ...
  ): findLib.findMod.AsyncFindStream = js.native
  def dir(
  ...
  ): findLib.findMod.FindEachStream = js.native
  def eachdir(
    pattern: stdLib.RegExp,
    root: java.lang.String,
    callback: js.Function1[/* directory */ java.lang.String, scala.Unit]
  ): findLib.findMod.FindEachStream = js.native
  def eachdir(root: java.lang.String, callback: js.Function1[/* directory */ java.lang.String, scala.Unit]): findLib.findMod.FindEachStream = js.native
  def eachfile(
    pattern: java.lang.String,
    root: java.lang.String,
  ...
  def eachfile(root: java.lang.String, callback: js.Function1[/* file */ java.lang.String, scala.Unit]): findLib.findMod.FindEachStream = js.native
  def file(
    pattern: java.lang.String,
    root: java.lang.String,
  ...
  def file(root: java.lang.String, callback: js.Function1[/* files */ js.Array[java.lang.String], scala.Unit]): findLib.findMod.AsyncFindStream = js.native
