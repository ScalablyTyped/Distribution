...
object mod extends js.Object {
  ...
  def apply(`type`: name, value: RegExp): js.Promise[js.Array[Cmd]] = js.native
  def apply(`type`: name, value: RegExp, strict: Boolean): js.Promise[js.Array[Cmd]] = js.native
  ...
  def apply(`type`: pid, value: RegExp): js.Promise[js.Array[Cmd]] = js.native
  def apply(`type`: pid, value: RegExp, strict: Boolean): js.Promise[js.Array[Cmd]] = js.native
  ...
  def apply(`type`: port, value: RegExp): js.Promise[js.Array[Cmd]] = js.native
  def apply(`type`: port, value: RegExp, strict: Boolean): js.Promise[js.Array[Cmd]] = js.native
}
