...
trait AbideOptions extends js.Object {
  ...
  var live_validate: js.UndefOr[scala.Boolean] = js.undefined
  var patterns: js.UndefOr[AbidePatterns] = js.undefined
  var timeout: js.UndefOr[scala.Double] = js.undefined
  var validate_on_blur: js.UndefOr[scala.Boolean] = js.undefined
...
object AbideOptions {
  @scala.inline
  def apply(
    error_labels: js.UndefOr[scala.Boolean] = js.undefined,
    focus_on_invalid: js.UndefOr[scala.Boolean] = js.undefined,
    live_validate: js.UndefOr[scala.Boolean] = js.undefined,
    patterns: AbidePatterns = null,
    timeout: scala.Int | scala.Double = null,
    validate_on_blur: js.UndefOr[scala.Boolean] = js.undefined,
