...
trait EqualizerOptions extends js.Object {
  var equalize_on_stack: js.UndefOr[scala.Boolean] = js.undefined
  var use_tallest: js.UndefOr[scala.Boolean] = js.undefined
}

object EqualizerOptions {
  @scala.inline
  def apply(
    equalize_on_stack: js.UndefOr[scala.Boolean] = js.undefined,
    use_tallest: js.UndefOr[scala.Boolean] = js.undefined
  ): EqualizerOptions = {
