...
trait FFProbeStream extends StObject {
  ...
  var side_data_list: js.UndefOr[js.Array[SideData]] = js.undefined
...
object FFProbeStream {
  ...
  implicit open class MutableBuilder[Self <: FFProbeStream] (val x: Self) extends AnyVal {
    ...
    inline def setSide_data_list(value: js.Array[SideData]): Self = StObject.set(x, "side_data_list", value.asInstanceOf[js.Any])
    
    inline def setSide_data_listUndefined: Self = StObject.set(x, "side_data_list", js.undefined)
    
    inline def setSide_data_listVarargs(value: SideData*): Self = StObject.set(x, "side_data_list", js.Array(value*))
