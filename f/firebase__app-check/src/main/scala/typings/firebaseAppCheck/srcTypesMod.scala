...
import typings.firebaseAppCheck.srcPublicTypesMod.AppCheckToken
import typings.firebaseAppCheck.srcPublicTypesMod.AppCheckTokenListener
...
object srcTypesMod {
  ...
  trait AppCheckTokenObserver
    ...
    @JSName("next")
    def next_MAppCheckTokenObserver(token: typings.firebaseAppCheck.srcPublicTypesMod.AppCheckTokenResult): Unit
    @JSName("next")
  ...
  object AppCheckTokenObserver {
    ...
    inline def apply(
      next: /* token */ typings.firebaseAppCheck.srcPublicTypesMod.AppCheckTokenResult => Unit,
      `type`: ListenerType
    ...
    extension [Self <: AppCheckTokenObserver](x: Self) {
      ...
      inline def setNext(value: /* token */ typings.firebaseAppCheck.srcPublicTypesMod.AppCheckTokenResult => Unit): Self = StObject.set(x, "next", js.Any.fromFunction1(value))
