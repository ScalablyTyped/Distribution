...
object distSrcApiMod {
  ...
  open class CustomProvider protected ()
    extends typings.firebaseAppCheck.distSrcProvidersMod.CustomProvider {
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends typings.firebaseAppCheck.distSrcProvidersMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends typings.firebaseAppCheck.distSrcProvidersMod.ReCaptchaV3Provider {
    /**
