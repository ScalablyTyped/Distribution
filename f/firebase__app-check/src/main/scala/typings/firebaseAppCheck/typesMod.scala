...
import typings.firebaseAppCheck.publicTypesMod.AppCheckToken
import typings.firebaseAppCheck.publicTypesMod.AppCheckTokenListener
...
object typesMod {
  ...
  trait AppCheckTokenObserver
    ...
    @JSName("next")
    def next_MAppCheckTokenObserver(token: typings.firebaseAppCheck.publicTypesMod.AppCheckTokenResult): Unit
    @JSName("next")
  ...
  object AppCheckTokenObserver {
    ...
    inline def apply(
      next: /* token */ typings.firebaseAppCheck.publicTypesMod.AppCheckTokenResult => Unit,
      `type`: ListenerType
    ...
    extension [Self <: AppCheckTokenObserver](x: Self) {
      ...
      inline def setNext(value: /* token */ typings.firebaseAppCheck.publicTypesMod.AppCheckTokenResult => Unit): Self = StObject.set(x, "next", js.Any.fromFunction1(value))
