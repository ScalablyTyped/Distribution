...
object srcMod {
  ...
  open class CustomProvider protected ()
    extends typings.firebaseAppCheck.apiMod.CustomProvider {
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends typings.firebaseAppCheck.apiMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends typings.firebaseAppCheck.apiMod.ReCaptchaV3Provider {
    /**
