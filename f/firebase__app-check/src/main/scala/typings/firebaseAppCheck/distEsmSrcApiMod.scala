...
object distEsmSrcApiMod {
  ...
  open class CustomProvider protected ()
    extends typings.firebaseAppCheck.distEsmSrcProvidersMod.CustomProvider {
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends typings.firebaseAppCheck.distEsmSrcProvidersMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends typings.firebaseAppCheck.distEsmSrcProvidersMod.ReCaptchaV3Provider {
    /**
