...
object distSrcConstantsMod {
  ...
  @JSImport("@firebase/app-check/dist/src/constants", "BASE_ENDPOINT")
  @js.native
  val BASE_ENDPOINT: /* "https://content-firebaseappcheck.googleapis.com/v1" */ String = js.native
  
  @JSImport("@firebase/app-check/dist/src/constants", "EXCHANGE_DEBUG_TOKEN_METHOD")
  @js.native
  val EXCHANGE_DEBUG_TOKEN_METHOD: /* "exchangeDebugToken" */ String = js.native
  
  @JSImport("@firebase/app-check/dist/src/constants", "EXCHANGE_RECAPTCHA_ENTERPRISE_TOKEN_METHOD")
  @js.native
  val EXCHANGE_RECAPTCHA_ENTERPRISE_TOKEN_METHOD: /* "exchangeRecaptchaEnterpriseToken" */ String = js.native
  
  @JSImport("@firebase/app-check/dist/src/constants", "EXCHANGE_RECAPTCHA_TOKEN_METHOD")
  @js.native
  val EXCHANGE_RECAPTCHA_TOKEN_METHOD: /* "exchangeRecaptchaV3Token" */ String = js.native
  
  @JSImport("@firebase/app-check/dist/src/constants", "ONE_DAY")
  @js.native
  val ONE_DAY: Double = js.native
  
  object TOKEN_REFRESH_TIME {
    
    @JSImport("@firebase/app-check/dist/src/constants", "TOKEN_REFRESH_TIME")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/app-check/dist/src/constants", "TOKEN_REFRESH_TIME.OFFSET_DURATION")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/app-check/dist/src/constants", "TOKEN_REFRESH_TIME.RETRIAL_MAX_WAIT")
    @js.native
    ...
    /**
      ...
      * 30 seconds.
      */
    @JSImport("@firebase/app-check/dist/src/constants", "TOKEN_REFRESH_TIME.RETRIAL_MIN_WAIT")
    @js.native
