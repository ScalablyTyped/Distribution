...
object srcApiMod {
  ...
  open class CustomProvider protected ()
    extends typings.firebaseAppCheck.srcProvidersMod.CustomProvider {
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends typings.firebaseAppCheck.srcProvidersMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends typings.firebaseAppCheck.srcProvidersMod.ReCaptchaV3Provider {
    /**
