...
import typings.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckToken
...
object distEsmSrcTypesMod {
  ...
  trait AppCheckTokenObserver
    ...
    @JSName("next")
    def next_MAppCheckTokenObserver(token: typings.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult): Unit
    @JSName("next")
  ...
  object AppCheckTokenObserver {
    ...
    inline def apply(
      next: /* token */ typings.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult => Unit,
      `type`: ListenerType
    ...
    implicit open class MutableBuilder[Self <: AppCheckTokenObserver] (val x: Self) extends AnyVal {
      ...
      inline def setNext(value: /* token */ typings.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult => Unit): Self = StObject.set(x, "next", js.Any.fromFunction1(value))
