...
class FineUploader ()
  ...
  /**
    ...
    */
  def addExtraDropzone(element: stdLib.HTMLElement): scala.Unit = js.native
  /**
    ...
    */
  def getDropTarget(id: scala.Double): stdLib.HTMLElement = js.native
  /**
    ...
    */
  def getId(element: stdLib.HTMLElement): scala.Double = js.native
  /**
    ...
    */
  def getItemByFileId(id: scala.Double): stdLib.HTMLElement = js.native
  /**
    * Used to un-mark an `element` as a drop zone
    *
    * @param HTMLElement element : The element to un-mark as a drop zone
    */
  def removeExtraDropzone(element: stdLib.HTMLElement): scala.Unit = js.native
}
