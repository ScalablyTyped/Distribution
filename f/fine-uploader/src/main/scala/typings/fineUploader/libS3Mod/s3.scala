package typings.fineUploader.libS3Mod

import typings.fineUploader.libCoreMod.ChunkingOptions
import typings.fineUploader.libCoreMod.CoreEvents
import typings.fineUploader.libCoreMod.CoreOptions
import typings.fineUploader.libCoreMod.CorsOptions
import typings.fineUploader.libCoreMod.PromiseOptions
import typings.fineUploader.libCoreMod.RequestOptions
import typings.fineUploader.libCoreMod.ResumableFileObject
...
object s3 {
  ...
  open class FineUploaderBasic ()
    extends typings.fineUploader.libCoreMod.FineUploaderBasic {
