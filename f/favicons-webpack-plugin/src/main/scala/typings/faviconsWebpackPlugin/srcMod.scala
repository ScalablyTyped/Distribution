...
import typings.faviconsWebpackPlugin.srcOptionsMod.FaviconWebpackPlugionInternalOptions
import typings.faviconsWebpackPlugin.srcOptionsMod.FaviconWebpackPlugionOptions
