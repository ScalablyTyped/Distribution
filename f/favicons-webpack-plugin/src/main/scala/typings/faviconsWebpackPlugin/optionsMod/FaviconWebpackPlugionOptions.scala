...
@js.native
trait FaviconWebpackPlugionOptions extends js.Object {
...
object FaviconWebpackPlugionOptions {
  ...
  @scala.inline
  implicit class FaviconWebpackPlugionOptionsOps[Self <: FaviconWebpackPlugionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInjectFunction1(value: /* htmlWebpackPlugin */ js.Any => Boolean): Self = this.set("inject", js.Any.fromFunction1(value))
    
    @scala.inline
    def setInject(value: Boolean | (js.Function1[/* htmlWebpackPlugin */ js.Any, Boolean])): Self = this.set("inject", value.asInstanceOf[js.Any])
