...
object Bankcode {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(account_number = account_number.asInstanceOf[js.Any], amount = amount.asInstanceOf[js.Any], approver = approver.asInstanceOf[js.Any], bank_code = bank_code.asInstanceOf[js.Any], bank_name = bank_name.asInstanceOf[js.Any], complete_message = complete_message.asInstanceOf[js.Any], currency = currency.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], fee = fee.asInstanceOf[js.Any], fullname = fullname.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], is_approved = is_approved.asInstanceOf[js.Any], narration = narration.asInstanceOf[js.Any], requires_approval = requires_approval.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[Bankcode]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Bankcode] (val x: Self) extends AnyVal {
    
    inline def setAccount_number(value: String): Self = StObject.set(x, "account_number", value.asInstanceOf[js.Any])
    
    inline def setAmount(value: Double): Self = StObject.set(x, "amount", value.asInstanceOf[js.Any])
    
    inline def setApprover(value: Any): Self = StObject.set(x, "approver", value.asInstanceOf[js.Any])
