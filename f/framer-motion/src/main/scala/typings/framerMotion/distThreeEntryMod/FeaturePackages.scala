...
/* Inlined {[ K in keyof framer-motion.framer-motion/dist/three-entry.HydratedFeatureDefinitions ]: framer-motion.framer-motion/dist/three-entry.FeaturePackage} */
