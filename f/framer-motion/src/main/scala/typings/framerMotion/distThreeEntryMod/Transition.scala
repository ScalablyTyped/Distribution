...
import typings.framerMotion.framerMotionStrings.spring
import typings.framerMotion.framerMotionStrings.tween
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined parent framer-motion.framer-motion/dist/three-entry.AnimationPlaybackOptions */
/* Inlined parent std.Omit<framer-motion.framer-motion/dist/three-entry.SpringOptions, 'keyframes'> */
/* Inlined parent std.Omit<framer-motion.framer-motion/dist/three-entry.InertiaOptions$1, 'keyframes'> */
/* Inlined parent framer-motion.framer-motion/dist/three-entry.KeyframeOptions */
trait Transition extends StObject {
  ...
  var `type`: js.UndefOr[decay | spring | keyframes | tween | inertia] = js.undefined
...
object Transition {
  ...
  implicit open class MutableBuilder[Self <: Transition] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: decay | spring | keyframes | tween | inertia): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
