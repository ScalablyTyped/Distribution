...
import typings.framerMotion.anon.MotionPropsvisualElementVAnimate
...
trait HydratedFeatureDefinition extends StObject {
  ...
  var MeasureLayout: js.UndefOr[js.Function1[/* props */ MotionPropsvisualElementVAnimate, Element]] = js.undefined
...
object HydratedFeatureDefinition {
  ...
  implicit open class MutableBuilder[Self <: HydratedFeatureDefinition] (val x: Self) extends AnyVal {
    ...
    inline def setMeasureLayout(value: /* props */ MotionPropsvisualElementVAnimate => Element): Self = StObject.set(x, "MeasureLayout", js.Any.fromFunction1(value))
