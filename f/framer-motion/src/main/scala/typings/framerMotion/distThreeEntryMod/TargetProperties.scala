...
/* Inlined framer-motion.framer-motion/dist/three-entry.CSSPropertiesWithoutTransitionOrSingleTransforms & react.react.SVGAttributes<std.SVGElement> & framer-motion.framer-motion/dist/three-entry.SVGTransformAttributes & framer-motion.framer-motion/dist/three-entry.TransformProperties & framer-motion.framer-motion/dist/three-entry.CustomStyles & framer-motion.framer-motion/dist/three-entry.SVGPathProperties */
...
object TargetProperties {
  ...
  inline def apply(): TargetProperties = {
