...
/**
  ...
  */
@js.native
trait MotionValue[V] extends StObject {
  ...
  def on[EventName /* <: /* keyof framer-motion.framer-motion/dist/three-entry.MotionValueEventCallbacks<V> */ animationStart_ | animationComplete_ | animationCancel | change | renderRequest | velocityChange */](
    eventName: EventName,
    callback: /* import warning: importer.ImportType#apply Failed type conversion: framer-motion.framer-motion/dist/three-entry.MotionValueEventCallbacks<V>[EventName] */ js.Any
