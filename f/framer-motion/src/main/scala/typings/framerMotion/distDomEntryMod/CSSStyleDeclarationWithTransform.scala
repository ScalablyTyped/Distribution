...
/* Inlined parent std.Omit<std.CSSStyleDeclaration, 'direction' | 'transition'> */
trait CSSStyleDeclarationWithTransform extends StObject {
  ...
  var getPropertyPriority: js.Function1[/* property */ String, String]
  
  var getPropertyValue: js.Function1[/* property */ String, String]
  ...
  var item: js.Function1[/* index */ Double, String]
  ...
  var removeProperty: js.Function1[/* property */ String, String]
  ...
  var rotateX: Double | String
  
  var rotateY: Double | String
  
  var rotateZ: Double | String
  ...
  var setProperty: js.Function1[/* property */ String, Unit]
  ...
  var skewX: Double | String
  
  var skewY: Double | String
...
object CSSStyleDeclarationWithTransform {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(accentColor = accentColor.asInstanceOf[js.Any], alignContent = alignContent.asInstanceOf[js.Any], alignItems = alignItems.asInstanceOf[js.Any], alignSelf = alignSelf.asInstanceOf[js.Any], alignmentBaseline = alignmentBaseline.asInstanceOf[js.Any], all = all.asInstanceOf[js.Any], animation = animation.asInstanceOf[js.Any], animationDelay = animationDelay.asInstanceOf[js.Any], animationDirection = animationDirection.asInstanceOf[js.Any], animationDuration = animationDuration.asInstanceOf[js.Any], animationFillMode = animationFillMode.asInstanceOf[js.Any], animationIterationCount = animationIterationCount.asInstanceOf[js.Any], animationName = animationName.asInstanceOf[js.Any], animationPlayState = animationPlayState.asInstanceOf[js.Any], animationTimingFunction = animationTimingFunction.asInstanceOf[js.Any], appearance = appearance.asInstanceOf[js.Any], aspectRatio = aspectRatio.asInstanceOf[js.Any], backdropFilter = backdropFilter.asInstanceOf[js.Any], backfaceVisibility = backfaceVisibility.asInstanceOf[js.Any], background = background.asInstanceOf[js.Any], backgroundAttachment = backgroundAttachment.asInstanceOf[js.Any], backgroundBlendMode = backgroundBlendMode.asInstanceOf[js.Any], backgroundClip = backgroundClip.asInstanceOf[js.Any], backgroundColor = backgroundColor.asInstanceOf[js.Any], backgroundImage = backgroundImage.asInstanceOf[js.Any], backgroundOrigin = backgroundOrigin.asInstanceOf[js.Any], backgroundPosition = backgroundPosition.asInstanceOf[js.Any], backgroundPositionX = backgroundPositionX.asInstanceOf[js.Any], backgroundPositionY = backgroundPositionY.asInstanceOf[js.Any], backgroundRepeat = backgroundRepeat.asInstanceOf[js.Any], backgroundSize = backgroundSize.asInstanceOf[js.Any], baselineShift = baselineShift.asInstanceOf[js.Any], blockSize = blockSize.asInstanceOf[js.Any], border = border.asInstanceOf[js.Any], borderBlock = borderBlock.asInstanceOf[js.Any], borderBlockColor = borderBlockColor.asInstanceOf[js.Any], borderBlockEnd = borderBlockEnd.asInstanceOf[js.Any], borderBlockEndColor = borderBlockEndColor.asInstanceOf[js.Any], borderBlockEndStyle = borderBlockEndStyle.asInstanceOf[js.Any], borderBlockEndWidth = borderBlockEndWidth.asInstanceOf[js.Any], borderBlockStart = borderBlockStart.asInstanceOf[js.Any], borderBlockStartColor = borderBlockStartColor.asInstanceOf[js.Any], borderBlockStartStyle = borderBlockStartStyle.asInstanceOf[js.Any], borderBlockStartWidth = borderBlockStartWidth.asInstanceOf[js.Any], borderBlockStyle = borderBlockStyle.asInstanceOf[js.Any], borderBlockWidth = borderBlockWidth.asInstanceOf[js.Any], borderBottom = borderBottom.asInstanceOf[js.Any], borderBottomColor = borderBottomColor.asInstanceOf[js.Any], borderBottomLeftRadius = borderBottomLeftRadius.asInstanceOf[js.Any], borderBottomRightRadius = borderBottomRightRadius.asInstanceOf[js.Any], borderBottomStyle = borderBottomStyle.asInstanceOf[js.Any], borderBottomWidth = borderBottomWidth.asInstanceOf[js.Any], borderCollapse = borderCollapse.asInstanceOf[js.Any], borderColor = borderColor.asInstanceOf[js.Any], borderEndEndRadius = borderEndEndRadius.asInstanceOf[js.Any], borderEndStartRadius = borderEndStartRadius.asInstanceOf[js.Any], borderImage = borderImage.asInstanceOf[js.Any], borderImageOutset = borderImageOutset.asInstanceOf[js.Any], borderImageRepeat = borderImageRepeat.asInstanceOf[js.Any], borderImageSlice = borderImageSlice.asInstanceOf[js.Any], borderImageSource = borderImageSource.asInstanceOf[js.Any], borderImageWidth = borderImageWidth.asInstanceOf[js.Any], borderInline = borderInline.asInstanceOf[js.Any], borderInlineColor = borderInlineColor.asInstanceOf[js.Any], borderInlineEnd = borderInlineEnd.asInstanceOf[js.Any], borderInlineEndColor = borderInlineEndColor.asInstanceOf[js.Any], borderInlineEndStyle = borderInlineEndStyle.asInstanceOf[js.Any], borderInlineEndWidth = borderInlineEndWidth.asInstanceOf[js.Any], borderInlineStart = borderInlineStart.asInstanceOf[js.Any], borderInlineStartColor = borderInlineStartColor.asInstanceOf[js.Any], borderInlineStartStyle = borderInlineStartStyle.asInstanceOf[js.Any], borderInlineStartWidth = borderInlineStartWidth.asInstanceOf[js.Any], borderInlineStyle = borderInlineStyle.asInstanceOf[js.Any], borderInlineWidth = borderInlineWidth.asInstanceOf[js.Any], borderLeft = borderLeft.asInstanceOf[js.Any], borderLeftColor = borderLeftColor.asInstanceOf[js.Any], borderLeftStyle = borderLeftStyle.asInstanceOf[js.Any], borderLeftWidth = borderLeftWidth.asInstanceOf[js.Any], borderRadius = borderRadius.asInstanceOf[js.Any], borderRight = borderRight.asInstanceOf[js.Any], borderRightColor = borderRightColor.asInstanceOf[js.Any], borderRightStyle = borderRightStyle.asInstanceOf[js.Any], borderRightWidth = borderRightWidth.asInstanceOf[js.Any], borderSpacing = borderSpacing.asInstanceOf[js.Any], borderStartEndRadius = borderStartEndRadius.asInstanceOf[js.Any], borderStartStartRadius = borderStartStartRadius.asInstanceOf[js.Any], borderStyle = borderStyle.asInstanceOf[js.Any], borderTop = borderTop.asInstanceOf[js.Any], borderTopColor = borderTopColor.asInstanceOf[js.Any], borderTopLeftRadius = borderTopLeftRadius.asInstanceOf[js.Any], borderTopRightRadius = borderTopRightRadius.asInstanceOf[js.Any], borderTopStyle = borderTopStyle.asInstanceOf[js.Any], borderTopWidth = borderTopWidth.asInstanceOf[js.Any], borderWidth = borderWidth.asInstanceOf[js.Any], bottom = bottom.asInstanceOf[js.Any], boxShadow = boxShadow.asInstanceOf[js.Any], boxSizing = boxSizing.asInstanceOf[js.Any], breakAfter = breakAfter.asInstanceOf[js.Any], breakBefore = breakBefore.asInstanceOf[js.Any], breakInside = breakInside.asInstanceOf[js.Any], captionSide = captionSide.asInstanceOf[js.Any], caretColor = caretColor.asInstanceOf[js.Any], clear = clear.asInstanceOf[js.Any], clip = clip.asInstanceOf[js.Any], clipPath = clipPath.asInstanceOf[js.Any], clipRule = clipRule.asInstanceOf[js.Any], color = color.asInstanceOf[js.Any], colorInterpolation = colorInterpolation.asInstanceOf[js.Any], colorInterpolationFilters = colorInterpolationFilters.asInstanceOf[js.Any], colorScheme = colorScheme.asInstanceOf[js.Any], columnCount = columnCount.asInstanceOf[js.Any], columnFill = columnFill.asInstanceOf[js.Any], columnGap = columnGap.asInstanceOf[js.Any], columnRule = columnRule.asInstanceOf[js.Any], columnRuleColor = columnRuleColor.asInstanceOf[js.Any], columnRuleStyle = columnRuleStyle.asInstanceOf[js.Any], columnRuleWidth = columnRuleWidth.asInstanceOf[js.Any], columnSpan = columnSpan.asInstanceOf[js.Any], columnWidth = columnWidth.asInstanceOf[js.Any], columns = columns.asInstanceOf[js.Any], contain = contain.asInstanceOf[js.Any], containIntrinsicBlockSize = containIntrinsicBlockSize.asInstanceOf[js.Any], containIntrinsicHeight = containIntrinsicHeight.asInstanceOf[js.Any], containIntrinsicInlineSize = containIntrinsicInlineSize.asInstanceOf[js.Any], containIntrinsicSize = containIntrinsicSize.asInstanceOf[js.Any], containIntrinsicWidth = containIntrinsicWidth.asInstanceOf[js.Any], container = container.asInstanceOf[js.Any], containerName = containerName.asInstanceOf[js.Any], containerType = containerType.asInstanceOf[js.Any], content = content.asInstanceOf[js.Any], contentVisibility = contentVisibility.asInstanceOf[js.Any], counterIncrement = counterIncrement.asInstanceOf[js.Any], counterReset = counterReset.asInstanceOf[js.Any], counterSet = counterSet.asInstanceOf[js.Any], cssFloat = cssFloat.asInstanceOf[js.Any], cssText = cssText.asInstanceOf[js.Any], cursor = cursor.asInstanceOf[js.Any], display = display.asInstanceOf[js.Any], dominantBaseline = dominantBaseline.asInstanceOf[js.Any], emptyCells = emptyCells.asInstanceOf[js.Any], fill = fill.asInstanceOf[js.Any], fillOpacity = fillOpacity.asInstanceOf[js.Any], fillRule = fillRule.asInstanceOf[js.Any], filter = filter.asInstanceOf[js.Any], flex = flex.asInstanceOf[js.Any], flexBasis = flexBasis.asInstanceOf[js.Any], flexDirection = flexDirection.asInstanceOf[js.Any], flexFlow = flexFlow.asInstanceOf[js.Any], flexGrow = flexGrow.asInstanceOf[js.Any], flexShrink = flexShrink.asInstanceOf[js.Any], flexWrap = flexWrap.asInstanceOf[js.Any], float = float.asInstanceOf[js.Any], floodColor = floodColor.asInstanceOf[js.Any], floodOpacity = floodOpacity.asInstanceOf[js.Any], font = font.asInstanceOf[js.Any], fontFamily = fontFamily.asInstanceOf[js.Any], fontFeatureSettings = fontFeatureSettings.asInstanceOf[js.Any], fontKerning = fontKerning.asInstanceOf[js.Any], fontOpticalSizing = fontOpticalSizing.asInstanceOf[js.Any], fontPalette = fontPalette.asInstanceOf[js.Any], fontSize = fontSize.asInstanceOf[js.Any], fontSizeAdjust = fontSizeAdjust.asInstanceOf[js.Any], fontStretch = fontStretch.asInstanceOf[js.Any], fontStyle = fontStyle.asInstanceOf[js.Any], fontSynthesis = fontSynthesis.asInstanceOf[js.Any], fontVariant = fontVariant.asInstanceOf[js.Any], fontVariantAlternates = fontVariantAlternates.asInstanceOf[js.Any], fontVariantCaps = fontVariantCaps.asInstanceOf[js.Any], fontVariantEastAsian = fontVariantEastAsian.asInstanceOf[js.Any], fontVariantLigatures = fontVariantLigatures.asInstanceOf[js.Any], fontVariantNumeric = fontVariantNumeric.asInstanceOf[js.Any], fontVariantPosition = fontVariantPosition.asInstanceOf[js.Any], fontVariationSettings = fontVariationSettings.asInstanceOf[js.Any], fontWeight = fontWeight.asInstanceOf[js.Any], gap = gap.asInstanceOf[js.Any], getPropertyPriority = js.Any.fromFunction1(getPropertyPriority), getPropertyValue = js.Any.fromFunction1(getPropertyValue), grid = grid.asInstanceOf[js.Any], gridArea = gridArea.asInstanceOf[js.Any], gridAutoColumns = gridAutoColumns.asInstanceOf[js.Any], gridAutoFlow = gridAutoFlow.asInstanceOf[js.Any], gridAutoRows = gridAutoRows.asInstanceOf[js.Any], gridColumn = gridColumn.asInstanceOf[js.Any], gridColumnEnd = gridColumnEnd.asInstanceOf[js.Any], gridColumnGap = gridColumnGap.asInstanceOf[js.Any], gridColumnStart = gridColumnStart.asInstanceOf[js.Any], gridGap = gridGap.asInstanceOf[js.Any], gridRow = gridRow.asInstanceOf[js.Any], gridRowEnd = gridRowEnd.asInstanceOf[js.Any], gridRowGap = gridRowGap.asInstanceOf[js.Any], gridRowStart = gridRowStart.asInstanceOf[js.Any], gridTemplate = gridTemplate.asInstanceOf[js.Any], gridTemplateAreas = gridTemplateAreas.asInstanceOf[js.Any], gridTemplateColumns = gridTemplateColumns.asInstanceOf[js.Any], gridTemplateRows = gridTemplateRows.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], hyphenateCharacter = hyphenateCharacter.asInstanceOf[js.Any], hyphens = hyphens.asInstanceOf[js.Any], imageOrientation = imageOrientation.asInstanceOf[js.Any], imageRendering = imageRendering.asInstanceOf[js.Any], inlineSize = inlineSize.asInstanceOf[js.Any], inset = inset.asInstanceOf[js.Any], insetBlock = insetBlock.asInstanceOf[js.Any], insetBlockEnd = insetBlockEnd.asInstanceOf[js.Any], insetBlockStart = insetBlockStart.asInstanceOf[js.Any], insetInline = insetInline.asInstanceOf[js.Any], insetInlineEnd = insetInlineEnd.asInstanceOf[js.Any], insetInlineStart = insetInlineStart.asInstanceOf[js.Any], isolation = isolation.asInstanceOf[js.Any], item = js.Any.fromFunction1(item), justifyContent = justifyContent.asInstanceOf[js.Any], justifyItems = justifyItems.asInstanceOf[js.Any], justifySelf = justifySelf.asInstanceOf[js.Any], left = left.asInstanceOf[js.Any], length = length.asInstanceOf[js.Any], letterSpacing = letterSpacing.asInstanceOf[js.Any], lightingColor = lightingColor.asInstanceOf[js.Any], lineBreak = lineBreak.asInstanceOf[js.Any], lineHeight = lineHeight.asInstanceOf[js.Any], listStyle = listStyle.asInstanceOf[js.Any], listStyleImage = listStyleImage.asInstanceOf[js.Any], listStylePosition = listStylePosition.asInstanceOf[js.Any], listStyleType = listStyleType.asInstanceOf[js.Any], margin = margin.asInstanceOf[js.Any], marginBlock = marginBlock.asInstanceOf[js.Any], marginBlockEnd = marginBlockEnd.asInstanceOf[js.Any], marginBlockStart = marginBlockStart.asInstanceOf[js.Any], marginBottom = marginBottom.asInstanceOf[js.Any], marginInline = marginInline.asInstanceOf[js.Any], marginInlineEnd = marginInlineEnd.asInstanceOf[js.Any], marginInlineStart = marginInlineStart.asInstanceOf[js.Any], marginLeft = marginLeft.asInstanceOf[js.Any], marginRight = marginRight.asInstanceOf[js.Any], marginTop = marginTop.asInstanceOf[js.Any], marker = marker.asInstanceOf[js.Any], markerEnd = markerEnd.asInstanceOf[js.Any], markerMid = markerMid.asInstanceOf[js.Any], markerStart = markerStart.asInstanceOf[js.Any], mask = mask.asInstanceOf[js.Any], maskClip = maskClip.asInstanceOf[js.Any], maskComposite = maskComposite.asInstanceOf[js.Any], maskImage = maskImage.asInstanceOf[js.Any], maskMode = maskMode.asInstanceOf[js.Any], maskOrigin = maskOrigin.asInstanceOf[js.Any], maskPosition = maskPosition.asInstanceOf[js.Any], maskRepeat = maskRepeat.asInstanceOf[js.Any], maskSize = maskSize.asInstanceOf[js.Any], maskType = maskType.asInstanceOf[js.Any], mathStyle = mathStyle.asInstanceOf[js.Any], maxBlockSize = maxBlockSize.asInstanceOf[js.Any], maxHeight = maxHeight.asInstanceOf[js.Any], maxInlineSize = maxInlineSize.asInstanceOf[js.Any], maxWidth = maxWidth.asInstanceOf[js.Any], minBlockSize = minBlockSize.asInstanceOf[js.Any])
    __obj.asInstanceOf[CSSStyleDeclarationWithTransform]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSStyleDeclarationWithTransform] (val x: Self) extends AnyVal {
    ...
    inline def setRotateX(value: Double | String): Self = StObject.set(x, "rotateX", value.asInstanceOf[js.Any])
    
    inline def setRotateY(value: Double | String): Self = StObject.set(x, "rotateY", value.asInstanceOf[js.Any])
    
    inline def setRotateZ(value: Double | String): Self = StObject.set(x, "rotateZ", value.asInstanceOf[js.Any])
    ...
    inline def setSkewX(value: Double | String): Self = StObject.set(x, "skewX", value.asInstanceOf[js.Any])
    
    inline def setSkewY(value: Double | String): Self = StObject.set(x, "skewY", value.asInstanceOf[js.Any])
