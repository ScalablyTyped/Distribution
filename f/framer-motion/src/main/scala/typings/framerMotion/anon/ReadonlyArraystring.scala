...
trait ReadonlyArraystring extends StObject {
  ...
  val flat: js.ThisFunction0[
    /* this */ Any, 
    js.Array[FlatArray[Any, typings.framerMotion.framerMotionInts.`1`]]
  ]
...
object ReadonlyArraystring {
  ...
  inline def apply(
    ...
    findLastIndex: /* predicate */ js.Function3[/* value */ String, /* index */ Double, /* array */ js.Array[String], Any] => Double,
  ...
  implicit open class MutableBuilder[Self <: ReadonlyArraystring] (val x: Self) extends AnyVal {
    ...
    inline def setFindLastIndex(
      value: /* predicate */ js.Function3[/* value */ String, /* index */ Double, /* array */ js.Array[String], Any] => Double
