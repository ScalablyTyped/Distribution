...
import typings.framerMotion.distThreeEntryMod.AnimationControls
import typings.framerMotion.distThreeEntryMod.AnimationDefinition
import typings.framerMotion.distThreeEntryMod.BoundingBox
import typings.framerMotion.distThreeEntryMod.Box
import typings.framerMotion.distThreeEntryMod.DragControls
import typings.framerMotion.distThreeEntryMod.DragElastic
import typings.framerMotion.distThreeEntryMod.EventInfo
import typings.framerMotion.distThreeEntryMod.InertiaOptions
import typings.framerMotion.distThreeEntryMod.MotionStyle
import typings.framerMotion.distThreeEntryMod.MotionValue
import typings.framerMotion.distThreeEntryMod.PanInfo
import typings.framerMotion.distThreeEntryMod.RefObject
import typings.framerMotion.distThreeEntryMod.ResolvedValues
import typings.framerMotion.distThreeEntryMod.TapInfo
import typings.framerMotion.distThreeEntryMod.Target
import typings.framerMotion.distThreeEntryMod.TargetAndTransition
import typings.framerMotion.distThreeEntryMod.TransformProperties
import typings.framerMotion.distThreeEntryMod.Transition1
import typings.framerMotion.distThreeEntryMod.VariantLabels
import typings.framerMotion.distThreeEntryMod.Variants
import typings.framerMotion.distThreeEntryMod.ViewportEventHandler
import typings.framerMotion.distThreeEntryMod.ViewportOptions
import typings.framerMotion.distThreeEntryMod.VisualElement
...
/* Inlined framer-motion.framer-motion/dist/three-entry.MotionProps & {  visualElement :framer-motion.framer-motion/dist/three-entry.VisualElement<unknown, unknown, {}>} */
trait MotionPropsvisualElementVAnimate extends StObject {
  ...
  /**
    ...
    * @public
    */
  var _dragX: js.UndefOr[MotionValue[Double]] = js.undefined
  ...
  /**
    ...
    * @public
    */
  var _dragY: js.UndefOr[MotionValue[Double]] = js.undefined
  ...
  /**
    ...
    * ```
    */
  var dragTransition: js.UndefOr[InertiaOptions] = js.undefined
...
object MotionPropsvisualElementVAnimate {
  
  inline def apply(visualElement: VisualElement[Any, Any, js.Object]): MotionPropsvisualElementVAnimate = {
    val __obj = js.Dynamic.literal(visualElement = visualElement.asInstanceOf[js.Any])
    __obj.asInstanceOf[MotionPropsvisualElementVAnimate]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MotionPropsvisualElementVAnimate] (val x: Self) extends AnyVal {
    ...
    inline def setDragTransition(value: InertiaOptions): Self = StObject.set(x, "dragTransition", value.asInstanceOf[js.Any])
    ...
    inline def set_dragX(value: MotionValue[Double]): Self = StObject.set(x, "_dragX", value.asInstanceOf[js.Any])
    
    inline def set_dragXUndefined: Self = StObject.set(x, "_dragX", js.undefined)
    
    inline def set_dragY(value: MotionValue[Double]): Self = StObject.set(x, "_dragY", value.asInstanceOf[js.Any])
