...
import typings.framerMotion.mod.VisualElement
...
/* Inlined framer-motion.framer-motion.MotionProps & {  visualElement :framer-motion.framer-motion.VisualElement<unknown, unknown, {}>} */
trait MotionPropsvisualElementV extends StObject {
  ...
  var visualElement: VisualElement[Any, Any, js.Object]
...
object MotionPropsvisualElementV {
  
  inline def apply(visualElement: VisualElement[Any, Any, js.Object]): MotionPropsvisualElementV = {
    val __obj = js.Dynamic.literal(visualElement = visualElement.asInstanceOf[js.Any])
    __obj.asInstanceOf[MotionPropsvisualElementV]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MotionPropsvisualElementV] (val x: Self) extends AnyVal {
