...
import typings.framerMotion.distThreeEntryMod.Point
import typings.framerMotion.distThreeEntryMod.ReducedMotionConfig
...
import typings.framerMotion.distThreeEntryMod.TransformPoint
...
/* Inlined framer-motion.framer-motion/dist/three-entry.MotionProps & std.Partial<framer-motion.framer-motion/dist/three-entry.MotionConfigContext> */
trait MotionPropsPartialMotionCAnimate extends StObject {
...
object MotionPropsPartialMotionCAnimate {
  
  inline def apply(): MotionPropsPartialMotionCAnimate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MotionPropsPartialMotionCAnimate]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MotionPropsPartialMotionCAnimate] (val x: Self) extends AnyVal {
