...
import typings.framerMotion.anon.`0`
...
object Owner {
  ...
  inline def apply(current: HTMLElement | Any, getProps: () => `0`): Owner = {
  ...
  implicit open class MutableBuilder[Self <: Owner] (val x: Self) extends AnyVal {
    ...
    inline def setGetProps(value: () => `0`): Self = StObject.set(x, "getProps", js.Any.fromFunction0(value))
  }
}
