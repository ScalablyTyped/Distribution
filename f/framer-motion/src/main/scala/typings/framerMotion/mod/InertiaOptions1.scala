...
object InertiaOptions1 {
  
  inline def apply(): InertiaOptions1 = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InertiaOptions1]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InertiaOptions1] (val x: Self) extends AnyVal {
