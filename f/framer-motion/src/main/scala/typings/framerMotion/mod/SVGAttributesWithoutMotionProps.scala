...
/* Inlined parent std.Pick<react.react.SVGAttributes<T>, std.Exclude<keyof react.react.SVGAttributes<T>, keyof framer-motion.framer-motion.MotionProps>> */
trait SVGAttributesWithoutMotionProps[T] extends StObject {
...
object SVGAttributesWithoutMotionProps {
  
  inline def apply[T](): SVGAttributesWithoutMotionProps[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGAttributesWithoutMotionProps[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SVGAttributesWithoutMotionProps[?], T] (val x: Self & SVGAttributesWithoutMotionProps[T]) extends AnyVal {
