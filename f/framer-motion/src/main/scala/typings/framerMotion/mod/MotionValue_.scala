...
/**
  ...
  * @public
  */
@JSImport("framer-motion", "MotionValue")
@js.native
open class MotionValue_[V] () extends StObject {
  ...
  def on[EventName /* <: /* keyof framer-motion.framer-motion.MotionValueEventCallbacks<V> */ animationStart_ | animationComplete_ | animationCancel | change | renderRequest | velocityChange */](
    eventName: EventName,
