...
import typings.framerMotion.anon.MotionPropsPartialMotionC
...
/**
  ...
  */
/* note: abstract class */ @JSImport("framer-motion", "VisualElement")
@js.native
open class VisualElement[Instance, RenderState, Options /* <: js.Object */] protected () extends StObject {
  def this(param0: VisualElementOptions[Instance, RenderState]) = this()
  def this(param0: VisualElementOptions[Instance, RenderState], options: Options) = this()
  
  /**
    * Add a motion value and bind it to this visual element.
    */
  def addValue(key: String, value: MotionValue_[Any]): Unit = js.native
  ...
  /**
    ...
    */
  var animationState: js.UndefOr[AnimationState1] = js.native
  ...
  /**
    ...
    */
  def getBaseTargetFromProps(props: MotionProps, key: String): js.UndefOr[String | Double | MotionValue_[Any]] = js.native
  ...
  /**
    ...
    */
  def getValue(key: String): js.UndefOr[MotionValue_[Any]] = js.native
  def getValue(key: String, defaultValue: String): MotionValue_[Any] = js.native
  def getValue(key: String, defaultValue: Double): MotionValue_[Any] = js.native
  ...
  /**
    ...
    */
  def measureInstanceViewportBox(instance: Instance, props: MotionPropsPartialMotionC): Box = js.native
  ...
  def notify[EventName /* <: /* keyof framer-motion.framer-motion.VisualElementEventCallbacks */ BeforeLayoutMeasure | LayoutMeasure | LayoutUpdate | typings.framerMotion.framerMotionStrings.Update | AnimationStart | AnimationComplete | LayoutAnimationStart | LayoutAnimationComplete | SetAxisTarget | Unmount */](
    eventName: EventName,
  ...
  def on[EventName /* <: /* keyof framer-motion.framer-motion.VisualElementEventCallbacks */ BeforeLayoutMeasure | LayoutMeasure | LayoutUpdate | typings.framerMotion.framerMotionStrings.Update | AnimationStart | AnimationComplete | LayoutAnimationStart | LayoutAnimationComplete | SetAxisTarget | Unmount */](
    eventName: EventName,
    callback: /* import warning: importer.ImportType#apply Failed type conversion: framer-motion.framer-motion.VisualElementEventCallbacks[EventName] */ js.Any
  ...
  /**
    ...
    * intended to be one.
    */
  def scrapeMotionValuesFromProps(_props: MotionProps, _prevProps: MotionProps): StringDictionary[MotionValue_[Any] | String | Double] = js.native
  ...
  /**
    ...
    */
  var values: Map[String, MotionValue_[Any]] = js.native
