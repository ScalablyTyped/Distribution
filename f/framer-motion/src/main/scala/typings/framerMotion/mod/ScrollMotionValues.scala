...
/**
  * @public
  */
trait ScrollMotionValues extends StObject {
...
object ScrollMotionValues {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ScrollMotionValues]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ScrollMotionValues] (val x: Self) extends AnyVal {
