...
/* Inlined parent std.Omit<framer-motion.framer-motion.InViewOptions, 'root' | 'amount'> */
trait Options extends StObject {
  ...
  var root: js.UndefOr[typings.react.mod.RefObject[Element]] = js.undefined
}
object Options {
  ...
  implicit open class MutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
    ...
    inline def setRoot(value: typings.react.mod.RefObject[Element]): Self = StObject.set(x, "root", value.asInstanceOf[js.Any])
