...
trait SequenceOptions
  ...
  var defaultTransition: js.UndefOr[Transition1] = js.undefined
...
object SequenceOptions {
  ...
  implicit open class MutableBuilder[Self <: SequenceOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDefaultTransition(value: Transition1): Self = StObject.set(x, "defaultTransition", value.asInstanceOf[js.Any])
