...
object FastifyError {
  ...
  @scala.inline
  implicit class FastifyErrorOps[Self <: FastifyError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidationVarargs(value: ValidationResult*): Self = this.set("validation", js.Array(value :_*))
    
    @scala.inline
    def setValidation(value: js.Array[ValidationResult]): Self = this.set("validation", value.asInstanceOf[js.Any])
