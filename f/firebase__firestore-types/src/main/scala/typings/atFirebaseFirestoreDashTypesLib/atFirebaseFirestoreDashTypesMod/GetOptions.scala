...
trait GetOptions extends js.Object {
  ...
  val source: js.UndefOr[
    atFirebaseFirestoreDashTypesLib.atFirebaseFirestoreDashTypesLibStrings.default | atFirebaseFirestoreDashTypesLib.atFirebaseFirestoreDashTypesLibStrings.server | atFirebaseFirestoreDashTypesLib.atFirebaseFirestoreDashTypesLibStrings.cache
  ] = js.undefined
}
