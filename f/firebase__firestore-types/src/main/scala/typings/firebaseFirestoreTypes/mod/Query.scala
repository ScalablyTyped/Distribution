...
import typings.firebaseFirestoreTypes.AnonCompleteErrorNextSnapshot
...
class Query[T] protected () extends js.Object {
  ...
  def onSnapshot(observer: AnonCompleteErrorNextSnapshot[T]): js.Function0[Unit] = js.native
  ...
  def onSnapshot(options: SnapshotListenOptions, observer: AnonCompleteErrorNextSnapshot[T]): js.Function0[Unit] = js.native
