...
object FieldConfig {
  ...
  implicit class FieldConfigOps[Self <: FieldConfig[_], V] (val x: Self with FieldConfig[V]) extends AnyVal {
    ...
    @scala.inline
    def setAs(value: (ComponentType[FieldInputProps[V] | js.Object]) | String | ForwardRefExoticComponent[_]): Self = this.set("as", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAs: Self = this.set("as", js.undefined)
    
    @scala.inline
    def setChildrenFunction1(value: /* props */ FieldProps[V, _] => ReactNode): Self = this.set("children", js.Any.fromFunction1(value))
    
    @scala.inline
    def setChildren(value: (js.Function1[/* props */ FieldProps[V, _], ReactNode]) | ReactNode): Self = this.set("children", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteChildren: Self = this.set("children", js.undefined)
    
    @scala.inline
    def setComponent(value: String | (ComponentType[(FieldProps[V, _]) | js.Object]) | ForwardRefExoticComponent[_]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRender(value: /* props */ FieldProps[V, _] => ReactNode): Self = this.set("render", js.Any.fromFunction1(value))
