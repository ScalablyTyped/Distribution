...
import typings.atFirebaseDatabase.distSrcCoreAuthTokenProviderMod.AuthTokenProvider
...
import typings.atFirebaseDatabase.distSrcRealtimeConnectionMod.Connection
