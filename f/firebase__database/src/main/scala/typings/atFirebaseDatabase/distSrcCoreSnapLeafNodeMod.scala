...
import typings.atFirebaseDatabase.distSrcCoreSnapChildrenNodeMod.ChildrenNodeConstructor
...
@js.native
object distSrcCoreSnapLeafNodeMod extends js.Object {
  @js.native
  class LeafNode protected () extends Node {
    ...
    /**
      ...
      */
    def getValue(): js.Object | String | Double | Boolean = js.native
    /**
      * @inheritDoc
      */
