...
import typings.atFirebaseDatabase.distSrcCoreUtilPathMod.ValidationPath
...
@js.native
object distSrcCoreUtilValidationMod extends js.Object {
  ...
  def validateUrl(fnName: String, argumentNumber: Double, parsedUrl: Anon_PathRepoInfo): Unit = js.native
