...
import typings.atFirebaseDatabase.distSrcRealtimeTransportMod.TransportConstructor
...
@js.native
object distSrcRealtimeTransportManagerMod extends js.Object {
  @js.native
  ...
  object TransportManager extends js.Object {
    /**
      ...
      */
    val ALL_TRANSPORTS: js.Array[TypeofClassBrowserPollConnection | TypeofClassWebSocketConnection] = js.native
  }
