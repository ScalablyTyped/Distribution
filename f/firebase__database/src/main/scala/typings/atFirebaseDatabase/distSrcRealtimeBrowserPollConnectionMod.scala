...
import typings.atFirebaseDatabase.distSrcRealtimeBrowserPollConnectionMod.FirebaseIFrameScriptHolder
import typings.atFirebaseDatabase.distSrcRealtimeBrowserPollConnectionMod.IFrameElement
