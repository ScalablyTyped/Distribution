...
import typings.firebaseDatabase.snapIndexMapMod.IndexMap
...
import typings.firebaseDatabase.utilSortedMapMod.SortedMapIterator
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object snapChildrenNodeMod {
  ...
  object firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod {
    ...
    trait NamedNode extends StObject {
      ...
      var MAX: typings.firebaseDatabase.snapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
      
      var MIN: typings.firebaseDatabase.snapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
    }
    object NamedNode {
      
      inline def apply(
        MAX: typings.firebaseDatabase.snapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode,
        MIN: typings.firebaseDatabase.snapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
      ): typings.firebaseDatabase.snapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = {
        val __obj = js.Dynamic.literal(MAX = MAX.asInstanceOf[js.Any], MIN = MIN.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.firebaseDatabase.snapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode]
      }
      
      extension [Self <: typings.firebaseDatabase.snapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode](x: Self) {
        
        inline def setMAX(
          value: typings.firebaseDatabase.snapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
