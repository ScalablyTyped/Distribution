...
object completeChildSourceMod {
  ...
  @JSImport("@firebase/database/dist/node-esm/src/core/view/CompleteChildSource", "NO_COMPLETE_CHILD_SOURCE")
  @js.native
  val NO_COMPLETE_CHILD_SOURCE: NoCompleteChildSource = js.native
  
  @JSImport("@firebase/database/dist/node-esm/src/core/view/CompleteChildSource", "NoCompleteChildSource_")
  @js.native
  ...
  @JSImport("@firebase/database/dist/node-esm/src/core/view/CompleteChildSource", "WriteTreeCompleteChildSource")
  @js.native
