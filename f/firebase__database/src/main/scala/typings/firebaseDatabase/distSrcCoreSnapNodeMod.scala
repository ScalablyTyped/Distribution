...
object distSrcCoreSnapNodeMod {
  ...
  open class NamedNode protected () extends StObject {
    ...
    var MAX: typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
    
    var MIN: typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
