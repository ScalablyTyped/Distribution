...
object pathMod {
  ...
  @JSImport("@firebase/database/dist/node-esm/src/core/util/Path", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/database/dist/node-esm/src/core/util/Path", "Path")
  @js.native
  ...
  @JSImport("@firebase/database/dist/node-esm/src/core/util/Path", "ValidationPath")
  @js.native
