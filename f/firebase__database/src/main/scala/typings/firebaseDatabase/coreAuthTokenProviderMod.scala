...
object coreAuthTokenProviderMod {
  ...
  open class FirebaseAuthTokenProvider protected ()
    ...
    def this(
      ...
      authProvider_ : /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<FirebaseAuthInternalName> */ Any
    ) = this()
