...
import typings.firebaseDatabase.distSrcCoreSnapIndexMapMod.IndexMap
...
import typings.firebaseDatabase.distSrcCoreUtilSortedMapMod.SortedMapIterator
...
object distSrcCoreSnapChildrenNodeMod {
  ...
  object firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod {
    ...
    trait NamedNode extends StObject {
      ...
      var MAX: typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
      
      var MIN: typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
    }
    object NamedNode {
      
      inline def apply(
        MAX: typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode,
        MIN: typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
      ): typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = {
        val __obj = js.Dynamic.literal(MAX = MAX.asInstanceOf[js.Any], MIN = MIN.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode] (val x: Self) extends AnyVal {
        
        inline def setMAX(
          value: typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
