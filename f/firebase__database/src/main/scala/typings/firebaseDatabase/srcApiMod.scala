...
object srcApiMod {
  ...
  open class DataSnapshot protected ()
    extends typings.firebaseDatabase.apiDotstandaloneMod.DataSnapshot {
    /**
  ...
  open class Database protected ()
    extends typings.firebaseDatabase.apiDotstandaloneMod.Database {
    /** @hideconstructor */
    def this(
      _repoInternal: Repo,
  ...
  open class OnDisconnect_ protected ()
    extends typings.firebaseDatabase.apiDotstandaloneMod.OnDisconnect_ {
    /** @hideconstructor */
    def this(_repo: Repo, _path: Path) = this()
  }
  
  @JSImport("@firebase/database/dist/src/api", "QueryConstraint")
  @js.native
  abstract class QueryConstraint ()
    extends typings.firebaseDatabase.apiDotstandaloneMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/src/api", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typings.firebaseDatabase.apiDotstandaloneMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  open class QueryParams ()
    extends typings.firebaseDatabase.apiDotstandaloneMod.QueryParams
  
  @JSImport("@firebase/database/dist/src/api", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typings.firebaseDatabase.apiDotstandaloneMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  open class TransactionResult protected ()
    extends typings.firebaseDatabase.apiDotstandaloneMod.TransactionResult {
    /** @hideconstructor */
    def this(
