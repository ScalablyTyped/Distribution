...
object leafNodeMod {
  ...
  @JSImport("@firebase/database/dist/node-esm/src/core/snap/LeafNode", "LeafNode")
  @js.native
  ...
  object LeafNode {
    ...
    /**
      ...
      */
    @JSImport("@firebase/database/dist/node-esm/src/core/snap/LeafNode", "LeafNode.VALUE_TYPE_ORDER")
    @js.native
