...
object utilMod {
  ...
  inline def ObjectToUniqueKey(obj: js.Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("ObjectToUniqueKey")(obj.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def beingCrawled(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("beingCrawled")().asInstanceOf[Boolean]
  
  inline def bindCallback(callback: js.Function1[/* a */ js.Any, Unit]): js.Function1[/* a */ js.Any, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("bindCallback")(callback.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* a */ js.Any, Unit]]
  inline def bindCallback(callback: js.Function1[/* a */ js.Any, Unit], context: js.Object): js.Function1[/* a */ js.Any, Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("bindCallback")(callback.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* a */ js.Any, Unit]]
  
  inline def callUserCallback(callback: js.Function, varArgs: js.Any*): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("callUserCallback")(callback.asInstanceOf[js.Any], varArgs.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def callUserCallback(callback: Null, varArgs: js.Any*): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("callUserCallback")(callback.asInstanceOf[js.Any], varArgs.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def callUserCallback(callback: Unit, varArgs: js.Any*): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("callUserCallback")(callback.asInstanceOf[js.Any], varArgs.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def each(obj: js.Object, fn: js.Function2[/* k */ String, /* v */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("each")(obj.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def error(varArgs: String*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("error")(varArgs.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def errorForServerCode(code: String, query: Query): Error = (^.asInstanceOf[js.Dynamic].applyDynamic("errorForServerCode")(code.asInstanceOf[js.Any], query.asInstanceOf[js.Any])).asInstanceOf[Error]
  ...
  inline def exportPropGetter(`object`: js.Object, name: String, fnGet: js.Function0[js.Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("exportPropGetter")(`object`.asInstanceOf[js.Any], name.asInstanceOf[js.Any], fnGet.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def fatal(varArgs: String*): scala.Nothing = ^.asInstanceOf[js.Dynamic].applyDynamic("fatal")(varArgs.asInstanceOf[js.Any]).asInstanceOf[scala.Nothing]
  ...
  inline def isInvalidJSONNumber(data: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInvalidJSONNumber")(data.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  inline def isWindowsStoreApp(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isWindowsStoreApp")().asInstanceOf[Boolean]
  
  inline def log(varArgs: js.Any*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("log")(varArgs.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def logWrapper(prefix: String): js.Function1[/* repeated */ js.Any, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("logWrapper")(prefix.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* repeated */ js.Any, Unit]]
  ...
  inline def requireKey(key: String, obj: StringDictionary[js.Any]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("requireKey")(key.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def warn(varArgs: js.Any*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("warn")(varArgs.asInstanceOf[js.Any]).asInstanceOf[Unit]
