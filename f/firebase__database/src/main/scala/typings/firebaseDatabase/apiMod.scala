...
object apiMod {
  ...
  open class DataSnapshot protected ()
    extends typings.firebaseDatabase.apiStandaloneMod.DataSnapshot {
    /**
  ...
  open class Database protected ()
    extends typings.firebaseDatabase.apiStandaloneMod.Database {
    /** @hideconstructor */
    def this(
      _repoInternal: Repo,
  ...
  open class OnDisconnect_ protected ()
    extends typings.firebaseDatabase.apiStandaloneMod.OnDisconnect_ {
    /** @hideconstructor */
    def this(_repo: Repo, _path: Path) = this()
  }
  
  @JSImport("@firebase/database/dist/node-esm/src/api", "QueryConstraint")
  @js.native
  abstract class QueryConstraint ()
    extends typings.firebaseDatabase.apiStandaloneMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/node-esm/src/api", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typings.firebaseDatabase.apiStandaloneMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  open class QueryParams ()
    extends typings.firebaseDatabase.apiStandaloneMod.QueryParams
  
  @JSImport("@firebase/database/dist/node-esm/src/api", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typings.firebaseDatabase.apiStandaloneMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  open class TransactionResult protected ()
    extends typings.firebaseDatabase.apiStandaloneMod.TransactionResult {
    /** @hideconstructor */
    def this(
