...
import typings.firebaseDatabase.distSrcCoreCompoundWriteMod.CompoundWrite
import typings.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.ChildrenNode
...
object distSrcCoreWriteTreeMod {
