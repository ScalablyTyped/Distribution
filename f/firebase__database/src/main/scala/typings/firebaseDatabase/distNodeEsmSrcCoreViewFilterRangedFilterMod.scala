...
import typings.firebaseDatabase.distNodeEsmSrcCoreViewFilterNodeFilterMod.NodeFilter
import typings.firebaseDatabase.distNodeEsmSrcCoreViewQueryParamsMod.QueryParams
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distNodeEsmSrcCoreViewFilterRangedFilterMod {
  
  @JSImport("@firebase/database/dist/node-esm/src/core/view/filter/RangedFilter", "RangedFilter")
  @js.native
  ...
  object RangedFilter {
    ...
    @JSImport("@firebase/database/dist/node-esm/src/core/view/filter/RangedFilter", "RangedFilter.getEndPost_")
    @js.native
    ...
    @JSImport("@firebase/database/dist/node-esm/src/core/view/filter/RangedFilter", "RangedFilter.getStartPost_")
    @js.native
