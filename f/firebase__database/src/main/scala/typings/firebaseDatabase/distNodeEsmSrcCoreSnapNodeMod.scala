...
object distNodeEsmSrcCoreSnapNodeMod {
  ...
  open class NamedNode protected () extends StObject {
    ...
    var MAX: typings.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
    
    var MIN: typings.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
