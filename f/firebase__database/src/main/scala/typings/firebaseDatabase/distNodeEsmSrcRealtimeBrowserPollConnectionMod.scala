...
import typings.firebaseDatabase.distNodeEsmSrcRealtimePollingPacketReceiverMod.PacketReceiver
import typings.firebaseDatabase.distNodeEsmSrcRealtimeTransportMod.Transport
...
object distNodeEsmSrcRealtimeBrowserPollConnectionMod {
