...
import typings.firebaseDatabase.anon.PathValue
...
trait ImmutableTree[T] extends StObject {
  ...
  /**
    ...
    */
  def findRootMostMatchingPathAndValue(relativePath: Path, predicate: js.Function1[/* a */ T, Boolean]): PathValue[T] | Null = js.native
  
  /**
    * Find, if it exists, the shortest subpath of the given path that points a defined
    * value in the tree
    */
  def findRootMostValueAndPath(relativePath: Path): PathValue[T] | Null = js.native
