...
object distNodeEsmSrcApiOnDisconnectMod {
  
  @JSImport("@firebase/database/dist/node-esm/src/api/OnDisconnect", "OnDisconnect")
  @js.native
  open class OnDisconnect protected () extends StObject {
    /** @hideconstructor */
