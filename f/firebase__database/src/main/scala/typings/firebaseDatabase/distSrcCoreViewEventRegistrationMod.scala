...
import typings.firebaseDatabase.distSrcCoreViewEventMod.CancelEvent
...
object distSrcCoreViewEventRegistrationMod {
  
  @JSImport("@firebase/database/dist/src/core/view/EventRegistration", "CallbackContext")
  @js.native
