...
import typings.firebaseDatabase.eventRegistrationMod.CallbackContext
...
object referenceImplMod {
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", "QueryConstraint")
  @js.native
  ...
  - typings.firebaseDatabase.eventRegistrationMod.QueryContext because Already inherited
  - typings.firebaseDatabase.referenceMod.Query because Already inherited
  - typings.firebaseDatabase.referenceMod.DatabaseReference because var conflicts: _queryIdentifier, _queryObject, key, ref. Inlined parent, root */ @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", "ReferenceImpl")
  @js.native
  ...
  inline def query(query: Query, queryConstraints: QueryConstraint*): Query = ^.asInstanceOf[js.Dynamic].applyDynamic("query")(List(query.asInstanceOf[js.Any]).`++`(queryConstraints.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Query]
