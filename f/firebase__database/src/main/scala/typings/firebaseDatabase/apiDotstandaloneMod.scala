...
object apiDotstandaloneMod {
  
  @JSImport("@firebase/database/dist/src/api.standalone", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/database/dist/src/api.standalone", "DataSnapshot")
  @js.native
  open class DataSnapshot protected ()
    extends typings.firebaseDatabase.apiReferenceImplMod.DataSnapshot {
    /**
  ...
  @JSImport("@firebase/database/dist/src/api.standalone", "Database")
  @js.native
  open class Database protected ()
    extends typings.firebaseDatabase.apiDatabaseMod.Database {
    /** @hideconstructor */
    def this(
      _repoInternal: Repo,
  ...
  @JSImport("@firebase/database/dist/src/api.standalone", "OnDisconnect")
  @js.native
  open class OnDisconnect_ protected () extends OnDisconnect {
    /** @hideconstructor */
    def this(_repo: Repo, _path: Path) = this()
  }
  
  @JSImport("@firebase/database/dist/src/api.standalone", "QueryConstraint")
  @js.native
  abstract class QueryConstraint ()
    extends typings.firebaseDatabase.apiReferenceImplMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/src/api.standalone", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typings.firebaseDatabase.apiReferenceImplMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  @JSImport("@firebase/database/dist/src/api.standalone", "_QueryParams")
  @js.native
  open class QueryParams ()
    extends typings.firebaseDatabase.viewQueryParamsMod.QueryParams
  
  @JSImport("@firebase/database/dist/src/api.standalone", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typings.firebaseDatabase.apiReferenceImplMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  @JSImport("@firebase/database/dist/src/api.standalone", "TransactionResult")
  @js.native
  open class TransactionResult protected ()
    extends typings.firebaseDatabase.apiTransactionMod.TransactionResult {
    /** @hideconstructor */
    def this(
  ...
  inline def query(query: Query, queryConstraints: typings.firebaseDatabase.apiReferenceImplMod.QueryConstraint*): Query = ^.asInstanceOf[js.Dynamic].applyDynamic("query")(List(query.asInstanceOf[js.Any]).`++`(queryConstraints.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Query]
