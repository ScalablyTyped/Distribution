...
import typings.firebaseDatabase.apiReferenceImplMod.ReferenceImpl
import typings.firebaseDatabase.coreRepoMod.Repo
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object apiDatabaseMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _FirebaseService * / any */ @JSImport("@firebase/database/dist/src/api/Database", "Database")
  @js.native
  ...
  ): Database = (^.asInstanceOf[js.Dynamic].applyDynamic("repoManagerDatabaseFromApp")(app.asInstanceOf[js.Any], authProvider.asInstanceOf[js.Any])).asInstanceOf[Database]
  inline def repoManagerDatabaseFromApp(
    app: FirebaseApp,
    authProvider: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<FirebaseAuthInternalName> */ Any,
