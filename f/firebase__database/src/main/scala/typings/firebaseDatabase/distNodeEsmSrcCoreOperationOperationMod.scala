...
object distNodeEsmSrcCoreOperationOperationMod {
  ...
  object OperationType extends StObject {
    ...
    sealed trait ACK_USER_WRITE
      extends StObject
         with OperationType
    /* 2 */ val ACK_USER_WRITE: typings.firebaseDatabase.distNodeEsmSrcCoreOperationOperationMod.OperationType.ACK_USER_WRITE & Double = js.native
    
    @js.native
    sealed trait LISTEN_COMPLETE
      extends StObject
         with OperationType
    /* 3 */ val LISTEN_COMPLETE: typings.firebaseDatabase.distNodeEsmSrcCoreOperationOperationMod.OperationType.LISTEN_COMPLETE & Double = js.native
    
    @js.native
    sealed trait MERGE
      extends StObject
         with OperationType
    /* 1 */ val MERGE: typings.firebaseDatabase.distNodeEsmSrcCoreOperationOperationMod.OperationType.MERGE & Double = js.native
    
    @js.native
    sealed trait OVERWRITE
      extends StObject
         with OperationType
    /* 0 */ val OVERWRITE: typings.firebaseDatabase.distNodeEsmSrcCoreOperationOperationMod.OperationType.OVERWRITE & Double = js.native
  }
