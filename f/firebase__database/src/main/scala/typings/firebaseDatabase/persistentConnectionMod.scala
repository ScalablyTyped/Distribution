...
object persistentConnectionMod {
  ...
  @JSImport("@firebase/database/dist/node-esm/src/core/PersistentConnection", "PersistentConnection")
  @js.native
  ...
  object PersistentConnection {
    ...
    /**
      ...
      */
    @JSImport("@firebase/database/dist/node-esm/src/core/PersistentConnection", "PersistentConnection.nextConnectionId_")
    @js.native
    ...
    @JSImport("@firebase/database/dist/node-esm/src/core/PersistentConnection", "PersistentConnection.nextPersistentConnectionId_")
    @js.native
    ...
    @JSImport("@firebase/database/dist/node-esm/src/core/PersistentConnection", "PersistentConnection.warnOnListenWarnings_")
    @js.native
