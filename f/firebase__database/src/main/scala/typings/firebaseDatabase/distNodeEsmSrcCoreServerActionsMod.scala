...
object distNodeEsmSrcCoreServerActionsMod {
  
  /* note: abstract class */ @JSImport("@firebase/database/dist/node-esm/src/core/ServerActions", "ServerActions")
  @js.native
  open class ServerActions () extends StObject {
