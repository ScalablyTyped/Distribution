...
import typings.firebaseDatabase.distSrcCoreViewEventGeneratorMod.EventGenerator
...
import typings.firebaseDatabase.distSrcCoreViewViewProcessorMod.ViewProcessor
