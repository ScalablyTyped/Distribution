...
import typings.firebaseDatabase.distSrcApiDatabaseMod.Database
...
import typings.firebaseDatabase.distSrcCoreViewEventMod.DataEvent
...
import typings.firebaseDatabase.distSrcCoreViewEventRegistrationMod.CallbackContext
...
object distSrcApiReferenceImplMod {
  ...
  - typings.firebaseDatabase.distSrcCoreViewEventRegistrationMod.QueryContext because Already inherited
  - typings.firebaseDatabase.distSrcApiReferenceMod.Query because Already inherited
  - typings.firebaseDatabase.distSrcApiReferenceMod.DatabaseReference because var conflicts: _queryIdentifier, _queryObject, key, ref. Inlined parent, root */ @JSImport("@firebase/database/dist/src/api/Reference_impl", "ReferenceImpl")
  @js.native
