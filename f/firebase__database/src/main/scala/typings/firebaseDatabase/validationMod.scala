...
object validationMod {
  ...
  @JSImport("@firebase/database/dist/node-esm/src/core/util/validation", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/database/dist/node-esm/src/core/util/validation", "INVALID_KEY_REGEX_")
  @js.native
  val INVALID_KEY_REGEX_ : js.RegExp = js.native
  
  @JSImport("@firebase/database/dist/node-esm/src/core/util/validation", "INVALID_PATH_REGEX_")
  @js.native
  val INVALID_PATH_REGEX_ : js.RegExp = js.native
  
  @JSImport("@firebase/database/dist/node-esm/src/core/util/validation", "MAX_LEAF_SIZE_")
  @js.native
  ...
  inline def validateUrl(fnName: String, parsedUrl: RepoInfo): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("validateUrl")(fnName.asInstanceOf[js.Any], parsedUrl.asInstanceOf[js.Any])).asInstanceOf[Unit]
