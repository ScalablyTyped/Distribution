...
import typings.firebaseDatabase.distNodeEsmSrcApiDatabaseMod.Database
...
import typings.firebaseDatabase.distNodeEsmSrcCoreViewEventMod.DataEvent
...
import typings.firebaseDatabase.distNodeEsmSrcCoreViewEventRegistrationMod.CallbackContext
...
object distNodeEsmSrcApiReferenceImplMod {
  
  @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", "ChildEventRegistration")
  @js.native
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", "DataSnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", "QueryConstraint")
  @js.native
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", "QueryImpl")
  @js.native
  ...
  - typings.firebaseDatabase.distNodeEsmSrcCoreViewEventRegistrationMod.QueryContext because Already inherited
  - typings.firebaseDatabase.distNodeEsmSrcApiReferenceMod.Query because Already inherited
  - typings.firebaseDatabase.distNodeEsmSrcApiReferenceMod.DatabaseReference because var conflicts: _queryIdentifier, _queryObject, key, ref. Inlined parent, root */ @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", "ReferenceImpl")
  @js.native
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api/Reference_impl", "ValueEventRegistration")
  @js.native
  ...
  */
  ...
  /* Inlined parent @firebase/database.@firebase/database/dist/node-esm/src/api/Reference_impl.ReferenceImpl */
  /* Inlined parent std.Pick<std.Promise<@firebase/database.@firebase/database/dist/node-esm/src/api/Reference_impl.ReferenceImpl>, 'then' | 'catch'> */
  @js.native
