...
object apiStandaloneMod {
  
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "DataSnapshot")
  @js.native
  open class DataSnapshot protected ()
    extends typings.firebaseDatabase.referenceImplMod.DataSnapshot {
    /**
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "Database")
  @js.native
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "OnDisconnect")
  @js.native
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "QueryConstraint")
  @js.native
  abstract class QueryConstraint ()
    extends typings.firebaseDatabase.referenceImplMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typings.firebaseDatabase.referenceImplMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "_QueryParams")
  @js.native
  open class QueryParams ()
    extends typings.firebaseDatabase.queryParamsMod.QueryParams
  
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typings.firebaseDatabase.referenceImplMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "TransactionResult")
  @js.native
  open class TransactionResult protected ()
    extends typings.firebaseDatabase.transactionMod.TransactionResult {
    /** @hideconstructor */
    def this(
