...
object distSrcApiDotstandaloneMod {
  ...
  open class DataSnapshot protected ()
    extends typings.firebaseDatabase.distSrcApiReferenceImplMod.DataSnapshot {
    /**
  ...
  open class Database protected ()
    extends typings.firebaseDatabase.distSrcApiDatabaseMod.Database {
    /** @hideconstructor */
    def this(
      _repoInternal: Repo,
  ...
  open class QueryConstraint ()
    extends typings.firebaseDatabase.distSrcApiReferenceImplMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/src/api.standalone", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typings.firebaseDatabase.distSrcApiReferenceImplMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  open class QueryParams ()
    extends typings.firebaseDatabase.distSrcCoreViewQueryParamsMod.QueryParams
  
  @JSImport("@firebase/database/dist/src/api.standalone", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typings.firebaseDatabase.distSrcApiReferenceImplMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  open class TransactionResult protected ()
    extends typings.firebaseDatabase.distSrcApiTransactionMod.TransactionResult {
    /** @hideconstructor */
    def this(
