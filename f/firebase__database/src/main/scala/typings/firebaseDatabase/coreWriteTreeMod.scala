...
import typings.firebaseDatabase.coreCompoundWriteMod.CompoundWrite
import typings.firebaseDatabase.indexesIndexMod.Index
import typings.firebaseDatabase.snapChildrenNodeMod.ChildrenNode
...
object coreWriteTreeMod {
  
  @JSImport("@firebase/database/dist/src/core/WriteTree", JSImport.Namespace)
  @js.native
