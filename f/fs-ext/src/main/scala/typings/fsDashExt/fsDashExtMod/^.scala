...
object ^ extends js.Object {
  ...
  def fcntl(fd: Double, cmd: String, callback: js.Function2[/* err */ Error, /* result */ Double, Unit]): Unit = js.native
  def fcntlSync(fd: Double, cmd: String): Double = js.native
  def fcntlSync(fd: Double, cmd: String, arg: Double): Double = js.native
  /**
  ...
  def flock(fd: Double, flags: String, callback: js.Function1[/* err */ Error, Unit]): Unit = js.native
  def flockSync(fd: Double, flags: String): Unit = js.native
  /**
  ...
  def utime(path: String, atime: Double, mtime: Double, callback: js.Function1[/* err */ Error, Unit]): Unit = js.native
  def utimeSync(path: String, atime: Double, mtime: Double): Unit = js.native
  /**
