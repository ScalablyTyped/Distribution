...
object mkdtempNs extends js.Object {
  ...
  def __promisify___buffer(prefix: java.lang.String, options: fsDashExtLib.fsDashExtLibStrings.buffer): js.Promise[nodeLib.Buffer] = js.native
}
