...
object MimeType {
  ...
  @scala.inline
  def `applicationSlashx-msi`: typings.fileType.fileTypeStrings.`applicationSlashx-msi` = "application/x-msi".asInstanceOf[typings.fileType.fileTypeStrings.`applicationSlashx-msi`]
  @scala.inline
  ...
  @scala.inline
  def `audioSlashx-ms-wma`: typings.fileType.fileTypeStrings.`audioSlashx-ms-wma` = "audio/x-ms-wma".asInstanceOf[typings.fileType.fileTypeStrings.`audioSlashx-ms-wma`]
  @scala.inline
