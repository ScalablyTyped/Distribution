...
package object mod {
  ...
  /* static member */
  @scala.inline
  def requestPort(callback: js.Function2[/* error */ js.Any, /* port */ typings.firmata.mod.Port, _]): scala.Unit = typings.firmata.mod.^.asInstanceOf[js.Dynamic].applyDynamic("requestPort")(callback.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
}
