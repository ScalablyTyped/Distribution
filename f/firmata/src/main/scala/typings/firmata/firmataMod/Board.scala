...
trait Board extends EventEmitter {
  ...
  var transport: typings.serialport.serialportMod.^ = js.native
  ...
  def i2cConfig(options: Anon_Delay): Unit = js.native
  ...
  def i2cStop(options: Anon_Address): Unit = js.native
  ...
  // TODO untested --- TWW
  def serialConfig(options: Anon_Baud): Unit = js.native
  // TODO untested --- TWW
