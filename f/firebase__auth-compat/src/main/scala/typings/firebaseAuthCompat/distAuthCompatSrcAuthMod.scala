...
import typings.firebaseAuthCompat.distAuthCompatSrcWrapMod.Wrapper
...
object distAuthCompatSrcAuthMod {
  ...
  open class Auth protected ()
    extends FirebaseAuth
       with Wrapper[typings.firebaseAuth.distSrcModelPublicTypesMod.Auth]
       with Compat[Any] {
    def this(
      app: FirebaseApp,
    ...
    /* CompleteClass */
    override def unwrap(): typings.firebaseAuth.distSrcModelPublicTypesMod.Auth = js.native
