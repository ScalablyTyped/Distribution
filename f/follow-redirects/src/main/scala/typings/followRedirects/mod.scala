...
object mod {
  ...
  object http {
    ...
    inline def createServer_Fhttp_=(x: js.Function0[typings.node.httpMod.Server]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("createServer")(x.asInstanceOf[js.Any])
  ...
  object https {
    ...
    inline def createServer_Fhttps_=(x: js.Function0[typings.node.httpsMod.Server]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("createServer")(x.asInstanceOf[js.Any])
  ...
  inline def wrap[T /* <: StringDictionary[Scheme[js.Any, js.Any, js.Any]] */](protocols: T): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  ...
  object WrappableRequest {
    ...
    inline def apply(removeHeader: /* repeated */ js.Any => js.Any, setHeader: /* repeated */ js.Any => js.Any): WrappableRequest = {
    ...
    extension [Self <: WrappableRequest](x: Self) {
      ...
      inline def setAbort(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "abort", js.Any.fromFunction1(value))
      
      inline def setAbortUndefined: Self = StObject.set(x, "abort", js.undefined)
      
      inline def setFlushHeaders(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "flushHeaders", js.Any.fromFunction1(value))
      
      inline def setFlushHeadersUndefined: Self = StObject.set(x, "flushHeaders", js.undefined)
      
      inline def setGetHeader(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "getHeader", js.Any.fromFunction1(value))
      
      inline def setGetHeaderUndefined: Self = StObject.set(x, "getHeader", js.undefined)
      
      inline def setRemoveHeader(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "removeHeader", js.Any.fromFunction1(value))
      
      inline def setSetHeader(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "setHeader", js.Any.fromFunction1(value))
      
      inline def setSetNoDelay(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "setNoDelay", js.Any.fromFunction1(value))
      
      inline def setSetNoDelayUndefined: Self = StObject.set(x, "setNoDelay", js.undefined)
      
      inline def setSetSocketKeepAlive(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "setSocketKeepAlive", js.Any.fromFunction1(value))
      
      inline def setSetSocketKeepAliveUndefined: Self = StObject.set(x, "setSocketKeepAlive", js.undefined)
      
      inline def setSetTimeout(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "setTimeout", js.Any.fromFunction1(value))
  ...
  object WrappableResponse {
    ...
    inline def apply(destroy: () => js.Any, headers: Location): WrappableResponse = {
