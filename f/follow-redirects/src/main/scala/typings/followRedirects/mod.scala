...
object mod {
  ...
  inline def wrap[T /* <: StringDictionary[Scheme[Any, Any, Any]] */](protocols: T): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  ...
  trait RedirectableRequest[Request /* <: WrappableRequest */, Response] extends Writable {
    ...
    @JSName("abort")
    var abort_FRedirectableRequest: /* import warning: importer.ImportType#apply Failed type conversion: Request['abort'] */ js.Any = js.native
  ...
  type WrappedScheme[T /* <: Scheme[Any, Any, Any] */] = Override[T, RedirectScheme[Any, Any, Any]]
}
