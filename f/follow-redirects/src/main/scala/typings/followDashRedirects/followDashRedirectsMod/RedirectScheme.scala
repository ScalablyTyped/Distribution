...
trait RedirectScheme[Options, Request /* <: WrappableRequest */, Response] extends js.Object {
  def get(options: Options with FollowOptions): RedirectableRequest[Request, Response] = js.native
  def get(
    options: Options with FollowOptions,
  ...
  def request(options: Options with FollowOptions): RedirectableRequest[Request, Response] = js.native
  def request(
    options: Options with FollowOptions,
    callback: js.Function1[/* res */ Response with FollowResponse, Unit]
  ): RedirectableRequest[Request, Response] = js.native
