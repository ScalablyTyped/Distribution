...
/* Inlined @floating-ui/dom.@floating-ui/dom/src/types.Prettify<std.Omit<@floating-ui/core.@floating-ui/core.FlipOptions, 'boundary'> & @floating-ui/dom.@floating-ui/dom/src/types.DetectOverflowOptions> */
