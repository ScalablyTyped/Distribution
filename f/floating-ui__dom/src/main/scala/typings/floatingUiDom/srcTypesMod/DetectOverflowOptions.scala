...
/* Inlined @floating-ui/dom.@floating-ui/dom/src/types.Prettify<std.Omit<@floating-ui/core.@floating-ui/core.DetectOverflowOptions, 'boundary'> & {  boundary :@floating-ui/dom.@floating-ui/dom/src/types.Boundary | undefined}> */
...
object DetectOverflowOptions {
  ...
  inline def apply(): DetectOverflowOptions = {
