...
import typings.firebaseFunctions.srcServiceMod.FunctionsService
...
object testUtilsMod {
  ...
  inline def createTestService(
    app: FirebaseApp,
    region: String,
    authProvider: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<'auth-internal'> */ Any
  ): FunctionsService = (^.asInstanceOf[js.Dynamic].applyDynamic("createTestService")(app.asInstanceOf[js.Any], region.asInstanceOf[js.Any], authProvider.asInstanceOf[js.Any])).asInstanceOf[FunctionsService]
  inline def createTestService(
    app: FirebaseApp,
    region: String,
    authProvider: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<'auth-internal'> */ Any,
    messagingProvider: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<'messaging-internal'> */ Any
  ...
  inline def createTestService(
    ...
    authProvider: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<'auth-internal'> */ Any,
    messagingProvider: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<'messaging-internal'> */ Any,
    appCheckProvider: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<'app-check-internal'> */ Any
