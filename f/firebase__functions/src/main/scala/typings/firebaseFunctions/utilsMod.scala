...
object utilsMod {
  ...
  inline def createTestService(app: FirebaseApp): Service = ^.asInstanceOf[js.Dynamic].applyDynamic("createTestService")(app.asInstanceOf[js.Any]).asInstanceOf[Service]
  inline def createTestService(app: FirebaseApp, regionOrCustomDomain: String): Service = (^.asInstanceOf[js.Dynamic].applyDynamic("createTestService")(app.asInstanceOf[js.Any], regionOrCustomDomain.asInstanceOf[js.Any])).asInstanceOf[Service]
  ...
  inline def createTestService_authinternal(app: FirebaseApp, regionOrCustomDomain: String, authProvider: Provider[`auth-internal`]): Service = (^.asInstanceOf[js.Dynamic].applyDynamic("createTestService")(app.asInstanceOf[js.Any], regionOrCustomDomain.asInstanceOf[js.Any], authProvider.asInstanceOf[js.Any])).asInstanceOf[Service]
  inline def createTestService_authinternal(app: FirebaseApp, regionOrCustomDomain: Unit, authProvider: Provider[`auth-internal`]): Service = (^.asInstanceOf[js.Dynamic].applyDynamic("createTestService")(app.asInstanceOf[js.Any], regionOrCustomDomain.asInstanceOf[js.Any], authProvider.asInstanceOf[js.Any])).asInstanceOf[Service]
  
  inline def createTestService_messaging(
    app: FirebaseApp,
    regionOrCustomDomain: String,
    authProvider: Unit,
    messagingProvider: Provider[messaging]
