...
import typings.firebaseFunctions.mod.FunctionsErrorCodeCore
...
object firebaseFunctionsStrings {
  ...
  sealed trait aborted
    extends StObject
       ...
       with typings.firebaseFunctions.srcPublicTypesMod.FunctionsErrorCodeCore
       with typings.firebaseFunctions.publicTypesMod.FunctionsErrorCodeCore
       with typings.firebaseFunctions.functionsMod.FunctionsErrorCodeCore
