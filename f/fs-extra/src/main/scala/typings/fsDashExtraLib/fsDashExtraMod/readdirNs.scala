...
object readdirNs extends js.Object {
  ...
  def __promisify___buffer(path: nodeLib.fsMod.PathLike, options: fsDashExtraLib.fsDashExtraLibStrings.buffer): stdLib.Promise[js.Array[nodeLib.Buffer]] = js.native
}
