...
object ^ extends js.Object {
  ...
  def ensureDir(path: java.lang.String, options: EnsureOptions): js.Promise[scala.Unit] = js.native
  def ensureDir(
    path: java.lang.String,
  ...
  def ensureDirSync(path: java.lang.String, options: EnsureOptions): scala.Unit = js.native
  ...
  @JSName("ensureDir")
  def ensureDir_Unit(path: java.lang.String, options: EnsureOptions): scala.Unit = js.native
  @JSName("ensureDir")
