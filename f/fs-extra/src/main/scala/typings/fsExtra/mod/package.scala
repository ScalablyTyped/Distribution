...
package object mod {
  ...
  @scala.inline
  def readJSON_(file: java.lang.String): js.Promise[_] = typings.fsExtra.mod.^.asInstanceOf[js.Dynamic].applyDynamic("readJSON")(file.asInstanceOf[js.Any]).asInstanceOf[js.Promise[_]]
  @scala.inline
  def readJSON_(
    file: java.lang.String,
  ...
  @scala.inline
  def readJSON_(file: java.lang.String, options: typings.fsExtra.mod.ReadOptions): js.Promise[_] = (typings.fsExtra.mod.^.asInstanceOf[js.Dynamic].applyDynamic("readJSON")(file.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[_]]
  @scala.inline
  def readJSON_(
    file: java.lang.String,
  ...
  @scala.inline
  def readJson(file: java.lang.String): js.Promise[_] = typings.fsExtra.mod.^.asInstanceOf[js.Dynamic].applyDynamic("readJson")(file.asInstanceOf[js.Any]).asInstanceOf[js.Promise[_]]
  @scala.inline
  def readJson(
    file: java.lang.String,
    callback: js.Function2[/* err */ typings.std.Error, /* jsonObject */ js.Any, scala.Unit]
  ...
  @scala.inline
  def readJson(file: java.lang.String, options: typings.fsExtra.mod.ReadOptions): js.Promise[_] = (typings.fsExtra.mod.^.asInstanceOf[js.Dynamic].applyDynamic("readJson")(file.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[_]]
  @scala.inline
  def readJson(
    file: java.lang.String,
    options: typings.fsExtra.mod.ReadOptions,
  ...
  def readlink(
    path: typings.node.fsMod.PathLike,
    callback: js.Function2[/* err */ typings.node.NodeJS.ErrnoException, /* linkString */ java.lang.String, _]
  ...
  def realpath(
    path: typings.node.fsMod.PathLike,
    cache: org.scalablytyped.runtime.StringDictionary[java.lang.String],
    callback: js.Function2[/* err */ typings.node.NodeJS.ErrnoException, /* resolvedPath */ java.lang.String, _]
  ...
  def write(
    ...
    offset: js.UndefOr[scala.Nothing],
    length: scala.Double
  ): js.Promise[typings.fsExtra.anon.BufferUint16Array] = (typings.fsExtra.mod.^.asInstanceOf[js.Dynamic].applyDynamic("write")(fd.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.fsExtra.anon.BufferUint16Array]]
  @scala.inline
  def write(
    fd: scala.Double,
    buffer: typings.std.Uint16Array,
  ...
  def write(
    ...
    offset: js.UndefOr[scala.Nothing],
    length: scala.Double
  ): js.Promise[typings.fsExtra.anon.BytesWrittenNumber] = (typings.fsExtra.mod.^.asInstanceOf[js.Dynamic].applyDynamic("write")(fd.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.fsExtra.anon.BytesWrittenNumber]]
  @scala.inline
  def write(
    fd: scala.Double,
    buffer: typings.std.Uint32Array,
  ...
  def write(
    ...
    offset: js.UndefOr[scala.Nothing],
    length: scala.Double
  ): js.Promise[typings.fsExtra.anon.BytesWritten] = (typings.fsExtra.mod.^.asInstanceOf[js.Dynamic].applyDynamic("write")(fd.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.fsExtra.anon.BytesWritten]]
  @scala.inline
  def write(
    fd: scala.Double,
    buffer: typings.std.Uint8Array,
  ...
  @scala.inline
  def write(fd: scala.Double, data: js.Any, offset: js.UndefOr[scala.Nothing], encoding: java.lang.String): js.Promise[typings.fsExtra.anon.BufferString] = (typings.fsExtra.mod.^.asInstanceOf[js.Dynamic].applyDynamic("write")(fd.asInstanceOf[js.Any], data.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], encoding.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.fsExtra.anon.BufferString]]
  @scala.inline
