...
import typings.jsonfile.utilsMod.StringifyOptions
...
object mod {
  ...
  trait EnsureDirOptions extends StObject {
    
    var mode: js.UndefOr[Double] = js.undefined
  }
  object EnsureDirOptions {
    
    inline def apply(): EnsureDirOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[EnsureDirOptions]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: EnsureDirOptions] (val x: Self) extends AnyVal {
  ...
  type JsonOutputOptions = WriteFileOptions & StringifyOptions
  ...
  type NoParamCallbackWithUndefined = js.Function1[/* err */ js.UndefOr[ErrnoException | Null], Unit]
  
  type SymlinkType = Type
}
