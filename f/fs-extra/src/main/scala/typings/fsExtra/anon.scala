...
object anon {
  ...
  trait Buffer[TBuffer /* <: ArrayBufferView */] extends StObject {
  ...
  object Buffer {
    ...
    inline def apply[TBuffer /* <: ArrayBufferView */](buffer: TBuffer, bytesRead: Double): Buffer[TBuffer] = {
      val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesRead = bytesRead.asInstanceOf[js.Any])
      __obj.asInstanceOf[Buffer[TBuffer]]
    }
    
    extension [Self <: Buffer[?], TBuffer /* <: ArrayBufferView */](x: Self & Buffer[TBuffer]) {
