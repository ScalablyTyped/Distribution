...
object mod extends js.Object {
  ...
  def obj(opts: AnonObjectMode with ReadableOptions, read: ReadObjectInput): ReadableStream = js.native
  ...
  type ObjectModeOptions = AnonObjectModeTrue with ReadableOptions
  type Options = AnonFalse with ReadableOptions
