...
object WebConfig {
  ...
  def apply(
    ...
    if (`builder.dest` != null) __obj.updateDynamic("builder.dest")(`builder.dest`)
    if (`builder.ext` != null) __obj.updateDynamic("builder.ext")(`builder.ext`)
    if (`builder.theme` != null) __obj.updateDynamic("builder.theme")(`builder.theme`.asInstanceOf[js.Any])
    if (`builder.urls` != null) __obj.updateDynamic("builder.urls")(`builder.urls`)
    if (`builder.urls.ext` != null) __obj.updateDynamic("builder.urls.ext")(`builder.urls.ext`)
    if (server != null) __obj.updateDynamic("server")(server)
    if (`server.port` != null) __obj.updateDynamic("server.port")(`server.port`.asInstanceOf[js.Any])
    if (!js.isUndefined(`server.sync`)) __obj.updateDynamic("server.sync")(`server.sync`)
    if (`server.syncOptions` != null) __obj.updateDynamic("server.syncOptions")(`server.syncOptions`)
    if (`server.syncOptions.browser` != null) __obj.updateDynamic("server.syncOptions.browser")(`server.syncOptions.browser`)
    if (!js.isUndefined(`server.syncOptions.notify`)) __obj.updateDynamic("server.syncOptions.notify")(`server.syncOptions.notify`)
    if (!js.isUndefined(`server.syncOptions.open`)) __obj.updateDynamic("server.syncOptions.open")(`server.syncOptions.open`)
    if (`server.theme` != null) __obj.updateDynamic("server.theme")(`server.theme`.asInstanceOf[js.Any])
    if (!js.isUndefined(`server.watch`)) __obj.updateDynamic("server.watch")(`server.watch`)
    if (static != null) __obj.updateDynamic("static")(static)
    if (`static.mount` != null) __obj.updateDynamic("static.mount")(`static.mount`)
    if (`static.path` != null) __obj.updateDynamic("static.path")(`static.path`)
