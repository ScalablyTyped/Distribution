...
object DocConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(markdownDotbreaks)) __obj.updateDynamic("markdown.breaks")(markdownDotbreaks.get.asInstanceOf[js.Any])
    if (!js.isUndefined(markdownDotgfm)) __obj.updateDynamic("markdown.gfm")(markdownDotgfm.get.asInstanceOf[js.Any])
    if (!js.isUndefined(markdownDotpedantic)) __obj.updateDynamic("markdown.pedantic")(markdownDotpedantic.get.asInstanceOf[js.Any])
    if (!js.isUndefined(markdownDotsanitize)) __obj.updateDynamic("markdown.sanitize")(markdownDotsanitize.get.asInstanceOf[js.Any])
    if (!js.isUndefined(markdownDotsmartLists)) __obj.updateDynamic("markdown.smartLists")(markdownDotsmartLists.get.asInstanceOf[js.Any])
    if (!js.isUndefined(markdownDotsmartypants)) __obj.updateDynamic("markdown.smartypants")(markdownDotsmartypants.get.asInstanceOf[js.Any])
    if (!js.isUndefined(markdownDottables)) __obj.updateDynamic("markdown.tables")(markdownDottables.get.asInstanceOf[js.Any])
