...
object utils {
  ...
  inline def defaultsDeep[T](args: T*): T = ^.asInstanceOf[js.Dynamic].applyDynamic("defaultsDeep")(args.asInstanceOf[js.Any]).asInstanceOf[T]
  ...
  inline def isPromise[T](value: T): /* is std.PromiseLike<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPromise")(value.asInstanceOf[js.Any]).asInstanceOf[/* is std.PromiseLike<T> */ Boolean]
  inline def isPromise[T](value: js.Thenable[T]): /* is std.PromiseLike<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPromise")(value.asInstanceOf[js.Any]).asInstanceOf[/* is std.PromiseLike<T> */ Boolean]
  ...
  inline def mergeProp(prop: js.Any, upstream: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("mergeProp")(prop.asInstanceOf[js.Any], upstream.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def relUrlPath(toPath: String, fromPath: String, opts: js.Any): String = (^.asInstanceOf[js.Dynamic].applyDynamic("relUrlPath")(toPath.asInstanceOf[js.Any], fromPath.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def stringify(data: js.Any, indent: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(data.asInstanceOf[js.Any], indent.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def toJSON(item: js.Any): js.Object = ^.asInstanceOf[js.Dynamic].applyDynamic("toJSON")(item.asInstanceOf[js.Any]).asInstanceOf[js.Object]
}
