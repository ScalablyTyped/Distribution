...
object frctlFractalStrings {
  ...
  @js.native
  sealed trait panels extends StObject
  inline def panels: panels = "panels".asInstanceOf[panels]
  ...
  @js.native
  sealed trait scripts extends StObject
  inline def scripts: scripts = "scripts".asInstanceOf[scripts]
  
  @js.native
  sealed trait skin extends StObject
  ...
  @js.native
  sealed trait staticDotmount extends StObject
  inline def staticDotmount: staticDotmount = "static.mount".asInstanceOf[staticDotmount]
