...
trait Anon_Del[V /* <: findDashMyDashWayLib.findDashMyDashWayMod.RouterNs.HTTPVersion */] extends js.Object {
  ...
  def get(version: java.lang.String): findDashMyDashWayLib.findDashMyDashWayMod.RouterNs.Handler[V] | scala.Null
  def set(version: java.lang.String, store: findDashMyDashWayLib.findDashMyDashWayMod.RouterNs.Handler[V]): scala.Unit
}
...
object Anon_Del {
  ...
  def apply[V /* <: findDashMyDashWayLib.findDashMyDashWayMod.RouterNs.HTTPVersion */](
    ...
    empty: () => scala.Unit,
    get: java.lang.String => findDashMyDashWayLib.findDashMyDashWayMod.RouterNs.Handler[V] | scala.Null,
    set: (java.lang.String, findDashMyDashWayLib.findDashMyDashWayMod.RouterNs.Handler[V]) => scala.Unit
  ): Anon_Del[V] = {
