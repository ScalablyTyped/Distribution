...
object ^ extends js.Object {
  ...
  def FluxChildMixin(react: fluxxorLib.Anon_A): fluxxorLib.fluxxorMod.FluxxorNs.FluxChildMixin = js.native
  def FluxMixin(react: fluxxorLib.Anon_A): fluxxorLib.fluxxorMod.FluxxorNs.FluxMixin = js.native
