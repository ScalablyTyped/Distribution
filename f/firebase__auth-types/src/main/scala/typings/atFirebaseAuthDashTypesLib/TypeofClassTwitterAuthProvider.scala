...
@js.native
trait TypeofClassTwitterAuthProvider
  extends org.scalablytyped.runtime.Instantiable0[atFirebaseAuthDashTypesLib.atFirebaseAuthDashTypesMod.TwitterAuthProvider] {
