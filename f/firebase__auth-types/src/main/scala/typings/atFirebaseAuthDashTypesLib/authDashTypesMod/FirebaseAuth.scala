...
class FirebaseAuth protected () extends js.Object {
  ...
  def fetchProvidersForEmail(email: java.lang.String): stdLib.Promise[js.Array[java.lang.String]] = js.native
  def fetchSignInMethodsForEmail(email: java.lang.String): stdLib.Promise[js.Array[java.lang.String]] = js.native
  ...
  def setPersistence(persistence: Persistence): stdLib.Promise[scala.Unit] = js.native
  ...
  def signInWithCredential(credential: AuthCredential): stdLib.Promise[User] = js.native
  ...
  def updateCurrentUser(user: User): stdLib.Promise[scala.Unit] = js.native
