...
object mod {
  ...
  @scala.inline
  def absolute(relativePath: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("absolute")(relativePath.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @scala.inline
  def copy(source: String, target: String, callback: js.Function1[/* err */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("copy")(source.asInstanceOf[js.Any], target.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  @scala.inline
  def copyFileSync(source: String, target: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("copyFileSync")(source.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def copyFileSync(source: String, target: String, bufferSize: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("copyFileSync")(source.asInstanceOf[js.Any], target.asInstanceOf[js.Any], bufferSize.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  @scala.inline
  def copySync(source: String, target: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("copySync")(source.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  @scala.inline
  def existsSync(pathToCheck: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("existsSync")(pathToCheck.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  @scala.inline
  def getAppDataDirectory(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getAppDataDirectory")().asInstanceOf[String]
  
  @scala.inline
  def getHomeDirectory(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getHomeDirectory")().asInstanceOf[String]
  
  @scala.inline
  def getSizeSync(pathToCheck: String): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("getSizeSync")(pathToCheck.asInstanceOf[js.Any]).asInstanceOf[Double]
  
  @scala.inline
  def isAbsolute(pathToCheck: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAbsolute")(pathToCheck.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isBinaryExtension(ext: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBinaryExtension")(ext.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isCaseInsensitive(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCaseInsensitive")().asInstanceOf[Boolean]
  
  @scala.inline
  def isCaseSensitive(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCaseSensitive")().asInstanceOf[Boolean]
  
  @scala.inline
  def isCompressedExtension(ext: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCompressedExtension")(ext.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isDirectory(directoryPath: String, callback: js.Function1[/* result */ Boolean, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("isDirectory")(directoryPath.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  @scala.inline
  def isDirectorySync(directoryPath: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDirectorySync")(directoryPath.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isExecutableSync(pathToCheck: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isExecutableSync")(pathToCheck.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isFileSync(filePath: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFileSync")(filePath.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isImageExtension(ext: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isImageExtension")(ext.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isMarkdownExtension(ext: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMarkdownExtension")(ext.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isPdfExtension(ext: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPdfExtension")(ext.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isReadmePath(readmePath: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isReadmePath")(readmePath.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isSymbolicLink(symlinkPath: String, callback: js.Function1[/* result */ Boolean, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("isSymbolicLink")(symlinkPath.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  @scala.inline
  def isSymbolicLinkSync(symlinkPath: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSymbolicLinkSync")(symlinkPath.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  @scala.inline
  def list(rootPath: String, callback: js.Function2[/* err */ Error, /* result */ js.Array[String], Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("list")(rootPath.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def list(
    rootPath: String,
  ...
  @scala.inline
  def listSync(rootPath: String): js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("listSync")(rootPath.asInstanceOf[js.Any]).asInstanceOf[js.Array[String]]
  @scala.inline
  def listSync(rootPath: String, extensions: js.Array[String]): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("listSync")(rootPath.asInstanceOf[js.Any], extensions.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  
  @scala.inline
  def listTreeSync(rootPath: String): js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("listTreeSync")(rootPath.asInstanceOf[js.Any]).asInstanceOf[js.Array[String]]
  ...
  @scala.inline
  def makeTree(directoryPath: String, callback: js.Function1[/* err */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("makeTree")(directoryPath.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  @scala.inline
  def makeTreeSync(directoryPath: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("makeTreeSync")(directoryPath.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  @scala.inline
  def md5ForPath(pathToDigest: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("md5ForPath")(pathToDigest.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @scala.inline
  def move(source: String, target: String, callback: js.Function1[/* err */ Error, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("move")(source.asInstanceOf[js.Any], target.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  @scala.inline
  def moveSync(source: String, target: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("moveSync")(source.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  @scala.inline
  def normalize(pathToNormalize: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("normalize")(pathToNormalize.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @scala.inline
  def remove(pathToRemove: String, callback: js.Function1[/* err */ Error, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("remove")(pathToRemove.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  @scala.inline
  def removeSync(pathToRemove: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeSync")(pathToRemove.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  @scala.inline
  def resolve(loadPath: String, pathToResolve: String): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(loadPath.asInstanceOf[js.Any], pathToResolve.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
  @scala.inline
  def resolve(loadPath: String, pathToResolve: String, extensions: js.Array[String]): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(loadPath.asInstanceOf[js.Any], pathToResolve.asInstanceOf[js.Any], extensions.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
  
  @scala.inline
  def resolveExtension(pathToResolve: String, extensions: js.Array[String]): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolveExtension")(pathToResolve.asInstanceOf[js.Any], extensions.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
  
  @scala.inline
  def resolveOnLoadPath(pathToResolve: String): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveOnLoadPath")(pathToResolve.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
  @scala.inline
  def resolveOnLoadPath(pathToResolve: String, extensions: js.Array[String]): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolveOnLoadPath")(pathToResolve.asInstanceOf[js.Any], extensions.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
  ...
  @scala.inline
  def tildify(pathToTildify: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("tildify")(pathToTildify.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @scala.inline
  def writeFile(filePath: String, content: js.Any, callback: js.Function1[/* err */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFile")(filePath.asInstanceOf[js.Any], content.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def writeFile(filePath: String, content: js.Any, options: String, callback: js.Function1[/* err */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFile")(filePath.asInstanceOf[js.Any], content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def writeFile(filePath: String, content: js.Any, options: Null, callback: js.Function1[/* err */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFile")(filePath.asInstanceOf[js.Any], content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def writeFile(filePath: String, content: js.Any, options: Unit, callback: js.Function1[/* err */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFile")(filePath.asInstanceOf[js.Any], content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def writeFile(
    filePath: String,
    content: js.Any,
  ...
  @scala.inline
  def writeFileSync(filePath: String, content: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFileSync")(filePath.asInstanceOf[js.Any], content.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def writeFileSync(filePath: String, content: String, options: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFileSync")(filePath.asInstanceOf[js.Any], content.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def writeFileSync(filePath: String, content: String, options: typings.fsPlus.anon.Encoding): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFileSync")(filePath.asInstanceOf[js.Any], content.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
