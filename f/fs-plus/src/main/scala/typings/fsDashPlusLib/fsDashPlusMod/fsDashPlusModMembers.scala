...
object fsDashPlusModMembers extends js.Object {
  ...
  def getSizeSync(pathToCheck: java.lang.String): scala.Double = js.native
  def isAbsolute(pathToCheck: java.lang.String): scala.Boolean = js.native
  def isBinaryExtension(ext: java.lang.String): scala.Boolean = js.native
  def isCaseInsensitive(): scala.Boolean = js.native
  def isCaseSensitive(): scala.Boolean = js.native
  def isCompressedExtension(ext: java.lang.String): scala.Boolean = js.native
  def isDirectory(directoryPath: java.lang.String, callback: js.Function1[/* result */ scala.Boolean, scala.Unit]): scala.Unit = js.native
  def isDirectorySync(directoryPath: java.lang.String): scala.Boolean = js.native
  def isExecutableSync(pathToCheck: java.lang.String): scala.Boolean = js.native
  def isFileSync(filePath: java.lang.String): scala.Boolean = js.native
  def isImageExtension(ext: java.lang.String): scala.Boolean = js.native
  def isMarkdownExtension(ext: java.lang.String): scala.Boolean = js.native
  def isPdfExtension(ext: java.lang.String): scala.Boolean = js.native
  def isReadmePath(readmePath: java.lang.String): scala.Boolean = js.native
  ...
  def resolve(
    ...
    pathToResolve: java.lang.String,
    extensions: js.Array[java.lang.String]
  ): js.UndefOr[java.lang.String] = js.native
  def resolveExtension(pathToResolve: java.lang.String, extensions: js.Array[java.lang.String]): js.UndefOr[java.lang.String] = js.native
  ...
  def traverseTree(
    rootPath: java.lang.String,
    onFile: js.Function1[/* file */ java.lang.String, scala.Unit],
    onDirectory: js.Function1[/* dir */ java.lang.String, scala.Boolean | scala.Unit],
    onDone: js.Function1[/* err */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  ...
  def writeFile(filePath: java.lang.String, content: js.Any, callback: js.Function1[/* err */ js.Any, scala.Unit]): scala.Unit = js.native
  def writeFile(
    filePath: java.lang.String,
    content: js.Any,
    options: fsDashPlusLib.Anon_Encoding,
    callback: js.Function1[/* err */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  def writeFile(
    filePath: java.lang.String,
  ...
  def writeFileSync(filePath: java.lang.String, content: java.lang.String): scala.Unit = js.native
