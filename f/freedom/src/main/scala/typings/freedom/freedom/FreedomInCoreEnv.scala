...
trait FreedomInCoreEnv
  ...
  // freedom module.
  def apply(manifestPath: String): js.Promise[FreedomModuleFactoryManager[js.Any]] = js.native
  def apply(manifestPath: String, options: FreedomInCoreEnvOptions): js.Promise[FreedomModuleFactoryManager[js.Any]] = js.native
}
