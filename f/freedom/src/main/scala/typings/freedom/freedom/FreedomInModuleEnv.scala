...
/* moduleName */ StringDictionary[FreedomModuleFactoryManager[Any]] {
  ...
  // module.
  @JSName("core.console")
  def coreDotconsole(args: Any*): typings.freedom.freedom.Console.Console = js.native
  @JSName("core.console")
  ...
  def coreDotrtcdatachannel(args: Any*): typings.freedom.freedom.RTCDataChannel.RTCDataChannel = js.native
  @JSName("core.rtcdatachannel")
  ...
  def coreDotrtcpeerconnection(args: Any*): typings.freedom.freedom.RTCPeerConnection.RTCPeerConnection = js.native
  @JSName("core.rtcpeerconnection")
  ...
  // module.
  @JSName("core.storage")
  def coreDotstorage(args: Any*): typings.freedom.freedom.Storage.Storage = js.native
  @JSName("core.storage")
  ...
  def coreDotudpsocket(args: Any*): typings.freedom.freedom.UdpSocket.Socket = js.native
  @JSName("core.udpsocket")
  ...
  // This is the factory constructor for a new instance of a stub/channel to a
  // module.
  def pgp(args: Any*): typings.freedom.freedom.PgpProvider.PgpProvider = js.native
  @JSName("pgp")
  var pgp_Original: FreedomModuleFactoryManager[typings.freedom.freedom.PgpProvider.PgpProvider] = js.native
  
  // This is the factory constructor for a new instance of a stub/channel to a
  // module.
  def portControl(args: Any*): typings.freedom.freedom.PortControl.PortControl = js.native
  @JSName("portControl")
