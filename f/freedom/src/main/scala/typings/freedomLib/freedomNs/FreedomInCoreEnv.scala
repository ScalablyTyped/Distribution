...
trait FreedomInCoreEnv
  ...
  // freedom module.
  def apply(manifestPath: java.lang.String): js.Promise[FreedomModuleFactoryManager[_]] = js.native
  def apply(manifestPath: java.lang.String, options: FreedomInCoreEnvOptions): js.Promise[FreedomModuleFactoryManager[_]] = js.native
}
