...
object mod {
  ...
  */
  ...
  type EnabledPlugins = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in formidable.formidable.Plugin ]: formidable.formidable.PluginFunction}
    */ typings.formidable.formidableStrings.EnabledPlugins & TopLevel[Any]
