...
object libInternalUtilsMod {
  ...
  inline def isMapLike(thing: Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapLike")(thing.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  inline def isPromiseLike(arg: Any): /* is std.Promise<any> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPromiseLike")(arg.asInstanceOf[js.Any]).asInstanceOf[/* is std.Promise<any> */ Boolean]
}
