...
object HasErrorValue {
  ...
  @scala.inline
  implicit class HasErrorValueOps[Self <: HasErrorValue[_], /* <: typings.formstate.formStateMod.ValidatableMapOrArray */ TValue] (val x: Self with HasErrorValue[TValue]) extends AnyVal {
    @scala.inline
