...
object mod {
  ...
  @JSImport("fs-extra-promise", "StatsFs")
  @js.native
  open class StatsFs ()
  ...
  inline def appendFileAsync(
    filename: String,
    data: Any,
    option: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WriteOptions */ Any
  ): typings.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("appendFileAsync")(filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any], option.asInstanceOf[js.Any])).asInstanceOf[typings.bluebird.mod.^[Unit]]
  ...
  inline def mkdtempAsync(prefix: String, options: Encoding): typings.bluebird.mod.^[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdtempAsync")(prefix.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.bluebird.mod.^[String]]
  ...
  inline def readFileAsync(
    filename: String,
    options: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ReadOptions */ Any
  ): typings.bluebird.mod.^[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("readFileAsync")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.bluebird.mod.^[String]]
  ...
  inline def readJSONAsync_(
    file: String,
    options: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ReadOptions */ Any
  ): typings.bluebird.mod.^[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("readJSONAsync")(file.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.bluebird.mod.^[Any]]
  ...
  inline def writeFileAsync(
    filename: String,
    data: Any,
    options: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WriteOptions */ Any
  ): typings.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFileAsync")(filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.bluebird.mod.^[Unit]]
  ...
  inline def writeJSONAsync_(
    file: String,
    `object`: Any,
    options: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WriteOptions */ Any
  ): typings.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJSONAsync")(file.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.bluebird.mod.^[Unit]]
