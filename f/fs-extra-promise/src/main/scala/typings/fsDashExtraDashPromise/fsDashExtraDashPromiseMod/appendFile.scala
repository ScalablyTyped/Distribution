...
object appendFile extends js.Object {
  ...
  def apply(file: String, data: js.Any, options: Anon_Encoding): js.Promise[Unit] = js.native
  def apply(
    file: String,
    data: js.Any,
  ...
  def apply(file: Buffer, data: js.Any, options: Anon_Encoding): js.Promise[Unit] = js.native
  def apply(
    file: Buffer,
    data: js.Any,
    options: Anon_Encoding,
