...
object fchmod extends js.Object {
  ...
  /**
    ...
    */
  def apply(fd: Double, mode: String, callback: js.Function1[ErrnoException | Null, Unit]): Unit = js.native
  def apply(fd: Double, mode: Double): js.Promise[Unit] = js.native
  def apply(fd: Double, mode: Double, callback: js.Function1[ErrnoException | Null, Unit]): Unit = js.native
  /**
    * Asynchronous fchmod(2) - Change permissions of a file.
    * @param fd A file descriptor.
    * @param mode A file mode. If a string is passed, it is parsed as an octal integer.
