...
trait BaseOptions extends js.Object {
  ...
  var monthSelectorType: flatpickrLib.flatpickrLibStrings.dropdown | flatpickrLib.flatpickrLibStrings.static
...
object BaseOptions {
  ...
  def apply(
    ...
    monthSelectorType: flatpickrLib.flatpickrLibStrings.dropdown | flatpickrLib.flatpickrLibStrings.static,
