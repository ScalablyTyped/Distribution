...
import typings.flatpickr.distTypesGlobalsMod.global.Window
...
import typings.flatpickr.distUtilsFormattingMod.Formats_
import typings.flatpickr.distUtilsFormattingMod.RevFormat_
import typings.flatpickr.distUtilsFormattingMod.TokenRegex_
...
object distTypesInstanceMod {
  ...
  trait Instance
    ...
    def set(
      option: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 62, starting with typings.flatpickr.flatpickrStrings.plugins, typings.flatpickr.flatpickrStrings.showMonths, typings.flatpickr.flatpickrStrings.disable */ Any
    ): Unit = js.native
    def set(
      option: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 62, starting with typings.flatpickr.flatpickrStrings.plugins, typings.flatpickr.flatpickrStrings.showMonths, typings.flatpickr.flatpickrStrings.disable */ Any,
      value: Any
