...
trait Anon_DefaultInput extends js.Object {
  ...
  def apply(input: java.lang.String, options: fkillLib.fkillMod.fkillNs.Options): js.Promise[scala.Unit] = js.native
  def apply(input: js.Array[java.lang.String | scala.Double]): js.Promise[scala.Unit] = js.native
  def apply(input: js.Array[java.lang.String | scala.Double], options: fkillLib.fkillMod.fkillNs.Options): js.Promise[scala.Unit] = js.native
  /**
  ...
  def apply(input: scala.Double, options: fkillLib.fkillMod.fkillNs.Options): js.Promise[scala.Unit] = js.native
  def default(input: java.lang.String): js.Promise[scala.Unit] = js.native
  def default(input: java.lang.String, options: fkillLib.fkillMod.fkillNs.Options): js.Promise[scala.Unit] = js.native
  def default(input: js.Array[java.lang.String | scala.Double]): js.Promise[scala.Unit] = js.native
  def default(input: js.Array[java.lang.String | scala.Double], options: fkillLib.fkillMod.fkillNs.Options): js.Promise[scala.Unit] = js.native
  /**
  	Fabulously kill processes. Cross-platform.
  	@param input - One or more process IDs/names/ports to kill. To kill a port, prefix it with a colon. For example: `:8080`.
  	@example
  ...
  def default(input: scala.Double, options: fkillLib.fkillMod.fkillNs.Options): js.Promise[scala.Unit] = js.native
}
