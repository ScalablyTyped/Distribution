...
import typings.forgeDashDi.Fn_Args
...
trait IBinding extends js.Object {
  ...
  /**
    ...
    */
  def function[T /* <: Fn_Args */](target: T): IBinding = js.native
  /**
  ...
  /**
    ...
    */
  def matches(hint: String): Boolean = js.native
  /** The predicate associated with this binding. Used to support hints. */
  def predicate(hint: String): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def when(hint: String): IBinding = js.native
  /**
