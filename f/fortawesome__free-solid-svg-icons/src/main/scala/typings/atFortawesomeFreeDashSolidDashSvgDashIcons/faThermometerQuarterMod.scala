package typings.atFortawesomeFreeDashSolidDashSvgDashIcons
...
@JSImport("@fortawesome/free-solid-svg-icons/faThermometerQuarter", JSImport.Namespace)
@js.native
object faThermometerQuarterMod extends js.Object {
