...
import typings.foreverMonitor.AnonArgsCommand
...
class Monitor protected () extends EventEmitter {
  ...
  /**
    ...
    */
  def parseCommand(command: String): `false` | AnonArgsCommand = js.native
  def parseCommand(command: String, args: js.Array[String]): `false` | AnonArgsCommand = js.native
  /**
