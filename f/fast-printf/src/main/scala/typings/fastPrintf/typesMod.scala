...
object typesMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.fastPrintf.typesMod.LiteralToken
    - typings.fastPrintf.typesMod.PlaceholderToken
  */
  trait Token extends StObject
  object Token {
    
    inline def LiteralToken(literal: String): typings.fastPrintf.typesMod.LiteralToken = {
      val __obj = js.Dynamic.literal(literal = literal.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("literal")
      __obj.asInstanceOf[typings.fastPrintf.typesMod.LiteralToken]
    }
    
    inline def PlaceholderToken(conversion: String, placeholder: String, position: Double): typings.fastPrintf.typesMod.PlaceholderToken = {
      val __obj = js.Dynamic.literal(conversion = conversion.asInstanceOf[js.Any], placeholder = placeholder.asInstanceOf[js.Any], position = position.asInstanceOf[js.Any], flag = null, precision = null, width = null)
      __obj.updateDynamic("type")("placeholder")
      __obj.asInstanceOf[typings.fastPrintf.typesMod.PlaceholderToken]
    }
  }
}
