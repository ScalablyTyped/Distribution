...
import typings.jquery.JQueryNs.ScrollEvent
import typings.jquery.JQueryNs.TouchEndEvent
import typings.jquery.JQueryNs.TouchMoveEvent
import typings.jquery.JQueryNs.TouchStartEvent
