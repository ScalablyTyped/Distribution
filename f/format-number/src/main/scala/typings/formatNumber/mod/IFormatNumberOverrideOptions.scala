...
object IFormatNumberOverrideOptions {
  ...
  def apply(noSeparator: js.UndefOr[Boolean] = js.undefined, noUnits: js.UndefOr[Boolean] = js.undefined): IFormatNumberOverrideOptions = {
    ...
    if (!js.isUndefined(noSeparator)) __obj.updateDynamic("noSeparator")(noSeparator.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noUnits)) __obj.updateDynamic("noUnits")(noUnits.get.asInstanceOf[js.Any])
