...
abstract class default[T] protected () extends Reader[T] {
  ...
  /* CompleteClass */
  override val deepFilter: typings.fastDashGlob.packageOutProvidersFiltersDeepMod.default = js.native
  /* CompleteClass */
  override val entryFilter: typings.fastDashGlob.packageOutProvidersFiltersEntryMod.default = js.native
  /* CompleteClass */
