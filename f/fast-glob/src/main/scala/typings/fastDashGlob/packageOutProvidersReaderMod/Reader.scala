package typings.fastDashGlob.packageOutProvidersReaderMod
...
trait Reader[T] extends js.Object {
  val deepFilter: typings.fastDashGlob.packageOutProvidersFiltersDeepMod.default
  val entryFilter: typings.fastDashGlob.packageOutProvidersFiltersEntryMod.default
...
object Reader {
  @scala.inline
  def apply[T](
    deepFilter: typings.fastDashGlob.packageOutProvidersFiltersDeepMod.default,
    entryFilter: typings.fastDashGlob.packageOutProvidersFiltersEntryMod.default,
