...
trait Reader[T] extends js.Object {
  val deepFilter: typings.fastDashGlob.outProvidersFiltersDeepMod.default
  val entryFilter: typings.fastDashGlob.outProvidersFiltersEntryMod.default
  ...
  /**
    ...
    */
  def getReaderOptions(task: ITask): typings.atMrmlncReaddirDashEnhanced.atMrmlncReaddirDashEnhancedMod.Options
  /**
...
object Reader {
  @scala.inline
  def apply[T](
    deepFilter: typings.fastDashGlob.outProvidersFiltersDeepMod.default,
    entryFilter: typings.fastDashGlob.outProvidersFiltersEntryMod.default,
    getMicromatchOptions: () => Options,
    getReaderOptions: ITask => typings.atMrmlncReaddirDashEnhanced.atMrmlncReaddirDashEnhancedMod.Options,
