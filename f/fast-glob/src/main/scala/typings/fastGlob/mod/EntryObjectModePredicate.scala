...
object EntryObjectModePredicate {
  ...
  @scala.inline
  implicit class EntryObjectModePredicateOps[Self <: EntryObjectModePredicate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setObjectMode(value: `true`): Self = this.set("objectMode", value.asInstanceOf[js.Any])
  }
}
