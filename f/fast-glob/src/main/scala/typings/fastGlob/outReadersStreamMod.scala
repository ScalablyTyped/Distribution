...
object outReadersStreamMod {
  ...
  @js.native
  trait ReaderStream
    extends typings.fastGlob.outReadersReaderMod.default[Readable] {
    ...
    /* protected */ def _walkStream(directory: String, optionsOrSettings: typings.nodelibFsWalk.outSettingsMod.default): Readable = js.native
