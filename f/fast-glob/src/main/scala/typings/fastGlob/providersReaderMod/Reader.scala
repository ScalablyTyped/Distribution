...
trait Reader[T] extends js.Object {
  val deepFilter: typings.fastGlob.filtersDeepMod.default
  val entryFilter: typings.fastGlob.filtersEntryMod.default
...
object Reader {
  @scala.inline
  def apply[T](
    deepFilter: typings.fastGlob.filtersDeepMod.default,
    entryFilter: typings.fastGlob.filtersEntryMod.default,
