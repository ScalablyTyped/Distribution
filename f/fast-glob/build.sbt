...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "merge2" % "1.1-dt-20180214Z-b24378",
  "org.scalablytyped" %%% "micromatch" % "3.1-dt-20180214Z-8fe84b",
  "org.scalablytyped" %%% "mrmlnc__readdir-enhanced" % "2.2.1-badcee",
  "org.scalablytyped" %%% "node" % "10.12-dt-20181219Z-7438ae",
  "org.scalablytyped" %%% "nodelib__fs_dot_stat" % "1.1.3-c6c6a4",
