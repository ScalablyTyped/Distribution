...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "merge2" % "1.1-dt-20180910Z-9377fc",
  "com.scalablytyped" %%% "micromatch" % "3.1-dt-20180910Z-50c51c",
  "com.scalablytyped" %%% "mrmlnc__readdir-enhanced" % "2.2.1-81e359",
  "com.scalablytyped" %%% "node" % "10.12-dt-20181203Z-7004b3",
  "com.scalablytyped" %%% "nodelib__fs_dot_stat" % "1.1.3-403e3b",
