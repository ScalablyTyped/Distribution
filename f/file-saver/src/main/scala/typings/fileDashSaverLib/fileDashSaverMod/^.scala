...
object ^ extends js.Object {
  ...
  def saveAs(data: java.lang.String, filename: java.lang.String, options: FileSaverOptions): scala.Unit = js.native
  /**
  ...
  def saveAs(data: stdLib.Blob, filename: java.lang.String, options: FileSaverOptions): scala.Unit = js.native
}
