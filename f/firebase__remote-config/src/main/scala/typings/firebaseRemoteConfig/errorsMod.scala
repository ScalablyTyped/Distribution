...
object errorsMod {
  ...
  inline def hasErrorCode(e: Error, errorCode: ErrorCode): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("hasErrorCode")(e.asInstanceOf[js.Any], errorCode.asInstanceOf[js.Any])).asInstanceOf[Boolean]
