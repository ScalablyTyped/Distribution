...
@JSImport("@fortawesome/fontawesome-svg-core", "findIconDefinition")
@js.native
object findIconDefinition extends js.Object {
  def apply(iconLookup: IconLookup): IconDefinition = js.native
}
