...
/* Rewritten from type alias, can be one of: 
  - typings.fortawesomeFontawesomeSvgCore.fortawesomeFontawesomeSvgCoreStrings.horizontal
  - typings.fortawesomeFontawesomeSvgCore.fortawesomeFontawesomeSvgCoreStrings.vertical
  - typings.fortawesomeFontawesomeSvgCore.fortawesomeFontawesomeSvgCoreStrings.both
*/
