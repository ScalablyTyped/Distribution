...
class Class_RedisSet () extends Class__object {
  /**
  	 ...
  	 * 
  	 */
  def add(members: js.Any*): scala.Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def add(members: js.Array[_]): scala.Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def exists(member: Class_Buffer): scala.Boolean = js.native
  /**
  	 * 
  	 * @brief 返回集合中元素的数量
  	 * @return 返回集合的长度
  ...
  /**
  	 ...
  	 * 
  	 */
  def randMember(count: scala.Double): js.Any = js.native
  /**
  	 * 
