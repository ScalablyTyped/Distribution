...
class Class_SandBox protected () extends Class__object {
  ...
  /**
  	 ...
  	 * 
  	 */
  def add(id: java.lang.String, mod: js.Any): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 向沙箱中添加一组基础模块
  	 ...
  	 * 
  	 */
  def add(mods: js.Object): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 向沙箱中添加一个脚本模块
  	 ...
  	 * 
  	 */
  def addScript(srcname: java.lang.String, script: Class_Buffer): js.Any = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def require(id: java.lang.String, base: java.lang.String): js.Any = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def resolve(id: java.lang.String, base: java.lang.String): java.lang.String = js.native
  /**
  	 * 
  	 * @brief 运行一个脚本
  ...
  /**
  	 ...
  	 * 
  	 */
  def setModuleCompiler(extname: java.lang.String, compiler: js.Function): scala.Unit = js.native
}
