...
class Class_RedisList () extends Class__object {
  /**
  	 ...
  	 * 
  	 */
  def get(index: scala.Double): Class_Buffer = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def insertAfter(pivot: Class_Buffer, value: Class_Buffer): scala.Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def insertBefore(pivot: Class_Buffer, value: Class_Buffer): scala.Double = js.native
  /**
  	 * 
  	 * @brief 返回列表的长度
  	 * @return 返回列表的长度
  ...
  /**
  	 ...
  	 * 
  	 */
  def push(values: js.Any*): scala.Double = js.native
  /**
  	 * 
  	 * @brief 将一个或多个值 value 插入到列表的表头
  	 * @param values 指定要插入的数据
  	 ...
  	 * 
  	 */
  def push(values: js.Array[_]): scala.Double = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def remove(count: scala.Double, value: Class_Buffer): scala.Double = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def rpush(values: js.Any*): scala.Double = js.native
  /**
  	 * 
  	 * @brief 将一个或多个值 value 插入到列表的表尾(最右边)
  	 * @param values 指定要插入的数据
  	 ...
  	 * 
  	 */
  def rpush(values: js.Array[_]): scala.Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def set(index: scala.Double, value: Class_Buffer): scala.Unit = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def trim(start: scala.Double, stop: scala.Double): scala.Unit = js.native
}
