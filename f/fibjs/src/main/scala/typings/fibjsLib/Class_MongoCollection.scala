...
class Class_MongoCollection () extends Class__object {
  ...
  /**
  	 ...
  	 * 
  	 */
  def dropIndex(name: java.lang.String): js.Object = js.native
  /**
  	 * 
  	 * @brief 删除当前集合全部索引
  	 * @return 返回命令执行结果
  ...
  /**
  	 ...
  	 * 
  	 */
  def getCollection(name: java.lang.String): Class_MongoCollection = js.native
  /**
  	 * 
  	 * @brief 查询当前集合全部索引
  	 * @return 返回包含索引的结果集
  	 ...
  	 * 
  	 */
  def getIndexes(): Class_MongoCursor = js.native
  /**
  	 * 
  	 * @brief 插入一条数据
  	 ...
  	 * 
  	 */
  def insert(document: js.Object): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 插入一组数据
  	 ...
  	 * 
  	 */
  def insert(documents: js.Array[_]): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 重建当前集合的索引
  	 * @return 返回命令执行结果
  ...
  /**
  	 ...
  	 * 
  	 */
  def remove(query: js.Object): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 执行数据库命令
  	 * @param cmd 给定命令名称
  ...
  /**
  	 ...
  	 * 
  	 */
  def save(document: js.Object): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 根据给定的查询条件更新数据
  	 * @param query 指定查询条件的对象
  	 ...
  	 * 
  	 */
  def update(query: js.Object, document: js.Object): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 根据给定的查询条件更新数据
  	 * @param query 指定查询条件的对象
