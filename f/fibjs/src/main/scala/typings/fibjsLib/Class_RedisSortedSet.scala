...
class Class_RedisSortedSet () extends Class__object {
  /**
  	 ...
  	 * 
  	 */
  def add(sms: js.Any*): scala.Double = js.native
  /**
  	 * 
  	 * @brief 将一个或多个 member 元素及其 score 值加入到有序集当中
  	 ...
  	 * 
  	 */
  def add(sms: js.Object): scala.Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def count(min: scala.Double, max: scala.Double): scala.Double = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def rank(member: Class_Buffer): scala.Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def rankRev(member: Class_Buffer): scala.Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def remove(members: js.Any*): scala.Double = js.native
  /**
  	 * 
  	 * @brief 移除有序集中的一个或多个 member 元素
  	 ...
  	 * 
  	 */
  def remove(members: js.Array[_]): scala.Double = js.native
  /**
  	 * 
