...
class Class_Smtp () extends Class__object {
  ...
  /**
  	 ...
  	 * @async
  	 */
  def command(cmd: java.lang.String, arg: java.lang.String): java.lang.String = js.native
  /**
  	 * 
  	 * @brief 建立到指定的服务器
  ...
  /**
  	 ...
  	 * @async
  	 */
  def data(txt: java.lang.String): scala.Unit = js.native
  /**
  	 * 
  	 ...
  	 * @async
  	 */
  def from(address: java.lang.String): scala.Unit = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * @async
  	 */
  def to(address: java.lang.String): scala.Unit = js.native
}
