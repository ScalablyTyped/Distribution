...
class Class_XmlCharacterData () extends Class_XmlNode {
  ...
  /**
  	 ...
  	 * 
  	 */
  def appendData(arg: java.lang.String): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 从节点删除文本
  ...
  /**
  	 ...
  	 * 
  	 */
  def insertData(offset: scala.Double, arg: java.lang.String): scala.Unit = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def replaceData(offset: scala.Double, count: scala.Double, arg: java.lang.String): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 从节点中提取子串
