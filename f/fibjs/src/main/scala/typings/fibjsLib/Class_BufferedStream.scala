...
class Class_BufferedStream protected () extends Class_Stream {
  ...
  /**
  	 ...
  	 * @async
  	 */
  def readText(size: scala.Double): java.lang.String = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * @async
  	 */
  def writeLine(txt: java.lang.String): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 写入一个字符串
  	 * @param txt 指定写入的字符串
  	 ...
  	 * @async
  	 */
  def writeText(txt: java.lang.String): scala.Unit = js.native
}
