...
class Class_HttpsServer protected () extends Class_HttpServer {
  /**
  	 ...
  	 * 
  	 */
  def this(certs: js.Array[_], port: scala.Double, hdlr: Class_Handler) = this()
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(certs: js.Array[_], addr: java.lang.String, port: scala.Double, hdlr: Class_Handler) = this()
  /**
  	 * 
  	 * @brief HttpsServer 构造函数，在所有本机地址侦听
  	 ...
  	 * 
  	 */
  def this(crt: Class_X509Cert, key: Class_PKey, port: scala.Double, hdlr: Class_Handler) = this()
  /**
  	 * 
  	 * @brief HttpsServer 构造函数
  	 * @param crt X509Cert 证书，用于客户端验证服务器
  	 ...
  	 * 
  	 */
  def this(crt: Class_X509Cert, key: Class_PKey, addr: java.lang.String, port: scala.Double, hdlr: Class_Handler) = this()
  /**
  	 * class prop 
  	 *
  	 * 
