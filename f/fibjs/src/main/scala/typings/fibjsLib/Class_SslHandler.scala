...
@js.native
class Class_SslHandler protected () extends Class_Handler {
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(certs: js.Array[_], hdlr: Class_Handler) = this()
  /**
  	 * 
  	 * @brief SslHandler 构造函数，创建一个新的 SslHandler 对象
  	 ...
  	 * 
  	 */
  def this(crt: Class_X509Cert, key: Class_PKey, hdlr: Class_Handler) = this()
  /**
  	 * class prop 
  	 *
  	 * 
