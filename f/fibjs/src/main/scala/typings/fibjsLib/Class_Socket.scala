...
@js.native
class Class_Socket () extends Class_Stream {
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(family: scala.Double) = this()
  /**
  	 * 
  	 * @brief Socket 构造函数，创建一个新的 Socket 对象
  	 * @param family 指定地址集，缺省为 AF_INET，ipv4
  	 ...
  	 * 
  	 */
  def this(family: scala.Double, `type`: scala.Double) = this()
  /**
  	 * class prop 
  	 *
  	 * 
  	 ...
  	 * @type Integer
  	 */
  var family: scala.Double = js.native
  /**
  	 * class prop 
  	 *
  	 * 
  ...
  /**
  	 ...
  	 * @async
  	 */
  def accept(): Class_Socket = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def bind(addr: java.lang.String, port: scala.Double): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 将当前 Socket 绑定至指定地址的指定端口
  	 * @param addr 指定绑定的地址
  	 ...
  	 * 
  	 */
  def bind(addr: java.lang.String, port: scala.Double, allowIPv4: scala.Boolean): scala.Unit = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def bind(port: scala.Double, allowIPv4: scala.Boolean): scala.Unit = js.native
  /**
  	 * 
  	 * @brief 建立一个 tcp 连接
  ...
  /**
  	 ...
  	 * 
  	 */
  def listen(backlog: scala.Double): scala.Unit = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * @async
  	 */
  def recv(bytes: scala.Double): Class_Buffer = js.native
  /**
  	 * 
  	 * @brief 读取一个 UDP 包
  ...
  /**
  	 ...
  	 * @async
  	 */
  def recvfrom(bytes: scala.Double): js.Any = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * @async
  	 */
  def sendto(data: Class_Buffer, host: java.lang.String, port: scala.Double): scala.Unit = js.native
}
