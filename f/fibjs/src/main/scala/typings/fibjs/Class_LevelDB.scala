...
class Class_LevelDB () extends Class__object {
  ...
  /**
  	 ...
  	 * 
  	 */
  def between(from: Class_Buffer, to: Class_Buffer, func: js.Function): Unit = js.native
  /**
  	 * 
  	 * @brief 关闭当前数据库连接或事务
  	 * 
  ...
  /**
  	 ...
  	 * @async
  	 */
  def has(key: Class_Buffer): Boolean = js.native
  /**
  	 * 
  	 * @brief 查询一组指定键值的值
  ...
  /**
  	 ...
  	 * @async
  	 */
  def remove(key: Class_Buffer): Unit = js.native
  /**
  	 * 
