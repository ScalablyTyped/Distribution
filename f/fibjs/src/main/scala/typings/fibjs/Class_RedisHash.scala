...
class Class_RedisHash () extends Class__object {
  ...
  /**
  	 ...
  	 * 
  	 */
  def exists(field: Class_Buffer): Boolean = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def incr(field: Class_Buffer): Double = js.native
  def incr(field: Class_Buffer, num: Double): Double = js.native
  /**
  	 * 
  	 * @brief 返回哈希表中的所有域
  ...
  /**
  	 ...
  	 * 
  	 */
  def set(field: Class_Buffer, value: Class_Buffer): Unit = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def setNX(field: Class_Buffer, value: Class_Buffer): Unit = js.native
}
