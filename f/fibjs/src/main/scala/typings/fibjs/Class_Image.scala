...
class Class_Image () extends Class__object {
  ...
  def affine(affine: js.Array[_], x: Double): Class_Image = js.native
  def affine(affine: js.Array[_], x: Double, y: Double): Class_Image = js.native
  def affine(affine: js.Array[_], x: Double, y: Double, width: Double): Class_Image = js.native
  def affine(affine: js.Array[_], x: Double, y: Double, width: Double, height: Double): Class_Image = js.native
  /**
  	 * 
  	 * @brief 画一个扇形
  	 * @param x 扇形中心的 x 坐标
  ...
  /**
  	 ...
  	 * @async
  	 */
  def crop(x: Double, y: Double, width: Double, height: Double): Class_Image = js.native
  /**
  	 * 
  	 * @brief 画一个椭圆
  	 * @param x 椭圆中心的 x 坐标
  ...
  def getData(format: Double): Class_Buffer = js.native
  def getData(format: Double, quality: Double): Class_Buffer = js.native
  /**
  	 * 
  	 * @brief 查询指定位置点的颜色
  	 * @param x 指定查询的 x 坐标
  ...
  /**
  	 ...
  	 * @async
  	 */
  def resample(width: Double, height: Double): Class_Image = js.native
  /**
  	 * 
  	 * @brief 旋转当前图像
  ...
  /**
  	 ...
  	 * @async
  	 */
  def save(stm: Class_Stream): Unit = js.native
  def save(stm: Class_Stream, format: Double): Unit = js.native
  def save(stm: Class_Stream, format: Double, quality: Double): Unit = js.native
  /**
  	 * 
  	 * @brief 在指定位置画一个点
  	 * @param x 指定画点的 x 坐标
