...
@js.native
class Class_RedisList () extends Class__object {
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def get(index: Double): Class_Buffer = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def insertAfter(pivot: Class_Buffer, value: Class_Buffer): Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def insertBefore(pivot: Class_Buffer, value: Class_Buffer): Double = js.native
  /**
  	 * 
  	 * @brief 返回列表的长度
  	 * @return 返回列表的长度
  ...
  /**
  	 ...
  	 * 
  	 */
  def pop(): Class_Buffer = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def remove(count: Double, value: Class_Buffer): Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def rpop(): Class_Buffer = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def set(index: Double, value: Class_Buffer): Unit = js.native
  /**
  	 * 
