...
class Class_SslServer protected () extends Class_TcpServer {
  /**
  	 ...
  	 * 
  	 */
  def this(certs: js.Array[_], port: Double, listener: Class_Handler) = this()
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(certs: js.Array[_], addr: String, port: Double, listener: Class_Handler) = this()
  /**
  	 * 
  	 * @brief SslServer 构造函数，在所有本机地址侦听
  	 ...
  	 * 
  	 */
  def this(crt: Class_X509Cert, key: Class_PKey, port: Double, listener: Class_Handler) = this()
  /**
  	 * 
  	 * @brief SslServer 构造函数
  	 * @param crt X509Cert 证书，用于客户端验证服务器
  	 ...
  	 * 
  	 */
  def this(crt: Class_X509Cert, key: Class_PKey, addr: String, port: Double, listener: Class_Handler) = this()
  /**
  	 * class prop 
  	 *
  	 * 
