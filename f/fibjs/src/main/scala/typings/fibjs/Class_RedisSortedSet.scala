...
class Class_RedisSortedSet () extends Class__object {
  ...
  def incr(member: Class_Buffer, num: Double): Class_Buffer = js.native
  /**
  	 * 
  	 * @brief 返回有序集中元素的数量
  	 * @return 返回有序集的长度
  ...
  /**
  	 ...
  	 * 
  	 */
  def rank(member: Class_Buffer): Double = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def rankRev(member: Class_Buffer): Double = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def score(member: Class_Buffer): Class_Buffer = js.native
}
