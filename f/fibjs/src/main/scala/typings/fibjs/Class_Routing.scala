...
class Class_Routing () extends Class_Handler {
  ...
  /**
  	 ...
  	 * 
  	 */
  def all(pattern: String, hdlr: Class_Handler): Class_Routing = js.native
  /**
  	 * 
  	 * @brief 添加一组路由规则
  	 * @param map 路由参数
  ...
  /**
  	 ...
  	 * 
  	 */
  def append(method: String, pattern: String, hdlr: Class_Handler): Class_Routing = js.native
  /**
  	 * 
  	 * @brief 添加一条路由规则
  	 * @param pattern 消息匹配格式
  	 ...
  	 * 
  	 */
  def append(pattern: String, hdlr: Class_Handler): Class_Routing = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def del(pattern: String, hdlr: Class_Handler): Class_Routing = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def find(pattern: String, hdlr: Class_Handler): Class_Routing = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def get(pattern: String, hdlr: Class_Handler): Class_Routing = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def patch(pattern: String, hdlr: Class_Handler): Class_Routing = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def post(pattern: String, hdlr: Class_Handler): Class_Routing = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def put(pattern: String, hdlr: Class_Handler): Class_Routing = js.native
}
