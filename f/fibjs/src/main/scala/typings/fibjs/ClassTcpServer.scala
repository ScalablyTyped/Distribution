...
@js.native
class ClassTcpServer protected () extends ClassObject {
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(port: Double, listener: ClassHandler) = this()
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(addr: String, port: Double, listener: ClassHandler) = this()
  /**
  	 * class prop 
  	 *
  	 * 
