...
class Class_Cipher protected () extends Class__object {
  /**
  	 ...
  	 * 
  	 */
  def this(provider: Double, key: Class_Buffer) = this()
  /**
  	 * 
  	 * @brief Cipher 构造函数
  	 * @param provider 指定加密算法
  	 ...
  	 * 
  	 */
  def this(provider: Double, mode: Double, key: Class_Buffer) = this()
  /**
  	 * 
  	 * @brief Cipher 构造函数
  	 * @param provider 指定加密算法
  	 ...
  	 * 
  	 */
  def this(provider: Double, mode: Double, key: Class_Buffer, iv: Class_Buffer) = this()
  /**
  	 * class prop 
  	 *
  	 * 
