...
class Class_XmlElement () extends Class_XmlNode {
  ...
  /**
  	 ...
  	 * 
  	 */
  def getElementById(id: String): Class_XmlElement = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def getElementsByClassName(className: String): Class_XmlNodeList = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def getElementsByTagName(tagName: String): Class_XmlNodeList = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def getElementsByTagNameNS(namespaceURI: String, localName: String): Class_XmlNodeList = js.native
  /**
  	 * 
