...
class Class_PKey () extends Class__object {
  ...
  def this(DerKey: Class_Buffer, password: String) = this()
  ...
  /**
  	 ...
  	 * 
  	 */
  def importKey(DerKey: Class_Buffer): Unit = js.native
  def importKey(DerKey: Class_Buffer, password: String): Unit = js.native
  /**
  	 * 
  ...
  def sign(data: Class_Buffer, alg: Double): Class_Buffer = js.native
  /**
  	 * 
  	 ...
  	 * @async
  	 */
  def verify(data: Class_Buffer, sign: Class_Buffer): Boolean = js.native
  def verify(data: Class_Buffer, sign: Class_Buffer, alg: Double): Boolean = js.native
}
