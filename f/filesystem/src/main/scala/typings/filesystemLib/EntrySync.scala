...
trait EntrySync extends js.Object {
  ...
  /**
       ...
       * Directory copies are always recursive--that is, they copy all contents of the directory.
       */
  def copyTo(parent: DirectoryEntrySync, newName: java.lang.String): EntrySync = js.native
  /**
  ...
  /**
       ...
       * @param newName The new name of the entry. Defaults to the EntrySync's current name if unspecified.
       */
  def moveTo(parent: DirectoryEntrySync, newName: java.lang.String): EntrySync = js.native
  /**
