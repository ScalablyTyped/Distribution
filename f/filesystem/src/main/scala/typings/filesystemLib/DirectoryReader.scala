...
trait DirectoryReader extends js.Object {
  /**
    ...
    */
  def readEntries(successCallback: EntriesCallback): scala.Unit = js.native
  def readEntries(successCallback: EntriesCallback, errorCallback: ErrorCallback): scala.Unit = js.native
}
