...
trait DirectoryEntrySync extends EntrySync {
  ...
  /**
    ...
    *     </ul>
    */
  def getDirectory(path: java.lang.String): DirectoryEntrySync = js.native
  def getDirectory(path: java.lang.String, options: Flags): DirectoryEntrySync = js.native
  /**
    * Creates or looks up a directory.
    ...
    *     </ul>
    */
  def getFile(path: java.lang.String): FileEntrySync = js.native
  def getFile(path: java.lang.String, options: Flags): FileEntrySync = js.native
  /**
