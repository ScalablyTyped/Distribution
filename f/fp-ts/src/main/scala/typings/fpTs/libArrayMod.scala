...
object libArrayMod {
  ...
  inline def append[A](end: A): js.Function1[/* init */ js.Array[A], NonEmptyArray_[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("append")(end.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* init */ js.Array[A], NonEmptyArray_[A]]]
  
  inline def appendW[A, B](end: B): js.Function1[/* init */ js.Array[A], NonEmptyArray_[A | B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("appendW")(end.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* init */ js.Array[A], NonEmptyArray_[A | B]]]
  
  @JSImport("fp-ts/lib/Array", "array")
  @js.native
  ...
  inline def chop[A, B](f: js.Function1[/* as */ NonEmptyArray_[A], js.Tuple2[B, js.Array[A]]]): js.Function1[/* as */ js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chop")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], js.Array[B]]]
  
  inline def chunksOf(n: Double): js.Function1[/* as */ js.Array[Any], js.Array[NonEmptyArray_[Any]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chunksOf")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[Any], js.Array[NonEmptyArray_[Any]]]]
  ...
  inline def copy[A](as: js.Array[A]): js.Array[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("copy")(as.asInstanceOf[js.Any]).asInstanceOf[js.Array[A]]
  ...
  @JSImport("fp-ts/lib/Array", "empty")
  @js.native
  ...
  inline def exists[A](predicate: Predicate[A]): js.Function1[
    /* as */ js.Array[A], 
    /* is fp-ts.fp-ts/lib/NonEmptyArray.NonEmptyArray<A> */ Boolean
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("exists")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[
    /* as */ js.Array[A], 
    /* is fp-ts.fp-ts/lib/NonEmptyArray.NonEmptyArray<A> */ Boolean
  ]]
  
  inline def extend[A, B](f: js.Function1[/* as */ js.Array[A], B]): js.Function1[/* as */ js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("extend")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], js.Array[B]]]
  ...
  @JSImport("fp-ts/lib/Array", "filterE")
  @js.native
  val filterE: FilterE1[Array] = js.native
  ...
  inline def isNonEmpty[A](as: js.Array[A]): /* is fp-ts.fp-ts/lib/NonEmptyArray.NonEmptyArray<A> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNonEmpty")(as.asInstanceOf[js.Any]).asInstanceOf[/* is fp-ts.fp-ts/lib/NonEmptyArray.NonEmptyArray<A> */ Boolean]
  ...
  inline def `match`[B, A](onEmpty: LazyArg[B], onNonEmpty: js.Function1[/* as */ NonEmptyArray_[A], B]): js.Function1[/* as */ js.Array[A], B] = (^.asInstanceOf[js.Dynamic].applyDynamic("match")(onEmpty.asInstanceOf[js.Any], onNonEmpty.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], B]]
  ...
  inline def matchW[B, A, C](onEmpty: LazyArg[B], onNonEmpty: js.Function1[/* as */ NonEmptyArray_[A], C]): js.Function1[/* as */ js.Array[A], B | C] = (^.asInstanceOf[js.Dynamic].applyDynamic("matchW")(onEmpty.asInstanceOf[js.Any], onNonEmpty.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], B | C]]
  ...
  inline def prependW[A, B](head: B): js.Function1[/* tail */ js.Array[A], NonEmptyArray_[A | B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("prependW")(head.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* tail */ js.Array[A], NonEmptyArray_[A | B]]]
  ...
  inline def scanLeft[A, B](b: B, f: js.Function2[/* b */ B, /* a */ A, B]): js.Function1[/* as */ js.Array[A], NonEmptyArray_[B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("scanLeft")(b.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], NonEmptyArray_[B]]]
  
  inline def scanRight[A, B](b: B, f: js.Function2[/* a */ A, /* b */ B, B]): js.Function1[/* as */ js.Array[A], NonEmptyArray_[B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("scanRight")(b.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], NonEmptyArray_[B]]]
  ...
  @JSImport("fp-ts/lib/Array", "sequence")
  @js.native
  ...
  @JSImport("fp-ts/lib/Array", "traverse")
  @js.native
  val traverse: PipeableTraverse1[typings.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/Array", "traverseWithIndex")
  @js.native
  ...
  inline def unsafeInsertAt[A](i: Double, a: A, as: js.Array[A]): NonEmptyArray_[A] = (^.asInstanceOf[js.Dynamic].applyDynamic("unsafeInsertAt")(i.asInstanceOf[js.Any], a.asInstanceOf[js.Any], as.asInstanceOf[js.Any])).asInstanceOf[NonEmptyArray_[A]]
