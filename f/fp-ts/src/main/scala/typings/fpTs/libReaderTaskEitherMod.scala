...
object libReaderTaskEitherMod {
  ...
  @JSImport("fp-ts/lib/ReaderTaskEither", "ApT")
  @js.native
  val ApT: ReaderTaskEither_[Any, scala.Nothing, js.Array[Any]] = js.native
  ...
  @JSImport("fp-ts/lib/ReaderTaskEither", "ApplyPar")
  @js.native
  val ApplyPar: Apply3[typings.fpTs.libReaderTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/ReaderTaskEither", "ApplySeq")
  @js.native
  ...
  @JSImport("fp-ts/lib/ReaderTaskEither", "Chain")
  @js.native
  val Chain_ : Chain3[typings.fpTs.libReaderTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/ReaderTaskEither", "Do")
  @js.native
  val Do: ReaderTaskEither_[Any, scala.Nothing, js.Object] = js.native
  
  @JSImport("fp-ts/lib/ReaderTaskEither", "FromEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/ReaderTaskEither", "FromReader")
  @js.native
  ...
  inline def altW[R2, E2, B](that: js.Function0[ReaderTaskEither_[R2, E2, B]]): js.Function1[
    /* fa */ ReaderTaskEither_[Any, Any, Any], 
    ReaderTaskEither_[Any & R2, E2, Any | B]
  ...
  inline def ap[R, E, A](fa: ReaderTaskEither_[R, E, A]): js.Function1[
    /* fab */ ReaderTaskEither_[R, E, js.Function1[/* a */ A, Any]], 
    ReaderTaskEither_[R, E, Any]
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("ap")(fa.asInstanceOf[js.Any]).asInstanceOf[js.Function1[
    /* fab */ ReaderTaskEither_[R, E, js.Function1[/* a */ A, Any]], 
    ReaderTaskEither_[R, E, Any]
  ]]
  
  inline def apFirst[R, E, B](second: ReaderTaskEither_[R, E, B]): js.Function1[/* first */ ReaderTaskEither_[R, E, Any], ReaderTaskEither_[R, E, Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("apFirst")(second.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* first */ ReaderTaskEither_[R, E, Any], ReaderTaskEither_[R, E, Any]]]
  
  inline def apFirstW[R2, E2, B](second: ReaderTaskEither_[R2, E2, B]): js.Function1[
    /* first */ ReaderTaskEither_[Any, Any, Any], 
    ReaderTaskEither_[Any & R2, Any | E2, Any]
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("apFirstW")(second.asInstanceOf[js.Any]).asInstanceOf[js.Function1[
    /* first */ ReaderTaskEither_[Any, Any, Any], 
    ReaderTaskEither_[Any & R2, Any | E2, Any]
  ]]
  
  inline def apS[N /* <: String */, A, R, E, B](name: Exclude[N, /* keyof A */ String], fb: ReaderTaskEither_[R, E, B]): js.Function1[
  ...
  inline def apSW[A, N /* <: String */, R2, E2, B](name: Exclude[N, /* keyof A */ String], fb: ReaderTaskEither_[R2, E2, B]): js.Function1[
  ...
  inline def apSecond[R, E, B](second: ReaderTaskEither_[R, E, B]): js.Function1[/* first */ ReaderTaskEither_[R, E, Any], ReaderTaskEither_[R, E, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("apSecond")(second.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* first */ ReaderTaskEither_[R, E, Any], ReaderTaskEither_[R, E, B]]]
  
  inline def apSecondW[R2, E2, B](second: ReaderTaskEither_[R2, E2, B]): js.Function1[
    /* first */ ReaderTaskEither_[Any, Any, Any], 
    ReaderTaskEither_[Any & R2, Any | E2, B]
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("apSecondW")(second.asInstanceOf[js.Any]).asInstanceOf[js.Function1[
    /* first */ ReaderTaskEither_[Any, Any, Any], 
    ReaderTaskEither_[Any & R2, Any | E2, B]
  ]]
  
  inline def apW[R2, E2, A](fa: ReaderTaskEither_[R2, E2, A]): js.Function1[
    /* fab */ ReaderTaskEither_[Any, Any, js.Function1[/* a */ A, Any]], 
    ReaderTaskEither_[Any & R2, Any | E2, Any]
  ...
  inline def asks[R, A, E](f: js.Function1[/* r */ R, A]): ReaderTaskEither_[R, E, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("asks")(f.asInstanceOf[js.Any]).asInstanceOf[ReaderTaskEither_[R, E, A]]
  
  inline def asksReaderTaskEither[R, E, A](f: js.Function1[/* r */ R, ReaderTaskEither_[R, E, A]]): ReaderTaskEither_[R, E, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("asksReaderTaskEither")(f.asInstanceOf[js.Any]).asInstanceOf[ReaderTaskEither_[R, E, A]]
  
  inline def asksReaderTaskEitherW[R1, R2, E, A](f: js.Function1[/* r1 */ R1, ReaderTaskEither_[R2, E, A]]): ReaderTaskEither_[R1 & R2, E, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("asksReaderTaskEitherW")(f.asInstanceOf[js.Any]).asInstanceOf[ReaderTaskEither_[R1 & R2, E, A]]
  
  inline def bimap[E, G, A, B](f: js.Function1[/* e */ E, G], g: js.Function1[/* a */ A, B]): js.Function1[/* fa */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, G, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("bimap")(f.asInstanceOf[js.Any], g.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* fa */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, G, B]]]
  ...
  inline def bindW[N /* <: String */, A, R2, E2, B](name: Exclude[N, /* keyof A */ String], f: js.Function1[/* a */ A, ReaderTaskEither_[R2, E2, B]]): js.Function1[
    /* fa */ ReaderTaskEither_[Any, Any, A], 
    ReaderTaskEither_[
      Any & R2, 
      Any | E2, 
  ...
  inline def bracket[R, E, A, B](
    acquire: ReaderTaskEither_[R, E, A],
    use: js.Function1[/* a */ A, ReaderTaskEither_[R, E, B]],
    release: js.Function2[/* a */ A, /* e */ Either_[E, B], ReaderTaskEither_[R, E, Unit]]
  ): ReaderTaskEither_[R, E, B] = (^.asInstanceOf[js.Dynamic].applyDynamic("bracket")(acquire.asInstanceOf[js.Any], use.asInstanceOf[js.Any], release.asInstanceOf[js.Any])).asInstanceOf[ReaderTaskEither_[R, E, B]]
  
  inline def bracketW[R1, E1, A, R2, E2, B, R3, E3](
    acquire: ReaderTaskEither_[R1, E1, A],
    use: js.Function1[/* a */ A, ReaderTaskEither_[R2, E2, B]],
    release: js.Function2[/* a */ A, /* e */ Either_[E2, B], ReaderTaskEither_[R3, E3, Unit]]
  ): ReaderTaskEither_[R1 & R2 & R3, E1 | E2 | E3, B] = (^.asInstanceOf[js.Dynamic].applyDynamic("bracketW")(acquire.asInstanceOf[js.Any], use.asInstanceOf[js.Any], release.asInstanceOf[js.Any])).asInstanceOf[ReaderTaskEither_[R1 & R2 & R3, E1 | E2 | E3, B]]
  ...
  inline def chainEitherK[E, A, B](f: js.Function1[/* a */ A, Either_[E, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainEitherK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, B]]]
  
  inline def chainEitherKW[E2, A, B](f: js.Function1[/* a */ A, Either_[E2, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainEitherKW")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]]]
  ...
  inline def chainFirstEitherK[A, E, B](f: js.Function1[/* a */ A, Either_[E, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirstEitherK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, A]]]
  
  inline def chainFirstEitherKW[A, E2, B](f: js.Function1[/* a */ A, Either_[E2, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirstEitherKW")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, A]]]
  
  inline def chainFirstIOK[A, B](f: js.Function1[/* a */ A, IO_[B]]): js.Function1[/* first */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirstIOK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* first */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any, A]]]
  
  inline def chainFirstReaderEitherK[R, E, A, B](f: js.Function1[/* a */ A, ReaderEither_[R, E, B]]): js.Function1[/* ma */ ReaderTaskEither_[R, E, A], ReaderTaskEither_[R, E, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirstReaderEitherK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[R, E, A], ReaderTaskEither_[R, E, A]]]
  ...
  inline def chainFirstTaskEitherKW[E2, A, B](f: js.Function1[/* a */ A, TaskEither_[E2, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirstTaskEitherKW")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, A]]]
  
  inline def chainFirstTaskK[A, B](f: js.Function1[/* a */ A, Task_[B]]): js.Function1[/* first */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirstTaskK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* first */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any, A]]]
  
  inline def chainFirstW[R2, E2, A, B](f: js.Function1[/* a */ A, ReaderTaskEither_[R2, E2, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any & R2, Any | E2, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirstW")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any & R2, Any | E2, A]]]
  
  inline def chainIOEitherK[E, A, B](f: js.Function1[/* a */ A, IOEither_[E, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainIOEitherK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, B]]]
  
  inline def chainIOEitherKW[E2, A, B](f: js.Function1[/* a */ A, IOEither_[E2, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainIOEitherKW")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]]]
  
  inline def chainIOK[A, B](f: js.Function1[/* a */ A, IO_[B]]): js.Function1[/* first */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainIOK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* first */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any, B]]]
  
  inline def chainNullableK[E](e: E): js.Function1[
    /* f */ js.Function1[/* a */ Any, js.UndefOr[Any | Null]], 
    js.Function1[
      /* ma */ ReaderTaskEither_[Any, E, Any], 
      ReaderTaskEither_[Any, E, NonNullable[Any]]
    ]
  ...
  inline def chainTaskEitherKW[E2, A, B](f: js.Function1[/* a */ A, TaskEither_[E2, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainTaskEitherKW")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]]]
  
  inline def chainTaskK[A, B](f: js.Function1[/* a */ A, Task_[B]]): js.Function1[/* first */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainTaskK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* first */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any, B]]]
  
  inline def chainW[R2, E2, A, B](f: js.Function1[/* a */ A, ReaderTaskEither_[R2, E2, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any & R2, Any | E2, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainW")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any & R2, Any | E2, B]]]
  
  inline def filterOrElse[E, A](predicate: Predicate[A], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* mb */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, A]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElse")(predicate.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* mb */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, A]]]
  
  inline def filterOrElseW[A, E2](predicate: Predicate[A], onFalse: js.Function1[/* a */ A, E2]): js.Function1[/* mb */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, A]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElseW")(predicate.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* mb */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, A]]]
  
  inline def filterOrElseW_ABE2[A, B /* <: A */, E2](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E2]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElseW")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]]]
  
  inline def filterOrElse_EAB[E, A, B /* <: A */](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElse")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, B]]]
  ...
  inline def foldW[E, R2, B, A, R3, C](
    onLeft: js.Function1[/* e */ E, ReaderTask_[R2, B]],
  ...
  inline def fromPredicate[E, A](predicate: Predicate[A], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* b */ A, ReaderTaskEither_[Any, E, A]] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(predicate.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* b */ A, ReaderTaskEither_[Any, E, A]]]
  ...
  inline def mapLeft[E, G](f: js.Function1[/* e */ E, G]): js.Function1[/* fa */ ReaderTaskEither_[Any, E, Any], ReaderTaskEither_[Any, G, Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("mapLeft")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ ReaderTaskEither_[Any, E, Any], ReaderTaskEither_[Any, G, Any]]]
  
  inline def `match`[E, B, A](onLeft: js.Function1[/* e */ E, B], onRight: js.Function1[/* a */ A, B]): js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTask_[Any, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("match")(onLeft.asInstanceOf[js.Any], onRight.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTask_[Any, B]]]
  
  inline def matchE[R, E, A, B](
    onLeft: js.Function1[/* e */ E, ReaderTask_[R, B]],
    onRight: js.Function1[/* a */ A, ReaderTask_[R, B]]
  ): js.Function1[/* ma */ ReaderTaskEither_[R, E, A], ReaderTask_[R, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("matchE")(onLeft.asInstanceOf[js.Any], onRight.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[R, E, A], ReaderTask_[R, B]]]
  
  inline def matchEW[E, R2, B, A, R3, C](
    onLeft: js.Function1[/* e */ E, ReaderTask_[R2, B]],
    onRight: js.Function1[/* a */ A, ReaderTask_[R3, C]]
  ): js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTask_[Any & R2 & R3, B | C]] = (^.asInstanceOf[js.Dynamic].applyDynamic("matchEW")(onLeft.asInstanceOf[js.Any], onRight.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTask_[Any & R2 & R3, B | C]]]
  
  inline def matchW[E, B, A, C](onLeft: js.Function1[/* e */ E, B], onRight: js.Function1[/* a */ A, C]): js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTask_[Any, B | C]] = (^.asInstanceOf[js.Dynamic].applyDynamic("matchW")(onLeft.asInstanceOf[js.Any], onRight.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTask_[Any, B | C]]]
  
  inline def of[R, E, A](a: A): ReaderTaskEither_[R, E, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(a.asInstanceOf[js.Any]).asInstanceOf[ReaderTaskEither_[R, E, A]]
  
  inline def orElse[R, E1, A, E2](onLeft: js.Function1[/* e */ E1, ReaderTaskEither_[R, E2, A]]): js.Function1[/* ma */ ReaderTaskEither_[R, E1, A], ReaderTaskEither_[R, E2, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("orElse")(onLeft.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[R, E1, A], ReaderTaskEither_[R, E2, A]]]
  
  inline def orElseFirst[E, R, B](onLeft: js.Function1[/* e */ E, ReaderTaskEither_[R, E, B]]): js.Function1[/* ma */ ReaderTaskEither_[R, E, Any], ReaderTaskEither_[R, E, Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("orElseFirst")(onLeft.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[R, E, Any], ReaderTaskEither_[R, E, Any]]]
  
  inline def orElseFirstW[E1, R2, E2, B](onLeft: js.Function1[/* e */ E1, ReaderTaskEither_[R2, E2, B]]): js.Function1[
    /* ma */ ReaderTaskEither_[Any, E1, Any], 
    ReaderTaskEither_[Any & R2, E1 | E2, Any]
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("orElseFirstW")(onLeft.asInstanceOf[js.Any]).asInstanceOf[js.Function1[
    /* ma */ ReaderTaskEither_[Any, E1, Any], 
    ReaderTaskEither_[Any & R2, E1 | E2, Any]
  ]]
  
  inline def orElseW[E1, R1, E2, B](onLeft: js.Function1[/* e */ E1, ReaderTaskEither_[R1, E2, B]]): js.Function1[/* ma */ ReaderTaskEither_[Any, E1, Any], ReaderTaskEither_[R1 & Any, E2, Any | B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("orElseW")(onLeft.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E1, Any], ReaderTaskEither_[R1 & Any, E2, Any | B]]]
  
  inline def orLeft[E1, R, E2](onLeft: js.Function1[/* e */ E1, ReaderTask_[R, E2]]): js.Function1[/* fa */ ReaderTaskEither_[R, E1, Any], ReaderTaskEither_[R, E2, Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("orLeft")(onLeft.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ ReaderTaskEither_[R, E1, Any], ReaderTaskEither_[R, E2, Any]]]
  ...
  inline def sequenceArray[R, E, A](arr: js.Array[ReaderTaskEither_[R, E, A]]): ReaderTaskEither_[R, E, js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("sequenceArray")(arr.asInstanceOf[js.Any]).asInstanceOf[ReaderTaskEither_[R, E, js.Array[A]]]
  ...
  inline def toUnion[R, E, A](fa: ReaderTaskEither_[R, E, A]): ReaderTask_[R, E | A] = ^.asInstanceOf[js.Dynamic].applyDynamic("toUnion")(fa.asInstanceOf[js.Any]).asInstanceOf[ReaderTask_[R, E | A]]
  
  inline def traverseArray[R, E, A, B](f: js.Function1[/* a */ A, ReaderTaskEither_[R, E, B]]): js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("traverseArray")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]]]
  
  inline def traverseArrayWithIndex[R, E, A, B](f: js.Function2[/* index */ Double, /* a */ A, ReaderTaskEither_[R, E, B]]): js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("traverseArrayWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]]]
  
  inline def traverseReadonlyArrayWithIndex[A, R, E, B](f: js.Function2[/* index */ Double, /* a */ A, ReaderTaskEither_[R, E, B]]): js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("traverseReadonlyArrayWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]]]
  
  inline def traverseReadonlyArrayWithIndexSeq[A, R, E, B](f: js.Function2[/* index */ Double, /* a */ A, ReaderTaskEither_[R, E, B]]): js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("traverseReadonlyArrayWithIndexSeq")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]]]
  
  inline def traverseReadonlyNonEmptyArrayWithIndex[A, R, E, B](f: js.Function2[/* index */ Double, /* a */ A, ReaderTaskEither_[R, E, B]]): js.Function1[
    /* as */ ReadonlyNonEmptyArray_[A], 
    ReaderTaskEither_[R, E, ReadonlyNonEmptyArray_[B]]
  ...
  inline def traverseReadonlyNonEmptyArrayWithIndexSeq[A, R, E, B](f: js.Function2[/* index */ Double, /* a */ A, ReaderTaskEither_[R, E, B]]): js.Function1[
    /* as */ ReadonlyNonEmptyArray_[A], 
    ReaderTaskEither_[R, E, ReadonlyNonEmptyArray_[B]]
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("traverseReadonlyNonEmptyArrayWithIndexSeq")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[
    /* as */ ReadonlyNonEmptyArray_[A], 
    ReaderTaskEither_[R, E, ReadonlyNonEmptyArray_[B]]
  ]]
  
  inline def traverseSeqArray[R, E, A, B](f: js.Function1[/* a */ A, ReaderTaskEither_[R, E, B]]): js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("traverseSeqArray")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], ReaderTaskEither_[R, E, js.Array[B]]]]
