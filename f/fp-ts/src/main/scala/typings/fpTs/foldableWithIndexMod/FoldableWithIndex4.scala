...
object FoldableWithIndex4 {
  ...
  @scala.inline
  implicit class FoldableWithIndex4MutableBuilder[Self <: FoldableWithIndex4[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */, I] (val x: Self & (FoldableWithIndex4[F, I])) extends AnyVal {
