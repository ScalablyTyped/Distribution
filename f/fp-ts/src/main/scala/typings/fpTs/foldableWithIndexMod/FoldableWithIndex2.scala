...
object FoldableWithIndex2 {
  ...
  extension [Self <: FoldableWithIndex2[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, I](x: Self & (FoldableWithIndex2[F, I])) {
