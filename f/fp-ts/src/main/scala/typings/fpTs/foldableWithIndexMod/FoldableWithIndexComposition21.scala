...
object FoldableWithIndexComposition21 {
  ...
  @scala.inline
  implicit class FoldableWithIndexComposition21MutableBuilder[Self <: FoldableWithIndexComposition21[?, ?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, FI, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */, GI] (val x: Self & (FoldableWithIndexComposition21[F, FI, G, GI])) extends AnyVal {
