...
object FoldableWithIndexComposition12C {
  ...
  @scala.inline
  implicit class FoldableWithIndexComposition12CMutableBuilder[Self <: FoldableWithIndexComposition12C[?, ?, ?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */, FI, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, GI, E] (val x: Self & (FoldableWithIndexComposition12C[F, FI, G, GI, E])) extends AnyVal {
