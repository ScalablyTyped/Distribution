...
object FoldableWithIndex3 {
  ...
  extension [Self <: FoldableWithIndex3[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I](x: Self & (FoldableWithIndex3[F, I])) {
