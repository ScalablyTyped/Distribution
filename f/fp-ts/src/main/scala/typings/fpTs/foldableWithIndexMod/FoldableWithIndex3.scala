...
trait FoldableWithIndex3[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I]
  extends StObject
     with Foldable3[F] {
...
object FoldableWithIndex3 {
  ...
  @scala.inline
  implicit class FoldableWithIndex3MutableBuilder[Self <: FoldableWithIndex3[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I] (val x: Self & (FoldableWithIndex3[F, I])) extends AnyVal {
