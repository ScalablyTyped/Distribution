...
import typings.fpTs.anon.Fn21
import typings.fpTs.anon.Fn22
...
object libReadonlyMapMod {
  ...
  inline def getFoldableWithIndex[K](O: Ord_[K]): FoldableWithIndex2C[typings.fpTs.fpTsStrings.ReadonlyMap, K, K] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFoldableWithIndex")(O.asInstanceOf[js.Any]).asInstanceOf[FoldableWithIndex2C[typings.fpTs.fpTsStrings.ReadonlyMap, K, K]]
  
  inline def getFunctorWithIndex[K](): FunctorWithIndex2C[typings.fpTs.fpTsStrings.ReadonlyMap, K, K] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFunctorWithIndex")().asInstanceOf[FunctorWithIndex2C[typings.fpTs.fpTsStrings.ReadonlyMap, K, K]]
  ...
  inline def getTraversable[K](O: Ord_[K]): Traversable2C[typings.fpTs.fpTsStrings.ReadonlyMap, K] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTraversable")(O.asInstanceOf[js.Any]).asInstanceOf[Traversable2C[typings.fpTs.fpTsStrings.ReadonlyMap, K]]
  
  inline def getTraversableWithIndex[K](O: Ord_[K]): TraversableWithIndex2C[typings.fpTs.fpTsStrings.ReadonlyMap, K, K] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTraversableWithIndex")(O.asInstanceOf[js.Any]).asInstanceOf[TraversableWithIndex2C[typings.fpTs.fpTsStrings.ReadonlyMap, K, K]]
