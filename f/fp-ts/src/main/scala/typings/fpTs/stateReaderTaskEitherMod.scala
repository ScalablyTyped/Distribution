...
object stateReaderTaskEitherMod {
  ...
  @JSImport("fp-ts/lib/StateReaderTaskEither", "fromIOEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/StateReaderTaskEither", "fromReaderEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/StateReaderTaskEither", "fromReaderTaskEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/StateReaderTaskEither", "fromTaskEither")
  @js.native
