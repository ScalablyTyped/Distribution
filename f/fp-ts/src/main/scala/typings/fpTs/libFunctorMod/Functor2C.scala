...
object Functor2C {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Functor2C[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, E] (val x: Self & (Functor2C[F, E])) extends AnyVal {
