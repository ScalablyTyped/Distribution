...
object Functor3 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Functor3[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */] (val x: Self & Functor3[F]) extends AnyVal {
