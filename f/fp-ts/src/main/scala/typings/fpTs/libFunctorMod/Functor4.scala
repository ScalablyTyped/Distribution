...
object Functor4 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Functor4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ Any */] (val x: Self & Functor4[F]) extends AnyVal {
