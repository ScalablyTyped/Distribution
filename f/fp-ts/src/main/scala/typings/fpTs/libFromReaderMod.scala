...
object libFromReaderMod {
  ...
  trait FromReader2[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */] extends StObject {
    ...
    def fromReader[E, A](fa: Reader_[E, A]): Any
  }
  object FromReader2 {
    
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */](URI: F, fromReader: Reader_[Any, Any] => Any): FromReader2[F] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], fromReader = js.Any.fromFunction1(fromReader))
  ...
  trait FromReader3[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */] extends StObject {
    ...
    def fromReader[R, A, E](fa: Reader_[R, A]): Any
  }
  object FromReader3 {
    
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */](URI: F, fromReader: Reader_[Any, Any] => Any): FromReader3[F] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], fromReader = js.Any.fromFunction1(fromReader))
  ...
  object FromReader3C {
    ...
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */, E](URI: F, _E: E, fromReader: Reader_[Any, Any] => Any): FromReader3C[F, E] = {
  ...
  trait FromReader4[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ Any */] extends StObject {
    ...
    def fromReader[R, A, S, E](fa: Reader_[R, A]): Any
  }
  object FromReader4 {
    
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ Any */](URI: F, fromReader: Reader_[Any, Any] => Any): FromReader4[F] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], fromReader = js.Any.fromFunction1(fromReader))
