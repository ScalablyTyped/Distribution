...
object PipeableSemigroupoid3C {
  ...
  extension [Self <: PipeableSemigroupoid3C[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */, E](x: Self & (PipeableSemigroupoid3C[F, E])) {
