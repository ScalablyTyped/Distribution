...
object PipeableCompactable3C {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PipeableCompactable3C[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */, E] (val x: Self & (PipeableCompactable3C[F, E])) extends AnyVal {
