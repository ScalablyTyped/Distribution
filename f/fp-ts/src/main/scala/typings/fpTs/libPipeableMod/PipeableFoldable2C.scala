...
object PipeableFoldable2C {
  ...
  extension [Self <: PipeableFoldable2C[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, E](x: Self & (PipeableFoldable2C[F, E])) {
