...
object PipeableFoldableWithIndex2C {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PipeableFoldableWithIndex2C[?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, I, E] (val x: Self & (PipeableFoldableWithIndex2C[F, I, E])) extends AnyVal {
