...
object ApplicativeComposition2C1 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ApplicativeComposition2C1[?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */, E] (val x: Self & (ApplicativeComposition2C1[F, G, E])) extends AnyVal {
