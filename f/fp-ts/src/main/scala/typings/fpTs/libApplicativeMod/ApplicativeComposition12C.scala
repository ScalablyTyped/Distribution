...
object ApplicativeComposition12C {
  ...
  extension [Self <: ApplicativeComposition12C[?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, E](x: Self & (ApplicativeComposition12C[F, G, E])) {
