...
object Applicative3 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Applicative3[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */] (val x: Self & Applicative3[F]) extends AnyVal {
