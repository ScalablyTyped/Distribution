...
object Applicative2 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Applicative2[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */] (val x: Self & Applicative2[F]) extends AnyVal {
