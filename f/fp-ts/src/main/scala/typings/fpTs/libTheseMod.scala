...
object libTheseMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.fpTs.libEitherMod.Either_[E, A]
    - typings.fpTs.libTheseMod.Both_[E, A]
  */
  trait These_[E, A] extends StObject
  object These_ {
    
    inline def Both_[E, A](left: E, right: A): typings.fpTs.libTheseMod.Both_[E, A] = {
      val __obj = js.Dynamic.literal(_tag = "Both", left = left.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fpTs.libTheseMod.Both_[E, A]]
    }
    
    inline def Left_[E](left: E): typings.fpTs.libEitherMod.Left_[E] = {
      val __obj = js.Dynamic.literal(_tag = "Left", left = left.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fpTs.libEitherMod.Left_[E]]
    }
    
    inline def Right_[A](right: A): typings.fpTs.libEitherMod.Right_[A] = {
      val __obj = js.Dynamic.literal(_tag = "Right", right = right.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fpTs.libEitherMod.Right_[A]]
    }
  }
}
