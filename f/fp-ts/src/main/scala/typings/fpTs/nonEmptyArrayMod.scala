...
object nonEmptyArrayMod {
  ...
  inline def ap[A](fa: NonEmptyArray_[A]): js.Function1[/* fab */ NonEmptyArray_[js.Function1[/* a */ A, js.Any]], NonEmptyArray_[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("ap")(fa.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fab */ NonEmptyArray_[js.Function1[/* a */ A, js.Any]], NonEmptyArray_[js.Any]]]
  
  inline def apFirst[B](fb: NonEmptyArray_[B]): js.Function1[/* fa */ NonEmptyArray_[js.Any], NonEmptyArray_[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("apFirst")(fb.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ NonEmptyArray_[js.Any], NonEmptyArray_[js.Any]]]
  
  inline def apS[A, N /* <: String */, B](name: Exclude[N, /* keyof A */ String], fb: NonEmptyArray_[B]): js.Function1[
    /* fa */ NonEmptyArray_[A], 
    NonEmptyArray_[
  ...
  inline def apSecond[B](fb: NonEmptyArray_[B]): js.Function1[/* fa */ NonEmptyArray_[js.Any], NonEmptyArray_[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("apSecond")(fb.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ NonEmptyArray_[js.Any], NonEmptyArray_[B]]]
  ...
  inline def chainFirst[A, B](f: js.Function1[/* a */ A, NonEmptyArray_[B]]): js.Function1[/* ma */ NonEmptyArray_[A], NonEmptyArray_[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirst")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ NonEmptyArray_[A], NonEmptyArray_[A]]]
  
  inline def concat[A](fx: js.Array[A], fy: NonEmptyArray_[A]): NonEmptyArray_[A] = (^.asInstanceOf[js.Dynamic].applyDynamic("concat")(fx.asInstanceOf[js.Any], fy.asInstanceOf[js.Any])).asInstanceOf[NonEmptyArray_[A]]
  inline def concat[A](fx: NonEmptyArray_[A], fy: js.Array[A]): NonEmptyArray_[A] = (^.asInstanceOf[js.Dynamic].applyDynamic("concat")(fx.asInstanceOf[js.Any], fy.asInstanceOf[js.Any])).asInstanceOf[NonEmptyArray_[A]]
  ...
  inline def copy[A](nea: NonEmptyArray_[A]): NonEmptyArray_[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("copy")(nea.asInstanceOf[js.Any]).asInstanceOf[NonEmptyArray_[A]]
  ...
  inline def extend[A, B](f: js.Function1[/* fa */ NonEmptyArray_[A], B]): js.Function1[/* ma */ NonEmptyArray_[A], NonEmptyArray_[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("extend")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ NonEmptyArray_[A], NonEmptyArray_[B]]]
  ...
  inline def filter[A](predicate: Predicate[A]): js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]]]
  
  inline def filterWithIndex[A](predicate: js.Function2[/* i */ Double, /* a */ A, Boolean]): js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filterWithIndex")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]]]
  
  inline def filter_AB_A[A, B /* <: A */](refinement: Refinement[A, B]): js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(refinement.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]]]
  ...
  inline def init[A](nea: NonEmptyArray_[A]): js.Array[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("init")(nea.asInstanceOf[js.Any]).asInstanceOf[js.Array[A]]
  
  inline def insertAt[A](i: Double, a: A): js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("insertAt")(i.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]]]
  ...
  inline def map[A, B](f: js.Function1[/* a */ A, B]): js.Function1[/* fa */ NonEmptyArray_[A], NonEmptyArray_[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("map")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ NonEmptyArray_[A], NonEmptyArray_[B]]]
  
  inline def mapWithIndex[A, B](f: js.Function2[/* i */ Double, /* a */ A, B]): js.Function1[/* fa */ NonEmptyArray_[A], NonEmptyArray_[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("mapWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ NonEmptyArray_[A], NonEmptyArray_[B]]]
  ...
  inline def modifyAt[A](i: Double, f: js.Function1[/* a */ A, A]): js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("modifyAt")(i.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]]]
  ...
  inline def reverse[A](nea: NonEmptyArray_[A]): NonEmptyArray_[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("reverse")(nea.asInstanceOf[js.Any]).asInstanceOf[NonEmptyArray_[A]]
  ...
  inline def sort[B](O: Ord_[B]): js.Function1[/* nea */ NonEmptyArray_[B], NonEmptyArray_[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("sort")(O.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* nea */ NonEmptyArray_[B], NonEmptyArray_[B]]]
  
  inline def tail[A](nea: NonEmptyArray_[A]): js.Array[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("tail")(nea.asInstanceOf[js.Any]).asInstanceOf[js.Array[A]]
  ...
  inline def unzip[A, B](as: NonEmptyArray_[js.Tuple2[A, B]]): js.Tuple2[NonEmptyArray_[A], NonEmptyArray_[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("unzip")(as.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[NonEmptyArray_[A], NonEmptyArray_[B]]]
  
  inline def updateAt[A](i: Double, a: A): js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("updateAt")(i.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* nea */ NonEmptyArray_[A], Option_[NonEmptyArray_[A]]]]
  
  inline def zip[B](bs: NonEmptyArray_[B]): js.Function1[/* as */ NonEmptyArray_[js.Any], NonEmptyArray_[js.Tuple2[js.Any, B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("zip")(bs.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ NonEmptyArray_[js.Any], NonEmptyArray_[js.Tuple2[js.Any, B]]]]
  ...
  inline def zipWith[A, B, C](fa: NonEmptyArray_[A], fb: NonEmptyArray_[B], f: js.Function2[/* a */ A, /* b */ B, C]): NonEmptyArray_[C] = (^.asInstanceOf[js.Dynamic].applyDynamic("zipWith")(fa.asInstanceOf[js.Any], fb.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[NonEmptyArray_[C]]
