...
object FunctorWithIndexComposition11 {
  ...
  extension [Self <: FunctorWithIndexComposition11[?, ?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */, FI, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */, GI](x: Self & (FunctorWithIndexComposition11[F, FI, G, GI])) {
