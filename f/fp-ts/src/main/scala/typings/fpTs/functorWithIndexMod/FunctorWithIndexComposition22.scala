...
object FunctorWithIndexComposition22 {
  ...
  @scala.inline
  implicit class FunctorWithIndexComposition22MutableBuilder[Self <: FunctorWithIndexComposition22[?, ?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, FI, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, GI] (val x: Self & (FunctorWithIndexComposition22[F, FI, G, GI])) extends AnyVal {
