...
object FunctorWithIndex1 {
  ...
  extension [Self <: FunctorWithIndex1[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */, I](x: Self & (FunctorWithIndex1[F, I])) {
