...
object FunctorWithIndexComposition21 {
  ...
  @scala.inline
  def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, FI, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */, GI](
  ...
  @scala.inline
  implicit class FunctorWithIndexComposition21MutableBuilder[Self <: FunctorWithIndexComposition21[?, ?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, FI, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */, GI] (val x: Self & (FunctorWithIndexComposition21[F, FI, G, GI])) extends AnyVal {
