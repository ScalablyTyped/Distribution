...
object FunctorWithIndexComposition22C {
  ...
  extension [Self <: FunctorWithIndexComposition22C[?, ?, ?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, FI, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, GI, E](x: Self & (FunctorWithIndexComposition22C[F, FI, G, GI, E])) {
