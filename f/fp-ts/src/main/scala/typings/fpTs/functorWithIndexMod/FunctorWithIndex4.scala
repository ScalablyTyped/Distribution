...
object FunctorWithIndex4 {
  ...
  extension [Self <: FunctorWithIndex4[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */, I](x: Self & (FunctorWithIndex4[F, I])) {
