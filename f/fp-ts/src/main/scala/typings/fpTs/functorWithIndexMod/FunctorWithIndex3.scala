...
object FunctorWithIndex3 {
  ...
  @scala.inline
  def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I](
    URI: F,
  ...
  @scala.inline
  implicit class FunctorWithIndex3MutableBuilder[Self <: FunctorWithIndex3[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I] (val x: Self & (FunctorWithIndex3[F, I])) extends AnyVal {
