...
object readonlyArrayMod {
  ...
  object Spanned {
    ...
    @scala.inline
    def apply[I, R](init: js.Array[I], rest: js.Array[R]): Spanned[I, R] = {
      val __obj = js.Dynamic.literal(init = init.asInstanceOf[js.Any], rest = rest.asInstanceOf[js.Any])
      __obj.asInstanceOf[Spanned[I, R]]
    }
    
    @scala.inline
    implicit class SpannedMutableBuilder[Self <: Spanned[?, ?], I, R] (val x: Self & (Spanned[I, R])) extends AnyVal {
      
      @scala.inline
      def setInit(value: js.Array[I]): Self = StObject.set(x, "init", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInitVarargs(value: I*): Self = StObject.set(x, "init", js.Array(value :_*))
      
      @scala.inline
      def setRest(value: js.Array[R]): Self = StObject.set(x, "rest", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRestVarargs(value: R*): Self = StObject.set(x, "rest", js.Array(value :_*))
    }
  }
}
