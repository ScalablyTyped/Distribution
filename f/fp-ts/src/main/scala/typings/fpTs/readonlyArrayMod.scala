...
object readonlyArrayMod {
  ...
  inline def ap[A](fa: js.Array[A]): js.Function1[/* fab */ js.Array[js.Function1[/* a */ A, js.Any]], js.Array[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("ap")(fa.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fab */ js.Array[js.Function1[/* a */ A, js.Any]], js.Array[js.Any]]]
  
  inline def apFirst[B](fb: js.Array[B]): js.Function1[/* fa */ js.Array[js.Any], js.Array[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("apFirst")(fb.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[js.Any], js.Array[js.Any]]]
  
  inline def apS[A, N /* <: String */, B](name: Exclude[N, /* keyof A */ String], fb: js.Array[B]): js.Function1[
    /* fa */ js.Array[A], 
    js.Array[
  ...
  inline def apSecond[B](fb: js.Array[B]): js.Function1[/* fa */ js.Array[js.Any], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("apSecond")(fb.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[js.Any], js.Array[B]]]
  ...
  inline def chainFirst[A, B](f: js.Function1[/* a */ A, js.Array[B]]): js.Function1[/* ma */ js.Array[A], js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirst")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ js.Array[A], js.Array[A]]]
  
  inline def chainWithIndex[A, B](f: js.Function2[/* i */ Double, /* a */ A, js.Array[B]]): js.Function1[/* ma */ js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ js.Array[A], js.Array[B]]]
  ...
  inline def chunksOf(n: Double): js.Function1[/* as */ js.Array[js.Any], js.Array[js.Array[js.Any]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chunksOf")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], js.Array[js.Array[js.Any]]]]
  ...
  inline def comprehension[A, R](input: js.Array[js.Array[A]], f: js.Function1[/* a */ A, Boolean | R]): js.Array[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("comprehension")(input.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Array[R]]
  inline def comprehension[A, R](
  ...
  inline def deleteAt(i: Double): js.Function1[/* as */ js.Array[js.Any], Option_[js.Array[js.Any]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("deleteAt")(i.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], Option_[js.Array[js.Any]]]]
  
  inline def difference[A](E: Eq[A]): Fn2[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("difference")(E.asInstanceOf[js.Any]).asInstanceOf[Fn2[A]]
  
  inline def dropLeft(n: Double): js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("dropLeft")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]]]
  
  inline def dropLeftWhile[A](predicate: Predicate[A]): js.Function1[/* as */ js.Array[A], js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("dropLeftWhile")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], js.Array[A]]]
  
  inline def dropRight(n: Double): js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("dropRight")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]]]
  ...
  inline def filter[A](predicate: Predicate[A]): js.Function1[/* fa */ js.Array[A], js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], js.Array[A]]]
  ...
  inline def filterWithIndex[A](predicateWithIndex: PredicateWithIndex[Double, A]): js.Function1[/* fa */ js.Array[A], js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filterWithIndex")(predicateWithIndex.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], js.Array[A]]]
  
  inline def filterWithIndex_AB_A[A, B /* <: A */](refinementWithIndex: RefinementWithIndex[Double, A, B]): js.Function1[/* fa */ js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filterWithIndex")(refinementWithIndex.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], js.Array[B]]]
  
  inline def filter_AB_A[A, B /* <: A */](refinement: Refinement[A, B]): js.Function1[/* fa */ js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(refinement.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], js.Array[B]]]
  
  inline def findFirst[A](predicate: Predicate[A]): js.Function1[/* as */ js.Array[A], Option_[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("findFirst")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], Option_[A]]]
  ...
  inline def findLast[A](predicate: Predicate[A]): js.Function1[/* as */ js.Array[A], Option_[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("findLast")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], Option_[A]]]
  ...
  inline def foldLeft[A, B](onEmpty: Lazy[B], onCons: js.Function2[/* head */ A, /* tail */ js.Array[A], B]): js.Function1[/* as */ js.Array[A], B] = (^.asInstanceOf[js.Dynamic].applyDynamic("foldLeft")(onEmpty.asInstanceOf[js.Any], onCons.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], B]]
  ...
  inline def foldRight[A, B](onEmpty: Lazy[B], onCons: js.Function2[/* init */ js.Array[A], /* last */ A, B]): js.Function1[/* as */ js.Array[A], B] = (^.asInstanceOf[js.Dynamic].applyDynamic("foldRight")(onEmpty.asInstanceOf[js.Any], onCons.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], B]]
  ...
  inline def insertAt[A](i: Double, a: A): js.Function1[/* as */ js.Array[A], Option_[js.Array[A]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("insertAt")(i.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], Option_[js.Array[A]]]]
  
  inline def intersection[A](E: Eq[A]): Fn2[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersection")(E.asInstanceOf[js.Any]).asInstanceOf[Fn2[A]]
  ...
  inline def lookup(i: Double): js.Function1[/* as */ js.Array[js.Any], Option_[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("lookup")(i.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], Option_[js.Any]]]
  ...
  @JSImport("fp-ts/lib/ReadonlyArray", "of")
  @js.native
  val of: js.Function1[
    /* a */ js.Any, 
  ...
  inline def partition[A](predicate: Predicate[A]): js.Function1[/* fa */ js.Array[A], Separated[js.Array[A], js.Array[A]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("partition")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], Separated[js.Array[A], js.Array[A]]]]
  
  inline def partitionMap[A, B, C](f: js.Function1[/* a */ A, Either_[B, C]]): js.Function1[/* fa */ js.Array[A], Separated[js.Array[B], js.Array[C]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("partitionMap")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], Separated[js.Array[B], js.Array[C]]]]
  
  inline def partitionMapWithIndex[A, B, C](f: js.Function2[/* i */ Double, /* a */ A, Either_[B, C]]): js.Function1[/* fa */ js.Array[A], Separated[js.Array[B], js.Array[C]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("partitionMapWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], Separated[js.Array[B], js.Array[C]]]]
  
  inline def partitionWithIndex[A](predicateWithIndex: PredicateWithIndex[Double, A]): js.Function1[/* fa */ js.Array[A], Separated[js.Array[A], js.Array[A]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("partitionWithIndex")(predicateWithIndex.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], Separated[js.Array[A], js.Array[A]]]]
  ...
  inline def partition_AB_A[A, B /* <: A */](refinement: Refinement[A, B]): js.Function1[/* fa */ js.Array[A], Separated[js.Array[A], js.Array[B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("partition")(refinement.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ js.Array[A], Separated[js.Array[A], js.Array[B]]]]
  ...
  inline def rotate(n: Double): js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("rotate")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]]]
  
  inline def scanLeft[A, B](b: B, f: js.Function2[/* b */ B, /* a */ A, B]): js.Function1[/* as */ js.Array[A], js.Array[B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("scanLeft")(b.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], js.Array[B]]]
  
  inline def scanRight[A, B](b: B, f: js.Function2[/* a */ A, /* b */ B, B]): js.Function1[/* as */ js.Array[A], js.Array[B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("scanRight")(b.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* as */ js.Array[A], js.Array[B]]]
  
  inline def separate[A, B](fa: js.Array[Either_[A, B]]): Separated[js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("separate")(fa.asInstanceOf[js.Any]).asInstanceOf[Separated[js.Array[A], js.Array[B]]]
  ...
  inline def spanLeft[A](predicate: Predicate[A]): js.Function1[/* as */ js.Array[A], Spanned[A, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("spanLeft")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], Spanned[A, A]]]
  ...
  inline def splitAt(n: Double): js.Function1[/* as */ js.Array[js.Any], js.Tuple2[js.Array[js.Any], js.Array[js.Any]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("splitAt")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], js.Tuple2[js.Array[js.Any], js.Array[js.Any]]]]
  ...
  inline def takeLeft(n: Double): js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("takeLeft")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]]]
  
  inline def takeLeftWhile[A](predicate: Predicate[A]): js.Function1[/* as */ js.Array[A], js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("takeLeftWhile")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], js.Array[A]]]
  ...
  inline def takeRight(n: Double): js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("takeRight")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], js.Array[js.Any]]]
  
  inline def toArray[A](ras: js.Array[A]): js.Array[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("toArray")(ras.asInstanceOf[js.Any]).asInstanceOf[js.Array[A]]
  ...
  inline def union[A](E: Eq[A]): Fn2[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("union")(E.asInstanceOf[js.Any]).asInstanceOf[Fn2[A]]
  ...
  inline def unsafeInsertAt[A](i: Double, a: A, as: js.Array[A]): js.Array[A] = (^.asInstanceOf[js.Dynamic].applyDynamic("unsafeInsertAt")(i.asInstanceOf[js.Any], a.asInstanceOf[js.Any], as.asInstanceOf[js.Any])).asInstanceOf[js.Array[A]]
  ...
  inline def zip[B](bs: js.Array[B]): js.Function1[/* as */ js.Array[js.Any], js.Array[js.Tuple2[js.Any, B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("zip")(bs.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[js.Any], js.Array[js.Tuple2[js.Any, B]]]]
  ...
  object Spanned {
    ...
    extension [Self <: Spanned[?, ?], I, R](x: Self & (Spanned[I, R])) {
      ...
      inline def setInitVarargs(value: I*): Self = StObject.set(x, "init", js.Array(value :_*))
      
      inline def setRest(value: js.Array[R]): Self = StObject.set(x, "rest", value.asInstanceOf[js.Any])
      
      inline def setRestVarargs(value: R*): Self = StObject.set(x, "rest", js.Array(value :_*))
    }
  }
}
