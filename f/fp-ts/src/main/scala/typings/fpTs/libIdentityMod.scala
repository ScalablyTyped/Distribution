...
object libIdentityMod {
  ...
  @JSImport("fp-ts/lib/Identity", "Apply")
  @js.native
  ...
  @JSImport("fp-ts/lib/Identity", "Chain")
  @js.native
  ...
  @JSImport("fp-ts/lib/Identity", "Do")
  @js.native
  ...
  @JSImport("fp-ts/lib/Identity", "Pointed")
  @js.native
