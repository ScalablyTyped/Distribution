...
object recordMod {
  ...
  @scala.inline
  def collect[K /* <: String */, A, B](f: js.Function2[/* k */ K, /* a */ A, B]): js.Function1[/* r */ Record[K, A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("collect")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* r */ Record[K, A], js.Array[B]]]
  ...
  @scala.inline
  def deleteAt[K /* <: String */](k: K): js.Function1[/* r */ Record[String, js.Any], Record[(Exclude[String, K]) | String, js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("deleteAt")(k.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* r */ Record[String, js.Any], Record[(Exclude[String, K]) | String, js.Any]]]
  
  @scala.inline
  def elem[A](E: Eq[A]): Fn13[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("elem")(E.asInstanceOf[js.Any]).asInstanceOf[Fn13[A]]
  ...
  @scala.inline
  def every[A](predicate: Predicate[A]): js.Function1[/* r */ Record[String, A], Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("every")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* r */ Record[String, A], Boolean]]
  ...
  @scala.inline
  def filterMapWithIndex[K /* <: String */, A, B](f: js.Function2[/* key */ K, /* a */ A, Option_[B]]): js.Function1[/* fa */ Record[K, A], Record[String, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filterMapWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Record[K, A], Record[String, B]]]
  
  @scala.inline
  def filterWithIndex[K /* <: String */, A](predicateWithIndex: PredicateWithIndex[K, A]): js.Function1[/* fa */ Record[K, A], Record[String, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filterWithIndex")(predicateWithIndex.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Record[K, A], Record[String, A]]]
  
  @scala.inline
  def filterWithIndex_K_StringAB_A[K /* <: String */, A, B /* <: A */](refinementWithIndex: RefinementWithIndex[K, A, B]): js.Function1[/* fa */ Record[K, A], Record[String, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filterWithIndex")(refinementWithIndex.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Record[K, A], Record[String, B]]]
  ...
  @scala.inline
  def getEq[K /* <: String */, A](E: Eq[A]): Eq[Record[K, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getEq")(E.asInstanceOf[js.Any]).asInstanceOf[Eq[Record[K, A]]]
  
  @scala.inline
  def getMonoid[K /* <: String */, A](S: Semigroup[A]): Monoid[Record[K, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getMonoid")(S.asInstanceOf[js.Any]).asInstanceOf[Monoid[Record[K, A]]]
  
  @scala.inline
  def getShow[A](S: Show[A]): Show[Record[String, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getShow")(S.asInstanceOf[js.Any]).asInstanceOf[Show[Record[String, A]]]
  
  @scala.inline
  def hasOwnProperty_[K /* <: String */](k: String, r: Record[K, js.Any]): /* is K */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("hasOwnProperty")(k.asInstanceOf[js.Any], r.asInstanceOf[js.Any])).asInstanceOf[/* is K */ Boolean]
  
  @scala.inline
  def insertAt[K /* <: String */, A](k: K, a: A): js.Function1[/* r */ Record[String, A], Record[String | K, A]] = (^.asInstanceOf[js.Dynamic].applyDynamic("insertAt")(k.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* r */ Record[String, A], Record[String | K, A]]]
  
  @scala.inline
  def isEmpty(r: Record[String, js.Any]): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEmpty")(r.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @scala.inline
  def isSubrecord[A](E: Eq[A]): Fn12[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("isSubrecord")(E.asInstanceOf[js.Any]).asInstanceOf[Fn12[A]]
  
  @scala.inline
  def keys[K /* <: String */](r: Record[K, js.Any]): js.Array[K] = ^.asInstanceOf[js.Dynamic].applyDynamic("keys")(r.asInstanceOf[js.Any]).asInstanceOf[js.Array[K]]
  
  @scala.inline
  def lookup(k: String): js.Function1[/* r */ Record[String, js.Any], Option_[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("lookup")(k.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* r */ Record[String, js.Any], Option_[js.Any]]]
  @scala.inline
  def lookup[A](k: String, r: Record[String, A]): Option_[A] = (^.asInstanceOf[js.Dynamic].applyDynamic("lookup")(k.asInstanceOf[js.Any], r.asInstanceOf[js.Any])).asInstanceOf[Option_[A]]
  
  @scala.inline
  def map[A, B](f: js.Function1[/* a */ A, B]): js.Function1[/* fa */ Record[String, A], Record[String, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("map")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Record[String, A], Record[String, B]]]
  
  @scala.inline
  def mapWithIndex[K /* <: String */, A, B](f: js.Function2[/* k */ K, /* a */ A, B]): js.Function1[/* fa */ Record[K, A], Record[K, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("mapWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Record[K, A], Record[K, B]]]
  
  @scala.inline
  def modifyAt[A](k: String, f: js.Function1[/* a */ A, A]): js.Function1[/* r */ Record[String, A], Option_[Record[String, A]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("modifyAt")(k.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* r */ Record[String, A], Option_[Record[String, A]]]]
  ...
  @scala.inline
  def reduceRightWithIndex[K /* <: String */, A, B](b: B, f: js.Function3[/* k */ K, /* a */ A, /* b */ B, B]): js.Function1[/* fa */ Record[K, A], B] = (^.asInstanceOf[js.Dynamic].applyDynamic("reduceRightWithIndex")(b.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* fa */ Record[K, A], B]]
  
  @scala.inline
  def reduceWithIndex[K /* <: String */, A, B](b: B, f: js.Function3[/* k */ K, /* b */ B, /* a */ A, B]): js.Function1[/* fa */ Record[K, A], B] = (^.asInstanceOf[js.Dynamic].applyDynamic("reduceWithIndex")(b.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* fa */ Record[K, A], B]]
  ...
  @scala.inline
  def singleton[K /* <: String */, A](k: K, a: A): Record[K, A] = (^.asInstanceOf[js.Dynamic].applyDynamic("singleton")(k.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[Record[K, A]]
  
  @scala.inline
  def size(r: Record[String, js.Any]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("size")(r.asInstanceOf[js.Any]).asInstanceOf[Double]
  
  @scala.inline
  def some[A](predicate: js.Function1[/* a */ A, Boolean]): js.Function1[/* r */ Record[String, A], Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("some")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* r */ Record[String, A], Boolean]]
  
  @scala.inline
  def toArray[K /* <: String */, A](r: Record[K, A]): js.Array[js.Tuple2[K, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("toArray")(r.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Tuple2[K, A]]]
  ...
  @scala.inline
  def updateAt[A](k: String, a: A): js.Function1[/* r */ Record[String, A], Option_[Record[String, A]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("updateAt")(k.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* r */ Record[String, A], Option_[Record[String, A]]]]
