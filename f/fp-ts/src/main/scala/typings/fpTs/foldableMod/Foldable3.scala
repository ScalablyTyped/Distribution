...
object Foldable3 {
  ...
  @scala.inline
  implicit class Foldable3MutableBuilder[Self <: Foldable3[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */] (val x: Self & Foldable3[F]) extends AnyVal {
