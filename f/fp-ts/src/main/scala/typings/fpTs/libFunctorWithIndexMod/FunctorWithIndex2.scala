...
object FunctorWithIndex2 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FunctorWithIndex2[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, I] (val x: Self & (FunctorWithIndex2[F, I])) extends AnyVal {
