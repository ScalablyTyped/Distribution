...
object optionMod {
  ...
  object None_ {
    ...
    @scala.inline
    implicit class None_MutableBuilder[Self <: None_] (val x: Self) extends AnyVal {
      
      @scala.inline
      def set_tag(value: None): Self = StObject.set(x, "_tag", value.asInstanceOf[js.Any])
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.fpTs.optionMod.None_
    - typings.fpTs.optionMod.Some_[A]
  */
  trait Option_[A] extends StObject
  object Option_ {
    
    @scala.inline
    def None_(): typings.fpTs.optionMod.None_ = {
      val __obj = js.Dynamic.literal(_tag = "None")
      __obj.asInstanceOf[typings.fpTs.optionMod.None_]
    }
    
    @scala.inline
    def Some_[A](value: A): typings.fpTs.optionMod.Some_[A] = {
      val __obj = js.Dynamic.literal(_tag = "Some", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fpTs.optionMod.Some_[A]]
    }
  }
  ...
  object Some_ {
    ...
    @scala.inline
    def apply[A](value: A): Some_[A] = {
      val __obj = js.Dynamic.literal(_tag = "Some", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[Some_[A]]
    }
    
    @scala.inline
    implicit class Some_MutableBuilder[Self <: Some_[?], A] (val x: Self & Some_[A]) extends AnyVal {
      
      @scala.inline
      def setValue(value: A): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
      
      @scala.inline
      def set_tag(value: Some): Self = StObject.set(x, "_tag", value.asInstanceOf[js.Any])
    }
  }
}
