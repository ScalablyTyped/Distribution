...
object libStateReaderTaskEitherMod {
  
  @JSImport("fp-ts/lib/StateReaderTaskEither", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/lib/StateReaderTaskEither", "Alt")
  @js.native
  val Alt_ : Alt4[typings.fpTs.libStateReaderTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/StateReaderTaskEither", "Applicative")
  @js.native
  val Applicative: Applicative4[typings.fpTs.libStateReaderTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/StateReaderTaskEither", "Apply")
  @js.native
  val Apply: Apply4[typings.fpTs.libStateReaderTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/StateReaderTaskEither", "Bifunctor")
  @js.native
  val Bifunctor: Bifunctor4[typings.fpTs.libStateReaderTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/StateReaderTaskEither", "Chain")
  @js.native
  val Chain_ : Chain4[typings.fpTs.libStateReaderTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/StateReaderTaskEither", "FromEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/StateReaderTaskEither", "FromReader")
  @js.native
  val FromReader_ : FromReader4[typings.fpTs.libStateReaderTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/StateReaderTaskEither", "FromState")
  @js.native
  ...
  type StateReaderTaskEither_[S, R, E, A] = js.Function1[/* s */ S, ReaderTaskEither_[R, E, js.Tuple2[A, S]]]
}
