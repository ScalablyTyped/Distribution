...
object ordering {
  ...
  @js.native
  val Eq: typings.fpTs.libEqMod.Eq[Ordering] = js.native
  
  @JSImport("fp-ts", "ordering.Monoid")
  @js.native
  val Monoid: typings.fpTs.libMonoidMod.Monoid[Ordering] = js.native
  
  @JSImport("fp-ts", "ordering.Semigroup")
  @js.native
  val Semigroup: typings.fpTs.libSemigroupMod.Semigroup[Ordering] = js.native
  
  @JSImport("fp-ts", "ordering.eqOrdering")
  @js.native
  val eqOrdering: typings.fpTs.libEqMod.Eq[Ordering] = js.native
  ...
  @js.native
  val monoidOrdering: typings.fpTs.libMonoidMod.Monoid[Ordering] = js.native
  ...
  @js.native
  val semigroupOrdering: typings.fpTs.libSemigroupMod.Semigroup[Ordering] = js.native
