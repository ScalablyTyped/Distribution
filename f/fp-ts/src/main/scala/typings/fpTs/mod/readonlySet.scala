...
object readonlySet {
  ...
  inline def difference[A](E: Eq[A]): Fn11[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("difference")(E.asInstanceOf[js.Any]).asInstanceOf[Fn11[A]]
  ...
  inline def every[A](predicate: Predicate[A]): js.Function1[/* set */ ReadonlySet[A], Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("every")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* set */ ReadonlySet[A], Boolean]]
  ...
  inline def filter_AB_A[A, B /* <: A */](refinement: Refinement[A, B]): js.Function1[/* set */ ReadonlySet[A], ReadonlySet[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(refinement.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* set */ ReadonlySet[A], ReadonlySet[B]]]
  ...
  inline def intersection[A](E: Eq[A]): Fn11[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersection")(E.asInstanceOf[js.Any]).asInstanceOf[Fn11[A]]
  
  inline def isSubset[A](E: Eq[A]): Fn10[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("isSubset")(E.asInstanceOf[js.Any]).asInstanceOf[Fn10[A]]
  ...
  inline def partition[A](predicate: Predicate[A]): js.Function1[/* set */ ReadonlySet[A], Separated[ReadonlySet[A], ReadonlySet[A]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("partition")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* set */ ReadonlySet[A], Separated[ReadonlySet[A], ReadonlySet[A]]]]
  ...
  inline def partition_AB_A[A, B /* <: A */](refinement: Refinement[A, B]): js.Function1[/* set */ ReadonlySet[A], Separated[ReadonlySet[A], ReadonlySet[B]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("partition")(refinement.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* set */ ReadonlySet[A], Separated[ReadonlySet[A], ReadonlySet[B]]]]
  ...
  inline def separate[E, A](EE: Eq[E], EA: Eq[A]): js.Function1[/* fa */ ReadonlySet[Either_[E, A]], Separated[ReadonlySet[E], ReadonlySet[A]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("separate")(EE.asInstanceOf[js.Any], EA.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* fa */ ReadonlySet[Either_[E, A]], Separated[ReadonlySet[E], ReadonlySet[A]]]]
  ...
  inline def union[A](E: Eq[A]): Fn11[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("union")(E.asInstanceOf[js.Any]).asInstanceOf[Fn11[A]]
}
