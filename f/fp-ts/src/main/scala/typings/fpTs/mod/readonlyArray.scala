...
object readonlyArray {
  ...
  @JSImport("fp-ts", "readonlyArray.Apply")
  @js.native
  val Apply: Apply1[typings.fpTs.readonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts", "readonlyArray.ChainRecBreadthFirst")
  @js.native
  val ChainRecBreadthFirst_ : ChainRec1[typings.fpTs.readonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts", "readonlyArray.ChainRecDepthFirst")
  @js.native
  val ChainRecDepthFirst_ : ChainRec1[typings.fpTs.readonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts", "readonlyArray.Chain")
  @js.native
  val Chain_ : Chain1[typings.fpTs.readonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts", "readonlyArray.Compactable")
  @js.native
  val Compactable: Compactable1[typings.fpTs.readonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts", "readonlyArray.Do")
  @js.native
  ...
  @JSImport("fp-ts", "readonlyArray.FromEither")
  @js.native
  val FromEither_ : FromEither1[typings.fpTs.readonlyArrayMod.URI] = js.native
  ...
  @JSImport("fp-ts", "readonlyArray.Pointed")
  @js.native
  val Pointed: Pointed1[typings.fpTs.readonlyArrayMod.URI] = js.native
  ...
  @js.native
  val Zero_ : Zero1[typings.fpTs.readonlyArrayMod.URI] = js.native
  ...
  inline def difference[A](E: Eq[A]): Fn20[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("difference")(E.asInstanceOf[js.Any]).asInstanceOf[Fn20[A]]
  ...
  @JSImport("fp-ts", "readonlyArray.filterE")
  @js.native
  ...
  @JSImport("fp-ts", "readonlyArray.fromEither")
  @js.native
  val fromEither: NaturalTransformation21[typings.fpTs.eitherMod.URI, typings.fpTs.readonlyArrayMod.URI] = js.native
  ...
  @JSImport("fp-ts", "readonlyArray.fromOption")
  @js.native
  val fromOption: NaturalTransformation11[typings.fpTs.optionMod.URI, typings.fpTs.readonlyArrayMod.URI] = js.native
  ...
  inline def intersection[A](E: Eq[A]): Fn20[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersection")(E.asInstanceOf[js.Any]).asInstanceOf[Fn20[A]]
  ...
  inline def union[A](E: Eq[A]): Fn20[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("union")(E.asInstanceOf[js.Any]).asInstanceOf[Fn20[A]]
