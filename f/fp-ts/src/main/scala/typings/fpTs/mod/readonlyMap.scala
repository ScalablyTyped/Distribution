...
object readonlyMap {
  ...
  inline def deleteAt[K](E: Eq[K]): js.Function1[/* k */ K, js.Function1[/* m */ ReadonlyMap[K, js.Any], ReadonlyMap[K, js.Any]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("deleteAt")(E.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* k */ K, js.Function1[/* m */ ReadonlyMap[K, js.Any], ReadonlyMap[K, js.Any]]]]
  
  inline def elem[A](E: Eq[A]): Fn4[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("elem")(E.asInstanceOf[js.Any]).asInstanceOf[Fn4[A]]
  
  @JSImport("fp-ts", "readonlyMap.empty")
  @js.native
  val empty: ReadonlyMap[scala.Nothing, scala.Nothing] = js.native
  
  inline def filter[A](predicate: Predicate[A]): js.Function1[/* fa */ ReadonlyMap[js.Any, A], ReadonlyMap[js.Any, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ ReadonlyMap[js.Any, A], ReadonlyMap[js.Any, A]]]
  
  inline def filterMap[A, B](f: js.Function1[/* a */ A, Option_[B]]): js.Function1[/* fa */ ReadonlyMap[js.Any, A], ReadonlyMap[js.Any, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filterMap")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ ReadonlyMap[js.Any, A], ReadonlyMap[js.Any, B]]]
  
  inline def filter_AB_A[A, B /* <: A */](refinement: Refinement[A, B]): js.Function1[/* fa */ ReadonlyMap[js.Any, A], ReadonlyMap[js.Any, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(refinement.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ ReadonlyMap[js.Any, A], ReadonlyMap[js.Any, B]]]
  ...
  inline def isEmpty[K, A](d: ReadonlyMap[K, A]): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEmpty")(d.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  inline def isSubmap[K, A](SK: Eq[K], SA: Eq[A]): Fn7[K, A] = (^.asInstanceOf[js.Dynamic].applyDynamic("isSubmap")(SK.asInstanceOf[js.Any], SA.asInstanceOf[js.Any])).asInstanceOf[Fn7[K, A]]
  
  inline def keys[K](O: Ord_[K]): js.Function1[/* m */ ReadonlyMap[K, js.Any], js.Array[K]] = ^.asInstanceOf[js.Dynamic].applyDynamic("keys")(O.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* m */ ReadonlyMap[K, js.Any], js.Array[K]]]
  
  inline def lookup[K](E: Eq[K]): Fn6[K] = ^.asInstanceOf[js.Dynamic].applyDynamic("lookup")(E.asInstanceOf[js.Any]).asInstanceOf[Fn6[K]]
  
  inline def lookupWithKey[K](E: Eq[K]): Fn5[K] = ^.asInstanceOf[js.Dynamic].applyDynamic("lookupWithKey")(E.asInstanceOf[js.Any]).asInstanceOf[Fn5[K]]
  
  inline def map[A, B](f: js.Function1[/* a */ A, B]): js.Function1[/* fa */ ReadonlyMap[js.Any, A], ReadonlyMap[js.Any, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("map")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ ReadonlyMap[js.Any, A], ReadonlyMap[js.Any, B]]]
  ...
  inline def member[K](E: Eq[K]): Fn3[K] = ^.asInstanceOf[js.Dynamic].applyDynamic("member")(E.asInstanceOf[js.Any]).asInstanceOf[Fn3[K]]
  ...
  inline def separate[K, A, B](fa: ReadonlyMap[K, Either_[A, B]]): Separated[ReadonlyMap[K, A], ReadonlyMap[K, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("separate")(fa.asInstanceOf[js.Any]).asInstanceOf[Separated[ReadonlyMap[K, A], ReadonlyMap[K, B]]]
  ...
  inline def size[K, A](d: ReadonlyMap[K, A]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("size")(d.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  inline def toReadonlyArray[K](O: Ord_[K]): js.Function1[/* m */ ReadonlyMap[K, js.Any], js.Array[js.Tuple2[K, js.Any]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("toReadonlyArray")(O.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* m */ ReadonlyMap[K, js.Any], js.Array[js.Tuple2[K, js.Any]]]]
  ...
  inline def toUnfoldable[K, F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */](ord: Ord_[K], U: Unfoldable1[F]): js.Function1[
    /* d */ ReadonlyMap[K, js.Any], 
  ...
  inline def values[A](O: Ord_[A]): js.Function1[/* m */ ReadonlyMap[js.Any, A], js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("values")(O.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* m */ ReadonlyMap[js.Any, A], js.Array[A]]]
