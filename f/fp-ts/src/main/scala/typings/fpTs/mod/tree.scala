...
import typings.fpTs.treeMod.Forest
import typings.fpTs.treeMod.Tree_
...
object tree {
  ...
  @JSImport("fp-ts", "tree.Applicative")
  @js.native
  val Applicative: Applicative1[typings.fpTs.treeMod.URI] = js.native
  
  @JSImport("fp-ts", "tree.Comonad")
  @js.native
  val Comonad: Comonad1[typings.fpTs.treeMod.URI] = js.native
  
  @JSImport("fp-ts", "tree.Foldable")
  @js.native
  val Foldable: Foldable1[typings.fpTs.treeMod.URI] = js.native
  
  @JSImport("fp-ts", "tree.Functor")
  @js.native
  val Functor: Functor1[typings.fpTs.treeMod.URI] = js.native
  
  @JSImport("fp-ts", "tree.Monad")
  @js.native
  val Monad: Monad1[typings.fpTs.treeMod.URI] = js.native
  
  @JSImport("fp-ts", "tree.Traversable")
  @js.native
  val Traversable: Traversable1[typings.fpTs.treeMod.URI] = js.native
  
  @JSImport("fp-ts", "tree.URI")
  @js.native
  val URI: /* "Tree" */ String = js.native
  
  inline def ap[A](fa: Tree_[A]): js.Function1[/* fab */ Tree_[js.Function1[/* a */ A, js.Any]], Tree_[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("ap")(fa.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fab */ Tree_[js.Function1[/* a */ A, js.Any]], Tree_[js.Any]]]
  
  inline def apFirst[B](fb: Tree_[B]): js.Function1[/* fa */ Tree_[js.Any], Tree_[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("apFirst")(fb.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Tree_[js.Any], Tree_[js.Any]]]
  
  inline def apS[A, N /* <: String */, B](name: Exclude[N, /* keyof A */ String], fb: Tree_[B]): js.Function1[
    /* fa */ Tree_[A], 
    Tree_[
  ...
  inline def apSecond[B](fb: Tree_[B]): js.Function1[/* fa */ Tree_[js.Any], Tree_[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("apSecond")(fb.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Tree_[js.Any], Tree_[B]]]
  ...
  inline def chainFirst[A, B](f: js.Function1[/* a */ A, Tree_[B]]): js.Function1[/* ma */ Tree_[A], Tree_[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainFirst")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ Tree_[A], Tree_[A]]]
  ...
  inline def foldMap[M](M: Monoid[M]): js.Function1[/* f */ js.Function1[/* a */ js.Any, M], js.Function1[/* fa */ Tree_[js.Any], M]] = ^.asInstanceOf[js.Dynamic].applyDynamic("foldMap")(M.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* f */ js.Function1[/* a */ js.Any, M], js.Function1[/* fa */ Tree_[js.Any], M]]]
  ...
  inline def unfoldForestM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */](M: Monad1[M]): js.Function2[
    /* bs */ js.Array[js.Any], 
    /* f */ js.Function1[
      /* b */ js.Any, 
  ...
  inline def unfoldForestM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */](M: Monad2[M]): js.Function2[
    /* bs */ js.Array[js.Any], 
    /* f */ js.Function1[
      /* b */ js.Any, 
  ...
  inline def unfoldForestM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */](M: Monad3[M]): js.Function2[
    /* bs */ js.Array[js.Any], 
    /* f */ js.Function1[
      /* b */ js.Any, 
  ...
  inline def unfoldForestM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, E](M: Monad2C[M, E]): js.Function2[
    /* bs */ js.Array[js.Any], 
    /* f */ js.Function1[
      /* b */ js.Any, 
  ...
  inline def unfoldForestM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, E](M: Monad3C[M, E]): js.Function2[
    /* bs */ js.Array[js.Any], 
    /* f */ js.Function1[
      /* b */ js.Any, 
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind3<M, R, E, [A, Array<B>]> */ js.Any
  ...
  inline def unfoldTreeM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */](M: Monad1[M]): js.Function2[
    /* b */ js.Any, 
    /* f */ js.Function1[
      /* b */ js.Any, 
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind<M, [A, Array<B>]> */ js.Any
  ...
  inline def unfoldTreeM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */](M: Monad2[M]): js.Function2[
    /* b */ js.Any, 
    /* f */ js.Function1[
      /* b */ js.Any, 
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind2<M, E, [A, Array<B>]> */ js.Any
  ...
  inline def unfoldTreeM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */](M: Monad3[M]): js.Function2[
    /* b */ js.Any, 
    /* f */ js.Function1[
      /* b */ js.Any, 
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind3<M, R, E, [A, Array<B>]> */ js.Any
  ...
  inline def unfoldTreeM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, E](M: Monad2C[M, E]): js.Function2[
    /* b */ js.Any, 
    /* f */ js.Function1[
      /* b */ js.Any, 
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind2<M, E, [A, Array<B>]> */ js.Any
  ...
  inline def unfoldTreeM[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, E](M: Monad3C[M, E]): js.Function2[
    /* b */ js.Any, 
    /* f */ js.Function1[
      /* b */ js.Any, 
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind3<M, R, E, [A, Array<B>]> */ js.Any
