...
object functor {
  ...
  @scala.inline
  def getFunctorComposition[F, G](F: Functor[F], G: Functor[G]): FunctorComposition[F, G] = (^.asInstanceOf[js.Dynamic].applyDynamic("getFunctorComposition")(F.asInstanceOf[js.Any], G.asInstanceOf[js.Any])).asInstanceOf[FunctorComposition[F, G]]
  @scala.inline
