...
import typings.fpTs.anon.Init
import typings.fpTs.anon.Rest
...
object array {
  ...
  @scala.inline
  def chainWithIndex[A, B](f: js.Function2[/* index */ Double, /* a */ A, js.Array[B]]): js.Function1[/* ma */ js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ js.Array[A], js.Array[B]]]
  
  @scala.inline
  def chop[A, B](f: js.Function1[/* as */ NonEmptyArray_[A], js.Tuple2[B, js.Array[A]]]): js.Function1[/* as */ js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chop")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], js.Array[B]]]
  ...
  @scala.inline
  def cons[A](head: A): js.Function1[/* tail */ js.Array[A], NonEmptyArray_[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("cons")(head.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* tail */ js.Array[A], NonEmptyArray_[A]]]
  @scala.inline
  ...
  @scala.inline
  def copy[A](as: js.Array[A]): js.Array[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("copy")(as.asInstanceOf[js.Any]).asInstanceOf[js.Array[A]]
  ...
  @scala.inline
  def difference[A](E: Eq[A]): FnCallXsYs[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("difference")(E.asInstanceOf[js.Any]).asInstanceOf[FnCallXsYs[A]]
  ...
  @scala.inline
  def elem[A](E: Eq[A]): FnCall[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("elem")(E.asInstanceOf[js.Any]).asInstanceOf[FnCall[A]]
  ...
  @scala.inline
  def intersection[A](E: Eq[A]): FnCallXsYs[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersection")(E.asInstanceOf[js.Any]).asInstanceOf[FnCallXsYs[A]]
  ...
  @scala.inline
  def isNonEmpty[A](as: js.Array[A]): /* is fp-ts.fp-ts/lib/NonEmptyArray.NonEmptyArray<A> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNonEmpty")(as.asInstanceOf[js.Any]).asInstanceOf[/* is fp-ts.fp-ts/lib/NonEmptyArray.NonEmptyArray<A> */ Boolean]
  ...
  @scala.inline
  def spanLeft[A](predicate: Predicate[A]): js.Function1[/* as */ js.Array[A], Rest[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("spanLeft")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], Rest[A]]]
  
  @scala.inline
  def spanLeft_AB_A[A, B /* <: A */](refinement: Refinement[A, B]): js.Function1[/* as */ js.Array[A], Init[B, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("spanLeft")(refinement.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], Init[B, A]]]
  ...
  @JSImport("fp-ts", "array.unfold")
  @js.native
  val unfold: js.Function2[
    /* b */ js.Any, 
    /* f */ js.Function1[/* b */ js.Any, Option_[js.Tuple2[js.Any, js.Any]]], 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind<F, A> */ js.Any
  ] = js.native
  
  @scala.inline
  def union[A](E: Eq[A]): FnCallXsYs[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("union")(E.asInstanceOf[js.Any]).asInstanceOf[FnCallXsYs[A]]
