...
object array {
  ...
  inline def chainWithIndex[A, B](f: js.Function2[/* index */ Double, /* a */ A, js.Array[B]]): js.Function1[/* ma */ js.Array[A], js.Array[B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("chainWithIndex")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ma */ js.Array[A], js.Array[B]]]
  ...
  inline def spanLeft[A](predicate: Predicate[A]): js.Function1[/* as */ js.Array[A], Rest[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("spanLeft")(predicate.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], Rest[A]]]
  
  inline def spanLeft_AB_A[A, B /* <: A */](refinement: Refinement[A, B]): js.Function1[/* as */ js.Array[A], Init[B, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("spanLeft")(refinement.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* as */ js.Array[A], Init[B, A]]]
