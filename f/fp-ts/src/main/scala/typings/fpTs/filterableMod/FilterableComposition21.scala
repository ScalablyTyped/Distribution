...
object FilterableComposition21 {
  ...
  @scala.inline
  implicit class FilterableComposition21MutableBuilder[Self <: FilterableComposition21[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */] (val x: Self & (FilterableComposition21[F, G])) extends AnyVal {
