...
object FunctorCompositionHKT2C {
  ...
  extension [Self <: FunctorCompositionHKT2C[?, ?, ?], F, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, E](x: Self & (FunctorCompositionHKT2C[F, G, E])) {
