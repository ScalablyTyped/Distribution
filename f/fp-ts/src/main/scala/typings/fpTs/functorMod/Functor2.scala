...
object Functor2 {
  ...
  @scala.inline
  implicit class Functor2MutableBuilder[Self <: Functor2[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */] (val x: Self & Functor2[F]) extends AnyVal {
