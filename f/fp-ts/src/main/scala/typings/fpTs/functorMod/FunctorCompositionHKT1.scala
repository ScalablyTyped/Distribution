...
object FunctorCompositionHKT1 {
  ...
  extension [Self <: FunctorCompositionHKT1[?, ?], F, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */](x: Self & (FunctorCompositionHKT1[F, G])) {
