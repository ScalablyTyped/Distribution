...
object FunctorCompositionHKT2 {
  ...
  @scala.inline
  implicit class FunctorCompositionHKT2MutableBuilder[Self <: FunctorCompositionHKT2[?, ?], F, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */] (val x: Self & (FunctorCompositionHKT2[F, G])) extends AnyVal {
