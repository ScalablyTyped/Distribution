...
object Functor3 {
  ...
  @scala.inline
  implicit class Functor3MutableBuilder[Self <: Functor3[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */] (val x: Self & Functor3[F]) extends AnyVal {
