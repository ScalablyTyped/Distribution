...
object Applicative1 {
  ...
  @scala.inline
  implicit class Applicative1MutableBuilder[Self <: Applicative1[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */] (val x: Self & Applicative1[F]) extends AnyVal {
