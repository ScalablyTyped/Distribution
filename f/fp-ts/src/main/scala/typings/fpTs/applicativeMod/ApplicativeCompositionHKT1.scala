...
object ApplicativeCompositionHKT1 {
  ...
  @scala.inline
  implicit class ApplicativeCompositionHKT1MutableBuilder[Self <: ApplicativeCompositionHKT1[?, ?], F, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */] (val x: Self & (ApplicativeCompositionHKT1[F, G])) extends AnyVal {
