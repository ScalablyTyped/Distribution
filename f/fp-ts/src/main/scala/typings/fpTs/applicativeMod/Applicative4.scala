...
object Applicative4 {
  ...
  @scala.inline
  implicit class Applicative4MutableBuilder[Self <: Applicative4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */] (val x: Self & Applicative4[F]) extends AnyVal {
