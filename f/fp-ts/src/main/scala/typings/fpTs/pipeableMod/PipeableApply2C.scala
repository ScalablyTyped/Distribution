...
object PipeableApply2C {
  ...
  extension [Self <: PipeableApply2C[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, E](x: Self & (PipeableApply2C[F, E])) {
