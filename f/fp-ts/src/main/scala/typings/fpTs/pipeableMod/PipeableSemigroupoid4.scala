...
object PipeableSemigroupoid4 {
  ...
  extension [Self <: PipeableSemigroupoid4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */](x: Self & PipeableSemigroupoid4[F]) {
