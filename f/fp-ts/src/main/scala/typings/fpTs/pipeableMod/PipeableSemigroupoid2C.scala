...
object PipeableSemigroupoid2C {
  ...
  extension [Self <: PipeableSemigroupoid2C[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, E](x: Self & (PipeableSemigroupoid2C[F, E])) {
