...
@js.native
trait PipeableMonadThrow3C[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, E] extends StObject {
  ...
  def fromEither[R, A](ma: Either_[E, A]): js.Any = js.native
