...
trait PipeableFoldableWithIndex3[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I]
  extends StObject
...
object PipeableFoldableWithIndex3 {
  ...
  @scala.inline
  implicit class PipeableFoldableWithIndex3MutableBuilder[Self <: PipeableFoldableWithIndex3[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I] (val x: Self & (PipeableFoldableWithIndex3[F, I])) extends AnyVal {
