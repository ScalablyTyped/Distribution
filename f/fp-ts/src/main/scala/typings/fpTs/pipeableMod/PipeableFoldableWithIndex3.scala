...
object PipeableFoldableWithIndex3 {
  ...
  extension [Self <: PipeableFoldableWithIndex3[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I](x: Self & (PipeableFoldableWithIndex3[F, I])) {
