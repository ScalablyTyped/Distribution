...
@js.native
trait PipeableFilterableWithIndex3C[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, I, E]
  extends StObject
     with PipeableFilterable3C[F, E] {
