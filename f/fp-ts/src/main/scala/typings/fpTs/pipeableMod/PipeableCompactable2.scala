...
object PipeableCompactable2 {
  ...
  extension [Self <: PipeableCompactable2[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */](x: Self & PipeableCompactable2[F]) {
