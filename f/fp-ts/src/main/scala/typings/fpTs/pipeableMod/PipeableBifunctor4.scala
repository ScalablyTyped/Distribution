...
object PipeableBifunctor4 {
  ...
  @scala.inline
  implicit class PipeableBifunctor4MutableBuilder[Self <: PipeableBifunctor4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */] (val x: Self & PipeableBifunctor4[F]) extends AnyVal {
