...
object PipeableChain1 {
  ...
  @scala.inline
  implicit class PipeableChain1MutableBuilder[Self <: PipeableChain1[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */] (val x: Self & PipeableChain1[F]) extends AnyVal {
