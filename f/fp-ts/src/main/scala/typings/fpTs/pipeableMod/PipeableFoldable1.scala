...
object PipeableFoldable1 {
  ...
  extension [Self <: PipeableFoldable1[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ js.Any */](x: Self & PipeableFoldable1[F]) {
