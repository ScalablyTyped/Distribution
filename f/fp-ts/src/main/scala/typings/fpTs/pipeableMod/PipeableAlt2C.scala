...
object PipeableAlt2C {
  ...
  extension [Self <: PipeableAlt2C[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, E](x: Self & (PipeableAlt2C[F, E])) {
