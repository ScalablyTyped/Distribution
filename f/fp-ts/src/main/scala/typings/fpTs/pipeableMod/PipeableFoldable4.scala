...
trait PipeableFoldable4[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */] extends StObject {
...
object PipeableFoldable4 {
  ...
  @scala.inline
  implicit class PipeableFoldable4MutableBuilder[Self <: PipeableFoldable4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */] (val x: Self & PipeableFoldable4[F]) extends AnyVal {
