...
object PipeableFoldable4 {
  ...
  extension [Self <: PipeableFoldable4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */](x: Self & PipeableFoldable4[F]) {
