...
object PipeableProfunctor3 {
  ...
  @scala.inline
  implicit class PipeableProfunctor3MutableBuilder[Self <: PipeableProfunctor3[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */] (val x: Self & PipeableProfunctor3[F]) extends AnyVal {
