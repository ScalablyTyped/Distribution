...
@js.native
trait PipeableMonadThrow2C[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, E] extends StObject {
  ...
  def fromEither[A](ma: Either_[E, A]): js.Any = js.native
