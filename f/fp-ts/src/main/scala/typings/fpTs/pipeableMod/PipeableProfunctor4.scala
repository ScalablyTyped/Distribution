...
object PipeableProfunctor4 {
  ...
  extension [Self <: PipeableProfunctor4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ js.Any */](x: Self & PipeableProfunctor4[F]) {
