...
trait PipeableChain[F]
  ...
  def flatten[A](
    mma: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HKT<F, HKT<F, A>> */ js.Any
  ): js.Any
}
object PipeableChain {
  ...
  inline def apply[F](
    ...
    flatten: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HKT<F, HKT<F, A>> */ js.Any => js.Any,
