...
object CompactableComposition23C {
  ...
  @scala.inline
  implicit class CompactableComposition23CMutableBuilder[Self <: CompactableComposition23C[?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ js.Any */, E] (val x: Self & (CompactableComposition23C[F, G, E])) extends AnyVal {
