...
object readerTaskEitherMod {
  ...
  inline def filterOrElseW_AB_AE2[A, B /* <: A */, E2](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E2]): js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElseW")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, Any, A], ReaderTaskEither_[Any, Any | E2, B]]]
  
  inline def filterOrElse_EAB_A[E, A, B /* <: A */](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElse")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ ReaderTaskEither_[Any, E, A], ReaderTaskEither_[Any, E, B]]]
  ...
  @JSImport("fp-ts/lib/ReaderTaskEither", "fromIOEither")
  @js.native
  ...
  inline def fromPredicate_EAB_A[E, A, B /* <: A */](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* a */ A, ReaderTaskEither_[Any, E, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* a */ A, ReaderTaskEither_[Any, E, B]]]
  
  @JSImport("fp-ts/lib/ReaderTaskEither", "fromReader")
  @js.native
  val fromReader: NaturalTransformation23R[typings.fpTs.readerMod.URI, typings.fpTs.readerTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/ReaderTaskEither", "fromReaderEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/ReaderTaskEither", "fromTaskEither")
  @js.native
