...
object Compactable4 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Compactable4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ Any */] (val x: Self & Compactable4[F]) extends AnyVal {
