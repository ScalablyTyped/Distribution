...
object Compactable3 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Compactable3[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */] (val x: Self & Compactable3[F]) extends AnyVal {
