...
object CompactableComposition22C {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CompactableComposition22C[?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, G /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, E] (val x: Self & (CompactableComposition22C[F, G, E])) extends AnyVal {
