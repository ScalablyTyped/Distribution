...
object Compactable1 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Compactable1[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */] (val x: Self & Compactable1[F]) extends AnyVal {
