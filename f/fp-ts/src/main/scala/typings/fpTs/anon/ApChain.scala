...
object ApChain {
  ...
  @scala.inline
  def apply[W, M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */](
    _E: W,
  ...
  @scala.inline
  implicit class ApChainMutableBuilder[Self <: ApChain[?, ?], W, M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ js.Any */] (val x: Self & (ApChain[W, M])) extends AnyVal {
    ...
    @scala.inline
    def setOf(value: js.Any => WriterT2[M, js.Any, W, js.Any]): Self = StObject.set(x, "of", js.Any.fromFunction1(value))
