...
object FoldableWithIndex2C {
  ...
  extension [Self <: FoldableWithIndex2C[?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, I, E](x: Self & (FoldableWithIndex2C[F, I, E])) {
