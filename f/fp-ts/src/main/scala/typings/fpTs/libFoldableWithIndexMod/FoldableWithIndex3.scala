...
object FoldableWithIndex3 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FoldableWithIndex3[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */, I] (val x: Self & (FoldableWithIndex3[F, I])) extends AnyVal {
