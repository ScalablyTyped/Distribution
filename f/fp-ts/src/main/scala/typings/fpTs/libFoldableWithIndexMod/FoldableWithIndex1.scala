...
object FoldableWithIndex1 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FoldableWithIndex1[?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */, I] (val x: Self & (FoldableWithIndex1[F, I])) extends AnyVal {
