...
object Foldable4 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Foldable4[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ Any */] (val x: Self & Foldable4[F]) extends AnyVal {
