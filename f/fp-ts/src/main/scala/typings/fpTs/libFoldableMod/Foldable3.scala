...
object Foldable3 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Foldable3[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */] (val x: Self & Foldable3[F]) extends AnyVal {
