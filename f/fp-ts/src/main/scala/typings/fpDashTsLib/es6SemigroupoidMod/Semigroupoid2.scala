...
trait Semigroupoid2[F /* <: fpDashTsLib.es6HKTMod.URIS2 */] extends js.Object {
  val URI: F
  def compose[L, A, B](ab: fpDashTsLib.es6HKTMod.Kind2[F, A, B], la: fpDashTsLib.es6HKTMod.Kind2[F, L, A]): fpDashTsLib.es6HKTMod.Kind2[F, L, B]
}
...
object Semigroupoid2 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    URI: F,
    compose: (fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Any], fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Any]
  ): Semigroupoid2[F] = {
