...
trait Sequence2C[T /* <: fpDashTsLib.libHKTMod.URIS2 */, TL] extends js.Object {
  def apply(
    ...
    /* ta */ fpDashTsLib.libHKTMod.Type2[T, TL, fpDashTsLib.libHKTMod.Type[fpDashTsLib.fpDashTsLibStrings.StrMap, _]], 
    fpDashTsLib.libHKTMod.Type[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libHKTMod.Type2[T, TL, _]]
  ] = js.native
  def apply(
    ...
    /* ta */ fpDashTsLib.libHKTMod.Type2[T, TL, fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, _, _]], 
    fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, _, fpDashTsLib.libHKTMod.Type2[T, TL, _]]
  ] = js.native
  def apply(
    ...
    /* ta */ fpDashTsLib.libHKTMod.Type2[
      T, 
      TL, 
    ...
    fpDashTsLib.libHKTMod.Type3[
      ...
      _, 
      _, 
      fpDashTsLib.libHKTMod.Type2[T, TL, _]
    ]
  ] = js.native
  ...
  def apply[FL](
    ...
    /* ta */ fpDashTsLib.libHKTMod.Type2[T, TL, fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, FL, _]], 
    fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, FL, fpDashTsLib.libHKTMod.Type2[T, TL, _]]
  ] = js.native
  def apply[FU, FL](
