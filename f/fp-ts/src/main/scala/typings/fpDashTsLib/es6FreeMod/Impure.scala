...
@JSImport("fp-ts/es6/Free", "Impure")
@js.native
class Impure[F, A, X] protected () extends js.Object {
  def this(fx: fpDashTsLib.es6HKTMod.HKT[F, X], f: js.Function1[/* x */ X, Free[F, A]]) = this()
  val _A: A = js.native
  val _L: F = js.native
  val _URI: URI = js.native
  val _tag: fpDashTsLib.fpDashTsLibStrings.Impure = js.native
  val fx: fpDashTsLib.es6HKTMod.HKT[F, X] = js.native
  ...
  def isImpure(): /* is fp-ts.fp-ts/es6/Free.Impure<F, A, X> */ scala.Boolean = js.native
