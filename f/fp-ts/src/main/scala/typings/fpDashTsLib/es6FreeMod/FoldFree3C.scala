...
trait FoldFree3C[M /* <: fpDashTsLib.es6HKTMod.URIS3 */, U, L] extends js.Object {
  def apply[A](
    nt: js.Function1[
      (/* fa */ fpDashTsLib.es6HKTMod.Type[
        ...
        _
      ]) | (/* fa */ fpDashTsLib.es6HKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Free, L, _]) | (/* fa */ fpDashTsLib.es6HKTMod.Type3[
        fpDashTsLib.fpDashTsLibStrings.IxIO | fpDashTsLib.fpDashTsLibStrings.ReaderTaskEither, 
        U, 
        L, 
        _
      ]), 
      fpDashTsLib.es6HKTMod.Type3[M, U, L, _]
    ],
    fa: Free[
  ...
  ): fpDashTsLib.es6HKTMod.Type3[M, U, L, A] = js.native
}
