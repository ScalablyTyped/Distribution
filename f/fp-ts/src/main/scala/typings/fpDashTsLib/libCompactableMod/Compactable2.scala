...
trait Compactable2[F /* <: fpDashTsLib.libHKTMod.URIS2 */] extends js.Object {
  ...
  def separate[L, A, B](fa: fpDashTsLib.libHKTMod.Kind2[F, L, fpDashTsLib.libEitherMod.Either[A, B]]): Separated[fpDashTsLib.libHKTMod.Kind2[F, L, A], fpDashTsLib.libHKTMod.Kind2[F, L, B]]
}
...
object Compactable2 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */](
    ...
    separate: fpDashTsLib.libHKTMod.Kind2[F, js.Any, fpDashTsLib.libEitherMod.Either[js.Any, js.Any]] => Separated[
