...
trait Compactable2C[F /* <: fpDashTsLib.libHKTMod.URIS2 */, L] extends js.Object {
  ...
  def separate[A, B](fa: fpDashTsLib.libHKTMod.Kind2[F, L, fpDashTsLib.libEitherMod.Either[A, B]]): Separated[fpDashTsLib.libHKTMod.Kind2[F, L, A], fpDashTsLib.libHKTMod.Kind2[F, L, B]]
}
...
object Compactable2C {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */, L](
    ...
    separate: fpDashTsLib.libHKTMod.Kind2[F, L, fpDashTsLib.libEitherMod.Either[js.Any, js.Any]] => Separated[
