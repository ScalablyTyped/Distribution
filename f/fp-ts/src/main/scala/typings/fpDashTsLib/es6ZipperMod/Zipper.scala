...
@JSImport("fp-ts/es6/Zipper", "Zipper")
@js.native
class Zipper[A] protected () extends js.Object {
  ...
  /**
    ...
    * @since 1.9.0
    */
  def deleteLeft(): fpDashTsLib.es6OptionMod.Option[Zipper[A]] = js.native
  /**
    * Deletes the element at focus and moves the focus to the right. If there is no element on the right,
    * focus is moved to the left.
    * @since 1.9.0
    */
  def deleteRight(): fpDashTsLib.es6OptionMod.Option[Zipper[A]] = js.native
  /**
    * @since 1.9.0
    */
  def down(): fpDashTsLib.es6OptionMod.Option[Zipper[A]] = js.native
  /**
  ...
  /**
    ...
    * @since 1.9.0
    */
  def move(f: js.Function1[/* currentIndex */ scala.Double, scala.Double]): fpDashTsLib.es6OptionMod.Option[Zipper[A]] = js.native
  /**
    * @since 1.9.0
    */
  ...
  /**
    * @since 1.9.0
    */
  def up(): fpDashTsLib.es6OptionMod.Option[Zipper[A]] = js.native
  /**
