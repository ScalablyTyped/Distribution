...
trait Filterable3C[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, U, L]
  ...
  def filter[A](fa: fpDashTsLib.es6HKTMod.Type3[F, U, L, A], predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): fpDashTsLib.es6HKTMod.Type3[F, U, L, A] = js.native
  def filterMap[A, B](
  ...
  def partition[A](fa: fpDashTsLib.es6HKTMod.Type3[F, U, L, A], predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): fpDashTsLib.es6CompactableMod.Separated[fpDashTsLib.es6HKTMod.Type3[F, U, L, A], fpDashTsLib.es6HKTMod.Type3[F, U, L, A]] = js.native
