...
trait Chain1[F /* <: fpDashTsLib.es6HKTMod.URIS */]
  ...
  def chain[A, B](fa: fpDashTsLib.es6HKTMod.Kind[F, A], f: js.Function1[/* a */ A, fpDashTsLib.es6HKTMod.Kind[F, B]]): fpDashTsLib.es6HKTMod.Kind[F, B]
}
...
object Chain1 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */](
    ...
    chain: (fpDashTsLib.es6HKTMod.Kind[F, js.Any], js.Function1[js.Any, fpDashTsLib.es6HKTMod.Kind[F, js.Any]]) => fpDashTsLib.es6HKTMod.Kind[F, js.Any],
