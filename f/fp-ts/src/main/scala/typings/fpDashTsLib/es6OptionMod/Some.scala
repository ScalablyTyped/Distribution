...
@JSImport("fp-ts/es6/Option", "Some")
@js.native
class Some[A] protected () extends Option[A] {
  ...
  def contains(S: fpDashTsLib.es6SetoidMod.Setoid[A], a: A): scala.Boolean = js.native
  ...
  def filter(p: fpDashTsLib.es6FunctionMod.Predicate[A]): Option[A] = js.native
  @JSName("filter")
  def filter_BA[B /* <: A */](p: fpDashTsLib.es6FunctionMod.Refinement[A, B]): Option[B] = js.native
  ...
  def isNone(): /* is fp-ts.fp-ts/es6/Option.None<A> */ scala.Boolean = js.native
  def isSome(): /* is fp-ts.fp-ts/es6/Option.Some<A> */ scala.Boolean = js.native
  ...
  def orElse(fa: fpDashTsLib.es6FunctionMod.Lazy[Option[A]]): Option[A] = js.native
  def reduce[B](b: B, f: js.Function2[/* b */ B, /* a */ A, B]): B = js.native
  def refine[B /* <: A */](refinement: fpDashTsLib.es6FunctionMod.Refinement[A, B]): Option[B] = js.native
