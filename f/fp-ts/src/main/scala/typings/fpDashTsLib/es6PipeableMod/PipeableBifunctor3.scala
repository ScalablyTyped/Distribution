...
trait PipeableBifunctor3[F /* <: fpDashTsLib.es6HKTMod.URIS3 */] extends js.Object {
  def bimap[L, A, M, B](f: js.Function1[/* l */ L, M], g: js.Function1[/* a */ A, B]): js.Function1[
    /* fa */ fpDashTsLib.es6HKTMod.Kind3[F, _, L, A], 
    fpDashTsLib.es6HKTMod.Kind3[F, _, M, B]
  ]
  def mapLeft[L, A, M](f: js.Function1[/* l */ L, M]): js.Function1[
    /* fa */ fpDashTsLib.es6HKTMod.Kind3[F, _, L, A], 
    fpDashTsLib.es6HKTMod.Kind3[F, _, M, A]
  ]
}
...
object PipeableBifunctor3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */](
    bimap: (js.Function1[js.Any, js.Any], js.Function1[js.Any, js.Any]) => js.Function1[
      /* fa */ fpDashTsLib.es6HKTMod.Kind3[F, _, js.Any, js.Any], 
      fpDashTsLib.es6HKTMod.Kind3[F, _, js.Any, js.Any]
    ],
