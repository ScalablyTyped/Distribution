...
trait PipeableFoldableWithIndex3[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, I] extends PipeableFoldable3[F] {
  ...
  def reduceRightWithIndex[A, B](b: B, f: js.Function3[/* i */ I, /* a */ A, /* b */ B, B]): js.Function1[/* fa */ fpDashTsLib.es6HKTMod.Kind3[F, _, _, A], B]
  def reduceWithIndex[A, B](b: B, f: js.Function3[/* i */ I, /* b */ B, /* a */ A, B]): js.Function1[/* fa */ fpDashTsLib.es6HKTMod.Kind3[F, _, _, A], B]
}
...
object PipeableFoldableWithIndex3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, I](
    ...
    reduceRightWithIndex: (js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Function1[/* fa */ fpDashTsLib.es6HKTMod.Kind3[F, _, _, js.Any], js.Any],
    reduceWithIndex: (js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Function1[/* fa */ fpDashTsLib.es6HKTMod.Kind3[F, _, _, js.Any], js.Any]
