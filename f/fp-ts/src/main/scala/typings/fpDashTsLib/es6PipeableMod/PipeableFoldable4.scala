...
trait PipeableFoldable4[F /* <: fpDashTsLib.es6HKTMod.URIS4 */] extends js.Object {
  ...
  def reduce[A, B](b: B, f: js.Function2[/* b */ B, /* a */ A, B]): js.Function1[/* fa */ fpDashTsLib.es6HKTMod.Kind4[F, _, _, _, A], B]
  def reduceRight[A, B](b: B, f: js.Function2[/* a */ A, /* b */ B, B]): js.Function1[/* fa */ fpDashTsLib.es6HKTMod.Kind4[F, _, _, _, A], B]
}
