...
object ^ extends js.Object {
  ...
  def leftIO[E](me: fpDashTsLib.es6IOMod.IO[E]): IOEither[E, scala.Nothing] = js.native
  ...
  def rightIO[A](ma: fpDashTsLib.es6IOMod.IO[A]): IOEither[scala.Nothing, A] = js.native
