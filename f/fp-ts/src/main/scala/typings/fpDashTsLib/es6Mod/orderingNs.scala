...
object orderingNs extends js.Object {
  val eqOrdering: fpDashTsLib.es6EqMod.Eq[fpDashTsLib.es6OrderingMod.Ordering] = js.native
  val semigroupOrdering: fpDashTsLib.es6SemigroupMod.Semigroup[fpDashTsLib.es6OrderingMod.Ordering] = js.native
  val setoidOrdering: fpDashTsLib.es6EqMod.Eq[fpDashTsLib.es6OrderingMod.Ordering] = js.native
