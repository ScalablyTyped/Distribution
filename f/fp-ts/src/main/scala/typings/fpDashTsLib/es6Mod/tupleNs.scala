...
object tupleNs extends js.Object {
  ...
  def getSetoid[L, A](SA: fpDashTsLib.es6SetoidMod.Setoid[L], SB: fpDashTsLib.es6SetoidMod.Setoid[A]): fpDashTsLib.es6SetoidMod.Setoid[fpDashTsLib.es6TupleMod.Tuple[L, A]] = js.native
