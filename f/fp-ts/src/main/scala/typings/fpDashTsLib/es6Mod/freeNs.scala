...
object freeNs extends js.Object {
  ...
  def hoistFree_Eq(
    ...
    /* fa */ fpDashTsLib.es6FreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Eq, _], 
    fpDashTsLib.es6FreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Eq, _]
  ] = js.native
  @JSName("hoistFree")
  ...
  def hoistFree_Ord(
    ...
    /* fa */ fpDashTsLib.es6FreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Ord, _], 
    fpDashTsLib.es6FreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Ord, _]
  ] = js.native
  @JSName("hoistFree")
  def hoistFree_Pair(
    nt: js.Function1[
  ...
  def hoistFree_Record(
    ...
    /* fa */ fpDashTsLib.es6FreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Record, _], 
    fpDashTsLib.es6FreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Record, _]
  ] = js.native
  @JSName("hoistFree")
