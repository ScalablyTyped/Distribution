...
object nonEmptyArray2vNs extends js.Object {
  ...
  /* import warning: parser.TsParser#tsDeclVar $anonfun Dropped List(apFirst, apSecond, chain, chainFirst, duplicate, extend, flatten, foldMap, foldMapWithIndex, map, mapWithIndex, reduce, reduceRight, reduceRightWithIndex, reduceWithIndex) */ def ap[A](fa: fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[A]): js.Function1[
    /* fab */ fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[js.Function1[/* a */ A, _]], 
    fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[_]
  ] = js.native
  ...
  def filter[A](predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): js.Function1[
    /* nea */ fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[A], 
    fpDashTsLib.es6OptionMod.Option[fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[A]]
  ] = js.native
  ...
  def getEq[A](E: fpDashTsLib.es6EqMod.Eq[A]): fpDashTsLib.es6EqMod.Eq[fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[A]] = js.native
  def getSemigroup[A](): fpDashTsLib.es6SemigroupMod.Semigroup[fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[A]] = js.native
  def getSetoid[A](E: fpDashTsLib.es6EqMod.Eq[A]): fpDashTsLib.es6EqMod.Eq[fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[A]] = js.native
  ...
  def group[A](E: fpDashTsLib.es6EqMod.Eq[A]): js.Function1[
  ...
  def groupBy[A](f: js.Function1[/* a */ A, java.lang.String]): js.Function1[
    /* as */ fpDashTsLib.libArrayMod.Global.Array[A], 
    org.scalablytyped.runtime.StringDictionary[fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[A]]
  ] = js.native
  ...
  def of[A](a: A): fpDashTsLib.es6NonEmptyArray2vMod.NonEmptyArray[A] = js.native
