...
object ioEitherNs extends js.Object {
  ...
  def left2v[L](l: L): fpDashTsLib.es6IOEitherMod.IOEither[L, scala.Nothing] = js.native
  def leftIO[E](me: fpDashTsLib.es6IOMod.IO[E]): fpDashTsLib.es6IOEitherMod.IOEither[E, scala.Nothing] = js.native
  ...
  def right2v[A](a: A): fpDashTsLib.es6IOEitherMod.IOEither[scala.Nothing, A] = js.native
  def rightIO[A](ma: fpDashTsLib.es6IOMod.IO[A]): fpDashTsLib.es6IOEitherMod.IOEither[scala.Nothing, A] = js.native
