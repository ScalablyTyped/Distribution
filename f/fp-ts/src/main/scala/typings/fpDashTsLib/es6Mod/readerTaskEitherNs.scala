...
object readerTaskEitherNs extends js.Object {
  ...
  def left2v[E, L](e: L): fpDashTsLib.es6ReaderTaskEitherMod.ReaderTaskEither[E, L, scala.Nothing] = js.native
  def leftTask[E, L, A](fa: fpDashTsLib.es6TaskMod.Task[L]): fpDashTsLib.es6ReaderTaskEitherMod.ReaderTaskEither[E, L, A] = js.native
  ...
  def right2v[E, A](a: A): fpDashTsLib.es6ReaderTaskEitherMod.ReaderTaskEither[E, scala.Nothing, A] = js.native
  def rightIO[E, A](ma: fpDashTsLib.es6IOMod.IO[A]): fpDashTsLib.es6ReaderTaskEitherMod.ReaderTaskEither[E, scala.Nothing, A] = js.native
  def rightReader[E, A](ma: fpDashTsLib.es6ReaderMod.Reader[E, A]): fpDashTsLib.es6ReaderTaskEitherMod.ReaderTaskEither[E, scala.Nothing, A] = js.native
  def rightTask[E, L, A](fa: fpDashTsLib.es6TaskMod.Task[A]): fpDashTsLib.es6ReaderTaskEitherMod.ReaderTaskEither[E, L, A] = js.native
  def tryCatch[E, L, A](
