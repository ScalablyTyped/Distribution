...
@JSImport("fp-ts/es6", "array")
@js.native
object arrayNs extends js.Object {
  val URI: fpDashTsLib.fpDashTsLibStrings.Array = js.native
  val array: fpDashTsLib.es6MonadMod.Monad1[fpDashTsLib.es6ArrayMod.URI] with fpDashTsLib.es6Foldable2vMod.Foldable2v1[fpDashTsLib.es6ArrayMod.URI] with fpDashTsLib.es6UnfoldableMod.Unfoldable1[fpDashTsLib.es6ArrayMod.URI] with (fpDashTsLib.es6TraversableWithIndexMod.TraversableWithIndex1[fpDashTsLib.es6ArrayMod.URI, scala.Double]) with fpDashTsLib.es6AlternativeMod.Alternative1[fpDashTsLib.es6ArrayMod.URI] with fpDashTsLib.es6PlusMod.Plus1[fpDashTsLib.es6ArrayMod.URI] with fpDashTsLib.es6ExtendMod.Extend1[fpDashTsLib.es6ArrayMod.URI] with fpDashTsLib.es6CompactableMod.Compactable1[fpDashTsLib.es6ArrayMod.URI] with (fpDashTsLib.es6FilterableWithIndexMod.FilterableWithIndex1[fpDashTsLib.es6ArrayMod.URI, scala.Double]) with fpDashTsLib.es6WitherableMod.Witherable1[fpDashTsLib.es6ArrayMod.URI] with (fpDashTsLib.es6FunctorWithIndexMod.FunctorWithIndex1[fpDashTsLib.es6ArrayMod.URI, scala.Double]) with (fpDashTsLib.es6FoldableWithIndexMod.FoldableWithIndex1[fpDashTsLib.es6ArrayMod.URI, scala.Double]) = js.native
