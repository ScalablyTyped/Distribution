...
object FoldableWithIndex2C {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */, I, L](
    ...
    foldrWithIndex: (fpDashTsLib.libHKTMod.Type2[F, L, js.Any], js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Any,
    reduce: (fpDashTsLib.libHKTMod.Type2[F, L, js.Any], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any,
    reduceWithIndex: (fpDashTsLib.libHKTMod.Type2[F, L, js.Any], js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Any
