...
object ^ extends js.Object {
  ...
  def leftTask[E, L, A](fa: fpDashTsLib.es6TaskMod.Task[L]): ReaderTaskEither[E, L, A] = js.native
  ...
  def rightIO[E, A](ma: fpDashTsLib.es6IOMod.IO[A]): ReaderTaskEither[E, scala.Nothing, A] = js.native
  def rightReader[E, A](ma: fpDashTsLib.es6ReaderMod.Reader[E, A]): ReaderTaskEither[E, scala.Nothing, A] = js.native
  def rightTask[E, L, A](fa: fpDashTsLib.es6TaskMod.Task[A]): ReaderTaskEither[E, L, A] = js.native
  def tryCatch[E, L, A](
