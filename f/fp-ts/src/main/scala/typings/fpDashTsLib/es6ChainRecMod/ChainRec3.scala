...
trait ChainRec3[F /* <: fpDashTsLib.es6HKTMod.URIS3 */]
  ...
  def chainRec[U, L, A, B](
    ...
    f: js.Function1[
      /* a */ A, 
      fpDashTsLib.es6HKTMod.Type3[F, U, L, fpDashTsLib.es6EitherMod.Either[A, B]]
    ]
...
object ChainRec3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */](
    ...
    chainRec: (js.Any, js.Function1[
      js.Any, 
      fpDashTsLib.es6HKTMod.Type3[F, js.Any, js.Any, fpDashTsLib.es6EitherMod.Either[js.Any, js.Any]]
