...
trait FunctorWithIndex4[F /* <: fpDashTsLib.libHKTMod.URIS4 */, I]
  ...
  def mapWithIndex[X, U, L, A, B](fa: fpDashTsLib.libHKTMod.Kind4[F, X, U, L, A], f: js.Function2[/* i */ I, /* a */ A, B]): fpDashTsLib.libHKTMod.Kind4[F, X, U, L, B]
}
...
object FunctorWithIndex4 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS4 */, I](
    ...
    mapWithIndex: (fpDashTsLib.libHKTMod.Kind4[F, js.Any, js.Any, js.Any, js.Any], js.Function2[/* i */ I, js.Any, js.Any]) => fpDashTsLib.libHKTMod.Kind4[F, js.Any, js.Any, js.Any, js.Any]
