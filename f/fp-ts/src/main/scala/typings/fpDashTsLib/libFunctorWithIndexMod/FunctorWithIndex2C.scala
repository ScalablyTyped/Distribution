...
trait FunctorWithIndex2C[F /* <: fpDashTsLib.libHKTMod.URIS2 */, I, L]
  ...
  def mapWithIndex[A, B](fa: fpDashTsLib.libHKTMod.Kind2[F, L, A], f: js.Function2[/* i */ I, /* a */ A, B]): fpDashTsLib.libHKTMod.Kind2[F, L, B]
}
...
object FunctorWithIndex2C {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */, I, L](
    ...
    mapWithIndex: (fpDashTsLib.libHKTMod.Kind2[F, L, js.Any], js.Function2[/* i */ I, js.Any, js.Any]) => fpDashTsLib.libHKTMod.Kind2[F, L, js.Any]
