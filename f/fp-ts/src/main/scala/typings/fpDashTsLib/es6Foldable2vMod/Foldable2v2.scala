...
trait Foldable2v2[F /* <: fpDashTsLib.es6HKTMod.URIS2 */]
  ...
  def foldMap[M](M: fpDashTsLib.es6MonoidMod.Monoid[M]): js.Function2[
    /* fa */ fpDashTsLib.es6HKTMod.Type2[F, _, _], 
    /* f */ js.Function1[/* a */ js.Any, M], 
    M
  ]
  def foldr[L, A, B](fa: fpDashTsLib.es6HKTMod.Type2[F, L, A], b: B, f: js.Function2[/* a */ A, /* b */ B, B]): B
}
...
object Foldable2v2 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    ...
    foldr: (fpDashTsLib.es6HKTMod.Type2[F, js.Any, js.Any], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any,
