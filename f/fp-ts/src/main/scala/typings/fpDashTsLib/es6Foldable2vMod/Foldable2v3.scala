...
trait Foldable2v3[F /* <: fpDashTsLib.es6HKTMod.URIS3 */]
  ...
  def foldMap[M](M: fpDashTsLib.es6MonoidMod.Monoid[M]): js.Function2[
    /* fa */ fpDashTsLib.es6HKTMod.Kind3[F, _, _, _], 
    /* f */ js.Function1[/* a */ js.Any, M], 
    M
  ]
  def foldr[U, L, A, B](fa: fpDashTsLib.es6HKTMod.Kind3[F, U, L, A], b: B, f: js.Function2[/* a */ A, /* b */ B, B]): B
}
...
object Foldable2v3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */](
    ...
    foldr: (fpDashTsLib.es6HKTMod.Kind3[F, js.Any, js.Any, js.Any], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any,
