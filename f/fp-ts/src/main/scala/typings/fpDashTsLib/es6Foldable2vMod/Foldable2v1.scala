...
trait Foldable2v1[F /* <: fpDashTsLib.es6HKTMod.URIS */]
  ...
  def foldMap[M](M: fpDashTsLib.es6MonoidMod.Monoid[M]): js.Function2[
    /* fa */ fpDashTsLib.es6HKTMod.Type[F, _], 
    /* f */ js.Function1[/* a */ js.Any, M], 
    M
  ]
  def foldr[A, B](fa: fpDashTsLib.es6HKTMod.Type[F, A], b: B, f: js.Function2[/* a */ A, /* b */ B, B]): B
}
...
object Foldable2v1 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */](
    ...
    foldr: (fpDashTsLib.es6HKTMod.Type[F, js.Any], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any,
    reduce: (fpDashTsLib.es6HKTMod.Type[F, js.Any], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any
  ): Foldable2v1[F] = {
