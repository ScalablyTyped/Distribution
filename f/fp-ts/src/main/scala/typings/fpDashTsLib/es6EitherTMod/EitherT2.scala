...
object EitherT2 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    ...
    ], fpDashTsLib.es6HKTMod.Type2[F, js.Any, fpDashTsLib.es6EitherMod.Either[js.Any, js.Any]]) => fpDashTsLib.es6HKTMod.Type2[F, js.Any, fpDashTsLib.es6EitherMod.Either[js.Any, js.Any]],
