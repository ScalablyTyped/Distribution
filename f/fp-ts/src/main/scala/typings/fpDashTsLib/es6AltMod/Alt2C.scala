...
trait Alt2C[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, L]
  ...
  def alt[A](fx: fpDashTsLib.es6HKTMod.Type2[F, L, A], fy: fpDashTsLib.es6HKTMod.Type2[F, L, A]): fpDashTsLib.es6HKTMod.Type2[F, L, A]
}
...
object Alt2C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, L](
    URI: F,
    _L: L,
    alt: (fpDashTsLib.es6HKTMod.Type2[F, L, js.Any], fpDashTsLib.es6HKTMod.Type2[F, L, js.Any]) => fpDashTsLib.es6HKTMod.Type2[F, L, js.Any],
