...
object ^ extends js.Object {
  ...
  def leftIO[E](me: fpDashTsLib.es6IOMod.IO[E]): TaskEither[E, scala.Nothing] = js.native
  def leftTask[E](me: fpDashTsLib.es6TaskMod.Task[E]): TaskEither[E, scala.Nothing] = js.native
  ...
  def rightIO[A](ma: fpDashTsLib.es6IOMod.IO[A]): TaskEither[scala.Nothing, A] = js.native
  def rightTask[A](ma: fpDashTsLib.es6TaskMod.Task[A]): TaskEither[scala.Nothing, A] = js.native
  def taskify[L, R](
    f: js.Function1[
