...
trait Invariant1[F /* <: fpDashTsLib.es6HKTMod.URIS */] extends js.Object {
  val URI: F
  def imap[A, B](fa: fpDashTsLib.es6HKTMod.HKT[F, A], f: js.Function1[/* a */ A, B], g: js.Function1[/* b */ B, A]): fpDashTsLib.es6HKTMod.Type[F, B]
}
...
object Invariant1 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */](
    URI: F,
    imap: (fpDashTsLib.es6HKTMod.HKT[F, js.Any], js.Function1[js.Any, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type[F, js.Any]
  ): Invariant1[F] = {
