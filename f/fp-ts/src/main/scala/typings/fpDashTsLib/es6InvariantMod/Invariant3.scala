...
object Invariant3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */](
    URI: F,
    imap: (fpDashTsLib.es6HKTMod.HKT3[F, js.Any, js.Any, js.Any], js.Function1[js.Any, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type3[F, js.Any, js.Any, js.Any]
  ): Invariant3[F] = {
