...
object FunctorWithIndexComposition3C1 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, FI, G /* <: fpDashTsLib.es6HKTMod.URIS */, GI, UF, LF](
    ...
    mapWithIndex: (fpDashTsLib.es6HKTMod.Type3[F, UF, LF, fpDashTsLib.es6HKTMod.Type[G, js.Any]], js.Function2[/* i */ js.Tuple2[FI, GI], js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type3[F, UF, LF, fpDashTsLib.es6HKTMod.Type[G, js.Any]]
