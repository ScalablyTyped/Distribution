...
trait FunctorWithIndex2C[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, I, L]
  ...
  def mapWithIndex[A, B](fa: fpDashTsLib.es6HKTMod.Type2[F, L, A], f: js.Function2[/* i */ I, /* a */ A, B]): fpDashTsLib.es6HKTMod.Type2[F, L, B]
}
...
object FunctorWithIndex2C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, I, L](
    ...
    mapWithIndex: (fpDashTsLib.es6HKTMod.Type2[F, L, js.Any], js.Function2[/* i */ I, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type2[F, L, js.Any]
