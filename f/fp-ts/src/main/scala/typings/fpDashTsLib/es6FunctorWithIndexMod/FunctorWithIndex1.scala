...
trait FunctorWithIndex1[F /* <: fpDashTsLib.es6HKTMod.URIS */, I]
  ...
  def mapWithIndex[A, B](fa: fpDashTsLib.es6HKTMod.Kind[F, A], f: js.Function2[/* i */ I, /* a */ A, B]): fpDashTsLib.es6HKTMod.Kind[F, B]
}
...
object FunctorWithIndex1 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */, I](
    ...
    mapWithIndex: (fpDashTsLib.es6HKTMod.Kind[F, js.Any], js.Function2[/* i */ I, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Kind[F, js.Any]
