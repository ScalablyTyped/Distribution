...
trait FunctorWithIndex3[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, I]
  ...
  def mapWithIndex[U, L, A, B](fa: fpDashTsLib.es6HKTMod.Type3[F, U, L, A], f: js.Function2[/* i */ I, /* a */ A, B]): fpDashTsLib.es6HKTMod.Type3[F, U, L, B]
}
...
object FunctorWithIndex3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, I](
    ...
    mapWithIndex: (fpDashTsLib.es6HKTMod.Type3[F, js.Any, js.Any, js.Any], js.Function2[/* i */ I, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type3[F, js.Any, js.Any, js.Any]
