...
trait FunctorWithIndexComposition22C[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, FI, G /* <: fpDashTsLib.es6HKTMod.URIS2 */, GI, LG]
  ...
  def mapWithIndex[L, A, B](
    fa: fpDashTsLib.es6HKTMod.Type2[F, L, fpDashTsLib.es6HKTMod.Type2[G, LG, A]],
    f: js.Function2[/* i */ js.Tuple2[FI, GI], /* a */ A, B]
  ): fpDashTsLib.es6HKTMod.Type2[F, L, fpDashTsLib.es6HKTMod.Type2[G, LG, B]]
}
...
object FunctorWithIndexComposition22C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, FI, G /* <: fpDashTsLib.es6HKTMod.URIS2 */, GI, LG](
    ...
    mapWithIndex: (fpDashTsLib.es6HKTMod.Type2[F, js.Any, fpDashTsLib.es6HKTMod.Type2[G, LG, js.Any]], js.Function2[/* i */ js.Tuple2[FI, GI], js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type2[F, js.Any, fpDashTsLib.es6HKTMod.Type2[G, LG, js.Any]]
