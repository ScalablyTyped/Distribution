...
trait FunctorWithIndex2[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, I]
  ...
  def mapWithIndex[L, A, B](fa: fpDashTsLib.es6HKTMod.Kind2[F, L, A], f: js.Function2[/* i */ I, /* a */ A, B]): fpDashTsLib.es6HKTMod.Kind2[F, L, B]
}
...
object FunctorWithIndex2 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, I](
    ...
    mapWithIndex: (fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Any], js.Function2[/* i */ I, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Any]
