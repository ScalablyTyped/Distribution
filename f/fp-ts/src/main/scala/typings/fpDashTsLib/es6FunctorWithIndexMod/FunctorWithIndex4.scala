...
trait FunctorWithIndex4[F /* <: fpDashTsLib.es6HKTMod.URIS4 */, I]
  ...
  def mapWithIndex[X, U, L, A, B](fa: fpDashTsLib.es6HKTMod.Kind4[F, X, U, L, A], f: js.Function2[/* i */ I, /* a */ A, B]): fpDashTsLib.es6HKTMod.Kind4[F, X, U, L, B]
}
...
object FunctorWithIndex4 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS4 */, I](
    ...
    mapWithIndex: (fpDashTsLib.es6HKTMod.Kind4[F, js.Any, js.Any, js.Any, js.Any], js.Function2[/* i */ I, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Kind4[F, js.Any, js.Any, js.Any, js.Any]
