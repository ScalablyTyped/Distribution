...
trait FunctorWithIndex3C[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, I, U, L]
  ...
  def mapWithIndex[A, B](fa: fpDashTsLib.es6HKTMod.Type3[F, U, L, A], f: js.Function2[/* i */ I, /* a */ A, B]): fpDashTsLib.es6HKTMod.Type3[F, U, L, B]
}
...
object FunctorWithIndex3C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, I, U, L](
    ...
    mapWithIndex: (fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any], js.Function2[/* i */ I, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any]
