...
@js.native
trait Traversable3C[T /* <: fpDashTsLib.libHKTMod.URIS3 */, TU, TL]
  extends fpDashTsLib.libFunctorMod.Functor3C[T, TU, TL]
     with fpDashTsLib.libFoldableMod.Foldable3C[T, TU, TL] {
  ...
  @JSName("traverse")
  var traverse_Original: Traverse3C[T, TU, TL] = js.native
