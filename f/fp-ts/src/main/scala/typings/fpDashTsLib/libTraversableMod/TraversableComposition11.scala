...
trait TraversableComposition11[F /* <: fpDashTsLib.libHKTMod.URIS */, G /* <: fpDashTsLib.libHKTMod.URIS */]
  ...
  def traverse[H /* <: fpDashTsLib.libHKTMod.URIS */](H: fpDashTsLib.libApplicativeMod.Applicative1[H]): js.Function2[
    /* fga */ fpDashTsLib.libHKTMod.Type[F, fpDashTsLib.libHKTMod.Type[G, _]], 
  ...
  def traverse[H /* <: fpDashTsLib.libHKTMod.URIS2 */](H: fpDashTsLib.libApplicativeMod.Applicative2[H]): js.Function2[
    /* fga */ fpDashTsLib.libHKTMod.Type[F, fpDashTsLib.libHKTMod.Type[G, _]], 
  ...
  def traverse[H /* <: fpDashTsLib.libHKTMod.URIS3 */](H: fpDashTsLib.libApplicativeMod.Applicative3[H]): js.Function2[
    /* fga */ fpDashTsLib.libHKTMod.Type[F, fpDashTsLib.libHKTMod.Type[G, _]], 
  ...
  def traverse[H /* <: fpDashTsLib.libHKTMod.URIS2 */, HL](H: fpDashTsLib.libApplicativeMod.Applicative2C[H, HL]): js.Function2[
    /* fga */ fpDashTsLib.libHKTMod.Type[F, fpDashTsLib.libHKTMod.Type[G, _]], 
  ...
  def traverse[H /* <: fpDashTsLib.libHKTMod.URIS3 */, HU, HL](H: fpDashTsLib.libApplicativeMod.Applicative3C[H, HU, HL]): js.Function2[
    /* fga */ fpDashTsLib.libHKTMod.Type[F, fpDashTsLib.libHKTMod.Type[G, _]], 
