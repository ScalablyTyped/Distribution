...
@js.native
trait Traverse2[T /* <: fpDashTsLib.libHKTMod.URIS2 */] extends js.Object {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */, FL](F: fpDashTsLib.libApplicativeMod.Applicative2C[F, FL]): js.Function2[
    ...
    fpDashTsLib.libHKTMod.Type2[F, FL, fpDashTsLib.libHKTMod.Type2[T, _, _]]
  ] = js.native
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS3 */, FU, FL](F: fpDashTsLib.libApplicativeMod.Applicative3C[F, FU, FL]): js.Function2[
    ...
    fpDashTsLib.libHKTMod.Type3[F, FU, FL, fpDashTsLib.libHKTMod.Type2[T, _, _]]
  ] = js.native
}
