...
@js.native
trait TraverseWithIndex2C[T /* <: fpDashTsLib.es6HKTMod.URIS2 */, I, FL] extends js.Object {
  def apply(
    ...
    fpDashTsLib.es6HKTMod.Type[fpDashTsLib.fpDashTsLibStrings.Task, fpDashTsLib.es6HKTMod.Type2[T, FL, _]]
  ] = js.native
  def apply(
  ...
  def apply(
    ...
    /* f */ js.Function2[
      /* i */ I, 
      /* a */ js.Any, 
      fpDashTsLib.es6HKTMod.Type3[fpDashTsLib.fpDashTsLibStrings.IxIO, _, FL, _]
    ], 
    fpDashTsLib.es6HKTMod.Type3[fpDashTsLib.fpDashTsLibStrings.IxIO, _, FL, fpDashTsLib.es6HKTMod.Type2[T, FL, _]]
  ] = js.native
  def apply[F](F: fpDashTsLib.es6ApplicativeMod.Applicative[F]): js.Function2[
    ...
    fpDashTsLib.es6HKTMod.HKT[F, fpDashTsLib.es6HKTMod.Type2[T, FL, _]]
  ] = js.native
  def apply[FU](
