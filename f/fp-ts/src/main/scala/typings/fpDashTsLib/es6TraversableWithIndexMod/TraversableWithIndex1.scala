...
@js.native
trait TraversableWithIndex1[T /* <: fpDashTsLib.es6HKTMod.URIS */, I]
  extends fpDashTsLib.es6Traversable2vMod.Traversable2v1[T]
     with fpDashTsLib.es6FunctorWithIndexMod.FunctorWithIndex1[T, I]
     with fpDashTsLib.es6FoldableWithIndexMod.FoldableWithIndex1[T, I] {
