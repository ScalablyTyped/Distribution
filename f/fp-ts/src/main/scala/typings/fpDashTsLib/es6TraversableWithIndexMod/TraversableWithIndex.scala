...
trait TraversableWithIndex[T, I]
  extends fpDashTsLib.es6Traversable2vMod.Traversable2v[T]
     with fpDashTsLib.es6FunctorWithIndexMod.FunctorWithIndex[T, I]
     with fpDashTsLib.es6FoldableWithIndexMod.FoldableWithIndex[T, I] {
