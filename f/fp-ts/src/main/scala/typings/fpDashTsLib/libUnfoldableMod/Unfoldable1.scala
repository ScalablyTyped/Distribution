...
trait Unfoldable1[F /* <: fpDashTsLib.libHKTMod.URIS */] extends js.Object {
  val URI: F
  def unfoldr[A, B](b: B, f: js.Function1[/* b */ B, fpDashTsLib.libOptionMod.Option[js.Tuple2[A, B]]]): fpDashTsLib.libHKTMod.Kind[F, A]
}
...
object Unfoldable1 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS */](
    URI: F,
    unfoldr: (js.Any, js.Function1[js.Any, fpDashTsLib.libOptionMod.Option[js.Tuple2[js.Any, js.Any]]]) => fpDashTsLib.libHKTMod.Kind[F, js.Any]
  ): Unfoldable1[F] = {
