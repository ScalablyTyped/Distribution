...
object ^ extends js.Object {
  ...
  val ord: fpDashTsLib.es6ContravariantMod.Contravariant1[URI] = js.native
  ...
  def contramap[A, B](f: js.Function1[/* b */ B, A]): js.Function1[/* O */ Ord[A], Ord[B]] = js.native
  def contramap[A, B](f: js.Function1[/* b */ B, A], O: Ord[A]): Ord[B] = js.native
  def fromCompare[A](compare: js.Function2[/* x */ A, /* y */ A, fpDashTsLib.es6OrderingMod.Ordering]): Ord[A] = js.native
  def geq[A](O: Ord[A]): js.Function2[/* x */ A, /* y */ A, scala.Boolean] = js.native
  ...
  def gt[A](O: Ord[A]): js.Function2[/* x */ A, /* y */ A, scala.Boolean] = js.native
  def leq[A](O: Ord[A]): js.Function2[/* x */ A, /* y */ A, scala.Boolean] = js.native
  ...
  def lt[A](O: Ord[A]): js.Function2[/* x */ A, /* y */ A, scala.Boolean] = js.native
