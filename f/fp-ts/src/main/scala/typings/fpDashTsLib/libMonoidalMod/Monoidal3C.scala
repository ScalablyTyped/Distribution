...
trait Monoidal3C[F /* <: fpDashTsLib.libHKTMod.URIS3 */, U, L]
  ...
  def mult[A, B](fa: fpDashTsLib.libHKTMod.Kind3[F, U, L, A], fb: fpDashTsLib.libHKTMod.Kind3[F, U, L, B]): fpDashTsLib.libHKTMod.Kind3[F, U, L, js.Tuple2[A, B]]
  def unit(): fpDashTsLib.libHKTMod.Kind3[F, U, L, scala.Unit]
}
...
object Monoidal3C {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS3 */, U, L](
    ...
    mult: (fpDashTsLib.libHKTMod.Kind3[F, U, L, js.Any], fpDashTsLib.libHKTMod.Kind3[F, U, L, js.Any]) => fpDashTsLib.libHKTMod.Kind3[F, U, L, js.Tuple2[js.Any, js.Any]],
    unit: () => fpDashTsLib.libHKTMod.Kind3[F, U, L, scala.Unit]
  ): Monoidal3C[F, U, L] = {
