...
trait Compactable2[F /* <: fpDashTsLib.es6HKTMod.URIS2 */] extends js.Object {
  ...
  def separate[L, A, B](fa: fpDashTsLib.es6HKTMod.Kind2[F, L, fpDashTsLib.es6EitherMod.Either[A, B]]): Separated[fpDashTsLib.es6HKTMod.Kind2[F, L, A], fpDashTsLib.es6HKTMod.Kind2[F, L, B]]
}
...
object Compactable2 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    ...
    separate: fpDashTsLib.es6HKTMod.Kind2[F, js.Any, fpDashTsLib.es6EitherMod.Either[js.Any, js.Any]] => Separated[
