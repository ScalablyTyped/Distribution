...
trait Compactable2C[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, L] extends js.Object {
  ...
  def separate[A, B](fa: fpDashTsLib.es6HKTMod.Kind2[F, L, fpDashTsLib.es6EitherMod.Either[A, B]]): Separated[fpDashTsLib.es6HKTMod.Kind2[F, L, A], fpDashTsLib.es6HKTMod.Kind2[F, L, B]]
}
...
object Compactable2C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, L](
    ...
    separate: fpDashTsLib.es6HKTMod.Kind2[F, L, fpDashTsLib.es6EitherMod.Either[js.Any, js.Any]] => Separated[
