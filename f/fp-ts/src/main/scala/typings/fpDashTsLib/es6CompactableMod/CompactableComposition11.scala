...
trait CompactableComposition11[F /* <: fpDashTsLib.es6HKTMod.URIS */, G /* <: fpDashTsLib.es6HKTMod.URIS */]
  ...
  def compact[A](
    fga: fpDashTsLib.es6HKTMod.Kind[F, fpDashTsLib.es6HKTMod.Kind[G, fpDashTsLib.es6OptionMod.Option[A]]]
  ): fpDashTsLib.es6HKTMod.Kind[F, fpDashTsLib.es6HKTMod.Kind[G, A]]
  def separate[A, B](
    fge: fpDashTsLib.es6HKTMod.Kind[F, fpDashTsLib.es6HKTMod.Kind[G, fpDashTsLib.es6EitherMod.Either[A, B]]]
  ): Separated[
    fpDashTsLib.es6HKTMod.Kind[F, fpDashTsLib.es6HKTMod.Kind[G, A]], 
...
object CompactableComposition11 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */, G /* <: fpDashTsLib.es6HKTMod.URIS */](
    ...
    separate: fpDashTsLib.es6HKTMod.Kind[F, fpDashTsLib.es6HKTMod.Kind[G, fpDashTsLib.es6EitherMod.Either[js.Any, js.Any]]] => Separated[
