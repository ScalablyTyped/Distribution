...
trait CompactableComposition3C1[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, G /* <: fpDashTsLib.es6HKTMod.URIS */, UF, LF]
  ...
  def compact[A](
    fga: fpDashTsLib.es6HKTMod.Type3[F, UF, LF, fpDashTsLib.es6HKTMod.Type[G, fpDashTsLib.es6OptionMod.Option[A]]]
  ): fpDashTsLib.es6HKTMod.Type3[F, UF, LF, fpDashTsLib.es6HKTMod.Type[G, A]]
  def separate[A, B](
    fge: fpDashTsLib.es6HKTMod.Type3[F, UF, LF, fpDashTsLib.es6HKTMod.Type[G, fpDashTsLib.es6EitherMod.Either[A, B]]]
  ): Separated[
    fpDashTsLib.es6HKTMod.Type3[F, UF, LF, fpDashTsLib.es6HKTMod.Type[G, A]], 
