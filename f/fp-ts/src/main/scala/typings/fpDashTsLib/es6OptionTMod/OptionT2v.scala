...
object OptionT2v {
  ...
  def apply[M](
    ...
    chain: (fpDashTsLib.es6HKTMod.HKT[M, fpDashTsLib.es6OptionMod.Option[js.Any]], js.Function1[js.Any, fpDashTsLib.es6HKTMod.HKT[M, fpDashTsLib.es6OptionMod.Option[js.Any]]]) => fpDashTsLib.es6HKTMod.HKT[M, fpDashTsLib.es6OptionMod.Option[js.Any]],
