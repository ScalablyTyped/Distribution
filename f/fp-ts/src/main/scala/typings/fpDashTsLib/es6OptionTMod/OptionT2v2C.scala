...
object OptionT2v2C {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS2 */, L](
    ...
    chain: (fpDashTsLib.es6HKTMod.Kind2[M, L, fpDashTsLib.es6OptionMod.Option[js.Any]], js.Function1[js.Any, fpDashTsLib.es6HKTMod.Kind2[M, L, fpDashTsLib.es6OptionMod.Option[js.Any]]]) => fpDashTsLib.es6HKTMod.Kind2[M, L, fpDashTsLib.es6OptionMod.Option[js.Any]],
