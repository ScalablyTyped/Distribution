...
object OptionT2v1 {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS */](
    ...
    chain: (fpDashTsLib.es6HKTMod.Kind[M, fpDashTsLib.es6OptionMod.Option[js.Any]], js.Function1[js.Any, fpDashTsLib.es6HKTMod.Kind[M, fpDashTsLib.es6OptionMod.Option[js.Any]]]) => fpDashTsLib.es6HKTMod.Kind[M, fpDashTsLib.es6OptionMod.Option[js.Any]],
