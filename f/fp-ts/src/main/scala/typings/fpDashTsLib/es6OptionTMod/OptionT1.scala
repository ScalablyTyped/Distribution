...
object OptionT1 {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS */](
    ...
    chain: (js.Function1[js.Any, fpDashTsLib.es6HKTMod.Type[M, fpDashTsLib.es6OptionMod.Option[js.Any]]], fpDashTsLib.es6HKTMod.Type[M, fpDashTsLib.es6OptionMod.Option[js.Any]]) => fpDashTsLib.es6HKTMod.Type[M, fpDashTsLib.es6OptionMod.Option[js.Any]],
