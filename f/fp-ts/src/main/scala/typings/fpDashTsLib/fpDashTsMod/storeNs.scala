...
object storeNs extends js.Object {
  ...
  /* import warning: parser.TsParser#tsDeclVar $anonfun Dropped List(extend, map) */ def duplicate[L, A](ma: fpDashTsLib.libStoreMod.Store[L, A]): fpDashTsLib.libStoreMod.Store[L, fpDashTsLib.libStoreMod.Store[L, A]] = js.native
  def experiment[F](F: fpDashTsLib.libFunctorMod.Functor[F]): js.Function1[
    /* f */ js.Function1[/* s */ js.Any, fpDashTsLib.libHKTMod.HKT[F, _]], 
    js.Function1[/* wa */ fpDashTsLib.libStoreMod.Store[_, _], fpDashTsLib.libHKTMod.HKT[F, _]]
  ] = js.native
  @JSName("experiment")
  def experiment_Array(F: fpDashTsLib.libFunctorMod.Functor1[fpDashTsLib.fpDashTsLibStrings.Array]): js.Function1[
    ...
    js.Function1[
      /* wa */ fpDashTsLib.libStoreMod.Store[_, _], 
      fpDashTsLib.libHKTMod.Kind[fpDashTsLib.fpDashTsLibStrings.Array, _]
    ]
  ] = js.native
  @JSName("experiment")
  ...
  def peeks[S](f: fpDashTsLib.libFunctionMod.Endomorphism[S]): js.Function1[/* wa */ fpDashTsLib.libStoreMod.Store[S, _], _] = js.native
  def seek[S](s: S): js.Function1[/* wa */ fpDashTsLib.libStoreMod.Store[S, _], fpDashTsLib.libStoreMod.Store[S, _]] = js.native
