...
object freeNs extends js.Object {
  ...
  def hoistFree_Eq(
    ...
    /* fa */ fpDashTsLib.libFreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Eq, _], 
    fpDashTsLib.libFreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Eq, _]
  ] = js.native
  @JSName("hoistFree")
  ...
  def hoistFree_Ord(
    ...
    /* fa */ fpDashTsLib.libFreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Ord, _], 
    fpDashTsLib.libFreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Ord, _]
  ] = js.native
  @JSName("hoistFree")
  def hoistFree_Pair(
    nt: js.Function1[
  ...
  def hoistFree_Record(
    ...
    /* fa */ fpDashTsLib.libFreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Record, _], 
    fpDashTsLib.libFreeMod.Free[fpDashTsLib.fpDashTsLibStrings.Record, _]
  ] = js.native
  @JSName("hoistFree")
