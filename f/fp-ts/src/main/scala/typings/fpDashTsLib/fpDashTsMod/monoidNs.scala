...
object monoidNs extends js.Object {
  ...
  def getDictionaryMonoid[A](S: fpDashTsLib.libSemigroupMod.Semigroup[A]): fpDashTsLib.libMonoidMod.Monoid[ScalablyTyped.runtime.StringDictionary[A]] = js.native
  ...
  def getRecordMonoid[O /* <: ScalablyTyped.runtime.StringDictionary[js.Any] */](monoids: fpDashTsLib.fpDashTsLibStrings.getRecordMonoid with O): fpDashTsLib.libMonoidMod.Monoid[O] = js.native
}
