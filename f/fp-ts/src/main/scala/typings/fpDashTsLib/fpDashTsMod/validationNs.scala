...
object validationNs extends js.Object {
  ...
  def isFailure[L, A](fa: fpDashTsLib.libValidationMod.Validation[L, A]): /* is Failure */scala.Boolean = js.native
  def isSuccess[L, A](fa: fpDashTsLib.libValidationMod.Validation[L, A]): /* is Success */scala.Boolean = js.native
