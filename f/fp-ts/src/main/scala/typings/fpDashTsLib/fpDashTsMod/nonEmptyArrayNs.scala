...
object nonEmptyArrayNs extends js.Object {
  ...
  def getEq[A](S: fpDashTsLib.libEqMod.Eq[A]): fpDashTsLib.libEqMod.Eq[fpDashTsLib.libNonEmptyArrayMod.NonEmptyArray[A]] = js.native
  def getSemigroup[A](): fpDashTsLib.libSemigroupMod.Semigroup[fpDashTsLib.libNonEmptyArrayMod.NonEmptyArray[A]] = js.native
  def getSetoid[A](S: fpDashTsLib.libEqMod.Eq[A]): fpDashTsLib.libEqMod.Eq[fpDashTsLib.libNonEmptyArrayMod.NonEmptyArray[A]] = js.native
  def group[A](S: fpDashTsLib.libEqMod.Eq[A]): js.Function1[
