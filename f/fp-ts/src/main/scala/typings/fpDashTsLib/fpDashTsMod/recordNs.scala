...
object recordNs extends js.Object {
  ...
  val record: (fpDashTsLib.libFunctorWithIndexMod.FunctorWithIndex1[fpDashTsLib.libRecordMod.URI, java.lang.String]) with fpDashTsLib.libFoldable2vMod.Foldable2v1[fpDashTsLib.libRecordMod.URI] with (fpDashTsLib.libTraversableWithIndexMod.TraversableWithIndex1[fpDashTsLib.libRecordMod.URI, java.lang.String]) with fpDashTsLib.libCompactableMod.Compactable1[fpDashTsLib.libRecordMod.URI] with (fpDashTsLib.libFilterableWithIndexMod.FilterableWithIndex1[fpDashTsLib.libRecordMod.URI, java.lang.String]) with fpDashTsLib.libWitherableMod.Witherable1[fpDashTsLib.libRecordMod.URI] with (fpDashTsLib.libFoldableWithIndexMod.FoldableWithIndex1[fpDashTsLib.libRecordMod.URI, java.lang.String]) = js.native
