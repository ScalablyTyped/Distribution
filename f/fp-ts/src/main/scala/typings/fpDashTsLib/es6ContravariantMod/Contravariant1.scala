...
trait Contravariant1[F /* <: fpDashTsLib.es6HKTMod.URIS */] extends js.Object {
  val URI: F
  def contramap[A, B](fa: fpDashTsLib.es6HKTMod.Type[F, A], f: js.Function1[/* b */ B, A]): fpDashTsLib.es6HKTMod.Type[F, B]
}
...
object Contravariant1 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */](
    URI: F,
    contramap: (fpDashTsLib.es6HKTMod.Type[F, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type[F, js.Any]
  ): Contravariant1[F] = {
