...
trait Contravariant2[F /* <: fpDashTsLib.es6HKTMod.URIS2 */] extends js.Object {
  val URI: F
  def contramap[L, A, B](fa: fpDashTsLib.es6HKTMod.Type2[F, L, A], f: js.Function1[/* b */ B, A]): fpDashTsLib.es6HKTMod.Type2[F, L, B]
}
...
object Contravariant2 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    URI: F,
    contramap: (fpDashTsLib.es6HKTMod.Type2[F, js.Any, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type2[F, js.Any, js.Any]
  ): Contravariant2[F] = {
