...
trait Contravariant3[F /* <: fpDashTsLib.es6HKTMod.URIS3 */] extends js.Object {
  val URI: F
  def contramap[U, L, A, B](fa: fpDashTsLib.es6HKTMod.Type3[F, U, L, A], f: js.Function1[/* b */ B, A]): fpDashTsLib.es6HKTMod.Type3[F, U, L, B]
}
...
object Contravariant3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */](
    URI: F,
    contramap: (fpDashTsLib.es6HKTMod.Type3[F, js.Any, js.Any, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type3[F, js.Any, js.Any, js.Any]
  ): Contravariant3[F] = {
