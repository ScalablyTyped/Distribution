...
trait Contravariant3C[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, U, L] extends js.Object {
  ...
  val _L: L
  val _U: U
  def contramap[A, B](fa: fpDashTsLib.es6HKTMod.Type3[F, U, L, A], f: js.Function1[/* b */ B, A]): fpDashTsLib.es6HKTMod.Type3[F, U, L, B]
}
...
object Contravariant3C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, U, L](
    ...
    _L: L,
    _U: U,
    contramap: (fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any]
