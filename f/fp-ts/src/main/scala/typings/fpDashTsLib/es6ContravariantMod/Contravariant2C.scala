...
trait Contravariant2C[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, L] extends js.Object {
  val URI: F
  val _L: L
  def contramap[A, B](fa: fpDashTsLib.es6HKTMod.Type2[F, L, A], f: js.Function1[/* b */ B, A]): fpDashTsLib.es6HKTMod.Type2[F, L, B]
}
...
object Contravariant2C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, L](
    URI: F,
    _L: L,
    contramap: (fpDashTsLib.es6HKTMod.Type2[F, L, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type2[F, L, js.Any]
  ): Contravariant2C[F, L] = {
