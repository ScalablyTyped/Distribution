...
class NonEmptyArray[A] protected () extends js.Object {
  ...
  /**
    * @since 1.14.0
    */
  def every(predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): scala.Boolean = js.native
  /**
    * @example
    * import { NonEmptyArray } from 'fp-ts/lib/NonEmptyArray'
  ...
  def filter(predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]] = js.native
  /**
    * @since 1.12.0
    */
  def filterWithIndex(predicate: js.Function2[/* i */ scala.Double, /* a */ A, scala.Boolean]): fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]] = js.native
  /**
    ...
    */
  @JSName("filter")
  def filter_BA[B /* <: A */](predicate: fpDashTsLib.es6FunctionMod.Refinement[A, B]): fpDashTsLib.es6OptionMod.Option[NonEmptyArray[B]] = js.native
  def findFirst(predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): fpDashTsLib.es6OptionMod.Option[A] = js.native
  /**
    ...
    */
  @JSName("findFirst")
  def findFirst_BA[B /* <: A */](refinement: fpDashTsLib.es6FunctionMod.Refinement[A, B]): fpDashTsLib.es6OptionMod.Option[B] = js.native
  /**
    ...
    * @since 1.11.0
    */
  def findIndex(predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): fpDashTsLib.es6OptionMod.Option[scala.Double] = js.native
  def findLast(predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): fpDashTsLib.es6OptionMod.Option[A] = js.native
  /**
    ...
    * @since 1.11.0
    */
  def findLastIndex(predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): fpDashTsLib.es6OptionMod.Option[scala.Double] = js.native
  /**
    ...
    */
  @JSName("findLast")
  def findLast_BA[B /* <: A */](predicate: fpDashTsLib.es6FunctionMod.Refinement[A, B]): fpDashTsLib.es6OptionMod.Option[B] = js.native
  /**
    * @since 1.12.0
    */
  ...
  /**
    ...
    * @deprecated
    */
  def index(i: scala.Double): fpDashTsLib.es6OptionMod.Option[A] = js.native
  /**
    ...
    * @since 1.11.0
    */
  def insertAt(i: scala.Double, a: A): fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]] = js.native
  /**
    * Same as `toString`
    */
  ...
  /**
    ...
    * @since 1.14.0
    */
  def lookup(i: scala.Double): fpDashTsLib.es6OptionMod.Option[A] = js.native
  /**
    * @example
    * import { NonEmptyArray } from 'fp-ts/lib/NonEmptyArray'
    *
  ...
  /**
    ...
    * @since 1.3.0
    */
  def max(ord: fpDashTsLib.es6OrdMod.Ord[A]): A = js.native
  /**
    ...
    * @since 1.3.0
    */
  def min(ord: fpDashTsLib.es6OrdMod.Ord[A]): A = js.native
  /**
    * @example
    * import { NonEmptyArray } from 'fp-ts/lib/NonEmptyArray'
    *
  ...
  /**
    * @since 1.14.0
    */
  def some(predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): scala.Boolean = js.native
  /**
    ...
    * @since 1.6.0
    */
  def sort(ord: fpDashTsLib.es6OrdMod.Ord[A]): NonEmptyArray[A] = js.native
  /**
  ...
  /**
    ...
    * @since 1.11.0
    */
  def updateAt(i: scala.Double, a: A): fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]] = js.native
}
