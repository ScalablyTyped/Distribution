...
object ^ extends js.Object {
  ...
  val traced: fpDashTsLib.libFunctorMod.Functor2[URI] = js.native
  def censor[P, A](wa: Traced[P, A], f: js.Function1[/* p */ P, P]): Traced[P, A] = js.native
  def getComonad[P](monoid: fpDashTsLib.libMonoidMod.Monoid[P]): fpDashTsLib.libComonadMod.Comonad2C[URI, P] = js.native
  ...
  def tracks[P, A](M: fpDashTsLib.libMonoidMod.Monoid[P], f: js.Function1[/* a */ A, P]): js.Function1[/* wa */ Traced[P, A], A] = js.native
}
