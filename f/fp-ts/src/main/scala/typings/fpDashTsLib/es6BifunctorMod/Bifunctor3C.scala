...
object Bifunctor3C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, U](
    URI: F,
    _U: U,
    bimap: (fpDashTsLib.es6HKTMod.Type3[F, U, js.Any, js.Any], js.Function1[js.Any, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Type3[F, U, js.Any, js.Any]
  ): Bifunctor3C[F, U] = {
