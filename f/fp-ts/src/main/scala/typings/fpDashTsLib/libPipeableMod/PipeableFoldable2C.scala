...
trait PipeableFoldable2C[F /* <: fpDashTsLib.libHKTMod.URIS2 */, L] extends js.Object {
  def foldMap[M](M: fpDashTsLib.libMonoidMod.Monoid[M]): js.Function1[
    /* f */ js.Function1[/* a */ js.Any, M], 
    js.Function1[/* fa */ fpDashTsLib.libHKTMod.Kind2[F, L, _], M]
  ]
  def reduce[A, B](b: B, f: js.Function2[/* b */ B, /* a */ A, B]): js.Function1[/* fa */ fpDashTsLib.libHKTMod.Kind2[F, L, A], B]
  def reduceRight[A, B](b: B, f: js.Function2[/* a */ A, /* b */ B, B]): js.Function1[/* fa */ fpDashTsLib.libHKTMod.Kind2[F, L, A], B]
}
