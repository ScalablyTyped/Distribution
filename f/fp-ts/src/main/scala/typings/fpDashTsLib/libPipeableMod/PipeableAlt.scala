...
trait PipeableAlt[F] extends js.Object {
  def alt[A](that: js.Function0[fpDashTsLib.libHKTMod.HKT[F, A]]): js.Function1[/* fa */ fpDashTsLib.libHKTMod.HKT[F, A], fpDashTsLib.libHKTMod.HKT[F, A]]
}

object PipeableAlt {
  @scala.inline
  def apply[F](
    alt: js.Function0[fpDashTsLib.libHKTMod.HKT[F, js.Any]] => js.Function1[
