...
trait PipeableFoldableWithIndex4[F /* <: fpDashTsLib.libHKTMod.URIS4 */, I] extends PipeableFoldable4[F] {
  ...
  def reduceRightWithIndex[A, B](b: B, f: js.Function3[/* i */ I, /* a */ A, /* b */ B, B]): js.Function1[/* fa */ fpDashTsLib.libHKTMod.Kind4[F, _, _, _, A], B]
  def reduceWithIndex[A, B](b: B, f: js.Function3[/* i */ I, /* b */ B, /* a */ A, B]): js.Function1[/* fa */ fpDashTsLib.libHKTMod.Kind4[F, _, _, _, A], B]
}
...
object PipeableFoldableWithIndex4 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS4 */, I](
    ...
    reduceRightWithIndex: (js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Function1[/* fa */ fpDashTsLib.libHKTMod.Kind4[F, _, _, _, js.Any], js.Any],
    reduceWithIndex: (js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Function1[/* fa */ fpDashTsLib.libHKTMod.Kind4[F, _, _, _, js.Any], js.Any]
