...
trait MonadThrow2[M /* <: fpDashTsLib.libHKTMod.URIS2 */]
  ...
  def fromEither[E, A](e: fpDashTsLib.libEitherMod.Either[E, A]): fpDashTsLib.libHKTMod.Type2[M, E, A]
  def fromOption[E, A](o: fpDashTsLib.libOptionMod.Option[A], e: E): fpDashTsLib.libHKTMod.Type2[M, E, A]
  def throwError[E, A](e: E): fpDashTsLib.libHKTMod.Type2[M, E, A]
}
...
object MonadThrow2 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS2 */](
    ...
    fromEither: fpDashTsLib.libEitherMod.Either[js.Any, js.Any] => fpDashTsLib.libHKTMod.Type2[M, js.Any, js.Any],
    fromOption: (fpDashTsLib.libOptionMod.Option[js.Any], js.Any) => fpDashTsLib.libHKTMod.Type2[M, js.Any, js.Any],
    ...
    throwError: js.Any => fpDashTsLib.libHKTMod.Type2[M, js.Any, js.Any]
  ): MonadThrow2[M] = {
