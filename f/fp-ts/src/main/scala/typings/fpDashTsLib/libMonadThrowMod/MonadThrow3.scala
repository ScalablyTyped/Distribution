...
trait MonadThrow3[M /* <: fpDashTsLib.libHKTMod.URIS3 */]
  ...
  def fromEither[U, E, A](e: fpDashTsLib.libEitherMod.Either[E, A]): fpDashTsLib.libHKTMod.Type3[M, U, E, A]
  def fromOption[U, E, A](o: fpDashTsLib.libOptionMod.Option[A], e: E): fpDashTsLib.libHKTMod.Type3[M, U, E, A]
  def throwError[U, E, A](e: E): fpDashTsLib.libHKTMod.Type3[M, U, E, A]
}
...
object MonadThrow3 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS3 */](
    ...
    fromEither: fpDashTsLib.libEitherMod.Either[js.Any, js.Any] => fpDashTsLib.libHKTMod.Type3[M, js.Any, js.Any, js.Any],
    fromOption: (fpDashTsLib.libOptionMod.Option[js.Any], js.Any) => fpDashTsLib.libHKTMod.Type3[M, js.Any, js.Any, js.Any],
    ...
    throwError: js.Any => fpDashTsLib.libHKTMod.Type3[M, js.Any, js.Any, js.Any]
  ): MonadThrow3[M] = {
