...
trait Choice3[F /* <: fpDashTsLib.es6HKTMod.URIS3 */]
  ...
  def left[U, A, B, C](pab: fpDashTsLib.es6HKTMod.Kind3[F, U, A, B]): fpDashTsLib.es6HKTMod.Kind3[F, U, fpDashTsLib.es6EitherMod.Either[A, C], fpDashTsLib.es6EitherMod.Either[B, C]]
  def right[U, A, B, C](pbc: fpDashTsLib.es6HKTMod.Kind3[F, U, B, C]): fpDashTsLib.es6HKTMod.Kind3[F, U, fpDashTsLib.es6EitherMod.Either[A, B], fpDashTsLib.es6EitherMod.Either[A, C]]
}
...
object Choice3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */](
    URI: F,
    left: fpDashTsLib.es6HKTMod.Kind3[F, js.Any, js.Any, js.Any] => fpDashTsLib.es6HKTMod.Kind3[
      F, 
      js.Any, 
    ...
    right: fpDashTsLib.es6HKTMod.Kind3[F, js.Any, js.Any, js.Any] => fpDashTsLib.es6HKTMod.Kind3[
      F, 
      js.Any, 
      fpDashTsLib.es6EitherMod.Either[js.Any, js.Any], 
      fpDashTsLib.es6EitherMod.Either[js.Any, js.Any]
