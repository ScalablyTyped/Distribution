...
trait Invariant1[F /* <: fpDashTsLib.libHKTMod.URIS */] extends js.Object {
  val URI: F
  def imap[A, B](fa: fpDashTsLib.libHKTMod.HKT[F, A], f: js.Function1[/* a */ A, B], g: js.Function1[/* b */ B, A]): fpDashTsLib.libHKTMod.Kind[F, B]
}
...
object Invariant1 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS */](
    URI: F,
    imap: (fpDashTsLib.libHKTMod.HKT[F, js.Any], js.Function1[js.Any, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.libHKTMod.Kind[F, js.Any]
  ): Invariant1[F] = {
