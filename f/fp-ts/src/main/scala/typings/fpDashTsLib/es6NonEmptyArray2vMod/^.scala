...
object ^ extends js.Object {
  ...
  def filter[A](predicate: fpDashTsLib.es6FunctionMod.Predicate[A]): js.Function1[/* nea */ NonEmptyArray[A], fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]]] = js.native
  ...
  def filterWithIndex[A](predicate: js.Function2[/* i */ scala.Double, /* a */ A, scala.Boolean]): js.Function1[/* nea */ NonEmptyArray[A], fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]]] = js.native
  @JSName("filter")
  ...
  @JSName("filter")
  def filter_ABA[A, B /* <: A */](refinement: fpDashTsLib.es6FunctionMod.Refinement[A, B]): js.Function1[/* nea */ NonEmptyArray[A], fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]]] = js.native
  ...
  def getEq[A](E: fpDashTsLib.es6EqMod.Eq[A]): fpDashTsLib.es6EqMod.Eq[NonEmptyArray[A]] = js.native
  def getSemigroup[A](): fpDashTsLib.es6SemigroupMod.Semigroup[NonEmptyArray[A]] = js.native
  def getSetoid[A](E: fpDashTsLib.es6EqMod.Eq[A]): fpDashTsLib.es6EqMod.Eq[NonEmptyArray[A]] = js.native
  ...
  def insertAt[A](i: scala.Double, a: A): js.Function1[/* nea */ NonEmptyArray[A], fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]]] = js.native
  ...
  def modifyAt[A](i: scala.Double, f: js.Function1[/* a */ A, A]): js.Function1[/* nea */ NonEmptyArray[A], fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]]] = js.native
  ...
  def updateAt[A](i: scala.Double, a: A): js.Function1[/* nea */ NonEmptyArray[A], fpDashTsLib.es6OptionMod.Option[NonEmptyArray[A]]] = js.native
