package typings
package fpDashTsLib.es6SemigroupMod
...
object ^ extends js.Object {
  ...
  def getJoinSemigroup[A](O: fpDashTsLib.es6OrdMod.Ord[A]): Semigroup[A] = js.native
  def getLastSemigroup[A](): Semigroup[A] = js.native
  def getMeetSemigroup[A](O: fpDashTsLib.es6OrdMod.Ord[A]): Semigroup[A] = js.native
