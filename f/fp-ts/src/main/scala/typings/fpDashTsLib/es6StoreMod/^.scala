...
object ^ extends js.Object {
  ...
  def experiment[F](F: fpDashTsLib.es6FunctorMod.Functor[F]): js.Function1[
    ...
    js.Function1[/* sa */ Store[_, _], fpDashTsLib.es6HKTMod.HKT[F, _]]
  ] = js.native
  @JSName("experiment")
  ...
  def peeks[S](f: fpDashTsLib.es6FunctionMod.Endomorphism[S]): js.Function1[/* sa */ Store[S, _], js.Function1[/* s */ S, _]] = js.native
