...
@js.native
trait Wilt1[W /* <: fpDashTsLib.libHKTMod.URIS */] extends js.Object {
  def apply(
    ...
    /* wa */ fpDashTsLib.libHKTMod.Kind[W, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
    ...
    fpDashTsLib.libHKTMod.Kind[
      ...
      fpDashTsLib.libCompactableMod.Separated[fpDashTsLib.libHKTMod.Kind[W, _], fpDashTsLib.libHKTMod.Kind[W, _]]
    ]
  ] = js.native
  def apply(
