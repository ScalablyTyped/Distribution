...
trait Wither2[W /* <: fpDashTsLib.libHKTMod.URIS2 */] extends js.Object {
  def apply(
    ...
    fpDashTsLib.libHKTMod.Type[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libHKTMod.Type2[W, _, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, _, fpDashTsLib.libHKTMod.Type2[W, _, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Type3[
      ...
      _, 
      _, 
      fpDashTsLib.libHKTMod.Type2[W, _, _]
    ]
  ] = js.native
  ...
  def apply[FL](
    ...
    fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, FL, fpDashTsLib.libHKTMod.Type2[W, _, _]]
  ] = js.native
  def apply[FU, FL](
