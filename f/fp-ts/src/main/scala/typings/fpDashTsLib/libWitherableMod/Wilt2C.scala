...
@js.native
trait Wilt2C[W /* <: fpDashTsLib.libHKTMod.URIS2 */, WL] extends js.Object {
  def apply(
    ...
    /* wa */ fpDashTsLib.libHKTMod.Kind2[W, WL, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
    ...
    fpDashTsLib.libHKTMod.Kind[
      ...
      fpDashTsLib.libCompactableMod.Separated[fpDashTsLib.libHKTMod.Kind2[W, WL, _], fpDashTsLib.libHKTMod.Kind2[W, WL, _]]
    ]
  ] = js.native
  def apply(
