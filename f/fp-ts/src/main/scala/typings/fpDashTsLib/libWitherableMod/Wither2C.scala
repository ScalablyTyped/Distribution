...
trait Wither2C[W /* <: fpDashTsLib.libHKTMod.URIS2 */, WL] extends js.Object {
  def apply(
    ...
    /* ta */ fpDashTsLib.libHKTMod.Kind2[W, WL, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
      fpDashTsLib.libHKTMod.Kind[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libOptionMod.Option[_]]
    ], 
    fpDashTsLib.libHKTMod.Kind[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libHKTMod.Kind2[W, WL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Kind2[fpDashTsLib.fpDashTsLibStrings.Writer, _, fpDashTsLib.libHKTMod.Kind2[W, WL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Kind3[
      ...
      _, 
      _, 
      fpDashTsLib.libHKTMod.Kind2[W, WL, _]
    ]
  ] = js.native
  def apply[F](F: fpDashTsLib.libApplicativeMod.Applicative[F]): js.Function2[
    ...
    fpDashTsLib.libHKTMod.HKT[F, fpDashTsLib.libHKTMod.Kind2[W, WL, _]]
  ] = js.native
  def apply[FL](
    ...
    fpDashTsLib.libHKTMod.Kind2[fpDashTsLib.fpDashTsLibStrings.Writer, FL, fpDashTsLib.libHKTMod.Kind2[W, WL, _]]
  ] = js.native
  def apply[FU, FL](
