...
@js.native
trait Wither2C[W /* <: fpDashTsLib.libHKTMod.URIS2 */, WL] extends js.Object {
  def apply(
    ...
    /* ta */ fpDashTsLib.libHKTMod.Type2[W, WL, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
      fpDashTsLib.libHKTMod.Type[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libOptionMod.Option[_]]
    ], 
    fpDashTsLib.libHKTMod.Type[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libHKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, _, fpDashTsLib.libHKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Type3[
      ...
      _, 
      _, 
      fpDashTsLib.libHKTMod.Type2[W, WL, _]
    ]
  ] = js.native
  def apply[F](F: fpDashTsLib.libApplicativeMod.Applicative[F]): js.Function2[
    ...
    fpDashTsLib.libHKTMod.HKT[F, fpDashTsLib.libHKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply[FL](
    ...
    fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, FL, fpDashTsLib.libHKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply[FU, FL](
