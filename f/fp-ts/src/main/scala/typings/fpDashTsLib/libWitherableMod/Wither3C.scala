...
trait Wither3C[W /* <: fpDashTsLib.libHKTMod.URIS3 */, WU, WL] extends js.Object {
  def apply(
    ...
    fpDashTsLib.libHKTMod.Type[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libHKTMod.Type3[W, WU, WL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, _, fpDashTsLib.libHKTMod.Type3[W, WU, WL, _]]
  ] = js.native
  def apply(
  ...
  def apply[FL](
    ...
    fpDashTsLib.libHKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.Writer, FL, fpDashTsLib.libHKTMod.Type3[W, WU, WL, _]]
  ] = js.native
  def apply[FU, FL](
