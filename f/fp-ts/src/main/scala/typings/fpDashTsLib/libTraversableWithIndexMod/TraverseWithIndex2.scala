...
trait TraverseWithIndex2[T /* <: fpDashTsLib.libHKTMod.URIS2 */, I] extends js.Object {
  def apply(
    ...
    /* ta */ fpDashTsLib.libHKTMod.Kind2[T, _, _], 
    /* f */ js.Function2[
      /* i */ I, 
      /* a */ js.Any, 
      fpDashTsLib.libHKTMod.Kind[fpDashTsLib.fpDashTsLibStrings.StrMap, _]
    ], 
    fpDashTsLib.libHKTMod.Kind[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libHKTMod.Kind2[T, _, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Kind2[fpDashTsLib.fpDashTsLibStrings.Writer, _, fpDashTsLib.libHKTMod.Kind2[T, _, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.libHKTMod.Kind3[
      ...
      _, 
      _, 
      fpDashTsLib.libHKTMod.Kind2[T, _, _]
    ]
  ] = js.native
  def apply[F](F: fpDashTsLib.libApplicativeMod.Applicative[F]): js.Function2[
    ...
    fpDashTsLib.libHKTMod.HKT[F, fpDashTsLib.libHKTMod.Kind2[T, _, _]]
  ] = js.native
  def apply[FL](
    ...
    fpDashTsLib.libHKTMod.Kind2[fpDashTsLib.fpDashTsLibStrings.Writer, FL, fpDashTsLib.libHKTMod.Kind2[T, _, _]]
  ] = js.native
  def apply[FU, FL](
