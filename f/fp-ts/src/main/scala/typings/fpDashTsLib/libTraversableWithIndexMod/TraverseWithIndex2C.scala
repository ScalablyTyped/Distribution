...
trait TraverseWithIndex2C[T /* <: fpDashTsLib.libHKTMod.URIS2 */, I, FL] extends js.Object {
  def apply(
    ...
    fpDashTsLib.libHKTMod.Type[fpDashTsLib.fpDashTsLibStrings.StrMap, fpDashTsLib.libHKTMod.Type2[T, FL, _]]
  ] = js.native
  def apply(
  ...
  def apply(
    ...
    /* f */ js.Function2[
      /* i */ I, 
      /* a */ js.Any, 
      fpDashTsLib.libHKTMod.Type3[fpDashTsLib.fpDashTsLibStrings.ReaderTaskEither, _, FL, _]
    ], 
