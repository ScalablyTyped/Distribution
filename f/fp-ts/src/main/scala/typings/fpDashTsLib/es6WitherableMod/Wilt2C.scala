...
@js.native
trait Wilt2C[W /* <: fpDashTsLib.es6HKTMod.URIS2 */, WL] extends js.Object {
  def apply(
    ...
    /* wa */ fpDashTsLib.es6HKTMod.Kind2[W, WL, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
    ...
    fpDashTsLib.es6HKTMod.Kind[
      ...
      fpDashTsLib.es6CompactableMod.Separated[fpDashTsLib.es6HKTMod.Kind2[W, WL, _], fpDashTsLib.es6HKTMod.Kind2[W, WL, _]]
    ]
  ] = js.native
  def apply(
