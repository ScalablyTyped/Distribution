...
@js.native
trait Witherable2C[T /* <: fpDashTsLib.es6HKTMod.URIS2 */, TL]
  extends fpDashTsLib.es6TraversableMod.Traversable2C[T, TL]
     with fpDashTsLib.es6FilterableMod.Filterable2C[T, TL] {
  ...
  def wilt[F](F: fpDashTsLib.es6ApplicativeMod.Applicative[F]): js.Function2[
    /* wa */ fpDashTsLib.es6HKTMod.Type2[T, TL, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
    ...
    fpDashTsLib.es6HKTMod.HKT[
      F, 
      fpDashTsLib.es6CompactableMod.Separated[fpDashTsLib.es6HKTMod.Type2[T, TL, _], fpDashTsLib.es6HKTMod.Type2[T, TL, _]]
    ]
  ] = js.native
  @JSName("wilt")
