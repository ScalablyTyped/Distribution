...
@js.native
trait Witherable3C[T /* <: fpDashTsLib.es6HKTMod.URIS3 */, TU, TL]
  extends fpDashTsLib.es6TraversableMod.Traversable3C[T, TU, TL]
     with fpDashTsLib.es6FilterableMod.Filterable3C[T, TU, TL] {
  ...
  def wilt[F](F: fpDashTsLib.es6ApplicativeMod.Applicative[F]): js.Function2[
    /* wa */ fpDashTsLib.es6HKTMod.Type3[T, TU, TL, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
