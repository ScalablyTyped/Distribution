...
@js.native
trait Wither2C[W /* <: fpDashTsLib.es6HKTMod.URIS2 */, WL] extends js.Object {
  def apply(
    ...
    /* ta */ fpDashTsLib.es6HKTMod.Type2[W, WL, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
      fpDashTsLib.es6HKTMod.Type[fpDashTsLib.fpDashTsLibStrings.Task, fpDashTsLib.es6OptionMod.Option[_]]
    ], 
    fpDashTsLib.es6HKTMod.Type[fpDashTsLib.fpDashTsLibStrings.Task, fpDashTsLib.es6HKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.es6HKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.State, _, fpDashTsLib.es6HKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.es6HKTMod.Type3[fpDashTsLib.fpDashTsLibStrings.IxIO, _, _, fpDashTsLib.es6HKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply[F](F: fpDashTsLib.es6ApplicativeMod.Applicative[F]): js.Function2[
    ...
    fpDashTsLib.es6HKTMod.HKT[F, fpDashTsLib.es6HKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply[FL](
    ...
    fpDashTsLib.es6HKTMod.Type2[fpDashTsLib.fpDashTsLibStrings.State, FL, fpDashTsLib.es6HKTMod.Type2[W, WL, _]]
  ] = js.native
  def apply[FU, FL](
    ...
    fpDashTsLib.es6HKTMod.Type3[fpDashTsLib.fpDashTsLibStrings.IxIO, FU, FL, fpDashTsLib.es6HKTMod.Type2[W, WL, _]]
  ] = js.native
}
