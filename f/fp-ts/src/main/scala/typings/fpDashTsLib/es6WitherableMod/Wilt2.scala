...
@js.native
trait Wilt2[W /* <: fpDashTsLib.es6HKTMod.URIS2 */] extends js.Object {
  def apply(
    ...
    /* wa */ fpDashTsLib.es6HKTMod.Type2[W, _, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
    ...
    fpDashTsLib.es6HKTMod.Type[
      ...
      fpDashTsLib.es6CompactableMod.Separated[fpDashTsLib.es6HKTMod.Type2[W, _, _], fpDashTsLib.es6HKTMod.Type2[W, _, _]]
    ]
  ] = js.native
  def apply(
