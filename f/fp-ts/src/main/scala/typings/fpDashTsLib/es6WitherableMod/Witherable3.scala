...
@js.native
trait Witherable3[T /* <: fpDashTsLib.es6HKTMod.URIS3 */]
  extends fpDashTsLib.es6TraversableMod.Traversable3[T]
     with fpDashTsLib.es6FilterableMod.Filterable3[T] {
  ...
  def wilt[F](F: fpDashTsLib.es6ApplicativeMod.Applicative[F]): js.Function2[
    /* wa */ fpDashTsLib.es6HKTMod.Kind3[T, _, _, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
    ...
    fpDashTsLib.es6HKTMod.HKT[
      F, 
      fpDashTsLib.es6CompactableMod.Separated[fpDashTsLib.es6HKTMod.Kind3[T, _, _, _], fpDashTsLib.es6HKTMod.Kind3[T, _, _, _]]
    ]
  ] = js.native
  @JSName("wilt")
