...
@js.native
trait Wilt3[W /* <: fpDashTsLib.es6HKTMod.URIS3 */] extends js.Object {
  def apply(
    ...
    /* wa */ fpDashTsLib.es6HKTMod.Kind3[W, _, _, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
    ...
    fpDashTsLib.es6HKTMod.Kind[
      ...
      fpDashTsLib.es6CompactableMod.Separated[fpDashTsLib.es6HKTMod.Kind3[W, _, _, _], fpDashTsLib.es6HKTMod.Kind3[W, _, _, _]]
    ]
  ] = js.native
  def apply(
