...
@js.native
trait Wilt1[W /* <: fpDashTsLib.es6HKTMod.URIS */] extends js.Object {
  def apply(
    ...
    /* wa */ fpDashTsLib.es6HKTMod.Kind[W, _], 
    /* f */ js.Function1[
      /* a */ js.Any, 
    ...
    fpDashTsLib.es6HKTMod.Kind[
      ...
      fpDashTsLib.es6CompactableMod.Separated[fpDashTsLib.es6HKTMod.Kind[W, _], fpDashTsLib.es6HKTMod.Kind[W, _]]
    ]
  ] = js.native
  def apply(
