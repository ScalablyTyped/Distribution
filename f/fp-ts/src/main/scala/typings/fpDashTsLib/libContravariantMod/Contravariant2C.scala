...
trait Contravariant2C[F /* <: fpDashTsLib.libHKTMod.URIS2 */, L] extends js.Object {
  val URI: F
  val _L: L
  def contramap[A, B](fa: fpDashTsLib.libHKTMod.Kind2[F, L, A], f: js.Function1[/* b */ B, A]): fpDashTsLib.libHKTMod.Kind2[F, L, B]
}
...
object Contravariant2C {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */, L](
    URI: F,
    _L: L,
    contramap: (fpDashTsLib.libHKTMod.Kind2[F, L, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.libHKTMod.Kind2[F, L, js.Any]
  ): Contravariant2C[F, L] = {
