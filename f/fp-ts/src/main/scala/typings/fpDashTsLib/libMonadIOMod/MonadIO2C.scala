...
trait MonadIO2C[M /* <: fpDashTsLib.libHKTMod.URIS2 */, L]
  ...
  def fromIO[A](fa: fpDashTsLib.libIOMod.IO[A]): fpDashTsLib.libHKTMod.Kind2[M, L, A]
}
...
object MonadIO2C {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS2 */, L](
    ...
    fromIO: fpDashTsLib.libIOMod.IO[js.Any] => fpDashTsLib.libHKTMod.Kind2[M, L, js.Any],
