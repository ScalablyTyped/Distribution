...
trait MonadIO3[M /* <: fpDashTsLib.libHKTMod.URIS3 */]
  ...
  def fromIO[U, L, A](fa: fpDashTsLib.libIOMod.IO[A]): fpDashTsLib.libHKTMod.Kind3[M, U, L, A]
}
...
object MonadIO3 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS3 */](
    ...
    fromIO: fpDashTsLib.libIOMod.IO[js.Any] => fpDashTsLib.libHKTMod.Kind3[M, js.Any, js.Any, js.Any],
