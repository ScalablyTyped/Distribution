...
trait Profunctor2C[F /* <: fpDashTsLib.libHKTMod.URIS2 */, L]
  ...
  def promap[A, C, D](
    flc: fpDashTsLib.libHKTMod.Type2[F, L, C],
...
object Profunctor2C {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */, L](
    ...
    promap: (fpDashTsLib.libHKTMod.Type2[F, L, js.Any], js.Function1[js.Any, L], js.Function1[js.Any, js.Any]) => fpDashTsLib.libHKTMod.Type2[F, js.Any, js.Any]
  ): Profunctor2C[F, L] = {
