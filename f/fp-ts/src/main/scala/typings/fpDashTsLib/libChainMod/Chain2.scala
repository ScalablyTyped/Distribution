...
object Chain2 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */](
    URI: F,
    ap: (fpDashTsLib.libHKTMod.Kind2[F, js.Any, js.Function1[js.Any, js.Any]], fpDashTsLib.libHKTMod.Kind2[F, js.Any, js.Any]) => fpDashTsLib.libHKTMod.Kind2[F, js.Any, js.Any],
    chain: (fpDashTsLib.libHKTMod.Kind2[F, js.Any, js.Any], js.Function1[js.Any, fpDashTsLib.libHKTMod.Kind2[F, js.Any, js.Any]]) => fpDashTsLib.libHKTMod.Kind2[F, js.Any, js.Any],
