...
trait MonadThrow2[M /* <: fpDashTsLib.es6HKTMod.URIS2 */]
  ...
  /** @deprecated */
  def fromEither[E, A](e: fpDashTsLib.es6EitherMod.Either[E, A]): fpDashTsLib.es6HKTMod.Kind2[M, E, A]
  /** @deprecated */
  def fromOption[E, A](o: fpDashTsLib.es6OptionMod.Option[A], e: E): fpDashTsLib.es6HKTMod.Kind2[M, E, A]
  def throwError[E, A](e: E): fpDashTsLib.es6HKTMod.Kind2[M, E, A]
}
...
object MonadThrow2 {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    ...
    fromEither: fpDashTsLib.es6EitherMod.Either[js.Any, js.Any] => fpDashTsLib.es6HKTMod.Kind2[M, js.Any, js.Any],
    fromOption: (fpDashTsLib.es6OptionMod.Option[js.Any], js.Any) => fpDashTsLib.es6HKTMod.Kind2[M, js.Any, js.Any],
    ...
    throwError: js.Any => fpDashTsLib.es6HKTMod.Kind2[M, js.Any, js.Any]
  ): MonadThrow2[M] = {
