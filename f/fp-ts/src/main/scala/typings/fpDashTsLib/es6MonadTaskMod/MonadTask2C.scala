...
trait MonadTask2C[M /* <: fpDashTsLib.es6HKTMod.URIS2 */, L]
  ...
  def fromTask[A](fa: fpDashTsLib.es6TaskMod.Task[A]): fpDashTsLib.es6HKTMod.Kind2[M, L, A]
}
...
object MonadTask2C {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS2 */, L](
    ...
    fromTask: fpDashTsLib.es6TaskMod.Task[js.Any] => fpDashTsLib.es6HKTMod.Kind2[M, L, js.Any],
