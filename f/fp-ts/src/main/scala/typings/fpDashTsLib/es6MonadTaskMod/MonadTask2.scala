...
trait MonadTask2[M /* <: fpDashTsLib.es6HKTMod.URIS2 */]
  ...
  def fromTask[L, A](fa: fpDashTsLib.es6TaskMod.Task[A]): fpDashTsLib.es6HKTMod.Type2[M, L, A]
}
...
object MonadTask2 {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    ...
    fromTask: fpDashTsLib.es6TaskMod.Task[js.Any] => fpDashTsLib.es6HKTMod.Type2[M, js.Any, js.Any],
