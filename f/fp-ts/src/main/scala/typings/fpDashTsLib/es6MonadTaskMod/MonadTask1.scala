...
trait MonadTask1[M /* <: fpDashTsLib.es6HKTMod.URIS */]
  ...
  def fromTask[A](fa: fpDashTsLib.es6TaskMod.Task[A]): fpDashTsLib.es6HKTMod.Type[M, A]
}
...
object MonadTask1 {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS */](
    ...
    fromTask: fpDashTsLib.es6TaskMod.Task[js.Any] => fpDashTsLib.es6HKTMod.Type[M, js.Any],
