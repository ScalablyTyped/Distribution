...
trait Comonad3C[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, U, L]
  ...
  def extract[A](ca: fpDashTsLib.es6HKTMod.Type3[F, U, L, A]): A
}
...
object Comonad3C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, U, L](
    ...
    _L: L,
    _U: U,
    extend: (fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any], js.Function1[/* fa */ fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any], js.Any]) => fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any],
    extract: fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any] => js.Any,
