...
trait FoldableWithIndex1[F /* <: fpDashTsLib.es6HKTMod.URIS */, I]
  ...
  def foldrWithIndex[A, B](fa: fpDashTsLib.es6HKTMod.Type[F, A], b: B, f: js.Function3[/* i */ I, /* a */ A, /* b */ B, B]): B
  def reduceWithIndex[A, B](fa: fpDashTsLib.es6HKTMod.Type[F, A], b: B, f: js.Function3[/* i */ I, /* b */ B, /* a */ A, B]): B
}
...
object FoldableWithIndex1 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */, I](
    ...
    foldrWithIndex: (fpDashTsLib.es6HKTMod.Type[F, js.Any], js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Any,
    reduce: (fpDashTsLib.es6HKTMod.Type[F, js.Any], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any,
    reduceWithIndex: (fpDashTsLib.es6HKTMod.Type[F, js.Any], js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Any
