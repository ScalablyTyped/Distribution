...
object FoldableWithIndex3C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, I, U, L](
    ...
    foldrWithIndex: (fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any], js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Any,
    reduce: (fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any,
    reduceWithIndex: (fpDashTsLib.es6HKTMod.Type3[F, U, L, js.Any], js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Any
