...
trait FoldableWithIndex2C[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, I, L]
  extends fpDashTsLib.es6Foldable2vMod.Foldable2v2C[F, L] {
...
object FoldableWithIndex2C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, I, L](
    ...
    foldrWithIndex: (fpDashTsLib.es6HKTMod.Kind2[F, L, js.Any], js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Any,
    reduce: (fpDashTsLib.es6HKTMod.Kind2[F, L, js.Any], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any,
    reduceWithIndex: (fpDashTsLib.es6HKTMod.Kind2[F, L, js.Any], js.Any, js.Function3[/* i */ I, js.Any, js.Any, js.Any]) => js.Any
