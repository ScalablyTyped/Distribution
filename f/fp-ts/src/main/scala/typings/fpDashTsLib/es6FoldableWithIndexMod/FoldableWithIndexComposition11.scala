...
object FoldableWithIndexComposition11 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */, FI, G /* <: fpDashTsLib.es6HKTMod.URIS */, GI](
    ...
    foldrWithIndex: (fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, js.Any]], js.Any, js.Function3[/* i */ js.Tuple2[FI, GI], js.Any, js.Any, js.Any]) => js.Any,
    reduce: (fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, js.Any]], js.Any, js.Function2[js.Any, js.Any, js.Any]) => js.Any,
    reduceWithIndex: (fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, js.Any]], js.Any, js.Function3[/* i */ js.Tuple2[FI, GI], js.Any, js.Any, js.Any]) => js.Any
