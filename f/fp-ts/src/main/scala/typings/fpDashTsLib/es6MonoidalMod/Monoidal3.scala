...
trait Monoidal3[F /* <: fpDashTsLib.es6HKTMod.URIS3 */]
  ...
  def mult[U, L, A, B](fa: fpDashTsLib.es6HKTMod.Kind3[F, U, L, A], fb: fpDashTsLib.es6HKTMod.Kind3[F, U, L, B]): fpDashTsLib.es6HKTMod.Kind3[F, U, L, js.Tuple2[A, B]]
  def unit[U, L](): fpDashTsLib.es6HKTMod.Kind3[F, U, L, scala.Unit]
}
...
object Monoidal3 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */](
    ...
    mult: (fpDashTsLib.es6HKTMod.Kind3[F, js.Any, js.Any, js.Any], fpDashTsLib.es6HKTMod.Kind3[F, js.Any, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Kind3[F, js.Any, js.Any, js.Tuple2[js.Any, js.Any]],
    unit: () => fpDashTsLib.es6HKTMod.Kind3[F, js.Any, js.Any, scala.Unit]
  ): Monoidal3[F] = {
