...
trait Monoidal2C[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, L]
  ...
  def mult[A, B](fa: fpDashTsLib.es6HKTMod.Kind2[F, L, A], fb: fpDashTsLib.es6HKTMod.Kind2[F, L, B]): fpDashTsLib.es6HKTMod.Kind2[F, L, js.Tuple2[A, B]]
  def unit(): fpDashTsLib.es6HKTMod.Kind2[F, L, scala.Unit]
}
...
object Monoidal2C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */, L](
    ...
    mult: (fpDashTsLib.es6HKTMod.Kind2[F, L, js.Any], fpDashTsLib.es6HKTMod.Kind2[F, L, js.Any]) => fpDashTsLib.es6HKTMod.Kind2[F, L, js.Tuple2[js.Any, js.Any]],
    unit: () => fpDashTsLib.es6HKTMod.Kind2[F, L, scala.Unit]
  ): Monoidal2C[F, L] = {
