...
trait Monoidal2[F /* <: fpDashTsLib.es6HKTMod.URIS2 */]
  ...
  def mult[L, A, B](fa: fpDashTsLib.es6HKTMod.Kind2[F, L, A], fb: fpDashTsLib.es6HKTMod.Kind2[F, L, B]): fpDashTsLib.es6HKTMod.Kind2[F, L, js.Tuple2[A, B]]
  def unit[L](): fpDashTsLib.es6HKTMod.Kind2[F, L, scala.Unit]
}
...
object Monoidal2 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    ...
    mult: (fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Any], fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Any]) => fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Tuple2[js.Any, js.Any]],
    unit: () => fpDashTsLib.es6HKTMod.Kind2[F, js.Any, scala.Unit]
  ): Monoidal2[F] = {
