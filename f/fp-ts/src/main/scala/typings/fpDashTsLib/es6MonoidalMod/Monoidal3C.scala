...
trait Monoidal3C[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, U, L]
  ...
  def mult[A, B](fa: fpDashTsLib.es6HKTMod.Kind3[F, U, L, A], fb: fpDashTsLib.es6HKTMod.Kind3[F, U, L, B]): fpDashTsLib.es6HKTMod.Kind3[F, U, L, js.Tuple2[A, B]]
  def unit(): fpDashTsLib.es6HKTMod.Kind3[F, U, L, scala.Unit]
}
...
object Monoidal3C {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS3 */, U, L](
    ...
    mult: (fpDashTsLib.es6HKTMod.Kind3[F, U, L, js.Any], fpDashTsLib.es6HKTMod.Kind3[F, U, L, js.Any]) => fpDashTsLib.es6HKTMod.Kind3[F, U, L, js.Tuple2[js.Any, js.Any]],
    unit: () => fpDashTsLib.es6HKTMod.Kind3[F, U, L, scala.Unit]
  ): Monoidal3C[F, U, L] = {
