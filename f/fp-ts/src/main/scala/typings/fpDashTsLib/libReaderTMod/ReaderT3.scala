...
object ReaderT3 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS3 */](
    ...
    map: (js.Function1[js.Any, js.Any], js.Function1[js.Any, fpDashTsLib.libHKTMod.Type3[M, js.Any, js.Any, js.Any]]) => js.Function1[js.Any, fpDashTsLib.libHKTMod.Type3[M, js.Any, js.Any, js.Any]],
