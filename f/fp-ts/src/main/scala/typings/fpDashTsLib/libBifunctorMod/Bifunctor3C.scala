...
object Bifunctor3C {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS3 */, U](
    URI: F,
    _U: U,
    bimap: (fpDashTsLib.libHKTMod.Kind3[F, U, js.Any, js.Any], js.Function1[js.Any, js.Any], js.Function1[js.Any, js.Any]) => fpDashTsLib.libHKTMod.Kind3[F, U, js.Any, js.Any]
  ): Bifunctor3C[F, U] = {
