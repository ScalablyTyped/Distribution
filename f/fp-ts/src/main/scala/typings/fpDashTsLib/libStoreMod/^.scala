...
object ^ extends js.Object {
  ...
  def peeks[S](f: fpDashTsLib.libFunctionMod.Endomorphism[S]): js.Function1[/* sa */ fpDashTsLib.libStoreMod.Store[S, _], js.Function1[/* s */ S, _]] = js.native
  def seeks[S](f: fpDashTsLib.libFunctionMod.Endomorphism[S]): js.Function1[/* sa */ fpDashTsLib.libStoreMod.Store[S, _], fpDashTsLib.libStoreMod.Store[S, _]] = js.native
}
