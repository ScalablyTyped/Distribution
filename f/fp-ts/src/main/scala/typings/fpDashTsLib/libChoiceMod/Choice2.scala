...
trait Choice2[F /* <: fpDashTsLib.libHKTMod.URIS2 */]
  ...
  def left[A, B, C](pab: fpDashTsLib.libHKTMod.Kind2[F, A, B]): fpDashTsLib.libHKTMod.Kind2[F, fpDashTsLib.libEitherMod.Either[A, C], fpDashTsLib.libEitherMod.Either[B, C]]
  def right[A, B, C](pbc: fpDashTsLib.libHKTMod.Kind2[F, B, C]): fpDashTsLib.libHKTMod.Kind2[F, fpDashTsLib.libEitherMod.Either[A, B], fpDashTsLib.libEitherMod.Either[A, C]]
}
...
object Choice2 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS2 */](
    URI: F,
    left: fpDashTsLib.libHKTMod.Kind2[F, js.Any, js.Any] => fpDashTsLib.libHKTMod.Kind2[
      F, 
    ...
    right: fpDashTsLib.libHKTMod.Kind2[F, js.Any, js.Any] => fpDashTsLib.libHKTMod.Kind2[
      F, 
      fpDashTsLib.libEitherMod.Either[js.Any, js.Any], 
      fpDashTsLib.libEitherMod.Either[js.Any, js.Any]
    ]
