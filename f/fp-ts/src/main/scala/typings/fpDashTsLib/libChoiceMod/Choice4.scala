...
trait Choice4[F /* <: fpDashTsLib.libHKTMod.URIS4 */]
  ...
  def left[X, U, A, B, C](pab: fpDashTsLib.libHKTMod.Kind4[F, X, U, A, B]): fpDashTsLib.libHKTMod.Kind4[F, X, U, fpDashTsLib.libEitherMod.Either[A, C], fpDashTsLib.libEitherMod.Either[B, C]]
  def right[X, U, A, B, C](pbc: fpDashTsLib.libHKTMod.Kind4[F, X, U, B, C]): fpDashTsLib.libHKTMod.Kind4[F, X, U, fpDashTsLib.libEitherMod.Either[A, B], fpDashTsLib.libEitherMod.Either[A, C]]
}
...
object Choice4 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS4 */](
    URI: F,
    left: fpDashTsLib.libHKTMod.Kind4[F, js.Any, js.Any, js.Any, js.Any] => fpDashTsLib.libHKTMod.Kind4[
      F, 
      js.Any, 
      js.Any, 
    ...
    right: fpDashTsLib.libHKTMod.Kind4[F, js.Any, js.Any, js.Any, js.Any] => fpDashTsLib.libHKTMod.Kind4[
      F, 
      js.Any, 
      js.Any, 
      fpDashTsLib.libEitherMod.Either[js.Any, js.Any], 
