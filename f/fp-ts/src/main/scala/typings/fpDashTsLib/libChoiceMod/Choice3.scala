...
object Choice3 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS3 */](
    URI: F,
    left: fpDashTsLib.libHKTMod.Type3[F, js.Any, js.Any, js.Any] => fpDashTsLib.libHKTMod.Type3[
      F, 
      js.Any, 
    ...
    right: fpDashTsLib.libHKTMod.Type3[F, js.Any, js.Any, js.Any] => fpDashTsLib.libHKTMod.Type3[
      F, 
      js.Any, 
      fpDashTsLib.libEitherMod.Either[js.Any, js.Any], 
      fpDashTsLib.libEitherMod.Either[js.Any, js.Any]
