...
object ^ extends js.Object {
  def fanin[F /* <: fpDashTsLib.libHKTMod.URIS3 */](F: fpDashTsLib.libCategoryMod.Category3[F] with Choice3[F]): js.Function2[
  ...
  def fanin[F /* <: fpDashTsLib.libHKTMod.URIS2 */](F: fpDashTsLib.libCategoryMod.Category2[F] with Choice2[F]): js.Function2[
  ...
  def splitChoice[F /* <: fpDashTsLib.libHKTMod.URIS2 */](F: fpDashTsLib.libCategoryMod.Category2[F] with Choice2[F]): js.Function2[
  ...
  def splitChoice[F /* <: fpDashTsLib.libHKTMod.URIS3 */](F: fpDashTsLib.libCategoryMod.Category3[F] with Choice3[F]): js.Function2[
