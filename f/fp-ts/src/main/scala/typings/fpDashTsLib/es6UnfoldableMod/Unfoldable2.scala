...
trait Unfoldable2[F /* <: fpDashTsLib.es6HKTMod.URIS2 */] extends js.Object {
  val URI: F
  def unfoldr[L, A, B](b: B, f: js.Function1[/* b */ B, fpDashTsLib.es6OptionMod.Option[js.Tuple2[A, B]]]): fpDashTsLib.es6HKTMod.Kind2[F, L, A]
}
...
object Unfoldable2 {
  ...
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    URI: F,
    unfoldr: (js.Any, js.Function1[js.Any, fpDashTsLib.es6OptionMod.Option[js.Tuple2[js.Any, js.Any]]]) => fpDashTsLib.es6HKTMod.Kind2[F, js.Any, js.Any]
  ): Unfoldable2[F] = {
