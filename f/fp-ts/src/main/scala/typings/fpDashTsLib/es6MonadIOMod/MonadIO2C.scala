...
trait MonadIO2C[M /* <: fpDashTsLib.es6HKTMod.URIS2 */, L]
  ...
  def fromIO[A](fa: fpDashTsLib.es6IOMod.IO[A]): fpDashTsLib.es6HKTMod.Type2[M, L, A]
}
...
object MonadIO2C {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS2 */, L](
    ...
    fromIO: fpDashTsLib.es6IOMod.IO[js.Any] => fpDashTsLib.es6HKTMod.Type2[M, L, js.Any],
