...
trait MonadIO2[M /* <: fpDashTsLib.es6HKTMod.URIS2 */]
  ...
  def fromIO[L, A](fa: fpDashTsLib.es6IOMod.IO[A]): fpDashTsLib.es6HKTMod.Type2[M, L, A]
}
...
object MonadIO2 {
  ...
  def apply[M /* <: fpDashTsLib.es6HKTMod.URIS2 */](
    ...
    fromIO: fpDashTsLib.es6IOMod.IO[js.Any] => fpDashTsLib.es6HKTMod.Type2[M, js.Any, js.Any],
