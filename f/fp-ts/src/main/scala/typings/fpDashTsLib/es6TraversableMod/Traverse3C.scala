...
@js.native
trait Traverse3C[T /* <: fpDashTsLib.es6HKTMod.URIS3 */, TU, TL] extends js.Object {
  def apply(
    ...
    /* ta */ fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, _], 
    /* f */ js.Function1[/* a */ js.Any, fpDashTsLib.es6HKTMod.Kind[fpDashTsLib.fpDashTsLibStrings.Task, _]], 
    fpDashTsLib.es6HKTMod.Kind[fpDashTsLib.fpDashTsLibStrings.Task, fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.es6HKTMod.Kind2[fpDashTsLib.fpDashTsLibStrings.State, _, fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, _]]
  ] = js.native
  def apply(
    ...
    fpDashTsLib.es6HKTMod.Kind3[fpDashTsLib.fpDashTsLibStrings.IxIO, _, _, fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, _]]
  ] = js.native
  def apply[F](F: fpDashTsLib.es6ApplicativeMod.Applicative[F]): js.Function2[
    ...
    fpDashTsLib.es6HKTMod.HKT[F, fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, _]]
  ] = js.native
  def apply[FL](
    ...
    fpDashTsLib.es6HKTMod.Kind2[fpDashTsLib.fpDashTsLibStrings.State, FL, fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, _]]
  ] = js.native
  def apply[FU, FL](
    ...
    fpDashTsLib.es6HKTMod.Kind3[fpDashTsLib.fpDashTsLibStrings.IxIO, FU, FL, fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, _]]
  ] = js.native
}
