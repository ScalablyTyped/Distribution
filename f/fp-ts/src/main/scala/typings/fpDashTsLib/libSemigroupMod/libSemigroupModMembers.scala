...
object libSemigroupModMembers extends js.Object {
  ...
  def getRecordSemigroup[O /* <: org.scalablytyped.runtime.StringDictionary[js.Any] */](semigroups: fpDashTsLib.fpDashTsLibStrings.getRecordSemigroup with O): Semigroup[O] = js.native
}
