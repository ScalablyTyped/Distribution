...
trait MonadTask1[M /* <: fpDashTsLib.libHKTMod.URIS */]
  ...
  def fromTask[A](fa: fpDashTsLib.libTaskMod.Task[A]): fpDashTsLib.libHKTMod.Kind[M, A]
}
...
object MonadTask1 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS */](
    ...
    fromTask: fpDashTsLib.libTaskMod.Task[js.Any] => fpDashTsLib.libHKTMod.Kind[M, js.Any],
