...
trait MonadTask3C[M /* <: fpDashTsLib.libHKTMod.URIS3 */, U, L]
  ...
  def fromTask[A](fa: fpDashTsLib.libTaskMod.Task[A]): fpDashTsLib.libHKTMod.Kind3[M, U, L, A]
}
...
object MonadTask3C {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS3 */, U, L](
    ...
    fromTask: fpDashTsLib.libTaskMod.Task[js.Any] => fpDashTsLib.libHKTMod.Kind3[M, U, L, js.Any],
