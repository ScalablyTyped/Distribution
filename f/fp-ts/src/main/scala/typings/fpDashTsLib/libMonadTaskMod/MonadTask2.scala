...
trait MonadTask2[M /* <: fpDashTsLib.libHKTMod.URIS2 */]
  ...
  def fromTask[L, A](fa: fpDashTsLib.libTaskMod.Task[A]): fpDashTsLib.libHKTMod.Kind2[M, L, A]
}
...
object MonadTask2 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS2 */](
    ...
    fromTask: fpDashTsLib.libTaskMod.Task[js.Any] => fpDashTsLib.libHKTMod.Kind2[M, js.Any, js.Any],
