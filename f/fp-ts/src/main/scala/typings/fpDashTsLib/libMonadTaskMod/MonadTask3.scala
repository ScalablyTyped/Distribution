...
trait MonadTask3[M /* <: fpDashTsLib.libHKTMod.URIS3 */]
  ...
  def fromTask[U, L, A](fa: fpDashTsLib.libTaskMod.Task[A]): fpDashTsLib.libHKTMod.Kind3[M, U, L, A]
}
...
object MonadTask3 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS3 */](
    ...
    fromTask: fpDashTsLib.libTaskMod.Task[js.Any] => fpDashTsLib.libHKTMod.Kind3[M, js.Any, js.Any, js.Any],
