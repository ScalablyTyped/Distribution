...
trait Sequence3C[T /* <: fpDashTsLib.es6HKTMod.URIS3 */, TU, TL] extends js.Object {
  def apply(
    ...
    /* ta */ fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, fpDashTsLib.es6HKTMod.Kind[fpDashTsLib.fpDashTsLibStrings.Task, _]], 
  ...
  def apply(
    ...
    /* ta */ fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, fpDashTsLib.es6HKTMod.Kind2[fpDashTsLib.fpDashTsLibStrings.State, _, _]], 
  ...
  def apply(
    ...
    /* ta */ fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, fpDashTsLib.es6HKTMod.Kind3[fpDashTsLib.fpDashTsLibStrings.IxIO, _, _, _]], 
  ...
  def apply[F](F: fpDashTsLib.es6ApplicativeMod.Applicative[F]): js.Function1[
    /* ta */ fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, fpDashTsLib.es6HKTMod.HKT[F, _]], 
  ...
  def apply[FL](
    ...
    /* ta */ fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, fpDashTsLib.es6HKTMod.Kind2[fpDashTsLib.fpDashTsLibStrings.State, FL, _]], 
  ...
  def apply[FU, FL](
    ...
    /* ta */ fpDashTsLib.es6HKTMod.Kind3[T, TU, TL, fpDashTsLib.es6HKTMod.Kind3[fpDashTsLib.fpDashTsLibStrings.IxIO, FU, FL, _]], 
