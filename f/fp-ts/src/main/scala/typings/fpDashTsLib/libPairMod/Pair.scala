...
class Pair[A] protected () extends js.Object {
  ...
  def first(f: fpDashTsLib.libFunctionMod.Endomorphism[A]): Pair[A] = js.native
  def map[B](f: js.Function1[/* a */ A, B]): Pair[B] = js.native
  def reduce[B](b: B, f: js.Function2[/* b */ B, /* a */ A, B]): B = js.native
  /** Map a function over the second field of a pair */
  def second(f: fpDashTsLib.libFunctionMod.Endomorphism[A]): Pair[A] = js.native
