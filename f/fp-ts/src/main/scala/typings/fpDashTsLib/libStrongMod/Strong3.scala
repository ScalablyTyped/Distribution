...
object Strong3 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS3 */](
    URI: F,
    first: fpDashTsLib.libHKTMod.Type3[F, js.Any, js.Any, js.Any] => fpDashTsLib.libHKTMod.Type3[F, js.Any, js.Tuple2[js.Any, js.Any], js.Tuple2[js.Any, js.Any]],
    ...
    second: fpDashTsLib.libHKTMod.Type3[F, js.Any, js.Any, js.Any] => fpDashTsLib.libHKTMod.Type3[F, js.Any, js.Tuple2[js.Any, js.Any], js.Tuple2[js.Any, js.Any]]
  ): Strong3[F] = {
