...
trait Strong4[F /* <: fpDashTsLib.libHKTMod.URIS4 */]
  ...
  def first[X, U, A, B, C](pab: fpDashTsLib.libHKTMod.Kind4[F, X, U, A, B]): fpDashTsLib.libHKTMod.Kind4[F, X, U, js.Tuple2[A, C], js.Tuple2[B, C]]
  def second[X, U, A, B, C](pab: fpDashTsLib.libHKTMod.Kind4[F, X, U, B, C]): fpDashTsLib.libHKTMod.Kind4[F, X, U, js.Tuple2[A, B], js.Tuple2[A, C]]
}
...
object Strong4 {
  ...
  def apply[F /* <: fpDashTsLib.libHKTMod.URIS4 */](
    URI: F,
    first: fpDashTsLib.libHKTMod.Kind4[F, js.Any, js.Any, js.Any, js.Any] => fpDashTsLib.libHKTMod.Kind4[F, js.Any, js.Any, js.Tuple2[js.Any, js.Any], js.Tuple2[js.Any, js.Any]],
    ...
    second: fpDashTsLib.libHKTMod.Kind4[F, js.Any, js.Any, js.Any, js.Any] => fpDashTsLib.libHKTMod.Kind4[F, js.Any, js.Any, js.Tuple2[js.Any, js.Any], js.Tuple2[js.Any, js.Any]]
  ): Strong4[F] = {
