...
trait ApplicativeComposition11[F /* <: fpDashTsLib.es6HKTMod.URIS */, G /* <: fpDashTsLib.es6HKTMod.URIS */]
  ...
  def ap[A, B](
    fgab: fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, js.Function1[/* a */ A, B]]],
  ...
  def of[A](a: A): fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, A]]
}

object ApplicativeComposition11 {
  @scala.inline
  def apply[F /* <: fpDashTsLib.es6HKTMod.URIS */, G /* <: fpDashTsLib.es6HKTMod.URIS */](
    ap: (fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, js.Function1[js.Any, js.Any]]], fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, js.Any]]) => fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, js.Any]],
    ...
    of: js.Any => fpDashTsLib.es6HKTMod.Type[F, fpDashTsLib.es6HKTMod.Type[G, js.Any]]
