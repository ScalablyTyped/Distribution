...
object OptionT1 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS */](
    ...
    chain: (js.Function1[js.Any, fpDashTsLib.libHKTMod.Kind[M, fpDashTsLib.libOptionMod.Option[js.Any]]], fpDashTsLib.libHKTMod.Kind[M, fpDashTsLib.libOptionMod.Option[js.Any]]) => fpDashTsLib.libHKTMod.Kind[M, fpDashTsLib.libOptionMod.Option[js.Any]],
