...
object OptionT2 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS2 */](
    ...
    ], fpDashTsLib.libHKTMod.Type2[M, js.Any, fpDashTsLib.libOptionMod.Option[js.Any]]) => fpDashTsLib.libHKTMod.Type2[M, js.Any, fpDashTsLib.libOptionMod.Option[js.Any]],
