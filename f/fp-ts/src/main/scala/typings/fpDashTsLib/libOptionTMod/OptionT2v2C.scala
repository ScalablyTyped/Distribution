...
object OptionT2v2C {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS2 */, L](
    ...
    chain: (fpDashTsLib.libHKTMod.Kind2[M, L, fpDashTsLib.libOptionMod.Option[js.Any]], js.Function1[js.Any, fpDashTsLib.libHKTMod.Kind2[M, L, fpDashTsLib.libOptionMod.Option[js.Any]]]) => fpDashTsLib.libHKTMod.Kind2[M, L, fpDashTsLib.libOptionMod.Option[js.Any]],
