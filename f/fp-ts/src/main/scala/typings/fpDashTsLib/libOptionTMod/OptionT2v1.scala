...
object OptionT2v1 {
  ...
  def apply[M /* <: fpDashTsLib.libHKTMod.URIS */](
    ...
    chain: (fpDashTsLib.libHKTMod.Type[M, fpDashTsLib.libOptionMod.Option[js.Any]], js.Function1[js.Any, fpDashTsLib.libHKTMod.Type[M, fpDashTsLib.libOptionMod.Option[js.Any]]]) => fpDashTsLib.libHKTMod.Type[M, fpDashTsLib.libOptionMod.Option[js.Any]],
