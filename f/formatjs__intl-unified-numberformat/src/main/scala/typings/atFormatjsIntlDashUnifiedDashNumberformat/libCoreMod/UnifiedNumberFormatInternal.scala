...
trait UnifiedNumberFormatInternal extends NumberFormatDigitInternalSlots {
  ...
  var compactDisplay: NonNullable[
    /* import warning: importer.ImportType#apply Failed type conversion: @formatjs/intl-unified-numberformat.@formatjs/intl-unified-numberformat/lib/core.UnifiedNumberFormatOptions['compactDisplay'] */ js.Any
  ]
  var currency: js.UndefOr[String] = js.undefined
  var currencyDisplay: NonNullable[
    /* import warning: importer.ImportType#apply Failed type conversion: @formatjs/intl-unified-numberformat.@formatjs/intl-unified-numberformat/lib/core.UnifiedNumberFormatOptions['currencyDisplay'] */ js.Any
  ]
  var currencySign: NonNullable[
    /* import warning: importer.ImportType#apply Failed type conversion: @formatjs/intl-unified-numberformat.@formatjs/intl-unified-numberformat/lib/core.UnifiedNumberFormatOptions['currencySign'] */ js.Any
  ]
  var dataLocale: String
  var ild: NumberILD
  var locale: String
  var notation: NonNullable[
    /* import warning: importer.ImportType#apply Failed type conversion: @formatjs/intl-unified-numberformat.@formatjs/intl-unified-numberformat/lib/core.UnifiedNumberFormatOptions['notation'] */ js.Any
  ]
  var numberingSystem: String
  var patterns: NumberLocalePatternData
  var relevantExtensionKeys: js.Array[String]
  var signDisplay: NonNullable[
    /* import warning: importer.ImportType#apply Failed type conversion: @formatjs/intl-unified-numberformat.@formatjs/intl-unified-numberformat/lib/core.UnifiedNumberFormatOptions['signDisplay'] */ js.Any
  ]
  var style: NonNullable[
    /* import warning: importer.ImportType#apply Failed type conversion: @formatjs/intl-unified-numberformat.@formatjs/intl-unified-numberformat/lib/core.UnifiedNumberFormatOptions['style'] */ js.Any
  ]
  var unit: js.UndefOr[String] = js.undefined
  var unitDisplay: NonNullable[
    /* import warning: importer.ImportType#apply Failed type conversion: @formatjs/intl-unified-numberformat.@formatjs/intl-unified-numberformat/lib/core.UnifiedNumberFormatOptions['unitDisplay'] */ js.Any
  ]
