...
object compatAppDistFirestoreMod {
  ...
  @JSImport("firebase/compat/app/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/app/dist/firestore", "QueryStartAtConstraint")
  @js.native
