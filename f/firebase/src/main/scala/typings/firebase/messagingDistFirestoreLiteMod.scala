...
object messagingDistFirestoreLiteMod {
  ...
  @JSImport("firebase/messaging/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/messaging/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
