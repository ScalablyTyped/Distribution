...
object compatMessagingDistFirestoreMod {
  ...
  @JSImport("firebase/compat/messaging/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/messaging/dist/firestore", "QueryEndAtConstraint")
  @js.native
  open class QueryEndAtConstraint ()
    extends typings.firebaseFirestore.mod.QueryEndAtConstraint
  
  @JSImport("firebase/compat/messaging/dist/firestore", "QueryFieldFilterConstraint")
  @js.native
  open class QueryFieldFilterConstraint ()
    extends typings.firebaseFirestore.mod.QueryFieldFilterConstraint
  
  @JSImport("firebase/compat/messaging/dist/firestore", "QueryLimitConstraint")
  @js.native
  open class QueryLimitConstraint ()
    extends typings.firebaseFirestore.mod.QueryLimitConstraint
  
  @JSImport("firebase/compat/messaging/dist/firestore", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/messaging/dist/firestore", "QueryStartAtConstraint")
  @js.native
