...
object authDistFirestoreLiteMod {
  
  @JSImport("firebase/auth/dist/firestore/lite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/dist/firestore/lite", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.liteMod.AggregateField[T]
  
  @JSImport("firebase/auth/dist/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/auth/dist/firestore/lite", "Bytes")
  @js.native
  ...
  @JSImport("firebase/auth/dist/firestore/lite", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.liteMod.Transaction
  
  @JSImport("firebase/auth/dist/firestore/lite", "WriteBatch")
  @js.native
