...
import typings.firebase.compatMod.firebase.appCheck.AppCheck
import typings.firebase.compatMod.firebase.appCheck.CustomProviderOptions
...
object appCheck {
  ...
  open class CustomProvider protected ()
    extends StObject
       with typings.firebase.compatMod.firebase.appCheck.CustomProvider {
    /**
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends StObject
       with typings.firebase.compatMod.firebase.appCheck.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends StObject
       with typings.firebase.compatMod.firebase.appCheck.ReCaptchaV3Provider {
    /**
