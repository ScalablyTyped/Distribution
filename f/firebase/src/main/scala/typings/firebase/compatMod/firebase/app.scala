...
import typings.firebase.compatMod.firebase.firestore.Firestore
import typings.firebase.compatMod.firebase.functions.Functions
import typings.firebase.compatMod.firebase.installations.Installations
import typings.firebase.compatMod.firebase.messaging.Messaging
