  ...
  */
  ...
  trait RemoteConfig extends StObject {
    ...
    /**
      ...
      */
    def setLogLevel(logLevel: typings.firebase.compatMod.firebase.remoteConfig.LogLevel): Unit
  ...
  object RemoteConfig {
    ...
    inline def apply(
      ...
      setLogLevel: typings.firebase.compatMod.firebase.remoteConfig.LogLevel => Unit,
      settings: Settings
    ): RemoteConfig = {
    ...
    extension [Self <: RemoteConfig](x: Self) {
      ...
      inline def setSetLogLevel(value: typings.firebase.compatMod.firebase.remoteConfig.LogLevel => Unit): Self = StObject.set(x, "setLogLevel", js.Any.fromFunction1(value))
