...
import typings.firebase.compatMod.firebase.User.MultiFactorUser
import typings.firebase.compatMod.firebase.auth.ActionCodeSettings
import typings.firebase.compatMod.firebase.auth.ApplicationVerifier
import typings.firebase.compatMod.firebase.auth.AuthCredential
import typings.firebase.compatMod.firebase.auth.AuthProvider
import typings.firebase.compatMod.firebase.auth.ConfirmationResult
import typings.firebase.compatMod.firebase.auth.IdTokenResult
import typings.firebase.compatMod.firebase.auth.MultiFactorAssertion
import typings.firebase.compatMod.firebase.auth.MultiFactorInfo
import typings.firebase.compatMod.firebase.auth.MultiFactorSession
import typings.firebase.compatMod.firebase.auth.UserCredential
import typings.firebase.compatMod.firebase.auth.UserMetadata
