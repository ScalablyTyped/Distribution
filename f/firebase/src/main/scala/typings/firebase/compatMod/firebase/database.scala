...
import typings.firebase.anon.ForceLongPolling
import typings.firebase.anon.MockUserToken
...
object database {
  ...
  trait Database extends StObject {
    ...
    /**
      ...
      *
      */
    var INTERNAL: ForceLongPolling = js.native
  ...
  type EmulatorMockTokenOptions = typings.firebase.compatMod.firebase.EmulatorMockTokenOptions
  ...
  */
  ...
  object EventType {
    ...
    inline def child_added: typings.firebase.firebaseStrings.child_added = "child_added".asInstanceOf[typings.firebase.firebaseStrings.child_added]
    
    inline def child_changed: typings.firebase.firebaseStrings.child_changed = "child_changed".asInstanceOf[typings.firebase.firebaseStrings.child_changed]
    
    inline def child_moved: typings.firebase.firebaseStrings.child_moved = "child_moved".asInstanceOf[typings.firebase.firebaseStrings.child_moved]
    
    inline def child_removed: typings.firebase.firebaseStrings.child_removed = "child_removed".asInstanceOf[typings.firebase.firebaseStrings.child_removed]
    
    inline def value: typings.firebase.firebaseStrings.value = "value".asInstanceOf[typings.firebase.firebaseStrings.value]
  }
  ...
  trait OnDisconnect extends StObject {
    ...
    /**
      ...
      *   is complete.
      */
    def cancel(): js.Promise[Any] = js.native
    def cancel(onComplete: js.Function1[/* a */ js.Error | Null, Any]): js.Promise[Any] = js.native
    ...
    def remove(onComplete: js.Function1[/* a */ js.Error | Null, Any]): js.Promise[Any] = js.native
    ...
    def set(value: Any, onComplete: js.Function1[/* a */ js.Error | Null, Any]): js.Promise[Any] = js.native
  ...
  /* Inlined parent firebase.firebase/compat.firebase.database.Reference */
  /* Inlined parent std.Pick<std.Promise<firebase.firebase/compat.firebase.database.Reference>, 'then' | 'catch'> */
  @js.native
