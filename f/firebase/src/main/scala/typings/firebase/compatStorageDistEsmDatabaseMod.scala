...
object compatStorageDistEsmDatabaseMod {
  
  @JSImport("firebase/compat/storage/dist/esm/database", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/storage/dist/esm/database", "DataSnapshot")
  @js.native
  /* private */ open class DataSnapshot ()
    extends typings.firebaseDatabase.mod.DataSnapshot
  
  @JSImport("firebase/compat/storage/dist/esm/database", "Database")
  @js.native
  /* private */ open class Database ()
    extends typings.firebaseDatabase.mod.Database
  
  @JSImport("firebase/compat/storage/dist/esm/database", "OnDisconnect")
  @js.native
  /* private */ open class OnDisconnect_ ()
    extends typings.firebaseDatabase.mod.OnDisconnect_
  
  /* note: abstract class */ @JSImport("firebase/compat/storage/dist/esm/database", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typings.firebaseDatabase.mod.QueryConstraint
  
  @JSImport("firebase/compat/storage/dist/esm/database", "TransactionResult")
  @js.native
