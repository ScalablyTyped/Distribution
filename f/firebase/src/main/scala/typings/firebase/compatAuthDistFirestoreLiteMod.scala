...
object compatAuthDistFirestoreLiteMod {
  ...
  @JSImport("firebase/compat/auth/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/auth/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
