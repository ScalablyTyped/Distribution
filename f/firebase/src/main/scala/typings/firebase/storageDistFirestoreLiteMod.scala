...
object storageDistFirestoreLiteMod {
  ...
  @JSImport("firebase/storage/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/storage/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
