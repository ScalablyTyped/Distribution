...
object firebasePerformanceDistFirestoreMod {
  ...
  @JSImport("firebase/performance/dist/firestore", "FieldValue")
  @js.native
  ...
  @JSImport("firebase/performance/dist/firestore", "QueryConstraint")
  @js.native
