...
object storageDistAppMod {
  
  @JSImport("firebase/storage/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/storage/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/storage/dist/app", "SDK_VERSION")
  @js.native
