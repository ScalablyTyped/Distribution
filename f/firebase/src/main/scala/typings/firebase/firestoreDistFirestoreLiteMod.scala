...
object firestoreDistFirestoreLiteMod {
  ...
  @JSImport("firebase/firestore/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/firestore/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
