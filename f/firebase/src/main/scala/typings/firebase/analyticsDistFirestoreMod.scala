...
object analyticsDistFirestoreMod {
  ...
  @JSImport("firebase/analytics/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/analytics/dist/firestore", "QueryStartAtConstraint")
  @js.native
