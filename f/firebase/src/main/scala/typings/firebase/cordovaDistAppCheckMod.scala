...
object cordovaDistAppCheckMod {
  
  @JSImport("firebase/auth/cordova/dist/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/cordova/dist/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/auth/cordova/dist/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/auth/cordova/dist/app-check", "ReCaptchaV3Provider")
  @js.native
