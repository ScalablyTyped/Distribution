...
/* Inlined {  user_id :string} & std.Partial<firebase.firebase/compat.firebase.FirebaseIdToken> */
...
object useridstringPartialFireba {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: useridstringPartialFireba] (val x: Self) extends AnyVal {
