...
trait Affiliation
  ...
  var shipping: js.UndefOr[typings.firebase.mod.firebase.analytics.Currency] = js.native
  
  var tax: js.UndefOr[typings.firebase.mod.firebase.analytics.Currency] = js.native
