...
object compatAuthDistEsmAppMod {
  
  @JSImport("firebase/compat/auth/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/auth/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/auth/dist/esm/app", "SDK_VERSION")
  @js.native
