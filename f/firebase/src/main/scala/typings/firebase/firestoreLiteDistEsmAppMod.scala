...
object firestoreLiteDistEsmAppMod {
  
  @JSImport("firebase/firestore/lite/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/firestore/lite/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/firestore/lite/dist/esm/app", "SDK_VERSION")
  @js.native
