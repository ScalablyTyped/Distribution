...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.firebase.firebaseStrings.Running
...
object TaskState {
  ...
  inline def Running: typings.firebase.firebaseStrings.Running = "Running".asInstanceOf[typings.firebase.firebaseStrings.Running]
