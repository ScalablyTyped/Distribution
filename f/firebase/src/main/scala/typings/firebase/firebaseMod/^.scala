...
object ^ extends js.Object {
  ...
  def functions(app: App): Functions = js.native
  /**
    ...
    */
  def initializeApp(options: js.Object): App = js.native
  def initializeApp(options: js.Object, name: String): App = js.native
  /**
