...
import typings.firebase.firebaseMod.firebase.User.MultiFactorUser
import typings.firebase.firebaseMod.firebase.auth.ActionCodeSettings
import typings.firebase.firebaseMod.firebase.auth.ApplicationVerifier
import typings.firebase.firebaseMod.firebase.auth.AuthCredential
import typings.firebase.firebaseMod.firebase.auth.AuthProvider
import typings.firebase.firebaseMod.firebase.auth.ConfirmationResult
import typings.firebase.firebaseMod.firebase.auth.IdTokenResult
import typings.firebase.firebaseMod.firebase.auth.MultiFactorAssertion
import typings.firebase.firebaseMod.firebase.auth.MultiFactorInfo
import typings.firebase.firebaseMod.firebase.auth.MultiFactorSession
import typings.firebase.firebaseMod.firebase.auth.UserCredential
import typings.firebase.firebaseMod.firebase.auth.UserMetadata
