...
import typings.firebase.firebaseMod.analytics.Analytics
import typings.firebase.firebaseMod.app.App
import typings.firebase.firebaseMod.auth.Auth
import typings.firebase.firebaseMod.database.Database
import typings.firebase.firebaseMod.firestore.Firestore
import typings.firebase.firebaseMod.functions.Functions
import typings.firebase.firebaseMod.installations.Installations
import typings.firebase.firebaseMod.messaging.Messaging
import typings.firebase.firebaseMod.performance.Performance
import typings.firebase.firebaseMod.remoteConfig.RemoteConfig
import typings.firebase.firebaseMod.storage.Storage
