...
object compatInstallationsDistEsmAppMod {
  
  @JSImport("firebase/compat/installations/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/installations/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/installations/dist/esm/app", "SDK_VERSION")
  @js.native
