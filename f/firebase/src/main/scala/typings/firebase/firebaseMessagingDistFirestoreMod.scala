...
object firebaseMessagingDistFirestoreMod {
  
  @JSImport("firebase/messaging/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/messaging/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/messaging/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/messaging/dist/firestore", "WriteBatch")
  @js.native
