...
object compatMessagingDistAppMod {
  
  @JSImport("firebase/compat/messaging/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/messaging/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/messaging/dist/app", "SDK_VERSION")
  @js.native
