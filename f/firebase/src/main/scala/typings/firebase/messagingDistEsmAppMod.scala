...
object messagingDistEsmAppMod {
  
  @JSImport("firebase/messaging/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/messaging/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/messaging/dist/esm/app", "SDK_VERSION")
  @js.native
