...
object databaseDistFirestoreMod {
  ...
  @JSImport("firebase/database/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/database/dist/firestore", "QueryStartAtConstraint")
  @js.native
