...
object firebaseInstallationsDistFirestoreMod {
  ...
  @JSImport("firebase/installations/dist/firestore", "FieldValue")
  @js.native
  ...
  @JSImport("firebase/installations/dist/firestore", "QueryConstraint")
  @js.native
