...
object authReactNativeDistFirestoreMod {
  
  @JSImport("firebase/auth/react-native/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/react-native/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/auth/react-native/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/auth/react-native/dist/firestore", "FieldValue")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  open class QueryCompositeFilterConstraint ()
    extends typings.firebaseFirestore.mod.QueryCompositeFilterConstraint
  
  /* note: abstract class */ @JSImport("firebase/auth/react-native/dist/firestore", "QueryConstraint")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/firestore", "QueryEndAtConstraint")
  @js.native
  open class QueryEndAtConstraint ()
    extends typings.firebaseFirestore.mod.QueryEndAtConstraint
  
  @JSImport("firebase/auth/react-native/dist/firestore", "QueryFieldFilterConstraint")
  @js.native
  open class QueryFieldFilterConstraint ()
    extends typings.firebaseFirestore.mod.QueryFieldFilterConstraint
  
  @JSImport("firebase/auth/react-native/dist/firestore", "QueryLimitConstraint")
  @js.native
  open class QueryLimitConstraint ()
    extends typings.firebaseFirestore.mod.QueryLimitConstraint
  
  @JSImport("firebase/auth/react-native/dist/firestore", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/firestore", "QueryStartAtConstraint")
  @js.native
