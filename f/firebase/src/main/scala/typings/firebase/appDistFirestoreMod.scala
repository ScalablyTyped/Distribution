...
object appDistFirestoreMod {
  ...
  @JSImport("firebase/app/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/app/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/app/dist/firestore", "FieldValue")
  @js.native
  ...
  @JSImport("firebase/app/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  open class QueryCompositeFilterConstraint ()
    extends typings.firebaseFirestore.mod.QueryCompositeFilterConstraint
  
  /* note: abstract class */ @JSImport("firebase/app/dist/firestore", "QueryConstraint")
  @js.native
  ...
  @JSImport("firebase/app/dist/firestore", "QueryStartAtConstraint")
  @js.native
