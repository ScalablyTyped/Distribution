...
object appDistFirestoreMod {
  
  @JSImport("firebase/app/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/app/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/app/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/app/dist/firestore", "WriteBatch")
  @js.native
