...
object databaseDistEsmStorageMod {
  
  @JSImport("firebase/database/dist/esm/storage", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/database/dist/esm/storage", "StorageError")
  @js.native
  ...
  @JSImport("firebase/database/dist/esm/storage", "StorageErrorCode")
  @js.native
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("firebase/database/dist/esm/storage", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("firebase/database/dist/esm/storage", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/database/dist/esm/storage", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/database/dist/esm/storage", "StringFormat.RAW")
    @js.native
