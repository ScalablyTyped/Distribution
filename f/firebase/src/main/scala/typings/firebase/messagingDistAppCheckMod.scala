...
object messagingDistAppCheckMod {
  ...
  @JSImport("firebase/compat/messaging/dist/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/messaging/dist/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/compat/messaging/dist/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/compat/messaging/dist/app-check", "ReCaptchaV3Provider")
  @js.native
