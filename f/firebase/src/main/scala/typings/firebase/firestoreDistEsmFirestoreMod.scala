...
object firestoreDistEsmFirestoreMod {
  
  @JSImport("firebase/firestore/dist/esm/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/firestore/dist/esm/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/firestore/dist/esm/firestore", "AggregateQuerySnapshot")
  @js.native
  /* private */ open class AggregateQuerySnapshot[T /* <: AggregateSpec */] ()
    extends typings.firebaseFirestore.mod.AggregateQuerySnapshot[T]
  
  @JSImport("firebase/firestore/dist/esm/firestore", "Bytes")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/firestore/dist/esm/firestore", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typings.firebaseFirestore.mod.FieldValue
  
  @JSImport("firebase/firestore/dist/esm/firestore", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typings.firebaseFirestore.mod.Firestore
  
  @JSImport("firebase/firestore/dist/esm/firestore", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typings.firebaseFirestore.mod.FirestoreError
  
  @JSImport("firebase/firestore/dist/esm/firestore", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/firestore/dist/esm/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/firestore/dist/esm/firestore", "WriteBatch")
  @js.native
