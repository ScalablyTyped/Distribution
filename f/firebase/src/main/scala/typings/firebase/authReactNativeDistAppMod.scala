...
object authReactNativeDistAppMod {
  
  @JSImport("firebase/auth/react-native/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/react-native/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/app", "SDK_VERSION")
  @js.native
