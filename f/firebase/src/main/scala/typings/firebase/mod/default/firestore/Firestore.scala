...
/* private */ class Firestore () extends StObject {
  ...
  /**
    ...
    */
  def batch(): typings.firebase.mod.firebase.firestore.WriteBatch = js.native
  ...
  /**
    ...
    */
  def collectionGroup(collectionId: String): typings.firebase.mod.firebase.firestore.Query[typings.firebase.mod.firebase.firestore.DocumentData] = js.native
  ...
  /**
    ...
    */
  def doc(documentPath: String): typings.firebase.mod.firebase.firestore.DocumentReference[typings.firebase.mod.firebase.firestore.DocumentData] = js.native
  ...
  def enablePersistence(settings: typings.firebase.mod.firebase.firestore.PersistenceSettings): js.Promise[Unit] = js.native
  ...
  def runTransaction[T](
    updateFunction: js.Function1[
      /* transaction */ typings.firebase.mod.firebase.firestore.Transaction, 
      js.Promise[T]
    ]
  ...
  /**
    ...
    */
  def settings(settings: typings.firebase.mod.firebase.firestore.Settings): Unit = js.native
