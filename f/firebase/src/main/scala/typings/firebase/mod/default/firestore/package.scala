...
@scala.inline
def apply(): typings.firebase.mod.firebase.firestore.Firestore = typings.firebase.mod.default.firestore.^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.firebase.mod.firebase.firestore.Firestore]
@scala.inline
def apply(app: typings.firebase.mod.firebase.app.App): typings.firebase.mod.firebase.firestore.Firestore = typings.firebase.mod.default.firestore.^.asInstanceOf[js.Dynamic].apply(app.asInstanceOf[js.Any]).asInstanceOf[typings.firebase.mod.firebase.firestore.Firestore]
