...
class Transaction protected () extends js.Object {
  ...
  /**
    ...
    */
  def get[T](documentRef: typings.firebase.mod.firebase.firestore.DocumentReference[T]): js.Promise[typings.firebase.mod.firebase.firestore.DocumentSnapshot[T]] = js.native
  ...
  /**
    ...
    * @return This `Transaction` instance. Used for chaining method calls.
    */
  def set[T](documentRef: typings.firebase.mod.firebase.firestore.DocumentReference[T], data: T): typings.firebase.mod.firebase.firestore.Transaction = js.native
  /**
    * Writes to the document referred to by the provided `DocumentReference`.
    * If the document does not exist yet, it will be created. If you pass
    * `SetOptions`, the provided data can be merged into the existing document.
