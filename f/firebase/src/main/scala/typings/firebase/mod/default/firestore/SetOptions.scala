...
object SetOptions {
  ...
  implicit class SetOptionsMutableBuilder[Self <: SetOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMergeFields(value: js.Array[String | typings.firebase.mod.firebase.firestore.FieldPath]): Self = StObject.set(x, "mergeFields", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMergeFieldsUndefined: Self = StObject.set(x, "mergeFields", js.undefined)
    
    @scala.inline
    def setMergeFieldsVarargs(value: (String | typings.firebase.mod.firebase.firestore.FieldPath)*): Self = StObject.set(x, "mergeFields", js.Array(value :_*))
