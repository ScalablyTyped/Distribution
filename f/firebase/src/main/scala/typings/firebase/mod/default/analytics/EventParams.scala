...
trait EventParams extends js.Object {
  ...
  var items: js.UndefOr[js.Array[typings.firebase.mod.firebase.analytics.Item]] = js.native
  ...
  var promotions: js.UndefOr[js.Array[typings.firebase.mod.firebase.analytics.Promotion]] = js.native
