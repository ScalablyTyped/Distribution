...
trait EventParams extends StObject {
  ...
  var items: js.UndefOr[js.Array[typings.firebase.mod.firebase.analytics.Item]] = js.undefined
  ...
  var promotions: js.UndefOr[js.Array[typings.firebase.mod.firebase.analytics.Promotion]] = js.undefined
...
object EventParams {
  ...
  extension [Self <: EventParams](x: Self) {
    ...
    inline def setItems(value: js.Array[typings.firebase.mod.firebase.analytics.Item]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: typings.firebase.mod.firebase.analytics.Item*): Self = StObject.set(x, "items", js.Array(value :_*))
    ...
    inline def setPromotions(value: js.Array[typings.firebase.mod.firebase.analytics.Promotion]): Self = StObject.set(x, "promotions", value.asInstanceOf[js.Any])
    
    inline def setPromotionsUndefined: Self = StObject.set(x, "promotions", js.undefined)
    
    inline def setPromotionsVarargs(value: typings.firebase.mod.firebase.analytics.Promotion*): Self = StObject.set(x, "promotions", js.Array(value :_*))
