...
object Item {
  ...
  extension [Self <: Item](x: Self) {
    ...
    inline def setDiscount(value: typings.firebase.mod.firebase.analytics.Currency): Self = StObject.set(x, "discount", value.asInstanceOf[js.Any])
    ...
    inline def setPrice(value: typings.firebase.mod.firebase.analytics.Currency): Self = StObject.set(x, "price", value.asInstanceOf[js.Any])
