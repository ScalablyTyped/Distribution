...
object installationsDistEsmFirestoreLiteMod {
  
  @JSImport("firebase/installations/dist/esm/firestore/lite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/installations/dist/esm/firestore/lite", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.liteMod.AggregateField[T]
  
  @JSImport("firebase/installations/dist/esm/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/installations/dist/esm/firestore/lite", "Bytes")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/installations/dist/esm/firestore/lite", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typings.firebaseFirestore.liteMod.FieldValue
  
  @JSImport("firebase/installations/dist/esm/firestore/lite", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typings.firebaseFirestore.liteMod.Firestore
  
  @JSImport("firebase/installations/dist/esm/firestore/lite", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typings.firebaseFirestore.liteMod.FirestoreError
  
  @JSImport("firebase/installations/dist/esm/firestore/lite", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/installations/dist/esm/firestore/lite", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.liteMod.Transaction
  
  @JSImport("firebase/installations/dist/esm/firestore/lite", "WriteBatch")
  @js.native
