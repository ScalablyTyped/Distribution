...
object compatDistEsmAppMod {
  
  @JSImport("firebase/compat/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/dist/esm/app", "SDK_VERSION")
  @js.native
