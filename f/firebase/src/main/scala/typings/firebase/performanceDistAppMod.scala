...
object performanceDistAppMod {
  
  @JSImport("firebase/compat/performance/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/performance/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/performance/dist/app", "SDK_VERSION")
  @js.native
