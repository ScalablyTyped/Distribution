...
object performanceDistEsmAppMod {
  
  @JSImport("firebase/performance/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/performance/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/performance/dist/esm/app", "SDK_VERSION")
  @js.native
