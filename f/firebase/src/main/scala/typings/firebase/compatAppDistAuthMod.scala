...
object compatAppDistAuthMod {
  ...
  object AuthErrorCodes {
    ...
    @JSImport("firebase/compat/app/dist/auth", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("firebase/compat/app/dist/auth", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("firebase/compat/app/dist/auth", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("firebase/compat/app/dist/auth", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    ...
    @JSImport("firebase/compat/app/dist/auth", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    ...
    @JSImport("firebase/compat/app/dist/auth", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("firebase/compat/app/dist/auth", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("firebase/compat/app/dist/auth", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
  ...
  object FactorId {
    ...
    @JSImport("firebase/compat/app/dist/auth", "FactorId.TOTP")
    @js.native
  ...
  @JSImport("firebase/compat/app/dist/auth", "TotpMultiFactorGenerator")
  @js.native
  ...
  object TotpMultiFactorGenerator {
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/app/dist/auth", "TotpMultiFactorGenerator.FACTOR_ID")
    @js.native
  ...
  @JSImport("firebase/compat/app/dist/auth", "TotpSecret")
  @js.native
