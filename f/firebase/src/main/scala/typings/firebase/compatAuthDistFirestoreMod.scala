...
object compatAuthDistFirestoreMod {
  ...
  @JSImport("firebase/compat/auth/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/auth/dist/firestore", "QueryStartAtConstraint")
  @js.native
