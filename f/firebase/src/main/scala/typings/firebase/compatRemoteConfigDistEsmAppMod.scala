...
object compatRemoteConfigDistEsmAppMod {
  
  @JSImport("firebase/compat/remote-config/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/remote-config/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/esm/app", "SDK_VERSION")
  @js.native
