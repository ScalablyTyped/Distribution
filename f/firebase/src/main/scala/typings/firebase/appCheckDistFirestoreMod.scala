...
object appCheckDistFirestoreMod {
  ...
  @JSImport("firebase/app-check/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/app-check/dist/firestore", "QueryStartAtConstraint")
  @js.native
