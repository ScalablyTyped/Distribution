...
object performanceDistFirestoreLiteMod {
  ...
  @JSImport("firebase/performance/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/performance/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
