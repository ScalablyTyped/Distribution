...
object compatFirestoreDistEsmAppMod {
  
  @JSImport("firebase/compat/firestore/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/firestore/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/firestore/dist/esm/app", "SDK_VERSION")
  @js.native
