...
object storageDistEsmAppMod {
  
  @JSImport("firebase/storage/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/storage/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/storage/dist/esm/app", "SDK_VERSION")
  @js.native
