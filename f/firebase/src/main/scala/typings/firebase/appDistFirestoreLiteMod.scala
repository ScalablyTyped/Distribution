...
object appDistFirestoreLiteMod {
  ...
  @JSImport("firebase/app/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/app/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
