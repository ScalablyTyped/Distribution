...
object compatAppDistAppMod {
  
  @JSImport("firebase/compat/app/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/app/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/app/dist/app", "SDK_VERSION")
  @js.native
