...
object compatRemoteConfigDistEsmFirestoreMod {
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "AggregateQuerySnapshot")
  @js.native
  /* private */ open class AggregateQuerySnapshot[T /* <: AggregateSpec */] ()
    extends typings.firebaseFirestore.mod.AggregateQuerySnapshot[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "CACHE_SIZE_UNLIMITED")
  @js.native
  val CACHE_SIZE_UNLIMITED: /* -1 */ Double = js.native
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "CollectionReference")
  @js.native
  /* private */ open class CollectionReference[T] ()
    extends typings.firebaseFirestore.mod.CollectionReference[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "DocumentReference")
  @js.native
  /* private */ open class DocumentReference[T] ()
    extends typings.firebaseFirestore.mod.DocumentReference[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "DocumentSnapshot")
  @js.native
  /* protected */ open class DocumentSnapshot[T] ()
    extends typings.firebaseFirestore.mod.DocumentSnapshot[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "FieldPath")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/remote-config/dist/esm/firestore", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typings.firebaseFirestore.mod.FieldValue
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typings.firebaseFirestore.mod.Firestore
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typings.firebaseFirestore.mod.FirestoreError
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore", "WriteBatch")
  @js.native
