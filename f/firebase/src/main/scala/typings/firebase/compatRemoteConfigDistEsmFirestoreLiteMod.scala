...
object compatRemoteConfigDistEsmFirestoreLiteMod {
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.liteMod.AggregateField[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "Bytes")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "CollectionReference")
  @js.native
  /* private */ open class CollectionReference[T] ()
    extends typings.firebaseFirestore.liteMod.CollectionReference[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "DocumentReference")
  @js.native
  /* private */ open class DocumentReference[T] ()
    extends typings.firebaseFirestore.liteMod.DocumentReference[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "DocumentSnapshot")
  @js.native
  /* protected */ open class DocumentSnapshot[T] ()
    extends typings.firebaseFirestore.liteMod.DocumentSnapshot[T]
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "FieldPath")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typings.firebaseFirestore.liteMod.FieldValue
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typings.firebaseFirestore.liteMod.Firestore
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typings.firebaseFirestore.liteMod.FirestoreError
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.liteMod.Transaction
  
  @JSImport("firebase/compat/remote-config/dist/esm/firestore/lite", "WriteBatch")
  @js.native
