...
object compatAnalyticsDistAppMod {
  
  @JSImport("firebase/compat/analytics/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/analytics/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/analytics/dist/app", "SDK_VERSION")
  @js.native
