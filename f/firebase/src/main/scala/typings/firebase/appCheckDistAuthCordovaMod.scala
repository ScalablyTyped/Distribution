...
object appCheckDistAuthCordovaMod {
  ...
  object AuthErrorCodes {
    ...
    @JSImport("firebase/app-check/dist/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("firebase/app-check/dist/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("firebase/app-check/dist/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("firebase/app-check/dist/auth/cordova", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    ...
    @JSImport("firebase/app-check/dist/auth/cordova", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    ...
    @JSImport("firebase/app-check/dist/auth/cordova", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("firebase/app-check/dist/auth/cordova", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("firebase/app-check/dist/auth/cordova", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
  ...
  object FactorId {
    ...
    @JSImport("firebase/app-check/dist/auth/cordova", "FactorId.TOTP")
    @js.native
