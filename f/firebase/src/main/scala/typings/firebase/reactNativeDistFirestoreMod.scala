...
object reactNativeDistFirestoreMod {
  
  @JSImport("firebase/auth/react-native/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/react-native/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/firestore", "CACHE_SIZE_UNLIMITED")
  @js.native
  val CACHE_SIZE_UNLIMITED: /* -1 */ Double = js.native
  
  @JSImport("firebase/auth/react-native/dist/firestore", "CollectionReference")
  @js.native
  /* private */ open class CollectionReference[T] ()
    extends typings.firebaseFirestore.mod.CollectionReference[T]
  
  @JSImport("firebase/auth/react-native/dist/firestore", "DocumentReference")
  @js.native
  /* private */ open class DocumentReference[T] ()
    extends typings.firebaseFirestore.mod.DocumentReference[T]
  
  @JSImport("firebase/auth/react-native/dist/firestore", "DocumentSnapshot")
  @js.native
  /* protected */ open class DocumentSnapshot[T] ()
    extends typings.firebaseFirestore.mod.DocumentSnapshot[T]
  
  @JSImport("firebase/auth/react-native/dist/firestore", "FieldPath")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/firestore", "FieldValue")
  @js.native
  /* private */ abstract class FieldValue ()
    extends typings.firebaseFirestore.mod.FieldValue
  
  @JSImport("firebase/auth/react-native/dist/firestore", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typings.firebaseFirestore.mod.Firestore
  
  @JSImport("firebase/auth/react-native/dist/firestore", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typings.firebaseFirestore.mod.FirestoreError
  
  @JSImport("firebase/auth/react-native/dist/firestore", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/auth/react-native/dist/firestore", "WriteBatch")
  @js.native
