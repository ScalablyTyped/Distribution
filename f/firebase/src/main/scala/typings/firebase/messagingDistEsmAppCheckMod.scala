...
object messagingDistEsmAppCheckMod {
  
  @JSImport("firebase/messaging/dist/esm/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/messaging/dist/esm/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/messaging/dist/esm/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/messaging/dist/esm/app-check", "ReCaptchaV3Provider")
  @js.native
