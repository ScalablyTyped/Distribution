...
import typings.firebase.mod.firebase.analytics.SettingsOptions
...
object analytics {
  ...
  @JSGlobal("firebase.analytics.EventName")
  @js.native
  object EventName extends StObject {
    
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.firebase.mod.default.analytics.EventName & String] = js.native
