...
object storage {
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSGlobal("firebase.storage.StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSGlobal("firebase.storage.StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("firebase.storage.StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("firebase.storage.StringFormat.RAW")
    @js.native
  ...
  object TaskEvent {
    ...
    /**
      ...
      * </ul>
      */
    @JSGlobal("firebase.storage.TaskEvent.STATE_CHANGED")
    @js.native
  ...
  object TaskState {
    ...
    @JSGlobal("firebase.storage.TaskState.CANCELED")
    @js.native
    ...
    @JSGlobal("firebase.storage.TaskState.ERROR")
    @js.native
    ...
    @JSGlobal("firebase.storage.TaskState.PAUSED")
    @js.native
    ...
    @JSGlobal("firebase.storage.TaskState.RUNNING")
    @js.native
    ...
    @JSGlobal("firebase.storage.TaskState.SUCCESS")
    @js.native
