...
object firebaseRemoteConfigDistFirestoreMod {
  ...
  @JSImport("firebase/remote-config/dist/firestore", "FieldValue")
  @js.native
  ...
  @JSImport("firebase/remote-config/dist/firestore", "QueryConstraint")
  @js.native
