...
object compatAppCheckDistFirestoreMod {
  ...
  @JSImport("firebase/compat/app-check/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/app-check/dist/firestore", "QueryEndAtConstraint")
  @js.native
  open class QueryEndAtConstraint ()
    extends typings.firebaseFirestore.mod.QueryEndAtConstraint
  
  @JSImport("firebase/compat/app-check/dist/firestore", "QueryFieldFilterConstraint")
  @js.native
  open class QueryFieldFilterConstraint ()
    extends typings.firebaseFirestore.mod.QueryFieldFilterConstraint
  
  @JSImport("firebase/compat/app-check/dist/firestore", "QueryLimitConstraint")
  @js.native
  open class QueryLimitConstraint ()
    extends typings.firebaseFirestore.mod.QueryLimitConstraint
  
  @JSImport("firebase/compat/app-check/dist/firestore", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/app-check/dist/firestore", "QueryStartAtConstraint")
  @js.native
