...
object databaseDistEsmAppMod {
  
  @JSImport("firebase/database/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/database/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/database/dist/esm/app", "SDK_VERSION")
  @js.native
