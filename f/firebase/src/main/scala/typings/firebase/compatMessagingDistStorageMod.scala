...
object compatMessagingDistStorageMod {
  
  @JSImport("firebase/compat/messaging/dist/storage", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/messaging/dist/storage", "StorageError")
  @js.native
  ...
  @JSImport("firebase/compat/messaging/dist/storage", "StorageErrorCode")
  @js.native
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/messaging/dist/storage", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("firebase/compat/messaging/dist/storage", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/messaging/dist/storage", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/messaging/dist/storage", "StringFormat.RAW")
    @js.native
