...
object firestoreDistFirestoreMod {
  ...
  @JSImport("firebase/firestore/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/firestore/dist/firestore", "QueryStartAtConstraint")
  @js.native
