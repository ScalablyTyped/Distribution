...
object swDistAppMod {
  ...
  @JSImport("firebase/messaging/sw/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/messaging/sw/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/messaging/sw/dist/app", "SDK_VERSION")
  @js.native
