...
object authCordovaDistEsmAppMod {
  
  @JSImport("firebase/auth/cordova/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/cordova/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/auth/cordova/dist/esm/app", "SDK_VERSION")
  @js.native
