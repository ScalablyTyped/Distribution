...
object messagingDistFirestoreMod {
  ...
  @JSImport("firebase/messaging/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/messaging/dist/firestore", "QueryStartAtConstraint")
  @js.native
