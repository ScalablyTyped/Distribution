...
object compatFunctionsDistFirestoreLiteMod {
  ...
  @JSImport("firebase/compat/functions/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/functions/dist/firestore/lite", "QueryEndAtConstraint")
  @js.native
  open class QueryEndAtConstraint ()
    extends typings.firebaseFirestore.liteMod.QueryEndAtConstraint
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "QueryFieldFilterConstraint")
  @js.native
  open class QueryFieldFilterConstraint ()
    extends typings.firebaseFirestore.liteMod.QueryFieldFilterConstraint
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "QueryLimitConstraint")
  @js.native
  open class QueryLimitConstraint ()
    extends typings.firebaseFirestore.liteMod.QueryLimitConstraint
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/functions/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
