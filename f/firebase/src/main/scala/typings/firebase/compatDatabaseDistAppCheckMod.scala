...
object compatDatabaseDistAppCheckMod {
  
  @JSImport("firebase/compat/database/dist/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/database/dist/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/compat/database/dist/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/compat/database/dist/app-check", "ReCaptchaV3Provider")
  @js.native
