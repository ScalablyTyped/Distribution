...
object authReactNativeDistEsmAppMod {
  
  @JSImport("firebase/auth/react-native/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/react-native/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/esm/app", "SDK_VERSION")
  @js.native
