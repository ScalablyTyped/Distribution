...
object databaseDistEsmDatabaseMod {
  
  @JSImport("firebase/database/dist/esm/database", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/database/dist/esm/database", "DataSnapshot")
  @js.native
  /* private */ open class DataSnapshot ()
    extends typings.firebaseDatabase.mod.DataSnapshot
  
  @JSImport("firebase/database/dist/esm/database", "Database")
  @js.native
  /* private */ open class Database ()
    extends typings.firebaseDatabase.mod.Database
  
  @JSImport("firebase/database/dist/esm/database", "OnDisconnect")
  @js.native
  /* private */ open class OnDisconnect_ ()
    extends typings.firebaseDatabase.mod.OnDisconnect_
  
  /* note: abstract class */ @JSImport("firebase/database/dist/esm/database", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typings.firebaseDatabase.mod.QueryConstraint
  
  @JSImport("firebase/database/dist/esm/database", "TransactionResult")
  @js.native
