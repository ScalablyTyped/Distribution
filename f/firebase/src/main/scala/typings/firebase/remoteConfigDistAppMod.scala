...
object remoteConfigDistAppMod {
  ...
  @JSImport("firebase/remote-config/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/remote-config/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/remote-config/dist/app", "SDK_VERSION")
  @js.native
