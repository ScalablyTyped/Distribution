...
object remoteConfigDistAppMod {
  
  @JSImport("firebase/compat/remote-config/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/remote-config/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/app", "SDK_VERSION")
  @js.native
