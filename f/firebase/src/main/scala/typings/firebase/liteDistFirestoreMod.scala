...
object liteDistFirestoreMod {
  
  @JSImport("firebase/firestore/lite/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/firestore/lite/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/firestore/lite/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/firestore/lite/dist/firestore", "WriteBatch")
  @js.native
