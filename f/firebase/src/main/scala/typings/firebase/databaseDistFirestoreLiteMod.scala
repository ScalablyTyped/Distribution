...
object databaseDistFirestoreLiteMod {
  ...
  @JSImport("firebase/database/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/database/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
