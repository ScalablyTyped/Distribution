...
object compatMessagingDistFirestoreLiteMod {
  ...
  @JSImport("firebase/compat/messaging/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/messaging/dist/firestore/lite", "QueryEndAtConstraint")
  @js.native
  open class QueryEndAtConstraint ()
    extends typings.firebaseFirestore.liteMod.QueryEndAtConstraint
  
  @JSImport("firebase/compat/messaging/dist/firestore/lite", "QueryFieldFilterConstraint")
  @js.native
  open class QueryFieldFilterConstraint ()
    extends typings.firebaseFirestore.liteMod.QueryFieldFilterConstraint
  
  @JSImport("firebase/compat/messaging/dist/firestore/lite", "QueryLimitConstraint")
  @js.native
  open class QueryLimitConstraint ()
    extends typings.firebaseFirestore.liteMod.QueryLimitConstraint
  
  @JSImport("firebase/compat/messaging/dist/firestore/lite", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/messaging/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
