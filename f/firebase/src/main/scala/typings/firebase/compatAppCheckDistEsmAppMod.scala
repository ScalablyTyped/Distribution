...
object compatAppCheckDistEsmAppMod {
  
  @JSImport("firebase/compat/app-check/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/app-check/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/app-check/dist/esm/app", "SDK_VERSION")
  @js.native
