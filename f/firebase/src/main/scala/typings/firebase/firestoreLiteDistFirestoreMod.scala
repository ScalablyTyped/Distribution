...
object firestoreLiteDistFirestoreMod {
  
  @JSImport("firebase/firestore/lite/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/firestore/lite/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/firestore/lite/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/firestore/lite/dist/firestore", "FieldValue")
  @js.native
  ...
  @JSImport("firebase/firestore/lite/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  open class QueryCompositeFilterConstraint ()
    extends typings.firebaseFirestore.mod.QueryCompositeFilterConstraint
  
  /* note: abstract class */ @JSImport("firebase/firestore/lite/dist/firestore", "QueryConstraint")
  @js.native
  ...
  @JSImport("firebase/firestore/lite/dist/firestore", "QueryEndAtConstraint")
  @js.native
  open class QueryEndAtConstraint ()
    extends typings.firebaseFirestore.mod.QueryEndAtConstraint
  
  @JSImport("firebase/firestore/lite/dist/firestore", "QueryFieldFilterConstraint")
  @js.native
  open class QueryFieldFilterConstraint ()
    extends typings.firebaseFirestore.mod.QueryFieldFilterConstraint
  
  @JSImport("firebase/firestore/lite/dist/firestore", "QueryLimitConstraint")
  @js.native
  open class QueryLimitConstraint ()
    extends typings.firebaseFirestore.mod.QueryLimitConstraint
  
  @JSImport("firebase/firestore/lite/dist/firestore", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("firebase/firestore/lite/dist/firestore", "QueryStartAtConstraint")
  @js.native
