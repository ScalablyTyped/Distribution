...
object swDistStorageMod {
  
  @JSImport("firebase/messaging/sw/dist/storage", JSImport.Namespace)
  @js.native
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("firebase/messaging/sw/dist/storage", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("firebase/messaging/sw/dist/storage", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/messaging/sw/dist/storage", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/messaging/sw/dist/storage", "StringFormat.RAW")
    @js.native
