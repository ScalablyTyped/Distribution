...
object compatStorageDistAppMod {
  
  @JSImport("firebase/compat/storage/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/storage/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/storage/dist/app", "SDK_VERSION")
  @js.native
