...
object appDistAppCheckMod {
  
  @JSImport("firebase/app/dist/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/app/dist/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/app/dist/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/app/dist/app-check", "ReCaptchaV3Provider")
  @js.native
