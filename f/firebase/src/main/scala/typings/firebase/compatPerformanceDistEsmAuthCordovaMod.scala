...
object compatPerformanceDistEsmAuthCordovaMod {
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", JSImport.Namespace)
  @js.native
  ...
  object ActionCodeOperation {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ActionCodeOperation.EMAIL_SIGNIN")
    @js.native
    val EMAIL_SIGNIN: typings.firebase.firebaseStrings.EMAIL_SIGNIN = js.native
    
    /** The password reset action. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ActionCodeOperation.PASSWORD_RESET")
    @js.native
    val PASSWORD_RESET: typings.firebase.firebaseStrings.PASSWORD_RESET = js.native
    
    /** The email revocation action. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ActionCodeOperation.RECOVER_EMAIL")
    @js.native
    val RECOVER_EMAIL: typings.firebase.firebaseStrings.RECOVER_EMAIL = js.native
    
    /** The revert second factor addition email action. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ActionCodeOperation.REVERT_SECOND_FACTOR_ADDITION")
    @js.native
    val REVERT_SECOND_FACTOR_ADDITION: typings.firebase.firebaseStrings.REVERT_SECOND_FACTOR_ADDITION = js.native
    
    /** The revert second factor addition email action. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ActionCodeOperation.VERIFY_AND_CHANGE_EMAIL")
    @js.native
    val VERIFY_AND_CHANGE_EMAIL: typings.firebase.firebaseStrings.VERIFY_AND_CHANGE_EMAIL = js.native
    
    /** The email verification action. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ActionCodeOperation.VERIFY_EMAIL")
    @js.native
    val VERIFY_EMAIL: typings.firebase.firebaseStrings.VERIFY_EMAIL = js.native
  }
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ActionCodeURL")
  @js.native
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthCredential")
  @js.native
  ...
  object AuthErrorCodes {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.ADMIN_ONLY_OPERATION")
    @js.native
    val ADMIN_ONLY_OPERATION: `authSlashadmin-restricted-operation` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.ALREADY_INITIALIZED")
    @js.native
    val ALREADY_INITIALIZED: `authSlashalready-initialized` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.APP_NOT_AUTHORIZED")
    @js.native
    val APP_NOT_AUTHORIZED: `authSlashapp-not-authorized` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.APP_NOT_INSTALLED")
    @js.native
    val APP_NOT_INSTALLED: `authSlashapp-not-installed` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.ARGUMENT_ERROR")
    @js.native
    val ARGUMENT_ERROR: `authSlashargument-error` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.CAPTCHA_CHECK_FAILED")
    @js.native
    val CAPTCHA_CHECK_FAILED: `authSlashcaptcha-check-failed` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.CODE_EXPIRED")
    @js.native
    val CODE_EXPIRED: `authSlashcode-expired` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.CORDOVA_NOT_READY")
    @js.native
    val CORDOVA_NOT_READY: `authSlashcordova-not-ready` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.CORS_UNSUPPORTED")
    @js.native
    val CORS_UNSUPPORTED: `authSlashcors-unsupported` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.CREDENTIAL_ALREADY_IN_USE")
    @js.native
    val CREDENTIAL_ALREADY_IN_USE: `authSlashcredential-already-in-use` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.CREDENTIAL_MISMATCH")
    @js.native
    val CREDENTIAL_MISMATCH: `authSlashcustom-token-mismatch` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.CREDENTIAL_TOO_OLD_LOGIN_AGAIN")
    @js.native
    val CREDENTIAL_TOO_OLD_LOGIN_AGAIN: `authSlashrequires-recent-login` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.DEPENDENT_SDK_INIT_BEFORE_AUTH")
    @js.native
    val DEPENDENT_SDK_INIT_BEFORE_AUTH: `authSlashdependent-sdk-initialized-before-auth` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.DYNAMIC_LINK_NOT_ACTIVATED")
    @js.native
    val DYNAMIC_LINK_NOT_ACTIVATED: `authSlashdynamic-link-not-activated` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.EMAIL_CHANGE_NEEDS_VERIFICATION")
    @js.native
    val EMAIL_CHANGE_NEEDS_VERIFICATION: `authSlashemail-change-needs-verification` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.EMAIL_EXISTS")
    @js.native
    val EMAIL_EXISTS: `authSlashemail-already-in-use` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.EMULATOR_CONFIG_FAILED")
    @js.native
    val EMULATOR_CONFIG_FAILED: `authSlashemulator-config-failed` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.EXPIRED_OOB_CODE")
    @js.native
    val EXPIRED_OOB_CODE: `authSlashexpired-action-code` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.EXPIRED_POPUP_REQUEST")
    @js.native
    val EXPIRED_POPUP_REQUEST: `authSlashcancelled-popup-request` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INTERNAL_ERROR")
    @js.native
    val INTERNAL_ERROR: `authSlashinternal-error` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_API_KEY")
    @js.native
    val INVALID_API_KEY: `authSlashinvalid-api-key` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_APP_CREDENTIAL")
    @js.native
    val INVALID_APP_CREDENTIAL: `authSlashinvalid-app-credential` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_APP_ID")
    @js.native
    val INVALID_APP_ID: `authSlashinvalid-app-id` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_AUTH")
    @js.native
    val INVALID_AUTH: `authSlashinvalid-user-token` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_AUTH_EVENT")
    @js.native
    val INVALID_AUTH_EVENT: `authSlashinvalid-auth-event` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_CERT_HASH")
    @js.native
    val INVALID_CERT_HASH: `authSlashinvalid-cert-hash` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_CODE")
    @js.native
    val INVALID_CODE: `authSlashinvalid-verification-code` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_CONTINUE_URI")
    @js.native
    val INVALID_CONTINUE_URI: `authSlashinvalid-continue-uri` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_CORDOVA_CONFIGURATION")
    @js.native
    val INVALID_CORDOVA_CONFIGURATION: `authSlashinvalid-cordova-configuration` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_CUSTOM_TOKEN")
    @js.native
    val INVALID_CUSTOM_TOKEN: `authSlashinvalid-custom-token` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_DYNAMIC_LINK_DOMAIN")
    @js.native
    val INVALID_DYNAMIC_LINK_DOMAIN: `authSlashinvalid-dynamic-link-domain` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_EMAIL")
    @js.native
    val INVALID_EMAIL: `authSlashinvalid-email` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_EMULATOR_SCHEME")
    @js.native
    val INVALID_EMULATOR_SCHEME: `authSlashinvalid-emulator-scheme` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_IDP_RESPONSE")
    @js.native
    val INVALID_IDP_RESPONSE: `authSlashinvalid-credential` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_MESSAGE_PAYLOAD")
    @js.native
    val INVALID_MESSAGE_PAYLOAD: `authSlashinvalid-message-payload` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_MFA_SESSION")
    @js.native
    val INVALID_MFA_SESSION: `authSlashinvalid-multi-factor-session` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_OAUTH_CLIENT_ID")
    @js.native
    val INVALID_OAUTH_CLIENT_ID: `authSlashinvalid-oauth-client-id` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_OAUTH_PROVIDER")
    @js.native
    val INVALID_OAUTH_PROVIDER: `authSlashinvalid-oauth-provider` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_OOB_CODE")
    @js.native
    val INVALID_OOB_CODE: `authSlashinvalid-action-code` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_ORIGIN")
    @js.native
    val INVALID_ORIGIN: `authSlashunauthorized-domain` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_PASSWORD")
    @js.native
    val INVALID_PASSWORD: `authSlashwrong-password` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_PERSISTENCE")
    @js.native
    val INVALID_PERSISTENCE: `authSlashinvalid-persistence-type` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_PHONE_NUMBER")
    @js.native
    val INVALID_PHONE_NUMBER: `authSlashinvalid-phone-number` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_PROVIDER_ID")
    @js.native
    val INVALID_PROVIDER_ID: `authSlashinvalid-provider-id` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    val INVALID_RECAPTCHA_VERSION: `authSlashinvalid-recaptcha-version` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_RECIPIENT_EMAIL")
    @js.native
    val INVALID_RECIPIENT_EMAIL: `authSlashinvalid-recipient-email` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    val INVALID_REQ_TYPE: `authSlashinvalid-req-type` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_SENDER")
    @js.native
    val INVALID_SENDER: `authSlashinvalid-sender` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_SESSION_INFO")
    @js.native
    val INVALID_SESSION_INFO: `authSlashinvalid-verification-id` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.INVALID_TENANT_ID")
    @js.native
    val INVALID_TENANT_ID: `authSlashinvalid-tenant-id` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MFA_INFO_NOT_FOUND")
    @js.native
    val MFA_INFO_NOT_FOUND: `authSlashmulti-factor-info-not-found` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MFA_REQUIRED")
    @js.native
    val MFA_REQUIRED: `authSlashmulti-factor-auth-required` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_ANDROID_PACKAGE_NAME")
    @js.native
    val MISSING_ANDROID_PACKAGE_NAME: `authSlashmissing-android-pkg-name` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_APP_CREDENTIAL")
    @js.native
    val MISSING_APP_CREDENTIAL: `authSlashmissing-app-credential` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_AUTH_DOMAIN")
    @js.native
    val MISSING_AUTH_DOMAIN: `authSlashauth-domain-config-required` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    val MISSING_CLIENT_TYPE: `authSlashmissing-client-type` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_CODE")
    @js.native
    val MISSING_CODE: `authSlashmissing-verification-code` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_CONTINUE_URI")
    @js.native
    val MISSING_CONTINUE_URI: `authSlashmissing-continue-uri` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_IFRAME_START")
    @js.native
    val MISSING_IFRAME_START: `authSlashmissing-iframe-start` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_IOS_BUNDLE_ID")
    @js.native
    val MISSING_IOS_BUNDLE_ID: `authSlashmissing-ios-bundle-id` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_MFA_INFO")
    @js.native
    val MISSING_MFA_INFO: `authSlashmissing-multi-factor-info` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_MFA_SESSION")
    @js.native
    val MISSING_MFA_SESSION: `authSlashmissing-multi-factor-session` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_OR_INVALID_NONCE")
    @js.native
    val MISSING_OR_INVALID_NONCE: `authSlashmissing-or-invalid-nonce` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_PHONE_NUMBER")
    @js.native
    val MISSING_PHONE_NUMBER: `authSlashmissing-phone-number` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    val MISSING_RECAPTCHA_VERSION: `authSlashmissing-recaptcha-version` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MISSING_SESSION_INFO")
    @js.native
    val MISSING_SESSION_INFO: `authSlashmissing-verification-id` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.MODULE_DESTROYED")
    @js.native
    val MODULE_DESTROYED: `authSlashapp-deleted` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.NEED_CONFIRMATION")
    @js.native
    val NEED_CONFIRMATION: `authSlashaccount-exists-with-different-credential` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.NETWORK_REQUEST_FAILED")
    @js.native
    val NETWORK_REQUEST_FAILED: `authSlashnetwork-request-failed` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.NO_AUTH_EVENT")
    @js.native
    val NO_AUTH_EVENT: `authSlashno-auth-event` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.NO_SUCH_PROVIDER")
    @js.native
    val NO_SUCH_PROVIDER: `authSlashno-such-provider` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.NULL_USER")
    @js.native
    val NULL_USER: `authSlashnull-user` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.OPERATION_NOT_ALLOWED")
    @js.native
    val OPERATION_NOT_ALLOWED: `authSlashoperation-not-allowed` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.OPERATION_NOT_SUPPORTED")
    @js.native
    val OPERATION_NOT_SUPPORTED: `authSlashoperation-not-supported-in-this-environment` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.POPUP_BLOCKED")
    @js.native
    val POPUP_BLOCKED: `authSlashpopup-blocked` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.POPUP_CLOSED_BY_USER")
    @js.native
    val POPUP_CLOSED_BY_USER: `authSlashpopup-closed-by-user` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.PROVIDER_ALREADY_LINKED")
    @js.native
    val PROVIDER_ALREADY_LINKED: `authSlashprovider-already-linked` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.QUOTA_EXCEEDED")
    @js.native
    val QUOTA_EXCEEDED: `authSlashquota-exceeded` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
    val RECAPTCHA_NOT_ENABLED: `authSlashrecaptcha-not-enabled` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.REDIRECT_CANCELLED_BY_USER")
    @js.native
    val REDIRECT_CANCELLED_BY_USER: `authSlashredirect-cancelled-by-user` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.REDIRECT_OPERATION_PENDING")
    @js.native
    val REDIRECT_OPERATION_PENDING: `authSlashredirect-operation-pending` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.REJECTED_CREDENTIAL")
    @js.native
    val REJECTED_CREDENTIAL: `authSlashrejected-credential` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.SECOND_FACTOR_ALREADY_ENROLLED")
    @js.native
    val SECOND_FACTOR_ALREADY_ENROLLED: `authSlashsecond-factor-already-in-use` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.SECOND_FACTOR_LIMIT_EXCEEDED")
    @js.native
    val SECOND_FACTOR_LIMIT_EXCEEDED: `authSlashmaximum-second-factor-count-exceeded` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.TENANT_ID_MISMATCH")
    @js.native
    val TENANT_ID_MISMATCH: `authSlashtenant-id-mismatch` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.TIMEOUT")
    @js.native
    val TIMEOUT: authSlashtimeout = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.TOKEN_EXPIRED")
    @js.native
    val TOKEN_EXPIRED: `authSlashuser-token-expired` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.TOO_MANY_ATTEMPTS_TRY_LATER")
    @js.native
    val TOO_MANY_ATTEMPTS_TRY_LATER: `authSlashtoo-many-requests` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.UNAUTHORIZED_DOMAIN")
    @js.native
    val UNAUTHORIZED_DOMAIN: `authSlashunauthorized-continue-uri` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.UNSUPPORTED_FIRST_FACTOR")
    @js.native
    val UNSUPPORTED_FIRST_FACTOR: `authSlashunsupported-first-factor` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.UNSUPPORTED_PERSISTENCE")
    @js.native
    val UNSUPPORTED_PERSISTENCE: `authSlashunsupported-persistence-type` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.UNSUPPORTED_TENANT_OPERATION")
    @js.native
    val UNSUPPORTED_TENANT_OPERATION: `authSlashunsupported-tenant-operation` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.UNVERIFIED_EMAIL")
    @js.native
    val UNVERIFIED_EMAIL: `authSlashunverified-email` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.USER_CANCELLED")
    @js.native
    val USER_CANCELLED: `authSlashuser-cancelled` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.USER_DELETED")
    @js.native
    val USER_DELETED: `authSlashuser-not-found` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.USER_DISABLED")
    @js.native
    val USER_DISABLED: `authSlashuser-disabled` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.USER_MISMATCH")
    @js.native
    val USER_MISMATCH: `authSlashuser-mismatch` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.USER_SIGNED_OUT")
    @js.native
    val USER_SIGNED_OUT: `authSlashuser-signed-out` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.WEAK_PASSWORD")
    @js.native
    val WEAK_PASSWORD: `authSlashweak-password` = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "AuthErrorCodes.WEB_STORAGE_UNSUPPORTED")
    @js.native
    val WEB_STORAGE_UNSUPPORTED: `authSlashweb-storage-unsupported` = js.native
  }
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "EmailAuthCredential")
  @js.native
  /** @internal */
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "EmailAuthProvider")
  @js.native
  ...
  object EmailAuthProvider {
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "EmailAuthProvider.PROVIDER_ID")
    @js.native
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "FacebookAuthProvider")
  @js.native
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.cordovaMod.FacebookAuthProvider
  /* static members */
  object FacebookAuthProvider {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD")
    @js.native
    val FACEBOOK_SIGN_IN_METHOD: facebookDotcom = js.native
    
    /** Always set to {@link ProviderId}.FACEBOOK. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "FacebookAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "FacebookAuthProvider.credentialFromTaggedObject")
    @js.native
  ...
  object FactorId {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "FactorId.PHONE")
    @js.native
    val PHONE: phone = js.native
    
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "FactorId.TOTP")
    @js.native
    val TOTP: totp = js.native
  }
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "GithubAuthProvider")
  @js.native
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.cordovaMod.GithubAuthProvider
  /* static members */
  object GithubAuthProvider {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "GithubAuthProvider.GITHUB_SIGN_IN_METHOD")
    @js.native
    val GITHUB_SIGN_IN_METHOD: githubDotcom = js.native
    
    /** Always set to {@link ProviderId}.GITHUB. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "GithubAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "GithubAuthProvider.credentialFromTaggedObject")
    @js.native
    def credentialFromTaggedObject: Any = js.native
    inline def credentialFromTaggedObject_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("credentialFromTaggedObject")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "GoogleAuthProvider")
  @js.native
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.cordovaMod.GoogleAuthProvider
  /* static members */
  object GoogleAuthProvider {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "GoogleAuthProvider.GOOGLE_SIGN_IN_METHOD")
    @js.native
    val GOOGLE_SIGN_IN_METHOD: googleDotcom = js.native
    
    /** Always set to {@link ProviderId}.GOOGLE. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "GoogleAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "GoogleAuthProvider.credentialFromTaggedObject")
    @js.native
    def credentialFromTaggedObject: Any = js.native
    inline def credentialFromTaggedObject_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("credentialFromTaggedObject")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "OAuthCredential")
  @js.native
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "OAuthProvider")
  @js.native
  ...
  object OAuthProvider {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "OAuthProvider.oauthCredentialFromTaggedObject")
    @js.native
  ...
  object OperationType {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "OperationType.LINK")
    @js.native
    val LINK: link = js.native
    
    /** Operation involving using a provider to reauthenticate an already signed-in user. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "OperationType.REAUTHENTICATE")
    @js.native
    val REAUTHENTICATE: reauthenticate = js.native
    
    /** Operation involving signing in a user. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "OperationType.SIGN_IN")
    @js.native
    val SIGN_IN: signIn = js.native
  }
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "PhoneAuthCredential")
  @js.native
  /* private */ open class PhoneAuthCredential ()
    extends typings.firebaseAuth.cordovaMod.PhoneAuthCredential
  /* static members */
  ...
  object ProviderId {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ProviderId.FACEBOOK")
    @js.native
    val FACEBOOK: facebookDotcom = js.native
    
    /** GitHub provider ID */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ProviderId.GITHUB")
    @js.native
    val GITHUB: githubDotcom = js.native
    
    /** Google provider ID */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ProviderId.GOOGLE")
    @js.native
    val GOOGLE: googleDotcom = js.native
    
    /** Password provider */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ProviderId.PASSWORD")
    @js.native
    val PASSWORD: password = js.native
    
    /** Phone provider */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ProviderId.PHONE")
    @js.native
    val PHONE: phone = js.native
    
    /** Twitter provider ID */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "ProviderId.TWITTER")
    @js.native
    val TWITTER: twitterDotcom = js.native
  }
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SAMLAuthProvider")
  @js.native
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.cordovaMod.SAMLAuthProvider {
    /**
  ...
  object SAMLAuthProvider {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SAMLAuthProvider.samlCredentialFromTaggedObject")
    @js.native
  ...
  object SignInMethod {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SignInMethod.EMAIL_LINK")
    @js.native
    val EMAIL_LINK: emailLink = js.native
    
    /** Email/password sign in method */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SignInMethod.EMAIL_PASSWORD")
    @js.native
    val EMAIL_PASSWORD: password = js.native
    
    /** Facebook sign in method */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SignInMethod.FACEBOOK")
    @js.native
    val FACEBOOK: facebookDotcom = js.native
    
    /** GitHub sign in method */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SignInMethod.GITHUB")
    @js.native
    val GITHUB: githubDotcom = js.native
    
    /** Google sign in method */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SignInMethod.GOOGLE")
    @js.native
    val GOOGLE: googleDotcom = js.native
    
    /** Phone sign in method */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SignInMethod.PHONE")
    @js.native
    val PHONE: phone = js.native
    
    /** Twitter sign in method */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "SignInMethod.TWITTER")
    @js.native
    val TWITTER: twitterDotcom = js.native
  }
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "TwitterAuthProvider")
  @js.native
  open class TwitterAuthProvider ()
    extends typings.firebaseAuth.cordovaMod.TwitterAuthProvider
  /* static members */
  object TwitterAuthProvider {
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "TwitterAuthProvider.PROVIDER_ID")
    @js.native
    val PROVIDER_ID: twitterDotcom = js.native
    
    /** Always set to {@link SignInMethod}.TWITTER. */
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "TwitterAuthProvider.TWITTER_SIGN_IN_METHOD")
    @js.native
    ...
    @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "TwitterAuthProvider.credentialFromTaggedObject")
    @js.native
    def credentialFromTaggedObject: Any = js.native
    inline def credentialFromTaggedObject_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("credentialFromTaggedObject")(x.asInstanceOf[js.Any])
  }
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "browserLocalPersistence")
  @js.native
  val browserLocalPersistence: Persistence = js.native
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "browserSessionPersistence")
  @js.native
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "cordovaPopupRedirectResolver")
  @js.native
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "debugErrorMap")
  @js.native
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "inMemoryPersistence")
  @js.native
  val inMemoryPersistence: Persistence = js.native
  
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "indexedDBLocalPersistence")
  @js.native
  ...
  @JSImport("firebase/compat/performance/dist/esm/auth/cordova", "prodErrorMap")
  @js.native
