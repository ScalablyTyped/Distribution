...
object firebaseMessagingDistAppMod {
  
  @JSImport("firebase/messaging/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/messaging/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/messaging/dist/app", "SDK_VERSION")
  @js.native
