...
object compatAnalyticsDistStorageMod {
  
  @JSImport("firebase/compat/analytics/dist/storage", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/analytics/dist/storage", "StorageError")
  @js.native
  ...
  @JSImport("firebase/compat/analytics/dist/storage", "StorageErrorCode")
  @js.native
