...
object installationsDistFirestoreMod {
  ...
  @JSImport("firebase/installations/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/installations/dist/firestore", "QueryStartAtConstraint")
  @js.native
