...
object installationsDistEsmAppMod {
  
  @JSImport("firebase/installations/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/installations/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/installations/dist/esm/app", "SDK_VERSION")
  @js.native
