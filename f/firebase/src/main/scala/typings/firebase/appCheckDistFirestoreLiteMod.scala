...
object appCheckDistFirestoreLiteMod {
  ...
  @JSImport("firebase/app-check/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/app-check/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
