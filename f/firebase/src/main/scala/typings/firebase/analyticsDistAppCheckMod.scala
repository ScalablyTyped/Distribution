...
object analyticsDistAppCheckMod {
  ...
  @JSImport("firebase/compat/analytics/dist/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/analytics/dist/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/compat/analytics/dist/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/compat/analytics/dist/app-check", "ReCaptchaV3Provider")
  @js.native
