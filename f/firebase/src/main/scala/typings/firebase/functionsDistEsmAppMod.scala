...
object functionsDistEsmAppMod {
  
  @JSImport("firebase/functions/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/functions/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/functions/dist/esm/app", "SDK_VERSION")
  @js.native
