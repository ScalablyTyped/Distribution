...
object distAppMod {
  ...
  @JSImport("firebase/app-check/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/app-check/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/app-check/dist/app", "SDK_VERSION")
  @js.native
