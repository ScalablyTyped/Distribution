...
object compatDatabaseDistFirestoreMod {
  ...
  @JSImport("firebase/compat/database/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/database/dist/firestore", "QueryEndAtConstraint")
  @js.native
  open class QueryEndAtConstraint ()
    extends typings.firebaseFirestore.mod.QueryEndAtConstraint
  
  @JSImport("firebase/compat/database/dist/firestore", "QueryFieldFilterConstraint")
  @js.native
  open class QueryFieldFilterConstraint ()
    extends typings.firebaseFirestore.mod.QueryFieldFilterConstraint
  
  @JSImport("firebase/compat/database/dist/firestore", "QueryLimitConstraint")
  @js.native
  open class QueryLimitConstraint ()
    extends typings.firebaseFirestore.mod.QueryLimitConstraint
  
  @JSImport("firebase/compat/database/dist/firestore", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/database/dist/firestore", "QueryStartAtConstraint")
  @js.native
