...
object compatAppDistEsmAppMod {
  
  @JSImport("firebase/compat/app/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/app/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/app/dist/esm/app", "SDK_VERSION")
  @js.native
