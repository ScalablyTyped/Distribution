...
object firebaseStorageMod {
  
  @JSImport("firebase/database/dist/storage", JSImport.Namespace)
  @js.native
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("firebase/database/dist/storage", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("firebase/database/dist/storage", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/database/dist/storage", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/database/dist/storage", "StringFormat.RAW")
    @js.native
