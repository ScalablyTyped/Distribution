...
object firebaseFunctionsDistFirestoreMod {
  ...
  @JSImport("firebase/functions/dist/firestore", "FieldValue")
  @js.native
  ...
  @JSImport("firebase/functions/dist/firestore", "QueryConstraint")
  @js.native
