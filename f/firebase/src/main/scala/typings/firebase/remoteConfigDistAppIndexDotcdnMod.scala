...
object remoteConfigDistAppIndexDotcdnMod {
  
  @JSImport("firebase/remote-config/dist/app/index.cdn", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/remote-config/dist/app/index.cdn", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/remote-config/dist/app/index.cdn", "SDK_VERSION")
  @js.native
