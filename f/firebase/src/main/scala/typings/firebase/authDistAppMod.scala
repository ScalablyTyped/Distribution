...
object authDistAppMod {
  
  @JSImport("firebase/auth/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/auth/dist/app", "SDK_VERSION")
  @js.native
