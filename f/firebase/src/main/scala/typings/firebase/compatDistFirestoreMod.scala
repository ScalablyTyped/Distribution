...
object compatDistFirestoreMod {
  ...
  @JSImport("firebase/compat/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/compat/dist/firestore", "QueryStartAtConstraint")
  @js.native
