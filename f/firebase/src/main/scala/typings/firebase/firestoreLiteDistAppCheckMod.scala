...
object firestoreLiteDistAppCheckMod {
  
  @JSImport("firebase/firestore/lite/dist/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/firestore/lite/dist/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/firestore/lite/dist/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/firestore/lite/dist/app-check", "ReCaptchaV3Provider")
  @js.native
