...
object appDistEsmAppIndexDotcdnMod {
  
  @JSImport("firebase/app/dist/esm/app/index.cdn", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/app/dist/esm/app/index.cdn", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/app/dist/esm/app/index.cdn", "SDK_VERSION")
  @js.native
