...
object compatFunctionsDistStorageMod {
  
  @JSImport("firebase/compat/functions/dist/storage", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/functions/dist/storage", "StorageError")
  @js.native
  ...
  @JSImport("firebase/compat/functions/dist/storage", "StorageErrorCode")
  @js.native
