...
object functionsDistFirestoreLiteMod {
  ...
  @JSImport("firebase/functions/dist/firestore/lite", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/functions/dist/firestore/lite", "QueryStartAtConstraint")
  @js.native
