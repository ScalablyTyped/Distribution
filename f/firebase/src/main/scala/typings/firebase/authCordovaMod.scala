...
object authCordovaMod {
  ...
  open class ActionCodeURL protected ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  object AuthErrorCodes {
    ...
    @JSImport("firebase/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("firebase/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("firebase/auth/cordova", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("firebase/auth/cordova", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    ...
    @JSImport("firebase/auth/cordova", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    ...
    @JSImport("firebase/auth/cordova", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("firebase/auth/cordova", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("firebase/auth/cordova", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
  ...
  /* private */ open class EmailAuthCredential ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.FacebookAuthProvider
  /* static members */
  ...
  object FactorId {
    ...
    @JSImport("firebase/auth/cordova", "FactorId.TOTP")
    @js.native
  ...
  open class GithubAuthProvider ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.PhoneAuthCredential
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typings.firebase.authCordovaDistAuthCordovaMod.TwitterAuthProvider
  /* static members */
