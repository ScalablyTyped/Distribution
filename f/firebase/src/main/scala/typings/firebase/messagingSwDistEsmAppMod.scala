...
object messagingSwDistEsmAppMod {
  
  @JSImport("firebase/messaging/sw/dist/esm/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/messaging/sw/dist/esm/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/messaging/sw/dist/esm/app", "SDK_VERSION")
  @js.native
