...
object cordovaDistAppMod {
  
  @JSImport("firebase/auth/cordova/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/cordova/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/auth/cordova/dist/app", "SDK_VERSION")
  @js.native
