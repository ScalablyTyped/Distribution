...
object authCordovaDistFirestoreMod {
  ...
  @JSImport("firebase/auth/cordova/dist/firestore", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("firebase/auth/cordova/dist/firestore", "QueryStartAtConstraint")
  @js.native
