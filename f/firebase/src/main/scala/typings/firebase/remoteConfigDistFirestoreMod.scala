...
object remoteConfigDistFirestoreMod {
  
  @JSImport("firebase/remote-config/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/remote-config/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/remote-config/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  /* private */ open class AggregateQuerySnapshot[T /* <: AggregateSpec */] ()
    extends typings.firebaseFirestore.mod.AggregateQuerySnapshot[T]
  
  @JSImport("firebase/remote-config/dist/firestore", "Bytes")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/remote-config/dist/firestore", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typings.firebaseFirestore.mod.FieldValue
  
  @JSImport("firebase/remote-config/dist/firestore", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typings.firebaseFirestore.mod.Firestore
  
  @JSImport("firebase/remote-config/dist/firestore", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typings.firebaseFirestore.mod.FirestoreError
  
  @JSImport("firebase/remote-config/dist/firestore", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/remote-config/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typings.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/remote-config/dist/firestore", "WriteBatch")
  @js.native
