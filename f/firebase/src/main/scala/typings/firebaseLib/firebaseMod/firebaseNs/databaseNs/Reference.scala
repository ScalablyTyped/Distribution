...
trait Reference extends Query {
  ...
  def remove(onComplete: js.Function1[/* a */ nodeLib.Error | scala.Null, _]): stdLib.Promise[_] = js.native
  def set(value: js.Any): stdLib.Promise[_] = js.native
  def set(value: js.Any, onComplete: js.Function1[/* a */ nodeLib.Error | scala.Null, _]): stdLib.Promise[_] = js.native
  def setPriority(priority: java.lang.String, onComplete: js.Function1[/* a */ nodeLib.Error | scala.Null, _]): stdLib.Promise[_] = js.native
  def setPriority(priority: scala.Double, onComplete: js.Function1[/* a */ nodeLib.Error | scala.Null, _]): stdLib.Promise[_] = js.native
  def setPriority(priority: scala.Null, onComplete: js.Function1[/* a */ nodeLib.Error | scala.Null, _]): stdLib.Promise[_] = js.native
  ...
  def update(values: js.Object, onComplete: js.Function1[/* a */ nodeLib.Error | scala.Null, _]): stdLib.Promise[_] = js.native
}
