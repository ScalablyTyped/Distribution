...
trait Reference extends js.Object {
  ...
  def getDownloadURL(): stdLib.Promise[_] = js.native
  def getMetadata(): stdLib.Promise[_] = js.native
  ...
  def updateMetadata(metadata: SettableMetadata): stdLib.Promise[_] = js.native
}
