...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase__auth" % "0.20.10-fd8e6b",
  ...
  "org.scalablytyped" %%% "firebase__firestore-compat" % "0.2.1-449fb3",
  ...
  "org.scalablytyped" %%% "firebase__storage" % "0.9.12-411fc3",
