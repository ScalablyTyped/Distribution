...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase__auth" % "0.20.10-910cbc",
  ...
  "org.scalablytyped" %%% "firebase__firestore-compat" % "0.2.1-33005f",
  ...
  "org.scalablytyped" %%% "firebase__storage" % "0.9.12-3fbf28",
