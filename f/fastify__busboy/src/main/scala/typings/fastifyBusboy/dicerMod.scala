...
import typings.fastifyBusboy.dicerMod.Dicer.PartStream
import typings.fastifyBusboy.fastifyBusboyStrings.close
import typings.fastifyBusboy.fastifyBusboyStrings.data
import typings.fastifyBusboy.fastifyBusboyStrings.drain
import typings.fastifyBusboy.fastifyBusboyStrings.end
import typings.fastifyBusboy.fastifyBusboyStrings.error
import typings.fastifyBusboy.fastifyBusboyStrings.finish
import typings.fastifyBusboy.fastifyBusboyStrings.header
import typings.fastifyBusboy.fastifyBusboyStrings.part
import typings.fastifyBusboy.fastifyBusboyStrings.pipe
import typings.fastifyBusboy.fastifyBusboyStrings.preamble
import typings.fastifyBusboy.fastifyBusboyStrings.readable
import typings.fastifyBusboy.fastifyBusboyStrings.trailer
import typings.fastifyBusboy.fastifyBusboyStrings.unpipe
...
object dicerMod {
  ...
  @JSImport("@fastify/busboy/deps/dicer/lib/dicer", "Dicer")
  @js.native
  open class Dicer protected () extends Writable {
    /**
