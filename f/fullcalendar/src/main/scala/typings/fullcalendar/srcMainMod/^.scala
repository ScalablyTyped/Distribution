...
import typings.fullcalendar.fullcalendarStrings.`<%= version %>`
...
object ^ extends js.Object {
  ...
  val internalApiVersion: `12` = js.native
  ...
  def defineThemeSystem(themeName: js.Any, themeClass: js.Any): Unit = js.native
  ...
  def getMomentLocaleData(localeCode: js.Any): Locale = js.native
