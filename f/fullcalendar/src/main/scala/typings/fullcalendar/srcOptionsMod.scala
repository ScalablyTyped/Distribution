...
object srcOptionsMod extends js.Object {
  ...
  object globalDefaults extends js.Object {
    ...
    var buttonText: Anon_Day = js.native
    var columnHeader: Boolean = js.native
    var dayPopoverFormat: String = js.native
    var defaultAllDayEventDuration: Anon_Days = js.native
    ...
    var header: Anon_Center = js.native
  ...
  object rtlDefaults extends js.Object {
    var buttonIcons: Anon_Next = js.native
    var header: Anon_Center = js.native
    var themeButtonIcons: Anon_NextNextYear = js.native
  }
