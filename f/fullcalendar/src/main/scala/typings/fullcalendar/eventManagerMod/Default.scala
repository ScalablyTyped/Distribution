package typings.fullcalendar.eventManagerMod
...
class Default protected () extends js.Object {
  ...
  def buildMutatedEventInstanceGroup(eventDefId: js.Any, eventDefMutation: js.Any): typings.fullcalendar.eventInstanceGroupMod.default = js.native
