...
trait Anon_ActiveUnzonedRange extends js.Object {
  var activeUnzonedRange: js.Any
  var currentRangeUnit: js.Any
  var currentUnzonedRange: js.Any
  var date: js.Any
  var dateIncrement: js.Any
  var isRangeAllDay: js.Any
  var isValid: js.Any
  var maxTime: js.Any
  var minTime: js.Any
  var renderUnzonedRange: js.Any
