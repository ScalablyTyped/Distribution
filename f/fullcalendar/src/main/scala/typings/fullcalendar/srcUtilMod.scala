...
object srcUtilMod extends js.Object {
  ...
  def constrainPoint(point: js.Any, rect: js.Any): AnonLeft = js.native
  ...
  def diffPoints(point1: js.Any, point2: js.Any): AnonLeft = js.native
  ...
  def getRectCenter(rect: js.Any): AnonLeft = js.native
  ...
  def intersectRects(rect1: js.Any, rect2: js.Any): `false` | AnonBottomLeft = js.native
