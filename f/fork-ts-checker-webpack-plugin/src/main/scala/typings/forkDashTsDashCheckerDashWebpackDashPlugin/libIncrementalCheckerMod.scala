...
import typings.forkDashTsDashCheckerDashWebpackDashPlugin.libIncrementalCheckerInterfaceMod.IncrementalCheckerParams
...
@js.native
object libIncrementalCheckerMod extends js.Object {
  @js.native
