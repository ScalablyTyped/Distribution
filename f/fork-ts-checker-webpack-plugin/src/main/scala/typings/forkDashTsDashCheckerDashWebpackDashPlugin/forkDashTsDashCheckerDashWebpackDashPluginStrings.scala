...
import typings.forkDashTsDashCheckerDashWebpackDashPlugin.libNormalizedMessageMod.ErrorType
import typings.forkDashTsDashCheckerDashWebpackDashPlugin.libNormalizedMessageMod.Severity
