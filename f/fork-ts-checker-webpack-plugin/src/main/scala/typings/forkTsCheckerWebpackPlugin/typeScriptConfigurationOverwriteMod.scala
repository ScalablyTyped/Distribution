...
object typeScriptConfigurationOverwriteMod {
  ...
  object TypeScriptConfigurationOverwrite {
    ...
    inline def apply(): TypeScriptConfigurationOverwrite = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TypeScriptConfigurationOverwrite]
    }
    
    extension [Self <: TypeScriptConfigurationOverwrite](x: Self) {
      ...
      inline def setReferencesVarargs(value: Path*): Self = StObject.set(x, "references", js.Array(value :_*))
    }
  }
}
