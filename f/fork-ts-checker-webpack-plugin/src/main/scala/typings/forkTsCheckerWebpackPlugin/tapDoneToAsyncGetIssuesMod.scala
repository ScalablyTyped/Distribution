...
object tapDoneToAsyncGetIssuesMod {
  ...
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("tapDoneToAsyncGetIssues")(compiler.asInstanceOf[js.Any], configuration.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
