...
import typings.forkTsCheckerWebpackPlugin.libWatchWatchFileSystemMod.Watch
import typings.forkTsCheckerWebpackPlugin.libWatchWatchFileSystemMod.WatchFileSystem
