...
import typings.forkTsCheckerWebpackPlugin.anon.TypeofScriptSnapshot
...
import typings.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.quit
...
object libTypescriptWorkerLibTypescriptMod {
  
  object typescript {
    
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript")
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.OperationCanceledException")
    @js.native
    ...
    inline def OperationCanceledException_=(x: Instantiable0[typings.typescript.mod.OperationCanceledException]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OperationCanceledException")(x.asInstanceOf[js.Any])
    
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.ScriptSnapshot")
    @js.native
    ...
    inline def createScanner(languageVersion: ScriptTarget, skipTrivia: Boolean, languageVariant: Unit, textInitial: String): Scanner = (^.asInstanceOf[js.Dynamic].applyDynamic("createScanner")(languageVersion.asInstanceOf[js.Any], skipTrivia.asInstanceOf[js.Any], languageVariant.asInstanceOf[js.Any], textInitial.asInstanceOf[js.Any])).asInstanceOf[Scanner]
    ...
    inline def createSourceFile(fileName: String, sourceText: String, languageVersionOrOptions: ScriptTarget): SourceFile = (^.asInstanceOf[js.Dynamic].applyDynamic("createSourceFile")(fileName.asInstanceOf[js.Any], sourceText.asInstanceOf[js.Any], languageVersionOrOptions.asInstanceOf[js.Any])).asInstanceOf[SourceFile]
    inline def createSourceFile(
      fileName: String,
      sourceText: String,
    ...
    inline def escapeLeadingUnderscores(identifier: String): typings.typescript.mod.String = ^.asInstanceOf[js.Dynamic].applyDynamic("escapeLeadingUnderscores")(identifier.asInstanceOf[js.Any]).asInstanceOf[typings.typescript.mod.String]
    
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.factory")
    @js.native
    ...
    inline def getModeForFileReference(ref: String, containingFileMode: ResolutionMode): ResolutionMode = (^.asInstanceOf[js.Dynamic].applyDynamic("getModeForFileReference")(ref.asInstanceOf[js.Any], containingFileMode.asInstanceOf[js.Any])).asInstanceOf[ResolutionMode]
    /**
    ...
    inline def parseIsolatedEntityName(text: String, languageVersion: ScriptTarget): js.UndefOr[EntityName] = (^.asInstanceOf[js.Dynamic].applyDynamic("parseIsolatedEntityName")(text.asInstanceOf[js.Any], languageVersion.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[EntityName]]
    ...
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.server")
    @js.native
    val server: Any = js.native
    
    /** The version of the language service API */
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.servicesVersion")
    @js.native
    ...
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.sys")
    @js.native
    ...
    inline def tokenToString(t: SyntaxKind): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("tokenToString")(t.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
    ...
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.unchangedTextChangeRange")
    @js.native
    ...
    /**
      ...
      */
    inline def unescapeLeadingUnderscores(identifier: typings.typescript.mod.String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("unescapeLeadingUnderscores")(identifier.asInstanceOf[js.Any]).asInstanceOf[String]
    ...
    inline def validateLocaleAndSetLanguage(locale: String, sys: FileExists, errors: js.Array[Diagnostic]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("validateLocaleAndSetLanguage")(locale.asInstanceOf[js.Any], sys.asInstanceOf[js.Any], errors.asInstanceOf[js.Any])).asInstanceOf[Unit]
    
    /** The version of the TypeScript compiler release */
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.version")
    @js.native
    val version: String = js.native
    
    @JSImport("fork-ts-checker-webpack-plugin/lib/typescript/worker/lib/typescript", "typescript.versionMajorMinor")
    @js.native
