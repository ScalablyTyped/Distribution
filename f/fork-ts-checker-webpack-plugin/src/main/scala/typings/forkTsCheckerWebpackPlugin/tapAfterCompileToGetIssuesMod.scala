...
object tapAfterCompileToGetIssuesMod {
  ...
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("tapAfterCompileToGetIssues")(compiler.asInstanceOf[js.Any], configuration.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
