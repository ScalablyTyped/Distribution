...
object libInfrastructureLoggerMod {
  
  @JSImport("fork-ts-checker-webpack-plugin/lib/infrastructure-logger", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def getInfrastructureLogger(compiler: Compiler): InfrastructureLogger = ^.asInstanceOf[js.Dynamic].applyDynamic("getInfrastructureLogger")(compiler.asInstanceOf[js.Any]).asInstanceOf[InfrastructureLogger]
  
  trait InfrastructureLogger extends StObject {
