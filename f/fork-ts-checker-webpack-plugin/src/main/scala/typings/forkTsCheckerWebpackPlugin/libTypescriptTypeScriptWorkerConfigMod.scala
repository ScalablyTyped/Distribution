...
import typings.forkTsCheckerWebpackPlugin.libTypescriptTypeScriptDiagnosticsOptionsMod.TypeScriptDiagnosticsOptions
...
object libTypescriptTypeScriptWorkerConfigMod {
  ...
  object TypeScriptWorkerConfig {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TypeScriptWorkerConfig] (val x: Self) extends AnyVal {
