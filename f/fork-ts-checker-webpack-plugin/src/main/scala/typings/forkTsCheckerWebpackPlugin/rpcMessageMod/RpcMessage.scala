...
object RpcMessage {
  ...
  @scala.inline
  implicit class RpcMessageOps[Self <: RpcMessage[_, _, _], TType /* <: String */, TProcedure /* <: RpcProcedure[_, _] */, TPayload] (val x: Self with (RpcMessage[TType, TProcedure, TPayload])) extends AnyVal {
