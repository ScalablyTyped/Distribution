...
object mod extends Shortcut {
  ...
  @JSImport("forever-agent", JSImport.Namespace)
  @js.native
  val ^ : TypeofForeverAgent with (Instantiable1[/* options */ js.UndefOr[ForeverAgentOptions], ForeverAgent]) with typings.foreverAgent.anon.SSL = js.native
  ...
  type _To = TypeofForeverAgent with (Instantiable1[/* options */ js.UndefOr[ForeverAgentOptions], ForeverAgent]) with typings.foreverAgent.anon.SSL
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: TypeofForeverAgent with (Instantiable1[/* options */ js.UndefOr[ForeverAgentOptions], ForeverAgent]) with typings.foreverAgent.anon.SSL = ^
}
