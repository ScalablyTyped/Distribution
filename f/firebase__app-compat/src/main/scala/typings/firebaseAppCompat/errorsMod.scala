...
object errorsMod {
  ...
  @JSImport("@firebase/app-compat/dist/esm/src/errors", "ERROR_FACTORY")
  @js.native
  ...
  */
  ...
  /* Inlined {[ key in @firebase/app-compat.@firebase/app-compat/dist/esm/src/errors.AppError ]: {  appName :string}} */
