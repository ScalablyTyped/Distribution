...
import typings.firebaseAppCompat.distSrcPublicTypesMod.FirebaseOptions
import typings.firebaseAppCompat.distSrcTypesMod.FirebaseNamespace
import typings.firebaseAppCompat.distSrcTypesMod.FirebaseService
...
object distSrcFirebaseAppMod {
  
  @JSImport("@firebase/app-compat/dist/src/firebaseApp", "FirebaseAppImpl")
  @js.native
