...
import typings.firebaseAppCompat.anon.App
import typings.firebaseAppCompat.anon.RegisterComponent
...
object appCompatMod extends Shortcut {
  
  @JSImport("@firebase/app-compat/dist/app-compat", JSImport.Default)
  @js.native
  ...
  trait FirebaseNamespace extends StObject {
    ...
    @JSName("app")
    var app_Original: App = js.native
  ...
  trait _FirebaseNamespace
    ...
    var INTERNAL: RegisterComponent = js.native
  }
  
  type _To = FirebaseNamespace
  
  /* This means you don't have to write `default`, but can instead just say `appCompatMod.foo` */
