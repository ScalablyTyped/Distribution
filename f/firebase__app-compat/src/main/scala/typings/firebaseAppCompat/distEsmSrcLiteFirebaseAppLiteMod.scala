...
import typings.firebaseAppCompat.distEsmSrcFirebaseAppMod.FirebaseApp
...
object distEsmSrcLiteFirebaseAppLiteMod {
  
  @JSImport("@firebase/app-compat/dist/esm/src/lite/firebaseAppLite", "FirebaseAppLiteImpl")
  @js.native
