...
object srcPublicTypesMod {
  ...
  type FirebaseApp = typings.firebaseAppCompat.srcFirebaseAppMod.FirebaseApp
  ...
  object firebaseComponentAugmentingMod {
    ...
    trait NameServiceMapping extends StObject {
      ...
      var `app-compat`: typings.firebaseAppCompat.publicTypesMod.FirebaseApp
    }
    object NameServiceMapping {
      
      inline def apply(`app-compat`: typings.firebaseAppCompat.publicTypesMod.FirebaseApp): NameServiceMapping = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: NameServiceMapping](x: Self) {
        ...
        inline def `setApp-compat`(value: typings.firebaseAppCompat.publicTypesMod.FirebaseApp): Self = StObject.set(x, "app-compat", value.asInstanceOf[js.Any])
      }
    }
  }
}
