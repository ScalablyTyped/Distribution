...
object indexDotliteMod extends Shortcut {
  
  @JSImport("@firebase/app-compat/dist/src/index.lite", JSImport.Default)
  @js.native
  val default: FirebaseNamespace = js.native
  
  type _To = FirebaseNamespace
  
  /* This means you don't have to write `default`, but can instead just say `indexDotliteMod.foo` */
