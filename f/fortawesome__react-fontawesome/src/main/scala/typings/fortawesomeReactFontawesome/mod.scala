...
object mod {
  ...
  trait FontAwesomeIconProps extends StObject {
    ...
    var forwardedRef: js.UndefOr[(js.Function1[/* e */ js.Any, Unit]) | RefObject[_]] = js.native
  ...
  object FontAwesomeIconProps {
    ...
    implicit class FontAwesomeIconPropsMutableBuilder[Self <: FontAwesomeIconProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setForwardedRef(value: (js.Function1[/* e */ js.Any, Unit]) | RefObject[_]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
