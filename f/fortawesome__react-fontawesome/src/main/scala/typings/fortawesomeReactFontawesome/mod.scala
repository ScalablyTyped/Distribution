...
object mod {
  ...
  @scala.inline
  def FontAwesomeIcon(props: FontAwesomeIconProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("FontAwesomeIcon")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait FontAwesomeIconProps extends StObject {
    ...
    var forwardedRef: js.UndefOr[(js.Function1[/* e */ js.Any, Unit]) | RefObject[js.Any]] = js.undefined
  ...
  object FontAwesomeIconProps {
    ...
    @scala.inline
    implicit class FontAwesomeIconPropsMutableBuilder[Self <: FontAwesomeIconProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFlip(value: FlipProp): Self = StObject.set(x, "flip", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setForwardedRef(value: (js.Function1[/* e */ js.Any, Unit]) | RefObject[js.Any]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setForwardedRefFunction1(value: /* e */ js.Any => Unit): Self = StObject.set(x, "forwardedRef", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setIcon(value: IconProp): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMask(value: IconProp): Self = StObject.set(x, "mask", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPull(value: PullProp): Self = StObject.set(x, "pull", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRotation(value: RotateProp): Self = StObject.set(x, "rotation", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSize(value: SizeProp): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSwapOpacity(value: Boolean): Self = StObject.set(x, "swapOpacity", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSwapOpacityUndefined: Self = StObject.set(x, "swapOpacity", js.undefined)
      ...
      @scala.inline
      def setTransform(value: String | Transform): Self = StObject.set(x, "transform", value.asInstanceOf[js.Any])
