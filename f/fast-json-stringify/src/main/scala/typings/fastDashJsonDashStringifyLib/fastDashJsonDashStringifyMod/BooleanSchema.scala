...
trait BooleanSchema
  extends BaseSchema
     with Schema {
  var `type`: fastDashJsonDashStringifyLib.fastDashJsonDashStringifyLibStrings.boolean
}

object BooleanSchema {
  @scala.inline
  def apply(
    `type`: fastDashJsonDashStringifyLib.fastDashJsonDashStringifyLibStrings.boolean,
