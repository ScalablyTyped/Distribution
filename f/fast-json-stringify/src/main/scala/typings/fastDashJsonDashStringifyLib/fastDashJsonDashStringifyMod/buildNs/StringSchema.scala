...
trait StringSchema
  extends BaseSchema
     with Schema {
  var `type`: fastDashJsonDashStringifyLib.fastDashJsonDashStringifyLibStrings.string
}

object StringSchema {
  @scala.inline
  def apply(
    `type`: fastDashJsonDashStringifyLib.fastDashJsonDashStringifyLibStrings.string,
