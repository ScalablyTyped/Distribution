...
trait ArraySchema
  ...
  var `type`: fastDashJsonDashStringifyLib.fastDashJsonDashStringifyLibStrings.array
}

object ArraySchema {
  @scala.inline
  def apply(
    items: Schema | js.Object,
    `type`: fastDashJsonDashStringifyLib.fastDashJsonDashStringifyLibStrings.array,
