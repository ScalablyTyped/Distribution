...
import typings.fullpageDotJs.fullpageDotJsStrings.bottom
import typings.fullpageDotJs.fullpageDotJsStrings.fingersonly
import typings.fullpageDotJs.fullpageDotJsStrings.horizontal
import typings.fullpageDotJs.fullpageDotJsStrings.mouseonly
import typings.fullpageDotJs.fullpageDotJsStrings.sections
import typings.fullpageDotJs.fullpageDotJsStrings.slides
import typings.fullpageDotJs.fullpageDotJsStrings.top
import typings.fullpageDotJs.fullpageDotJsStrings.vertical
...
object FullPageJsOptions {
  @scala.inline
  def apply(
    afterLoad: (/* anchorLink */ String, /* index */ Double) => Unit = null,
    afterRender: () => Unit = null,
    afterResize: () => Unit = null,
    afterResponsive: /* isResponsive */ Boolean => Unit = null,
    afterSlideLoad: (/* anchorLink */ String, /* index */ Double, /* slideAnchor */ String, /* slideIndex */ Double) => Unit = null,
    ...
    onSlideLeave: (/* anchorLink */ String, /* index */ Double, /* slideIndex */ Double, /* direction */ String, /* nextSlideIndex */ Double) => Unit = null,
