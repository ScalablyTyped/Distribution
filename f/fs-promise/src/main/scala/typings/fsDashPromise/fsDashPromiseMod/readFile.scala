...
object readFile extends js.Object {
  ...
  def apply(file: String, options: String): js.Promise[String] = js.native
  def apply(
    file: String,
    options: String,
  ...
  def apply(file: String, options: Anon_Buffer): js.Promise[Buffer] = js.native
  def apply(
    file: String,
    options: Anon_Buffer,
    callback: js.Function2[/* err */ ErrnoException, /* data */ Buffer, Unit]
  ): Unit = js.native
  def apply(file: String, options: Anon_EncodingFlagString): js.Promise[String] = js.native
  def apply(
    file: String,
  ...
  def apply(file: Double, options: Anon_Buffer): js.Promise[Buffer] = js.native
  def apply(
    file: Double,
    options: Anon_Buffer,
    callback: js.Function2[/* err */ ErrnoException, /* data */ Buffer, Unit]
  ): Unit = js.native
  def apply(file: Double, options: Anon_EncodingFlagString): js.Promise[String] = js.native
  def apply(
    file: Double,
    options: Anon_EncodingFlagString,
    callback: js.Function2[/* err */ ErrnoException, /* data */ String, Unit]
  ...
  def apply(file: Buffer, options: String): js.Promise[String] = js.native
  def apply(
    file: Buffer,
    options: String,
    callback: js.Function2[/* err */ ErrnoException, /* data */ String, Unit]
  ...
  def apply(file: Buffer, options: Anon_Buffer): js.Promise[Buffer] = js.native
  def apply(
    file: Buffer,
    options: Anon_Buffer,
    callback: js.Function2[/* err */ ErrnoException, /* data */ Buffer, Unit]
  ): Unit = js.native
  def apply(file: Buffer, options: Anon_EncodingFlagString): js.Promise[String] = js.native
  def apply(
    file: Buffer,
    options: Anon_EncodingFlagString,
    callback: js.Function2[/* err */ ErrnoException, /* data */ String, Unit]
  ...
  def apply(
    path: Double,
    options: typings.node.Anon_EncodingFlagString,
  ...
  /**
    ...
    * If a flag is not provided, it defaults to `'r'`.
    */
  def __promisify__(path: PathLike, options: typings.node.Anon_EncodingFlagString): js.Promise[String] = js.native
}
