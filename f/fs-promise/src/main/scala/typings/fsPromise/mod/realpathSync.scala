...
object realpathSync {
  ...
  @scala.inline
  def apply(path: PathLike, options: typings.node.fsMod.BaseEncodingOptions): String = (^.asInstanceOf[js.Dynamic].apply(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  @scala.inline
  ...
  @scala.inline
  def native(path: PathLike, options: typings.node.fsMod.BaseEncodingOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("native")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  @scala.inline
  ...
  @scala.inline
  def native_Union(path: PathLike, options: typings.node.fsMod.BaseEncodingOptions): String | Buffer = (^.asInstanceOf[js.Dynamic].applyDynamic("native")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String | Buffer]
}
