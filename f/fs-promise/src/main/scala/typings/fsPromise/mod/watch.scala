...
object watch extends js.Object {
  ...
  def apply(filename: PathLike, options: typings.node.anon.Persistent): FSWatcher = js.native
  def apply(
    filename: PathLike,
    options: typings.node.anon.Persistent,
    listener: js.Function2[/* event */ String, Buffer | (/* filename */ String), Unit]
  ): FSWatcher = js.native
  def apply(filename: PathLike, options: typings.node.anon.Recursive): FSWatcher = js.native
  def apply(
    filename: PathLike,
