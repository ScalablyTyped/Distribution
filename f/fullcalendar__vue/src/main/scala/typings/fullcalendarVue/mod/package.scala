...
import typings.fullcalendarCommon.mod.BgEventProps
import typings.fullcalendarCommon.mod.BusinessHoursInput
import typings.fullcalendarCommon.mod.CalendarContext
import typings.fullcalendarCommon.mod.ChunkConfig
import typings.fullcalendarCommon.mod.ChunkContentCallbackArgs
import typings.fullcalendarCommon.mod.ClassNamesGenerator
import typings.fullcalendarCommon.mod.ClassNamesInput
import typings.fullcalendarCommon.mod.ColProps
import typings.fullcalendarCommon.mod.ContentHookProps
import typings.fullcalendarCommon.mod.DateFormatter
import typings.fullcalendarCommon.mod.DateInput
import typings.fullcalendarCommon.mod.DateMarker
import typings.fullcalendarCommon.mod.DateMeta
...
import typings.fullcalendarCommon.mod.DragMeta
import typings.fullcalendarCommon.mod.DragMetaInput
import typings.fullcalendarCommon.mod.Duration
import typings.fullcalendarCommon.mod.DurationInput
import typings.fullcalendarCommon.mod.EdgeInfo
import typings.fullcalendarCommon.mod.EqualityFuncs
import typings.fullcalendarCommon.mod.EventContentArg
import typings.fullcalendarCommon.mod.EventDef
import typings.fullcalendarCommon.mod.EventInput
import typings.fullcalendarCommon.mod.EventInstance
import typings.fullcalendarCommon.mod.EventInteractionState
import typings.fullcalendarCommon.mod.EventMutation
import typings.fullcalendarCommon.mod.EventRefined
import typings.fullcalendarCommon.mod.EventRenderRange
import typings.fullcalendarCommon.mod.EventStore
import typings.fullcalendarCommon.mod.EventTuple
import typings.fullcalendarCommon.mod.EventUi
import typings.fullcalendarCommon.mod.EventUiHash
import typings.fullcalendarCommon.mod.EventUiRefined
import typings.fullcalendarCommon.mod.FieldSpecInput
import typings.fullcalendarCommon.mod.FormatDateOptions
import typings.fullcalendarCommon.mod.FormatRangeOptions
import typings.fullcalendarCommon.mod.FormatterInput
import typings.fullcalendarCommon.mod.GenericRefiners
import typings.fullcalendarCommon.mod.InteractionSettings
import typings.fullcalendarCommon.mod.InteractionSettingsStore_
import typings.fullcalendarCommon.mod.LocaleInput
import typings.fullcalendarCommon.mod.MemoiseArrayFunc
import typings.fullcalendarCommon.mod.MemoizeHashFunc
import typings.fullcalendarCommon.mod.NowIndicatorRootProps
import typings.fullcalendarCommon.mod.OpenDateRange
import typings.fullcalendarCommon.mod.OrderSpec
import typings.fullcalendarCommon.mod.PluginDef
import typings.fullcalendarCommon.mod.PluginDefInput
import typings.fullcalendarCommon.mod.Point
import typings.fullcalendarCommon.mod.PointerDragEvent
import typings.fullcalendarCommon.mod.RawOptionsFromRefiners
import typings.fullcalendarCommon.mod.Rect
import typings.fullcalendarCommon.mod.ScrollbarWidths
import typings.fullcalendarCommon.mod.SectionConfig
import typings.fullcalendarCommon.mod.Seg
import typings.fullcalendarCommon.mod.SegEntry
import typings.fullcalendarCommon.mod.SegEntryGroup
import typings.fullcalendarCommon.mod.SegSpan
import typings.fullcalendarCommon.mod.SplittableProps
import typings.fullcalendarCommon.mod.ViewContext
import typings.fullcalendarCommon.mod.WeekNumberRootProps
import typings.fullcalendarVue.fullcalendarVueBooleans.`false`
import typings.fullcalendarVue.mod.^
...
inline def buildEventApis(eventStore: EventStore, context: CalendarContext): js.Array[typings.fullcalendarCommon.mod.EventApi] = (^.asInstanceOf[js.Dynamic].applyDynamic("buildEventApis")(eventStore.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.fullcalendarCommon.mod.EventApi]]
inline def buildEventApis(eventStore: EventStore, context: CalendarContext, excludeInstance: EventInstance): js.Array[typings.fullcalendarCommon.mod.EventApi] = (^.asInstanceOf[js.Dynamic].applyDynamic("buildEventApis")(eventStore.asInstanceOf[js.Any], context.asInstanceOf[js.Any], excludeInstance.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.fullcalendarCommon.mod.EventApi]]
...
inline def diffDates(date0: DateMarker, date1: DateMarker, dateEnv: typings.fullcalendarCommon.mod.DateEnv): Duration = (^.asInstanceOf[js.Dynamic].applyDynamic("diffDates")(date0.asInstanceOf[js.Any], date1.asInstanceOf[js.Any], dateEnv.asInstanceOf[js.Any])).asInstanceOf[Duration]
...
inline def getDayClassNames(meta: DateMeta, theme: typings.fullcalendarCommon.mod.Theme): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getDayClassNames")(meta.asInstanceOf[js.Any], theme.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
...
inline def getSlotClassNames(meta: DateMeta, theme: typings.fullcalendarCommon.mod.Theme): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getSlotClassNames")(meta.asInstanceOf[js.Any], theme.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
...
inline def sortEventSegs(segs: Any, eventOrderSpecs: js.Array[OrderSpec[typings.fullcalendarCommon.mod.EventApi]]): js.Array[Seg] = (^.asInstanceOf[js.Dynamic].applyDynamic("sortEventSegs")(segs.asInstanceOf[js.Any], eventOrderSpecs.asInstanceOf[js.Any])).asInstanceOf[js.Array[Seg]]
