...
import typings.fastEquals.distMinTypesInternalTypesMod.PrimitiveWrapper
import typings.fastEquals.distMinTypesInternalTypesMod.State
import typings.fastEquals.distMinTypesInternalTypesMod.TypedArray
...
object distMinTypesEqualsMod {
  
  @JSImport("fast-equals/dist/min/types/equals", JSImport.Namespace)
  @js.native
