...
import typings.fastEquals.anon.Cache
import typings.fastEquals.distCjsTypesInternalTypesMod.ComparatorConfig
import typings.fastEquals.distCjsTypesInternalTypesMod.CreateState
import typings.fastEquals.distCjsTypesInternalTypesMod.CustomEqualCreatorOptions
import typings.fastEquals.distCjsTypesInternalTypesMod.EqualityComparator
import typings.fastEquals.distCjsTypesInternalTypesMod.InternalEqualityComparator
import typings.fastEquals.distCjsTypesInternalTypesMod.State
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distCjsTypesComparatorMod {
  
  @JSImport("fast-equals/dist/cjs/types/comparator", JSImport.Namespace)
  @js.native
  ...
  object CreateIsEqualOptions {
    ...
    implicit open class MutableBuilder[Self <: CreateIsEqualOptions[?], Meta] (val x: Self & CreateIsEqualOptions[Meta]) extends AnyVal {
      ...
      inline def setCreateState(value: () => Cache[Meta]): Self = StObject.set(x, "createState", js.Any.fromFunction0(value))
