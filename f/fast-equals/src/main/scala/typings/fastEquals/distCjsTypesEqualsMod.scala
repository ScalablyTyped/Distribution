...
import typings.fastEquals.distCjsTypesInternalTypesMod.PrimitiveWrapper
import typings.fastEquals.distCjsTypesInternalTypesMod.State
import typings.fastEquals.distCjsTypesInternalTypesMod.TypedArray
...
object distCjsTypesEqualsMod {
  
  @JSImport("fast-equals/dist/cjs/types/equals", JSImport.Namespace)
  @js.native
