...
object mod {
  ...
  inline def createCustomEqual[Meta](
    options: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CustomEqualCreatorOptions<Meta> */ Any
  ): js.Function2[/* a */ Any, /* b */ Any, Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("createCustomEqual")(options.asInstanceOf[js.Any]).asInstanceOf[js.Function2[/* a */ Any, /* b */ Any, Boolean]]
