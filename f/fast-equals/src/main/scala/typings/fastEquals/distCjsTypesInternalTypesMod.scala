...
object distCjsTypesInternalTypesMod {
  ...
  type CreateState[Meta] = js.Function0[typings.fastEquals.anon.Cache[Meta]]
  ...
  object CustomEqualCreatorOptions {
    ...
    implicit open class MutableBuilder[Self <: CustomEqualCreatorOptions[?], Meta] (val x: Self & CustomEqualCreatorOptions[Meta]) extends AnyVal {
      ...
      inline def setCreateState(value: () => typings.fastEquals.anon.Cache[Meta]): Self = StObject.set(x, "createState", js.Any.fromFunction0(value))
