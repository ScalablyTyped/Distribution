...
- Dropped {[ P in 'style' | 'numeric' ]: @formatjs/intl-relativetimeformat.@formatjs/intl-relativetimeformat/dist-es6/core.IntlRelativeTimeFormatOptions[P]} */ trait ResolvedIntlRelativeTimeFormatOptions extends js.Object {
  /**
