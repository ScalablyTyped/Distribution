...
import typings.atFormatjsIntlDashRelativetimeformat.libCoreMod.IntlRelativeTimeFormatOptions
...
object libLocalesMod extends js.Object {
  @js.native
  class default ()
    extends typings.atFormatjsIntlDashRelativetimeformat.libCoreMod.default {
