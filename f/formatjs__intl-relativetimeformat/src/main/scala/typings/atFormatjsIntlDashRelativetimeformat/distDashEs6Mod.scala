...
import typings.atFormatjsIntlDashRelativetimeformat.distDashEs6CoreMod.IntlRelativeTimeFormatOptions
...
@JSImport("@formatjs/intl-relativetimeformat/dist-es6", JSImport.Namespace)
@js.native
object distDashEs6Mod extends js.Object {
  @js.native
  class default ()
    extends typings.atFormatjsIntlDashRelativetimeformat.distDashEs6CoreMod.default {
