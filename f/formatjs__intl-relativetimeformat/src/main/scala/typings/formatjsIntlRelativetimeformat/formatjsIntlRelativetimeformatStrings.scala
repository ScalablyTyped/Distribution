...
import typings.formatjsIntlRelativetimeformat.mod.FormattableUnit
import typings.formatjsIntlRelativetimeformat.mod.Unit
import typings.formatjsIntlRelativetimeformat.mod.Units
...
object formatjsIntlRelativetimeformatStrings {
  ...
  sealed trait day
    extends FormattableUnit
       with typings.formatjsIntlRelativetimeformat.typesMod.FormattableUnit
       with Unit
       with typings.formatjsIntlRelativetimeformat.typesMod.Unit
