...
trait Typeofdownloads extends js.Object {
  /**
    ...
    */
  val onChanged: WebExtEvent[js.Function1[/* downloadDelta */ Anon_CanResume, scala.Unit]] = js.native
  /* downloads events */
  ...
  /**
    ...
    */
  def download(options: Anon_Body): js.Promise[js.UndefOr[scala.Double]] = js.native
  /**
