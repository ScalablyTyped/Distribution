...
object tabsNsMembers extends js.Object {
  ...
  val onActiveChanged: js.UndefOr[
    firefoxDashWebextDashBrowserLib.WebExtEvent[
      js.Function2[
        /* tabId */ scala.Double, 
        /* selectInfo */ firefoxDashWebextDashBrowserLib.Anon_WindowIdNumber_956958679, 
        scala.Unit
      ]
    ]
  ] = js.native
  ...
  /**
       ...
       */
  def captureTab(): stdLib.Promise[java.lang.String] = js.native
  /**
       * Captures the visible area of a specified tab. You must have <all_urls> permission to use this method.
       * @param [tabId] The tab to capture. Defaults to the active tab of the current window.
       */
  def captureTab(tabId: scala.Double): stdLib.Promise[java.lang.String] = js.native
  /**
       * Captures the visible area of a specified tab. You must have <all_urls> permission to use this method.
       * @param [tabId] The tab to capture. Defaults to the active tab of the current window.
       */
  ...
  /**
       ...
       */
  def captureVisibleTab(): stdLib.Promise[java.lang.String] = js.native
  /**
       * Captures the visible area of the currently active tab in the specified window. You must have <all_urls>
       * permission to use this method.
       * @param [windowId] The target window. Defaults to the current window.
       */
  def captureVisibleTab(windowId: scala.Double): stdLib.Promise[java.lang.String] = js.native
  /**
       * Captures the visible area of the currently active tab in the specified window. You must have <all_urls>
       * permission to use this method.
       * @param [windowId] The target window. Defaults to the current window.
  ...
  /** Creates a new tab. */
  def create(createProperties: firefoxDashWebextDashBrowserLib.Anon_Discarded): stdLib.Promise[js.UndefOr[Tab]] = js.native
  /**
       * Detects the primary language of the content in a tab.
       * @param [tabId] Defaults to the active tab of the current window.
       */
  def detectLanguage(): stdLib.Promise[java.lang.String] = js.native
  /**
       * Detects the primary language of the content in a tab.
       * @param [tabId] Defaults to the active tab of the current window.
       */
  def detectLanguage(tabId: scala.Double): stdLib.Promise[java.lang.String] = js.native
  /**
       * discards one or more tabs.
       * @param tabIds The tab or list of tabs to discard.
       */
  def discard(tabIds: js.Array[scala.Double]): stdLib.Promise[scala.Unit] = js.native
  /**
       * discards one or more tabs.
       * @param tabIds The tab or list of tabs to discard.
       */
  def discard(tabIds: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       * Duplicates a tab.
       * @param tabId The ID of the tab which is to be duplicated.
       */
  def duplicate(tabId: scala.Double): stdLib.Promise[js.UndefOr[Tab]] = js.native
  /**
       * Injects JavaScript code into a page. For details, see the programmatic injection section of the content scripts
       * doc.
       * @param details Details of the script to run.
       */
  def executeScript(details: firefoxDashWebextDashBrowserLib.browserNs.extensionTypesNs.InjectDetails): stdLib.Promise[js.UndefOr[js.Array[_]]] = js.native
  /**
       * Injects JavaScript code into a page. For details, see the programmatic injection section of the content scripts
       * doc.
  ...
  ): stdLib.Promise[js.UndefOr[js.Array[_]]] = js.native
  /* tabs functions */
  /** Retrieves details about the specified tab. */
  def get(tabId: scala.Double): stdLib.Promise[Tab] = js.native
  /**
       * Gets details about all tabs in the specified window.
       * @param [windowId] Defaults to the current window.
       * @deprecated Please use `tabs.query` `{windowId: windowId}`.
       */
  def getAllInWindow(): stdLib.Promise[js.Array[Tab]] = js.native
  /**
       * Gets details about all tabs in the specified window.
       * @param [windowId] Defaults to the current window.
       * @deprecated Please use `tabs.query` `{windowId: windowId}`.
       */
  def getAllInWindow(windowId: scala.Double): stdLib.Promise[js.Array[Tab]] = js.native
  /**
       ...
       */
  def getCurrent(): stdLib.Promise[Tab] = js.native
  /**
       * Gets the tab that is selected in the specified window.
       * @param [windowId] Defaults to the current window.
       * @deprecated Please use `tabs.query` `{active: true}`.
       */
  def getSelected(): stdLib.Promise[Tab] = js.native
  /**
       * Gets the tab that is selected in the specified window.
       * @param [windowId] Defaults to the current window.
       * @deprecated Please use `tabs.query` `{active: true}`.
       */
  def getSelected(windowId: scala.Double): stdLib.Promise[Tab] = js.native
  /**
       * Gets the current zoom factor of a specified tab.
       * @param [tabId] The ID of the tab to get the current zoom factor from; defaults to the active tab of the current
       *     window.
       */
  def getZoom(): stdLib.Promise[scala.Double] = js.native
  /**
       * Gets the current zoom factor of a specified tab.
       * @param [tabId] The ID of the tab to get the current zoom factor from; defaults to the active tab of the current
       *     window.
       */
  def getZoom(tabId: scala.Double): stdLib.Promise[scala.Double] = js.native
  /**
       * Gets the current zoom settings of a specified tab.
       * @param [tabId] The ID of the tab to get the current zoom settings from; defaults to the active tab of the
       *     current window.
       */
  def getZoomSettings(): stdLib.Promise[ZoomSettings] = js.native
  /**
       * Gets the current zoom settings of a specified tab.
       * @param [tabId] The ID of the tab to get the current zoom settings from; defaults to the active tab of the
       *     current window.
       */
  def getZoomSettings(tabId: scala.Double): stdLib.Promise[ZoomSettings] = js.native
  /**
       ...
       */
  def hide(tabIds: js.Array[scala.Double]): stdLib.Promise[js.Array[scala.Double]] = js.native
  /**
       * Hides one or more tabs. The `"tabHide"` permission is required to hide tabs. Not all tabs are hidable. Returns
       * an array of hidden tabs.
       * @param tabIds The TAB ID or list of TAB IDs to hide.
  ...
  /**
       ...
       */
  def insertCSS(details: firefoxDashWebextDashBrowserLib.browserNs.extensionTypesNs.InjectDetails): stdLib.Promise[scala.Unit] = js.native
  /**
       * Injects CSS into a page. For details, see the programmatic injection section of the content scripts doc.
  ...
  /**
       ...
       */
  def move(tabIds: js.Array[scala.Double], moveProperties: firefoxDashWebextDashBrowserLib.Anon_WindowIdIndex): stdLib.Promise[js.UndefOr[Tab | js.Array[Tab]]] = js.native
  /**
       * Moves one or more tabs to a new position within its window, or to a new window. Note that tabs can only be moved
       * to and from normal (window.type === "normal") windows.
       * @param tabIds The tab or list of tabs to move.
       */
  def move(tabIds: scala.Double, moveProperties: firefoxDashWebextDashBrowserLib.Anon_WindowIdIndex): stdLib.Promise[js.UndefOr[Tab | js.Array[Tab]]] = js.native
  /** Prints page in active tab. */
  def print(): scala.Unit = js.native
  /** Shows print preview for page in active tab. */
  def printPreview(): stdLib.Promise[scala.Unit] = js.native
  /** Gets all tabs that have the specified properties, or all tabs if no properties are specified. */
  def query(queryInfo: firefoxDashWebextDashBrowserLib.Anon_DiscardedCurrentWindow): stdLib.Promise[js.Array[Tab]] = js.native
  /**
       * Reload a tab.
  ...
  /**
       ...
       * @param [tabId] The ID of the tab to reload; defaults to the selected tab of the current window.
       */
  def reload(tabId: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       * Reload a tab.
       * @param [tabId] The ID of the tab to reload; defaults to the selected tab of the current window.
       */
  def reload(tabId: scala.Double, reloadProperties: firefoxDashWebextDashBrowserLib.Anon_BypassCache): stdLib.Promise[scala.Unit] = js.native
  /**
       * Closes one or more tabs.
       * @param tabIds The tab or list of tabs to close.
       */
  def remove(tabIds: js.Array[scala.Double]): stdLib.Promise[scala.Unit] = js.native
  /**
       * Closes one or more tabs.
       * @param tabIds The tab or list of tabs to close.
       */
  def remove(tabIds: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       ...
       */
  def removeCSS(details: firefoxDashWebextDashBrowserLib.browserNs.extensionTypesNs.InjectDetails): stdLib.Promise[scala.Unit] = js.native
  /**
  ...
  /**
       ...
       */
  def saveAsPDF(pageSettings: PageSettings): stdLib.Promise[js.UndefOr[java.lang.String]] = js.native
  /**
       ...
       */
  def sendMessage(tabId: scala.Double, message: js.Any): stdLib.Promise[_] = js.native
  /**
       * Sends a single message to the content script(s) in the specified tab, with an optional callback to run when a
       * response is sent back. The `runtime.onMessage` event is fired in each content script running in the specified
       * tab for the current extension.
       */
  def sendMessage(tabId: scala.Double, message: js.Any, options: firefoxDashWebextDashBrowserLib.Anon_FrameId): stdLib.Promise[_] = js.native
  /**
  ...
  /**
       ...
       */
  def setZoom(tabId: scala.Double, zoomFactor: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       * Zooms a specified tab.
       * @param zoomFactor The new zoom factor. Use a value of 0 here to set the tab to its current default zoom factor.
       *     Values greater than zero specify a (possibly non-default) zoom factor for the tab.
       */
  def setZoom(zoomFactor: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       ...
       */
  def setZoomSettings(tabId: scala.Double, zoomSettings: ZoomSettings): stdLib.Promise[scala.Unit] = js.native
  /**
       * Sets the zoom settings for a specified tab, which define how zoom changes are handled. These settings are reset
       * to defaults upon navigating the tab.
       * @param zoomSettings Defines how zoom changes are handled and at what scope.
       */
  def setZoomSettings(zoomSettings: ZoomSettings): stdLib.Promise[scala.Unit] = js.native
  /**
       * Shows one or more tabs.
       * @param tabIds The TAB ID or list of TAB IDs to show.
       */
  def show(tabIds: js.Array[scala.Double]): stdLib.Promise[scala.Unit] = js.native
  /**
       * Shows one or more tabs.
       * @param tabIds The TAB ID or list of TAB IDs to show.
       */
  def show(tabIds: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       * Toggles reader mode for the document in the tab.
       * @param [tabId] Defaults to the active tab of the current window.
       */
  def toggleReaderMode(): stdLib.Promise[scala.Unit] = js.native
  /**
       * Toggles reader mode for the document in the tab.
       * @param [tabId] Defaults to the active tab of the current window.
       */
  def toggleReaderMode(tabId: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       * Modifies the properties of a tab. Properties that are not specified in `updateProperties` are not modified.
       * @param tabId Defaults to the selected tab of the current window.
       */
  def update(tabId: scala.Double, updateProperties: firefoxDashWebextDashBrowserLib.Anon_UrlSelected): stdLib.Promise[js.UndefOr[Tab]] = js.native
  /**
       * Modifies the properties of a tab. Properties that are not specified in `updateProperties` are not modified.
       */
  def update(updateProperties: firefoxDashWebextDashBrowserLib.Anon_UrlSelected): stdLib.Promise[js.UndefOr[Tab]] = js.native
}
