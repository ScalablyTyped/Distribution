...
object historyNsMembers extends js.Object {
  ...
  val onTitleChanged: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function1[/* changed */ firefoxDashWebextDashBrowserLib.Anon_TitleUrlString, scala.Unit]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  def addUrl(details: firefoxDashWebextDashBrowserLib.Anon_TitleTransition): js.Promise[scala.Unit] = js.native
  ...
  /**
    ...
    */
  def deleteRange(range: firefoxDashWebextDashBrowserLib.Anon_EndTimeStartTime): js.Promise[scala.Unit] = js.native
  ...
  def search(query: firefoxDashWebextDashBrowserLib.Anon_EndTime): js.Promise[js.Array[HistoryItem]] = js.native
}
