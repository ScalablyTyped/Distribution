package typings
package firefoxDashWebextDashBrowserLib.browserNs.privacyNs.networkNs
...
object networkNsMembers extends js.Object {
  ...
  /**
       ...
       */
  val networkPredictionEnabled: firefoxDashWebextDashBrowserLib.browserNs.typesNs.Setting = js.native
  /** Allow users to enable and disable RTCPeerConnections (aka WebRTC). */
  val peerConnectionEnabled: firefoxDashWebextDashBrowserLib.browserNs.typesNs.Setting = js.native
  /**
       ...
       */
  val webRTCIPHandlingPolicy: firefoxDashWebextDashBrowserLib.browserNs.typesNs.Setting = js.native
}
