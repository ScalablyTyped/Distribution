...
object ^ extends js.Object {
  ...
  def getPanel(details: firefoxDashWebextDashBrowserLib.Anon_TabIdWindowId): js.Promise[java.lang.String] = js.native
  /** Gets the title of the sidebar action. */
  def getTitle(details: firefoxDashWebextDashBrowserLib.Anon_TabIdWindowId): js.Promise[java.lang.String] = js.native
  /** Checks whether the sidebar action is open. */
  def isOpen(details: firefoxDashWebextDashBrowserLib.Anon_WindowId): js.Promise[scala.Boolean] = js.native
  ...
  /**
    ...
    */
  def setPanel(details: firefoxDashWebextDashBrowserLib.Anon_Panel): js.Promise[scala.Unit] = js.native
