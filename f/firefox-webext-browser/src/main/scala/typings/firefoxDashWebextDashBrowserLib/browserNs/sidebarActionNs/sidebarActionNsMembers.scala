...
object sidebarActionNsMembers extends js.Object {
  ...
  def getPanel(details: firefoxDashWebextDashBrowserLib.Anon_WindowIdTabId): stdLib.Promise[java.lang.String] = js.native
  /** Gets the title of the sidebar action. */
  def getTitle(details: firefoxDashWebextDashBrowserLib.Anon_WindowIdTabId): stdLib.Promise[java.lang.String] = js.native
  /** Checks whether the sidebar action is open. */
  def isOpen(details: firefoxDashWebextDashBrowserLib.Anon_WindowIdNumber): stdLib.Promise[scala.Boolean] = js.native
  ...
  /**
       ...
       */
  def setIcon(details: firefoxDashWebextDashBrowserLib.Anon_WindowIdImageData): stdLib.Promise[scala.Unit] = js.native
  /**
       * Sets the url to the html document to be opened in the sidebar when the user clicks on the sidebar action's icon.
       */
  def setPanel(details: firefoxDashWebextDashBrowserLib.Anon_WindowIdPanel): stdLib.Promise[scala.Unit] = js.native
