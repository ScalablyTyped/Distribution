...
@js.native
object downloadsNsMembers extends js.Object {
  /**
  ...
  /**
       ...
       */
  val onErased: firefoxDashWebextDashBrowserLib.WebExtEvent[js.Function1[/* downloadId */ scala.Double, scala.Unit]] = js.native
  /**
       * Prompt the user to either accept or cancel a dangerous download. `acceptDanger()` does not automatically accept
       * dangerous downloads.
       * @deprecated Unsupported on Firefox at this time.
       */
  def acceptDanger(downloadId: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       * Cancel a download. When `callback` is run, the download is cancelled, completed, interrupted or doesn't exist
       * anymore.
       * @param downloadId The id of the download to cancel.
       */
  def cancel(downloadId: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /* downloads functions */
  /**
       ...
       */
  def download(options: firefoxDashWebextDashBrowserLib.Anon_MethodBody): stdLib.Promise[js.UndefOr[scala.Double]] = js.native
  /**
  ...
  def erase(query: DownloadQuery): stdLib.Promise[js.UndefOr[js.Array[scala.Double]]] = js.native
  /**
       ...
       */
  def getFileIcon(downloadId: scala.Double): stdLib.Promise[java.lang.String] = js.native
  /**
       * Retrieve an icon for the specified download. For new downloads, file icons are available after the onCreated
       * event has been received. The image returned by this function while a download is in progress may be different
       * from the image returned after the download is complete. Icon retrieval is done by querying the underlying
       ...
       * @param downloadId The identifier for the download.
       */
  def getFileIcon(downloadId: scala.Double, options: firefoxDashWebextDashBrowserLib.Anon_Size): stdLib.Promise[java.lang.String] = js.native
  /** Open the downloaded file. */
  def open(downloadId: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       ...
       */
  def pause(downloadId: scala.Double): stdLib.Promise[scala.Unit] = js.native
  def removeFile(downloadId: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       * Resume a paused download. If the request was successful the download is in progress and unpaused. Otherwise
       * browser.extension.lastError contains an error message. The request will fail if the download is not active.
       * @param downloadId The id of the download to resume.
       */
  def resume(downloadId: scala.Double): stdLib.Promise[scala.Unit] = js.native
  /**
       ...
       */
  def search(query: DownloadQuery): stdLib.Promise[js.Array[DownloadItem]] = js.native
  /** @deprecated Unsupported on Firefox at this time. */
  def setShelfEnabled(enabled: scala.Boolean): scala.Unit = js.native
  /** Show the downloaded file in its folder in a file manager. */
  def show(downloadId: scala.Double): stdLib.Promise[js.UndefOr[scala.Boolean]] = js.native
