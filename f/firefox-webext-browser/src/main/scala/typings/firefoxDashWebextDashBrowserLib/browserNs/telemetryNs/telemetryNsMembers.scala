...
@js.native
object telemetryNsMembers extends js.Object {
  /** Checks if Telemetry is enabled. */
  def canUpload(): stdLib.Promise[_] = js.native
  /**
       ...
       */
  def recordEvent(category: java.lang.String, method: java.lang.String, `object`: java.lang.String): stdLib.Promise[_] = js.native
  /**
       * Record an event in Telemetry. Throws when trying to record an unknown event.
       * @param category The category name.
       * @param method The method name.
  ...
  /**
       ...
       */
  def registerEvents(category: java.lang.String, data: EventData): stdLib.Promise[_] = js.native
  /**
       ...
       */
  def registerScalars(category: java.lang.String, data: ScalarData): stdLib.Promise[_] = js.native
  /**
       * Adds the value to the given scalar.
       * @param name The scalar name.
       * @param value The numeric value to add to the scalar. Only unsigned integers supported.
       */
  def scalarAdd(name: java.lang.String, value: scala.Double): stdLib.Promise[_] = js.native
  /**
       ...
       */
  def scalarSet(name: java.lang.String, value: java.lang.String): stdLib.Promise[_] = js.native
  /**
       * Sets the named scalar to the given value. Throws if the value type doesn't match the scalar type.
       * @param name The scalar name
       * @param value The value to set the scalar to
       */
  def scalarSet(name: java.lang.String, value: js.Object): stdLib.Promise[_] = js.native
  /**
       * Sets the named scalar to the given value. Throws if the value type doesn't match the scalar type.
       * @param name The scalar name
       * @param value The value to set the scalar to
       */
  def scalarSet(name: java.lang.String, value: scala.Boolean): stdLib.Promise[_] = js.native
  /**
       * Sets the named scalar to the given value. Throws if the value type doesn't match the scalar type.
       * @param name The scalar name
       * @param value The value to set the scalar to
       */
  def scalarSet(name: java.lang.String, value: scala.Double): stdLib.Promise[_] = js.native
  /**
       * Sets the scalar to the maximum of the current and the passed value
       * @param name The scalar name.
       * @param value The numeric value to set the scalar to. Only unsigned integers supported.
       */
  def scalarSetMaximum(name: java.lang.String, value: scala.Double): stdLib.Promise[_] = js.native
  /**
       ...
       */
  def setEventRecordingEnabled(category: java.lang.String, enabled: scala.Boolean): stdLib.Promise[_] = js.native
  /* telemetry functions */
  /**
