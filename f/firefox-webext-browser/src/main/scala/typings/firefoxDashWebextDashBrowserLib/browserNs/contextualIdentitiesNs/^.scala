...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def create(details: firefoxDashWebextDashBrowserLib.Anon_Color): js.Promise[
  ...
  /**
    ...
    */
  def query(details: firefoxDashWebextDashBrowserLib.Anon_Name): js.Promise[
    js.Array[
      firefoxDashWebextDashBrowserLib.browserNs.contextualIdentitiesNs.ContextualIdentity
    ]
  ] = js.native
  ...
  /**
    ...
    * @param details Details about the contextual identity being created.
    */
  def update(cookieStoreId: java.lang.String, details: firefoxDashWebextDashBrowserLib.Anon_ColorIcon): js.Promise[
    firefoxDashWebextDashBrowserLib.browserNs.contextualIdentitiesNs.ContextualIdentity
  ] = js.native
}
