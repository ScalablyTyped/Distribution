...
object ^ extends js.Object {
  ...
  def get(options: firefoxDashWebextDashBrowserLib.Anon_IncludeBlocked): js.Promise[js.Array[firefoxDashWebextDashBrowserLib.browserNs.topSitesNs.MostVisitedURL]] = js.native
}
