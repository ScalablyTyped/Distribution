...
trait UrlFilter extends js.Object {
  ...
  /**
    ...
    */
  var ports: js.UndefOr[js.Array[scala.Double | (js.Tuple2[scala.Double, scala.Double])]] = js.undefined
...
object UrlFilter {
  ...
  def apply(
    ...
    ports: js.Array[scala.Double | (js.Tuple2[scala.Double, scala.Double])] = null,
