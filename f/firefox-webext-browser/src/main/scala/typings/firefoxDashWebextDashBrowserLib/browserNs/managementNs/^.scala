...
object ^ extends js.Object {
  ...
  val onDisabled: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function1[
  ...
  val onEnabled: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function1[
      /* info */ firefoxDashWebextDashBrowserLib.browserNs.managementNs.ExtensionInfo, 
      scala.Unit
    ]
  ...
  val onUninstalled: firefoxDashWebextDashBrowserLib.WebExtEvent[
    js.Function1[
      /* info */ firefoxDashWebextDashBrowserLib.browserNs.managementNs.ExtensionInfo, 
      scala.Unit
    ]
