...
/* Rewritten from type alias, can be one of: 
  - firefoxDashWebextDashBrowserLib.firefoxDashWebextDashBrowserLibStrings.user
  - firefoxDashWebextDashBrowserLib.firefoxDashWebextDashBrowserLibStrings.author
*/
