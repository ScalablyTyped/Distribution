...
object sessionsNsMembers extends js.Object {
  ...
  /**
       ...
       */
  def forgetClosedTab(windowId: scala.Double, sessionId: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  /**
       * Forget a recently closed window.
       * @param sessionId The sessionId (closedId) of the recently closed window to be forgotten.
       */
  def forgetClosedWindow(sessionId: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  /**
       * Retrieves all devices with synced sessions.
       * @deprecated Unsupported on Firefox at this time.
       */
  def getDevices(): stdLib.Promise[js.Array[Device]] = js.native
  /**
       * Retrieves all devices with synced sessions.
       * @deprecated Unsupported on Firefox at this time.
       */
  def getDevices(filter: Filter): stdLib.Promise[js.Array[Device]] = js.native
  /** Gets the list of recently closed tabs and/or windows. */
  def getRecentlyClosed(callback: js.Function1[/* sessions */ js.Array[Session], scala.Unit]): stdLib.Promise[js.Array[Session]] = js.native
  /** Gets the list of recently closed tabs and/or windows. */
  def getRecentlyClosed(filter: Filter, callback: js.Function1[/* sessions */ js.Array[Session], scala.Unit]): stdLib.Promise[js.Array[Session]] = js.native
  /**
       ...
       */
  def getTabValue(tabId: scala.Double, key: java.lang.String): stdLib.Promise[js.UndefOr[java.lang.String | js.Object]] = js.native
  /**
       ...
       * @param key The key which corresponds to the value.
       */
  def getWindowValue(windowId: scala.Double, key: java.lang.String): stdLib.Promise[js.UndefOr[java.lang.String | js.Object]] = js.native
  /**
       * Remove a key/value pair that was set on a given tab.
       * @param tabId The id of the tab whose key/value pair is being removed.
       * @param key The key which corresponds to the value.
       */
  def removeTabValue(tabId: scala.Double, key: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  /**
       ...
       * @param key The key which corresponds to the value.
       */
  def removeWindowValue(windowId: scala.Double, key: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  /**
       ...
       */
  def restore(): stdLib.Promise[Session] = js.native
  /**
       * Reopens a `windows.Window` or `tabs.Tab`, with an optional callback to run when the entry has been restored.
       * @param [sessionId] The `windows.Window.sessionId`, or `tabs.Tab.sessionId` to restore. If this parameter is not
       *     specified, the most recently closed session is restored.
       */
  def restore(sessionId: java.lang.String): stdLib.Promise[Session] = js.native
  /**
       * Reopens a `windows.Window` or `tabs.Tab`, with an optional callback to run when the entry has been restored.
       * @param [sessionId] The `windows.Window.sessionId`, or `tabs.Tab.sessionId` to restore. If this parameter is not
       *     specified, the most recently closed session is restored.
       */
  def restore(sessionId: java.lang.String, callback: js.Function1[/* restoredSession */ Session, scala.Unit]): stdLib.Promise[Session] = js.native
  /**
       ...
       */
  def setTabValue(tabId: scala.Double, key: java.lang.String, value: js.Any): stdLib.Promise[scala.Unit] = js.native
  /**
       ...
       * @param value The value being set.
       */
  def setWindowValue(windowId: scala.Double, key: java.lang.String, value: js.Any): stdLib.Promise[scala.Unit] = js.native
}
