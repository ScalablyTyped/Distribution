...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def get(details: firefoxDashWebextDashBrowserLib.Anon_FirstPartyDomain): js.Promise[Cookie] = js.native
  /**
    ...
    */
  def getAll(details: firefoxDashWebextDashBrowserLib.Anon_Domain): js.Promise[js.Array[Cookie]] = js.native
  ...
  /**
    ...
    */
  def set(details: firefoxDashWebextDashBrowserLib.Anon_DomainExpirationDate): js.Promise[js.UndefOr[Cookie]] = js.native
}
