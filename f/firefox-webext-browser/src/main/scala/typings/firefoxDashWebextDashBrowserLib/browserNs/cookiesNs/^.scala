...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def get(details: firefoxDashWebextDashBrowserLib.Anon_FirstPartyDomain): js.Promise[firefoxDashWebextDashBrowserLib.browserNs.cookiesNs.Cookie] = js.native
  /**
    ...
    */
  def getAll(details: firefoxDashWebextDashBrowserLib.Anon_Domain): js.Promise[js.Array[firefoxDashWebextDashBrowserLib.browserNs.cookiesNs.Cookie]] = js.native
  /** Lists all existing cookie stores. */
  def getAllCookieStores(): js.Promise[js.Array[firefoxDashWebextDashBrowserLib.browserNs.cookiesNs.CookieStore]] = js.native
  /**
    * Deletes a cookie by name.
    * @param details Information to identify the cookie to remove.
    */
  def remove(details: firefoxDashWebextDashBrowserLib.Anon_FirstPartyDomain): js.Promise[js.UndefOr[firefoxDashWebextDashBrowserLib.Anon_FirstPartyDomainName]] = js.native
  /**
    * Sets a cookie with the given cookie data; may overwrite equivalent cookies if they exist.
    * @param details Details about the cookie being set.
    */
  def set(details: firefoxDashWebextDashBrowserLib.Anon_DomainExpirationDate): js.Promise[js.UndefOr[firefoxDashWebextDashBrowserLib.browserNs.cookiesNs.Cookie]] = js.native
}
