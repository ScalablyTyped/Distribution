...
object contextualIdentitiesNsMembers extends js.Object {
  ...
  /**
       ...
       */
  def create(details: firefoxDashWebextDashBrowserLib.Anon_Color): stdLib.Promise[ContextualIdentity] = js.native
  /* contextualIdentities functions */
  /**
       * Retrieves information about a single contextual identity.
       * @param cookieStoreId The ID of the contextual identity cookie store.
       */
  def get(cookieStoreId: java.lang.String): stdLib.Promise[ContextualIdentity] = js.native
  /**
       * Retrieves all contextual identities
       * @param details Information to filter the contextual identities being retrieved.
       */
  def query(details: firefoxDashWebextDashBrowserLib.Anon_Name): stdLib.Promise[js.Array[ContextualIdentity]] = js.native
  /**
       * Deletes a contetual identity by its cookie Store ID.
       * @param cookieStoreId The ID of the contextual identity cookie store.
       */
  def remove(cookieStoreId: java.lang.String): stdLib.Promise[ContextualIdentity] = js.native
  /**
       * Updates a contextual identity with the given data.
       * @param cookieStoreId The ID of the contextual identity cookie store.
       * @param details Details about the contextual identity being created.
       */
  def update(cookieStoreId: java.lang.String, details: firefoxDashWebextDashBrowserLib.Anon_ColorName): stdLib.Promise[ContextualIdentity] = js.native
}
