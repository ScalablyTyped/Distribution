...
trait Anon_Application extends js.Object {
  ...
  /**
    ...
    */
  val onInstalled: WebExtEvent[js.Function1[/* details */ Anon_IdPreviousVersion, scala.Unit]] = js.native
  /**
  ...
  def connect(extensionId: java.lang.String, connectInfo: Anon_IncludeTlsChannelId): firefoxDashWebextDashBrowserLib.browserNs.runtimeNs.Port = js.native
  /**
  ...
  def sendMessage(extensionId: java.lang.String, message: js.Any, options: Anon_IncludeTlsChannelIdToProxyScript): js.Promise[_] = js.native
  /**
    * Sends a single message to event listeners within your extension/app or a different extension/app. Similar to
    * `runtime.connect` but only sends a single message, with an optional response. If sending to your extension, the
    * `runtime.onMessage` event will be fired in each page, or `runtime.onMessageExternal`, if a different extension.
