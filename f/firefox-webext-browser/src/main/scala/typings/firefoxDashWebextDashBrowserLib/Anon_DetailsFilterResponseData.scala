...
@js.native
trait Anon_DetailsFilterResponseData extends js.Object {
  ...
  val onBeforeRedirect: firefoxDashWebextDashBrowserLib.browserNs.webRequestNs._WebRequestOnBeforeRedirectEvent[js.Function1[/* details */ Anon_DocumentUrlFrameIdFromCacheIp, scala.Unit]] = js.native
  /* webRequest events */
  /**
  ...
  val onCompleted: firefoxDashWebextDashBrowserLib.browserNs.webRequestNs._WebRequestOnCompletedEvent[js.Function1[/* details */ Anon_DocumentUrlFrameIdFromCache, scala.Unit]] = js.native
  /** Fired when an error occurs. */
  val onErrorOccurred: firefoxDashWebextDashBrowserLib.browserNs.webRequestNs._WebRequestOnErrorOccurredEvent[js.Function1[/* details */ Anon_DocumentUrlError, scala.Unit]] = js.native
  /**
  ...
  /**
    ...
    */
  val onResponseStarted: firefoxDashWebextDashBrowserLib.browserNs.webRequestNs._WebRequestOnResponseStartedEvent[js.Function1[/* details */ Anon_DocumentUrlFrameIdFromCache, scala.Unit]] = js.native
  /**
    ...
    */
  val onSendHeaders: firefoxDashWebextDashBrowserLib.browserNs.webRequestNs._WebRequestOnSendHeadersEvent[js.Function1[/* details */ Anon_DocumentUrlFrameIdMethod, scala.Unit]] = js.native
  /** ... */
