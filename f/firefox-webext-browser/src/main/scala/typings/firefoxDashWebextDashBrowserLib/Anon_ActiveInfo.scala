...
@js.native
trait Anon_ActiveInfo extends js.Object {
  /* tabs properties */
  ...
  /**
    ...
    */
  val onActivated: WebExtEvent[js.Function1[/* activeInfo */ Anon_PreviousTabId, scala.Unit]] = js.native
  /**
  ...
  val onAttached: WebExtEvent[
    js.Function2[/* tabId */ scala.Double, /* attachInfo */ Anon_NewPosition, scala.Unit]
  ] = js.native
  /* tabs events */
  /**
  ...
  val onDetached: WebExtEvent[
    js.Function2[/* tabId */ scala.Double, /* detachInfo */ Anon_OldPosition, scala.Unit]
  ] = js.native
  /**
    * Fired when the highlighted or selected tabs in a window changes.
    * @deprecated Please use `tabs.onHighlighted`.
    */
  val onHighlightChanged: js.UndefOr[WebExtEvent[js.Function1[/* selectInfo */ Anon_TabIds, scala.Unit]]] = js.native
  /** Fired when the highlighted or selected tabs in a window changes. */
  val onHighlighted: WebExtEvent[js.Function1[/* highlightInfo */ Anon_TabIds, scala.Unit]] = js.native
  /**
  ...
  val onMoved: WebExtEvent[
    js.Function2[/* tabId */ scala.Double, /* moveInfo */ Anon_FromIndex, scala.Unit]
  ] = js.native
  /** Fired when a tab is closed. */
  val onRemoved: WebExtEvent[
    js.Function2[/* tabId */ scala.Double, /* removeInfo */ Anon_IsWindowClosing, scala.Unit]
  ] = js.native
  ...
  val onZoomChange: WebExtEvent[js.Function1[/* ZoomChangeInfo */ Anon_NewZoomFactor, scala.Unit]] = js.native
  /**
  ...
  def connect(tabId: scala.Double, connectInfo: Anon_FrameIdName): firefoxDashWebextDashBrowserLib.browserNs.runtimeNs.Port = js.native
  /** Creates a new tab. */
  def create(createProperties: Anon_Active): js.Promise[js.UndefOr[firefoxDashWebextDashBrowserLib.browserNs.tabsNs.Tab]] = js.native
  /**
  ...
  def highlight(highlightInfo: Anon_Populate): js.Promise[js.UndefOr[firefoxDashWebextDashBrowserLib.browserNs.windowsNs.Window]] = js.native
  /**
  ...
  def move(tabIds: js.Array[scala.Double], moveProperties: Anon_IndexWindowId): js.Promise[
    js.UndefOr[
  ...
  /**
    ...
    */
  def move(tabIds: scala.Double, moveProperties: Anon_IndexWindowId): js.Promise[
    js.UndefOr[
      firefoxDashWebextDashBrowserLib.browserNs.tabsNs.Tab | js.Array[firefoxDashWebextDashBrowserLib.browserNs.tabsNs.Tab]
    ]
  ] = js.native
  ...
  def moveInSuccession(tabIds: js.Array[scala.Double], tabId: scala.Double, options: Anon_Append): js.Promise[_] = js.native
  ...
  def query(queryInfo: Anon_ActiveAttention): js.Promise[js.Array[firefoxDashWebextDashBrowserLib.browserNs.tabsNs.Tab]] = js.native
  /**
    * Reload a tab.
  ...
  def sendMessage(tabId: scala.Double, message: js.Any, options: Anon_FrameIdNumber): js.Promise[_] = js.native
  /**
  ...
  /**
    ...
    */
  def update(tabId: scala.Double, updateProperties: Anon_ActiveHighlighted): js.Promise[js.UndefOr[firefoxDashWebextDashBrowserLib.browserNs.tabsNs.Tab]] = js.native
  /**
    * Modifies the properties of a tab. Properties that are not specified in `updateProperties` are not modified.
    */
  def update(updateProperties: Anon_ActiveHighlighted): js.Promise[js.UndefOr[firefoxDashWebextDashBrowserLib.browserNs.tabsNs.Tab]] = js.native
}
