...
trait _UrlbarOnQueryCanceledEvent[TCallback] extends js.Object {
...
object _UrlbarOnQueryCanceledEvent {
  ...
  def apply[TCallback](
    ...
    __obj.asInstanceOf[_UrlbarOnQueryCanceledEvent[TCallback]]
  }
}
