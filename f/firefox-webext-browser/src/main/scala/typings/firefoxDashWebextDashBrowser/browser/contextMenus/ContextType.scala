...
object ContextType {
  @scala.inline
  def all: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.all = this.cast("all")
  @scala.inline
  def audio: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.audio = this.cast("audio")
  @scala.inline
  def bookmark: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.bookmark = this.cast("bookmark")
  @scala.inline
  def browser_action: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.browser_action = this.cast("browser_action")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def editable: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.editable = this.cast("editable")
  @scala.inline
  def frame: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.frame = this.cast("frame")
  @scala.inline
  def image: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.image = this.cast("image")
  @scala.inline
  def launcher: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.launcher = this.cast("launcher")
  @scala.inline
  def link: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.link = this.cast("link")
  @scala.inline
  def page: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.page = this.cast("page")
  @scala.inline
  def page_action: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.page_action = this.cast("page_action")
  @scala.inline
  def password: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.password = this.cast("password")
  @scala.inline
  def selection: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.selection = this.cast("selection")
  @scala.inline
  def tab: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.tab = this.cast("tab")
  @scala.inline
  def video: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.video = this.cast("video")
}
