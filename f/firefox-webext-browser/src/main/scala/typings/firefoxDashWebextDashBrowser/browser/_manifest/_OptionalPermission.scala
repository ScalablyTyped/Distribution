...
object _OptionalPermission {
  @scala.inline
  def activeTab: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.activeTab = this.cast("activeTab")
  @scala.inline
  def bookmarks: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.bookmarks = this.cast("bookmarks")
  @scala.inline
  def browserSettings: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.browserSettings = this.cast("browserSettings")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def clipboardRead: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.clipboardRead = this.cast("clipboardRead")
  @scala.inline
  def clipboardWrite: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.clipboardWrite = this.cast("clipboardWrite")
  @scala.inline
  def cookies: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.cookies = this.cast("cookies")
  @scala.inline
  def downloads: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.downloads = this.cast("downloads")
  @scala.inline
  def downloadsDotopen: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.downloadsDotopen = this.cast("downloads.open")
  @scala.inline
  def find: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.find = this.cast("find")
  @scala.inline
  def geolocation: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.geolocation = this.cast("geolocation")
  @scala.inline
  ...
  @scala.inline
  def menusDotoverrideContext: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.menusDotoverrideContext = this.cast("menus.overrideContext")
  @scala.inline
  def notifications: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.notifications = this.cast("notifications")
  @scala.inline
  def search: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.search = this.cast("search")
  @scala.inline
  def tabHide: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.tabHide = this.cast("tabHide")
  @scala.inline
  def tabs: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.tabs = this.cast("tabs")
  @scala.inline
  def topSites: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.topSites = this.cast("topSites")
  @scala.inline
  def webNavigation: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.webNavigation = this.cast("webNavigation")
  @scala.inline
  def webRequest: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.webRequest = this.cast("webRequest")
  @scala.inline
  def webRequestBlocking: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.webRequestBlocking = this.cast("webRequestBlocking")
}
