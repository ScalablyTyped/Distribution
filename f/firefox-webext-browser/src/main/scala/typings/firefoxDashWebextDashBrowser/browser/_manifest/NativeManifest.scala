...
object NativeManifest {
  ...
  def Anon_Allowedextensions(
    ...
    name: String,
    path: String,
    `type`: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.pkcs11 | stdio
  ): NativeManifest = {
  ...
  def Anon_DataDescription(
    ...
    description: String,
    name: ExtensionID,
    `type`: typings.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.storage
  ): NativeManifest = {
