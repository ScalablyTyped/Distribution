...
trait TypeofpageAction extends js.Object {
  ...
  def getPopup(details: Anon_TabIdNumber): js.Promise[String]
  /** Gets the title of the page action. */
  def getTitle(details: Anon_TabIdNumber): js.Promise[String]
  /**
  ...
  def isShown(details: Anon_TabIdNumber): js.Promise[Boolean]
  ...
  /**
    ...
    */
  def setIcon(details: Anon_ImageDataKey): js.Promise[Unit]
  /** Sets the html document to be opened as a popup when the user clicks on the page action's icon. */
  def setPopup(details: Anon_PopupTabId): Unit
  /** Sets the title of the page action. This is displayed in a tooltip over the page action. */
  def setTitle(details: Anon_TabIdTitleNull): Unit
...
object TypeofpageAction {
  @scala.inline
  def apply(
    getPopup: Anon_TabIdNumber => js.Promise[String],
    getTitle: Anon_TabIdNumber => js.Promise[String],
    hide: Double => js.Promise[Unit],
    isShown: Anon_TabIdNumber => js.Promise[Boolean],
    onClicked: WebExtEvent[js.Function1[/* tab */ Tab, Unit]],
    openPopup: () => js.Promise[Unit],
    setIcon: Anon_ImageDataKey => js.Promise[Unit],
    setPopup: Anon_PopupTabId => Unit,
    setTitle: Anon_TabIdTitleNull => Unit,
