...
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs.BlockingResponse
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs.SecurityInfo
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnAuthRequiredEvent
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnBeforeRedirectEvent
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnBeforeRequestEvent
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnBeforeSendHeadersEvent
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnCompletedEvent
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnErrorOccurredEvent
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnHeadersReceivedEvent
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnResponseStartedEvent
import typings.firefoxDashWebextDashBrowser.browserNs.webRequestNs._WebRequestOnSendHeadersEvent
