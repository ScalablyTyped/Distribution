...
trait Anon_CookieStoreIdDocumentUrlFrameIdFromCache extends js.Object {
...
object Anon_CookieStoreIdDocumentUrlFrameIdFromCache {
  @scala.inline
  def apply(
    frameId: Double,
    fromCache: Boolean,
  ...
  ): Anon_CookieStoreIdDocumentUrlFrameIdFromCache = {
    ...
    __obj.asInstanceOf[Anon_CookieStoreIdDocumentUrlFrameIdFromCache]
  }
}
