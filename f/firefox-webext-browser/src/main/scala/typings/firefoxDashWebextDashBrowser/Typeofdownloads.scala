...
import typings.firefoxDashWebextDashBrowser.browserNs.downloadsNs.DownloadItem
import typings.firefoxDashWebextDashBrowser.browserNs.downloadsNs.DownloadQuery
