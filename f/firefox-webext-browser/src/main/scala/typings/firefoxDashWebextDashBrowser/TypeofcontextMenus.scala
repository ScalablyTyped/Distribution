...
trait TypeofcontextMenus extends js.Object {
  ...
  /**
    ...
    */
  val onShown: WebExtEvent[js.Function2[/* info */ Anon_Contexts, /* tab */ Tab, Unit]] = js.native
  ...
  /**
    ...
    */
  def create(createProperties: Anon_Checked): Double | String = js.native
  def create(createProperties: Anon_Checked, callback: js.Function0[Unit]): Double | String = js.native
  /**
  ...
  /**
    ...
    */
  def overrideContext(contextOptions: Anon_BookmarkId): Unit = js.native
  /**
  ...
  def update(id: String, updateProperties: Anon_CheckedContexts): js.Promise[Unit] = js.native
  /**
    * Updates a previously created context menu item.
    * @param id The ID of the item to update.
    * @param updateProperties The properties to update. Accepts the same values as the create function.
    */
  def update(id: Double, updateProperties: Anon_CheckedContexts): js.Promise[Unit] = js.native
}
