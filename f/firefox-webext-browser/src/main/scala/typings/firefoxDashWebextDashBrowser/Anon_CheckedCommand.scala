...
import typings.firefoxDashWebextDashBrowser.browser.menus.ContextType
import typings.firefoxDashWebextDashBrowser.browser.menus.ItemType
...
trait Anon_CheckedCommand extends js.Object {
  /**
