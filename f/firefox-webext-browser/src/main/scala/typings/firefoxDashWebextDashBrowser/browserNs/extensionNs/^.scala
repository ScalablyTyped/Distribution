package typings.firefoxDashWebextDashBrowser.browserNs.extensionNs

import typings.firefoxDashWebextDashBrowser.Anon_Message
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  val lastError: js.UndefOr[Anon_Message] = js.native
  /* extension events */
  /**
  ...
  def getViews(fetchProperties: Anon_TabId): js.Array[Window] = js.native
  /**
