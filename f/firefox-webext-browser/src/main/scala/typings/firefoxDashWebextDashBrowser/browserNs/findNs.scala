...
import typings.firefoxDashWebextDashBrowser.Anon_CaseSensitive
import typings.firefoxDashWebextDashBrowser.Anon_Count
import typings.firefoxDashWebextDashBrowser.Anon_NoScroll
...
object findNs extends js.Object {
  ...
  /**
    ...
    */
  def find(queryphrase: String): js.Promise[Anon_Count] = js.native
  def find(queryphrase: String, params: Anon_CaseSensitive): js.Promise[Anon_Count] = js.native
  /**
    * Highlight a range
    * @param [params] highlightResults parameters
    */
  def highlightResults(): Unit = js.native
  def highlightResults(params: Anon_NoScroll): Unit = js.native
  /**
