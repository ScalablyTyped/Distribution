package typings.firefoxDashWebextDashBrowser.browserNs.windowsNs

import typings.firefoxDashWebextDashBrowser.Anon_AllowScriptsToClose
import typings.firefoxDashWebextDashBrowser.Anon_DrawAttention
...
object ^ extends js.Object {
  ...
  val onCreated: WebExtEvent[
    js.Function1[/* window */ typings.firefoxDashWebextDashBrowser.browserNs.windowsNs.Window, Unit]
  ] = js.native
  /**
