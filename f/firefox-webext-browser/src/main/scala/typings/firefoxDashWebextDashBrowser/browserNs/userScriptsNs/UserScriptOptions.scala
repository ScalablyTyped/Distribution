package typings.firefoxDashWebextDashBrowser.browserNs.userScriptsNs

import typings.firefoxDashWebextDashBrowser.browserNs.extensionTypesNs.ExtensionFileOrCode
import typings.firefoxDashWebextDashBrowser.browserNs.extensionTypesNs.PlainJSONValue
