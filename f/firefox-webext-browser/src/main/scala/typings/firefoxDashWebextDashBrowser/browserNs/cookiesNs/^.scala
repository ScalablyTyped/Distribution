...
import typings.firefoxDashWebextDashBrowser.Anon_FirstPartyDomain
import typings.firefoxDashWebextDashBrowser.Anon_FirstPartyDomainName
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  val onChanged: WebExtEvent[js.Function1[/* changeInfo */ Anon_Cause, Unit]] = js.native
  /* cookies functions */
  /**
    ...
    */
  def get(details: Anon_FirstPartyDomain): js.Promise[Cookie] = js.native
  /**
    ...
    */
  def getAll(details: Anon_Domain): js.Promise[js.Array[Cookie]] = js.native
  ...
  /**
    ...
    */
  def remove(details: Anon_FirstPartyDomain): js.Promise[js.UndefOr[Anon_FirstPartyDomainName]] = js.native
  /**
    * Sets a cookie with the given cookie data; may overwrite equivalent cookies if they exist.
    * @param details Details about the cookie being set.
    */
  def set(details: Anon_DomainExpirationDate): js.Promise[js.UndefOr[Cookie]] = js.native
}
