...
import typings.firefoxDashWebextDashBrowser.browser.cookies.CookieStore
...
trait Typeofcookies extends js.Object {
  ...
  /**
    ...
    */
  val onChanged: WebExtEvent[js.Function1[/* changeInfo */ Anon_Cause, Unit]]
  /* cookies functions */
  /**
    ...
    */
  def get(details: Anon_FirstPartyDomain): js.Promise[Cookie]
  /**
    ...
    */
  def getAll(details: Anon_Domain): js.Promise[js.Array[Cookie]]
  ...
  /**
    ...
    */
  def remove(details: Anon_FirstPartyDomain): js.Promise[Anon_FirstPartyDomainName]
  /**
    * Sets a cookie with the given cookie data; may overwrite equivalent cookies if they exist.
    * @param details Details about the cookie being set.
    */
  def set(details: Anon_DomainExpirationDate): js.Promise[Cookie]
}

object Typeofcookies {
  @scala.inline
  def apply(
    get: Anon_FirstPartyDomain => js.Promise[Cookie],
    getAll: Anon_Domain => js.Promise[js.Array[Cookie]],
    getAllCookieStores: () => js.Promise[js.Array[CookieStore]],
    onChanged: WebExtEvent[js.Function1[/* changeInfo */ Anon_Cause, Unit]],
