...
trait TypeofsidebarAction extends js.Object {
  ...
  def getPanel(details: Anon_TabIdWindowId): js.Promise[String]
  /** Gets the title of the sidebar action. */
  def getTitle(details: Anon_TabIdWindowId): js.Promise[String]
  /** Checks whether the sidebar action is open. */
  def isOpen(details: Anon_WindowId): js.Promise[Boolean]
...
object TypeofsidebarAction {
  ...
  def apply(
    ...
    getPanel: Anon_TabIdWindowId => js.Promise[String],
    getTitle: Anon_TabIdWindowId => js.Promise[String],
    isOpen: Anon_WindowId => js.Promise[Boolean],
    open: () => js.Promise[Unit],
    setIcon: Anon_ImageDataKeyPath => js.Promise[Unit],
    setPanel: Anon_Panel => js.Promise[Unit],
    setTitle: Anon_TabIdTitle => js.Promise[Unit]
  ): TypeofsidebarAction = {
