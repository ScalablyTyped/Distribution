...
trait AnonCookieStoreIdDocumentUrl extends js.Object {
  ...
  var requestBody: js.UndefOr[AnonErrorFormData] = js.undefined
  /**
...
object AnonCookieStoreIdDocumentUrl {
  @scala.inline
  def apply(
    frameId: Double,
    method: String,
    ...
    requestBody: AnonErrorFormData = null,
    urlClassification: UrlClassification = null
  ): AnonCookieStoreIdDocumentUrl = {
    ...
    __obj.asInstanceOf[AnonCookieStoreIdDocumentUrl]
  }
}
