...
trait AnonCookieStoreIdDocumentUrlFrameIdFromCacheIncognitoIp extends js.Object {
...
object AnonCookieStoreIdDocumentUrlFrameIdFromCacheIncognitoIp {
  @scala.inline
  def apply(
    frameId: Double,
    fromCache: Boolean,
  ...
  ): AnonCookieStoreIdDocumentUrlFrameIdFromCacheIncognitoIp = {
    ...
    __obj.asInstanceOf[AnonCookieStoreIdDocumentUrlFrameIdFromCacheIncognitoIp]
  }
}
