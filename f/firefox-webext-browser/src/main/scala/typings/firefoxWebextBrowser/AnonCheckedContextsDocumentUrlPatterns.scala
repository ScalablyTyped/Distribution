...
trait AnonCheckedContextsDocumentUrlPatterns extends js.Object {
...
object AnonCheckedContextsDocumentUrlPatterns {
  @scala.inline
  def apply(
  ...
  ): AnonCheckedContextsDocumentUrlPatterns = {
    ...
    __obj.asInstanceOf[AnonCheckedContextsDocumentUrlPatterns]
  }
}
