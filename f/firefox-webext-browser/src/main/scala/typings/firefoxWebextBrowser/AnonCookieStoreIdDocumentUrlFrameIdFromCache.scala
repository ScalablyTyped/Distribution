...
trait AnonCookieStoreIdDocumentUrlFrameIdFromCache extends js.Object {
...
object AnonCookieStoreIdDocumentUrlFrameIdFromCache {
  @scala.inline
  def apply(
    frameId: Double,
    fromCache: Boolean,
  ...
  ): AnonCookieStoreIdDocumentUrlFrameIdFromCache = {
    ...
    __obj.asInstanceOf[AnonCookieStoreIdDocumentUrlFrameIdFromCache]
  }
}
