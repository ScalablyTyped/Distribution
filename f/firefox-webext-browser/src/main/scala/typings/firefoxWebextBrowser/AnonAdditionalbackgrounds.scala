...
trait AnonAdditionalbackgrounds extends js.Object {
...
object AnonAdditionalbackgrounds {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAdditionalbackgrounds]
  }
}
