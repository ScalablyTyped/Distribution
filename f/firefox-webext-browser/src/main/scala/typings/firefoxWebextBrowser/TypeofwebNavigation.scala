...
trait TypeofwebNavigation extends js.Object {
  ...
  val onBeforeNavigate: WebNavigationOnBeforeNavigateEvent[js.Function1[/* details */ AnonFrameIdParentFrameId, Unit]]
  /**
    ...
    */
  val onCommitted: WebNavigationOnCommittedEvent[js.Function1[/* details */ AnonFrameIdProcessId, Unit]]
  /** Fired when a document, including the resources it refers to, is completely loaded and initialized. */
  val onCompleted: WebNavigationOnCompletedEvent[js.Function1[/* details */ AnonFrameIdProcessIdTabId, Unit]]
  ...
  val onDOMContentLoaded: WebNavigationOnDOMContentLoadedEvent[js.Function1[/* details */ AnonFrameIdProcessIdTabId, Unit]]
  /**
  ...
  /**
    ...
    * URL.
    */
  val onHistoryStateUpdated: WebNavigationOnHistoryStateUpdatedEvent[js.Function1[/* details */ AnonFrameIdProcessId, Unit]]
  /**
    * Fired when the reference fragment of a frame was updated. All future events for that frame will use the updated
    * URL.
    */
  val onReferenceFragmentUpdated: WebNavigationOnReferenceFragmentUpdatedEvent[js.Function1[/* details */ AnonFrameIdProcessId, Unit]]
  ...
  /**
    ...
    */
  def getAllFrames(details: AnonTabIdNumber): js.Promise[js.Array[AnonErrorOccurredFrameId]]
...
object TypeofwebNavigation {
  @scala.inline
  def apply(
    getAllFrames: AnonTabIdNumber => js.Promise[js.Array[AnonErrorOccurredFrameId]],
    getFrame: AnonFrameId => js.Promise[AnonErrorOccurred],
    onBeforeNavigate: WebNavigationOnBeforeNavigateEvent[js.Function1[/* details */ AnonFrameIdParentFrameId, Unit]],
    onCommitted: WebNavigationOnCommittedEvent[js.Function1[/* details */ AnonFrameIdProcessId, Unit]],
    onCompleted: WebNavigationOnCompletedEvent[js.Function1[/* details */ AnonFrameIdProcessIdTabId, Unit]],
    onCreatedNavigationTarget: WebNavigationOnCreatedNavigationTargetEvent[js.Function1[/* details */ AnonSourceFrameId, Unit]],
    onDOMContentLoaded: WebNavigationOnDOMContentLoadedEvent[js.Function1[/* details */ AnonFrameIdProcessIdTabId, Unit]],
    onErrorOccurred: WebNavigationOnErrorOccurredEvent[js.Function1[/* details */ AnonError, Unit]],
    onHistoryStateUpdated: WebNavigationOnHistoryStateUpdatedEvent[js.Function1[/* details */ AnonFrameIdProcessId, Unit]],
    onReferenceFragmentUpdated: WebNavigationOnReferenceFragmentUpdatedEvent[js.Function1[/* details */ AnonFrameIdProcessId, Unit]],
