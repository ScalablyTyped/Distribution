...
@js.native
trait FrameUrl extends js.Object {
...
object FrameUrl {
  @scala.inline
  def apply(contexts: js.Array[ContextType], editable: Boolean, menuIds: Double | js.Array[String]): FrameUrl = {
    ...
    __obj.asInstanceOf[FrameUrl]
  }
  @scala.inline
  implicit class FrameUrlOps[Self <: FrameUrl] (val x: Self) extends AnyVal {
    @scala.inline
