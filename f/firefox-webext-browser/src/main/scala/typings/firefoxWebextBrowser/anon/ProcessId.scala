...
@js.native
trait ProcessId extends js.Object {
  /**
...
object ProcessId {
  @scala.inline
  def apply(frameId: Double, parentFrameId: Double, tabId: Double, timeStamp: Double, url: String): ProcessId = {
  ...
  @scala.inline
  implicit class ProcessIdOps[Self <: ProcessId] (val x: Self) extends AnyVal {
    @scala.inline
