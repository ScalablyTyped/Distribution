...
@js.native
trait Challenger extends js.Object {
  /** The server requesting authentication. */
  var challenger: Host = js.native
...
object Challenger {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Challenger]
  }
  @scala.inline
  implicit class ChallengerOps[Self <: Challenger] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setChallenger(value: Host): Self = this.set("challenger", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setResponseHeadersVarargs(value: BinaryValue*): Self = this.set("responseHeaders", js.Array(value :_*))
    @scala.inline
