...
object AllowHttpErrors {
  ...
  def apply(
    url: String,
    allowHttpErrors: js.UndefOr[Boolean] = js.undefined,
    body: String = null,
    ...
    if (!js.isUndefined(allowHttpErrors)) __obj.updateDynamic("allowHttpErrors")(allowHttpErrors.get.asInstanceOf[js.Any])
