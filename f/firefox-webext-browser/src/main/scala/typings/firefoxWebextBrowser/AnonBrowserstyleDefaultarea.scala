...
trait AnonBrowserstyleDefaultarea extends js.Object {
...
object AnonBrowserstyleDefaultarea {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonBrowserstyleDefaultarea]
  }
}
