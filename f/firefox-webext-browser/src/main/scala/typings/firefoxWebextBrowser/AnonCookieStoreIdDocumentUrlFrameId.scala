...
trait AnonCookieStoreIdDocumentUrlFrameId extends js.Object {
...
object AnonCookieStoreIdDocumentUrlFrameId {
  @scala.inline
  def apply(
    frameId: Double,
    method: String,
  ...
  ): AnonCookieStoreIdDocumentUrlFrameId = {
    ...
    __obj.asInstanceOf[AnonCookieStoreIdDocumentUrlFrameId]
  }
}
