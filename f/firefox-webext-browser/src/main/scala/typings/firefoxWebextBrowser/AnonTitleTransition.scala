...
trait AnonTitleTransition extends js.Object {
...
object AnonTitleTransition {
  @scala.inline
  def apply(url: String, title: String = null, transition: TransitionType = null, visitTime: Date = null): AnonTitleTransition = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    if (title != null) __obj.updateDynamic("title")(title.asInstanceOf[js.Any])
    if (transition != null) __obj.updateDynamic("transition")(transition.asInstanceOf[js.Any])
    if (visitTime != null) __obj.updateDynamic("visitTime")(visitTime.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonTitleTransition]
  }
}
