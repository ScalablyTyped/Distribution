...
trait AnonCookieStoreIdDocumentUrlFrameIdFromCacheIncognito extends js.Object {
...
object AnonCookieStoreIdDocumentUrlFrameIdFromCacheIncognito {
  @scala.inline
  def apply(
    frameId: Double,
    fromCache: Boolean,
  ...
  ): AnonCookieStoreIdDocumentUrlFrameIdFromCacheIncognito = {
    ...
    __obj.asInstanceOf[AnonCookieStoreIdDocumentUrlFrameIdFromCacheIncognito]
  }
}
