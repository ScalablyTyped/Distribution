...
@js.native
trait WebExtensionDictionaryManifestBrowserSpecificSettings extends js.Object {
...
object WebExtensionDictionaryManifestBrowserSpecificSettings {
  ...
  @scala.inline
  implicit class WebExtensionDictionaryManifestBrowserSpecificSettingsOps[Self <: WebExtensionDictionaryManifestBrowserSpecificSettings] (val x: Self) extends AnyVal {
