...
@js.native
trait OnHighlightedHighlightInfo extends js.Object {
...
object OnHighlightedHighlightInfo {
  ...
  @scala.inline
  implicit class OnHighlightedHighlightInfoOps[Self <: OnHighlightedHighlightInfo] (val x: Self) extends AnyVal {
