...
trait URLTransform extends StObject {
  ...
  var queryTransform: js.UndefOr[URLTransformQueryTransform] = js.undefined
  
  /** The new scheme for the request. */
  var scheme: js.UndefOr[URLTransformScheme] = js.undefined
...
object URLTransform {
  ...
  implicit open class MutableBuilder[Self <: URLTransform] (val x: Self) extends AnyVal {
    ...
    inline def setQueryTransform(value: URLTransformQueryTransform): Self = StObject.set(x, "queryTransform", value.asInstanceOf[js.Any])
    
    inline def setQueryTransformUndefined: Self = StObject.set(x, "queryTransform", js.undefined)
    
    inline def setQueryUndefined: Self = StObject.set(x, "query", js.undefined)
    
    inline def setScheme(value: URLTransformScheme): Self = StObject.set(x, "scheme", value.asInstanceOf[js.Any])
