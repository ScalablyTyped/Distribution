...
@js.native
trait OnHighlightChangedSelectInfo extends js.Object {
...
object OnHighlightChangedSelectInfo {
  ...
  @scala.inline
  implicit class OnHighlightChangedSelectInfoOps[Self <: OnHighlightChangedSelectInfo] (val x: Self) extends AnyVal {
