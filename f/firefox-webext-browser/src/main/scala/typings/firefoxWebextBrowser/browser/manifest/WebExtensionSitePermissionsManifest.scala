...
trait WebExtensionSitePermissionsManifest extends StObject {
  ...
  var developer: js.UndefOr[WebExtensionSitePermissionsManifestDeveloper] = js.undefined
...
object WebExtensionSitePermissionsManifest {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(manifest_version = manifest_version.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], site_permissions = site_permissions.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: WebExtensionSitePermissionsManifest] (val x: Self) extends AnyVal {
    ...
    inline def setDeveloper(value: WebExtensionSitePermissionsManifestDeveloper): Self = StObject.set(x, "developer", value.asInstanceOf[js.Any])
