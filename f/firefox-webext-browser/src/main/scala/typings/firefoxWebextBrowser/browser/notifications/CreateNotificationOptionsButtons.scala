...
@js.native
trait CreateNotificationOptionsButtons extends js.Object {
...
object CreateNotificationOptionsButtons {
  ...
  @scala.inline
  implicit class CreateNotificationOptionsButtonsOps[Self <: CreateNotificationOptionsButtons] (val x: Self) extends AnyVal {
