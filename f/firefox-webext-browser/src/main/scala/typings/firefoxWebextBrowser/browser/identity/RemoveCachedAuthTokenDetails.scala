...
@js.native
trait RemoveCachedAuthTokenDetails extends js.Object {
...
object RemoveCachedAuthTokenDetails {
  ...
  @scala.inline
  implicit class RemoveCachedAuthTokenDetailsOps[Self <: RemoveCachedAuthTokenDetails] (val x: Self) extends AnyVal {
