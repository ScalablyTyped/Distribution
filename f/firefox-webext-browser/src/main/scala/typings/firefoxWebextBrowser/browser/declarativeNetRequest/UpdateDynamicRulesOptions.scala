...
trait UpdateDynamicRulesOptions extends StObject {
...
object UpdateDynamicRulesOptions {
  
  inline def apply(): UpdateDynamicRulesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateDynamicRulesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateDynamicRulesOptions] (val x: Self) extends AnyVal {
