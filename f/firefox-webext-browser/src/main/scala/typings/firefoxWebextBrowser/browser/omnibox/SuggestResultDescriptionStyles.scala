...
@js.native
trait SuggestResultDescriptionStyles extends js.Object {
...
object SuggestResultDescriptionStyles {
  ...
  @scala.inline
  implicit class SuggestResultDescriptionStylesOps[Self <: SuggestResultDescriptionStyles] (val x: Self) extends AnyVal {
