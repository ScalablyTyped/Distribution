...
object UrlbarOnResultPickedEvent {
  ...
  @scala.inline
  implicit class UrlbarOnResultPickedEventOps[Self <: UrlbarOnResultPickedEvent[_], TCallback] (val x: Self with UrlbarOnResultPickedEvent[TCallback]) extends AnyVal {
    @scala.inline
