...
object SecurityInfo {
  ...
  def apply(
    ...
    if (!js.isUndefined(hsts)) __obj.updateDynamic("hsts")(hsts.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isDomainMismatch)) __obj.updateDynamic("isDomainMismatch")(isDomainMismatch.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isExtendedValidation)) __obj.updateDynamic("isExtendedValidation")(isExtendedValidation.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isNotValidAtThisTime)) __obj.updateDynamic("isNotValidAtThisTime")(isNotValidAtThisTime.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isUntrusted)) __obj.updateDynamic("isUntrusted")(isUntrusted.get.asInstanceOf[js.Any])
