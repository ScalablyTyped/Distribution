...
object OnHeadersReceivedOptions {
  ...
  inline def responseHeaders: typings.firefoxWebextBrowser.firefoxWebextBrowserStrings.responseHeaders = "responseHeaders".asInstanceOf[typings.firefoxWebextBrowser.firefoxWebextBrowserStrings.responseHeaders]
}
