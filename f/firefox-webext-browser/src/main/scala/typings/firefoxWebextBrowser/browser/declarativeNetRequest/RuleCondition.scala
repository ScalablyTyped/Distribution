...
trait RuleCondition extends StObject {
  ...
  /**
    ...
    */
  var domainType: js.UndefOr[RuleConditionDomainType] = js.undefined
...
object RuleCondition {
  ...
  implicit open class MutableBuilder[Self <: RuleCondition] (val x: Self) extends AnyVal {
    ...
    inline def setDomainType(value: RuleConditionDomainType): Self = StObject.set(x, "domainType", value.asInstanceOf[js.Any])
