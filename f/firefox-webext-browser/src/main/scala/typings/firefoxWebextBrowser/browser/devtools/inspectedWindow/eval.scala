...
import typings.firefoxWebextBrowser.AnonContextSecurityOrigin
...
object eval extends js.Object {
  ...
  def apply(expression: String, options: AnonContextSecurityOrigin): js.Promise[js.Object] = js.native
}
