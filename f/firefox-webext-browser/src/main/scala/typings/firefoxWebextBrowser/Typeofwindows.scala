...
trait Typeofwindows extends js.Object {
  ...
  def create(): js.Promise[typings.firefoxWebextBrowser.browser.windows.Window] = js.native
  def create(createData: AnonAllowScriptsToClose): js.Promise[typings.firefoxWebextBrowser.browser.windows.Window] = js.native
  /* windows functions */
  /** Gets details about a window. */
  def get(windowId: Double): js.Promise[typings.firefoxWebextBrowser.browser.windows.Window] = js.native
  def get(windowId: Double, getInfo: GetInfo): js.Promise[typings.firefoxWebextBrowser.browser.windows.Window] = js.native
  /**
    * Gets all windows.
  ...
  def getLastFocused(): js.Promise[typings.firefoxWebextBrowser.browser.windows.Window] = js.native
  def getLastFocused(getInfo: GetInfo): js.Promise[typings.firefoxWebextBrowser.browser.windows.Window] = js.native
  ...
  /**
    ...
    */
  def update(windowId: Double, updateInfo: AnonDrawAttention): js.Promise[typings.firefoxWebextBrowser.browser.windows.Window] = js.native
}
