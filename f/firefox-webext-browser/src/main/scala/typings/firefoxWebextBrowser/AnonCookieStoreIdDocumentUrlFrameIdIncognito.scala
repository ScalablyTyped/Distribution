...
trait AnonCookieStoreIdDocumentUrlFrameIdIncognito extends js.Object {
...
object AnonCookieStoreIdDocumentUrlFrameIdIncognito {
  @scala.inline
  def apply(
    frameId: Double,
    method: String,
  ...
  ): AnonCookieStoreIdDocumentUrlFrameIdIncognito = {
    ...
    __obj.asInstanceOf[AnonCookieStoreIdDocumentUrlFrameIdIncognito]
  }
}
