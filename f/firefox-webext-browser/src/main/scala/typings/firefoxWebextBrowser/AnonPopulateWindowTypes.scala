...
trait AnonPopulateWindowTypes extends js.Object {
  /**
...
object AnonPopulateWindowTypes {
  @scala.inline
  def apply(populate: js.UndefOr[Boolean] = js.undefined, windowTypes: js.Array[WindowType] = null): AnonPopulateWindowTypes = {
    ...
    __obj.asInstanceOf[AnonPopulateWindowTypes]
  }
}
