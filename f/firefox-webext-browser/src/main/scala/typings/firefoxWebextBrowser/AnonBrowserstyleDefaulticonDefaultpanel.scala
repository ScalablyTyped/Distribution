...
trait AnonBrowserstyleDefaulticonDefaultpanel extends js.Object {
...
object AnonBrowserstyleDefaulticonDefaultpanel {
  @scala.inline
  def apply(
  ...
  ): AnonBrowserstyleDefaulticonDefaultpanel = {
    ...
    __obj.asInstanceOf[AnonBrowserstyleDefaulticonDefaultpanel]
  }
}
