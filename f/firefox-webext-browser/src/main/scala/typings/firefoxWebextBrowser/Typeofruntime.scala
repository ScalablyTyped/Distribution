...
trait Typeofruntime extends js.Object {
  ...
  val lastError: js.UndefOr[AnonMessageString] = js.native
  /**
  ...
  /**
    ...
    */
  val onUpdateAvailable: WebExtEvent[js.Function1[/* details */ AnonVersion, Unit]] = js.native
  /**
  ...
  def connect(extensionId: String, connectInfo: AnonIncludeTlsChannelId): Port = js.native
  /**
