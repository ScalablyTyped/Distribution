...
trait AnonIdPreviousVersion extends js.Object {
  /**
...
object AnonIdPreviousVersion {
  @scala.inline
  def apply(reason: OnInstalledReason, temporary: Boolean, id: String = null, previousVersion: String = null): AnonIdPreviousVersion = {
    ...
    __obj.asInstanceOf[AnonIdPreviousVersion]
  }
}
