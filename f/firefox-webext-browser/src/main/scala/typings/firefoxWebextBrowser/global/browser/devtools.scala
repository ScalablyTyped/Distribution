...
import typings.firefoxWebextBrowser.anon.ContextSecurityOrigin
import typings.firefoxWebextBrowser.anon.IgnoreCache
...
import typings.firefoxWebextBrowser.browser.devtools.panels.Create
