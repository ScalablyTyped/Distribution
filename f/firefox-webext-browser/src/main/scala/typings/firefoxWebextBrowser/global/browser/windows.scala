...
import typings.firefoxWebextBrowser.anon.AllowScriptsToClose
import typings.firefoxWebextBrowser.anon.DrawAttention
import typings.firefoxWebextBrowser.anon.WindowTypes
