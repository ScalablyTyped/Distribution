...
import typings.firefoxWebextBrowser.browser.menus.CreateCreateProperties
import typings.firefoxWebextBrowser.browser.menus.OnClickData
import typings.firefoxWebextBrowser.browser.menus.OnShownInfo
import typings.firefoxWebextBrowser.browser.menus.OverrideContextContextOptions
import typings.firefoxWebextBrowser.browser.menus.UpdateUpdateProperties
