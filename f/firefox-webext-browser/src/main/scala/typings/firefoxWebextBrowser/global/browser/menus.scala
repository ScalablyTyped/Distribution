...
import typings.firefoxWebextBrowser.anon.Command
import typings.firefoxWebextBrowser.anon.Context
import typings.firefoxWebextBrowser.anon.DocumentUrlPatterns
import typings.firefoxWebextBrowser.anon.FrameUrl
