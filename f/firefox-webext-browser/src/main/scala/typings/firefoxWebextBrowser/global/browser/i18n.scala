...
object i18n {
  ...
  /**
    ...
    */
  @scala.inline
  def detectLanguage(text: String): js.Promise[DetectLanguageReturnResult] = ^.asInstanceOf[js.Dynamic].applyDynamic("detectLanguage")(text.asInstanceOf[js.Any]).asInstanceOf[js.Promise[DetectLanguageReturnResult]]
  ...
  /**
    ...
    */
  @scala.inline
  def getAcceptLanguages(): js.Promise[js.Array[LanguageCode]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getAcceptLanguages")().asInstanceOf[js.Promise[js.Array[LanguageCode]]]
