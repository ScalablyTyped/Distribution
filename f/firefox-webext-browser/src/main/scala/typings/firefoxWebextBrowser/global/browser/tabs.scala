...
import typings.firefoxWebextBrowser.anon.BypassCache
import typings.firefoxWebextBrowser.anon.FrameIdName
import typings.firefoxWebextBrowser.anon.FrameIdNumber
import typings.firefoxWebextBrowser.anon.FromIndex
import typings.firefoxWebextBrowser.anon.Highlighted
import typings.firefoxWebextBrowser.anon.IndexWindowId
import typings.firefoxWebextBrowser.anon.IsWindowClosing
import typings.firefoxWebextBrowser.anon.NewPosition
import typings.firefoxWebextBrowser.anon.NewZoomFactor
import typings.firefoxWebextBrowser.anon.OldPosition
import typings.firefoxWebextBrowser.anon.Populate
import typings.firefoxWebextBrowser.anon.PreviousTabId
import typings.firefoxWebextBrowser.anon.TabIds
...
object tabs extends js.Object {
  ...
  /**
    ...
    */
  val onActivated: WebExtEvent[js.Function1[/* activeInfo */ PreviousTabId, Unit]] = js.native
  /**
  ...
  val onDetached: WebExtEvent[js.Function2[/* tabId */ Double, /* detachInfo */ OldPosition, Unit]] = js.native
  /**
    * Fired when the highlighted or selected tabs in a window changes.
    * @deprecated Please use `tabs.onHighlighted`.
    */
  val onHighlightChanged: js.UndefOr[WebExtEvent[js.Function1[/* selectInfo */ TabIds, Unit]]] = js.native
  /** Fired when the highlighted or selected tabs in a window changes. */
  val onHighlighted: WebExtEvent[js.Function1[/* highlightInfo */ TabIds, Unit]] = js.native
  /**
    ...
    */
  val onMoved: WebExtEvent[js.Function2[/* tabId */ Double, /* moveInfo */ FromIndex, Unit]] = js.native
  /** Fired when a tab is closed. */
  val onRemoved: WebExtEvent[js.Function2[/* tabId */ Double, /* removeInfo */ IsWindowClosing, Unit]] = js.native
  ...
  /**
    ...
    */
  val onUpdated: TabsOnUpdatedEvent[js.Function3[/* tabId */ Double, /* changeInfo */ Audible, /* tab */ Tab, Unit]] = js.native
  /** Fired when a tab is zoomed. */
  val onZoomChange: WebExtEvent[js.Function1[/* ZoomChangeInfo */ NewZoomFactor, Unit]] = js.native
  /**
  ...
  def connect(tabId: Double, connectInfo: FrameIdName): Port = js.native
  /** Creates a new tab. */
  def create(createProperties: Active): js.Promise[Tab] = js.native
  /**
  ...
  def highlight(highlightInfo: Populate): js.Promise[Window] = js.native
  /**
  ...
  def move(tabIds: js.Array[Double], moveProperties: IndexWindowId): js.Promise[Tab | js.Array[Tab]] = js.native
  /**
    ...
    */
  def move(tabIds: Double, moveProperties: IndexWindowId): js.Promise[Tab | js.Array[Tab]] = js.native
  /**
  ...
  def query(queryInfo: Attention): js.Promise[js.Array[Tab]] = js.native
  /**
    * Reload a tab.
  ...
  /**
    ...
    */
  def update(tabId: Double, updateProperties: Highlighted): js.Promise[Tab] = js.native
  /**
    * Modifies the properties of a tab. Properties that are not specified in `updateProperties` are not modified.
    */
  def update(updateProperties: Highlighted): js.Promise[Tab] = js.native
}
