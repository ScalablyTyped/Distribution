...
import typings.firefoxWebextBrowser.browser.action.SetIconDetails
import typings.firefoxWebextBrowser.browser.action.SetPopupDetails
import typings.firefoxWebextBrowser.browser.action.SetTitleDetails
