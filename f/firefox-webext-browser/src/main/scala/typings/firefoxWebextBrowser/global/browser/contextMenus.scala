...
object contextMenus {
  ...
  /**
    ...
    */
  @scala.inline
  def create(createProperties: CreateCreateProperties): Double | String = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(createProperties.asInstanceOf[js.Any]).asInstanceOf[Double | String]
  @scala.inline
  def create(createProperties: CreateCreateProperties, callback: js.Function0[Unit]): Double | String = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(createProperties.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Double | String]
  ...
  /**
    ...
    */
  @scala.inline
  def getTargetElement(targetElementId: Double): Element | Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTargetElement")(targetElementId.asInstanceOf[js.Any]).asInstanceOf[Element | Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def overrideContext(contextOptions: OverrideContextContextOptions): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("overrideContext")(contextOptions.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def refresh(): js.Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("refresh")().asInstanceOf[js.Promise[js.Any]]
  
  @scala.inline
  def remove(menuItemId: String): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("remove")(menuItemId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  /**
    * Removes a context menu item.
    * @param menuItemId The ID of the context menu item to remove.
    */
  @scala.inline
  def remove(menuItemId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("remove")(menuItemId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  
  /** Removes all context menu items added by this extension. */
  @scala.inline
  def removeAll(): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("removeAll")().asInstanceOf[js.Promise[Unit]]
  
  @scala.inline
  def update(id: String, updateProperties: UpdateUpdateProperties): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("update")(id.asInstanceOf[js.Any], updateProperties.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  /**
    ...
    */
  @scala.inline
  def update(id: Double, updateProperties: UpdateUpdateProperties): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("update")(id.asInstanceOf[js.Any], updateProperties.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
}
