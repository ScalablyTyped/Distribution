...
import typings.firefoxWebextBrowser.anon.BookmarkId
import typings.firefoxWebextBrowser.anon.Checked
import typings.firefoxWebextBrowser.anon.Contexts
import typings.firefoxWebextBrowser.anon.Editable
...
object contextMenus extends js.Object {
  ...
  /**
    ...
    */
  val onShown: WebExtEvent[js.Function2[/* info */ Editable, /* tab */ Tab, Unit]] = js.native
  ...
  /**
    ...
    */
  def create(createProperties: Checked): Double | String = js.native
  def create(createProperties: Checked, callback: js.Function0[Unit]): Double | String = js.native
  /**
  ...
  /**
    ...
    */
  def overrideContext(contextOptions: BookmarkId): Unit = js.native
  /**
  ...
  def update(id: String, updateProperties: Contexts): js.Promise[Unit] = js.native
  /**
    * Updates a previously created context menu item.
    * @param id The ID of the item to update.
    * @param updateProperties The properties to update. Accepts the same values as the create function.
    */
  def update(id: Double, updateProperties: Contexts): js.Promise[Unit] = js.native
}
