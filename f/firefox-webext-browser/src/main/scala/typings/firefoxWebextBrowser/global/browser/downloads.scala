...
object downloads {
  ...
  /**
    ...
    */
  @scala.inline
  def acceptDanger(downloadId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("acceptDanger")(downloadId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  /**
    ...
    */
  @scala.inline
  def cancel(downloadId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("cancel")(downloadId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  /**
    ...
    */
  @scala.inline
  def download(options: DownloadOptions): js.Promise[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("download")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Double]]
  ...
  @scala.inline
  def erase(query: DownloadQuery): js.Promise[js.Array[Double]] = ^.asInstanceOf[js.Dynamic].applyDynamic("erase")(query.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[Double]]]
  ...
  /**
    ...
    */
  @scala.inline
  def getFileIcon(downloadId: Double): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFileIcon")(downloadId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  @scala.inline
  def getFileIcon(downloadId: Double, options: GetFileIconOptions): js.Promise[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getFileIcon")(downloadId.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[String]]
  ...
  @scala.inline
  def open(downloadId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("open")(downloadId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  /**
    ...
    */
  @scala.inline
  def pause(downloadId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("pause")(downloadId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  
  @scala.inline
  def removeFile(downloadId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("removeFile")(downloadId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  /**
    ...
    */
  @scala.inline
  def resume(downloadId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("resume")(downloadId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  /**
    ...
    */
  @scala.inline
  def search(query: DownloadQuery): js.Promise[js.Array[DownloadItem]] = ^.asInstanceOf[js.Dynamic].applyDynamic("search")(query.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[DownloadItem]]]
  ...
  @scala.inline
  def show(downloadId: Double): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("show")(downloadId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
