...
import typings.firefoxWebextBrowser.anon.AllowHttpErrors
import typings.firefoxWebextBrowser.anon.CanResume
import typings.firefoxWebextBrowser.anon.Size
