...
trait AnonIndexNode extends js.Object {
  var index: Double
  var node: BookmarkTreeNode
  var parentId: String
}

object AnonIndexNode {
  @scala.inline
  def apply(index: Double, node: BookmarkTreeNode, parentId: String): AnonIndexNode = {
    ...
    __obj.asInstanceOf[AnonIndexNode]
  }
}
