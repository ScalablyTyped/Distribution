...
trait AnonCookieStoreIdDocumentUrlError extends js.Object {
...
object AnonCookieStoreIdDocumentUrlError {
  @scala.inline
  def apply(
    error: String,
    frameId: Double,
  ...
  ): AnonCookieStoreIdDocumentUrlError = {
    ...
    __obj.asInstanceOf[AnonCookieStoreIdDocumentUrlError]
  }
}
