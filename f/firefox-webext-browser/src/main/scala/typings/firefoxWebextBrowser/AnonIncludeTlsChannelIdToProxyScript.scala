...
trait AnonIncludeTlsChannelIdToProxyScript extends js.Object {
  /**
...
object AnonIncludeTlsChannelIdToProxyScript {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonIncludeTlsChannelIdToProxyScript]
  }
}
