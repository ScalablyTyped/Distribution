...
trait Typeofhistory extends js.Object {
  ...
  val onTitleChanged: WebExtEvent[js.Function1[/* changed */ AnonTitleUrlString, Unit]]
  /**
  ...
  /**
    ...
    */
  def addUrl(details: AnonTitleTransition): js.Promise[Unit]
  ...
  /**
    ...
    */
  def deleteRange(range: AnonEndTimeStartTime): js.Promise[Unit]
  /** Removes all occurrences of the given URL from the history. */
  def deleteUrl(details: AnonUrl): js.Promise[Unit]
  /** Retrieves information about visits to a URL. */
  def getVisits(details: AnonUrl): js.Promise[js.Array[VisitItem]]
  /* history functions */
...
object Typeofhistory {
  @scala.inline
  def apply(
    addUrl: AnonTitleTransition => js.Promise[Unit],
    deleteAll: () => js.Promise[Unit],
    deleteRange: AnonEndTimeStartTime => js.Promise[Unit],
    deleteUrl: AnonUrl => js.Promise[Unit],
    getVisits: AnonUrl => js.Promise[js.Array[VisitItem]],
    onTitleChanged: WebExtEvent[js.Function1[/* changed */ AnonTitleUrlString, Unit]],
