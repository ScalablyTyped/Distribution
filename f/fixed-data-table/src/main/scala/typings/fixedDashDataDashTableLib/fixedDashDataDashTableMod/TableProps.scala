...
trait TableProps
  extends reactLib.reactMod.Props[Table] {
  /**
  ...
  var onRowClick: js.UndefOr[
    js.Function2[
      /* event */ reactLib.reactMod.SyntheticEvent[Table, reactLib.Event], 
...
object TableProps {
  ...
  def apply(
    ...
    onRowClick: (/* event */ reactLib.reactMod.SyntheticEvent[Table, reactLib.Event], /* rowIndex */ scala.Double) => scala.Unit = null,
    onRowDoubleClick: (/* event */ reactLib.reactMod.SyntheticEvent[Table, reactLib.Event], /* rowIndex */ scala.Double) => scala.Unit = null,
    onRowMouseDown: (/* event */ reactLib.reactMod.SyntheticEvent[Table, reactLib.Event], /* rowIndex */ scala.Double) => scala.Unit = null,
    onRowMouseEnter: (/* event */ reactLib.reactMod.SyntheticEvent[Table, reactLib.Event], /* rowIndex */ scala.Double) => scala.Unit = null,
    onRowMouseLeave: (/* event */ reactLib.reactMod.SyntheticEvent[Table, reactLib.Event], /* rowIndex */ scala.Double) => scala.Unit = null,
