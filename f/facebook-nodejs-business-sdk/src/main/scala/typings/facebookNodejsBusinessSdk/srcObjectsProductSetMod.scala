...
object srcObjectsProductSetMod {
  
  @JSImport("facebook-nodejs-business-sdk/src/objects/product-set", JSImport.Default)
  @js.native
  open class default () extends ProductSet
  
  @js.native
  trait ProductSet extends AbstractCrudObject {
    ...
    def get(fields: js.Array[String]): js.Promise[ProductSet] = js.native
    def get(fields: js.Array[String], params: Record[String, Any]): js.Promise[ProductSet] = js.native
    ...
    def update(fields: js.Array[String]): js.Promise[ProductSet] = js.native
    def update(fields: js.Array[String], params: Record[String, Any]): js.Promise[ProductSet] = js.native
  }
}
