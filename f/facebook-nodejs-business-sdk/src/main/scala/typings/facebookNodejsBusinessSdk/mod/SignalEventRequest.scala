...
@JSImport("facebook-nodejs-business-sdk", "SignalEventRequest")
@js.native
open class SignalEventRequest protected () extends default {
  def this(
    access_token: String,
    pixel_id: String,
    events: js.UndefOr[
...
object SignalEventRequest {
  ...
  ]) = ^.asInstanceOf[js.Dynamic].selectDynamic("SignalEventRequest").asInstanceOf[(Instantiable11[
    /* access_token */ String, 
    /* pixel_id */ String, 
    /* events */ js.UndefOr[
      js.Array[typings.facebookNodejsBusinessSdk.srcObjectsServersideServerEventMod.default]
