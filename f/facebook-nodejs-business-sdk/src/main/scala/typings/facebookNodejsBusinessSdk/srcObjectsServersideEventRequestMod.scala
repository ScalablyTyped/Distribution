...
object srcObjectsServersideEventRequestMod {
  
  @JSImport("facebook-nodejs-business-sdk/src/objects/serverside/event-request", JSImport.Default)
  @js.native
  ...
  trait EventRequest extends StObject {
    ...
    var _debug_mode: Boolean = js.native
    
    var _events: js.Array[typings.facebookNodejsBusinessSdk.srcObjectsServersideServerEventMod.default] = js.native
    
    var _http_service: js.UndefOr[
        typings.facebookNodejsBusinessSdk.srcObjectsServersideHttpServiceInterfaceMod.default | Null
      ] = js.native
    
    var _namespace_id: js.UndefOr[String | Null] = js.native
    
    var _partner_agent: js.UndefOr[String | Null] = js.native
    
    var _pixel_id: String = js.native
    
    var _test_event_code: js.UndefOr[String | Null] = js.native
    
    var _upload_id: js.UndefOr[String | Null] = js.native
    
    var _upload_source: js.UndefOr[String | Null] = js.native
    
    var _upload_tag: js.UndefOr[String | Null] = js.native
    
    def access_token: String = js.native
    def access_token_=(access_token: String): Unit = js.native
    
    def cloneWithoutEvents(): EventRequest = js.native
    
    def debug_mode: Boolean = js.native
    def debug_mode_=(debug_mode: Boolean): Unit = js.native
    
    def events: js.Array[typings.facebookNodejsBusinessSdk.srcObjectsServersideServerEventMod.default] = js.native
    def events_=(events: js.Array[typings.facebookNodejsBusinessSdk.srcObjectsServersideServerEventMod.default]): Unit = js.native
    
    def execute(): js.Promise[typings.facebookNodejsBusinessSdk.srcObjectsServersideEventResponseMod.default] = js.native
    ...
    def setEvents(events: js.Array[typings.facebookNodejsBusinessSdk.srcObjectsServersideServerEventMod.default]): EventRequest = js.native
