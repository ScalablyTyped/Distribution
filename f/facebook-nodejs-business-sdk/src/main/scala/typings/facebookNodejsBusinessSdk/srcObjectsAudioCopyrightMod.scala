...
object srcObjectsAudioCopyrightMod {
  
  @JSImport("facebook-nodejs-business-sdk/src/objects/audio-copyright", JSImport.Default)
  @js.native
  open class default () extends AudioCopyright
  
  @js.native
  trait AudioCopyright extends AbstractCrudObject {
    
    def get(fields: js.Array[String]): js.Promise[AudioCopyright] = js.native
    def get(fields: js.Array[String], params: Record[String, Any]): js.Promise[AudioCopyright] = js.native
