...
object srcObjectsInstantArticleMod {
  
  @JSImport("facebook-nodejs-business-sdk/src/objects/instant-article", JSImport.Default)
  @js.native
  open class default () extends InstantArticle
  
  @js.native
  trait InstantArticle extends AbstractCrudObject {
    ...
    def get(fields: js.Array[String]): js.Promise[InstantArticle] = js.native
    def get(fields: js.Array[String], params: Record[String, Any]): js.Promise[InstantArticle] = js.native
