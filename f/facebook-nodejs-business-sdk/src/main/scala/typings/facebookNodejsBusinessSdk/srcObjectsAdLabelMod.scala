...
object srcObjectsAdLabelMod {
  
  @JSImport("facebook-nodejs-business-sdk/src/objects/ad-label", JSImport.Default)
  @js.native
  open class default () extends AdLabel
  
  @js.native
  trait AdLabel extends AbstractCrudObject {
    ...
    def get(fields: js.Array[String]): js.Promise[AdLabel] = js.native
    def get(fields: js.Array[String], params: Record[String, Any]): js.Promise[AdLabel] = js.native
    ...
    def getAdSets(fields: js.Array[String]): typings.facebookNodejsBusinessSdk.srcCursorMod.default = js.native
    def getAdSets(fields: js.Array[String], params: Unit, fetchFirstPage: Boolean): typings.facebookNodejsBusinessSdk.srcCursorMod.default = js.native
    def getAdSets(fields: js.Array[String], params: Record[String, Any]): typings.facebookNodejsBusinessSdk.srcCursorMod.default = js.native
    def getAdSets(fields: js.Array[String], params: Record[String, Any], fetchFirstPage: Boolean): typings.facebookNodejsBusinessSdk.srcCursorMod.default = js.native
    ...
    def update(fields: js.Array[String]): js.Promise[AdLabel] = js.native
    def update(fields: js.Array[String], params: Record[String, Any]): js.Promise[AdLabel] = js.native
  }
}
