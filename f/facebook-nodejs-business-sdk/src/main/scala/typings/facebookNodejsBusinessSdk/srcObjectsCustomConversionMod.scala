...
object srcObjectsCustomConversionMod {
  
  @JSImport("facebook-nodejs-business-sdk/src/objects/custom-conversion", JSImport.Default)
  @js.native
  open class default () extends CustomConversion
  
  @js.native
  trait CustomConversion extends AbstractCrudObject {
    ...
    def get(fields: js.Array[String]): js.Promise[CustomConversion] = js.native
    def get(fields: js.Array[String], params: Record[String, Any]): js.Promise[CustomConversion] = js.native
    ...
    def update(fields: js.Array[String]): js.Promise[CustomConversion] = js.native
    def update(fields: js.Array[String], params: Record[String, Any]): js.Promise[CustomConversion] = js.native
  }
}
