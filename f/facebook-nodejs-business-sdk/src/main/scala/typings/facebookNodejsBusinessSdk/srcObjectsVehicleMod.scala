...
object srcObjectsVehicleMod {
  
  @JSImport("facebook-nodejs-business-sdk/src/objects/vehicle", JSImport.Default)
  @js.native
  open class default () extends Vehicle
  
  @js.native
  trait Vehicle extends AbstractCrudObject {
    
    def get(fields: js.Array[String]): js.Promise[Vehicle] = js.native
    def get(fields: js.Array[String], params: Record[String, Any]): js.Promise[Vehicle] = js.native
    ...
    def update(fields: js.Array[String]): js.Promise[Vehicle] = js.native
    def update(fields: js.Array[String], params: Record[String, Any]): js.Promise[Vehicle] = js.native
  }
}
