...
class Verifier protected () extends js.Object {
  ...
  def _createEntity(data: atFeathersjsAuthenticationDashOauth2Lib.Anon_Profile): stdLib.Promise[_] = js.native
  ...
  def _updateEntity(entity: js.Any, data: atFeathersjsAuthenticationDashOauth2Lib.Anon_Profile): stdLib.Promise[_] = js.native
