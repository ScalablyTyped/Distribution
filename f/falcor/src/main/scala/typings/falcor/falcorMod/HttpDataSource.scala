...
import typings.falcorDashHttpDashDatasource.falcorDashHttpDashDatasourceMod.XMlHttpSource
...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify FalcorModel.DataSource * / any */ @JSImport("falcor", "HttpDataSource")
@js.native
