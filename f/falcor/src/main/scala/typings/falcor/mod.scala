...
object mod {
  ...
  abstract class DataSource () extends StObject {
    ...
    def call(functionPath: Path, args: js.Array[js.Any]): Observable[JSONGraphEnvelope] = js.native
    def call(functionPath: Path, args: js.Array[js.Any], refSuffixes: js.Array[PathSet]): Observable[JSONGraphEnvelope] = js.native
    def call(
      functionPath: Path,
    ...
    def call(functionPath: Path, args: js.Array[js.Any], refSuffixes: Unit, thisPaths: js.Array[PathSet]): Observable[JSONGraphEnvelope] = js.native
  ...
  class Model () extends StObject {
    ...
    def call(functionPath: String): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: String, args: js.Array[js.Any]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: String, args: js.Array[js.Any], refPaths: Unit, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: String, args: js.Array[js.Any], refPaths: PathSet): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: String, args: js.Array[js.Any], refPaths: PathSet, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: String, args: Unit, refPaths: Unit, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: String, args: Unit, refPaths: PathSet): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: String, args: Unit, refPaths: PathSet, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: Path): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: Path, args: js.Array[js.Any]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: Path, args: js.Array[js.Any], refPaths: Unit, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: Path, args: js.Array[js.Any], refPaths: PathSet): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: Path, args: js.Array[js.Any], refPaths: PathSet, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: Path, args: Unit, refPaths: Unit, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: Path, args: Unit, refPaths: PathSet): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def call(functionPath: Path, args: Unit, refPaths: PathSet, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[js.Any]] = js.native
    @JSName("call")
    def call_T[T](functionPath: String): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    def call_T[T](functionPath: String, args: js.Array[js.Any]): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    def call_T[T](functionPath: String, args: js.Array[js.Any], refPaths: Unit, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    def call_T[T](functionPath: String, args: js.Array[js.Any], refPaths: PathSet): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    def call_T[T](functionPath: String, args: js.Array[js.Any], refPaths: PathSet, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    ...
    @JSName("call")
    def call_T[T](functionPath: Path, args: js.Array[js.Any]): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    def call_T[T](functionPath: Path, args: js.Array[js.Any], refPaths: Unit, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    def call_T[T](functionPath: Path, args: js.Array[js.Any], refPaths: PathSet): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    def call_T[T](functionPath: Path, args: js.Array[js.Any], refPaths: PathSet, thisPaths: js.Array[PathSet]): ModelResponse[JSONEnvelope[T]] = js.native
    @JSName("call")
    ...
    /**
      ...
      */
    def get(path: (String | PathSet)*): ModelResponse[JSONEnvelope[js.Any]] = js.native
    ...
    /**
      ...
      */
    def getValue(path: String): ModelResponse[js.Any] = js.native
    def getValue(path: Path): ModelResponse[js.Any] = js.native
    @JSName("getValue")
    ...
    /**
      ...
      */
    def set(args: PathValue_ *): ModelResponse[JSONEnvelope[js.Any]] = js.native
    def set(jsonGraph: JSONGraph): ModelResponse[JSONEnvelope[js.Any]] = js.native
    ...
    /**
      ...
      */
    def setValue(path: String, value: js.Any): ModelResponse[js.Any] = js.native
    def setValue(path: Path, value: js.Any): ModelResponse[js.Any] = js.native
    @JSName("setValue")
  ...
  class ModelResponse[T] protected () extends Observable[T] {
    ...
    def `then`(): Thenable[js.Any] = js.native
    def `then`(onFulfilled: js.Function1[/* value */ T, js.Any | Thenable[js.Any]]): Thenable[js.Any] = js.native
    def `then`(
      onFulfilled: js.Function1[/* value */ T, js.Any | Thenable[js.Any]],
      onRejected: js.Function1[/* error */ js.Any, Unit]
    ): Thenable[js.Any] = js.native
    def `then`(onFulfilled: Unit, onRejected: js.Function1[/* error */ js.Any, Unit]): Thenable[js.Any] = js.native
    @JSName("then")
    ...
    @JSName("then")
    def then_U[U](onFulfilled: Unit, onRejected: js.Function1[/* error */ js.Any, Unit]): Thenable[U] = js.native
  }
  ...
  trait Thenable[T] extends StObject {
    ...
    def `then`[U](onFulfilled: Unit, onRejected: js.Function1[/* error */ js.Any, U | Thenable[U] | Unit]): Thenable[U] = js.native
  }
}
