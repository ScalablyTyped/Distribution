...
trait ModelOptions extends js.Object {
  var cache: js.UndefOr[falcorDashJsonDashGraphLib.falcorDashJsonDashGraphMod.JSONGraph] = js.undefined
...
object ModelOptions {
  @scala.inline
  def apply(
    cache: falcorDashJsonDashGraphLib.falcorDashJsonDashGraphMod.JSONGraph = null,
