...
import typings.firebaseUtil.anon.SigninproviderFirebaseSignInProvider
import typings.firebaseUtil.firebaseUtilStrings.anonymous
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distSrcEmulatorMod {
  
  @JSImport("@firebase/util/dist/src/emulator", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseUtil.anon.useridstringPartialFirebaAud
    - typings.firebaseUtil.anon.substringPartialFirebaseIAud
  */
  trait EmulatorMockTokenOptions extends StObject
  object EmulatorMockTokenOptions {
    
    inline def substringPartialFirebaseIAud(sub: String & js.UndefOr[String]): typings.firebaseUtil.anon.substringPartialFirebaseIAud = {
      val __obj = js.Dynamic.literal(sub = sub.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseUtil.anon.substringPartialFirebaseIAud]
    }
    
    inline def useridstringPartialFirebaAud(user_id: String & js.UndefOr[String]): typings.firebaseUtil.anon.useridstringPartialFirebaAud = {
      val __obj = js.Dynamic.literal(user_id = user_id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseUtil.anon.useridstringPartialFirebaAud]
    }
  }
  ...
  trait FirebaseIdToken
    ...
    var firebase: SigninproviderFirebaseSignInProvider
  ...
  object FirebaseIdToken {
    ...
    inline def apply(
      ...
      auth_time: Double,
      exp: Double,
      firebase: SigninproviderFirebaseSignInProvider,
      iat: Double,
      iss: String,
      sub: String,
      user_id: String
    ...
    extension [Self <: FirebaseIdToken](x: Self) {
      ...
      inline def setFirebase(value: SigninproviderFirebaseSignInProvider): Self = StObject.set(x, "firebase", value.asInstanceOf[js.Any])
