...
/* Inlined {  user_id :string} & std.Partial<@firebase/util.@firebase/util/dist/src/emulator.FirebaseIdToken> */
trait useridstringPartialFirebaAud
  extends StObject
...
object useridstringPartialFirebaAud {
  
  inline def apply(user_id: String & js.UndefOr[String]): useridstringPartialFirebaAud = {
