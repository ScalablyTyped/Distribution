...
/* Inlined {  sub :string} & std.Partial<@firebase/util.@firebase/util/dist/src/emulator.FirebaseIdToken> */
trait substringPartialFirebaseIAud
  extends StObject
  ...
  var firebase: js.UndefOr[IdentitiesSigninprovider] = js.undefined
...
object substringPartialFirebaseIAud {
  
  inline def apply(sub: String): substringPartialFirebaseIAud = {
    val __obj = js.Dynamic.literal(sub = sub.asInstanceOf[js.Any])
    __obj.asInstanceOf[substringPartialFirebaseIAud]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: substringPartialFirebaseIAud] (val x: Self) extends AnyVal {
    ...
    inline def setFirebase(value: IdentitiesSigninprovider): Self = StObject.set(x, "firebase", value.asInstanceOf[js.Any])
