...
import typings.firebaseUtil.distUtilMod.EmulatorMockTokenOptions
...
object useridstringPartialFirebaEmail {
  ...
  inline def apply(user_id: String): useridstringPartialFirebaEmail = {
    val __obj = js.Dynamic.literal(user_id = user_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[useridstringPartialFirebaEmail]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: useridstringPartialFirebaEmail] (val x: Self) extends AnyVal {
