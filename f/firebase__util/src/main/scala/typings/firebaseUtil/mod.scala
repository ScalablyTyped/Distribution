...
object mod {
  ...
  @JSImport("@firebase/util", "DecodeBase64StringError")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseUtil.anon.useridstringPartialFirebaAuthtime
    - typings.firebaseUtil.anon.substringPartialFirebaseIAuthtime
  */
  ...
  */
  ...
  object FirebaseIdToken {
    ...
    implicit open class MutableBuilder[Self <: FirebaseIdToken] (val x: Self) extends AnyVal {
      ...
      inline def setFirebase(value: `0`): Self = StObject.set(x, "firebase", value.asInstanceOf[js.Any])
  ...
  */
  ...
  /* Inlined std.Partial<@firebase/util.@firebase/util.Observer<T>> */
