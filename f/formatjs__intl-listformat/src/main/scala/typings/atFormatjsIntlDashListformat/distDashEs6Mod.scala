...
import typings.atFormatjsIntlDashListformat.distDashEs6CoreMod.IntlListFormatOptions
...
@JSImport("@formatjs/intl-listformat/dist-es6", JSImport.Namespace)
@js.native
object distDashEs6Mod extends js.Object {
  @js.native
  class default ()
    extends typings.atFormatjsIntlDashListformat.distDashEs6CoreMod.default {
