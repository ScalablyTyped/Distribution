...
@JSImport("@formatjs/intl-listformat", JSImport.Namespace)
@js.native
object atFormatjsIntlDashListformatMod extends js.Object {
  @js.native
  class default ()
    extends typings.atFormatjsIntlDashListformat.distCoreMod.default {
