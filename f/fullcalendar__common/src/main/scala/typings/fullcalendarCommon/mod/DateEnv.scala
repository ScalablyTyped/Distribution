...
import typings.fullcalendarCommon.anon.DefaultSeparator
import typings.fullcalendarCommon.anon.ForcedTzo
import typings.fullcalendarCommon.anon.Unit
import typings.fullcalendarCommon.anon.`8`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@fullcalendar/common", "DateEnv")
@js.native
open class DateEnv protected () extends StObject {
  def this(settings: DateEnvSettings) = this()
