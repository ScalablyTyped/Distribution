...
trait EventSourceRefined extends StObject {
  ...
  var allow: js.UndefOr[Any] = js.undefined
  ...
  var constraint: js.UndefOr[Any] = js.undefined
  
  var defaultAllDay: js.UndefOr[Any] = js.undefined
  
  var display: js.UndefOr[Any] = js.undefined
  
  var durationEditable: js.UndefOr[Any] = js.undefined
  
  var editable: js.UndefOr[Any] = js.undefined
  
  var endParam: js.UndefOr[Any] = js.undefined
  ...
  var overlap: js.UndefOr[Any] = js.undefined
  
  var startEditable: js.UndefOr[Any] = js.undefined
  
  var startParam: js.UndefOr[Any] = js.undefined
  
  var success: js.UndefOr[Any] = js.undefined
  
  var textColor: js.UndefOr[Any] = js.undefined
  
  var timeZoneParam: js.UndefOr[Any] = js.undefined
...
object EventSourceRefined {
  ...
  extension [Self <: EventSourceRefined](x: Self) {
    ...
    inline def setAllow(value: Any): Self = StObject.set(x, "allow", value.asInstanceOf[js.Any])
    ...
    inline def setConstraint(value: Any): Self = StObject.set(x, "constraint", value.asInstanceOf[js.Any])
    ...
    inline def setDurationEditable(value: Any): Self = StObject.set(x, "durationEditable", value.asInstanceOf[js.Any])
    ...
    inline def setOverlap(value: Any): Self = StObject.set(x, "overlap", value.asInstanceOf[js.Any])
    
    inline def setOverlapUndefined: Self = StObject.set(x, "overlap", js.undefined)
    
    inline def setStartEditable(value: Any): Self = StObject.set(x, "startEditable", value.asInstanceOf[js.Any])
