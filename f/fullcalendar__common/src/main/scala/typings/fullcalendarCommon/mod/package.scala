...
import typings.fullcalendarCommon.anon.Bg
import typings.fullcalendarCommon.anon.Bottom
import typings.fullcalendarCommon.anon.CalendarContextviewApiVie
import typings.fullcalendarCommon.anon.Context
import typings.fullcalendarCommon.anon.Datanavlink
import typings.fullcalendarCommon.anon.Days
import typings.fullcalendarCommon.anon.DefId
import typings.fullcalendarCommon.anon.Destroy
import typings.fullcalendarCommon.anon.El
import typings.fullcalendarCommon.anon.EndStr
import typings.fullcalendarCommon.anon.ExtraRefined
import typings.fullcalendarCommon.anon.Href
import typings.fullcalendarCommon.anon.HrefUndefined
import typings.fullcalendarCommon.anon.IsFuture
import typings.fullcalendarCommon.anon.IsTimeUnspecified
import typings.fullcalendarCommon.anon.Liquid
import typings.fullcalendarCommon.anon.OnClick
import typings.fullcalendarCommon.anon.OnKeyDown
import typings.fullcalendarCommon.anon.PartialEventDef
import typings.fullcalendarCommon.anon.RawEvents
import typings.fullcalendarCommon.anon.Refined
import typings.fullcalendarCommon.anon.ViewPropsdateProfileDateP
import typings.fullcalendarCommon.fullcalendarCommonBooleans.`false`
import typings.fullcalendarCommon.fullcalendarCommonBooleans.`true`
import typings.fullcalendarCommon.mod.^
...
inline def findElements(container: NodeListOf[HTMLElement], selector: String): js.Array[HTMLElement] = (^.asInstanceOf[js.Dynamic].applyDynamic("findElements")(container.asInstanceOf[js.Any], selector.asInstanceOf[js.Any])).asInstanceOf[js.Array[HTMLElement]]
...
inline def greatestDurationDenominator(dur: Duration): typings.fullcalendarCommon.anon.Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("greatestDurationDenominator")(dur.asInstanceOf[js.Any]).asInstanceOf[typings.fullcalendarCommon.anon.Unit]
...
/* Rewritten from type alias, can be one of: 
  - typings.fullcalendarCommon.fullcalendarCommonStrings.businessHours
  - java.lang.String
  - typings.fullcalendarCommon.mod.EventStore
  - typings.fullcalendarCommon.fullcalendarCommonBooleans.`false`
*/
...
/* Rewritten from type alias, can be one of: 
  - typings.fullcalendarCommon.fullcalendarCommonStrings.businessHours
  - java.lang.String
  - typings.fullcalendarCommon.mod.EventInput
  - js.Array[typings.fullcalendarCommon.mod.EventInput]
*/
...
/* Rewritten from type alias, can be one of: 
  - typings.fullcalendarCommon.fullcalendarCommonStrings.popover
  - typings.fullcalendarCommon.fullcalendarCommonStrings.week
  - typings.fullcalendarCommon.fullcalendarCommonStrings.day
  - typings.fullcalendarCommon.fullcalendarCommonStrings.timeGridWeek
  - typings.fullcalendarCommon.fullcalendarCommonStrings.timeGridDay
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typings.fullcalendarCommon.fullcalendarCommonStrings.local
  - typings.fullcalendarCommon.fullcalendarCommonStrings.ISO
