...
@js.native
class ArmRelocator protected () extends js.Object {
  /**
    ...
    *               address.
    */
  def this(inputCode: NativePointerValue, output: ArmWriter) = this()
  /**
  ...
  /**
    * Recycles instance.
    */
  def reset(inputCode: NativePointerValue, output: ArmWriter): scala.Unit = js.native
  /**
