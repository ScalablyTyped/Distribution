...
class SqliteDatabase () extends js.Object {
  ...
  /**
    ...
    */
  def exec(sql: java.lang.String): scala.Unit = js.native
  /**
    ...
    * @param sql Text-representation of the SQL query.
    */
  def prepare(sql: java.lang.String): SqliteStatement = js.native
}
...
object SqliteDatabase extends js.Object {
  /**
    ...
    */
  def open(path: java.lang.String): fridaDashGumLib.SqliteDatabase = js.native
  def open(path: java.lang.String, options: fridaDashGumLib.SqliteOpenOptions): fridaDashGumLib.SqliteDatabase = js.native
  /**
    ...
    */
  def openInline(encodedContents: java.lang.String): fridaDashGumLib.SqliteDatabase = js.native
}
