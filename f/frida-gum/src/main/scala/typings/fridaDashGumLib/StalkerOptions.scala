...
trait StalkerOptions extends js.Object {
  /**
    ...
    */
  var events: js.UndefOr[Anon_Block] = js.undefined
  /**
    ...
    */
  var onCallSummary: js.UndefOr[js.Function1[/* summary */ StalkerCallSummary, scala.Unit]] = js.undefined
  /**
    ...
    */
  var onReceive: js.UndefOr[js.Function1[/* events */ stdLib.ArrayBuffer, scala.Unit]] = js.undefined
  /**
...
object StalkerOptions {
  ...
  def apply(
    ...
    onCallSummary: /* summary */ StalkerCallSummary => scala.Unit = null,
    onReceive: /* events */ stdLib.ArrayBuffer => scala.Unit = null,
