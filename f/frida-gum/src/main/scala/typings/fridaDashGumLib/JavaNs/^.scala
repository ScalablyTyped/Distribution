...
object ^ extends js.Object {
  /**
    ...
    */
  val androidVersion: java.lang.String = js.native
  /**
  ...
  /**
    ...
    *                 Java array.
    */
  def array(`type`: java.lang.String, elements: js.Array[_]): js.Array[_] = js.native
  /**
  ...
  /**
    ...
    */
  def choose(className: java.lang.String, callbacks: ChooseCallbacks): scala.Unit = js.native
  /**
    ...
    */
  def deoptimizeEverything(): scala.Unit = js.native
  /**
    ...
    * @param callbacks Object with callbacks.
    */
  def enumerateClassLoaders(callbacks: EnumerateClassLoadersCallbacks): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def enumerateLoadedClassesSync(): js.Array[java.lang.String] = js.native
  /**
    * Determines whether the caller is running on the main thread.
    */
  def isMainThread(): scala.Boolean = js.native
  /**
    * Opens the .dex file at `filePath`.
    *
    * @param filePath Path to .dex to open.
    */
  def openClassFile(filePath: java.lang.String): DexFile = js.native
  /**
    ...
    */
  def perform(fn: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    * Ensures that the current thread is attached to the VM and calls `fn`.
    * (This isn't necessary in callbacks from Java.)
    *
    * @param fn Function to run while attached to the VM.
    */
  def performNow(fn: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def scheduleOnMainThread(fn: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def synchronized(obj: Wrapper, fn: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def use(className: java.lang.String): Wrapper = js.native
}
