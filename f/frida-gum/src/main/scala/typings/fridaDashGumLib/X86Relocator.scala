...
class X86Relocator protected () extends js.Object {
  ...
  /**
    * Recycles instance.
    */
  def reset(inputCode: NativePointerValue, output: X86Writer): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def skipOneNoLabel(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def writeOneNoLabel(): scala.Boolean = js.native
}
