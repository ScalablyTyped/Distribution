...
class UInt64 protected ()
  ...
  def add(v: java.lang.String): UInt64 = js.native
  def add(v: scala.Double): UInt64 = js.native
  /**
    * Makes a new UInt64 whose value is `this` & `v`.
    */
  def and(v: UInt64): UInt64 = js.native
  def and(v: java.lang.String): UInt64 = js.native
  def and(v: scala.Double): UInt64 = js.native
  /**
  ...
  def or(v: java.lang.String): UInt64 = js.native
  def or(v: scala.Double): UInt64 = js.native
  /**
    * Makes a new UInt64 whose value is `this` >> `v`.
    */
  def shl(v: UInt64): UInt64 = js.native
  def shl(v: java.lang.String): UInt64 = js.native
  def shl(v: scala.Double): UInt64 = js.native
  /**
    * Makes a new UInt64 whose value is `this` << `v`.
    */
  def shr(v: UInt64): UInt64 = js.native
  def shr(v: java.lang.String): UInt64 = js.native
  def shr(v: scala.Double): UInt64 = js.native
  /**
    * Makes a new UInt64 whose value is `this` - `v`.
    */
  def sub(v: UInt64): UInt64 = js.native
  def sub(v: java.lang.String): UInt64 = js.native
  def sub(v: scala.Double): UInt64 = js.native
  /**
  ...
  def xor(v: java.lang.String): UInt64 = js.native
  def xor(v: scala.Double): UInt64 = js.native
}
