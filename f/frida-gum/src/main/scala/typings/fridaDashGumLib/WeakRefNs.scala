...
@JSGlobal("WeakRef")
@js.native
object WeakRefNs extends js.Object {
  /**
    ...
    */
  def bind(target: js.Any, callback: fridaDashGumLib.WeakRefCallback): fridaDashGumLib.WeakRefId = js.native
  /**
    ...
    */
  def unbind(id: fridaDashGumLib.WeakRefId): scala.Unit = js.native
}
