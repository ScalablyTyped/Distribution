...
class MipsRelocator protected ()
  extends typings.fridaGum.MipsRelocator {
  /**
    ...
    *               address.
    */
  def this(inputCode: NativePointerValue, output: typings.fridaGum.MipsWriter) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def reset(inputCode: NativePointerValue, output: typings.fridaGum.MipsWriter): Unit = js.native
  /**
