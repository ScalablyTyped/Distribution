...
@scala.inline
def setTimeout(func: typings.fridaGum.ScheduledCallback, delay: scala.Unit, params: js.Any*): typings.fridaGum.TimeoutId = (js.Dynamic.global.applyDynamic("setTimeout")(func.asInstanceOf[js.Any], delay.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[typings.fridaGum.TimeoutId]
