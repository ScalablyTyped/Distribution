...
object Arm64Relocator {
  ...
  @scala.inline
  implicit class Arm64RelocatorOps[Self <: Arm64Relocator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReset(value: (NativePointerValue, Arm64Writer) => Unit): Self = this.set("reset", js.Any.fromFunction2(value))
