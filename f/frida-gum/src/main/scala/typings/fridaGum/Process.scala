...
object Process extends js.Object {
  ...
  /**
    ...
    */
  def enumerateModules(): js.Array[Module] = js.native
  ...
  /**
    ...
    */
  def findModuleByAddress(address: NativePointerValue): Module | Null = js.native
  /**
    * Looks up a module by name. Returns null if not found.
    */
  def findModuleByName(name: String): Module | Null = js.native
  /**
  ...
  /**
    ...
    */
  def getModuleByAddress(address: NativePointerValue): Module = js.native
  /**
    * Looks up a module by name. Throws an exception if not found.
    */
  def getModuleByName(name: String): Module = js.native
  /**
