package typings.functionDashBind
...
object functionDashBindMod extends js.Object {
  def apply[T](`this`: T, thisArg: js.Any): T = js.native
  def apply[AX, R](`this`: Instantiable1[/* args (repeated) */ AX, R], thisArg: js.Any, args: AX*): Instantiable1[/* args (repeated) */ AX, R] = js.native
  def apply[T, A /* <: js.Array[_] */, R](`this`: js.ThisFunction1[/* this */ T, /* args */ A, R], thisArg: T): js.Function1[/* args */ A, R] = js.native
  def apply[T, AX, R](`this`: js.ThisFunction1[/* this */ T, /* repeated */ AX, R], thisArg: T, args: AX*): js.Function1[/* repeated */ AX, R] = js.native
  def apply[A0, A /* <: js.Array[_] */, R](`this`: Instantiable2[/* arg0 */ A0, /* args */ A, R], thisArg: js.Any, arg0: A0): Instantiable1[/* args */ A, R] = js.native
  def apply[T, A0, A /* <: js.Array[_] */, R](`this`: js.ThisFunction2[/* this */ T, /* arg0 */ A0, /* args */ A, R], thisArg: T, arg0: A0): js.Function1[/* args */ A, R] = js.native
  def apply[A0, A1, A /* <: js.Array[_] */, R](
