...
/* Inlined std.Omit<@formatjs/intl-datetimeformat.@formatjs/intl-datetimeformat/src/types.DateTimeFormatLocaleInternalData, 'dateFormat' | 'timeFormat' | 'dateTimeFormat' | 'formats'> & {  formats :std.Record<string, std.Array<string>>,   dateFormat :{  full :string,   long :string,   medium :string,   short :string},   timeFormat :{  full :string,   long :string,   medium :string,   short :string},   dateTimeFormat :{  full :string,   long :string,   medium :string,   short :string}} */
@js.native
