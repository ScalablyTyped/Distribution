...
import typings.formatjsIntlDatetimeformat.anon.FullLong
import typings.formatjsIntlDatetimeformat.anon.Long
import typings.formatjsIntlDatetimeformat.anon.LongNarrow
...
object DateTimeFormatLocaleInternalData {
  ...
  implicit class DateTimeFormatLocaleInternalDataOps[Self <: DateTimeFormatLocaleInternalData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEra(value: LongNarrow): Self = this.set("era", value.asInstanceOf[js.Any])
    @scala.inline
