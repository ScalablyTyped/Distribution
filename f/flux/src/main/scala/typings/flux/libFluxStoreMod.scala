...
object libFluxStoreMod {
  ...
  open class ^[TPayload] protected ()
    ...
    /* protected */ /* CompleteClass */
    var __dispatcher: typings.flux.libDispatcherMod.^[TPayload] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDispatcher(): typings.flux.libDispatcherMod.^[TPayload] = js.native
  ...
  trait FluxStore[TPayload] extends StObject {
    ...
    /* protected */ var __dispatcher: typings.flux.libDispatcherMod.^[TPayload]
  ...
  object FluxStore {
    ...
    extension [Self <: FluxStore[?], TPayload](x: Self & FluxStore[TPayload]) {
      ...
      inline def setGetDispatcher(value: () => typings.flux.libDispatcherMod.^[TPayload]): Self = StObject.set(x, "getDispatcher", js.Any.fromFunction0(value))
      ...
      inline def set__dispatcher(value: typings.flux.libDispatcherMod.^[TPayload]): Self = StObject.set(x, "__dispatcher", value.asInstanceOf[js.Any])
