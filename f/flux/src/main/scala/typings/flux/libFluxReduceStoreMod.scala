...
object libFluxReduceStoreMod {
  
  /**
    * This is the basic building block of a Flux application. All of your stores
    * should extend this class.
    */
  /* note: abstract class */ @JSImport("flux/lib/FluxReduceStore", JSImport.Namespace)
  @js.native
  open class ^[TState, TPayload] () extends FluxReduceStore[TState, TPayload]
