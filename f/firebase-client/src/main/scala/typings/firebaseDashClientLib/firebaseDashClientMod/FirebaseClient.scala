...
org.scalablytyped.runtime.Instantiable1[/* config */ FirebaseConfig, FirebaseClient] {
  /**
  	 ...
  	 */
  def delete(path: java.lang.String): qLib.qMod.Promise[scala.Unit] = js.native
  /**
  	 * Retrieves all objects at the base path
  	 */
  def get[T](): qLib.qMod.Promise[T] = js.native
  /**
  	 * Retrieves an object
  	 * @param path Relative path from the base for the resource
  	 */
  def get[T](path: java.lang.String): qLib.qMod.Promise[T] = js.native
  /**
  	 * @param path Relative path from the base for the resource
  	 * @param value Object to push to the path
  	 */
  def push[T](path: java.lang.String, value: T): qLib.qMod.Promise[PushResponse] = js.native
  /**
  	 ...
  	 */
  def set[T](path: java.lang.String, data: T): qLib.qMod.Promise[T] = js.native
  /**
  	 * Update a node at a given path
  	 * @param path Relative path from the base for the resource
  	 * @param value Value of the response
  	 */
  def update[T](path: java.lang.String, value: T): qLib.qMod.Promise[T] = js.native
}
