...
trait Affiliation
  ...
  var shipping: js.UndefOr[typings.firebaseAnalytics.mod.Currency] = js.undefined
  
  var tax: js.UndefOr[typings.firebaseAnalytics.mod.Currency] = js.undefined
...
object Affiliation {
  ...
  extension [Self <: Affiliation](x: Self) {
    ...
    inline def setShipping(value: typings.firebaseAnalytics.mod.Currency): Self = StObject.set(x, "shipping", value.asInstanceOf[js.Any])
    
    inline def setShippingUndefined: Self = StObject.set(x, "shipping", js.undefined)
    
    inline def setTax(value: typings.firebaseAnalytics.mod.Currency): Self = StObject.set(x, "tax", value.asInstanceOf[js.Any])
