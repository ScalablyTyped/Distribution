...
trait Affiliation
  ...
  var shipping: js.UndefOr[typings.firebaseAnalyticsTypes.mod.Currency] = js.undefined
  
  var tax: js.UndefOr[typings.firebaseAnalyticsTypes.mod.Currency] = js.undefined
...
object Affiliation {
  ...
  implicit open class MutableBuilder[Self <: Affiliation] (val x: Self) extends AnyVal {
    ...
    inline def setShipping(value: typings.firebaseAnalyticsTypes.mod.Currency): Self = StObject.set(x, "shipping", value.asInstanceOf[js.Any])
    
    inline def setShippingUndefined: Self = StObject.set(x, "shipping", js.undefined)
    
    inline def setTax(value: typings.firebaseAnalyticsTypes.mod.Currency): Self = StObject.set(x, "tax", value.asInstanceOf[js.Any])
