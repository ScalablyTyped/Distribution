...
object ^ extends js.Object {
  def apply(options: Options): java.lang.String | scala.Null = js.native
  /**
    ...
    */
  def apply(options: OptionsWithThunk): (js.Function1[/* repeated */ java.lang.String, java.lang.String]) | scala.Null = js.native
}
