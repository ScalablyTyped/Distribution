...
object mod {
  ...
  @scala.inline
  def apply(options: Options): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].apply(options.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
  /**
    ...
    */
  @scala.inline
  def apply(options: OptionsWithThunk): js.UndefOr[js.Function1[/* repeated */ String, String]] = ^.asInstanceOf[js.Dynamic].apply(options.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[js.Function1[/* repeated */ String, String]]]
  ...
  object OptionsWithThunk {
    ...
    @scala.inline
    def apply(name: String): OptionsWithThunk = {
