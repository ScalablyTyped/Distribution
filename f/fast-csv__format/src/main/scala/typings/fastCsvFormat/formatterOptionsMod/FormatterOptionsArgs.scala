...
object FormatterOptionsArgs {
  @scala.inline
  def apply[/* <: typings.fastCsvFormat.typesMod.Row */ I, /* <: typings.fastCsvFormat.typesMod.Row */ O](): FormatterOptionsArgs[I, O] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FormatterOptionsArgs[I, O]]
  }
  @scala.inline
  implicit class FormatterOptionsArgsOps[Self <: FormatterOptionsArgs[_, _], /* <: typings.fastCsvFormat.typesMod.Row */ I, /* <: typings.fastCsvFormat.typesMod.Row */ O] (val x: Self with (FormatterOptionsArgs[I, O])) extends AnyVal {
    @scala.inline
