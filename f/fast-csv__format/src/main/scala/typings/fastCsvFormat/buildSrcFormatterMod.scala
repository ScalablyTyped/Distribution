...
object buildSrcFormatterMod {
  ...
  open class FieldFormatter[I /* <: Row */, O /* <: Row */] protected ()
    extends typings.fastCsvFormat.buildSrcFormatterFieldFormatterMod.FieldFormatter[I, O] {
  ...
  open class RowFormatter[I /* <: Row */, O /* <: Row */] protected ()
    extends typings.fastCsvFormat.buildSrcFormatterRowFormatterMod.RowFormatter[I, O] {
    def this(formatterOptions: FormatterOptions[I, O]) = this()
  }
  /* static members */
  object RowFormatter {
