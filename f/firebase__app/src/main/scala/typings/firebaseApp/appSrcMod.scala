...
import typings.firebaseApp.srcPublicTypesMod.FirebaseAppSettings
import typings.firebaseApp.srcPublicTypesMod.FirebaseOptions
...
object appSrcMod {
  ...
  @JSImport("@firebase/app/dist/esm/app/src", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/app/dist/esm/app/src", "FirebaseError")
  @js.native
  open class FirebaseError protected ()
    extends typings.firebaseApp.srcApiMod.FirebaseError {
  ...
  @JSImport("@firebase/app/dist/esm/app/src", "SDK_VERSION")
  @js.native
  val SDK_VERSION: String = js.native
  
  @JSImport("@firebase/app/dist/esm/app/src", "_DEFAULT_ENTRY_NAME")
  @js.native
  ...
  @JSImport("@firebase/app/dist/esm/app/src", "_apps")
  @js.native
  ...
  @JSImport("@firebase/app/dist/esm/app/src", "_components")
  @js.native
  val components: Map[
    String, 
