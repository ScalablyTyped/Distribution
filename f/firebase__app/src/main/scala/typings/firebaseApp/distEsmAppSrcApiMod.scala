...
import typings.firebaseApp.distEsmAppSrcPublicTypesMod.FirebaseAppSettings
import typings.firebaseApp.distEsmAppSrcPublicTypesMod.FirebaseOptions
...
object distEsmAppSrcApiMod {
  
  @JSImport("@firebase/app/dist/esm/app/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/app/dist/esm/app/src/api", "FirebaseError")
  @js.native
  ...
  @JSImport("@firebase/app/dist/esm/app/src/api", "SDK_VERSION")
  @js.native
