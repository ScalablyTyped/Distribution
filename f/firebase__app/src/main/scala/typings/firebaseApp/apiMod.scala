...
import typings.firebaseApp.publicTypesMod.FirebaseAppSettings
...
object apiMod {
  ...
  @JSImport("@firebase/app/dist/app/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/app/dist/app/src/api", "FirebaseError")
  @js.native
  ...
  @JSImport("@firebase/app/dist/app/src/api", "SDK_VERSION")
  @js.native
