...
import typings.firebaseApp.distEsmAppSrcPublicTypesMod.FirebaseService
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsmAppTestUtilMod {
  
  @JSImport("@firebase/app/dist/esm/app/test/util", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/app/dist/esm/app/test/util", "TestService")
  @js.native
