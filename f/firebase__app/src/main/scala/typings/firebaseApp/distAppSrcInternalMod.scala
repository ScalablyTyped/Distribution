...
object distAppSrcInternalMod {
  
  @JSImport("@firebase/app/dist/app/src/internal", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/app/dist/app/src/internal", "_DEFAULT_ENTRY_NAME")
  @js.native
  ...
  @JSImport("@firebase/app/dist/app/src/internal", "_apps")
  @js.native
  ...
  @JSImport("@firebase/app/dist/app/src/internal", "_components")
  @js.native
  val components: Map[
    String, 
