...
object moduleCoreMod {
  ...
  */
  ...
  object _Operation {
    ...
    @scala.inline
    def CopyOperation(from: String, op: copy, path: String): typings.fastJsonPatch.moduleCoreMod.CopyOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fastJsonPatch.moduleCoreMod.CopyOperation]
    }
    
    @scala.inline
    def MoveOperation(from: String, op: move, path: String): typings.fastJsonPatch.moduleCoreMod.MoveOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fastJsonPatch.moduleCoreMod.MoveOperation]
    }
    
    @scala.inline
    def RemoveOperation(op: remove, path: String): typings.fastJsonPatch.moduleCoreMod.RemoveOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
