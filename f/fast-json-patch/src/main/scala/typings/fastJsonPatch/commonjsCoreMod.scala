...
import typings.fastJsonPatch.commonjsHelpersMod.JsonPatchErrorName
import typings.fastJsonPatch.commonjsHelpersMod.PatchError
...
object commonjsCoreMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.fastJsonPatch.commonjsCoreMod.AddOperation[scala.Any]
    - typings.fastJsonPatch.commonjsCoreMod.RemoveOperation
    - typings.fastJsonPatch.commonjsCoreMod.ReplaceOperation[scala.Any]
    - typings.fastJsonPatch.commonjsCoreMod.MoveOperation
    - typings.fastJsonPatch.commonjsCoreMod.CopyOperation
    - typings.fastJsonPatch.commonjsCoreMod.TestOperation[scala.Any]
    - typings.fastJsonPatch.commonjsCoreMod.GetOperation[scala.Any]
  */
  ...
  object _Operation {
    ...
    inline def CopyOperation(from: String, path: String): typings.fastJsonPatch.commonjsCoreMod.CopyOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = "copy", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fastJsonPatch.commonjsCoreMod.CopyOperation]
    }
    
    inline def MoveOperation(from: String, path: String): typings.fastJsonPatch.commonjsCoreMod.MoveOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = "move", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fastJsonPatch.commonjsCoreMod.MoveOperation]
    }
    
    inline def RemoveOperation(path: String): typings.fastJsonPatch.commonjsCoreMod.RemoveOperation = {
      val __obj = js.Dynamic.literal(op = "remove", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.fastJsonPatch.commonjsCoreMod.RemoveOperation]
    }
  }
}
