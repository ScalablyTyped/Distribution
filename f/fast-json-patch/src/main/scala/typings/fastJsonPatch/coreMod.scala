...
object coreMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.fastJsonPatch.coreMod.AddOperation[scala.Any]
    - typings.fastJsonPatch.coreMod.RemoveOperation
    - typings.fastJsonPatch.coreMod.ReplaceOperation[scala.Any]
    - typings.fastJsonPatch.coreMod.MoveOperation
    - typings.fastJsonPatch.coreMod.CopyOperation
    - typings.fastJsonPatch.coreMod.TestOperation[scala.Any]
    - typings.fastJsonPatch.coreMod.GetOperation[scala.Any]
  */
