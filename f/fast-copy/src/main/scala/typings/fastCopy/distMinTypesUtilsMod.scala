...
object distMinTypesUtilsMod {
  ...
  @JSImport("fast-copy/dist/min/types/utils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fast-copy/dist/min/types/utils", "createCache")
  @js.native
  ...
  @JSImport("fast-copy/dist/min/types/utils", "getRegExpFlags")
  @js.native
  val getRegExpFlags: js.Function1[/* regExp */ js.RegExp, String] = js.native
  
  @JSImport("fast-copy/dist/min/types/utils", "getTag")
  @js.native
