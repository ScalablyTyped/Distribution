...
object distCjsTypesUtilsMod {
  ...
  @JSImport("fast-copy/dist/cjs/types/utils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fast-copy/dist/cjs/types/utils", "createCache")
  @js.native
  ...
  @JSImport("fast-copy/dist/cjs/types/utils", "getRegExpFlags")
  @js.native
  val getRegExpFlags: js.Function1[/* regExp */ js.RegExp, String] = js.native
  
  @JSImport("fast-copy/dist/cjs/types/utils", "getTag")
  @js.native
