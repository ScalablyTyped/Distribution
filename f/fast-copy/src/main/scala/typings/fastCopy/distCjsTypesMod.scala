...
import typings.fastCopy.distCjsTypesCopierMod.InternalCopier
import typings.fastCopy.distCjsTypesCopierMod.State
...
object distCjsTypesMod {
  ...
  @JSImport("fast-copy/dist/cjs/types", JSImport.Namespace)
  @js.native
