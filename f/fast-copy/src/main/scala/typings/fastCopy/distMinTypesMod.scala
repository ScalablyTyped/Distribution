...
import typings.fastCopy.distMinTypesCopierMod.InternalCopier
import typings.fastCopy.distMinTypesCopierMod.State
...
object distMinTypesMod {
  
  @JSImport("fast-copy/dist/min/types", JSImport.Namespace)
  @js.native
