...
object DictkeyCoupon {
  
  inline def apply(): DictkeyCoupon = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DictkeyCoupon]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DictkeyCoupon] (val x: Self) extends AnyVal {
