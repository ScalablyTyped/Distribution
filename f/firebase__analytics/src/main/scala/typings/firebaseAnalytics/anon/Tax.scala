...
trait Tax
  ...
  var shipping: js.UndefOr[typings.firebaseAnalytics.publicTypesMod.Currency] = js.undefined
  
  var tax: js.UndefOr[typings.firebaseAnalytics.publicTypesMod.Currency] = js.undefined
...
object Tax {
  ...
  extension [Self <: Tax](x: Self) {
    ...
    inline def setShipping(value: typings.firebaseAnalytics.publicTypesMod.Currency): Self = StObject.set(x, "shipping", value.asInstanceOf[js.Any])
    
    inline def setShippingUndefined: Self = StObject.set(x, "shipping", js.undefined)
    
    inline def setTax(value: typings.firebaseAnalytics.publicTypesMod.Currency): Self = StObject.set(x, "tax", value.asInstanceOf[js.Any])
