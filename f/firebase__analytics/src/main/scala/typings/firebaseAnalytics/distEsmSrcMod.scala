...
import typings.firebaseAnalytics.distEsmSrcApiMod.CustomEventName
import typings.firebaseAnalytics.distEsmSrcPublicTypesMod.Analytics
...
import typings.firebaseAnalytics.distEsmSrcPublicTypesMod.SettingsOptions
