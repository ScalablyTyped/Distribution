...
import typings.firebaseAnalytics.mod.ConsentStatusString
import typings.firebaseAnalytics.mod.EventNameString
import typings.firebaseAnalytics.srcConstantsMod.GtagCommand
import typings.firebaseAnalytics.srcErrorsMod.AnalyticsError
...
object firebaseAnalyticsStrings {
  ...
  sealed trait add_payment_info
    extends StObject
       ...
       with typings.firebaseAnalytics.srcPublicTypesMod.EventNameString
       with typings.firebaseAnalytics.analyticsMod.EventNameString
       with typings.firebaseAnalytics.publicTypesMod.EventNameString
  ...
  sealed trait `already-exists`
    extends StObject
       with AnalyticsError
       with typings.firebaseAnalytics.errorsMod.AnalyticsError
  ...
  sealed trait config
    extends StObject
       with GtagCommand
       with typings.firebaseAnalytics.constantsMod.GtagCommand
  ...
  sealed trait denied
    extends StObject
       ...
       with typings.firebaseAnalytics.srcPublicTypesMod.ConsentStatusString
       with typings.firebaseAnalytics.analyticsMod.ConsentStatusString
       with typings.firebaseAnalytics.publicTypesMod.ConsentStatusString
