...
object distSrcFunctionsMod {
  
  @JSImport("@firebase/analytics/dist/src/functions", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/analytics/dist/src/functions", "defaultConsentSettingsForInit")
  @js.native
  ...
  @JSImport("@firebase/analytics/dist/src/functions", "defaultEventParametersForInit")
  @js.native
