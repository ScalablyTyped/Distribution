...
import typings.formatjsIntlNumberformat.typesMod.NumberFormatOptionsLocaleMatcher
import typings.formatjsIntlNumberformat.typesMod.NumberFormatOptionsNotation
import typings.formatjsIntlNumberformat.typesMod.NumberFormatOptionsSignDisplay
...
trait NumberFormatOptions extends js.Object {
  var compactDisplay: js.UndefOr[NumberFormatOptionsCompactDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsCompactDisplay] = js.native
  var currency: js.UndefOr[String] = js.native
  var currencyDisplay: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsCurrencyDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsCurrencyDisplay] = js.native
  var currencySign: js.UndefOr[NumberFormatOptionsCurrencySign] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsCurrencySign] = js.native
  var localeMatcher: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsLocaleMatcher] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsLocaleMatcher] = js.native
  ...
  var notation: js.UndefOr[NumberFormatOptionsNotation] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsNotation] = js.native
  var numberingSystem: js.UndefOr[String] = js.native
  var signDisplay: js.UndefOr[NumberFormatOptionsSignDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsSignDisplay] = js.native
  var style: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsStyle] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsStyle] = js.native
  var unit: js.UndefOr[String] = js.native
  var unitDisplay: js.UndefOr[NumberFormatOptionsUnitDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsUnitDisplay] = js.native
...
object NumberFormatOptions {
  @scala.inline
  def apply(
    currencyDisplay: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsCurrencyDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsCurrencyDisplay],
    localeMatcher: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsLocaleMatcher] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsLocaleMatcher],
    notation: js.UndefOr[NumberFormatOptionsNotation] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsNotation],
    style: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsStyle] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsStyle]
  ): NumberFormatOptions = {
  ...
  implicit class NumberFormatOptionsOps[Self <: NumberFormatOptions] (val x: Self) extends AnyVal {
    ...
    def setCurrencyDisplay(
      value: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsCurrencyDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsCurrencyDisplay]
    ): Self = this.set("currencyDisplay", value.asInstanceOf[js.Any])
    @scala.inline
    def setLocaleMatcher(
      value: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsLocaleMatcher] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsLocaleMatcher]
    ): Self = this.set("localeMatcher", value.asInstanceOf[js.Any])
    @scala.inline
    def setNotation(
      value: js.UndefOr[NumberFormatOptionsNotation] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsNotation]
    ): Self = this.set("notation", value.asInstanceOf[js.Any])
    @scala.inline
    def setStyle(
      value: js.UndefOr[String] with js.UndefOr[NumberFormatOptionsStyle] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsStyle]
    ): Self = this.set("style", value.asInstanceOf[js.Any])
    @scala.inline
    def setCompactDisplay(
      value: js.UndefOr[NumberFormatOptionsCompactDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsCompactDisplay]
    ...
    @scala.inline
    def setCurrencySign(
      value: js.UndefOr[NumberFormatOptionsCurrencySign] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsCurrencySign]
    ...
    @scala.inline
    def setSignDisplay(
      value: js.UndefOr[NumberFormatOptionsSignDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsSignDisplay]
    ...
    @scala.inline
    def setUnitDisplay(
      value: js.UndefOr[NumberFormatOptionsUnitDisplay] with js.UndefOr[typings.formatjsIntlNumberformat.mod.NumberFormatOptionsUnitDisplay]
