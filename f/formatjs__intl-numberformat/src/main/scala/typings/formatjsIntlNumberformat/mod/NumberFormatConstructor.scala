...
trait NumberFormatConstructor
  extends Instantiable0[NumberFormat2]
     ...
     with Instantiable2[
      ...
      /* options */ typings.formatjsIntlNumberformat.anon.NumberFormatOptions, 
      NumberFormat2
    ] {
  ...
  def apply(locales: String, options: typings.formatjsIntlNumberformat.anon.NumberFormatOptions): NumberFormat2 = js.native
  def apply(locales: js.Array[String]): NumberFormat2 = js.native
  def apply(locales: js.Array[String], options: typings.formatjsIntlNumberformat.anon.NumberFormatOptions): NumberFormat2 = js.native
