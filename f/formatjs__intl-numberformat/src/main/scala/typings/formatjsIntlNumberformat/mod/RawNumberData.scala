...
import typings.formatjsIntlNumberformat.anon.Long
...
trait RawNumberData extends js.Object {
  ...
  var decimal: Record[NumberingSystem, Long] = js.native
...
object RawNumberData {
  ...
  def apply(
    ...
    decimal: Record[NumberingSystem, Long],
    nu: js.Array[String],
  ...
  implicit class RawNumberDataOps[Self <: RawNumberData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDecimal(value: Record[NumberingSystem, Long]): Self = this.set("decimal", value.asInstanceOf[js.Any])
    @scala.inline
