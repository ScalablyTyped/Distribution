...
import typings.formatjsIntlUtils.mod.NumberFormatDigitInternalSlots
...
object NumberFormatInternal {
  ...
  implicit class NumberFormatInternalOps[Self <: NumberFormatInternal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundFormat(value: /* value */ Double => String): Self = this.set("boundFormat", js.Any.fromFunction1(value))
    @scala.inline
