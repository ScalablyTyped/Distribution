...
/* Inlined std.Intl.ResolvedNumberFormatOptions & std.Pick<@formatjs/intl-numberformat.@formatjs/intl-numberformat/src/types.NumberFormatInternal, 'currencySign' | 'unit' | 'unitDisplay' | 'notation' | 'compactDisplay' | 'signDisplay'> */
@js.native
