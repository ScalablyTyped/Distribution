...
trait PaymentReconciliationDetail
  ...
  /**
    ...
    */
  var responce: js.UndefOr[Reference] = js.undefined
...
object PaymentReconciliationDetail {
  ...
  inline def apply(`type`: Coding): PaymentReconciliationDetail = {
  ...
  implicit open class MutableBuilder[Self <: PaymentReconciliationDetail] (val x: Self) extends AnyVal {
    ...
    inline def setResponce(value: Reference): Self = StObject.set(x, "responce", value.asInstanceOf[js.Any])
    
    inline def setResponceUndefined: Self = StObject.set(x, "responce", js.undefined)
