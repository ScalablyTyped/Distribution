...
trait DeviceMetric
  ...
  /**
    ...
    */
  var operationalStatus: js.UndefOr[on | off | standby] = js.undefined
...
object DeviceMetric {
  ...
  implicit open class MutableBuilder[Self <: DeviceMetric] (val x: Self) extends AnyVal {
    ...
    inline def setOperationalStatus(value: on | off | standby): Self = StObject.set(x, "operationalStatus", value.asInstanceOf[js.Any])
