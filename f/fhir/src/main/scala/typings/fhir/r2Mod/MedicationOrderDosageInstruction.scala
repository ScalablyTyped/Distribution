...
trait MedicationOrderDosageInstruction
  extends StObject
...
object MedicationOrderDosageInstruction {
  
  inline def apply(): MedicationOrderDosageInstruction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MedicationOrderDosageInstruction]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MedicationOrderDosageInstruction] (val x: Self) extends AnyVal {
