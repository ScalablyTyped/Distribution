...
trait CarePlan
  ...
  /**
    ...
    */
  var intent: proposal | plan | order_ | option | directive
...
object CarePlan {
  ...
  implicit open class MutableBuilder[Self <: CarePlan] (val x: Self) extends AnyVal {
    ...
    inline def setAddresses(value: js.Array[CodeableReference]): Self = StObject.set(x, "addresses", value.asInstanceOf[js.Any])
    ...
    inline def setIntent(value: proposal | plan | order_ | option | directive): Self = StObject.set(x, "intent", value.asInstanceOf[js.Any])
