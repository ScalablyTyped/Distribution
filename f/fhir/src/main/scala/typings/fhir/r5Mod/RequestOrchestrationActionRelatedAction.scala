...
trait RequestOrchestrationActionRelatedAction
  extends StObject
...
object RequestOrchestrationActionRelatedAction {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[RequestOrchestrationActionRelatedAction]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestOrchestrationActionRelatedAction] (val x: Self) extends AnyVal {
