...
trait ProvenanceEntity
  ...
  /**
    ...
    */
  var role: revision | quotation | source | instantiates | removal
...
object ProvenanceEntity {
  ...
  inline def apply(role: revision | quotation | source | instantiates | removal, what: Reference): ProvenanceEntity = {
  ...
  implicit open class MutableBuilder[Self <: ProvenanceEntity] (val x: Self) extends AnyVal {
    ...
    inline def setRole(value: revision | quotation | source | instantiates | removal): Self = StObject.set(x, "role", value.asInstanceOf[js.Any])
