...
trait PermissionRuleDataResource
  extends StObject
...
object PermissionRuleDataResource {
  
  inline def apply(meaning: instance | related | dependents | authoredby, reference: Reference): PermissionRuleDataResource = {
    val __obj = js.Dynamic.literal(meaning = meaning.asInstanceOf[js.Any], reference = reference.asInstanceOf[js.Any])
    __obj.asInstanceOf[PermissionRuleDataResource]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PermissionRuleDataResource] (val x: Self) extends AnyVal {
