...
trait PackagedProductDefinitionPackagingProperty
  extends StObject
...
object PackagedProductDefinitionPackagingProperty {
  
  inline def apply(`type`: CodeableConcept): PackagedProductDefinitionPackagingProperty = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[PackagedProductDefinitionPackagingProperty]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PackagedProductDefinitionPackagingProperty] (val x: Self) extends AnyVal {
