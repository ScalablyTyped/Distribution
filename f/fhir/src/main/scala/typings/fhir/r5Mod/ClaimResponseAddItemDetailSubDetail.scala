...
trait ClaimResponseAddItemDetailSubDetail
  extends StObject
...
object ClaimResponseAddItemDetailSubDetail {
  
  inline def apply(adjudication: js.Array[ClaimResponseItemAdjudication], productOrService: CodeableConcept): ClaimResponseAddItemDetailSubDetail = {
    ...
    __obj.asInstanceOf[ClaimResponseAddItemDetailSubDetail]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ClaimResponseAddItemDetailSubDetail] (val x: Self) extends AnyVal {
