...
trait ClaimResponseAddItemBodySite
  extends StObject
...
object ClaimResponseAddItemBodySite {
  
  inline def apply(site: js.Array[CodeableReference]): ClaimResponseAddItemBodySite = {
    val __obj = js.Dynamic.literal(site = site.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClaimResponseAddItemBodySite]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ClaimResponseAddItemBodySite] (val x: Self) extends AnyVal {
