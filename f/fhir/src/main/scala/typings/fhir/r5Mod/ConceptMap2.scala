...
trait ConceptMap2
  ...
  /**
    ...
    */
  var group: js.UndefOr[js.Array[ConceptMap2Group]] = js.undefined
  ...
  @JSName("resourceType")
  val resourceType_ConceptMap2: typings.fhir.fhirStrings.ConceptMap2
...
object ConceptMap2 {
  ...
  inline def apply(status: draft | active | retired | unknown): ConceptMap2 = {
    val __obj = js.Dynamic.literal(resourceType = "ConceptMap2", status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[ConceptMap2]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ConceptMap2] (val x: Self) extends AnyVal {
    ...
    inline def setGroup(value: js.Array[ConceptMap2Group]): Self = StObject.set(x, "group", value.asInstanceOf[js.Any])
    
    inline def setGroupUndefined: Self = StObject.set(x, "group", js.undefined)
    
    inline def setGroupVarargs(value: ConceptMap2Group*): Self = StObject.set(x, "group", js.Array(value*))
    ...
    inline def setResourceType(value: typings.fhir.fhirStrings.ConceptMap2): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
