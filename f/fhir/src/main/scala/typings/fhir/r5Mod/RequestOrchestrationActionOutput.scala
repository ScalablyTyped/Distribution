...
trait RequestOrchestrationActionOutput
  extends StObject
...
object RequestOrchestrationActionOutput {
  
  inline def apply(): RequestOrchestrationActionOutput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RequestOrchestrationActionOutput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestOrchestrationActionOutput] (val x: Self) extends AnyVal {
