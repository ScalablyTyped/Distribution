...
trait TriggerDefinition
  ...
  var _subscriptionTopic: js.UndefOr[Element] = js.undefined
  ...
  /**
    ...
    */
  var subscriptionTopic: js.UndefOr[String] = js.undefined
...
object TriggerDefinition {
  ...
  implicit open class MutableBuilder[Self <: TriggerDefinition] (val x: Self) extends AnyVal {
    ...
    inline def setSubscriptionTopic(value: String): Self = StObject.set(x, "subscriptionTopic", value.asInstanceOf[js.Any])
    
    inline def setSubscriptionTopicUndefined: Self = StObject.set(x, "subscriptionTopic", js.undefined)
    ...
    inline def set_subscriptionTopic(value: Element): Self = StObject.set(x, "_subscriptionTopic", value.asInstanceOf[js.Any])
    
    inline def set_subscriptionTopicUndefined: Self = StObject.set(x, "_subscriptionTopic", js.undefined)
