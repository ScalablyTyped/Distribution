...
trait ConceptMapGroupElementTargetProperty
  extends StObject
...
object ConceptMapGroupElementTargetProperty {
  
  inline def apply(code: String): ConceptMapGroupElementTargetProperty = {
    val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any])
    __obj.asInstanceOf[ConceptMapGroupElementTargetProperty]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ConceptMapGroupElementTargetProperty] (val x: Self) extends AnyVal {
