...
{{{
type FhirResource = fhir.fhir/r5.Account | fhir.fhir/r5.ActivityDefinition | fhir.fhir/r5.AdministrableProductDefinition | fhir.fhir/r5.AdverseEvent | fhir.fhir/r5.AllergyIntolerance | fhir.fhir/r5.Appointment | fhir.fhir/r5.AppointmentResponse | fhir.fhir/r5.ArtifactAssessment | fhir.fhir/r5.AuditEvent | fhir.fhir/r5.Basic | fhir.fhir/r5.Binary | fhir.fhir/r5.BiologicallyDerivedProduct | fhir.fhir/r5.BodyStructure | fhir.fhir/r5.Bundle<fhir.fhir/r5.FhirResource> | fhir.fhir/r5.CapabilityStatement | fhir.fhir/r5.CapabilityStatement2 | fhir.fhir/r5.CarePlan | fhir.fhir/r5.CareTeam | fhir.fhir/r5.ChargeItem | fhir.fhir/r5.ChargeItemDefinition | fhir.fhir/r5.Citation | fhir.fhir/r5.Claim | fhir.fhir/r5.ClaimResponse | fhir.fhir/r5.ClinicalImpression | fhir.fhir/r5.ClinicalUseDefinition | fhir.fhir/r5.ClinicalUseIssue | fhir.fhir/r5.CodeSystem | fhir.fhir/r5.Communication | fhir.fhir/r5.CommunicationRequest | fhir.fhir/r5.CompartmentDefinition | fhir.fhir/r5.Composition | fhir.fhir/r5.ConceptMap | fhir.fhir/r5.ConceptMap2 | fhir.fhir/r5.Condition | fhir.fhir/r5.ConditionDefinition | fhir.fhir/r5.Consent | fhir.fhir/r5.Contract | fhir.fhir/r5.Coverage | fhir.fhir/r5.CoverageEligibilityRequest | fhir.fhir/r5.CoverageEligibilityResponse | fhir.fhir/r5.DetectedIssue | fhir.fhir/r5.Device | fhir.fhir/r5.DeviceDefinition | fhir.fhir/r5.DeviceDispense | fhir.fhir/r5.DeviceMetric | fhir.fhir/r5.DeviceRequest | fhir.fhir/r5.DeviceUsage | fhir.fhir/r5.DiagnosticReport | fhir.fhir/r5.DocumentManifest | fhir.fhir/r5.DocumentReference | fhir.fhir/r5.Encounter | fhir.fhir/r5.Endpoint | fhir.fhir/r5.EnrollmentRequest | fhir.fhir/r5.EnrollmentResponse | fhir.fhir/r5.EpisodeOfCare | fhir.fhir/r5.EventDefinition | fhir.fhir/r5.Evidence | fhir.fhir/r5.EvidenceReport | fhir.fhir/r5.EvidenceVariable | fhir.fhir/r5.ExampleScenario | fhir.fhir/r5.ExplanationOfBenefit | fhir.fhir/r5.FamilyMemberHistory | fhir.fhir/r5.Flag | fhir.fhir/r5.Goal | fhir.fhir/r5.GraphDefinition | fhir.fhir/r5.Group | fhir.fhir/r5.GuidanceResponse | fhir.fhir/r5.HealthcareService | fhir.fhir/r5.ImagingSelection | fhir.fhir/r5.ImagingStudy | fhir.fhir/r5.Immunization | fhir.fhir/r5.ImmunizationEvaluation | fhir.fhir/r5.ImmunizationRecommendation | fhir.fhir/r5.ImplementationGuide | fhir.fhir/r5.Ingredient | fhir.fhir/r5.InsurancePlan | fhir.fhir/r5.InventoryReport | fhir.fhir/r5.Invoice | fhir.fhir/r5.Library | fhir.fhir/r5.Linkage | fhir.fhir/r5.List | fhir.fhir/r5.Location | fhir.fhir/r5.ManufacturedItemDefinition | fhir.fhir/r5.Measure | fhir.fhir/r5.MeasureReport | fhir.fhir/r5.Medication | fhir.fhir/r5.MedicationAdministration | fhir.fhir/r5.MedicationDispense | fhir.fhir/r5.MedicationKnowledge | fhir.fhir/r5.MedicationRequest | fhir.fhir/r5.MedicationUsage | fhir.fhir/r5.MedicinalProductDefinition | fhir.fhir/r5.MessageDefinition | fhir.fhir/r5.MessageHeader | fhir.fhir/r5.MolecularSequence | fhir.fhir/r5.NamingSystem | fhir.fhir/r5.NutritionIntake | fhir.fhir/r5.NutritionOrder | fhir.fhir/r5.NutritionProduct | fhir.fhir/r5.Observation | fhir.fhir/r5.ObservationDefinition | fhir.fhir/r5.OperationDefinition | fhir.fhir/r5.OperationOutcome | fhir.fhir/r5.Organization | fhir.fhir/r5.OrganizationAffiliation | fhir.fhir/r5.PackagedProductDefinition | fhir.fhir/r5.Parameters | fhir.fhir/r5.Patient | fhir.fhir/r5.PaymentNotice | fhir.fhir/r5.PaymentReconciliation | fhir.fhir/r5.Permission | fhir.fhir/r5.Person | fhir.fhir/r5.PlanDefinition | fhir.fhir/r5.Practitioner | fhir.fhir/r5.PractitionerRole | fhir.fhir/r5.Procedure | fhir.fhir/r5.Provenance | fhir.fhir/r5.Questionnaire | fhir.fhir/r5.QuestionnaireResponse | fhir.fhir/r5.RegulatedAuthorization | fhir.fhir/r5.RelatedPerson | fhir.fhir/r5.RequestGroup | fhir.fhir/r5.ResearchStudy | fhir.fhir/r5.ResearchSubject | fhir.fhir/r5.RiskAssessment | fhir.fhir/r5.Schedule | fhir.fhir/r5.SearchParameter | fhir.fhir/r5.ServiceRequest | fhir.fhir/r5.Slot | fhir.fhir/r5.Specimen | fhir.fhir/r5.SpecimenDefinition | fhir.fhir/r5.StructureDefinition | fhir.fhir/r5.StructureMap | fhir.fhir/r5.Subscription | fhir.fhir/r5.SubscriptionStatus | fhir.fhir/r5.SubscriptionTopic | fhir.fhir/r5.Substance | fhir.fhir/r5.SubstanceDefinition | fhir.fhir/r5.SubstanceNucleicAcid | fhir.fhir/r5.SubstancePolymer | fhir.fhir/r5.SubstanceProtein | fhir.fhir/r5.SubstanceReferenceInformation | fhir.fhir/r5.SubstanceSourceMaterial | fhir.fhir/r5.SupplyDelivery | fhir.fhir/r5.SupplyRequest | fhir.fhir/r5.Task | fhir.fhir/r5.TerminologyCapabilities | fhir.fhir/r5.TestReport | fhir.fhir/r5.TestScript | fhir.fhir/r5.ValueSet | fhir.fhir/r5.VerificationResult | fhir.fhir/r5.VisionPrescription
}}}
