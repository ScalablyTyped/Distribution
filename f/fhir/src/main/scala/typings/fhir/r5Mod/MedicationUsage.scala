...
trait MedicationUsage
  ...
  @JSName("resourceType")
  val resourceType_MedicationUsage: typings.fhir.fhirStrings.MedicationUsage
...
object MedicationUsage {
  ...
  extension [Self <: MedicationUsage](x: Self) {
    ...
    inline def setResourceType(value: typings.fhir.fhirStrings.MedicationUsage): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
