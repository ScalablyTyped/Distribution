...
trait ExplanationOfBenefitItemBodySite
  extends StObject
...
object ExplanationOfBenefitItemBodySite {
  
  inline def apply(site: js.Array[CodeableReference]): ExplanationOfBenefitItemBodySite = {
    val __obj = js.Dynamic.literal(site = site.asInstanceOf[js.Any])
    __obj.asInstanceOf[ExplanationOfBenefitItemBodySite]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ExplanationOfBenefitItemBodySite] (val x: Self) extends AnyVal {
