...
trait TestReportSetupActionAssertRequirement
  extends StObject
...
object TestReportSetupActionAssertRequirement {
  
  inline def apply(): TestReportSetupActionAssertRequirement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TestReportSetupActionAssertRequirement]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TestReportSetupActionAssertRequirement] (val x: Self) extends AnyVal {
