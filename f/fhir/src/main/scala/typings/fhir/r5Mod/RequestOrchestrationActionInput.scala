...
trait RequestOrchestrationActionInput
  extends StObject
...
object RequestOrchestrationActionInput {
  
  inline def apply(): RequestOrchestrationActionInput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RequestOrchestrationActionInput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestOrchestrationActionInput] (val x: Self) extends AnyVal {
