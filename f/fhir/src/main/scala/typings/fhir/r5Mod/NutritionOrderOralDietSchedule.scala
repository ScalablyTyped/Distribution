...
trait NutritionOrderOralDietSchedule
  extends StObject
...
object NutritionOrderOralDietSchedule {
  
  inline def apply(): NutritionOrderOralDietSchedule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NutritionOrderOralDietSchedule]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NutritionOrderOralDietSchedule] (val x: Self) extends AnyVal {
