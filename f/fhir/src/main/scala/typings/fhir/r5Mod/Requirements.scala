...
trait Requirements
  ...
  var _actor: js.UndefOr[js.Array[Element]] = js.undefined
  ...
  @JSName("resourceType")
  val resourceType_Requirements: typings.fhir.fhirStrings.Requirements
  
  /**
    * The actual statement of requirement, in markdown format.
    */
  var statement: js.UndefOr[js.Array[RequirementsStatement]] = js.undefined
...
object Requirements {
  ...
  inline def apply(status: draft | active | retired | unknown): Requirements = {
  ...
  implicit open class MutableBuilder[Self <: Requirements] (val x: Self) extends AnyVal {
    ...
    inline def setResourceType(value: typings.fhir.fhirStrings.Requirements): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
    
    inline def setStatement(value: js.Array[RequirementsStatement]): Self = StObject.set(x, "statement", value.asInstanceOf[js.Any])
    
    inline def setStatementUndefined: Self = StObject.set(x, "statement", js.undefined)
    
    inline def setStatementVarargs(value: RequirementsStatement*): Self = StObject.set(x, "statement", js.Array(value*))
    ...
    inline def set_actor(value: js.Array[Element]): Self = StObject.set(x, "_actor", value.asInstanceOf[js.Any])
    
    inline def set_actorUndefined: Self = StObject.set(x, "_actor", js.undefined)
    
    inline def set_actorVarargs(value: Element*): Self = StObject.set(x, "_actor", js.Array(value*))
