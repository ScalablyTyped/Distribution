...
object TransportRestriction {
  
  inline def apply(): TransportRestriction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TransportRestriction]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TransportRestriction] (val x: Self) extends AnyVal {
