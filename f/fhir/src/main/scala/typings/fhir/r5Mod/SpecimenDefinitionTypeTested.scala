...
trait SpecimenDefinitionTypeTested
  ...
  var _singleUse: js.UndefOr[Element] = js.undefined
  ...
  /**
    ...
    */
  var singleUse: js.UndefOr[Boolean] = js.undefined
  
  /**
    * Where the specimen will be tested: e.g., lab, sector, device or any combination of these.
    */
  var testingDestination: js.UndefOr[js.Array[CodeableConcept]] = js.undefined
...
object SpecimenDefinitionTypeTested {
  ...
  extension [Self <: SpecimenDefinitionTypeTested](x: Self) {
    ...
    inline def setTestingDestination(value: js.Array[CodeableConcept]): Self = StObject.set(x, "testingDestination", value.asInstanceOf[js.Any])
    
    inline def setTestingDestinationUndefined: Self = StObject.set(x, "testingDestination", js.undefined)
    
    inline def setTestingDestinationVarargs(value: CodeableConcept*): Self = StObject.set(x, "testingDestination", js.Array(value*))
    ...
    inline def set_singleUse(value: Element): Self = StObject.set(x, "_singleUse", value.asInstanceOf[js.Any])
    
    inline def set_singleUseUndefined: Self = StObject.set(x, "_singleUse", js.undefined)
  }
}
