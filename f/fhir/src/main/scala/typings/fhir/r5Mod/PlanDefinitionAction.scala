...
trait PlanDefinitionAction
  ...
  /**
    ...
    */
  var output: js.UndefOr[js.Array[PlanDefinitionActionOutput]] = js.undefined
...
object PlanDefinitionAction {
  ...
  extension [Self <: PlanDefinitionAction](x: Self) {
    ...
    inline def setInput(value: js.Array[PlanDefinitionActionInput]): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
    
    inline def setInputUndefined: Self = StObject.set(x, "input", js.undefined)
    
    inline def setInputVarargs(value: PlanDefinitionActionInput*): Self = StObject.set(x, "input", js.Array(value*))
    ...
    inline def setOutput(value: js.Array[PlanDefinitionActionOutput]): Self = StObject.set(x, "output", value.asInstanceOf[js.Any])
    
    inline def setOutputUndefined: Self = StObject.set(x, "output", js.undefined)
    
    inline def setOutputVarargs(value: PlanDefinitionActionOutput*): Self = StObject.set(x, "output", js.Array(value*))
