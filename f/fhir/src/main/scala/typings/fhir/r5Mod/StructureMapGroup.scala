...
trait StructureMapGroup
  ...
  /**
    ...
    */
  var typeMode: js.UndefOr[types | `type-and-types`] = js.undefined
}
object StructureMapGroup {
  
  inline def apply(input: js.Array[StructureMapGroupInput], name: String): StructureMapGroup = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StructureMapGroup] (val x: Self) extends AnyVal {
    ...
    inline def setTypeMode(value: types | `type-and-types`): Self = StObject.set(x, "typeMode", value.asInstanceOf[js.Any])
    
    inline def setTypeModeUndefined: Self = StObject.set(x, "typeMode", js.undefined)
