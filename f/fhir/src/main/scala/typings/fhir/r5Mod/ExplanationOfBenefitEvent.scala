...
trait ExplanationOfBenefitEvent
  extends StObject
...
object ExplanationOfBenefitEvent {
  
  inline def apply(`type`: CodeableConcept): ExplanationOfBenefitEvent = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ExplanationOfBenefitEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ExplanationOfBenefitEvent] (val x: Self) extends AnyVal {
