...
trait ExplanationOfBenefitItemReviewOutcome
  extends StObject
...
object ExplanationOfBenefitItemReviewOutcome {
  
  inline def apply(): ExplanationOfBenefitItemReviewOutcome = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExplanationOfBenefitItemReviewOutcome]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ExplanationOfBenefitItemReviewOutcome] (val x: Self) extends AnyVal {
