...
object ClaimResponseEvent {
  
  inline def apply(`type`: CodeableConcept): ClaimResponseEvent = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClaimResponseEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ClaimResponseEvent] (val x: Self) extends AnyVal {
