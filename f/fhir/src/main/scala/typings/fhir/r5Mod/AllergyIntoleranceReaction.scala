...
trait AllergyIntoleranceReaction
  ...
  /**
    ...
    */
  var manifestation: js.Array[CodeableReference]
...
object AllergyIntoleranceReaction {
  ...
  inline def apply(manifestation: js.Array[CodeableReference]): AllergyIntoleranceReaction = {
  ...
  implicit open class MutableBuilder[Self <: AllergyIntoleranceReaction] (val x: Self) extends AnyVal {
    ...
    inline def setManifestation(value: js.Array[CodeableReference]): Self = StObject.set(x, "manifestation", value.asInstanceOf[js.Any])
    
    inline def setManifestationVarargs(value: CodeableReference*): Self = StObject.set(x, "manifestation", js.Array(value*))
