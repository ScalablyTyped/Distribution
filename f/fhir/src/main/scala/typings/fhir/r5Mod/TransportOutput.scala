...
object TransportOutput {
  
  inline def apply(`type`: CodeableConcept): TransportOutput = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[TransportOutput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TransportOutput] (val x: Self) extends AnyVal {
