...
trait CoverageEligibilityRequestEvent
  extends StObject
...
object CoverageEligibilityRequestEvent {
  
  inline def apply(`type`: CodeableConcept): CoverageEligibilityRequestEvent = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[CoverageEligibilityRequestEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CoverageEligibilityRequestEvent] (val x: Self) extends AnyVal {
