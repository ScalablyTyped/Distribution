...
trait ValueSetExpansionContainsPropertySubProperty
  extends StObject
...
object ValueSetExpansionContainsPropertySubProperty {
  
  inline def apply(code: String): ValueSetExpansionContainsPropertySubProperty = {
    val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any])
    __obj.asInstanceOf[ValueSetExpansionContainsPropertySubProperty]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ValueSetExpansionContainsPropertySubProperty] (val x: Self) extends AnyVal {
