...
trait SpecimenCollection
  ...
  /**
    ...
    */
  var device: js.UndefOr[CodeableReference] = js.undefined
  ...
  /**
    ...
    */
  var procedure: js.UndefOr[Reference] = js.undefined
...
object SpecimenCollection {
  ...
  extension [Self <: SpecimenCollection](x: Self) {
    ...
    inline def setProcedure(value: Reference): Self = StObject.set(x, "procedure", value.asInstanceOf[js.Any])
