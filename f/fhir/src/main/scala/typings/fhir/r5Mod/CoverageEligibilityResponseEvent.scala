...
trait CoverageEligibilityResponseEvent
  extends StObject
...
object CoverageEligibilityResponseEvent {
  
  inline def apply(`type`: CodeableConcept): CoverageEligibilityResponseEvent = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[CoverageEligibilityResponseEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CoverageEligibilityResponseEvent] (val x: Self) extends AnyVal {
