...
trait AvailabilityAvailableTime
  extends StObject
     with Element {
...
object AvailabilityAvailableTime {
  
  inline def apply(): AvailabilityAvailableTime = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AvailabilityAvailableTime]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AvailabilityAvailableTime] (val x: Self) extends AnyVal {
