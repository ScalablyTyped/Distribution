...
trait RequestOrchestrationActionCondition
  extends StObject
...
object RequestOrchestrationActionCondition {
  
  inline def apply(kind: applicability | start | stop): RequestOrchestrationActionCondition = {
    val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestOrchestrationActionCondition]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestOrchestrationActionCondition] (val x: Self) extends AnyVal {
