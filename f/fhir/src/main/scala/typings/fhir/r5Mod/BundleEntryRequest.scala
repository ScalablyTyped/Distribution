...
import typings.fhir.fhirStrings.HEAD
import typings.fhir.fhirStrings.PATCH
...
trait BundleEntryRequest
  ...
  /**
    ...
    */
  var method: GET | HEAD | POST | PUT | DELETE | PATCH
...
object BundleEntryRequest {
  ...
  inline def apply(method: GET | HEAD | POST | PUT | DELETE | PATCH, url: String): BundleEntryRequest = {
  ...
  implicit open class MutableBuilder[Self <: BundleEntryRequest] (val x: Self) extends AnyVal {
    ...
    inline def setMethod(value: GET | HEAD | POST | PUT | DELETE | PATCH): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
