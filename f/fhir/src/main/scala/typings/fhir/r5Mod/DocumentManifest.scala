...
trait DocumentManifest
  ...
  /**
    ...
    */
  var content: js.Array[Reference]
...
object DocumentManifest {
  ...
  inline def apply(content: js.Array[Reference], status: current | superseded | `entered-in-error`): DocumentManifest = {
  ...
  extension [Self <: DocumentManifest](x: Self) {
    ...
    inline def setContent(value: js.Array[Reference]): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    
    inline def setContentVarargs(value: Reference*): Self = StObject.set(x, "content", js.Array(value*))
