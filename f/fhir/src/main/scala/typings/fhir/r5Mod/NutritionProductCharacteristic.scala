...
trait NutritionProductCharacteristic
  extends StObject
...
object NutritionProductCharacteristic {
  
  inline def apply(`type`: CodeableConcept): NutritionProductCharacteristic = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[NutritionProductCharacteristic]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NutritionProductCharacteristic] (val x: Self) extends AnyVal {
