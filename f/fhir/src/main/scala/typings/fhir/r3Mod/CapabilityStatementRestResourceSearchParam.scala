...
object CapabilityStatementRestResourceSearchParam {
  ...
  inline def apply(name: String, `type`: number | date | string | token | reference | composite | quantity_ | uri): CapabilityStatementRestResourceSearchParam = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CapabilityStatementRestResourceSearchParam] (val x: Self) extends AnyVal {
