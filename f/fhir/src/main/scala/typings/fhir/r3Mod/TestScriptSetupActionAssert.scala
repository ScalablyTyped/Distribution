...
trait TestScriptSetupActionAssert
  ...
  /**
    ...
    */
  var requestMethod: js.UndefOr[delete_ | get_ | options | patch_ | post_ | put_] = js.undefined
...
object TestScriptSetupActionAssert {
  ...
  implicit open class MutableBuilder[Self <: TestScriptSetupActionAssert] (val x: Self) extends AnyVal {
    ...
    inline def setRequestMethod(value: delete_ | get_ | options | patch_ | post_ | put_): Self = StObject.set(x, "requestMethod", value.asInstanceOf[js.Any])
