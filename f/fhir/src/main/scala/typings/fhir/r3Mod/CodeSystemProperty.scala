...
trait CodeSystemProperty
  ...
  /**
    ...
    */
  var `type`: code | typings.fhir.fhirStrings.Coding | string | integer | boolean | dateTime
...
object CodeSystemProperty {
  ...
  inline def apply(
    code: String,
    `type`: code | typings.fhir.fhirStrings.Coding | string | integer | boolean | dateTime
  ): CodeSystemProperty = {
  ...
  extension [Self <: CodeSystemProperty](x: Self) {
    ...
    inline def setType(value: code | typings.fhir.fhirStrings.Coding | string | integer | boolean | dateTime): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
