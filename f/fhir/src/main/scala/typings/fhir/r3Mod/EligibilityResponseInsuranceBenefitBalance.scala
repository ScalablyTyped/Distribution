...
object EligibilityResponseInsuranceBenefitBalance {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EligibilityResponseInsuranceBenefitBalance] (val x: Self) extends AnyVal {
    ...
    inline def setFinancialVarargs(value: EligibilityResponseInsuranceBenefitBalanceFinancial*): Self = StObject.set(x, "financial", js.Array(value*))
