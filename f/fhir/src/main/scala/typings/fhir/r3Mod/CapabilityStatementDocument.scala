...
object CapabilityStatementDocument {
  ...
  inline def apply(mode: producer | consumer, profile: Reference): CapabilityStatementDocument = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CapabilityStatementDocument] (val x: Self) extends AnyVal {
