...
trait StructureDefinition
  ...
  /**
    ...
    */
  var contextType: js.UndefOr[resource | datatype | `extension`] = js.undefined
...
object StructureDefinition {
  ...
  implicit open class MutableBuilder[Self <: StructureDefinition] (val x: Self) extends AnyVal {
    ...
    inline def setContextType(value: resource | datatype | `extension`): Self = StObject.set(x, "contextType", value.asInstanceOf[js.Any])
