...
object List {
  ...
  inline def apply(mode: working | snapshot | changes, status: current | retired | `entered-in-error`): typings.fhir.r4bMod.List = {
    val __obj = js.Dynamic.literal(mode = mode.asInstanceOf[js.Any], resourceType = "List", status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.fhir.r4bMod.List]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: typings.fhir.r4bMod.List] (val x: Self) extends AnyVal {
