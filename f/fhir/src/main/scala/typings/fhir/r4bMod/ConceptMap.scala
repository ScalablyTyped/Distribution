...
trait ConceptMap
  ...
  var _sourceCanonical: js.UndefOr[Element] = js.undefined
  
  var _sourceUri: js.UndefOr[Element] = js.undefined
  
  var _status: js.UndefOr[Element] = js.undefined
  
  var _targetCanonical: js.UndefOr[Element] = js.undefined
  ...
  /**
    ...
    */
  var sourceCanonical: js.UndefOr[String] = js.undefined
  ...
  /**
    ...
    */
  var targetCanonical: js.UndefOr[String] = js.undefined
...
object ConceptMap {
  ...
  implicit open class MutableBuilder[Self <: ConceptMap] (val x: Self) extends AnyVal {
    ...
    inline def setSourceCanonical(value: String): Self = StObject.set(x, "sourceCanonical", value.asInstanceOf[js.Any])
    
    inline def setSourceCanonicalUndefined: Self = StObject.set(x, "sourceCanonical", js.undefined)
    ...
    inline def setTargetCanonical(value: String): Self = StObject.set(x, "targetCanonical", value.asInstanceOf[js.Any])
    
    inline def setTargetCanonicalUndefined: Self = StObject.set(x, "targetCanonical", js.undefined)
    ...
    inline def set_sourceCanonical(value: Element): Self = StObject.set(x, "_sourceCanonical", value.asInstanceOf[js.Any])
    
    inline def set_sourceCanonicalUndefined: Self = StObject.set(x, "_sourceCanonical", js.undefined)
    ...
    inline def set_targetCanonical(value: Element): Self = StObject.set(x, "_targetCanonical", value.asInstanceOf[js.Any])
    
    inline def set_targetCanonicalUndefined: Self = StObject.set(x, "_targetCanonical", js.undefined)
