...
trait ExplanationOfBenefitAddItemDetail
  ...
  /**
    ...
    */
  var subDetail: js.UndefOr[js.Array[ExplanationOfBenefitAddItemDetailSubDetail]] = js.undefined
...
object ExplanationOfBenefitAddItemDetail {
  ...
  inline def apply(productOrService: CodeableConcept): ExplanationOfBenefitAddItemDetail = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ExplanationOfBenefitAddItemDetail] (val x: Self) extends AnyVal {
    ...
    inline def setSubDetail(value: js.Array[ExplanationOfBenefitAddItemDetailSubDetail]): Self = StObject.set(x, "subDetail", value.asInstanceOf[js.Any])
    
    inline def setSubDetailUndefined: Self = StObject.set(x, "subDetail", js.undefined)
    
    inline def setSubDetailVarargs(value: ExplanationOfBenefitAddItemDetailSubDetail*): Self = StObject.set(x, "subDetail", js.Array(value*))
