...
trait ResearchDefinition
  ...
  @JSName("resourceType")
  val resourceType_ResearchDefinition: typings.fhir.fhirStrings.ResearchDefinition
...
object ResearchDefinition {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResearchDefinition] (val x: Self) extends AnyVal {
    ...
    inline def setResourceType(value: typings.fhir.fhirStrings.ResearchDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
