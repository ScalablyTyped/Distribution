...
trait Citation
  ...
  /**
    ...
    */
  var relatesTo: js.UndefOr[js.Array[CitationRelatesTo]] = js.undefined
...
object Citation {
  ...
  implicit open class MutableBuilder[Self <: Citation] (val x: Self) extends AnyVal {
    ...
    inline def setRelatesTo(value: js.Array[CitationRelatesTo]): Self = StObject.set(x, "relatesTo", value.asInstanceOf[js.Any])
    
    inline def setRelatesToUndefined: Self = StObject.set(x, "relatesTo", js.undefined)
    
    inline def setRelatesToVarargs(value: CitationRelatesTo*): Self = StObject.set(x, "relatesTo", js.Array(value*))
