...
import typings.fhir.fhirStrings.population
...
trait ResearchElementDefinition
  extends StObject
     with DomainResource
     with _FhirResource {
  ...
  var _variableType: js.UndefOr[Element] = js.undefined
  ...
  /**
    ...
    */
  var characteristic: js.Array[ResearchElementDefinitionCharacteristic]
  ...
  @JSName("resourceType")
  val resourceType_ResearchElementDefinition: typings.fhir.fhirStrings.ResearchElementDefinition
  ...
  /**
    ...
    */
  var `type`: population | exposure | outcome
  ...
  /**
    ...
    */
  var variableType: js.UndefOr[dichotomous | continuous | descriptive] = js.undefined
...
object ResearchElementDefinition {
  
  inline def apply(
    characteristic: js.Array[ResearchElementDefinitionCharacteristic],
    status: draft | active | retired | unknown,
    `type`: population | exposure | outcome
  ): ResearchElementDefinition = {
    val __obj = js.Dynamic.literal(characteristic = characteristic.asInstanceOf[js.Any], resourceType = "ResearchElementDefinition", status = status.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: ResearchElementDefinition] (val x: Self) extends AnyVal {
    ...
    inline def setCharacteristic(value: js.Array[ResearchElementDefinitionCharacteristic]): Self = StObject.set(x, "characteristic", value.asInstanceOf[js.Any])
    
    inline def setCharacteristicVarargs(value: ResearchElementDefinitionCharacteristic*): Self = StObject.set(x, "characteristic", js.Array(value*))
    ...
    inline def setResourceType(value: typings.fhir.fhirStrings.ResearchElementDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: population | exposure | outcome): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    ...
    inline def setVariableType(value: dichotomous | continuous | descriptive): Self = StObject.set(x, "variableType", value.asInstanceOf[js.Any])
    ...
    inline def set_variableType(value: Element): Self = StObject.set(x, "_variableType", value.asInstanceOf[js.Any])
    
    inline def set_variableTypeUndefined: Self = StObject.set(x, "_variableType", js.undefined)
