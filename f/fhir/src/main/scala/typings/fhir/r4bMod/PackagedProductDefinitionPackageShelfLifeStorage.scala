...
trait PackagedProductDefinitionPackageShelfLifeStorage
  extends StObject
...
object PackagedProductDefinitionPackageShelfLifeStorage {
  
  inline def apply(): PackagedProductDefinitionPackageShelfLifeStorage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PackagedProductDefinitionPackageShelfLifeStorage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PackagedProductDefinitionPackageShelfLifeStorage] (val x: Self) extends AnyVal {
