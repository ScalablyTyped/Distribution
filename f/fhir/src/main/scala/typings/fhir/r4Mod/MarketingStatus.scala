...
object MarketingStatus {
  ...
  inline def apply(country: CodeableConcept, dateRange: Period, status: CodeableConcept): MarketingStatus = {
    val __obj = js.Dynamic.literal(country = country.asInstanceOf[js.Any], dateRange = dateRange.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[MarketingStatus]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MarketingStatus] (val x: Self) extends AnyVal {
