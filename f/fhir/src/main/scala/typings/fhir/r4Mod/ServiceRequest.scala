...
trait ServiceRequest
  ...
  /**
    ...
    */
  var locationCode: js.UndefOr[js.Array[CodeableConcept]] = js.undefined
  
  /**
    * A reference to the the preferred location(s) where the procedure should actually happen. E.g. at home or nursing day care center.
    */
  var locationReference: js.UndefOr[js.Array[Reference]] = js.undefined
...
object ServiceRequest {
  ...
  implicit open class MutableBuilder[Self <: ServiceRequest] (val x: Self) extends AnyVal {
    ...
    inline def setLocationCode(value: js.Array[CodeableConcept]): Self = StObject.set(x, "locationCode", value.asInstanceOf[js.Any])
    
    inline def setLocationCodeUndefined: Self = StObject.set(x, "locationCode", js.undefined)
    
    inline def setLocationCodeVarargs(value: CodeableConcept*): Self = StObject.set(x, "locationCode", js.Array(value*))
    
    inline def setLocationReference(value: js.Array[Reference]): Self = StObject.set(x, "locationReference", value.asInstanceOf[js.Any])
    
    inline def setLocationReferenceUndefined: Self = StObject.set(x, "locationReference", js.undefined)
    
    inline def setLocationReferenceVarargs(value: Reference*): Self = StObject.set(x, "locationReference", js.Array(value*))
