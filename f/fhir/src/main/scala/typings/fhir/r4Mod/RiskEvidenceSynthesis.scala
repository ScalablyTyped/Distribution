...
trait RiskEvidenceSynthesis
  ...
  /**
    ...
    */
  var certainty: js.UndefOr[js.Array[RiskEvidenceSynthesisCertainty]] = js.undefined
  ...
  @JSName("resourceType")
  val resourceType_RiskEvidenceSynthesis: typings.fhir.fhirStrings.RiskEvidenceSynthesis
  ...
  /**
    ...
    */
  var riskEstimate: js.UndefOr[RiskEvidenceSynthesisRiskEstimate] = js.undefined
  
  /**
    * A description of the size of the sample involved in the synthesis.
    */
  var sampleSize: js.UndefOr[RiskEvidenceSynthesisSampleSize] = js.undefined
...
object RiskEvidenceSynthesis {
  
  inline def apply(outcome: Reference, population: Reference, status: draft | active | retired | unknown): RiskEvidenceSynthesis = {
    ...
    __obj.asInstanceOf[RiskEvidenceSynthesis]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RiskEvidenceSynthesis] (val x: Self) extends AnyVal {
    ...
    inline def setCertainty(value: js.Array[RiskEvidenceSynthesisCertainty]): Self = StObject.set(x, "certainty", value.asInstanceOf[js.Any])
    
    inline def setCertaintyUndefined: Self = StObject.set(x, "certainty", js.undefined)
    
    inline def setCertaintyVarargs(value: RiskEvidenceSynthesisCertainty*): Self = StObject.set(x, "certainty", js.Array(value*))
    ...
    inline def setResourceType(value: typings.fhir.fhirStrings.RiskEvidenceSynthesis): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
    ...
    inline def setRiskEstimate(value: RiskEvidenceSynthesisRiskEstimate): Self = StObject.set(x, "riskEstimate", value.asInstanceOf[js.Any])
    
    inline def setRiskEstimateUndefined: Self = StObject.set(x, "riskEstimate", js.undefined)
    
    inline def setSampleSize(value: RiskEvidenceSynthesisSampleSize): Self = StObject.set(x, "sampleSize", value.asInstanceOf[js.Any])
