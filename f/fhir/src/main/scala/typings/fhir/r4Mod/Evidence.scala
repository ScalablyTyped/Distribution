...
trait Evidence
  ...
  /**
    ...
    */
  var exposureVariant: js.UndefOr[js.Array[Reference]] = js.undefined
  ...
  /**
    ...
    */
  var outcome: js.UndefOr[js.Array[Reference]] = js.undefined
...
object Evidence {
  ...
  inline def apply(exposureBackground: Reference, status: draft | active | retired | unknown): Evidence = {
  ...
  implicit open class MutableBuilder[Self <: Evidence] (val x: Self) extends AnyVal {
    ...
    inline def setExposureBackground(value: Reference): Self = StObject.set(x, "exposureBackground", value.asInstanceOf[js.Any])
    
    inline def setExposureVariant(value: js.Array[Reference]): Self = StObject.set(x, "exposureVariant", value.asInstanceOf[js.Any])
    
    inline def setExposureVariantUndefined: Self = StObject.set(x, "exposureVariant", js.undefined)
    
    inline def setExposureVariantVarargs(value: Reference*): Self = StObject.set(x, "exposureVariant", js.Array(value*))
    ...
    inline def setOutcome(value: js.Array[Reference]): Self = StObject.set(x, "outcome", value.asInstanceOf[js.Any])
    
    inline def setOutcomeUndefined: Self = StObject.set(x, "outcome", js.undefined)
    
    inline def setOutcomeVarargs(value: Reference*): Self = StObject.set(x, "outcome", js.Array(value*))
