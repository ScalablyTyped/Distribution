...
trait PackagedProductDefinitionPackageProperty
  extends StObject
...
object PackagedProductDefinitionPackageProperty {
  
  inline def apply(`type`: CodeableConcept): PackagedProductDefinitionPackageProperty = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[PackagedProductDefinitionPackageProperty]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PackagedProductDefinitionPackageProperty] (val x: Self) extends AnyVal {
