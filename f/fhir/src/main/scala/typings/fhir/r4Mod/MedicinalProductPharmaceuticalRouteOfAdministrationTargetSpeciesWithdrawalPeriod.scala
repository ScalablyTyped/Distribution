...
trait MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod
  extends StObject
...
object MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod {
  
  inline def apply(tissue: CodeableConcept, value: Quantity): MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod = {
    val __obj = js.Dynamic.literal(tissue = tissue.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod] (val x: Self) extends AnyVal {
