...
trait MedicationKnowledgeDrugCharacteristic
  extends StObject
...
object MedicationKnowledgeDrugCharacteristic {
  
  inline def apply(): MedicationKnowledgeDrugCharacteristic = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MedicationKnowledgeDrugCharacteristic]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MedicationKnowledgeDrugCharacteristic] (val x: Self) extends AnyVal {
