...
trait EffectEvidenceSynthesisSampleSize
  extends StObject
...
object EffectEvidenceSynthesisSampleSize {
  
  inline def apply(): EffectEvidenceSynthesisSampleSize = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EffectEvidenceSynthesisSampleSize]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EffectEvidenceSynthesisSampleSize] (val x: Self) extends AnyVal {
