...
{{{
type FhirResource = fhir.fhir/r4.Account | fhir.fhir/r4.ActivityDefinition | fhir.fhir/r4.AdministrableProductDefinition | fhir.fhir/r4.AdverseEvent | fhir.fhir/r4.AllergyIntolerance | fhir.fhir/r4.Appointment | fhir.fhir/r4.AppointmentResponse | fhir.fhir/r4.AuditEvent | fhir.fhir/r4.Basic | fhir.fhir/r4.Binary | fhir.fhir/r4.BiologicallyDerivedProduct | fhir.fhir/r4.BodyStructure | fhir.fhir/r4.Bundle<fhir.fhir/r4.FhirResource> | fhir.fhir/r4.CapabilityStatement | fhir.fhir/r4.CarePlan | fhir.fhir/r4.CareTeam | fhir.fhir/r4.CatalogEntry | fhir.fhir/r4.ChargeItem | fhir.fhir/r4.ChargeItemDefinition | fhir.fhir/r4.Citation | fhir.fhir/r4.Claim | fhir.fhir/r4.ClaimResponse | fhir.fhir/r4.ClinicalImpression | fhir.fhir/r4.ClinicalUseDefinition | fhir.fhir/r4.CodeSystem | fhir.fhir/r4.Communication | fhir.fhir/r4.CommunicationRequest | fhir.fhir/r4.CompartmentDefinition | fhir.fhir/r4.Composition | fhir.fhir/r4.ConceptMap | fhir.fhir/r4.Condition | fhir.fhir/r4.Consent | fhir.fhir/r4.Contract | fhir.fhir/r4.Coverage | fhir.fhir/r4.CoverageEligibilityRequest | fhir.fhir/r4.CoverageEligibilityResponse | fhir.fhir/r4.DetectedIssue | fhir.fhir/r4.Device | fhir.fhir/r4.DeviceDefinition | fhir.fhir/r4.DeviceMetric | fhir.fhir/r4.DeviceRequest | fhir.fhir/r4.DeviceUseStatement | fhir.fhir/r4.DiagnosticReport | fhir.fhir/r4.DocumentManifest | fhir.fhir/r4.DocumentReference | fhir.fhir/r4.Encounter | fhir.fhir/r4.Endpoint | fhir.fhir/r4.EnrollmentRequest | fhir.fhir/r4.EnrollmentResponse | fhir.fhir/r4.EpisodeOfCare | fhir.fhir/r4.EventDefinition | fhir.fhir/r4.Evidence | fhir.fhir/r4.EvidenceReport | fhir.fhir/r4.EvidenceVariable | fhir.fhir/r4.ExampleScenario | fhir.fhir/r4.ExplanationOfBenefit | fhir.fhir/r4.FamilyMemberHistory | fhir.fhir/r4.Flag | fhir.fhir/r4.Goal | fhir.fhir/r4.GraphDefinition | fhir.fhir/r4.Group | fhir.fhir/r4.GuidanceResponse | fhir.fhir/r4.HealthcareService | fhir.fhir/r4.ImagingStudy | fhir.fhir/r4.Immunization | fhir.fhir/r4.ImmunizationEvaluation | fhir.fhir/r4.ImmunizationRecommendation | fhir.fhir/r4.ImplementationGuide | fhir.fhir/r4.Ingredient | fhir.fhir/r4.InsurancePlan | fhir.fhir/r4.Invoice | fhir.fhir/r4.Library | fhir.fhir/r4.Linkage | fhir.fhir/r4.List | fhir.fhir/r4.Location | fhir.fhir/r4.ManufacturedItemDefinition | fhir.fhir/r4.Measure | fhir.fhir/r4.MeasureReport | fhir.fhir/r4.Media | fhir.fhir/r4.Medication | fhir.fhir/r4.MedicationAdministration | fhir.fhir/r4.MedicationDispense | fhir.fhir/r4.MedicationKnowledge | fhir.fhir/r4.MedicationRequest | fhir.fhir/r4.MedicationStatement | fhir.fhir/r4.MedicinalProductDefinition | fhir.fhir/r4.MessageDefinition | fhir.fhir/r4.MessageHeader | fhir.fhir/r4.MolecularSequence | fhir.fhir/r4.NamingSystem | fhir.fhir/r4.NutritionOrder | fhir.fhir/r4.NutritionProduct | fhir.fhir/r4.Observation | fhir.fhir/r4.ObservationDefinition | fhir.fhir/r4.OperationDefinition | fhir.fhir/r4.OperationOutcome | fhir.fhir/r4.Organization | fhir.fhir/r4.OrganizationAffiliation | fhir.fhir/r4.PackagedProductDefinition | fhir.fhir/r4.Parameters | fhir.fhir/r4.Patient | fhir.fhir/r4.PaymentNotice | fhir.fhir/r4.PaymentReconciliation | fhir.fhir/r4.Person | fhir.fhir/r4.PlanDefinition | fhir.fhir/r4.Practitioner | fhir.fhir/r4.PractitionerRole | fhir.fhir/r4.Procedure | fhir.fhir/r4.Provenance | fhir.fhir/r4.Questionnaire | fhir.fhir/r4.QuestionnaireResponse | fhir.fhir/r4.RegulatedAuthorization | fhir.fhir/r4.RelatedPerson | fhir.fhir/r4.RequestGroup | fhir.fhir/r4.ResearchDefinition | fhir.fhir/r4.ResearchElementDefinition | fhir.fhir/r4.ResearchStudy | fhir.fhir/r4.ResearchSubject | fhir.fhir/r4.RiskAssessment | fhir.fhir/r4.Schedule | fhir.fhir/r4.SearchParameter | fhir.fhir/r4.ServiceRequest | fhir.fhir/r4.Slot | fhir.fhir/r4.Specimen | fhir.fhir/r4.SpecimenDefinition | fhir.fhir/r4.StructureDefinition | fhir.fhir/r4.StructureMap | fhir.fhir/r4.Subscription | fhir.fhir/r4.SubscriptionStatus | fhir.fhir/r4.SubscriptionTopic | fhir.fhir/r4.Substance | fhir.fhir/r4.SubstanceDefinition | fhir.fhir/r4.SupplyDelivery | fhir.fhir/r4.SupplyRequest | fhir.fhir/r4.Task | fhir.fhir/r4.TerminologyCapabilities | fhir.fhir/r4.TestReport | fhir.fhir/r4.TestScript | fhir.fhir/r4.ValueSet | fhir.fhir/r4.VerificationResult | fhir.fhir/r4.VisionPrescription
}}}
