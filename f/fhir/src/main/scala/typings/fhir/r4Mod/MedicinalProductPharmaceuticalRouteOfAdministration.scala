...
trait MedicinalProductPharmaceuticalRouteOfAdministration
  extends StObject
  ...
  /**
    ...
    */
  var targetSpecies: js.UndefOr[js.Array[MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpecies]] = js.undefined
}
object MedicinalProductPharmaceuticalRouteOfAdministration {
  
  inline def apply(code: CodeableConcept): MedicinalProductPharmaceuticalRouteOfAdministration = {
    val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any])
    __obj.asInstanceOf[MedicinalProductPharmaceuticalRouteOfAdministration]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MedicinalProductPharmaceuticalRouteOfAdministration] (val x: Self) extends AnyVal {
    ...
    inline def setTargetSpecies(value: js.Array[MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpecies]): Self = StObject.set(x, "targetSpecies", value.asInstanceOf[js.Any])
    
    inline def setTargetSpeciesUndefined: Self = StObject.set(x, "targetSpecies", js.undefined)
    
    inline def setTargetSpeciesVarargs(value: MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpecies*): Self = StObject.set(x, "targetSpecies", js.Array(value*))
  }
}
