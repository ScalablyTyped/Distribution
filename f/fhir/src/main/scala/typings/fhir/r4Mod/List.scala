...
object List {
  ...
  inline def apply(mode: working | snapshot | changes, status: current | retired | `entered-in-error`): typings.fhir.r4Mod.List = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: typings.fhir.r4Mod.List] (val x: Self) extends AnyVal {
