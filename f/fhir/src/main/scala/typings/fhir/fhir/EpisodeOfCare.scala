...
object EpisodeOfCare {
  ...
  inline def apply(patient: Reference, status: code): EpisodeOfCare = {
  ...
  extension [Self <: EpisodeOfCare](x: Self) {
    ...
    inline def setDiagnosisVarargs(value: EpisodeOfCareDiagnosis*): Self = StObject.set(x, "diagnosis", js.Array(value :_*))
    ...
    inline def setReferralRequestVarargs(value: Reference*): Self = StObject.set(x, "referralRequest", js.Array(value :_*))
    ...
    inline def setStatusHistoryVarargs(value: EpisodeOfCareStatusHistory*): Self = StObject.set(x, "statusHistory", js.Array(value :_*))
    ...
    inline def setTeamVarargs(value: Reference*): Self = StObject.set(x, "team", js.Array(value :_*))
