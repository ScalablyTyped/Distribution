...
object SpecimenProcessing {
  ...
  extension [Self <: SpecimenProcessing](x: Self) {
    ...
    inline def setAdditiveVarargs(value: Reference*): Self = StObject.set(x, "additive", js.Array(value :_*))
    ...
    inline def setTimeDateTime(value: dateTime): Self = StObject.set(x, "timeDateTime", value.asInstanceOf[js.Any])
