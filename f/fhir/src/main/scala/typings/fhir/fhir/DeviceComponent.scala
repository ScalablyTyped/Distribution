...
object DeviceComponent {
  ...
  extension [Self <: DeviceComponent](x: Self) {
    ...
    inline def setLastSystemChange(value: instant): Self = StObject.set(x, "lastSystemChange", value.asInstanceOf[js.Any])
    
    inline def setLastSystemChangeUndefined: Self = StObject.set(x, "lastSystemChange", js.undefined)
    
    inline def setMeasurementPrinciple(value: code): Self = StObject.set(x, "measurementPrinciple", value.asInstanceOf[js.Any])
    ...
    inline def setOperationalStatusVarargs(value: CodeableConcept*): Self = StObject.set(x, "operationalStatus", js.Array(value :_*))
    ...
    inline def setProductionSpecificationVarargs(value: DeviceComponentProductionSpecification*): Self = StObject.set(x, "productionSpecification", js.Array(value :_*))
