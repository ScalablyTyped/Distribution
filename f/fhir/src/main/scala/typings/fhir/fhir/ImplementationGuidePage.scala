...
object ImplementationGuidePage {
  ...
  inline def apply(kind: code, source: uri, title: String): ImplementationGuidePage = {
  ...
  extension [Self <: ImplementationGuidePage](x: Self) {
    ...
    inline def setFormat(value: code): Self = StObject.set(x, "format", value.asInstanceOf[js.Any])
    ...
    inline def setPageVarargs(value: ImplementationGuidePage*): Self = StObject.set(x, "page", js.Array(value :_*))
    
    inline def setSource(value: uri): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
    
    inline def setTitle(value: String): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
    
    inline def setType(value: js.Array[code]): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    
    inline def setTypeUndefined: Self = StObject.set(x, "type", js.undefined)
    
    inline def setTypeVarargs(value: code*): Self = StObject.set(x, "type", js.Array(value :_*))
    ...
    inline def set_packageVarargs(value: (Element | String)*): Self = StObject.set(x, "package", js.Array(value :_*))
    ...
    inline def set_typeVarargs(value: Element*): Self = StObject.set(x, "_type", js.Array(value :_*))
  }
}
