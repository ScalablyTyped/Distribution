...
object OperationOutcomeIssue {
  ...
  inline def apply(code: code, severity: code): OperationOutcomeIssue = {
  ...
  extension [Self <: OperationOutcomeIssue](x: Self) {
    ...
    inline def setExpressionVarargs(value: String*): Self = StObject.set(x, "expression", js.Array(value :_*))
    ...
    inline def set_expressionVarargs(value: Element*): Self = StObject.set(x, "_expression", js.Array(value :_*))
    ...
    inline def set_locationVarargs(value: Element*): Self = StObject.set(x, "_location", js.Array(value :_*))
