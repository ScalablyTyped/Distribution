...
object EligibilityResponse {
  ...
  extension [Self <: EligibilityResponse](x: Self) {
    ...
    inline def setErrorVarargs(value: EligibilityResponseError*): Self = StObject.set(x, "error", js.Array(value :_*))
    ...
    inline def setInsuranceVarargs(value: EligibilityResponseInsurance*): Self = StObject.set(x, "insurance", js.Array(value :_*))
