...
object CarePlan {
  ...
  inline def apply(intent: code, status: code, subject: Reference): CarePlan = {
  ...
  extension [Self <: CarePlan](x: Self) {
    ...
    inline def setActivityVarargs(value: CarePlanActivity*): Self = StObject.set(x, "activity", js.Array(value :_*))
    
    inline def setAddresses(value: js.Array[Reference]): Self = StObject.set(x, "addresses", value.asInstanceOf[js.Any])
    
    inline def setAddressesUndefined: Self = StObject.set(x, "addresses", js.undefined)
    
    inline def setAddressesVarargs(value: Reference*): Self = StObject.set(x, "addresses", js.Array(value :_*))
    ...
    inline def setCareTeamVarargs(value: Reference*): Self = StObject.set(x, "careTeam", js.Array(value :_*))
