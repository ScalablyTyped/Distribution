...
object NamingSystem {
  ...
  inline def apply(date: dateTime, kind: code, name: String, status: code, uniqueId: js.Array[NamingSystemUniqueId]): NamingSystem = {
  ...
  extension [Self <: NamingSystem](x: Self) {
    ...
    inline def setUniqueIdVarargs(value: NamingSystemUniqueId*): Self = StObject.set(x, "uniqueId", js.Array(value :_*))
