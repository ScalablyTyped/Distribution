...
object ElementDefinition {
  ...
  def apply(
    ...
    fixedUnsignedInt: Int | Double = null,
    fixedUri: uri = null,
    id: String = null,
    ...
    maxValueDecimal: Int | Double = null,
    maxValueInstant: instant = null,
    maxValueInteger: Int | Double = null,
    maxValuePositiveInt: Int | Double = null,
    maxValueQuantity: Quantity = null,
    maxValueTime: time = null,
    maxValueUnsignedInt: Int | Double = null,
    meaningWhenMissing: markdown = null,
    min: Int | Double = null,
    minValueDate: date = null,
    minValueDateTime: dateTime = null,
    minValueDecimal: Int | Double = null,
    minValueInstant: instant = null,
    minValueInteger: Int | Double = null,
    minValuePositiveInt: Int | Double = null,
    minValueQuantity: Quantity = null,
    minValueTime: time = null,
    minValueUnsignedInt: Int | Double = null,
    ...
    patternDecimal: Int | Double = null,
    ...
    patternUnsignedInt: Int | Double = null,
    patternUri: uri = null,
    ...
    if (_contentReference != null) __obj.updateDynamic("_contentReference")(_contentReference)
    ...
    if (_fixedDate != null) __obj.updateDynamic("_fixedDate")(_fixedDate)
    if (_fixedDateTime != null) __obj.updateDynamic("_fixedDateTime")(_fixedDateTime)
    if (_fixedDecimal != null) __obj.updateDynamic("_fixedDecimal")(_fixedDecimal)
    if (_fixedId != null) __obj.updateDynamic("_fixedId")(_fixedId)
    if (_fixedInstant != null) __obj.updateDynamic("_fixedInstant")(_fixedInstant)
    if (_fixedInteger != null) __obj.updateDynamic("_fixedInteger")(_fixedInteger)
    if (_fixedMarkdown != null) __obj.updateDynamic("_fixedMarkdown")(_fixedMarkdown)
    if (_fixedOid != null) __obj.updateDynamic("_fixedOid")(_fixedOid)
    if (_fixedPositiveInt != null) __obj.updateDynamic("_fixedPositiveInt")(_fixedPositiveInt)
    if (_fixedString != null) __obj.updateDynamic("_fixedString")(_fixedString)
    ...
    if (_maxValueDate != null) __obj.updateDynamic("_maxValueDate")(_maxValueDate)
    if (_maxValueDateTime != null) __obj.updateDynamic("_maxValueDateTime")(_maxValueDateTime)
    if (_maxValueDecimal != null) __obj.updateDynamic("_maxValueDecimal")(_maxValueDecimal)
    if (_maxValueInstant != null) __obj.updateDynamic("_maxValueInstant")(_maxValueInstant)
    if (_maxValueInteger != null) __obj.updateDynamic("_maxValueInteger")(_maxValueInteger)
    if (_maxValuePositiveInt != null) __obj.updateDynamic("_maxValuePositiveInt")(_maxValuePositiveInt)
    if (_maxValueTime != null) __obj.updateDynamic("_maxValueTime")(_maxValueTime)
    if (_maxValueUnsignedInt != null) __obj.updateDynamic("_maxValueUnsignedInt")(_maxValueUnsignedInt)
    if (_meaningWhenMissing != null) __obj.updateDynamic("_meaningWhenMissing")(_meaningWhenMissing)
    if (_min != null) __obj.updateDynamic("_min")(_min)
    if (_minValueDate != null) __obj.updateDynamic("_minValueDate")(_minValueDate)
    if (_minValueDateTime != null) __obj.updateDynamic("_minValueDateTime")(_minValueDateTime)
    if (_minValueDecimal != null) __obj.updateDynamic("_minValueDecimal")(_minValueDecimal)
    if (_minValueInstant != null) __obj.updateDynamic("_minValueInstant")(_minValueInstant)
    if (_minValueInteger != null) __obj.updateDynamic("_minValueInteger")(_minValueInteger)
    if (_minValuePositiveInt != null) __obj.updateDynamic("_minValuePositiveInt")(_minValuePositiveInt)
    if (_minValueTime != null) __obj.updateDynamic("_minValueTime")(_minValueTime)
    if (_minValueUnsignedInt != null) __obj.updateDynamic("_minValueUnsignedInt")(_minValueUnsignedInt)
    if (_mustSupport != null) __obj.updateDynamic("_mustSupport")(_mustSupport)
    if (_orderMeaning != null) __obj.updateDynamic("_orderMeaning")(_orderMeaning)
    if (_path != null) __obj.updateDynamic("_path")(_path)
    if (_patternBase64Binary != null) __obj.updateDynamic("_patternBase64Binary")(_patternBase64Binary)
    if (_patternBoolean != null) __obj.updateDynamic("_patternBoolean")(_patternBoolean)
    if (_patternCode != null) __obj.updateDynamic("_patternCode")(_patternCode)
    if (_patternDate != null) __obj.updateDynamic("_patternDate")(_patternDate)
    if (_patternDateTime != null) __obj.updateDynamic("_patternDateTime")(_patternDateTime)
    if (_patternDecimal != null) __obj.updateDynamic("_patternDecimal")(_patternDecimal)
    if (_patternId != null) __obj.updateDynamic("_patternId")(_patternId)
    if (_patternInstant != null) __obj.updateDynamic("_patternInstant")(_patternInstant)
    if (_patternInteger != null) __obj.updateDynamic("_patternInteger")(_patternInteger)
    if (_patternMarkdown != null) __obj.updateDynamic("_patternMarkdown")(_patternMarkdown)
    if (_patternOid != null) __obj.updateDynamic("_patternOid")(_patternOid)
    if (_patternPositiveInt != null) __obj.updateDynamic("_patternPositiveInt")(_patternPositiveInt)
    if (_patternString != null) __obj.updateDynamic("_patternString")(_patternString)
    if (_patternTime != null) __obj.updateDynamic("_patternTime")(_patternTime)
    if (_patternUnsignedInt != null) __obj.updateDynamic("_patternUnsignedInt")(_patternUnsignedInt)
    if (_patternUri != null) __obj.updateDynamic("_patternUri")(_patternUri)
    if (_representation != null) __obj.updateDynamic("_representation")(_representation)
    if (_requirements != null) __obj.updateDynamic("_requirements")(_requirements)
    if (_short != null) __obj.updateDynamic("_short")(_short)
    ...
    if (fixedAttachment != null) __obj.updateDynamic("fixedAttachment")(fixedAttachment)
    if (fixedBase64Binary != null) __obj.updateDynamic("fixedBase64Binary")(fixedBase64Binary)
    if (!js.isUndefined(fixedBoolean)) __obj.updateDynamic("fixedBoolean")(fixedBoolean)
    if (fixedCode != null) __obj.updateDynamic("fixedCode")(fixedCode)
    if (fixedCodeableConcept != null) __obj.updateDynamic("fixedCodeableConcept")(fixedCodeableConcept)
    if (fixedCoding != null) __obj.updateDynamic("fixedCoding")(fixedCoding)
    if (fixedContactPoint != null) __obj.updateDynamic("fixedContactPoint")(fixedContactPoint)
    if (fixedCount != null) __obj.updateDynamic("fixedCount")(fixedCount)
    if (fixedDate != null) __obj.updateDynamic("fixedDate")(fixedDate)
    if (fixedDateTime != null) __obj.updateDynamic("fixedDateTime")(fixedDateTime)
    if (fixedDecimal != null) __obj.updateDynamic("fixedDecimal")(fixedDecimal.asInstanceOf[js.Any])
    if (fixedDistance != null) __obj.updateDynamic("fixedDistance")(fixedDistance)
    ...
    if (fixedInteger != null) __obj.updateDynamic("fixedInteger")(fixedInteger.asInstanceOf[js.Any])
    ...
    if (fixedPositiveInt != null) __obj.updateDynamic("fixedPositiveInt")(fixedPositiveInt.asInstanceOf[js.Any])
    ...
    if (fixedUnsignedInt != null) __obj.updateDynamic("fixedUnsignedInt")(fixedUnsignedInt.asInstanceOf[js.Any])
    ...
    if (maxValueDecimal != null) __obj.updateDynamic("maxValueDecimal")(maxValueDecimal.asInstanceOf[js.Any])
    if (maxValueInstant != null) __obj.updateDynamic("maxValueInstant")(maxValueInstant)
    if (maxValueInteger != null) __obj.updateDynamic("maxValueInteger")(maxValueInteger.asInstanceOf[js.Any])
    if (maxValuePositiveInt != null) __obj.updateDynamic("maxValuePositiveInt")(maxValuePositiveInt.asInstanceOf[js.Any])
    ...
    if (maxValueUnsignedInt != null) __obj.updateDynamic("maxValueUnsignedInt")(maxValueUnsignedInt.asInstanceOf[js.Any])
    ...
    if (minValueDecimal != null) __obj.updateDynamic("minValueDecimal")(minValueDecimal.asInstanceOf[js.Any])
    if (minValueInstant != null) __obj.updateDynamic("minValueInstant")(minValueInstant)
    if (minValueInteger != null) __obj.updateDynamic("minValueInteger")(minValueInteger.asInstanceOf[js.Any])
    if (minValuePositiveInt != null) __obj.updateDynamic("minValuePositiveInt")(minValuePositiveInt.asInstanceOf[js.Any])
    ...
    if (minValueUnsignedInt != null) __obj.updateDynamic("minValueUnsignedInt")(minValueUnsignedInt.asInstanceOf[js.Any])
    ...
    if (patternDecimal != null) __obj.updateDynamic("patternDecimal")(patternDecimal.asInstanceOf[js.Any])
    ...
    if (patternInteger != null) __obj.updateDynamic("patternInteger")(patternInteger.asInstanceOf[js.Any])
    ...
    if (patternPositiveInt != null) __obj.updateDynamic("patternPositiveInt")(patternPositiveInt.asInstanceOf[js.Any])
    ...
    if (patternUnsignedInt != null) __obj.updateDynamic("patternUnsignedInt")(patternUnsignedInt.asInstanceOf[js.Any])
