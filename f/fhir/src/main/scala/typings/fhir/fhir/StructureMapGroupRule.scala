...
object StructureMapGroupRule {
  ...
  inline def apply(name: id, source: js.Array[StructureMapGroupRuleSource]): StructureMapGroupRule = {
  ...
  extension [Self <: StructureMapGroupRule](x: Self) {
    ...
    inline def setDependentVarargs(value: StructureMapGroupRuleDependent*): Self = StObject.set(x, "dependent", js.Array(value :_*))
    ...
    inline def setSourceVarargs(value: StructureMapGroupRuleSource*): Self = StObject.set(x, "source", js.Array(value :_*))
    ...
    inline def setTargetVarargs(value: StructureMapGroupRuleTarget*): Self = StObject.set(x, "target", js.Array(value :_*))
