...
object ValueSetComposeIncludeConcept {
  ...
  inline def apply(code: code): ValueSetComposeIncludeConcept = {
  ...
  extension [Self <: ValueSetComposeIncludeConcept](x: Self) {
    ...
    inline def setDesignationVarargs(value: ValueSetComposeIncludeConceptDesignation*): Self = StObject.set(x, "designation", js.Array(value :_*))
