...
object ImmunizationRecommendationRecommendation {
  ...
  inline def apply(date: dateTime, forecastStatus: CodeableConcept): ImmunizationRecommendationRecommendation = {
  ...
  extension [Self <: ImmunizationRecommendationRecommendation](x: Self) {
    ...
    inline def setDateCriterionVarargs(value: ImmunizationRecommendationRecommendationDateCriterion*): Self = StObject.set(x, "dateCriterion", js.Array(value :_*))
    
    inline def setDoseNumber(value: positiveInt): Self = StObject.set(x, "doseNumber", value.asInstanceOf[js.Any])
    ...
    inline def setSupportingImmunizationVarargs(value: Reference*): Self = StObject.set(x, "supportingImmunization", js.Array(value :_*))
    ...
    inline def setSupportingPatientInformationVarargs(value: Reference*): Self = StObject.set(x, "supportingPatientInformation", js.Array(value :_*))
