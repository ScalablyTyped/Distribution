...
object ParametersParameter {
  ...
  @scala.inline
  implicit class ParametersParameterMutableBuilder[Self <: ParametersParameter] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPart(value: js.Array[ParametersParameter]): Self = StObject.set(x, "part", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPartUndefined: Self = StObject.set(x, "part", js.undefined)
    
    @scala.inline
    def setPartVarargs(value: ParametersParameter*): Self = StObject.set(x, "part", js.Array(value :_*))
