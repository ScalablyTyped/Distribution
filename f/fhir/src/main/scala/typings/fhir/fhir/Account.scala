...
object Account {
  ...
  extension [Self <: Account](x: Self) {
    ...
    inline def setCoverageVarargs(value: AccountCoverage*): Self = StObject.set(x, "coverage", js.Array(value :_*))
    ...
    inline def setGuarantorVarargs(value: AccountGuarantor*): Self = StObject.set(x, "guarantor", js.Array(value :_*))
