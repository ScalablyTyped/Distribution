...
object Goal {
  ...
  inline def apply(description: CodeableConcept, status: code): Goal = {
  ...
  extension [Self <: Goal](x: Self) {
    ...
    inline def setOutcomeCodeVarargs(value: CodeableConcept*): Self = StObject.set(x, "outcomeCode", js.Array(value :_*))
