...
object MeasureReportGroup {
  ...
  extension [Self <: MeasureReportGroup](x: Self) {
    ...
    inline def setPopulationVarargs(value: MeasureReportGroupPopulation*): Self = StObject.set(x, "population", js.Array(value :_*))
    ...
    inline def setStratifierVarargs(value: MeasureReportGroupStratifier*): Self = StObject.set(x, "stratifier", js.Array(value :_*))
