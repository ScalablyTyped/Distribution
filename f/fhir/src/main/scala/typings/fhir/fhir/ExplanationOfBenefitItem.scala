...
object ExplanationOfBenefitItem {
  ...
  implicit class ExplanationOfBenefitItemOps[Self <: ExplanationOfBenefitItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDetailVarargs(value: ExplanationOfBenefitItemDetail*): Self = this.set("detail", js.Array(value :_*))
    @scala.inline
    def setDetail(value: js.Array[ExplanationOfBenefitItemDetail]): Self = this.set("detail", value.asInstanceOf[js.Any])
    @scala.inline
