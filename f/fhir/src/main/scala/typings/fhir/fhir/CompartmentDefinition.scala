...
- typings.fhir.fhir.Resource because Already inherited */ trait CompartmentDefinition
  extends StObject
     with DomainResource {
...
object CompartmentDefinition {
  ...
  @scala.inline
  implicit class CompartmentDefinitionMutableBuilder[Self <: CompartmentDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: js.Array[CompartmentDefinitionResource]): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceUndefined: Self = StObject.set(x, "resource", js.undefined)
    
    @scala.inline
    def setResourceVarargs(value: CompartmentDefinitionResource*): Self = StObject.set(x, "resource", js.Array(value :_*))
    ...
    @scala.inline
    def set_search(value: Element): Self = StObject.set(x, "_search", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_searchUndefined: Self = StObject.set(x, "_search", js.undefined)
