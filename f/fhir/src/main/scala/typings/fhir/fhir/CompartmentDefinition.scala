...
object CompartmentDefinition {
  ...
  inline def apply(code: code, name: String, search: Boolean, status: code, url: uri): CompartmentDefinition = {
  ...
  extension [Self <: CompartmentDefinition](x: Self) {
    ...
    inline def setResourceVarargs(value: CompartmentDefinitionResource*): Self = StObject.set(x, "resource", js.Array(value :_*))
