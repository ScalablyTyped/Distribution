...
object TestScriptSetupActionAssertRulesetRule {
  ...
  inline def apply(ruleId: id): TestScriptSetupActionAssertRulesetRule = {
    val __obj = js.Dynamic.literal(ruleId = ruleId.asInstanceOf[js.Any])
    __obj.asInstanceOf[TestScriptSetupActionAssertRulesetRule]
  }
  
  extension [Self <: TestScriptSetupActionAssertRulesetRule](x: Self) {
    ...
    inline def setParamVarargs(value: TestScriptSetupActionAssertRulesetRuleParam*): Self = StObject.set(x, "param", js.Array(value :_*))
