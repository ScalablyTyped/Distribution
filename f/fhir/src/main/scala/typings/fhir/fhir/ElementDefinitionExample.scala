...
/**
  ...
  */
@js.native
trait ElementDefinitionExample extends Element {
...
object ElementDefinitionExample {
  
  @scala.inline
  def apply(label: String): ElementDefinitionExample = {
    val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any])
    __obj.asInstanceOf[ElementDefinitionExample]
  }
  
  @scala.inline
  implicit class ElementDefinitionExampleOps[Self <: ElementDefinitionExample] (val x: Self) extends AnyVal {
