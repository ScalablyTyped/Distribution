...
object AllergyIntolerance {
  ...
  inline def apply(patient: Reference, verificationStatus: code): AllergyIntolerance = {
  ...
  extension [Self <: AllergyIntolerance](x: Self) {
    ...
    inline def setCategory(value: js.Array[code]): Self = StObject.set(x, "category", value.asInstanceOf[js.Any])
    
    inline def setCategoryUndefined: Self = StObject.set(x, "category", js.undefined)
    
    inline def setCategoryVarargs(value: code*): Self = StObject.set(x, "category", js.Array(value :_*))
    ...
    inline def setCriticality(value: code): Self = StObject.set(x, "criticality", value.asInstanceOf[js.Any])
    ...
    inline def setLastOccurrence(value: dateTime): Self = StObject.set(x, "lastOccurrence", value.asInstanceOf[js.Any])
    ...
    inline def setReactionVarargs(value: AllergyIntoleranceReaction*): Self = StObject.set(x, "reaction", js.Array(value :_*))
    ...
    inline def set_categoryVarargs(value: Element*): Self = StObject.set(x, "_category", js.Array(value :_*))
