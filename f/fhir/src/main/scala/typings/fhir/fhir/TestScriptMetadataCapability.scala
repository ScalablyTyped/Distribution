...
object TestScriptMetadataCapability {
  ...
  extension [Self <: TestScriptMetadataCapability](x: Self) {
    ...
    inline def setLink(value: js.Array[uri]): Self = StObject.set(x, "link", value.asInstanceOf[js.Any])
    
    inline def setLinkUndefined: Self = StObject.set(x, "link", js.undefined)
    
    inline def setLinkVarargs(value: uri*): Self = StObject.set(x, "link", js.Array(value :_*))
    
    inline def setOrigin(value: js.Array[integer]): Self = StObject.set(x, "origin", value.asInstanceOf[js.Any])
    
    inline def setOriginUndefined: Self = StObject.set(x, "origin", js.undefined)
    
    inline def setOriginVarargs(value: integer*): Self = StObject.set(x, "origin", js.Array(value :_*))
    ...
    inline def set_linkVarargs(value: Element*): Self = StObject.set(x, "_link", js.Array(value :_*))
    
    inline def set_origin(value: js.Array[Element]): Self = StObject.set(x, "_origin", value.asInstanceOf[js.Any])
    
    inline def set_originUndefined: Self = StObject.set(x, "_origin", js.undefined)
    
    inline def set_originVarargs(value: Element*): Self = StObject.set(x, "_origin", js.Array(value :_*))
