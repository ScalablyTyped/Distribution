...
- typings.fhir.fhir.Resource because Already inherited */ trait NutritionOrder
  extends StObject
     with DomainResource {
...
object NutritionOrder {
  ...
  inline def apply(dateTime: dateTime, patient: Reference): NutritionOrder = {
  ...
  extension [Self <: NutritionOrder](x: Self) {
    ...
    inline def setAllergyIntoleranceVarargs(value: Reference*): Self = StObject.set(x, "allergyIntolerance", js.Array(value :_*))
    ...
    inline def setExcludeFoodModifierVarargs(value: CodeableConcept*): Self = StObject.set(x, "excludeFoodModifier", js.Array(value :_*))
    ...
    inline def setFoodPreferenceModifierVarargs(value: CodeableConcept*): Self = StObject.set(x, "foodPreferenceModifier", js.Array(value :_*))
    ...
    inline def setSupplementVarargs(value: NutritionOrderSupplement*): Self = StObject.set(x, "supplement", js.Array(value :_*))
