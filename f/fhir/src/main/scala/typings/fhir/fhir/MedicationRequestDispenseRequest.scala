...
object MedicationRequestDispenseRequest {
  ...
  extension [Self <: MedicationRequestDispenseRequest](x: Self) {
    ...
    inline def setNumberOfRepeatsAllowed(value: positiveInt): Self = StObject.set(x, "numberOfRepeatsAllowed", value.asInstanceOf[js.Any])
    ...
    inline def set_numberOfRepeatsAllowed(value: Element): Self = StObject.set(x, "_numberOfRepeatsAllowed", value.asInstanceOf[js.Any])
    
    inline def set_numberOfRepeatsAllowedUndefined: Self = StObject.set(x, "_numberOfRepeatsAllowed", js.undefined)
  }
}
