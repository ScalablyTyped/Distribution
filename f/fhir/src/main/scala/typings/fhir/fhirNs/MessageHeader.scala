...
- typings.fhir.fhirNs.Resource because Already inherited */ trait MessageHeader extends DomainResource {
  /**
...
object MessageHeader {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(event = event, source = source, timestamp = timestamp)
