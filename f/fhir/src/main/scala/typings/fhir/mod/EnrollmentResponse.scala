...
trait EnrollmentResponse
  ...
  @JSName("resourceType")
  val resourceType_EnrollmentResponse: typings.fhir.fhirStrings.EnrollmentResponse
...
object EnrollmentResponse {
  ...
  extension [Self <: EnrollmentResponse](x: Self) {
    ...
    inline def setResourceType(value: typings.fhir.fhirStrings.EnrollmentResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
