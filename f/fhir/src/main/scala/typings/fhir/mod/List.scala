...
object List {
  ...
  inline def apply(mode: working | snapshot | changes, status: current | retired | `entered-in-error`): typings.fhir.mod.List = {
  ...
  extension [Self <: typings.fhir.mod.List](x: Self) {
