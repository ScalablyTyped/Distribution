...
import typings.firebaseAuth.distBrowserCjsSrcCoreCredentialsPhoneMod.PhoneAuthCredential
import typings.firebaseAuth.distBrowserCjsSrcModelApplicationVerifierMod.ApplicationVerifierInternal
import typings.firebaseAuth.distBrowserCjsSrcModelAuthMod.AuthInternal
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.ApplicationVerifier
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.Auth
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.ConfirmationResult
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.PhoneInfoOptions
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.User
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distBrowserCjsSrcPlatformBrowserStrategiesPhoneMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/strategies/phone", JSImport.Namespace)
  @js.native
