...
object abstractPopupRedirectOperationMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/core/strategies/abstract_popup_redirect_operation", "AbstractPopupRedirectOperation")
  @js.native
