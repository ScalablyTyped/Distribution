...
object distBrowserCjsSrcPlatformBrowserStrategiesRedirectMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/strategies/redirect", JSImport.Namespace)
  @js.native
