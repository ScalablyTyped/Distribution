...
object UiFunction extends StObject {
  ...
  sealed trait LOAD
    extends StObject
       with UiFunction
  /* "ui.loadUiCode" */ val LOAD: typings.firebaseAuth.distTestIntegrationWebdriverUtilFunctionsMod.UiFunction.LOAD & String = js.native
  
  @js.native
  sealed trait START
    extends StObject
       with UiFunction
  /* "ui.startUi" */ val START: typings.firebaseAuth.distTestIntegrationWebdriverUtilFunctionsMod.UiFunction.START & String = js.native
}
