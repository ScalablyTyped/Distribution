...
object coreStrategiesAbstractPopupRedirectOperationMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/core/strategies/abstract_popup_redirect_operation", "AbstractPopupRedirectOperation")
  @js.native
