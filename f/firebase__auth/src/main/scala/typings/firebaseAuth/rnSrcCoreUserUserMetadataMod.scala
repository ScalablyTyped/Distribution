...
object rnSrcCoreUserUserMetadataMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/user/user_metadata", "UserMetadata")
  @js.native
  open class UserMetadata ()
    extends StObject
       with typings.firebaseAuth.rnSrcModelPublicTypesMod.UserMetadata {
