...
object distNodeEsmSrcCoreProvidersFederatedMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/node-esm/src/core/providers/federated", "FederatedAuthProvider")
  @js.native
