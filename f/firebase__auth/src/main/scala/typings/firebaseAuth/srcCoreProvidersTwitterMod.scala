...
import typings.firebaseAuth.nodeEsmSrcCoreProvidersOauthMod.BaseOAuthProvider
import typings.firebaseAuth.nodeEsmSrcModelPublicTypesMod.UserCredential
import typings.firebaseAuth.srcCoreCredentialsOauthMod.OAuthCredential
import typings.firebaseUtil.mod.FirebaseError
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcCoreProvidersTwitterMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/providers/twitter", "TwitterAuthProvider")
  @js.native
  ...
  object TwitterAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core/providers/twitter", "TwitterAuthProvider.PROVIDER_ID")
    @js.native
    val PROVIDER_ID: twitterDotcom = js.native
    
    /** Always set to {@link SignInMethod}.TWITTER. */
    @JSImport("@firebase/auth/dist/node-esm/src/core/providers/twitter", "TwitterAuthProvider.TWITTER_SIGN_IN_METHOD")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core/providers/twitter", "TwitterAuthProvider.credentialFromTaggedObject")
    @js.native
