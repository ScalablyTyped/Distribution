...
@JSImport("@firebase/auth/dist/cordova/internal", "PhoneMultiFactorGenerator")
@js.native
...
object PhoneMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/cordova/internal", "PhoneMultiFactorGenerator.FACTOR_ID")
  @js.native
