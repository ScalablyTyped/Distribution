...
@JSImport("@firebase/auth/internal", "FacebookAuthProvider")
@js.native
open class FacebookAuthProvider ()
  extends typings.firebaseAuth.distInternalMod.FacebookAuthProvider
/* static members */
object FacebookAuthProvider {
  ...
  @JSImport("@firebase/auth/internal", "FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD")
  @js.native
  val FACEBOOK_SIGN_IN_METHOD: facebookDotcom = js.native
  
  /** Always set to {@link ProviderId}.FACEBOOK. */
  @JSImport("@firebase/auth/internal", "FacebookAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/internal", "FacebookAuthProvider.credentialFromTaggedObject")
  @js.native
