...
import typings.firebaseAuth.messagechannelMod.EventType
import typings.firebaseAuth.messagechannelMod.ReceiverHandler
import typings.firebaseAuth.messagechannelMod.ReceiverResponse
import typings.firebaseAuth.messagechannelMod.SenderRequest
...
object receiverMod {
  ...
  @JSImport("@firebase/auth/dist/cordova/src/platform_browser/messagechannel/receiver", "Receiver")
  @js.native
  ...
  object Receiver {
    ...
    @JSImport("@firebase/auth/dist/cordova/src/platform_browser/messagechannel/receiver", "Receiver.receivers")
    @js.native
