...
object distNodeSrcApiAuthenticationSmsMod {
  ...
  - typings.firebaseAuth.distNodeSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
