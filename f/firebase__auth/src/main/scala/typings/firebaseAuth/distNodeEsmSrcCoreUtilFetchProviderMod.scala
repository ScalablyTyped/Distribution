...
object distNodeEsmSrcCoreUtilFetchProviderMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/util/fetch_provider", "FetchProvider")
  @js.native
  ...
  object FetchProvider {
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core/util/fetch_provider", "FetchProvider.fetchImpl")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core/util/fetch_provider", "FetchProvider.headersImpl")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core/util/fetch_provider", "FetchProvider.responseImpl")
    @js.native
