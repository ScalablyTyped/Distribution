...
import typings.firebaseAuth.anon.InAppBrowser47
...
object distSrcPlatformCordovaPluginsMod {
  
  @JSImport("@firebase/auth/dist/src/platform_cordova/plugins", JSImport.Namespace)
  @js.native
  ...
  object CordovaWindow {
    ...
    implicit open class MutableBuilder[Self <: CordovaWindow] (val x: Self) extends AnyVal {
      ...
      inline def setCordova(value: InAppBrowser47): Self = StObject.set(x, "cordova", value.asInstanceOf[js.Any])
