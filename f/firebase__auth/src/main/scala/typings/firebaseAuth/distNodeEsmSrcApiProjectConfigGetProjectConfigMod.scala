...
object distNodeEsmSrcApiProjectConfigGetProjectConfigMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/api/project_config/get_project_config", JSImport.Namespace)
  @js.native
