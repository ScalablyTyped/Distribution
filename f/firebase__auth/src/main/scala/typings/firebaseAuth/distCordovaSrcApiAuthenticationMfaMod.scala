...
import typings.firebaseAuth.distCordovaSrcApiAuthenticationSmsMod.SignInWithPhoneNumberRequest
...
object distCordovaSrcApiAuthenticationMfaMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distCordovaSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse
    - typings.firebaseAuth.distCordovaSrcApiAuthenticationIdpMod.SignInWithIdpResponse
    - typings.firebaseAuth.distCordovaSrcModelIdTokenMod.IdTokenResponse
  */
  trait PhoneOrOauthTokenResponse extends StObject
  object PhoneOrOauthTokenResponse {
    
    inline def IdTokenResponse(localId: String): typings.firebaseAuth.distCordovaSrcModelIdTokenMod.IdTokenResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distCordovaSrcModelIdTokenMod.IdTokenResponse]
    }
    
    inline def SignInWithIdpResponse(localId: String): typings.firebaseAuth.distCordovaSrcApiAuthenticationIdpMod.SignInWithIdpResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distCordovaSrcApiAuthenticationIdpMod.SignInWithIdpResponse]
    }
    
    inline def SignInWithPhoneNumberResponse(localId: String): typings.firebaseAuth.distCordovaSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distCordovaSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse]
    }
  }
