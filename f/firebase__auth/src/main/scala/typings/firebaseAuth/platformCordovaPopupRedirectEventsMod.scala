...
import typings.firebaseAuth.coreAuthAuthEventManagerMod.AuthEventManager
...
object platformCordovaPopupRedirectEventsMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/platform_cordova/popup_redirect/events", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm5/src/platform_cordova/popup_redirect/events", "CordovaAuthEventManager")
  @js.native
