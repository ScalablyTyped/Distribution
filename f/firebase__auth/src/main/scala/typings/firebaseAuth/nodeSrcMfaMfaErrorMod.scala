...
import typings.firebaseAuth.nodeSrcModelEnumsMod.OperationType
...
object nodeSrcMfaMfaErrorMod {
  ...
  /* private */ open class MultiFactorError ()
    extends typings.firebaseAuth.nodeSrcModelPublicTypesMod.MultiFactorError {
