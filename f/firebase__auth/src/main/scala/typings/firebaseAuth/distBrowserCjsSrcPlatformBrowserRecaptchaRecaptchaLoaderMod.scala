...
import typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserRecaptchaRecaptchaMod.Recaptcha
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distBrowserCjsSrcPlatformBrowserRecaptchaRecaptchaLoaderMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/recaptcha/recaptcha_loader", "MockReCaptchaLoaderImpl")
  @js.native
  open class MockReCaptchaLoaderImpl ()
    extends StObject
       with ReCaptchaLoader
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/recaptcha/recaptcha_loader", "ReCaptchaLoaderImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/recaptcha/recaptcha_loader", "_JSLOAD_CALLBACK")
  @js.native
