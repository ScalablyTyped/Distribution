...
object distNodeEsmSrcCoreMod {
  ...
  open class ActionCodeURL protected ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreActionCodeUrlMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreCredentialsMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  object AuthErrorCodes {
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("@firebase/auth/dist/node-esm/src/core", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/node-esm/src/core", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/node-esm/src/core", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
  ...
  open class EmailAuthProvider ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreProvidersEmailMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreProvidersFacebookMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreProvidersGithubMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreProvidersGoogleMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreProvidersOauthMod.OAuthProvider {
    /**
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreProvidersSamlMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typings.firebaseAuth.distNodeEsmSrcCoreProvidersTwitterMod.TwitterAuthProvider
  /* static members */
