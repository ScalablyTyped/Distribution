...
object OperationType {
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/index.node", "OperationType.LINK")
  @js.native
  val LINK: link = js.native
  
  /** Operation involving using a provider to reauthenticate an already signed-in user. */
  @JSImport("@firebase/auth/dist/browser-cjs/index.node", "OperationType.REAUTHENTICATE")
  @js.native
  val REAUTHENTICATE: reauthenticate = js.native
  
  /** Operation involving signing in a user. */
  @JSImport("@firebase/auth/dist/browser-cjs/index.node", "OperationType.SIGN_IN")
  @js.native
