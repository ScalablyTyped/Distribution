...
@JSImport("@firebase/auth/dist/browser-cjs/index.node", "EmailAuthProvider")
@js.native
open class EmailAuthProvider ()
  extends typings.firebaseAuth.distBrowserCjsMod.EmailAuthProvider
/* static members */
object EmailAuthProvider {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/browser-cjs/index.node", "EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/browser-cjs/index.node", "EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/browser-cjs/index.node", "EmailAuthProvider.PROVIDER_ID")
  @js.native
