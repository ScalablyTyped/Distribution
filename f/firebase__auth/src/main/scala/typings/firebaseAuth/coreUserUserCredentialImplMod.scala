...
import typings.firebaseAuth.srcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse
import typings.firebaseAuth.srcModelEnumsMod.OperationType
import typings.firebaseAuth.srcModelEnumsMod.ProviderId
...
object coreUserUserCredentialImplMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.firebaseAuth.coreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/esm5/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
