...
import typings.firebaseAuth.nodeEsmSrcModelPublicTypesMod.ReactNativeAsyncStorage
...
object nodeEsmIndexDocMod {
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.nodeEsmMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  /* private */ open class EmailAuthCredential ()
    extends typings.firebaseAuth.nodeEsmMod.EmailAuthCredential
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.nodeEsmMod.FacebookAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.nodeEsmMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typings.firebaseAuth.nodeEsmMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.nodeEsmMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typings.firebaseAuth.nodeEsmMod.PhoneAuthCredential
  /* static members */
  ...
  open class PhoneAuthProvider protected ()
    extends typings.firebaseAuth.nodeEsmMod.PhoneAuthProvider {
    /**
  ...
  /* private */ open class PhoneMultiFactorGenerator ()
    extends typings.firebaseAuth.nodeEsmMod.PhoneMultiFactorGenerator
  /* static members */
  ...
  open class RecaptchaVerifier protected ()
    extends typings.firebaseAuth.nodeEsmMod.RecaptchaVerifier {
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.nodeEsmMod.SAMLAuthProvider {
    /**
