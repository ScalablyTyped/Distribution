...
object nodeSrcApiAuthenticationSmsMod {
  
  @JSImport("@firebase/auth/dist/node/src/api/authentication/sms", JSImport.Namespace)
  @js.native
  ...
  - typings.firebaseAuth.nodeSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
