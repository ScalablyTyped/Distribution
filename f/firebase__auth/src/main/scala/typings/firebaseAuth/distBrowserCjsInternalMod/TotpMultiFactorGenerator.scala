...
@JSImport("@firebase/auth/dist/browser-cjs/internal", "TotpMultiFactorGenerator")
@js.native
...
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/browser-cjs/internal", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
