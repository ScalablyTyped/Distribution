...
@JSImport("@firebase/auth/dist/browser-cjs/internal", "EmailAuthProvider")
@js.native
...
object EmailAuthProvider {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/browser-cjs/internal", "EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/browser-cjs/internal", "EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/browser-cjs/internal", "EmailAuthProvider.PROVIDER_ID")
  @js.native
