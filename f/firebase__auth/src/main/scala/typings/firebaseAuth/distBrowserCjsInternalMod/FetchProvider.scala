...
@JSImport("@firebase/auth/dist/browser-cjs/internal", "FetchProvider")
@js.native
open class FetchProvider ()
  extends typings.firebaseAuth.distBrowserCjsSrcCoreUtilFetchProviderMod.FetchProvider
/* static members */
object FetchProvider {
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/internal", "FetchProvider.fetchImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/internal", "FetchProvider.headersImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/internal", "FetchProvider.responseImpl")
  @js.native
