...
object AnonFunction extends StObject {
  ...
  sealed trait SIGN_IN_ANONYMOUSLY
    extends StObject
       with AnonFunction
  /* "anonymous.anonymousSignIn" */ val SIGN_IN_ANONYMOUSLY: typings.firebaseAuth.distRnTestIntegrationWebdriverUtilFunctionsMod.AnonFunction.SIGN_IN_ANONYMOUSLY & String = js.native
}
