...
object distEsm5SrcPlatformBrowserPersistenceBrowserMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/esm5/src/platform_browser/persistence/browser", "BrowserPersistenceClass")
  @js.native
