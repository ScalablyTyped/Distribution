...
object distBrowserCjsSrcPlatformBrowserUtilPopupMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/util/popup", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/util/popup", "AuthPopup")
  @js.native
