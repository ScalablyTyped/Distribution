...
object distBrowserCjsSrcApiAuthenticationCreateAuthUriMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/api/authentication/create_auth_uri", JSImport.Namespace)
  @js.native
