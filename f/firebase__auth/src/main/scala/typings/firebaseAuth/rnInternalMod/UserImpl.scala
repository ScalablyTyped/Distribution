...
import typings.firebaseAuth.rnSrcCorePersistenceMod.PersistedBlob
...
import typings.firebaseAuth.rnSrcModelUserMod.UserParameters
...
open class UserImpl protected ()
  extends typings.firebaseAuth.rnSrcCoreUserUserImplMod.UserImpl {
