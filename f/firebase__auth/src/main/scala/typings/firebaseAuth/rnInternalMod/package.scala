...
import typings.firebaseAuth.rnInternalMod.^
import typings.firebaseAuth.rnSrcCoreErrorsMod.AuthErrorCode
import typings.firebaseAuth.rnSrcCoreUtilAssertMod.LessAppName
import typings.firebaseAuth.rnSrcCoreUtilVersionMod.ClientPlatform
import typings.firebaseAuth.rnSrcModelAuthMod.ApiKey
import typings.firebaseAuth.rnSrcModelAuthMod.AppName
...
inline def updatePhoneNumber(user: User, credential: typings.firebaseAuth.rnSrcCoreCredentialsPhoneMod.PhoneAuthCredential): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("updatePhoneNumber")(user.asInstanceOf[js.Any], credential.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
