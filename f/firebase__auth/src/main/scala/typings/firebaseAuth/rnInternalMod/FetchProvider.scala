...
@JSImport("@firebase/auth/dist/rn/internal", "FetchProvider")
@js.native
open class FetchProvider ()
  extends typings.firebaseAuth.rnSrcCoreUtilFetchProviderMod.FetchProvider
/* static members */
object FetchProvider {
  ...
  @JSImport("@firebase/auth/dist/rn/internal", "FetchProvider.fetchImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/rn/internal", "FetchProvider.headersImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/rn/internal", "FetchProvider.responseImpl")
  @js.native
