...
import typings.firebaseAuth.anon.InAppBrowser17
...
object nodeEsmSrcPlatformCordovaPluginsMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_cordova/plugins", JSImport.Namespace)
  @js.native
  ...
  trait CordovaWindow
    ...
    var cordova: InAppBrowser17 = js.native
