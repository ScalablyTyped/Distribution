...
object distNodeEsmSrcPlatformCordovaPluginsMod {
  ...
  object CordovaWindow {
    ...
    implicit open class MutableBuilder[Self <: CordovaWindow] (val x: Self) extends AnyVal {
      ...
      inline def setCordova(value: InAppBrowser24): Self = StObject.set(x, "cordova", value.asInstanceOf[js.Any])
