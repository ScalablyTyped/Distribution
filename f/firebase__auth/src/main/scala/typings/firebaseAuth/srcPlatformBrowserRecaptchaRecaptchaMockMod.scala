...
object srcPlatformBrowserRecaptchaRecaptchaMockMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/recaptcha/recaptcha_mock", "MockReCaptcha")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/recaptcha/recaptcha_mock", "MockWidget")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/recaptcha/recaptcha_mock", "_EXPIRATION_TIME_MS")
  @js.native
  val _EXPIRATION_TIME_MS: /* 60000 */ Double = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/recaptcha/recaptcha_mock", "_SOLVE_TIME_MS")
  @js.native
  val _SOLVE_TIME_MS: /* 500 */ Double = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/recaptcha/recaptcha_mock", "_WIDGET_ID_START")
  @js.native
