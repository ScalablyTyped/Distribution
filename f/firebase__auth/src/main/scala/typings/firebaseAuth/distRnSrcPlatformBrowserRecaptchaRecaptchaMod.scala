...
import typings.firebaseAuth.distRnSrcApiAuthenticationRecaptchaMod.GetRecaptchaConfigResponse
...
object distRnSrcPlatformBrowserRecaptchaRecaptchaMod {
  
  @JSImport("@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha", "RecaptchaConfig")
  @js.native
  ...
  inline def isEnterprise(): /* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.GreCAPTCHATopLevel */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEnterprise")().asInstanceOf[/* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.GreCAPTCHATopLevel */ Boolean]
  inline def isEnterprise(grecaptcha: GreCAPTCHA): /* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.GreCAPTCHATopLevel */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEnterprise")(grecaptcha.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.GreCAPTCHATopLevel */ Boolean]
  inline def isEnterprise(grecaptcha: Recaptcha): /* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.GreCAPTCHATopLevel */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEnterprise")(grecaptcha.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.GreCAPTCHATopLevel */ Boolean]
  
  inline def isV2(): /* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.Recaptcha */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isV2")().asInstanceOf[/* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.Recaptcha */ Boolean]
  inline def isV2(grecaptcha: GreCAPTCHA): /* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.Recaptcha */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isV2")(grecaptcha.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.Recaptcha */ Boolean]
  inline def isV2(grecaptcha: Recaptcha): /* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.Recaptcha */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isV2")(grecaptcha.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/auth.@firebase/auth/dist/rn/src/platform_browser/recaptcha/recaptcha.Recaptcha */ Boolean]
