...
object integrationWebdriverUtilAuthDriverMod {
  
  @JSImport("@firebase/auth/dist/node-esm/test/integration/webdriver/util/auth_driver", "AuthDriver")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/test/integration/webdriver/util/auth_driver", "START_FUNCTION")
  @js.native
