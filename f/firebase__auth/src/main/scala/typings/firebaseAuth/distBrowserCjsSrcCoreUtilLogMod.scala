...
object distBrowserCjsSrcCoreUtilLogMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/util/log", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/util/log", "LogLevel")
  @js.native
