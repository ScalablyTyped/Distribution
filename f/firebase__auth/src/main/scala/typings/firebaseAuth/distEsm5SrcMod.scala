...
object distEsm5SrcMod {
  ...
  open class ActionCodeURL protected ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  object AuthErrorCodes {
    ...
    @JSImport("@firebase/auth/dist/esm5/src", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("@firebase/auth/dist/esm5/src", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/esm5/src", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm5/src", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm5/src", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm5/src", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/esm5/src", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm5/src", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
  ...
  /* private */ open class EmailAuthCredential ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.PhoneAuthCredential
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcCoreMod.TwitterAuthProvider
  /* static members */
