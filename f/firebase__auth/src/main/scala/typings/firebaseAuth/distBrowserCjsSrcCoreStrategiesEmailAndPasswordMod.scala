...
object distBrowserCjsSrcCoreStrategiesEmailAndPasswordMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/strategies/email_and_password", JSImport.Namespace)
  @js.native
