...
import typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.EventType
import typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
import typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.PingRequest
import typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.ReceiverMessageResponse
import typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.ReceiverResponse
import typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.TimeoutDuration
import typings.std.ServiceWorker
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distCordovaSrcPlatformBrowserMessagechannelSenderMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/platform_browser/messagechannel/sender", "Sender")
  @js.native
