...
import typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse
...
object distBrowserCjsSrcCoreCredentialsAuthCredentialMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/credentials/auth_credential", "AuthCredential")
  @js.native
