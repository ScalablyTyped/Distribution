...
import typings.firebaseAuth.nodeSrcModelIdTokenMod.IdToken
...
object nodeSrcApiAuthenticationEmailAndPasswordMod {
  
  @JSImport("@firebase/auth/dist/node/src/api/authentication/email_and_password", JSImport.Namespace)
  @js.native
