...
import typings.firebaseAuth.nodeEsmSrcCoreErrorsMod.AuthErrorCode
import typings.firebaseAuth.nodeEsmSrcCoreErrorsMod.AuthErrorParams
...
import typings.firebaseAuth.nodeEsmSrcModelPublicTypesMod.Config
...
import typings.firebaseAuth.srcCoreUtilVersionMod.ClientPlatform
