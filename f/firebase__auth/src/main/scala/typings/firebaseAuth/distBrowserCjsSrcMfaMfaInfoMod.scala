...
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.PhoneMultiFactorInfo
...
object distBrowserCjsSrcMfaMfaInfoMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/browser-cjs/src/mfa/mfa_info", "MultiFactorInfoImpl")
  @js.native
  ...
  object MultiFactorInfoImpl {
    ...
    @JSImport("@firebase/auth/dist/browser-cjs/src/mfa/mfa_info", "MultiFactorInfoImpl")
    @js.native
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/src/mfa/mfa_info", "PhoneMultiFactorInfoImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/src/mfa/mfa_info", "TotpMultiFactorInfoImpl")
  @js.native
