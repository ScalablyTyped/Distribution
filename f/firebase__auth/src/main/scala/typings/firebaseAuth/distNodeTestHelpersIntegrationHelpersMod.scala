...
object distNodeTestHelpersIntegrationHelpersMod {
  ...
  @JSImport("@firebase/auth/dist/node/test/helpers/integration/helpers", "email")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node/test/helpers/integration/helpers", "incorrectTotpCode")
  @js.native
