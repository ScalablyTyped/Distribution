...
import typings.firebaseAuth.distCordovaSrcModelPublicTypesMod.TotpMultiFactorAssertion
import typings.firebaseAuth.firebaseAuthStrings.totp
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@firebase/auth/dist/cordova/index.node", "TotpMultiFactorGenerator")
@js.native
open class TotpMultiFactorGenerator ()
  extends typings.firebaseAuth.distCordovaMod.TotpMultiFactorGenerator
/* static members */
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/cordova/index.node", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
  ...
  inline def assertionForEnrollment(
    secret: typings.firebaseAuth.distCordovaSrcMfaAssertionsTotpMod.TotpSecret,
  ...
  /**
    ...
    */
  inline def generateSecret(session: MultiFactorSession): js.Promise[typings.firebaseAuth.distCordovaSrcMfaAssertionsTotpMod.TotpSecret] = ^.asInstanceOf[js.Dynamic].applyDynamic("generateSecret")(session.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.firebaseAuth.distCordovaSrcMfaAssertionsTotpMod.TotpSecret]]
}
