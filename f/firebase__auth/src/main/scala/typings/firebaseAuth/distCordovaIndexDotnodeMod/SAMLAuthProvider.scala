...
@JSImport("@firebase/auth/dist/cordova/index.node", "SAMLAuthProvider")
@js.native
open class SAMLAuthProvider protected ()
  extends typings.firebaseAuth.distCordovaMod.SAMLAuthProvider {
  /**
...
object SAMLAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/cordova/index.node", "SAMLAuthProvider.samlCredentialFromTaggedObject")
  @js.native
