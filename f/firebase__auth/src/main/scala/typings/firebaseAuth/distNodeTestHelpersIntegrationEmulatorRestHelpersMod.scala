...
object distNodeTestHelpersIntegrationEmulatorRestHelpersMod {
  
  @JSImport("@firebase/auth/dist/node/test/helpers/integration/emulator_rest_helpers", JSImport.Namespace)
  @js.native
