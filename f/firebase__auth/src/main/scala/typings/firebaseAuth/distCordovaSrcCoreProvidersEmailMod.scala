...
import typings.firebaseAuth.distCordovaSrcCoreCredentialsEmailMod.EmailAuthCredential
...
object distCordovaSrcCoreProvidersEmailMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/core/providers/email", "EmailAuthProvider")
  @js.native
  ...
  object EmailAuthProvider {
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/cordova/src/core/providers/email", "EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/cordova/src/core/providers/email", "EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD")
    @js.native
    ...
    /**
      * Always set to {@link ProviderId}.PASSWORD, even for email link.
      */
    @JSImport("@firebase/auth/dist/cordova/src/core/providers/email", "EmailAuthProvider.PROVIDER_ID")
    @js.native
