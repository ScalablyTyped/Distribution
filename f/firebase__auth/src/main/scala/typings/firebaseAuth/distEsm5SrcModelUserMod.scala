...
import typings.firebaseAuth.distEsm5SrcApiAccountManagementAccountMod.APIUserInfo
import typings.firebaseAuth.distEsm5SrcApiAuthenticationMfaMod.FinalizeMfaResponse
import typings.firebaseAuth.distEsm5SrcCoreUserTokenManagerMod.StsTokenManager
import typings.firebaseAuth.distEsm5SrcCoreUserUserMetadataMod.UserMetadata
...
import typings.firebaseAuth.distEsm5SrcModelIdTokenMod.TaggedWithTokenResponse
...
object distEsm5SrcModelUserMod {
  
  /* Inlined {-readonly [ K in keyof @firebase/auth.@firebase/auth/dist/esm5/src/model/public_types.UserInfo ]: @firebase/auth.@firebase/auth/dist/esm5/src/model/public_types.UserInfo[K]} */
