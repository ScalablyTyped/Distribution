...
import typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distBrowserCjsSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
