...
import typings.firebaseAuth.distNodeEsmSrcCoreCredentialsMod.AuthCredential
...
object distNodeEsmSrcCoreProvidersSamlMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/providers/saml", "SAMLAuthProvider")
  @js.native
  ...
  object SAMLAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core/providers/saml", "SAMLAuthProvider.samlCredentialFromTaggedObject")
    @js.native
