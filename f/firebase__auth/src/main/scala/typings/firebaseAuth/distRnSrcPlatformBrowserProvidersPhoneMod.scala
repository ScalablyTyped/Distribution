...
import typings.firebaseAuth.distRnSrcCoreMod.AuthCredential
...
object distRnSrcPlatformBrowserProvidersPhoneMod {
  
  @JSImport("@firebase/auth/dist/rn/src/platform_browser/providers/phone", "PhoneAuthProvider")
  @js.native
  ...
  object PhoneAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/rn/src/platform_browser/providers/phone", "PhoneAuthProvider.PHONE_SIGN_IN_METHOD")
    @js.native
    val PHONE_SIGN_IN_METHOD: phone = js.native
    
    /** Always set to {@link ProviderId}.PHONE. */
    @JSImport("@firebase/auth/dist/rn/src/platform_browser/providers/phone", "PhoneAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/rn/src/platform_browser/providers/phone", "PhoneAuthProvider.credentialFromTaggedObject")
    @js.native
