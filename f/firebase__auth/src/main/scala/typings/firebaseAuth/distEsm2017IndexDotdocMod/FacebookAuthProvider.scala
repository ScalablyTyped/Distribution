...
@JSImport("@firebase/auth/dist/esm2017/index.doc", "FacebookAuthProvider")
@js.native
open class FacebookAuthProvider ()
  extends typings.firebaseAuth.distEsm2017Mod.FacebookAuthProvider
/* static members */
object FacebookAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/esm2017/index.doc", "FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD")
  @js.native
  val FACEBOOK_SIGN_IN_METHOD: facebookDotcom = js.native
  
  /** Always set to {@link ProviderId}.FACEBOOK. */
  @JSImport("@firebase/auth/dist/esm2017/index.doc", "FacebookAuthProvider.PROVIDER_ID")
  @js.native
  ...
  /**
    ...
    */
  inline def credential(accessToken: String): typings.firebaseAuth.distEsm2017SrcCoreCredentialsOauthMod.OAuthCredential = ^.asInstanceOf[js.Dynamic].applyDynamic("credential")(accessToken.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distEsm2017SrcCoreCredentialsOauthMod.OAuthCredential]
  ...
  @JSImport("@firebase/auth/dist/esm2017/index.doc", "FacebookAuthProvider.credentialFromTaggedObject")
  @js.native
