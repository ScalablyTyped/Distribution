...
import typings.firebaseAuth.distNodeEsmSrcCoreErrorsMod.AuthErrorParams
...
import typings.firebaseAuth.distNodeEsmSrcModelPublicTypesMod.Config
...
import typings.firebaseAuth.distNodeEsmSrcPlatformBrowserRecaptchaRecaptchaMod.RecaptchaConfig
