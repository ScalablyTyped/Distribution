...
object distNodeTestIntegrationWebdriverUtilIdpPageMod {
  
  @JSImport("@firebase/auth/dist/node/test/integration/webdriver/util/idp_page", "IdPPage")
  @js.native
  ...
  object IdPPage {
    ...
    @JSImport("@firebase/auth/dist/node/test/integration/webdriver/util/idp_page", "IdPPage.PAGE_TITLE")
    @js.native
