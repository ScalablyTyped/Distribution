...
object distEsm2017SrcCoreProvidersFederatedMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/esm2017/src/core/providers/federated", "FederatedAuthProvider")
  @js.native
