...
import typings.firebaseAuth.distNodeSrcApiAuthenticationMfaMod.FinalizeMfaResponse
...
object distNodeSrcApiAccountManagementMfaMod {
  
  @JSImport("@firebase/auth/dist/node/src/api/account_management/mfa", JSImport.Namespace)
  @js.native
