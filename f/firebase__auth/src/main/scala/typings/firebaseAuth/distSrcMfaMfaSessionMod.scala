...
import typings.firebaseAuth.distSrcModelPublicTypesMod.MultiFactorSession
...
object distSrcMfaMfaSessionMod {
  
  @JSImport("@firebase/auth/dist/src/mfa/mfa_session", "MultiFactorSessionImpl")
  @js.native
