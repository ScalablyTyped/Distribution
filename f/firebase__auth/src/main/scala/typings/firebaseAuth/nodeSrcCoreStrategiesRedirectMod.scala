...
import typings.firebaseAuth.nodeSrcCoreStrategiesAbstractPopupRedirectOperationMod.AbstractPopupRedirectOperation
...
object nodeSrcCoreStrategiesRedirectMod {
