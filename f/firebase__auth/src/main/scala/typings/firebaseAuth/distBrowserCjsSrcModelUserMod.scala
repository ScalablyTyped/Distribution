...
import typings.firebaseAuth.distBrowserCjsSrcApiAccountManagementAccountMod.APIUserInfo
import typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationMfaMod.FinalizeMfaResponse
import typings.firebaseAuth.distBrowserCjsSrcCoreUserTokenManagerMod.StsTokenManager
import typings.firebaseAuth.distBrowserCjsSrcCoreUserUserMetadataMod.UserMetadata
...
import typings.firebaseAuth.distBrowserCjsSrcModelIdTokenMod.TaggedWithTokenResponse
...
object distBrowserCjsSrcModelUserMod {
  
  /* Inlined {-readonly [ K in keyof @firebase/auth.@firebase/auth/dist/browser-cjs/src/model/public_types.UserInfo ]: @firebase/auth.@firebase/auth/dist/browser-cjs/src/model/public_types.UserInfo[K]} */
