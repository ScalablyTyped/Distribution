...
import typings.firebaseAuth.rnSrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object rnSrcCoreProvidersOauthMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/providers/oauth", "BaseOAuthProvider")
  @js.native
