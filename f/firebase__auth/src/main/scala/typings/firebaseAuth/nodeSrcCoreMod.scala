...
object nodeSrcCoreMod {
  ...
  open class ActionCodeURL protected ()
    extends typings.firebaseAuth.nodeSrcCoreActionCodeUrlMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.nodeSrcCoreCredentialsMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  open class EmailAuthProvider ()
    extends typings.firebaseAuth.nodeSrcCoreProvidersEmailMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.nodeSrcCoreProvidersFacebookMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.nodeSrcCoreProvidersGithubMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.nodeSrcCoreProvidersGoogleMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.nodeSrcCoreProvidersOauthMod.OAuthProvider {
    /**
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.nodeSrcCoreProvidersSamlMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typings.firebaseAuth.nodeSrcCoreProvidersTwitterMod.TwitterAuthProvider
  /* static members */
