...
import typings.firebaseAuth.srcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nodeEsmSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.nodeEsmSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typings.firebaseAuth.nodeEsmSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typings.firebaseAuth.nodeEsmSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.nodeEsmSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
