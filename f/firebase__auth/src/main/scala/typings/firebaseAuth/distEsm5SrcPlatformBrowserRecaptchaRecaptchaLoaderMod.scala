...
object distEsm5SrcPlatformBrowserRecaptchaRecaptchaLoaderMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/platform_browser/recaptcha/recaptcha_loader", "MockReCaptchaLoaderImpl")
  @js.native
  open class MockReCaptchaLoaderImpl ()
    extends StObject
       with ReCaptchaLoader
  
  @JSImport("@firebase/auth/dist/esm5/src/platform_browser/recaptcha/recaptcha_loader", "ReCaptchaLoaderImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm5/src/platform_browser/recaptcha/recaptcha_loader", "_JSLOAD_CALLBACK")
  @js.native
