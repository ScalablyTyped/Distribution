...
object distBrowserCjsTestIntegrationWebdriverUtilAuthDriverMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/test/integration/webdriver/util/auth_driver", "AuthDriver")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/test/integration/webdriver/util/auth_driver", "START_FUNCTION")
  @js.native
