...
object distBrowserCjsSrcCoreProvidersSamlMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/providers/saml", "SAMLAuthProvider")
  @js.native
  ...
  object SAMLAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/browser-cjs/src/core/providers/saml", "SAMLAuthProvider.samlCredentialFromTaggedObject")
    @js.native
