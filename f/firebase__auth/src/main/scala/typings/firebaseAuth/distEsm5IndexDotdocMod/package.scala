...
import typings.firebaseAuth.distEsm5IndexDotdocMod.^
...
import typings.firebaseAuth.distEsm5SrcModelPublicTypesMod.ReactNativeAsyncStorage
...
inline def reactNativeLocalPersistence: Persistence = ^.asInstanceOf[js.Dynamic].selectDynamic("reactNativeLocalPersistence").asInstanceOf[Persistence]
