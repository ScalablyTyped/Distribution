...
object distNodeSrcPlatformCordovaPluginsMod {
  
  @JSImport("@firebase/auth/dist/node/src/platform_cordova/plugins", JSImport.Namespace)
  @js.native
  ...
  object CordovaWindow {
    ...
    implicit open class MutableBuilder[Self <: CordovaWindow] (val x: Self) extends AnyVal {
      ...
      inline def setCordova(value: InAppBrowser31): Self = StObject.set(x, "cordova", value.asInstanceOf[js.Any])
