...
object distCordovaTestHelpersIntegrationHelpersMod {
  ...
  @JSImport("@firebase/auth/dist/cordova/test/helpers/integration/helpers", "email")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/cordova/test/helpers/integration/helpers", "incorrectTotpCode")
  @js.native
