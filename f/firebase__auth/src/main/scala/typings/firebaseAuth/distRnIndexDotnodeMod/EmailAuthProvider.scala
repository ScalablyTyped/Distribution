...
@JSImport("@firebase/auth/dist/rn/index.node", "EmailAuthProvider")
@js.native
...
object EmailAuthProvider {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/rn/index.node", "EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/rn/index.node", "EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/rn/index.node", "EmailAuthProvider.PROVIDER_ID")
  @js.native
