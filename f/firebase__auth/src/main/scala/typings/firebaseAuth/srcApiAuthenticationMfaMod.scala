...
object srcApiAuthenticationMfaMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/api/authentication/mfa", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.apiAuthenticationSmsMod.SignInWithPhoneNumberResponse
    - typings.firebaseAuth.apiAuthenticationIdpMod.SignInWithIdpResponse
    - typings.firebaseAuth.srcModelIdTokenMod.IdTokenResponse
  */
  trait PhoneOrOauthTokenResponse extends StObject
  object PhoneOrOauthTokenResponse {
    
    inline def IdTokenResponse(localId: String): typings.firebaseAuth.srcModelIdTokenMod.IdTokenResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.srcModelIdTokenMod.IdTokenResponse]
    }
    
    inline def SignInWithIdpResponse(localId: String): typings.firebaseAuth.apiAuthenticationIdpMod.SignInWithIdpResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.apiAuthenticationIdpMod.SignInWithIdpResponse]
    }
    
    inline def SignInWithPhoneNumberResponse(localId: String): typings.firebaseAuth.apiAuthenticationSmsMod.SignInWithPhoneNumberResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.apiAuthenticationSmsMod.SignInWithPhoneNumberResponse]
    }
  }
