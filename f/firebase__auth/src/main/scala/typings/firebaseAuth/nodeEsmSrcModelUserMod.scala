...
import typings.firebaseAuth.nodeEsmSrcModelIdTokenMod.TaggedWithTokenResponse
...
import typings.firebaseAuth.srcApiAccountManagementAccountMod.APIUserInfo
import typings.firebaseAuth.srcCoreUserTokenManagerMod.StsTokenManager
import typings.firebaseAuth.srcCoreUserUserMetadataMod.UserMetadata
import typings.firebaseUtil.mod.NextFn
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nodeEsmSrcModelUserMod {
  
  /* Inlined {-readonly [ K in keyof @firebase/auth.@firebase/auth/dist/node-esm/src/model/public_types.UserInfo ]: @firebase/auth.@firebase/auth/dist/node-esm/src/model/public_types.UserInfo[K]} */
