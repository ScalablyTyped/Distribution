...
import typings.firebaseAuth.distEsm5SrcMfaMfaAssertionMod.MultiFactorAssertionImpl
import typings.firebaseAuth.distEsm5SrcMfaMfaErrorMod.MultiFactorError
import typings.firebaseAuth.distEsm5SrcMfaMfaInfoMod.MultiFactorInfoImpl
...
import typings.firebaseAuth.distEsm5SrcModelPublicTypesMod.MultiFactorInfo
...
object distEsm5SrcMfaMfaResolverMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/mfa/mfa_resolver", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm5/src/mfa/mfa_resolver", "MultiFactorResolverImpl")
  @js.native
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typings.firebaseAuth.distEsm5SrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
