...
object distBrowserCjsSrcCoreUserUserCredentialImplMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.firebaseAuth.distBrowserCjsSrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/browser-cjs/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
  ...
  object UserCredentialImpl {
    ...
    @JSImport("@firebase/auth/dist/browser-cjs/src/core/user/user_credential_impl", "UserCredentialImpl")
    @js.native
