...
import typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.EventType
import typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
import typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.PingRequest
import typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.ReceiverMessageResponse
import typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.ReceiverResponse
import typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.TimeoutDuration
import typings.std.ServiceWorker
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distRnSrcPlatformBrowserMessagechannelSenderMod {
  
  @JSImport("@firebase/auth/dist/rn/src/platform_browser/messagechannel/sender", "Sender")
  @js.native
