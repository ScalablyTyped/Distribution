...
@JSImport("@firebase/auth/dist/esm2017/index.node", "TwitterAuthProvider")
@js.native
...
object TwitterAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/esm2017/index.node", "TwitterAuthProvider.PROVIDER_ID")
  @js.native
  val PROVIDER_ID: twitterDotcom = js.native
  
  /** Always set to {@link SignInMethod}.TWITTER. */
  @JSImport("@firebase/auth/dist/esm2017/index.node", "TwitterAuthProvider.TWITTER_SIGN_IN_METHOD")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm2017/index.node", "TwitterAuthProvider.credentialFromTaggedObject")
  @js.native
