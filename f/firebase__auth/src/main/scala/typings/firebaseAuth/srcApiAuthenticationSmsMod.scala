...
object srcApiAuthenticationSmsMod {
  ...
  - typings.firebaseAuth.nodeEsmSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
