...
object distRnTestHelpersIntegrationHelpersMod {
  ...
  @JSImport("@firebase/auth/dist/rn/test/helpers/integration/helpers", "email")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/rn/test/helpers/integration/helpers", "incorrectTotpCode")
  @js.native
