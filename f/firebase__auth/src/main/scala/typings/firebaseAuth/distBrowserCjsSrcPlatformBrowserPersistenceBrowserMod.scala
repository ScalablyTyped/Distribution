...
object distBrowserCjsSrcPlatformBrowserPersistenceBrowserMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/persistence/browser", "BrowserPersistenceClass")
  @js.native
