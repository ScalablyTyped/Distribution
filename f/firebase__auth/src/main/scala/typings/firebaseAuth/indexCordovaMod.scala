...
object indexCordovaMod {
  ...
  open class ActionCodeURL protected ()
    extends typings.firebaseAuth.indexSharedMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.indexSharedMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  /* private */ open class EmailAuthCredential ()
    extends typings.firebaseAuth.indexSharedMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typings.firebaseAuth.indexSharedMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.indexSharedMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.indexSharedMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.indexSharedMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typings.firebaseAuth.indexSharedMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.indexSharedMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typings.firebaseAuth.indexSharedMod.PhoneAuthCredential
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.indexSharedMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typings.firebaseAuth.indexSharedMod.TwitterAuthProvider
  /* static members */
