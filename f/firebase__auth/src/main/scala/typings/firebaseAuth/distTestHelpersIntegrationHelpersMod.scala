...
object distTestHelpersIntegrationHelpersMod {
  
  @JSImport("@firebase/auth/dist/test/helpers/integration/helpers", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@firebase/auth/dist/test/helpers/integration/helpers", "email")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/test/helpers/integration/helpers", "incorrectTotpCode")
  @js.native
