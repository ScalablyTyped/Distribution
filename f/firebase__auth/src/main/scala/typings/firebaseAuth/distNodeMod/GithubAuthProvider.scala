...
@JSImport("@firebase/auth/dist/node", "GithubAuthProvider")
@js.native
...
object GithubAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/node", "GithubAuthProvider.GITHUB_SIGN_IN_METHOD")
  @js.native
  val GITHUB_SIGN_IN_METHOD: githubDotcom = js.native
  
  /** Always set to {@link ProviderId}.GITHUB. */
  @JSImport("@firebase/auth/dist/node", "GithubAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node", "GithubAuthProvider.credentialFromTaggedObject")
  @js.native
