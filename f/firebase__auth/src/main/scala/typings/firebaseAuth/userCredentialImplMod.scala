...
import typings.firebaseAuth.enumsMod.OperationType
...
object userCredentialImplMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.firebaseAuth.userCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/cordova/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
