...
import typings.firebaseAuth.srcModelIdTokenMod.IdToken
...
object srcApiAuthenticationEmailAndPasswordMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/api/authentication/email_and_password", JSImport.Namespace)
  @js.native
