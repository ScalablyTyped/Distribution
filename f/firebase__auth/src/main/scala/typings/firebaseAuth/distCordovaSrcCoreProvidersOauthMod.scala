...
import typings.firebaseAuth.distCordovaSrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object distCordovaSrcCoreProvidersOauthMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/cordova/src/core/providers/oauth", "BaseOAuthProvider")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/cordova/src/core/providers/oauth", "OAuthProvider")
  @js.native
  ...
  object OAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/cordova/src/core/providers/oauth", "OAuthProvider.oauthCredentialFromTaggedObject")
    @js.native
