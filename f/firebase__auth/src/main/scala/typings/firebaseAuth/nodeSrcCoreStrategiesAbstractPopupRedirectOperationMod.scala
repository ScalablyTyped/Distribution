...
object nodeSrcCoreStrategiesAbstractPopupRedirectOperationMod {
  
  @JSImport("@firebase/auth/dist/node/src/core/strategies/abstract_popup_redirect_operation", "AbstractPopupRedirectOperation")
  @js.native
