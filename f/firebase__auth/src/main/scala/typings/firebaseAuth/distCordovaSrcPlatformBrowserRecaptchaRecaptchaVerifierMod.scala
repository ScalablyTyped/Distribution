...
import typings.firebaseAuth.distCordovaSrcModelApplicationVerifierMod.ApplicationVerifierInternal
...
import typings.firebaseAuth.distCordovaSrcPlatformBrowserRecaptchaRecaptchaLoaderMod.ReCaptchaLoader
