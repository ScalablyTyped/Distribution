...
object distNodeEsmTestHelpersIntegrationHelpersMod {
  ...
  @JSImport("@firebase/auth/dist/node-esm/test/helpers/integration/helpers", "email")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/test/helpers/integration/helpers", "incorrectTotpCode")
  @js.native
