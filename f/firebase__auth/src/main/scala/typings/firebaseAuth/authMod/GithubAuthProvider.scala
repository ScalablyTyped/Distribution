...
@JSImport("@firebase/auth/dist/auth", "GithubAuthProvider")
@js.native
...
object GithubAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/auth", "GithubAuthProvider.GITHUB_SIGN_IN_METHOD")
  @js.native
  val GITHUB_SIGN_IN_METHOD: githubDotcom = js.native
  
  /** Always set to {@link ProviderId}.GITHUB. */
  @JSImport("@firebase/auth/dist/auth", "GithubAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/auth", "GithubAuthProvider.credentialFromTaggedObject")
  @js.native
