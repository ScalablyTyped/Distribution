...
@JSImport("@firebase/auth/dist/auth", "EmailAuthProvider")
@js.native
...
object EmailAuthProvider {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/auth", "EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/auth", "EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    * Always set to {@link ProviderId}.PASSWORD, even for email link.
    */
  @JSImport("@firebase/auth/dist/auth", "EmailAuthProvider.PROVIDER_ID")
  @js.native
