...
object rnSrcApiAuthenticationSmsMod {
  ...
  - typings.firebaseAuth.rnSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
