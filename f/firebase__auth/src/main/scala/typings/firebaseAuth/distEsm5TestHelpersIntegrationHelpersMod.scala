...
object distEsm5TestHelpersIntegrationHelpersMod {
  ...
  @JSImport("@firebase/auth/dist/esm5/test/helpers/integration/helpers", "email")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm5/test/helpers/integration/helpers", "incorrectTotpCode")
  @js.native
