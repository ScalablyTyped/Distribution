...
object distEsm5TestIntegrationWebdriverUtilIdpPageMod {
  
  @JSImport("@firebase/auth/dist/esm5/test/integration/webdriver/util/idp_page", "IdPPage")
  @js.native
  ...
  object IdPPage {
    ...
    @JSImport("@firebase/auth/dist/esm5/test/integration/webdriver/util/idp_page", "IdPPage.PAGE_TITLE")
    @js.native
