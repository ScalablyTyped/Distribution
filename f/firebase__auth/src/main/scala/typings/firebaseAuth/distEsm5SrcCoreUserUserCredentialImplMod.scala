...
object distEsm5SrcCoreUserUserCredentialImplMod {
  ...
  - typings.firebaseAuth.distEsm5SrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/esm5/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
