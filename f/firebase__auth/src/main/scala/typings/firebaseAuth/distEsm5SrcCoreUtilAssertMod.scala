...
object distEsm5SrcCoreUtilAssertMod {
  ...
  {{{
  type TypeExpectation = std.Function | string | @firebase/auth.@firebase/auth/dist/esm5/src/core/util/assert.MapType
  }}}
  to avoid circular code involving: 
  - @firebase/auth.@firebase/auth/dist/esm5/src/core/util/assert.MapType
  - @firebase/auth.@firebase/auth/dist/esm5/src/core/util/assert.TypeExpectation
  */
