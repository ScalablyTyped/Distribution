...
import typings.firebaseAuth.distNodeEsmSrcApiMod.RecaptchaClientType
import typings.firebaseAuth.distNodeEsmSrcApiMod.RecaptchaVersion
import typings.firebaseAuth.distNodeEsmSrcModelIdTokenMod.IdToken
...
object distNodeEsmSrcApiAuthenticationEmailAndPasswordMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/api/authentication/email_and_password", JSImport.Namespace)
  @js.native
