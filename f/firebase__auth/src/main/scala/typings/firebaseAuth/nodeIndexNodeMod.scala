...
object nodeIndexNodeMod {
  ...
  open class EmailAuthProvider ()
    extends typings.firebaseAuth.nodeMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.nodeMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.nodeMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.nodeMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typings.firebaseAuth.nodeMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.nodeMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typings.firebaseAuth.nodeMod.PhoneAuthCredential
  /* static members */
  ...
  open class PhoneAuthProvider protected ()
    extends typings.firebaseAuth.nodeMod.PhoneAuthProvider {
    /**
  ...
  /* private */ open class PhoneMultiFactorGenerator ()
    extends typings.firebaseAuth.nodeMod.PhoneMultiFactorGenerator
  /* static members */
  ...
  open class RecaptchaVerifier protected ()
    extends typings.firebaseAuth.nodeMod.RecaptchaVerifier {
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.nodeMod.SAMLAuthProvider {
    /**
