...
import typings.firebaseAuth.distCordovaSrcCoreCredentialsPhoneMod.PhoneAuthCredential
...
object distCordovaSrcPlatformBrowserMfaAssertionsPhoneMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorAssertionImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/cordova/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorGenerator")
  @js.native
  ...
  object PhoneMultiFactorGenerator {
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/cordova/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorGenerator.FACTOR_ID")
    @js.native
