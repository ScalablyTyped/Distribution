...
import typings.firebaseAuth.distEsm2017SrcCoreCredentialsOauthMod.OAuthCredential
import typings.firebaseAuth.distEsm2017SrcCoreProvidersOauthMod.BaseOAuthProvider
...
object distEsm2017SrcCoreProvidersGithubMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/core/providers/github", "GithubAuthProvider")
  @js.native
  ...
  object GithubAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/core/providers/github", "GithubAuthProvider.GITHUB_SIGN_IN_METHOD")
    @js.native
    val GITHUB_SIGN_IN_METHOD: githubDotcom = js.native
    
    /** Always set to {@link ProviderId}.GITHUB. */
    @JSImport("@firebase/auth/dist/esm2017/src/core/providers/github", "GithubAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/core/providers/github", "GithubAuthProvider.credentialFromTaggedObject")
    @js.native
