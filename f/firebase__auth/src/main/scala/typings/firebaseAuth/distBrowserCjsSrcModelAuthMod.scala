...
import typings.firebaseAuth.distBrowserCjsSrcCoreErrorsMod.AuthErrorParams
import typings.firebaseAuth.distBrowserCjsSrcCoreUtilVersionMod.ClientPlatform
import typings.firebaseAuth.distBrowserCjsSrcModelPopupRedirectMod.PopupRedirectResolverInternal
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.Auth
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.Config
...
import typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserRecaptchaRecaptchaMod.RecaptchaConfig
...
object distBrowserCjsSrcModelAuthMod {
