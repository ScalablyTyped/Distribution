...
object distRnSrcCoreUtilAssertMod {
  ...
  {{{
  type TypeExpectation = std.Function | string | @firebase/auth.@firebase/auth/dist/rn/src/core/util/assert.MapType
  }}}
  to avoid circular code involving: 
  - @firebase/auth.@firebase/auth/dist/rn/src/core/util/assert.MapType
  - @firebase/auth.@firebase/auth/dist/rn/src/core/util/assert.TypeExpectation
  */
