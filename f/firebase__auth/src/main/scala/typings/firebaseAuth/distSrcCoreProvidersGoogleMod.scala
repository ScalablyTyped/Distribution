...
import typings.firebaseAuth.distSrcCoreCredentialsOauthMod.OAuthCredential
import typings.firebaseAuth.distSrcCoreProvidersOauthMod.BaseOAuthProvider
...
object distSrcCoreProvidersGoogleMod {
  
  @JSImport("@firebase/auth/dist/src/core/providers/google", "GoogleAuthProvider")
  @js.native
  ...
  object GoogleAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/src/core/providers/google", "GoogleAuthProvider.GOOGLE_SIGN_IN_METHOD")
    @js.native
    val GOOGLE_SIGN_IN_METHOD: googleDotcom = js.native
    
    /** Always set to {@link ProviderId}.GOOGLE. */
    @JSImport("@firebase/auth/dist/src/core/providers/google", "GoogleAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/src/core/providers/google", "GoogleAuthProvider.credentialFromTaggedObject")
    @js.native
