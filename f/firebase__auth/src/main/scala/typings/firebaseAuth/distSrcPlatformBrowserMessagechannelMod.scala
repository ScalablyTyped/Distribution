...
import typings.firebaseAuth.distSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typings.firebaseAuth.distSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typings.firebaseAuth.distSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
