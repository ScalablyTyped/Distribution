...
import typings.firebaseAuth.distSrcApiAccountManagementMfaMod.TotpVerificationInfo
import typings.firebaseAuth.distSrcMfaMfaAssertionMod.MultiFactorAssertionImpl
...
object distSrcMfaAssertionsTotpMod {
  
  @JSImport("@firebase/auth/dist/src/mfa/assertions/totp", "TotpMultiFactorAssertionImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/src/mfa/assertions/totp", "TotpMultiFactorGenerator")
  @js.native
  ...
  object TotpMultiFactorGenerator {
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/src/mfa/assertions/totp", "TotpMultiFactorGenerator.FACTOR_ID")
    @js.native
  ...
  @JSImport("@firebase/auth/dist/src/mfa/assertions/totp", "TotpSecret")
  @js.native
