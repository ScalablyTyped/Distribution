...
import typings.firebaseAuth.distNodeEsmSrcCorePersistenceMod.PersistenceType
import typings.firebaseAuth.distNodeEsmSrcCorePersistenceMod.PersistenceValue
