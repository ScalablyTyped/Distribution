...
object nodeSrcPlatformBrowserUtilPopupMod {
  
  @JSImport("@firebase/auth/dist/node/src/platform_browser/util/popup", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node/src/platform_browser/util/popup", "AuthPopup")
  @js.native
