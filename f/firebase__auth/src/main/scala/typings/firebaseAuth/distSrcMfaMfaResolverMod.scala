...
import typings.firebaseAuth.distSrcMfaMfaErrorMod.MultiFactorError
import typings.firebaseAuth.distSrcMfaMfaInfoMod.MultiFactorInfoImpl
...
object distSrcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typings.firebaseAuth.distSrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
