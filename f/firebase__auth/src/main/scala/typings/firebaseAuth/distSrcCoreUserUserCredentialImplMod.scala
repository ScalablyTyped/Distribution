...
object distSrcCoreUserUserCredentialImplMod {
  ...
  - typings.firebaseAuth.distSrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
