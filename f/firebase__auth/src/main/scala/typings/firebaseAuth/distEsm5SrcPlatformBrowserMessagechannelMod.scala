...
import typings.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distEsm5SrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typings.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typings.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
