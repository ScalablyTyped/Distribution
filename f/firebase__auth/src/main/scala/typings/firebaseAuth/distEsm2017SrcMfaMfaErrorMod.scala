...
object distEsm2017SrcMfaMfaErrorMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/mfa/mfa_error", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm2017/src/mfa/mfa_error", "MultiFactorError")
  @js.native
  /* private */ open class MultiFactorError ()
    extends typings.firebaseAuth.distEsm2017SrcModelPublicTypesMod.MultiFactorError {
  ...
  type MultiFactorErrorData = (/* import warning: importer.ImportType#apply Failed type conversion: @firebase/auth.@firebase/auth/dist/esm2017/src/model/public_types.AuthError['customData'] */ js.Any) & `2` & `10`
}
