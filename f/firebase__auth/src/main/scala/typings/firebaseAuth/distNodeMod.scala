...
object distNodeMod {
  ...
  open class PhoneAuthProvider protected ()
    extends typings.firebaseAuth.distNodeSrcPlatformBrowserProvidersPhoneMod.PhoneAuthProvider {
    /**
  ...
  open class RecaptchaVerifier protected ()
    extends typings.firebaseAuth.distNodeSrcPlatformBrowserRecaptchaRecaptchaVerifierMod.RecaptchaVerifier {
