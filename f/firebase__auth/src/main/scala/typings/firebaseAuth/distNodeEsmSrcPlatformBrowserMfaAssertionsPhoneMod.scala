...
object distNodeEsmSrcPlatformBrowserMfaAssertionsPhoneMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorAssertionImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorGenerator")
  @js.native
  ...
  object PhoneMultiFactorGenerator {
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorGenerator.FACTOR_ID")
    @js.native
