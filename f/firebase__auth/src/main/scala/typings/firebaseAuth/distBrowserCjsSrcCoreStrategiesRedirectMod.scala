...
import typings.firebaseAuth.distBrowserCjsSrcCoreStrategiesAbstractPopupRedirectOperationMod.AbstractPopupRedirectOperation
...
object distBrowserCjsSrcCoreStrategiesRedirectMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/strategies/redirect", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/strategies/redirect", "RedirectAction")
  @js.native
