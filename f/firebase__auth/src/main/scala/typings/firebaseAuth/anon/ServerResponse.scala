...
import typings.firebaseAuth.authMod.IdTokenMfaResponse
...
object ServerResponse {
  ...
  inline def apply(_serverResponse: IdTokenMfaResponse, appName: typings.firebaseAuth.authMod.AppName): ServerResponse = {
