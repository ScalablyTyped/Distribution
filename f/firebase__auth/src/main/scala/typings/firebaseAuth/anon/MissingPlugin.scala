...
trait MissingPlugin extends StObject {
  ...
  var appName: typings.firebaseAuth.authMod.AppName
  
  var missingPlugin: js.UndefOr[String] = js.undefined
}
object MissingPlugin {
  
  inline def apply(appName: typings.firebaseAuth.authMod.AppName): MissingPlugin = {
  ...
  extension [Self <: MissingPlugin](x: Self) {
    ...
    inline def setAppName(value: typings.firebaseAuth.authMod.AppName): Self = StObject.set(x, "appName", value.asInstanceOf[js.Any])
