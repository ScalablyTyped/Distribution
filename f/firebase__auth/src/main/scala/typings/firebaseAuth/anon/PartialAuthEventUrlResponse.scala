...
import typings.firebaseAuth.distSrcModelPopupRedirectMod.AuthEventError
import typings.firebaseAuth.distSrcModelPopupRedirectMod.AuthEventType
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<@firebase/auth.@firebase/auth/dist/src/model/popup_redirect.AuthEvent> */
trait PartialAuthEventUrlResponse extends StObject {
...
object PartialAuthEventUrlResponse {
  
  inline def apply(): PartialAuthEventUrlResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAuthEventUrlResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAuthEventUrlResponse] (val x: Self) extends AnyVal {
