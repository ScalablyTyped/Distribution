...
trait PreviousEmail extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[typings.firebaseAuth.publicTypesMod.MultiFactorInfo | Null] = js.undefined
...
object PreviousEmail {
  ...
  extension [Self <: PreviousEmail](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typings.firebaseAuth.publicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
