...
trait Email extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[typings.firebaseAuth.mod.MultiFactorInfo | Null] = js.undefined
...
object Email {
  ...
  implicit open class MutableBuilder[Self <: Email] (val x: Self) extends AnyVal {
    ...
    inline def setMultiFactorInfo(value: typings.firebaseAuth.mod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
