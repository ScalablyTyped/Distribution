...
trait `23` extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[typings.firebaseAuth.nodeSrcModelPublicTypesMod.MultiFactorInfo | Null] = js.undefined
...
object `23` {
  ...
  extension [Self <: `23`](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typings.firebaseAuth.nodeSrcModelPublicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
