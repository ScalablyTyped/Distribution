...
trait MultiFactorInfoPreviousEmail extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[typings.firebaseAuth.srcModelPublicTypesMod.MultiFactorInfo | Null] = js.undefined
...
object MultiFactorInfoPreviousEmail {
  ...
  extension [Self <: MultiFactorInfoPreviousEmail](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typings.firebaseAuth.srcModelPublicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
