...
import typings.firebaseAuth.srcModelPopupRedirectMod.EventManager
import typings.firebaseAuth.srcModelPublicTypesMod.PopupRedirectResolver
import typings.firebaseAuth.srcPlatformBrowserUtilPopupMod.AuthPopup
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object testHelpersMockPopupRedirectResolverMod {
  
  @JSImport("@firebase/auth/dist/esm5/test/helpers/mock_popup_redirect_resolver", JSImport.Namespace)
  @js.native
