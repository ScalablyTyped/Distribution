...
object srcCoreActionCodeUrlMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/core/action_code_url", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm5/src/core/action_code_url", "ActionCodeURL")
  @js.native
