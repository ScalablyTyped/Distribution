...
object distRnTestHelpersMockAuthMod {
  ...
  object FAKE_APP_CHECK_CONTROLLER {
    ...
    @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "FAKE_APP_CHECK_CONTROLLER")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "FAKE_APP_CHECK_CONTROLLER_PROVIDER")
  @js.native
