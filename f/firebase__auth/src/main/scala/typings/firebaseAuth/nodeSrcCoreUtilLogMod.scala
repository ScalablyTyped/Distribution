...
object nodeSrcCoreUtilLogMod {
  
  @JSImport("@firebase/auth/dist/node/src/core/util/log", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node/src/core/util/log", "LogLevel")
  @js.native
