...
import typings.firebaseAuth.distRnSrcApiMod.RecaptchaClientType
import typings.firebaseAuth.distRnSrcApiMod.RecaptchaVersion
import typings.firebaseAuth.distRnSrcModelIdTokenMod.IdToken
...
object distRnSrcApiAuthenticationEmailAndPasswordMod {
  
  @JSImport("@firebase/auth/dist/rn/src/api/authentication/email_and_password", JSImport.Namespace)
  @js.native
