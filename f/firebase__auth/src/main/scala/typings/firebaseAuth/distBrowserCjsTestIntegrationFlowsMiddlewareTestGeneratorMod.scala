...
object distBrowserCjsTestIntegrationFlowsMiddlewareTestGeneratorMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/test/integration/flows/middleware_test_generator", JSImport.Namespace)
  @js.native
