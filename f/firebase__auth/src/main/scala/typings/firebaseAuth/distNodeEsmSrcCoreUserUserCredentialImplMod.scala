...
object distNodeEsmSrcCoreUserUserCredentialImplMod {
  ...
  - typings.firebaseAuth.distNodeEsmSrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/node-esm/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
