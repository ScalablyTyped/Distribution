...
import typings.firebaseAuth.distNodeEsmSrcModelEnumsMod.OperationType
...
object distNodeEsmSrcMfaMfaErrorMod {
  ...
  /* private */ open class MultiFactorError ()
    extends typings.firebaseAuth.distNodeEsmSrcModelPublicTypesMod.MultiFactorError {
  ...
  type MultiFactorErrorData = (/* import warning: importer.ImportType#apply Failed type conversion: @firebase/auth.@firebase/auth/dist/node-esm/src/model/public_types.AuthError['customData'] */ js.Any) & `2` & `22`
}
