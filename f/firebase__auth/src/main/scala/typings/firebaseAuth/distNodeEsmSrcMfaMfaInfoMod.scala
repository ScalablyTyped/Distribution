...
import typings.firebaseAuth.distNodeEsmSrcModelPublicTypesMod.PhoneMultiFactorInfo
...
object distNodeEsmSrcMfaMfaInfoMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/node-esm/src/mfa/mfa_info", "MultiFactorInfoImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/src/mfa/mfa_info", "TotpMultiFactorInfoImpl")
  @js.native
