...
import typings.firebaseAuth.distNodeSrcModelIdTokenMod.IdToken
...
object distNodeSrcApiAuthenticationIdpMod {
  
  @JSImport("@firebase/auth/dist/node/src/api/authentication/idp", JSImport.Namespace)
  @js.native
  ...
  - typings.firebaseAuth.distNodeSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
