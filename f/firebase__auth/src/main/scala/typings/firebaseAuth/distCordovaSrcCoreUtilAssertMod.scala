...
object distCordovaSrcCoreUtilAssertMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/core/util/assert", JSImport.Namespace)
  @js.native
  ...
  {{{
  type TypeExpectation = std.Function | string | @firebase/auth.@firebase/auth/dist/cordova/src/core/util/assert.MapType
  }}}
  to avoid circular code involving: 
  - @firebase/auth.@firebase/auth/dist/cordova/src/core/util/assert.MapType
  - @firebase/auth.@firebase/auth/dist/cordova/src/core/util/assert.TypeExpectation
  */
