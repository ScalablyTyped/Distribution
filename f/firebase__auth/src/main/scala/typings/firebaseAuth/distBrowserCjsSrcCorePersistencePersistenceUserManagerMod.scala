...
import typings.firebaseAuth.distBrowserCjsSrcModelAuthMod.ApiKey
import typings.firebaseAuth.distBrowserCjsSrcModelAuthMod.AppName
...
object distBrowserCjsSrcCorePersistencePersistenceUserManagerMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/persistence/persistence_user_manager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/persistence/persistence_user_manager", "PersistenceUserManager")
  @js.native
