...
import typings.firebaseAuth.nodeEsmSrcMfaMfaAssertionMod.MultiFactorAssertionImpl
import typings.firebaseAuth.nodeEsmSrcMfaMfaErrorMod.MultiFactorError
import typings.firebaseAuth.nodeEsmSrcMfaMfaInfoMod.MultiFactorInfoImpl
...
import typings.firebaseAuth.nodeEsmSrcModelPublicTypesMod.MultiFactorSession
import typings.firebaseAuth.nodeEsmSrcModelPublicTypesMod.UserCredential
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nodeEsmSrcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typings.firebaseAuth.nodeEsmSrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
