...
import typings.firebaseAuth.distNodeEsmSrcModelPublicTypesMod.TotpMultiFactorAssertion
import typings.firebaseAuth.firebaseAuthStrings.totp
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@firebase/auth/dist/node-esm/index.doc", "TotpMultiFactorGenerator")
@js.native
open class TotpMultiFactorGenerator ()
  extends typings.firebaseAuth.distNodeEsmMod.TotpMultiFactorGenerator
/* static members */
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/node-esm/index.doc", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
  ...
  inline def assertionForEnrollment(
    secret: typings.firebaseAuth.distNodeEsmSrcMfaAssertionsTotpMod.TotpSecret,
  ...
  /**
    ...
    */
  inline def generateSecret(session: MultiFactorSession): js.Promise[typings.firebaseAuth.distNodeEsmSrcMfaAssertionsTotpMod.TotpSecret] = ^.asInstanceOf[js.Dynamic].applyDynamic("generateSecret")(session.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.firebaseAuth.distNodeEsmSrcMfaAssertionsTotpMod.TotpSecret]]
}
