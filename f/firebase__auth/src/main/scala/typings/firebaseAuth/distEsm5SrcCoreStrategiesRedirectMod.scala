...
import typings.firebaseAuth.distEsm5SrcCoreStrategiesAbstractPopupRedirectOperationMod.AbstractPopupRedirectOperation
...
object distEsm5SrcCoreStrategiesRedirectMod {
