...
object srcPlatformBrowserPersistenceIndexedDbMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/persistence/indexed_db", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/persistence/indexed_db", "DB_NAME")
  @js.native
  val DB_NAME: /* "firebaseLocalStorageDb" */ String = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/persistence/indexed_db", "_POLLING_INTERVAL_MS")
  @js.native
  val _POLLING_INTERVAL_MS: /* 800 */ Double = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/persistence/indexed_db", "_TRANSACTION_RETRY_COUNT")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/persistence/indexed_db", "indexedDBLocalPersistence")
  @js.native
