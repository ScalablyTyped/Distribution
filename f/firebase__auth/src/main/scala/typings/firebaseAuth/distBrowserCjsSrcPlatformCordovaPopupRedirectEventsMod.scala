...
import typings.firebaseAuth.distBrowserCjsSrcCoreAuthAuthEventManagerMod.AuthEventManager
...
object distBrowserCjsSrcPlatformCordovaPopupRedirectEventsMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_cordova/popup_redirect/events", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_cordova/popup_redirect/events", "CordovaAuthEventManager")
  @js.native
