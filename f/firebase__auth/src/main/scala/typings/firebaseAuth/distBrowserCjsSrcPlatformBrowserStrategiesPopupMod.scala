...
object distBrowserCjsSrcPlatformBrowserStrategiesPopupMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/strategies/popup", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/strategies/popup", "_POLL_WINDOW_CLOSE_TIMEOUT")
  @js.native
