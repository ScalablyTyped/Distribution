...
import typings.firebaseAuth.esm5SrcCoreErrorsMod.AuthErrorCode
...
object coreUtilAssertMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/core/util/assert", JSImport.Namespace)
  @js.native
  ...
  inline def assert[K /* <: AuthErrorCode */](
    ...
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param data because its type {} extends AuthErrorParams[K] ? [AuthErrorParams[K] | undefined] : [AuthErrorParams[K]] is not an array type */ data: js.Array[
      js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: @firebase/auth.@firebase/auth/dist/esm5/src/core/errors.AuthErrorParams[K] */ js.Any
      ]
    ]
