...
object authenticationSmsMod {
  ...
  - typings.firebaseAuth.apiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
