...
object utilFetchProviderMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/core/util/fetch_provider", "FetchProvider")
  @js.native
  ...
  object FetchProvider {
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/core/util/fetch_provider", "FetchProvider.fetchImpl")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/core/util/fetch_provider", "FetchProvider.headersImpl")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/core/util/fetch_provider", "FetchProvider.responseImpl")
    @js.native
