...
import typings.firebaseAuth.distRnSrcCoreCredentialsOauthMod.OAuthCredential
import typings.firebaseAuth.distRnSrcCoreProvidersOauthMod.BaseOAuthProvider
...
object distRnSrcCoreProvidersFacebookMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/providers/facebook", "FacebookAuthProvider")
  @js.native
  ...
  object FacebookAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/providers/facebook", "FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD")
    @js.native
    val FACEBOOK_SIGN_IN_METHOD: facebookDotcom = js.native
    
    /** Always set to {@link ProviderId}.FACEBOOK. */
    @JSImport("@firebase/auth/dist/rn/src/core/providers/facebook", "FacebookAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/providers/facebook", "FacebookAuthProvider.credentialFromTaggedObject")
    @js.native
