...
import typings.firebaseAuth.accountManagementMfaMod.MfaEnrollment
import typings.firebaseAuth.anon.RecaptchaToken
import typings.firebaseAuth.anon.SessionInfo
import typings.firebaseAuth.authenticationSmsMod.SignInWithPhoneNumberRequest
...
object apiAuthenticationMfaMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.authenticationSmsMod.SignInWithPhoneNumberResponse
    - typings.firebaseAuth.authenticationIdpMod.SignInWithIdpResponse
    - typings.firebaseAuth.modelIdTokenMod.IdTokenResponse
  */
  trait PhoneOrOauthTokenResponse extends StObject
  object PhoneOrOauthTokenResponse {
    
    inline def IdTokenResponse(localId: String): typings.firebaseAuth.modelIdTokenMod.IdTokenResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.modelIdTokenMod.IdTokenResponse]
    }
    
    inline def SignInWithIdpResponse(localId: String): typings.firebaseAuth.authenticationIdpMod.SignInWithIdpResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.authenticationIdpMod.SignInWithIdpResponse]
    }
    
    inline def SignInWithPhoneNumberResponse(localId: String): typings.firebaseAuth.authenticationSmsMod.SignInWithPhoneNumberResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.authenticationSmsMod.SignInWithPhoneNumberResponse]
    }
  }
