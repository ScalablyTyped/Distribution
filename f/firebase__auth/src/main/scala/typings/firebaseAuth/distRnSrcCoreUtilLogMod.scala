...
object distRnSrcCoreUtilLogMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/util/log", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/rn/src/core/util/log", "LogLevel")
  @js.native
