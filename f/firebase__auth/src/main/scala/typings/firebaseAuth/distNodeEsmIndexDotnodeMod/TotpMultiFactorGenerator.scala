...
@JSImport("@firebase/auth/dist/node-esm/index.node", "TotpMultiFactorGenerator")
@js.native
...
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/node-esm/index.node", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
