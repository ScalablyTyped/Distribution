...
import typings.firebaseAuth.distEsm5SrcCoreCredentialsPhoneMod.PhoneAuthCredential
...
object distEsm5SrcPlatformBrowserMfaAssertionsPhoneMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorAssertionImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm5/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorGenerator")
  @js.native
  ...
  object PhoneMultiFactorGenerator {
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/esm5/src/platform_browser/mfa/assertions/phone", "PhoneMultiFactorGenerator.FACTOR_ID")
    @js.native
