...
import typings.firebaseAuth.distSrcPlatformBrowserRecaptchaRecaptchaMod.GreCAPTCHATopLevel
import typings.firebaseAuth.distSrcPlatformBrowserRecaptchaRecaptchaMod.Recaptcha
import typings.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distSrcPlatformBrowserAuthWindowMod {
  
  @JSImport("@firebase/auth/dist/src/platform_browser/auth_window", JSImport.Namespace)
  @js.native
  ...
  /* Inlined {  grecaptcha :@firebase/auth.@firebase/auth/dist/src/platform_browser/recaptcha/recaptcha.Recaptcha | @firebase/auth.@firebase/auth/dist/src/platform_browser/recaptcha/recaptcha.GreCAPTCHATopLevel | undefined,   ___jsl :std.Record<string, any> | undefined,   gapi :{readonly load (features : 'gapi.iframes', options : @firebase/auth.gapi.LoadOptions | @firebase/auth.gapi.LoadCallback | undefined): void,  readonly iframes :{  Context :new (): @firebase/auth.gapi.iframes.Context,   Iframe :new (): @firebase/auth.gapi.iframes.Iframe,  readonly CROSS_ORIGIN_IFRAMES_FILTER :@firebase/auth.gapi.iframes.IframesFilter, readonly getContext (): @firebase/auth.gapi.iframes.Context}} | undefined, [callback: string] : (args : ...unknown): void} & {[ T in keyof @firebase/auth.@firebase/auth/dist/src/platform_browser/recaptcha/recaptcha.<global>.Window ]: @firebase/auth.@firebase/auth/dist/src/platform_browser/recaptcha/recaptcha.<global>.Window[T]} */
  trait AuthWindow
    extends StObject
