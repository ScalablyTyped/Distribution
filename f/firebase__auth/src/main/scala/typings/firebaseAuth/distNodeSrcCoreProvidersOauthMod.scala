...
import typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential
import typings.firebaseAuth.distNodeSrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object distNodeSrcCoreProvidersOauthMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/node/src/core/providers/oauth", "BaseOAuthProvider")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node/src/core/providers/oauth", "OAuthProvider")
  @js.native
  ...
  object OAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/node/src/core/providers/oauth", "OAuthProvider.oauthCredentialFromTaggedObject")
    @js.native
