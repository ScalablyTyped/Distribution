...
import typings.firebaseAuth.distNodeEsmSrcModelPopupRedirectMod.AuthEventConsumer
import typings.firebaseAuth.distNodeEsmSrcModelPopupRedirectMod.EventManager
