...
import typings.firebaseAuth.srcApiAuthenticationMfaMod.FinalizeMfaResponse
import typings.firebaseAuth.srcMfaMfaSessionMod.MultiFactorSessionImpl
import typings.firebaseAuth.srcModelPublicTypesMod.FactorId
import typings.firebaseAuth.srcModelPublicTypesMod.MultiFactorAssertion
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcMfaMfaAssertionMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/mfa/mfa_assertion", "MultiFactorAssertionImpl")
  @js.native
