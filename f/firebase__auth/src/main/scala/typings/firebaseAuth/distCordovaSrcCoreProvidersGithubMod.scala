...
import typings.firebaseAuth.distCordovaSrcCoreCredentialsOauthMod.OAuthCredential
import typings.firebaseAuth.distCordovaSrcCoreProvidersOauthMod.BaseOAuthProvider
...
object distCordovaSrcCoreProvidersGithubMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/core/providers/github", "GithubAuthProvider")
  @js.native
  ...
  object GithubAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/cordova/src/core/providers/github", "GithubAuthProvider.GITHUB_SIGN_IN_METHOD")
    @js.native
    val GITHUB_SIGN_IN_METHOD: githubDotcom = js.native
    
    /** Always set to {@link ProviderId}.GITHUB. */
    @JSImport("@firebase/auth/dist/cordova/src/core/providers/github", "GithubAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/cordova/src/core/providers/github", "GithubAuthProvider.credentialFromTaggedObject")
    @js.native
