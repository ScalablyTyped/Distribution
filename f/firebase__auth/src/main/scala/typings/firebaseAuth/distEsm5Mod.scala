...
object distEsm5Mod {
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.distEsm5SrcMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  open class EmailAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typings.firebaseAuth.distEsm5SrcMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.distEsm5SrcMod.OAuthProvider {
    /**
  ...
  open class PhoneAuthProvider protected ()
    extends typings.firebaseAuth.distEsm5SrcPlatformBrowserProvidersPhoneMod.PhoneAuthProvider {
    /**
  ...
  /* private */ open class PhoneMultiFactorGenerator ()
    extends typings.firebaseAuth.distEsm5SrcPlatformBrowserMfaAssertionsPhoneMod.PhoneMultiFactorGenerator
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.distEsm5SrcMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typings.firebaseAuth.distEsm5SrcMod.TwitterAuthProvider
  /* static members */
