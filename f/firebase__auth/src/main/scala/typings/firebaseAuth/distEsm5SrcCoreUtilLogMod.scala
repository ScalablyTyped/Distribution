...
object distEsm5SrcCoreUtilLogMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/core/util/log", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm5/src/core/util/log", "LogLevel")
  @js.native
