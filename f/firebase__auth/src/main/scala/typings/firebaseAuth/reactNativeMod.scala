...
object reactNativeMod {
  ...
  open class ActionCodeURL protected ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  /* private */ open class EmailAuthCredential ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.PhoneAuthCredential
  /* static members */
  ...
  open class PhoneAuthProvider protected ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.PhoneAuthProvider {
    /**
  ...
  /* private */ open class PhoneMultiFactorGenerator ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.PhoneMultiFactorGenerator
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typings.firebaseAuth.distRnIndexDotrnMod.TwitterAuthProvider
  /* static members */
