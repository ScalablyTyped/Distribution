...
object distBrowserCjsSrcApiAuthenticationSmsMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/api/authentication/sms", JSImport.Namespace)
  @js.native
  ...
  - typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
