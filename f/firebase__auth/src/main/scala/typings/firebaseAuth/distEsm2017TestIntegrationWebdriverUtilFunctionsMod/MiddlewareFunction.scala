...
object MiddlewareFunction extends StObject {
  ...
  /* "middleware.attachBlockingMiddleware" */ val ATTACH_BLOCKING_MIDDLEWARE: typings.firebaseAuth.distEsm2017TestIntegrationWebdriverUtilFunctionsMod.MiddlewareFunction.ATTACH_BLOCKING_MIDDLEWARE & String = js.native
  
  @js.native
  sealed trait ATTACH_BLOCKING_MIDDLEWARE_ON_START
    extends StObject
       with MiddlewareFunction
  /* "middleware.attachBlockingMiddlewareOnStart" */ val ATTACH_BLOCKING_MIDDLEWARE_ON_START: typings.firebaseAuth.distEsm2017TestIntegrationWebdriverUtilFunctionsMod.MiddlewareFunction.ATTACH_BLOCKING_MIDDLEWARE_ON_START & String = js.native
}
