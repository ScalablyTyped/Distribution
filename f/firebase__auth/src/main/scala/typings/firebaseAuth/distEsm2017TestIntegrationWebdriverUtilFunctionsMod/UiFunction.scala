...
object UiFunction extends StObject {
  ...
  sealed trait LOAD
    extends StObject
       with UiFunction
  /* "ui.loadUiCode" */ val LOAD: typings.firebaseAuth.distEsm2017TestIntegrationWebdriverUtilFunctionsMod.UiFunction.LOAD & String = js.native
  
  @js.native
  sealed trait START
    extends StObject
       with UiFunction
  /* "ui.startUi" */ val START: typings.firebaseAuth.distEsm2017TestIntegrationWebdriverUtilFunctionsMod.UiFunction.START & String = js.native
}
