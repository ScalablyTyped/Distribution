...
import typings.firebaseAuth.distNodeEsmInternalMod.^
...
import typings.firebaseAuth.distNodeEsmSrcModelAuthMod.ApiKey
import typings.firebaseAuth.distNodeEsmSrcModelAuthMod.AppName
...
import typings.firebaseAuth.distNodeEsmSrcModelUserMod.UserCredentialInternal
...
inline def assert[K /* <: AuthErrorCode */](
  ...
  auth: Auth,
  code: K,
  /* import warning: parser.TsParser#functionParam Dropping repeated marker of param data because its type {} extends LessAppName<K> ? [LessAppName<K> | undefined] : [LessAppName<K>] is not an array type */ data: /* import warning: importer.ImportType#apply Failed type conversion: {} extends @firebase/auth.@firebase/auth/dist/node-esm/src/core/util/assert.LessAppName<K> ? [@firebase/auth.@firebase/auth/dist/node-esm/src/core/util/assert.LessAppName<K> | undefined] : [@firebase/auth.@firebase/auth/dist/node-esm/src/core/util/assert.LessAppName<K>] */ js.Any
...
inline def assert[K /* <: AuthErrorCode */](
  assertion: Any,
  code: K,
  /* import warning: parser.TsParser#functionParam Dropping repeated marker of param data because its type {} extends AuthErrorParams[K] ? [AuthErrorParams[K] | undefined] : [AuthErrorParams[K]] is not an array type */ data: /* import warning: importer.ImportType#apply Failed type conversion: {} extends @firebase/auth.@firebase/auth/dist/node-esm/src/core/errors.AuthErrorParams[K] ? [@firebase/auth.@firebase/auth/dist/node-esm/src/core/errors.AuthErrorParams[K] | undefined] : [@firebase/auth.@firebase/auth/dist/node-esm/src/core/errors.AuthErrorParams[K]] */ js.Any
