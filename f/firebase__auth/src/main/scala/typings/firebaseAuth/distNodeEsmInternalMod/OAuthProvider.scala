...
@JSImport("@firebase/auth/dist/node-esm/internal", "OAuthProvider")
@js.native
...
object OAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/node-esm/internal", "OAuthProvider.oauthCredentialFromTaggedObject")
  @js.native
