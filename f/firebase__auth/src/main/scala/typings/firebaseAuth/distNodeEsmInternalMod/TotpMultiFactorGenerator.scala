...
@JSImport("@firebase/auth/dist/node-esm/internal", "TotpMultiFactorGenerator")
@js.native
...
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/node-esm/internal", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
