...
@JSImport("@firebase/auth/dist/cordova/internal", "GoogleAuthProvider")
@js.native
open class GoogleAuthProvider ()
  extends typings.firebaseAuth.distCordovaMod.GoogleAuthProvider
/* static members */
object GoogleAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/cordova/internal", "GoogleAuthProvider.GOOGLE_SIGN_IN_METHOD")
  @js.native
  val GOOGLE_SIGN_IN_METHOD: googleDotcom = js.native
  
  /** Always set to {@link ProviderId}.GOOGLE. */
  @JSImport("@firebase/auth/dist/cordova/internal", "GoogleAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/cordova/internal", "GoogleAuthProvider.credentialFromTaggedObject")
  @js.native
