...
import typings.firebaseAuth.distSrcCoreStrategiesAbstractPopupRedirectOperationMod.AbstractPopupRedirectOperation
...
object distSrcCoreStrategiesRedirectMod {
  
  @JSImport("@firebase/auth/dist/src/core/strategies/redirect", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/src/core/strategies/redirect", "RedirectAction")
  @js.native
