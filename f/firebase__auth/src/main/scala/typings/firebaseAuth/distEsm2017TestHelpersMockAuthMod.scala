...
import typings.firebaseAuth.distEsm2017SrcCoreAuthAuthImplMod.AuthImpl
import typings.firebaseAuth.distEsm2017SrcCorePersistenceInMemoryMod.InMemoryPersistence_
...
object distEsm2017TestHelpersMockAuthMod {
  ...
  object FAKE_APP_CHECK_CONTROLLER {
    ...
    @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "FAKE_APP_CHECK_CONTROLLER")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "FAKE_APP_CHECK_CONTROLLER_PROVIDER")
  @js.native
