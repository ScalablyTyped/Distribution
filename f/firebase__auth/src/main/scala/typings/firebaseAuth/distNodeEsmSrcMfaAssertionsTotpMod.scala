...
import typings.firebaseAuth.distNodeEsmSrcApiAccountManagementMfaMod.TotpVerificationInfo
...
object distNodeEsmSrcMfaAssertionsTotpMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/mfa/assertions/totp", "TotpMultiFactorAssertionImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/src/mfa/assertions/totp", "TotpMultiFactorGenerator")
  @js.native
  ...
  object TotpMultiFactorGenerator {
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/node-esm/src/mfa/assertions/totp", "TotpMultiFactorGenerator.FACTOR_ID")
    @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/src/mfa/assertions/totp", "TotpSecret")
  @js.native
