...
object distEsm5TestIntegrationWebdriverUtilAuthDriverMod {
  
  @JSImport("@firebase/auth/dist/esm5/test/integration/webdriver/util/auth_driver", "AuthDriver")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm5/test/integration/webdriver/util/auth_driver", "START_FUNCTION")
  @js.native
