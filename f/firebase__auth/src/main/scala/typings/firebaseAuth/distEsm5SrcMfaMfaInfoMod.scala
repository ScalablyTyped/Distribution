...
import typings.firebaseAuth.distEsm5SrcModelPublicTypesMod.PhoneMultiFactorInfo
...
object distEsm5SrcMfaMfaInfoMod {
  ...
  @JSImport("@firebase/auth/dist/esm5/src/mfa/mfa_info", "TotpMultiFactorInfoImpl")
  @js.native
