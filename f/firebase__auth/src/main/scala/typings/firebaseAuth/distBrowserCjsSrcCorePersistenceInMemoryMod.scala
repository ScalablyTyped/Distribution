...
import typings.firebaseAuth.distBrowserCjsSrcCorePersistenceMod.PersistenceInternal
import typings.firebaseAuth.distBrowserCjsSrcCorePersistenceMod.PersistenceType
import typings.firebaseAuth.distBrowserCjsSrcCorePersistenceMod.PersistenceValue
import typings.firebaseAuth.distBrowserCjsSrcCorePersistenceMod.StorageEventListener
...
object distBrowserCjsSrcCorePersistenceInMemoryMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/persistence/in_memory", "InMemoryPersistence")
  @js.native
  ...
  object InMemoryPersistence_ {
    ...
    @JSImport("@firebase/auth/dist/browser-cjs/src/core/persistence/in_memory", "InMemoryPersistence.type")
    @js.native
