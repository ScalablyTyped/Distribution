...
object distRnSrcMfaMfaInfoMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/rn/src/mfa/mfa_info", "MultiFactorInfoImpl")
  @js.native
  ...
  object MultiFactorInfoImpl {
    ...
    @JSImport("@firebase/auth/dist/rn/src/mfa/mfa_info", "MultiFactorInfoImpl")
    @js.native
  ...
  @JSImport("@firebase/auth/dist/rn/src/mfa/mfa_info", "PhoneMultiFactorInfoImpl")
  @js.native
