...
@JSImport("@firebase/auth/dist/esm5/internal", "GoogleAuthProvider")
@js.native
...
object GoogleAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/esm5/internal", "GoogleAuthProvider.GOOGLE_SIGN_IN_METHOD")
  @js.native
  val GOOGLE_SIGN_IN_METHOD: googleDotcom = js.native
  
  /** Always set to {@link ProviderId}.GOOGLE. */
  @JSImport("@firebase/auth/dist/esm5/internal", "GoogleAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm5/internal", "GoogleAuthProvider.credentialFromTaggedObject")
  @js.native
