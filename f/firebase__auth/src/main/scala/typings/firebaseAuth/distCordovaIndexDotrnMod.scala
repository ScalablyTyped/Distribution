...
import typings.firebaseAuth.distCordovaSrcModelPublicTypesMod.ConfirmationResult
...
import typings.firebaseAuth.distCordovaSrcModelPublicTypesMod.ReactNativeAsyncStorage
...
object distCordovaIndexDotrnMod {
  ...
  object AuthErrorCodes {
    ...
    @JSImport("@firebase/auth/dist/cordova/index.rn", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("@firebase/auth/dist/cordova/index.rn", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/cordova/index.rn", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/cordova/index.rn", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/cordova/index.rn", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/cordova/index.rn", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/cordova/index.rn", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/cordova/index.rn", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
  ...
  object FactorId {
    ...
    @JSImport("@firebase/auth/dist/cordova/index.rn", "FactorId.TOTP")
    @js.native
  ...
  open class PhoneAuthProvider protected ()
    extends typings.firebaseAuth.distCordovaSrcPlatformBrowserProvidersPhoneMod.PhoneAuthProvider {
    /**
  ...
  /* private */ open class PhoneMultiFactorGenerator ()
    extends typings.firebaseAuth.distCordovaSrcPlatformBrowserMfaAssertionsPhoneMod.PhoneMultiFactorGenerator
  /* static members */
  ...
  inline def updatePhoneNumber(
    user: User,
    credential: typings.firebaseAuth.distCordovaSrcCoreCredentialsPhoneMod.PhoneAuthCredential
