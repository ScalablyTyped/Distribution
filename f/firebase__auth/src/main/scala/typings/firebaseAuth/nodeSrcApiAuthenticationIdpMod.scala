...
object nodeSrcApiAuthenticationIdpMod {
  ...
  - typings.firebaseAuth.nodeSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
