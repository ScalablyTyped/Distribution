...
object distBrowserCjsSrcApiAuthenticationEmailAndPasswordMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/api/authentication/email_and_password", JSImport.Namespace)
  @js.native
