...
import typings.firebaseAuth.distNodeSrcPlatformBrowserRecaptchaRecaptchaLoaderMod.ReCaptchaLoader
import typings.std.HTMLElement
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distNodeSrcPlatformBrowserRecaptchaRecaptchaVerifierMod {
  
  @JSImport("@firebase/auth/dist/node/src/platform_browser/recaptcha/recaptcha_verifier", "RECAPTCHA_VERIFIER_TYPE")
  @js.native
  val RECAPTCHA_VERIFIER_TYPE: /* "recaptcha" */ String = js.native
  
  @JSImport("@firebase/auth/dist/node/src/platform_browser/recaptcha/recaptcha_verifier", "RecaptchaVerifier")
  @js.native
