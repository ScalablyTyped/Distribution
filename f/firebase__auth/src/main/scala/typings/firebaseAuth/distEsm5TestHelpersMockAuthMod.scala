...
import typings.firebaseAuth.distEsm5SrcCorePersistenceInMemoryMod.InMemoryPersistence_
import typings.firebaseAuth.distEsm5SrcCorePersistenceMod.PersistedBlob
...
object distEsm5TestHelpersMockAuthMod {
  ...
  object FAKE_APP_CHECK_CONTROLLER {
    ...
    @JSImport("@firebase/auth/dist/esm5/test/helpers/mock_auth", "FAKE_APP_CHECK_CONTROLLER")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@firebase/auth/dist/esm5/test/helpers/mock_auth", "FAKE_APP_CHECK_CONTROLLER_PROVIDER")
  @js.native
