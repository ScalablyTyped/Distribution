...
object distCordovaSrcCoreAuthAuthImplMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/core/auth/auth_impl", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* import warning: RemoveDifficultInheritance.summarizeChanges 
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _FirebaseService * / any */ @JSImport("@firebase/auth/dist/cordova/src/core/auth/auth_impl", "AuthImpl")
  @js.native
