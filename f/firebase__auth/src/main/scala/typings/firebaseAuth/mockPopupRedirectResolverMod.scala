...
import typings.firebaseAuth.utilPopupMod.AuthPopup
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object mockPopupRedirectResolverMod {
  
  @JSImport("@firebase/auth/dist/cordova/test/helpers/mock_popup_redirect_resolver", JSImport.Namespace)
  @js.native
