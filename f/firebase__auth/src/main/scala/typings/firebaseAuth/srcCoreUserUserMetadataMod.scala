...
object srcCoreUserUserMetadataMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/user/user_metadata", "UserMetadata")
  @js.native
  open class UserMetadata ()
    extends StObject
       with typings.firebaseAuth.nodeEsmSrcModelPublicTypesMod.UserMetadata {
