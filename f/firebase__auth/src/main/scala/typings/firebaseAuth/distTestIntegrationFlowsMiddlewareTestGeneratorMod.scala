...
object distTestIntegrationFlowsMiddlewareTestGeneratorMod {
  
  @JSImport("@firebase/auth/dist/test/integration/flows/middleware_test_generator", JSImport.Namespace)
  @js.native
