...
@JSImport("@firebase/auth/dist/browser-cjs", "TotpMultiFactorGenerator")
@js.native
open class TotpMultiFactorGenerator ()
  extends typings.firebaseAuth.distBrowserCjsSrcMfaAssertionsTotpMod.TotpMultiFactorGenerator
/* static members */
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/browser-cjs", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
