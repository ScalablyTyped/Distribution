...
@JSImport("@firebase/auth/dist/browser-cjs", "RecaptchaVerifier")
@js.native
open class RecaptchaVerifier protected ()
  extends typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserRecaptchaRecaptchaVerifierMod.RecaptchaVerifier {
