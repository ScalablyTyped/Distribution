...
import typings.firebaseAuth.distCordovaSrcApiAccountManagementMfaMod.TotpVerificationInfo
...
object distCordovaSrcMfaAssertionsTotpMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/mfa/assertions/totp", "TotpMultiFactorAssertionImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/cordova/src/mfa/assertions/totp", "TotpMultiFactorGenerator")
  @js.native
  ...
  object TotpMultiFactorGenerator {
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/cordova/src/mfa/assertions/totp", "TotpMultiFactorGenerator.FACTOR_ID")
    @js.native
  ...
  @JSImport("@firebase/auth/dist/cordova/src/mfa/assertions/totp", "TotpSecret")
  @js.native
