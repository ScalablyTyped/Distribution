...
object distCordovaSrcPlatformBrowserMessagechannelPromiseMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]
    - typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult
  */
  trait PromiseSettledResult[T] extends StObject
  object PromiseSettledResult {
    
    inline def PromiseFulfilledResult[T](value: T): typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T] = {
      val __obj = js.Dynamic.literal(fulfilled = true, value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]]
    }
    
    inline def PromiseRejectedResult(reason: Any): typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult = {
      val __obj = js.Dynamic.literal(fulfilled = false, reason = reason.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult]
    }
  }
}
