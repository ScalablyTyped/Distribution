...
object distEsm2017SrcApiAuthenticationIdpMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/api/authentication/idp", JSImport.Namespace)
  @js.native
  ...
  - typings.firebaseAuth.distEsm2017SrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
