...
@JSImport("@firebase/auth/dist/cordova", "TotpMultiFactorGenerator")
@js.native
open class TotpMultiFactorGenerator ()
  extends typings.firebaseAuth.distCordovaSrcMfaAssertionsTotpMod.TotpMultiFactorGenerator
/* static members */
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/cordova", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
