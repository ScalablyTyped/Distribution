...
object distBrowserCjsSrcApiAuthenticationMfaMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/api/authentication/mfa", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse
    - typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationIdpMod.SignInWithIdpResponse
    - typings.firebaseAuth.distBrowserCjsSrcModelIdTokenMod.IdTokenResponse
  */
  trait PhoneOrOauthTokenResponse extends StObject
  object PhoneOrOauthTokenResponse {
    
    inline def IdTokenResponse(localId: String): typings.firebaseAuth.distBrowserCjsSrcModelIdTokenMod.IdTokenResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distBrowserCjsSrcModelIdTokenMod.IdTokenResponse]
    }
    
    inline def SignInWithIdpResponse(localId: String): typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationIdpMod.SignInWithIdpResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationIdpMod.SignInWithIdpResponse]
    }
    
    inline def SignInWithPhoneNumberResponse(localId: String): typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse]
    }
  }
