...
import typings.firebaseAuth.distSrcModelIdTokenMod.IdToken
...
object distSrcApiAuthenticationIdpMod {
  ...
  - typings.firebaseAuth.distSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
