...
import typings.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distNodeEsmSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typings.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typings.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
