...
object distCordovaSrcPlatformCordovaPluginsMod {
  ...
  object CordovaWindow {
    ...
    inline def apply(BuildInfo: PackageName, cordova: Plugins, handleOpenURL: String => Unit, universalLinks: Subscribe): CordovaWindow = {
    ...
    implicit open class MutableBuilder[Self <: CordovaWindow] (val x: Self) extends AnyVal {
      ...
      inline def setCordova(value: Plugins): Self = StObject.set(x, "cordova", value.asInstanceOf[js.Any])
