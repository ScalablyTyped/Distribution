...
import typings.firebaseAuth.distCordovaSrcCoreAuthAuthEventManagerMod.AuthEventManager
import typings.firebaseAuth.distCordovaSrcModelAuthMod.AuthInternal
import typings.firebaseAuth.distCordovaSrcModelPopupRedirectMod.AuthEvent
import typings.firebaseAuth.distCordovaSrcModelPopupRedirectMod.AuthEventType
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distCordovaSrcPlatformCordovaPopupRedirectEventsMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/platform_cordova/popup_redirect/events", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/cordova/src/platform_cordova/popup_redirect/events", "CordovaAuthEventManager")
  @js.native
