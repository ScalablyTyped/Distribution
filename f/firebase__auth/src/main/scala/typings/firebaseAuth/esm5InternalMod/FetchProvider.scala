...
@JSImport("@firebase/auth/dist/esm5/internal", "FetchProvider")
@js.native
open class FetchProvider ()
  extends typings.firebaseAuth.coreUtilFetchProviderMod.FetchProvider
/* static members */
object FetchProvider {
  ...
  @JSImport("@firebase/auth/dist/esm5/internal", "FetchProvider.fetchImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm5/internal", "FetchProvider.headersImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm5/internal", "FetchProvider.responseImpl")
  @js.native
