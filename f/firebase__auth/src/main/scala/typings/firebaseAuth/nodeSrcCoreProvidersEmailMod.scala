...
import typings.firebaseAuth.nodeSrcCoreCredentialsEmailMod.EmailAuthCredential
import typings.firebaseAuth.nodeSrcModelPublicTypesMod.AuthProvider
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nodeSrcCoreProvidersEmailMod {
  
  @JSImport("@firebase/auth/dist/node/src/core/providers/email", "EmailAuthProvider")
  @js.native
  ...
  object EmailAuthProvider {
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/node/src/core/providers/email", "EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/auth/dist/node/src/core/providers/email", "EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD")
    @js.native
    ...
    /**
      * Always set to {@link ProviderId}.PASSWORD, even for email link.
      */
    @JSImport("@firebase/auth/dist/node/src/core/providers/email", "EmailAuthProvider.PROVIDER_ID")
    @js.native
