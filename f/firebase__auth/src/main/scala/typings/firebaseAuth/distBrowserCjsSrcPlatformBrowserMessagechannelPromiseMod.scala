...
object distBrowserCjsSrcPlatformBrowserMessagechannelPromiseMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/messagechannel/promise", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]
    - typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult
  */
  trait PromiseSettledResult[T] extends StObject
  object PromiseSettledResult {
    
    inline def PromiseFulfilledResult[T](value: T): typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T] = {
      val __obj = js.Dynamic.literal(fulfilled = true, value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]]
    }
    
    inline def PromiseRejectedResult(reason: Any): typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult = {
      val __obj = js.Dynamic.literal(fulfilled = false, reason = reason.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distBrowserCjsSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult]
    }
  }
}
