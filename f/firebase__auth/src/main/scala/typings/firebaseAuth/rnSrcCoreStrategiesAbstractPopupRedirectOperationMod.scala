...
import typings.firebaseAuth.rnSrcModelPopupRedirectMod.AuthEventConsumer
import typings.firebaseAuth.rnSrcModelPopupRedirectMod.AuthEventType
...
object rnSrcCoreStrategiesAbstractPopupRedirectOperationMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/strategies/abstract_popup_redirect_operation", "AbstractPopupRedirectOperation")
  @js.native
