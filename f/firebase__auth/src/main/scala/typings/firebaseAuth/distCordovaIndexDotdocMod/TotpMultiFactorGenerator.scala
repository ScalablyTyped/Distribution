...
@JSImport("@firebase/auth/dist/cordova/index.doc", "TotpMultiFactorGenerator")
@js.native
...
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/cordova/index.doc", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
