package typings.firebaseAuth.distIndexDotnodeMod
...
@JSImport("@firebase/auth/dist/index.node", "FacebookAuthProvider")
@js.native
...
object FacebookAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/index.node", "FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD")
  @js.native
  val FACEBOOK_SIGN_IN_METHOD: facebookDotcom = js.native
  
  /** Always set to {@link ProviderId}.FACEBOOK. */
  @JSImport("@firebase/auth/dist/index.node", "FacebookAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/index.node", "FacebookAuthProvider.credentialFromTaggedObject")
  @js.native
