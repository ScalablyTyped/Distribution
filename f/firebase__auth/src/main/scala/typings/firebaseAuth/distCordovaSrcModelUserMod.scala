...
import typings.firebaseAuth.distCordovaSrcApiAccountManagementAccountMod.APIUserInfo
import typings.firebaseAuth.distCordovaSrcApiAuthenticationMfaMod.FinalizeMfaResponse
import typings.firebaseAuth.distCordovaSrcCoreUserTokenManagerMod.StsTokenManager
import typings.firebaseAuth.distCordovaSrcCoreUserUserMetadataMod.UserMetadata
...
import typings.firebaseAuth.distCordovaSrcModelIdTokenMod.TaggedWithTokenResponse
...
object distCordovaSrcModelUserMod {
  
  /* Inlined {-readonly [ K in keyof @firebase/auth.@firebase/auth/dist/cordova/src/model/public_types.UserInfo ]: @firebase/auth.@firebase/auth/dist/cordova/src/model/public_types.UserInfo[K]} */
