...
import typings.firebaseAuth.modelEnumsMod.OperationType
...
object userUserCredentialImplMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.firebaseAuth.userUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/esm2017/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
