...
import typings.firebaseAuth.distBrowserCjsSrcModelIdTokenMod.IdToken
...
object distBrowserCjsSrcApiAuthenticationIdpMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/api/authentication/idp", JSImport.Namespace)
  @js.native
  ...
  - typings.firebaseAuth.distBrowserCjsSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
