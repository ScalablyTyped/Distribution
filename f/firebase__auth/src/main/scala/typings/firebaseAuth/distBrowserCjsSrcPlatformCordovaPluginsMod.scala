...
import typings.firebaseAuth.anon.InAppBrowser
...
object distBrowserCjsSrcPlatformCordovaPluginsMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_cordova/plugins", JSImport.Namespace)
  @js.native
  ...
  object CordovaWindow {
    ...
    implicit open class MutableBuilder[Self <: CordovaWindow] (val x: Self) extends AnyVal {
      ...
      inline def setCordova(value: InAppBrowser): Self = StObject.set(x, "cordova", value.asInstanceOf[js.Any])
