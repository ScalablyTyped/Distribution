...
import typings.firebaseAuth.anon.PartialServerErrorMapServBLOCKINGFUNCTIONERRORRESPONSE
import typings.firebaseAuth.anon.TenantId
import typings.firebaseAuth.distEsm5SrcCoreErrorsMod.AuthErrorCode
import typings.firebaseAuth.distEsm5SrcCoreUtilDelayMod.Delay
...
object distEsm5SrcApiMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm5/src/api", "DEFAULT_API_TIMEOUT_MS")
  @js.native
  ...
  inline def performApiRequest[T, V](
    ...
    path: Endpoint,
    request: T,
    customErrorMap: PartialServerErrorMapServBLOCKINGFUNCTIONERRORRESPONSE
