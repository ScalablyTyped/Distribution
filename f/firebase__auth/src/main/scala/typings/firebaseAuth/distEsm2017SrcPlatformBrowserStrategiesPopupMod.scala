...
import typings.firebaseAuth.distEsm2017SrcCoreUtilDelayMod.Delay
...
object distEsm2017SrcPlatformBrowserStrategiesPopupMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/strategies/popup", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/strategies/popup", "_POLL_WINDOW_CLOSE_TIMEOUT")
  @js.native
