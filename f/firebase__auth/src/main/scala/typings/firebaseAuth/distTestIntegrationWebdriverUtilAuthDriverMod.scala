...
object distTestIntegrationWebdriverUtilAuthDriverMod {
  
  @JSImport("@firebase/auth/dist/test/integration/webdriver/util/auth_driver", "AuthDriver")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/test/integration/webdriver/util/auth_driver", "START_FUNCTION")
  @js.native
