...
import typings.firebaseAuth.distSrcCoreAuthAuthEventManagerMod.AuthEventManager
...
object distSrcPlatformCordovaPopupRedirectEventsMod {
  
  @JSImport("@firebase/auth/dist/src/platform_cordova/popup_redirect/events", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_cordova/popup_redirect/events", "CordovaAuthEventManager")
  @js.native
