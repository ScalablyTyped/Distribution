...
import typings.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distNodeSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typings.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typings.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
