...
@JSImport("@firebase/auth/dist/esm2017", "TwitterAuthProvider")
@js.native
open class TwitterAuthProvider ()
  extends typings.firebaseAuth.distEsm2017SrcMod.TwitterAuthProvider
/* static members */
object TwitterAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/esm2017", "TwitterAuthProvider.PROVIDER_ID")
  @js.native
  val PROVIDER_ID: twitterDotcom = js.native
  
  /** Always set to {@link SignInMethod}.TWITTER. */
  @JSImport("@firebase/auth/dist/esm2017", "TwitterAuthProvider.TWITTER_SIGN_IN_METHOD")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm2017", "TwitterAuthProvider.credentialFromTaggedObject")
  @js.native
