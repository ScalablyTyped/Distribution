...
import typings.firebaseAuth.distEsm2017SrcModelPublicTypesMod.TotpMultiFactorAssertion
import typings.firebaseAuth.firebaseAuthStrings.totp
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@firebase/auth/dist/esm2017", "TotpMultiFactorGenerator")
@js.native
open class TotpMultiFactorGenerator ()
  extends typings.firebaseAuth.distEsm2017SrcMfaAssertionsTotpMod.TotpMultiFactorGenerator
/* static members */
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/esm2017", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
  ...
  inline def assertionForEnrollment(
    secret: typings.firebaseAuth.distEsm2017SrcMfaAssertionsTotpMod.TotpSecret,
  ...
  /**
    ...
    */
  inline def generateSecret(session: MultiFactorSession): js.Promise[typings.firebaseAuth.distEsm2017SrcMfaAssertionsTotpMod.TotpSecret] = ^.asInstanceOf[js.Dynamic].applyDynamic("generateSecret")(session.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.firebaseAuth.distEsm2017SrcMfaAssertionsTotpMod.TotpSecret]]
}
