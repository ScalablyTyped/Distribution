...
import typings.firebaseAuth.distNodeSrcMfaMfaSessionMod.MultiFactorSessionImpl
...
import typings.firebaseAuth.distNodeSrcModelPublicTypesMod.MultiFactorAssertion
