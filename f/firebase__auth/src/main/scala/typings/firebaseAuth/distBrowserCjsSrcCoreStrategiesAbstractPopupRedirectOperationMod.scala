...
import typings.firebaseAuth.distBrowserCjsSrcModelPopupRedirectMod.AuthEventConsumer
...
object distBrowserCjsSrcCoreStrategiesAbstractPopupRedirectOperationMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/browser-cjs/src/core/strategies/abstract_popup_redirect_operation", "AbstractPopupRedirectOperation")
  @js.native
