...
import typings.firebaseAuth.nodeEsmSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse
...
object srcCoreUserUserCredentialImplMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.firebaseAuth.srcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/node-esm/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
  ...
  object UserCredentialImpl {
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/core/user/user_credential_impl", "UserCredentialImpl")
    @js.native
