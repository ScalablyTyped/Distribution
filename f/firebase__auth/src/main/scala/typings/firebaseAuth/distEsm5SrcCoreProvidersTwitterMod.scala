...
object distEsm5SrcCoreProvidersTwitterMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/core/providers/twitter", "TwitterAuthProvider")
  @js.native
  ...
  object TwitterAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/esm5/src/core/providers/twitter", "TwitterAuthProvider.PROVIDER_ID")
    @js.native
    val PROVIDER_ID: twitterDotcom = js.native
    
    /** Always set to {@link SignInMethod}.TWITTER. */
    @JSImport("@firebase/auth/dist/esm5/src/core/providers/twitter", "TwitterAuthProvider.TWITTER_SIGN_IN_METHOD")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm5/src/core/providers/twitter", "TwitterAuthProvider.credentialFromTaggedObject")
    @js.native
