...
import typings.firebaseAuth.distNodeSrcModelEnumsMod.OperationType
import typings.firebaseAuth.distNodeSrcModelEnumsMod.ProviderId
...
object distNodeSrcCoreUserUserCredentialImplMod {
  ...
  - typings.firebaseAuth.distNodeSrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/node/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
