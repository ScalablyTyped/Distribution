...
import typings.firebaseAuth.distNodeEsmSrcCoreCredentialsAuthCredentialMod.AuthCredential
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distNodeEsmSrcCoreCredentialsEmailMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/credentials/email", "EmailAuthCredential")
  @js.native
  /** @internal */
