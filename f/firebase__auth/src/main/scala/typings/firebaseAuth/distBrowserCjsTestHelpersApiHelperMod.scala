...
import typings.firebaseAuth.distBrowserCjsSrcApiMod.Endpoint
import typings.firebaseAuth.distBrowserCjsTestHelpersMockFetchMod.Route
import typings.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distBrowserCjsTestHelpersApiHelperMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/test/helpers/api/helper", JSImport.Namespace)
  @js.native
