...
import typings.firebaseAuth.distSrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object distSrcCoreProvidersOauthMod {
  ...
  @JSImport("@firebase/auth/dist/src/core/providers/oauth", "OAuthProvider")
  @js.native
  ...
  object OAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/src/core/providers/oauth", "OAuthProvider.oauthCredentialFromTaggedObject")
    @js.native
