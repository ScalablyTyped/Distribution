...
object distBrowserCjsTestIntegrationWebdriverUtilIdpPageMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/test/integration/webdriver/util/idp_page", "IdPPage")
  @js.native
  ...
  object IdPPage {
    ...
    @JSImport("@firebase/auth/dist/browser-cjs/test/integration/webdriver/util/idp_page", "IdPPage.PAGE_TITLE")
    @js.native
