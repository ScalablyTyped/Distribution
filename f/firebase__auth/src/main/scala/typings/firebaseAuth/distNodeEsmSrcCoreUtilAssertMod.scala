...
object distNodeEsmSrcCoreUtilAssertMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/util/assert", JSImport.Namespace)
  @js.native
  ...
  type LessAppName[K /* <: AuthErrorCode */] = Omit[
    /* import warning: importer.ImportType#apply Failed type conversion: @firebase/auth.@firebase/auth/dist/node-esm/src/core/errors.AuthErrorParams[K] */ js.Any, 
    appName
  ]
  ...
  {{{
  type TypeExpectation = std.Function | string | @firebase/auth.@firebase/auth/dist/node-esm/src/core/util/assert.MapType
  }}}
  to avoid circular code involving: 
  - @firebase/auth.@firebase/auth/dist/node-esm/src/core/util/assert.MapType
  - @firebase/auth.@firebase/auth/dist/node-esm/src/core/util/assert.TypeExpectation
  */
