...
import typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distCordovaSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
