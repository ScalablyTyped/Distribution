...
object distBrowserCjsTestHelpersIntegrationEmulatorRestHelpersMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/test/helpers/integration/emulator_rest_helpers", JSImport.Namespace)
  @js.native
