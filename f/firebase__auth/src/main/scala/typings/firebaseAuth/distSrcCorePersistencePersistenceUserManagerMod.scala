...
object distSrcCorePersistencePersistenceUserManagerMod {
  
  @JSImport("@firebase/auth/dist/src/core/persistence/persistence_user_manager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/src/core/persistence/persistence_user_manager", "PersistenceUserManager")
  @js.native
