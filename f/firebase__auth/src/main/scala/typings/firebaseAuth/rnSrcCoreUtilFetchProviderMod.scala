...
object rnSrcCoreUtilFetchProviderMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/util/fetch_provider", "FetchProvider")
  @js.native
  ...
  object FetchProvider {
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/util/fetch_provider", "FetchProvider.fetchImpl")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/util/fetch_provider", "FetchProvider.headersImpl")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/util/fetch_provider", "FetchProvider.responseImpl")
    @js.native
