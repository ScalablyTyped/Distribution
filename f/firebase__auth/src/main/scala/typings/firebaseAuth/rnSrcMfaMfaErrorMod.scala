...
import typings.firebaseAuth.rnSrcModelEnumsMod.OperationType
...
object rnSrcMfaMfaErrorMod {
  ...
  /* private */ open class MultiFactorError ()
    extends typings.firebaseAuth.rnSrcModelPublicTypesMod.MultiFactorError {
