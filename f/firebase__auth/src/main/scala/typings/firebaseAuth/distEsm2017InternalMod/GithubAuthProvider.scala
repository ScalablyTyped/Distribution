...
@JSImport("@firebase/auth/dist/esm2017/internal", "GithubAuthProvider")
@js.native
open class GithubAuthProvider ()
  extends typings.firebaseAuth.distEsm2017Mod.GithubAuthProvider
/* static members */
object GithubAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/esm2017/internal", "GithubAuthProvider.GITHUB_SIGN_IN_METHOD")
  @js.native
  val GITHUB_SIGN_IN_METHOD: githubDotcom = js.native
  
  /** Always set to {@link ProviderId}.GITHUB. */
  @JSImport("@firebase/auth/dist/esm2017/internal", "GithubAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm2017/internal", "GithubAuthProvider.credentialFromTaggedObject")
  @js.native
