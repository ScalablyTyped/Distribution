...
@JSImport("@firebase/auth/dist/esm2017/internal", "PhoneMultiFactorGenerator")
@js.native
/* private */ open class PhoneMultiFactorGenerator ()
  extends typings.firebaseAuth.distEsm2017Mod.PhoneMultiFactorGenerator
/* static members */
object PhoneMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/esm2017/internal", "PhoneMultiFactorGenerator.FACTOR_ID")
  @js.native
