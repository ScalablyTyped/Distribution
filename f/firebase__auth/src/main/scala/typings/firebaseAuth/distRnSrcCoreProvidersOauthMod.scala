...
import typings.firebaseAuth.distRnSrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object distRnSrcCoreProvidersOauthMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/rn/src/core/providers/oauth", "BaseOAuthProvider")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/rn/src/core/providers/oauth", "OAuthProvider")
  @js.native
  ...
  object OAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/providers/oauth", "OAuthProvider.oauthCredentialFromTaggedObject")
    @js.native
