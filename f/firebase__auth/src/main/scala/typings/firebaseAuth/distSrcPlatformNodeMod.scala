...
object distSrcPlatformNodeMod {
  
  @JSImport("@firebase/auth/dist/src/platform_node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("@firebase/auth/dist/src/platform_node", "PhoneAuthProvider")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/src/platform_node", "PhoneMultiFactorGenerator")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("@firebase/auth/dist/src/platform_node", "RecaptchaVerifier")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/src/platform_node", "browserLocalPersistence")
  @js.native
  val browserLocalPersistence: Persistence = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "browserPopupRedirectResolver")
  @js.native
  val browserPopupRedirectResolver: FirebaseError = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "browserSessionPersistence")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/src/platform_node", "getRedirectResult")
  @js.native
  val getRedirectResult: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "indexedDBLocalPersistence")
  @js.native
  val indexedDBLocalPersistence: Persistence = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "linkWithPhoneNumber")
  @js.native
  val linkWithPhoneNumber: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "linkWithPopup")
  @js.native
  val linkWithPopup: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "linkWithRedirect")
  @js.native
  val linkWithRedirect: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "reauthenticateWithPhoneNumber")
  @js.native
  val reauthenticateWithPhoneNumber: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "reauthenticateWithPopup")
  @js.native
  val reauthenticateWithPopup: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "reauthenticateWithRedirect")
  @js.native
  val reauthenticateWithRedirect: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "signInWithPhoneNumber")
  @js.native
  val signInWithPhoneNumber: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "signInWithPopup")
  @js.native
  val signInWithPopup: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "signInWithRedirect")
  @js.native
  val signInWithRedirect: js.Function0[js.Promise[Unit]] = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_node", "updatePhoneNumber")
  @js.native
