...
import typings.firebaseAuth.anon.PartialServerErrorMapServDYNAMICLINKNOTACTIVATED
import typings.firebaseAuth.anon.TenantId
import typings.firebaseAuth.distSrcCoreErrorsMod.AuthErrorCode
import typings.firebaseAuth.distSrcCoreUtilDelayMod.Delay
...
object distSrcApiMod {
  ...
  inline def performApiRequest[T, V](
    ...
    path: Endpoint,
    request: T,
    customErrorMap: PartialServerErrorMapServDYNAMICLINKNOTACTIVATED
