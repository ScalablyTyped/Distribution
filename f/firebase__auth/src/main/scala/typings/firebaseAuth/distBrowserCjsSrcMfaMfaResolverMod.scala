...
import typings.firebaseAuth.distBrowserCjsSrcMfaMfaErrorMod.MultiFactorError
import typings.firebaseAuth.distBrowserCjsSrcMfaMfaInfoMod.MultiFactorInfoImpl
...
import typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.MultiFactorInfo
...
object distBrowserCjsSrcMfaMfaResolverMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/mfa/mfa_resolver", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/mfa/mfa_resolver", "MultiFactorResolverImpl")
  @js.native
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
