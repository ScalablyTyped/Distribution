...
import typings.firebaseAuth.distEsm5SrcModelIdTokenMod.IdToken
...
object distEsm5SrcApiAuthenticationIdpMod {
  ...
  - typings.firebaseAuth.distEsm5SrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
