...
import typings.firebaseAuth.distNodeSrcMfaMfaErrorMod.MultiFactorError
import typings.firebaseAuth.distNodeSrcMfaMfaInfoMod.MultiFactorInfoImpl
...
object distNodeSrcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typings.firebaseAuth.distNodeSrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
