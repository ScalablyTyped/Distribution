...
object distNodeSrcCoreUserUserMetadataMod {
  
  @JSImport("@firebase/auth/dist/node/src/core/user/user_metadata", "UserMetadata")
  @js.native
  open class UserMetadata ()
    extends StObject
       with typings.firebaseAuth.distNodeSrcModelPublicTypesMod.UserMetadata {
