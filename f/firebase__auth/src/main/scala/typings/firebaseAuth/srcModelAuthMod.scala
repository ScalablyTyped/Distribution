...
import typings.firebaseAuth.modelPublicTypesMod.Config
...
import typings.firebaseAuth.srcCoreErrorsMod.AuthErrorCode
import typings.firebaseAuth.srcCoreErrorsMod.AuthErrorParams
import typings.firebaseAuth.utilVersionMod.ClientPlatform
