...
object rnSrcApiAuthenticationIdpMod {
  ...
  - typings.firebaseAuth.rnSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
