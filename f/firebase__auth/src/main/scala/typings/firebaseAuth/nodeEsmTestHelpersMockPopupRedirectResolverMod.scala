...
import typings.firebaseAuth.nodeEsmSrcPlatformBrowserUtilPopupMod.AuthPopup
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nodeEsmTestHelpersMockPopupRedirectResolverMod {
  
  @JSImport("@firebase/auth/dist/node-esm/test/helpers/mock_popup_redirect_resolver", JSImport.Namespace)
  @js.native
