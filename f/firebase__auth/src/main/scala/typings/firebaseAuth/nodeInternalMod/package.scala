...
import typings.firebaseAuth.nodeInternalMod.^
import typings.firebaseAuth.nodeSrcCoreErrorsMod.AuthErrorCode
import typings.firebaseAuth.nodeSrcCoreUtilAssertMod.LessAppName
import typings.firebaseAuth.nodeSrcCoreUtilVersionMod.ClientPlatform
import typings.firebaseAuth.nodeSrcModelAuthMod.ApiKey
import typings.firebaseAuth.nodeSrcModelAuthMod.AppName
