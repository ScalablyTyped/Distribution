...
import typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredentialParams
...
object distNodeIndexDotcordovaMod {
  ...
  open class ActionCodeURL protected ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  object AuthErrorCodes {
    ...
    @JSImport("@firebase/auth/dist/node/index.cordova", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("@firebase/auth/dist/node/index.cordova", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/node/index.cordova", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node/index.cordova", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node/index.cordova", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node/index.cordova", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/node/index.cordova", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node/index.cordova", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
  ...
  /* private */ open class EmailAuthCredential ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.EmailAuthProvider
  /* static members */
  object EmailAuthProvider {
    ...
    /**
      ...
      */
    inline def credential(email: String, password: String): typings.firebaseAuth.distNodeSrcCoreCredentialsEmailMod.EmailAuthCredential = (^.asInstanceOf[js.Dynamic].applyDynamic("credential")(email.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsEmailMod.EmailAuthCredential]
  ...
  object FacebookAuthProvider {
    ...
    /**
      ...
      */
    inline def credential(accessToken: String): typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential = ^.asInstanceOf[js.Dynamic].applyDynamic("credential")(accessToken.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential]
  ...
  object FactorId {
    ...
    @JSImport("@firebase/auth/dist/node/index.cordova", "FactorId.TOTP")
    @js.native
  ...
  open class GithubAuthProvider ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  object OAuthCredential {
    ...
    /** @internal */
    inline def _fromParams(params: OAuthCredentialParams): typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential = ^.asInstanceOf[js.Dynamic].applyDynamic("_fromParams")(params.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential]
    ...
    /**
      ...
      * @returns If the JSON input does not represent an {@link  AuthCredential}, null is returned.
      */
    inline def fromJSON(json: String): typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential | Null]
    inline def fromJSON(json: js.Object): typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential | Null]
  }
  
  @JSImport("@firebase/auth/dist/node/index.cordova", "OAuthProvider")
  @js.native
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.OAuthProvider {
    /**
  ...
  object OAuthProvider {
    ...
    inline def credentialFromJSON(json: String): typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential = ^.asInstanceOf[js.Dynamic].applyDynamic("credentialFromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential]
    /**
      * Creates an {@link OAuthCredential} from a JSON string or a plain object.
      * @param json - A plain object or a JSON string
      */
    inline def credentialFromJSON(json: js.Object): typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential = ^.asInstanceOf[js.Dynamic].applyDynamic("credentialFromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential]
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.PhoneAuthCredential
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.SAMLAuthProvider {
    /**
  ...
  object SAMLAuthProvider {
    ...
    /**
      ...
      * @param userCredential - The user credential.
      */
    inline def credentialFromError(error: FirebaseError): typings.firebaseAuth.distNodeSrcCoreCredentialsMod.AuthCredential | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("credentialFromError")(error.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsMod.AuthCredential | Null]
    
    /**
      * Creates an {@link AuthCredential} from a JSON string or a plain object.
      * @param json - A plain object or a JSON string
      */
    inline def credentialFromJSON(json: String): typings.firebaseAuth.distNodeSrcCoreCredentialsMod.AuthCredential = ^.asInstanceOf[js.Dynamic].applyDynamic("credentialFromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsMod.AuthCredential]
    inline def credentialFromJSON(json: js.Object): typings.firebaseAuth.distNodeSrcCoreCredentialsMod.AuthCredential = ^.asInstanceOf[js.Dynamic].applyDynamic("credentialFromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsMod.AuthCredential]
    ...
    /**
      ...
      * @param userCredential - The user credential.
      */
    inline def credentialFromResult(userCredential: UserCredential): typings.firebaseAuth.distNodeSrcCoreCredentialsMod.AuthCredential | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("credentialFromResult")(userCredential.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsMod.AuthCredential | Null]
  ...
  open class TwitterAuthProvider ()
    extends typings.firebaseAuth.distNodeIndexDotsharedMod.TwitterAuthProvider
  /* static members */
  object TwitterAuthProvider {
    ...
    /**
      ...
      */
    inline def credential(token: String, secret: String): typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential = (^.asInstanceOf[js.Dynamic].applyDynamic("credential")(token.asInstanceOf[js.Any], secret.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseAuth.distNodeSrcCoreCredentialsOauthMod.OAuthCredential]
