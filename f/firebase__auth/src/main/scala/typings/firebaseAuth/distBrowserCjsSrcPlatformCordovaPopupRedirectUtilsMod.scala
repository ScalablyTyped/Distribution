...
import typings.firebaseAuth.distBrowserCjsSrcModelPopupRedirectMod.AuthEvent
...
object distBrowserCjsSrcPlatformCordovaPopupRedirectUtilsMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_cordova/popup_redirect/utils", JSImport.Namespace)
  @js.native
