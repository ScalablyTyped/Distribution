...
import typings.firebaseAuth.distBrowserCjsSrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object distBrowserCjsSrcCoreProvidersOauthMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/browser-cjs/src/core/providers/oauth", "BaseOAuthProvider")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/providers/oauth", "OAuthProvider")
  @js.native
  ...
  object OAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/browser-cjs/src/core/providers/oauth", "OAuthProvider.oauthCredentialFromTaggedObject")
    @js.native
