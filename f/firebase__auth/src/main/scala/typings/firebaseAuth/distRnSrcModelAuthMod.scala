...
import typings.firebaseAuth.distRnSrcCoreErrorsMod.AuthErrorParams
...
import typings.firebaseAuth.distRnSrcModelPublicTypesMod.Config
...
import typings.firebaseAuth.distRnSrcPlatformBrowserRecaptchaRecaptchaMod.RecaptchaConfig
