...
object apiAuthenticationIdpMod {
  ...
  - typings.firebaseAuth.srcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
