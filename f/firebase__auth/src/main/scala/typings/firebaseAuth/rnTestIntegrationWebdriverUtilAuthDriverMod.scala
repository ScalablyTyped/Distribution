...
object rnTestIntegrationWebdriverUtilAuthDriverMod {
  
  @JSImport("@firebase/auth/dist/rn/test/integration/webdriver/util/auth_driver", "AuthDriver")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/rn/test/integration/webdriver/util/auth_driver", "START_FUNCTION")
  @js.native
