...
object distBrowserCjsSrcCoreUserUserMetadataMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/core/user/user_metadata", "UserMetadata")
  @js.native
  open class UserMetadata ()
    extends StObject
       with typings.firebaseAuth.distBrowserCjsSrcModelPublicTypesMod.UserMetadata {
