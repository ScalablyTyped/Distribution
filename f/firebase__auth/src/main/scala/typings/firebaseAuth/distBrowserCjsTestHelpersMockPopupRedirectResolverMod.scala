...
import typings.firebaseAuth.distBrowserCjsSrcModelPopupRedirectMod.EventManager
...
object distBrowserCjsTestHelpersMockPopupRedirectResolverMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/test/helpers/mock_popup_redirect_resolver", JSImport.Namespace)
  @js.native
