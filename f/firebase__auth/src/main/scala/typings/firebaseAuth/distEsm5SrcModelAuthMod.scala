...
import typings.firebaseAuth.distEsm5SrcCoreErrorsMod.AuthErrorParams
import typings.firebaseAuth.distEsm5SrcCoreUtilVersionMod.ClientPlatform
...
object distEsm5SrcModelAuthMod {
