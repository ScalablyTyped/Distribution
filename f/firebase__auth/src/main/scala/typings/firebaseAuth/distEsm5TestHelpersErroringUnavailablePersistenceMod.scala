...
import typings.firebaseAuth.distEsm5SrcCorePersistenceMod.PersistenceInternal
import typings.firebaseAuth.distEsm5SrcCorePersistenceMod.PersistenceType
import typings.firebaseAuth.distEsm5SrcCorePersistenceMod.PersistenceValue
import typings.firebaseAuth.distEsm5SrcCorePersistenceMod.StorageEventListener
...
object distEsm5TestHelpersErroringUnavailablePersistenceMod {
  
  @JSImport("@firebase/auth/dist/esm5/test/helpers/erroring_unavailable_persistence", "ErroringUnavailablePersistence")
  @js.native
