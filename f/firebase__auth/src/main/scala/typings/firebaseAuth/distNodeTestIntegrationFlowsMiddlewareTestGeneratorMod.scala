...
object distNodeTestIntegrationFlowsMiddlewareTestGeneratorMod {
  
  @JSImport("@firebase/auth/dist/node/test/integration/flows/middleware_test_generator", JSImport.Namespace)
  @js.native
