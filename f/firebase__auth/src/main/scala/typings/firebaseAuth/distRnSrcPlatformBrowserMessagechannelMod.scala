...
import typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distRnSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
