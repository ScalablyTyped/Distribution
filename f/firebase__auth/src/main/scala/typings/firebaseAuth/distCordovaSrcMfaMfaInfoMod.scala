...
import typings.firebaseAuth.distCordovaSrcModelPublicTypesMod.PhoneMultiFactorInfo
...
object distCordovaSrcMfaMfaInfoMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/cordova/src/mfa/mfa_info", "MultiFactorInfoImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/cordova/src/mfa/mfa_info", "TotpMultiFactorInfoImpl")
  @js.native
