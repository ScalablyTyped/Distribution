...
import typings.firebaseAuth.federatedMod.FederatedAuthProvider
...
object providersSamlMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/core/providers/saml", "SAMLAuthProvider")
  @js.native
  ...
  object SAMLAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/cordova/src/core/providers/saml", "SAMLAuthProvider.samlCredentialFromTaggedObject")
    @js.native
