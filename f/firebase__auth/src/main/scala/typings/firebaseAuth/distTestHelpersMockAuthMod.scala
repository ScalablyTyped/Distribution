...
object distTestHelpersMockAuthMod {
  
  @JSImport("@firebase/auth/dist/test/helpers/mock_auth", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object FAKE_APP_CHECK_CONTROLLER {
    
    @JSImport("@firebase/auth/dist/test/helpers/mock_auth", "FAKE_APP_CHECK_CONTROLLER")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@firebase/auth/dist/test/helpers/mock_auth", "FAKE_APP_CHECK_CONTROLLER_PROVIDER")
  @js.native
  val FAKE_APP_CHECK_CONTROLLER_PROVIDER: Provider[`app-check-internal`] = js.native
  
  object FAKE_HEARTBEAT_CONTROLLER {
    
    @JSImport("@firebase/auth/dist/test/helpers/mock_auth", "FAKE_HEARTBEAT_CONTROLLER")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@firebase/auth/dist/test/helpers/mock_auth", "TEST_AUTH_DOMAIN")
  @js.native
  val TEST_AUTH_DOMAIN: /* "localhost" */ String = js.native
  
  @JSImport("@firebase/auth/dist/test/helpers/mock_auth", "TEST_HOST")
  @js.native
  val TEST_HOST: /* "localhost" */ String = js.native
  
  @JSImport("@firebase/auth/dist/test/helpers/mock_auth", "TEST_KEY")
  @js.native
  val TEST_KEY: /* "test-api-key" */ String = js.native
  
  @JSImport("@firebase/auth/dist/test/helpers/mock_auth", "TEST_SCHEME")
  @js.native
  val TEST_SCHEME: /* "mock" */ String = js.native
  
  @JSImport("@firebase/auth/dist/test/helpers/mock_auth", "TEST_TOKEN_HOST")
  @js.native
