...
import typings.firebaseAuth.nodeSrcModelUserMod.UserCredentialInternal
import typings.firebaseAuth.nodeSrcPlatformBrowserUtilPopupMod.AuthPopup
...
object nodeSrcModelPopupRedirectMod {
