...
import typings.firebaseAuth.nodeSrcMfaMfaAssertionMod.MultiFactorAssertionImpl
import typings.firebaseAuth.nodeSrcMfaMfaErrorMod.MultiFactorError
import typings.firebaseAuth.nodeSrcMfaMfaInfoMod.MultiFactorInfoImpl
...
import typings.firebaseAuth.nodeSrcModelPublicTypesMod.MultiFactorSession
import typings.firebaseAuth.nodeSrcModelPublicTypesMod.UserCredential
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nodeSrcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typings.firebaseAuth.nodeSrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
