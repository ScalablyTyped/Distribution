...
@JSImport("@firebase/auth/dist/node/index.doc", "TwitterAuthProvider")
@js.native
...
object TwitterAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/node/index.doc", "TwitterAuthProvider.PROVIDER_ID")
  @js.native
  val PROVIDER_ID: twitterDotcom = js.native
  
  /** Always set to {@link SignInMethod}.TWITTER. */
  @JSImport("@firebase/auth/dist/node/index.doc", "TwitterAuthProvider.TWITTER_SIGN_IN_METHOD")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node/index.doc", "TwitterAuthProvider.credentialFromTaggedObject")
  @js.native
