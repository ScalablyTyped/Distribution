...
@JSImport("@firebase/auth/dist/node/index.doc", "FacebookAuthProvider")
@js.native
...
object FacebookAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/node/index.doc", "FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD")
  @js.native
  val FACEBOOK_SIGN_IN_METHOD: facebookDotcom = js.native
  
  /** Always set to {@link ProviderId}.FACEBOOK. */
  @JSImport("@firebase/auth/dist/node/index.doc", "FacebookAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node/index.doc", "FacebookAuthProvider.credentialFromTaggedObject")
  @js.native
