...
object distEsm5SrcPlatformCordovaPluginsMod {
  ...
  object CordovaWindow {
    ...
    implicit open class MutableBuilder[Self <: CordovaWindow] (val x: Self) extends AnyVal {
      ...
      inline def setCordova(value: InAppBrowser17): Self = StObject.set(x, "cordova", value.asInstanceOf[js.Any])
