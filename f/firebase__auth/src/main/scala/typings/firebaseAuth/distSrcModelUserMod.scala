...
import typings.firebaseAuth.distSrcApiAccountManagementAccountMod.APIUserInfo
import typings.firebaseAuth.distSrcApiAuthenticationMfaMod.FinalizeMfaResponse
import typings.firebaseAuth.distSrcCoreUserTokenManagerMod.StsTokenManager
import typings.firebaseAuth.distSrcCoreUserUserMetadataMod.UserMetadata
...
import typings.firebaseAuth.distSrcModelIdTokenMod.TaggedWithTokenResponse
...
object distSrcModelUserMod {
  
  /* Inlined {-readonly [ K in keyof @firebase/auth.@firebase/auth/dist/src/model/public_types.UserInfo ]: @firebase/auth.@firebase/auth/dist/src/model/public_types.UserInfo[K]} */
