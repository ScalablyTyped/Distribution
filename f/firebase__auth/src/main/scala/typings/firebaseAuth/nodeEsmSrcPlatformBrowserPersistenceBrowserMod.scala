...
object nodeEsmSrcPlatformBrowserPersistenceBrowserMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/persistence/browser", "BrowserPersistenceClass")
  @js.native
