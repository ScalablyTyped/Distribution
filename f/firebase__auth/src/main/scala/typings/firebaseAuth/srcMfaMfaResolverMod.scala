...
import typings.firebaseAuth.srcMfaMfaAssertionMod.MultiFactorAssertionImpl
import typings.firebaseAuth.srcMfaMfaErrorMod.MultiFactorError
import typings.firebaseAuth.srcMfaMfaInfoMod.MultiFactorInfoImpl
...
import typings.firebaseAuth.srcModelPublicTypesMod.MultiFactorSession
import typings.firebaseAuth.srcModelPublicTypesMod.UserCredential
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typings.firebaseAuth.srcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
