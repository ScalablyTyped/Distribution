...
import typings.firebaseAuth.distBrowserCjsSrcApiMod.RecaptchaActionName
...
object distBrowserCjsSrcPlatformBrowserRecaptchaRecaptchaEnterpriseVerifierMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/recaptcha/recaptcha_enterprise_verifier", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/recaptcha/recaptcha_enterprise_verifier", "FAKE_TOKEN")
  @js.native
  val FAKE_TOKEN: /* "NO_RECAPTCHA" */ String = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/recaptcha/recaptcha_enterprise_verifier", "RECAPTCHA_ENTERPRISE_VERIFIER_TYPE")
  @js.native
  val RECAPTCHA_ENTERPRISE_VERIFIER_TYPE: /* "recaptcha-enterprise" */ String = js.native
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/platform_browser/recaptcha/recaptcha_enterprise_verifier", "RecaptchaEnterpriseVerifier")
  @js.native
