...
import typings.firebaseAuth.nodeEsmSrcModelIdTokenMod.IdToken
...
object srcApiAuthenticationIdpMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/api/authentication/idp", JSImport.Namespace)
  @js.native
  ...
  - typings.firebaseAuth.nodeEsmSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
