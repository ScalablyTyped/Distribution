...
import typings.firebaseAuth.anon.`37`
...
import typings.firebaseAuth.distSrcModelEnumsMod.OperationType
...
object distSrcMfaMfaErrorMod {
  
  @JSImport("@firebase/auth/dist/src/mfa/mfa_error", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/src/mfa/mfa_error", "MultiFactorError")
  @js.native
  /* private */ open class MultiFactorError ()
    extends typings.firebaseAuth.distSrcModelPublicTypesMod.MultiFactorError {
  ...
  type MultiFactorErrorData = (/* import warning: importer.ImportType#apply Failed type conversion: @firebase/auth.@firebase/auth/dist/src/model/public_types.AuthError['customData'] */ js.Any) & `2` & `37`
}
