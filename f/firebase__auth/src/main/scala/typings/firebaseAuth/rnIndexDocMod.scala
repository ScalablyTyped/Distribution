...
object rnIndexDocMod {
  ...
  open class AuthCredential protected ()
    extends typings.firebaseAuth.rnMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  open class OAuthProvider protected ()
    extends typings.firebaseAuth.rnMod.OAuthProvider {
    /**
  ...
  open class RecaptchaVerifier protected ()
    extends typings.firebaseAuth.rnMod.RecaptchaVerifier {
