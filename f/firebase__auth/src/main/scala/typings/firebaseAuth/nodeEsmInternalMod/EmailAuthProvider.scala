...
@JSImport("@firebase/auth/dist/node-esm/internal", "EmailAuthProvider")
@js.native
open class EmailAuthProvider ()
  extends typings.firebaseAuth.nodeEsmMod.EmailAuthProvider
/* static members */
object EmailAuthProvider {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/node-esm/internal", "EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/node-esm/internal", "EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/node-esm/internal", "EmailAuthProvider.PROVIDER_ID")
  @js.native
