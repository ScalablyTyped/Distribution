...
import typings.firebaseAuth.distEsm5SrcModelApplicationVerifierMod.ApplicationVerifierInternal
...
import typings.firebaseAuth.distEsm5SrcModelPublicTypesMod.PhoneInfoOptions
