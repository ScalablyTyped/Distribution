...
object distBrowserCjsTestHelpersErroringUnavailablePersistenceMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/test/helpers/erroring_unavailable_persistence", "ErroringUnavailablePersistence")
  @js.native
