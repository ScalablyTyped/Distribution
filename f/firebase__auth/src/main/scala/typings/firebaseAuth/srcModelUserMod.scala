...
import typings.firebaseAuth.apiAccountManagementAccountMod.APIUserInfo
import typings.firebaseAuth.coreUserTokenManagerMod.StsTokenManager
import typings.firebaseAuth.coreUserUserMetadataMod.UserMetadata
...
import typings.firebaseAuth.srcModelIdTokenMod.TaggedWithTokenResponse
