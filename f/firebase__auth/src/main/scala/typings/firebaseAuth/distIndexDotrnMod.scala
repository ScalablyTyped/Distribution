...
object distIndexDotrnMod {
  ...
  object AuthErrorCodes {
    ...
    @JSImport("@firebase/auth/dist/index.rn", "AuthErrorCodes.INVALID_RECAPTCHA_ACTION")
    @js.native
    val INVALID_RECAPTCHA_ACTION: `authSlashinvalid-recaptcha-action` = js.native
    
    @JSImport("@firebase/auth/dist/index.rn", "AuthErrorCodes.INVALID_RECAPTCHA_TOKEN")
    @js.native
    val INVALID_RECAPTCHA_TOKEN: `authSlashinvalid-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/index.rn", "AuthErrorCodes.INVALID_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/index.rn", "AuthErrorCodes.INVALID_REQ_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/index.rn", "AuthErrorCodes.MISSING_CLIENT_TYPE")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/index.rn", "AuthErrorCodes.MISSING_RECAPTCHA_TOKEN")
    @js.native
    val MISSING_RECAPTCHA_TOKEN: `authSlashmissing-recaptcha-token` = js.native
    
    @JSImport("@firebase/auth/dist/index.rn", "AuthErrorCodes.MISSING_RECAPTCHA_VERSION")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/index.rn", "AuthErrorCodes.RECAPTCHA_NOT_ENABLED")
    @js.native
  ...
  object FactorId {
    ...
    @JSImport("@firebase/auth/dist/index.rn", "FactorId.TOTP")
    @js.native
