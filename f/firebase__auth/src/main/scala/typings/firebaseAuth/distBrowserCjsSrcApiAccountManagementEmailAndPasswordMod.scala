...
object distBrowserCjsSrcApiAccountManagementEmailAndPasswordMod {
  
  @JSImport("@firebase/auth/dist/browser-cjs/src/api/account_management/email_and_password", JSImport.Namespace)
  @js.native
