...
import typings.firebaseAuth.authAuthImplMod.AuthImpl
...
import typings.firebaseAuth.persistenceInMemoryMod.InMemoryPersistence_
import typings.firebaseAuth.srcModelAuthMod.AuthInternal
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object helpersMockAuthMod {
  
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object FAKE_HEARTBEAT_CONTROLLER {
    
    @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "FAKE_HEARTBEAT_CONTROLLER")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "FAKE_HEARTBEAT_CONTROLLER_PROVIDER")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "MockPersistenceLayer")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "TEST_AUTH_DOMAIN")
  @js.native
  val TEST_AUTH_DOMAIN: /* "localhost" */ String = js.native
  
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "TEST_HOST")
  @js.native
  val TEST_HOST: /* "localhost" */ String = js.native
  
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "TEST_KEY")
  @js.native
  val TEST_KEY: /* "test-api-key" */ String = js.native
  
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "TEST_SCHEME")
  @js.native
  val TEST_SCHEME: /* "mock" */ String = js.native
  
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/mock_auth", "TEST_TOKEN_HOST")
  @js.native
