...
@JSImport("@firebase/auth/dist/node-esm", "RecaptchaVerifier")
@js.native
open class RecaptchaVerifier protected ()
  extends typings.firebaseAuth.distNodeEsmSrcPlatformBrowserRecaptchaRecaptchaVerifierMod.RecaptchaVerifier {
