...
@JSImport("@firebase/auth/dist/node-esm", "TotpMultiFactorGenerator")
@js.native
open class TotpMultiFactorGenerator ()
  extends typings.firebaseAuth.distNodeEsmSrcMfaAssertionsTotpMod.TotpMultiFactorGenerator
/* static members */
object TotpMultiFactorGenerator {
  ...
  /**
    ...
    */
  @JSImport("@firebase/auth/dist/node-esm", "TotpMultiFactorGenerator.FACTOR_ID")
  @js.native
