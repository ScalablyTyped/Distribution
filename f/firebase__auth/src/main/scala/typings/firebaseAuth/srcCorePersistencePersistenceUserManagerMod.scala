...
import typings.firebaseAuth.nodeEsmSrcModelAuthMod.ApiKey
import typings.firebaseAuth.nodeEsmSrcModelAuthMod.AppName
...
object srcCorePersistencePersistenceUserManagerMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/persistence/persistence_user_manager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/persistence/persistence_user_manager", "PersistenceUserManager")
  @js.native
