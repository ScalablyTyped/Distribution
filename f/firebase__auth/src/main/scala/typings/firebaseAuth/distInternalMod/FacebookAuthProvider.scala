...
@JSImport("@firebase/auth/dist/internal", "FacebookAuthProvider")
@js.native
...
object FacebookAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/internal", "FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD")
  @js.native
  val FACEBOOK_SIGN_IN_METHOD: facebookDotcom = js.native
  
  /** Always set to {@link ProviderId}.FACEBOOK. */
  @JSImport("@firebase/auth/dist/internal", "FacebookAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/internal", "FacebookAuthProvider.credentialFromTaggedObject")
  @js.native
