...
object IconName {
  ...
  @scala.inline
  def adobe: typings.fortawesomeFontawesomeCommonTypes.fortawesomeFontawesomeCommonTypesStrings.adobe = "adobe".asInstanceOf[typings.fortawesomeFontawesomeCommonTypes.fortawesomeFontawesomeCommonTypesStrings.adobe]
  @scala.inline
