...
object CreateItemRelationshipsStorage {
  ...
  @scala.inline
  implicit class CreateItemRelationshipsStorageOps[Self <: CreateItemRelationshipsStorage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: CreateItemRelationshipsStorageData): Self = this.set("data", value.asInstanceOf[js.Any])
