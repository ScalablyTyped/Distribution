...
object BaseAttributesExtensionObject {
  ...
  @scala.inline
  implicit class BaseAttributesExtensionObjectOps[Self <: BaseAttributesExtensionObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSchema(value: JsonApiLink): Self = this.set("schema", value.asInstanceOf[js.Any])
