...
trait AnonFilterExtensionTypeFilterIdArray extends js.Object {
  var filterExtensionType: js.UndefOr[js.Array[String]] = js.undefined
  var filterId: js.UndefOr[js.Array[String]] = js.undefined
}

object AnonFilterExtensionTypeFilterIdArray {
  @scala.inline
  def apply(filterExtensionType: js.Array[String] = null, filterId: js.Array[String] = null): AnonFilterExtensionTypeFilterIdArray = {
    ...
    __obj.asInstanceOf[AnonFilterExtensionTypeFilterIdArray]
  }
}
