...
object FilterRefType {
  ...
  inline def apply(): FilterRefType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FilterRefType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FilterRefType] (val x: Self) extends AnyVal {
    ...
    inline def setFilterRefType(value: String): Self = StObject.set(x, "filterRefType", value.asInstanceOf[js.Any])
