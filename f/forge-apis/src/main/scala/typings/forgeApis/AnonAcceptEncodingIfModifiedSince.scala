...
trait AnonAcceptEncodingIfModifiedSince extends js.Object {
...
object AnonAcceptEncodingIfModifiedSince {
  @scala.inline
  def apply(
    ...
    range: String = null
  ): AnonAcceptEncodingIfModifiedSince = {
    ...
    __obj.asInstanceOf[AnonAcceptEncodingIfModifiedSince]
  }
}
