...
trait AnonFilterDirectionFilterExtensionType extends js.Object {
...
object AnonFilterDirectionFilterExtensionType {
  @scala.inline
  def apply(
  ...
  ): AnonFilterDirectionFilterExtensionType = {
    ...
    __obj.asInstanceOf[AnonFilterDirectionFilterExtensionType]
  }
}
