...
trait AnonFilterExtensionTypeFilterIdFilterType extends js.Object {
...
object AnonFilterExtensionTypeFilterIdFilterType {
  @scala.inline
  def apply(
  ...
  ): AnonFilterExtensionTypeFilterIdFilterType = {
    ...
    __obj.asInstanceOf[AnonFilterExtensionTypeFilterIdFilterType]
  }
}
