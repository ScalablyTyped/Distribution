...
import typings.formdataNode.blobMod.Blob
...
object fileMod {
  ...
  - typings.formdataNode.fileMod.FileLike because var conflicts: size, toStringTag, `type`. Inlined name, lastModified */ @JSImport("formdata-node/@type/File", "File")
  @js.native
