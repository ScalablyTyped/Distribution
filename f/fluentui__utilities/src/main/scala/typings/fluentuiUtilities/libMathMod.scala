...
object libMathMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.fluentuiUtilities.fluentuiUtilitiesStrings.contain
    - typings.fluentuiUtilities.fluentuiUtilitiesStrings.cover
  */
  trait FitMode extends StObject
  object FitMode {
    
    inline def contain: typings.fluentuiUtilities.fluentuiUtilitiesStrings.contain = "contain".asInstanceOf[typings.fluentuiUtilities.fluentuiUtilitiesStrings.contain]
    
    inline def cover: typings.fluentuiUtilities.fluentuiUtilitiesStrings.cover = "cover".asInstanceOf[typings.fluentuiUtilities.fluentuiUtilitiesStrings.cover]
  }
