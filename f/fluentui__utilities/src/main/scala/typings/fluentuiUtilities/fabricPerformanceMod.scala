...
object fabricPerformanceMod {
  ...
  @JSImport("@fluentui/utilities/lib/FabricPerformance", "FabricPerformance")
  @js.native
  ...
  object FabricPerformance {
    ...
    @JSImport("@fluentui/utilities/lib/FabricPerformance", "FabricPerformance._timeoutId")
    @js.native
    ...
    @JSImport("@fluentui/utilities/lib/FabricPerformance", "FabricPerformance.summary")
    @js.native
