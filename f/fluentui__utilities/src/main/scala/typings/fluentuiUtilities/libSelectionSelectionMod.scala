...
import typings.fluentuiUtilities.libSelectionSelectionDottypesMod.ISelection
import typings.fluentuiUtilities.libSelectionSelectionDottypesMod.SelectionMode
