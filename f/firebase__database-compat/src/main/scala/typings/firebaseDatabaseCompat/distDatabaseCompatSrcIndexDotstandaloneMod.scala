...
object distDatabaseCompatSrcIndexDotstandaloneMod {
  ...
  open class DataSnapshot protected ()
    extends typings.firebaseDatabaseCompat.distDatabaseCompatSrcApiReferenceMod.DataSnapshot {
    def this(
  ...
  open class Database protected ()
    extends typings.firebaseDatabaseCompat.distDatabaseCompatSrcApiDatabaseMod.Database {
    /**
  ...
  open class Query protected ()
    extends typings.firebaseDatabaseCompat.distDatabaseCompatSrcApiReferenceMod.Query {
    def this(
  ...
  open class Reference protected ()
    extends typings.firebaseDatabaseCompat.distDatabaseCompatSrcApiReferenceMod.Reference {
    /**
      * Call options:
