...
package object typesMod {
  ...
  type InstanceFactory[T /* <: typings.firebaseComponent.typesMod.Name */] = js.Function2[
    /* container */ typings.firebaseComponent.componentContainerMod.ComponentContainer, 
