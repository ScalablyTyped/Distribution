...
object firebaseComponentStrings {
  ...
  sealed trait EAGER
    extends StObject
       ...
       with typings.firebaseComponent.typesMod.InstantiationMode
  ...
  sealed trait PRIVATE
    extends StObject
       with ComponentType
       with typings.firebaseComponent.typesMod.ComponentType
  ...
  sealed trait badtest
    extends StObject
       with Name
       with typings.firebaseComponent.typesMod.Name
