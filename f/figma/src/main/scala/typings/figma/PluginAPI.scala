...
trait PluginAPI extends js.Object {
  ...
  @JSName("off")
  def off_close(`type`: close, callback: js.Function0[Unit]): Unit = js.native
  @JSName("off")
  ...
  @JSName("on")
  def on_close(`type`: close, callback: js.Function0[Unit]): Unit = js.native
  @JSName("on")
  ...
  @JSName("once")
  def once_close(`type`: close, callback: js.Function0[Unit]): Unit = js.native
  @JSName("once")
