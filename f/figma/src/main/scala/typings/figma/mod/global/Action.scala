...
object Action {
  ...
  inline def DestinationId(navigation: Navigation, preserveScrollPosition: Boolean): typings.figma.anon.DestinationId = {
  ...
  inline def Type(`type`: BACK | CLOSE): typings.figma.anon.Type = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.figma.anon.Type]
  }
  
  inline def Url(url: String): typings.figma.anon.Url = {
