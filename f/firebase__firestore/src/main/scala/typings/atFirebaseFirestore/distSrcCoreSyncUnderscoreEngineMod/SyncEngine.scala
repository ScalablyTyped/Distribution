package typings.atFirebaseFirestore.distSrcCoreSyncUnderscoreEngineMod
...
import typings.atFirebaseFirestore.distSrcCoreTypesMod.OnlineStateSource
...
import typings.atFirebaseFirestore.distSrcLocalSharedUnderscoreClientUnderscoreStateMod.SharedClientState
import typings.atFirebaseFirestore.distSrcLocalSharedUnderscoreClientUnderscoreStateUnderscoreSyncerMod.SharedClientStateSyncer
...
import typings.atFirebaseFirestore.distSrcRemoteRemoteUnderscoreSyncerMod.RemoteSyncer
...
class SyncEngine protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getRemoteKeysForTarget(targetId: TargetId): DocumentKeySet = js.native
