...
import typings.atFirebaseFirestore.distSrcApiUserUnderscoreDataUnderscoreConverterMod.DataPreConverter
import typings.atFirebaseFirestore.distSrcApiUserUnderscoreDataUnderscoreConverterMod.ParsedSetData
import typings.atFirebaseFirestore.distSrcApiUserUnderscoreDataUnderscoreConverterMod.ParsedUpdateData
...
import typings.atFirebaseFirestoreDashTypes.atFirebaseFirestoreDashTypesMod.FieldPath
...
object distSrcApiUserUnderscoreDataUnderscoreConverterMod extends js.Object {
  ...
  class UserDataConverter protected () extends js.Object {
    ...
    def parseUpdateVarargs(
      methodName: String,
      field: typings.atFirebaseFirestore.distSrcApiFieldUnderscorePathMod.FieldPath,
      value: js.Any,
      moreFieldsAndValues: js.Array[_]
    ): ParsedUpdateData = js.native
  }
  
  def fieldPathFromArgument(methodName: String, path: String): typings.atFirebaseFirestore.distSrcModelPathMod.FieldPath = js.native
  def fieldPathFromArgument(methodName: String, path: typings.atFirebaseFirestore.distSrcApiFieldUnderscorePathMod.FieldPath): typings.atFirebaseFirestore.distSrcModelPathMod.FieldPath = js.native
