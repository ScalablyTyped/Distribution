...
@JSImport("@firebase/firestore/dist/src/remote/online_state_tracker", JSImport.Namespace)
@js.native
object distSrcRemoteOnlineUnderscoreStateUnderscoreTrackerMod extends js.Object {
  @js.native
