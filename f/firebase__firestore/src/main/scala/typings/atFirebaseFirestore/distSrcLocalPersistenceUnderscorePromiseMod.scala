...
import typings.atFirebaseFirestore.distSrcLocalPersistenceUnderscorePromiseMod.FulfilledHandler
import typings.atFirebaseFirestore.distSrcLocalPersistenceUnderscorePromiseMod.PersistencePromise
import typings.atFirebaseFirestore.distSrcLocalPersistenceUnderscorePromiseMod.RejectedHandler
import typings.atFirebaseFirestore.distSrcLocalPersistenceUnderscorePromiseMod.Rejector
import typings.atFirebaseFirestore.distSrcLocalPersistenceUnderscorePromiseMod.Resolver
...
@js.native
object distSrcLocalPersistenceUnderscorePromiseMod extends js.Object {
  @js.native
  ...
  object PersistencePromise extends js.Object {
    def forEach[R](collection: Anon_CbForEachR[R], f: js.Function1[/* r */ R, PersistencePromise[Unit]]): PersistencePromise[Unit] = js.native
    def forEach[R, S](collection: Anon_CbForEach[R, S], f: js.Function1[/* r */ R, PersistencePromise[Unit]]): PersistencePromise[Unit] = js.native
    /**
      * Given an iterable, call the given function on each element in the
      * collection and wait for all of the resulting concurrent PersistencePromises
      * to resolve.
      */
    def forEach[R, S](collection: Anon_CbForEach[R, S], f: js.Function2[/* r */ R, /* s */ S, PersistencePromise[Unit]]): PersistencePromise[Unit] = js.native
    /**
    ...
    def waitFor(all: Anon_Cb): PersistencePromise[Unit] = js.native
  }
