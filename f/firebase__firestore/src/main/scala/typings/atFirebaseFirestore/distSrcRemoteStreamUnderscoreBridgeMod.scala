...
import typings.atFirebaseFirestore.distSrcRemoteConnectionMod.Stream
...
@js.native
object distSrcRemoteStreamUnderscoreBridgeMod extends js.Object {
  @js.native
  class StreamBridge[I, O] protected () extends Stream[I, O] {
    def this(args: Anon_CloseFn[I]) = this()
