...
import typings.atFirebaseFirestore.distSrcModelCollectionsMod.DocumentSizeEntries
import typings.atFirebaseFirestore.distSrcModelCollectionsMod.DocumentSizeEntry
import typings.atFirebaseFirestore.distSrcModelDocumentUnderscoreKeyMod.DocumentKey
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@firebase/firestore/dist/src/local/indexeddb_remote_document_cache", JSImport.Namespace)
@js.native
object distSrcLocalIndexeddbUnderscoreRemoteUnderscoreDocumentUnderscoreCacheMod extends js.Object {
  @js.native
  class IndexedDbRemoteDocumentCache protected () extends RemoteDocumentCache {
    ...
    /**
      ...
      */
    def getLastDocumentChange(transaction: PersistenceTransaction): PersistencePromise[Anon_ChangedDoc] = js.native
    /**
      ...
      */
    def getSizedEntries(transaction: PersistenceTransaction, documentKeys: DocumentKeySet): PersistencePromise[DocumentSizeEntries] = js.native
    /**
