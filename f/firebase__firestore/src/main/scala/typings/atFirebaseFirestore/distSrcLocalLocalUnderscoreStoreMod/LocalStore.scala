...
import typings.atFirebaseFirestore.distSrcLocalLruUnderscoreGarbageUnderscoreCollectorMod.LruResults
...
class LocalStore protected () extends js.Object {
  ...
  /**
    ...
    */
  def acknowledgeBatch(batchResult: MutationBatchResult): js.Promise[MaybeDocumentMap] = js.native
  /**
  ...
  /**
    ...
    * queue.
    */
  def applyRemoteEvent(remoteEvent: RemoteEvent): js.Promise[MaybeDocumentMap] = js.native
  ...
  /**
    ...
    */
  def getNewDocumentChanges(): js.Promise[MaybeDocumentMap] = js.native
  ...
  def lookupMutationDocuments(batchId: BatchId): js.Promise[MaybeDocumentMap | Null] = js.native
  /**
  ...
  /**
    ...
    * @returns The resulting modified documents.
    */
  def rejectBatch(batchId: BatchId): js.Promise[MaybeDocumentMap] = js.native
  /**
  ...
  /**
    ...
    */
  def remoteDocumentKeys(targetId: TargetId): js.Promise[DocumentKeySet] = js.native
