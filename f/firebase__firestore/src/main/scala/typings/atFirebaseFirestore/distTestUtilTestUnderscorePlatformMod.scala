...
import typings.atFirebaseFirestore.distTestUtilTestUnderscorePlatformMod.FakeDocument
import typings.atFirebaseFirestore.distTestUtilTestUnderscorePlatformMod.FakeWindow
import typings.atFirebaseFirestore.distTestUtilTestUnderscorePlatformMod.SharedFakeWebStorage
