...
import typings.firebaseFirestore.distLiteFirestoreTestIntegrationUtilFirebaseExportMod.CollectionReference
import typings.firebaseFirestore.distLiteFirestoreTestIntegrationUtilFirebaseExportMod.DocumentReference
