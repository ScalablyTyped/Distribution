...
object distLitePackagesFirestoreSrcRemoteStreamBridgeMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/remote/stream_bridge", "StreamBridge")
  @js.native
