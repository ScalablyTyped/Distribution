...
import typings.firebaseFirestore.firestoreSrcCoreViewSnapshotMod.DocumentChangeSet
import typings.firebaseFirestore.firestoreSrcCoreViewSnapshotMod.ViewSnapshot
import typings.firebaseFirestore.firestoreSrcLocalLocalStoreImplMod.QueryResult
...
object firestoreSrcCoreViewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.firestoreSrcCoreViewMod.AddedLimboDocument
    - typings.firebaseFirestore.firestoreSrcCoreViewMod.RemovedLimboDocument
  */
