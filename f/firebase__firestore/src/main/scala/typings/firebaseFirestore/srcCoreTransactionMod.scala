...
import typings.firebaseFirestore.liteApiUserDataReaderMod.ParsedSetData
import typings.firebaseFirestore.liteApiUserDataReaderMod.ParsedUpdateData
...
object srcCoreTransactionMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/transaction", "Transaction")
  @js.native
