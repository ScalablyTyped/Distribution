...
object distLitePackagesFirestoreSrcUtilLogMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/log", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/log", "LogLevel")
  @js.native
