...
object distPackagesFirestoreSrcPlatformNodeLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/node_lite/text_serializer", JSImport.Namespace)
  @js.native
