...
object distLiteFirestoreSrcPlatformRnLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/rn_lite/text_serializer", JSImport.Namespace)
  @js.native
