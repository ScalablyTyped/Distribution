...
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbNoDocument
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbUnknownDocument
...
object firestoreSrcLocalIndexeddbSchemaLegacyMod {
