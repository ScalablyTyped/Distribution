...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreTargetMod.Direction
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreTargetMod.FieldFilter
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreTargetMod.Operator
...
object distLitePackagesFirestoreSrcLiteApiQueryMod {
  ...
  inline def orderBy(fieldPath: typings.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiFieldPathMod.FieldPath): QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryConstraint]
  inline def orderBy(
