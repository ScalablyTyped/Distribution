...
object localPersistencePromiseMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/persistence_promise", "PersistencePromise")
  @js.native
  ...
  object PersistencePromise {
    ...
    inline def waitFor(all: `12`): PersistencePromise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(all.asInstanceOf[js.Any]).asInstanceOf[PersistencePromise[Unit]]
  }
