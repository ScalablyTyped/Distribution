...
object distPackagesFirestoreSrcPlatformNodeLiteRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/node_lite/random_bytes", JSImport.Namespace)
  @js.native
