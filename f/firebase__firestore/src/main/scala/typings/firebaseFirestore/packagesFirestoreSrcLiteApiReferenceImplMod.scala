...
import typings.firebaseFirestore.packagesFirestoreSrcLiteApiSnapshotMod.QuerySnapshot
...
object packagesFirestoreSrcLiteApiReferenceImplMod {
  ...
  inline def setDoc[T](
    ...
    options: typings.firebaseFirestore.packagesFirestoreSrcLiteApiReferenceMod.SetOptions
