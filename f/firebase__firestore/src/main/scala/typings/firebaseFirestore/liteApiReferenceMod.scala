...
import typings.firebaseFirestore.liteApiTypesMod.NestedUpdateFields
...
object liteApiReferenceMod {
  ...
  open class Query[T] protected () extends StObject {
    ...
    val _query: typings.firebaseFirestore.queryMod.Query = js.native
  ...
  {[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/reference.PartialWithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/field_value.FieldValue}
  ...
  */
  ...
  {[ K in keyof T ]: @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/reference.WithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/field_value.FieldValue}
