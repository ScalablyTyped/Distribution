...
object distLiteFirestoreTestIntegrationUtilFirebaseExportMod {
  ...
  open class AbstractUserDataWriter ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.AbstractUserDataWriter
  ...
  open class DocumentKey protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.DocumentKey {
  ...
  open class EmptyAppCheckTokenProvider ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.EmptyAppCheckTokenProvider
  ...
  open class EmptyAuthCredentialsProvider ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.EmptyAuthCredentialsProvider
  ...
  open class FieldPath protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.FieldPath {
    /**
  ...
  open class FieldValue protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.FieldValue {
    /**
  ...
  open class FirestoreError protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.FirestoreError {
    /** @hideconstructor */
    def this(
      /**
  ...
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.LoadBundleTask
  ...
  open class QueryConstraint ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.QueryConstraint
  ...
  open class SnapshotMetadata protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.SnapshotMetadata {
    /** @hideconstructor */
  ...
  open class Transaction protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod.Transaction {
    /** @hideconstructor */
    def this(
      _firestore: typings.firebaseFirestore.distLiteFirestoreSrcApiDatabaseMod.Firestore,
  ...
  open class _FieldPath ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcMod._FieldPath
  /* static members */
  object _FieldPath {
