...
import typings.firebaseFirestore.distFirestoreSrcCoreViewSnapshotMod.DocumentChangeSet
import typings.firebaseFirestore.distFirestoreSrcCoreViewSnapshotMod.ViewSnapshot
import typings.firebaseFirestore.distFirestoreSrcLocalLocalStoreImplMod.QueryResult
...
object distFirestoreSrcCoreViewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distFirestoreSrcCoreViewMod.AddedLimboDocument
    - typings.firebaseFirestore.distFirestoreSrcCoreViewMod.RemovedLimboDocument
  */
