...
object distPackagesFirestoreSrcPlatformBrowserTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/browser/text_serializer", JSImport.Namespace)
  @js.native
