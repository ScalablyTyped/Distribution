...
object distLitePackagesFirestoreSrcLocalPersistenceTransactionMod {
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/persistence_transaction", "PersistenceTransaction")
  @js.native
