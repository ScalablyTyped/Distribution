...
object distLiteFirestoreSrcUtilAsyncQueueImplMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/async_queue_impl", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/async_queue_impl", "AsyncQueueImpl")
  @js.native
