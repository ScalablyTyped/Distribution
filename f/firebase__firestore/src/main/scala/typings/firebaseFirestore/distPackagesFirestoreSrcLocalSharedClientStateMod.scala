...
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreTypesMod.OnlineState
...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalSharedClientStateSyncerMod.SharedClientStateSyncer
import typings.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.TargetIdSet_
