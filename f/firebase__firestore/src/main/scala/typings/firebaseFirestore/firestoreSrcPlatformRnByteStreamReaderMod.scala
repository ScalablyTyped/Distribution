...
object firestoreSrcPlatformRnByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/rn/byte_stream_reader", JSImport.Namespace)
  @js.native
