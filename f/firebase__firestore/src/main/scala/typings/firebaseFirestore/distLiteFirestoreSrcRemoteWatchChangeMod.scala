...
import typings.firebaseFirestore.distLiteFirestoreSrcRemoteExistenceFilterMod.ExistenceFilter
...
object distLiteFirestoreSrcRemoteWatchChangeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distLiteFirestoreSrcRemoteWatchChangeMod.DocumentWatchChange
    - typings.firebaseFirestore.distLiteFirestoreSrcRemoteWatchChangeMod.WatchTargetChange
    - typings.firebaseFirestore.distLiteFirestoreSrcRemoteWatchChangeMod.ExistenceFilterChange
  */
