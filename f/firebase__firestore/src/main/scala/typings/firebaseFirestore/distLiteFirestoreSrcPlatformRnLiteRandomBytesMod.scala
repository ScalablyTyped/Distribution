...
object distLiteFirestoreSrcPlatformRnLiteRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/rn_lite/random_bytes", JSImport.Namespace)
  @js.native
