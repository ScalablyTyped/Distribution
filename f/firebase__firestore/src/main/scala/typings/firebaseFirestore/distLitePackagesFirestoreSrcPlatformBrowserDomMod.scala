...
object distLitePackagesFirestoreSrcPlatformBrowserDomMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser/dom", JSImport.Namespace)
  @js.native
