...
object TypeOrder {
  @scala.inline
  def ArrayValue: `9` = this.cast(9)
  @scala.inline
  def BlobValue: `6` = this.cast(6)
  @scala.inline
  def BooleanValue: `1` = this.cast(1)
  @scala.inline
  def GeoPointValue: `8` = this.cast(8)
  @scala.inline
  def NullValue: `0` = this.cast(0)
  @scala.inline
  def NumberValue: `2` = this.cast(2)
  @scala.inline
  def ObjectValue: `10` = this.cast(10)
  @scala.inline
  def RefValue: `7` = this.cast(7)
  @scala.inline
  def ServerTimestampValue: `4` = this.cast(4)
  @scala.inline
  def StringValue: `5` = this.cast(5)
  @scala.inline
