...
object distLiteFirestoreSrcRemoteRemoteEventMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/remote_event", "RemoteEvent")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/remote_event", "TargetChange")
  @js.native
