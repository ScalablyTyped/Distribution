...
object distLitePackagesFirestoreSrcPlatformNodeDomMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/node/dom", JSImport.Namespace)
  @js.native
