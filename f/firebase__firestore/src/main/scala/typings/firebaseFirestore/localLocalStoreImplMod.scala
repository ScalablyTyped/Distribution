...
import typings.firebaseFirestore.srcCoreBundleMod.BundleConverter
...
object localLocalStoreImplMod {
  ...
  inline def localStoreSaveNamedQuery(localStore: LocalStore, query: typings.firebaseFirestore.protosFirestoreBundleProtoMod.NamedQuery): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("localStoreSaveNamedQuery")(localStore.asInstanceOf[js.Any], query.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
