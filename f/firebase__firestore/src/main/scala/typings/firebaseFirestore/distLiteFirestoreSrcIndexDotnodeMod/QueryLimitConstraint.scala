...
@JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "QueryLimitConstraint")
@js.native
open class QueryLimitConstraint protected ()
  extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.QueryLimitConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
