...
import typings.firebaseFirestore.modelCollectionsMod.DocumentSizeEntries
import typings.firebaseFirestore.modelCollectionsMod.DocumentSizeEntry
...
@js.native
object localIndexeddbRemoteDocumentCacheMod extends js.Object {
  @js.native
  class IndexedDbRemoteDocumentCache protected () extends RemoteDocumentCache {
    ...
    /**
      ...
      */
    def getLastDocumentChange(transaction: PersistenceTransaction): PersistencePromise[AnonChangedDocReadTime] = js.native
    /**
