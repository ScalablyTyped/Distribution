...
object distLiteFirestoreSrcCoreVersionMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/version", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/version", "SDK_VERSION")
  @js.native
