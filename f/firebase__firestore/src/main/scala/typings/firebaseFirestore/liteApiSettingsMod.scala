...
import typings.firebaseFirestore.credentialsMod.CredentialsSettings
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object liteApiSettingsMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/settings", "DEFAULT_HOST")
  @js.native
  val DEFAULT_HOST: /* "firestore.googleapis.com" */ String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/settings", "DEFAULT_SSL")
  @js.native
  val DEFAULT_SSL: /* true */ Boolean = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/settings", "FirestoreSettingsImpl")
  @js.native
