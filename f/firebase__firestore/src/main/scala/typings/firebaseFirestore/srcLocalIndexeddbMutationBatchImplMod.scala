...
import typings.firebaseFirestore.srcLocalIndexeddbSchemaLegacyMod.DbRemoteDocument
...
object srcLocalIndexeddbMutationBatchImplMod {
  ...
  inline def dbDocumentSize(doc: typings.firebaseFirestore.srcLocalIndexeddbSchemaMod.DbRemoteDocument): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("dbDocumentSize")(doc.asInstanceOf[js.Any]).asInstanceOf[Double]
