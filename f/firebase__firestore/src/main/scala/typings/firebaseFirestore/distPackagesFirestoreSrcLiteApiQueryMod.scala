...
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreTargetMod.Direction
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreTargetMod.FieldFilter
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreTargetMod.Operator
...
object distPackagesFirestoreSrcLiteApiQueryMod {
  ...
  inline def orderBy(fieldPath: typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiFieldPathMod.FieldPath): QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryConstraint]
  inline def orderBy(
