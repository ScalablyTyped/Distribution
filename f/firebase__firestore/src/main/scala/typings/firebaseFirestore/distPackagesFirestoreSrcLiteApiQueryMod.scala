...
import typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiUserDataReaderMod.UserDataReader
...
object distPackagesFirestoreSrcLiteApiQueryMod {
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", "AppliableConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", "QueryEndAtConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", "QueryFieldFilterConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", "QueryLimitConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", "QueryStartAtConstraint")
  @js.native
  ...
  inline def newQueryBoundFromDocument(
    query: typings.firebaseFirestore.distPackagesFirestoreSrcCoreQueryMod.Query,
  ...
  inline def orderBy(fieldPath: typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiFieldPathMod.FieldPath): QueryOrderByConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryOrderByConstraint]
  inline def orderBy(
  ...
  inline def validateHasExplicitOrderByForLimitToLast(query: typings.firebaseFirestore.distPackagesFirestoreSrcCoreQueryMod.Query): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("validateHasExplicitOrderByForLimitToLast")(query.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiQueryMod.QueryFieldFilterConstraint
    - typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiQueryMod.QueryCompositeFilterConstraint
  */
  trait QueryFilterConstraint extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiQueryMod.QueryOrderByConstraint
    - typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiQueryMod.QueryLimitConstraint
    - typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiQueryMod.QueryStartAtConstraint
    - typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiQueryMod.QueryEndAtConstraint
  */
