...
object srcCoreTargetMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "ArrayContainsAnyFilter")
  @js.native
  open class ArrayContainsAnyFilter protected () extends FieldFilter {
    def this(field: FieldPath, value: Value) = this()
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "ArrayContainsFilter")
  @js.native
  open class ArrayContainsFilter protected () extends FieldFilter {
    def this(field: FieldPath, value: Value) = this()
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "Bound")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "FieldFilter")
  @js.native
  ...
  object FieldFilter {
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "FieldFilter.createKeyFieldInFilter")
    @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "Filter")
  @js.native
  abstract class Filter () extends StObject {
    
    def matches(doc: Document): Boolean = js.native
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "InFilter")
  @js.native
  open class InFilter protected () extends FieldFilter {
    def this(field: FieldPath, value: Value) = this()
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "KeyFieldFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "KeyFieldInFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "KeyFieldNotInFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "NotInFilter")
  @js.native
  open class NotInFilter protected () extends FieldFilter {
    def this(field: FieldPath, value: Value) = this()
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "OrderBy")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/target", "TargetImpl")
  @js.native
