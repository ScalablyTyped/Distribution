...
@JSImport("@firebase/firestore/dist/firestore/test/integration/util/firebase_export", "QueryCompositeFilterConstraint")
@js.native
open class QueryCompositeFilterConstraint protected ()
  extends typings.firebaseFirestore.distFirestoreSrcMod.QueryCompositeFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
