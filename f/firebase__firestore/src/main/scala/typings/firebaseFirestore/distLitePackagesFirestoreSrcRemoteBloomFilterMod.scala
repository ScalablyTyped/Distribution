...
object distLitePackagesFirestoreSrcRemoteBloomFilterMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/remote/bloom_filter", "BloomFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/remote/bloom_filter", "BloomFilterError")
  @js.native
