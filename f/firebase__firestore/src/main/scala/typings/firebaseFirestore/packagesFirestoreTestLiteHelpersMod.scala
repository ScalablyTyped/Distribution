...
import typings.firebaseFirestore.packagesFirestoreSrcLiteApiReferenceMod.CollectionReference
import typings.firebaseFirestore.packagesFirestoreSrcLiteApiReferenceMod.DocumentData
import typings.firebaseFirestore.packagesFirestoreSrcLiteApiReferenceMod.DocumentReference
...
import typings.firebaseFirestore.packagesFirestoreSrcLiteApiSnapshotMod.QueryDocumentSnapshot
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object packagesFirestoreTestLiteHelpersMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/test/lite/helpers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/test/lite/helpers", "Post")
  @js.native
  ...
  object postConverter {
    ...
    @JSImport("@firebase/firestore/dist/packages/firestore/test/lite/helpers", "postConverter")
    @js.native
    val ^ : js.Any = js.native
  ...
  object postConverterMerge {
    ...
    @JSImport("@firebase/firestore/dist/packages/firestore/test/lite/helpers", "postConverterMerge")
    @js.native
    val ^ : js.Any = js.native
