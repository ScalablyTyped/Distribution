...
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaLegacyMod.DbRemoteDocument
...
object firestoreSrcLocalIndexeddbMutationBatchImplMod {
  ...
  inline def dbDocumentSize(doc: typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbRemoteDocument): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("dbDocumentSize")(doc.asInstanceOf[js.Any]).asInstanceOf[Double]
