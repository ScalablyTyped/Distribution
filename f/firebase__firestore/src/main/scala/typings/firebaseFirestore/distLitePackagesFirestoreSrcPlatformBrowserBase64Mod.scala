...
object distLitePackagesFirestoreSrcPlatformBrowserBase64Mod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser/base64", JSImport.Namespace)
  @js.native
