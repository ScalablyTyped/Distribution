...
object modelDocumentMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/model/document", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/model/document", "MutableDocument")
  @js.native
