...
object distPackagesFirestoreSrcPlatformBrowserRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/browser/random_bytes", JSImport.Namespace)
  @js.native
