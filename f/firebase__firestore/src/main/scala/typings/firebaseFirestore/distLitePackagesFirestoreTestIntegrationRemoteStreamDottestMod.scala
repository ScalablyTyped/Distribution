...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.EmptyAuthCredentialsProvider
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteWatchChangeMod.DocumentWatchChange
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteWatchChangeMod.ExistenceFilterChange
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteWatchChangeMod.WatchTargetChange
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilAsyncQueueImplMod.AsyncQueueImpl
