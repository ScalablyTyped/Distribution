...
object distFirestoreSrcCoreBoundMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/core/bound", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/core/bound", "Bound")
  @js.native
