...
object distPackagesFirestoreSrcRemoteBloomFilterMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/remote/bloom_filter", "BloomFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/remote/bloom_filter", "BloomFilterError")
  @js.native
