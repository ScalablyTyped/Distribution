...
object firestoreSrcApiObserverMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api/observer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def isPartialObserver[T](obj: Any): /* is @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/api/observer.PartialObserver<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPartialObserver")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/api/observer.PartialObserver<T> */ Boolean]
