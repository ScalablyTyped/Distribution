...
object distLitePackagesFirestoreSrcApiLongPollingOptionsMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/long_polling_options", JSImport.Namespace)
  @js.native
