...
import typings.firebaseFirestore.firestoreSrcCoreTransactionMod.Transaction
import typings.firebaseFirestore.firestoreSrcCoreTransactionOptionsMod.TransactionOptions
...
object srcCoreTransactionRunnerMod {
