...
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreBundleMod.BundleLoadResult
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreBundleMod.BundledDocument
...
import typings.firebaseFirestore.distPackagesFirestoreSrcUtilBundleReaderMod.SizedBundleElement
