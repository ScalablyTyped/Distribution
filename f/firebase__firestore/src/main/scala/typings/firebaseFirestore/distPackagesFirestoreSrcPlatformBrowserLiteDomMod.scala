...
object distPackagesFirestoreSrcPlatformBrowserLiteDomMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/browser_lite/dom", JSImport.Namespace)
  @js.native
