...
import typings.firebaseFirestore.srcCoreComponentProviderMod.OfflineComponentProvider
...
import typings.firebaseFirestore.srcCoreEventManagerMod.ListenOptions
...
object srcCoreFirestoreClientMod {
