...
import typings.firebaseFirestore.firestoreSrcMod.Bytes
...
import typings.firebaseFirestore.protosFirestoreBundleProtoMod.LimitType
import typings.firebaseFirestore.protosFirestoreBundleProtoMod.NamedQuery
...
import typings.firebaseFirestore.srcCoreBundleMod.BundledDocuments
...
object testUtilHelpersMod {
  ...
  inline def limboChanges(changes: `14`): js.Array[LimboDocumentChange] = ^.asInstanceOf[js.Dynamic].applyDynamic("limboChanges")(changes.asInstanceOf[js.Any]).asInstanceOf[js.Array[LimboDocumentChange]]
