...
object distLitePackagesFirestoreSrcPlatformBrowserTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser/text_serializer", JSImport.Namespace)
  @js.native
