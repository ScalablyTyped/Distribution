...
object distLitePackagesFirestoreSrcRemoteSerializerMod {
  ...
  inline def fromFieldFilter(filter: Filter): typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreTargetMod.Filter = ^.asInstanceOf[js.Dynamic].applyDynamic("fromFieldFilter")(filter.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreTargetMod.Filter]
  ...
  inline def fromUnaryFilter(filter: Filter): typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreTargetMod.Filter = ^.asInstanceOf[js.Dynamic].applyDynamic("fromUnaryFilter")(filter.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreTargetMod.Filter]
