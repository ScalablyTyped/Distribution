...
import typings.firebaseFirestore.anon.AliasMapRequest
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.BatchGetDocumentsResponse
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.DocumentMask
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.FieldReference
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.Filter
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.ListenResponse
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.Order
...
object distLitePackagesFirestoreSrcRemoteSerializerMod {
  ...
  inline def fromUnaryFilter(filter: Filter): typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreFilterMod.Filter = ^.asInstanceOf[js.Dynamic].applyDynamic("fromUnaryFilter")(filter.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreFilterMod.Filter]
  ...
  inline def toFilter(filter: typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreFilterMod.Filter): Filter = ^.asInstanceOf[js.Dynamic].applyDynamic("toFilter")(filter.asInstanceOf[js.Any]).asInstanceOf[Filter]
  ...
  inline def toRunAggregationQueryRequest(serializer: JsonProtoSerializer, target: Target, aggregates: js.Array[Aggregate]): AliasMapRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("toRunAggregationQueryRequest")(serializer.asInstanceOf[js.Any], target.asInstanceOf[js.Any], aggregates.asInstanceOf[js.Any])).asInstanceOf[AliasMapRequest]
  
  inline def toTarget(serializer: JsonProtoSerializer, targetData: TargetData): typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.Target = (^.asInstanceOf[js.Dynamic].applyDynamic("toTarget")(serializer.asInstanceOf[js.Any], targetData.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.Target]
  
  inline def toTimestamp(
    serializer: JsonProtoSerializer,
    timestamp: typings.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiTimestampMod.Timestamp
