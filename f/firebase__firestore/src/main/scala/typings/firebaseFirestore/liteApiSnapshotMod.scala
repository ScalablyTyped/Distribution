...
object liteApiSnapshotMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/snapshot", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/snapshot", "DocumentSnapshot")
  @js.native
  open class DocumentSnapshot[T] protected () extends StObject {
    ...
    /**
      ...
      */
    def exists(): /* is @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/snapshot.QueryDocumentSnapshot<T> */ Boolean = js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/snapshot", "QueryDocumentSnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/snapshot", "QuerySnapshot")
  @js.native
  ...
  inline def fieldPathFromArgument(methodName: String, arg: String): typings.firebaseFirestore.pathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.pathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: FieldPath): typings.firebaseFirestore.pathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.pathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: Compat[FieldPath]): typings.firebaseFirestore.pathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.pathMod.FieldPath]
