...
object distFirestoreTestIntegrationUtilTestingHooksUtilMod {
  
  @JSImport("@firebase/firestore/dist/firestore/test/integration/util/testing_hooks_util", JSImport.Namespace)
  @js.native
