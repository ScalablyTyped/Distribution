...
import typings.firebaseFirestore.localIndexeddbLruDelegateMod.IndexedDbLruDelegate
...
object localIndexeddbLruDelegateImplMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/indexeddb_lru_delegate_impl", "IndexedDbLruDelegateImpl")
  @js.native
