...
object distPackagesFirestoreSrcPlatformNodeLiteBase64Mod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/node_lite/base64", JSImport.Namespace)
  @js.native
