...
object distLiteFirestoreSrcApiCredentialsMod {
  ...
  */
  ...
  object CredentialsSettings {
    ...
    inline def FirstPartyCredentialsSettings(sessionIndex: String): typings.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings = {
