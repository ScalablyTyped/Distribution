...
object distLiteFirestoreSrcModelPathMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/model/path", "DOCUMENT_KEY_NAME")
  @js.native
  val DOCUMENT_KEY_NAME: /* "__name__" */ String = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/model/path", "FieldPath")
  @js.native
  ...
  object FieldPath {
    ...
    /**
      ...
      * without escaping.
      */
    @JSImport("@firebase/firestore/dist/lite/firestore/src/model/path", "FieldPath.isValidIdentifier")
    @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/model/path", "ResourcePath")
  @js.native
