...
object distPackagesFirestoreSrcApiCredentialsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings
    - typings.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings
  */
  ...
  object CredentialsSettings {
    ...
    inline def ProviderCredentialsSettings(client: CredentialsProvider[User]): typings.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings = {
      val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("provider")
      __obj.asInstanceOf[typings.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings]
    }
  }
