...
object srcLocalSimpleDbMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/simple_db", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/simple_db", "IndexedDbTransactionError")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/simple_db", "IterationController")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/simple_db", "SimpleDb")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/simple_db", "SimpleDbStore")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/simple_db", "SimpleDbTransaction")
  @js.native
