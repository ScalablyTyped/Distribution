...
object bundleDataMod {
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "TestBundleBuilder")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "doc1")
  @js.native
  val doc1: BundleElement = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "doc1Meta")
  @js.native
  val doc1Meta: BundleElement = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "doc1MetaString")
  @js.native
  val doc1MetaString: String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "doc1String")
  @js.native
  val doc1String: String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "doc2")
  @js.native
  val doc2: BundleElement = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "doc2Meta")
  @js.native
  val doc2Meta: BundleElement = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "doc2MetaString")
  @js.native
  val doc2MetaString: String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "doc2String")
  @js.native
  val doc2String: String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "encoder")
  @js.native
  val encoder: TextEncoder = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "limitQuery")
  @js.native
  val limitQuery: BundleElement = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "limitQueryString")
  @js.native
  val limitQueryString: String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "limitToLastQuery")
  @js.native
  val limitToLastQuery: BundleElement = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "limitToLastQueryString")
  @js.native
  val limitToLastQueryString: String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "meta")
  @js.native
  val meta: BundleElement = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "metaString")
  @js.native
  val metaString: String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "noDocMeta")
  @js.native
  val noDocMeta: BundleElement = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/unit/util/bundle_data", "noDocMetaString")
  @js.native
