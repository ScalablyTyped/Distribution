...
import typings.firebaseFirestore.firestoreSrcDirectionalIndexByteEncoderMod.DirectionalIndexByteEncoder
import typings.firebaseFirestore.srcProtosFirestoreProtoApiMod.Value
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object firestoreSrcFirestoreIndexValueWriterMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/firestore_index_value_writer", "FirestoreIndexValueWriter")
  @js.native
  ...
  object FirestoreIndexValueWriter {
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/firestore_index_value_writer", "FirestoreIndexValueWriter.INSTANCE")
    @js.native
