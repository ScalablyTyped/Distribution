...
object distFirestoreSrcRemoteRestConnectionMod {
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/remote/rest_connection", "RestConnection")
  @js.native
