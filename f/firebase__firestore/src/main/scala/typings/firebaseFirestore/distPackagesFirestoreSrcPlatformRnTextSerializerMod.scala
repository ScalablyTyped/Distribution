...
object distPackagesFirestoreSrcPlatformRnTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/rn/text_serializer", JSImport.Namespace)
  @js.native
