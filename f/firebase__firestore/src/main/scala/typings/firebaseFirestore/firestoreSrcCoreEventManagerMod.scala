...
object firestoreSrcCoreEventManagerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/core/event_manager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/core/event_manager", "EventManagerImpl")
  @js.native
