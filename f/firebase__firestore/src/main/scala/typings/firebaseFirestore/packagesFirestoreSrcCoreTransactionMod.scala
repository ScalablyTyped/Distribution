...
import typings.firebaseFirestore.firestoreSrcLiteApiUserDataReaderMod.ParsedSetData
import typings.firebaseFirestore.firestoreSrcLiteApiUserDataReaderMod.ParsedUpdateData
...
object packagesFirestoreSrcCoreTransactionMod {
