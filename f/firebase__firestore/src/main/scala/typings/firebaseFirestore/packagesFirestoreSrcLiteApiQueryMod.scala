...
object packagesFirestoreSrcLiteApiQueryMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/query", "QueryConstraint")
  @js.native
  ...
  inline def newQueryBoundFromDocument(
    query: typings.firebaseFirestore.firestoreSrcCoreQueryMod.Query,
  ...
  inline def orderBy(fieldPath: typings.firebaseFirestore.packagesFirestoreSrcLiteApiFieldPathMod.FieldPath): QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryConstraint]
  inline def orderBy(
  ...
  inline def query[T](query: Query[T], queryConstraints: QueryConstraint*): Query[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("query")(List(query.asInstanceOf[js.Any]).`++`(queryConstraints.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Query[T]]
  ...
  inline def validateHasExplicitOrderByForLimitToLast(query: typings.firebaseFirestore.firestoreSrcCoreQueryMod.Query): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("validateHasExplicitOrderByForLimitToLast")(query.asInstanceOf[js.Any]).asInstanceOf[Unit]
