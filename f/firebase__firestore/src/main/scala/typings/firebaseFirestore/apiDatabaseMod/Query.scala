...
class Query[T] protected ()
  ...
  def this(_query: typings.firebaseFirestore.coreQueryMod.Query, firestore: Firestore) = this()
  def this(
  ...
  var _query: typings.firebaseFirestore.coreQueryMod.Query = js.native
