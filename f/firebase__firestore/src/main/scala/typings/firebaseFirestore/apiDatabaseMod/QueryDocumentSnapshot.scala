...
- typings.firebaseFirestoreTypes.mod.QueryDocumentSnapshot because Inheritance from two classes. Inlined  */ @JSImport("@firebase/firestore/dist/src/api/database", "QueryDocumentSnapshot")
@js.native
