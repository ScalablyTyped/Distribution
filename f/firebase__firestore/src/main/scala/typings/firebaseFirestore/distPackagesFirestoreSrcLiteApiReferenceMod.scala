...
object distPackagesFirestoreSrcLiteApiReferenceMod {
  ...
  open class Query[T] protected () extends StObject {
    ...
    val _query: typings.firebaseFirestore.distPackagesFirestoreSrcCoreQueryMod.Query = js.native
  ...
  type PartialWithFieldValue[T] = Partial[T] | (/* import warning: importer.ImportType#apply Failed type conversion: T extends @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/types.Primitive ? T : T extends {} ? {[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/reference.PartialWithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/field_value.FieldValue} : never */ js.Any)
  
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.anon.Merge
    - typings.firebaseFirestore.anon.`44`
  */
  trait SetOptions extends StObject
  object SetOptions {
    
    inline def `44`(): typings.firebaseFirestore.anon.`44` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.firebaseFirestore.anon.`44`]
    }
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    T extends @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/types.Primitive ? T : T extends {} ? {[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/reference.UpdateData<T[K]> | @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/field_value.FieldValue} & @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/types.NestedUpdateFields<T> : std.Partial<T>
    }}}
    */
  type UpdateData[T] = T
  
  type WithFieldValue[T] = T | (/* import warning: importer.ImportType#apply Failed type conversion: T extends @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/types.Primitive ? T : T extends {} ? {[ K in keyof T ]: @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/reference.WithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/field_value.FieldValue} : never */ js.Any)
}
