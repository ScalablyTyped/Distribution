...
import typings.firebaseFirestore.distFirestoreSrcLocalLocalStoreImplMod.LocalWriteResult
...
import typings.firebaseFirestore.distFirestoreSrcModelCollectionsMod.DocumentKeyMap
