...
/**
  ...
  */ trait rl extends StObject {
  ...
  def set(t: Any, e: Any, n: Any): rl
  
  def update(t: Any, e: Any, n: Any, s: Any*): rl
}
object rl {
  ...
  inline def apply(
    ...
    delete: Any => rl,
    set: (Any, Any, Any) => rl,
    update: (Any, Any, Any, /* repeated */ Any) => rl
  ): rl = {
  ...
  extension [Self <: rl](x: Self) {
    
    inline def setCommit(value: () => Any): Self = StObject.set(x, "commit", js.Any.fromFunction0(value))
    
    inline def setDelete(value: Any => rl): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
    
    inline def setSet(value: (Any, Any, Any) => rl): Self = StObject.set(x, "set", js.Any.fromFunction3(value))
    
    inline def setUpdate(value: (Any, Any, Any, /* repeated */ Any) => rl): Self = StObject.set(x, "update", js.Any.fromFunction4(value))
    ...
    inline def set_dataReader(value: rh): Self = StObject.set(x, "_dataReader", value.asInstanceOf[js.Any])
