...
object DocumentKey {
  ...
  /* static member */
  inline def empty(): ut = ^.asInstanceOf[js.Dynamic].applyDynamic("empty")().asInstanceOf[ut]
  
  /* static member */
  inline def fromName(t: Any): ut = ^.asInstanceOf[js.Dynamic].applyDynamic("fromName")(t.asInstanceOf[js.Any]).asInstanceOf[ut]
  
  /* static member */
  inline def fromPath(t: Any): ut = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPath")(t.asInstanceOf[js.Any]).asInstanceOf[ut]
  ...
  /**
    ...
    */ /* static member */
  inline def fromSegments(t: Any): ut = ^.asInstanceOf[js.Dynamic].applyDynamic("fromSegments")(t.asInstanceOf[js.Any]).asInstanceOf[ut]
