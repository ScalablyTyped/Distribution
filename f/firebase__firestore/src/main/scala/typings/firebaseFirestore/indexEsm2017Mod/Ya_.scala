...
object Ya_ {
  ...
  inline def apply(_byteString: Any, isEqual: Any => Any, toBase64: () => Any, toUint8Array: () => Any): Ya_ = {
    ...
    __obj.asInstanceOf[Ya_]
  }
  
  extension [Self <: Ya_](x: Self) {
