...
open class WriteBatch_ protected ()
  ...
  /**
    ...
    */ /* CompleteClass */
  override def delete(t: Any): rl = js.native
  
  /* CompleteClass */
  override def set(t: Any, e: Any, n: Any): rl = js.native
  
  /* CompleteClass */
  override def update(t: Any, e: Any, n: Any, s: Any*): rl = js.native
}
