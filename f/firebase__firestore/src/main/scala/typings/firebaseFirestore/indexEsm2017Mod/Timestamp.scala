...
/**
  ...
  */
@JSImport("@firebase/firestore/dist/packages/firestore/dist/index.esm2017", "Timestamp")
@js.native
...
object Timestamp {
  ...
  /**
    ...
    *     date.
    */ /* static member */
  inline def fromDate(t: Any): et = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDate")(t.asInstanceOf[js.Any]).asInstanceOf[et]
  ...
  /**
    ...
    */ /* static member */
  inline def fromMillis(t: Any): et = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMillis")(t.asInstanceOf[js.Any]).asInstanceOf[et]
  ...
  /**
    ...
    */ /* static member */
  inline def now(): et = ^.asInstanceOf[js.Dynamic].applyDynamic("now")().asInstanceOf[et]
}
