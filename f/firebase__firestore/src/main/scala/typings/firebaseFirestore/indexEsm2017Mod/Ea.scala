...
/**
  ...
  */ trait Ea extends StObject {
  ...
  def withConverter(t: Any): Ea
}
object Ea {
  
  inline def apply(_query: Any, converter: Any, firestore: Any, `type`: String, withConverter: Any => Ea): Ea = {
  ...
  extension [Self <: Ea](x: Self) {
    ...
    inline def setWithConverter(value: Any => Ea): Self = StObject.set(x, "withConverter", js.Any.fromFunction1(value))
