...
object distLiteFirestoreSrcPlatformBrowserLiteSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/browser_lite/serializer", JSImport.Namespace)
  @js.native
