...
object distLiteFirestoreSrcUtilTypesMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/types", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/types", "BATCHID_UNKNOWN")
  @js.native
