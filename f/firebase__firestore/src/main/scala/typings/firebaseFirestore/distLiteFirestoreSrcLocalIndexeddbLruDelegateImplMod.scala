...
import typings.firebaseFirestore.distLiteFirestoreSrcLocalIndexeddbLruDelegateMod.IndexedDbLruDelegate
...
object distLiteFirestoreSrcLocalIndexeddbLruDelegateImplMod {
