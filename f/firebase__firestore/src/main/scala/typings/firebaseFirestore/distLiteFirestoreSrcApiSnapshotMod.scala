...
import typings.firebaseFirestore.distLiteFirestoreSrcCoreViewSnapshotMod.ChangeType
...
object distLiteFirestoreSrcApiSnapshotMod {
  ...
  */
  ...
  trait FirestoreDataConverter[T]
    extends StObject
       with typings.firebaseFirestore.distLiteFirestoreSrcLiteApiSnapshotMod.FirestoreDataConverter[T] {
