...
trait ProjectsDatabasesIndexesGetNamedParameters extends StObject {
...
object ProjectsDatabasesIndexesGetNamedParameters {
  
  inline def apply(): ProjectsDatabasesIndexesGetNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesIndexesGetNamedParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectsDatabasesIndexesGetNamedParameters] (val x: Self) extends AnyVal {
