...
trait ProjectsDatabasesDocumentsGetNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsGetNamedParameters {
  ...
  inline def apply(): ProjectsDatabasesDocumentsGetNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsGetNamedParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectsDatabasesDocumentsGetNamedParameters] (val x: Self) extends AnyVal {
