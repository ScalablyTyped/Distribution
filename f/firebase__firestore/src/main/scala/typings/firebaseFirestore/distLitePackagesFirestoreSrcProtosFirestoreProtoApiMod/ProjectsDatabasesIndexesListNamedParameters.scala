...
trait ProjectsDatabasesIndexesListNamedParameters extends StObject {
...
object ProjectsDatabasesIndexesListNamedParameters {
  
  inline def apply(): ProjectsDatabasesIndexesListNamedParameters = {
