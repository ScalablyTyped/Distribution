...
object distLitePackagesFirestoreSrcPlatformRnBase64Mod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn/base64", JSImport.Namespace)
  @js.native
