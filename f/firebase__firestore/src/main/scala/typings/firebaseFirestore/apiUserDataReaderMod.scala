...
@JSImport("@firebase/firestore/dist/src/api/user_data_reader", JSImport.Namespace)
@js.native
object apiUserDataReaderMod extends js.Object {
  @js.native
  ...
  class UserDataReader protected () extends js.Object {
    ...
    def parseUpdateVarargs(
      methodName: String,
      field: typings.firebaseFirestore.apiFieldPathMod.FieldPath,
      value: js.Any,
      moreFieldsAndValues: js.Array[_]
    ): ParsedUpdateData = js.native
  }
  
  def fieldPathFromArgument(methodName: String, path: String): typings.firebaseFirestore.modelPathMod.FieldPath = js.native
  def fieldPathFromArgument(methodName: String, path: typings.firebaseFirestore.apiFieldPathMod.FieldPath): typings.firebaseFirestore.modelPathMod.FieldPath = js.native
