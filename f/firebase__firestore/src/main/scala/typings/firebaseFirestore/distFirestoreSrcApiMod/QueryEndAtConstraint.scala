...
@JSImport("@firebase/firestore/dist/firestore/src/api", "QueryEndAtConstraint")
@js.native
open class QueryEndAtConstraint protected ()
  extends typings.firebaseFirestore.distFirestoreSrcApiFilterMod.QueryEndAtConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
