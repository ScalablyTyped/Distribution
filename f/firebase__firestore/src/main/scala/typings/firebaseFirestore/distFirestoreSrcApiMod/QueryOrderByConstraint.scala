...
@JSImport("@firebase/firestore/dist/firestore/src/api", "QueryOrderByConstraint")
@js.native
open class QueryOrderByConstraint protected ()
  extends typings.firebaseFirestore.distFirestoreSrcApiFilterMod.QueryOrderByConstraint {
  /**
    * @internal
    */
