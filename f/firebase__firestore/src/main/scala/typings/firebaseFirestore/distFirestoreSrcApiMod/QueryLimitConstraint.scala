...
@JSImport("@firebase/firestore/dist/firestore/src/api", "QueryLimitConstraint")
@js.native
open class QueryLimitConstraint protected ()
  extends typings.firebaseFirestore.distFirestoreSrcApiFilterMod.QueryLimitConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
