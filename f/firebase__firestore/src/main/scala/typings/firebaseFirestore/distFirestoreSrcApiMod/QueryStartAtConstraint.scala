...
@JSImport("@firebase/firestore/dist/firestore/src/api", "QueryStartAtConstraint")
@js.native
open class QueryStartAtConstraint protected ()
  extends typings.firebaseFirestore.distFirestoreSrcApiFilterMod.QueryStartAtConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
