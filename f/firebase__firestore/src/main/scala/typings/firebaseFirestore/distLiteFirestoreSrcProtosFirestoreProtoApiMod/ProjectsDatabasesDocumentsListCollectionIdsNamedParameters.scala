...
trait ProjectsDatabasesDocumentsListCollectionIdsNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsListCollectionIdsNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsListCollectionIdsNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsListCollectionIdsNamedParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectsDatabasesDocumentsListCollectionIdsNamedParameters] (val x: Self) extends AnyVal {
