...
trait ProjectsDatabasesDocumentsCreateDocumentNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsCreateDocumentNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsCreateDocumentNamedParameters = {
