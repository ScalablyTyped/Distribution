...
trait ProjectsDatabasesDocumentsRollbackNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsRollbackNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsRollbackNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsRollbackNamedParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectsDatabasesDocumentsRollbackNamedParameters] (val x: Self) extends AnyVal {
