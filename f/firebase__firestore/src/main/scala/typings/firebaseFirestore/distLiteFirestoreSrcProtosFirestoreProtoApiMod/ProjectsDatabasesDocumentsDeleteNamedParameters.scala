...
trait ProjectsDatabasesDocumentsDeleteNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsDeleteNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsDeleteNamedParameters = {
