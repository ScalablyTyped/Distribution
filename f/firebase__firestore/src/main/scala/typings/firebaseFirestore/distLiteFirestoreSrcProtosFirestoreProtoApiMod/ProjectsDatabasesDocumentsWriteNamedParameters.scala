...
trait ProjectsDatabasesDocumentsWriteNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsWriteNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsWriteNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsWriteNamedParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectsDatabasesDocumentsWriteNamedParameters] (val x: Self) extends AnyVal {
