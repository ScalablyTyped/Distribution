...
object distLiteFirestoreSrcLiteApiAggregateTypesMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/aggregate_types", "AggregateField")
  @js.native
  /**
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/aggregate_types", "AggregateQuerySnapshot")
  @js.native
  ...
  /** NOTE: Mapped type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    {[ P in keyof T ]: T[P] extends @firebase/firestore.@firebase/firestore/dist/lite/firestore/src/lite-api/aggregate_types.AggregateField<infer U>? U : never}
    }}}
    */
  @js.native
