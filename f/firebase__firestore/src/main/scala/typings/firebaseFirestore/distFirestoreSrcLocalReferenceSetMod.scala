...
object distFirestoreSrcLocalReferenceSetMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/reference_set", "DocReference")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/local/reference_set", "ReferenceSet")
  @js.native
