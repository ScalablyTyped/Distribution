...
object distLitePackagesFirestoreSrcPlatformRnByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn/byte_stream_reader", JSImport.Namespace)
  @js.native
