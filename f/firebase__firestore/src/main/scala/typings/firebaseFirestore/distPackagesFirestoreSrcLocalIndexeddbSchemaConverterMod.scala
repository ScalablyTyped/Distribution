...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalSimpleDbMod.SimpleDbSchemaConverter
...
object distPackagesFirestoreSrcLocalIndexeddbSchemaConverterMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/indexeddb_schema_converter", "SchemaConverter")
  @js.native
