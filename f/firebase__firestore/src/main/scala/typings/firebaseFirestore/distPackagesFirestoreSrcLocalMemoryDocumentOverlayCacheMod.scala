...
object distPackagesFirestoreSrcLocalMemoryDocumentOverlayCacheMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/memory_document_overlay_cache", "MemoryDocumentOverlayCache")
  @js.native
