...
object distLiteFirestoreSrcApiAggregateMod {
  ...
  inline def getCountFromServer(query: Query_[Any]): js.Promise[AggregateQuerySnapshot[`12`]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getCountFromServer")(query.asInstanceOf[js.Any]).asInstanceOf[js.Promise[AggregateQuerySnapshot[`12`]]]
