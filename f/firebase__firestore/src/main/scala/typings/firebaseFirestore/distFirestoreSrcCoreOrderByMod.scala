...
object distFirestoreSrcCoreOrderByMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/core/order_by", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/core/order_by", "OrderBy")
  @js.native
