...
object distLiteMod {
  ...
  @JSImport("@firebase/firestore/dist/lite", "FieldValue")
  @js.native
  /* private */ abstract class FieldValue () extends StObject {
  ...
  @JSImport("@firebase/firestore/dist/lite", "QueryConstraint")
  @js.native
  ...
  */
  ...
  {[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/lite.PartialWithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/lite.FieldValue}
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.firebaseFirestore.anon.`15`
  */
  trait SetOptions extends StObject
  object SetOptions {
    
    inline def `15`(): typings.firebaseFirestore.anon.`15` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.firebaseFirestore.anon.`15`]
    }
  ...
  */
  ...
  {[ K in keyof T ]: @firebase/firestore.@firebase/firestore/dist/lite.WithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/lite.FieldValue}
