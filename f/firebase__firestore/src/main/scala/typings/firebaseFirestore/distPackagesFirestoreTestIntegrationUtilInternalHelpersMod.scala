...
import typings.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.EmptyAuthCredentialsProvider
...
import typings.firebaseFirestore.distPackagesFirestoreSrcUtilAsyncQueueImplMod.AsyncQueueImpl
