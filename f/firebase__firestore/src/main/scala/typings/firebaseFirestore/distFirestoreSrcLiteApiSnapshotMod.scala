...
object distFirestoreSrcLiteApiSnapshotMod {
  ...
  inline def fieldPathFromArgument(methodName: String, arg: String): typings.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: FieldPath): typings.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: Compat[FieldPath]): typings.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath]
