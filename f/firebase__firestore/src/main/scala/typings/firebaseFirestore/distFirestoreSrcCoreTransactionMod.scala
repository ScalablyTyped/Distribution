...
import typings.firebaseFirestore.distFirestoreSrcLiteApiUserDataReaderMod.ParsedSetData
import typings.firebaseFirestore.distFirestoreSrcLiteApiUserDataReaderMod.ParsedUpdateData
...
object distFirestoreSrcCoreTransactionMod {
