...
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreViewSnapshotMod.DocumentChangeSet
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreViewSnapshotMod.ViewSnapshot
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalLocalStoreImplMod.QueryResult
...
object distPackagesFirestoreSrcCoreViewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distPackagesFirestoreSrcCoreViewMod.AddedLimboDocument
    - typings.firebaseFirestore.distPackagesFirestoreSrcCoreViewMod.RemovedLimboDocument
  */
