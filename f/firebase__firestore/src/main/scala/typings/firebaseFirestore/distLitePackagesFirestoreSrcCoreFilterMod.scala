...
object distLitePackagesFirestoreSrcCoreFilterMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "ArrayContainsAnyFilter")
  @js.native
  open class ArrayContainsAnyFilter protected () extends FieldFilter {
    def this(field: FieldPath, value: Value) = this()
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "ArrayContainsFilter")
  @js.native
  open class ArrayContainsFilter protected () extends FieldFilter {
    def this(field: FieldPath, value: Value) = this()
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "CompositeFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "FieldFilter")
  @js.native
  ...
  object FieldFilter {
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "FieldFilter.createKeyFieldInFilter")
    @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "Filter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "InFilter")
  @js.native
  open class InFilter protected () extends FieldFilter {
    def this(field: FieldPath, value: Value) = this()
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "KeyFieldFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "KeyFieldInFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "KeyFieldNotInFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/filter", "NotInFilter")
  @js.native
