...
import typings.firebaseFirestore.srcCoreTypesMod.MutationBatchState
import typings.firebaseFirestore.srcCoreTypesMod.OnlineState
import typings.firebaseFirestore.srcCoreTypesMod.TargetId
import typings.firebaseFirestore.srcLocalSharedClientStateSyncerMod.QueryTargetState
import typings.firebaseFirestore.srcLocalSharedClientStateSyncerMod.SharedClientStateSyncer
import typings.firebaseFirestore.srcModelCollectionsMod.TargetIdSet_
...
object srcLocalSharedClientStateMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/shared_client_state", "LocalClientState")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/shared_client_state", "MemorySharedClientState")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/shared_client_state", "MutationMetadata")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/shared_client_state", "QueryTargetMetadata")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/shared_client_state", "SharedOnlineState")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/shared_client_state", "WebStorageSharedClientState")
  @js.native
  ...
  object WebStorageSharedClientState {
    ...
    inline def isAvailable(): /* is @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/util/types.WindowLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAvailable")().asInstanceOf[/* is @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/util/types.WindowLike */ Boolean]
    inline def isAvailable(window: WindowLike): /* is @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/util/types.WindowLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAvailable")(window.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/util/types.WindowLike */ Boolean]
  }
