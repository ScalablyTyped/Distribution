...
object distPackagesFirestoreSrcModelDocumentMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/document", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/document", "MutableDocument")
  @js.native
