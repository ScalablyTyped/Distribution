...
object distPackagesFirestoreSrcPlatformRnLiteConnectionMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/rn_lite/connection", JSImport.Namespace)
  @js.native
