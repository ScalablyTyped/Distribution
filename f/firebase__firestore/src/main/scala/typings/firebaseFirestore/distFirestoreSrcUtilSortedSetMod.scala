...
import typings.firebaseFirestore.distFirestoreSrcUtilSortedMapMod.SortedMapIterator
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distFirestoreSrcUtilSortedSetMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/util/sorted_set", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/util/sorted_set", "SortedSet")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/util/sorted_set", "SortedSetIterator")
  @js.native
