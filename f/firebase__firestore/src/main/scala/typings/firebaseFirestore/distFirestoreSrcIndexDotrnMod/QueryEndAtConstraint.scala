...
@JSImport("@firebase/firestore/dist/firestore/src/index.rn", "QueryEndAtConstraint")
@js.native
open class QueryEndAtConstraint protected ()
  extends typings.firebaseFirestore.distFirestoreSrcApiMod.QueryEndAtConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
