...
object distFirestoreSrcPlatformNodeLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/platform/node_lite/text_serializer", JSImport.Namespace)
  @js.native
