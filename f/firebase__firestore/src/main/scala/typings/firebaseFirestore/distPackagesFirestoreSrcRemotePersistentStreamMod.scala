...
import typings.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.Token
...
import typings.firebaseFirestore.distPackagesFirestoreSrcRemoteBackoffMod.ExponentialBackoff
...
object distPackagesFirestoreSrcRemotePersistentStreamMod {
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/packages/firestore/src/remote/persistent_stream", "PersistentStream")
  @js.native
  ...
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typings.firebaseFirestore.distPackagesFirestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typings.firebaseFirestore.distPackagesFirestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
