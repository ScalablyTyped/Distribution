...
import typings.firebaseFirestore.anon.OfflineKind
...
trait FirestoreClient extends StObject {
  ...
  var _uninitializedComponentsProvider: js.UndefOr[OfflineKind] = js.undefined
...
object FirestoreClient {
  ...
  implicit open class MutableBuilder[Self <: FirestoreClient] (val x: Self) extends AnyVal {
    ...
    inline def set_uninitializedComponentsProvider(value: OfflineKind): Self = StObject.set(x, "_uninitializedComponentsProvider", value.asInstanceOf[js.Any])
