...
trait Filter extends StObject {
  ...
  def getFirstInequalityField(): _FieldPath | Null
...
object Filter {
  ...
  implicit open class MutableBuilder[Self <: Filter] (val x: Self) extends AnyVal {
    ...
    inline def setGetFirstInequalityField(value: () => _FieldPath | Null): Self = StObject.set(x, "getFirstInequalityField", js.Any.fromFunction0(value))
