...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteExistenceFilterMod.ExistenceFilter
...
object distLitePackagesFirestoreSrcRemoteWatchChangeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteWatchChangeMod.DocumentWatchChange
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteWatchChangeMod.WatchTargetChange
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteWatchChangeMod.ExistenceFilterChange
  */
