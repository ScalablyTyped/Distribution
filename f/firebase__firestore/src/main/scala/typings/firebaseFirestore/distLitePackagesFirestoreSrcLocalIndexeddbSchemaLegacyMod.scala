...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbNoDocument
import typings.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbUnknownDocument
