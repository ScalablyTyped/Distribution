...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilObjMapMod.ObjectMap
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLitePackagesFirestoreSrcLocalRemoteDocumentChangeBufferMod {
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/remote_document_change_buffer", "RemoteDocumentChangeBuffer")
  @js.native
