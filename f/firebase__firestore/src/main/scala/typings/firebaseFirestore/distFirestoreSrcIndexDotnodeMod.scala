...
object distFirestoreSrcIndexDotnodeMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/index.node", "AbstractUserDataWriter")
  @js.native
  open class AbstractUserDataWriter ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.AbstractUserDataWriter
  
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "AggregateField")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "_ByteString")
  @js.native
  /* private */ open class ByteString ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.ByteString
  /* static members */
  object ByteString {
    ...
    @JSImport("@firebase/firestore/dist/firestore/src/index.node", "_ByteString.EMPTY_BYTE_STRING")
    @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "Bytes")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "CACHE_SIZE_UNLIMITED")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "_DatabaseId")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "_DocumentKey")
  @js.native
  open class DocumentKey protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.DocumentKey {
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "DocumentSnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "_EmptyAppCheckTokenProvider")
  @js.native
  open class EmptyAppCheckTokenProvider ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.EmptyAppCheckTokenProvider
  
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "_EmptyAuthCredentialsProvider")
  @js.native
  open class EmptyAuthCredentialsProvider ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.EmptyAuthCredentialsProvider
  
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "FieldPath")
  @js.native
  open class FieldPath protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.FieldPath {
    /**
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/index.node", "FieldValue")
  @js.native
  open class FieldValue protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.FieldValue {
    /**
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "Firestore")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "FirestoreError")
  @js.native
  open class FirestoreError protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.FirestoreError {
    /** @hideconstructor */
    def this(
      /**
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "GeoPoint")
  @js.native
  open class GeoPoint protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.GeoPoint {
    /**
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "LoadBundleTask")
  @js.native
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.LoadBundleTask
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/index.node", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.QueryConstraint
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "QuerySnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "Query")
  @js.native
  open class Query_[T] protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.Query_[T] {
    def this(
      firestore: typings.firebaseFirestore.distFirestoreSrcLiteApiDatabaseMod.Firestore,
      /**
      * If provided, the `FirestoreDataConverter` associated with this instance.
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "_ResourcePath")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "SnapshotMetadata")
  @js.native
  open class SnapshotMetadata protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.SnapshotMetadata {
    /** @hideconstructor */
    def this(hasPendingWrites: Boolean, fromCache: Boolean) = this()
  }
  
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "Timestamp")
  @js.native
  open class Timestamp protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.Timestamp {
    /**
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.node", "Transaction")
  @js.native
  open class Transaction protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiMod.Transaction {
    /** @hideconstructor */
    def this(
      _firestore: typings.firebaseFirestore.distFirestoreSrcApiDatabaseMod.Firestore,
