...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.ListenRequest
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.ListenResponse
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.WriteResponse
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteBackoffMod.ExponentialBackoff
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteConnectionMod.Connection
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteConnectionMod.Stream
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteSerializerMod.JsonProtoSerializer
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteWatchChangeMod.WatchChange
...
object distLitePackagesFirestoreSrcRemotePersistentStreamMod {
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/remote/persistent_stream", "PersistentStream")
  @js.native
  open class PersistentStream[SendType, ReceiveType, ListenerType /* <: PersistentStreamListener */] protected () extends StObject {
    def this(
      queue: AsyncQueue,
  ...
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
