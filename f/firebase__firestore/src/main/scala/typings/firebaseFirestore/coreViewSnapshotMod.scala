...
object coreViewSnapshotMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/view_snapshot", "DocumentChangeSet")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/view_snapshot", "ViewSnapshot")
  @js.native
