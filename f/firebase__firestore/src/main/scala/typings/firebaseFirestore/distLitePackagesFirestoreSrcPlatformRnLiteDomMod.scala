...
object distLitePackagesFirestoreSrcPlatformRnLiteDomMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn_lite/dom", JSImport.Namespace)
  @js.native
