...
object distLiteFirestoreSrcLiteApiReferenceMod {
  ...
  open class Query[T] protected () extends StObject {
    ...
    val _query: typings.firebaseFirestore.distLiteFirestoreSrcCoreQueryMod.Query = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.firebaseFirestore.anon.`16`
  */
  trait SetOptions extends StObject
  object SetOptions {
    
    inline def `16`(): typings.firebaseFirestore.anon.`16` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.firebaseFirestore.anon.`16`]
    }
