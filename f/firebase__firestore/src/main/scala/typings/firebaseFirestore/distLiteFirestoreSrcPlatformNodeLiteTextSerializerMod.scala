...
object distLiteFirestoreSrcPlatformNodeLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/node_lite/text_serializer", JSImport.Namespace)
  @js.native
