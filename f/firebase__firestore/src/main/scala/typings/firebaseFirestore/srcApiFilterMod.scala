...
object srcApiFilterMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/filter", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/filter", "QueryConstraint")
  @js.native
  ...
  inline def endAt(snapshot: DocumentSnapshot[Any]): typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("endAt")(snapshot.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint]
  ...
  inline def endBefore(snapshot: DocumentSnapshot[Any]): typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("endBefore")(snapshot.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint]
  ...
  inline def orderBy(fieldPath: FieldPath): typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint]
  inline def orderBy(fieldPath: FieldPath, directionStr: OrderByDirection): typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint = (^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any], directionStr.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint]
  ...
  inline def startAfter(snapshot: DocumentSnapshot[Any]): typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("startAfter")(snapshot.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint]
  ...
  inline def startAt(snapshot: DocumentSnapshot[Any]): typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("startAt")(snapshot.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint]
  ...
  inline def where(fieldPath: FieldPath, opStr: WhereFilterOp, value: Any): typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint = (^.asInstanceOf[js.Dynamic].applyDynamic("where")(fieldPath.asInstanceOf[js.Any], opStr.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.firestoreSrcLiteApiQueryMod.QueryConstraint]
}
