...
@JSImport("@firebase/firestore/dist/packages/firestore/src/api", "QueryDocumentSnapshot")
@js.native
open class QueryDocumentSnapshot[T] protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcApiSnapshotMod.QueryDocumentSnapshot[T] {
  def this(
