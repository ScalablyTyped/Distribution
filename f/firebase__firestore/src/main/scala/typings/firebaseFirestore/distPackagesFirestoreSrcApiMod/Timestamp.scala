...
@JSImport("@firebase/firestore/dist/packages/firestore/src/api", "Timestamp")
@js.native
open class Timestamp protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcApiTimestampMod.Timestamp {
  /**
