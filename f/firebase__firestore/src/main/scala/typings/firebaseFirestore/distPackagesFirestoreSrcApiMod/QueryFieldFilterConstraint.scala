...
@JSImport("@firebase/firestore/dist/packages/firestore/src/api", "QueryFieldFilterConstraint")
@js.native
open class QueryFieldFilterConstraint protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcApiFilterMod.QueryFieldFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
