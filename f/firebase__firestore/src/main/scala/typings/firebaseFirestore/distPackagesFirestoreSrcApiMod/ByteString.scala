...
@JSImport("@firebase/firestore/dist/packages/firestore/src/api", "_ByteString")
@js.native
/* private */ open class ByteString ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcUtilByteStringMod.ByteString
/* static members */
object ByteString {
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "_ByteString.EMPTY_BYTE_STRING")
  @js.native
