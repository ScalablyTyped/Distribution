...
@JSImport("@firebase/firestore/dist/packages/firestore/src/api", "_DatabaseId")
@js.native
open class DatabaseId protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcCoreDatabaseInfoMod.DatabaseId {
