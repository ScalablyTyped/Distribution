...
@JSImport("@firebase/firestore/dist/packages/firestore/src/api", "_FieldPath")
@js.native
open class _FieldPath ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.FieldPath
/* static members */
object _FieldPath {
  ...
  /**
    ...
    * without escaping.
    */
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "_FieldPath.isValidIdentifier")
  @js.native
