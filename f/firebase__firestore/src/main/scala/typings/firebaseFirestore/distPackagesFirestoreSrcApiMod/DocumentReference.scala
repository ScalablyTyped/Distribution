...
@JSImport("@firebase/firestore/dist/packages/firestore/src/api", "DocumentReference")
@js.native
open class DocumentReference[T] protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcApiReferenceMod.DocumentReference[T] {
  def this(
