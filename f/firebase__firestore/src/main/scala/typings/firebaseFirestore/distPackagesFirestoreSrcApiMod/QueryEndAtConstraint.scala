...
@JSImport("@firebase/firestore/dist/packages/firestore/src/api", "QueryEndAtConstraint")
@js.native
open class QueryEndAtConstraint protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcApiFilterMod.QueryEndAtConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
