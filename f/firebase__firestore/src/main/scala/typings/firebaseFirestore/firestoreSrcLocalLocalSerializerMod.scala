...
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbBundle
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbDocumentOverlay
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbIndexConfiguration
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbIndexState
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbMutationBatch
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbNamedQuery
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbRemoteDocument
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbTarget
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbTimestamp
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSentinelsMod.DbDocumentOverlayKey
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSentinelsMod.DbTimestampKey
...
object firestoreSrcLocalLocalSerializerMod {
  ...
  inline def fromBundleMetadata(metadata: BundleMetadata): typings.firebaseFirestore.packagesFirestoreSrcCoreBundleMod.BundleMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBundleMetadata")(metadata.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.packagesFirestoreSrcCoreBundleMod.BundleMetadata]
  ...
  inline def fromDbBundle(dbBundle: DbBundle): typings.firebaseFirestore.packagesFirestoreSrcCoreBundleMod.BundleMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDbBundle")(dbBundle.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.packagesFirestoreSrcCoreBundleMod.BundleMetadata]
  ...
  inline def fromProtoNamedQuery(namedQuery: typings.firebaseFirestore.firestoreSrcProtosFirestoreBundleProtoMod.NamedQuery): NamedQuery = ^.asInstanceOf[js.Dynamic].applyDynamic("fromProtoNamedQuery")(namedQuery.asInstanceOf[js.Any]).asInstanceOf[NamedQuery]
  ...
  inline def toDbNamedQuery(query: typings.firebaseFirestore.firestoreSrcProtosFirestoreBundleProtoMod.NamedQuery): DbNamedQuery = ^.asInstanceOf[js.Dynamic].applyDynamic("toDbNamedQuery")(query.asInstanceOf[js.Any]).asInstanceOf[DbNamedQuery]
