...
import typings.firebaseFirestore.anon.`47`
...
import typings.firebaseFirestore.distPackagesFirestoreSrcProtosFirestoreProtoApiMod.MapValue
...
object distPackagesFirestoreSrcModelObjectValueMod {
