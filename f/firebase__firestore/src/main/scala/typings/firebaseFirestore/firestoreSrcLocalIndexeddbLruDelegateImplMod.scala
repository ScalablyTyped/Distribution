...
object firestoreSrcLocalIndexeddbLruDelegateImplMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/indexeddb_lru_delegate_impl", "IndexedDbLruDelegateImpl")
  @js.native
