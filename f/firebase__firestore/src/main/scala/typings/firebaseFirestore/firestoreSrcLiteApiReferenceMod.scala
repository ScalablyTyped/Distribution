...
import typings.firebaseFirestore.firestoreSrcLiteApiTypesMod.NestedUpdateFields
...
object firestoreSrcLiteApiReferenceMod {
  ...
  open class Query[T] protected () extends StObject {
    ...
    val _query: typings.firebaseFirestore.srcCoreQueryMod.Query = js.native
  ...
  {[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/lite-api/reference.PartialWithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/lite-api/field_value.FieldValue}
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.firebaseFirestore.anon.`21`
  */
  trait SetOptions extends StObject
  object SetOptions {
    
    inline def `21`(): typings.firebaseFirestore.anon.`21` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.firebaseFirestore.anon.`21`]
    }
  ...
  {[ K in keyof T ]: @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/lite-api/reference.WithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/lite-api/field_value.FieldValue}
