...
import typings.firebaseFirestore.firestoreSrcCoreTargetMod.Bound
import typings.firebaseFirestore.firestoreSrcCoreTargetMod.Filter
...
object firestoreSrcCoreQueryMod {
