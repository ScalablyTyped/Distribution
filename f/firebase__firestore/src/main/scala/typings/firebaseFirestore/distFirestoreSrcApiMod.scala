...
object distFirestoreSrcApiMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/api", "AbstractUserDataWriter")
  @js.native
  open class AbstractUserDataWriter ()
    extends typings.firebaseFirestore.distFirestoreSrcLiteApiUserDataWriterMod.AbstractUserDataWriter
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.distFirestoreSrcLiteApiAggregateTypesMod.AggregateField[T]
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_ByteString")
  @js.native
  /* private */ open class ByteString ()
    extends typings.firebaseFirestore.distFirestoreSrcUtilByteStringMod.ByteString
  /* static members */
  object ByteString {
    ...
    @JSImport("@firebase/firestore/dist/firestore/src/api", "_ByteString.EMPTY_BYTE_STRING")
    @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "Bytes")
  @js.native
  open class Bytes protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiBytesMod.Bytes {
    /** @hideconstructor */
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "CACHE_SIZE_UNLIMITED")
  @js.native
  val CACHE_SIZE_UNLIMITED: /* -1 */ Double = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "CollectionReference")
  @js.native
  open class CollectionReference[T] protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiReferenceMod.CollectionReference[T] {
    def this(
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_DatabaseId")
  @js.native
  open class DatabaseId protected ()
    extends typings.firebaseFirestore.distFirestoreSrcCoreDatabaseInfoMod.DatabaseId {
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_DocumentKey")
  @js.native
  open class DocumentKey protected ()
    extends typings.firebaseFirestore.distFirestoreSrcModelDocumentKeyMod.DocumentKey {
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "DocumentReference")
  @js.native
  open class DocumentReference[T] protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiReferenceMod.DocumentReference[T] {
    def this(
      firestore: typings.firebaseFirestore.distFirestoreSrcLiteApiDatabaseMod.Firestore,
      /**
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "DocumentSnapshot")
  @js.native
  open class DocumentSnapshot[T] protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiSnapshotMod.DocumentSnapshot[T] {
    def this(
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_EmptyAppCheckTokenProvider")
  @js.native
  open class EmptyAppCheckTokenProvider ()
    extends typings.firebaseFirestore.distFirestoreSrcApiCredentialsMod.EmptyAppCheckTokenProvider
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_EmptyAuthCredentialsProvider")
  @js.native
  open class EmptyAuthCredentialsProvider ()
    extends typings.firebaseFirestore.distFirestoreSrcApiCredentialsMod.EmptyAuthCredentialsProvider
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "FieldPath")
  @js.native
  open class FieldPath protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiFieldPathMod.FieldPath {
    /**
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/api", "FieldValue")
  @js.native
  open class FieldValue protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiFieldValueMod.FieldValue {
    /**
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "FirestoreError")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "GeoPoint")
  @js.native
  open class GeoPoint protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiGeoPointMod.GeoPoint {
    /**
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "LoadBundleTask")
  @js.native
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.distFirestoreSrcApiBundleMod.LoadBundleTask
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/api", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typings.firebaseFirestore.distFirestoreSrcApiFilterMod.QueryConstraint
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "QuerySnapshot")
  @js.native
  open class QuerySnapshot[T] protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiSnapshotMod.QuerySnapshot[T] {
    /** @hideconstructor */
    def this(
      _firestore: typings.firebaseFirestore.distFirestoreSrcApiDatabaseMod.Firestore,
  ...
  open class Query_[T] protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiReferenceMod.Query[T] {
    def this(
      firestore: typings.firebaseFirestore.distFirestoreSrcLiteApiDatabaseMod.Firestore,
      /**
      * If provided, the `FirestoreDataConverter` associated with this instance.
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_ResourcePath")
  @js.native
  open class ResourcePath ()
    extends typings.firebaseFirestore.distFirestoreSrcModelPathMod.ResourcePath
  /* static members */
  object ResourcePath {
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "SnapshotMetadata")
  @js.native
  open class SnapshotMetadata protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiSnapshotMod.SnapshotMetadata {
    /** @hideconstructor */
    def this(hasPendingWrites: Boolean, fromCache: Boolean) = this()
  }
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "Timestamp")
  @js.native
  open class Timestamp protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiTimestampMod.Timestamp {
    /**
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "Transaction")
  @js.native
  open class Transaction protected ()
    extends typings.firebaseFirestore.distFirestoreSrcApiTransactionMod.Transaction {
    /** @hideconstructor */
    def this(
      _firestore: typings.firebaseFirestore.distFirestoreSrcApiDatabaseMod.Firestore,
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_FieldPath")
  @js.native
  open class _FieldPath ()
    extends typings.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath
  /* static members */
  object _FieldPath {
    ...
    /**
      ...
      * without escaping.
      */
    @JSImport("@firebase/firestore/dist/firestore/src/api", "_FieldPath.isValidIdentifier")
    @js.native
