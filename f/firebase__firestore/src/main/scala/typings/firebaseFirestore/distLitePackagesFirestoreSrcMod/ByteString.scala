...
@JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "_ByteString")
@js.native
...
object ByteString {
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "_ByteString.EMPTY_BYTE_STRING")
  @js.native
