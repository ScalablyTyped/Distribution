...
@JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "_FieldPath")
@js.native
...
object _FieldPath {
  ...
  /**
    ...
    * without escaping.
    */
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "_FieldPath.isValidIdentifier")
  @js.native
