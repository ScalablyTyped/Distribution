...
import typings.firebaseFirestore.srcLocalLocalStoreImplMod.LocalWriteResult
...
import typings.firebaseFirestore.srcModelCollectionsMod.DocumentKeyMap
...
import typings.firebaseFirestore.srcModelCollectionsMod.OverlayedDocumentMap
...
object srcLocalLocalDocumentsViewMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/local_documents_view", "LocalDocumentsView")
  @js.native
