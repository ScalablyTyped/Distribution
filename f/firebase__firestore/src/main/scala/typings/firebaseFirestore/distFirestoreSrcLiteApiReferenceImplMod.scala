...
import typings.firebaseFirestore.distFirestoreSrcLiteApiSnapshotMod.QuerySnapshot
...
object distFirestoreSrcLiteApiReferenceImplMod {
  ...
  inline def setDoc[T](
    ...
    options: typings.firebaseFirestore.distFirestoreSrcLiteApiReferenceMod.SetOptions
