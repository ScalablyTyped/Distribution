...
object distLitePackagesFirestoreTestIntegrationUtilTestingHooksUtilMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/integration/util/testing_hooks_util", JSImport.Namespace)
  @js.native
