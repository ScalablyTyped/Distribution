...
object utilTestPlatformMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/test_platform", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/test_platform", "FakeDocument")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/test_platform", "SharedFakeWebStorage")
  @js.native
