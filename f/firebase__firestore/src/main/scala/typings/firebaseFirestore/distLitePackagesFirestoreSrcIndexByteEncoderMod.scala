...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcDirectionalIndexByteEncoderMod.DirectionalIndexByteEncoder
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelFieldIndexMod.IndexKind
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLitePackagesFirestoreSrcIndexByteEncoderMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index_byte_encoder", "IndexByteEncoder")
  @js.native
