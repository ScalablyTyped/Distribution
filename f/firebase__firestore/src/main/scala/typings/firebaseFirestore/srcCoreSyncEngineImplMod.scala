...
import typings.firebaseFirestore.srcCoreEventManagerMod.EventManager
import typings.firebaseFirestore.srcCoreQueryMod.Query
import typings.firebaseFirestore.srcCoreSyncEngineMod.SyncEngine
import typings.firebaseFirestore.srcCoreTargetIdGeneratorMod.TargetIdGenerator
...
import typings.firebaseFirestore.srcCoreTypesMod.OnlineStateSource
...
import typings.firebaseFirestore.srcLocalLocalStoreMod.LocalStore
import typings.firebaseFirestore.srcLocalReferenceSetMod.ReferenceSet
import typings.firebaseFirestore.srcLocalSharedClientStateMod.ClientId
import typings.firebaseFirestore.srcLocalSharedClientStateMod.SharedClientState
...
import typings.firebaseFirestore.srcRemoteRemoteStoreMod.RemoteStore
...
object srcCoreSyncEngineImplMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/sync_engine_impl", JSImport.Namespace)
  @js.native
