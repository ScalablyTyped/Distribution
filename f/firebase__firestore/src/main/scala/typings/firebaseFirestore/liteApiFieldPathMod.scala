...
object liteApiFieldPathMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/field_path", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/field_path", "FieldPath")
  @js.native
