...
object Transaction2 {
  ...
  inline def apply(
    ...
    readVersions: Any,
    recordVersion: Any,
    set: (DocumentKey, ParsedSetData) => Unit,
    update: (DocumentKey, ParsedUpdateData) => Unit,
    write: Any,
    writtenDocs: Any
  ): Transaction2 = {
  ...
  extension [Self <: Transaction2](x: Self) {
    ...
    inline def setDelete(value: DocumentKey => Unit): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
    ...
    inline def setSet(value: (DocumentKey, ParsedSetData) => Unit): Self = StObject.set(x, "set", js.Any.fromFunction2(value))
    
    inline def setUpdate(value: (DocumentKey, ParsedUpdateData) => Unit): Self = StObject.set(x, "update", js.Any.fromFunction2(value))
