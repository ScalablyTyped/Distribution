...
trait Filter extends StObject {
  ...
  def getFirstInequalityField(): FieldPath2 | Null
...
object Filter {
  ...
  implicit open class MutableBuilder[Self <: Filter] (val x: Self) extends AnyVal {
    ...
    inline def setGetFirstInequalityField(value: () => FieldPath2 | Null): Self = StObject.set(x, "getFirstInequalityField", js.Any.fromFunction0(value))
