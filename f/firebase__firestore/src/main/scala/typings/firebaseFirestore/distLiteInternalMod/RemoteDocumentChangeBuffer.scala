...
object RemoteDocumentChangeBuffer {
  ...
  inline def apply(
    ...
    removeEntry: (DocumentKey, SnapshotVersion) => Unit
  ...
  implicit open class MutableBuilder[Self <: RemoteDocumentChangeBuffer] (val x: Self) extends AnyVal {
    ...
    inline def setRemoveEntry(value: (DocumentKey, SnapshotVersion) => Unit): Self = StObject.set(x, "removeEntry", js.Any.fromFunction2(value))
  }
}
