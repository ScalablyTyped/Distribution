...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalPersistenceTransactionMod.PersistenceTransactionMode
...
object distPackagesFirestoreSrcLocalPersistenceMod {
