...
object distPackagesFirestoreSrcPlatformNodeTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/node/text_serializer", JSImport.Namespace)
  @js.native
