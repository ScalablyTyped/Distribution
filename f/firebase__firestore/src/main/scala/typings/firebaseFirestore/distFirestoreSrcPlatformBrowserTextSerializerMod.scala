...
object distFirestoreSrcPlatformBrowserTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/platform/browser/text_serializer", JSImport.Namespace)
  @js.native
