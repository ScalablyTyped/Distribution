...
object modelMutationBatchMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/model/mutation_batch", "MutationBatch")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/model/mutation_batch", "MutationBatchResult")
  @js.native
