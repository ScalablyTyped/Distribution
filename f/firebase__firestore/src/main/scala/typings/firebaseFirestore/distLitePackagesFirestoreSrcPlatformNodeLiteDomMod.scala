...
object distLitePackagesFirestoreSrcPlatformNodeLiteDomMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/node_lite/dom", JSImport.Namespace)
  @js.native
