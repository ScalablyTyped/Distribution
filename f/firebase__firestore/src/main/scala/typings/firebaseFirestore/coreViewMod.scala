...
import typings.firebaseFirestore.coreViewSnapshotMod.DocumentChangeSet
import typings.firebaseFirestore.coreViewSnapshotMod.ViewSnapshot
import typings.firebaseFirestore.localLocalStoreImplMod.QueryResult
...
object coreViewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.coreViewMod.AddedLimboDocument
    - typings.firebaseFirestore.coreViewMod.RemovedLimboDocument
  */
