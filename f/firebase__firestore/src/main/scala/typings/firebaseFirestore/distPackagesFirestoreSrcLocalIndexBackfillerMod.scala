...
object distPackagesFirestoreSrcLocalIndexBackfillerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/index_backfiller", "IndexBackfiller")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/index_backfiller", "IndexBackfillerScheduler")
  @js.native
