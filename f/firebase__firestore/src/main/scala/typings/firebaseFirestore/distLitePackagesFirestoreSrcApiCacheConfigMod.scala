...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreComponentProviderMod.MemoryOfflineComponentProvider
...
object distLitePackagesFirestoreSrcApiCacheConfigMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/cache_config", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.MemoryLocalCache_
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.PersistentLocalCache_
  */
  ...
  object FirestoreLocalCache {
    ...
    inline def MemoryLocalCache_(
      ...
      __obj.asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.MemoryLocalCache_]
    }
    ...
    inline def PersistentLocalCache_(
      ...
      __obj.asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.PersistentLocalCache_]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.MemoryEagerGarbageCollector_
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.MemoryLruGarbageCollector_
  */
  trait MemoryGarbageCollector extends StObject
  object MemoryGarbageCollector {
    
    inline def MemoryEagerGarbageCollector_(_offlineComponentProvider: MemoryOfflineComponentProvider): typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.MemoryEagerGarbageCollector_ = {
      val __obj = js.Dynamic.literal(_offlineComponentProvider = _offlineComponentProvider.asInstanceOf[js.Any], kind = "memoryEager")
      __obj.asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.MemoryEagerGarbageCollector_]
    }
    
    inline def MemoryLruGarbageCollector_(_offlineComponentProvider: MemoryOfflineComponentProvider): typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.MemoryLruGarbageCollector_ = {
      val __obj = js.Dynamic.literal(_offlineComponentProvider = _offlineComponentProvider.asInstanceOf[js.Any], kind = "memoryLru")
      __obj.asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.MemoryLruGarbageCollector_]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.PersistentSingleTabManager_
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCacheConfigMod.PersistentMultipleTabManager_
  */
