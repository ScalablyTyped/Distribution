...
trait Filter extends StObject {
  ...
  def getFirstInequalityField(): (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _FieldPath */ Any) | Null
...
object Filter {
  ...
  implicit open class MutableBuilder[Self <: Filter] (val x: Self) extends AnyVal {
    ...
    inline def setGetFirstInequalityField(
      value: () => (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _FieldPath */ Any) | Null
