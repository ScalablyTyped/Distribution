...
object Transaction3 {
  ...
  inline def apply(
    ...
    committed: Any,
    datastore: Any,
    delete: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any => Unit,
    ...
    readVersions: Any,
    recordVersion: Any,
    set: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any, ParsedSetData) => Unit,
    update: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any, ParsedUpdateData) => Unit,
    write: Any,
    writtenDocs: Any
  ): Transaction3 = {
  ...
  extension [Self <: Transaction3](x: Self) {
    ...
    inline def setDelete(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any => Unit
    ...
    inline def setSet(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any, ParsedSetData) => Unit
    ): Self = StObject.set(x, "set", js.Any.fromFunction2(value))
    
    inline def setUpdate(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any, ParsedUpdateData) => Unit
