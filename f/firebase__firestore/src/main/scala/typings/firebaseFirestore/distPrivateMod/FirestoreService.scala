...
- Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _FirebaseService * / any */ trait FirestoreService extends StObject {
  ...
  var _databaseId: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DatabaseId */ Any
...
object FirestoreService {
  ...
  inline def apply(
    ...
    _databaseId: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DatabaseId */ Any,
