...
object ParsedUpdateData {
  ...
  inline def apply(
    ...
    toMutation: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any, Precondition) => Mutation
  ): ParsedUpdateData = {
  ...
  extension [Self <: ParsedUpdateData](x: Self) {
    ...
    inline def setToMutation(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any, Precondition) => Mutation
