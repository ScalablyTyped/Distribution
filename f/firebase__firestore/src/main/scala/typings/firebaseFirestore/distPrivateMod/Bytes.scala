...
@JSImport("@firebase/firestore/dist/private", "Bytes")
@js.native
open class Bytes protected () extends StObject {
  /** @hideconstructor */
  def this(byteString: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _ByteString */ Any) = this()
  
  var _byteString: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _ByteString */ Any = js.native
