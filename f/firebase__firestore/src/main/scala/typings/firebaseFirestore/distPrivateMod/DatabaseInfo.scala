...
trait DatabaseInfo extends StObject {
  ...
  val databaseId: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DatabaseId */ Any
...
object DatabaseInfo {
  ...
  implicit open class MutableBuilder[Self <: DatabaseInfo] (val x: Self) extends AnyVal {
    ...
    inline def setDatabaseId(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DatabaseId */ Any
