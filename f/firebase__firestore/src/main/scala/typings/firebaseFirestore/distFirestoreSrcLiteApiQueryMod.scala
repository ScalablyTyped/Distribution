...
import typings.firebaseFirestore.distFirestoreSrcCoreTargetMod.Direction
...
object distFirestoreSrcLiteApiQueryMod {
  ...
  inline def orderBy(fieldPath: typings.firebaseFirestore.distFirestoreSrcLiteApiFieldPathMod.FieldPath): QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryConstraint]
  inline def orderBy(
