...
object srcCoreEventManagerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/event_manager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/event_manager", "EventManagerImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/event_manager", "QueryListener")
  @js.native
