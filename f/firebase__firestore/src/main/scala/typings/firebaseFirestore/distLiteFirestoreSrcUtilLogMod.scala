...
object distLiteFirestoreSrcUtilLogMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/log", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/log", "LogLevel")
  @js.native
