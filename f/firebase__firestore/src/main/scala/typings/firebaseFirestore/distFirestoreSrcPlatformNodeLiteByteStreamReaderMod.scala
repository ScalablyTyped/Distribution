...
object distFirestoreSrcPlatformNodeLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/platform/node_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
