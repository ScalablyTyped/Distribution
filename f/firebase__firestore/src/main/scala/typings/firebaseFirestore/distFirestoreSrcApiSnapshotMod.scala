...
import typings.firebaseFirestore.distFirestoreSrcCoreViewSnapshotMod.ChangeType
...
object distFirestoreSrcApiSnapshotMod {
  ...
  */
  ...
  trait FirestoreDataConverter[T]
    extends StObject
       with typings.firebaseFirestore.distFirestoreSrcLiteApiSnapshotMod.FirestoreDataConverter[T] {
