...
object distLiteFirestoreTestIntegrationUtilTestingHooksUtilMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/integration/util/testing_hooks_util", JSImport.Namespace)
  @js.native
