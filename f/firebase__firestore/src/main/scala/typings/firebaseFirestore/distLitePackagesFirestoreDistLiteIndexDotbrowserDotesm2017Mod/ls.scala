...
/**
  ...
  */ trait ls extends StObject {
  ...
  def set(t: Any, e: Any, n: Any): ls
  
  def update(t: Any, e: Any, n: Any, r: Any*): ls
}
object ls {
  ...
  inline def apply(
    ...
    delete: Any => ls,
    set: (Any, Any, Any) => ls,
    update: (Any, Any, Any, /* repeated */ Any) => ls
  ): ls = {
    ...
    __obj.asInstanceOf[ls]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ls] (val x: Self) extends AnyVal {
    
    inline def setCommit(value: () => Any): Self = StObject.set(x, "commit", js.Any.fromFunction0(value))
    
    inline def setDelete(value: Any => ls): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
    
    inline def setSet(value: (Any, Any, Any) => ls): Self = StObject.set(x, "set", js.Any.fromFunction3(value))
    
    inline def setUpdate(value: (Any, Any, Any, /* repeated */ Any) => ls): Self = StObject.set(x, "update", js.Any.fromFunction4(value))
