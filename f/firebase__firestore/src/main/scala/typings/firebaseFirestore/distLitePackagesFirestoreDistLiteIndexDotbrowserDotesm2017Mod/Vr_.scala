...
object Vr_ {
  ...
  inline def apply(_apply: Any => Nn, _direction: Any, _field: Any, `type`: String): Vr_ = {
    ...
    __obj.asInstanceOf[Vr_]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Vr_] (val x: Self) extends AnyVal {
