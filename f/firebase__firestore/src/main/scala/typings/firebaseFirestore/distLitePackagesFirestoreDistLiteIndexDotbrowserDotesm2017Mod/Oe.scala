...
/**
  ...
  */
/** A field path and the TransformOperation to perform upon it. */ trait Oe extends StObject {
...
object Oe {
  ...
  inline def apply(field: Any, transform: Any): Oe = {
    val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], transform = transform.asInstanceOf[js.Any])
    __obj.asInstanceOf[Oe]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Oe] (val x: Self) extends AnyVal {
