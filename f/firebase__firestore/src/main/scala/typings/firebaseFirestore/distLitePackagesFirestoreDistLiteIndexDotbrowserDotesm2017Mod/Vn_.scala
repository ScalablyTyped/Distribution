...
object Vn_ {
  ...
  inline def apply(_byteString: Any, isEqual: Any => Any, toBase64: () => Any, toUint8Array: () => Any): Vn_ = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Vn_] (val x: Self) extends AnyVal {
