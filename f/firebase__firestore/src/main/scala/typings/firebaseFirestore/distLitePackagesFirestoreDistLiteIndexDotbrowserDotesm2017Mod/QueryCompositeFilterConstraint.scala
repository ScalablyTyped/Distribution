...
/**
  ...
  */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/dist/lite/index.browser.esm2017", "QueryCompositeFilterConstraint")
@js.native
...
object QueryCompositeFilterConstraint {
  ...
  /* static member */
  inline def create(t: Any, e: Any): Rr_ = (^.asInstanceOf[js.Dynamic].applyDynamic("_create")(t.asInstanceOf[js.Any], e.asInstanceOf[js.Any])).asInstanceOf[Rr_]
}
