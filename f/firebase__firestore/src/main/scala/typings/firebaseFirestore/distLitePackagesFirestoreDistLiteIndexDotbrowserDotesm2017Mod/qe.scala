...
/**
  ...
  */
/** A field path and the TransformOperation to perform upon it. */ trait qe extends StObject {
...
object qe {
  ...
  inline def apply(field: Any, transform: Any): qe = {
    val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], transform = transform.asInstanceOf[js.Any])
    __obj.asInstanceOf[qe]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: qe] (val x: Self) extends AnyVal {
