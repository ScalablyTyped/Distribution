...
object QueryEndAtConstraint {
  ...
  /* static member */
  inline def create(t: Any, e: Any, n: Any): Or_ = (^.asInstanceOf[js.Dynamic].applyDynamic("_create")(t.asInstanceOf[js.Any], e.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[Or_]
}
