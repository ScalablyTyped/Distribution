...
object Timestamp {
  ...
  /**
    ...
    *     date.
    */ /* static member */
  inline def fromDate(t: Any): xt = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDate")(t.asInstanceOf[js.Any]).asInstanceOf[xt]
  ...
  /**
    ...
    */ /* static member */
  inline def fromMillis(t: Any): xt = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMillis")(t.asInstanceOf[js.Any]).asInstanceOf[xt]
  ...
  /**
    ...
    */ /* static member */
  inline def now(): xt = ^.asInstanceOf[js.Dynamic].applyDynamic("now")().asInstanceOf[xt]
}
