...
/**
  ...
  */ trait fs extends StObject {
  ...
  def set(t: Any, e: Any, n: Any): fs
  
  def update(t: Any, e: Any, n: Any, r: Any*): fs
}
object fs {
  ...
  inline def apply(
    ...
    delete: Any => fs,
    set: (Any, Any, Any) => fs,
    update: (Any, Any, Any, /* repeated */ Any) => fs
  ): fs = {
  ...
  implicit open class MutableBuilder[Self <: fs] (val x: Self) extends AnyVal {
    ...
    inline def setDelete(value: Any => fs): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
    
    inline def setSet(value: (Any, Any, Any) => fs): Self = StObject.set(x, "set", js.Any.fromFunction3(value))
    
    inline def setUpdate(value: (Any, Any, Any, /* repeated */ Any) => fs): Self = StObject.set(x, "update", js.Any.fromFunction4(value))
