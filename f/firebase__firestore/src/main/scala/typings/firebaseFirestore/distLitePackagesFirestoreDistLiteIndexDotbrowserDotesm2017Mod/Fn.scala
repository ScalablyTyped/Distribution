...
/**
  ...
  */ trait Fn extends StObject {
  ...
  def withConverter(t: Any): Fn
}
object Fn {
  
  inline def apply(_query: Any, converter: Any, firestore: Any, `type`: String, withConverter: Any => Fn): Fn = {
  ...
  implicit open class MutableBuilder[Self <: Fn] (val x: Self) extends AnyVal {
    ...
    inline def setWithConverter(value: Any => Fn): Self = StObject.set(x, "withConverter", js.Any.fromFunction1(value))
