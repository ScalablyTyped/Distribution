...
import typings.firebaseFirestore.anon.`34`
...
import typings.firebaseFirestore.distLitePackagesFirestoreTestUnitSpecsSpecRpcErrorMod.RpcError
...
import typings.firebaseFirestore.distLitePackagesFirestoreTestUnitSpecsSpecTestRunnerMod.SpecQuery
...
object distLitePackagesFirestoreTestUnitSpecsSpecBuilderMod {
  ...
  open class SpecBuilder () extends StObject {
    ...
    def expectActiveTargets(targets: ReadTime*): this.type = js.native
