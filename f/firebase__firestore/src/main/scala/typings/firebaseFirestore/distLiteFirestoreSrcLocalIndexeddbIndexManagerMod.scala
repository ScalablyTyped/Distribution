...
object distLiteFirestoreSrcLocalIndexeddbIndexManagerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/indexeddb_index_manager", "IndexedDbIndexManager")
  @js.native
