...
import typings.firebaseFirestore.distLiteFirestoreSrcModelTypeOrderMod.TypeOrder
import typings.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreProtoApiMod.ArrayValue
import typings.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreProtoApiMod.Value
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLiteFirestoreSrcModelValuesMod {
  ...
  inline def isMapValue(): /* is @firebase/firestore.anon.18 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")().asInstanceOf[/* is @firebase/firestore.anon.18 */ Boolean]
  inline def isMapValue(value: Value): /* is @firebase/firestore.anon.18 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.18 */ Boolean]
