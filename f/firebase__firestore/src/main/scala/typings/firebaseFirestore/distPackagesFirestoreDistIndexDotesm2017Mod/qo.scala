...
object qo {
  ...
  implicit open class MutableBuilder[Self <: qo] (val x: Self) extends AnyVal {
    ...
    inline def setApplyChanges(value: Any => vt): Self = StObject.set(x, "applyChanges", js.Any.fromFunction1(value))
    ...
    inline def setRs(value: Any): Self = StObject.set(x, "rs", value.asInstanceOf[js.Any])
  }
}
