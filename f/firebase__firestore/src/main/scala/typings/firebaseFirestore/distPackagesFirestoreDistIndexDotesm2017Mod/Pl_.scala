...
object Pl_ {
  ...
  inline def apply(_apply: Any => dh, _field: Any, _op: Any, _parse: Any => mn | bn | Nn, _value: Any, `type`: String): Pl_ = {
    ...
    __obj.asInstanceOf[Pl_]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Pl_] (val x: Self) extends AnyVal {
