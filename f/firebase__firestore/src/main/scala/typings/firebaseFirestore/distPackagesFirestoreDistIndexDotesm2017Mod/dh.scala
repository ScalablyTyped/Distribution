...
/**
  ...
  */ trait dh extends StObject {
  ...
  def withConverter(t: Any): dh
}
object dh {
  
  inline def apply(_query: Any, converter: Any, firestore: Any, `type`: String, withConverter: Any => dh): dh = {
  ...
  implicit open class MutableBuilder[Self <: dh] (val x: Self) extends AnyVal {
    ...
    inline def setWithConverter(value: Any => dh): Self = StObject.set(x, "withConverter", js.Any.fromFunction1(value))
