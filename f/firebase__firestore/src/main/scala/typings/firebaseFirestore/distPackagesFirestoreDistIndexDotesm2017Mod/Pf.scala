...
object Pf {
  ...
  inline def apply(_offlineComponentProvider: Any, _onlineComponentProvider: Any, kind: String, toJSON: () => Kind): Pf = {
    ...
    __obj.asInstanceOf[Pf]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Pf] (val x: Self) extends AnyVal {
