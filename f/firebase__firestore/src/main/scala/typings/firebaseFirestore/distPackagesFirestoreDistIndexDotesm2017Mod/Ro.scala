...
/**
  ...
  */ trait Ro extends StObject {
  ...
  /**
    ...
    */ def ss(t: Any, e: Any): Any
  
  /**
    * Decodes `dbRemoteDoc` and returns the document (or an invalid document if
    * the document corresponds to the format used for sentinel deletes).
    */ def ts(t: Any, e: Any): Unit | an
...
object Ro {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(Zn = js.Any.fromFunction2(Zn), addEntry = js.Any.fromFunction3(addEntry), es = js.Any.fromFunction2(es), getAllFromCollectionGroup = js.Any.fromFunction4(getAllFromCollectionGroup), getDocumentsMatchingQuery = js.Any.fromFunction4(getDocumentsMatchingQuery), getEntries = js.Any.fromFunction2(getEntries), getEntry = js.Any.fromFunction2(getEntry), getMetadata = js.Any.fromFunction1(getMetadata), getSize = js.Any.fromFunction1(getSize), indexManager = indexManager.asInstanceOf[js.Any], newChangeBuffer = js.Any.fromFunction1(newChangeBuffer), ns = js.Any.fromFunction3(ns), removeEntry = js.Any.fromFunction3(removeEntry), serializer = serializer.asInstanceOf[js.Any], setIndexManager = js.Any.fromFunction1(setIndexManager), ss = js.Any.fromFunction2(ss), ts = js.Any.fromFunction2(ts), updateMetadata = js.Any.fromFunction2(updateMetadata))
  ...
  implicit open class MutableBuilder[Self <: Ro] (val x: Self) extends AnyVal {
    ...
    inline def setEs(value: (Any, Any) => Any): Self = StObject.set(x, "es", js.Any.fromFunction2(value))
    ...
    inline def setNs(value: (Any, Any, Any) => Any): Self = StObject.set(x, "ns", js.Any.fromFunction3(value))
    ...
    inline def setSs(value: (Any, Any) => Any): Self = StObject.set(x, "ss", js.Any.fromFunction2(value))
    
    inline def setTs(value: (Any, Any) => Unit | an): Self = StObject.set(x, "ts", js.Any.fromFunction2(value))
