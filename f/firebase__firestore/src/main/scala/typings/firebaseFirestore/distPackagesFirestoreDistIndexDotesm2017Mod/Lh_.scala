...
object Lh_ {
  ...
  inline def apply(_data: Any, _userDataWriter: Any, data: () => Any, query: Any, `type`: String): Lh_ = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Lh_] (val x: Self) extends AnyVal {
