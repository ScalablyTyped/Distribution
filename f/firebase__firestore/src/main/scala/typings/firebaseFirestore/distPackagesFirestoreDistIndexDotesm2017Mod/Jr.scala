...
trait Jr extends StObject {
  ...
  /** Creates the index entries for the given document. */ def An(t: Any, e: Any): Ee
  
  def En(t: Any, e: Any, n: Any): Any
  
  /** Returns the byte representation for the provided encoders. */ def In(t: Any): js.Array[Any]
  
  def Pn(t: Any, e: Any, n: Any, s: Any): Any
  ...
  /** Encodes a single value to the ascending index format. */ def dn(t: Any): js.typedarray.Uint8Array
  
  /**
    * Constructs a key range query on `DbIndexEntryStore` that unions all
    * bounds.
    */ def fn(t: Any, e: Any, n: Any, s: Any, i: Any, r: Any, o: Any): js.Array[IDBKeyRange]
  ...
  /**
    ...
    */ def gn(t: Any, e: Any): js.typedarray.Uint8Array
  ...
  /**
    ...
    */ def ln(t: Any, e: Any, n: Any): js.Array[Any]
  
  /**
    * Returns the byte encoded form of the directional values in the field index.
    * Returns `null` if the document does not have all fields specified in the
    * index.
    */ def mn(t: Any, e: Any): js.typedarray.Uint8Array | Null
  ...
  /**
    ...
    */ def pn(t: Any, e: Any, n: Any): js.Array[Nr]
  ...
  /**
    ...
    * entries.
    */ def vn(t: Any, e: Any, n: Any, s: Any, i: Any): Rt_
  
  /** Generates the lower bound for `arrayValue` and `directionalValue`. */ def wn(t: Any, e: Any, n: Any, s: Any): kr
  
  def yn(t: Any, e: Any): Boolean
}
object Jr {
  ...
  inline def apply(
    ...
    dn: Any => js.typedarray.Uint8Array,
    fn: (Any, Any, Any, Any, Any, Any, Any) => js.Array[IDBKeyRange],
    ...
    gn: (Any, Any) => js.typedarray.Uint8Array,
    hn: (Any, Any, Any) => js.Array[Any],
    ln: (Any, Any, Any) => js.Array[Any],
    mn: (Any, Any) => js.typedarray.Uint8Array | Null,
    on: Wr,
    pn: (Any, Any, Any) => js.Array[Nr],
    uid: Any,
    un: os,
    updateCollectionGroup: (Any, Any, Any) => Any,
    updateIndexEntries: (Any, Any) => Rt_,
    user: Any,
    vn: (Any, Any, Any, Any, Any) => Rt_,
    wn: (Any, Any, Any, Any) => kr,
    yn: (Any, Any) => Boolean
  ): Jr = {
    val __obj = js.Dynamic.literal(An = js.Any.fromFunction2(An), En = js.Any.fromFunction3(En), In = js.Any.fromFunction1(In), Pn = js.Any.fromFunction4(Pn), Rn = js.Any.fromFunction4(Rn), Tn = js.Any.fromFunction1(Tn), _n = js.Any.fromFunction4(_n), addFieldIndex = js.Any.fromFunction2(addFieldIndex), addToCollectionParentIndex = js.Any.fromFunction2(addToCollectionParentIndex), an = js.Any.fromFunction2(an), bn = js.Any.fromFunction2(bn), cn = js.Any.fromFunction1(cn), createRange = js.Any.fromFunction3(createRange), databaseId = databaseId.asInstanceOf[js.Any], deleteFieldIndex = js.Any.fromFunction2(deleteFieldIndex), dn = js.Any.fromFunction1(dn), fn = js.Any.fromFunction7(fn), getCollectionParents = js.Any.fromFunction2(getCollectionParents), getDocumentsMatchingTarget = js.Any.fromFunction2(getDocumentsMatchingTarget), getFieldIndexes = js.Any.fromFunction2(getFieldIndexes), getIndexType = js.Any.fromFunction2(getIndexType), getMinOffset = js.Any.fromFunction2(getMinOffset), getMinOffsetFromCollectionGroup = js.Any.fromFunction2(getMinOffsetFromCollectionGroup), getNextCollectionGroupToUpdate = js.Any.fromFunction1(getNextCollectionGroupToUpdate), gn = js.Any.fromFunction2(gn), hn = js.Any.fromFunction3(hn), ln = js.Any.fromFunction3(ln), mn = js.Any.fromFunction2(mn), on = on.asInstanceOf[js.Any], pn = js.Any.fromFunction3(pn), uid = uid.asInstanceOf[js.Any], un = un.asInstanceOf[js.Any], updateCollectionGroup = js.Any.fromFunction3(updateCollectionGroup), updateIndexEntries = js.Any.fromFunction2(updateIndexEntries), user = user.asInstanceOf[js.Any], vn = js.Any.fromFunction5(vn), wn = js.Any.fromFunction4(wn), yn = js.Any.fromFunction2(yn))
  ...
  implicit open class MutableBuilder[Self <: Jr] (val x: Self) extends AnyVal {
    ...
    inline def setAn(value: (Any, Any) => Ee): Self = StObject.set(x, "An", js.Any.fromFunction2(value))
    ...
    inline def setDn(value: Any => js.typedarray.Uint8Array): Self = StObject.set(x, "dn", js.Any.fromFunction1(value))
    
    inline def setEn(value: (Any, Any, Any) => Any): Self = StObject.set(x, "En", js.Any.fromFunction3(value))
    
    inline def setFn(value: (Any, Any, Any, Any, Any, Any, Any) => js.Array[IDBKeyRange]): Self = StObject.set(x, "fn", js.Any.fromFunction7(value))
    ...
    inline def setGn(value: (Any, Any) => js.typedarray.Uint8Array): Self = StObject.set(x, "gn", js.Any.fromFunction2(value))
    
    inline def setHn(value: (Any, Any, Any) => js.Array[Any]): Self = StObject.set(x, "hn", js.Any.fromFunction3(value))
    
    inline def setIn(value: Any => js.Array[Any]): Self = StObject.set(x, "In", js.Any.fromFunction1(value))
    
    inline def setLn(value: (Any, Any, Any) => js.Array[Any]): Self = StObject.set(x, "ln", js.Any.fromFunction3(value))
    
    inline def setMn(value: (Any, Any) => js.typedarray.Uint8Array | Null): Self = StObject.set(x, "mn", js.Any.fromFunction2(value))
    
    inline def setOn(value: Wr): Self = StObject.set(x, "on", value.asInstanceOf[js.Any])
    
    inline def setPn(value: (Any, Any, Any, Any) => Any): Self = StObject.set(x, "Pn", js.Any.fromFunction4(value))
    
    inline def setRn(value: (Any, Any, Any, Any) => Any): Self = StObject.set(x, "Rn", js.Any.fromFunction4(value))
    
    inline def setTn(value: Any => Any): Self = StObject.set(x, "Tn", js.Any.fromFunction1(value))
    
    inline def setUid(value: Any): Self = StObject.set(x, "uid", value.asInstanceOf[js.Any])
    
    inline def setUn(value: os): Self = StObject.set(x, "un", value.asInstanceOf[js.Any])
    ...
    inline def setVn(value: (Any, Any, Any, Any, Any) => Rt_): Self = StObject.set(x, "vn", js.Any.fromFunction5(value))
    
    inline def setWn(value: (Any, Any, Any, Any) => kr): Self = StObject.set(x, "wn", js.Any.fromFunction4(value))
    
    inline def setYn(value: (Any, Any) => Boolean): Self = StObject.set(x, "yn", js.Any.fromFunction2(value))
