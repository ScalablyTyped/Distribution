...
open class WriteBatch_ protected ()
  ...
  /**
    ...
    */ /* CompleteClass */
  override def delete(t: Any): Bf_ = js.native
  
  /* CompleteClass */
  override def set(t: Any, e: Any, n: Any): Bf_ = js.native
  
  /* CompleteClass */
  override def update(t: Any, e: Any, n: Any, s: Any*): Bf_ = js.native
}
