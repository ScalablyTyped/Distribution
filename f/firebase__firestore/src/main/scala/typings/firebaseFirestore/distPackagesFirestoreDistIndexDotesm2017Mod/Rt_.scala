...
/**
  ...
  */ trait Rt_ extends StObject {
  ...
  def wrapFailure(t: Any, e: Any): Rt_
  
  def wrapSuccess(t: Any, e: Any): Rt_
  
  def wrapUserFunction(t: Any): Rt_
}
object Rt_ {
  ...
  inline def apply(
    ...
    wrapFailure: (Any, Any) => Rt_,
    wrapSuccess: (Any, Any) => Rt_,
    wrapUserFunction: Any => Rt_
  ): Rt_ = {
    ...
    __obj.asInstanceOf[Rt_]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Rt_] (val x: Self) extends AnyVal {
    
    inline def setCallbackAttached(value: Boolean): Self = StObject.set(x, "callbackAttached", value.asInstanceOf[js.Any])
    
    inline def setCatch(value: Any => Rt_): Self = StObject.set(x, "catch", js.Any.fromFunction1(value))
    ...
    inline def setNext(value: (Any, Any) => Rt_): Self = StObject.set(x, "next", js.Any.fromFunction2(value))
    ...
    inline def setWrapFailure(value: (Any, Any) => Rt_): Self = StObject.set(x, "wrapFailure", js.Any.fromFunction2(value))
    
    inline def setWrapSuccess(value: (Any, Any) => Rt_): Self = StObject.set(x, "wrapSuccess", js.Any.fromFunction2(value))
    
    inline def setWrapUserFunction(value: Any => Rt_): Self = StObject.set(x, "wrapUserFunction", js.Any.fromFunction1(value))
  }
}
