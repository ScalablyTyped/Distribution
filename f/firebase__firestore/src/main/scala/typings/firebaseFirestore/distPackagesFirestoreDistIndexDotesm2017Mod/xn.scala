...
/**
  ...
  */
/** A field path and the TransformOperation to perform upon it. */ trait xn extends StObject {
...
object xn {
  ...
  inline def apply(field: Any, transform: Any): xn = {
    val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], transform = transform.asInstanceOf[js.Any])
    __obj.asInstanceOf[xn]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: xn] (val x: Self) extends AnyVal {
