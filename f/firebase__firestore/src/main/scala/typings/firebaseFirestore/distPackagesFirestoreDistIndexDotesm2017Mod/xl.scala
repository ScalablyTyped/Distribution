...
object xl {
  ...
  inline def apply(_apply: Any => fh, _limit: Any, _limitType: Any, `type`: Any): xl = {
    ...
    __obj.asInstanceOf[xl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: xl] (val x: Self) extends AnyVal {
