...
trait Ff extends StObject {
  ...
  def set(t: Any, e: Any, n: Any): Ff
  
  def update(t: Any, e: Any, n: Any, s: Any*): Ff
}
object Ff {
  ...
  inline def apply(
    ...
    delete: Any => Ff,
    set: (Any, Any, Any) => Ff,
    update: (Any, Any, Any, /* repeated */ Any) => Ff
  ): Ff = {
    ...
    __obj.asInstanceOf[Ff]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Ff] (val x: Self) extends AnyVal {
    
    inline def setCommit(value: () => Any): Self = StObject.set(x, "commit", js.Any.fromFunction0(value))
    
    inline def setDelete(value: Any => Ff): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
    
    inline def setSet(value: (Any, Any, Any) => Ff): Self = StObject.set(x, "set", js.Any.fromFunction3(value))
    
    inline def setUpdate(value: (Any, Any, Any, /* repeated */ Any) => Ff): Self = StObject.set(x, "update", js.Any.fromFunction4(value))
    ...
    inline def set_dataReader(value: Yh): Self = StObject.set(x, "_dataReader", value.asInstanceOf[js.Any])
