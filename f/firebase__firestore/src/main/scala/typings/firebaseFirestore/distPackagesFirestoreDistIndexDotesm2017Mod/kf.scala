...
trait kf extends StObject {
  
  /**
    * @internal
    */ def _initialize(t: Any): Unit
  
  var _offlineComponentProvider: js.UndefOr[va] = js.undefined
...
object kf {
  ...
  implicit open class MutableBuilder[Self <: kf] (val x: Self) extends AnyVal {
    ...
    inline def set_offlineComponentProvider(value: va): Self = StObject.set(x, "_offlineComponentProvider", value.asInstanceOf[js.Any])
