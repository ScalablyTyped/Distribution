...
trait Bf_ extends StObject {
  ...
  /**
    ...
    */ def delete(t: Any): Bf_
  
  def set(t: Any, e: Any, n: Any): Bf_
  
  def update(t: Any, e: Any, n: Any, s: Any*): Bf_
}
object Bf_ {
  ...
  inline def apply(
    ...
    delete: Any => Bf_,
    set: (Any, Any, Any) => Bf_,
    update: (Any, Any, Any, /* repeated */ Any) => Bf_
  ): Bf_ = {
    ...
    __obj.asInstanceOf[Bf_]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Bf_] (val x: Self) extends AnyVal {
    
    inline def setCommit(value: () => Any): Self = StObject.set(x, "commit", js.Any.fromFunction0(value))
    
    inline def setDelete(value: Any => Bf_): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
    
    inline def setSet(value: (Any, Any, Any) => Bf_): Self = StObject.set(x, "set", js.Any.fromFunction3(value))
    
    inline def setUpdate(value: (Any, Any, Any, /* repeated */ Any) => Bf_): Self = StObject.set(x, "update", js.Any.fromFunction4(value))
    ...
    inline def set_dataReader(value: Xh): Self = StObject.set(x, "_dataReader", value.asInstanceOf[js.Any])
