...
object Eh {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Eh] (val x: Self) extends AnyVal {
    ...
    inline def set_taskCompletionResolver(value: K): Self = StObject.set(x, "_taskCompletionResolver", value.asInstanceOf[js.Any])
