...
object firestoreSrcLiteApiQueryMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/query", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/query", "QueryConstraint")
  @js.native
  ...
  inline def newQueryBoundFromDocument(
    query: typings.firebaseFirestore.srcCoreQueryMod.Query,
  ...
  inline def newQueryOrderBy(query: typings.firebaseFirestore.srcCoreQueryMod.Query, fieldPath: FieldPath, direction: Direction): OrderBy = (^.asInstanceOf[js.Dynamic].applyDynamic("newQueryOrderBy")(query.asInstanceOf[js.Any], fieldPath.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[OrderBy]
  ...
  inline def orderBy(fieldPath: typings.firebaseFirestore.firestoreSrcLiteApiFieldPathMod.FieldPath): QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryConstraint]
  inline def orderBy(
  ...
  inline def validateHasExplicitOrderByForLimitToLast(query: typings.firebaseFirestore.srcCoreQueryMod.Query): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("validateHasExplicitOrderByForLimitToLast")(query.asInstanceOf[js.Any]).asInstanceOf[Unit]
