...
trait ProjectsDatabasesDocumentsBeginTransactionNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsBeginTransactionNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsBeginTransactionNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsBeginTransactionNamedParameters]
  }
  
  extension [Self <: ProjectsDatabasesDocumentsBeginTransactionNamedParameters](x: Self) {
