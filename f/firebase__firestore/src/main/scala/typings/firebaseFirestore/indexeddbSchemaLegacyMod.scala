...
import typings.firebaseFirestore.indexeddbSchemaMod.DbNoDocument
import typings.firebaseFirestore.indexeddbSchemaMod.DbUnknownDocument
import typings.firebaseFirestore.indexeddbSentinelsMod.DbTimestampKey
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object indexeddbSchemaLegacyMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/indexeddb_schema_legacy", "DbRemoteDocumentStore")
  @js.native
