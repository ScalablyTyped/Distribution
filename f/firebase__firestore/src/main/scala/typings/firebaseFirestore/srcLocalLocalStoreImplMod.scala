...
import typings.firebaseFirestore.firestoreSrcCoreBundleMod.BundleConverter
...
import typings.firebaseFirestore.srcLocalQueryEngineMod.QueryEngine
...
object srcLocalLocalStoreImplMod {
