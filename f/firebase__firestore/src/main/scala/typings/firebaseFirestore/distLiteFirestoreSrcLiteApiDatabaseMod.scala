...
import typings.firebaseFirestore.distLiteFirestoreSrcLiteApiComponentsMod.FirestoreService
import typings.firebaseFirestore.distLiteFirestoreSrcLiteApiSettingsMod.FirestoreSettings
import typings.firebaseFirestore.distLiteFirestoreSrcLiteApiSettingsMod.FirestoreSettingsImpl
