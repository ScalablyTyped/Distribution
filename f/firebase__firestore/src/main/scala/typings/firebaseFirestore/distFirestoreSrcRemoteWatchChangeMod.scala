...
import typings.firebaseFirestore.distFirestoreSrcRemoteExistenceFilterMod.ExistenceFilter
...
object distFirestoreSrcRemoteWatchChangeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distFirestoreSrcRemoteWatchChangeMod.DocumentWatchChange
    - typings.firebaseFirestore.distFirestoreSrcRemoteWatchChangeMod.WatchTargetChange
    - typings.firebaseFirestore.distFirestoreSrcRemoteWatchChangeMod.ExistenceFilterChange
  */
