...
import typings.firebaseFirestore.firestoreBundleProtoMod.BundleElement
...
object bundleReaderMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/util/bundle_reader", "SizedBundleElement")
  @js.native
