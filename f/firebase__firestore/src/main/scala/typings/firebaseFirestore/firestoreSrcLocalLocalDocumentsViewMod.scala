...
import typings.firebaseFirestore.firestoreSrcLocalLocalStoreImplMod.LocalWriteResult
...
import typings.firebaseFirestore.firestoreSrcModelCollectionsMod.DocumentKeyMap
...
import typings.firebaseFirestore.firestoreSrcModelCollectionsMod.OverlayedDocumentMap
...
object firestoreSrcLocalLocalDocumentsViewMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/local_documents_view", "LocalDocumentsView")
  @js.native
