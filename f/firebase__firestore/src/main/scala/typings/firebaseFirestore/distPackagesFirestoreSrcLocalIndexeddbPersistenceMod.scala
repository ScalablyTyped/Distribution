...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalIndexeddbLruDelegateImplMod.IndexedDbLruDelegateImpl
...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalPersistenceMod.PrimaryStateListener
