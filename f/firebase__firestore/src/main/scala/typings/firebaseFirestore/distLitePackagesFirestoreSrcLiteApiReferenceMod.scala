...
object distLitePackagesFirestoreSrcLiteApiReferenceMod {
  ...
  open class Query[T] protected () extends StObject {
    ...
    val _query: typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreQueryMod.Query = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.firebaseFirestore.anon.`29`
  */
  trait SetOptions extends StObject
  object SetOptions {
    
    inline def `29`(): typings.firebaseFirestore.anon.`29` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.firebaseFirestore.anon.`29`]
    }
