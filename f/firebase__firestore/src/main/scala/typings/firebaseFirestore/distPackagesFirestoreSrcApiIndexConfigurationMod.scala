...
object distPackagesFirestoreSrcApiIndexConfigurationMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api/index_configuration", JSImport.Namespace)
  @js.native
