...
@JSImport("@firebase/firestore/dist/lite/firestore/src/api", "_ByteString")
@js.native
/* private */ open class ByteString ()
  extends typings.firebaseFirestore.distLiteFirestoreSrcUtilByteStringMod.ByteString
/* static members */
object ByteString {
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api", "_ByteString.EMPTY_BYTE_STRING")
  @js.native
