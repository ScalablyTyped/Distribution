...
@JSImport("@firebase/firestore/dist/lite/firestore/src/api", "QueryStartAtConstraint")
@js.native
open class QueryStartAtConstraint protected ()
  extends typings.firebaseFirestore.distLiteFirestoreSrcApiFilterMod.QueryStartAtConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
