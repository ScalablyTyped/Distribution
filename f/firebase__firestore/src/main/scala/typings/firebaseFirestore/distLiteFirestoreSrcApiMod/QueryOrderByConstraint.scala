...
@JSImport("@firebase/firestore/dist/lite/firestore/src/api", "QueryOrderByConstraint")
@js.native
open class QueryOrderByConstraint protected ()
  extends typings.firebaseFirestore.distLiteFirestoreSrcApiFilterMod.QueryOrderByConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
