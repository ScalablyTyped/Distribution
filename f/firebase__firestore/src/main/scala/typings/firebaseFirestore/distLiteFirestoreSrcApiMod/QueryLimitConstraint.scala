...
@JSImport("@firebase/firestore/dist/lite/firestore/src/api", "QueryLimitConstraint")
@js.native
open class QueryLimitConstraint protected ()
  extends typings.firebaseFirestore.distLiteFirestoreSrcApiFilterMod.QueryLimitConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
