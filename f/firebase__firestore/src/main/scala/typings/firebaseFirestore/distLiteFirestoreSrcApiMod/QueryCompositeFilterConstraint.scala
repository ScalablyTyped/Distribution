...
@JSImport("@firebase/firestore/dist/lite/firestore/src/api", "QueryCompositeFilterConstraint")
@js.native
open class QueryCompositeFilterConstraint protected ()
  extends typings.firebaseFirestore.distLiteFirestoreSrcApiFilterMod.QueryCompositeFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
