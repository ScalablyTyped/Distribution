...
@JSImport("@firebase/firestore/dist/packages/firestore/test/integration/util/firebase_export", "QueryFieldFilterConstraint")
@js.native
open class QueryFieldFilterConstraint protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcMod.QueryFieldFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
