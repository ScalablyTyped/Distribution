...
@JSImport("@firebase/firestore/dist/packages/firestore/test/integration/util/firebase_export", "QueryCompositeFilterConstraint")
@js.native
open class QueryCompositeFilterConstraint protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcMod.QueryCompositeFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
