...
@JSImport("@firebase/firestore/dist/packages/firestore/test/integration/util/firebase_export", "QueryLimitConstraint")
@js.native
open class QueryLimitConstraint protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcMod.QueryLimitConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
