...
object distLiteFirestoreSrcPlatformBrowserTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/browser/text_serializer", JSImport.Namespace)
  @js.native
