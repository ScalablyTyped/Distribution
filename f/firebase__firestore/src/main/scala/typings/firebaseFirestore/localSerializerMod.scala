...
import typings.firebaseFirestore.firestoreBundleProtoMod.BundledQuery
import typings.firebaseFirestore.indexeddbSchemaMod.DbBundle
import typings.firebaseFirestore.indexeddbSchemaMod.DbDocumentOverlay
import typings.firebaseFirestore.indexeddbSchemaMod.DbIndexConfiguration
import typings.firebaseFirestore.indexeddbSchemaMod.DbIndexState
import typings.firebaseFirestore.indexeddbSchemaMod.DbMutationBatch
import typings.firebaseFirestore.indexeddbSchemaMod.DbNamedQuery
...
import typings.firebaseFirestore.indexeddbSchemaMod.DbTimestamp
import typings.firebaseFirestore.indexeddbSentinelsMod.DbDocumentOverlayKey
import typings.firebaseFirestore.indexeddbSentinelsMod.DbTimestampKey
...
object localSerializerMod {
  ...
  inline def fromBundleMetadata(metadata: BundleMetadata): typings.firebaseFirestore.coreBundleMod.BundleMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBundleMetadata")(metadata.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.coreBundleMod.BundleMetadata]
  ...
  inline def fromDbBundle(dbBundle: DbBundle): typings.firebaseFirestore.coreBundleMod.BundleMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDbBundle")(dbBundle.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.coreBundleMod.BundleMetadata]
  ...
  inline def fromProtoNamedQuery(namedQuery: typings.firebaseFirestore.firestoreBundleProtoMod.NamedQuery): NamedQuery = ^.asInstanceOf[js.Dynamic].applyDynamic("fromProtoNamedQuery")(namedQuery.asInstanceOf[js.Any]).asInstanceOf[NamedQuery]
  ...
  inline def toDbNamedQuery(query: typings.firebaseFirestore.firestoreBundleProtoMod.NamedQuery): DbNamedQuery = ^.asInstanceOf[js.Dynamic].applyDynamic("toDbNamedQuery")(query.asInstanceOf[js.Any]).asInstanceOf[DbNamedQuery]
