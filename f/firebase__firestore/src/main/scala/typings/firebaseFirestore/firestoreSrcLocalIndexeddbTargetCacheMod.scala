...
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbLruDelegateMod.IndexedDbLruDelegate
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSchemaMod.DbTargetDocument
import typings.firebaseFirestore.firestoreSrcLocalIndexeddbSentinelsMod.DbTargetDocumentKey
import typings.firebaseFirestore.firestoreSrcLocalLocalSerializerMod.LocalSerializer
import typings.firebaseFirestore.firestoreSrcLocalLruGarbageCollectorMod.ActiveTargets
...
object firestoreSrcLocalIndexeddbTargetCacheMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/indexeddb_target_cache", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/indexeddb_target_cache", "IndexedDbTargetCache")
  @js.native
