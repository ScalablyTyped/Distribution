...
object byteStringMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/util/byte_string", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/util/byte_string", "ByteString")
  @js.native
  ...
  object ByteString {
    ...
    @JSImport("@firebase/firestore/dist/firestore/src/util/byte_string", "ByteString.EMPTY_BYTE_STRING")
    @js.native
