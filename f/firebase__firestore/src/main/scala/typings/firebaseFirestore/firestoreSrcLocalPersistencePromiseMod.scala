...
object firestoreSrcLocalPersistencePromiseMod {
  ...
  object PersistencePromise {
    ...
    inline def waitFor(all: `35`): PersistencePromise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(all.asInstanceOf[js.Any]).asInstanceOf[PersistencePromise[Unit]]
  }
