...
object firestoreSrcLocalPersistenceTransactionMod {
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/persistence_transaction", "PersistenceTransaction")
  @js.native
