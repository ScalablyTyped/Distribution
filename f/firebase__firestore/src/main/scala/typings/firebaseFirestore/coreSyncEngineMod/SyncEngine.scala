...
import typings.firebaseFirestore.coreTypesMod.OnlineStateSource
...
import typings.firebaseFirestore.localSharedClientStateSyncerMod.SharedClientStateSyncer
