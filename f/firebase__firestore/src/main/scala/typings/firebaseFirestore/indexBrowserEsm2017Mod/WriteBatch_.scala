...
open class WriteBatch_ protected ()
  ...
  /**
    ...
    */ /* CompleteClass */
  override def delete(t: Any): Or_ = js.native
  
  /* CompleteClass */
  override def set(t: Any, e: Any, n: Any): Or_ = js.native
  
  /* CompleteClass */
  override def update(t: Any, e: Any, n: Any, r: Any*): Or_ = js.native
}
