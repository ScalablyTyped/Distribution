...
/**
  ...
  */ trait mn extends StObject {
  ...
  def withConverter(t: Any): mn
}
object mn {
  
  inline def apply(_query: Any, converter: Any, firestore: Any, `type`: String, withConverter: Any => mn): mn = {
  ...
  extension [Self <: mn](x: Self) {
    ...
    inline def setWithConverter(value: Any => mn): Self = StObject.set(x, "withConverter", js.Any.fromFunction1(value))
