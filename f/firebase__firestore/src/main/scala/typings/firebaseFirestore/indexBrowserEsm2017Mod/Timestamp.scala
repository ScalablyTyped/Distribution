...
object Timestamp {
  ...
  /**
    ...
    *     date.
    */ /* static member */
  inline def fromDate(t: Any): gt = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDate")(t.asInstanceOf[js.Any]).asInstanceOf[gt]
  ...
  /**
    ...
    */ /* static member */
  inline def fromMillis(t: Any): gt = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMillis")(t.asInstanceOf[js.Any]).asInstanceOf[gt]
  ...
  /**
    ...
    */ /* static member */
  inline def now(): gt = ^.asInstanceOf[js.Dynamic].applyDynamic("now")().asInstanceOf[gt]
}
