...
/**
  ...
  */ trait Or_ extends StObject {
  ...
  /**
    ...
    */ def delete(t: Any): Or_
  
  def set(t: Any, e: Any, n: Any): Or_
  
  def update(t: Any, e: Any, n: Any, r: Any*): Or_
}
object Or_ {
  ...
  inline def apply(
    ...
    delete: Any => Or_,
    set: (Any, Any, Any) => Or_,
    update: (Any, Any, Any, /* repeated */ Any) => Or_
  ): Or_ = {
  ...
  extension [Self <: Or_](x: Self) {
    
    inline def setCommit(value: () => Any): Self = StObject.set(x, "commit", js.Any.fromFunction0(value))
    
    inline def setDelete(value: Any => Or_): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
    
    inline def setSet(value: (Any, Any, Any) => Or_): Self = StObject.set(x, "set", js.Any.fromFunction3(value))
    
    inline def setUpdate(value: (Any, Any, Any, /* repeated */ Any) => Or_): Self = StObject.set(x, "update", js.Any.fromFunction4(value))
