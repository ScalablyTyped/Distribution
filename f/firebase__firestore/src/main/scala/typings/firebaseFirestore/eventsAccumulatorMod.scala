...
import typings.firebaseFirestore.firebaseExportMod.DocumentSnapshot
import typings.firebaseFirestore.firebaseExportMod.QuerySnapshot
import typings.firebaseFirestore.liteApiReferenceMod.DocumentData
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object eventsAccumulatorMod {
  
  @JSImport("@firebase/firestore/dist/firestore/test/integration/util/events_accumulator", "EventsAccumulator")
  @js.native
