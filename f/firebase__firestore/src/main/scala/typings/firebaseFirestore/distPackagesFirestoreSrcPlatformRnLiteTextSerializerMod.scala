...
object distPackagesFirestoreSrcPlatformRnLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/rn_lite/text_serializer", JSImport.Namespace)
  @js.native
