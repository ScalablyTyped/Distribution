...
import typings.firebaseFirestore.localIndexeddbSchemaMod.DbNoDocument
import typings.firebaseFirestore.localIndexeddbSchemaMod.DbUnknownDocument
...
object localIndexeddbSchemaLegacyMod {
