...
object distLitePackagesFirestoreSrcPlatformNodeLiteConnectionMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/node_lite/connection", JSImport.Namespace)
  @js.native
