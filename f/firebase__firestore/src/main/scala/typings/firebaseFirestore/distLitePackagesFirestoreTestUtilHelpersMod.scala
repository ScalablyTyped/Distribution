...
import typings.firebaseFirestore.anon.HashCount
import typings.firebaseFirestore.anon.KeyValue
import typings.firebaseFirestore.anon.Offset
import typings.firebaseFirestore.anon.`35`
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreBoundMod.Bound
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreFilterMod.CompositeFilter
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreFilterMod.FieldFilter
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreFilterMod.Filter
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreOrderByMod.OrderBy
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewMod.LimboDocumentChange
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewMod.View
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewMod.ViewChange
import typings.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiReferenceMod.DocumentData
import typings.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiUserDataReaderMod.UserDataReader
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcMod.Bytes
import typings.firebaseFirestore.distLitePackagesFirestoreSrcMod.DocumentReference
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelDocumentComparatorMod.DocumentComparator
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelMutationMod.DeleteMutation
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelMutationMod.MutationResult
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelMutationMod.PatchMutation
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelMutationMod.Precondition
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelMutationMod.SetMutation
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelObjectValueMod.JsonObject
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelObjectValueMod.ObjectValue
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreBundleProtoMod.LimitType
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreBundleProtoMod.NamedQuery
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.BloomFilter
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteRemoteEventMod.TargetChange
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilByteStringMod.ByteString
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilErrorMod.Code
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilObjMod.Dict
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilSortedMapMod.SortedMap
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilSortedSetMod.SortedSet
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLitePackagesFirestoreTestUtilHelpersMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/util/helpers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/util/helpers", "DocComparator")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/util/helpers", "TestBundledDocuments")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/util/helpers", "TestNamedQuery")
  @js.native
  ...
  inline def fieldIndex(collectionGroup: String, options: Offset): FieldIndex = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldIndex")(collectionGroup.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[FieldIndex]
  ...
  inline def generateBloomFilterProto(config: HashCount): BloomFilter = ^.asInstanceOf[js.Dynamic].applyDynamic("generateBloomFilterProto")(config.asInstanceOf[js.Any]).asInstanceOf[BloomFilter]
  ...
  inline def limboChanges(changes: `35`): js.Array[LimboDocumentChange] = ^.asInstanceOf[js.Dynamic].applyDynamic("limboChanges")(changes.asInstanceOf[js.Any]).asInstanceOf[js.Array[LimboDocumentChange]]
