...
object distFirestoreSrcLocalIndexeddbDocumentOverlayCacheMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/indexeddb_document_overlay_cache", "IndexedDbDocumentOverlayCache")
  @js.native
