...
import typings.firebaseFirestore.anon.ValueValue
...
import typings.firebaseFirestore.firestoreSrcModelTypeOrderMod.TypeOrder
import typings.firebaseFirestore.firestoreSrcProtosFirestoreProtoApiMod.ArrayValue
import typings.firebaseFirestore.firestoreSrcProtosFirestoreProtoApiMod.Value
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object firestoreSrcModelValuesMod {
  ...
  inline def isArray(): /* is @firebase/firestore.anon.37 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArray")().asInstanceOf[/* is @firebase/firestore.anon.37 */ Boolean]
  inline def isArray(value: Value): /* is @firebase/firestore.anon.37 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArray")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.37 */ Boolean]
  ...
  inline def isMapValue(): /* is @firebase/firestore.anon.36 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")().asInstanceOf[/* is @firebase/firestore.anon.36 */ Boolean]
  inline def isMapValue(value: Value): /* is @firebase/firestore.anon.36 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.36 */ Boolean]
