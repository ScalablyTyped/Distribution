...
object distFirestoreSrcPlatformRnLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/platform/rn_lite/text_serializer", JSImport.Namespace)
  @js.native
