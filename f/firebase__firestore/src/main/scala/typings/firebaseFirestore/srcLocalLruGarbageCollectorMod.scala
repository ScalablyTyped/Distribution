...
object srcLocalLruGarbageCollectorMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/lru_garbage_collector", "GC_DID_NOT_RUN")
  @js.native
  val GC_DID_NOT_RUN: LruResults = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/lru_garbage_collector", "LRU_COLLECTION_DISABLED")
  @js.native
  val LRU_COLLECTION_DISABLED: /* -1 */ Double = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/lru_garbage_collector", "LRU_DEFAULT_CACHE_SIZE_BYTES")
  @js.native
  val LRU_DEFAULT_CACHE_SIZE_BYTES: Double = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/lru_garbage_collector", "LruParams")
  @js.native
  ...
  object LruParams {
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/lru_garbage_collector", "LruParams.DEFAULT")
    @js.native
    val DEFAULT: LruParams = js.native
    
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/lru_garbage_collector", "LruParams.DEFAULT_COLLECTION_PERCENTILE")
    @js.native
    val DEFAULT_COLLECTION_PERCENTILE: Any = js.native
    
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/lru_garbage_collector", "LruParams.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT")
    @js.native
    val DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT: Any = js.native
    
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/lru_garbage_collector", "LruParams.DISABLED")
    @js.native
