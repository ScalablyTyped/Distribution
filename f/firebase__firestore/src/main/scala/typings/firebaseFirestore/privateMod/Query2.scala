...
trait Query2 extends StObject {
  ...
  val path: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResourcePath */ Any
...
object Query2 {
  ...
  inline def apply(
    ...
    limitType: LimitType,
    path: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResourcePath */ Any
  ): Query2 = {
  ...
  extension [Self <: Query2](x: Self) {
    ...
    inline def setPath(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResourcePath */ Any
