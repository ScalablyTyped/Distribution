...
import typings.firebaseFirestore.privateMod.^
...
type MapValue = typings.firebaseFirestore.privateMod.firestoreV1ApiClientInterfaces.MapValue
...
{[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/lite/private.PartialWithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/lite/private.FieldValue}
...
type Value = typings.firebaseFirestore.privateMod.firestoreV1ApiClientInterfaces.Value
...
{[ K in keyof T ]: @firebase/firestore.@firebase/firestore/dist/lite/private.WithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/lite/private.FieldValue}
