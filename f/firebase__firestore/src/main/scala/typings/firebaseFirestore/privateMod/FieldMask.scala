...
trait FieldMask extends StObject {
  ...
  /**
    ...
    */
  def covers(
    fieldPath: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any
  ): Boolean
...
object FieldMask {
  ...
  inline def apply(
    covers: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any => Boolean,
    fields: js.Array[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any
    ],
  ...
  extension [Self <: FieldMask](x: Self) {
    ...
    inline def setCovers(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any => Boolean
