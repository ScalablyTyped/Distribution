...
object distFirestoreSrcLiteApiReferenceMod {
  ...
  open class Query[T] protected () extends StObject {
    ...
    val _query: typings.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.firebaseFirestore.anon.MergeFields
  */
  ...
  object SetOptions {
    ...
    inline def MergeFields(): typings.firebaseFirestore.anon.MergeFields = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.firebaseFirestore.anon.MergeFields]
    }
  }
