...
object distLiteFirestoreSrcPlatformBrowserLiteRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/browser_lite/random_bytes", JSImport.Namespace)
  @js.native
