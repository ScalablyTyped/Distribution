...
import typings.firebaseFirestore.anon.InclusiveBoolean
...
import typings.firebaseFirestore.srcModelTypeOrderMod.TypeOrder
import typings.firebaseFirestore.srcProtosFirestoreProtoApiMod.ArrayValue
import typings.firebaseFirestore.srcProtosFirestoreProtoApiMod.Value
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcModelValuesMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/values", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/values", "MAX_VALUE")
  @js.native
  val MAX_VALUE: Value = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/values", "MIN_VALUE")
  @js.native
  ...
  inline def isArray(): /* is @firebase/firestore.anon.25 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArray")().asInstanceOf[/* is @firebase/firestore.anon.25 */ Boolean]
  inline def isArray(value: Value): /* is @firebase/firestore.anon.25 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArray")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.25 */ Boolean]
  ...
  inline def isMapValue(): /* is @firebase/firestore.anon.24 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")().asInstanceOf[/* is @firebase/firestore.anon.24 */ Boolean]
  inline def isMapValue(value: Value): /* is @firebase/firestore.anon.24 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.24 */ Boolean]
  ...
  inline def lowerBoundCompare(left: InclusiveBoolean, right: InclusiveBoolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("lowerBoundCompare")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def upperBoundCompare(left: InclusiveBoolean, right: InclusiveBoolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("upperBoundCompare")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Double]
