...
import typings.firebaseFirestore.internalMod.^
...
inline def collection(firestore: Firestore2, path: String, pathSegments: String*): CollectionReference[DocumentData] = (^.asInstanceOf[js.Dynamic].applyDynamic("collection")((List(firestore.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).`++`(pathSegments.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[CollectionReference[DocumentData]]
...
inline def doc(firestore: Firestore2, path: String, pathSegments: String*): DocumentReference[DocumentData] = (^.asInstanceOf[js.Dynamic].applyDynamic("doc")((List(firestore.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).`++`(pathSegments.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[DocumentReference[DocumentData]]
...
inline def onSnapshot[T](query: Query_[T], observer: `5`[T]): Unsubscribe = (^.asInstanceOf[js.Dynamic].applyDynamic("onSnapshot")(query.asInstanceOf[js.Any], observer.asInstanceOf[js.Any])).asInstanceOf[Unsubscribe]
...
inline def onSnapshot[T](query: Query_[T], options: SnapshotListenOptions, observer: `5`[T]): Unsubscribe = (^.asInstanceOf[js.Dynamic].applyDynamic("onSnapshot")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any], observer.asInstanceOf[js.Any])).asInstanceOf[Unsubscribe]
inline def onSnapshot[T](
  query: Query_[T],
...
inline def onSnapshot[T](reference: DocumentReference[T], observer: `4`[T]): Unsubscribe = (^.asInstanceOf[js.Dynamic].applyDynamic("onSnapshot")(reference.asInstanceOf[js.Any], observer.asInstanceOf[js.Any])).asInstanceOf[Unsubscribe]
...
inline def onSnapshot[T](reference: DocumentReference[T], options: SnapshotListenOptions, observer: `4`[T]): Unsubscribe = (^.asInstanceOf[js.Dynamic].applyDynamic("onSnapshot")(reference.asInstanceOf[js.Any], options.asInstanceOf[js.Any], observer.asInstanceOf[js.Any])).asInstanceOf[Unsubscribe]
inline def onSnapshot[T](
  reference: DocumentReference[T],
  options: SnapshotListenOptions,
  onNext: js.Function1[/* snapshot */ DocumentSnapshot[T], Unit]
...
inline def onSnapshotsInSync(firestore: Firestore, observer: `6`): Unsubscribe = (^.asInstanceOf[js.Dynamic].applyDynamic("onSnapshotsInSync")(firestore.asInstanceOf[js.Any], observer.asInstanceOf[js.Any])).asInstanceOf[Unsubscribe]
...
type MapValue = typings.firebaseFirestore.internalMod.firestoreV1ApiClientInterfaces.MapValue
...
{[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/internal.PartialWithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/internal.FieldValue}
...
type StructuredQuery = typings.firebaseFirestore.internalMod.firestoreV1ApiClientInterfaces.StructuredQuery
...
type Value = typings.firebaseFirestore.internalMod.firestoreV1ApiClientInterfaces.Value
...
{[ K in keyof T ]: @firebase/firestore.@firebase/firestore/dist/internal.WithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/internal.FieldValue}
