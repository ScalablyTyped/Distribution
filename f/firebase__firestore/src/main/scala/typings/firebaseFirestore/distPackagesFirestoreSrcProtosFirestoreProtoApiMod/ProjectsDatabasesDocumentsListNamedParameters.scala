...
trait ProjectsDatabasesDocumentsListNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsListNamedParameters {
  ...
  inline def apply(): ProjectsDatabasesDocumentsListNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsListNamedParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectsDatabasesDocumentsListNamedParameters] (val x: Self) extends AnyVal {
