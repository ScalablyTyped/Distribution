...
import typings.firebaseFirestore.remoteBackoffMod.ExponentialBackoff
...
import typings.firebaseFirestore.srcRemoteConnectionMod.Stream
...
object remotePersistentStreamMod {
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/persistent_stream", "PersistentStream")
  @js.native
  ...
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typings.firebaseFirestore.protosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typings.firebaseFirestore.protosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
