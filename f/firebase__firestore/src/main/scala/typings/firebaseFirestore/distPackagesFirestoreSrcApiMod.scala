...
object distPackagesFirestoreSrcApiMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "AbstractUserDataWriter")
  @js.native
  open class AbstractUserDataWriter ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiUserDataWriterMod.AbstractUserDataWriter
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "AggregateField")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "CACHE_SIZE_UNLIMITED")
  @js.native
  val CACHE_SIZE_UNLIMITED: /* -1 */ Double = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "CollectionReference")
  @js.native
  open class CollectionReference[T] protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiReferenceMod.CollectionReference[T] {
    def this(
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "_DocumentKey")
  @js.native
  open class DocumentKey protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcModelDocumentKeyMod.DocumentKey {
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "DocumentSnapshot")
  @js.native
  open class DocumentSnapshot[T] protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiSnapshotMod.DocumentSnapshot[T] {
    def this(
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "_EmptyAppCheckTokenProvider")
  @js.native
  open class EmptyAppCheckTokenProvider ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.EmptyAppCheckTokenProvider
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "_EmptyAuthCredentialsProvider")
  @js.native
  open class EmptyAuthCredentialsProvider ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.EmptyAuthCredentialsProvider
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "FieldPath")
  @js.native
  open class FieldPath protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiFieldPathMod.FieldPath {
    /**
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "FieldValue")
  @js.native
  open class FieldValue protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiFieldValueMod.FieldValue {
    /**
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "Firestore")
  @js.native
  open class Firestore protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiDatabaseMod.Firestore {
    /** @hideconstructor */
    def this(
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "LoadBundleTask")
  @js.native
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiBundleMod.LoadBundleTask
  ...
  open class Query_[T] protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiReferenceMod.Query[T] {
    def this(
      firestore: typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiDatabaseMod.Firestore,
      /**
      * If provided, the `FirestoreDataConverter` associated with this instance.
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "SnapshotMetadata")
  @js.native
  open class SnapshotMetadata protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiSnapshotMod.SnapshotMetadata {
    /** @hideconstructor */
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "Transaction")
  @js.native
  open class Transaction protected ()
    extends typings.firebaseFirestore.distPackagesFirestoreSrcApiTransactionMod.Transaction {
    /** @hideconstructor */
    def this(
      _firestore: typings.firebaseFirestore.distPackagesFirestoreSrcApiDatabaseMod.Firestore,
