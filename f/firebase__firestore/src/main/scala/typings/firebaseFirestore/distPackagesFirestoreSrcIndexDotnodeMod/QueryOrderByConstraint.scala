...
@JSImport("@firebase/firestore/dist/packages/firestore/src/index.node", "QueryOrderByConstraint")
@js.native
open class QueryOrderByConstraint protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcApiMod.QueryOrderByConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
