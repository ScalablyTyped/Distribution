...
import typings.firebaseFirestore.firestoreSrcMod.CollectionReference
import typings.firebaseFirestore.firestoreSrcMod.DocumentReference
import typings.firebaseFirestore.firestoreSrcMod.DocumentSnapshot
import typings.firebaseFirestore.firestoreSrcMod.Firestore
import typings.firebaseFirestore.firestoreSrcMod.QuerySnapshot
import typings.firebaseFirestore.firestoreSrcMod.Query_
import typings.firebaseFirestore.modelCollectionsMod.DocumentKeySet_
import typings.firebaseFirestore.modelObjectValueMod.JsonObject
import typings.firebaseFirestore.srcLiteApiReferenceMod.DocumentData
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object utilApiHelpersMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/api_helpers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/api_helpers", "FIRESTORE")
  @js.native
