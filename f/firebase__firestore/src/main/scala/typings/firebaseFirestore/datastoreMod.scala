...
object datastoreMod extends js.Object {
  ...
  def invokeCommitRpc(datastore: Datastore, mutations: js.Array[Mutation]): js.Promise[Unit] = js.native
  ...
  def terminateDatastore(datastore: Datastore): Unit = js.native
}
