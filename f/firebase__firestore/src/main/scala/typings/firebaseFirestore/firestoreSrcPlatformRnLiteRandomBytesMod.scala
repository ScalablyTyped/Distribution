...
object firestoreSrcPlatformRnLiteRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/rn_lite/random_bytes", JSImport.Namespace)
  @js.native
