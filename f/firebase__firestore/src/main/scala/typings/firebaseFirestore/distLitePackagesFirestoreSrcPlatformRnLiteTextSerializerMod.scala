...
object distLitePackagesFirestoreSrcPlatformRnLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn_lite/text_serializer", JSImport.Namespace)
  @js.native
