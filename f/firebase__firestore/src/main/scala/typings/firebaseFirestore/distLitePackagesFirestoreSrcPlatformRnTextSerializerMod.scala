...
object distLitePackagesFirestoreSrcPlatformRnTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn/text_serializer", JSImport.Namespace)
  @js.native
