...
import typings.firebaseFirestore.coreBundleMod.BundledDocuments
...
object localStoreImplMod {
  ...
  inline def localStoreSaveNamedQuery(localStore: LocalStore, query: typings.firebaseFirestore.firestoreBundleProtoMod.NamedQuery): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("localStoreSaveNamedQuery")(localStore.asInstanceOf[js.Any], query.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
