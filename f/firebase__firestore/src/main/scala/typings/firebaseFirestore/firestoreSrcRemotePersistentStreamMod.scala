...
import typings.firebaseFirestore.firestoreSrcProtosFirestoreProtoApiMod.ListenRequest
import typings.firebaseFirestore.firestoreSrcProtosFirestoreProtoApiMod.ListenResponse
import typings.firebaseFirestore.firestoreSrcProtosFirestoreProtoApiMod.WriteResponse
import typings.firebaseFirestore.firestoreSrcRemoteBackoffMod.ExponentialBackoff
...
import typings.firebaseFirestore.firestoreSrcUtilAsyncQueueMod.TimerId
...
import typings.firebaseFirestore.packagesFirestoreSrcRemoteConnectionMod.Stream
...
object firestoreSrcRemotePersistentStreamMod {
  ...
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typings.firebaseFirestore.firestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typings.firebaseFirestore.firestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
