...
import typings.firebaseFirestore.anon.ConfigSpecConfig
import typings.firebaseFirestore.anon.ExpectUserCallback
import typings.firebaseFirestore.anon.HasPendingWrites
import typings.firebaseFirestore.anon.QueryQuery
import typings.firebaseFirestore.anon.RunBackoffTimer
import typings.firebaseFirestore.anon.`49`
...
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreTargetIdGeneratorMod.TargetIdGenerator
...
import typings.firebaseFirestore.distPackagesFirestoreSrcModelObjectValueMod.JsonObject
import typings.firebaseFirestore.distPackagesFirestoreSrcUtilAsyncQueueMod.TimerId
import typings.firebaseFirestore.distPackagesFirestoreSrcUtilErrorMod.Code
import typings.firebaseFirestore.distPackagesFirestoreSrcUtilObjMapMod.ObjectMap
import typings.firebaseFirestore.distPackagesFirestoreTestUnitSpecsSpecRpcErrorMod.RpcError
...
import typings.firebaseFirestore.distPackagesFirestoreTestUnitSpecsSpecTestRunnerMod.SpecQuery
...
object distPackagesFirestoreTestUnitSpecsSpecBuilderMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/test/unit/specs/spec_builder", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/test/unit/specs/spec_builder", "SpecBuilder")
  @js.native
  open class SpecBuilder () extends StObject {
    ...
    def expectActiveTargets(targets: QueryQuery*): this.type = js.native
    ...
    def expectEvents(query: Query, events: HasPendingWrites): this.type = js.native
    ...
    def expectListen(query: Query, resume: `49`): this.type = js.native
    ...
    /**
      ...
      */
    def toJSON(): ConfigSpecConfig = js.native
    ...
    def userListens(query: Query, resume: `49`): this.type = js.native
    ...
    def watchSends(targets: `50`, docs: Document*): this.type = js.native
  ...
  object SpecBuilder {
    ...
    @JSImport("@firebase/firestore/dist/packages/firestore/test/unit/specs/spec_builder", "SpecBuilder.docToSpec")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/packages/firestore/test/unit/specs/spec_builder", "SpecBuilder.keyToSpec")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/packages/firestore/test/unit/specs/spec_builder", "SpecBuilder.queryToSpec")
    @js.native
