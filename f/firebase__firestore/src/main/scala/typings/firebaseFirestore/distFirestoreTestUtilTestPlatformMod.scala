...
object distFirestoreTestUtilTestPlatformMod {
  
  @JSImport("@firebase/firestore/dist/firestore/test/util/test_platform", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/util/test_platform", "FakeDocument")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/test/util/test_platform", "FakeWindow")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/test/util/test_platform", "SharedFakeWebStorage")
  @js.native
