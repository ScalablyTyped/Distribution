...
object distPackagesFirestoreSrcApiDatabaseMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api/database", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api/database", "CACHE_SIZE_UNLIMITED")
  @js.native
