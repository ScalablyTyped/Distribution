...
object distLitePackagesFirestoreSrcLocalPersistencePromiseMod {
  ...
  object PersistencePromise {
    ...
    inline def waitFor(all: `31`): PersistencePromise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(all.asInstanceOf[js.Any]).asInstanceOf[PersistencePromise[Unit]]
  }
