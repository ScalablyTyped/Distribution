...
import typings.firebaseFirestore.srcCoreViewSnapshotMod.ChangeType
...
object srcApiSnapshotMod {
  ...
  */
  ...
  trait FirestoreDataConverter[T]
    extends StObject
       with typings.firebaseFirestore.firestoreSrcLiteApiSnapshotMod.FirestoreDataConverter[T] {
