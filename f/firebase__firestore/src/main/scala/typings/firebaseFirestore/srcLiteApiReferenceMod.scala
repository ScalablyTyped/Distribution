...
import typings.firebaseFirestore.srcLiteApiTypesMod.NestedUpdateFields
import typings.std.Partial
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcLiteApiReferenceMod {
  ...
  open class Query[T] protected () extends StObject {
    ...
    val _query: typings.firebaseFirestore.coreQueryMod.Query = js.native
  ...
  {[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/lite/firestore/src/lite-api/reference.PartialWithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/lite/firestore/src/lite-api/field_value.FieldValue}
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.firebaseFirestore.anon.`11`
  */
  trait SetOptions extends StObject
  object SetOptions {
    
    inline def `11`(): typings.firebaseFirestore.anon.`11` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.firebaseFirestore.anon.`11`]
    }
  ...
  {[ K in keyof T ]: @firebase/firestore.@firebase/firestore/dist/lite/firestore/src/lite-api/reference.WithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/lite/firestore/src/lite-api/field_value.FieldValue}
