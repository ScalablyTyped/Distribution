...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteRemoteSyncerMod.RemoteSyncer
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilAsyncQueueMod.AsyncQueue
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLitePackagesFirestoreSrcRemoteRemoteStoreMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/remote/remote_store", JSImport.Namespace)
  @js.native
