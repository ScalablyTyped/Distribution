...
object distFirestoreSrcApiAggregateMod {
  ...
  inline def getCountFromServer(query: Query_[Any]): js.Promise[AggregateQuerySnapshot[`0`]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getCountFromServer")(query.asInstanceOf[js.Any]).asInstanceOf[js.Promise[AggregateQuerySnapshot[`0`]]]
