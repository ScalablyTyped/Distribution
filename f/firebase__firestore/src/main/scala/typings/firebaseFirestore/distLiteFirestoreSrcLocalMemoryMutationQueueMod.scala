...
object distLiteFirestoreSrcLocalMemoryMutationQueueMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/memory_mutation_queue", "MemoryMutationQueue")
  @js.native
