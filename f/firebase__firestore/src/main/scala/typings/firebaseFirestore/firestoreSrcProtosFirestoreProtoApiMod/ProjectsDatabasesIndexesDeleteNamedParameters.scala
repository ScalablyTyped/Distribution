...
trait ProjectsDatabasesIndexesDeleteNamedParameters extends StObject {
...
object ProjectsDatabasesIndexesDeleteNamedParameters {
  
  inline def apply(): ProjectsDatabasesIndexesDeleteNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesIndexesDeleteNamedParameters]
  }
  
  extension [Self <: ProjectsDatabasesIndexesDeleteNamedParameters](x: Self) {
