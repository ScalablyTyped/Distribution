...
object distLitePackagesFirestoreSrcLocalIndexeddbMutationQueueMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/indexeddb_mutation_queue", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/indexeddb_mutation_queue", "IndexedDbMutationQueue")
  @js.native
