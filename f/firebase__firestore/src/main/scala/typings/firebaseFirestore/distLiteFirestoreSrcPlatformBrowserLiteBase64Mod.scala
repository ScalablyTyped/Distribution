...
object distLiteFirestoreSrcPlatformBrowserLiteBase64Mod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/browser_lite/base64", JSImport.Namespace)
  @js.native
