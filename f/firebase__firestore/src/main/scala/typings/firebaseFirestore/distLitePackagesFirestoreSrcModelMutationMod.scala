...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcModelTransformOperationMod.TransformOperation
...
object distLitePackagesFirestoreSrcModelMutationMod {
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/mutation", "Mutation")
  @js.native
  open class Mutation () extends StObject {
