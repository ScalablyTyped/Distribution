...
object distLiteFirestoreSrcIndexDotnodeMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "AbstractUserDataWriter")
  @js.native
  open class AbstractUserDataWriter ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.AbstractUserDataWriter
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.AggregateField[T]
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "AggregateQuerySnapshot")
  @js.native
  open class AggregateQuerySnapshot[T /* <: AggregateSpec */] protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.AggregateQuerySnapshot[T] {
    /** @hideconstructor */
    def this(query: Query[Any], _data: AggregateSpecData[T]) = this()
  }
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "_ByteString")
  @js.native
  ...
  object ByteString {
    ...
    @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "_ByteString.EMPTY_BYTE_STRING")
    @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "Bytes")
  @js.native
  open class Bytes protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.Bytes {
    /** @hideconstructor */
    def this(byteString: typings.firebaseFirestore.distLiteFirestoreSrcUtilByteStringMod.ByteString) = this()
  }
  /* static members */
  object Bytes {
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "CACHE_SIZE_UNLIMITED")
  @js.native
  val CACHE_SIZE_UNLIMITED: /* -1 */ Double = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "CollectionReference")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "_DocumentKey")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "DocumentReference")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "DocumentSnapshot")
  @js.native
  open class DocumentSnapshot[T] protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.DocumentSnapshot[T] {
    def this(
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "_EmptyAppCheckTokenProvider")
  @js.native
  open class EmptyAppCheckTokenProvider ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.EmptyAppCheckTokenProvider
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "_EmptyAuthCredentialsProvider")
  @js.native
  open class EmptyAuthCredentialsProvider ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.EmptyAuthCredentialsProvider
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "FieldPath")
  @js.native
  open class FieldPath protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.FieldPath {
    /**
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "FieldValue")
  @js.native
  open class FieldValue protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.FieldValue {
    /**
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "Firestore")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "GeoPoint")
  @js.native
  open class GeoPoint protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.GeoPoint {
    /**
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "LoadBundleTask")
  @js.native
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.LoadBundleTask
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.QueryConstraint
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "QuerySnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "_ResourcePath")
  @js.native
  open class ResourcePath ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.ResourcePath
  /* static members */
  object ResourcePath {
    ...
    inline def emptyPath(): typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.ResourcePath = ^.asInstanceOf[js.Dynamic].applyDynamic("emptyPath")().asInstanceOf[typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.ResourcePath]
    ...
    /**
      ...
      */
    inline def fromString(pathComponents: String*): typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.ResourcePath = ^.asInstanceOf[js.Dynamic].applyDynamic("fromString")(pathComponents.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.ResourcePath]
  }
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "SnapshotMetadata")
  @js.native
  open class SnapshotMetadata protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.SnapshotMetadata {
    /** @hideconstructor */
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "Transaction")
  @js.native
  open class Transaction protected ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod.Transaction {
    /** @hideconstructor */
    def this(
      _firestore: typings.firebaseFirestore.distLiteFirestoreSrcApiDatabaseMod.Firestore,
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "WriteBatch")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "_FieldPath")
  @js.native
  open class _FieldPath ()
    extends typings.firebaseFirestore.distLiteFirestoreSrcApiMod._FieldPath
  /* static members */
  object _FieldPath {
    ...
    inline def emptyPath(): typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.FieldPath = ^.asInstanceOf[js.Dynamic].applyDynamic("emptyPath")().asInstanceOf[typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.FieldPath]
    ...
    /**
      ...
      */
    inline def fromServerFormat(path: String): typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.FieldPath = ^.asInstanceOf[js.Dynamic].applyDynamic("fromServerFormat")(path.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.FieldPath]
    
    /**
      * Returns true if the string could be used as a segment in a field path
      * without escaping.
      */
    @JSImport("@firebase/firestore/dist/lite/firestore/src/index.node", "_FieldPath.isValidIdentifier")
    @js.native
    ...
    /**
      ...
      */
    inline def keyField(): typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.FieldPath = ^.asInstanceOf[js.Dynamic].applyDynamic("keyField")().asInstanceOf[typings.firebaseFirestore.distLiteFirestoreSrcModelPathMod.FieldPath]
  }
  ...
  inline def getCountFromServer(query: typings.firebaseFirestore.distLiteFirestoreSrcApiMod.Query_[Any]): js.Promise[
  ...
  inline def onSnapshotsInSync(firestore: typings.firebaseFirestore.distLiteFirestoreSrcApiDatabaseMod.Firestore, observer: `14`): Unsubscribe = (^.asInstanceOf[js.Dynamic].applyDynamic("onSnapshotsInSync")(firestore.asInstanceOf[js.Any], observer.asInstanceOf[js.Any])).asInstanceOf[Unsubscribe]
