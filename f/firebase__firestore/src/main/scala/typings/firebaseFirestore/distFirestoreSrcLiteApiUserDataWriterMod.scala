...
object distFirestoreSrcLiteApiUserDataWriterMod {
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_writer", "AbstractUserDataWriter")
  @js.native
