...
object srcLocalIndexBackfillerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/index_backfiller", "IndexBackfiller")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/index_backfiller", "IndexBackfillerScheduler")
  @js.native
