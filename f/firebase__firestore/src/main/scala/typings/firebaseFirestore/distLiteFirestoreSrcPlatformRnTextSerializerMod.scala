...
object distLiteFirestoreSrcPlatformRnTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/rn/text_serializer", JSImport.Namespace)
  @js.native
