...
import typings.firebaseFirestore.distLitePackagesFirestoreTestUnitSpecsSpecBuilderMod.SpecBuilder
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLitePackagesFirestoreTestUnitSpecsDescribeSpecMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/unit/specs/describe_spec", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/unit/specs/describe_spec", "MULTI_CLIENT_TAG")
  @js.native
