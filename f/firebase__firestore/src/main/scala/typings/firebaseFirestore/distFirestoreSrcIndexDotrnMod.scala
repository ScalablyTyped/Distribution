...
object distFirestoreSrcIndexDotrnMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/index.rn", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/index.rn", "AbstractUserDataWriter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/index.rn", "AggregateQuerySnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/index.rn", "FieldValue")
  @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/index.rn", "QueryConstraint")
  @js.native
