...
object distLiteFirestoreSrcLiteApiQueryMod {
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", "AppliableConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", "QueryCompositeFilterConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", "QueryEndAtConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", "QueryFieldFilterConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", "QueryLimitConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", "QueryOrderByConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", "QueryStartAtConstraint")
  @js.native
  ...
  inline def orderBy(fieldPath: typings.firebaseFirestore.distLiteFirestoreSrcLiteApiFieldPathMod.FieldPath): QueryOrderByConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryOrderByConstraint]
  inline def orderBy(
  ...
  inline def validateHasExplicitOrderByForLimitToLast(query: typings.firebaseFirestore.distLiteFirestoreSrcCoreQueryMod.Query): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("validateHasExplicitOrderByForLimitToLast")(query.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distLiteFirestoreSrcLiteApiQueryMod.QueryFieldFilterConstraint
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distLiteFirestoreSrcLiteApiQueryMod.QueryOrderByConstraint
    - typings.firebaseFirestore.distLiteFirestoreSrcLiteApiQueryMod.QueryLimitConstraint
    - typings.firebaseFirestore.distLiteFirestoreSrcLiteApiQueryMod.QueryStartAtConstraint
