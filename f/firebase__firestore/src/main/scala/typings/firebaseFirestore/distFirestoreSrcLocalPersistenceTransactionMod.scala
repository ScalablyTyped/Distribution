...
object distFirestoreSrcLocalPersistenceTransactionMod {
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/local/persistence_transaction", "PersistenceTransaction")
  @js.native
