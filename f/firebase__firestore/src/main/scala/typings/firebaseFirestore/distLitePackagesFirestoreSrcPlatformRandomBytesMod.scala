...
object distLitePackagesFirestoreSrcPlatformRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/random_bytes", JSImport.Namespace)
  @js.native
