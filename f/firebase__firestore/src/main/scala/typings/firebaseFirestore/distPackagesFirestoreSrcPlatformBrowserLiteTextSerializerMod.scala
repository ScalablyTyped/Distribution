...
object distPackagesFirestoreSrcPlatformBrowserLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/browser_lite/text_serializer", JSImport.Namespace)
  @js.native
