...
object firestoreSrcCoreTransactionOptionsMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/transaction_options", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/transaction_options", "DEFAULT_TRANSACTION_OPTIONS")
  @js.native
