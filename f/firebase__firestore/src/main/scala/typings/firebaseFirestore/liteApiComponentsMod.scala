...
import typings.firebaseFirestore.srcLiteApiSettingsMod.FirestoreSettingsImpl
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object liteApiComponentsMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/components", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/components", "LOG_TAG")
  @js.native
