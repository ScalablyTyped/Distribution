...
import typings.firebaseFirestore.indexDotnodeMod.firebaseAppTypesAugmentingMod.FirebaseApp
...
@js.native
trait AnonAppBlobCollectionReferenceDocumentReference extends js.Object {
