...
object distFirestoreSrcRemoteRemoteEventMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/remote/remote_event", "RemoteEvent")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/remote/remote_event", "TargetChange")
  @js.native
