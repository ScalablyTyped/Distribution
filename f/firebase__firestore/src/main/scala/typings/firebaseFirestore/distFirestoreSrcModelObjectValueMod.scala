...
object distFirestoreSrcModelObjectValueMod {
  ...
  inline def extractFieldMask(value: typings.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.MapValue): FieldMask = ^.asInstanceOf[js.Dynamic].applyDynamic("extractFieldMask")(value.asInstanceOf[js.Any]).asInstanceOf[FieldMask]
