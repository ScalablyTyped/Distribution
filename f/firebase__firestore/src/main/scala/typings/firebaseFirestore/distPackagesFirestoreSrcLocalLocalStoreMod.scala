...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalLruGarbageCollectorMod.LruResults
import typings.firebaseFirestore.distPackagesFirestoreSrcUtilErrorMod.FirestoreError
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distPackagesFirestoreSrcLocalLocalStoreMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/local_store", JSImport.Namespace)
  @js.native
