...
object distFirestoreSrcCoreViewSnapshotMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/core/view_snapshot", "DocumentChangeSet")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/core/view_snapshot", "ViewSnapshot")
  @js.native
