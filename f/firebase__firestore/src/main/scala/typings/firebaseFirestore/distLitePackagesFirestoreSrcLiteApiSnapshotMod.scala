...
object distLitePackagesFirestoreSrcLiteApiSnapshotMod {
  ...
  inline def fieldPathFromArgument(methodName: String, arg: String): typings.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: FieldPath): typings.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: Compat[FieldPath]): typings.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath]
