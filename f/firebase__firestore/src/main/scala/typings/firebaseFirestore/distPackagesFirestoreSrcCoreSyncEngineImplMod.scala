...
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreTypesMod.OnlineStateSource
...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalReferenceSetMod.ReferenceSet
