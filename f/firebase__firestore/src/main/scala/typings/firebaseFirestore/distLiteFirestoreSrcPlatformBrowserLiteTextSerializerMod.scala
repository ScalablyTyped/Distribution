...
object distLiteFirestoreSrcPlatformBrowserLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/browser_lite/text_serializer", JSImport.Namespace)
  @js.native
