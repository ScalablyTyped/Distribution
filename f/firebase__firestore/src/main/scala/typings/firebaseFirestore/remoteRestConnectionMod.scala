...
import typings.firebaseFirestore.apiCredentialsMod.Token
...
object remoteRestConnectionMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/rest_connection", "RestConnection")
  @js.native
