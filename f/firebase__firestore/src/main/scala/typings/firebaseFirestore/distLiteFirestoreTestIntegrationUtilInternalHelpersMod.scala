...
import typings.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.EmptyAuthCredentialsProvider
...
import typings.firebaseFirestore.distLiteFirestoreSrcUtilAsyncQueueImplMod.AsyncQueueImpl
import typings.firebaseFirestore.distLiteFirestoreTestIntegrationUtilFirebaseExportMod.Firestore
