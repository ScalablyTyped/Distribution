...
object distFirestoreSrcLiteApiUserDataReaderMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", "ArrayRemoveFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", "ArrayUnionFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", "DeleteFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", "NumericIncrementFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", "ParsedSetData")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", "ParsedUpdateData")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", "ServerTimestampFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/user_data_reader", "UserDataReader")
  @js.native
  ...
  trait ParseContextImpl
    ...
    def contextWith(configuration: PartialContextSettings): ParseContextImpl = js.native
