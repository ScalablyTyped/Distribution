...
object distLitePackagesFirestoreSrcLocalReferenceSetMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/reference_set", "DocReference")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/reference_set", "ReferenceSet")
  @js.native
