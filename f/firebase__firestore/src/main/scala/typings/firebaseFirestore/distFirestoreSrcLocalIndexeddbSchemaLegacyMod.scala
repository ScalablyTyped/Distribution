...
import typings.firebaseFirestore.distFirestoreSrcLocalIndexeddbSchemaMod.DbNoDocument
import typings.firebaseFirestore.distFirestoreSrcLocalIndexeddbSchemaMod.DbUnknownDocument
...
object distFirestoreSrcLocalIndexeddbSchemaLegacyMod {
