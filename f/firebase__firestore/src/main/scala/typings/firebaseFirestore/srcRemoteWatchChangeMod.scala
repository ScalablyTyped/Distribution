...
import typings.firebaseFirestore.srcRemoteExistenceFilterMod.ExistenceFilter
...
object srcRemoteWatchChangeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.srcRemoteWatchChangeMod.DocumentWatchChange
    - typings.firebaseFirestore.srcRemoteWatchChangeMod.WatchTargetChange
    - typings.firebaseFirestore.srcRemoteWatchChangeMod.ExistenceFilterChange
  */
