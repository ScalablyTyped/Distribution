...
object distLitePackagesFirestoreSrcLocalMemoryPersistenceMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/memory_persistence", "MemoryEagerDelegate")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/memory_persistence", "MemoryTransaction")
  @js.native
