...
object distLitePackagesFirestoreSrcPlatformRnLiteRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn_lite/random_bytes", JSImport.Namespace)
  @js.native
