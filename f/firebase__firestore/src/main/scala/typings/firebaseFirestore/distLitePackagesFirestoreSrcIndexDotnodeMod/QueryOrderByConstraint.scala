...
@JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.node", "QueryOrderByConstraint")
@js.native
open class QueryOrderByConstraint protected ()
  extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.QueryOrderByConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
