...
@JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.node", "_ByteString")
@js.native
...
object ByteString {
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.node", "_ByteString.EMPTY_BYTE_STRING")
  @js.native
