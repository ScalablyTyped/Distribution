...
object distLiteFirestoreSrcCoreDatabaseInfoMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/database_info", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/database_info", "DEFAULT_DATABASE_NAME")
  @js.native
  val DEFAULT_DATABASE_NAME: /* "(default)" */ String = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/database_info", "DatabaseId")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/database_info", "DatabaseInfo")
  @js.native
