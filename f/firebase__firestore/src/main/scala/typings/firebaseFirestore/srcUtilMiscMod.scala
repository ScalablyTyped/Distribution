...
object srcUtilMiscMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/misc", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/misc", "AutoId")
  @js.native
