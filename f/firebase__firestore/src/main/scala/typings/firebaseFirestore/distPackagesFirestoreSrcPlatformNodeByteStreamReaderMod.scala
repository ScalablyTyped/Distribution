...
object distPackagesFirestoreSrcPlatformNodeByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/node/byte_stream_reader", JSImport.Namespace)
  @js.native
