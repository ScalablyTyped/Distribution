...
trait ProjectsDatabasesDocumentsRunQueryNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsRunQueryNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsRunQueryNamedParameters = {
