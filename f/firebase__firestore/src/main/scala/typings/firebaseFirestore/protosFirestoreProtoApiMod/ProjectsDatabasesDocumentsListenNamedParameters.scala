...
trait ProjectsDatabasesDocumentsListenNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsListenNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsListenNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsListenNamedParameters]
  }
  
  extension [Self <: ProjectsDatabasesDocumentsListenNamedParameters](x: Self) {
