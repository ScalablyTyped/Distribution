...
object distLiteFirestoreSrcLocalRemoteDocumentChangeBufferMod {
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/firestore/src/local/remote_document_change_buffer", "RemoteDocumentChangeBuffer")
  @js.native
