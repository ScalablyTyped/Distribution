...
import typings.firebaseFirestore.distPackagesFirestoreSrcCoreTypesMod.MutationBatchState
...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalSharedClientStateSyncerMod.QueryTargetState
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distPackagesFirestoreSrcLocalSharedClientStateSchemaMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/shared_client_state_schema", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/shared_client_state_schema", "BUNDLE_LOADED_KEY_PREFIX")
  @js.native
  val BUNDLE_LOADED_KEY_PREFIX: /* "firestore_bundle_loaded_v2" */ String = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/shared_client_state_schema", "CLIENT_STATE_KEY_PREFIX")
  @js.native
  val CLIENT_STATE_KEY_PREFIX: /* "firestore_clients" */ String = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/shared_client_state_schema", "MUTATION_BATCH_KEY_PREFIX")
  @js.native
  val MUTATION_BATCH_KEY_PREFIX: /* "firestore_mutations" */ String = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/shared_client_state_schema", "ONLINE_STATE_KEY_PREFIX")
  @js.native
  val ONLINE_STATE_KEY_PREFIX: /* "firestore_online_state" */ String = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/shared_client_state_schema", "QUERY_TARGET_KEY_PREFIX")
  @js.native
  val QUERY_TARGET_KEY_PREFIX: /* "firestore_targets" */ String = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/shared_client_state_schema", "SEQUENCE_NUMBER_KEY_PREFIX")
  @js.native
