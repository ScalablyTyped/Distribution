...
object persistentStreamMod {
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/remote/persistent_stream", "PersistentStream")
  @js.native
  ...
  trait WriteRequest
    extends StObject
       with typings.firebaseFirestore.firestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
