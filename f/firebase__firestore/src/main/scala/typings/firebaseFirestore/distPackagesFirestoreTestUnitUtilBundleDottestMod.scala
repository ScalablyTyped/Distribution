...
object distPackagesFirestoreTestUnitUtilBundleDottestMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/test/unit/util/bundle.test", JSImport.Namespace)
  @js.native
