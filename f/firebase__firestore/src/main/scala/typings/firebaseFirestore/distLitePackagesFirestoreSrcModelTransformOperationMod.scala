...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcRemoteNumberSerializerMod.Serializer
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLitePackagesFirestoreSrcModelTransformOperationMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/transform_operation", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/transform_operation", "ArrayRemoveTransformOperation")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/transform_operation", "ArrayUnionTransformOperation")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/transform_operation", "NumericIncrementTransformOperation")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/transform_operation", "ServerTimestampTransform")
  @js.native
  open class ServerTimestampTransform () extends TransformOperation
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/transform_operation", "TransformOperation")
  @js.native
