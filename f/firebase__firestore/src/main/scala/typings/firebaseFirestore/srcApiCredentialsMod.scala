...
object srcApiCredentialsMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "AppCheckToken")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "EmptyAppCheckTokenProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "EmptyAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "EmulatorAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "FirebaseAppCheckTokenProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "FirebaseAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "FirstPartyAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "FirstPartyToken")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "LiteAppCheckTokenProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "LiteAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/credentials", "OAuthToken")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.srcApiCredentialsMod.FirstPartyCredentialsSettings
    - typings.firebaseFirestore.srcApiCredentialsMod.ProviderCredentialsSettings
  */
  trait CredentialsSettings extends StObject
  object CredentialsSettings {
    
    inline def FirstPartyCredentialsSettings(client: Any, sessionIndex: String): typings.firebaseFirestore.srcApiCredentialsMod.FirstPartyCredentialsSettings = {
      ...
      __obj.asInstanceOf[typings.firebaseFirestore.srcApiCredentialsMod.FirstPartyCredentialsSettings]
    }
    
    inline def ProviderCredentialsSettings(client: CredentialsProvider[User]): typings.firebaseFirestore.srcApiCredentialsMod.ProviderCredentialsSettings = {
      val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("provider")
      __obj.asInstanceOf[typings.firebaseFirestore.srcApiCredentialsMod.ProviderCredentialsSettings]
    }
  }
