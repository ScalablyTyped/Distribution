...
import typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiComponentsMod.FirestoreService
import typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiSettingsMod.FirestoreSettings
import typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiSettingsMod.FirestoreSettingsImpl
...
object distPackagesFirestoreSrcLiteApiDatabaseMod {
