...
object distLiteFirestoreSrcLiteApiWriteBatchMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/write_batch", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/write_batch", "WriteBatch")
  @js.native
