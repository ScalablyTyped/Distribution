...
object distLitePackagesFirestoreSrcApiMod {
  ...
  open class AbstractUserDataWriter ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiUserDataWriterMod.AbstractUserDataWriter
  ...
  open class DatabaseId protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreDatabaseInfoMod.DatabaseId {
  ...
  open class FieldPath protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiFieldPathMod.FieldPath {
    /**
  ...
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiBundleMod.LoadBundleTask
  ...
  open class QueryConstraint ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiFilterMod.QueryConstraint
  ...
  open class Query_[T] protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiReferenceMod.Query[T] {
    def this(
      firestore: typings.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiDatabaseMod.Firestore,
      /**
      * If provided, the `FirestoreDataConverter` associated with this instance.
  ...
  open class _FieldPath ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath
  /* static members */
  object _FieldPath {
