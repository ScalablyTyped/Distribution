...
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalLruGarbageCollectorMod.ActiveTargets
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalLruGarbageCollectorMod.LruDelegate
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalLruGarbageCollectorMod.LruGarbageCollector
import typings.firebaseFirestore.distPackagesFirestoreSrcLocalPersistenceMod.ReferenceDelegate
