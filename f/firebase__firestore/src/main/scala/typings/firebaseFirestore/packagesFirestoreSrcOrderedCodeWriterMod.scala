...
object packagesFirestoreSrcOrderedCodeWriterMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/ordered_code_writer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/ordered_code_writer", "OrderedCodeWriter")
  @js.native
