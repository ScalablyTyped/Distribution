...
object distLitePackagesFirestoreSrcCoreBoundMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/bound", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/bound", "Bound")
  @js.native
