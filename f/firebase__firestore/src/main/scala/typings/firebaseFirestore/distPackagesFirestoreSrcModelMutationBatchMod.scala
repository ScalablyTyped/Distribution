...
import typings.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.DocumentVersionMap_
import typings.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.MutationMap
import typings.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.OverlayedDocumentMap
