...
object distLitePackagesFirestoreSrcModelTargetIndexMatcherMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/target_index_matcher", "TargetIndexMatcher")
  @js.native
