...
import typings.firebaseFirestore.anon.`2`
import typings.firebaseFirestore.anon.`46`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distPackagesFirestoreSrcLocalPersistencePromiseMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/persistence_promise", "PersistencePromise")
  @js.native
  ...
  object PersistencePromise {
    ...
    inline def forEach[R](collection: `2`[R], f: js.Function1[/* r */ R, PersistencePromise[Unit]]): PersistencePromise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("forEach")(collection.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[PersistencePromise[Unit]]
    inline def forEach[R, S](collection: `1`[R, S], f: js.Function1[/* r */ R, PersistencePromise[Unit]]): PersistencePromise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("forEach")(collection.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[PersistencePromise[Unit]]
    /**
      * Given an iterable, call the given function on each element in the
      * collection and wait for all of the resulting concurrent PersistencePromises
      * to resolve.
      */
    inline def forEach[R, S](collection: `1`[R, S], f: js.Function2[/* r */ R, /* s */ S, PersistencePromise[Unit]]): PersistencePromise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("forEach")(collection.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[PersistencePromise[Unit]]
    ...
    inline def waitFor(all: `46`): PersistencePromise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(all.asInstanceOf[js.Any]).asInstanceOf[PersistencePromise[Unit]]
  }
