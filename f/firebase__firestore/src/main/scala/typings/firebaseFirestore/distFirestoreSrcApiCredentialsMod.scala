...
object distFirestoreSrcApiCredentialsMod {
  ...
  */
  ...
  object CredentialsSettings {
    ...
    inline def FirstPartyCredentialsSettings(sessionIndex: String): typings.firebaseFirestore.distFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings = {
