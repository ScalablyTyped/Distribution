...
object distPackagesFirestoreSrcLocalMemoryMutationQueueMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/memory_mutation_queue", "MemoryMutationQueue")
  @js.native
