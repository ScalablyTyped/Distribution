...
import typings.firebaseFirestore.distLiteFirestoreSrcLocalIndexeddbLruDelegateImplMod.IndexedDbLruDelegateImpl
...
import typings.firebaseFirestore.distLiteFirestoreSrcLocalPersistenceMod.PrimaryStateListener
