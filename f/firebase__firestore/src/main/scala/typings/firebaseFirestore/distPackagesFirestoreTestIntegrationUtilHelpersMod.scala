...
import typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiSettingsMod.PrivateSettings
import typings.firebaseFirestore.distPackagesFirestoreTestIntegrationUtilFirebaseExportMod.CollectionReference
import typings.firebaseFirestore.distPackagesFirestoreTestIntegrationUtilFirebaseExportMod.DocumentReference
import typings.firebaseFirestore.distPackagesFirestoreTestIntegrationUtilFirebaseExportMod.Firestore
import typings.firebaseFirestore.distPackagesFirestoreTestIntegrationUtilFirebaseExportMod.QuerySnapshot
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distPackagesFirestoreTestIntegrationUtilHelpersMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/test/integration/util/helpers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/test/integration/util/helpers", "apiDescribe")
  @js.native
  ...
  inline def withEmptyTestCollection(
    persistence: Boolean,
    fn: js.Function2[
