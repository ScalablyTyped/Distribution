...
object RemoteDocumentChangeBuffer {
  ...
  inline def apply(
    ...
    getEntry: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any) => PersistencePromise[MutableDocument],
    getFromCache: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any) => PersistencePromise[MutableDocument],
    removeEntry: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any, SnapshotVersion) => Unit
  ...
  implicit open class MutableBuilder[Self <: RemoteDocumentChangeBuffer] (val x: Self) extends AnyVal {
    ...
    inline def setGetEntry(
      value: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any) => PersistencePromise[MutableDocument]
    ...
    inline def setRemoveEntry(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any, SnapshotVersion) => Unit
