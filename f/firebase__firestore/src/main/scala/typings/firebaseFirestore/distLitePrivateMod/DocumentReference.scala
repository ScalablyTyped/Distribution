...
@JSImport("@firebase/firestore/dist/lite/private", "DocumentReference")
@js.native
open class DocumentReference[T] protected () extends StObject {
  ...
  val _key: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any = js.native
