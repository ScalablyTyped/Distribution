...
trait RemoteSyncer extends StObject {
  ...
  /**
    ...
    * the last snapshot.
    */
  var getRemoteKeysForTarget: js.UndefOr[js.Function1[/* targetId */ TargetId, DocumentKeySet]] = js.undefined
...
object RemoteSyncer {
  ...
  implicit open class MutableBuilder[Self <: RemoteSyncer] (val x: Self) extends AnyVal {
    ...
    inline def setGetRemoteKeysForTarget(value: /* targetId */ TargetId => DocumentKeySet): Self = StObject.set(x, "getRemoteKeysForTarget", js.Any.fromFunction1(value))
