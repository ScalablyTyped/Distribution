...
trait MutationQueue extends StObject {
  ...
  def getAllMutationBatchesAffectingDocumentKey(
    transaction: PersistenceTransaction,
    documentKey: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any
...
object MutationQueue {
  ...
  inline def apply(
    ...
    getAllMutationBatchesAffectingDocumentKey: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any) => PersistencePromise[js.Array[MutationBatch]],
  ...
  implicit open class MutableBuilder[Self <: MutationQueue] (val x: Self) extends AnyVal {
    ...
    inline def setGetAllMutationBatchesAffectingDocumentKey(
      value: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any) => PersistencePromise[js.Array[MutationBatch]]
