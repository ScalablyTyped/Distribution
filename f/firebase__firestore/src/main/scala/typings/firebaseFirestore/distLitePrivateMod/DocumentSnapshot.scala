...
@JSImport("@firebase/firestore/dist/lite/private", "DocumentSnapshot")
@js.native
open class DocumentSnapshot[T] protected () extends StObject {
  ...
  var _key: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any = js.native
  ...
  /**
    ...
    */
  def exists(): /* is @firebase/firestore.@firebase/firestore/dist/lite/private.QueryDocumentSnapshot<T> */ Boolean = js.native
