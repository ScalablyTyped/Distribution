...
trait DocumentOverlayCache extends StObject {
  ...
  def getOverlaysForCollection(
    transaction: PersistenceTransaction,
    collection: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResourcePath */ Any,
    sinceBatchId: Double
  ): PersistencePromise[OverlayMap]
...
object DocumentOverlayCache {
  ...
  inline def apply(
    getOverlay: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any) => PersistencePromise[Overlay | Null],
    getOverlays: (PersistenceTransaction, js.Array[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any
    ]) => PersistencePromise[OverlayMap],
    getOverlaysForCollection: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResourcePath */ Any, Double) => PersistencePromise[OverlayMap],
  ...
  implicit open class MutableBuilder[Self <: DocumentOverlayCache] (val x: Self) extends AnyVal {
    ...
    inline def setGetOverlay(
      value: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any) => PersistencePromise[Overlay | Null]
    ...
    inline def setGetOverlaysForCollection(
      value: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResourcePath */ Any, Double) => PersistencePromise[OverlayMap]
