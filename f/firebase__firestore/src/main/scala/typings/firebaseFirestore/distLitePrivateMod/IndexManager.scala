...
trait IndexManager extends StObject {
  ...
  def addToCollectionParentIndex(
    ...
    collectionPath: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResourcePath */ Any
  ...
  def getCollectionParents(transaction: PersistenceTransaction, collectionId: String): PersistencePromise[
    js.Array[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResourcePath */ Any
    ]
  ] = js.native
