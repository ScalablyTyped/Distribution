...
trait Mutation extends StObject {
  ...
  val key: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any
...
object Mutation {
  ...
  extension [Self <: Mutation](x: Self) {
    ...
    inline def setKey(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any
