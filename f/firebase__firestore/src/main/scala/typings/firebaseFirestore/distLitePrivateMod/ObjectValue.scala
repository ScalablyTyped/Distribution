...
trait ObjectValue extends StObject {
  ...
  /**
    ...
    */
  def delete(
    path: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any
  ): Unit
  ...
  def setAll(
    data: Map[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any, 
      Value | Null
    ]
  ): Unit
...
object ObjectValue {
  ...
  inline def apply(
    applyChanges: Any,
    delete: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any => Unit,
    field: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any => Value | Null,
    getFieldsMap: Any,
    isEqual: ObjectValue => Boolean,
    set: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any, Value) => Unit,
    setAll: Map[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any, 
      Value | Null
    ] => Unit,
  ...
  implicit open class MutableBuilder[Self <: ObjectValue] (val x: Self) extends AnyVal {
    ...
    inline def setDelete(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any => Unit
    ): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
    
    inline def setField(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any => Value | Null
    ...
    inline def setSet(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FieldPath_2 */ Any, Value) => Unit
    ...
    inline def setValue(value: `38`): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  }
}
