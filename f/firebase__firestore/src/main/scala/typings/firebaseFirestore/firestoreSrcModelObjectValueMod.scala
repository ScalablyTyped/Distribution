...
import typings.firebaseFirestore.firestoreSrcProtosFirestoreProtoApiMod.MapValue
...
object firestoreSrcModelObjectValueMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/object_value", JSImport.Namespace)
  @js.native
