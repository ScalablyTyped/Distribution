...
import typings.firebaseFirestore.firestoreSrcRemoteExistenceFilterMod.ExistenceFilter
import typings.firebaseFirestore.firestoreSrcRemoteRemoteEventMod.RemoteEvent
...
object firestoreSrcRemoteWatchChangeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.firestoreSrcRemoteWatchChangeMod.DocumentWatchChange
    - typings.firebaseFirestore.firestoreSrcRemoteWatchChangeMod.WatchTargetChange
    - typings.firebaseFirestore.firestoreSrcRemoteWatchChangeMod.ExistenceFilterChange
  */
