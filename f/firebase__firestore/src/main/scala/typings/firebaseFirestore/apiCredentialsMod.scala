...
object apiCredentialsMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "AppCheckToken")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "EmptyAppCheckTokenProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "EmptyAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "EmulatorAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "FirebaseAppCheckTokenProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "FirebaseAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "FirstPartyAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "FirstPartyToken")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "LiteAppCheckTokenProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "LiteAuthCredentialsProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/credentials", "OAuthToken")
  @js.native
  ...
  */
  ...
  object CredentialsSettings {
    ...
    inline def FirstPartyCredentialsSettings(client: Any, sessionIndex: String): typings.firebaseFirestore.apiCredentialsMod.FirstPartyCredentialsSettings = {
      ...
      __obj.asInstanceOf[typings.firebaseFirestore.apiCredentialsMod.FirstPartyCredentialsSettings]
    }
    
    inline def ProviderCredentialsSettings(client: CredentialsProvider[User]): typings.firebaseFirestore.apiCredentialsMod.ProviderCredentialsSettings = {
      val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("provider")
      __obj.asInstanceOf[typings.firebaseFirestore.apiCredentialsMod.ProviderCredentialsSettings]
    }
  }
