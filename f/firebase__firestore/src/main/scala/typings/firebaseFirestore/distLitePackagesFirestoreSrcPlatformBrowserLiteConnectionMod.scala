...
object distLitePackagesFirestoreSrcPlatformBrowserLiteConnectionMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser_lite/connection", JSImport.Namespace)
  @js.native
