...
import typings.firebaseFirestore.distLiteFirestoreSrcLiteApiSettingsMod.PrivateSettings
...
import typings.firebaseFirestore.distLiteFirestoreTestIntegrationUtilFirebaseExportMod.^
...
inline def getAggregateFromServer[T /* <: AggregateSpec */](query: typings.firebaseFirestore.distLiteFirestoreSrcApiMod.Query_[Any], aggregateSpec: T): js.Promise[
...
inline def newTestFirestore(app: FirebaseApp): typings.firebaseFirestore.distLiteFirestoreSrcMod.Firestore = ^.asInstanceOf[js.Dynamic].applyDynamic("newTestFirestore")(app.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.distLiteFirestoreSrcMod.Firestore]
inline def newTestFirestore(app: FirebaseApp, settings: Unit, dbName: String): typings.firebaseFirestore.distLiteFirestoreSrcMod.Firestore = (^.asInstanceOf[js.Dynamic].applyDynamic("newTestFirestore")(app.asInstanceOf[js.Any], settings.asInstanceOf[js.Any], dbName.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distLiteFirestoreSrcMod.Firestore]
inline def newTestFirestore(app: FirebaseApp, settings: PrivateSettings): typings.firebaseFirestore.distLiteFirestoreSrcMod.Firestore = (^.asInstanceOf[js.Dynamic].applyDynamic("newTestFirestore")(app.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.distLiteFirestoreSrcMod.Firestore]
