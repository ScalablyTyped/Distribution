...
@JSImport("@firebase/firestore/dist/lite/firestore/test/integration/util/firebase_export", "QueryCompositeFilterConstraint")
@js.native
open class QueryCompositeFilterConstraint protected ()
  extends typings.firebaseFirestore.distLiteFirestoreSrcMod.QueryCompositeFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
