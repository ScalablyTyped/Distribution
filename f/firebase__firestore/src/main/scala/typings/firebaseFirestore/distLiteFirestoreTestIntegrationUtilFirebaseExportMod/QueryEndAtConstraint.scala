...
@JSImport("@firebase/firestore/dist/lite/firestore/test/integration/util/firebase_export", "QueryEndAtConstraint")
@js.native
open class QueryEndAtConstraint protected ()
  extends typings.firebaseFirestore.distLiteFirestoreSrcMod.QueryEndAtConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
