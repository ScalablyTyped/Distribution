...
object distPackagesFirestoreSrcUtilMiscMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/util/misc", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/util/misc", "AutoId")
  @js.native
