...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbLruDelegateImplMod.IndexedDbLruDelegateImpl
...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcLocalPersistenceMod.PrimaryStateListener
...
object distLitePackagesFirestoreSrcLocalIndexeddbPersistenceMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/indexeddb_persistence", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/indexeddb_persistence", "IndexedDbPersistence")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/indexeddb_persistence", "MAIN_DATABASE")
  @js.native
