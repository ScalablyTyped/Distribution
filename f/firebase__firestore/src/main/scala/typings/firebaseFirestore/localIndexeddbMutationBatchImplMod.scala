...
import typings.firebaseFirestore.localIndexeddbSchemaLegacyMod.DbRemoteDocument
...
object localIndexeddbMutationBatchImplMod {
  ...
  inline def dbDocumentSize(doc: typings.firebaseFirestore.localIndexeddbSchemaMod.DbRemoteDocument): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("dbDocumentSize")(doc.asInstanceOf[js.Any]).asInstanceOf[Double]
