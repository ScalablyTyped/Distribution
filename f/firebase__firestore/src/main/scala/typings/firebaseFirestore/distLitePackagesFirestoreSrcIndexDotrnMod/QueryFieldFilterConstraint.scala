...
@JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.rn", "QueryFieldFilterConstraint")
@js.native
open class QueryFieldFilterConstraint protected ()
  extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.QueryFieldFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
