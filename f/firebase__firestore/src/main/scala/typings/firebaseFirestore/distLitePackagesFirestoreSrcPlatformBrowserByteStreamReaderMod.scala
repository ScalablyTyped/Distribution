...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcUtilBundleReaderMod.BundleSource
import typings.std.ReadableStreamReader
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLitePackagesFirestoreSrcPlatformBrowserByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser/byte_stream_reader", JSImport.Namespace)
  @js.native
