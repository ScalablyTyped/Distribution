...
object firestoreSrcPlatformBrowserLiteRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/browser_lite/random_bytes", JSImport.Namespace)
  @js.native
