...
object rollupSharedMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/rollup.shared", JSImport.Namespace)
  @js.native
  ...
  object manglePrivatePropertiesOptions {
    ...
    object mangle {
      ...
      object properties {
        ...
        @JSImport("@firebase/firestore/dist/lite/packages/firestore/rollup.shared", "manglePrivatePropertiesOptions.mangle.properties.regex")
        @js.native
        val regex: js.RegExp = js.native
        
        @JSImport("@firebase/firestore/dist/lite/packages/firestore/rollup.shared", "manglePrivatePropertiesOptions.mangle.properties.reserved_1")
        @js.native
        val reserved1: js.Array[String] = js.native
      }
      
      @JSImport("@firebase/firestore/dist/lite/packages/firestore/rollup.shared", "manglePrivatePropertiesOptions.mangle.reserved")
      @js.native
    ...
    object output {
      ...
      @JSImport("@firebase/firestore/dist/lite/packages/firestore/rollup.shared", "manglePrivatePropertiesOptions.output.beautify")
      @js.native
      val beautify: Boolean = js.native
      
      @JSImport("@firebase/firestore/dist/lite/packages/firestore/rollup.shared", "manglePrivatePropertiesOptions.output.comments")
      @js.native
