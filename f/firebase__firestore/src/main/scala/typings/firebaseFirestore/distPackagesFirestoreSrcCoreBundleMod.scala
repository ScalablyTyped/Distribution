...
import typings.firebaseFirestore.distPackagesFirestoreSrcProtosFirestoreBundleProtoMod.BundledDocumentMetadata
...
object distPackagesFirestoreSrcCoreBundleMod {
