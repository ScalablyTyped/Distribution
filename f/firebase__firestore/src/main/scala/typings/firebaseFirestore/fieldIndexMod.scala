...
object fieldIndexMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/model/field_index", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/model/field_index", "FieldIndex")
  @js.native
  ...
  object FieldIndex {
    ...
    @JSImport("@firebase/firestore/dist/firestore/src/model/field_index", "FieldIndex.UNKNOWN_ID")
    @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/model/field_index", "INITIAL_LARGEST_BATCH_ID")
  @js.native
  val INITIAL_LARGEST_BATCH_ID: /* -1 */ Double = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/model/field_index", "INITIAL_SEQUENCE_NUMBER")
  @js.native
  val INITIAL_SEQUENCE_NUMBER: /* 0 */ Double = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/model/field_index", "IndexOffset")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/model/field_index", "IndexSegment")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/model/field_index", "IndexState")
  @js.native
