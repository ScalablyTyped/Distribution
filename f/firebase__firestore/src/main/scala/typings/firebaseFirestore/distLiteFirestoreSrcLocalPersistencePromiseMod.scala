...
import typings.firebaseFirestore.anon.`17`
...
object distLiteFirestoreSrcLocalPersistencePromiseMod {
  ...
  object PersistencePromise {
    ...
    inline def waitFor(all: `17`): PersistencePromise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(all.asInstanceOf[js.Any]).asInstanceOf[PersistencePromise[Unit]]
  }
