...
object distFirestoreSrcPlatformBrowserLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/platform/browser_lite/text_serializer", JSImport.Namespace)
  @js.native
