...
import typings.firebaseFirestore.srcLocalDocumentOverlayCacheMod.DocumentOverlayCache
...
import typings.firebaseFirestore.srcModelCollectionsMod.MutationMap
import typings.firebaseFirestore.srcModelCollectionsMod.OverlayMap
...
object srcLocalIndexeddbDocumentOverlayCacheMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/indexeddb_document_overlay_cache", "IndexedDbDocumentOverlayCache")
  @js.native
