...
object distPackagesFirestoreSrcRemoteOnlineStateTrackerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/remote/online_state_tracker", "OnlineStateTracker")
  @js.native
