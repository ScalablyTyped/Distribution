...
object srcIndexNodeMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.node", "AbstractUserDataWriter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.node", "FieldValue")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.node", "QueryConstraint")
  @js.native
