...
object srcUtilErrorMod {
  
  object Code {
    
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code")
    @js.native
    ...
    /**
      ...
      * and UNAVAILABLE.
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.ABORTED")
    @js.native
    ...
    /**
      ...
      * exists.
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.ALREADY_EXISTS")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.CANCELLED")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.DATA_LOSS")
    @js.native
    ...
    /**
      ...
      * expire.
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.DEADLINE_EXCEEDED")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.FAILED_PRECONDITION")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.INTERNAL")
    @js.native
    ...
    /**
      ...
      * name).
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.INVALID_ARGUMENT")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.NOT_FOUND")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.OK")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.OUT_OF_RANGE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.PERMISSION_DENIED")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.RESOURCE_EXHAUSTED")
    @js.native
    ...
    /**
      ...
      * operation.
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.UNAUTHENTICATED")
    @js.native
    ...
    /**
      ...
      * and UNAVAILABLE.
      */
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.UNAVAILABLE")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.UNIMPLEMENTED")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "Code.UNKNOWN")
    @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/error", "FirestoreError")
  @js.native
