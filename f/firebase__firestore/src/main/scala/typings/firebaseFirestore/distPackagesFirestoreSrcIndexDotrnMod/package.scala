...
import typings.firebaseFirestore.distPackagesFirestoreSrcIndexDotrnMod.^
...
inline def getAggregateFromServer[T /* <: AggregateSpec */](query: typings.firebaseFirestore.distPackagesFirestoreSrcApiMod.Query_[Any], aggregateSpec: T): js.Promise[
