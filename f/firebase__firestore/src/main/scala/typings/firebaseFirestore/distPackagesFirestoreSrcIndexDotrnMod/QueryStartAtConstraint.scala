...
@JSImport("@firebase/firestore/dist/packages/firestore/src/index.rn", "QueryStartAtConstraint")
@js.native
open class QueryStartAtConstraint protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcApiMod.QueryStartAtConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
