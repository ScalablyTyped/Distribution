...
@JSImport("@firebase/firestore/dist/packages/firestore/src/index.rn", "QueryCompositeFilterConstraint")
@js.native
open class QueryCompositeFilterConstraint protected ()
  extends typings.firebaseFirestore.distPackagesFirestoreSrcApiMod.QueryCompositeFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
