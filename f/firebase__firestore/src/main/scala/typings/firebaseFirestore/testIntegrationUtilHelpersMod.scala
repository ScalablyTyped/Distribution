...
import typings.firebaseFirestore.integrationUtilFirebaseExportMod.CollectionReference
import typings.firebaseFirestore.integrationUtilFirebaseExportMod.DocumentReference
import typings.firebaseFirestore.integrationUtilFirebaseExportMod.Firestore
import typings.firebaseFirestore.integrationUtilFirebaseExportMod.QuerySnapshot
import typings.firebaseFirestore.srcApiReferenceImplMod.SnapshotListenOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object testIntegrationUtilHelpersMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/integration/util/helpers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/integration/util/helpers", "apiDescribe")
  @js.native
