...
import typings.firebaseFirestore.firestoreSrcUtilBundleReaderMod.BundleSource
import typings.std.ReadableStreamReader
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object firestoreSrcPlatformBrowserLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/browser_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
