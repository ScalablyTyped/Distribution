...
@JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api", "QueryOrderByConstraint")
@js.native
open class QueryOrderByConstraint protected ()
  extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiFilterMod.QueryOrderByConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
