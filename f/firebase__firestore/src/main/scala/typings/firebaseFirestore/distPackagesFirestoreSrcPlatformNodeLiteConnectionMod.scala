...
object distPackagesFirestoreSrcPlatformNodeLiteConnectionMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/node_lite/connection", JSImport.Namespace)
  @js.native
