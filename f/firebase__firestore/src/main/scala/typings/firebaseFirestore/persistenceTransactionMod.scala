...
object persistenceTransactionMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/persistence_transaction", "PRIMARY_LEASE_LOST_ERROR_MSG")
  @js.native
  val PRIMARY_LEASE_LOST_ERROR_MSG: String = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/persistence_transaction", "PersistenceTransaction")
  @js.native
