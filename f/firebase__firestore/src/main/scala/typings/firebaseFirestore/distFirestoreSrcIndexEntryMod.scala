...
object distFirestoreSrcIndexEntryMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/index_entry", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/index_entry", "IndexEntry")
  @js.native
