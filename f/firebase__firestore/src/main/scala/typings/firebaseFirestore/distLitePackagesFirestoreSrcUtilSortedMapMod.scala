...
object distLitePackagesFirestoreSrcUtilSortedMapMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/sorted_map", "LLRBEmptyNode")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/sorted_map", "LLRBNode")
  @js.native
  ...
  object LLRBNode {
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/sorted_map", "LLRBNode.BLACK")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/sorted_map", "LLRBNode.EMPTY")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/sorted_map", "LLRBNode.RED")
    @js.native
    def RED: Boolean = js.native
    inline def RED_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RED")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/sorted_map", "SortedMap")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/sorted_map", "SortedMapIterator")
  @js.native
