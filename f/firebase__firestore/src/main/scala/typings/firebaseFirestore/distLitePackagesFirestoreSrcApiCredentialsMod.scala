...
object distLitePackagesFirestoreSrcApiCredentialsMod {
  ...
  */
  ...
  object CredentialsSettings {
    ...
    inline def FirstPartyCredentialsSettings(sessionIndex: String): typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings = {
