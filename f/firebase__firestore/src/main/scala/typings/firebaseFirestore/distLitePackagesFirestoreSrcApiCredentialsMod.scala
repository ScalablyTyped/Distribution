...
object distLitePackagesFirestoreSrcApiCredentialsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings
    - typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings
  */
  trait CredentialsSettings extends StObject
  object CredentialsSettings {
    
    inline def FirstPartyCredentialsSettings(client: Any, sessionIndex: String): typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings = {
      ...
      __obj.asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings]
    }
    
    inline def ProviderCredentialsSettings(client: CredentialsProvider[User]): typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings = {
      val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("provider")
      __obj.asInstanceOf[typings.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings]
    }
  }
