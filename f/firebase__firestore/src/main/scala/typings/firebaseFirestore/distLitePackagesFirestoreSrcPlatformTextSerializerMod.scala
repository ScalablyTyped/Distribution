...
object distLitePackagesFirestoreSrcPlatformTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/text_serializer", JSImport.Namespace)
  @js.native
