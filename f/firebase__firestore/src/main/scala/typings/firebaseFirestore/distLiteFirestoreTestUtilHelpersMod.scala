...
import typings.firebaseFirestore.anon.Contains
import typings.firebaseFirestore.anon.Id
...
import typings.firebaseFirestore.distLiteFirestoreSrcCoreViewMod.LimboDocumentChange
import typings.firebaseFirestore.distLiteFirestoreSrcCoreViewMod.View
import typings.firebaseFirestore.distLiteFirestoreSrcCoreViewMod.ViewChange
import typings.firebaseFirestore.distLiteFirestoreSrcLiteApiReferenceMod.DocumentData
import typings.firebaseFirestore.distLiteFirestoreSrcLiteApiUserDataReaderMod.UserDataReader
...
import typings.firebaseFirestore.distLiteFirestoreSrcMod.Bytes
import typings.firebaseFirestore.distLiteFirestoreSrcMod.DocumentReference
...
import typings.firebaseFirestore.distLiteFirestoreSrcModelDocumentComparatorMod.DocumentComparator
...
import typings.firebaseFirestore.distLiteFirestoreSrcModelMutationMod.DeleteMutation
import typings.firebaseFirestore.distLiteFirestoreSrcModelMutationMod.MutationResult
import typings.firebaseFirestore.distLiteFirestoreSrcModelMutationMod.PatchMutation
import typings.firebaseFirestore.distLiteFirestoreSrcModelMutationMod.Precondition
import typings.firebaseFirestore.distLiteFirestoreSrcModelMutationMod.SetMutation
...
import typings.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreBundleProtoMod.LimitType
import typings.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreBundleProtoMod.NamedQuery
import typings.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreProtoApiMod.BloomFilter
...
import typings.firebaseFirestore.distLiteFirestoreSrcUtilObjMod.Dict
...
object distLiteFirestoreTestUtilHelpersMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/helpers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/helpers", "DocComparator")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/helpers", "TestBundledDocuments")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/test/util/helpers", "TestNamedQuery")
  @js.native
  ...
  inline def fieldIndex(collectionGroup: String, options: Id): FieldIndex = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldIndex")(collectionGroup.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[FieldIndex]
  ...
  inline def generateBloomFilterProto(config: Contains): BloomFilter = ^.asInstanceOf[js.Dynamic].applyDynamic("generateBloomFilterProto")(config.asInstanceOf[js.Any]).asInstanceOf[BloomFilter]
  ...
  inline def limboChanges(changes: `19`): js.Array[LimboDocumentChange] = ^.asInstanceOf[js.Dynamic].applyDynamic("limboChanges")(changes.asInstanceOf[js.Any]).asInstanceOf[js.Array[LimboDocumentChange]]
