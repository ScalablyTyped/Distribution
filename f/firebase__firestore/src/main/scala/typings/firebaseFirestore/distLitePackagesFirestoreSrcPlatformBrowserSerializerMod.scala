...
object distLitePackagesFirestoreSrcPlatformBrowserSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser/serializer", JSImport.Namespace)
  @js.native
