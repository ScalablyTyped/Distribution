...
import typings.firebaseFirestore.srcLocalIndexeddbSchemaMod.DbNoDocument
import typings.firebaseFirestore.srcLocalIndexeddbSchemaMod.DbUnknownDocument
...
object srcLocalIndexeddbSchemaLegacyMod {
