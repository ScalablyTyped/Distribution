...
import typings.firebaseFirestore.distPackagesFirestoreSrcProtosFirestoreBundleProtoMod.BundleElement
...
object distPackagesFirestoreSrcUtilBundleReaderMod {
