...
object distLitePackagesFirestoreSrcIndexDotrnMod {
  ...
  open class AbstractUserDataWriter ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.AbstractUserDataWriter
  ...
  open class Bytes protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.Bytes {
    /** @hideconstructor */
  ...
  open class DatabaseId protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.DatabaseId {
  ...
  open class DocumentReference[T] protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.DocumentReference[T] {
    def this(
      firestore: typings.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiDatabaseMod.Firestore,
      /**
  ...
  open class EmptyAppCheckTokenProvider ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.EmptyAppCheckTokenProvider
  ...
  open class FieldPath protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.FieldPath {
    /**
  ...
  open class GeoPoint protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.GeoPoint {
    /**
  ...
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.LoadBundleTask
  ...
  open class QueryConstraint ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.QueryConstraint
  ...
  open class SnapshotMetadata protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.SnapshotMetadata {
    /** @hideconstructor */
  ...
  open class Transaction protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.Transaction {
    /** @hideconstructor */
    def this(
      _firestore: typings.firebaseFirestore.distLitePackagesFirestoreSrcApiDatabaseMod.Firestore,
  ...
  open class WriteBatch_ protected ()
    extends typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.WriteBatch_ {
    /** @hideconstructor */
    def this(
