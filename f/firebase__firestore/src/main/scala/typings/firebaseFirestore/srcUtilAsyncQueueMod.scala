...
object srcUtilAsyncQueueMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/async_queue", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/async_queue", "DelayedOperation")
  @js.native
