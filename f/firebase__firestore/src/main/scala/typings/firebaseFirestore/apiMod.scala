...
object apiMod {
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "AbstractUserDataWriter")
  @js.native
  abstract class AbstractUserDataWriter ()
    extends typings.firebaseFirestore.userDataWriterMod.AbstractUserDataWriter
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_ByteString")
  @js.native
  /* private */ open class ByteString ()
    extends typings.firebaseFirestore.byteStringMod.ByteString
  /* static members */
  object ByteString {
  ...
  open class Bytes protected ()
    extends typings.firebaseFirestore.bytesMod.Bytes {
    /** @hideconstructor */
  ...
  open class DatabaseId protected ()
    extends typings.firebaseFirestore.databaseInfoMod.DatabaseId {
  ...
  open class DocumentKey protected ()
    extends typings.firebaseFirestore.documentKeyMod.DocumentKey {
  ...
  open class EmptyAppCheckTokenProvider ()
    extends typings.firebaseFirestore.credentialsMod.EmptyAppCheckTokenProvider
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "_EmptyAuthCredentialsProvider")
  @js.native
  open class EmptyAuthCredentialsProvider ()
    extends typings.firebaseFirestore.credentialsMod.EmptyAuthCredentialsProvider
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api", "FieldValue")
  @js.native
  ...
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.bundleMod.LoadBundleTask
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "QueryConstraint")
  @js.native
  abstract class QueryConstraint ()
    extends typings.firebaseFirestore.filterMod.QueryConstraint
  
  @JSImport("@firebase/firestore/dist/firestore/src/api", "QueryDocumentSnapshot")
  @js.native
  open class QueryDocumentSnapshot[T] protected ()
    extends typings.firebaseFirestore.snapshotMod.QueryDocumentSnapshot[T] {
    def this(
      _firestore: typings.firebaseFirestore.databaseMod.Firestore,
      userDataWriter: typings.firebaseFirestore.userDataWriterMod.AbstractUserDataWriter,
      key: typings.firebaseFirestore.documentKeyMod.DocumentKey,
  ...
  open class ResourcePath ()
    extends typings.firebaseFirestore.pathMod.ResourcePath
  /* static members */
  object ResourcePath {
  ...
  open class SnapshotMetadata protected ()
    extends typings.firebaseFirestore.snapshotMod.SnapshotMetadata {
    /** @hideconstructor */
  ...
  open class _FieldPath ()
    extends typings.firebaseFirestore.pathMod.FieldPath
  /* static members */
  object _FieldPath {
