...
@JSImport("@firebase/firestore/dist/firestore/src/index.node", "QueryCompositeFilterConstraint")
@js.native
open class QueryCompositeFilterConstraint protected ()
  extends typings.firebaseFirestore.distFirestoreSrcApiMod.QueryCompositeFilterConstraint {
  /**
    * @internal
    */
  /* protected */ def this(
