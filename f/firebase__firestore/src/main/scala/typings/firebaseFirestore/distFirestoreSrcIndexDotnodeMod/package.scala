...
import typings.firebaseFirestore.distFirestoreSrcIndexDotnodeMod.^
...
inline def getAggregateFromServer[T /* <: AggregateSpec */](query: typings.firebaseFirestore.distFirestoreSrcApiMod.Query_[Any], aggregateSpec: T): js.Promise[
