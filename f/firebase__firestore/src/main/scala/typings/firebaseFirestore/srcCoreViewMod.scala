...
import typings.firebaseFirestore.srcCoreViewSnapshotMod.DocumentChangeSet
import typings.firebaseFirestore.srcCoreViewSnapshotMod.ViewSnapshot
import typings.firebaseFirestore.srcLocalLocalStoreImplMod.QueryResult
...
object srcCoreViewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseFirestore.srcCoreViewMod.AddedLimboDocument
    - typings.firebaseFirestore.srcCoreViewMod.RemovedLimboDocument
  */
