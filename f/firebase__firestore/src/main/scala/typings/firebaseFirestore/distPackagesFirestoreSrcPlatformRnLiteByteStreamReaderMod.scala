...
object distPackagesFirestoreSrcPlatformRnLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/rn_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
