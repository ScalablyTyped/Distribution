...
trait HashCount extends StObject {
...
object HashCount {
  ...
  inline def apply(contains: js.Array[MutableDocument], notContains: js.Array[MutableDocument]): HashCount = {
    val __obj = js.Dynamic.literal(contains = contains.asInstanceOf[js.Any], notContains = notContains.asInstanceOf[js.Any])
    __obj.asInstanceOf[HashCount]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: HashCount] (val x: Self) extends AnyVal {
