...
trait OfflineOfflineKind extends StObject {
...
object OfflineOfflineKind {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OfflineOfflineKind]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OfflineOfflineKind] (val x: Self) extends AnyVal {
