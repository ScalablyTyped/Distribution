...
trait QueryQuery extends StObject {
  ...
  var query: typings.firebaseFirestore.firestoreSrcCoreQueryMod.Query
...
object QueryQuery {
  ...
  inline def apply(query: typings.firebaseFirestore.firestoreSrcCoreQueryMod.Query): QueryQuery = {
  ...
  extension [Self <: QueryQuery](x: Self) {
    ...
    inline def setQuery(value: typings.firebaseFirestore.firestoreSrcCoreQueryMod.Query): Self = StObject.set(x, "query", value.asInstanceOf[js.Any])
