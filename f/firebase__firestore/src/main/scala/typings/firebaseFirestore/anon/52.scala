...
import typings.firebaseFirestore.distPrivateMod.DocumentSnapshot
import typings.firebaseFirestore.distPrivateMod.FirestoreError
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait `52`[T] extends StObject {
...
object `52` {
  ...
  inline def apply[T](): `52`[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`52`[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `52`[?], T] (val x: Self & `52`[T]) extends AnyVal {
