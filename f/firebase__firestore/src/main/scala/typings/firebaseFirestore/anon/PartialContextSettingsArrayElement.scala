...
import typings.firebaseFirestore.distLiteFirestoreSrcLiteApiUserDataReaderMod.UserDataSource
...
object PartialContextSettingsArrayElement {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialContextSettingsArrayElement] (val x: Self) extends AnyVal {
