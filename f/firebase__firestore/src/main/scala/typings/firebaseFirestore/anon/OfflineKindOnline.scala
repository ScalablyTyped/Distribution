...
trait OfflineKindOnline extends StObject {
...
object OfflineKindOnline {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OfflineKindOnline]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OfflineKindOnline] (val x: Self) extends AnyVal {
