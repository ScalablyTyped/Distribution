...
trait BitCount extends StObject {
...
object BitCount {
  ...
  inline def apply(contains: js.Array[MutableDocument], notContains: js.Array[MutableDocument]): BitCount = {
    val __obj = js.Dynamic.literal(contains = contains.asInstanceOf[js.Any], notContains = notContains.asInstanceOf[js.Any])
    __obj.asInstanceOf[BitCount]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BitCount] (val x: Self) extends AnyVal {
