...
import typings.firebaseFirestore.distPackagesFirestoreDistIndexDotesm2017Mod.ah
...
object DatabaseId {
  ...
  inline def apply(app: Any, databaseId: Any, settings: ah): DatabaseId = {
  ...
  implicit open class MutableBuilder[Self <: DatabaseId] (val x: Self) extends AnyVal {
    ...
    inline def setSettings(value: ah): Self = StObject.set(x, "settings", value.asInstanceOf[js.Any])
  }
}
