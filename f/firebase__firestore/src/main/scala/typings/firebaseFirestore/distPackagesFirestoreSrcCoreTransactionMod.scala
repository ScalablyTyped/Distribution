...
import typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiUserDataReaderMod.ParsedSetData
import typings.firebaseFirestore.distPackagesFirestoreSrcLiteApiUserDataReaderMod.ParsedUpdateData
...
object distPackagesFirestoreSrcCoreTransactionMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/core/transaction", "Transaction")
  @js.native
