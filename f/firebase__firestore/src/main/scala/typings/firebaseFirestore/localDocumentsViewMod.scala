...
import typings.firebaseFirestore.collectionsMod.DocumentKeyMap
...
import typings.firebaseFirestore.collectionsMod.OverlayedDocumentMap
...
import typings.firebaseFirestore.localStoreImplMod.LocalWriteResult
...
object localDocumentsViewMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/local_documents_view", "LocalDocumentsView")
  @js.native
