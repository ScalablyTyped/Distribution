...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewSnapshotMod.ChangeType
...
object distLitePackagesFirestoreSrcApiSnapshotMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/snapshot", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/snapshot", "DocumentSnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/snapshot", "QueryDocumentSnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/snapshot", "QuerySnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/snapshot", "SnapshotMetadata")
  @js.native
  ...
  */
  ...
  trait FirestoreDataConverter[T]
    extends StObject
       with typings.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiSnapshotMod.FirestoreDataConverter[T] {
