...
import typings.firebaseFirestore.firestoreSrcLiteApiSnapshotMod.QuerySnapshot
...
object firestoreSrcLiteApiReferenceImplMod {
  ...
  inline def setDoc[T](
    ...
    options: typings.firebaseFirestore.firestoreSrcLiteApiReferenceMod.SetOptions
