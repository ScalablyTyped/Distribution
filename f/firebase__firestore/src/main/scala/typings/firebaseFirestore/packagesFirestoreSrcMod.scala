...
object packagesFirestoreSrcMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "AbstractUserDataWriter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "CACHE_SIZE_UNLIMITED")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "_DatabaseId")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "DocumentReference")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "_EmptyAppCheckTokenProvider")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "FieldValue")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "LoadBundleTask")
  @js.native
  open class LoadBundleTask ()
    extends typings.firebaseFirestore.firestoreSrcApiMod.LoadBundleTask
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "QueryConstraint")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "QuerySnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "Query")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "Timestamp")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src", "Transaction")
  @js.native
