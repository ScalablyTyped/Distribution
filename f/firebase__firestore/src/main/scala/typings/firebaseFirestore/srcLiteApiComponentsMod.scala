...
import typings.firebaseFirestore.firestoreSrcLiteApiSettingsMod.FirestoreSettingsImpl
...
object srcLiteApiComponentsMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/components", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/components", "LOG_TAG")
  @js.native
