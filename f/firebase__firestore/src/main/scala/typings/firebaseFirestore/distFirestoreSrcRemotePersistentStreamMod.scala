...
import typings.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.ListenRequest
import typings.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.ListenResponse
import typings.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.WriteResponse
import typings.firebaseFirestore.distFirestoreSrcRemoteBackoffMod.ExponentialBackoff
import typings.firebaseFirestore.distFirestoreSrcRemoteConnectionMod.Connection
import typings.firebaseFirestore.distFirestoreSrcRemoteConnectionMod.Stream
...
object distFirestoreSrcRemotePersistentStreamMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/remote/persistent_stream", "PersistentListenStream")
  @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/remote/persistent_stream", "PersistentStream")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/remote/persistent_stream", "PersistentWriteStream")
  @js.native
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typings.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typings.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
