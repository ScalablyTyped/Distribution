...
object distLitePackagesFirestoreSrcPlatformNodeLiteTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/node_lite/text_serializer", JSImport.Namespace)
  @js.native
