...
import typings.firebaseFirestore.distLitePackagesFirestoreTestIntegrationUtilFirebaseExportMod.^
...
inline def getAggregateFromServer[T /* <: AggregateSpec */](query: typings.firebaseFirestore.distLitePackagesFirestoreSrcApiMod.Query_[Any], aggregateSpec: T): js.Promise[
