...
object distLitePackagesFirestoreSrcCoreQueryMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/query", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/query", "QueryImpl")
  @js.native
