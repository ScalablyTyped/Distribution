...
import typings.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.StructuredQuery
...
object distLitePackagesFirestoreSrcProtosFirestoreBundleProtoMod {
