...
object distLiteFirestoreSrcPlatformNodeLiteSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/node_lite/serializer", JSImport.Namespace)
  @js.native
