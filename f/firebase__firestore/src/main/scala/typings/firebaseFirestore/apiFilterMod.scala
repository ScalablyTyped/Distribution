...
object apiFilterMod {
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/api/filter", "QueryConstraint")
  @js.native
  ...
  inline def endAt(snapshot: DocumentSnapshot[Any]): typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("endAt")(snapshot.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint]
  ...
  inline def endBefore(snapshot: DocumentSnapshot[Any]): typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("endBefore")(snapshot.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint]
  ...
  inline def orderBy(fieldPath: FieldPath): typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint]
  inline def orderBy(fieldPath: FieldPath, directionStr: OrderByDirection): typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint = (^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any], directionStr.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint]
  ...
  inline def startAfter(snapshot: DocumentSnapshot[Any]): typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("startAfter")(snapshot.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint]
  ...
  inline def startAt(snapshot: DocumentSnapshot[Any]): typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("startAt")(snapshot.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint]
  ...
  inline def where(fieldPath: FieldPath, opStr: WhereFilterOp, value: Any): typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint = (^.asInstanceOf[js.Dynamic].applyDynamic("where")(fieldPath.asInstanceOf[js.Any], opStr.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseFirestore.srcLiteApiQueryMod.QueryConstraint]
}
