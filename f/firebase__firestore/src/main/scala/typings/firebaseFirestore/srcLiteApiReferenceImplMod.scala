...
import typings.firebaseFirestore.srcLiteApiSnapshotMod.QuerySnapshot
...
object srcLiteApiReferenceImplMod {
  ...
  inline def setDoc[T](
    ...
    options: typings.firebaseFirestore.srcLiteApiReferenceMod.SetOptions
