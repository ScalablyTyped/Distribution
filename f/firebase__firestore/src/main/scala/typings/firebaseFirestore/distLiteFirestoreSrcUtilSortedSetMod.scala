...
import typings.firebaseFirestore.distLiteFirestoreSrcUtilSortedMapMod.SortedMapIterator
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLiteFirestoreSrcUtilSortedSetMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/sorted_set", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/sorted_set", "SortedSet")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/sorted_set", "SortedSetIterator")
  @js.native
