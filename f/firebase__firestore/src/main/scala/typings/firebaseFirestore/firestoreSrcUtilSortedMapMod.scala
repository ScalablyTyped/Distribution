...
object firestoreSrcUtilSortedMapMod {
  ...
  object LLRBNode {
    ...
    @JSImport("@firebase/firestore/dist/packages/firestore/src/util/sorted_map", "LLRBNode.BLACK")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/packages/firestore/src/util/sorted_map", "LLRBNode.EMPTY")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/packages/firestore/src/util/sorted_map", "LLRBNode.RED")
    @js.native
