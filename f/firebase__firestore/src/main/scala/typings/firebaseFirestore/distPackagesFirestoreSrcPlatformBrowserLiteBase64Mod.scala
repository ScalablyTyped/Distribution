...
object distPackagesFirestoreSrcPlatformBrowserLiteBase64Mod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/browser_lite/base64", JSImport.Namespace)
  @js.native
