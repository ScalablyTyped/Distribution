...
object distLiteFirestoreSrcRemoteBloomFilterMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/bloom_filter", "BloomFilter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/bloom_filter", "BloomFilterError")
  @js.native
