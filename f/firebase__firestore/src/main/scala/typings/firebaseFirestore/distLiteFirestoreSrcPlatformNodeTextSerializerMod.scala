...
object distLiteFirestoreSrcPlatformNodeTextSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/node/text_serializer", JSImport.Namespace)
  @js.native
