...
import typings.firebaseFirestore.distLiteFirestoreSrcRemoteBackoffMod.ExponentialBackoff
import typings.firebaseFirestore.distLiteFirestoreSrcRemoteConnectionMod.Connection
import typings.firebaseFirestore.distLiteFirestoreSrcRemoteConnectionMod.Stream
...
object distLiteFirestoreSrcRemotePersistentStreamMod {
  ...
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typings.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typings.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
