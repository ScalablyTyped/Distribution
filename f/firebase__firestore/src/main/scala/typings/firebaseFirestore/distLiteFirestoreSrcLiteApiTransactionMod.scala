...
object distLiteFirestoreSrcLiteApiTransactionMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/transaction", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/transaction", "Transaction")
  @js.native
