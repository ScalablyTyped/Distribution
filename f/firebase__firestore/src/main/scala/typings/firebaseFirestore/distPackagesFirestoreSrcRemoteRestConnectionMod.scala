...
object distPackagesFirestoreSrcRemoteRestConnectionMod {
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/packages/firestore/src/remote/rest_connection", "RestConnection")
  @js.native
