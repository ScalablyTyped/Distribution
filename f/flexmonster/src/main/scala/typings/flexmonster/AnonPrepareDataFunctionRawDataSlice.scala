...
trait AnonPrepareDataFunctionRawDataSlice extends js.Object {
...
object AnonPrepareDataFunctionRawDataSlice {
  @scala.inline
  def apply(
  ...
  ): AnonPrepareDataFunctionRawDataSlice = {
    ...
    __obj.asInstanceOf[AnonPrepareDataFunctionRawDataSlice]
  }
}
