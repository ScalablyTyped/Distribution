...
@js.native
trait AnonCallbackHandlerError extends js.Object {
  def getData(options: AnonPrepareDataFunctionRawData, callbackHandler: String): Unit = js.native
  def getData(options: AnonPrepareDataFunctionRawData, callbackHandler: String, updateHandler: String): Unit = js.native
  def getData(
    options: AnonPrepareDataFunctionRawData,
