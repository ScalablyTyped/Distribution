...
@js.native
trait AnonCallbackHandlerErrorFormat extends js.Object {
  def getAxisFormat(format: js.Object): String = js.native
  def getData(options: AnonPrepareDataFunctionRawDataSlice, callbackHandler: String): Unit = js.native
  def getData(options: AnonPrepareDataFunctionRawDataSlice, callbackHandler: String, updateHandler: String): Unit = js.native
  def getData(
    options: AnonPrepareDataFunctionRawDataSlice,
