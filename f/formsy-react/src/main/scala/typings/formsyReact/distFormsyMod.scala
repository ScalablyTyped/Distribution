...
import typings.formsyReact.distInterfacesMod.IUpdateInputsWithValue
import typings.formsyReact.distInterfacesMod.InputComponent
...
object distFormsyMod {
  ...
  object FormsyProps {
    ...
    implicit open class MutableBuilder[Self <: FormsyProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnChange(value: (IModel, Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
