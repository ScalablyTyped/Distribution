...
object anon {
  ...
  object Disabled {
    ...
    implicit class DisabledMutableBuilder[Self <: Disabled] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisabled(value: Requireable[Boolean]): Self = StObject.set(x, "disabled", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMapping(value: Requireable[js.Function1[/* repeated */ _, _]]): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnChange(value: Requireable[js.Function1[/* repeated */ _, _]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnInvalid(value: Requireable[js.Function1[/* repeated */ _, _]]): Self = StObject.set(x, "onInvalid", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnInvalidSubmit(value: Requireable[js.Function1[/* repeated */ _, _]]): Self = StObject.set(x, "onInvalidSubmit", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnReset(value: Requireable[js.Function1[/* repeated */ _, _]]): Self = StObject.set(x, "onReset", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnSubmit(value: Requireable[js.Function1[/* repeated */ _, _]]): Self = StObject.set(x, "onSubmit", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnValid(value: Requireable[js.Function1[/* repeated */ _, _]]): Self = StObject.set(x, "onValid", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnValidSubmit(value: Requireable[js.Function1[/* repeated */ _, _]]): Self = StObject.set(x, "onValidSubmit", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreventDefaultSubmit(value: Requireable[Boolean]): Self = StObject.set(x, "preventDefaultSubmit", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreventExternalInvalidation(value: Requireable[Boolean]): Self = StObject.set(x, "preventExternalInvalidation", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValidationErrors(value: Requireable[js.Object]): Self = StObject.set(x, "validationErrors", value.asInstanceOf[js.Any])
    }
  }
  ...
  object IsRequired {
    ...
    @scala.inline
    implicit class IsRequiredMutableBuilder[Self <: IsRequired] (val x: Self) extends AnyVal {
  ...
  object PartialFormsyProps {
    ...
    @scala.inline
    implicit class PartialFormsyPropsMutableBuilder[Self <: PartialFormsyProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: (/* model */ IModel, /* isChanged */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnInvalidSubmitUndefined: Self = StObject.set(x, "onInvalidSubmit", js.undefined)
