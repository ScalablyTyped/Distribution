...
object anon {
  ...
  object Disabled {
    ...
    implicit class DisabledMutableBuilder[Self <: Disabled] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMapping(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnInvalid(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onInvalid", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnInvalidSubmit(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onInvalidSubmit", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnReset(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onReset", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnSubmit(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onSubmit", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnValid(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onValid", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnValidSubmit(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onValidSubmit", value.asInstanceOf[js.Any])
