...
trait FormsyProps extends FormHTMLAttributesCleaned {
  ...
  def onInvalidSubmit(model: IModel, resetModel: IResetModel, updateInputsWithError: IUpdateInputsWithError): Unit
  @JSName("onInvalid")
...
object FormsyProps {
  ...
  def apply(
    ...
    validationErrors: js.UndefOr[Null | js.Object] = js.undefined,
    vocab: String = null
  ): FormsyProps = {
    val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], onChange = js.Any.fromFunction2(onChange), onInvalid = js.Any.fromFunction0(onInvalid), onInvalidSubmit = js.Any.fromFunction3(onInvalidSubmit), onValid = js.Any.fromFunction0(onValid), mapping = js.Any.fromFunction1(mapping))
