...
object formsyMod {
  ...
  object FormHTMLAttributesCleaned {
    ...
    @scala.inline
    implicit class FormHTMLAttributesCleanedMutableBuilder[Self <: FormHTMLAttributesCleaned] (val x: Self) extends AnyVal {
  ...
  object FormsyProps {
    ...
    @scala.inline
    implicit class FormsyPropsMutableBuilder[Self <: FormsyProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setDisabled(value: Boolean): Self = StObject.set(x, "disabled", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMapping(value: /* model */ IModel => IModel): Self = StObject.set(x, "mapping", js.Any.fromFunction1(value))
      
      @scala.inline
      def setMappingNull: Self = StObject.set(x, "mapping", null)
      
      @scala.inline
      def setOnChange(value: (IModel, Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setPreventDefaultSubmit(value: Boolean): Self = StObject.set(x, "preventDefaultSubmit", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreventDefaultSubmitUndefined: Self = StObject.set(x, "preventDefaultSubmit", js.undefined)
      
      @scala.inline
      def setPreventExternalInvalidation(value: Boolean): Self = StObject.set(x, "preventExternalInvalidation", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreventExternalInvalidationUndefined: Self = StObject.set(x, "preventExternalInvalidation", js.undefined)
  ...
  object FormsyState {
    ...
    @scala.inline
    implicit class FormsyStateMutableBuilder[Self <: FormsyState] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setCanChange(value: Boolean): Self = StObject.set(x, "canChange", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setContextValue(value: FormsyContextInterface): Self = StObject.set(x, "contextValue", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFormSubmitted(value: Boolean): Self = StObject.set(x, "formSubmitted", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFormSubmittedUndefined: Self = StObject.set(x, "formSubmitted", js.undefined)
      
      @scala.inline
      def setIsPristine(value: Boolean): Self = StObject.set(x, "isPristine", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsPristineUndefined: Self = StObject.set(x, "isPristine", js.undefined)
