...
object PartialFormsyProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(preventDefaultSubmit)) __obj.updateDynamic("preventDefaultSubmit")(preventDefaultSubmit.get.asInstanceOf[js.Any])
    if (!js.isUndefined(preventExternalInvalidation)) __obj.updateDynamic("preventExternalInvalidation")(preventExternalInvalidation.get.asInstanceOf[js.Any])
