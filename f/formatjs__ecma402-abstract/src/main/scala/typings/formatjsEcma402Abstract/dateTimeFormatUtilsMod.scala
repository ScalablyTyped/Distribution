...
object dateTimeFormatUtilsMod {
  
  @JSImport("@formatjs/ecma402-abstract/lib/DateTimeFormat/utils", "DATE_TIME_PROPS")
  @js.native
  ...
  @JSImport("@formatjs/ecma402-abstract/lib/DateTimeFormat/utils", "additionPenalty")
  @js.native
  val additionPenalty: /* 20 */ Double = js.native
  
  @JSImport("@formatjs/ecma402-abstract/lib/DateTimeFormat/utils", "differentNumericTypePenalty")
  @js.native
  val differentNumericTypePenalty: /* 15 */ Double = js.native
  
  @JSImport("@formatjs/ecma402-abstract/lib/DateTimeFormat/utils", "longLessPenalty")
  @js.native
  val longLessPenalty: /* 8 */ Double = js.native
  
  @JSImport("@formatjs/ecma402-abstract/lib/DateTimeFormat/utils", "longMorePenalty")
  @js.native
  val longMorePenalty: /* 6 */ Double = js.native
  
  @JSImport("@formatjs/ecma402-abstract/lib/DateTimeFormat/utils", "removalPenalty")
  @js.native
  val removalPenalty: /* 120 */ Double = js.native
  
  @JSImport("@formatjs/ecma402-abstract/lib/DateTimeFormat/utils", "shortLessPenalty")
  @js.native
  val shortLessPenalty: /* 6 */ Double = js.native
  
  @JSImport("@formatjs/ecma402-abstract/lib/DateTimeFormat/utils", "shortMorePenalty")
  @js.native
