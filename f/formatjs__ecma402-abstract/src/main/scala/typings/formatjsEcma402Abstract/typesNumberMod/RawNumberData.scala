...
import typings.formatjsEcma402Abstract.anon.LongShort
...
object RawNumberData {
  ...
  implicit class RawNumberDataOps[Self <: RawNumberData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDecimal(value: Record[NumberingSystem, LongShort]): Self = this.set("decimal", value.asInstanceOf[js.Any])
