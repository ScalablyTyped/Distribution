...
@JSImport("@formatjs/ecma402-abstract/DateTimeFormat/FormatDateTimeToParts", JSImport.Namespace)
@js.native
object dateTimeFormatFormatDateTimeToPartsMod extends js.Object {
  
  @JSName("FormatDateTimeToParts")
