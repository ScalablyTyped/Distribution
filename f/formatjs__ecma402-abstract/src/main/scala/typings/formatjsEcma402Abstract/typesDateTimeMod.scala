...
object typesDateTimeMod {
  ...
  object RangePatternType extends StObject {
    ...
    /* "endRange" */ val endRange: typings.formatjsEcma402Abstract.typesDateTimeMod.RangePatternType.endRange & String = js.native
    
    @js.native
    sealed trait shared
      extends StObject
         with RangePatternType
    /* "shared" */ val shared: typings.formatjsEcma402Abstract.typesDateTimeMod.RangePatternType.shared & String = js.native
    
    @js.native
    sealed trait startRange
      extends StObject
         with RangePatternType
    /* "startRange" */ val startRange: typings.formatjsEcma402Abstract.typesDateTimeMod.RangePatternType.startRange & String = js.native
  }
  ...
  /* Inlined std.Pick<std.Intl.DateTimeFormatOptions, 'weekday' | 'era' | 'year' | 'month' | 'day' | 'dayPeriod' | 'hour' | 'minute' | 'second' | 'timeZoneName'> & {  fractionalSecondDigits :1 | 2 | 3 | undefined,   hour12 :boolean | undefined,   pattern :string,   pattern12 :string,   skeleton :string,   rawPattern :string,   rangePatterns :std.Record<@formatjs/ecma402-abstract.@formatjs/ecma402-abstract/types/date-time.TABLE_2 | 'default', @formatjs/ecma402-abstract.@formatjs/ecma402-abstract/types/date-time.RangePatterns>,   rangePatterns12 :std.Record<@formatjs/ecma402-abstract.@formatjs/ecma402-abstract/types/date-time.TABLE_2 | 'default', @formatjs/ecma402-abstract.@formatjs/ecma402-abstract/types/date-time.RangePatterns>} */
