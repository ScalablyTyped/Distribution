...
import typings.formatjsEcma402Abstract.libTypesDisplaynamesMod.ScriptCode
...
object LongNarrowShort {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LongNarrowShort] (val x: Self) extends AnyVal {
