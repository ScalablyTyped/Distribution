...
import typings.formatjsEcma402Abstract.libTypesDateTimeMod.RangePatterns
...
object RecordTABLE2defaultRangeP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RecordTABLE2defaultRangeP] (val x: Self) extends AnyVal {
