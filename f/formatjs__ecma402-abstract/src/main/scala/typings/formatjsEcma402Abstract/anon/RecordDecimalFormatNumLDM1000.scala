...
import typings.formatjsEcma402Abstract.typesNumberMod.LDMLPluralRuleMap
...
object RecordDecimalFormatNumLDM1000 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RecordDecimalFormatNumLDM1000] (val x: Self) extends AnyVal {
