...
trait LongRecordNarrowRecordShortRecord extends StObject {
...
object LongRecordNarrowRecordShortRecord {
  
  inline def apply(
    long: Record[ScriptCode, String],
    narrow: Record[ScriptCode, String],
    short: Record[ScriptCode, String]
  ): LongRecordNarrowRecordShortRecord = {
    val __obj = js.Dynamic.literal(long = long.asInstanceOf[js.Any], narrow = narrow.asInstanceOf[js.Any], short = short.asInstanceOf[js.Any])
    __obj.asInstanceOf[LongRecordNarrowRecordShortRecord]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LongRecordNarrowRecordShortRecord] (val x: Self) extends AnyVal {
