...
object typesRelativeTimeMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.formatjsEcma402Abstract.formatjsEcma402AbstractUtilsMod.LiteralPart
    - typings.formatjsEcma402Abstract.typesRelativeTimeMod.RelativeTimeFormatNumberPart
  */
  trait RelativeTimePart extends StObject
  object RelativeTimePart {
    
    inline def LiteralPart(value: String): typings.formatjsEcma402Abstract.formatjsEcma402AbstractUtilsMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("literal")
      __obj.asInstanceOf[typings.formatjsEcma402Abstract.formatjsEcma402AbstractUtilsMod.LiteralPart]
    }
    
    inline def RelativeTimeFormatNumberPart(`type`: NumberFormatPartTypes, unit: RelativeTimeUnit, value: String): typings.formatjsEcma402Abstract.typesRelativeTimeMod.RelativeTimeFormatNumberPart = {
      val __obj = js.Dynamic.literal(unit = unit.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.formatjsEcma402Abstract.typesRelativeTimeMod.RelativeTimeFormatNumberPart]
    }
  }
