...
object dataMod {
  ...
  @JSImport("@formatjs/ecma402-abstract/data", "isMissingLocaleDataError")
  @js.native
  def isMissingLocaleDataError(e: Error): /* is @formatjs/ecma402-abstract.@formatjs/ecma402-abstract/data.MissingLocaleDataError */ Boolean = js.native
