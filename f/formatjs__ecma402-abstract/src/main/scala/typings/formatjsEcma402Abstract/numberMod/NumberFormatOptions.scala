...
- typings.formatjsEcma402Abstract.numberMod.NumberFormatDigitOptions because var conflicts: maximumFractionDigits, maximumSignificantDigits, minimumFractionDigits, minimumIntegerDigits, minimumSignificantDigits. Inlined  */ trait NumberFormatOptions
  extends StObject
