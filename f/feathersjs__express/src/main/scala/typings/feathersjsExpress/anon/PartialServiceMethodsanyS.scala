...
object PartialServiceMethodsanyS {
  ...
  implicit class PartialServiceMethodsanySOps[Self <: PartialServiceMethodsanyS] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreate(value: /* data */ Partial[_] => js.Promise[_ | js.Array[_]]): Self = this.set("create", js.Any.fromFunction1(value))
    @scala.inline
    def deleteCreate: Self = this.set("create", js.undefined)
    @scala.inline
    def setFind(value: () => js.Promise[_ | js.Array[_] | Paginated[_]]): Self = this.set("find", js.Any.fromFunction0(value))
    @scala.inline
    def deleteFind: Self = this.set("find", js.undefined)
    @scala.inline
    def setGet(value: /* id */ Id => js.Promise[_]): Self = this.set("get", js.Any.fromFunction1(value))
    @scala.inline
    def deleteGet: Self = this.set("get", js.undefined)
    @scala.inline
    def setPatch(value: (/* id */ NullableId, /* data */ Partial[_]) => js.Promise[_]): Self = this.set("patch", js.Any.fromFunction2(value))
    @scala.inline
    def deletePatch: Self = this.set("patch", js.undefined)
    @scala.inline
    def setRemove(value: /* id */ NullableId => js.Promise[_]): Self = this.set("remove", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setUpdate(value: (/* id */ NullableId, /* data */ js.Any) => js.Promise[_]): Self = this.set("update", js.Any.fromFunction2(value))
    @scala.inline
