...
trait EventResizeStartStopArg extends StObject {
...
object EventResizeStartStopArg {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EventResizeStartStopArg]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EventResizeStartStopArg] (val x: Self) extends AnyVal {
