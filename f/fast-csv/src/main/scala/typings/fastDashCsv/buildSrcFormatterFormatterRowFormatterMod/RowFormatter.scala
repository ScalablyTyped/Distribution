...
object RowFormatter {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(callTransformer = callTransformer.asInstanceOf[js.Any], checkHeaders = checkHeaders.asInstanceOf[js.Any], fieldFormatter = fieldFormatter.asInstanceOf[js.Any], format = js.Any.fromFunction2(format), formatColumns = formatColumns.asInstanceOf[js.Any], formatterOptions = formatterOptions.asInstanceOf[js.Any], gatherColumns = gatherColumns.asInstanceOf[js.Any], hasWrittenHeaders = hasWrittenHeaders.asInstanceOf[js.Any], headers = headers.asInstanceOf[js.Any], rowCount = rowCount.asInstanceOf[js.Any], rowTransform = js.Any.fromFunction1(rowTransform), shouldWriteHeaders = shouldWriteHeaders.asInstanceOf[js.Any])
