...
@JSImport("fflate", "ZipPassThrough")
@js.native
open class ZipPassThrough protected ()
  ...
  @JSName("ondata")
  def ondata_MZipPassThrough(err: Null, data: js.typedarray.Uint8Array, `final`: Boolean): Unit = js.native
  @JSName("ondata")
  def ondata_MZipPassThrough(err: FlateError, data: js.typedarray.Uint8Array, `final`: Boolean): Unit = js.native
  @JSName("ondata")
