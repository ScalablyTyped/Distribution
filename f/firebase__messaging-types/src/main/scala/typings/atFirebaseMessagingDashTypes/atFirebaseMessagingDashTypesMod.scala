package typings.atFirebaseMessagingDashTypes
...
@JSImport("@firebase/messaging-types", JSImport.Namespace)
@js.native
object atFirebaseMessagingDashTypesMod extends js.Object {
  @js.native
