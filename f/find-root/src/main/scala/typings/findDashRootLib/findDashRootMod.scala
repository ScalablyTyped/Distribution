...
@js.native
object findDashRootMod extends js.Object {
  /**
   ...
   * @throws {Error} if package.json cannot be found or if the function never returns true
   */
  def apply(startingPath: java.lang.String, check: findDashRootLib.FindRootCheckFn): java.lang.String = js.native
}
