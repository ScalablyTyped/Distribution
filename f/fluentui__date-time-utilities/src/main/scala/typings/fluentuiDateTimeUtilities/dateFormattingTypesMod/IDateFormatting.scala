...
object IDateFormatting {
  ...
  def apply(
    ...
    formatMonthDayYear: Date => String,
  ...
  implicit class IDateFormattingOps[Self <: IDateFormatting] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormatMonthDayYear(value: Date => String): Self = this.set("formatMonthDayYear", js.Any.fromFunction1(value))
    @scala.inline
    def setFormatMonthYear(value: Date => String): Self = this.set("formatMonthYear", js.Any.fromFunction1(value))
    @scala.inline
