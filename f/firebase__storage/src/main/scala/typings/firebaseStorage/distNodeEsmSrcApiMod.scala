...
object distNodeEsmSrcApiMod {
  ...
  @JSImport("@firebase/storage/dist/node-esm/src/api", "StorageError")
  @js.native
  open class StorageError protected ()
    extends typings.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageError {
    /**
  ...
  @JSImport("@firebase/storage/dist/node-esm/src/api", "StorageErrorCode")
  @js.native
