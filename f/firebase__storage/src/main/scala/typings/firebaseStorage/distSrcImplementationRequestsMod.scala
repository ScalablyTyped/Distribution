...
import typings.firebaseStorage.distSrcImplementationLocationMod.Location
import typings.firebaseStorage.distSrcImplementationMetadataMod.Mappings
import typings.firebaseStorage.distSrcImplementationRequestinfoMod.RequestInfo
