...
object firebaseStorageStrings {
  ...
  @js.native
  sealed trait storageBucket extends js.Object
  ...
  @scala.inline
  def storageBucket: storageBucket = "storageBucket".asInstanceOf[storageBucket]
  @scala.inline
  def `totally-legit-auth-token`: `totally-legit-auth-token` = "totally-legit-auth-token".asInstanceOf[`totally-legit-auth-token`]
}
