...
object distNodeEsmTestUnitConnectionMod {
  ...
  object State extends StObject {
    ...
    sealed trait DONE
      extends StObject
         with State
    /* 2 */ val DONE: typings.firebaseStorage.distNodeEsmTestUnitConnectionMod.State.DONE & Double = js.native
    
    @js.native
    sealed trait SENT
      extends StObject
         with State
    /* 1 */ val SENT: typings.firebaseStorage.distNodeEsmTestUnitConnectionMod.State.SENT & Double = js.native
    
    @js.native
    sealed trait START
      extends StObject
         with State
    /* 0 */ val START: typings.firebaseStorage.distNodeEsmTestUnitConnectionMod.State.START & Double = js.native
  }
