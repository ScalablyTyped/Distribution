...
object implementationMetadataMod {
  ...
  inline def toResourceString(metadata: PartialMetadataBucket, mappings: Mappings): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toResourceString")(metadata.asInstanceOf[js.Any], mappings.asInstanceOf[js.Any])).asInstanceOf[String]
