...
import typings.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageErrorCode
...
object distNodeEsmSrcIndexDotnodeMod {
  ...
  open class FbsBlob protected ()
    extends typings.firebaseStorage.distNodeEsmSrcApiMod.FbsBlob {
  ...
  open class FirebaseStorageImpl protected ()
    extends typings.firebaseStorage.distNodeEsmSrcApiMod.FirebaseStorageImpl {
    def this(
      /**
  ...
  open class Location protected ()
    extends typings.firebaseStorage.distNodeEsmSrcApiMod.Location {
  ...
  open class Reference protected ()
    extends typings.firebaseStorage.distNodeEsmSrcApiMod.Reference {
  ...
  @JSImport("@firebase/storage/dist/node-esm/src/index.node", "StorageError")
  @js.native
  open class StorageError protected ()
    extends typings.firebaseStorage.distNodeEsmSrcApiMod.StorageError {
    /**
  ...
  @JSImport("@firebase/storage/dist/node-esm/src/index.node", "StorageErrorCode")
  @js.native
  object StorageErrorCode extends StObject {
    
    @JSBracketAccess
    def apply(value: String): js.UndefOr[
        typings.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageErrorCode & String
      ] = js.native
  ...
  open class UploadTask protected ()
    extends typings.firebaseStorage.distNodeEsmSrcApiMod.UploadTask {
    /**
  ...
  inline def invalidArgument(message: String): typings.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageError = ^.asInstanceOf[js.Dynamic].applyDynamic("_invalidArgument")(message.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageError]
  
  inline def invalidRootOperation(name: String): typings.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageError = ^.asInstanceOf[js.Dynamic].applyDynamic("_invalidRootOperation")(name.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageError]
