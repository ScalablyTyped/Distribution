...
object typeMod {
  ...
  inline def isFunction(p: js.Any): /* is std.Function */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFunction")(p.asInstanceOf[js.Any]).asInstanceOf[/* is std.Function */ Boolean]
  ...
  inline def isNativeBlob(p: js.Any): /* is std.Blob */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNativeBlob")(p.asInstanceOf[js.Any]).asInstanceOf[/* is std.Blob */ Boolean]
  
  inline def isNativeBlobDefined(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNativeBlobDefined")().asInstanceOf[Boolean]
  
  inline def isNonArrayObject(p: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNonArrayObject")(p.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  inline def isString(p: js.Any): /* is string */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isString")(p.asInstanceOf[js.Any]).asInstanceOf[/* is string */ Boolean]
