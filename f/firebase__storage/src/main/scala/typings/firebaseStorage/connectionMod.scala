...
object connectionMod {
  ...
  object ErrorCode extends StObject {
    ...
    sealed trait ABORT
      extends StObject
         with ErrorCode
    /* 2 */ val ABORT: typings.firebaseStorage.connectionMod.ErrorCode.ABORT & Double = js.native
    
    @js.native
    sealed trait NETWORK_ERROR
      extends StObject
         with ErrorCode
    /* 1 */ val NETWORK_ERROR: typings.firebaseStorage.connectionMod.ErrorCode.NETWORK_ERROR & Double = js.native
    
    @js.native
    sealed trait NO_ERROR
      extends StObject
         with ErrorCode
    /* 0 */ val NO_ERROR: typings.firebaseStorage.connectionMod.ErrorCode.NO_ERROR & Double = js.native
  }
