...
object stringMod {
  ...
  object StringFormat {
    ...
    inline def BASE64URL_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BASE64URL")(x.asInstanceOf[js.Any])
    
    inline def BASE64_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BASE64")(x.asInstanceOf[js.Any])
    
    @JSImport("@firebase/storage/dist/src/implementation/string", "StringFormat.DATA_URL")
    @js.native
    def DATA_URL: String = js.native
    inline def DATA_URL_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DATA_URL")(x.asInstanceOf[js.Any])
  ...
  inline def base64Bytes(format: StringFormat, value: String): Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("base64Bytes_")(format.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Uint8Array]
  ...
  inline def dataURLBytes(dataUrl: String): Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("dataURLBytes_")(dataUrl.asInstanceOf[js.Any]).asInstanceOf[Uint8Array]
  ...
  inline def percentEncodedBytes(value: String): Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("percentEncodedBytes_")(value.asInstanceOf[js.Any]).asInstanceOf[Uint8Array]
  
  inline def utf8Bytes(value: String): Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("utf8Bytes_")(value.asInstanceOf[js.Any]).asInstanceOf[Uint8Array]
}
