...
import typings.firebaseStorage.distNodeEsmSrcTaskMod.UploadTask
...
object distNodeEsmSrcReferenceMod {
  ...
  inline def getStreamInternal(ref: Reference): ReadableStream = ^.asInstanceOf[js.Dynamic].applyDynamic("getStreamInternal")(ref.asInstanceOf[js.Any]).asInstanceOf[ReadableStream]
  inline def getStreamInternal(ref: Reference, maxDownloadSizeBytes: Double): ReadableStream = (^.asInstanceOf[js.Dynamic].applyDynamic("getStreamInternal")(ref.asInstanceOf[js.Any], maxDownloadSizeBytes.asInstanceOf[js.Any])).asInstanceOf[ReadableStream]
