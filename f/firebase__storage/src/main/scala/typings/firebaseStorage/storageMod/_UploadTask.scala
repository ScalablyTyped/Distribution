...
@JSImport("@firebase/storage/dist/storage", "_UploadTask")
@js.native
open class _UploadTask protected () extends StObject {
  /**
  ...
  /**
    ...
    *     callbacks.
    */
  def on(`type`: _TaskEvent): Unsubscribe2 | Subscribe2[UploadTaskSnapshot] = js.native
  def on(`type`: _TaskEvent, nextOrObserver: js.Function1[/* snapshot */ UploadTaskSnapshot, Any]): Unsubscribe2 | Subscribe2[UploadTaskSnapshot] = js.native
  def on(
    `type`: _TaskEvent,
  ...
  def on(`type`: _TaskEvent, nextOrObserver: Null, error: Null, completed: Unsubscribe2): Unsubscribe2 | Subscribe2[UploadTaskSnapshot] = js.native
  def on(`type`: _TaskEvent, nextOrObserver: Null, error: Unit, completed: Unsubscribe2): Unsubscribe2 | Subscribe2[UploadTaskSnapshot] = js.native
  ...
  def on(`type`: _TaskEvent, nextOrObserver: Unit, error: Null, completed: Unsubscribe2): Unsubscribe2 | Subscribe2[UploadTaskSnapshot] = js.native
  def on(`type`: _TaskEvent, nextOrObserver: Unit, error: Unit, completed: Unsubscribe2): Unsubscribe2 | Subscribe2[UploadTaskSnapshot] = js.native
  def on(`type`: _TaskEvent, nextOrObserver: StorageObserver[UploadTaskSnapshot]): Unsubscribe2 | Subscribe2[UploadTaskSnapshot] = js.native
  def on(
    `type`: _TaskEvent,
