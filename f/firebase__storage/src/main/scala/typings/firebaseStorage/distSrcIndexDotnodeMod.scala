...
object distSrcIndexDotnodeMod {
  
  @JSImport("@firebase/storage/dist/src/index.node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/storage/dist/src/index.node", "_FbsBlob")
  @js.native
  ...
  @JSImport("@firebase/storage/dist/src/index.node", "_FirebaseStorageImpl")
  @js.native
  ...
  @JSImport("@firebase/storage/dist/src/index.node", "_Location")
  @js.native
  ...
  @JSImport("@firebase/storage/dist/src/index.node", "_Reference")
  @js.native
  ...
  @JSImport("@firebase/storage/dist/src/index.node", "StorageError")
  @js.native
  ...
  @JSImport("@firebase/storage/dist/src/index.node", "StorageErrorCode")
  @js.native
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/src/index.node", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("@firebase/storage/dist/src/index.node", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/src/index.node", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/src/index.node", "StringFormat.RAW")
    @js.native
  ...
  object TaskEvent {
    ...
    @JSImport("@firebase/storage/dist/src/index.node", "_TaskEvent")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      * </ul>
      */
    @JSImport("@firebase/storage/dist/src/index.node", "_TaskEvent.STATE_CHANGED")
    @js.native
  ...
  object TaskState {
    ...
    @JSImport("@firebase/storage/dist/src/index.node", "_TaskState.CANCELED")
    @js.native
    val CANCELED: canceled = js.native
    
    /** The task failed with an error. */
    @JSImport("@firebase/storage/dist/src/index.node", "_TaskState.ERROR")
    @js.native
    val ERROR: error = js.native
    
    /** The task was paused by the user. */
    @JSImport("@firebase/storage/dist/src/index.node", "_TaskState.PAUSED")
    @js.native
    val PAUSED: paused = js.native
    
    /** The task is currently transferring data. */
    @JSImport("@firebase/storage/dist/src/index.node", "_TaskState.RUNNING")
    @js.native
    val RUNNING: running = js.native
    
    /** The task completed successfully. */
    @JSImport("@firebase/storage/dist/src/index.node", "_TaskState.SUCCESS")
    @js.native
    val SUCCESS: success = js.native
  }
  
  @JSImport("@firebase/storage/dist/src/index.node", "_UploadTask")
  @js.native
