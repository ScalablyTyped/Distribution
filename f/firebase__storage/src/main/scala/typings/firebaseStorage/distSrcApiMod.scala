...
object distSrcApiMod {
  ...
  open class FbsBlob protected ()
    extends typings.firebaseStorage.distSrcImplementationBlobMod.FbsBlob {
  ...
  open class FirebaseStorageImpl protected ()
    extends typings.firebaseStorage.distSrcServiceMod.FirebaseStorageImpl {
    def this(
      /**
  ...
  open class Location protected ()
    extends typings.firebaseStorage.distSrcImplementationLocationMod.Location {
  ...
  open class Reference protected ()
    extends typings.firebaseStorage.distSrcReferenceMod.Reference {
  ...
  open class UploadTask protected ()
    extends typings.firebaseStorage.distSrcTaskMod.UploadTask {
    /**
