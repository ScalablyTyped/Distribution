...
object srcApiMod {
  ...
  @JSImport("@firebase/storage/dist/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/storage/dist/src/api", "_FbsBlob")
  @js.native
  open class FbsBlob protected ()
    extends typings.firebaseStorage.implementationBlobMod.FbsBlob {
  ...
  @JSImport("@firebase/storage/dist/src/api", "_FirebaseStorageImpl")
  @js.native
  open class FirebaseStorageImpl protected ()
    extends typings.firebaseStorage.srcServiceMod.FirebaseStorageImpl {
    def this(
      /**
  ...
  @JSImport("@firebase/storage/dist/src/api", "_Location")
  @js.native
  open class Location protected ()
    extends typings.firebaseStorage.implementationLocationMod.Location {
  ...
  @JSImport("@firebase/storage/dist/src/api", "_Reference")
  @js.native
  open class Reference protected ()
    extends typings.firebaseStorage.srcReferenceMod.Reference {
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/src/api", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("@firebase/storage/dist/src/api", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/src/api", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/src/api", "StringFormat.RAW")
    @js.native
  ...
  object TaskEvent {
    ...
    @JSImport("@firebase/storage/dist/src/api", "_TaskEvent")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      * </ul>
      */
    @JSImport("@firebase/storage/dist/src/api", "_TaskEvent.STATE_CHANGED")
    @js.native
  ...
  object TaskState {
    ...
    @JSImport("@firebase/storage/dist/src/api", "_TaskState.CANCELED")
    @js.native
    val CANCELED: canceled = js.native
    
    /** The task failed with an error. */
    @JSImport("@firebase/storage/dist/src/api", "_TaskState.ERROR")
    @js.native
    val ERROR: error = js.native
    
    /** The task was paused by the user. */
    @JSImport("@firebase/storage/dist/src/api", "_TaskState.PAUSED")
    @js.native
    val PAUSED: paused = js.native
    
    /** The task is currently transferring data. */
    @JSImport("@firebase/storage/dist/src/api", "_TaskState.RUNNING")
    @js.native
    val RUNNING: running = js.native
    
    /** The task completed successfully. */
    @JSImport("@firebase/storage/dist/src/api", "_TaskState.SUCCESS")
    @js.native
    val SUCCESS: success = js.native
  }
  
  @JSImport("@firebase/storage/dist/src/api", "_UploadTask")
  @js.native
  open class UploadTask protected ()
    extends typings.firebaseStorage.srcTaskMod.UploadTask {
    /**
