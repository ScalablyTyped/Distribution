...
object taskenumsMod {
  ...
  object InternalTaskState {
    ...
    inline def CANCELING_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CANCELING")(x.asInstanceOf[js.Any])
    ...
    inline def PAUSING_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PAUSING")(x.asInstanceOf[js.Any])
