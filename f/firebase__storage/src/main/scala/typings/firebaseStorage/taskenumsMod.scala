...
object taskenumsMod {
  ...
  @JSImport("@firebase/storage/dist/node-esm/src/implementation/taskenums", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object TaskEvent {
    
    @JSImport("@firebase/storage/dist/node-esm/src/implementation/taskenums", "TaskEvent")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      * </ul>
      */
    @JSImport("@firebase/storage/dist/node-esm/src/implementation/taskenums", "TaskEvent.STATE_CHANGED")
    @js.native
  ...
  */
  ...
  object TaskState {
    ...
    @JSImport("@firebase/storage/dist/node-esm/src/implementation/taskenums", "TaskState.CANCELED")
    @js.native
    val CANCELED: canceled = js.native
    
    /** The task failed with an error. */
    @JSImport("@firebase/storage/dist/node-esm/src/implementation/taskenums", "TaskState.ERROR")
    @js.native
    val ERROR: error = js.native
    
    /** The task was paused by the user. */
    @JSImport("@firebase/storage/dist/node-esm/src/implementation/taskenums", "TaskState.PAUSED")
    @js.native
    val PAUSED: paused = js.native
    
    /** The task is currently transferring data. */
    @JSImport("@firebase/storage/dist/node-esm/src/implementation/taskenums", "TaskState.RUNNING")
    @js.native
    val RUNNING: running = js.native
    
    /** The task completed successfully. */
    @JSImport("@firebase/storage/dist/node-esm/src/implementation/taskenums", "TaskState.SUCCESS")
    @js.native
