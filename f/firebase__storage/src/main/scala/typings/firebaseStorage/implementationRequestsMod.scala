...
import typings.firebaseStorage.implementationMetadataMod.Mappings
...
object implementationRequestsMod {
  
  @JSImport("@firebase/storage/dist/src/implementation/requests", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/storage/dist/src/implementation/requests", "RESUMABLE_UPLOAD_CHUNK_SIZE")
  @js.native
  ...
  inline def updateMetadata(
    service: FirebaseStorageImpl,
    location: Location,
    metadata: PartialMetadataBucket,
    mappings: Mappings
  ): RequestInfo[String, Metadata] = (^.asInstanceOf[js.Dynamic].applyDynamic("updateMetadata")(service.asInstanceOf[js.Any], location.asInstanceOf[js.Any], metadata.asInstanceOf[js.Any], mappings.asInstanceOf[js.Any])).asInstanceOf[RequestInfo[String, Metadata]]
}
