...
object distSrcImplementationConnectionMod {
  
  @js.native
  sealed trait ErrorCode extends StObject
  @JSImport("@firebase/storage/dist/src/implementation/connection", "ErrorCode")
  @js.native
  object ErrorCode extends StObject {
    ...
    sealed trait ABORT
      extends StObject
         with ErrorCode
    /* 2 */ val ABORT: typings.firebaseStorage.distSrcImplementationConnectionMod.ErrorCode.ABORT & Double = js.native
    
    @js.native
    sealed trait NETWORK_ERROR
      extends StObject
         with ErrorCode
    /* 1 */ val NETWORK_ERROR: typings.firebaseStorage.distSrcImplementationConnectionMod.ErrorCode.NETWORK_ERROR & Double = js.native
    
    @js.native
    sealed trait NO_ERROR
      extends StObject
         with ErrorCode
    /* 0 */ val NO_ERROR: typings.firebaseStorage.distSrcImplementationConnectionMod.ErrorCode.NO_ERROR & Double = js.native
  }
