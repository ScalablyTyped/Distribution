...
import typings.firebaseStorage.distNodeEsmSrcImplementationConnectionMod.ErrorCode
...
object distNodeEsmSrcPlatformNodeConnectionMod {
  
  @JSImport("@firebase/storage/dist/node-esm/src/platform/node/connection", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/storage/dist/node-esm/src/platform/node/connection", "FetchBytesConnection")
  @js.native
  open class FetchBytesConnection ()
    extends StObject
       with FetchConnection[js.typedarray.ArrayBuffer]
  
  @JSImport("@firebase/storage/dist/node-esm/src/platform/node/connection", "FetchStreamConnection")
  @js.native
  ...
  @JSImport("@firebase/storage/dist/node-esm/src/platform/node/connection", "FetchTextConnection")
  @js.native
