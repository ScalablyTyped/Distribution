...
object distTestUnitConnectionMod {
  ...
  object State extends StObject {
    ...
    sealed trait DONE
      extends StObject
         with State
    /* 2 */ val DONE: typings.firebaseStorage.distTestUnitConnectionMod.State.DONE & Double = js.native
    
    @js.native
    sealed trait SENT
      extends StObject
         with State
    /* 1 */ val SENT: typings.firebaseStorage.distTestUnitConnectionMod.State.SENT & Double = js.native
    
    @js.native
    sealed trait START
      extends StObject
         with State
    /* 0 */ val START: typings.firebaseStorage.distTestUnitConnectionMod.State.START & Double = js.native
  }
