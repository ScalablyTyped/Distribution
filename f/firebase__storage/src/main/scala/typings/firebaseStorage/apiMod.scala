...
object apiMod {
  ...
  open class FbsBlob protected ()
    extends typings.firebaseStorage.blobMod.FbsBlob {
  ...
  open class FirebaseStorageImpl protected ()
    extends typings.firebaseStorage.serviceMod.FirebaseStorageImpl {
    def this(
      /**
  ...
  open class Location protected ()
    extends typings.firebaseStorage.locationMod.Location {
  ...
  open class Reference protected ()
    extends typings.firebaseStorage.referenceMod.Reference {
  ...
  open class UploadTask protected ()
    extends typings.firebaseStorage.taskMod.UploadTask {
    /**
