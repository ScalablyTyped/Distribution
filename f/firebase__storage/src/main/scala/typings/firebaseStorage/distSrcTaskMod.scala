...
import typings.firebaseStorage.distSrcImplementationBlobMod.FbsBlob
import typings.firebaseStorage.distSrcImplementationErrorMod.StorageError
import typings.firebaseStorage.distSrcImplementationObserverMod.Subscribe
import typings.firebaseStorage.distSrcImplementationObserverMod.Unsubscribe
import typings.firebaseStorage.distSrcImplementationTaskenumsMod.InternalTaskState
import typings.firebaseStorage.distSrcImplementationTaskenumsMod.TaskEvent
import typings.firebaseStorage.distSrcMetadataMod.Metadata
import typings.firebaseStorage.distSrcPublicTypesMod.StorageObserver
import typings.firebaseStorage.distSrcPublicTypesMod.UploadTaskSnapshot
...
object distSrcTaskMod {
  ...
  open class UploadTask protected () extends StObject {
    ...
    def on(`type`: TaskEvent, nextOrObserver: Null, error: Unit, completed: CompleteFn): Unsubscribe | Subscribe[UploadTaskSnapshot] = js.native
    ...
    def on(`type`: TaskEvent, nextOrObserver: Unit, error: Null, completed: CompleteFn): Unsubscribe | Subscribe[UploadTaskSnapshot] = js.native
