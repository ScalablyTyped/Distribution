...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "google-cloud__common" % "2.2.2-1b3066",
  "org.scalablytyped" %%% "google-cloud__firestore" % "2.3.0-063821",
  "org.scalablytyped" %%% "google-cloud__storage" % "3.3.1-f7d99d",
  "org.scalablytyped" %%% "gtoken" % "4.1.0-1da488",
  "org.scalablytyped" %%% "node" % "12.7-dt-20191008Z-c62b25",
  "org.scalablytyped" %%% "std" % "3.6-b80e7a",
  "org.scalablytyped" %%% "teeny-request" % "5.2.1-110027")
