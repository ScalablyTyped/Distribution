...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "google-cloud__common" % "2.2.2-e10fc6",
  "org.scalablytyped" %%% "google-cloud__firestore" % "2.4.0-4e8e06",
  "org.scalablytyped" %%% "google-cloud__storage" % "3.5.0-d9d5b7",
