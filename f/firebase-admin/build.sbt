...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "google-cloud__common" % "2.0.4-1689b5",
  "org.scalablytyped" %%% "google-cloud__firestore" % "2.2.4-e5b5d7",
  "org.scalablytyped" %%% "google-cloud__storage" % "3.0.3-eb0d85",
