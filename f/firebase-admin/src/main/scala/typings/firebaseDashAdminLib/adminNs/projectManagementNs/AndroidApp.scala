...
trait AndroidApp extends js.Object {
  ...
  /**
    ...
    */
  def addShaCertificate(certificateToAdd: ShaCertificate): js.Promise[scala.Unit]
  /**
    ...
    */
  def deleteShaCertificate(certificateToRemove: ShaCertificate): js.Promise[scala.Unit]
  /**
...
object AndroidApp {
  @scala.inline
  def apply(
    addShaCertificate: ShaCertificate => js.Promise[scala.Unit],
    appId: java.lang.String,
    deleteShaCertificate: ShaCertificate => js.Promise[scala.Unit],
