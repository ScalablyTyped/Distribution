...
trait MessagingOptions
  extends /* key */ org.scalablytyped.runtime.StringDictionary[js.UndefOr[js.Any]] {
  /**
...
object MessagingOptions {
  @scala.inline
  def apply(
    StringDictionary: /* key */ org.scalablytyped.runtime.StringDictionary[js.UndefOr[js.Any]] = null,
