package typings
package firebaseDashAdminLib.adminNs.credentialNs
...
trait Credential extends js.Object {
  /**
    ...
    */
  def getAccessToken(): js.Promise[firebaseDashAdminLib.adminNs.GoogleOAuthAccessToken]
}

object Credential {
  @scala.inline
  def apply(getAccessToken: () => js.Promise[firebaseDashAdminLib.adminNs.GoogleOAuthAccessToken]): Credential = {
