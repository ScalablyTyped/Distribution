...
trait Messaging extends js.Object {
  ...
  /**
    ...
    */
  def send(message: Message): js.Promise[java.lang.String] = js.native
  def send(message: Message, dryRun: scala.Boolean): js.Promise[java.lang.String] = js.native
  /**
  ...
  def sendAll(messages: js.Array[Message], dryRun: scala.Boolean): js.Promise[BatchResponse] = js.native
  /**
  ...
  def sendMulticast(message: MulticastMessage, dryRun: scala.Boolean): js.Promise[BatchResponse] = js.native
  /**
    ...
    *   has been sent.
    */
  def sendToCondition(condition: java.lang.String, payload: MessagingPayload): js.Promise[MessagingConditionResponse] = js.native
  def sendToCondition(condition: java.lang.String, payload: MessagingPayload, options: MessagingOptions): js.Promise[MessagingConditionResponse] = js.native
  /**
    ...
    *   has been sent.
    */
  def sendToDevice(registrationToken: java.lang.String, payload: MessagingPayload): js.Promise[MessagingDevicesResponse] = js.native
  def sendToDevice(registrationToken: java.lang.String, payload: MessagingPayload, options: MessagingOptions): js.Promise[MessagingDevicesResponse] = js.native
  def sendToDevice(registrationToken: js.Array[java.lang.String], payload: MessagingPayload): js.Promise[MessagingDevicesResponse] = js.native
  def sendToDevice(
    registrationToken: js.Array[java.lang.String],
    payload: MessagingPayload,
    options: MessagingOptions
  ): js.Promise[MessagingDevicesResponse] = js.native
  /**
    ...
    *   has been sent.
    */
  def sendToDeviceGroup(notificationKey: java.lang.String, payload: MessagingPayload): js.Promise[MessagingDeviceGroupResponse] = js.native
  def sendToDeviceGroup(notificationKey: java.lang.String, payload: MessagingPayload, options: MessagingOptions): js.Promise[MessagingDeviceGroupResponse] = js.native
  /**
    ...
    *   has been sent.
    */
  def sendToTopic(topic: java.lang.String, payload: MessagingPayload): js.Promise[MessagingTopicResponse] = js.native
  def sendToTopic(topic: java.lang.String, payload: MessagingPayload, options: MessagingOptions): js.Promise[MessagingTopicResponse] = js.native
  /**
    ...
    */
  def subscribeToTopic(registrationTokens: java.lang.String, topic: java.lang.String): js.Promise[MessagingTopicManagementResponse] = js.native
  def subscribeToTopic(registrationTokens: js.Array[java.lang.String], topic: java.lang.String): js.Promise[MessagingTopicManagementResponse] = js.native
  /**
    ...
    */
  def unsubscribeFromTopic(registrationTokens: java.lang.String, topic: java.lang.String): js.Promise[MessagingTopicManagementResponse] = js.native
  def unsubscribeFromTopic(registrationTokens: js.Array[java.lang.String], topic: java.lang.String): js.Promise[MessagingTopicManagementResponse] = js.native
}
