...
object firebaseDashAdminLibStrings {
  @js.native
  sealed trait BCRYPT
    extends firebaseDashAdminLib.adminNs.authNs.HashAlgorithmType
  ...
  sealed trait child_added
    extends firebaseDashAdminLib.adminNs.databaseNs.EventType
