...
import typings.firebaseDashAdmin.Anon_Committed
...
trait Reference extends Query {
  ...
  /**
    ...
    * @return
    */
  def setPriority(priority: String, onComplete: js.Function1[/* a */ Error | Null, _]): js.Promise[Unit] = js.native
  def setPriority(priority: Double, onComplete: js.Function1[/* a */ Error | Null, _]): js.Promise[Unit] = js.native
  def setPriority(priority: Null, onComplete: js.Function1[/* a */ Error | Null, _]): js.Promise[Unit] = js.native
  ...
  def setWithPriority(newVal: js.Any, newPriority: String, onComplete: js.Function1[/* a */ Error | Null, _]): js.Promise[Unit] = js.native
  def setWithPriority(newVal: js.Any, newPriority: Double): js.Promise[Unit] = js.native
  def setWithPriority(newVal: js.Any, newPriority: Double, onComplete: js.Function1[/* a */ Error | Null, _]): js.Promise[Unit] = js.native
  def setWithPriority(newVal: js.Any, newPriority: Null, onComplete: js.Function1[/* a */ Error | Null, _]): js.Promise[Unit] = js.native
  /**
