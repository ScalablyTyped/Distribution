...
import typings.firebaseDashAdmin.Anon_Action
import typings.firebaseDashAdmin.firebaseDashAdminStrings.auto
import typings.firebaseDashAdmin.firebaseDashAdminStrings.ltr
import typings.firebaseDashAdmin.firebaseDashAdminStrings.rtl
...
trait WebpushNotification
  ...
  /**
    ...
    */
  var actions: js.UndefOr[js.Array[Anon_Action]] = js.undefined
  /**
...
object WebpushNotification {
  ...
  def apply(
    ...
    actions: js.Array[Anon_Action] = null,
    badge: String = null,
    body: String = null,
    data: js.Any = null,
