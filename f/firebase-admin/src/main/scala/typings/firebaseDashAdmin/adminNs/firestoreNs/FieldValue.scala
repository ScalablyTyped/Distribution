...
class FieldValue protected ()
  extends typings.atGoogleDashCloudFirestore.FirebaseFirestoreNs.FieldValue
...
object FieldValue extends js.Object {
  /**
    ...
    * update().
    */
  def arrayRemove(elements: js.Any*): typings.atGoogleDashCloudFirestore.FirebaseFirestoreNs.FieldValue = js.native
  /**
    * Returns a special value that can be used with set(), create() or update()
    ...
    * update().
    */
  def arrayUnion(elements: js.Any*): typings.atGoogleDashCloudFirestore.FirebaseFirestoreNs.FieldValue = js.native
  /**
    ...
    */
  def delete(): typings.atGoogleDashCloudFirestore.FirebaseFirestoreNs.FieldValue = js.native
  /**
    * Returns a special value that can be used with set(), create() or update()
    ...
    * update().
    */
  def increment(n: Double): typings.atGoogleDashCloudFirestore.FirebaseFirestoreNs.FieldValue = js.native
  /**
    ...
    * update().
    */
  def serverTimestamp(): typings.atGoogleDashCloudFirestore.FirebaseFirestoreNs.FieldValue = js.native
}
