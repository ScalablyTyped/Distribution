...
object jwtMod {
  ...
  object JwtErrorCode extends StObject {
    ...
    sealed trait INVALID_ARGUMENT
      extends StObject
         with JwtErrorCode
    /* "invalid-argument" */ val INVALID_ARGUMENT: typings.firebaseAdmin.jwtMod.JwtErrorCode.INVALID_ARGUMENT & String = js.native
    
    @js.native
    sealed trait INVALID_CREDENTIAL
      extends StObject
         with JwtErrorCode
    /* "invalid-credential" */ val INVALID_CREDENTIAL: typings.firebaseAdmin.jwtMod.JwtErrorCode.INVALID_CREDENTIAL & String = js.native
    
    @js.native
    sealed trait INVALID_SIGNATURE
      extends StObject
         with JwtErrorCode
    /* "invalid-token" */ val INVALID_SIGNATURE: typings.firebaseAdmin.jwtMod.JwtErrorCode.INVALID_SIGNATURE & String = js.native
    
    @js.native
    sealed trait KEY_FETCH_ERROR
      extends StObject
         with JwtErrorCode
    /* "key-fetch-error" */ val KEY_FETCH_ERROR: typings.firebaseAdmin.jwtMod.JwtErrorCode.KEY_FETCH_ERROR & String = js.native
    
    @js.native
    sealed trait NO_KID_IN_HEADER
      extends StObject
         with JwtErrorCode
    /* "no-kid-error" */ val NO_KID_IN_HEADER: typings.firebaseAdmin.jwtMod.JwtErrorCode.NO_KID_IN_HEADER & String = js.native
    
    @js.native
    sealed trait NO_MATCHING_KID
      extends StObject
         with JwtErrorCode
    /* "no-matching-kid-error" */ val NO_MATCHING_KID: typings.firebaseAdmin.jwtMod.JwtErrorCode.NO_MATCHING_KID & String = js.native
    
    @js.native
    sealed trait TOKEN_EXPIRED
      extends StObject
         with JwtErrorCode
    /* "token-expired" */ val TOKEN_EXPIRED: typings.firebaseAdmin.jwtMod.JwtErrorCode.TOKEN_EXPIRED & String = js.native
  }
