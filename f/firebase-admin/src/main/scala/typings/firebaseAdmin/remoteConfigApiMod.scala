...
object remoteConfigApiMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAdmin.remoteConfigApiMod.ExplicitParameterValue
    - typings.firebaseAdmin.remoteConfigApiMod.InAppDefaultValue
  */
  trait RemoteConfigParameterValue extends StObject
  object RemoteConfigParameterValue {
    
    inline def ExplicitParameterValue(value: String): typings.firebaseAdmin.remoteConfigApiMod.ExplicitParameterValue = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAdmin.remoteConfigApiMod.ExplicitParameterValue]
    }
    
    inline def InAppDefaultValue(useInAppDefault: Boolean): typings.firebaseAdmin.remoteConfigApiMod.InAppDefaultValue = {
      val __obj = js.Dynamic.literal(useInAppDefault = useInAppDefault.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAdmin.remoteConfigApiMod.InAppDefaultValue]
    }
  }
