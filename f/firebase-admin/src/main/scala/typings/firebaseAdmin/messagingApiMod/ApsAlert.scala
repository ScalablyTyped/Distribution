...
object ApsAlert {
  ...
  extension [Self <: ApsAlert](x: Self) {
    ...
    inline def setLocArgsVarargs(value: String*): Self = StObject.set(x, "locArgs", js.Array(value*))
    ...
    inline def setSubtitleLocArgsVarargs(value: String*): Self = StObject.set(x, "subtitleLocArgs", js.Array(value*))
