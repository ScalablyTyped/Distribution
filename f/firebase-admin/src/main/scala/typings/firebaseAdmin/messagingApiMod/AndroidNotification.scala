...
trait AndroidNotification extends StObject {
  ...
  /**
    ...
    */
  var eventTimestamp: js.UndefOr[js.Date] = js.undefined
...
object AndroidNotification {
  ...
  extension [Self <: AndroidNotification](x: Self) {
    ...
    inline def setEventTimestamp(value: js.Date): Self = StObject.set(x, "eventTimestamp", value.asInstanceOf[js.Any])
    ...
    inline def setPriority(value: min | low | default | high | max): Self = StObject.set(x, "priority", value.asInstanceOf[js.Any])
    ...
    inline def setVibrateTimingsMillis(value: js.Array[Double]): Self = StObject.set(x, "vibrateTimingsMillis", value.asInstanceOf[js.Any])
    
    inline def setVibrateTimingsMillisUndefined: Self = StObject.set(x, "vibrateTimingsMillis", js.undefined)
    
    inline def setVibrateTimingsMillisVarargs(value: Double*): Self = StObject.set(x, "vibrateTimingsMillis", js.Array(value*))
    
    inline def setVisibility(value: `private` | public | secret): Self = StObject.set(x, "visibility", value.asInstanceOf[js.Any])
