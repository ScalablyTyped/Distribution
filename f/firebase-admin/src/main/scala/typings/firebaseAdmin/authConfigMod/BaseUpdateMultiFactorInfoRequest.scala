...
trait BaseUpdateMultiFactorInfoRequest extends StObject {
...
object BaseUpdateMultiFactorInfoRequest {
  
  inline def apply(factorId: String): BaseUpdateMultiFactorInfoRequest = {
    val __obj = js.Dynamic.literal(factorId = factorId.asInstanceOf[js.Any])
    __obj.asInstanceOf[BaseUpdateMultiFactorInfoRequest]
  }
  
  extension [Self <: BaseUpdateMultiFactorInfoRequest](x: Self) {
