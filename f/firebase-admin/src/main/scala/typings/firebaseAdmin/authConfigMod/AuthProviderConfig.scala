...
/* Rewritten from type alias, can be one of: 
  - typings.firebaseAdmin.authConfigMod.SAMLAuthProviderConfig
  - typings.firebaseAdmin.authConfigMod.OIDCAuthProviderConfig
*/
trait AuthProviderConfig extends StObject
object AuthProviderConfig {
  
  inline def OIDCAuthProviderConfig(clientId: String, enabled: Boolean, issuer: String, providerId: String): typings.firebaseAdmin.authConfigMod.OIDCAuthProviderConfig = {
    ...
    __obj.asInstanceOf[typings.firebaseAdmin.authConfigMod.OIDCAuthProviderConfig]
  }
  ...
  inline def SAMLAuthProviderConfig(
    ...
    __obj.asInstanceOf[typings.firebaseAdmin.authConfigMod.SAMLAuthProviderConfig]
  }
}
