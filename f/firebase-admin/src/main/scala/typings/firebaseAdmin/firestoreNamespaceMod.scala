...
object firestoreNamespaceMod {
  ...
  object firestore {
    ...
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.BulkWriter")
    @js.native
    /* private */ open class BulkWriter ()
      extends StObject
         with typings.googleCloudFirestore.FirebaseFirestore.BulkWriter
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.BundleBuilder")
    @js.native
    open class BundleBuilder ()
      extends StObject
         with typings.googleCloudFirestore.FirebaseFirestore.BundleBuilder
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.CollectionGroup")
    @js.native
    /* private */ open class CollectionGroup[T] ()
      extends StObject
         with typings.googleCloudFirestore.FirebaseFirestore.CollectionGroup[T]
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.CollectionReference")
    @js.native
    /* private */ open class CollectionReference[T] ()
      extends StObject
         with typings.googleCloudFirestore.FirebaseFirestore.CollectionReference[T]
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.DocumentReference")
    @js.native
    /* private */ open class DocumentReference[T] ()
      extends StObject
         with typings.googleCloudFirestore.FirebaseFirestore.DocumentReference[T]
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.DocumentSnapshot")
    @js.native
    /* protected */ open class DocumentSnapshot[T] ()
      extends StObject
         with typings.googleCloudFirestore.FirebaseFirestore.DocumentSnapshot[T]
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.FieldPath")
    @js.native
    ...
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.FieldValue")
    @js.native
    ...
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.Firestore")
    @js.native
    /**
    ...
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.GeoPoint")
    @js.native
    ...
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.GrpcStatus")
    @js.native
    ...
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.Transaction")
    @js.native
    /* private */ open class Transaction ()
      extends StObject
         with typings.googleCloudFirestore.FirebaseFirestore.Transaction
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.WriteBatch")
    @js.native
    /* private */ open class WriteBatch ()
      extends StObject
         with typings.googleCloudFirestore.FirebaseFirestore.WriteBatch
    
    @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.WriteResult")
    @js.native
    ...
    object v1 {
      ...
      @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.v1")
      @js.native
      val ^ : js.Any = js.native
      
      /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
      @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.v1.FirestoreAdminClient")
      @js.native
      /**
      ...
      /**
        ...
        *     if you need to override this behavior.
        */
      open class FirestoreAdminClientCls ()
        extends typings.googleCloudFirestore.firestoreAdminClientMod.FirestoreAdminClient {
        /**
          * Construct an instance of FirestoreAdminClient.
          *
      ...
      /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
      @JSImport("firebase-admin/lib/firestore/firestore-namespace", "firestore.v1.FirestoreClient")
      @js.native
      /**
