...
object defaultNamespaceMod {
  ...
  inline def appCheck(app: typings.firebaseAdmin.coreMod.App): AppCheck = ^.asInstanceOf[js.Dynamic].applyDynamic("appCheck")(app.asInstanceOf[js.Any]).asInstanceOf[AppCheck]
  ...
  inline def auth(app: typings.firebaseAdmin.coreMod.App): Auth = ^.asInstanceOf[js.Dynamic].applyDynamic("auth")(app.asInstanceOf[js.Any]).asInstanceOf[Auth]
  ...
  object database {
    ...
    inline def apply(app: typings.firebaseAdmin.coreMod.App): Database = ^.asInstanceOf[js.Dynamic].apply(app.asInstanceOf[js.Any]).asInstanceOf[Database]
  ...
  object firestore {
    ...
    inline def apply(app: typings.firebaseAdmin.coreMod.App): typings.googleCloudFirestore.mod.Firestore = ^.asInstanceOf[js.Dynamic].apply(app.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudFirestore.mod.Firestore]
    ...
    /* private */ open class FieldValue ()
      extends typings.firebaseAdmin.firebaseNamespaceApiMod.firestore.FieldValue
    /* static members */
    object FieldValue {
    ...
    open class Firestore ()
      extends typings.firebaseAdmin.firebaseNamespaceApiMod.firestore.Firestore {
    ...
    open class GeoPoint protected ()
      extends typings.firebaseAdmin.firebaseNamespaceApiMod.firestore.GeoPoint {
      /**
    ...
    /* private */ open class Transaction ()
      extends typings.firebaseAdmin.firebaseNamespaceApiMod.firestore.Transaction
    
    @JSImport("firebase-admin/lib/default-namespace", "firestore.WriteBatch")
    @js.native
    /* private */ open class WriteBatch ()
      extends typings.firebaseAdmin.firebaseNamespaceApiMod.firestore.WriteBatch
    
    @JSImport("firebase-admin/lib/default-namespace", "firestore.WriteResult")
    @js.native
    /* private */ open class WriteResult ()
      extends typings.firebaseAdmin.firebaseNamespaceApiMod.firestore.WriteResult
  ...
  inline def installations(app: typings.firebaseAdmin.coreMod.App): Installations = ^.asInstanceOf[js.Dynamic].applyDynamic("installations")(app.asInstanceOf[js.Any]).asInstanceOf[Installations]
  
  inline def instanceId(): InstanceId = ^.asInstanceOf[js.Dynamic].applyDynamic("instanceId")().asInstanceOf[InstanceId]
  inline def instanceId(app: typings.firebaseAdmin.coreMod.App): InstanceId = ^.asInstanceOf[js.Dynamic].applyDynamic("instanceId")(app.asInstanceOf[js.Any]).asInstanceOf[InstanceId]
  ...
  inline def machineLearning(app: typings.firebaseAdmin.coreMod.App): MachineLearning = ^.asInstanceOf[js.Dynamic].applyDynamic("machineLearning")(app.asInstanceOf[js.Any]).asInstanceOf[MachineLearning]
  
  inline def messaging(): Messaging = ^.asInstanceOf[js.Dynamic].applyDynamic("messaging")().asInstanceOf[Messaging]
  inline def messaging(app: typings.firebaseAdmin.coreMod.App): Messaging = ^.asInstanceOf[js.Dynamic].applyDynamic("messaging")(app.asInstanceOf[js.Any]).asInstanceOf[Messaging]
  ...
  inline def projectManagement(app: typings.firebaseAdmin.coreMod.App): ProjectManagement = ^.asInstanceOf[js.Dynamic].applyDynamic("projectManagement")(app.asInstanceOf[js.Any]).asInstanceOf[ProjectManagement]
  
  inline def remoteConfig(): RemoteConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("remoteConfig")().asInstanceOf[RemoteConfig]
  inline def remoteConfig(app: typings.firebaseAdmin.coreMod.App): RemoteConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("remoteConfig")(app.asInstanceOf[js.Any]).asInstanceOf[RemoteConfig]
  
  inline def securityRules(): SecurityRules = ^.asInstanceOf[js.Dynamic].applyDynamic("securityRules")().asInstanceOf[SecurityRules]
  inline def securityRules(app: typings.firebaseAdmin.coreMod.App): SecurityRules = ^.asInstanceOf[js.Dynamic].applyDynamic("securityRules")(app.asInstanceOf[js.Any]).asInstanceOf[SecurityRules]
  
  inline def storage(): Storage = ^.asInstanceOf[js.Dynamic].applyDynamic("storage")().asInstanceOf[Storage]
  inline def storage(app: typings.firebaseAdmin.coreMod.App): Storage = ^.asInstanceOf[js.Dynamic].applyDynamic("storage")(app.asInstanceOf[js.Any]).asInstanceOf[Storage]
}
