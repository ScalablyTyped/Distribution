...
/**
  ...
  */
trait CreateRequest
  extends typings.firebaseAdmin.authMod.admin.auth.UpdateRequest {
  /**
    * The user's multi-factor related properties.
    */
  @JSName("multiFactor")
  var multiFactor_CreateRequest: js.UndefOr[typings.firebaseAdmin.authMod.admin.auth.MultiFactorCreateSettings] = js.undefined
  /**
    * The user's `uid`.
    */
...
object CreateRequest {
  ...
  def apply(
    ...
    multiFactor: typings.firebaseAdmin.authMod.admin.auth.MultiFactorCreateSettings = null,
