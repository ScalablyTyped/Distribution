...
import typings.firebaseAdmin.actionCodeSettingsBuilderMod.ActionCodeSettings
import typings.firebaseAdmin.authConfigMod.AuthProviderConfig
import typings.firebaseAdmin.authConfigMod.AuthProviderConfigFilter
import typings.firebaseAdmin.authConfigMod.CreateRequest
import typings.firebaseAdmin.authConfigMod.ListProviderConfigResults
import typings.firebaseAdmin.authConfigMod.UpdateAuthProviderRequest
import typings.firebaseAdmin.authConfigMod.UpdateRequest
import typings.firebaseAdmin.authTokenVerifierMod.DecodedAuthBlockingToken
import typings.firebaseAdmin.authTokenVerifierMod.DecodedIdToken
import typings.firebaseAdmin.coreMod.FirebaseArrayIndexError
import typings.firebaseAdmin.identifierMod.UserIdentifier
...
import typings.firebaseAdmin.userRecordMod.UserRecord
...
object baseAuthMod {
  ...
  @JSImport("firebase-admin/lib/auth/base-auth", "BaseAuth")
  @js.native
  abstract class BaseAuth () extends StObject {
