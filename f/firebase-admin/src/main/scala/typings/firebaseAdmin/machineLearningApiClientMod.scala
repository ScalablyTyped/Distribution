...
object machineLearningApiClientMod {
  ...
  - typings.firebaseAdmin.machineLearningApiClientMod.ModelOptions because Already inherited */ trait AutoMLTfliteModelOptions
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.firebaseAdmin.machineLearningApiClientMod.ModelOptions because Already inherited */ trait GcsTfliteModelOptions
    extends StObject
       with ModelOptionsBase {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAdmin.machineLearningApiClientMod.ModelOptionsBase
    - typings.firebaseAdmin.machineLearningApiClientMod.GcsTfliteModelOptions
    - typings.firebaseAdmin.machineLearningApiClientMod.AutoMLTfliteModelOptions
  */
  trait ModelOptions extends StObject
  object ModelOptions {
    
    inline def AutoMLTfliteModelOptions(tfliteModel: AutomlModel): typings.firebaseAdmin.machineLearningApiClientMod.AutoMLTfliteModelOptions = {
      val __obj = js.Dynamic.literal(tfliteModel = tfliteModel.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAdmin.machineLearningApiClientMod.AutoMLTfliteModelOptions]
    }
    
    inline def GcsTfliteModelOptions(tfliteModel: GcsTfliteUri): typings.firebaseAdmin.machineLearningApiClientMod.GcsTfliteModelOptions = {
      val __obj = js.Dynamic.literal(tfliteModel = tfliteModel.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAdmin.machineLearningApiClientMod.GcsTfliteModelOptions]
    }
    
    inline def ModelOptionsBase(): typings.firebaseAdmin.machineLearningApiClientMod.ModelOptionsBase = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.firebaseAdmin.machineLearningApiClientMod.ModelOptionsBase]
    }
  }
