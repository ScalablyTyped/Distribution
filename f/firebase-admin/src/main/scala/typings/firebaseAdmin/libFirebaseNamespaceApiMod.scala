...
import typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.Firestore
...
object libFirebaseNamespaceApiMod {
  ...
  object app {
    ...
    trait App
      extends StObject
         with typings.firebaseAdmin.libAppCoreMod.App {
  ...
  @js.native
  val apps: js.Array[typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App | Null] = js.native
  ...
  object firestore {
    ...
    /* private */ open class FieldValue ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.FieldValue
    /* static members */
    object FieldValue {
    ...
    open class Firestore ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.Firestore {
    ...
    open class GeoPoint protected ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.GeoPoint {
      /**
    ...
    /* protected */ open class Query[T] ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.Query[T]
    ...
    /* private */ open class QueryDocumentSnapshot[T] ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.QueryDocumentSnapshot[T]
    
    @JSImport("firebase-admin/lib/firebase-namespace-api", "firestore.QueryPartition")
    @js.native
    /* private */ open class QueryPartition[T] ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.QueryPartition[T]
    
    @JSImport("firebase-admin/lib/firebase-namespace-api", "firestore.QuerySnapshot")
    @js.native
    /* private */ open class QuerySnapshot[T] ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.QuerySnapshot[T]
    
    @JSImport("firebase-admin/lib/firebase-namespace-api", "firestore.Timestamp")
    @js.native
    open class Timestamp protected ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.Timestamp {
      /**
    ...
    /* private */ open class Transaction ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.Transaction
    
    @JSImport("firebase-admin/lib/firebase-namespace-api", "firestore.WriteBatch")
    @js.native
    /* private */ open class WriteBatch ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.WriteBatch
    
    @JSImport("firebase-admin/lib/firebase-namespace-api", "firestore.WriteResult")
    @js.native
    /* private */ open class WriteResult ()
      extends typings.firebaseAdmin.libFirestoreFirestoreNamespaceMod.firestore.WriteResult
  ...
  inline def initializeApp(): typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App = ^.asInstanceOf[js.Dynamic].applyDynamic("initializeApp")().asInstanceOf[typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App]
  inline def initializeApp(options: Unit, name: String): typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App = (^.asInstanceOf[js.Dynamic].applyDynamic("initializeApp")(options.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App]
  inline def initializeApp(options: AppOptions): typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App = ^.asInstanceOf[js.Dynamic].applyDynamic("initializeApp")(options.asInstanceOf[js.Any]).asInstanceOf[typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App]
  inline def initializeApp(options: AppOptions, name: String): typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App = (^.asInstanceOf[js.Dynamic].applyDynamic("initializeApp")(options.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[typings.firebaseAdmin.libFirebaseNamespaceApiMod.app.App]
