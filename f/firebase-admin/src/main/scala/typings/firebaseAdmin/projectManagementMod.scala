...
object projectManagementMod {
  ...
  open class AndroidApp ()
    extends typings.firebaseAdmin.libProjectManagementMod.AndroidApp
  ...
  @js.native
  open class IosApp ()
    extends typings.firebaseAdmin.libProjectManagementMod.IosApp
  
  @JSImport("firebase-admin/project-management", "ProjectManagement")
  @js.native
  open class ProjectManagement ()
    extends typings.firebaseAdmin.libProjectManagementMod.ProjectManagement
  
  @JSImport("firebase-admin/project-management", "ShaCertificate")
  @js.native
  open class ShaCertificate ()
    extends typings.firebaseAdmin.libProjectManagementMod.ShaCertificate
