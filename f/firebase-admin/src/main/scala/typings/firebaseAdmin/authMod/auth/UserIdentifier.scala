...
object UserIdentifier {
  ...
  inline def EmailIdentifier(email: String): typings.firebaseAdmin.authMod.auth.EmailIdentifier = {
    val __obj = js.Dynamic.literal(email = email.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.firebaseAdmin.authMod.auth.EmailIdentifier]
  }
  
  inline def PhoneIdentifier(phoneNumber: String): typings.firebaseAdmin.authMod.auth.PhoneIdentifier = {
    val __obj = js.Dynamic.literal(phoneNumber = phoneNumber.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.firebaseAdmin.authMod.auth.PhoneIdentifier]
  }
  
  inline def ProviderIdentifier(providerId: String, providerUid: String): typings.firebaseAdmin.authMod.auth.ProviderIdentifier = {
  ...
  inline def UidIdentifier(uid: String): typings.firebaseAdmin.authMod.auth.UidIdentifier = {
