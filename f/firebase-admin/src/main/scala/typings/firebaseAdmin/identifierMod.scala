...
object identifierMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseAdmin.identifierMod.UidIdentifier
    - typings.firebaseAdmin.identifierMod.EmailIdentifier
    - typings.firebaseAdmin.identifierMod.PhoneIdentifier
    - typings.firebaseAdmin.identifierMod.ProviderIdentifier
  */
  trait UserIdentifier extends StObject
  object UserIdentifier {
    
    inline def EmailIdentifier(email: String): typings.firebaseAdmin.identifierMod.EmailIdentifier = {
      val __obj = js.Dynamic.literal(email = email.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAdmin.identifierMod.EmailIdentifier]
    }
    
    inline def PhoneIdentifier(phoneNumber: String): typings.firebaseAdmin.identifierMod.PhoneIdentifier = {
      val __obj = js.Dynamic.literal(phoneNumber = phoneNumber.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAdmin.identifierMod.PhoneIdentifier]
    }
    
    inline def ProviderIdentifier(providerId: String, providerUid: String): typings.firebaseAdmin.identifierMod.ProviderIdentifier = {
      val __obj = js.Dynamic.literal(providerId = providerId.asInstanceOf[js.Any], providerUid = providerUid.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAdmin.identifierMod.ProviderIdentifier]
    }
    
    inline def UidIdentifier(uid: String): typings.firebaseAdmin.identifierMod.UidIdentifier = {
      val __obj = js.Dynamic.literal(uid = uid.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseAdmin.identifierMod.UidIdentifier]
    }
  }
}
