...
import typings.firebaseAdmin.apiRequestMod.AuthorizedHttpClient
import typings.firebaseAdmin.coreMod.App
import typings.firebaseAdmin.credentialInternalMod.ServiceAccountCredential
import typings.firebaseAdmin.errorMod.ErrorInfo
