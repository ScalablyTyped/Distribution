...
object AndroidNotification {
  ...
  extension [Self <: AndroidNotification](x: Self) {
    ...
    inline def setEventTimestamp(value: Date): Self = StObject.set(x, "eventTimestamp", value.asInstanceOf[js.Any])
    ...
    inline def setVibrateTimingsMillisVarargs(value: Double*): Self = StObject.set(x, "vibrateTimingsMillis", js.Array(value :_*))
