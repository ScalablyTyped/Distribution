...
@js.native
trait Reference
  extends typings.firebaseAdmin.admin.database.Query {
  /**
  ...
  /**
    ...
    * ```
    */
  var parent: typings.firebaseAdmin.admin.database.Reference | Null = js.native
  ...
  /**
    ...
    * ```
    */
  var root: typings.firebaseAdmin.admin.database.Reference = js.native
  /**
    ...
    */
  def child(path: String): typings.firebaseAdmin.admin.database.Reference = js.native
  /**
    ...
    */
  def onDisconnect(): typings.firebaseAdmin.admin.database.OnDisconnect = js.native
  /**
    ...
    */
  def push(): typings.firebaseAdmin.admin.database.ThenableReference = js.native
  def push(value: js.Any): typings.firebaseAdmin.admin.database.ThenableReference = js.native
  def push(value: js.Any, onComplete: js.Function1[/* a */ Error | Null, _]): typings.firebaseAdmin.admin.database.ThenableReference = js.native
  /**
  ...
  def transaction(
    ...
    onComplete: js.Function3[
      /* a */ Error | Null, 
      /* b */ Boolean, 
      /* c */ typings.firebaseAdmin.admin.database.DataSnapshot | Null, 
      _
    ]
