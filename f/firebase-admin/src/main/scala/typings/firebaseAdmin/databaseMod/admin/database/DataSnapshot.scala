...
trait DataSnapshot extends js.Object {
  var key: String | Null
  var ref: typings.firebaseAdmin.admin.database.Reference
  /**
    ...
    */
  def child(path: String): typings.firebaseAdmin.admin.database.DataSnapshot
  /**
...
object DataSnapshot {
  @scala.inline
  def apply(
    child: String => typings.firebaseAdmin.admin.database.DataSnapshot,
    exists: () => Boolean,
    exportVal: () => js.Any,
    ...
    hasChildren: () => Boolean,
    numChildren: () => Double,
    ref: typings.firebaseAdmin.admin.database.Reference,
