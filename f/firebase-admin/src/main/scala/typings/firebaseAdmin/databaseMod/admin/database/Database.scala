...
trait Database extends js.Object {
  ...
  /**
    ...
    */
  def ref(): typings.firebaseAdmin.admin.database.Reference = js.native
  def ref(path: String): typings.firebaseAdmin.admin.database.Reference = js.native
  def ref(path: typings.firebaseAdmin.admin.database.Reference): typings.firebaseAdmin.admin.database.Reference = js.native
  /**
    * Returns a `Reference` representing the location in the Database
    ...
    */
  def refFromURL(url: String): typings.firebaseAdmin.admin.database.Reference = js.native
  /**
