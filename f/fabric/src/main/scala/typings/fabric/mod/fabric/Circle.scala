...
object Circle {
  ...
  /**
    ...
    */
  @scala.inline
  def fromElement(element: SVGElement, options: ICircleOptions): typings.fabric.fabricImplMod.Circle = (^.asInstanceOf[js.Dynamic].applyDynamic("fromElement")(element.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.fabric.fabricImplMod.Circle]
  ...
  /**
    ...
    */
  @scala.inline
  def fromObject(`object`: js.Any): typings.fabric.fabricImplMod.Circle = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.fabric.fabricImplMod.Circle]
}
