...
object Color {
  ...
  /**
    ...
    */
  inline def fromHex(color: String): typings.fabric.fabricImplMod.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHex")(color.asInstanceOf[js.Any]).asInstanceOf[typings.fabric.fabricImplMod.Color]
  
  /**
    * Returns new color object, when given a color in HSL format
    * @param color Color value ex: hsl(0-260,0%-100%,0%-100%)
    */
  inline def fromHsl(color: String): typings.fabric.fabricImplMod.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHsl")(color.asInstanceOf[js.Any]).asInstanceOf[typings.fabric.fabricImplMod.Color]
  
  /**
    * Returns new color object, when given a color in HSLA format
    * @param color Color value ex: hsl(0-260,0%-100%,0%-100%)
    */
  inline def fromHsla(color: String): typings.fabric.fabricImplMod.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHsla")(color.asInstanceOf[js.Any]).asInstanceOf[typings.fabric.fabricImplMod.Color]
  
  /**
    * Returns new color object, when given a color in RGB format
    * @param color Color value ex: rgb(0-255,0-255,0-255)
    */
  inline def fromRgb(color: String): typings.fabric.fabricImplMod.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRgb")(color.asInstanceOf[js.Any]).asInstanceOf[typings.fabric.fabricImplMod.Color]
  
  /**
    * Returns new color object, when given a color in RGBA format
    * @param color Color value ex: rgb(0-255,0-255,0-255)
    */
  inline def fromRgba(color: String): typings.fabric.fabricImplMod.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRgba")(color.asInstanceOf[js.Any]).asInstanceOf[typings.fabric.fabricImplMod.Color]
  
  /**
    * Returns new color object, when given color in array representation (ex: [200, 100, 100, 0.5])
    */
  inline def fromSource(source: js.Array[Double]): typings.fabric.fabricImplMod.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("fromSource")(source.asInstanceOf[js.Any]).asInstanceOf[typings.fabric.fabricImplMod.Color]
