...
trait AnonBlBrMbMl extends js.Object {
  var bl: Point
  var br: Point
  var mb: Point
  var ml: Point
...
object AnonBlBrMbMl {
  @scala.inline
  def apply(bl: Point, br: Point, mb: Point, ml: Point, mr: Point, mt: Point, mtr: Point, tl: Point, tr: Point): AnonBlBrMbMl = {
    ...
    __obj.asInstanceOf[AnonBlBrMbMl]
  }
}
