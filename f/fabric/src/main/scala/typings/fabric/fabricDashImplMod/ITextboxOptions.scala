...
object ITextboxOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(isWrapping)) __obj.updateDynamic("isWrapping")(isWrapping.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(splitByGrapheme)) __obj.updateDynamic("splitByGrapheme")(splitByGrapheme.asInstanceOf[js.Any])
