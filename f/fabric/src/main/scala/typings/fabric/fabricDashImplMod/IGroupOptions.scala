...
object IGroupOptions {
  ...
  def apply(
    ...
    subTargetCheck: js.UndefOr[Boolean] = js.undefined,
    top: Int | Double = null,
    transformMatrix: js.Array[_] = null,
    transparentCorners: js.UndefOr[Boolean] = js.undefined,
    `type`: String = null,
    useSetOnGroup: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(subTargetCheck)) __obj.updateDynamic("subTargetCheck")(subTargetCheck.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useSetOnGroup)) __obj.updateDynamic("useSetOnGroup")(useSetOnGroup.asInstanceOf[js.Any])
