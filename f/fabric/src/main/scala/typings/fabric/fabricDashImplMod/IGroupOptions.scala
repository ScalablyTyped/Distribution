...
object IGroupOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(subTargetCheck)) __obj.updateDynamic("subTargetCheck")(subTargetCheck)
    ...
    if (!js.isUndefined(useSetOnGroup)) __obj.updateDynamic("useSetOnGroup")(useSetOnGroup)
