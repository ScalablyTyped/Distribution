...
object Path {
  ...
  /**
    ...
    */
  @scala.inline
  def fromElement(element: SVGElement, callback: js.Function): Path = (^.asInstanceOf[js.Dynamic].applyDynamic("fromElement")(element.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Path]
  @scala.inline
  def fromElement(element: SVGElement, callback: js.Function, options: IPathOptions): Path = (^.asInstanceOf[js.Dynamic].applyDynamic("fromElement")(element.asInstanceOf[js.Any], callback.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Path]
  ...
  /**
    ...
    */
  @scala.inline
  def fromObject(`object`: js.Any, callback: js.Function): Path = (^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Path]
}
