...
object IImageOptions {
  ...
  def apply(
    ...
    cropX: js.UndefOr[Double] = js.undefined,
    cropY: js.UndefOr[Double] = js.undefined,
    ...
    minimumScaleTrigger: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(cropX)) __obj.updateDynamic("cropX")(cropX.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cropY)) __obj.updateDynamic("cropY")(cropY.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(minimumScaleTrigger)) __obj.updateDynamic("minimumScaleTrigger")(minimumScaleTrigger.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(srcFromAttribute)) __obj.updateDynamic("srcFromAttribute")(srcFromAttribute.get.asInstanceOf[js.Any])
