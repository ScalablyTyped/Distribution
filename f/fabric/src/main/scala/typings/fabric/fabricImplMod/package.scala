...
package object fabricImplMod {
  ...
  @scala.inline
  def parseElements(elements: js.Array[_ | typings.std.SVGElement], callback: js.Function, options: js.Any): scala.Unit = (typings.fabric.fabricImplMod.^.asInstanceOf[js.Dynamic].applyDynamic("parseElements")(elements.asInstanceOf[js.Any], callback.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def parseElements(
    elements: js.Array[_ | typings.std.SVGElement],
    callback: js.Function,
    options: js.Any,
    reviver: js.Function
  ): scala.Unit = (typings.fabric.fabricImplMod.^.asInstanceOf[js.Dynamic].applyDynamic("parseElements")(elements.asInstanceOf[js.Any], callback.asInstanceOf[js.Any], options.asInstanceOf[js.Any], reviver.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  ...
  @scala.inline
  def parsePointsAttribute(points: java.lang.String): js.Array[_] = typings.fabric.fabricImplMod.^.asInstanceOf[js.Dynamic].applyDynamic("parsePointsAttribute")(points.asInstanceOf[js.Any]).asInstanceOf[js.Array[_]]
