...
object IGroupOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(subTargetCheck)) __obj.updateDynamic("subTargetCheck")(subTargetCheck.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useSetOnGroup)) __obj.updateDynamic("useSetOnGroup")(useSetOnGroup.get.asInstanceOf[js.Any])
