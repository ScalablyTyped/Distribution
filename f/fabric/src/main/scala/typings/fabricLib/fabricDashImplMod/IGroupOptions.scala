...
trait IGroupOptions extends IObjectOptions {
  /**
  	 ...
  	 * @type Boolean
  	 */
  var subTargetCheck: js.UndefOr[scala.Boolean] = js.undefined
  /**
  	 ...
  	 * @default
  	 */
  var useSetOnGroup: js.UndefOr[scala.Boolean] = js.undefined
}
...
object IGroupOptions {
  ...
  def apply(
    ...
    subTargetCheck: js.UndefOr[scala.Boolean] = js.undefined,
    top: scala.Int | scala.Double = null,
    transformMatrix: js.Array[_] = null,
    transparentCorners: js.UndefOr[scala.Boolean] = js.undefined,
    `type`: java.lang.String = null,
    useSetOnGroup: js.UndefOr[scala.Boolean] = js.undefined,
