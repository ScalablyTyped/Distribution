...
- fastifyLib.fastifyMod.fastifyNs.ServerOptionsAsSecure because var conflicts: bodyLimit, ignoreTrailingSlash, logger, maxParamLength, modifyCoreObjects, onProtoPoisoning, pluginTimeout, querystringParser, trustProxy, versioning. Inlined https */ trait ServerOptionsAsSecureHttp2 extends ServerOptionsAsHttp2 {
