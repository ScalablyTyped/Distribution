...
object ^ extends js.Object {
  ...
  def close(fd: scala.Double, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def copy(
    ...
    callback: js.Function1[
      (/* err */ stdLib.Error) | (/* src */ java.lang.String), 
  ...
  def ensureDir(path: java.lang.String, cb: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def fchmod(fd: scala.Double, mode: scala.Double, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def fstat(fd: scala.Double, callback: js.Function2[/* err */ stdLib.Error, /* stats */ Stats, scala.Unit]): scala.Unit = js.native
  ...
  def fsync(fd: scala.Double, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def lstat(
    path: java.lang.String,
    callback: js.Function2[/* err */ stdLib.Error, /* stats */ Stats, scala.Unit]
  ): scala.Unit = js.native
  ...
  def open(
    ...
    mode: java.lang.String,
    callback: js.Function2[/* err */ stdLib.Error, /* fs */ scala.Double, scala.Unit]
  ): scala.Unit = js.native
  ...
  def readJSON(file: java.lang.String, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def readlink(
    path: java.lang.String,
    callback: js.Function2[/* err */ stdLib.Error, /* linkString */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  ...
  def realpath(
    ...
    callback: js.Function2[/* err */ stdLib.Error, /* resolvedPath */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def realpath(
    path: java.lang.String,
    callback: js.Function2[/* err */ stdLib.Error, /* resolvedPath */ java.lang.String, scala.Unit]
  ...
  def rmdir(path: java.lang.String, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def truncate(fd: scala.Double, len: scala.Double, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def unlink(path: java.lang.String, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
