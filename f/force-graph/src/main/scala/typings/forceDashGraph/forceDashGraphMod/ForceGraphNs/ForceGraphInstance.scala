...
import typings.forceDashGraph.forceDashGraphStrings.center
import typings.forceDashGraph.forceDashGraphStrings.charge
import typings.forceDashGraph.forceDashGraphStrings.link
...
trait ForceGraphInstance extends js.Object {
  ...
  def centerAt(): ForceGraphInstance with Anon_X = js.native
  def centerAt(x: Double): ForceGraphInstance with Anon_X = js.native
  def centerAt(x: Double, y: Double): ForceGraphInstance with Anon_X = js.native
  def centerAt(x: Double, y: Double, milliseconds: Double): ForceGraphInstance with Anon_X = js.native
