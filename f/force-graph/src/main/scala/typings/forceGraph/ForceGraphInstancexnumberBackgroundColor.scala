...
@js.native
trait ForceGraphInstancexnumberBackgroundColor extends js.Object {
  ...
  def centerAt(): ForceGraphInstancexnumberCall = js.native
  def centerAt(x: Double): ForceGraphInstancexnumberCall = js.native
  def centerAt(x: Double, y: Double): ForceGraphInstancexnumberCall = js.native
  def centerAt(x: Double, y: Double, milliseconds: Double): ForceGraphInstancexnumberCall = js.native
