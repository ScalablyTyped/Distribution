...
import typings.flightplan.Anon_Exec
...
trait Transport extends js.Object {
  ...
  def echo(command: String, options: Anon_Exec): CommandResult = js.native
  def echo(command: String, options: CommandOptions): CommandResult = js.native
  def exec(command: String): CommandResult = js.native
  def exec(command: String, options: Anon_Exec): CommandResult = js.native
  ...
  def unzip(command: String, options: Anon_Exec): CommandResult = js.native
  ...
  def whoami(command: String, options: Anon_Exec): CommandResult = js.native
  ...
  def zip(command: String, options: Anon_Exec): CommandResult = js.native
