...
@js.native
object fechaModMembers extends js.Object {
  ...
  def parse(dateStr: java.lang.String, format: java.lang.String): stdLib.Date | scala.Boolean = js.native
  def parse(dateStr: java.lang.String, format: java.lang.String, i18nSettings: i18nSettings): stdLib.Date | scala.Boolean = js.native
}
