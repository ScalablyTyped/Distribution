...
trait FirebaseAppInternals extends js.Object {
  ...
  def getToken(): js.Promise[FirebaseAuthTokenData | scala.Null] = js.native
  def getToken(refreshToken: scala.Boolean): js.Promise[FirebaseAuthTokenData | scala.Null] = js.native
