...
import typings.atFirebaseAppDashTypes.privateMod.AppHook
import typings.atFirebaseAppDashTypes.privateMod.FirebaseService
import typings.atFirebaseAppDashTypes.privateMod.FirebaseServiceFactory
import typings.atFirebaseAppDashTypes.privateMod.FirebaseServiceNamespace
...
trait Anon_AllowMultipleInstances extends js.Object {
  ...
  {readonly [ K in / * import warning: RewrittenClass.unapply cls $anonfun was tparam ErrorCode * / any ]:? @firebase/util.@firebase/util/dist/src/errors.ErrorData}
    */ typings.atFirebaseAppDashTypes.atFirebaseAppDashTypesStrings.Anon_AllowMultipleInstances with js.Any
    ]
  ] = js.native
  /**
