...
trait FastifyRequest[HttpRequest] extends js.Object {
  ...
  def multipart(
    handler: fastifyDashMultipartLib.fastifyDashMultipartMod.MultipartHandler,
...
object FastifyRequest {
  ...
  def apply[HttpRequest](
    ...
    multipart: (fastifyDashMultipartLib.fastifyDashMultipartMod.MultipartHandler, js.Function1[/* err */ stdLib.Error, scala.Unit]) => busboyLib.busboyNs.Busboy
