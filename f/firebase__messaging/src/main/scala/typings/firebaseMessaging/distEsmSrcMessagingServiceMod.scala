...
object distEsmSrcMessagingServiceMod {
  
  /* import warning: RemoveDifficultInheritance.summarizeChanges 
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _FirebaseService * / any */ @JSImport("@firebase/messaging/dist/esm/src/messaging-service", "MessagingService")
  @js.native
