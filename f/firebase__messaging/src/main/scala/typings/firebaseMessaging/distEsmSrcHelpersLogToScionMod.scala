...
import typings.firebaseMessaging.distEsmSrcInterfacesInternalMessagePayloadMod.ConsoleMessageData
import typings.firebaseMessaging.distEsmSrcInterfacesInternalMessagePayloadMod.MessageType
