...
import typings.firebaseMessaging.distEsmSrcUtilErrorsMod.ErrorCode
import typings.firebaseMessaging.distSrcInterfacesLoggingTypesMod.UserResponse
...
object firebaseMessagingStrings {
  ...
  sealed trait DELETE_REQUEST
    extends StObject
       with UserResponse
       with typings.firebaseMessaging.distEsmSrcInterfacesLoggingTypesMod.UserResponse
  ...
  sealed trait `failed-service-worker-registration`
    extends StObject
       with ErrorCode
       with typings.firebaseMessaging.distSrcUtilErrorsMod.ErrorCode
