...
object distSrcInterfacesInternalMessagePayloadMod {
  
  @js.native
  sealed trait MessageType extends StObject
  @JSImport("@firebase/messaging/dist/src/interfaces/internal-message-payload", "MessageType")
  @js.native
  object MessageType extends StObject {
    ...
    sealed trait NOTIFICATION_CLICKED
      extends StObject
         with MessageType
    /* "notification-clicked" */ val NOTIFICATION_CLICKED: typings.firebaseMessaging.distSrcInterfacesInternalMessagePayloadMod.MessageType.NOTIFICATION_CLICKED & String = js.native
    
    @js.native
    sealed trait PUSH_RECEIVED
      extends StObject
         with MessageType
    /* "push-received" */ val PUSH_RECEIVED: typings.firebaseMessaging.distSrcInterfacesInternalMessagePayloadMod.MessageType.PUSH_RECEIVED & String = js.native
  }
