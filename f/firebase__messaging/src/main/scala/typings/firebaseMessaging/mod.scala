...
object mod {
  ...
  object FirebaseApp {
    ...
    inline def apply(messaging: () => FirebaseMessaging): FirebaseApp = {
    ...
    extension [Self <: FirebaseApp](x: Self) {
      ...
      inline def setMessaging(value: () => FirebaseMessaging): Self = StObject.set(x, "messaging", js.Any.fromFunction0(value))
    }
  }
