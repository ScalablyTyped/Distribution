...
import typings.firebaseMessaging.firebaseMessagingStrings.messaging
...
object distSwInternalMod {
  
  @JSImport("@firebase/messaging/dist/sw/internal", JSImport.Namespace)
  @js.native
