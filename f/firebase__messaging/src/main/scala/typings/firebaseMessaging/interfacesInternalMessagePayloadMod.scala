...
object interfacesInternalMessagePayloadMod {
  ...
  object MessageType extends StObject {
    ...
    sealed trait NOTIFICATION_CLICKED
      extends StObject
         with MessageType
    /* "notification-clicked" */ val NOTIFICATION_CLICKED: typings.firebaseMessaging.interfacesInternalMessagePayloadMod.MessageType.NOTIFICATION_CLICKED & String = js.native
    
    @js.native
    sealed trait PUSH_RECEIVED
      extends StObject
         with MessageType
    /* "push-received" */ val PUSH_RECEIVED: typings.firebaseMessaging.interfacesInternalMessagePayloadMod.MessageType.PUSH_RECEIVED & String = js.native
  }
