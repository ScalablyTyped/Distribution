...
object constantsMod {
  ...
  object MessageType extends StObject {
    ...
    sealed trait DATA_MESSAGE
      extends StObject
         with MessageType
    /* 1 */ val DATA_MESSAGE: typings.firebaseMessaging.constantsMod.MessageType.DATA_MESSAGE & Double = js.native
    
    @js.native
    sealed trait DISPLAY_NOTIFICATION
      extends StObject
         with MessageType
    /* 3 */ val DISPLAY_NOTIFICATION: typings.firebaseMessaging.constantsMod.MessageType.DISPLAY_NOTIFICATION & Double = js.native
  }
