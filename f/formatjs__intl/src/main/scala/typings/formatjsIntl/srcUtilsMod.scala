...
object srcUtilsMod {
  ...
  object DEFAULT_INTL_CONFIG {
    ...
    @JSImport("@formatjs/intl/src/utils", "DEFAULT_INTL_CONFIG.defaultFormats")
    @js.native
    ...
    @JSImport("@formatjs/intl/src/utils", "DEFAULT_INTL_CONFIG.defaultLocale")
    @js.native
  ...
  @JSImport("@formatjs/intl/src/utils", "createFormatters")
  @js.native
  ...
  @JSImport("@formatjs/intl/src/utils", "createIntlCache")
  @js.native
  def createIntlCache(): IntlCache = js.native
  
  @JSImport("@formatjs/intl/src/utils", "filterProps")
  @js.native
  ...
  @JSImport("@formatjs/intl/src/utils", "getNamedFormat")
  @js.native
