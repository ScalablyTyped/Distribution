...
object ^ extends js.Object {
  ...
  def apply[HttpServer, HttpRequest, HttpResponse, T](
    fn: (fastifyLib.fastifyMod.fastifyNs.Plugin[HttpServer, HttpRequest, HttpResponse, T]) | (fastifyDashPluginLib.Anon_Callback[HttpServer, HttpRequest, HttpResponse, T])
