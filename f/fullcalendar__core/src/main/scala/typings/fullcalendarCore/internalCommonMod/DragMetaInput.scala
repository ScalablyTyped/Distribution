...
/* Inlined @fullcalendar/core.@fullcalendar/core/internal-common.RawOptionsFromRefiners<{  startTime :typeof createDuration,   duration :typeof createDuration,   create :std.BooleanConstructor,   sourceId :std.StringConstructor}> & {[otherProp: string] : any} */
trait DragMetaInput
  extends StObject
