...
import typings.fullcalendarCore.anon.View
...
trait BuiltInCalendarListenerRefiners extends StObject {
  ...
  var eventMouseEnter_Original: Identity[js.Function1[/* arg */ EventHoveringArg, Unit]]
