...
trait DayHeaderProps extends StObject {
  ...
  var renderIntro: js.UndefOr[js.Function1[/* rowKey */ String, VNode[js.Object]]] = js.undefined
}
object DayHeaderProps {
  ...
  implicit open class MutableBuilder[Self <: DayHeaderProps] (val x: Self) extends AnyVal {
    ...
    inline def setRenderIntro(value: /* rowKey */ String => VNode[js.Object]): Self = StObject.set(x, "renderIntro", js.Any.fromFunction1(value))
