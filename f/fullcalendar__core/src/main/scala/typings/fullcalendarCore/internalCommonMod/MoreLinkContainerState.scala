...
trait MoreLinkContainerState extends StObject {
  
  var isPopoverOpen: Boolean
  
  var popoverId: String
}
object MoreLinkContainerState {
  
  inline def apply(isPopoverOpen: Boolean, popoverId: String): MoreLinkContainerState = {
    val __obj = js.Dynamic.literal(isPopoverOpen = isPopoverOpen.asInstanceOf[js.Any], popoverId = popoverId.asInstanceOf[js.Any])
    __obj.asInstanceOf[MoreLinkContainerState]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MoreLinkContainerState] (val x: Self) extends AnyVal {
