...
trait PluginDefInput extends StObject {
  ...
  var premiumReleaseDate: js.UndefOr[String] = js.undefined
...
object PluginDefInput {
  ...
  inline def apply(name: String): PluginDefInput = {
  ...
  implicit open class MutableBuilder[Self <: PluginDefInput] (val x: Self) extends AnyVal {
    ...
    inline def setPremiumReleaseDate(value: String): Self = StObject.set(x, "premiumReleaseDate", value.asInstanceOf[js.Any])
