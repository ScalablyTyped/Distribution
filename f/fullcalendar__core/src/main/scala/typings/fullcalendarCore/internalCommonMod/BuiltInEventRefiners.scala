...
trait BuiltInEventRefiners extends StObject {
  ...
  @JSName("date")
  var date_Original: Identity[DateInput]
  
  def end(raw: DateInput): DateInput
  @JSName("end")
  var end_Original: Identity[DateInput]
  
  def extendedProps(raw: Dictionary): Dictionary
  @JSName("extendedProps")
  var extendedProps_Original: Identity[Dictionary]
  ...
  @JSName("start")
  var start_Original: Identity[DateInput]
