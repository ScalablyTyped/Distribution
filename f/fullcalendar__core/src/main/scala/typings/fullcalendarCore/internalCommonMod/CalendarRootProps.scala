...
trait CalendarRootProps extends StObject {
  ...
  def children(classNames: js.Array[String], height: CssDimValue, isHeightAuto: Boolean, forPrint: Boolean): ComponentChildren
...
object CalendarRootProps {
  ...
  inline def apply(
    children: (js.Array[String], CssDimValue, Boolean, Boolean) => ComponentChildren,
  ...
  implicit open class MutableBuilder[Self <: CalendarRootProps] (val x: Self) extends AnyVal {
    ...
    inline def setChildren(value: (js.Array[String], CssDimValue, Boolean, Boolean) => ComponentChildren): Self = StObject.set(x, "children", js.Any.fromFunction4(value))
