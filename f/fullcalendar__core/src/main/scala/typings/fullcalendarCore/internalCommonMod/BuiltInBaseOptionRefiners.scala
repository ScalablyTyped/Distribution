...
import typings.fullcalendarCore.fullcalendarCoreStrings.ltr
import typings.fullcalendarCore.fullcalendarCoreStrings.rtl
...
trait BuiltInBaseOptionRefiners extends StObject {
  ...
  var allDayClassNames_Original: Identity[ClassNamesGenerator[AllDayContentArg]]
  ...
  var allDayContent_Original: Identity[CustomContentGenerator[AllDayContentArg]]
  
  def allDayDidMount(raw: DidMountHandler[AllDayMountArg]): DidMountHandler[AllDayMountArg]
  @JSName("allDayDidMount")
  var allDayDidMount_Original: Identity[DidMountHandler[AllDayMountArg]]
  ...
  var allDayWillUnmount_Original: Identity[WillUnmountHandler[AllDayMountArg]]
  ...
  var bootstrapFontAwesome_Original: Identity[`false` | ButtonIconsInput]
  @JSName("bootstrapFontAwesome")
  ...
  var businessHours_Original: Identity[BusinessHoursInput]
  
  def buttonIcons(raw: ButtonIconsInput): `false` | ButtonIconsInput
  @JSName("buttonIcons")
  var buttonIcons_Original: Identity[`false` | ButtonIconsInput]
  @JSName("buttonIcons")
  ...
  var contentHeight_Original: Identity[CssDimValue]
  
  def customButtons(raw: StringDictionary[CustomButtonInput]): StringDictionary[CustomButtonInput]
  @JSName("customButtons")
  var customButtons_Original: Identity[StringDictionary[CustomButtonInput]]
  
  def customRenderingMetaMap(raw: StringDictionary[Any]): StringDictionary[Any]
  @JSName("customRenderingMetaMap")
  var customRenderingMetaMap_Original: Identity[StringDictionary[Any]]
  
  /* standard es5 */
  def customRenderingReplacesEl[T](): Boolean
  def customRenderingReplacesEl[T](value: T): Boolean
  @JSName("customRenderingReplacesEl")
  var customRenderingReplacesEl_Original: BooleanConstructor
  ...
  var dayCellClassNames_Original: Identity[ClassNamesGenerator[DayCellContentArg]]
  ...
  var dayCellContent_Original: Identity[CustomContentGenerator[DayCellContentArg]]
  
  def dayCellDidMount(raw: DidMountHandler[DayCellMountArg]): DidMountHandler[DayCellMountArg]
  @JSName("dayCellDidMount")
  var dayCellDidMount_Original: Identity[DidMountHandler[DayCellMountArg]]
  ...
  var dayCellWillUnmount_Original: Identity[WillUnmountHandler[DayCellMountArg]]
  ...
  var dayHeaderClassNames_Original: Identity[ClassNamesGenerator[DayHeaderContentArg]]
  ...
  var dayHeaderContent_Original: Identity[CustomContentGenerator[DayHeaderContentArg]]
  
  def dayHeaderDidMount(raw: DidMountHandler[DayHeaderMountArg]): DidMountHandler[DayHeaderMountArg]
  @JSName("dayHeaderDidMount")
  var dayHeaderDidMount_Original: Identity[DidMountHandler[DayHeaderMountArg]]
  ...
  var dayHeaderWillUnmount_Original: Identity[WillUnmountHandler[DayHeaderMountArg]]
  ...
  var dayMaxEventRows_Original: Identity[Double | Boolean]
  
  def dayMaxEvents(raw: Boolean): Double | Boolean
  def dayMaxEvents(raw: Double): Double | Boolean
  @JSName("dayMaxEvents")
  var dayMaxEvents_Original: Identity[Double | Boolean]
  ...
  @JSName("direction")
  var direction_Original: Identity[ltr | rtl]
  ...
  @JSName("dropAccept")
  var dropAccept_Original: Identity[
  ...
  @JSName("eventAllow")
  var eventAllow_Original: Identity[AllowFunc]
  ...
  var eventClassNames_Original: Identity[ClassNamesGenerator[EventContentArg]]
  ...
  var eventConstraint_Original: Identity[ConstraintInput]
  
  def eventContent(raw: CustomContentGenerator[EventContentArg]): CustomContentGenerator[EventContentArg]
  @JSName("eventContent")
  var eventContent_Original: Identity[CustomContentGenerator[EventContentArg]]
  ...
  var eventDidMount_Original: Identity[DidMountHandler[EventMountArg]]
  ...
  @JSName("eventOverlap")
  var eventOverlap_Original: Identity[Boolean | OverlapFunc]
  ...
  var eventSourceFailure_Original: Identity[js.ThisFunction1[/* this */ CalendarApi, /* error */ Any, Unit]]
  ...
  var eventSourceSuccess_Original: Identity[
    js.ThisFunction2[
      /* this */ CalendarApi, 
      /* eventsInput */ js.Array[EventInput], 
      /* response */ js.UndefOr[Response], 
  ...
  var eventWillUnmount_Original: Identity[WillUnmountHandler[EventMountArg]]
  ...
  var footerToolbar_Original: Identity[`false` | ToolbarInput]
  @JSName("footerToolbar")
  ...
  def handleCustomRendering(raw: CustomRenderingHandler[Any]): CustomRenderingHandler[Any]
  @JSName("handleCustomRendering")
  var handleCustomRendering_Original: Identity[CustomRenderingHandler[Any]]
  ...
  var headerToolbar_Original: Identity[`false` | ToolbarInput]
  @JSName("headerToolbar")
  def headerToolbar_false(raw: `false`): `false` | ToolbarInput
  
  def height(raw: CssDimValue): CssDimValue
  @JSName("height")
  var height_Original: Identity[CssDimValue]
  
  def hiddenDays(raw: js.Array[Double]): js.Array[Double]
  @JSName("hiddenDays")
  var hiddenDays_Original: Identity[js.Array[Double]]
  
  def initialDate(raw: DateInput): DateInput
  @JSName("initialDate")
  var initialDate_Original: Identity[DateInput]
  ...
  @JSName("locale")
  var locale_Original: Identity[LocaleSingularArg]
  
  def locales(raw: js.Array[LocaleInput]): js.Array[LocaleInput]
  @JSName("locales")
  var locales_Original: Identity[js.Array[LocaleInput]]
  ...
  var moreLinkClassNames_Original: Identity[ClassNamesGenerator[MoreLinkContentArg]]
  
  def moreLinkClick(raw: MoreLinkAction): MoreLinkAction
  @JSName("moreLinkClick")
  var moreLinkClick_Original: Identity[MoreLinkAction]
  ...
  var moreLinkContent_Original: Identity[CustomContentGenerator[MoreLinkContentArg]]
  
  def moreLinkDidMount(raw: DidMountHandler[MoreLinkMountArg]): DidMountHandler[MoreLinkMountArg]
  @JSName("moreLinkDidMount")
  var moreLinkDidMount_Original: Identity[DidMountHandler[MoreLinkMountArg]]
  ...
  @JSName("moreLinkHint")
  var moreLinkHint_Original: Identity[String | (js.ThisFunction1[/* this */ CalendarApi, /* num */ Double, String])]
  ...
  @JSName("moreLinkText")
  var moreLinkText_Original: Identity[String | (js.ThisFunction1[/* this */ CalendarApi, /* num */ Double, String])]
  ...
  var moreLinkWillUnmount_Original: Identity[WillUnmountHandler[MoreLinkMountArg]]
  
  def navLinkDayClick(raw: String): String | (js.ThisFunction2[/* this */ CalendarApi, /* date */ js.Date, /* jsEvent */ UIEvent, Unit])
  def navLinkDayClick(raw: js.ThisFunction2[/* this */ CalendarApi, /* date */ js.Date, /* jsEvent */ UIEvent, Unit]): String | (js.ThisFunction2[/* this */ CalendarApi, /* date */ js.Date, /* jsEvent */ UIEvent, Unit])
  @JSName("navLinkDayClick")
  var navLinkDayClick_Original: Identity[
    String | (js.ThisFunction2[/* this */ CalendarApi, /* date */ js.Date, /* jsEvent */ UIEvent, Unit])
  ]
  ...
  @JSName("navLinkHint")
  var navLinkHint_Original: Identity[String | (js.Function1[/* repeated */ Any, String])]
  
  def navLinkWeekClick(raw: String): String | (js.ThisFunction2[/* this */ CalendarApi, /* weekStart */ js.Date, /* jsEvent */ UIEvent, Unit])
  def navLinkWeekClick(
    raw: js.ThisFunction2[/* this */ CalendarApi, /* weekStart */ js.Date, /* jsEvent */ UIEvent, Unit]
  ): String | (js.ThisFunction2[/* this */ CalendarApi, /* weekStart */ js.Date, /* jsEvent */ UIEvent, Unit])
  @JSName("navLinkWeekClick")
  var navLinkWeekClick_Original: Identity[
    String | (js.ThisFunction2[/* this */ CalendarApi, /* weekStart */ js.Date, /* jsEvent */ UIEvent, Unit])
  ]
  ...
  var nowIndicatorClassNames_Original: Identity[ClassNamesGenerator[NowIndicatorContentArg]]
  ...
  var nowIndicatorContent_Original: Identity[CustomContentGenerator[NowIndicatorContentArg]]
  ...
  var nowIndicatorDidMount_Original: Identity[DidMountHandler[NowIndicatorMountArg]]
  ...
  var nowIndicatorWillUnmount_Original: Identity[WillUnmountHandler[NowIndicatorMountArg]]
  
  @JSName("nowIndicator")
  var nowIndicator_Original: BooleanConstructor
  
  @JSName("now")
  var now_Original: Identity[DateInput | (js.ThisFunction0[/* this */ CalendarApi, DateInput])]
  ...
  @JSName("selectAllow")
  var selectAllow_Original: Identity[AllowFunc]
  
  def selectConstraint(raw: ConstraintInput): ConstraintInput
  @JSName("selectConstraint")
  var selectConstraint_Original: Identity[ConstraintInput]
  ...
  var selectOverlap_Original: Identity[Boolean | OverlapFunc]
  ...
  var slotLabelClassNames_Original: Identity[ClassNamesGenerator[SlotLabelContentArg]]
  ...
  var slotLabelContent_Original: Identity[CustomContentGenerator[SlotLabelContentArg]]
  
  def slotLabelDidMount(raw: DidMountHandler[SlotLabelMountArg]): DidMountHandler[SlotLabelMountArg]
  @JSName("slotLabelDidMount")
  var slotLabelDidMount_Original: Identity[DidMountHandler[SlotLabelMountArg]]
  ...
  var slotLabelFormat_Original: Identity[FormatterInput | js.Array[FormatterInput]]
  ...
  var slotLabelWillUnmount_Original: Identity[WillUnmountHandler[SlotLabelMountArg]]
  ...
  var slotLaneClassNames_Original: Identity[ClassNamesGenerator[SlotLaneContentArg]]
  ...
  var slotLaneContent_Original: Identity[CustomContentGenerator[SlotLaneContentArg]]
  
  def slotLaneDidMount(raw: DidMountHandler[SlotLaneMountArg]): DidMountHandler[SlotLaneMountArg]
  @JSName("slotLaneDidMount")
  var slotLaneDidMount_Original: Identity[DidMountHandler[SlotLaneMountArg]]
  ...
  var slotLaneWillUnmount_Original: Identity[WillUnmountHandler[SlotLaneMountArg]]
  ...
  var stickyFooterScrollbar_Original: Identity[Boolean | auto]
  @JSName("stickyFooterScrollbar")
  ...
  var stickyHeaderDates_Original: Identity[Boolean | auto]
  @JSName("stickyHeaderDates")
  def stickyHeaderDates_auto(raw: auto): Boolean | auto
  
  def themeSystem(raw: String): String
  @JSName("themeSystem")
  var themeSystem_Original: Identity[String]
  ...
  @JSName("titleFormat")
  var titleFormat_Original: Identity[FormatterInput]
  ...
  @JSName("validRange")
  var validRange_Original: Identity[
  ...
  var viewClassNames_Original: Identity[ClassNamesGenerator[ViewContentArg]]
  
  def viewDidMount(raw: DidMountHandler[ViewMountArg]): DidMountHandler[ViewMountArg]
  @JSName("viewDidMount")
  var viewDidMount_Original: Identity[DidMountHandler[ViewMountArg]]
  
  def viewHeight(raw: CssDimValue): CssDimValue
  @JSName("viewHeight")
  var viewHeight_Original: Identity[CssDimValue]
  ...
  @JSName("viewHint")
  var viewHint_Original: Identity[String | (js.Function1[/* repeated */ Any, String])]
  
  def viewWillUnmount(raw: WillUnmountHandler[ViewMountArg]): WillUnmountHandler[ViewMountArg]
  @JSName("viewWillUnmount")
  var viewWillUnmount_Original: Identity[WillUnmountHandler[ViewMountArg]]
  ...
  @JSName("visibleRange")
  var visibleRange_Original: Identity[
  ...
  var weekNumberCalculation_Original: Identity[WeekNumberCalculation]
  ...
  var weekNumberClassNames_Original: Identity[ClassNamesGenerator[WeekNumberContentArg]]
  ...
  var weekNumberContent_Original: Identity[CustomContentGenerator[WeekNumberContentArg]]
  ...
  var weekNumberDidMount_Original: Identity[DidMountHandler[WeekNumberMountArg]]
  ...
  var weekNumberWillUnmount_Original: Identity[WillUnmountHandler[WeekNumberMountArg]]
...
object BuiltInBaseOptionRefiners {
  ...
  inline def apply(
    ...
    customRenderingMetaMap: StringDictionary[Any] => StringDictionary[Any],
    ...
    handleCustomRendering: CustomRenderingHandler[Any] => CustomRenderingHandler[Any],
    ...
    navLinkDayClick: String | (js.ThisFunction2[/* this */ CalendarApi, /* date */ js.Date, /* jsEvent */ UIEvent, Unit]) => String | (js.ThisFunction2[/* this */ CalendarApi, /* date */ js.Date, /* jsEvent */ UIEvent, Unit]),
    navLinkHint: String | (js.Function1[/* repeated */ Any, String]) => String | (js.Function1[/* repeated */ Any, String]),
    navLinkWeekClick: String | (js.ThisFunction2[/* this */ CalendarApi, /* weekStart */ js.Date, /* jsEvent */ UIEvent, Unit]) => String | (js.ThisFunction2[/* this */ CalendarApi, /* weekStart */ js.Date, /* jsEvent */ UIEvent, Unit]),
  ...
  implicit open class MutableBuilder[Self <: BuiltInBaseOptionRefiners] (val x: Self) extends AnyVal {
    ...
    inline def setCustomRenderingMetaMap(value: StringDictionary[Any] => StringDictionary[Any]): Self = StObject.set(x, "customRenderingMetaMap", js.Any.fromFunction1(value))
    
    inline def setCustomRenderingReplacesEl(value: BooleanConstructor): Self = StObject.set(x, "customRenderingReplacesEl", value.asInstanceOf[js.Any])
    ...
    inline def setHandleCustomRendering(value: CustomRenderingHandler[Any] => CustomRenderingHandler[Any]): Self = StObject.set(x, "handleCustomRendering", js.Any.fromFunction1(value))
    ...
    inline def setNavLinkDayClick(
      value: String | (js.ThisFunction2[/* this */ CalendarApi, /* date */ js.Date, /* jsEvent */ UIEvent, Unit]) => String | (js.ThisFunction2[/* this */ CalendarApi, /* date */ js.Date, /* jsEvent */ UIEvent, Unit])
    ...
    inline def setNavLinkWeekClick(
      value: String | (js.ThisFunction2[/* this */ CalendarApi, /* weekStart */ js.Date, /* jsEvent */ UIEvent, Unit]) => String | (js.ThisFunction2[/* this */ CalendarApi, /* weekStart */ js.Date, /* jsEvent */ UIEvent, Unit])
