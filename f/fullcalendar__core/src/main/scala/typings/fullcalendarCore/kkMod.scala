...
object kkMod extends Shortcut {
  
  @JSImport("@fullcalendar/core/locales/kk", JSImport.Default)
  @js.native
  val default: LocaleInput = js.native
  
  type _To = LocaleInput
  
  /* This means you don't have to write `default`, but can instead just say `kkMod.foo` */
