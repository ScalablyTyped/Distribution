...
object nlMod extends Shortcut {
  
  @JSImport("@fullcalendar/core/locales/nl", JSImport.Default)
  @js.native
  val default: LocaleInput = js.native
  
  type _To = LocaleInput
  
  /* This means you don't have to write `default`, but can instead just say `nlMod.foo` */
