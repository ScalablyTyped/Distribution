...
import typings.preact.mod.ErrorInfo
...
open class Component[P, S] () extends StObject {
  ...
  def render(): typings.preact.mod.ComponentChild = js.native
  def render(props: Unit, state: S): typings.preact.mod.ComponentChild = js.native
  def render(props: Unit, state: S, context: Any): typings.preact.mod.ComponentChild = js.native
  def render(props: Unit, state: Unit, context: Any): typings.preact.mod.ComponentChild = js.native
  def render(props: RenderableProps[P, Any]): typings.preact.mod.ComponentChild = js.native
  def render(props: RenderableProps[P, Any], state: S): typings.preact.mod.ComponentChild = js.native
  def render(props: RenderableProps[P, Any], state: S, context: Any): typings.preact.mod.ComponentChild = js.native
  def render(props: RenderableProps[P, Any], state: Unit, context: Any): typings.preact.mod.ComponentChild = js.native
...
object Component {
  ...
  @js.native
  def contextType: js.UndefOr[typings.preact.mod.Context[Any]] = js.native
  inline def contextType_=(x: js.UndefOr[typings.preact.mod.Context[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("contextType")(x.asInstanceOf[js.Any])
