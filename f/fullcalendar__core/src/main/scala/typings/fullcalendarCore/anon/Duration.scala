...
trait Duration extends StObject {
  ...
  var duration: typings.fullcalendarCore.internalCommonMod.Duration | Null
...
object Duration {
  ...
  implicit open class MutableBuilder[Self <: Duration] (val x: Self) extends AnyVal {
    ...
    inline def setDuration(value: typings.fullcalendarCore.internalCommonMod.Duration): Self = StObject.set(x, "duration", value.asInstanceOf[js.Any])
