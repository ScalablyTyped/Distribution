...
object FieldProps {
  ...
  def apply[V](
    ...
    if (classNameModifiers != null) __obj.updateDynamic("classNameModifiers")(classNameModifiers)
    ...
    if (validityErrors != null) __obj.updateDynamic("validityErrors")(validityErrors)
