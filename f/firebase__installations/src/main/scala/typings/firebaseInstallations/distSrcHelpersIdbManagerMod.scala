...
import typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InstallationEntry
import typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.RegisteredInstallationEntry
import typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.UnregisteredInstallationEntry
