...
object installationImplMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _FirebaseService * / any */ trait FirebaseInstallationsImpl
    ...
    val heartbeatServiceProvider: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<'heartbeat'> */ Any
  }
  object FirebaseInstallationsImpl {
    ...
    extension [Self <: FirebaseInstallationsImpl](x: Self) {
      ...
      inline def setHeartbeatServiceProvider(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Provider<'heartbeat'> */ Any
      ): Self = StObject.set(x, "heartbeatServiceProvider", value.asInstanceOf[js.Any])
    }
  }
}
