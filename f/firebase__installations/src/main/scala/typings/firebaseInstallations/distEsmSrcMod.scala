...
import typings.firebaseInstallations.distEsmSrcApiOnIdChangeMod.IdChangeUnsubscribeFn
import typings.firebaseInstallations.distEsmSrcInterfacesPublicTypesMod.FirebaseInstallationsInternal
