...
object distSrcInterfacesInstallationEntryMod {
  
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.NotStartedAuthToken
    - typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressAuthToken
    - typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.CompletedAuthToken
  */
  trait AuthToken extends StObject
  object AuthToken {
    
    inline def CompletedAuthToken(creationTime: Double, expiresIn: Double, token: String): typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.CompletedAuthToken = {
      ...
      __obj.asInstanceOf[typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.CompletedAuthToken]
    }
    
    inline def InProgressAuthToken(requestTime: Double): typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressAuthToken = {
      val __obj = js.Dynamic.literal(requestStatus = 1, requestTime = requestTime.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressAuthToken]
    }
    
    inline def NotStartedAuthToken(): typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.NotStartedAuthToken = {
      val __obj = js.Dynamic.literal(requestStatus = 0)
      __obj.asInstanceOf[typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.NotStartedAuthToken]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.UnregisteredInstallationEntry
    - typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressInstallationEntry
    - typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.RegisteredInstallationEntry
  */
  trait InstallationEntry extends StObject
  object InstallationEntry {
    
    inline def InProgressInstallationEntry(fid: String, registrationTime: Double): typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressInstallationEntry = {
      val __obj = js.Dynamic.literal(fid = fid.asInstanceOf[js.Any], registrationStatus = 1, registrationTime = registrationTime.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressInstallationEntry]
    }
    
    inline def RegisteredInstallationEntry(authToken: AuthToken, fid: String, refreshToken: String): typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.RegisteredInstallationEntry = {
      ...
      __obj.asInstanceOf[typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.RegisteredInstallationEntry]
    }
    
    inline def UnregisteredInstallationEntry(fid: String): typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.UnregisteredInstallationEntry = {
      val __obj = js.Dynamic.literal(fid = fid.asInstanceOf[js.Any], registrationStatus = 0)
      __obj.asInstanceOf[typings.firebaseInstallations.distSrcInterfacesInstallationEntryMod.UnregisteredInstallationEntry]
    }
  }
