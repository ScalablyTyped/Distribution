package typings
package fastifyDashRateDashLimitLib.fastifyDashRateDashLimitMod
...
trait FastifyRateLimitOptions[T] extends js.Object {
  ...
  /**
    ...
    * default: null
    */
  var redis: js.UndefOr[ioredisLib.ioredisMod.Redis] = js.undefined
  /**
...
object FastifyRateLimitOptions {
  ...
  def apply[T](
    ...
    keyGenerator: /* req */ T => java.lang.String = null,
    max: scala.Int | scala.Double = null,
    redis: ioredisLib.ioredisMod.Redis = null,
