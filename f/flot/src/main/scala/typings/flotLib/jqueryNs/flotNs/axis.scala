...
object axis {
  @scala.inline
  def apply(
    c2p: js.Function1[canvasPoint, point],
    options: axisOptions,
    p2c: js.Function1[point, canvasPoint],
    alignTicksWithAxis: scala.Int | scala.Double = null,
    autoscaleMargin: scala.Int | scala.Double = null,
    color: js.Any = null,
    font: js.Any = null,
    inverseTransform: js.Function1[/* v */ scala.Double, scala.Double] = null,
    ...
    tickFormatter: js.Function2[/* t */ scala.Double, /* a */ js.UndefOr[axis], java.lang.String] = null,
    ...
    if (inverseTransform != null) __obj.updateDynamic("inverseTransform")(inverseTransform)
