...
import typings.fixedDataTable2.mod.CellProps
import typings.fixedDataTable2.mod.ColumnGroupProps
import typings.fixedDataTable2.mod.ColumnProps
import typings.fixedDataTable2.mod.TableProps
...
object global {
  ...
  object FixedDataTable {
    ...
    open class Cell protected ()
      extends typings.fixedDataTable2.mod.Cell {
    ...
    open class Column protected ()
      extends typings.fixedDataTable2.mod.Column {
    ...
    open class ColumnGroup protected ()
      extends typings.fixedDataTable2.mod.ColumnGroup {
    ...
    open class Table protected ()
      extends typings.fixedDataTable2.mod.Table {
