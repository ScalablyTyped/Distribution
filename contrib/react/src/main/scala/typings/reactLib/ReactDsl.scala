...
object ReactDsl {
  type Dom[T] = DOMElement[HTMLAttributes[T], T]
  ...
  @inline final class BuildIntrinsic[P[e] <: DOMAttributes[e], E](
    ...
    @inline def apply(props: P[E], children: ReactNode*): ReactElement[P[E]] =
  ...
  /**
    ...
    *
    * // usage
    * componentClass[Foo].apply(new FooProps{}, "child1", 2)
    *
    * Note that because of some implicit magic you need to spell out `apply`
    * ```
    */
  @inline def componentClass[C <: Component[_, _, _]](implicit C: js.ConstructorTag[C]): InferProps[C] =
    C.constructor.asInstanceOf[InferProps[C]]

  @inline def component[P <: js.Any](_ctor: ComponentClass[P, _]): BuildComponent[P] =
    new BuildComponent[P](_ctor.asInstanceOf[ComponentClass[P, ComponentState]], js.undefined, js.undefined)

  @inline def componentInstantiable1[P <: js.Any](_ctor: Instantiable1[P, ReactElement[_]]): BuildComponent[P] =
    new BuildComponent[P](_ctor.asInstanceOf[ComponentClass[P, ComponentState]], js.undefined, js.undefined)

  @inline def componentInstantiable2[P <: js.Any](_ctor: Instantiable2[P, _, ReactElement[_]]): BuildComponent[P] =
    new BuildComponent[P](_ctor.asInstanceOf[ComponentClass[P, ComponentState]], js.undefined, js.undefined)

  // dodgy cast inside here, but I don't think it matters. let's see
  @inline def component[P <: js.Any](_ctor: SFC[P]): BuildComponent[P] =
    new BuildComponent[P](_ctor.asInstanceOf[ComponentClass[P, ComponentState]], js.undefined, js.undefined)
  ...
  object InferProps {
    @inline implicit def builder[P <: js.Any](ctor: InferProps[Component[P, _, _]]): BuildComponent[P] =
      new BuildComponent[P](ctor.asInstanceOf[ComponentClass[P, ComponentState]])
  }

  @inline final class BuildComponent[P <: js.Any] private[ReactDsl] (
    ...
    @inline def apply(props: P, children: ReactNode*): ReactElement[P] = {
      if (LinkingInfo.developmentMode && js.isUndefined(ctor))
        console.warn("Component was undefined", props, _key.asInstanceOf[js.Any], _ref.asInstanceOf[js.Any], children)
