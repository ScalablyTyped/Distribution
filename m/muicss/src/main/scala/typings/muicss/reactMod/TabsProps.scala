...
object TabsProps {
  ...
  def apply(
    ...
    defaultSelectedIndex: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(defaultSelectedIndex)) __obj.updateDynamic("defaultSelectedIndex")(defaultSelectedIndex.get.asInstanceOf[js.Any])
