...
object ColProps {
  ...
  def apply(
    ...
    `lg-offset`: js.UndefOr[Double] = js.undefined,
    md: js.UndefOr[Double] = js.undefined,
    `md-offset`: js.UndefOr[Double] = js.undefined,
    ...
    `sm-offset`: js.UndefOr[Double] = js.undefined,
    ...
    `xl-offset`: js.UndefOr[Double] = js.undefined,
    xs: js.UndefOr[Double] = js.undefined,
    `xs-offset`: js.UndefOr[Double] = js.undefined
  ): ColProps = {
    ...
    if (!js.isUndefined(`lg-offset`)) __obj.updateDynamic("lg-offset")(`lg-offset`.get.asInstanceOf[js.Any])
    if (!js.isUndefined(md)) __obj.updateDynamic("md")(md.get.asInstanceOf[js.Any])
    if (!js.isUndefined(`md-offset`)) __obj.updateDynamic("md-offset")(`md-offset`.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(`sm-offset`)) __obj.updateDynamic("sm-offset")(`sm-offset`.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(`xl-offset`)) __obj.updateDynamic("xl-offset")(`xl-offset`.get.asInstanceOf[js.Any])
    if (!js.isUndefined(xs)) __obj.updateDynamic("xs")(xs.get.asInstanceOf[js.Any])
    if (!js.isUndefined(`xs-offset`)) __obj.updateDynamic("xs-offset")(`xs-offset`.get.asInstanceOf[js.Any])
