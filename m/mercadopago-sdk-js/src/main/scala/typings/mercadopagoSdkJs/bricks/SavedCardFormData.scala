...
trait SavedCardFormData extends StObject {
  
  var installments: Double
  
  var issuer_id: String | Null
  
  var payer: SavedCardPayer
...
object SavedCardFormData {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[SavedCardFormData]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SavedCardFormData] (val x: Self) extends AnyVal {
    ...
    inline def setPayer(value: SavedCardPayer): Self = StObject.set(x, "payer", value.asInstanceOf[js.Any])
