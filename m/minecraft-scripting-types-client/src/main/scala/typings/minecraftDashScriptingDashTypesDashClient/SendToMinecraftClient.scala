...
/* Rewritten from type alias, can be one of: 
  - typings.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:display_chat_event`
  - typings.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:load_ui`
  - typings.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:script_logger_config`
  - typings.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:send_ui_event`
  - typings.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:spawn_particle_attached_entity`
  - typings.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:spawn_particle_in_world`
  - typings.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:unload_ui`
*/
...
object SendToMinecraftClient {
  /**
    ...
    */
  @scala.inline
  def DisplayChat: `minecraft:display_chat_event` = this.cast("minecraft:display_chat_event")
  /**
    ...
    */
  @scala.inline
  def LoadUI: `minecraft:load_ui` = this.cast("minecraft:load_ui")
  /**
    ...
    */
  @scala.inline
  def ScriptLoggerConfig: `minecraft:script_logger_config` = this.cast("minecraft:script_logger_config")
  /**
    ...
    */
  @scala.inline
  def SendUIEvent: `minecraft:send_ui_event` = this.cast("minecraft:send_ui_event")
  /**
    ...
    */
  @scala.inline
  def SpawnParticleAttachedEntity: `minecraft:spawn_particle_attached_entity` = this.cast("minecraft:spawn_particle_attached_entity")
  /**
    ...
    */
  @scala.inline
  def SpawnParticleInWorld: `minecraft:spawn_particle_in_world` = this.cast("minecraft:spawn_particle_in_world")
  /**
    ...
    */
  @scala.inline
  def UnloadUI: `minecraft:unload_ui` = this.cast("minecraft:unload_ui")
  @scala.inline
