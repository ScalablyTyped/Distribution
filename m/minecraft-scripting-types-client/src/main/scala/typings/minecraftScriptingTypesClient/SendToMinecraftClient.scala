...
object SendToMinecraftClient {
  ...
  /**
    ...
    */
  inline def LoadUI: minecraftColonload_ui = "minecraft:load_ui".asInstanceOf[minecraftColonload_ui]
  ...
  /**
    ...
    */
  inline def SendUIEvent: minecraftColonsend_ui_event = "minecraft:send_ui_event".asInstanceOf[minecraftColonsend_ui_event]
  ...
  /**
    ...
    */
  inline def UnloadUI: minecraftColonunload_ui = "minecraft:unload_ui".asInstanceOf[minecraftColonunload_ui]
}
