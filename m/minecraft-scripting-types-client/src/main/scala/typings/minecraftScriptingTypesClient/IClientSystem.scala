...
import typings.minecraftScriptingTypesClient.minecraftScriptingTypesClientBooleans.`false`
import typings.minecraftScriptingTypesClient.minecraftScriptingTypesClientBooleans.`true`
