...
trait IClientSystem[TSystem]
  ...
  /**
    ...
    */
  def hasComponent(
    entityObject: minecraftDashScriptingDashTypesDashSharedLib.IEntity,
    componentIdentifier: java.lang.String
  ): minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibNumbers.`true` | minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibNumbers.`false` | scala.Null = js.native
}
