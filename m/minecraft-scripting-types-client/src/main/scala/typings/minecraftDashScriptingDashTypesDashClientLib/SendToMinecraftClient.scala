...
object SendToMinecraftClient {
  /**
    ...
    */
  @scala.inline
  def DisplayChat: minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibStrings.`minecraft:display_chat_event` = this.cast("minecraft:display_chat_event")
  /**
    ...
    */
  @scala.inline
  def LoadUI: minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibStrings.`minecraft:load_ui` = this.cast("minecraft:load_ui")
  /**
    ...
    */
  @scala.inline
  def ScriptLoggerConfig: minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibStrings.`minecraft:script_logger_config` = this.cast("minecraft:script_logger_config")
  /**
    ...
    */
  @scala.inline
  def SendUIEvent: minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibStrings.`minecraft:send_ui_event` = this.cast("minecraft:send_ui_event")
  /**
    ...
    */
  @scala.inline
  def SpawnParticleAttachedEntity: minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibStrings.`minecraft:spawn_particle_attached_entity` = this.cast("minecraft:spawn_particle_attached_entity")
  /**
    ...
    */
  @scala.inline
  def SpawnParticleInWorld: minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibStrings.`minecraft:spawn_particle_in_world` = this.cast("minecraft:spawn_particle_in_world")
  /**
    ...
    */
  @scala.inline
  def UnloadUI: minecraftDashScriptingDashTypesDashClientLib.minecraftDashScriptingDashTypesDashClientLibStrings.`minecraft:unload_ui` = this.cast("minecraft:unload_ui")
  @scala.inline
