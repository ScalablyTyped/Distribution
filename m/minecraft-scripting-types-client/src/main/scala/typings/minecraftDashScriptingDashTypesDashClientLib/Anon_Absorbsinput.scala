...
trait Anon_Absorbsinput extends js.Object {
  /**
    ...
    */
  var absorbs_input: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var always_accepts_input: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * If true, this screen will be rendered even if another screen is on top of it and will render over them, including the HUD
    */
  var force_render_below: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * If true, the screen will be treated as the pause menu and the pause menu won't be allowed to show on top of this screen
    */
  var is_showing_menu: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * If true, the game will continue to be rendered underneath this screen
    */
  var render_game_behind: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * If true, this screen will only be rendered if it is the screen at the top of the stack
    */
  var render_only_when_topmost: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * If true, the screen will capture the mouse pointer and limit its movement to the UI screen
    */
  var should_steal_mouse: js.UndefOr[scala.Boolean] = js.undefined
}

object Anon_Absorbsinput {
  @scala.inline
  def apply(
    absorbs_input: js.UndefOr[scala.Boolean] = js.undefined,
    always_accepts_input: js.UndefOr[scala.Boolean] = js.undefined,
    force_render_below: js.UndefOr[scala.Boolean] = js.undefined,
    is_showing_menu: js.UndefOr[scala.Boolean] = js.undefined,
    render_game_behind: js.UndefOr[scala.Boolean] = js.undefined,
    render_only_when_topmost: js.UndefOr[scala.Boolean] = js.undefined,
    should_steal_mouse: js.UndefOr[scala.Boolean] = js.undefined
  ): Anon_Absorbsinput = {
