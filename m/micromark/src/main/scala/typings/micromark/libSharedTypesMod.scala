...
object libSharedTypesMod {
  ...
  */
  ...
  object HtmlExtension {
    ...
    @scala.inline
    def EnterRecord(enter: Record[Type, js.Function0[Unit]]): typings.micromark.anon.EnterRecord = {
      val __obj = js.Dynamic.literal(enter = enter.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.micromark.anon.EnterRecord]
    }
    
    @scala.inline
    def ExitRecord(exit: Record[Type, js.Function0[Unit]]): typings.micromark.anon.ExitRecord = {
