...
import typings.maximMazurokGapiClientDatalabeling.gapi.client.datalabeling.GoogleCloudDatalabelingV1beta1EvaluationJob
...
trait UpdateMask extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDatalabelingV1beta1EvaluationJob = js.native
...
object UpdateMask {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudDatalabelingV1beta1EvaluationJob): UpdateMask = {
  ...
  implicit class UpdateMaskMutableBuilder[Self <: UpdateMask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDatalabelingV1beta1EvaluationJob): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
