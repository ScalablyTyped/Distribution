...
object GoogleCloudDatalabelingV1alpha1LabelTextClassificationOperationMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1alpha1LabelTextClassificationOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1alpha1LabelTextClassificationOperationMetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDatalabelingV1alpha1LabelTextClassificationOperationMetadata] (val x: Self) extends AnyVal {
