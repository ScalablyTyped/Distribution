...
object GoogleCloudDatalabelingV1alpha1ExportDataOperationResponse {
  ...
  inline def apply(): GoogleCloudDatalabelingV1alpha1ExportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1alpha1ExportDataOperationResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDatalabelingV1alpha1ExportDataOperationResponse] (val x: Self) extends AnyVal {
    ...
    inline def setLabelStats(value: GoogleCloudDatalabelingV1alpha1LabelStats): Self = StObject.set(x, "labelStats", value.asInstanceOf[js.Any])
    
    inline def setLabelStatsUndefined: Self = StObject.set(x, "labelStats", js.undefined)
    
    inline def setOutputConfig(value: GoogleCloudDatalabelingV1alpha1OutputConfig): Self = StObject.set(x, "outputConfig", value.asInstanceOf[js.Any])
