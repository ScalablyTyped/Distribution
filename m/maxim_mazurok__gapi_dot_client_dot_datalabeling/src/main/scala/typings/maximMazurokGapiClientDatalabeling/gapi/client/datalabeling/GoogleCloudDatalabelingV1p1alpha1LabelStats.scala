...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1LabelStats extends js.Object {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientDatalabeling.maximMazurokGapiClientDatalabelingStrings.GoogleCloudDatalabelingV1p1alpha1LabelStats with TopLevel[js.Any]
  ] = js.native
}
object GoogleCloudDatalabelingV1p1alpha1LabelStats {
  
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p1alpha1LabelStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p1alpha1LabelStats]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1LabelStatsOps[Self <: GoogleCloudDatalabelingV1p1alpha1LabelStats] (val x: Self) extends AnyVal {
