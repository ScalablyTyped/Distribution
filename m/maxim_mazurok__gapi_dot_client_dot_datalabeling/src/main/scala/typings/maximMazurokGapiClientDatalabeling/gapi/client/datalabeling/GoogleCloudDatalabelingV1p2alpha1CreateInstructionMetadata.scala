...
object GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadataMutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata] (val x: Self) extends AnyVal {
