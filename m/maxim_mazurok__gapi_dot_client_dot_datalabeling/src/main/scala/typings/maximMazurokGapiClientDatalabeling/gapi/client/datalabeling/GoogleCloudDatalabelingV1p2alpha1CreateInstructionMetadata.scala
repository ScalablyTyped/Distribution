...
object GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata] (val x: Self) extends AnyVal {
