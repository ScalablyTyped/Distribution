...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadataOps[Self <: GoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata] (val x: Self) extends AnyVal {
