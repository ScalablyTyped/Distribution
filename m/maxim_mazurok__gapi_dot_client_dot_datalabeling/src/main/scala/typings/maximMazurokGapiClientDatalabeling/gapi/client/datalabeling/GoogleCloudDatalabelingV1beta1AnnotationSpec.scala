...
@js.native
trait GoogleCloudDatalabelingV1beta1AnnotationSpec extends js.Object {
...
object GoogleCloudDatalabelingV1beta1AnnotationSpec {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1AnnotationSpecOps[Self <: GoogleCloudDatalabelingV1beta1AnnotationSpec] (val x: Self) extends AnyVal {
