...
object GoogleCloudDatalabelingV1p2alpha1GcsFolderDestination {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p2alpha1GcsFolderDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1GcsFolderDestination]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1GcsFolderDestination] (val x: Self) extends AnyVal {
