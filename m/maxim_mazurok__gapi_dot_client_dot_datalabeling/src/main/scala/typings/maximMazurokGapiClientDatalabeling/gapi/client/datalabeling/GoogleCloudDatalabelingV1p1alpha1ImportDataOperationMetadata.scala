...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata] (val x: Self) extends AnyVal {
