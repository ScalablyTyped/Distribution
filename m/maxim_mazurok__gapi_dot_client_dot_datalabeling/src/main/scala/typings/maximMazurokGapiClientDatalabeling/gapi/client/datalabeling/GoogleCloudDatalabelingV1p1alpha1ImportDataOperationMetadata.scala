...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata extends StObject {
...
object GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata {
  
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadataMutableBuilder[Self <: GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata] (val x: Self) extends AnyVal {
