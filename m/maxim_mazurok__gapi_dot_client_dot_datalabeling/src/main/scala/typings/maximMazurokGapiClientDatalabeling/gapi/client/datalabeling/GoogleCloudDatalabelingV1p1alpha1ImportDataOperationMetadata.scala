...
object GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDatalabelingV1p1alpha1ImportDataOperationMetadata] (val x: Self) extends AnyVal {
