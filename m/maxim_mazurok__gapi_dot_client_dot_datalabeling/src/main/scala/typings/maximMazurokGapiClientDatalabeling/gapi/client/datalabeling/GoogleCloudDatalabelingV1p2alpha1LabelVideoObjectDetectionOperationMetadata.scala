...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectDetectionOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectDetectionOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectDetectionOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectDetectionOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectDetectionOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectDetectionOperationMetadata] (val x: Self) extends AnyVal {
