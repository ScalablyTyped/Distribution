...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1LabelImageBoundingPolyOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1LabelImageBoundingPolyOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1LabelImageBoundingPolyOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1LabelImageBoundingPolyOperationMetadata] (val x: Self) extends AnyVal {
