...
@js.native
trait GoogleCloudDatalabelingV1beta1VideoEventAnnotation extends js.Object {
...
object GoogleCloudDatalabelingV1beta1VideoEventAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1VideoEventAnnotationOps[Self <: GoogleCloudDatalabelingV1beta1VideoEventAnnotation] (val x: Self) extends AnyVal {
