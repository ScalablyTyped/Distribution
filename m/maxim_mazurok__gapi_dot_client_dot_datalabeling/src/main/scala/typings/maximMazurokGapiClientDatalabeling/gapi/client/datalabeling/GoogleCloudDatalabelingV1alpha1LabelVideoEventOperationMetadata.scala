...
@js.native
trait GoogleCloudDatalabelingV1alpha1LabelVideoEventOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1alpha1LabelVideoEventOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1alpha1LabelVideoEventOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1alpha1LabelVideoEventOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1alpha1LabelVideoEventOperationMetadataOps[Self <: GoogleCloudDatalabelingV1alpha1LabelVideoEventOperationMetadata] (val x: Self) extends AnyVal {
