...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfigOps[Self <: GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig] (val x: Self) extends AnyVal {
