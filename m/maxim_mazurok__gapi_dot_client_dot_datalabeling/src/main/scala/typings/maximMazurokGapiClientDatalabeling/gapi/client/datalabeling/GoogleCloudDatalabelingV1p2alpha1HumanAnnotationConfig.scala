...
trait GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig extends StObject {
...
object GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig {
  
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfigMutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig] (val x: Self) extends AnyVal {
