...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse extends js.Object {
  ...
  var labelStats: js.UndefOr[GoogleCloudDatalabelingV1p2alpha1LabelStats] = js.native
  
  /** Output only. output_config in the ExportData request. */
  var outputConfig: js.UndefOr[GoogleCloudDatalabelingV1p2alpha1OutputConfig] = js.native
...
object GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponseOps[Self <: GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelStats(value: GoogleCloudDatalabelingV1p2alpha1LabelStats): Self = this.set("labelStats", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLabelStats: Self = this.set("labelStats", js.undefined)
    
    @scala.inline
    def setOutputConfig(value: GoogleCloudDatalabelingV1p2alpha1OutputConfig): Self = this.set("outputConfig", value.asInstanceOf[js.Any])
