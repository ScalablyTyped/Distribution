...
@js.native
trait GoogleCloudDatalabelingV1beta1ExportDataOperationResponse extends StObject {
...
object GoogleCloudDatalabelingV1beta1ExportDataOperationResponse {
  
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1beta1ExportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1beta1ExportDataOperationResponse]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1ExportDataOperationResponseMutableBuilder[Self <: GoogleCloudDatalabelingV1beta1ExportDataOperationResponse] (val x: Self) extends AnyVal {
