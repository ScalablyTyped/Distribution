...
object GoogleCloudDatalabelingV1beta1LabelTextEntityExtractionOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1LabelTextEntityExtractionOperationMetadataMutableBuilder[Self <: GoogleCloudDatalabelingV1beta1LabelTextEntityExtractionOperationMetadata] (val x: Self) extends AnyVal {
