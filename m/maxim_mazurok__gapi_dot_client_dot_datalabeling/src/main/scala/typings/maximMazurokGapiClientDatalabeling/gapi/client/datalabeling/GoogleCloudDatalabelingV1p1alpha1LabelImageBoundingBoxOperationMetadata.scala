...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1LabelImageBoundingBoxOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1LabelImageBoundingBoxOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1LabelImageBoundingBoxOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1LabelImageBoundingBoxOperationMetadata] (val x: Self) extends AnyVal {
