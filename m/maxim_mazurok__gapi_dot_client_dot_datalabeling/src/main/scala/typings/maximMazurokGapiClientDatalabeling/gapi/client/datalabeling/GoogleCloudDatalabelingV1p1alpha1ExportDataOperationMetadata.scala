...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata] (val x: Self) extends AnyVal {
