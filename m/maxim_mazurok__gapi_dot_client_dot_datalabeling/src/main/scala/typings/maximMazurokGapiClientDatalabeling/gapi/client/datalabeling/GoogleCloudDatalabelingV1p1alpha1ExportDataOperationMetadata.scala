...
object GoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata] (val x: Self) extends AnyVal {
