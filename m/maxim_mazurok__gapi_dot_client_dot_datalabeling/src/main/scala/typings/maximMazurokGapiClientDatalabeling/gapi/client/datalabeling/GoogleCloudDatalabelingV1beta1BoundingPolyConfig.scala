...
@js.native
trait GoogleCloudDatalabelingV1beta1BoundingPolyConfig extends js.Object {
...
object GoogleCloudDatalabelingV1beta1BoundingPolyConfig {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1BoundingPolyConfigOps[Self <: GoogleCloudDatalabelingV1beta1BoundingPolyConfig] (val x: Self) extends AnyVal {
