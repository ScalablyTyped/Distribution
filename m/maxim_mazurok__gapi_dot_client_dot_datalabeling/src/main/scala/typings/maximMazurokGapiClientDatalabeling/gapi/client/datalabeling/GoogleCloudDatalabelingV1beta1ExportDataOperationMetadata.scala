...
@js.native
trait GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata extends StObject {
...
object GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata {
  
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1ExportDataOperationMetadataMutableBuilder[Self <: GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata] (val x: Self) extends AnyVal {
