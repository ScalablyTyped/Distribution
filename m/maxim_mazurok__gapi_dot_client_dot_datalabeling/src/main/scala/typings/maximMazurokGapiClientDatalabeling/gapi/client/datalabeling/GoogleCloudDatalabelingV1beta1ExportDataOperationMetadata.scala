...
object GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDatalabelingV1beta1ExportDataOperationMetadata] (val x: Self) extends AnyVal {
