...
@js.native
trait GoogleCloudDatalabelingV1alpha1LabelImageBoundingPolyOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1alpha1LabelImageBoundingPolyOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1alpha1LabelImageBoundingPolyOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1alpha1LabelImageBoundingPolyOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1alpha1LabelImageBoundingPolyOperationMetadataOps[Self <: GoogleCloudDatalabelingV1alpha1LabelImageBoundingPolyOperationMetadata] (val x: Self) extends AnyVal {
