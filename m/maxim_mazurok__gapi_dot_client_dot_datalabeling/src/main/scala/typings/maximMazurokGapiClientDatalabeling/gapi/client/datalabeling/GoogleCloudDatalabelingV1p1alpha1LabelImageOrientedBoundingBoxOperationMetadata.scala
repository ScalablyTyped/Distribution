...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1LabelImageOrientedBoundingBoxOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1LabelImageOrientedBoundingBoxOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1LabelImageOrientedBoundingBoxOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1LabelImageOrientedBoundingBoxOperationMetadata] (val x: Self) extends AnyVal {
