...
@js.native
trait GoogleCloudDatalabelingV1beta1AnnotationSpecSetConfig extends js.Object {
...
object GoogleCloudDatalabelingV1beta1AnnotationSpecSetConfig {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1AnnotationSpecSetConfigOps[Self <: GoogleCloudDatalabelingV1beta1AnnotationSpecSetConfig] (val x: Self) extends AnyVal {
