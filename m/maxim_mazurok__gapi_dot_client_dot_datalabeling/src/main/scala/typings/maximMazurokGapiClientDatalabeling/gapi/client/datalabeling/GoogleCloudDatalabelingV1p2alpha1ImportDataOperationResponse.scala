...
object GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse] (val x: Self) extends AnyVal {
