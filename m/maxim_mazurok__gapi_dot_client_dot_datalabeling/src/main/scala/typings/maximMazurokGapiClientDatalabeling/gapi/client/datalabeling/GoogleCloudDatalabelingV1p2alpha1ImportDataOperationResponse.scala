...
object GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponseMutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse] (val x: Self) extends AnyVal {
