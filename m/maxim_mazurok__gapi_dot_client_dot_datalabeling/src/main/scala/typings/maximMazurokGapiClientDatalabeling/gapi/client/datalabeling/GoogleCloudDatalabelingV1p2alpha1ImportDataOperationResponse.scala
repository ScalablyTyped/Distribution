...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponseOps[Self <: GoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse] (val x: Self) extends AnyVal {
