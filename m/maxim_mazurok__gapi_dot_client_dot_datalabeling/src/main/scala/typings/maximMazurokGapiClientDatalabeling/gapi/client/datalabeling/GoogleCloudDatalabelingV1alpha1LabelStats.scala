...
trait GoogleCloudDatalabelingV1alpha1LabelStats extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientDatalabeling.maximMazurokGapiClientDatalabelingStrings.GoogleCloudDatalabelingV1alpha1LabelStats & TopLevel[js.Any]
  ] = js.undefined
}
object GoogleCloudDatalabelingV1alpha1LabelStats {
  
  inline def apply(): GoogleCloudDatalabelingV1alpha1LabelStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1alpha1LabelStats]
  }
  
  extension [Self <: GoogleCloudDatalabelingV1alpha1LabelStats](x: Self) {
