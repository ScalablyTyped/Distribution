...
@js.native
trait AdClientId extends StObject {
...
object AdClientId {
  ...
  @scala.inline
  def apply(accountId: String, adClientId: String, adUnitId: String): AdClientId = {
  ...
  @scala.inline
  implicit class AdClientIdMutableBuilder[Self <: AdClientId] (val x: Self) extends AnyVal {
