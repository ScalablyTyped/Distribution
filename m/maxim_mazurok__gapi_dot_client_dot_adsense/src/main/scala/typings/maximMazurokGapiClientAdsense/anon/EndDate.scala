...
trait EndDate extends StObject {
  ...
  var accountId: js.UndefOr[String | js.Array[String]] = js.undefined
...
object EndDate {
  ...
  inline def apply(endDate: String, startDate: String): EndDate = {
  ...
  extension [Self <: EndDate](x: Self) {
    ...
    inline def setAccountId(value: String | js.Array[String]): Self = StObject.set(x, "accountId", value.asInstanceOf[js.Any])
