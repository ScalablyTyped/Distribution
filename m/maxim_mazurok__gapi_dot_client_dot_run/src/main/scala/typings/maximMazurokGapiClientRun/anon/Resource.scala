...
import typings.maximMazurokGapiClientRun.gapi.client.run.GoogleCloudRunV2Service
...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudRunV2Service
...
object Resource {
  ...
  inline def apply(name: String, resource: GoogleCloudRunV2Service): Resource = {
  ...
  implicit open class MutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: GoogleCloudRunV2Service): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
