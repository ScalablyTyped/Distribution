...
object ListConfigurationsResponse {
  ...
  extension [Self <: ListConfigurationsResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[Configuration]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Configuration*): Self = StObject.set(x, "items", js.Array(value :_*))
