...
object ListDomainMappingsResponse {
  ...
  extension [Self <: ListDomainMappingsResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[DomainMapping]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: DomainMapping*): Self = StObject.set(x, "items", js.Array(value :_*))
