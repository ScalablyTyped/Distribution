...
import typings.momentDurationFormat.mod.momentAugmentingMod.DurationLabelType
import typings.momentDurationFormat.mod.momentAugmentingMod.DurationTemplate
import typings.momentDurationFormat.mod.momentAugmentingMod.DurationToken
import typings.momentDurationFormat.mod.momentAugmentingMod.UnitOfTrim
...
object momentDurationFormatStrings {
  ...
  @js.native
  sealed trait HMS extends DurationTemplate
  @scala.inline
  ...
  @js.native
  sealed trait MS extends DurationTemplate
  @scala.inline
  ...
  @js.native
  sealed trait all extends UnitOfTrim
  @scala.inline
  def all: all = "all".asInstanceOf[all]
  
  @js.native
  sealed trait both extends UnitOfTrim
  @scala.inline
  def both: both = "both".asInstanceOf[both]
  
  @js.native
  sealed trait d extends DurationToken
  @scala.inline
  def d: d = "d".asInstanceOf[d]
  
  @js.native
  sealed trait dd extends DurationToken
  @scala.inline
  def dd: dd = "dd".asInstanceOf[dd]
  
  @js.native
  sealed trait ddd extends DurationToken
  @scala.inline
  def ddd: ddd = "ddd".asInstanceOf[ddd]
  
  @js.native
  sealed trait `final` extends UnitOfTrim
  @scala.inline
  def `final`: `final` = "final".asInstanceOf[`final`]
  
  @js.native
  sealed trait h extends DurationToken
  @scala.inline
  def h: h = "h".asInstanceOf[h]
  
  @js.native
  sealed trait hh extends DurationToken
  @scala.inline
  def hh: hh = "hh".asInstanceOf[hh]
  
  @js.native
  sealed trait hhh extends DurationToken
  @scala.inline
  def hhh: hhh = "hhh".asInstanceOf[hhh]
  
  @js.native
  sealed trait large extends UnitOfTrim
  @scala.inline
  def large: large = "large".asInstanceOf[large]
  
  @js.native
  sealed trait left extends UnitOfTrimV1
  @scala.inline
  ...
  @js.native
  sealed trait w extends DurationToken
  @scala.inline
  def w: w = "w".asInstanceOf[w]
  
  @js.native
  sealed trait ww extends DurationToken
  @scala.inline
  def ww: ww = "ww".asInstanceOf[ww]
  
  @js.native
  sealed trait www extends DurationToken
  @scala.inline
  def www: www = "www".asInstanceOf[www]
  
  @js.native
  sealed trait y extends DurationToken
  @scala.inline
  def y: y = "y".asInstanceOf[y]
  
  @js.native
  sealed trait yy extends DurationToken
  @scala.inline
