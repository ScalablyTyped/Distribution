...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(parent: String, resource: GoogleCloudBillingBudgetsV1Budget): Accesstoken = {
    ...
    implicit open class MutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      inline def setResource(value: GoogleCloudBillingBudgetsV1Budget): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    inline def apply(name: String, resource: GoogleCloudBillingBudgetsV1Budget): Key = {
