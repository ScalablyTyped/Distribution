...
@js.native
trait ApkManifest extends js.Object {
...
object ApkManifest {
  ...
  @scala.inline
  implicit class ApkManifestOps[Self <: ApkManifest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIntentFiltersVarargs(value: IntentFilter*): Self = this.set("intentFilters", js.Array(value :_*))
    
    @scala.inline
    def setIntentFilters(value: js.Array[IntentFilter]): Self = this.set("intentFilters", value.asInstanceOf[js.Any])
