...
trait Queryany extends js.Object {
  ...
  /**
    ...
    */
  def orFail(): DocumentQuery[NonNullable[_], _, js.Object] = js.native
  def orFail(err: js.Function0[Error]): DocumentQuery[NonNullable[_], _, js.Object] = js.native
  def orFail(err: Error): DocumentQuery[NonNullable[_], _, js.Object] = js.native
