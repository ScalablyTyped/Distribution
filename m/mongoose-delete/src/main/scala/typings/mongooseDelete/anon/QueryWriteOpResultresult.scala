...
trait QueryWriteOpResultresult extends js.Object {
  ...
  def findOne_result(
    ...
    callback: js.Function2[
      /* err */ js.Any, 
      /* res */ (/* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ js.Any) | Null, 
      Unit
    ]
  ): (DocumentQuery[_ | Null, _, js.Object]) with js.Object = js.native
  @JSName("findOne")
  ...
  def orFail(err: js.Function0[Error]): DocumentQuery[
    NonNullable[
      /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ js.Any
    ], 
    _, 
  ...
  def orFail(err: Error): DocumentQuery[
    NonNullable[
      /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ js.Any
    ], 
    _, 
