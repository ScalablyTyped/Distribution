...
import typings.mongoose.mod.Error
import typings.mongoose.mod.FilterQuery
import typings.mongoose.mod.NativeError
import typings.mongoose.mod.Query
import typings.mongoose.mod.QueryCursor
import typings.mongoose.mod.QueryFindBaseOptions
import typings.mongoose.mod.QueryFindOneAndRemoveOptions
...
/* Inlined mongoose.mongoose.Query<std.Array<any>> & {} */
@js.native
trait QueryArrayany extends js.Object {
  /** Executes this query and returns a promise */
  @JSName("then")
  var then_Original: FnCallOnfulfilledOnrejected[js.Array[_]] = js.native
  /**
  ...
  /**
    ...
    * @return {Query} this
    */
  def estimatedDocumentCount(): Query[Double] with js.Object = js.native
  def estimatedDocumentCount(callback: js.Function2[/* err */ js.Any, /* count */ Double, Unit]): Query[Double] with js.Object = js.native
  def estimatedDocumentCount(options: js.Any): Query[Double] with js.Object = js.native
  def estimatedDocumentCount(options: js.Any, callback: js.Function2[/* err */ js.Any, /* count */ Double, Unit]): Query[Double] with js.Object = js.native
  /** Executes the query */
  def exec(): js.Promise[js.Array[_]] = js.native
  def exec(callback: js.Function2[/* err */ NativeError, /* res */ js.Array[_], Unit]): js.Promise[js.Array[_]] = js.native
  def exec(operation: String): js.Promise[js.Array[_]] = js.native
  def exec(operation: String, callback: js.Function2[/* err */ js.Any, /* res */ js.Array[_], Unit]): js.Promise[js.Array[_]] = js.native
  def exec(operation: js.Function): js.Promise[js.Array[_]] = js.native
  def exec(operation: js.Function, callback: js.Function2[/* err */ js.Any, /* res */ js.Array[_], Unit]): js.Promise[js.Array[_]] = js.native
  ...
  def find(criteria: FilterQuery[_]): (DocumentQuery[js.Array[_], _, js.Object]) with js.Object = js.native
  def find(criteria: FilterQuery[_], callback: js.Function2[/* err */ js.Any, /* res */ js.Array[_], Unit]): (DocumentQuery[js.Array[_], _, js.Object]) with js.Object = js.native
  /**
  ...
  def findOne(
    ...
    projection: js.Any,
    callback: js.Function2[/* err */ js.Any, /* res */ js.Array[_] | Null, Unit]
  ...
  def findOneAndRemove(conditions: FilterQuery[_]): (DocumentQuery[_ | Null, _, js.Object]) with js.Object = js.native
  def findOneAndRemove(
    conditions: FilterQuery[_],
    callback: js.Function3[/* error */ js.Any, /* doc */ js.Any | Null, /* result */ js.Any, Unit]
  ): (DocumentQuery[_ | Null, _, js.Object]) with js.Object = js.native
  def findOneAndRemove(conditions: FilterQuery[_], options: rawResulttrueQueryFindOne): (Query[FindAndModifyWriteOpResultObject[_ | Null]]) with js.Object = js.native
  def findOneAndRemove(
    conditions: FilterQuery[_],
  ...
  def findOneAndRemove(conditions: FilterQuery[_], options: QueryFindOneAndRemoveOptions): (DocumentQuery[_ | Null, _, js.Object]) with js.Object = js.native
  def findOneAndRemove(
    conditions: FilterQuery[_],
  ...
  def findOneAndUpdate(query: FilterQuery[_], update: UpdateQuery[_], options: rawResulttrueupserttruene): Query[FindAndModifyWriteOpResultObject[_]] with js.Object = js.native
  def findOneAndUpdate(
    query: FilterQuery[_],
    update: UpdateQuery[_],
  ...
  def findOneAndUpdate(query: FilterQuery[_], update: UpdateQuery[_], options: upserttruenewtrueQueryFin): (DocumentQuery[_, _, js.Object]) with js.Object = js.native
  def findOneAndUpdate(
    query: FilterQuery[_],
    update: UpdateQuery[_],
  ...
  /**
    ...
    */
  def map[TRes](fn: js.Function1[/* res */ js.Array[_], TRes]): (DocumentQuery[TRes, _, js.Object]) with js.Object = js.native
  ...
  /**
    ...
    */
  def orFail(): DocumentQuery[NonNullable[js.Array[_]], _, js.Object] = js.native
  def orFail(err: js.Function0[Error]): DocumentQuery[NonNullable[js.Array[_]], _, js.Object] = js.native
  def orFail(err: Error): DocumentQuery[NonNullable[js.Array[_]], _, js.Object] = js.native
  ...
  def regex(path: String, `val`: RegExp): this.type = js.native
  /**
  ...
  def remove(criteria: FilterQuery[_]): (Query[
    /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ js.Any
  ]) with js.Object = js.native
  def remove(criteria: FilterQuery[_], callback: js.Function1[/* err */ js.Any, Unit]): (Query[
    /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ js.Any
  ]) with js.Object = js.native
  ...
  /** Executes this query and returns a promise */
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ js.Array[_], TResult1 | js.Thenable[TResult1]]): js.Promise[TResult1 | TResult2] = js.native
  /** Executes this query and returns a promise */
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ js.Array[_], TResult1 | js.Thenable[TResult1]],
    onrejected: js.Function1[/* reason */ js.Any, TResult2 | js.Thenable[TResult2]]
  ): js.Promise[TResult1 | TResult2] = js.native
  /** Executes this query and returns a promise */
