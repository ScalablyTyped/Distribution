...
trait QueryFindAndModifyWriteOpAll extends js.Object {
  ...
  /**
    ...
    */
  def orFail(): DocumentQuery[NonNullable[FindAndModifyWriteOpResultObject[_]], _, js.Object] = js.native
  def orFail(err: js.Function0[Error]): DocumentQuery[NonNullable[FindAndModifyWriteOpResultObject[_]], _, js.Object] = js.native
  def orFail(err: Error): DocumentQuery[NonNullable[FindAndModifyWriteOpResultObject[_]], _, js.Object] = js.native
