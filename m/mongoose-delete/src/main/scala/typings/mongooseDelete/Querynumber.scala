...
/* Inlined mongoose.mongoose.Query<number> & {} */
@js.native
trait Querynumber extends js.Object {
  /** Executes this query and returns a promise */
  @JSName("then")
  var then_Original: FnCallOnfulfilledOnrejected[Double] = js.native
  /**
  ...
  /** Executes the query */
  def exec(): js.Promise[Double] = js.native
  def exec(callback: js.Function2[/* err */ NativeError, /* res */ Double, Unit]): js.Promise[Double] = js.native
  def exec(operation: String): js.Promise[Double] = js.native
  def exec(operation: String, callback: js.Function2[/* err */ js.Any, /* res */ Double, Unit]): js.Promise[Double] = js.native
  def exec(operation: js.Function): js.Promise[Double] = js.native
  def exec(operation: js.Function, callback: js.Function2[/* err */ js.Any, /* res */ Double, Unit]): js.Promise[Double] = js.native
  ...
  /**
    ...
    */
  def map[TRes](fn: js.Function1[/* res */ Double, TRes]): (DocumentQuery[TRes, _, js.Object]) with js.Object = js.native
  ...
  /** Executes this query and returns a promise */
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ Double, TResult1 | js.Thenable[TResult1]]): js.Promise[TResult1 | TResult2] = js.native
  /** Executes this query and returns a promise */
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ Double, TResult1 | js.Thenable[TResult1]],
    onrejected: js.Function1[/* reason */ js.Any, TResult2 | js.Thenable[TResult2]]
  ): js.Promise[TResult1 | TResult2] = js.native
  /** Executes this query and returns a promise */
