...
/* Inlined mongoose.mongoose.Query<mongodb.mongodb.WriteOpResult['result']> & {} */
@js.native
trait QueryWriteOpResultresult extends js.Object {
  /** Executes this query and returns a promise */
  @JSName("then")
  var then_Original: FnCallOnfulfilledOnrejected[
  ...
  def exec(operation: String): js.Promise[
    /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ js.Any
  ] = js.native
  def exec(operation: js.Function): js.Promise[
    /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ js.Any
  ] = js.native
  @JSName("exec")
  def exec_result(
    callback: js.Function2[
      /* err */ NativeError, 
      /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ /* res */ js.Any, 
      Unit
    ]
  ): js.Promise[
    /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ js.Any
  ...
  ): (DocumentQuery[TRes, _, js.Object]) with js.Object = js.native
  ...
  /** Executes this query and returns a promise */
  @JSName("then")
  def then_result[TResult1, TResult2](
    onfulfilled: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: mongodb.mongodb.WriteOpResult['result'] */ /* value */ js.Any, 
