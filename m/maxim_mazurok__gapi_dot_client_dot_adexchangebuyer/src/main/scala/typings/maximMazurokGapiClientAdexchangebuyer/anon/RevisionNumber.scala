...
@js.native
trait RevisionNumber extends js.Object {
...
object RevisionNumber {
  ...
  @scala.inline
  def apply(proposalId: String, resource: Proposal, revisionNumber: String, updateAction: String): RevisionNumber = {
  ...
  @scala.inline
  implicit class RevisionNumberOps[Self <: RevisionNumber] (val x: Self) extends AnyVal {
