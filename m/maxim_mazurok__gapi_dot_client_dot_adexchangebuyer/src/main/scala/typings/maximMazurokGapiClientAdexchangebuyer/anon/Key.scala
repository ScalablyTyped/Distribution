...
import typings.maximMazurokGapiClientAdexchangebuyer.gapi.client.adexchangebuyer.Budget
...
object Key {
  ...
  @scala.inline
  def apply(accountId: String, billingId: String, resource: Budget): Key = {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Budget): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
