...
trait OauthtokenPqlQuery extends StObject {
...
object OauthtokenPqlQuery {
  
  @scala.inline
  def apply(): OauthtokenPqlQuery = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OauthtokenPqlQuery]
  }
  
  @scala.inline
  implicit class OauthtokenPqlQueryMutableBuilder[Self <: OauthtokenPqlQuery] (val x: Self) extends AnyVal {
