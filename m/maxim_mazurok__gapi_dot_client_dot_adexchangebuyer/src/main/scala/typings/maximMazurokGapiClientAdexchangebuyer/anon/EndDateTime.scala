...
object EndDateTime {
  ...
  inline def apply(accountId: String, endDateTime: String, startDateTime: String): EndDateTime = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EndDateTime] (val x: Self) extends AnyVal {
