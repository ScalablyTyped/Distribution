...
object PublisherProfileApiProto {
  ...
  @scala.inline
  implicit class PublisherProfileApiProtoOps[Self <: PublisherProfileApiProto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPublisherAppIdsVarargs(value: String*): Self = this.set("publisherAppIds", js.Array(value :_*))
    
    @scala.inline
    def setPublisherAppIds(value: js.Array[String]): Self = this.set("publisherAppIds", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePublisherAppIds: Self = this.set("publisherAppIds", js.undefined)
    
    @scala.inline
    def setPublisherAppsVarargs(value: MobileApplication*): Self = this.set("publisherApps", js.Array(value :_*))
    
    @scala.inline
    def setPublisherApps(value: js.Array[MobileApplication]): Self = this.set("publisherApps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePublisherApps: Self = this.set("publisherApps", js.undefined)
