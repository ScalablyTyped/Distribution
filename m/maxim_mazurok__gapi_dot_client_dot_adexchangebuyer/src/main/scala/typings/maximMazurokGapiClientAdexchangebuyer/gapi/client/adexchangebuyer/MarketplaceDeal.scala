...
object MarketplaceDeal {
  ...
  implicit class MarketplaceDealOps[Self <: MarketplaceDeal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMakegoodRequestedReason(value: String): Self = this.set("makegoodRequestedReason", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMakegoodRequestedReason: Self = this.set("makegoodRequestedReason", js.undefined)
