...
object materializeCssStrings {
  ...
  inline def addChip: addChip = "addChip".asInstanceOf[addChip]
  ...
  inline def buttom: buttom = "buttom".asInstanceOf[buttom]
  ...
  inline def deleteChip: deleteChip = "deleteChip".asInstanceOf[deleteChip]
  ...
  inline def getSelectedValues: getSelectedValues = "getSelectedValues".asInstanceOf[getSelectedValues]
  ...
  inline def `pin-bottom`: `pin-bottom` = "pin-bottom".asInstanceOf[`pin-bottom`]
  
  @js.native
  sealed trait `pin-top` extends StObject
  inline def `pin-top`: `pin-top` = "pin-top".asInstanceOf[`pin-top`]
  ...
  inline def recalculateDimensions: recalculateDimensions = "recalculateDimensions".asInstanceOf[recalculateDimensions]
  ...
  inline def selectChip: selectChip = "selectChip".asInstanceOf[selectChip]
  ...
  inline def showView: showView = "showView".asInstanceOf[showView]
