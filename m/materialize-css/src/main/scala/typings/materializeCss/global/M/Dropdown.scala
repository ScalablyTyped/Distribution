...
object Dropdown {
  ...
  /**
    ...
    */
  /* static member */
  inline def init(els: MElements): js.Array[typings.materializeCss.M.Dropdown] = ^.asInstanceOf[js.Dynamic].applyDynamic("init")(els.asInstanceOf[js.Any]).asInstanceOf[js.Array[typings.materializeCss.M.Dropdown]]
  inline def init(els: MElements, options: PartialDropdownOptions): js.Array[typings.materializeCss.M.Dropdown] = (^.asInstanceOf[js.Dynamic].applyDynamic("init")(els.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.materializeCss.M.Dropdown]]
  /**
    * Init Dropdown
    */
  /* static member */
