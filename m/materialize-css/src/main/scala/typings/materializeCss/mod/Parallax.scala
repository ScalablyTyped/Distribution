...
open class Parallax ()
  extends StObject
     with typings.materializeCss.M.Component[ParallaxOptions] {
...
object Parallax {
  ...
  /**
    ...
    */
  /* static member */
  inline def init(els: MElements): js.Array[typings.materializeCss.M.Parallax] = ^.asInstanceOf[js.Dynamic].applyDynamic("init")(els.asInstanceOf[js.Any]).asInstanceOf[js.Array[typings.materializeCss.M.Parallax]]
  inline def init(els: MElements, options: PartialParallaxOptions): js.Array[typings.materializeCss.M.Parallax] = (^.asInstanceOf[js.Dynamic].applyDynamic("init")(els.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.materializeCss.M.Parallax]]
  /**
    * Init Parallax
    */
  /* static member */
