...
@js.native
trait ReservationId extends StObject {
  ...
  /** Request body */
  var resource: Reservation = js.native
...
object ReservationId {
  ...
  @scala.inline
  def apply(parent: String, resource: Reservation): ReservationId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReservationId]
  }
  
  @scala.inline
  implicit class ReservationIdMutableBuilder[Self <: ReservationId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Reservation): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
