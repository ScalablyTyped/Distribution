...
@js.native
trait ReservationId extends js.Object {
...
object ReservationId {
  ...
  @scala.inline
  implicit class ReservationIdOps[Self <: ReservationId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Reservation): Self = this.set("resource", value.asInstanceOf[js.Any])
