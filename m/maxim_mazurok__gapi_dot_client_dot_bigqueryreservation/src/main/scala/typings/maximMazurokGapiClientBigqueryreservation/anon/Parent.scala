...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: Assignment = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: Assignment): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Assignment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
