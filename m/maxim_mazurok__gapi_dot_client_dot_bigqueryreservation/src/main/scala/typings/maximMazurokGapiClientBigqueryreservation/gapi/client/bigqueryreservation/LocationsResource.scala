...
import typings.maximMazurokGapiClientBigqueryreservation.anon.AccesstokenAlt
...
trait LocationsResource extends StObject {
  ...
  def getBiReservation(request: Fields): Request[BiReservation] = js.native
  ...
  /**
    ...
    */
  def updateBiReservation(request: AccesstokenAlt): Request[BiReservation] = js.native
