...
@js.native
trait Modifiers_ extends js.Object {
...
object Modifiers_ {
  ...
  @scala.inline
  implicit class Modifiers_Ops[Self <: Modifiers_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPercentsign(value: String): Self = this.set("%", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJ(value: String): Self = this.set("j", value.asInstanceOf[js.Any])
