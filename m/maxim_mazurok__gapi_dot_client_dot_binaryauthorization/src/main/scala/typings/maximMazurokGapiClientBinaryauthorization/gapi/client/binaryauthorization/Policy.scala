...
object Policy {
  ...
  implicit class PolicyOps[Self <: Policy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdmissionWhitelistPatternsVarargs(value: AdmissionWhitelistPattern*): Self = this.set("admissionWhitelistPatterns", js.Array(value :_*))
    
    @scala.inline
    def setAdmissionWhitelistPatterns(value: js.Array[AdmissionWhitelistPattern]): Self = this.set("admissionWhitelistPatterns", value.asInstanceOf[js.Any])
    ...
    {[ P in string ]: @maxim_mazurok/gapi.client.binaryauthorization.gapi.client.binaryauthorization.AdmissionRule}
      */ typings.maximMazurokGapiClientBinaryauthorization.maximMazurokGapiClientBinaryauthorizationStrings.Policy with TopLevel[js.Any]
    ): Self = this.set("clusterAdmissionRules", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteClusterAdmissionRules: Self = this.set("clusterAdmissionRules", js.undefined)
    
    @scala.inline
    def setDefaultAdmissionRule(value: AdmissionRule): Self = this.set("defaultAdmissionRule", value.asInstanceOf[js.Any])
