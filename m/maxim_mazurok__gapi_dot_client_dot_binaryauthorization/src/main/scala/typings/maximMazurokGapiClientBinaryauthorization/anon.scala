...
import typings.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Policy
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: typings.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Attestor
  ...
  object Accesstoken {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: typings.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Attestor): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Attestor {
    ...
    implicit class AttestorMutableBuilder[Self <: Attestor] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttestor(value: String): Self = StObject.set(x, "attestor", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setResource(value: ValidateAttestationOccurrenceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object QuotaUser {
    ...
    @scala.inline
    def apply(name: String, resource: Policy): QuotaUser = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
