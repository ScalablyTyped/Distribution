...
object anon {
  ...
  object Accesstoken {
    ...
    implicit open class MutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      inline def setResource(value: typings.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Attestor): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
