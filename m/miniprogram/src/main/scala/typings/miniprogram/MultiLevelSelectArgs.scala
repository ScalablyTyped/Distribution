...
object MultiLevelSelectArgs {
  ...
  inline def apply(list: js.Array[js.Any], name: String): MultiLevelSelectArgs = {
  ...
  extension [Self <: MultiLevelSelectArgs](x: Self) {
    ...
    inline def setSubList(value: js.Array[js.Any]): Self = StObject.set(x, "subList", value.asInstanceOf[js.Any])
    
    inline def setSubListUndefined: Self = StObject.set(x, "subList", js.undefined)
    
    inline def setSubListVarargs(value: js.Any*): Self = StObject.set(x, "subList", js.Array(value :_*))
