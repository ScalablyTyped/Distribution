...
import typings.maximMazurokGapiClientVision.gapi.client.vision.BatchAnnotateFilesRequest
...
object Fields {
  ...
  inline def apply(parent: String, resource: BatchAnnotateFilesRequest): Fields = {
