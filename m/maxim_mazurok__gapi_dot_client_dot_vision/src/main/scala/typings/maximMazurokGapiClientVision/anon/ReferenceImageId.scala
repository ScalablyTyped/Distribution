...
import typings.maximMazurokGapiClientVision.gapi.client.vision.ReferenceImage
...
object ReferenceImageId {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReferenceImageId] (val x: Self) extends AnyVal {
