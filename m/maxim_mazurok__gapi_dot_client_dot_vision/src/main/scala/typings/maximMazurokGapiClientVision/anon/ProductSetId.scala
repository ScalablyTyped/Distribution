...
object ProductSetId {
  ...
  @scala.inline
  implicit class ProductSetIdMutableBuilder[Self <: ProductSetId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ProductSet): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
