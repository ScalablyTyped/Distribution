...
import typings.maximMazurokGapiClientVision.gapi.client.vision.ProductSet
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait ProductSetId extends js.Object {
  ...
  /** Request body */
  var resource: ProductSet = js.native
...
object ProductSetId {
  ...
  @scala.inline
  def apply(parent: String, resource: ProductSet): ProductSetId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProductSetId]
  }
  
  @scala.inline
  implicit class ProductSetIdOps[Self <: ProductSetId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ProductSet): Self = this.set("resource", value.asInstanceOf[js.Any])
