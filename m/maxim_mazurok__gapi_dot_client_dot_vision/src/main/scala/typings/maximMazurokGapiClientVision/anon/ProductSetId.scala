...
trait ProductSetId extends StObject {
...
object ProductSetId {
  ...
  inline def apply(parent: String, resource: ProductSet): ProductSetId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ProductSetId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ProductSet): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
