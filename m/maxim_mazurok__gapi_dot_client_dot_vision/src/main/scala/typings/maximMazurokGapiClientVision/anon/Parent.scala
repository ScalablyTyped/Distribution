...
import typings.maximMazurokGapiClientVision.gapi.client.vision.BatchAnnotateImagesRequest
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: BatchAnnotateImagesRequest): Parent = {
