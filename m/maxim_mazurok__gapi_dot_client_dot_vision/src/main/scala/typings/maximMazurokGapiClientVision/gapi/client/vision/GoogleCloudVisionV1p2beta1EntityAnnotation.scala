...
object GoogleCloudVisionV1p2beta1EntityAnnotation {
  ...
  extension [Self <: GoogleCloudVisionV1p2beta1EntityAnnotation](x: Self) {
    ...
    inline def setLocationsVarargs(value: GoogleCloudVisionV1p2beta1LocationInfo*): Self = StObject.set(x, "locations", js.Array(value :_*))
    ...
    inline def setPropertiesVarargs(value: GoogleCloudVisionV1p2beta1Property*): Self = StObject.set(x, "properties", js.Array(value :_*))
