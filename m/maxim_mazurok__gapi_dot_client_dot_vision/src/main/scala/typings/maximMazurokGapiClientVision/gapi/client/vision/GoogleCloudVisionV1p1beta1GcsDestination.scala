...
@js.native
trait GoogleCloudVisionV1p1beta1GcsDestination extends js.Object {
...
object GoogleCloudVisionV1p1beta1GcsDestination {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1GcsDestinationOps[Self <: GoogleCloudVisionV1p1beta1GcsDestination] (val x: Self) extends AnyVal {
