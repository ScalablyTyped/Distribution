...
@js.native
trait GoogleCloudVisionV1p3beta1LocationInfo extends js.Object {
...
object GoogleCloudVisionV1p3beta1LocationInfo {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1LocationInfoOps[Self <: GoogleCloudVisionV1p3beta1LocationInfo] (val x: Self) extends AnyVal {
