...
object GoogleCloudVisionV1p4beta1WebDetectionWebPage {
  ...
  extension [Self <: GoogleCloudVisionV1p4beta1WebDetectionWebPage](x: Self) {
    ...
    inline def setFullMatchingImagesVarargs(value: GoogleCloudVisionV1p4beta1WebDetectionWebImage*): Self = StObject.set(x, "fullMatchingImages", js.Array(value :_*))
    ...
    inline def setPartialMatchingImagesVarargs(value: GoogleCloudVisionV1p4beta1WebDetectionWebImage*): Self = StObject.set(x, "partialMatchingImages", js.Array(value :_*))
