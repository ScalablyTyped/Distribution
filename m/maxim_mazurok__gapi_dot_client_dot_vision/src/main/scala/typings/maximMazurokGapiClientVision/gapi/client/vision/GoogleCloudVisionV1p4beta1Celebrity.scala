...
@js.native
trait GoogleCloudVisionV1p4beta1Celebrity extends js.Object {
...
object GoogleCloudVisionV1p4beta1Celebrity {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1CelebrityOps[Self <: GoogleCloudVisionV1p4beta1Celebrity] (val x: Self) extends AnyVal {
