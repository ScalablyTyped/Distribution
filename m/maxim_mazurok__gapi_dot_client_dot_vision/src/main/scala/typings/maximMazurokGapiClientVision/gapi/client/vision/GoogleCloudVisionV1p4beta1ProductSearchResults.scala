...
trait GoogleCloudVisionV1p4beta1ProductSearchResults extends StObject {
  ...
  /**
    ...
    */
  var productGroupedResults: js.UndefOr[js.Array[GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult]] = js.undefined
...
object GoogleCloudVisionV1p4beta1ProductSearchResults {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p4beta1ProductSearchResults] (val x: Self) extends AnyVal {
    ...
    inline def setProductGroupedResultsVarargs(value: GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult*): Self = StObject.set(x, "productGroupedResults", js.Array(value*))
