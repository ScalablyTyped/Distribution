...
@js.native
trait GoogleCloudVisionV1p4beta1LocationInfo extends js.Object {
...
object GoogleCloudVisionV1p4beta1LocationInfo {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1LocationInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1LocationInfo]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1LocationInfoOps[Self <: GoogleCloudVisionV1p4beta1LocationInfo] (val x: Self) extends AnyVal {
