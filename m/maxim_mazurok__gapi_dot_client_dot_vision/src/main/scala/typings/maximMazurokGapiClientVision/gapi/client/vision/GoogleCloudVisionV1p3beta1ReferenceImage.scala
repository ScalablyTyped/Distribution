...
@js.native
trait GoogleCloudVisionV1p3beta1ReferenceImage extends js.Object {
  ...
  /**
    ...
    */
  var boundingPolys: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1BoundingPoly]] = js.native
...
object GoogleCloudVisionV1p3beta1ReferenceImage {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p3beta1ReferenceImage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1ReferenceImage]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1ReferenceImageOps[Self <: GoogleCloudVisionV1p3beta1ReferenceImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingPolysVarargs(value: GoogleCloudVisionV1p3beta1BoundingPoly*): Self = this.set("boundingPolys", js.Array(value :_*))
    
    @scala.inline
    def setBoundingPolys(value: js.Array[GoogleCloudVisionV1p3beta1BoundingPoly]): Self = this.set("boundingPolys", value.asInstanceOf[js.Any])
