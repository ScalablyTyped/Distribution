...
trait GoogleCloudVisionV1p1beta1EntityAnnotation extends StObject {
  ...
  /**
    ...
    */
  var locations: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1LocationInfo]] = js.undefined
  
  /** Opaque entity ID. Some IDs may be available in [Google Knowledge Graph Search API](https://developers.google.com/knowledge-graph/). */
  var mid: js.UndefOr[String] = js.undefined
  
  /** Some entities may have optional user-supplied `Property` (name/value) fields, such a score or string that qualifies the entity. */
  var properties: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1Property]] = js.undefined
...
object GoogleCloudVisionV1p1beta1EntityAnnotation {
  
  inline def apply(): GoogleCloudVisionV1p1beta1EntityAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1EntityAnnotation]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p1beta1EntityAnnotation] (val x: Self) extends AnyVal {
    
    inline def setBoundingPoly(value: GoogleCloudVisionV1p1beta1BoundingPoly): Self = StObject.set(x, "boundingPoly", value.asInstanceOf[js.Any])
    ...
    inline def setLocations(value: js.Array[GoogleCloudVisionV1p1beta1LocationInfo]): Self = StObject.set(x, "locations", value.asInstanceOf[js.Any])
    
    inline def setLocationsUndefined: Self = StObject.set(x, "locations", js.undefined)
    
    inline def setLocationsVarargs(value: GoogleCloudVisionV1p1beta1LocationInfo*): Self = StObject.set(x, "locations", js.Array(value*))
    ...
    inline def setProperties(value: js.Array[GoogleCloudVisionV1p1beta1Property]): Self = StObject.set(x, "properties", value.asInstanceOf[js.Any])
    
    inline def setPropertiesUndefined: Self = StObject.set(x, "properties", js.undefined)
    
    inline def setPropertiesVarargs(value: GoogleCloudVisionV1p1beta1Property*): Self = StObject.set(x, "properties", js.Array(value*))
