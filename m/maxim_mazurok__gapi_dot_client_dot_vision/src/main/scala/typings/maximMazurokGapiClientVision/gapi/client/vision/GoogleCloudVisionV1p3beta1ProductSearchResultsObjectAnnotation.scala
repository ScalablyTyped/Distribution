...
object GoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation] (val x: Self) extends AnyVal {
