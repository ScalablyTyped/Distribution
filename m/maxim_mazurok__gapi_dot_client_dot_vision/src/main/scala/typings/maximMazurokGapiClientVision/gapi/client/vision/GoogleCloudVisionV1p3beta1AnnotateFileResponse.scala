...
trait GoogleCloudVisionV1p3beta1AnnotateFileResponse extends StObject {
  ...
  var inputConfig: js.UndefOr[GoogleCloudVisionV1p3beta1InputConfig] = js.undefined
  
  /** Individual responses to images found within the file. This field will be empty if the `error` field is set. */
  var responses: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1AnnotateImageResponse]] = js.undefined
...
object GoogleCloudVisionV1p3beta1AnnotateFileResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p3beta1AnnotateFileResponse] (val x: Self) extends AnyVal {
