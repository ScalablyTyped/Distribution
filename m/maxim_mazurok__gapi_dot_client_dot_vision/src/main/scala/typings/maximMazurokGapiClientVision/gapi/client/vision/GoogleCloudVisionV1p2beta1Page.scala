...
object GoogleCloudVisionV1p2beta1Page {
  ...
  extension [Self <: GoogleCloudVisionV1p2beta1Page](x: Self) {
    ...
    inline def setBlocksVarargs(value: GoogleCloudVisionV1p2beta1Block*): Self = StObject.set(x, "blocks", js.Array(value :_*))
