...
@js.native
trait GoogleCloudVisionV1p3beta1EntityAnnotation extends js.Object {
  ...
  /**
    ...
    */
  var locations: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1LocationInfo]] = js.native
  
  /** Opaque entity ID. Some IDs may be available in [Google Knowledge Graph Search API](https://developers.google.com/knowledge-graph/). */
  var mid: js.UndefOr[String] = js.native
  
  /** Some entities may have optional user-supplied `Property` (name/value) fields, such a score or string that qualifies the entity. */
  var properties: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1Property]] = js.native
...
object GoogleCloudVisionV1p3beta1EntityAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p3beta1EntityAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1EntityAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1EntityAnnotationOps[Self <: GoogleCloudVisionV1p3beta1EntityAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocationsVarargs(value: GoogleCloudVisionV1p3beta1LocationInfo*): Self = this.set("locations", js.Array(value :_*))
    
    @scala.inline
    def setLocations(value: js.Array[GoogleCloudVisionV1p3beta1LocationInfo]): Self = this.set("locations", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPropertiesVarargs(value: GoogleCloudVisionV1p3beta1Property*): Self = this.set("properties", js.Array(value :_*))
    
    @scala.inline
    def setProperties(value: js.Array[GoogleCloudVisionV1p3beta1Property]): Self = this.set("properties", value.asInstanceOf[js.Any])
