...
@js.native
trait GoogleCloudVisionV1p2beta1Word extends js.Object {
  ...
  var symbols: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1Symbol]] = js.native
}
object GoogleCloudVisionV1p2beta1Word {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1Word]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1WordOps[Self <: GoogleCloudVisionV1p2beta1Word] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSymbolsVarargs(value: GoogleCloudVisionV1p2beta1Symbol*): Self = this.set("symbols", js.Array(value :_*))
    
    @scala.inline
    def setSymbols(value: js.Array[GoogleCloudVisionV1p2beta1Symbol]): Self = this.set("symbols", value.asInstanceOf[js.Any])
