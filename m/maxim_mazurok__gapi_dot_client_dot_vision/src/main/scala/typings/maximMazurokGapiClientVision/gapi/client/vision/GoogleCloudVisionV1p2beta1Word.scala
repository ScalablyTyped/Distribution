...
object GoogleCloudVisionV1p2beta1Word {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1WordMutableBuilder[Self <: GoogleCloudVisionV1p2beta1Word] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSymbols(value: js.Array[GoogleCloudVisionV1p2beta1Symbol]): Self = StObject.set(x, "symbols", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSymbolsUndefined: Self = StObject.set(x, "symbols", js.undefined)
    
    @scala.inline
    def setSymbolsVarargs(value: GoogleCloudVisionV1p2beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value :_*))
  }
}
