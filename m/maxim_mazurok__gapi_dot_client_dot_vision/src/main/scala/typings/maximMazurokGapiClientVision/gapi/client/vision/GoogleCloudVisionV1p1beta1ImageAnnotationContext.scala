...
object GoogleCloudVisionV1p1beta1ImageAnnotationContext {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1ImageAnnotationContextMutableBuilder[Self <: GoogleCloudVisionV1p1beta1ImageAnnotationContext] (val x: Self) extends AnyVal {
