...
@js.native
trait GoogleCloudVisionV1p1beta1ImageAnnotationContext extends js.Object {
...
object GoogleCloudVisionV1p1beta1ImageAnnotationContext {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p1beta1ImageAnnotationContext = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1ImageAnnotationContext]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1ImageAnnotationContextOps[Self <: GoogleCloudVisionV1p1beta1ImageAnnotationContext] (val x: Self) extends AnyVal {
