...
@js.native
trait GoogleCloudVisionV1p1beta1Block extends js.Object {
  ...
  var paragraphs: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1Paragraph]] = js.native
...
object GoogleCloudVisionV1p1beta1Block {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1BlockOps[Self <: GoogleCloudVisionV1p1beta1Block] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParagraphsVarargs(value: GoogleCloudVisionV1p1beta1Paragraph*): Self = this.set("paragraphs", js.Array(value :_*))
    
    @scala.inline
    def setParagraphs(value: js.Array[GoogleCloudVisionV1p1beta1Paragraph]): Self = this.set("paragraphs", value.asInstanceOf[js.Any])
