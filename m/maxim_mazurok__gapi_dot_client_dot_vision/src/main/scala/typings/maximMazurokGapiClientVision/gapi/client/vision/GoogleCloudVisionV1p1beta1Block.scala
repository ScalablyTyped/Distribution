...
trait GoogleCloudVisionV1p1beta1Block extends StObject {
  ...
  var paragraphs: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1Paragraph]] = js.undefined
...
object GoogleCloudVisionV1p1beta1Block {
  ...
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p1beta1Block] (val x: Self) extends AnyVal {
    ...
    inline def setParagraphsVarargs(value: GoogleCloudVisionV1p1beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value*))
