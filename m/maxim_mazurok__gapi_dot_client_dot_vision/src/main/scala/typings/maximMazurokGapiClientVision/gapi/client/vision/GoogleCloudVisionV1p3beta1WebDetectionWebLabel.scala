...
object GoogleCloudVisionV1p3beta1WebDetectionWebLabel {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1WebDetectionWebLabelMutableBuilder[Self <: GoogleCloudVisionV1p3beta1WebDetectionWebLabel] (val x: Self) extends AnyVal {
