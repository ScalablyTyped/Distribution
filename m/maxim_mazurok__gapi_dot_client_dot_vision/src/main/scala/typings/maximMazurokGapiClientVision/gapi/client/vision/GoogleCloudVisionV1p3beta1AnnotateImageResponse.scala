...
object GoogleCloudVisionV1p3beta1AnnotateImageResponse {
  ...
  inline def apply(): GoogleCloudVisionV1p3beta1AnnotateImageResponse = {
  ...
  extension [Self <: GoogleCloudVisionV1p3beta1AnnotateImageResponse](x: Self) {
    ...
    inline def setCropHintsAnnotation(value: GoogleCloudVisionV1p3beta1CropHintsAnnotation): Self = StObject.set(x, "cropHintsAnnotation", value.asInstanceOf[js.Any])
    ...
    inline def setFaceAnnotations(value: js.Array[GoogleCloudVisionV1p3beta1FaceAnnotation]): Self = StObject.set(x, "faceAnnotations", value.asInstanceOf[js.Any])
    
    inline def setFaceAnnotationsUndefined: Self = StObject.set(x, "faceAnnotations", js.undefined)
    
    inline def setFaceAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1FaceAnnotation*): Self = StObject.set(x, "faceAnnotations", js.Array(value :_*))
    
    inline def setFullTextAnnotation(value: GoogleCloudVisionV1p3beta1TextAnnotation): Self = StObject.set(x, "fullTextAnnotation", value.asInstanceOf[js.Any])
    
    inline def setFullTextAnnotationUndefined: Self = StObject.set(x, "fullTextAnnotation", js.undefined)
    
    inline def setImagePropertiesAnnotation(value: GoogleCloudVisionV1p3beta1ImageProperties): Self = StObject.set(x, "imagePropertiesAnnotation", value.asInstanceOf[js.Any])
    
    inline def setImagePropertiesAnnotationUndefined: Self = StObject.set(x, "imagePropertiesAnnotation", js.undefined)
    
    inline def setLabelAnnotations(value: js.Array[GoogleCloudVisionV1p3beta1EntityAnnotation]): Self = StObject.set(x, "labelAnnotations", value.asInstanceOf[js.Any])
    
    inline def setLabelAnnotationsUndefined: Self = StObject.set(x, "labelAnnotations", js.undefined)
    
    inline def setLabelAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1EntityAnnotation*): Self = StObject.set(x, "labelAnnotations", js.Array(value :_*))
    
    inline def setLandmarkAnnotations(value: js.Array[GoogleCloudVisionV1p3beta1EntityAnnotation]): Self = StObject.set(x, "landmarkAnnotations", value.asInstanceOf[js.Any])
    
    inline def setLandmarkAnnotationsUndefined: Self = StObject.set(x, "landmarkAnnotations", js.undefined)
    
    inline def setLandmarkAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1EntityAnnotation*): Self = StObject.set(x, "landmarkAnnotations", js.Array(value :_*))
    
    inline def setLocalizedObjectAnnotations(value: js.Array[GoogleCloudVisionV1p3beta1LocalizedObjectAnnotation]): Self = StObject.set(x, "localizedObjectAnnotations", value.asInstanceOf[js.Any])
    
    inline def setLocalizedObjectAnnotationsUndefined: Self = StObject.set(x, "localizedObjectAnnotations", js.undefined)
    
    inline def setLocalizedObjectAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1LocalizedObjectAnnotation*): Self = StObject.set(x, "localizedObjectAnnotations", js.Array(value :_*))
    
    inline def setLogoAnnotations(value: js.Array[GoogleCloudVisionV1p3beta1EntityAnnotation]): Self = StObject.set(x, "logoAnnotations", value.asInstanceOf[js.Any])
    
    inline def setLogoAnnotationsUndefined: Self = StObject.set(x, "logoAnnotations", js.undefined)
    
    inline def setLogoAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1EntityAnnotation*): Self = StObject.set(x, "logoAnnotations", js.Array(value :_*))
    
    inline def setProductSearchResults(value: GoogleCloudVisionV1p3beta1ProductSearchResults): Self = StObject.set(x, "productSearchResults", value.asInstanceOf[js.Any])
    
    inline def setProductSearchResultsUndefined: Self = StObject.set(x, "productSearchResults", js.undefined)
    
    inline def setSafeSearchAnnotation(value: GoogleCloudVisionV1p3beta1SafeSearchAnnotation): Self = StObject.set(x, "safeSearchAnnotation", value.asInstanceOf[js.Any])
    
    inline def setSafeSearchAnnotationUndefined: Self = StObject.set(x, "safeSearchAnnotation", js.undefined)
    
    inline def setTextAnnotations(value: js.Array[GoogleCloudVisionV1p3beta1EntityAnnotation]): Self = StObject.set(x, "textAnnotations", value.asInstanceOf[js.Any])
    
    inline def setTextAnnotationsUndefined: Self = StObject.set(x, "textAnnotations", js.undefined)
    
    inline def setTextAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1EntityAnnotation*): Self = StObject.set(x, "textAnnotations", js.Array(value :_*))
    
    inline def setWebDetection(value: GoogleCloudVisionV1p3beta1WebDetection): Self = StObject.set(x, "webDetection", value.asInstanceOf[js.Any])
