...
object GoogleCloudVisionV1p3beta1AnnotateImageResponse {
  ...
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p3beta1AnnotateImageResponse] (val x: Self) extends AnyVal {
    ...
    inline def setFaceAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1FaceAnnotation*): Self = StObject.set(x, "faceAnnotations", js.Array(value*))
    ...
    inline def setLabelAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1EntityAnnotation*): Self = StObject.set(x, "labelAnnotations", js.Array(value*))
    ...
    inline def setLandmarkAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1EntityAnnotation*): Self = StObject.set(x, "landmarkAnnotations", js.Array(value*))
    ...
    inline def setLocalizedObjectAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1LocalizedObjectAnnotation*): Self = StObject.set(x, "localizedObjectAnnotations", js.Array(value*))
    ...
    inline def setLogoAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1EntityAnnotation*): Self = StObject.set(x, "logoAnnotations", js.Array(value*))
    ...
    inline def setTextAnnotationsVarargs(value: GoogleCloudVisionV1p3beta1EntityAnnotation*): Self = StObject.set(x, "textAnnotations", js.Array(value*))
