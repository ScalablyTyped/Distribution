...
object GoogleCloudVisionV1p4beta1Paragraph {
  ...
  inline def apply(): GoogleCloudVisionV1p4beta1Paragraph = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1Paragraph]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p4beta1Paragraph] (val x: Self) extends AnyVal {
    ...
    inline def setWords(value: js.Array[GoogleCloudVisionV1p4beta1Word]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    inline def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    inline def setWordsVarargs(value: GoogleCloudVisionV1p4beta1Word*): Self = StObject.set(x, "words", js.Array(value*))
  }
}
