...
@js.native
trait GoogleCloudVisionV1p4beta1Paragraph extends js.Object {
...
object GoogleCloudVisionV1p4beta1Paragraph {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1ParagraphOps[Self <: GoogleCloudVisionV1p4beta1Paragraph] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordsVarargs(value: GoogleCloudVisionV1p4beta1Word*): Self = this.set("words", js.Array(value :_*))
    
    @scala.inline
    def setWords(value: js.Array[GoogleCloudVisionV1p4beta1Word]): Self = this.set("words", value.asInstanceOf[js.Any])
