...
object GoogleCloudVisionV1p4beta1Paragraph {
  ...
  extension [Self <: GoogleCloudVisionV1p4beta1Paragraph](x: Self) {
    ...
    inline def setWordsVarargs(value: GoogleCloudVisionV1p4beta1Word*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
