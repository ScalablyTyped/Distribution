...
@js.native
trait GoogleCloudVisionV1p2beta1GcsDestination extends js.Object {
...
object GoogleCloudVisionV1p2beta1GcsDestination {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1GcsDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1GcsDestination]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1GcsDestinationOps[Self <: GoogleCloudVisionV1p2beta1GcsDestination] (val x: Self) extends AnyVal {
