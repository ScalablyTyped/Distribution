...
@js.native
trait GoogleCloudVisionV1p4beta1SafeSearchAnnotation extends js.Object {
...
object GoogleCloudVisionV1p4beta1SafeSearchAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1SafeSearchAnnotationOps[Self <: GoogleCloudVisionV1p4beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
