...
trait GoogleCloudVisionV1p4beta1SafeSearchAnnotation extends StObject {
...
object GoogleCloudVisionV1p4beta1SafeSearchAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1SafeSearchAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1SafeSearchAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1SafeSearchAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p4beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
