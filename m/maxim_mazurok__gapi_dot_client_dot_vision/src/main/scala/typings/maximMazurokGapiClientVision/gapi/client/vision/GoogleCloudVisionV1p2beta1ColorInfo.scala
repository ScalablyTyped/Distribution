...
@js.native
trait GoogleCloudVisionV1p2beta1ColorInfo extends js.Object {
...
object GoogleCloudVisionV1p2beta1ColorInfo {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1ColorInfoOps[Self <: GoogleCloudVisionV1p2beta1ColorInfo] (val x: Self) extends AnyVal {
