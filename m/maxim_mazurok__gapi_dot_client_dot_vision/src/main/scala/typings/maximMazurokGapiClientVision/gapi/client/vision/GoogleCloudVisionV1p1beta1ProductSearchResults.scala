...
object GoogleCloudVisionV1p1beta1ProductSearchResults {
  ...
  extension [Self <: GoogleCloudVisionV1p1beta1ProductSearchResults](x: Self) {
    ...
    inline def setProductGroupedResultsVarargs(value: GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult*): Self = StObject.set(x, "productGroupedResults", js.Array(value :_*))
