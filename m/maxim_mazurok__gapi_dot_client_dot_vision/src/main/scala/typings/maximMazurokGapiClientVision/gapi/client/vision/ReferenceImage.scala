...
@js.native
trait ReferenceImage extends js.Object {
...
object ReferenceImage {
  ...
  @scala.inline
  implicit class ReferenceImageOps[Self <: ReferenceImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingPolysVarargs(value: BoundingPoly*): Self = this.set("boundingPolys", js.Array(value :_*))
    
    @scala.inline
    def setBoundingPolys(value: js.Array[BoundingPoly]): Self = this.set("boundingPolys", value.asInstanceOf[js.Any])
