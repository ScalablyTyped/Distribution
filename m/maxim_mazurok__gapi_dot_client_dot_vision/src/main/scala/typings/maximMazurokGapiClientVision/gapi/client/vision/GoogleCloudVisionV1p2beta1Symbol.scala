...
@js.native
trait GoogleCloudVisionV1p2beta1Symbol extends js.Object {
...
object GoogleCloudVisionV1p2beta1Symbol {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1SymbolOps[Self <: GoogleCloudVisionV1p2beta1Symbol] (val x: Self) extends AnyVal {
