...
trait GoogleCloudVisionV1p3beta1Word extends StObject {
  ...
  var symbols: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1Symbol]] = js.undefined
}
object GoogleCloudVisionV1p3beta1Word {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p3beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1Word]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1WordMutableBuilder[Self <: GoogleCloudVisionV1p3beta1Word] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSymbols(value: js.Array[GoogleCloudVisionV1p3beta1Symbol]): Self = StObject.set(x, "symbols", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSymbolsUndefined: Self = StObject.set(x, "symbols", js.undefined)
    
    @scala.inline
    def setSymbolsVarargs(value: GoogleCloudVisionV1p3beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value :_*))
  }
}
