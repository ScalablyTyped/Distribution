...
trait GoogleCloudVisionV1p2beta1Product extends StObject {
  ...
  /**
    ...
    */
  var productLabels: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1ProductKeyValue]] = js.undefined
}
object GoogleCloudVisionV1p2beta1Product {
  
  inline def apply(): GoogleCloudVisionV1p2beta1Product = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1Product]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p2beta1Product] (val x: Self) extends AnyVal {
    ...
    inline def setProductLabels(value: js.Array[GoogleCloudVisionV1p2beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
    
    inline def setProductLabelsUndefined: Self = StObject.set(x, "productLabels", js.undefined)
    
    inline def setProductLabelsVarargs(value: GoogleCloudVisionV1p2beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value*))
  }
}
