...
object GoogleCloudVisionV1p2beta1Product {
  ...
  extension [Self <: GoogleCloudVisionV1p2beta1Product](x: Self) {
    ...
    inline def setProductLabelsVarargs(value: GoogleCloudVisionV1p2beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value :_*))
  }
}
