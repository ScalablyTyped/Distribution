...
trait GoogleCloudVisionV1p1beta1ColorInfo extends StObject {
...
object GoogleCloudVisionV1p1beta1ColorInfo {
  ...
  inline def apply(): GoogleCloudVisionV1p1beta1ColorInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1ColorInfo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p1beta1ColorInfo] (val x: Self) extends AnyVal {
