...
@js.native
trait GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation extends js.Object {
...
object GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1LocalizedObjectAnnotationOps[Self <: GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation] (val x: Self) extends AnyVal {
