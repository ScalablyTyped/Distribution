...
object GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1LocalizedObjectAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation] (val x: Self) extends AnyVal {
