...
object GoogleCloudVisionV1p1beta1AnnotateImageResponse {
  ...
  extension [Self <: GoogleCloudVisionV1p1beta1AnnotateImageResponse](x: Self) {
    ...
    inline def setFaceAnnotationsVarargs(value: GoogleCloudVisionV1p1beta1FaceAnnotation*): Self = StObject.set(x, "faceAnnotations", js.Array(value :_*))
    ...
    inline def setLabelAnnotationsVarargs(value: GoogleCloudVisionV1p1beta1EntityAnnotation*): Self = StObject.set(x, "labelAnnotations", js.Array(value :_*))
    ...
    inline def setLandmarkAnnotationsVarargs(value: GoogleCloudVisionV1p1beta1EntityAnnotation*): Self = StObject.set(x, "landmarkAnnotations", js.Array(value :_*))
    ...
    inline def setLocalizedObjectAnnotationsVarargs(value: GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation*): Self = StObject.set(x, "localizedObjectAnnotations", js.Array(value :_*))
    ...
    inline def setLogoAnnotationsVarargs(value: GoogleCloudVisionV1p1beta1EntityAnnotation*): Self = StObject.set(x, "logoAnnotations", js.Array(value :_*))
    ...
    inline def setTextAnnotationsVarargs(value: GoogleCloudVisionV1p1beta1EntityAnnotation*): Self = StObject.set(x, "textAnnotations", js.Array(value :_*))
