...
object GoogleCloudVisionV1p3beta1Product {
  ...
  inline def apply(): GoogleCloudVisionV1p3beta1Product = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1Product]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p3beta1Product] (val x: Self) extends AnyVal {
    ...
    inline def setProductLabels(value: js.Array[GoogleCloudVisionV1p3beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
