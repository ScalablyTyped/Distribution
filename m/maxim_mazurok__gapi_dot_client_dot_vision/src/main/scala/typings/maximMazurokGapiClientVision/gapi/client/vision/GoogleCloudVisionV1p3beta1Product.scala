...
trait GoogleCloudVisionV1p3beta1Product extends StObject {
  ...
  /**
    ...
    */
  var productLabels: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1ProductKeyValue]] = js.undefined
}
object GoogleCloudVisionV1p3beta1Product {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1ProductMutableBuilder[Self <: GoogleCloudVisionV1p3beta1Product] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductLabels(value: js.Array[GoogleCloudVisionV1p3beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProductLabelsUndefined: Self = StObject.set(x, "productLabels", js.undefined)
    
    @scala.inline
    def setProductLabelsVarargs(value: GoogleCloudVisionV1p3beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value :_*))
  }
}
