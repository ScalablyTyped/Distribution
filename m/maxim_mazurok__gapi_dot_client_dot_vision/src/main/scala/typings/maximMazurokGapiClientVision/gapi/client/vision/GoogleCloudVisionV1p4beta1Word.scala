...
trait GoogleCloudVisionV1p4beta1Word extends StObject {
  ...
  var symbols: js.UndefOr[js.Array[GoogleCloudVisionV1p4beta1Symbol]] = js.undefined
}
object GoogleCloudVisionV1p4beta1Word {
  
  inline def apply(): GoogleCloudVisionV1p4beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1Word]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p4beta1Word] (val x: Self) extends AnyVal {
    ...
    inline def setSymbols(value: js.Array[GoogleCloudVisionV1p4beta1Symbol]): Self = StObject.set(x, "symbols", value.asInstanceOf[js.Any])
    
    inline def setSymbolsUndefined: Self = StObject.set(x, "symbols", js.undefined)
    
    inline def setSymbolsVarargs(value: GoogleCloudVisionV1p4beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value*))
  }
}
