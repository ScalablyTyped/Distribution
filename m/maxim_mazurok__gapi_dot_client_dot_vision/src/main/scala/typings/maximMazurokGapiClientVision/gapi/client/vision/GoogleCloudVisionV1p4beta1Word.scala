...
object GoogleCloudVisionV1p4beta1Word {
  ...
  extension [Self <: GoogleCloudVisionV1p4beta1Word](x: Self) {
    ...
    inline def setSymbolsVarargs(value: GoogleCloudVisionV1p4beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value :_*))
  }
}
