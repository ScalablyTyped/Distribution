...
trait GoogleCloudVisionV1p4beta1ProductSearchResultsResult extends StObject {
  ...
  /** The Product. */
  var product: js.UndefOr[GoogleCloudVisionV1p4beta1Product] = js.undefined
...
object GoogleCloudVisionV1p4beta1ProductSearchResultsResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p4beta1ProductSearchResultsResult] (val x: Self) extends AnyVal {
