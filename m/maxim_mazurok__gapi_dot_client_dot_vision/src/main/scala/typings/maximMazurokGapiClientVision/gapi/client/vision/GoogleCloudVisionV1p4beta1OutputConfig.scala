...
trait GoogleCloudVisionV1p4beta1OutputConfig extends StObject {
  ...
  var gcsDestination: js.UndefOr[GoogleCloudVisionV1p4beta1GcsDestination] = js.undefined
}
object GoogleCloudVisionV1p4beta1OutputConfig {
  
  inline def apply(): GoogleCloudVisionV1p4beta1OutputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1OutputConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p4beta1OutputConfig] (val x: Self) extends AnyVal {
    
    inline def setBatchSize(value: Double): Self = StObject.set(x, "batchSize", value.asInstanceOf[js.Any])
    
    inline def setBatchSizeUndefined: Self = StObject.set(x, "batchSize", js.undefined)
    
    inline def setGcsDestination(value: GoogleCloudVisionV1p4beta1GcsDestination): Self = StObject.set(x, "gcsDestination", value.asInstanceOf[js.Any])
