...
trait GoogleCloudVisionV1p1beta1Symbol extends StObject {
...
object GoogleCloudVisionV1p1beta1Symbol {
  ...
  inline def apply(): GoogleCloudVisionV1p1beta1Symbol = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1Symbol]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p1beta1Symbol] (val x: Self) extends AnyVal {
