...
trait GoogleCloudVisionV1p3beta1ProductSearchResultsResult extends StObject {
  ...
  /** The Product. */
  var product: js.UndefOr[GoogleCloudVisionV1p3beta1Product] = js.undefined
...
object GoogleCloudVisionV1p3beta1ProductSearchResultsResult {
  ...
  inline def apply(): GoogleCloudVisionV1p3beta1ProductSearchResultsResult = {
  ...
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p3beta1ProductSearchResultsResult] (val x: Self) extends AnyVal {
    ...
    inline def setProduct(value: GoogleCloudVisionV1p3beta1Product): Self = StObject.set(x, "product", value.asInstanceOf[js.Any])
