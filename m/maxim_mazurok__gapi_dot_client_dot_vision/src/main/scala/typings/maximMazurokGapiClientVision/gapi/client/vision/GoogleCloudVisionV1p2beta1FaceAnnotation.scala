...
trait GoogleCloudVisionV1p2beta1FaceAnnotation extends StObject {
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[GoogleCloudVisionV1p2beta1BoundingPoly] = js.undefined
  ...
  var landmarks: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1FaceAnnotationLandmark]] = js.undefined
...
object GoogleCloudVisionV1p2beta1FaceAnnotation {
  ...
  inline def apply(): GoogleCloudVisionV1p2beta1FaceAnnotation = {
  ...
  extension [Self <: GoogleCloudVisionV1p2beta1FaceAnnotation](x: Self) {
    ...
    inline def setFdBoundingPoly(value: GoogleCloudVisionV1p2beta1BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    inline def setLandmarks(value: js.Array[GoogleCloudVisionV1p2beta1FaceAnnotationLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    inline def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    inline def setLandmarksVarargs(value: GoogleCloudVisionV1p2beta1FaceAnnotationLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
