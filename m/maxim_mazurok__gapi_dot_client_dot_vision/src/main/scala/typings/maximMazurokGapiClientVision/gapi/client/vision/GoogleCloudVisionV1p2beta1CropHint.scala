...
@js.native
trait GoogleCloudVisionV1p2beta1CropHint extends js.Object {
...
object GoogleCloudVisionV1p2beta1CropHint {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1CropHint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1CropHint]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1CropHintOps[Self <: GoogleCloudVisionV1p2beta1CropHint] (val x: Self) extends AnyVal {
