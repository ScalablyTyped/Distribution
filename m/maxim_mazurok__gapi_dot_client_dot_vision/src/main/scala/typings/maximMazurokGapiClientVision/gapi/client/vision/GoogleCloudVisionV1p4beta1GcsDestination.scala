...
@js.native
trait GoogleCloudVisionV1p4beta1GcsDestination extends js.Object {
...
object GoogleCloudVisionV1p4beta1GcsDestination {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1GcsDestinationOps[Self <: GoogleCloudVisionV1p4beta1GcsDestination] (val x: Self) extends AnyVal {
