...
@js.native
trait GoogleCloudVisionV1p4beta1GcsDestination extends StObject {
...
object GoogleCloudVisionV1p4beta1GcsDestination {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1GcsDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1GcsDestination]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1GcsDestinationMutableBuilder[Self <: GoogleCloudVisionV1p4beta1GcsDestination] (val x: Self) extends AnyVal {
