...
trait GoogleCloudVisionV1p2beta1InputConfig extends StObject {
  ...
  var gcsSource: js.UndefOr[GoogleCloudVisionV1p2beta1GcsSource] = js.undefined
...
object GoogleCloudVisionV1p2beta1InputConfig {
  ...
  inline def apply(): GoogleCloudVisionV1p2beta1InputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1InputConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p2beta1InputConfig] (val x: Self) extends AnyVal {
    
    inline def setContent(value: String): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    
    inline def setContentUndefined: Self = StObject.set(x, "content", js.undefined)
    
    inline def setGcsSource(value: GoogleCloudVisionV1p2beta1GcsSource): Self = StObject.set(x, "gcsSource", value.asInstanceOf[js.Any])
