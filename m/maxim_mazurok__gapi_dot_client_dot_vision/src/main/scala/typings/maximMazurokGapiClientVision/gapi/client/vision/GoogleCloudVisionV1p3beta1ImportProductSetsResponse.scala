...
object GoogleCloudVisionV1p3beta1ImportProductSetsResponse {
  ...
  inline def apply(): GoogleCloudVisionV1p3beta1ImportProductSetsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1ImportProductSetsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p3beta1ImportProductSetsResponse] (val x: Self) extends AnyVal {
    
    inline def setReferenceImages(value: js.Array[GoogleCloudVisionV1p3beta1ReferenceImage]): Self = StObject.set(x, "referenceImages", value.asInstanceOf[js.Any])
    
    inline def setReferenceImagesUndefined: Self = StObject.set(x, "referenceImages", js.undefined)
    
    inline def setReferenceImagesVarargs(value: GoogleCloudVisionV1p3beta1ReferenceImage*): Self = StObject.set(x, "referenceImages", js.Array(value*))
