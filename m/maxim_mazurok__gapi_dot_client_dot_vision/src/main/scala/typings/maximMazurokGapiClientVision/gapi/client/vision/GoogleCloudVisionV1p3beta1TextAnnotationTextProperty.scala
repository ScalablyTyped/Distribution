...
object GoogleCloudVisionV1p3beta1TextAnnotationTextProperty {
  ...
  extension [Self <: GoogleCloudVisionV1p3beta1TextAnnotationTextProperty](x: Self) {
    ...
    inline def setDetectedLanguagesVarargs(value: GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage*): Self = StObject.set(x, "detectedLanguages", js.Array(value*))
  }
}
