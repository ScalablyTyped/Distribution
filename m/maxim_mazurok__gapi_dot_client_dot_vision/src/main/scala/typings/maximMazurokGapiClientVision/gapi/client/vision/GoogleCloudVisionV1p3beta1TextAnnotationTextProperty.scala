...
object GoogleCloudVisionV1p3beta1TextAnnotationTextProperty {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1TextAnnotationTextPropertyMutableBuilder[Self <: GoogleCloudVisionV1p3beta1TextAnnotationTextProperty] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setDetectedBreak(value: GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak): Self = StObject.set(x, "detectedBreak", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDetectedBreakUndefined: Self = StObject.set(x, "detectedBreak", js.undefined)
    
    @scala.inline
    def setDetectedLanguages(value: js.Array[GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage]): Self = StObject.set(x, "detectedLanguages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDetectedLanguagesUndefined: Self = StObject.set(x, "detectedLanguages", js.undefined)
    
    @scala.inline
    def setDetectedLanguagesVarargs(value: GoogleCloudVisionV1p3beta1TextAnnotationDetectedLanguage*): Self = StObject.set(x, "detectedLanguages", js.Array(value :_*))
  }
}
