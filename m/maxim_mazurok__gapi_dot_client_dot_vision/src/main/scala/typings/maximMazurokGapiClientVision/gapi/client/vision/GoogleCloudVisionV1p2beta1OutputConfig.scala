...
@js.native
trait GoogleCloudVisionV1p2beta1OutputConfig extends js.Object {
...
object GoogleCloudVisionV1p2beta1OutputConfig {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1OutputConfigOps[Self <: GoogleCloudVisionV1p2beta1OutputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsDestination(value: GoogleCloudVisionV1p2beta1GcsDestination): Self = this.set("gcsDestination", value.asInstanceOf[js.Any])
