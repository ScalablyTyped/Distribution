...
trait GoogleCloudVisionV1p2beta1OutputConfig extends StObject {
  ...
  var gcsDestination: js.UndefOr[GoogleCloudVisionV1p2beta1GcsDestination] = js.undefined
}
object GoogleCloudVisionV1p2beta1OutputConfig {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1OutputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1OutputConfig]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1OutputConfigMutableBuilder[Self <: GoogleCloudVisionV1p2beta1OutputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsDestination(value: GoogleCloudVisionV1p2beta1GcsDestination): Self = StObject.set(x, "gcsDestination", value.asInstanceOf[js.Any])
