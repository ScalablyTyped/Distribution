...
object GoogleCloudVisionV1p3beta1FaceAnnotation {
  ...
  extension [Self <: GoogleCloudVisionV1p3beta1FaceAnnotation](x: Self) {
    ...
    inline def setLandmarksVarargs(value: GoogleCloudVisionV1p3beta1FaceAnnotationLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
