...
trait GoogleCloudVisionV1p3beta1FaceAnnotation extends StObject {
  ...
  /**
    ...
    */
  var boundingPoly: js.UndefOr[GoogleCloudVisionV1p3beta1BoundingPoly] = js.undefined
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[GoogleCloudVisionV1p3beta1BoundingPoly] = js.undefined
  ...
  var landmarks: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1FaceAnnotationLandmark]] = js.undefined
...
object GoogleCloudVisionV1p3beta1FaceAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p3beta1FaceAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1FaceAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1FaceAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p3beta1FaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingPoly(value: GoogleCloudVisionV1p3beta1BoundingPoly): Self = StObject.set(x, "boundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFdBoundingPoly(value: GoogleCloudVisionV1p3beta1BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarks(value: js.Array[GoogleCloudVisionV1p3beta1FaceAnnotationLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    @scala.inline
    def setLandmarksVarargs(value: GoogleCloudVisionV1p3beta1FaceAnnotationLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
