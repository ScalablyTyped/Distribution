...
object GoogleCloudVisionV1p3beta1FaceAnnotation {
  ...
  inline def apply(): GoogleCloudVisionV1p3beta1FaceAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1FaceAnnotation]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p3beta1FaceAnnotation] (val x: Self) extends AnyVal {
    ...
    inline def setBoundingPoly(value: GoogleCloudVisionV1p3beta1BoundingPoly): Self = StObject.set(x, "boundingPoly", value.asInstanceOf[js.Any])
    ...
    inline def setFdBoundingPoly(value: GoogleCloudVisionV1p3beta1BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    inline def setLandmarks(value: js.Array[GoogleCloudVisionV1p3beta1FaceAnnotationLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    inline def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    inline def setLandmarksVarargs(value: GoogleCloudVisionV1p3beta1FaceAnnotationLandmark*): Self = StObject.set(x, "landmarks", js.Array(value*))
