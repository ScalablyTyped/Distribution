...
@js.native
trait GoogleCloudVisionV1p3beta1Block extends js.Object {
  ...
  var paragraphs: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1Paragraph]] = js.native
...
object GoogleCloudVisionV1p3beta1Block {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p3beta1Block = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1Block]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1BlockOps[Self <: GoogleCloudVisionV1p3beta1Block] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingBox(value: GoogleCloudVisionV1p3beta1BoundingPoly): Self = this.set("boundingBox", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParagraphsVarargs(value: GoogleCloudVisionV1p3beta1Paragraph*): Self = this.set("paragraphs", js.Array(value :_*))
    
    @scala.inline
    def setParagraphs(value: js.Array[GoogleCloudVisionV1p3beta1Paragraph]): Self = this.set("paragraphs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteParagraphs: Self = this.set("paragraphs", js.undefined)
    
    @scala.inline
    def setProperty(value: GoogleCloudVisionV1p3beta1TextAnnotationTextProperty): Self = this.set("property", value.asInstanceOf[js.Any])
