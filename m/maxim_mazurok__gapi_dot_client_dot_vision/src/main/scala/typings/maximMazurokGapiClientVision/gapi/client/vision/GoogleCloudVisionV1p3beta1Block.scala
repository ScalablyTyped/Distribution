...
trait GoogleCloudVisionV1p3beta1Block extends StObject {
  ...
  /**
    ...
    */
  var boundingBox: js.UndefOr[GoogleCloudVisionV1p3beta1BoundingPoly] = js.undefined
  
  /** Confidence of the OCR results on the block. Range [0, 1]. */
  var confidence: js.UndefOr[Double] = js.undefined
  
  /** List of paragraphs in this block (if this blocks is of type text). */
  var paragraphs: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1Paragraph]] = js.undefined
...
object GoogleCloudVisionV1p3beta1Block {
  ...
  inline def apply(): GoogleCloudVisionV1p3beta1Block = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1Block]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p3beta1Block] (val x: Self) extends AnyVal {
    ...
    inline def setBoundingBox(value: GoogleCloudVisionV1p3beta1BoundingPoly): Self = StObject.set(x, "boundingBox", value.asInstanceOf[js.Any])
    ...
    inline def setParagraphs(value: js.Array[GoogleCloudVisionV1p3beta1Paragraph]): Self = StObject.set(x, "paragraphs", value.asInstanceOf[js.Any])
    
    inline def setParagraphsUndefined: Self = StObject.set(x, "paragraphs", js.undefined)
    
    inline def setParagraphsVarargs(value: GoogleCloudVisionV1p3beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value*))
    
    inline def setProperty(value: GoogleCloudVisionV1p3beta1TextAnnotationTextProperty): Self = StObject.set(x, "property", value.asInstanceOf[js.Any])
