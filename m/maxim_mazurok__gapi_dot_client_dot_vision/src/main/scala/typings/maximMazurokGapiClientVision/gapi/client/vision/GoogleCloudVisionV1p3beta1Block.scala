...
object GoogleCloudVisionV1p3beta1Block {
  ...
  extension [Self <: GoogleCloudVisionV1p3beta1Block](x: Self) {
    ...
    inline def setParagraphsVarargs(value: GoogleCloudVisionV1p3beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value :_*))
