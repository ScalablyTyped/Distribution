...
object GoogleCloudVisionV1p3beta1Block {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1BlockMutableBuilder[Self <: GoogleCloudVisionV1p3beta1Block] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParagraphs(value: js.Array[GoogleCloudVisionV1p3beta1Paragraph]): Self = StObject.set(x, "paragraphs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setParagraphsUndefined: Self = StObject.set(x, "paragraphs", js.undefined)
    
    @scala.inline
    def setParagraphsVarargs(value: GoogleCloudVisionV1p3beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value :_*))
