...
@js.native
trait GoogleCloudVisionV1p3beta1OutputConfig extends js.Object {
...
object GoogleCloudVisionV1p3beta1OutputConfig {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1OutputConfigOps[Self <: GoogleCloudVisionV1p3beta1OutputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsDestination(value: GoogleCloudVisionV1p3beta1GcsDestination): Self = this.set("gcsDestination", value.asInstanceOf[js.Any])
