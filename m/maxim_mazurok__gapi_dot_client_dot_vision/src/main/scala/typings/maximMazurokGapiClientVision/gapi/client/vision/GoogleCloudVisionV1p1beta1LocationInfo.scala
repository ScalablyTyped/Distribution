...
trait GoogleCloudVisionV1p1beta1LocationInfo extends StObject {
...
object GoogleCloudVisionV1p1beta1LocationInfo {
  ...
  inline def apply(): GoogleCloudVisionV1p1beta1LocationInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1LocationInfo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p1beta1LocationInfo] (val x: Self) extends AnyVal {
