...
@js.native
trait GoogleCloudVisionV1p4beta1ImportProductSetsResponse extends js.Object {
  
  /** The list of reference_images that are imported successfully. */
  var referenceImages: js.UndefOr[js.Array[GoogleCloudVisionV1p4beta1ReferenceImage]] = js.native
...
object GoogleCloudVisionV1p4beta1ImportProductSetsResponse {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1ImportProductSetsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1ImportProductSetsResponse]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1ImportProductSetsResponseOps[Self <: GoogleCloudVisionV1p4beta1ImportProductSetsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReferenceImagesVarargs(value: GoogleCloudVisionV1p4beta1ReferenceImage*): Self = this.set("referenceImages", js.Array(value :_*))
    
    @scala.inline
    def setReferenceImages(value: js.Array[GoogleCloudVisionV1p4beta1ReferenceImage]): Self = this.set("referenceImages", value.asInstanceOf[js.Any])
