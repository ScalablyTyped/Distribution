...
object GoogleCloudVisionV1p4beta1ImportProductSetsResponse {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1ImportProductSetsResponseMutableBuilder[Self <: GoogleCloudVisionV1p4beta1ImportProductSetsResponse] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setReferenceImages(value: js.Array[GoogleCloudVisionV1p4beta1ReferenceImage]): Self = StObject.set(x, "referenceImages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReferenceImagesUndefined: Self = StObject.set(x, "referenceImages", js.undefined)
    
    @scala.inline
    def setReferenceImagesVarargs(value: GoogleCloudVisionV1p4beta1ReferenceImage*): Self = StObject.set(x, "referenceImages", js.Array(value :_*))
