...
@js.native
trait GoogleCloudVisionV1p3beta1Symbol extends js.Object {
...
object GoogleCloudVisionV1p3beta1Symbol {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1SymbolOps[Self <: GoogleCloudVisionV1p3beta1Symbol] (val x: Self) extends AnyVal {
