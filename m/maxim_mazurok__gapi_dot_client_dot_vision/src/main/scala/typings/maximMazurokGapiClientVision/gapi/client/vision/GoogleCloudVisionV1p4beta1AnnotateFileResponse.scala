...
object GoogleCloudVisionV1p4beta1AnnotateFileResponse {
  ...
  extension [Self <: GoogleCloudVisionV1p4beta1AnnotateFileResponse](x: Self) {
    ...
    inline def setResponsesVarargs(value: GoogleCloudVisionV1p4beta1AnnotateImageResponse*): Self = StObject.set(x, "responses", js.Array(value :_*))
