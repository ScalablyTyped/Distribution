...
trait GoogleCloudVisionV1p2beta1Block extends StObject {
  ...
  var paragraphs: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1Paragraph]] = js.undefined
...
object GoogleCloudVisionV1p2beta1Block {
  ...
  inline def apply(): GoogleCloudVisionV1p2beta1Block = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1Block]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p2beta1Block] (val x: Self) extends AnyVal {
    ...
    inline def setParagraphs(value: js.Array[GoogleCloudVisionV1p2beta1Paragraph]): Self = StObject.set(x, "paragraphs", value.asInstanceOf[js.Any])
    
    inline def setParagraphsUndefined: Self = StObject.set(x, "paragraphs", js.undefined)
    
    inline def setParagraphsVarargs(value: GoogleCloudVisionV1p2beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value*))
