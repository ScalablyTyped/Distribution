...
object GoogleCloudVisionV1p2beta1Block {
  ...
  extension [Self <: GoogleCloudVisionV1p2beta1Block](x: Self) {
    ...
    inline def setParagraphsVarargs(value: GoogleCloudVisionV1p2beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value :_*))
