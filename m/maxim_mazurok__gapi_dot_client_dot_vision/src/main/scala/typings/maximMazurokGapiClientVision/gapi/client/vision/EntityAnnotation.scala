...
object EntityAnnotation {
  ...
  @scala.inline
  implicit class EntityAnnotationMutableBuilder[Self <: EntityAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocations(value: js.Array[LocationInfo]): Self = StObject.set(x, "locations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLocationsUndefined: Self = StObject.set(x, "locations", js.undefined)
    
    @scala.inline
    def setLocationsVarargs(value: LocationInfo*): Self = StObject.set(x, "locations", js.Array(value :_*))
