...
@js.native
trait GoogleCloudVisionV1p2beta1SafeSearchAnnotation extends js.Object {
...
object GoogleCloudVisionV1p2beta1SafeSearchAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1SafeSearchAnnotationOps[Self <: GoogleCloudVisionV1p2beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
