...
object GoogleCloudVisionV1p2beta1SafeSearchAnnotation {
  ...
  inline def apply(): GoogleCloudVisionV1p2beta1SafeSearchAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1SafeSearchAnnotation]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p2beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
