...
trait GoogleCloudVisionV1p2beta1SafeSearchAnnotation extends StObject {
...
object GoogleCloudVisionV1p2beta1SafeSearchAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1SafeSearchAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1SafeSearchAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1SafeSearchAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p2beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
