...
trait GoogleCloudVisionV1p3beta1GcsDestination extends StObject {
...
object GoogleCloudVisionV1p3beta1GcsDestination {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p3beta1GcsDestination] (val x: Self) extends AnyVal {
