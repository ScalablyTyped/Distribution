...
object GoogleCloudVisionV1p1beta1Paragraph {
  ...
  inline def apply(): GoogleCloudVisionV1p1beta1Paragraph = {
  ...
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p1beta1Paragraph] (val x: Self) extends AnyVal {
    ...
    inline def setWords(value: js.Array[GoogleCloudVisionV1p1beta1Word]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
