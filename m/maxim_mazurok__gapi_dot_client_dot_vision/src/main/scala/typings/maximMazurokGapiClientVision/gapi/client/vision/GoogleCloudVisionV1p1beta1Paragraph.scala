...
trait GoogleCloudVisionV1p1beta1Paragraph extends StObject {
  ...
  /**
    ...
    */
  var boundingBox: js.UndefOr[GoogleCloudVisionV1p1beta1BoundingPoly] = js.undefined
  
  /** Confidence of the OCR results for the paragraph. Range [0, 1]. */
  var confidence: js.UndefOr[Double] = js.undefined
  
  /** Additional information detected for the paragraph. */
  var property: js.UndefOr[GoogleCloudVisionV1p1beta1TextAnnotationTextProperty] = js.undefined
  
  /** List of all words in this paragraph. */
  var words: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1Word]] = js.undefined
}
object GoogleCloudVisionV1p1beta1Paragraph {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p1beta1Paragraph = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1Paragraph]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1ParagraphMutableBuilder[Self <: GoogleCloudVisionV1p1beta1Paragraph] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWords(value: js.Array[GoogleCloudVisionV1p1beta1Word]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    @scala.inline
    def setWordsVarargs(value: GoogleCloudVisionV1p1beta1Word*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
