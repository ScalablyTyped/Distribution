...
object GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult {
  ...
  inline def apply(): GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult]
  }
  
  extension [Self <: GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult](x: Self) {
    ...
    inline def setObjectAnnotations(value: js.Array[GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation]): Self = StObject.set(x, "objectAnnotations", value.asInstanceOf[js.Any])
    
    inline def setObjectAnnotationsUndefined: Self = StObject.set(x, "objectAnnotations", js.undefined)
    
    inline def setObjectAnnotationsVarargs(value: GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation*): Self = StObject.set(x, "objectAnnotations", js.Array(value :_*))
    ...
    inline def setResultsVarargs(value: GoogleCloudVisionV1p2beta1ProductSearchResultsResult*): Self = StObject.set(x, "results", js.Array(value :_*))
  }
}
