...
object GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult] (val x: Self) extends AnyVal {
    ...
    inline def setObjectAnnotationsVarargs(value: GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation*): Self = StObject.set(x, "objectAnnotations", js.Array(value*))
