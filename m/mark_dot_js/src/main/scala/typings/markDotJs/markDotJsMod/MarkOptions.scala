...
import typings.markDotJs.markDotJsStrings.disabled
import typings.markDotJs.markDotJsStrings.enabled
import typings.markDotJs.markDotJsStrings.withSpaces
