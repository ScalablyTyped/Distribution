...
trait Moment extends js.Object {
  ...
  def nextHoliday(): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def nextHoliday(count: scala.Double): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def nextHoliday(count: scala.Double, adjust: scala.Boolean): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def nextHolidays(): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def nextHolidays(count: scala.Double): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def nextHolidays(count: scala.Double, adjust: scala.Boolean): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def previousHoliday(): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def previousHoliday(count: scala.Double): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def previousHoliday(count: scala.Double, adjust: scala.Boolean): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def previousHolidays(): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def previousHolidays(count: scala.Double): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
  def previousHolidays(count: scala.Double, adjust: scala.Boolean): js.Array[momentLib.momentMod.momentNs.Moment] | momentLib.momentMod.momentNs.Moment = js.native
}
