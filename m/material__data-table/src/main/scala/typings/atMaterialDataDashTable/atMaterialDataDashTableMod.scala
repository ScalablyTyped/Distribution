...
@js.native
object atMaterialDataDashTableMod extends js.Object {
  @js.native
  class MDCDataTable ()
    extends typings.atMaterialDataDashTable.componentMod.MDCDataTable
  
  @js.native
  class MDCDataTableFoundation ()
    extends typings.atMaterialDataDashTable.foundationMod.MDCDataTableFoundation {
  ...
  object MDCDataTable extends js.Object {
    def attachTo(root: Element): typings.atMaterialDataDashTable.componentMod.MDCDataTable = js.native
  }
