...
trait Callback extends js.Object {
  ...
  /** Request body */
  var resource: DismissApprovalRequestMessage = js.native
...
object Callback {
  ...
  implicit class CallbackOps[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DismissApprovalRequestMessage): Self = this.set("resource", value.asInstanceOf[js.Any])
