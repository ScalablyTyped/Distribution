package typings.maximMazurokGapiClientAccessapproval.anon
...
trait Accesstoken extends js.Object {
  ...
  /** Request body */
  var resource: ApproveApprovalRequestMessage = js.native
...
object Accesstoken {
  ...
  implicit class AccesstokenOps[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ApproveApprovalRequestMessage): Self = this.set("resource", value.asInstanceOf[js.Any])
