...
@js.native
open class RoomMember protected () extends StObject {
  ...
  def setMembershipEvent(event: MatrixEvent[EventContentTypeMessage, EventType], roomState: RoomState): Unit = js.native
  
  def setPowerLevelEvent(powerLevelEvent: MatrixEvent[EventContentTypeMessage, EventType]): Unit = js.native
