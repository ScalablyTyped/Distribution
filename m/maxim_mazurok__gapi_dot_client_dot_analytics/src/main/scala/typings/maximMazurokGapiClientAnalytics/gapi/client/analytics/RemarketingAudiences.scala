...
object RemarketingAudiences {
  ...
  implicit class RemarketingAudiencesOps[Self <: RemarketingAudiences] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: RemarketingAudience*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[RemarketingAudience]): Self = this.set("items", value.asInstanceOf[js.Any])
