...
object AltCustomDataSourceId {
  ...
  inline def apply(accountId: String, customDataSourceId: String, webPropertyId: String): AltCustomDataSourceId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AltCustomDataSourceId] (val x: Self) extends AnyVal {
