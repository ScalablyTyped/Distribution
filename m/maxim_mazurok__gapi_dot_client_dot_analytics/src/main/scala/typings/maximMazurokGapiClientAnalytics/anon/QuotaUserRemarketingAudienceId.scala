...
object QuotaUserRemarketingAudienceId {
  ...
  @scala.inline
  implicit class QuotaUserRemarketingAudienceIdMutableBuilder[Self <: QuotaUserRemarketingAudienceId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RemarketingAudience): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
