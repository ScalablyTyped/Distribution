...
import typings.maximMazurokGapiClientAnalytics.gapi.client.analytics.RemarketingAudience
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait QuotaUserRemarketingAudienceId extends js.Object {
  ...
  /** Request body */
  var resource: RemarketingAudience = js.native
...
object QuotaUserRemarketingAudienceId {
  ...
  @scala.inline
  implicit class QuotaUserRemarketingAudienceIdOps[Self <: QuotaUserRemarketingAudienceId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RemarketingAudience): Self = this.set("resource", value.asInstanceOf[js.Any])
