...
object CustomMetricIdFields {
  ...
  inline def apply(accountId: String, customMetricId: String, webPropertyId: String): CustomMetricIdFields = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CustomMetricIdFields] (val x: Self) extends AnyVal {
