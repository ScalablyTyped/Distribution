...
@js.native
trait CustomMetricIdFields extends StObject {
...
object CustomMetricIdFields {
  
  @scala.inline
  def apply(accountId: String, customMetricId: String, webPropertyId: String): CustomMetricIdFields = {
    ...
    __obj.asInstanceOf[CustomMetricIdFields]
  }
  
  @scala.inline
  implicit class CustomMetricIdFieldsMutableBuilder[Self <: CustomMetricIdFields] (val x: Self) extends AnyVal {
