...
object AltCustomDimensionId {
  ...
  inline def apply(accountId: String, customDimensionId: String, webPropertyId: String): AltCustomDimensionId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AltCustomDimensionId] (val x: Self) extends AnyVal {
