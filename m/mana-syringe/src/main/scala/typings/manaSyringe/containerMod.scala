...
import typings.manaSyringe.inversifyProtocolMod.InversifyContext
...
object containerMod {
  ...
  open class Container ()
    extends StObject
       with typings.manaSyringe.coreMod.Syringe.Container
       with InversifyContext {
    def this(inversifyContainer: typings.inversify.interfacesMod.interfaces.Container) = this()
    
    /* CompleteClass */
    var container: typings.inversify.interfacesMod.interfaces.Container = js.native
