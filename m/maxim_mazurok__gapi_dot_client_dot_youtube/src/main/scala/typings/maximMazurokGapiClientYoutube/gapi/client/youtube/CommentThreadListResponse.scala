...
@js.native
trait CommentThreadListResponse extends js.Object {
...
object CommentThreadListResponse {
  ...
  @scala.inline
  implicit class CommentThreadListResponseOps[Self <: CommentThreadListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: CommentThread*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[CommentThread]): Self = this.set("items", value.asInstanceOf[js.Any])
