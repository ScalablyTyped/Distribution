...
trait ContentRating extends StObject {
  ...
  var nmcRating: js.UndefOr[String] = js.undefined
...
object ContentRating {
  ...
  extension [Self <: ContentRating](x: Self) {
    ...
    inline def setNmcRating(value: String): Self = StObject.set(x, "nmcRating", value.asInstanceOf[js.Any])
    
    inline def setNmcRatingUndefined: Self = StObject.set(x, "nmcRating", js.undefined)
