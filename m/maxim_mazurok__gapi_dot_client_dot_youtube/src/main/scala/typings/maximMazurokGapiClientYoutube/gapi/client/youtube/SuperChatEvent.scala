...
object SuperChatEvent {
  ...
  @scala.inline
  implicit class SuperChatEventOps[Self <: SuperChatEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSnippet(value: SuperChatEventSnippet): Self = this.set("snippet", value.asInstanceOf[js.Any])
