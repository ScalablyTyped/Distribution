...
object VideoCategory {
  ...
  @scala.inline
  implicit class VideoCategoryOps[Self <: VideoCategory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSnippet(value: VideoCategorySnippet): Self = this.set("snippet", value.asInstanceOf[js.Any])
