...
object LiveStreamListResponse {
  ...
  @scala.inline
  implicit class LiveStreamListResponseOps[Self <: LiveStreamListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: LiveStream*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[LiveStream]): Self = this.set("items", value.asInstanceOf[js.Any])
