...
@js.native
trait RegionCode extends js.Object {
...
object RegionCode {
  ...
  @scala.inline
  def apply(part: String | js.Array[String]): RegionCode = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any])
    __obj.asInstanceOf[RegionCode]
  }
  
  @scala.inline
  implicit class RegionCodeOps[Self <: RegionCode] (val x: Self) extends AnyVal {
