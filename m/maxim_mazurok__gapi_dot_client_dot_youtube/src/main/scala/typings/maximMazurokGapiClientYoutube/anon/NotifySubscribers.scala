...
trait NotifySubscribers extends StObject {
...
object NotifySubscribers {
  
  @scala.inline
  def apply(part: String | js.Array[String]): NotifySubscribers = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any])
    __obj.asInstanceOf[NotifySubscribers]
  }
  
  @scala.inline
  implicit class NotifySubscribersMutableBuilder[Self <: NotifySubscribers] (val x: Self) extends AnyVal {
