...
import typings.maximMazurokGapiClientYoutube.gapi.client.youtube.PlaylistItem
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait OnBehalfOfContentOwnerPart extends js.Object {
...
object OnBehalfOfContentOwnerPart {
  ...
  @scala.inline
  implicit class OnBehalfOfContentOwnerPartOps[Self <: OnBehalfOfContentOwnerPart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PlaylistItem): Self = this.set("resource", value.asInstanceOf[js.Any])
