...
@js.native
trait OnBehalfOfContentOwnerPrettyPrint extends js.Object {
...
object OnBehalfOfContentOwnerPrettyPrint {
  ...
  @scala.inline
  implicit class OnBehalfOfContentOwnerPrettyPrintOps[Self <: OnBehalfOfContentOwnerPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: VideoAbuseReport): Self = this.set("resource", value.asInstanceOf[js.Any])
