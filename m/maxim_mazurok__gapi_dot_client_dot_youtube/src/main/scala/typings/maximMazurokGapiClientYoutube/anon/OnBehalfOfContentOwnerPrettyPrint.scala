...
@js.native
trait OnBehalfOfContentOwnerPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: VideoAbuseReport = js.native
...
object OnBehalfOfContentOwnerPrettyPrint {
  ...
  @scala.inline
  def apply(resource: VideoAbuseReport): OnBehalfOfContentOwnerPrettyPrint = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[OnBehalfOfContentOwnerPrettyPrint]
  }
  
  @scala.inline
  implicit class OnBehalfOfContentOwnerPrettyPrintMutableBuilder[Self <: OnBehalfOfContentOwnerPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: VideoAbuseReport): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
