...
import typings.maximMazurokGapiClientYoutube.gapi.client.youtube.AbuseReport
...
object Accesstoken {
  ...
  inline def apply(part: String | js.Array[String], resource: AbuseReport): Accesstoken = {
  ...
  implicit open class MutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: AbuseReport): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
