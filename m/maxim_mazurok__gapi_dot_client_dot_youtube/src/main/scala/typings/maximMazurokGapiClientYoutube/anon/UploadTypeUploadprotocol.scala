...
trait UploadTypeUploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: ThirdPartyLink = js.native
...
object UploadTypeUploadprotocol {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: ThirdPartyLink): UploadTypeUploadprotocol = {
  ...
  implicit class UploadTypeUploadprotocolMutableBuilder[Self <: UploadTypeUploadprotocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ThirdPartyLink): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
