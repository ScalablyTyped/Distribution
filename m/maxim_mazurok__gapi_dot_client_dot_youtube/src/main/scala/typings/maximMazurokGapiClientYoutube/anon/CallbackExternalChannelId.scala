...
trait CallbackExternalChannelId extends StObject {
...
object CallbackExternalChannelId {
  
  inline def apply(part: String | js.Array[String]): CallbackExternalChannelId = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackExternalChannelId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackExternalChannelId] (val x: Self) extends AnyVal {
