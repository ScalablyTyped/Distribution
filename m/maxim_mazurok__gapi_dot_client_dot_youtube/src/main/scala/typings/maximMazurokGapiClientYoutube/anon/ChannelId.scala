...
trait ChannelId extends StObject {
  ...
  /** Request body */
  var resource: ChannelBannerResource = js.native
...
object ChannelId {
  ...
  @scala.inline
  def apply(resource: ChannelBannerResource): ChannelId = {
  ...
  implicit class ChannelIdMutableBuilder[Self <: ChannelId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ChannelBannerResource): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
