...
import typings.maximMazurokGapiClientYoutube.gapi.client.youtube.ChannelBannerResource
...
trait ChannelId extends StObject {
  ...
  /** Request body */
  var resource: ChannelBannerResource
...
object ChannelId {
  ...
  inline def apply(resource: ChannelBannerResource): ChannelId = {
  ...
  extension [Self <: ChannelId](x: Self) {
    ...
    inline def setResource(value: ChannelBannerResource): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
