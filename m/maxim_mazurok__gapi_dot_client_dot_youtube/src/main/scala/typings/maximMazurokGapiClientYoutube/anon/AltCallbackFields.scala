...
import typings.maximMazurokGapiClientYoutube.gapi.client.youtube.CommentThread
...
trait AltCallbackFields extends StObject {
  ...
  /**
    ...
    */
  var part: js.UndefOr[String | js.Array[String]] = js.undefined
...
object AltCallbackFields {
  ...
  inline def apply(resource: CommentThread): AltCallbackFields = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltCallbackFields]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AltCallbackFields] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: CommentThread): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
