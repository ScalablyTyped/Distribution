...
@js.native
trait OauthtokenPart extends js.Object {
...
object OauthtokenPart {
  ...
  @scala.inline
  implicit class OauthtokenPartOps[Self <: OauthtokenPart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiveChatMessage): Self = this.set("resource", value.asInstanceOf[js.Any])
