...
@js.native
trait OauthtokenPart extends StObject {
  ...
  /** Request body */
  var resource: LiveChatMessage = js.native
...
object OauthtokenPart {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: LiveChatMessage): OauthtokenPart = {
  ...
  @scala.inline
  implicit class OauthtokenPartMutableBuilder[Self <: OauthtokenPart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiveChatMessage): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
