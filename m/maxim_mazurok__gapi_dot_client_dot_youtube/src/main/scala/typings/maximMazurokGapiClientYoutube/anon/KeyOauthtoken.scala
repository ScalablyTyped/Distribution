...
trait KeyOauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: LiveChatBan = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: LiveChatBan): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenOps[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiveChatBan): Self = this.set("resource", value.asInstanceOf[js.Any])
