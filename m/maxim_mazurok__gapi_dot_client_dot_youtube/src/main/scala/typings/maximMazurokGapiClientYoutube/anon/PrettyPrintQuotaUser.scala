...
@js.native
trait PrettyPrintQuotaUser extends js.Object {
  ...
  /** Request body */
  var resource: Playlist = js.native
...
object PrettyPrintQuotaUser {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: Playlist): PrettyPrintQuotaUser = {
  ...
  @scala.inline
  implicit class PrettyPrintQuotaUserOps[Self <: PrettyPrintQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Playlist): Self = this.set("resource", value.asInstanceOf[js.Any])
