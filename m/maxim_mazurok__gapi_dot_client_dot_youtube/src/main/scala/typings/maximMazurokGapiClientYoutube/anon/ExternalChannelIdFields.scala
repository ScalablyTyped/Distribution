...
import typings.maximMazurokGapiClientYoutube.gapi.client.youtube.ThirdPartyLink
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ExternalChannelIdFields extends StObject {
...
object ExternalChannelIdFields {
  
  inline def apply(part: String | js.Array[String], resource: ThirdPartyLink): ExternalChannelIdFields = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ExternalChannelIdFields]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ExternalChannelIdFields] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ThirdPartyLink): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
