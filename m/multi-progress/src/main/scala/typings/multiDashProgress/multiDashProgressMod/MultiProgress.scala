package typings.multiDashProgress.multiDashProgressMod

import typings.progress.progressMod.ProgressBarOptions
...
trait MultiProgress extends js.Object {
  ...
  /**
    * Add a new bar
    */
  def newBar(format: String, options: ProgressBarOptions): typings.progress.progressMod.^ = js.native
  /**
    * Close all bars
    */
