...
@js.native
trait PartialMDCSelectIconAdapt extends js.Object {
...
object PartialMDCSelectIconAdapt {
  @scala.inline
  def apply(): PartialMDCSelectIconAdapt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMDCSelectIconAdapt]
  }
  @scala.inline
  implicit class PartialMDCSelectIconAdaptOps[Self <: PartialMDCSelectIconAdapt] (val x: Self) extends AnyVal {
    @scala.inline
