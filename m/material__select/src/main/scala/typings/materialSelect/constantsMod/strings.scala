package typings.materialSelect.constantsMod

import org.scalablytyped.runtime.StringDictionary
import typings.materialBase.foundationMod.MDCStrings
import typings.materialSelect.materialSelectStrings.MDCSelectColonchange
import typings.materialSelect.materialSelectStrings.`Dotmdc-floating-label`
import typings.materialSelect.materialSelectStrings.`Dotmdc-line-ripple`
import typings.materialSelect.materialSelectStrings.`Dotmdc-select__native-control`
