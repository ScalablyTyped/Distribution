package typings
package atMaterialSelectLib.foundationMod
...
@js.native
trait MDCSelectFoundation
  extends atMaterialBaseLib.atMaterialBaseMod.MDCFoundation[atMaterialSelectLib.adapterMod.MDCSelectAdapter] {
