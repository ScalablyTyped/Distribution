...
trait PublishCompositeConfig2[InLevel1, InLevel2, OutLevel] extends StObject {
  ...
  var children: js.UndefOr[js.Array[PublishCompositeConfig3[InLevel1, InLevel2, OutLevel, Any]]] = js.undefined
...
object PublishCompositeConfig2 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PublishCompositeConfig2[?, ?, ?], InLevel1, InLevel2, OutLevel] (val x: Self & (PublishCompositeConfig2[InLevel1, InLevel2, OutLevel])) extends AnyVal {
    
    inline def setChildren(value: js.Array[PublishCompositeConfig3[InLevel1, InLevel2, OutLevel, Any]]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
    
    inline def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
    
    inline def setChildrenVarargs(value: (PublishCompositeConfig3[InLevel1, InLevel2, OutLevel, Any])*): Self = StObject.set(x, "children", js.Array(value*))
