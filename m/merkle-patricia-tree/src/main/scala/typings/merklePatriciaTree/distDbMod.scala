...
object distDbMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.merklePatriciaTree.distDbMod.PutBatch
    - typings.merklePatriciaTree.distDbMod.DelBatch
  */
  trait BatchDBOp extends StObject
  object BatchDBOp {
    
    inline def DelBatch(key: Buffer): typings.merklePatriciaTree.distDbMod.DelBatch = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("del")
      __obj.asInstanceOf[typings.merklePatriciaTree.distDbMod.DelBatch]
    }
    
    inline def PutBatch(key: Buffer, value: Buffer): typings.merklePatriciaTree.distDbMod.PutBatch = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("put")
      __obj.asInstanceOf[typings.merklePatriciaTree.distDbMod.PutBatch]
    }
  }
