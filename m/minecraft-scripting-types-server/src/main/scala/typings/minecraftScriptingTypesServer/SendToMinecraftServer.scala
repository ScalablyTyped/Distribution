...
object SendToMinecraftServer {
  ...
  /**
    ...
    */
  inline def DisplayChat: minecraftColondisplay_chat_event = "minecraft:display_chat_event".asInstanceOf[minecraftColondisplay_chat_event]
  ...
  /**
    ...
    */
  inline def ExecuteCommand: minecraftColonexecute_command = "minecraft:execute_command".asInstanceOf[minecraftColonexecute_command]
  ...
  /**
    ...
    */
  inline def ScriptLoggerConfig: minecraftColonscript_logger_config = "minecraft:script_logger_config".asInstanceOf[minecraftColonscript_logger_config]
  ...
  /**
    ...
    */
  inline def SpawnParticleAttachedEntity: minecraftColonspawn_particle_attached_entity = "minecraft:spawn_particle_attached_entity".asInstanceOf[minecraftColonspawn_particle_attached_entity]
  ...
  /**
    ...
    */
  inline def SpawnParticleInWorld: minecraftColonspawn_particle_in_world = "minecraft:spawn_particle_in_world".asInstanceOf[minecraftColonspawn_particle_in_world]
}
