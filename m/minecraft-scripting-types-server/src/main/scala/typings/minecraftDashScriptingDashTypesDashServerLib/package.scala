...
package object minecraftDashScriptingDashTypesDashServerLib {
  type IArmorContainerComponent = js.Array[minecraftDashScriptingDashTypesDashSharedLib.IItemStack]
  /**
    ...
    */
  type IHandContainerComponent = js.Array[minecraftDashScriptingDashTypesDashSharedLib.IItemStack]
  /**
    ...
    */
  type IHotbarContainerComponent = js.Array[minecraftDashScriptingDashTypesDashSharedLib.IItemStack]
  /**
    ...
    */
  type IInventoryContainerComponent = js.Array[minecraftDashScriptingDashTypesDashSharedLib.IItemStack]
}
