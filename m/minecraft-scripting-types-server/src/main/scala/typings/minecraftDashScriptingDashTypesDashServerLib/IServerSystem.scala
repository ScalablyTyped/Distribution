...
trait IServerSystem[TSystem]
  extends minecraftDashScriptingDashTypesDashSharedLib.ISystem[TSystem]
  ...
  /**
    ...
    */
  def createEntity(`type`: java.lang.String, templateIdentifier: java.lang.String): minecraftDashScriptingDashTypesDashSharedLib.IEntity | scala.Null = js.native
  ////////////////////////////////////////////////
  // Commands
  ////////////////////////////////////////////////
  /**
  ...
  def executeCommand(
    ...
    callback: js.Function1[/* callback */ IExecuteCommandCallback, scala.Unit]
  ...
  /**
    ...
    */
  def getBlock(
    tickingArea: minecraftDashScriptingDashTypesDashSharedLib.ITickingArea,
    positionObject: minecraftDashScriptingDashTypesDashSharedLib.VectorXYZ
  ): minecraftDashScriptingDashTypesDashSharedLib.IBlock | scala.Null = js.native
  ////////////////////////////////////////////////
  // Blocks
  ////////////////////////////////////////////////
  /**
  ...
  def getBlocks(
    tickingArea: minecraftDashScriptingDashTypesDashSharedLib.ITickingArea,
    minimumPositionObject: minecraftDashScriptingDashTypesDashSharedLib.VectorXYZ,
    maximumPositionObject: minecraftDashScriptingDashTypesDashSharedLib.VectorXYZ
  ): js.Array[js.Array[minecraftDashScriptingDashTypesDashSharedLib.IBlock]] | scala.Null = js.native
  /**
  ...
  def registerQuery(component: java.lang.String): minecraftDashScriptingDashTypesDashSharedLib.IQuery | scala.Null = js.native
  def registerQuery(component: java.lang.String, componentField1: java.lang.String): minecraftDashScriptingDashTypesDashSharedLib.IQuery | scala.Null = js.native
  def registerQuery(component: java.lang.String, componentField1: java.lang.String, componentField2: java.lang.String): minecraftDashScriptingDashTypesDashSharedLib.IQuery | scala.Null = js.native
  def registerQuery(
  ...
  ): minecraftDashScriptingDashTypesDashSharedLib.IQuery | scala.Null = js.native
  /**
    ...
    */
  def registerQuery(component: MinecraftComponent): minecraftDashScriptingDashTypesDashSharedLib.IQuery | scala.Null = js.native
  def registerQuery(component: MinecraftComponent, componentField1: java.lang.String): minecraftDashScriptingDashTypesDashSharedLib.IQuery | scala.Null = js.native
  def registerQuery(
