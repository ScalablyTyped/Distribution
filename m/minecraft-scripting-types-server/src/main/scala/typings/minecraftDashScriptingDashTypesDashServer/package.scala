...
package object minecraftDashScriptingDashTypesDashServer {
  ...
  /**
    ...
    */
  type IHandContainerComponent = js.Array[IItemStack]
  /**
    ...
    */
  type IHotbarContainerComponent = js.Array[IItemStack]
  /**
    ...
    */
  type IInventoryContainerComponent = js.Array[IItemStack]
}
