...
import typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:display_chat_event`
import typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:execute_command`
...
import typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:script_logger_config`
import typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:spawn_particle_attached_entity`
import typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:spawn_particle_in_world`
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Rewritten from type alias, can be one of: 
  - typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:display_chat_event`
  - typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:execute_command`
  - typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:play_sound`
  - typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:script_logger_config`
  - typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:spawn_particle_attached_entity`
  - typings.minecraftDashScriptingDashTypesDashServer.minecraftDashScriptingDashTypesDashServerStrings.`minecraft:spawn_particle_in_world`
*/
...
object SendToMinecraftServer {
  ...
  /**
    ...
    */
  @scala.inline
  def ExecuteCommand: `minecraft:execute_command` = this.cast("minecraft:execute_command")
  /**
