...
object MiniSignalBinding {
  ...
  @scala.inline
  implicit class MiniSignalBindingOps[Self <: MiniSignalBinding] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDetach(value: () => Boolean): Self = this.set("detach", js.Any.fromFunction0(value))
  }
