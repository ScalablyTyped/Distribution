...
import typings.maximMazurokGapiClientIndexing.gapi.client.indexing.UrlNotification
...
object anon {
  ...
  object Alt {
    ...
    inline def apply(resource: UrlNotification): Alt = {
    ...
    implicit open class MutableBuilder[Self <: Alt] (val x: Self) extends AnyVal {
      ...
      inline def setResource(value: UrlNotification): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
