...
object anon {
  ...
  object Name {
    ...
    @scala.inline
    def apply(name: String, resource: MoveFolderRequest): Name = {
    ...
    implicit class NameMutableBuilder[Self <: Name] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: MoveFolderRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Oauthtoken {
    ...
    @scala.inline
    def apply(name: String, resource: Folder): Oauthtoken = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  object QuotaUser {
    ...
    implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: SearchFoldersRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Resource {
    ...
    implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: UndeleteFolderRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
