...
/* Rewritten from type alias, can be one of: 
  - typings.mapboxGl.mapboxGlStrings.center
  - typings.mapboxGl.mapboxGlStrings.left
  - typings.mapboxGl.mapboxGlStrings.right
  - typings.mapboxGl.mapboxGlStrings.top
  - typings.mapboxGl.mapboxGlStrings.bottom
  - typings.mapboxGl.mapboxGlStrings.`top-left`
  - typings.mapboxGl.mapboxGlStrings.`top-right`
  - typings.mapboxGl.mapboxGlStrings.`bottom-left`
  - typings.mapboxGl.mapboxGlStrings.`bottom-right`
*/
