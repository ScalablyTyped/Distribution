...
import typings.mapboxDashGl.mapboxDashGlStrings.GET
import typings.mapboxDashGl.mapboxDashGlStrings.POST
import typings.mapboxDashGl.mapboxDashGlStrings.PUT
import typings.mapboxDashGl.mapboxDashGlStrings.`same-origin`
import typings.mapboxDashGl.mapboxDashGlStrings.include
