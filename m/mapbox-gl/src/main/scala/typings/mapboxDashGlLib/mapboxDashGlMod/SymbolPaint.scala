...
trait SymbolPaint extends js.Object {
  ...
  var `icon-halo-blur`: js.UndefOr[scala.Double | StyleFunction | Expression] = js.undefined
  var `icon-halo-blur-transition`: js.UndefOr[Transition] = js.undefined
  var `icon-halo-color`: js.UndefOr[java.lang.String | StyleFunction | Expression] = js.undefined
  var `icon-halo-color-transition`: js.UndefOr[Transition] = js.undefined
  var `icon-halo-width`: js.UndefOr[scala.Double | StyleFunction | Expression] = js.undefined
  var `icon-halo-width-transition`: js.UndefOr[Transition] = js.undefined
  var `icon-opacity`: js.UndefOr[scala.Double | StyleFunction | Expression] = js.undefined
  var `icon-opacity-transition`: js.UndefOr[Transition] = js.undefined
  var `icon-translate`: js.UndefOr[js.Array[scala.Double] | Expression] = js.undefined
  var `icon-translate-anchor`: js.UndefOr[
  ...
  var `text-color`: js.UndefOr[java.lang.String | StyleFunction | Expression] = js.undefined
  var `text-color-transition`: js.UndefOr[Transition] = js.undefined
  var `text-halo-blur`: js.UndefOr[scala.Double | StyleFunction | Expression] = js.undefined
  var `text-halo-blur-transition`: js.UndefOr[Transition] = js.undefined
  var `text-halo-color`: js.UndefOr[java.lang.String | StyleFunction | Expression] = js.undefined
  var `text-halo-color-transition`: js.UndefOr[Transition] = js.undefined
  var `text-halo-width`: js.UndefOr[scala.Double | StyleFunction | Expression] = js.undefined
  var `text-halo-width-transition`: js.UndefOr[Transition] = js.undefined
  var `text-opacity`: js.UndefOr[scala.Double | StyleFunction | Expression] = js.undefined
  var `text-opacity-transition`: js.UndefOr[Transition] = js.undefined
  var `text-translate`: js.UndefOr[js.Array[scala.Double] | Expression] = js.undefined
  var `text-translate-anchor`: js.UndefOr[
    mapboxDashGlLib.mapboxDashGlLibStrings.map | mapboxDashGlLib.mapboxDashGlLibStrings.viewport
  ] = js.undefined
...
object SymbolPaint {
  @scala.inline
  def apply(
    `icon-color`: java.lang.String | StyleFunction | Expression = null,
    `icon-color-transition`: Transition = null,
    `icon-halo-blur`: scala.Double | StyleFunction | Expression = null,
    `icon-halo-blur-transition`: Transition = null,
    `icon-halo-color`: java.lang.String | StyleFunction | Expression = null,
    `icon-halo-color-transition`: Transition = null,
    `icon-halo-width`: scala.Double | StyleFunction | Expression = null,
    `icon-halo-width-transition`: Transition = null,
    `icon-opacity`: scala.Double | StyleFunction | Expression = null,
    `icon-opacity-transition`: Transition = null,
    `icon-translate`: js.Array[scala.Double] | Expression = null,
    `icon-translate-anchor`: mapboxDashGlLib.mapboxDashGlLibStrings.map | mapboxDashGlLib.mapboxDashGlLibStrings.viewport = null,
    `icon-translate-transition`: Transition = null,
    `text-color`: java.lang.String | StyleFunction | Expression = null,
    `text-color-transition`: Transition = null,
    `text-halo-blur`: scala.Double | StyleFunction | Expression = null,
    `text-halo-blur-transition`: Transition = null,
    `text-halo-color`: java.lang.String | StyleFunction | Expression = null,
    `text-halo-color-transition`: Transition = null,
    `text-halo-width`: scala.Double | StyleFunction | Expression = null,
    `text-halo-width-transition`: Transition = null,
    `text-opacity`: scala.Double | StyleFunction | Expression = null,
    `text-opacity-transition`: Transition = null,
    `text-translate`: js.Array[scala.Double] | Expression = null,
    `text-translate-anchor`: mapboxDashGlLib.mapboxDashGlLibStrings.map | mapboxDashGlLib.mapboxDashGlLibStrings.viewport = null,
