...
trait HeatmapPaint extends js.Object {
  var `heatmap-color`: js.UndefOr[java.lang.String | Expression] = js.undefined
  var `heatmap-intensity`: js.UndefOr[scala.Double | Expression] = js.undefined
  var `heatmap-intensity-transition`: js.UndefOr[Transition] = js.undefined
  var `heatmap-opacity`: js.UndefOr[scala.Double | Expression] = js.undefined
  var `heatmap-opacity-transition`: js.UndefOr[Transition] = js.undefined
  var `heatmap-radius`: js.UndefOr[scala.Double | Expression] = js.undefined
