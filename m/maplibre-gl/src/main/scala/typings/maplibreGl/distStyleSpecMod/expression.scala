...
object expression {
  ...
  def StyleExpression: Instantiable2[
    ...
    typings.maplibreGl.distStyleSpecMod.StyleExpression
  ] = js.native
  ...
  def StylePropertyFunction: TypeofStylePropertyFuncti & (Instantiable2[
    ...
    typings.maplibreGl.distStyleSpecMod.StylePropertyFunction[js.Object]
  ]) = js.native
  ...
  def ZoomConstantExpression: Instantiable2[
    ...
    typings.maplibreGl.distStyleSpecMod.ZoomConstantExpression[EvaluationKind]
  ] = js.native
  ...
  def ZoomDependentExpression: Instantiable4[
    ...
    typings.maplibreGl.distStyleSpecMod.ZoomDependentExpression[EvaluationKind]
  ] = js.native
