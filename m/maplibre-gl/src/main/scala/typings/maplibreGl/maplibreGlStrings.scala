...
import typings.maplibreGl.mod.MapSourceDataType
import typings.maplibreGl.mod.OverlapMode
import typings.maplibreGl.mod.PositionAnchor
import typings.maplibreGl.mod.RenderPass
import typings.maplibreGl.mod.ResourceTypeEnum
import typings.maplibreGl.mod.TextAnchor
...
object maplibreGlStrings {
  ...
  @js.native
  sealed trait ACTIVE_ERROR extends StObject
  inline def ACTIVE_ERROR: ACTIVE_ERROR = "ACTIVE_ERROR".asInstanceOf[ACTIVE_ERROR]
  
  @js.native
  sealed trait ACTIVE_LOCK extends StObject
  inline def ACTIVE_LOCK: ACTIVE_LOCK = "ACTIVE_LOCK".asInstanceOf[ACTIVE_LOCK]
  ...
  @js.native
  sealed trait Exclamationmarkhas extends StObject
  inline def Exclamationmarkhas: Exclamationmarkhas = "!has".asInstanceOf[Exclamationmarkhas]
  
  @js.native
  sealed trait Exclamationmarkin extends StObject
  inline def Exclamationmarkin: Exclamationmarkin = "!in".asInstanceOf[Exclamationmarkin]
  
  @js.native
  sealed trait ExpressionSpecification extends StObject
  inline def ExpressionSpecification: ExpressionSpecification = "ExpressionSpecification".asInstanceOf[ExpressionSpecification]
  ...
  inline def Glyphs: Glyphs = "Glyphs".asInstanceOf[Glyphs]
  ...
  sealed trait SpriteImage
    extends StObject
       with ResourceTypeEnum
  inline def SpriteImage: SpriteImage = "SpriteImage".asInstanceOf[SpriteImage]
  
  @js.native
  sealed trait SpriteJSON
    extends StObject
       with ResourceTypeEnum
  inline def SpriteJSON: SpriteJSON = "SpriteJSON".asInstanceOf[SpriteJSON]
  ...
  inline def abs: abs = "abs".asInstanceOf[abs]
  ...
  @js.native
  sealed trait accumulated extends StObject
  inline def accumulated: accumulated = "accumulated".asInstanceOf[accumulated]
  
  @js.native
  sealed trait acos extends StObject
  ...
  @js.native
  sealed trait asin extends StObject
  inline def asin: asin = "asin".asInstanceOf[asin]
  ...
  @js.native
  sealed trait atan extends StObject
  ...
  @js.native
  sealed trait background_ extends StObject
  ...
  @js.native
  sealed trait boxzoomcancel
    extends StObject
       with MapEvent
  inline def boxzoomcancel: boxzoomcancel = "boxzoomcancel".asInstanceOf[boxzoomcancel]
  
  @js.native
  sealed trait boxzoomend
    extends StObject
       with MapEvent
  inline def boxzoomend: boxzoomend = "boxzoomend".asInstanceOf[boxzoomend]
  
  @js.native
  sealed trait boxzoomstart
    extends StObject
       with MapEvent
  inline def boxzoomstart: boxzoomstart = "boxzoomstart".asInstanceOf[boxzoomstart]
  ...
  @js.native
  sealed trait coalesce extends StObject
  inline def coalesce: coalesce = "coalesce".asInstanceOf[coalesce]
  
  @js.native
  sealed trait collator extends StObject
  inline def collator: collator = "collator".asInstanceOf[collator]
  ...
  inline def cos: cos = "cos".asInstanceOf[cos]
  ...
  @js.native
  sealed trait `cubic-bezier` extends StObject
  inline def `cubic-bezier`: `cubic-bezier` = "cubic-bezier".asInstanceOf[`cubic-bezier`]
  ...
  @js.native
  sealed trait dataabort
    extends StObject
       with MapEvent
  inline def dataabort: dataabort = "dataabort".asInstanceOf[dataabort]
  
  @js.native
  sealed trait dataloading
    extends StObject
       with MapEvent
  inline def dataloading: dataloading = "dataloading".asInstanceOf[dataloading]
  ...
  @js.native
  sealed trait downcase extends StObject
  inline def downcase: downcase = "downcase".asInstanceOf[downcase]
  ...
  @js.native
  sealed trait `feature-state` extends StObject
  inline def `feature-state`: `feature-state` = "feature-state".asInstanceOf[`feature-state`]
  
  @js.native
  sealed trait feature_ extends StObject
  inline def feature_ : feature_ = "feature".asInstanceOf[feature_]
  ...
  @js.native
  sealed trait `fill-extrusion` extends StObject
  inline def `fill-extrusion`: `fill-extrusion` = "fill-extrusion".asInstanceOf[`fill-extrusion`]
  ...
  @js.native
  sealed trait formatted extends StObject
  inline def formatted: formatted = "formatted".asInstanceOf[formatted]
  ...
  @js.native
  sealed trait `geometry-type` extends StObject
  inline def `geometry-type`: `geometry-type` = "geometry-type".asInstanceOf[`geometry-type`]
  ...
  @js.native
  sealed trait `heatmap-density` extends StObject
  inline def `heatmap-density`: `heatmap-density` = "heatmap-density".asInstanceOf[`heatmap-density`]
  ...
  @js.native
  sealed trait hillshade extends StObject
  inline def hillshade: hillshade = "hillshade".asInstanceOf[hillshade]
  ...
  @js.native
  sealed trait `index-of` extends StObject
  inline def `index-of`: `index-of` = "index-of".asInstanceOf[`index-of`]
  
  @js.native
  sealed trait intensity extends StObject
  ...
  @js.native
  sealed trait `interpolate-hcl` extends StObject
  inline def `interpolate-hcl`: `interpolate-hcl` = "interpolate-hcl".asInstanceOf[`interpolate-hcl`]
  
  @js.native
  sealed trait `interpolate-lab` extends StObject
  inline def `interpolate-lab`: `interpolate-lab` = "interpolate-lab".asInstanceOf[`interpolate-lab`]
  ...
  @js.native
  sealed trait `is-supported-script` extends StObject
  inline def `is-supported-script`: `is-supported-script` = "is-supported-script".asInstanceOf[`is-supported-script`]
  ...
  @js.native
  sealed trait `line-progress` extends StObject
  inline def `line-progress`: `line-progress` = "line-progress".asInstanceOf[`line-progress`]
  ...
  @js.native
  sealed trait ln extends StObject
  inline def ln: ln = "ln".asInstanceOf[ln]
  
  @js.native
  sealed trait ln2 extends StObject
  inline def ln2: ln2 = "ln2".asInstanceOf[ln2]
  ...
  @js.native
  sealed trait log10 extends StObject
  inline def log10: log10 = "log10".asInstanceOf[log10]
  
  @js.native
  sealed trait log2 extends StObject
  ...
  @js.native
  sealed trait `number-format` extends StObject
  ...
  @js.native
  sealed trait pi extends StObject
  ...
  @js.native
  sealed trait pitchend
    extends StObject
       with MapEvent
  inline def pitchend: pitchend = "pitchend".asInstanceOf[pitchend]
  
  @js.native
  sealed trait pitchstart
    extends StObject
       with MapEvent
  inline def pitchstart: pitchstart = "pitchstart".asInstanceOf[pitchstart]
  ...
  @js.native
  sealed trait `raster-dem` extends StObject
  inline def `raster-dem`: `raster-dem` = "raster-dem".asInstanceOf[`raster-dem`]
  ...
  @js.native
  sealed trait reloading
    extends StObject
       with TileState
  inline def reloading: reloading = "reloading".asInstanceOf[reloading]
  ...
  @js.native
  sealed trait renderFrame extends StObject
  inline def renderFrame: renderFrame = "renderFrame".asInstanceOf[renderFrame]
  ...
  @js.native
  sealed trait `resolved-locale` extends StObject
  inline def `resolved-locale`: `resolved-locale` = "resolved-locale".asInstanceOf[`resolved-locale`]
  
  @js.native
  sealed trait resolvedImage extends StObject
  inline def resolvedImage: resolvedImage = "resolvedImage".asInstanceOf[resolvedImage]
  ...
  @js.native
  sealed trait rgba extends StObject
  ...
  @js.native
  sealed trait rotateend
    extends StObject
       with MapEvent
  inline def rotateend: rotateend = "rotateend".asInstanceOf[rotateend]
  
  @js.native
  sealed trait rotatestart
    extends StObject
       with MapEvent
  inline def rotatestart: rotatestart = "rotatestart".asInstanceOf[rotatestart]
  ...
  sealed trait source_
    extends StObject
       with EvaluationKind
  inline def source_ : source_ = "source".asInstanceOf[source_]
  
  @js.native
  sealed trait sourcedata
    extends StObject
       with MapEvent
  inline def sourcedata: sourcedata = "sourcedata".asInstanceOf[sourcedata]
  
  @js.native
  sealed trait sourcedataabort
    extends StObject
       with MapEvent
  inline def sourcedataabort: sourcedataabort = "sourcedataabort".asInstanceOf[sourcedataabort]
  
  @js.native
  sealed trait sourcedataloading
    extends StObject
       with MapEvent
  inline def sourcedataloading: sourcedataloading = "sourcedataloading".asInstanceOf[sourcedataloading]
  ...
  @js.native
  sealed trait styleDotload
    extends StObject
       with MapEvent
  inline def styleDotload: styleDotload = "style.load".asInstanceOf[styleDotload]
  ...
  @js.native
  sealed trait styledata
    extends StObject
       with MapEvent
  inline def styledata: styledata = "styledata".asInstanceOf[styledata]
  
  @js.native
  sealed trait styledataloading
    extends StObject
       with MapEvent
  inline def styledataloading: styledataloading = "styledataloading".asInstanceOf[styledataloading]
  
  @js.native
  sealed trait styleimagemissing
    extends StObject
       with MapEvent
  inline def styleimagemissing: styleimagemissing = "styleimagemissing".asInstanceOf[styleimagemissing]
  ...
  @js.native
  sealed trait tan extends StObject
  ...
  @js.native
  sealed trait tiledataloading extends StObject
  inline def tiledataloading: tiledataloading = "tiledataloading".asInstanceOf[tiledataloading]
  ...
  @js.native
  sealed trait `to-boolean` extends StObject
  inline def `to-boolean`: `to-boolean` = "to-boolean".asInstanceOf[`to-boolean`]
  
  @js.native
  sealed trait `to-color` extends StObject
  inline def `to-color`: `to-color` = "to-color".asInstanceOf[`to-color`]
  
  @js.native
  sealed trait `to-number` extends StObject
  inline def `to-number`: `to-number` = "to-number".asInstanceOf[`to-number`]
  
  @js.native
  sealed trait `to-rgba` extends StObject
  inline def `to-rgba`: `to-rgba` = "to-rgba".asInstanceOf[`to-rgba`]
  
  @js.native
  sealed trait `to-string` extends StObject
  inline def `to-string`: `to-string` = "to-string".asInstanceOf[`to-string`]
  ...
  @js.native
  sealed trait trackpad extends StObject
  ...
  sealed trait translucent
    extends StObject
       with RenderPass
  inline def translucent: translucent = "translucent".asInstanceOf[translucent]
  ...
  @js.native
  sealed trait upcase extends StObject
  inline def upcase: upcase = "upcase".asInstanceOf[upcase]
  ...
  @js.native
  sealed trait `viewport-glyph` extends StObject
  inline def `viewport-glyph`: `viewport-glyph` = "viewport-glyph".asInstanceOf[`viewport-glyph`]
  
  @js.native
  sealed trait `viewport-y` extends StObject
  inline def `viewport-y`: `viewport-y` = "viewport-y".asInstanceOf[`viewport-y`]
  ...
  @js.native
  sealed trait within extends StObject
