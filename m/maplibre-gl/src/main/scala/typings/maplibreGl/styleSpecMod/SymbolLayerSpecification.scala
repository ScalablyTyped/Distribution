...
import typings.maplibreGl.anon.Iconanchor
import typings.maplibreGl.anon.Iconhaloblur
...
trait SymbolLayerSpecification
  ...
  var layout: js.UndefOr[Iconanchor] = js.undefined
  ...
  var paint: js.UndefOr[Iconhaloblur] = js.undefined
...
object SymbolLayerSpecification {
  ...
  extension [Self <: SymbolLayerSpecification](x: Self) {
    ...
    inline def setLayout(value: Iconanchor): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
    ...
    inline def setPaint(value: Iconhaloblur): Self = StObject.set(x, "paint", value.asInstanceOf[js.Any])
