...
/* Inlined std.Readonly<{  zoom :number,   heatmapDensity :number | undefined,   lineProgress :number | undefined,   isSupportedScript :(_ : string): boolean | undefined,   accumulated :maplibre-gl.maplibre-gl/dist/style-spec.Value | undefined}> */
