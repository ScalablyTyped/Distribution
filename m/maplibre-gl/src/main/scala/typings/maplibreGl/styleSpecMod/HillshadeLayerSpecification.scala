...
import typings.maplibreGl.anon.Hillshadeexaggeration
...
trait HillshadeLayerSpecification
  extends StObject
  ...
  var paint: js.UndefOr[Hillshadeexaggeration] = js.undefined
...
object HillshadeLayerSpecification {
  
  inline def apply(id: String, source: String): HillshadeLayerSpecification = {
  ...
  extension [Self <: HillshadeLayerSpecification](x: Self) {
    ...
    inline def setPaint(value: Hillshadeexaggeration): Self = StObject.set(x, "paint", value.asInstanceOf[js.Any])
