...
import typings.maplibreGl.anon.Heatmapcolor
...
trait HeatmapLayerSpecification
  ...
  var paint: js.UndefOr[Heatmapcolor] = js.undefined
...
object HeatmapLayerSpecification {
  ...
  implicit open class MutableBuilder[Self <: HeatmapLayerSpecification] (val x: Self) extends AnyVal {
    ...
    inline def setPaint(value: Heatmapcolor): Self = StObject.set(x, "paint", value.asInstanceOf[js.Any])
