...
import typings.maplibreGl.anon.Lineblur
import typings.maplibreGl.anon.Linecap
...
trait LineLayerSpecification
  ...
  var layout: js.UndefOr[Linecap] = js.undefined
  ...
  var paint: js.UndefOr[Lineblur] = js.undefined
...
object LineLayerSpecification {
  ...
  implicit open class MutableBuilder[Self <: LineLayerSpecification] (val x: Self) extends AnyVal {
    ...
    inline def setLayout(value: Linecap): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
    ...
    inline def setPaint(value: Lineblur): Self = StObject.set(x, "paint", value.asInstanceOf[js.Any])
