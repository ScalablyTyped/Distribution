...
@JSImport("maplibre-gl", "StructArrayLayout2ub2f12")
@js.native
open class StructArrayLayout2ub2f12 ()
  extends StObject
     with StructArray {
  ...
  def emplace(i: Double, v0: Double, v1: Double, v2: Double, v3: Double): Double = js.native
  /* CompleteClass */
  override def emplace(i: Double, v: Double*): Any = js.native
  
  def emplaceBack(v0: Double, v1: Double, v2: Double, v3: Double): Double = js.native
  /* CompleteClass */
