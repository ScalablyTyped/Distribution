...
@JSImport("maplibre-gl", "StructArrayLayout2ui4")
@js.native
open class StructArrayLayout2ui4 ()
  extends StObject
     with StructArray {
  ...
  def emplace(i: Double, v0: Double, v1: Double): Double = js.native
  /* CompleteClass */
  override def emplace(i: Double, v: Double*): Any = js.native
  
  def emplaceBack(v0: Double, v1: Double): Double = js.native
  /* CompleteClass */
