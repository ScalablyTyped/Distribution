...
@JSImport("maplibre-gl", "StructArrayLayout1ul4")
@js.native
open class StructArrayLayout1ul4 ()
  extends StObject
     with StructArray {
  ...
  def emplace(i: Double, v0: Double): Double = js.native
  /* CompleteClass */
  override def emplace(i: Double, v: Double*): Any = js.native
  
  def emplaceBack(v0: Double): Double = js.native
  /* CompleteClass */
