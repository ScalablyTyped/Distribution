...
import typings.maximMazurokGapiClientGameservices.gapi.client.gameservices.GameServerDeploymentRollout
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: GameServerDeploymentRollout = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(name: String, resource: GameServerDeploymentRollout): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GameServerDeploymentRollout): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
