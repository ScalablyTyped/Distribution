...
object UploadType {
  ...
  inline def apply(name: String, resource: GameServerDeploymentRollout): UploadType = {
  ...
  extension [Self <: UploadType](x: Self) {
    ...
    inline def setResource(value: GameServerDeploymentRollout): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
