...
import typings.maximMazurokGapiClientGameservices.gapi.client.gameservices.GameServerConfig
...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: GameServerConfig): Accesstoken = {
  ...
  extension [Self <: Accesstoken](x: Self) {
    ...
    inline def setResource(value: GameServerConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
