...
import typings.maximMazurokGapiClientGameservices.gapi.client.gameservices.GameServerDeployment
...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: GameServerDeployment = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(name: String, resource: GameServerDeployment): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GameServerDeployment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
