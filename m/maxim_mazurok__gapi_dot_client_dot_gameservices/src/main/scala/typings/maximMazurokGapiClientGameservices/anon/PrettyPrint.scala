...
object PrettyPrint {
  ...
  inline def apply(name: String, resource: GameServerDeployment): PrettyPrint = {
  ...
  extension [Self <: PrettyPrint](x: Self) {
    ...
    inline def setResource(value: GameServerDeployment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
