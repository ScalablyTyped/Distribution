...
@js.native
trait PreviewDeleteGameServerClusterResponse extends js.Object {
...
object PreviewDeleteGameServerClusterResponse {
  ...
  @scala.inline
  implicit class PreviewDeleteGameServerClusterResponseOps[Self <: PreviewDeleteGameServerClusterResponse] (val x: Self) extends AnyVal {
