...
object libUtilPatternInScopeMod {
  ...
  inline def patternInScope(stack: js.Array[ConstructName], pattern: Unsafe): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("patternInScope")(stack.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  /* Inlined mdast-util-to-markdown.mdast-util-to-markdown/lib/types.ConstructName */
