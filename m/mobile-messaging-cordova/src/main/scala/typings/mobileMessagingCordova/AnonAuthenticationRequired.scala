...
object AnonAuthenticationRequired {
  ...
  def apply(
    ...
    if (!js.isUndefined(authenticationRequired)) __obj.updateDynamic("authenticationRequired")(authenticationRequired.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(moRequired)) __obj.updateDynamic("moRequired")(moRequired.asInstanceOf[js.Any])
