...
object Installation {
  ...
  def apply(
    ...
    if (!js.isUndefined(deviceSecure)) __obj.updateDynamic("deviceSecure")(deviceSecure.asInstanceOf[js.Any])
    if (deviceTimezoneId != null) __obj.updateDynamic("deviceTimezoneId")(deviceTimezoneId.asInstanceOf[js.Any])
    if (!js.isUndefined(geoEnabled)) __obj.updateDynamic("geoEnabled")(geoEnabled.asInstanceOf[js.Any])
    if (!js.isUndefined(isPrimaryDevice)) __obj.updateDynamic("isPrimaryDevice")(isPrimaryDevice.asInstanceOf[js.Any])
    if (!js.isUndefined(isPushRegistrationEnabled)) __obj.updateDynamic("isPushRegistrationEnabled")(isPushRegistrationEnabled.asInstanceOf[js.Any])
