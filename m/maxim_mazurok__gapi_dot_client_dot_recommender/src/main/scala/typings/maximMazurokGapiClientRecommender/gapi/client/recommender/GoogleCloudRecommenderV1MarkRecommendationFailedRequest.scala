...
@js.native
trait GoogleCloudRecommenderV1MarkRecommendationFailedRequest extends js.Object {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientRecommender.maximMazurokGapiClientRecommenderStrings.GoogleCloudRecommenderV1MarkRecommendationFailedRequest with TopLevel[js.Any]
  ] = js.native
}
object GoogleCloudRecommenderV1MarkRecommendationFailedRequest {
  ...
  @scala.inline
  implicit class GoogleCloudRecommenderV1MarkRecommendationFailedRequestOps[Self <: GoogleCloudRecommenderV1MarkRecommendationFailedRequest] (val x: Self) extends AnyVal {
