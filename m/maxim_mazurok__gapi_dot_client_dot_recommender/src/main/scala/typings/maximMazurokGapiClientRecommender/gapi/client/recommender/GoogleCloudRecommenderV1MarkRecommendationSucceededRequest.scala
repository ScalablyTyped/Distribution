...
trait GoogleCloudRecommenderV1MarkRecommendationSucceededRequest extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientRecommender.maximMazurokGapiClientRecommenderStrings.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest & TopLevel[Any]
  ] = js.undefined
}
