...
trait Callback extends js.Object {
  ...
  /** Request body */
  var resource: GoogleCloudRecommenderV1MarkInsightAcceptedRequest = js.native
...
object Callback {
  ...
  implicit class CallbackOps[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudRecommenderV1MarkInsightAcceptedRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
