package typings.maximMazurokGapiClientRecommender.anon
...
trait Fields extends js.Object {
  ...
  /** Request body */
  var resource: GoogleCloudRecommenderV1MarkRecommendationClaimedRequest = js.native
...
object Fields {
  ...
  implicit class FieldsOps[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudRecommenderV1MarkRecommendationClaimedRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
