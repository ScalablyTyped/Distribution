...
object TransferJob {
  ...
  implicit class TransferJobOps[Self <: TransferJob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLatestOperationName(value: String): Self = this.set("latestOperationName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLatestOperationName: Self = this.set("latestOperationName", js.undefined)
