...
object RecognitionConfig {
  ...
  implicit class RecognitionConfigOps[Self <: RecognitionConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDiarizationConfig(value: SpeakerDiarizationConfig): Self = this.set("diarizationConfig", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDiarizationConfig: Self = this.set("diarizationConfig", js.undefined)
    ...
    @scala.inline
    def setMetadata(value: RecognitionMetadata): Self = this.set("metadata", value.asInstanceOf[js.Any])
