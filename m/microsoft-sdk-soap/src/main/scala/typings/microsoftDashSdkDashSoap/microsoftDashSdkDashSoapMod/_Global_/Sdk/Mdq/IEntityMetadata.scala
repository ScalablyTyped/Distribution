...
import typings.microsoftDashSdkDashSoap.microsoftDashSdkDashSoapStrings.NoneCharactertabulationOrganizationOwned
import typings.microsoftDashSdkDashSoap.microsoftDashSdkDashSoapStrings.TeamOwnedCharactertabulationUserOwned
