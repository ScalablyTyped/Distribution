...
object OrderType extends js.Object {
  ...
  /* 0 */ val Ascending: typings.microsoftDashSdkDashSoap.microsoftDashSdkDashSoapMod.Global.Sdk.Query.OrderType.Ascending with scala.Double = js.native
  /* 1 */ val Descending: typings.microsoftDashSdkDashSoap.microsoftDashSdkDashSoapMod.Global.Sdk.Query.OrderType.Descending with scala.Double = js.native
  @JSBracketAccess
