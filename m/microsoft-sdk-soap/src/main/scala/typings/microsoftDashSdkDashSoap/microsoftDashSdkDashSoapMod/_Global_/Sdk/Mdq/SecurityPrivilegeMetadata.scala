...
object SecurityPrivilegeMetadata {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(CanBeBasic = CanBeBasic, CanBeDeep = CanBeDeep, CanBeEntityReference = CanBeEntityReference, CanBeGlobal = CanBeGlobal, CanBeLocal = CanBeLocal, CanBeParentEntityReference = CanBeParentEntityReference, ExtensionData = ExtensionData, Name = Name, PrivilegeId = PrivilegeId, PrivilegeType = PrivilegeType.asInstanceOf[js.Any])
