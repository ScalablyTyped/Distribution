...
trait Fields extends js.Object {
  ...
  var levels: js.UndefOr[String | js.Array[String]] = js.native
  
  /** OAuth 2.0 token for the current user. */
  var oauth_token: js.UndefOr[String] = js.native
  
  /** The Open Civic Data division identifier of the division to look up. */
  var ocdId: String = js.native
  ...
  var roles: js.UndefOr[String | js.Array[String]] = js.native
...
object Fields {
  ...
  implicit class FieldsOps[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLevels(value: String | js.Array[String]): Self = this.set("levels", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRoles(value: String | js.Array[String]): Self = this.set("roles", value.asInstanceOf[js.Any])
