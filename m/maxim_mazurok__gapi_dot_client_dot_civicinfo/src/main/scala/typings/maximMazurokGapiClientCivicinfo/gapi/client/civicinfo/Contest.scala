...
object Contest {
  ...
  implicit class ContestOps[Self <: Contest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrimaryPartiesVarargs(value: String*): Self = this.set("primaryParties", js.Array(value :_*))
    
    @scala.inline
    def setPrimaryParties(value: js.Array[String]): Self = this.set("primaryParties", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePrimaryParties: Self = this.set("primaryParties", js.undefined)
