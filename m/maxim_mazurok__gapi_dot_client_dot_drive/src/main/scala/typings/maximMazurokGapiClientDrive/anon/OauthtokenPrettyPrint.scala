...
trait OauthtokenPrettyPrint extends js.Object {
  ...
  /** Request body */
  var resource: Revision = js.native
...
object OauthtokenPrettyPrint {
  ...
  @scala.inline
  def apply(fileId: String, resource: Revision, revisionId: String): OauthtokenPrettyPrint = {
  ...
  implicit class OauthtokenPrettyPrintOps[Self <: OauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Revision): Self = this.set("resource", value.asInstanceOf[js.Any])
