...
trait TeamDriveId extends StObject {
...
object TeamDriveId {
  ...
  inline def apply(teamDriveId: String): TeamDriveId = {
    val __obj = js.Dynamic.literal(teamDriveId = teamDriveId.asInstanceOf[js.Any])
    __obj.asInstanceOf[TeamDriveId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TeamDriveId] (val x: Self) extends AnyVal {
