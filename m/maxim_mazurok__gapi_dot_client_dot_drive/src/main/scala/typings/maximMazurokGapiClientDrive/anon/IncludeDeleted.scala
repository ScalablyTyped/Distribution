...
@js.native
trait IncludeDeleted extends StObject {
...
object IncludeDeleted {
  ...
  @scala.inline
  def apply(commentId: String, fileId: String): IncludeDeleted = {
  ...
  @scala.inline
  implicit class IncludeDeletedMutableBuilder[Self <: IncludeDeleted] (val x: Self) extends AnyVal {
