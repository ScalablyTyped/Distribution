...
object CommentIdFields {
  ...
  inline def apply(commentId: String, fileId: String, replyId: String): CommentIdFields = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentIdFields] (val x: Self) extends AnyVal {
