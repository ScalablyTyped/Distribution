...
@js.native
trait ReplyId extends StObject {
...
object ReplyId {
  ...
  @scala.inline
  def apply(commentId: String, fileId: String, replyId: String): ReplyId = {
    ...
    __obj.asInstanceOf[ReplyId]
  }
  
  @scala.inline
  implicit class ReplyIdMutableBuilder[Self <: ReplyId] (val x: Self) extends AnyVal {
