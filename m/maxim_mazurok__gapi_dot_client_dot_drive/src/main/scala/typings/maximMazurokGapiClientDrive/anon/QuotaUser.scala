...
import typings.maximMazurokGapiClientDrive.gapi.client.drive.Drive
...
object QuotaUser {
  ...
  @scala.inline
  def apply(requestId: String, resource: Drive): QuotaUser = {
    val __obj = js.Dynamic.literal(requestId = requestId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Drive): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
