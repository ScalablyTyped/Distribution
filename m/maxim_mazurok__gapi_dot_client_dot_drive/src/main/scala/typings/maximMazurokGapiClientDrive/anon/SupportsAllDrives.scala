...
@js.native
trait SupportsAllDrives extends StObject {
...
object SupportsAllDrives {
  
  @scala.inline
  def apply(fileId: String): SupportsAllDrives = {
    val __obj = js.Dynamic.literal(fileId = fileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[SupportsAllDrives]
  }
  
  @scala.inline
  implicit class SupportsAllDrivesMutableBuilder[Self <: SupportsAllDrives] (val x: Self) extends AnyVal {
