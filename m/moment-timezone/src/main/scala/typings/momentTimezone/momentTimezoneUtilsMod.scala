...
object momentTimezoneUtilsMod {
  ...
  object momentAugmentingMod {
    ...
    object PackedZoneBundle {
      ...
      inline def apply(links: js.Array[String], version: String, zones: js.Array[String]): PackedZoneBundle = {
    ...
    trait UnpackedZone extends StObject {
      ...
      var untils: js.Array[Double | Null]
    }
    object UnpackedZone {
      
      inline def apply(abbrs: js.Array[String], name: String, offsets: js.Array[Double], untils: js.Array[Double | Null]): UnpackedZone = {
    ...
    trait UnpackedZoneBundle extends StObject {
      ...
      var zones: js.Array[UnpackedZone]
    }
    object UnpackedZoneBundle {
      
      inline def apply(links: js.Array[String], version: String, zones: js.Array[UnpackedZone]): UnpackedZoneBundle = {
        val __obj = js.Dynamic.literal(links = links.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any], zones = zones.asInstanceOf[js.Any])
