...
@js.native
trait UnpackedZoneBundle extends js.Object {
...
object UnpackedZoneBundle {
  ...
  @scala.inline
  implicit class UnpackedZoneBundleOps[Self <: UnpackedZoneBundle] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setZonesVarargs(value: UnpackedZone*): Self = this.set("zones", js.Array(value :_*))
    @scala.inline
    def setZones(value: js.Array[UnpackedZone]): Self = this.set("zones", value.asInstanceOf[js.Any])
  }
