...
trait MomentTimezone extends js.Object {
  ...
  def apply(date: java.lang.String, timezone: java.lang.String): momentLib.momentMod.Moment = js.native
  def apply(date: js.Any, timezone: java.lang.String): momentLib.momentMod.Moment = js.native
  def apply(date: js.Array[scala.Double], timezone: java.lang.String): momentLib.momentMod.Moment = js.native
  def apply(date: momentLib.momentMod.Moment, timezone: java.lang.String): momentLib.momentMod.Moment = js.native
  def apply(date: scala.Double, timezone: java.lang.String): momentLib.momentMod.Moment = js.native
  def apply(date: stdLib.Date, timezone: java.lang.String): momentLib.momentMod.Moment = js.native
  def apply(timezone: java.lang.String): momentLib.momentMod.Moment = js.native
