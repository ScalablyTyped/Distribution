...
object mod extends Shortcut {
  ...
  @js.native
  class ^ protected ()
    extends typings.mocBetterSqlite3.mod.MocBetterSqlite3.Database {
  ...
  object MocBetterSqlite3 {
    ...
    object ColumnDefinition {
      ...
      @scala.inline
      def apply(name: String): typings.mocBetterSqlite3.mod.MocBetterSqlite3.ColumnDefinition = {
        val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.mocBetterSqlite3.mod.MocBetterSqlite3.ColumnDefinition]
      }
      
      @scala.inline
      implicit class ColumnDefinitionMutableBuilder[Self <: typings.mocBetterSqlite3.mod.MocBetterSqlite3.ColumnDefinition] (val x: Self) extends AnyVal {
    ...
    trait Database extends StObject {
      ...
      def prepare[BindParameters /* <: js.Array[_] | js.Object */](source: String): typings.mocBetterSqlite3.mod.MocBetterSqlite3.Statement[js.Array[BindParameters] | BindParameters] = js.native
    ...
    trait DatabaseConstructor
      extends Instantiable1[/* filename */ String, typings.mocBetterSqlite3.mod.MocBetterSqlite3.Database]
         with Instantiable2[
              /* filename */ String, 
              /* options */ Options, 
