...
object StepId {
  ...
  @scala.inline
  def apply(executionId: String, historyId: String, projectId: String, stepId: String): StepId = {
  ...
  @scala.inline
  implicit class StepIdMutableBuilder[Self <: StepId] (val x: Self) extends AnyVal {
