package typings.maximMazurokGapiClientToolresults.anon

import typings.maximMazurokGapiClientToolresults.gapi.client.toolresults.PublishXunitXmlFilesRequest
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: PublishXunitXmlFilesRequest = js.native
...
object UploadType {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(executionId = executionId.asInstanceOf[js.Any], historyId = historyId.asInstanceOf[js.Any], projectId = projectId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], stepId = stepId.asInstanceOf[js.Any])
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PublishXunitXmlFilesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
