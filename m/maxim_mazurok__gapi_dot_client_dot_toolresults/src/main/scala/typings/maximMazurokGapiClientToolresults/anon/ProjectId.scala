...
object ProjectId {
  ...
  inline def apply(executionId: String, historyId: String, projectId: String, stepId: String, testCaseId: String): ProjectId = {
    val __obj = js.Dynamic.literal(executionId = executionId.asInstanceOf[js.Any], historyId = historyId.asInstanceOf[js.Any], projectId = projectId.asInstanceOf[js.Any], stepId = stepId.asInstanceOf[js.Any], testCaseId = testCaseId.asInstanceOf[js.Any])
