...
import typings.matrixBotSdk.cryptoMod.EncryptionAlgorithm.MegolmV1AesSha2
import typings.matrixBotSdk.cryptoMod.EncryptionAlgorithm.OlmV1Curve25519AesSha2
import typings.matrixBotSdk.cryptoMod.OTKAlgorithm.Signed
import typings.matrixBotSdk.cryptoMod.OTKAlgorithm.Unsigned
...
object cryptoMod {
  ...
  type OTKCounts = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ alg in matrix-bot-sdk.matrix-bot-sdk/lib/models/Crypto.OTKAlgorithm ]:? number}
    */ typings.matrixBotSdk.matrixBotSdkStrings.OTKCounts & TopLevel[Any]
