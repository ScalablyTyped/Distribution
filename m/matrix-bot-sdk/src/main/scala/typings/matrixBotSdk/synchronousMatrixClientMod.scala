...
object synchronousMatrixClientMod {
  
  @JSImport("matrix-bot-sdk/lib/SynchronousMatrixClient", "SynchronousMatrixClient")
  @js.native
  abstract class SynchronousMatrixClient protected () extends MatrixClient {
    /**
