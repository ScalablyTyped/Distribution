...
@js.native
trait MailPhishing extends js.Object {
...
object MailPhishing {
  ...
  @scala.inline
  implicit class MailPhishingOps[Self <: MailPhishing] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSystemActionType(value: String): Self = this.set("systemActionType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSystemActionType: Self = this.set("systemActionType", js.undefined)
  }
}
