...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: Session = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(resource: Session, sessionId: String, userId: String): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Session): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
