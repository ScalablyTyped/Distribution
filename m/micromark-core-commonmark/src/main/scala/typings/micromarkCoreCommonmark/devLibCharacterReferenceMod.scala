...
object devLibCharacterReferenceMod {
  
  @JSImport("micromark-core-commonmark/dev/lib/character-reference", "characterReference")
  @js.native
  val characterReference: Construct = js.native
