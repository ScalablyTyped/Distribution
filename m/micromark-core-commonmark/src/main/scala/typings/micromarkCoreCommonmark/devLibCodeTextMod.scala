...
object devLibCodeTextMod {
  
  @JSImport("micromark-core-commonmark/dev/lib/code-text", "codeText")
  @js.native
  val codeText: Construct = js.native
  
  type Construct = typings.micromarkUtilTypes.mod.Construct
  
  type Previous = typings.micromarkUtilTypes.mod.Previous
