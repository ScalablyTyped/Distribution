...
object ^ extends js.Object {
  ...
  def preciseDiff(
    d1: typings.momentDashPreciseDashRangeDashPlugin.momentDashPreciseDashRangeDashPluginMod.momentMod.Moment,
    d2: typings.momentDashPreciseDashRangeDashPlugin.momentDashPreciseDashRangeDashPluginMod.momentMod.Moment
  ): String = js.native
  @JSName("preciseDiff")
