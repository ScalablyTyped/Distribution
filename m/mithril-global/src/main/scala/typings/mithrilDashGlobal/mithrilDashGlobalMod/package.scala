...
package object mithrilDashGlobalMod {
  ...
  type Child = typings.mithril.mithrilMod.Child
  type ChildArray = typings.mithril.mithrilMod.ChildArray
  ...
  type Lifecycle[A, S] = typings.mithril.mithrilMod.Lifecycle[A, S]
  type RequestOptions[T] = typings.mithril.mithrilMod.RequestOptions[T]
