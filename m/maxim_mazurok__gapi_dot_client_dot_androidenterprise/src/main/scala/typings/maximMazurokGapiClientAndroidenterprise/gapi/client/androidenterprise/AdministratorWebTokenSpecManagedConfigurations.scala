...
@js.native
trait AdministratorWebTokenSpecManagedConfigurations extends js.Object {
...
object AdministratorWebTokenSpecManagedConfigurations {
  ...
  @scala.inline
  implicit class AdministratorWebTokenSpecManagedConfigurationsOps[Self <: AdministratorWebTokenSpecManagedConfigurations] (val x: Self) extends AnyVal {
