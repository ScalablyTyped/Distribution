...
object ManagedConfigurationForDeviceId {
  ...
  inline def apply(deviceId: String, enterpriseId: String, managedConfigurationForDeviceId: String, userId: String): ManagedConfigurationForDeviceId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ManagedConfigurationForDeviceId] (val x: Self) extends AnyVal {
