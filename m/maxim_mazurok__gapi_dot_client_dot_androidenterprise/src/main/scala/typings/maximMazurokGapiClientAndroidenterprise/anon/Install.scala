...
import typings.maximMazurokGapiClientAndroidenterprise.gapi.client.androidenterprise.Entitlement
...
trait Install extends StObject {
  ...
  /** Request body */
  var resource: Entitlement = js.native
...
object Install {
  ...
  @scala.inline
  def apply(enterpriseId: String, entitlementId: String, resource: Entitlement, userId: String): Install = {
    val __obj = js.Dynamic.literal(enterpriseId = enterpriseId.asInstanceOf[js.Any], entitlementId = entitlementId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], userId = userId.asInstanceOf[js.Any])
  ...
  implicit class InstallMutableBuilder[Self <: Install] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Entitlement): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
