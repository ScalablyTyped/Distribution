...
object Install {
  ...
  inline def apply(enterpriseId: String, entitlementId: String, resource: Entitlement, userId: String): Install = {
  ...
  extension [Self <: Install](x: Self) {
    ...
    inline def setResource(value: Entitlement): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
