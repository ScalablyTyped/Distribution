...
@js.native
trait EntitlementId extends StObject {
  ...
  var entitlementId: String = js.native
...
object EntitlementId {
  ...
  @scala.inline
  def apply(enterpriseId: String, entitlementId: String, userId: String): EntitlementId = {
    ...
    __obj.asInstanceOf[EntitlementId]
  }
  
  @scala.inline
  implicit class EntitlementIdMutableBuilder[Self <: EntitlementId] (val x: Self) extends AnyVal {
