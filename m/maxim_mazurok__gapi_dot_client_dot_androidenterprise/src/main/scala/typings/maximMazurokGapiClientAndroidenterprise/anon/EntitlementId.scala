...
object EntitlementId {
  ...
  inline def apply(enterpriseId: String, entitlementId: String, userId: String): EntitlementId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EntitlementId] (val x: Self) extends AnyVal {
