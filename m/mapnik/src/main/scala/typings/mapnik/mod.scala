...
object mod extends js.Object {
  ...
  class VectorTile protected () extends js.Object {
    ...
    def addImageSync(image: Image, name: String, options: AnonImageformatImagescaling): Unit = js.native
    ...
    def composite(vectorTiles: js.Array[VectorTile], options: AnonAreathresholdCallback): Unit = js.native
    def compositeSync(vectorTiles: js.Array[VectorTile]): Unit = js.native
    def compositeSync(vectorTiles: js.Array[VectorTile], options: AnonAreathresholdFilltype): Unit = js.native
