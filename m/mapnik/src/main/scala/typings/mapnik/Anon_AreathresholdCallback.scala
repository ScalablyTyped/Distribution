...
object Anon_AreathresholdCallback {
  ...
  def apply(
    ...
    if (max_extent != null) __obj.updateDynamic("max_extent")(max_extent)
    ...
    if (!js.isUndefined(reencode)) __obj.updateDynamic("reencode")(reencode)
    ...
    if (scaling_method != null) __obj.updateDynamic("scaling_method")(scaling_method)
    ...
    if (threading_mode != null) __obj.updateDynamic("threading_mode")(threading_mode)
