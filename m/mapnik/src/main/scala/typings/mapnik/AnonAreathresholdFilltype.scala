...
trait AnonAreathresholdFilltype extends js.Object {
...
object AnonAreathresholdFilltype {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAreathresholdFilltype]
  }
}
