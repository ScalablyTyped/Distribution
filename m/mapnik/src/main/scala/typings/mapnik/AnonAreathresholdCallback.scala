...
trait AnonAreathresholdCallback extends js.Object {
...
object AnonAreathresholdCallback {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAreathresholdCallback]
  }
}
