...
trait Anon_AreathresholdFilltype extends js.Object {
...
object Anon_AreathresholdFilltype {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AreathresholdFilltype]
  }
}
