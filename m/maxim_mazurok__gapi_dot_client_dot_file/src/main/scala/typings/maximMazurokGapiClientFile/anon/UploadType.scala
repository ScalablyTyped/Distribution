package typings.maximMazurokGapiClientFile.anon
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: RestoreInstanceRequest
...
object UploadType {
  ...
  inline def apply(name: String, resource: RestoreInstanceRequest): UploadType = {
  ...
  implicit open class MutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: RestoreInstanceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
