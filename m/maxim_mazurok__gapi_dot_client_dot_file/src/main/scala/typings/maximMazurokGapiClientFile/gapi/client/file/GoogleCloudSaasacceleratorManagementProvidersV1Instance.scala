...
trait GoogleCloudSaasacceleratorManagementProvidersV1Instance extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientFile.maximMazurokGapiClientFileStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance & TopLevel[Any]
  ] = js.undefined
  ...
  var notificationParameters: js.UndefOr[
    /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in string ]: @maxim_mazurok/gapi.client.file.gapi.client.file.GoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter}
    */ typings.maximMazurokGapiClientFile.maximMazurokGapiClientFileStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance & TopLevel[Any]
  ] = js.undefined
