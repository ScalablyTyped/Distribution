...
trait GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings extends StObject {
  ...
  var maintenancePolicies: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.file.gapi.client.file.MaintenancePolicy} */ js.Any
  ] = js.undefined
}
object GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings {
  ...
  implicit open class MutableBuilder[Self <: GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings] (val x: Self) extends AnyVal {
    ...
    inline def setMaintenancePolicies(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.file.gapi.client.file.MaintenancePolicy} */ js.Any
