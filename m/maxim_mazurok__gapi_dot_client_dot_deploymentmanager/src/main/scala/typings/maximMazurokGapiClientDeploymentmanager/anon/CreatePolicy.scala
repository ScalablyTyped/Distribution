...
object CreatePolicy {
  ...
  implicit class CreatePolicyOps[Self <: CreatePolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientDeploymentmanager.gapi.client.deploymentmanager.Deployment): Self = this.set("resource", value.asInstanceOf[js.Any])
