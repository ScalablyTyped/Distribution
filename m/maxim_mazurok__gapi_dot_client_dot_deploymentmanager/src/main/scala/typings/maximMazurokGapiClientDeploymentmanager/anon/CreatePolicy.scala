...
trait CreatePolicy extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientDeploymentmanager.gapi.client.deploymentmanager.Deployment = js.native
...
object CreatePolicy {
  ...
  @scala.inline
  implicit class CreatePolicyMutableBuilder[Self <: CreatePolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientDeploymentmanager.gapi.client.deploymentmanager.Deployment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
