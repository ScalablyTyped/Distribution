...
object Connection {
  ...
  inline def apply(
    ...
    getPublicKey: (String, js.Function2[/* err */ js.Error, /* publicKey */ Any, Unit]) => Unit,
    ...
    resetToken: (Any, js.Function1[/* result */ Any, Unit]) => Unit,
  ...
  implicit open class MutableBuilder[Self <: Connection] (val x: Self) extends AnyVal {
    ...
    inline def setGetPublicKey(value: (String, js.Function2[/* err */ js.Error, /* publicKey */ Any, Unit]) => Unit): Self = StObject.set(x, "getPublicKey", js.Any.fromFunction2(value))
    ...
    inline def setResetToken(value: (Any, js.Function1[/* result */ Any, Unit]) => Unit): Self = StObject.set(x, "resetToken", js.Any.fromFunction2(value))
