...
object mod {
  ...
  inline def group(groupTitle: String, optionalParams: Any*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("group")(scala.List(groupTitle.asInstanceOf[js.Any]).`++`(optionalParams.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Unit]
  inline def group(groupTitle: Unit, optionalParams: Any*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("group")(scala.List(groupTitle.asInstanceOf[js.Any]).`++`(optionalParams.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Unit]
  
  inline def groupCollapsed(groupTitle: String, optionalParams: Any*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("groupCollapsed")(scala.List(groupTitle.asInstanceOf[js.Any]).`++`(optionalParams.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Unit]
  inline def groupCollapsed(groupTitle: Unit, optionalParams: Any*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("groupCollapsed")(scala.List(groupTitle.asInstanceOf[js.Any]).`++`(optionalParams.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Unit]
