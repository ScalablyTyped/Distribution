...
trait ArrayConstructor extends js.Object {
  ...
  /**
      ...
      *
      */
  def add[T](array: js.Array[T], element: T): scala.Unit = js.native
  /**
      * Copies all the elements of the specified array to the end of an Array object.
      */
  def addRange[T](array: js.Array[T], items: js.Array[T]): scala.Unit = js.native
  /**
      * Removes all elements from an Array object.
      */
  def clear[T](array: js.Array[T]): scala.Unit = js.native
  /**
  ...
  /**
      ...
      */
  def contains[T](array: js.Array[T], element: T): scala.Boolean = js.native
  /**
  ...
  /**
      ...
      */
  def enqueue[T](array: js.Array[T], element: T): scala.Unit = js.native
  /**
      * Performs a specified action on each element of an Array object.
      */
  def forEach[T](
    array: js.Array[T],
    method: js.Function3[/* element */ T, /* index */ scala.Double, /* array */ js.Array[T], scala.Unit],
    instance: js.Any
  ): scala.Unit = js.native
  /**
      * Searches for the specified element of an Array object and returns its index.
      */
  def indexOf[T](array: js.Array[T], item: T): scala.Double = js.native
  /**
      * Searches for the specified element of an Array object and returns its index.
      */
  def indexOf[T](array: js.Array[T], item: T, startIndex: scala.Double): scala.Double = js.native
  /**
      * Inserts a value at the specified location in an Array object.
      */
  def insert[T](array: js.Array[T], index: scala.Double, item: T): scala.Unit = js.native
  /**
  ...
  /**
      ...
      */
  def remove[T](array: js.Array[T], item: T): scala.Boolean = js.native
  /**
      * Removes an element at the specified location in an Array object.
      */
  def removeAt[T](array: js.Array[T], index: scala.Double): scala.Unit = js.native
}
