...
object ProfileService extends js.Object {
  ...
  /**
    ...
    */
  def set_defaultLoadCompletedCallback(value: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def set_defaultSaveCompletedCallback(value: java.lang.String): scala.Unit = js.native
  /**
    * Gets or sets the profile service path.
    * @param value
