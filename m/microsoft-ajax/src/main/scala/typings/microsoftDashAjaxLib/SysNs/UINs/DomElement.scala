...
trait DomElement extends js.Object {
  ...
  /**
    ...
    */
  def containsCssClass(element: stdLib.HTMLElement, className: java.lang.String): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getElementById(id: java.lang.String): stdLib.HTMLElement = js.native
  def getElementById(id: java.lang.String, element: js.Any): js.Any = js.native
  def getElementById(id: java.lang.String, element: stdLib.HTMLElement): stdLib.HTMLElement = js.native
  /**
    ...
    */
  def getLocation(element: stdLib.HTMLElement): Point = js.native
  /*
    ...
    */
  def getVisibilityMode(element: stdLib.HTMLElement): VisibilityMode = js.native
  /**
    ...
    */
  def getVisible(element: js.Any): scala.Boolean = js.native
  /**
    ...
    */
  def isDomElement(obj: js.Any): scala.Boolean = js.native
  /**
    ...
    *      The event arguments
    */
  def raiseBubbleEvent(source: stdLib.HTMLElement, args: microsoftDashAjaxLib.SysNs.EventArgs): scala.Unit = js.native
  def removeCssClass(element: js.Any, className: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    *      A DOM element.
    */
  def resolveElement(elementOrElementId: java.lang.String): stdLib.HTMLElement = js.native
  def resolveElement(elementOrElementId: java.lang.String, containerElement: stdLib.HTMLElement): stdLib.HTMLElement = js.native
  def resolveElement(elementOrElementId: stdLib.HTMLElement): stdLib.HTMLElement = js.native
  def resolveElement(elementOrElementId: stdLib.HTMLElement, containerElement: stdLib.HTMLElement): stdLib.HTMLElement = js.native
  /**
    ...
    */
  def setLocation(element: stdLib.HTMLElement, x: scala.Double, y: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def setVisibilityMode(element: stdLib.HTMLElement, value: VisibilityMode): scala.Unit = js.native
  /**
    ...
    */
  def setVisible(element: stdLib.HTMLElement, value: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def toggleCssClass(element: stdLib.HTMLElement, className: java.lang.String): scala.Unit = js.native
}
