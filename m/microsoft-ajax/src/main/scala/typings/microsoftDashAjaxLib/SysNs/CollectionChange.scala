...
class CollectionChange protected () extends js.Object {
  ...
  /**
    ...
    */
  def this(action: NotifyCollectionChangedAction, newItems: js.Array[_], newStartingIndex: scala.Double, oldItems: js.Array[_], oldStartingIndex: scala.Double) = this()
  //#endregion
  //#region Fields
  /**
