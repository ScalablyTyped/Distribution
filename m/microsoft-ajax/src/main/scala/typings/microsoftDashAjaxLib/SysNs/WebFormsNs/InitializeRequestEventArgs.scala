...
class InitializeRequestEventArgs protected ()
  ...
  /**
              ...
              */
  def this(request: microsoftDashAjaxLib.SysNs.NetNs.WebRequest, postBackElement: js.Any, updatePanelsToUpdate: js.Array[java.lang.String]) = this()
  //#endregion
  //#region Properties
  /**
              ...
              */
  def get_postBackElement(): stdLib.HTMLElement = js.native
  /**
              ...
              */
  def get_request(): microsoftDashAjaxLib.SysNs.NetNs.WebRequestExecutor = js.native
  /**
