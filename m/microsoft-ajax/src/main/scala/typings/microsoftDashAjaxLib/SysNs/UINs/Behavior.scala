...
object Behavior extends js.Object {
  ...
  /**
    ...
    */
  def getBehaviorByName(element: stdLib.HTMLElement, name: java.lang.String): microsoftDashAjaxLib.SysNs.UINs.Behavior = js.native
  /**
    ...
    */
  def getBehaviors(element: microsoftDashAjaxLib.SysNs.UINs.DomElement): js.Array[microsoftDashAjaxLib.SysNs.UINs.Behavior] = js.native
  /**
    ...
    */
  def getBehaviorsByType(element: stdLib.HTMLElement, `type`: microsoftDashAjaxLib.SysNs.UINs.Behavior): js.Array[microsoftDashAjaxLib.SysNs.UINs.Behavior] = js.native
}
