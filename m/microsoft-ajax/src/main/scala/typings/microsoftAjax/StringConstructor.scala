...
trait StringConstructor extends StObject {
  ...
  */
  def format(format: java.lang.String, args: Any*): java.lang.String
  ...
  /**
    ...
    * @returns A copy of the string with the formatting applied.
    */
  def localeFormat(format: java.lang.String, args: Any*): java.lang.String
}
object StringConstructor {
  
  inline def apply(
    format: (java.lang.String, /* repeated */ Any) => java.lang.String,
    localeFormat: (java.lang.String, /* repeated */ Any) => java.lang.String
  ): StringConstructor = {
  ...
  extension [Self <: StringConstructor](x: Self) {
    ...
    inline def setLocaleFormat(value: (java.lang.String, /* repeated */ Any) => java.lang.String): Self = StObject.set(x, "localeFormat", js.Any.fromFunction2(value))
  }
}
