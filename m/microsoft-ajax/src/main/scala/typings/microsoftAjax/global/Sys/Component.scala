...
object Component {
  ...
  inline def create(`type`: Type, properties: js.Any): typings.microsoftAjax.Sys.Component = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[typings.microsoftAjax.Sys.Component]
  inline def create(`type`: Type, properties: js.Any, events: js.Any): typings.microsoftAjax.Sys.Component = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[typings.microsoftAjax.Sys.Component]
  ...
  inline def create(`type`: Type, properties: Unit, events: js.Any): typings.microsoftAjax.Sys.Component = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[typings.microsoftAjax.Sys.Component]
