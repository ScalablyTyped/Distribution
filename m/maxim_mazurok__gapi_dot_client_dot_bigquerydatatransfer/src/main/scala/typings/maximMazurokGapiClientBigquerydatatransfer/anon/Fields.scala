...
trait Fields extends StObject {
  ...
  var messageTypes: js.UndefOr[String | js.Array[String]] = js.native
...
object Fields {
  ...
  implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessageTypes(value: String | js.Array[String]): Self = StObject.set(x, "messageTypes", value.asInstanceOf[js.Any])
