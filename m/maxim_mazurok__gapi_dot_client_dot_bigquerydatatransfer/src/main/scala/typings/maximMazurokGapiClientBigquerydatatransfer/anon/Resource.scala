...
import typings.maximMazurokGapiClientBigquerydatatransfer.gapi.client.bigquerydatatransfer.StartManualTransferRunsRequest
...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: StartManualTransferRunsRequest = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(parent: String, resource: StartManualTransferRunsRequest): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: StartManualTransferRunsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
