...
trait DataSourceIds extends StObject {
  ...
  var dataSourceIds: js.UndefOr[String | js.Array[String]] = js.undefined
...
object DataSourceIds {
  ...
  inline def apply(parent: String): DataSourceIds = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[DataSourceIds]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DataSourceIds] (val x: Self) extends AnyVal {
    ...
    inline def setDataSourceIds(value: String | js.Array[String]): Self = StObject.set(x, "dataSourceIds", value.asInstanceOf[js.Any])
