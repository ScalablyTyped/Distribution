...
trait CopyOptions extends js.Object {
  var globOptions: js.UndefOr[globLib.globMod.IOptions] = js.undefined
  var process: js.UndefOr[ProcessingFunc] = js.undefined
}

object CopyOptions {
  @scala.inline
  def apply(globOptions: globLib.globMod.IOptions = null, process: ProcessingFunc = null): CopyOptions = {
