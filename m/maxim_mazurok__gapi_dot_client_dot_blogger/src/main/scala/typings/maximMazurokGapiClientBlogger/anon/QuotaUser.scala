...
trait QuotaUser extends StObject {
  ...
  var range: js.UndefOr[String | js.Array[String]] = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(blogId: String): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRange(value: String | js.Array[String]): Self = StObject.set(x, "range", value.asInstanceOf[js.Any])
