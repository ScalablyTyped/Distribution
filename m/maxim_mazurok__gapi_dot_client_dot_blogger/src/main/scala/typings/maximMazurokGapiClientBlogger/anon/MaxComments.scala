...
trait MaxComments extends StObject {
...
object MaxComments {
  ...
  inline def apply(blogId: String, path: String): MaxComments = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MaxComments] (val x: Self) extends AnyVal {
