...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: RevokeCertificateRequest = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(name: String, resource: RevokeCertificateRequest): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RevokeCertificateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
