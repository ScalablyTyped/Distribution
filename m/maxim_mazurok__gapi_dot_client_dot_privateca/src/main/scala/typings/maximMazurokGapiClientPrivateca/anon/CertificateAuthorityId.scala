...
object CertificateAuthorityId {
  ...
  inline def apply(parent: String, resource: CertificateAuthority): CertificateAuthorityId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CertificateAuthorityId] (val x: Self) extends AnyVal {
