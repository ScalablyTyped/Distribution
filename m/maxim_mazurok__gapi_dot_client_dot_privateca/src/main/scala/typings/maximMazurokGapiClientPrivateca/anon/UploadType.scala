...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: EnableCertificateAuthorityRequest = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(name: String, resource: EnableCertificateAuthorityRequest): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: EnableCertificateAuthorityRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
