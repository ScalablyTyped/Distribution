...
object CaPoolId {
  ...
  inline def apply(parent: String, resource: typings.maximMazurokGapiClientPrivateca.gapi.client.privateca.CaPool): CaPoolId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CaPoolId] (val x: Self) extends AnyVal {
