...
trait AltCallback extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientPrivateca.gapi.client.privateca.CaPool
...
object AltCallback {
  ...
  inline def apply(name: String, resource: typings.maximMazurokGapiClientPrivateca.gapi.client.privateca.CaPool): AltCallback = {
  ...
  implicit open class MutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientPrivateca.gapi.client.privateca.CaPool): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
