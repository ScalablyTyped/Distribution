...
trait CertificateTemplateId extends StObject {
...
object CertificateTemplateId {
  ...
  inline def apply(parent: String, resource: CertificateTemplate): CertificateTemplateId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CertificateTemplateId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CertificateTemplateId] (val x: Self) extends AnyVal {
