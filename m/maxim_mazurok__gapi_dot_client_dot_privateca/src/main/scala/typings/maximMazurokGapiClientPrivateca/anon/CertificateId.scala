...
@js.native
trait CertificateId extends js.Object {
...
object CertificateId {
  ...
  @scala.inline
  implicit class CertificateIdOps[Self <: CertificateId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Certificate): Self = this.set("resource", value.asInstanceOf[js.Any])
