...
@js.native
trait CertificateId extends StObject {
  ...
  /** Request body */
  var resource: Certificate = js.native
...
object CertificateId {
  ...
  @scala.inline
  def apply(parent: String, resource: Certificate): CertificateId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CertificateId]
  }
  
  @scala.inline
  implicit class CertificateIdMutableBuilder[Self <: CertificateId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Certificate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
