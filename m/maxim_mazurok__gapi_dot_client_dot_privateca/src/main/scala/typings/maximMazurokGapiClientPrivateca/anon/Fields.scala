...
trait Fields extends StObject {
  ...
  /** Request body */
  var resource: CertificateRevocationList = js.native
...
object Fields {
  ...
  @scala.inline
  def apply(name: String, resource: CertificateRevocationList): Fields = {
  ...
  implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CertificateRevocationList): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
