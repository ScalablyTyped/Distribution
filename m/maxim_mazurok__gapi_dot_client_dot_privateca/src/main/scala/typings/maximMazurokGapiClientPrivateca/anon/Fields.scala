...
import typings.maximMazurokGapiClientPrivateca.gapi.client.privateca.CertificateRevocationList
...
trait Fields extends StObject {
  ...
  /** Request body */
  var resource: CertificateRevocationList
...
object Fields {
  ...
  inline def apply(name: String, resource: CertificateRevocationList): Fields = {
  ...
  extension [Self <: Fields](x: Self) {
    ...
    inline def setResource(value: CertificateRevocationList): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
