...
import typings.maximMazurokGapiClientPrivateca.gapi.client.privateca.CertificateTemplate
...
object CallbackFields {
  ...
  inline def apply(name: String, resource: CertificateTemplate): CallbackFields = {
  ...
  implicit open class MutableBuilder[Self <: CallbackFields] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: CertificateTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
