...
trait UndeleteCertificateAuthorityRequest extends StObject {
...
object UndeleteCertificateAuthorityRequest {
  
  inline def apply(): UndeleteCertificateAuthorityRequest = {
