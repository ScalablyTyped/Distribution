...
trait DisableCertificateAuthorityRequest extends StObject {
...
object DisableCertificateAuthorityRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DisableCertificateAuthorityRequest] (val x: Self) extends AnyVal {
