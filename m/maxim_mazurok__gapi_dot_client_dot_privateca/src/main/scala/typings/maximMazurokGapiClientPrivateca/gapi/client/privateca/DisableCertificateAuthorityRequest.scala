...
@js.native
trait DisableCertificateAuthorityRequest extends js.Object {
...
object DisableCertificateAuthorityRequest {
  ...
  @scala.inline
  implicit class DisableCertificateAuthorityRequestOps[Self <: DisableCertificateAuthorityRequest] (val x: Self) extends AnyVal {
