...
import typings.maximMazurokGapiClientYoutubereporting.gapi.client.youtubereporting.Job
...
object anon {
  ...
  object Callback {
    ...
    @scala.inline
    def apply(resource: Job): Callback = {
  ...
  object IncludeSystemManaged {
    ...
    @scala.inline
    def apply(): IncludeSystemManaged = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IncludeSystemManaged]
    }
    
    @scala.inline
    implicit class IncludeSystemManagedMutableBuilder[Self <: IncludeSystemManaged] (val x: Self) extends AnyVal {
