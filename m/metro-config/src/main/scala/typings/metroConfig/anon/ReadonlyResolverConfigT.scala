...
/* Inlined std.Readonly<metro-config.metro-config/src/configTypes.ResolverConfigT> */
trait ReadonlyResolverConfigT extends StObject {
  ...
  val requireCycleIgnorePatterns: js.Array[js.RegExp]
  
  val resolveRequest: js.UndefOr[
  ...
  val unstable_conditionNames: js.Array[String]
  
  val unstable_enablePackageExports: Boolean
  
  val unstable_enableSymlinks: Boolean
