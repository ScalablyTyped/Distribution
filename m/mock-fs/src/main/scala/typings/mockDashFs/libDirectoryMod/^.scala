...
class ^ () extends Directory {
  /**
    ...
    */
  /* CompleteClass */
  override def addItem[T /* <: typings.mockDashFs.libItemMod.^ */](name: String, item: T): T = js.native
  ...
  /* CompleteClass */
  override def getItem(name: String): typings.mockDashFs.libItemMod.^  | Null = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeItem(name: String): typings.mockDashFs.libItemMod.^ = js.native
  /** Set access time. */
  /* CompleteClass */
