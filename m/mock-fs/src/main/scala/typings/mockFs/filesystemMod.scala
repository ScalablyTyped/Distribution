...
object filesystemMod {
  ...
  object FileSystem {
    ...
    inline def apply(getItem: String => typings.mockFs.itemMod.^, getRoot: () => typings.mockFs.directoryMod.^): FileSystem = {
    ...
    extension [Self <: FileSystem](x: Self) {
      ...
      inline def setGetItem(value: String => typings.mockFs.itemMod.^): Self = StObject.set(x, "getItem", js.Any.fromFunction1(value))
      
      inline def setGetRoot(value: () => typings.mockFs.directoryMod.^): Self = StObject.set(x, "getRoot", js.Any.fromFunction0(value))
    }
  }
