...
object Parent {
  ...
  implicit class ParentOps[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudRecommendationengineV1beta1CreatePredictionApiKeyRegistrationRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
