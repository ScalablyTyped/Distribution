...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudRecommendationengineV1beta1CreatePredictionApiKeyRegistrationRequest
...
object Parent {
  ...
  implicit open class MutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: GoogleCloudRecommendationengineV1beta1CreatePredictionApiKeyRegistrationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
