...
import typings.maximMazurokGapiClientRecommendationengine.gapi.client.recommendationengine.GoogleCloudRecommendationengineV1beta1CreatePredictionApiKeyRegistrationRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudRecommendationengineV1beta1CreatePredictionApiKeyRegistrationRequest = js.native
...
object Parent {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudRecommendationengineV1beta1CreatePredictionApiKeyRegistrationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
