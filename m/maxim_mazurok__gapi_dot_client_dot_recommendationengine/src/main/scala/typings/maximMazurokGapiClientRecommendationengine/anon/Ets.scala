...
trait Ets extends StObject {
  ...
  var ets: js.UndefOr[String] = js.native
  ...
  var userEvent: js.UndefOr[String] = js.native
}
object Ets {
  
  @scala.inline
  def apply(parent: String): Ets = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[Ets]
  }
  
  @scala.inline
  implicit class EtsMutableBuilder[Self <: Ets] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEts(value: String): Self = StObject.set(x, "ets", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEtsUndefined: Self = StObject.set(x, "ets", js.undefined)
    ...
    @scala.inline
    def setUserEvent(value: String): Self = StObject.set(x, "userEvent", value.asInstanceOf[js.Any])
