...
@js.native
trait SasPortalStatus extends js.Object {
  ...
  {[ P in string ]: any}
    */ typings.maximMazurokGapiClientSasportal.maximMazurokGapiClientSasportalStrings.SasPortalStatus with TopLevel[js.Any]
    ]
  ] = js.native
...
object SasPortalStatus {
  ...
  @scala.inline
  implicit class SasPortalStatusOps[Self <: SasPortalStatus] (val x: Self) extends AnyVal {
