...
object PhrasingContent {
  ...
  @scala.inline
  def Link(children: js.Array[StaticPhrasingContent], url: String): typings.mdast.mod.Link = {
  ...
  @scala.inline
  def LinkReference(children: js.Array[StaticPhrasingContent], identifier: String, referenceType: ReferenceType): typings.mdast.mod.LinkReference = {
