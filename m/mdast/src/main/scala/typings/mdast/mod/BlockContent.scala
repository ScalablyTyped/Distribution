...
object BlockContent {
  ...
  inline def Blockquote(children: js.Array[BlockContent]): typings.mdast.mod.Blockquote = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("blockquote")
    __obj.asInstanceOf[typings.mdast.mod.Blockquote]
  }
  
  inline def Code(value: js.Any): typings.mdast.mod.Code = {
  ...
  inline def Heading(children: js.Array[PhrasingContent], depth: `1` | `2` | `3` | `4` | `5` | `6`): typings.mdast.mod.Heading = {
  ...
  inline def List(children: js.Array[ListContent]): typings.mdast.mod.List = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("list")
    __obj.asInstanceOf[typings.mdast.mod.List]
  }
  
  inline def Paragraph(children: js.Array[PhrasingContent]): typings.mdast.mod.Paragraph = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("paragraph")
    __obj.asInstanceOf[typings.mdast.mod.Paragraph]
  }
  
  inline def Table(children: js.Array[TableContent]): typings.mdast.mod.Table = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("table")
    __obj.asInstanceOf[typings.mdast.mod.Table]
  }
  
  inline def ThematicBreak(): typings.mdast.mod.ThematicBreak = {
