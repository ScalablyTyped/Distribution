...
import typings.maximMazurokGapiClientOsconfig.gapi.client.osconfig.CancelPatchJobRequest
...
object anon {
  ...
  object Accesstoken {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPatchDeploymentId(value: String): Self = StObject.set(x, "patchDeploymentId", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPatchDeploymentIdUndefined: Self = StObject.set(x, "patchDeploymentId", js.undefined)
      ...
      @scala.inline
      def setResource(value: PatchDeployment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    @scala.inline
    def apply(name: String, resource: CancelPatchJobRequest): Key = {
    ...
    implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: CancelPatchJobRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  trait Oauthtoken extends StObject {
    ...
    /** Request body */
    var resource: ExecutePatchJobRequest
  ...
  object Oauthtoken {
    ...
    implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: ExecutePatchJobRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
