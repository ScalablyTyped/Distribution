...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(parent: String, resource: PatchDeployment): Accesstoken = {
  ...
  object Key {
    ...
    inline def apply(name: String, resource: CancelPatchJobRequest): Key = {
  ...
  object Oauthtoken {
    ...
    inline def apply(parent: String, resource: ExecutePatchJobRequest): Oauthtoken = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: Oauthtoken](x: Self) {
      ...
      inline def setResource(value: ExecutePatchJobRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
