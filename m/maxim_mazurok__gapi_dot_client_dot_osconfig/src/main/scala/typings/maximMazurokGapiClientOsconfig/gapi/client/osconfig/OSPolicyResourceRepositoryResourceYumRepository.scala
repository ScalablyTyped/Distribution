...
trait OSPolicyResourceRepositoryResourceYumRepository extends StObject {
...
object OSPolicyResourceRepositoryResourceYumRepository {
  
  inline def apply(): OSPolicyResourceRepositoryResourceYumRepository = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OSPolicyResourceRepositoryResourceYumRepository]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OSPolicyResourceRepositoryResourceYumRepository] (val x: Self) extends AnyVal {
