...
object ErrorGroupStats {
  ...
  extension [Self <: ErrorGroupStats](x: Self) {
    ...
    inline def setAffectedServicesVarargs(value: ServiceContext*): Self = StObject.set(x, "affectedServices", js.Array(value*))
    ...
    inline def setTimedCountsVarargs(value: TimedCount*): Self = StObject.set(x, "timedCounts", js.Array(value*))
  }
}
