...
object GetCustomerUserStatsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetCustomerUserStatsResponse] (val x: Self) extends AnyVal {
    
    inline def setStats(value: js.Array[CustomerUserStats]): Self = StObject.set(x, "stats", value.asInstanceOf[js.Any])
    
    inline def setStatsUndefined: Self = StObject.set(x, "stats", js.undefined)
    
    inline def setStatsVarargs(value: CustomerUserStats*): Self = StObject.set(x, "stats", js.Array(value*))
  }
}
