...
@js.native
trait SearchApplicationUserStats extends js.Object {
...
object SearchApplicationUserStats {
  ...
  @scala.inline
  implicit class SearchApplicationUserStatsOps[Self <: SearchApplicationUserStats] (val x: Self) extends AnyVal {
