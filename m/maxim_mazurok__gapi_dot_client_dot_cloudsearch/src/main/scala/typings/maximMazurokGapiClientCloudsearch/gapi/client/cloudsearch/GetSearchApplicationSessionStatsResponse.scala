...
object GetSearchApplicationSessionStatsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSearchApplicationSessionStatsResponse] (val x: Self) extends AnyVal {
    ...
    inline def setStatsVarargs(value: SearchApplicationSessionStats*): Self = StObject.set(x, "stats", js.Array(value*))
  }
}
