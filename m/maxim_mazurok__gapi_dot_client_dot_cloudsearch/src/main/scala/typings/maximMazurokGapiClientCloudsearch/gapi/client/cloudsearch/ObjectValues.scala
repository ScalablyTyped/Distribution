...
object ObjectValues {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ObjectValues] (val x: Self) extends AnyVal {
    ...
    inline def setValuesVarargs(value: StructuredDataObject*): Self = StObject.set(x, "values", js.Array(value*))
  }
}
