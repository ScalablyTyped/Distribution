...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: IndexItemRequest = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(name: String, resource: IndexItemRequest): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: IndexItemRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
