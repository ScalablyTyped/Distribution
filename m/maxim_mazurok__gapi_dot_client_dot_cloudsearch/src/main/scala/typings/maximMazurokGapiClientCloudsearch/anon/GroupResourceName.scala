...
@js.native
trait GroupResourceName extends js.Object {
...
object GroupResourceName {
  ...
  @scala.inline
  def apply(parent: String): GroupResourceName = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[GroupResourceName]
  }
  
  @scala.inline
  implicit class GroupResourceNameOps[Self <: GroupResourceName] (val x: Self) extends AnyVal {
