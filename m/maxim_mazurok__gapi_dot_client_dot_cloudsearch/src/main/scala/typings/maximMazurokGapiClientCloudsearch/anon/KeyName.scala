...
trait KeyName extends StObject {
  ...
  /** Request body */
  var resource: ResetSearchApplicationRequest = js.native
...
object KeyName {
  ...
  @scala.inline
  def apply(name: String, resource: ResetSearchApplicationRequest): KeyName = {
  ...
  implicit class KeyNameMutableBuilder[Self <: KeyName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ResetSearchApplicationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
