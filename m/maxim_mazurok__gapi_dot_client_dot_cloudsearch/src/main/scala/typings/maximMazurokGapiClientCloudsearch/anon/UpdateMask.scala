...
import typings.maximMazurokGapiClientCloudsearch.gapi.client.cloudsearch.CustomerSettings
...
object UpdateMask {
  ...
  inline def apply(resource: CustomerSettings): UpdateMask = {
  ...
  implicit open class MutableBuilder[Self <: UpdateMask] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: CustomerSettings): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
