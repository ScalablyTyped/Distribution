...
import typings.maximMazurokGapiClientCloudsearch.gapi.client.cloudsearch.Principal
...
object Callback {
  ...
  inline def apply(name: String, resource: Principal): Callback = {
  ...
  implicit open class MutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: Principal): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
