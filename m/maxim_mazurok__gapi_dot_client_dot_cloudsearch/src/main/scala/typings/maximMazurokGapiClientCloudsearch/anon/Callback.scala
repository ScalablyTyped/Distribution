...
trait Callback extends StObject {
  ...
  /** Request body */
  var resource: Principal = js.native
...
object Callback {
  ...
  @scala.inline
  def apply(name: String, resource: Principal): Callback = {
  ...
  implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Principal): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
