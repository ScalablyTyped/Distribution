...
@js.native
trait DebugOptionsenableDebugging extends js.Object {
...
object DebugOptionsenableDebugging {
  ...
  @scala.inline
  implicit class DebugOptionsenableDebuggingOps[Self <: DebugOptionsenableDebugging] (val x: Self) extends AnyVal {
