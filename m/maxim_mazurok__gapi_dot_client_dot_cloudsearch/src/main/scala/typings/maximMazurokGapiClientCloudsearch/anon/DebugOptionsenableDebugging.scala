...
@js.native
trait DebugOptionsenableDebugging extends StObject {
...
object DebugOptionsenableDebugging {
  
  @scala.inline
  def apply(name: String): DebugOptionsenableDebugging = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[DebugOptionsenableDebugging]
  }
  
  @scala.inline
  implicit class DebugOptionsenableDebuggingMutableBuilder[Self <: DebugOptionsenableDebugging] (val x: Self) extends AnyVal {
