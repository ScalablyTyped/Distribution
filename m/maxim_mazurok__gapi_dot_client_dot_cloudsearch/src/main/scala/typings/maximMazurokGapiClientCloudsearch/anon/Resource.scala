...
import typings.maximMazurokGapiClientCloudsearch.gapi.client.cloudsearch.PushItemRequest
...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: PushItemRequest = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(name: String, resource: PushItemRequest): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PushItemRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
