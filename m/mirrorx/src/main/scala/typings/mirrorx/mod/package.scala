...
@scala.inline
def hook(): js.Function1[/* subscriber */ js.Function0[js.Any], js.Any] = typings.mirrorx.mod.^.asInstanceOf[js.Dynamic].applyDynamic("hook")().asInstanceOf[js.Function1[/* subscriber */ js.Function0[js.Any], js.Any]]
...
@scala.inline
def withRouter[P /* <: typings.mirrorx.mod.RouteComponentProps[js.Any] */](component: typings.react.mod.ComponentType[P]): typings.react.mod.ComponentClass[
...
@scala.inline
def withRouter[TFunction /* <: typings.react.mod.ComponentClass[js.Any, typings.react.mod.ComponentState] */](target: TFunction): TFunction = typings.mirrorx.mod.^.asInstanceOf[js.Dynamic].applyDynamic("withRouter")(target.asInstanceOf[js.Any]).asInstanceOf[TFunction]
