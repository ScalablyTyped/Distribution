...
@js.native
trait GoogleCloudSecuritycenterV1p1beta1Resource extends js.Object {
...
object GoogleCloudSecuritycenterV1p1beta1Resource {
  ...
  @scala.inline
  def apply(): GoogleCloudSecuritycenterV1p1beta1Resource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudSecuritycenterV1p1beta1Resource]
  }
  
  @scala.inline
  implicit class GoogleCloudSecuritycenterV1p1beta1ResourceOps[Self <: GoogleCloudSecuritycenterV1p1beta1Resource] (val x: Self) extends AnyVal {
