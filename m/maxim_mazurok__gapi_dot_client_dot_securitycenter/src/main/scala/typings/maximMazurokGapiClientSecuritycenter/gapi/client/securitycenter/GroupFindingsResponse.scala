...
@js.native
trait GroupFindingsResponse extends js.Object {
...
object GroupFindingsResponse {
  ...
  @scala.inline
  def apply(): GroupFindingsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GroupFindingsResponse]
  }
  
  @scala.inline
  implicit class GroupFindingsResponseOps[Self <: GroupFindingsResponse] (val x: Self) extends AnyVal {
