...
trait GoogleCloudSecuritycenterV1BigQueryExport extends StObject {
...
object GoogleCloudSecuritycenterV1BigQueryExport {
  
  inline def apply(): GoogleCloudSecuritycenterV1BigQueryExport = {
