...
trait GoogleCloudSecuritycenterV1p1beta1Finding extends js.Object {
  ...
  {[ P in string ]: any}
    */ typings.maximMazurokGapiClientSecuritycenter.maximMazurokGapiClientSecuritycenterStrings.GoogleCloudSecuritycenterV1p1beta1Finding with TopLevel[js.Any]
  ] = js.native
