...
trait Key extends StObject {
  ...
  /** Request body */
  var resource: SecurityMarks = js.native
...
object Key {
  ...
  @scala.inline
  def apply(name: String, resource: SecurityMarks): Key = {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SecurityMarks): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
