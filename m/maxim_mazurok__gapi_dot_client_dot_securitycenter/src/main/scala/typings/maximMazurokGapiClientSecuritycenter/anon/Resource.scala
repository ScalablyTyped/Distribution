...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: GroupFindingsRequest = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(parent: String, resource: GroupFindingsRequest): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GroupFindingsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
