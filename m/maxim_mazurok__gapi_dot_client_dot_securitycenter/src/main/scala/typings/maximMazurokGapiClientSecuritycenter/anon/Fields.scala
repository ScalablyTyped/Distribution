...
trait Fields extends StObject {
  ...
  /** Request body */
  var resource: RunAssetDiscoveryRequest = js.native
...
object Fields {
  ...
  @scala.inline
  def apply(parent: String, resource: RunAssetDiscoveryRequest): Fields = {
  ...
  implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RunAssetDiscoveryRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
