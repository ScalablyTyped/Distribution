...
import typings.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.NotificationConfig
...
trait ConfigId extends StObject {
  ...
  /** Request body */
  var resource: NotificationConfig = js.native
...
object ConfigId {
  ...
  @scala.inline
  def apply(parent: String, resource: NotificationConfig): ConfigId = {
  ...
  implicit class ConfigIdMutableBuilder[Self <: ConfigId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NotificationConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
