...
@js.native
trait FindingId extends StObject {
...
object FindingId {
  ...
  @scala.inline
  def apply(parent: String, resource: Finding): FindingId = {
  ...
  @scala.inline
  implicit class FindingIdMutableBuilder[Self <: FindingId] (val x: Self) extends AnyVal {
