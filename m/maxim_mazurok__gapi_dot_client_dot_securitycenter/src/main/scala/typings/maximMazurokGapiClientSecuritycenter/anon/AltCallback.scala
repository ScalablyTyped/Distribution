...
object AltCallback {
  ...
  @scala.inline
  def apply(name: String, resource: Source): AltCallback = {
  ...
  implicit class AltCallbackMutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Source): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
