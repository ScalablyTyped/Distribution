...
import typings.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.GoogleCloudSecuritycenterV1ExternalSystem
...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudSecuritycenterV1ExternalSystem
...
object FieldsKey {
  ...
  inline def apply(name: String, resource: GoogleCloudSecuritycenterV1ExternalSystem): FieldsKey = {
  ...
  implicit open class MutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: GoogleCloudSecuritycenterV1ExternalSystem): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
