...
import typings.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.FoldersResource
import typings.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.OrganizationsResource
import typings.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.ProjectsResource
