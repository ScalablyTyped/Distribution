...
trait Taglib extends js.Object {
  ...
  var tags: org.scalablytyped.runtime.StringDictionary[markoLib.srcCompilerTaglibDashLoaderTagMod.^] = js.native
  ...
  def addTag(tag: markoLib.srcCompilerTaglibDashLoaderTagMod.^): scala.Unit = js.native
  ...
  def forEachTag(callback: js.Function1[/* tag */ markoLib.srcCompilerTaglibDashLoaderTagMod.^, scala.Unit]): scala.Unit = js.native
  def forEachTag(
    callback: js.Function1[/* tag */ markoLib.srcCompilerTaglibDashLoaderTagMod.^, scala.Unit],
    thisObj: js.Any
