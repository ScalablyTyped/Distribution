...
import typings.marko.srcCompilerTaglibDashLoaderAttributeMod.default
...
trait Tag extends js.Object {
  ...
  var transformers: StringDictionary[typings.marko.srcCompilerTaglibDashLoaderTransformerMod.default] = js.native
  ...
  def forEachTransformer(
    callback: js.Function1[
      /* transformer */ typings.marko.srcCompilerTaglibDashLoaderTransformerMod.default, 
      Unit
    ]
  ): Unit = js.native
  def forEachTransformer(
  ...
  def setTaglib(taglib: typings.marko.srcCompilerTaglibDashLoaderTaglibMod.default): Unit = js.native
}
