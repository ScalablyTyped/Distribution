...
object compilerMod {
  ...
  object taglibLoader {
    ...
    inline def loadTaglibFromProps(taglib: typings.marko.taglibLoaderMod.Taglib, taglibProps: Any): typings.marko.taglibLoaderMod.Taglib = (^.asInstanceOf[js.Dynamic].applyDynamic("loadTaglibFromProps")(taglib.asInstanceOf[js.Any], taglibProps.asInstanceOf[js.Any])).asInstanceOf[typings.marko.taglibLoaderMod.Taglib]
  }
