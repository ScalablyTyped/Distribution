...
import typings.marko.srcCompilerTaglibLoaderAttributeMod.default
  ...
  trait Tag extends StObject {
    ...
    def forEachTransformer(
      callback: js.Function1[
          /* transformer */ typings.marko.srcCompilerTaglibLoaderTransformerMod.default, 
          Unit
        ]
    ): Unit = js.native
    def forEachTransformer(
    ...
    def setTaglib(taglib: typings.marko.srcCompilerTaglibLoaderTaglibMod.default): Unit = js.native
    ...
    var transformers: StringDictionary[typings.marko.srcCompilerTaglibLoaderTransformerMod.default] = js.native
