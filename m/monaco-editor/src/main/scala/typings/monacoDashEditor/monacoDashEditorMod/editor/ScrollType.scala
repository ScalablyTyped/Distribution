...
import typings.monacoDashEditor.monacoDashEditorMod.editor.ScrollType.Immediate
import typings.monacoDashEditor.monacoDashEditorMod.editor.ScrollType.Smooth
