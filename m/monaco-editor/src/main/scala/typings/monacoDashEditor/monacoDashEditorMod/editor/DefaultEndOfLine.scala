...
import typings.monacoDashEditor.monacoDashEditorMod.editor.DefaultEndOfLine.CRLF
import typings.monacoDashEditor.monacoDashEditorMod.editor.DefaultEndOfLine.LF
