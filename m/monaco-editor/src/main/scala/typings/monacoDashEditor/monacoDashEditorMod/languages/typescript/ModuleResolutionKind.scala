...
import typings.monacoDashEditor.monacoDashEditorMod.languages.typescript.ModuleResolutionKind.Classic
import typings.monacoDashEditor.monacoDashEditorMod.languages.typescript.ModuleResolutionKind.NodeJs
