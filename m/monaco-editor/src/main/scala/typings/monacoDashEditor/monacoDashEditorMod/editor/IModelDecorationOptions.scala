...
object IModelDecorationOptions {
  ...
  def apply(
    ...
    if (afterContentClassName != null) __obj.updateDynamic("afterContentClassName")(afterContentClassName)
    if (beforeContentClassName != null) __obj.updateDynamic("beforeContentClassName")(beforeContentClassName)
    if (className != null) __obj.updateDynamic("className")(className)
    if (glyphMarginClassName != null) __obj.updateDynamic("glyphMarginClassName")(glyphMarginClassName)
    ...
    if (inlineClassName != null) __obj.updateDynamic("inlineClassName")(inlineClassName)
    if (!js.isUndefined(inlineClassNameAffectsLetterSpacing)) __obj.updateDynamic("inlineClassNameAffectsLetterSpacing")(inlineClassNameAffectsLetterSpacing)
    if (!js.isUndefined(isWholeLine)) __obj.updateDynamic("isWholeLine")(isWholeLine)
    if (linesDecorationsClassName != null) __obj.updateDynamic("linesDecorationsClassName")(linesDecorationsClassName)
    if (marginClassName != null) __obj.updateDynamic("marginClassName")(marginClassName)
    if (minimap != null) __obj.updateDynamic("minimap")(minimap)
    if (overviewRuler != null) __obj.updateDynamic("overviewRuler")(overviewRuler)
    if (stickiness != null) __obj.updateDynamic("stickiness")(stickiness)
