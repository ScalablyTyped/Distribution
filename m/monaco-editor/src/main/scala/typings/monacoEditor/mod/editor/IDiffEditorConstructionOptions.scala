...
object IDiffEditorConstructionOptions {
  ...
  def apply(
    ...
    maxComputationTime: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(maxComputationTime)) __obj.updateDynamic("maxComputationTime")(maxComputationTime.get.asInstanceOf[js.Any])
