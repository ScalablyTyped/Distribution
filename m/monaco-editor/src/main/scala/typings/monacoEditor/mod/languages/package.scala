...
inline def getEncodedLanguageId(languageId: java.lang.String): scala.Double = typings.monacoEditor.mod.languages.^.asInstanceOf[js.Dynamic].applyDynamic("getEncodedLanguageId")(languageId.asInstanceOf[js.Any]).asInstanceOf[scala.Double]

inline def getLanguages(): js.Array[typings.monacoEditor.mod.languages.ILanguageExtensionPoint] = typings.monacoEditor.mod.languages.^.asInstanceOf[js.Dynamic].applyDynamic("getLanguages")().asInstanceOf[js.Array[typings.monacoEditor.mod.languages.ILanguageExtensionPoint]]
...
inline def register(language: typings.monacoEditor.mod.languages.ILanguageExtensionPoint): scala.Unit = typings.monacoEditor.mod.languages.^.asInstanceOf[js.Dynamic].applyDynamic("register")(language.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
...
inline def registerDocumentFormattingEditProvider(
...
inline def registerDocumentHighlightProvider(
  languageId: java.lang.String,
...
inline def registerDocumentRangeFormattingEditProvider(
  languageId: java.lang.String,
...
inline def setLanguageConfiguration(
  languageId: java.lang.String,
...
inline def setMonarchTokensProvider(
  languageId: java.lang.String,
