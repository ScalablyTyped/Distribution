...
object ModeConfiguration {
  ...
  def apply(
    ...
    if (!js.isUndefined(definitions)) __obj.updateDynamic("definitions")(definitions.get.asInstanceOf[js.Any])
    if (!js.isUndefined(diagnostics)) __obj.updateDynamic("diagnostics")(diagnostics.get.asInstanceOf[js.Any])
    if (!js.isUndefined(documentHighlights)) __obj.updateDynamic("documentHighlights")(documentHighlights.get.asInstanceOf[js.Any])
