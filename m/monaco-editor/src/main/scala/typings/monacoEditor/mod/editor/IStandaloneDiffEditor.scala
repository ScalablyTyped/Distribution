...
trait IStandaloneDiffEditor
  ...
  {[ P in string ]: null | undefined | boolean | number | string}
    */ typings.monacoEditor.monacoEditorStrings.IStandaloneDiffEditor & TopLevel[Any] */](key: String, defaultValue: T): IContextKey[T] = js.native
}
