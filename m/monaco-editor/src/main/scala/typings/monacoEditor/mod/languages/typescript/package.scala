...
inline def javascriptDefaults: typings.monacoEditor.mod.languages.typescript.LanguageServiceDefaults = typings.monacoEditor.mod.languages.typescript.^.asInstanceOf[js.Dynamic].selectDynamic("javascriptDefaults").asInstanceOf[typings.monacoEditor.mod.languages.typescript.LanguageServiceDefaults]

inline def typescriptDefaults: typings.monacoEditor.mod.languages.typescript.LanguageServiceDefaults = typings.monacoEditor.mod.languages.typescript.^.asInstanceOf[js.Dynamic].selectDynamic("typescriptDefaults").asInstanceOf[typings.monacoEditor.mod.languages.typescript.LanguageServiceDefaults]

inline def typescriptVersion: java.lang.String = typings.monacoEditor.mod.languages.typescript.^.asInstanceOf[js.Dynamic].selectDynamic("typescriptVersion").asInstanceOf[java.lang.String]
