...
object IMouseTarget {
  ...
  inline def apply(detail: js.Any, mouseColumn: Double, `type`: MouseTargetType): IMouseTarget = {
  ...
  extension [Self <: IMouseTarget](x: Self) {
    ...
    inline def setType(value: MouseTargetType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
