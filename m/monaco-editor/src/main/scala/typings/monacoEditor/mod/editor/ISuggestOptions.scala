...
object ISuggestOptions {
  ...
  def apply(
    ...
    maxVisibleSuggestions: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(insertHighlight)) __obj.updateDynamic("insertHighlight")(insertHighlight.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showClasses)) __obj.updateDynamic("showClasses")(showClasses.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showColors)) __obj.updateDynamic("showColors")(showColors.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showConstants)) __obj.updateDynamic("showConstants")(showConstants.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showConstructors)) __obj.updateDynamic("showConstructors")(showConstructors.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showEnumMembers)) __obj.updateDynamic("showEnumMembers")(showEnumMembers.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showEnums)) __obj.updateDynamic("showEnums")(showEnums.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showEvents)) __obj.updateDynamic("showEvents")(showEvents.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showFields)) __obj.updateDynamic("showFields")(showFields.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showFunctions)) __obj.updateDynamic("showFunctions")(showFunctions.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showIcons)) __obj.updateDynamic("showIcons")(showIcons.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showInterfaces)) __obj.updateDynamic("showInterfaces")(showInterfaces.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showKeywords)) __obj.updateDynamic("showKeywords")(showKeywords.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showMethods)) __obj.updateDynamic("showMethods")(showMethods.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showModules)) __obj.updateDynamic("showModules")(showModules.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showReferences)) __obj.updateDynamic("showReferences")(showReferences.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showSnippets)) __obj.updateDynamic("showSnippets")(showSnippets.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showStructs)) __obj.updateDynamic("showStructs")(showStructs.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showTypeParameters)) __obj.updateDynamic("showTypeParameters")(showTypeParameters.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showUnits)) __obj.updateDynamic("showUnits")(showUnits.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showValues)) __obj.updateDynamic("showValues")(showValues.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showVariables)) __obj.updateDynamic("showVariables")(showVariables.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showWords)) __obj.updateDynamic("showWords")(showWords.get.asInstanceOf[js.Any])
