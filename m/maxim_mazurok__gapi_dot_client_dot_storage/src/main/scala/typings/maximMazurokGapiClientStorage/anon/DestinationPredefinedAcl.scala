...
@js.native
trait DestinationPredefinedAcl extends js.Object {
...
object DestinationPredefinedAcl {
  ...
  @scala.inline
  def apply(destinationBucket: String, destinationObject: String, sourceBucket: String, sourceObject: String): DestinationPredefinedAcl = {
  ...
  @scala.inline
  implicit class DestinationPredefinedAclOps[Self <: DestinationPredefinedAcl] (val x: Self) extends AnyVal {
