...
@js.native
trait OauthtokenObject extends js.Object {
...
object OauthtokenObject {
  ...
  @scala.inline
  def apply(bucket: String, `object`: String, permissions: String | js.Array[String]): OauthtokenObject = {
  ...
  @scala.inline
  implicit class OauthtokenObjectOps[Self <: OauthtokenObject] (val x: Self) extends AnyVal {
