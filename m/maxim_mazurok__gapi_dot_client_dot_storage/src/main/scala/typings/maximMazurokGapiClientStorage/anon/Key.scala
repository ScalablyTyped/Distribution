...
trait Key extends StObject {
  ...
  /** Request body */
  var resource: BucketAccessControl = js.native
...
object Key {
  ...
  @scala.inline
  def apply(bucket: String, entity: String, resource: BucketAccessControl): Key = {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BucketAccessControl): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
