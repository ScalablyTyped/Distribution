...
trait IfMetagenerationNotMatch extends StObject {
...
object IfMetagenerationNotMatch {
  ...
  inline def apply(bucket: String): IfMetagenerationNotMatch = {
    val __obj = js.Dynamic.literal(bucket = bucket.asInstanceOf[js.Any])
    __obj.asInstanceOf[IfMetagenerationNotMatch]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IfMetagenerationNotMatch] (val x: Self) extends AnyVal {
