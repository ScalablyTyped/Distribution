...
@js.native
trait BucketEntity extends js.Object {
...
object BucketEntity {
  ...
  @scala.inline
  def apply(bucket: String, entity: String, `object`: String, resource: ObjectAccessControl): BucketEntity = {
  ...
  @scala.inline
  implicit class BucketEntityOps[Self <: BucketEntity] (val x: Self) extends AnyVal {
