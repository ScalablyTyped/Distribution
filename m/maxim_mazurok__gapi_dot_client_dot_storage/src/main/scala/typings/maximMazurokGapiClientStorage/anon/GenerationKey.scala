...
trait GenerationKey extends StObject {
...
object GenerationKey {
  ...
  @scala.inline
  def apply(bucket: String, `object`: String): GenerationKey = {
  ...
  @scala.inline
  implicit class GenerationKeyMutableBuilder[Self <: GenerationKey] (val x: Self) extends AnyVal {
