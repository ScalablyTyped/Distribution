...
@js.native
trait BucketFields extends js.Object {
...
object BucketFields {
  ...
  @scala.inline
  implicit class BucketFieldsOps[Self <: BucketFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientStorage.gapi.client.storage.Notification): Self = this.set("resource", value.asInstanceOf[js.Any])
