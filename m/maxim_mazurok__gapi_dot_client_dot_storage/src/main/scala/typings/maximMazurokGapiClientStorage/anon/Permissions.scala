...
trait Permissions extends StObject {
  ...
  /** Permissions to test. */
  var permissions: String | js.Array[String] = js.native
...
object Permissions {
  ...
  @scala.inline
  def apply(bucket: String, permissions: String | js.Array[String]): Permissions = {
  ...
  implicit class PermissionsMutableBuilder[Self <: Permissions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPermissions(value: String | js.Array[String]): Self = StObject.set(x, "permissions", value.asInstanceOf[js.Any])
