...
@js.native
trait IfGenerationNotMatchIfMetagenerationMatch extends js.Object {
...
object IfGenerationNotMatchIfMetagenerationMatch {
  ...
  @scala.inline
  implicit class IfGenerationNotMatchIfMetagenerationMatchOps[Self <: IfGenerationNotMatchIfMetagenerationMatch] (val x: Self) extends AnyVal {
