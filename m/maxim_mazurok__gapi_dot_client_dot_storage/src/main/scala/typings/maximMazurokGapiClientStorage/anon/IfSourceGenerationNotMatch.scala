...
object IfSourceGenerationNotMatch {
  ...
  inline def apply(destinationBucket: String, destinationObject: String, sourceBucket: String, sourceObject: String): IfSourceGenerationNotMatch = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IfSourceGenerationNotMatch] (val x: Self) extends AnyVal {
