...
@js.native
trait IfSourceGenerationNotMatch extends js.Object {
...
object IfSourceGenerationNotMatch {
  ...
  @scala.inline
  implicit class IfSourceGenerationNotMatchOps[Self <: IfSourceGenerationNotMatch] (val x: Self) extends AnyVal {
