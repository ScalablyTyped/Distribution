...
trait IfSourceGenerationNotMatch extends StObject {
...
object IfSourceGenerationNotMatch {
  
  @scala.inline
  def apply(destinationBucket: String, destinationObject: String, sourceBucket: String, sourceObject: String): IfSourceGenerationNotMatch = {
    ...
    __obj.asInstanceOf[IfSourceGenerationNotMatch]
  }
  
  @scala.inline
  implicit class IfSourceGenerationNotMatchMutableBuilder[Self <: IfSourceGenerationNotMatch] (val x: Self) extends AnyVal {
