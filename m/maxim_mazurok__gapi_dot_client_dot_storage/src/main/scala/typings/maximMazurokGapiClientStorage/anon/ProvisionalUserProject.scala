...
@js.native
trait ProvisionalUserProject extends js.Object {
...
object ProvisionalUserProject {
  ...
  @scala.inline
  def apply(bucket: String): ProvisionalUserProject = {
    val __obj = js.Dynamic.literal(bucket = bucket.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProvisionalUserProject]
  }
  
  @scala.inline
  implicit class ProvisionalUserProjectOps[Self <: ProvisionalUserProject] (val x: Self) extends AnyVal {
