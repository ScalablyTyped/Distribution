...
object DestinationObject {
  ...
  inline def apply(destinationBucket: String, destinationObject: String): DestinationObject = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DestinationObject] (val x: Self) extends AnyVal {
