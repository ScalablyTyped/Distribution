...
object PredefinedDefaultObjectAcl {
  ...
  inline def apply(project: String): PredefinedDefaultObjectAcl = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[PredefinedDefaultObjectAcl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PredefinedDefaultObjectAcl] (val x: Self) extends AnyVal {
