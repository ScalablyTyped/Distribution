...
object Projection {
  ...
  inline def apply(bucket: String, resource: typings.maximMazurokGapiClientStorage.gapi.client.storage.Bucket): Projection = {
  ...
  implicit open class MutableBuilder[Self <: Projection] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientStorage.gapi.client.storage.Bucket): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
