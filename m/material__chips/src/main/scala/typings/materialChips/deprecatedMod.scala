...
object deprecatedMod {
  ...
  open class MDCChip protected ()
    extends typings.materialChips.deprecatedChipMod.MDCChip {
  ...
  open class MDCChipFoundation ()
    extends typings.materialChips.deprecatedChipMod.MDCChipFoundation {
  ...
  open class MDCChipSet protected ()
    extends typings.materialChips.deprecatedChipSetMod.MDCChipSet {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
  ...
  open class MDCChipSetFoundation ()
    extends typings.materialChips.deprecatedChipSetMod.MDCChipSetFoundation {
