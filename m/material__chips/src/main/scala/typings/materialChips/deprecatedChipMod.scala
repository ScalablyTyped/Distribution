...
object deprecatedChipMod {
  ...
  @js.native
  open class default ()
    extends typings.materialChips.deprecatedChipFoundationMod.default {
  ...
  open class MDCChip protected ()
    extends typings.materialChips.deprecatedChipComponentMod.MDCChip {
  ...
  open class MDCChipFoundation ()
    extends typings.materialChips.deprecatedChipFoundationMod.MDCChipFoundation {
    def this(adapter: PartialMDCChipAdapterAddClass) = this()
  }
