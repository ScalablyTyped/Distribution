...
import typings.materialChips.materialChipsStrings.`mdc-chip--exit`
import typings.materialChips.materialChipsStrings.`mdc-chip--selected`
import typings.materialChips.materialChipsStrings.`mdc-chip__checkmark`
import typings.materialChips.materialChipsStrings.`mdc-chip__icon--leading-hidden`
import typings.materialChips.materialChipsStrings.`mdc-chip__icon--leading`
import typings.materialChips.materialChipsStrings.`mdc-chip__icon--trailing`
import typings.materialChips.materialChipsStrings.`mdc-chip__text`
import typings.materialChips.materialChipsStrings.`mdc-chip`
