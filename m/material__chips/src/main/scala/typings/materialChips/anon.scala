...
object anon {
  ...
  object PartialMDCChipAdapterAddClass {
    ...
    extension [Self <: PartialMDCChipAdapterAddClass](x: Self) {
      ...
      inline def setAddClassToLeadingIcon(value: /* className */ String => Unit): Self = StObject.set(x, "addClassToLeadingIcon", js.Any.fromFunction1(value))
      ...
      inline def setFocusPrimaryAction(value: () => Unit): Self = StObject.set(x, "focusPrimaryAction", js.Any.fromFunction0(value))
      
      inline def setFocusPrimaryActionUndefined: Self = StObject.set(x, "focusPrimaryAction", js.undefined)
      
      inline def setFocusTrailingAction(value: () => Unit): Self = StObject.set(x, "focusTrailingAction", js.Any.fromFunction0(value))
      ...
      inline def setHasLeadingIcon(value: () => Boolean): Self = StObject.set(x, "hasLeadingIcon", js.Any.fromFunction0(value))
      ...
      inline def setIsTrailingActionNavigable(value: () => Boolean): Self = StObject.set(x, "isTrailingActionNavigable", js.Any.fromFunction0(value))
      
      inline def setIsTrailingActionNavigableUndefined: Self = StObject.set(x, "isTrailingActionNavigable", js.undefined)
      
      inline def setNotifyEditFinish(value: () => Unit): Self = StObject.set(x, "notifyEditFinish", js.Any.fromFunction0(value))
      
      inline def setNotifyEditFinishUndefined: Self = StObject.set(x, "notifyEditFinish", js.undefined)
      
      inline def setNotifyEditStart(value: () => Unit): Self = StObject.set(x, "notifyEditStart", js.Any.fromFunction0(value))
      
      inline def setNotifyEditStartUndefined: Self = StObject.set(x, "notifyEditStart", js.undefined)
      
      inline def setNotifyInteraction(value: () => Unit): Self = StObject.set(x, "notifyInteraction", js.Any.fromFunction0(value))
      
      inline def setNotifyInteractionUndefined: Self = StObject.set(x, "notifyInteraction", js.undefined)
      
      inline def setNotifyNavigation(value: (/* key */ String, /* source */ EventSource) => Unit): Self = StObject.set(x, "notifyNavigation", js.Any.fromFunction2(value))
      
      inline def setNotifyNavigationUndefined: Self = StObject.set(x, "notifyNavigation", js.undefined)
      
      inline def setNotifyRemoval(value: /* removedAnnouncement */ String | Null => Unit): Self = StObject.set(x, "notifyRemoval", js.Any.fromFunction1(value))
      
      inline def setNotifyRemovalUndefined: Self = StObject.set(x, "notifyRemoval", js.undefined)
      
      inline def setNotifySelection(value: (/* selected */ Boolean, /* chipSetShouldIgnore */ Boolean) => Unit): Self = StObject.set(x, "notifySelection", js.Any.fromFunction2(value))
      
      inline def setNotifySelectionUndefined: Self = StObject.set(x, "notifySelection", js.undefined)
      
      inline def setNotifyTrailingIconInteraction(value: () => Unit): Self = StObject.set(x, "notifyTrailingIconInteraction", js.Any.fromFunction0(value))
      ...
      inline def setRemoveClassFromLeadingIcon(value: /* className */ String => Unit): Self = StObject.set(x, "removeClassFromLeadingIcon", js.Any.fromFunction1(value))
      
      inline def setRemoveClassFromLeadingIconUndefined: Self = StObject.set(x, "removeClassFromLeadingIcon", js.undefined)
      
      inline def setRemoveClassUndefined: Self = StObject.set(x, "removeClass", js.undefined)
      
      inline def setRemoveTrailingActionFocus(value: () => Unit): Self = StObject.set(x, "removeTrailingActionFocus", js.Any.fromFunction0(value))
      
      inline def setRemoveTrailingActionFocusUndefined: Self = StObject.set(x, "removeTrailingActionFocus", js.undefined)
      
      inline def setSetPrimaryActionAttr(value: (/* attr */ String, /* value */ String) => Unit): Self = StObject.set(x, "setPrimaryActionAttr", js.Any.fromFunction2(value))
  ...
  object PartialMDCChipSetAdapterAnnounceMessage {
    ...
    extension [Self <: PartialMDCChipSetAdapterAnnounceMessage](x: Self) {
      ...
      inline def setFocusChipPrimaryActionAtIndex(value: /* index */ Double => Unit): Self = StObject.set(x, "focusChipPrimaryActionAtIndex", js.Any.fromFunction1(value))
      
      inline def setFocusChipPrimaryActionAtIndexUndefined: Self = StObject.set(x, "focusChipPrimaryActionAtIndex", js.undefined)
      
      inline def setFocusChipTrailingActionAtIndex(value: /* index */ Double => Unit): Self = StObject.set(x, "focusChipTrailingActionAtIndex", js.Any.fromFunction1(value))
      ...
      inline def setRemoveFocusFromChipAtIndex(value: /* index */ Double => Unit): Self = StObject.set(x, "removeFocusFromChipAtIndex", js.Any.fromFunction1(value))
      
      inline def setRemoveFocusFromChipAtIndexUndefined: Self = StObject.set(x, "removeFocusFromChipAtIndex", js.undefined)
      
      inline def setSelectChipAtIndex(value: (/* index */ Double, /* isSelected */ Boolean, /* shouldNotifyClients */ Boolean) => Unit): Self = StObject.set(x, "selectChipAtIndex", js.Any.fromFunction3(value))
  ...
  object PartialMDCChipTrailingAct {
    ...
    extension [Self <: PartialMDCChipTrailingAct](x: Self) {
      ...
      inline def setNotifyInteraction(value: /* trigger */ InteractionTrigger => Unit): Self = StObject.set(x, "notifyInteraction", js.Any.fromFunction1(value))
      
      inline def setNotifyInteractionUndefined: Self = StObject.set(x, "notifyInteraction", js.undefined)
      
      inline def setNotifyNavigation(value: /* key */ String => Unit): Self = StObject.set(x, "notifyNavigation", js.Any.fromFunction1(value))
