...
trait VpnGatewayAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.VpnGatewaysScopedList} */ js.Any
  ] = js.undefined
...
object VpnGatewayAggregatedList {
  ...
  inline def apply(): VpnGatewayAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VpnGatewayAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VpnGatewayAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.VpnGatewaysScopedList} */ js.Any
