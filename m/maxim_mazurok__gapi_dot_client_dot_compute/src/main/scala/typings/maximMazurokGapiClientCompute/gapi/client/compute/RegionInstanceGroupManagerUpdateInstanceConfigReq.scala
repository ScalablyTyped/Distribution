...
@js.native
trait RegionInstanceGroupManagerUpdateInstanceConfigReq extends js.Object {
...
object RegionInstanceGroupManagerUpdateInstanceConfigReq {
  ...
  @scala.inline
  implicit class RegionInstanceGroupManagerUpdateInstanceConfigReqOps[Self <: RegionInstanceGroupManagerUpdateInstanceConfigReq] (val x: Self) extends AnyVal {
