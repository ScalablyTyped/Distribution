...
trait ReservationAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.ReservationsScopedList} */ js.Any
  ] = js.undefined
...
object ReservationAggregatedList {
  ...
  inline def apply(): ReservationAggregatedList = {
  ...
  implicit open class MutableBuilder[Self <: ReservationAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.ReservationsScopedList} */ js.Any
