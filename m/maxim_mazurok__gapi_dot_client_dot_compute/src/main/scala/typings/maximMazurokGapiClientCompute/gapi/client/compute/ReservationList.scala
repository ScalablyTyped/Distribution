...
trait ReservationList extends StObject {
  ...
  var items: js.UndefOr[js.Array[Reservation]] = js.undefined
...
object ReservationList {
  ...
  inline def apply(): ReservationList = {
  ...
  extension [Self <: ReservationList](x: Self) {
    ...
    inline def setItems(value: js.Array[Reservation]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Reservation*): Self = StObject.set(x, "items", js.Array(value :_*))
