...
@js.native
trait ReservationList extends js.Object {
...
object ReservationList {
  ...
  @scala.inline
  implicit class ReservationListOps[Self <: ReservationList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Reservation*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Reservation]): Self = this.set("items", value.asInstanceOf[js.Any])
