...
@js.native
trait TargetPoolAggregatedList extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.TargetPoolsScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.TargetPoolAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object TargetPoolAggregatedList {
  ...
  @scala.inline
  def apply(): TargetPoolAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetPoolAggregatedList]
  }
  
  @scala.inline
  implicit class TargetPoolAggregatedListOps[Self <: TargetPoolAggregatedList] (val x: Self) extends AnyVal {
