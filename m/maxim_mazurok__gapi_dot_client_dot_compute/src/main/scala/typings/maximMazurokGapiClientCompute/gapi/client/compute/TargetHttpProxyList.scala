...
object TargetHttpProxyList {
  ...
  inline def apply(): TargetHttpProxyList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetHttpProxyList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetHttpProxyList] (val x: Self) extends AnyVal {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[TargetHttpProxy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: TargetHttpProxy*): Self = StObject.set(x, "items", js.Array(value*))
