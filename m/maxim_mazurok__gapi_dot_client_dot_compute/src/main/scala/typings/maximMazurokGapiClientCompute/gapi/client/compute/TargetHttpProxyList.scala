...
object TargetHttpProxyList {
  ...
  @scala.inline
  implicit class TargetHttpProxyListOps[Self <: TargetHttpProxyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: TargetHttpProxy*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[TargetHttpProxy]): Self = this.set("items", value.asInstanceOf[js.Any])
