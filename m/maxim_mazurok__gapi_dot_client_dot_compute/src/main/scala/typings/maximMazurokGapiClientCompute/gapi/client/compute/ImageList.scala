...
object ImageList {
  ...
  @scala.inline
  implicit class ImageListOps[Self <: ImageList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Image*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Image]): Self = this.set("items", value.asInstanceOf[js.Any])
