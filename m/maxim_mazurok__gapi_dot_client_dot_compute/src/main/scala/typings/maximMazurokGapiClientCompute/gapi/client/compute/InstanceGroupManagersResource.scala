...
import typings.maximMazurokGapiClientCompute.anon.AccesstokenAltCallbackFields
import typings.maximMazurokGapiClientCompute.anon.Alt
import typings.maximMazurokGapiClientCompute.anon.CallbackFieldsInstanceGroupManager
...
import typings.maximMazurokGapiClientCompute.anon.RequestIdResourceUploadType
import typings.maximMazurokGapiClientCompute.anon.ResourceUploadTypeUploadprotocol
...
import typings.maximMazurokGapiClientCompute.anon.UploadTypeUploadprotocolUserIp
import typings.maximMazurokGapiClientCompute.anon.UploadprotocolUserIpXgafv
import typings.maximMazurokGapiClientCompute.anon.UserIpXgafvZone
import typings.maximMazurokGapiClientCompute.anon.XgafvZone
...
trait InstanceGroupManagersResource extends StObject {
  ...
  def aggregatedList(request: Accesstoken): Request[InstanceGroupManagerAggregatedList] = js.native
  
  /** Applies changes to selected instances on the managed instance group. This method can be used to apply new overrides and/or new versions. */
  def applyUpdatesToInstances(request: InstanceGroupManagerKey): Request[Operation] = js.native
  def applyUpdatesToInstances(request: XgafvZone, body: InstanceGroupManagersApplyUpdatesRequest): Request[Operation] = js.native
  ...
  /**
    ...
    */
  def createInstances(request: CallbackFieldsInstanceGroupManager): Request[Operation] = js.native
  ...
  /**
    ...
    */
  def deleteInstances(request: FieldsInstanceGroupManagerKey): Request[Operation] = js.native
  ...
  def deletePerInstanceConfigs(request: InstanceGroupManagerKeyOauthtoken): Request[Operation] = js.native
  def deletePerInstanceConfigs(request: XgafvZone, body: InstanceGroupManagersDeletePerInstanceConfigsReq): Request[Operation] = js.native
  
  /** Returns all of the details about the specified managed instance group. Gets a list of available managed instance groups by making a list() request. */
  def get(): Request[InstanceGroupManager] = js.native
  def get(request: XgafvZone): Request[InstanceGroupManager] = js.native
  ...
  def insert(request: QuotaUser, body: InstanceGroupManager): Request[Operation] = js.native
  
  /** Retrieves a list of managed instance groups that are contained within the specified project and zone. */
  def list(): Request[InstanceGroupManagerList] = js.native
  def list(request: Alt): Request[InstanceGroupManagerList] = js.native
  ...
  /**
    ...
    */
  def patch(request: RequestIdResourceUploadType): Request[Operation] = js.native
  ...
  def patchPerInstanceConfigs(request: ResourceUploadTypeUploadprotocol): Request[Operation] = js.native
  ...
  /**
    ...
    */
  def recreateInstances(request: UploadTypeUploadprotocolUserIp): Request[Operation] = js.native
  ...
  /**
    ...
    */
  def setInstanceTemplate(request: UploadprotocolUserIpXgafv): Request[Operation] = js.native
  ...
  /**
    ...
    */
  def setTargetPools(request: UserIpXgafvZone): Request[Operation] = js.native
  ...
  def updatePerInstanceConfigs(request: AccesstokenAltCallbackFields): Request[Operation] = js.native
