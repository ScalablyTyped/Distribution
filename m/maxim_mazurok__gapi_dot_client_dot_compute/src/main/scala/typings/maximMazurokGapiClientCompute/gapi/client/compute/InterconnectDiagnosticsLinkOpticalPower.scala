...
@js.native
trait InterconnectDiagnosticsLinkOpticalPower extends js.Object {
...
object InterconnectDiagnosticsLinkOpticalPower {
  ...
  @scala.inline
  implicit class InterconnectDiagnosticsLinkOpticalPowerOps[Self <: InterconnectDiagnosticsLinkOpticalPower] (val x: Self) extends AnyVal {
