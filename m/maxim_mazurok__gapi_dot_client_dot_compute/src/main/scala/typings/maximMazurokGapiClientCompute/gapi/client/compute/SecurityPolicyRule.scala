...
@js.native
trait SecurityPolicyRule extends js.Object {
...
object SecurityPolicyRule {
  ...
  @scala.inline
  implicit class SecurityPolicyRuleOps[Self <: SecurityPolicyRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMatch(value: SecurityPolicyRuleMatcher): Self = this.set("match", value.asInstanceOf[js.Any])
