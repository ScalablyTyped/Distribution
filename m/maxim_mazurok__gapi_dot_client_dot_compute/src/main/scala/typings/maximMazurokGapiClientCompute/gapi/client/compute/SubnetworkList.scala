...
@js.native
trait SubnetworkList extends js.Object {
...
object SubnetworkList {
  ...
  @scala.inline
  implicit class SubnetworkListOps[Self <: SubnetworkList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Subnetwork*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Subnetwork]): Self = this.set("items", value.asInstanceOf[js.Any])
