...
object RouterStatus {
  ...
  implicit class RouterStatusOps[Self <: RouterStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNatStatusVarargs(value: RouterStatusNatStatus*): Self = this.set("natStatus", js.Array(value :_*))
    
    @scala.inline
    def setNatStatus(value: js.Array[RouterStatusNatStatus]): Self = this.set("natStatus", value.asInstanceOf[js.Any])
