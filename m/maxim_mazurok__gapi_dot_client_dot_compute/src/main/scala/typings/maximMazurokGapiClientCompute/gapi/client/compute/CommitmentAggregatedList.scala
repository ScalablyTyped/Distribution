...
trait CommitmentAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.CommitmentsScopedList} */ js.Any
  ] = js.undefined
...
object CommitmentAggregatedList {
  ...
  inline def apply(): CommitmentAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CommitmentAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommitmentAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.CommitmentsScopedList} */ js.Any
