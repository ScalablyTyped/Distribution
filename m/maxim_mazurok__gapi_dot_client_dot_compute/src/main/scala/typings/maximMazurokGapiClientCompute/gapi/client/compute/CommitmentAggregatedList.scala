...
trait CommitmentAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.CommitmentsScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.CommitmentAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object CommitmentAggregatedList {
  ...
  @scala.inline
  def apply(): CommitmentAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CommitmentAggregatedList]
  }
  
  @scala.inline
  implicit class CommitmentAggregatedListMutableBuilder[Self <: CommitmentAggregatedList] (val x: Self) extends AnyVal {
