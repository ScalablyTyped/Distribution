...
@js.native
trait NetworkEndpointGroupAggregatedList extends StObject {
...
object NetworkEndpointGroupAggregatedList {
  ...
  @scala.inline
  implicit class NetworkEndpointGroupAggregatedListMutableBuilder[Self <: NetworkEndpointGroupAggregatedList] (val x: Self) extends AnyVal {
