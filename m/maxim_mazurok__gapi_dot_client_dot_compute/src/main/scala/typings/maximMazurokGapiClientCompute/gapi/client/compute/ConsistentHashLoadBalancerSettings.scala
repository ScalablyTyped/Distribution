...
@js.native
trait ConsistentHashLoadBalancerSettings extends js.Object {
...
object ConsistentHashLoadBalancerSettings {
  ...
  @scala.inline
  implicit class ConsistentHashLoadBalancerSettingsOps[Self <: ConsistentHashLoadBalancerSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHttpCookie(value: ConsistentHashLoadBalancerSettingsHttpCookie): Self = this.set("httpCookie", value.asInstanceOf[js.Any])
