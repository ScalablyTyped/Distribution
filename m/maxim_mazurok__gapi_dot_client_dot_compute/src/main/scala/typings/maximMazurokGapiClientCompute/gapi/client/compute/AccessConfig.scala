...
trait AccessConfig extends StObject {
  ...
  /**
    * [Output Only] The first IPv6 address of the external IPv6 range associated with this instance, prefix length is stored in externalIpv6PrefixLength in ipv6AccessConfig. The field is
    * output only, an IPv6 address from a subnetwork associated with the instance will be allocated dynamically.
    */
  var externalIpv6: js.UndefOr[String] = js.undefined
  
  /** [Output Only] The prefix length of the external IPv6 range. */
  var externalIpv6PrefixLength: js.UndefOr[Double] = js.undefined
...
object AccessConfig {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AccessConfig] (val x: Self) extends AnyVal {
