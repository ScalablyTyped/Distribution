...
trait ExternalVpnGateway extends StObject {
  ...
  /**
    * List of interfaces for this external VPN gateway. If your peer-side gateway is an on-premises gateway and non-AWS cloud providers’ gateway, at most two interfaces can be provided
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.ExternalVpnGateway & TopLevel[Any]
  ] = js.undefined
