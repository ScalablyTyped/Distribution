...
object TargetSslProxyList {
  ...
  inline def apply(): TargetSslProxyList = {
  ...
  extension [Self <: TargetSslProxyList](x: Self) {
    ...
    inline def setItems(value: js.Array[TargetSslProxy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: TargetSslProxy*): Self = StObject.set(x, "items", js.Array(value :_*))
