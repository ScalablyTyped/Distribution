...
@js.native
trait ResourcePolicyList extends js.Object {
  ...
  var items: js.UndefOr[js.Array[ResourcePolicy]] = js.native
...
object ResourcePolicyList {
  ...
  @scala.inline
  def apply(): ResourcePolicyList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ResourcePolicyList]
  }
  
  @scala.inline
  implicit class ResourcePolicyListOps[Self <: ResourcePolicyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: ResourcePolicy*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[ResourcePolicy]): Self = this.set("items", value.asInstanceOf[js.Any])
