...
object ResourcePolicyList {
  ...
  @scala.inline
  implicit class ResourcePolicyListMutableBuilder[Self <: ResourcePolicyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[ResourcePolicy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: ResourcePolicy*): Self = StObject.set(x, "items", js.Array(value :_*))
