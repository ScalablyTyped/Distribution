...
object PathMatcher {
  ...
  extension [Self <: PathMatcher](x: Self) {
    ...
    inline def setPathRulesVarargs(value: PathRule*): Self = StObject.set(x, "pathRules", js.Array(value :_*))
    ...
    inline def setRouteRulesVarargs(value: HttpRouteRule*): Self = StObject.set(x, "routeRules", js.Array(value :_*))
  }
}
