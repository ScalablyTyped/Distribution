...
object InterconnectAttachment {
  ...
  @scala.inline
  implicit class InterconnectAttachmentMutableBuilder[Self <: InterconnectAttachment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataplaneVersion(value: Double): Self = StObject.set(x, "dataplaneVersion", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataplaneVersionUndefined: Self = StObject.set(x, "dataplaneVersion", js.undefined)
    ...
    @scala.inline
    def setPartnerMetadata(value: InterconnectAttachmentPartnerMetadata): Self = StObject.set(x, "partnerMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPartnerMetadataUndefined: Self = StObject.set(x, "partnerMetadata", js.undefined)
    
    @scala.inline
    def setPrivateInterconnectInfo(value: InterconnectAttachmentPrivateInfo): Self = StObject.set(x, "privateInterconnectInfo", value.asInstanceOf[js.Any])
