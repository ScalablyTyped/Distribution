...
object HttpRouteRuleMatch {
  ...
  extension [Self <: HttpRouteRuleMatch](x: Self) {
    ...
    inline def setHeaderMatchesVarargs(value: HttpHeaderMatch*): Self = StObject.set(x, "headerMatches", js.Array(value :_*))
    ...
    inline def setQueryParameterMatchesVarargs(value: HttpQueryParameterMatch*): Self = StObject.set(x, "queryParameterMatches", js.Array(value :_*))
