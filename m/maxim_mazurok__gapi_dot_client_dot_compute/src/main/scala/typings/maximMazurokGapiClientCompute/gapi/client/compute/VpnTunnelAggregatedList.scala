...
trait VpnTunnelAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.VpnTunnelsScopedList} */ js.Any
  ] = js.undefined
...
object VpnTunnelAggregatedList {
  ...
  inline def apply(): VpnTunnelAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VpnTunnelAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VpnTunnelAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.VpnTunnelsScopedList} */ js.Any
