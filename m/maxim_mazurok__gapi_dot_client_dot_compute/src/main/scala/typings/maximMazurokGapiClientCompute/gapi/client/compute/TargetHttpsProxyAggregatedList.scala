...
trait TargetHttpsProxyAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.TargetHttpsProxiesScopedList} */ js.Any
  ] = js.undefined
...
object TargetHttpsProxyAggregatedList {
  ...
  inline def apply(): TargetHttpsProxyAggregatedList = {
  ...
  extension [Self <: TargetHttpsProxyAggregatedList](x: Self) {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.TargetHttpsProxiesScopedList} */ js.Any
