...
trait InstanceGroupManagerAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.InstanceGroupManagersScopedList} */ js.Any
  ] = js.undefined
...
object InstanceGroupManagerAggregatedList {
  ...
  inline def apply(): InstanceGroupManagerAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceGroupManagerAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceGroupManagerAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.InstanceGroupManagersScopedList} */ js.Any
