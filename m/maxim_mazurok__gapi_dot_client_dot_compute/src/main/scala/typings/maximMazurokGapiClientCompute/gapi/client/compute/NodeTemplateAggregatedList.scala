...
trait NodeTemplateAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.NodeTemplatesScopedList} */ js.Any
  ] = js.undefined
...
object NodeTemplateAggregatedList {
  ...
  inline def apply(): NodeTemplateAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeTemplateAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeTemplateAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.NodeTemplatesScopedList} */ js.Any
