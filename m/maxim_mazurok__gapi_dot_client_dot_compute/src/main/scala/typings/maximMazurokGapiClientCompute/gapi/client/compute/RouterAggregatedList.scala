...
trait RouterAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.RoutersScopedList} */ js.Any
  ] = js.undefined
...
object RouterAggregatedList {
  ...
  inline def apply(): RouterAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RouterAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RouterAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.RoutersScopedList} */ js.Any
