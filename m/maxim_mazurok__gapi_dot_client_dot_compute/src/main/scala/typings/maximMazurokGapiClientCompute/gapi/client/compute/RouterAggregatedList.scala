...
@js.native
trait RouterAggregatedList extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.RoutersScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.RouterAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object RouterAggregatedList {
  ...
  @scala.inline
  implicit class RouterAggregatedListOps[Self <: RouterAggregatedList] (val x: Self) extends AnyVal {
