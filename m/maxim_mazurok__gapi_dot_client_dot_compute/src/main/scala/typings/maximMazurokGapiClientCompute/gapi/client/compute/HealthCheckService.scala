...
@js.native
trait HealthCheckService extends js.Object {
...
object HealthCheckService {
  ...
  @scala.inline
  implicit class HealthCheckServiceOps[Self <: HealthCheckService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHealthStatusAggregationPolicy(value: String): Self = this.set("healthStatusAggregationPolicy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHealthStatusAggregationPolicy: Self = this.set("healthStatusAggregationPolicy", js.undefined)
