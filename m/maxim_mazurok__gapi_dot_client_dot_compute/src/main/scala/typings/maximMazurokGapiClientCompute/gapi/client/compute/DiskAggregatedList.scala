...
trait DiskAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.DisksScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.DiskAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object DiskAggregatedList {
  ...
  @scala.inline
  implicit class DiskAggregatedListMutableBuilder[Self <: DiskAggregatedList] (val x: Self) extends AnyVal {
