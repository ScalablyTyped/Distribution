...
trait OperationAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.OperationsScopedList} */ js.Any
  ] = js.undefined
...
object OperationAggregatedList {
  ...
  inline def apply(): OperationAggregatedList = {
  ...
  extension [Self <: OperationAggregatedList](x: Self) {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.OperationsScopedList} */ js.Any
