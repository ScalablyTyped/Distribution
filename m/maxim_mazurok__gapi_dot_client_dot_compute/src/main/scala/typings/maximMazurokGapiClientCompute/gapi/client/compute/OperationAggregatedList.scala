...
trait OperationAggregatedList extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.OperationsScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.OperationAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object OperationAggregatedList {
  ...
  @scala.inline
  def apply(): OperationAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OperationAggregatedList]
  }
  
  @scala.inline
  implicit class OperationAggregatedListOps[Self <: OperationAggregatedList] (val x: Self) extends AnyVal {
