...
@js.native
trait ZoneList extends StObject {
...
object ZoneList {
  ...
  @scala.inline
  implicit class ZoneListMutableBuilder[Self <: ZoneList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Zone]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Zone*): Self = StObject.set(x, "items", js.Array(value :_*))
