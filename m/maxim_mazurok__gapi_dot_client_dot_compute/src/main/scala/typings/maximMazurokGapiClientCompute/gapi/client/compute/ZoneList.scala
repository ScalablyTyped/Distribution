...
object ZoneList {
  ...
  extension [Self <: ZoneList](x: Self) {
    ...
    inline def setItems(value: js.Array[Zone]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Zone*): Self = StObject.set(x, "items", js.Array(value :_*))
