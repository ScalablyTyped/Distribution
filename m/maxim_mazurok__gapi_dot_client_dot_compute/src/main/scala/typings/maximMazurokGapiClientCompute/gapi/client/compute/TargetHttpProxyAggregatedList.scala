...
@js.native
trait TargetHttpProxyAggregatedList extends js.Object {
...
object TargetHttpProxyAggregatedList {
  ...
  @scala.inline
  implicit class TargetHttpProxyAggregatedListOps[Self <: TargetHttpProxyAggregatedList] (val x: Self) extends AnyVal {
