...
@js.native
trait InstanceGroupManagersCreateInstancesRequest extends js.Object {
...
object InstanceGroupManagersCreateInstancesRequest {
  ...
  @scala.inline
  implicit class InstanceGroupManagersCreateInstancesRequestOps[Self <: InstanceGroupManagersCreateInstancesRequest] (val x: Self) extends AnyVal {
