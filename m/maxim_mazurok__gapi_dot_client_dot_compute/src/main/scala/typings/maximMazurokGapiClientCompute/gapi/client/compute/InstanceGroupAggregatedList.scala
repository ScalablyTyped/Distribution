...
trait InstanceGroupAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.InstanceGroupsScopedList} */ js.Any
  ] = js.undefined
...
object InstanceGroupAggregatedList {
  ...
  inline def apply(): InstanceGroupAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceGroupAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceGroupAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.InstanceGroupsScopedList} */ js.Any
