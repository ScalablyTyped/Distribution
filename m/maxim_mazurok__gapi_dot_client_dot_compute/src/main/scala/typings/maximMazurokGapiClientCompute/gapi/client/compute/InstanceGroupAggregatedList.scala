...
trait InstanceGroupAggregatedList extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.InstanceGroupsScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.InstanceGroupAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object InstanceGroupAggregatedList {
  ...
  @scala.inline
  def apply(): InstanceGroupAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceGroupAggregatedList]
  }
  
  @scala.inline
  implicit class InstanceGroupAggregatedListOps[Self <: InstanceGroupAggregatedList] (val x: Self) extends AnyVal {
