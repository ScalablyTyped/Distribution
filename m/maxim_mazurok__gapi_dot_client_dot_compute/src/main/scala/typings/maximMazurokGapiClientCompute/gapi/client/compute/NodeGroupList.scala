...
trait NodeGroupList extends StObject {
  ...
  var items: js.UndefOr[js.Array[NodeGroup]] = js.undefined
...
object NodeGroupList {
  ...
  inline def apply(): NodeGroupList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeGroupList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeGroupList] (val x: Self) extends AnyVal {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[NodeGroup]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: NodeGroup*): Self = StObject.set(x, "items", js.Array(value*))
