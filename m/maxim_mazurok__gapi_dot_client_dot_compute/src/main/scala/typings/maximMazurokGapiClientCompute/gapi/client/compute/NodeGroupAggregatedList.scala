...
trait NodeGroupAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.NodeGroupsScopedList} */ js.Any
  ] = js.undefined
...
object NodeGroupAggregatedList {
  ...
  inline def apply(): NodeGroupAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeGroupAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeGroupAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.NodeGroupsScopedList} */ js.Any
