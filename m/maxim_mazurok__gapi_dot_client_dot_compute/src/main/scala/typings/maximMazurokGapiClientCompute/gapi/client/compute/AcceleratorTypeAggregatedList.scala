...
trait AcceleratorTypeAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.AcceleratorTypesScopedList} */ js.Any
  ] = js.undefined
...
object AcceleratorTypeAggregatedList {
  ...
  inline def apply(): AcceleratorTypeAggregatedList = {
  ...
  implicit open class MutableBuilder[Self <: AcceleratorTypeAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.AcceleratorTypesScopedList} */ js.Any
