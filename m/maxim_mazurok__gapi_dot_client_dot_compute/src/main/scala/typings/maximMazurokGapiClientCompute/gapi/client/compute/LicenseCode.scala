...
@js.native
trait LicenseCode extends js.Object {
...
object LicenseCode {
  ...
  @scala.inline
  implicit class LicenseCodeOps[Self <: LicenseCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLicenseAliasVarargs(value: LicenseCodeLicenseAlias*): Self = this.set("licenseAlias", js.Array(value :_*))
    
    @scala.inline
    def setLicenseAlias(value: js.Array[LicenseCodeLicenseAlias]): Self = this.set("licenseAlias", value.asInstanceOf[js.Any])
