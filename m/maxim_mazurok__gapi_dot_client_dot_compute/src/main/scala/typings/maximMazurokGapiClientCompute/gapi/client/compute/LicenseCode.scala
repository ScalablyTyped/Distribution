...
trait LicenseCode extends StObject {
  ...
  var licenseAlias: js.UndefOr[js.Array[LicenseCodeLicenseAlias]] = js.undefined
...
object LicenseCode {
  ...
  extension [Self <: LicenseCode](x: Self) {
    ...
    inline def setLicenseAlias(value: js.Array[LicenseCodeLicenseAlias]): Self = StObject.set(x, "licenseAlias", value.asInstanceOf[js.Any])
