...
object FirewallList {
  ...
  @scala.inline
  implicit class FirewallListMutableBuilder[Self <: FirewallList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Firewall]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Firewall*): Self = StObject.set(x, "items", js.Array(value :_*))
