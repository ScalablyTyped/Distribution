...
trait FirewallList extends StObject {
...
object FirewallList {
  ...
  inline def apply(): FirewallList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FirewallList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FirewallList] (val x: Self) extends AnyVal {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Firewall]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Firewall*): Self = StObject.set(x, "items", js.Array(value*))
