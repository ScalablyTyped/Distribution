...
trait HealthChecksAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.HealthChecksScopedList} */ js.Any
  ] = js.undefined
...
object HealthChecksAggregatedList {
  ...
  inline def apply(): HealthChecksAggregatedList = {
  ...
  implicit open class MutableBuilder[Self <: HealthChecksAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.HealthChecksScopedList} */ js.Any
