...
@js.native
trait SecurityPolicyList extends js.Object {
...
object SecurityPolicyList {
  ...
  @scala.inline
  implicit class SecurityPolicyListOps[Self <: SecurityPolicyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SecurityPolicy*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SecurityPolicy]): Self = this.set("items", value.asInstanceOf[js.Any])
