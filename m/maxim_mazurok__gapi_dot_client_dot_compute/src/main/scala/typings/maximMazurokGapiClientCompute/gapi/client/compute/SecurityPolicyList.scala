...
trait SecurityPolicyList extends StObject {
  ...
  var items: js.UndefOr[js.Array[SecurityPolicy]] = js.undefined
...
object SecurityPolicyList {
  ...
  inline def apply(): SecurityPolicyList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SecurityPolicyList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SecurityPolicyList] (val x: Self) extends AnyVal {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[SecurityPolicy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
