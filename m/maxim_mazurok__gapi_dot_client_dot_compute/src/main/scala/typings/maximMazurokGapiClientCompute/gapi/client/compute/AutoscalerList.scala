...
trait AutoscalerList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  
  /** A list of Autoscaler resources. */
  var items: js.UndefOr[js.Array[Autoscaler]] = js.undefined
...
object AutoscalerList {
  ...
  inline def apply(): AutoscalerList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AutoscalerList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AutoscalerList] (val x: Self) extends AnyVal {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Autoscaler]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Autoscaler*): Self = StObject.set(x, "items", js.Array(value*))
