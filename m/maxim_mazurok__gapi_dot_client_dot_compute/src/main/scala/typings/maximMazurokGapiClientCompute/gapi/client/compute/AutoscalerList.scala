...
object AutoscalerList {
  ...
  @scala.inline
  def apply(): AutoscalerList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AutoscalerList]
  }
  
  @scala.inline
  implicit class AutoscalerListMutableBuilder[Self <: AutoscalerList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Autoscaler]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Autoscaler*): Self = StObject.set(x, "items", js.Array(value :_*))
