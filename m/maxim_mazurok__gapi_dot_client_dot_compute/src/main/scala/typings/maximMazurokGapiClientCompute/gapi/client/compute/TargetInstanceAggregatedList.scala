...
trait TargetInstanceAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.TargetInstancesScopedList} */ js.Any
  ] = js.undefined
...
object TargetInstanceAggregatedList {
  ...
  inline def apply(): TargetInstanceAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetInstanceAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetInstanceAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.TargetInstancesScopedList} */ js.Any
