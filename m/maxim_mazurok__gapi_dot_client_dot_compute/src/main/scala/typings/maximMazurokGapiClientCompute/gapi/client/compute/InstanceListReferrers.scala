...
@js.native
trait InstanceListReferrers extends js.Object {
...
object InstanceListReferrers {
  ...
  @scala.inline
  def apply(): InstanceListReferrers = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceListReferrers]
  }
  
  @scala.inline
  implicit class InstanceListReferrersOps[Self <: InstanceListReferrers] (val x: Self) extends AnyVal {
