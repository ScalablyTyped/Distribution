...
object AddressList {
  ...
  implicit class AddressListMutableBuilder[Self <: AddressList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Address]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Address*): Self = StObject.set(x, "items", js.Array(value :_*))
