...
object AddressList {
  ...
  extension [Self <: AddressList](x: Self) {
    ...
    inline def setItems(value: js.Array[Address]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Address*): Self = StObject.set(x, "items", js.Array(value :_*))
