...
trait TargetGrpcProxyList extends StObject {
  ...
  var items: js.UndefOr[js.Array[TargetGrpcProxy]] = js.undefined
...
object TargetGrpcProxyList {
  ...
  inline def apply(): TargetGrpcProxyList = {
  ...
  extension [Self <: TargetGrpcProxyList](x: Self) {
    ...
    inline def setItems(value: js.Array[TargetGrpcProxy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: TargetGrpcProxy*): Self = StObject.set(x, "items", js.Array(value :_*))
