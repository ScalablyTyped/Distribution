...
@js.native
trait InterconnectLocation extends js.Object {
...
object InterconnectLocation {
  ...
  @scala.inline
  implicit class InterconnectLocationOps[Self <: InterconnectLocation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRegionInfosVarargs(value: InterconnectLocationRegionInfo*): Self = this.set("regionInfos", js.Array(value :_*))
    
    @scala.inline
    def setRegionInfos(value: js.Array[InterconnectLocationRegionInfo]): Self = this.set("regionInfos", value.asInstanceOf[js.Any])
