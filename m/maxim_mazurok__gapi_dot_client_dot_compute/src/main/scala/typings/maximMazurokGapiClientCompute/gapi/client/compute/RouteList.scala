...
object RouteList {
  ...
  inline def apply(): RouteList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RouteList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RouteList] (val x: Self) extends AnyVal {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Route]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
