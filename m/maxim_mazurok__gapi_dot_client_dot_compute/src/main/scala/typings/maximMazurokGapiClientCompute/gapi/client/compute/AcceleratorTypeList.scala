...
object AcceleratorTypeList {
  ...
  @scala.inline
  implicit class AcceleratorTypeListMutableBuilder[Self <: AcceleratorTypeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[AcceleratorType]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: AcceleratorType*): Self = StObject.set(x, "items", js.Array(value :_*))
