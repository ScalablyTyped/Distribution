...
@js.native
trait NodeTemplateList extends js.Object {
...
object NodeTemplateList {
  ...
  @scala.inline
  implicit class NodeTemplateListOps[Self <: NodeTemplateList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: NodeTemplate*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[NodeTemplate]): Self = this.set("items", value.asInstanceOf[js.Any])
