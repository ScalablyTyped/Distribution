...
object RouterStatusBgpPeerStatus {
  ...
  @scala.inline
  implicit class RouterStatusBgpPeerStatusOps[Self <: RouterStatusBgpPeerStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdvertisedRoutesVarargs(value: Route*): Self = this.set("advertisedRoutes", js.Array(value :_*))
    
    @scala.inline
    def setAdvertisedRoutes(value: js.Array[Route]): Self = this.set("advertisedRoutes", value.asInstanceOf[js.Any])
