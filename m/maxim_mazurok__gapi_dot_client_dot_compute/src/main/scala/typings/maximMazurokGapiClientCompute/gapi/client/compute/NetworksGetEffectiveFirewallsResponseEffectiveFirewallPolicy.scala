...
trait NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy extends StObject {
...
object NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy {
  ...
  inline def apply(): NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy] (val x: Self) extends AnyVal {
