...
@js.native
trait PacketMirroringList extends js.Object {
...
object PacketMirroringList {
  ...
  @scala.inline
  implicit class PacketMirroringListOps[Self <: PacketMirroringList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: PacketMirroring*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[PacketMirroring]): Self = this.set("items", value.asInstanceOf[js.Any])
