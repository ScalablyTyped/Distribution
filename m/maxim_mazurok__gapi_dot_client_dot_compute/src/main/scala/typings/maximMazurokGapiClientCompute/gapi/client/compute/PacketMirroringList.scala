...
object PacketMirroringList {
  ...
  inline def apply(): PacketMirroringList = {
  ...
  extension [Self <: PacketMirroringList](x: Self) {
    ...
    inline def setItems(value: js.Array[PacketMirroring]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: PacketMirroring*): Self = StObject.set(x, "items", js.Array(value :_*))
