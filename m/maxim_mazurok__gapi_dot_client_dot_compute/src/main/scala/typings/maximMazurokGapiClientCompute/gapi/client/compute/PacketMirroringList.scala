...
trait PacketMirroringList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  
  /** A list of PacketMirroring resources. */
  var items: js.UndefOr[js.Array[PacketMirroring]] = js.undefined
...
object PacketMirroringList {
  
  @scala.inline
  def apply(): PacketMirroringList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PacketMirroringList]
  }
  
  @scala.inline
  implicit class PacketMirroringListMutableBuilder[Self <: PacketMirroringList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[PacketMirroring]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: PacketMirroring*): Self = StObject.set(x, "items", js.Array(value :_*))
