...
@js.native
trait RegionInstanceGroupManagerPatchInstanceConfigReq extends js.Object {
...
object RegionInstanceGroupManagerPatchInstanceConfigReq {
  ...
  @scala.inline
  implicit class RegionInstanceGroupManagerPatchInstanceConfigReqOps[Self <: RegionInstanceGroupManagerPatchInstanceConfigReq] (val x: Self) extends AnyVal {
