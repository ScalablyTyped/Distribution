...
trait PublicDelegatedPrefixAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.PublicDelegatedPrefixesScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.PublicDelegatedPrefixAggregatedList & TopLevel[Any]
  ] = js.undefined
