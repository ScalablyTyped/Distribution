...
object VpnGatewayList {
  ...
  @scala.inline
  implicit class VpnGatewayListMutableBuilder[Self <: VpnGatewayList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[VpnGateway]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: VpnGateway*): Self = StObject.set(x, "items", js.Array(value :_*))
