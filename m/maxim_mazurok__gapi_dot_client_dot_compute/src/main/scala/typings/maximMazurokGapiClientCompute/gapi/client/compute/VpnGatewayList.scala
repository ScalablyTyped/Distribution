...
@js.native
trait VpnGatewayList extends js.Object {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of VpnGateway resources. */
  var items: js.UndefOr[js.Array[VpnGateway]] = js.native
...
object VpnGatewayList {
  ...
  @scala.inline
  def apply(): VpnGatewayList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VpnGatewayList]
  }
  
  @scala.inline
  implicit class VpnGatewayListOps[Self <: VpnGatewayList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: VpnGateway*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[VpnGateway]): Self = this.set("items", value.asInstanceOf[js.Any])
