...
trait SubnetworkAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.SubnetworksScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.SubnetworkAggregatedList & TopLevel[js.Any]
  ] = js.undefined
...
object SubnetworkAggregatedList {
  ...
  inline def apply(): SubnetworkAggregatedList = {
