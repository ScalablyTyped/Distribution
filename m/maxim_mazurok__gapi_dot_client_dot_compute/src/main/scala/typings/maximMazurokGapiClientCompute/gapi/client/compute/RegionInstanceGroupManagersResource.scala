...
import typings.maximMazurokGapiClientCompute.anon.AltFieldsInstanceGroupManagerKeyOauthtoken
import typings.maximMazurokGapiClientCompute.anon.AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint
import typings.maximMazurokGapiClientCompute.anon.FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint
import typings.maximMazurokGapiClientCompute.anon.FieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProject
...
import typings.maximMazurokGapiClientCompute.anon.InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser
...
import typings.maximMazurokGapiClientCompute.anon.ProjectQuotaUserRegionUserIp
import typings.maximMazurokGapiClientCompute.anon.QuotaUserRegionRequestIdResourceUserIp
...
trait RegionInstanceGroupManagersResource extends StObject {
  ...
  def insert(request: typings.maximMazurokGapiClientCompute.anon.Project, body: InstanceGroupManager): Request[Operation] = js.native
