...
object RegionInstanceGroupList {
  ...
  inline def apply(): RegionInstanceGroupList = {
  ...
  extension [Self <: RegionInstanceGroupList](x: Self) {
    ...
    inline def setItems(value: js.Array[InstanceGroup]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: InstanceGroup*): Self = StObject.set(x, "items", js.Array(value :_*))
