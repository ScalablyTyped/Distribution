...
@js.native
trait ExternalVpnGatewayInterface extends js.Object {
...
object ExternalVpnGatewayInterface {
  ...
  @scala.inline
  implicit class ExternalVpnGatewayInterfaceOps[Self <: ExternalVpnGatewayInterface] (val x: Self) extends AnyVal {
