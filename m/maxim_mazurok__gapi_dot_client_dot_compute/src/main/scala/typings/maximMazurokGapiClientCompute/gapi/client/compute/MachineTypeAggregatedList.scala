...
@js.native
trait MachineTypeAggregatedList extends StObject {
...
object MachineTypeAggregatedList {
  ...
  @scala.inline
  implicit class MachineTypeAggregatedListMutableBuilder[Self <: MachineTypeAggregatedList] (val x: Self) extends AnyVal {
