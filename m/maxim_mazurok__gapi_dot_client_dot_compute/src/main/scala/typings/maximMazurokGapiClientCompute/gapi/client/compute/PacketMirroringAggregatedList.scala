...
trait PacketMirroringAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.PacketMirroringsScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.PacketMirroringAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object PacketMirroringAggregatedList {
  ...
  @scala.inline
  def apply(): PacketMirroringAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PacketMirroringAggregatedList]
  }
  
  @scala.inline
  implicit class PacketMirroringAggregatedListMutableBuilder[Self <: PacketMirroringAggregatedList] (val x: Self) extends AnyVal {
