...
trait PacketMirroringAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.PacketMirroringsScopedList} */ js.Any
  ] = js.undefined
...
object PacketMirroringAggregatedList {
  
  inline def apply(): PacketMirroringAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PacketMirroringAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PacketMirroringAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.PacketMirroringsScopedList} */ js.Any
