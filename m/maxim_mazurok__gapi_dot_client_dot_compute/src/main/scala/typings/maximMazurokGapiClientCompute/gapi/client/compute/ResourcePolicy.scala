...
object ResourcePolicy {
  ...
  implicit class ResourcePolicyOps[Self <: ResourcePolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupPlacementPolicy(value: ResourcePolicyGroupPlacementPolicy): Self = this.set("groupPlacementPolicy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGroupPlacementPolicy: Self = this.set("groupPlacementPolicy", js.undefined)
    ...
    @scala.inline
    def setSnapshotSchedulePolicy(value: ResourcePolicySnapshotSchedulePolicy): Self = this.set("snapshotSchedulePolicy", value.asInstanceOf[js.Any])
