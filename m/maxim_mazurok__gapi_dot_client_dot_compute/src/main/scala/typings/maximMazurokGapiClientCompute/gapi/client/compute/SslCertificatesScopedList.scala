...
object SslCertificatesScopedList {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SslCertificatesScopedList] (val x: Self) extends AnyVal {
    ...
    inline def setSslCertificatesVarargs(value: SslCertificate*): Self = StObject.set(x, "sslCertificates", js.Array(value*))
