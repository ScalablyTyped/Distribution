...
trait AddressAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.AddressesScopedList}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.AddressAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object AddressAggregatedList {
  ...
  @scala.inline
  implicit class AddressAggregatedListMutableBuilder[Self <: AddressAggregatedList] (val x: Self) extends AnyVal {
