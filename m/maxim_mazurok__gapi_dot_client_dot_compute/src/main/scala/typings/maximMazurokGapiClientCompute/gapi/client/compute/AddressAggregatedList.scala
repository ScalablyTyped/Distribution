...
trait AddressAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.AddressesScopedList} */ js.Any
  ] = js.undefined
...
object AddressAggregatedList {
  ...
  inline def apply(): AddressAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AddressAggregatedList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AddressAggregatedList] (val x: Self) extends AnyVal {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.AddressesScopedList} */ js.Any
