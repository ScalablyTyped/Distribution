...
import typings.maximMazurokGapiClientCompute.anon.ContainerType
...
trait Image extends StObject {
  ...
  /**
    ...
    *
    * If you do not provide an encryption key when creating the image, then the disk will be encrypted using an automatically generated key and you do not need to provide a key to use the
    * image later.
    */
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.Image with TopLevel[js.Any]
  ] = js.native
  ...
  /**
    * URL of the source disk used to create this image. This can be a full or valid partial URL. You must provide either this property or the rawDisk.source property but not both to
    * create an image. For example, the following are valid values:
...
object Image {
  ...
  implicit class ImageMutableBuilder[Self <: Image] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImageEncryptionKey(value: CustomerEncryptionKey): Self = StObject.set(x, "imageEncryptionKey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setShieldedInstanceInitialState(value: InitialStateConfig): Self = StObject.set(x, "shieldedInstanceInitialState", value.asInstanceOf[js.Any])
