...
@js.native
trait InstancesAddResourcePoliciesRequest extends js.Object {
...
object InstancesAddResourcePoliciesRequest {
  ...
  @scala.inline
  implicit class InstancesAddResourcePoliciesRequestOps[Self <: InstancesAddResourcePoliciesRequest] (val x: Self) extends AnyVal {
