...
object RequestIdTargetHttpProxy {
  ...
  inline def apply(project: String, targetHttpProxy: String): RequestIdTargetHttpProxy = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestIdTargetHttpProxy] (val x: Self) extends AnyVal {
