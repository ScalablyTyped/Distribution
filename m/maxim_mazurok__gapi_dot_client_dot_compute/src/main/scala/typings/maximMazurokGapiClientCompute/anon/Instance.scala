...
trait Instance extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.AccessConfig
...
object Instance {
  ...
  extension [Self <: Instance](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.AccessConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
