...
trait FieldsKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway = js.native
...
object FieldsKeyOauthtoken {
  ...
  implicit class FieldsKeyOauthtokenMutableBuilder[Self <: FieldsKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
