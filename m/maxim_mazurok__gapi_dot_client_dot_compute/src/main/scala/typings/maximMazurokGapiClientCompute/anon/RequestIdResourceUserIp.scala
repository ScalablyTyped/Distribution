...
object RequestIdResourceUserIp {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck): RequestIdResourceUserIp = {
  ...
  extension [Self <: RequestIdResourceUserIp](x: Self) {
