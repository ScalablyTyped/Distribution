...
object QuotaUserRequestIdResourceTargetHttpsProxy {
  ...
  inline def apply(project: String, resource: SslPolicyReference, targetHttpsProxy: String): QuotaUserRequestIdResourceTargetHttpsProxy = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserRequestIdResourceTargetHttpsProxy] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: SslPolicyReference): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
