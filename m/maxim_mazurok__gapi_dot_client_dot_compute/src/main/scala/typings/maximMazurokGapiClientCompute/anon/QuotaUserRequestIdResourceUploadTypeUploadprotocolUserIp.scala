...
trait QuotaUserRequestIdResourceUploadTypeUploadprotocolUserIp extends StObject {
...
object QuotaUserRequestIdResourceUploadTypeUploadprotocolUserIp {
  
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetGrpcProxy
  ): QuotaUserRequestIdResourceUploadTypeUploadprotocolUserIp = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserRequestIdResourceUploadTypeUploadprotocolUserIp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserRequestIdResourceUploadTypeUploadprotocolUserIp] (val x: Self) extends AnyVal {
