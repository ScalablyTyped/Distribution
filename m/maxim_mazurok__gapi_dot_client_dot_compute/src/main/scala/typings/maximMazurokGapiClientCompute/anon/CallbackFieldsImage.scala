...
trait CallbackFieldsImage extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Image
...
object CallbackFieldsImage {
  ...
  inline def apply(
    image: String,
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Image
  ): CallbackFieldsImage = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackFieldsImage] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Image): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
