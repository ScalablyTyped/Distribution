...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworksRemovePeeringRequest
...
object KeyNetworkOauthtoken {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyNetworkOauthtoken] (val x: Self) extends AnyVal {
