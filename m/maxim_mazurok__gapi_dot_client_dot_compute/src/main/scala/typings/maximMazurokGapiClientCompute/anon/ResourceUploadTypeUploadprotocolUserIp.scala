...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.ShieldedInstanceConfig
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ResourceUploadTypeUploadprotocolUserIp extends StObject {
  ...
  /** Request body */
  var resource: ShieldedInstanceConfig
...
object ResourceUploadTypeUploadprotocolUserIp {
  
  inline def apply(instance: String, project: String, resource: ShieldedInstanceConfig, zone: String): ResourceUploadTypeUploadprotocolUserIp = {
    ...
    __obj.asInstanceOf[ResourceUploadTypeUploadprotocolUserIp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceUploadTypeUploadprotocolUserIp] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ShieldedInstanceConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
