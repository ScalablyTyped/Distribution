...
@js.native
trait ResourceUrlMapUserIp extends StObject {
...
object ResourceUrlMapUserIp {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ResourceUrlMapUserIp]
  }
  
  @scala.inline
  implicit class ResourceUrlMapUserIpMutableBuilder[Self <: ResourceUrlMapUserIp] (val x: Self) extends AnyVal {
