...
@js.native
trait DiskFieldsKey extends js.Object {
...
object DiskFieldsKey {
  ...
  @scala.inline
  def apply(disk: String, project: String, region: String): DiskFieldsKey = {
  ...
  @scala.inline
  implicit class DiskFieldsKeyOps[Self <: DiskFieldsKey] (val x: Self) extends AnyVal {
