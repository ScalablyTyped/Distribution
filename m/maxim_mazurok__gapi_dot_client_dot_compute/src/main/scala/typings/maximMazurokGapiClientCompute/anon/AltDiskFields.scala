...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionDisksAddResourcePoliciesRequest
...
trait AltDiskFields extends StObject {
  ...
  /** Request body */
  var resource: RegionDisksAddResourcePoliciesRequest
...
object AltDiskFields {
  ...
  inline def apply(disk: String, project: String, region: String, resource: RegionDisksAddResourcePoliciesRequest): AltDiskFields = {
  ...
  extension [Self <: AltDiskFields](x: Self) {
    ...
    inline def setResource(value: RegionDisksAddResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
