...
object ForwardingRuleKeyOauthtoken {
  ...
  inline def apply(forwardingRule: String, project: String, resource: TargetReference): ForwardingRuleKeyOauthtoken = {
  ...
  extension [Self <: ForwardingRuleKeyOauthtoken](x: Self) {
