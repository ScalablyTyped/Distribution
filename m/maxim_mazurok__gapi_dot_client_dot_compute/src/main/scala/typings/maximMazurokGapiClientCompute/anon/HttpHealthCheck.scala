...
object HttpHealthCheck {
  ...
  @scala.inline
  def apply(httpHealthCheck: String, project: String): HttpHealthCheck = {
  ...
  @scala.inline
  implicit class HttpHealthCheckMutableBuilder[Self <: HttpHealthCheck] (val x: Self) extends AnyVal {
