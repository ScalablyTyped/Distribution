...
trait SourceFirewallPolicy extends StObject {
...
object SourceFirewallPolicy {
  
  inline def apply(firewallPolicy: String): SourceFirewallPolicy = {
    val __obj = js.Dynamic.literal(firewallPolicy = firewallPolicy.asInstanceOf[js.Any])
    __obj.asInstanceOf[SourceFirewallPolicy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SourceFirewallPolicy] (val x: Self) extends AnyVal {
