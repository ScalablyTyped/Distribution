...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersCreateInstancesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CallbackFieldsInstanceGroupManagerKey extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersCreateInstancesRequest
...
object CallbackFieldsInstanceGroupManagerKey {
  ...
  inline def apply(
  ...
  ): CallbackFieldsInstanceGroupManagerKey = {
    ...
    __obj.asInstanceOf[CallbackFieldsInstanceGroupManagerKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackFieldsInstanceGroupManagerKey] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: RegionInstanceGroupManagersCreateInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
