...
object RequestIdResource {
  ...
  inline def apply(project: String, resource: String, zone: String): RequestIdResource = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestIdResource] (val x: Self) extends AnyVal {
