...
@js.native
trait ProjectString extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy = js.native
...
object ProjectString {
  ...
  def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy
  ): ProjectString = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectString]
  }
  
  @scala.inline
  implicit class ProjectStringMutableBuilder[Self <: ProjectString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
