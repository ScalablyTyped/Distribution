...
object ProjectString {
  ...
  extension [Self <: ProjectString](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
