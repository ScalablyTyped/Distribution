...
@js.native
trait ProjectString extends js.Object {
...
object ProjectString {
  ...
  @scala.inline
  implicit class ProjectStringOps[Self <: ProjectString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy): Self = this.set("resource", value.asInstanceOf[js.Any])
