...
trait RegionRequestIdResourceUploadTypeUploadprotocolUserIp extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.VpnGateway
...
object RegionRequestIdResourceUploadTypeUploadprotocolUserIp {
  
  inline def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.VpnGateway
  ): RegionRequestIdResourceUploadTypeUploadprotocolUserIp = {
    ...
    __obj.asInstanceOf[RegionRequestIdResourceUploadTypeUploadprotocolUserIp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RegionRequestIdResourceUploadTypeUploadprotocolUserIp] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.VpnGateway): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
