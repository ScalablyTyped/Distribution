...
object PacketMirroringPrettyPrint {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PacketMirroringPrettyPrint] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.PacketMirroring): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
