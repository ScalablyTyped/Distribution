...
trait ResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway
...
object ResourceUploadType {
  ...
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway
  ): ResourceUploadType = {
  ...
  implicit open class MutableBuilder[Self <: ResourceUploadType] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
