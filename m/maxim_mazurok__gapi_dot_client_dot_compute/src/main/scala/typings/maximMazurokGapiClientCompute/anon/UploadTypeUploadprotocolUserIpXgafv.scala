...
object UploadTypeUploadprotocolUserIpXgafv {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect): UploadTypeUploadprotocolUserIpXgafv = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UploadTypeUploadprotocolUserIpXgafv] (val x: Self) extends AnyVal {
