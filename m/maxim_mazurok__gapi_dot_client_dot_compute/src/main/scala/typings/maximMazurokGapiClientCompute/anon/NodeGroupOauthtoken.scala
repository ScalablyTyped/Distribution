...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroupsDeleteNodesRequest
...
object NodeGroupOauthtoken {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeGroupOauthtoken] (val x: Self) extends AnyVal {
