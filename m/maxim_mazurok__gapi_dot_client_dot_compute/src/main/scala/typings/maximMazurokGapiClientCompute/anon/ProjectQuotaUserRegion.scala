...
trait ProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate
...
object ProjectQuotaUserRegion {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
