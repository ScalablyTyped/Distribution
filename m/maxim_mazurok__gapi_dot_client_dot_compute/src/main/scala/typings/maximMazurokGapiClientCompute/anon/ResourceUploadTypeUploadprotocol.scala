...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersPatchPerInstanceConfigsReq
...
trait ResourceUploadTypeUploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersPatchPerInstanceConfigsReq
...
object ResourceUploadTypeUploadprotocol {
  ...
  inline def apply(
    ...
    zone: String
  ): ResourceUploadTypeUploadprotocol = {
  ...
  implicit open class MutableBuilder[Self <: ResourceUploadTypeUploadprotocol] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: InstanceGroupManagersPatchPerInstanceConfigsReq): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
