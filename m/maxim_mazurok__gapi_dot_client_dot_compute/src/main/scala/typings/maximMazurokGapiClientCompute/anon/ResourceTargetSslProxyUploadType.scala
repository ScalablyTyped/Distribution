...
trait ResourceTargetSslProxyUploadType extends StObject {
...
object ResourceTargetSslProxyUploadType {
  
  inline def apply(project: String, resource: SslPolicyReference, targetSslProxy: String): ResourceTargetSslProxyUploadType = {
    ...
    __obj.asInstanceOf[ResourceTargetSslProxyUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceTargetSslProxyUploadType] (val x: Self) extends AnyVal {
