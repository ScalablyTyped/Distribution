...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.UsageExportLocation
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait QuotaUserRequestIdResourceUploadTypeUploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: UsageExportLocation
...
object QuotaUserRequestIdResourceUploadTypeUploadprotocol {
  
  inline def apply(project: String, resource: UsageExportLocation): QuotaUserRequestIdResourceUploadTypeUploadprotocol = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserRequestIdResourceUploadTypeUploadprotocol]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserRequestIdResourceUploadTypeUploadprotocol] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: UsageExportLocation): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
