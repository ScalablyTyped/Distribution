...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroupsAttachEndpointsRequest
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait KeyNetworkEndpointGroupOauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: NetworkEndpointGroupsAttachEndpointsRequest = js.native
...
object KeyNetworkEndpointGroupOauthtoken {
  ...
  @scala.inline
  implicit class KeyNetworkEndpointGroupOauthtokenOps[Self <: KeyNetworkEndpointGroupOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NetworkEndpointGroupsAttachEndpointsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
