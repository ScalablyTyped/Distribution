...
object KeyNetworkEndpointGroupOauthtoken {
  ...
  @scala.inline
  implicit class KeyNetworkEndpointGroupOauthtokenMutableBuilder[Self <: KeyNetworkEndpointGroupOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NetworkEndpointGroupsAttachEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
