...
object KeyOauthtokenPrettyPrintProjectQuotaUserRequestId {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Route): KeyOauthtokenPrettyPrintProjectQuotaUserRequestId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyOauthtokenPrettyPrintProjectQuotaUserRequestId] (val x: Self) extends AnyVal {
