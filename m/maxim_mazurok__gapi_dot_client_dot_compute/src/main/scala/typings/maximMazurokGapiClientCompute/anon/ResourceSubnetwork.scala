...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.SubnetworksExpandIpCidrRangeRequest
...
object ResourceSubnetwork {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceSubnetwork] (val x: Self) extends AnyVal {
