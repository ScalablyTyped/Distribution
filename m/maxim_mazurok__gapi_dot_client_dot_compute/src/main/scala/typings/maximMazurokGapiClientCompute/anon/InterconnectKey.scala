...
object InterconnectKey {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InterconnectKey] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
