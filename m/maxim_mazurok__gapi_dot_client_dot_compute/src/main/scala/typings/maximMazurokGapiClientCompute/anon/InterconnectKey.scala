...
@js.native
trait InterconnectKey extends js.Object {
...
object InterconnectKey {
  ...
  @scala.inline
  implicit class InterconnectKeyOps[Self <: InterconnectKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect): Self = this.set("resource", value.asInstanceOf[js.Any])
