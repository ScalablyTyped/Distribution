...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersUpdatePerInstanceConfigsReq
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AccesstokenAltCallbackFields extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersUpdatePerInstanceConfigsReq
...
object AccesstokenAltCallbackFields {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AccesstokenAltCallbackFields] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: InstanceGroupManagersUpdatePerInstanceConfigsReq): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
