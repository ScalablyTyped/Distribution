...
@js.native
trait NotificationEndpoint extends StObject {
  ...
  var notificationEndpoint: String = js.native
...
object NotificationEndpoint {
  ...
  @scala.inline
  def apply(notificationEndpoint: String, project: String, region: String): NotificationEndpoint = {
    val __obj = js.Dynamic.literal(notificationEndpoint = notificationEndpoint.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[NotificationEndpoint]
  }
  
  @scala.inline
  implicit class NotificationEndpointMutableBuilder[Self <: NotificationEndpoint] (val x: Self) extends AnyVal {
