...
trait UploadprotocolUserIp extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicy
...
object UploadprotocolUserIp {
  
  inline def apply(
    firewallPolicy: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicy
  ): UploadprotocolUserIp = {
    val __obj = js.Dynamic.literal(firewallPolicy = firewallPolicy.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[UploadprotocolUserIp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UploadprotocolUserIp] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
