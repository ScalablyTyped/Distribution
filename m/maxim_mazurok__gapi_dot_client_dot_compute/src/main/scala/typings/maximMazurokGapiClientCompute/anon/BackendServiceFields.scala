...
@js.native
trait BackendServiceFields extends StObject {
...
object BackendServiceFields {
  ...
  @scala.inline
  def apply(backendService: String, keyName: String, project: String): BackendServiceFields = {
  ...
  @scala.inline
  implicit class BackendServiceFieldsMutableBuilder[Self <: BackendServiceFields] (val x: Self) extends AnyVal {
