...
trait FilterInstance extends StObject {
...
object FilterInstance {
  ...
  @scala.inline
  def apply(instance: String, project: String, zone: String): FilterInstance = {
    ...
    __obj.asInstanceOf[FilterInstance]
  }
  
  @scala.inline
  implicit class FilterInstanceMutableBuilder[Self <: FilterInstance] (val x: Self) extends AnyVal {
