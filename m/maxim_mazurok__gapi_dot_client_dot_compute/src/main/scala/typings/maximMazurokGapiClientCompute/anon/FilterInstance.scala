...
object FilterInstance {
  ...
  inline def apply(instance: String, project: String, zone: String): FilterInstance = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FilterInstance] (val x: Self) extends AnyVal {
