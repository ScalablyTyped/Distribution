...
trait AccesstokenAltCallbackFieldsKeyOauthtoken extends StObject {
...
object AccesstokenAltCallbackFieldsKeyOauthtoken {
  
  inline def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslCertificate
  ): AccesstokenAltCallbackFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AccesstokenAltCallbackFieldsKeyOauthtoken]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AccesstokenAltCallbackFieldsKeyOauthtoken] (val x: Self) extends AnyVal {
