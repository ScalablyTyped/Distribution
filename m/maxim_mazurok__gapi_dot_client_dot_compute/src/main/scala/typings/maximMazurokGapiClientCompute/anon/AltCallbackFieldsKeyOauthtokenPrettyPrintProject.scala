...
trait AltCallbackFieldsKeyOauthtokenPrettyPrintProject extends StObject {
...
object AltCallbackFieldsKeyOauthtokenPrettyPrintProject {
  
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy
  ): AltCallbackFieldsKeyOauthtokenPrettyPrintProject = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltCallbackFieldsKeyOauthtokenPrettyPrintProject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AltCallbackFieldsKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
