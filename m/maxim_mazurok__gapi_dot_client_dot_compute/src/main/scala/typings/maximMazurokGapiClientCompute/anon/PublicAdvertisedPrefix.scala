...
object PublicAdvertisedPrefix {
  ...
  inline def apply(project: String, publicAdvertisedPrefix: String): PublicAdvertisedPrefix = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PublicAdvertisedPrefix] (val x: Self) extends AnyVal {
