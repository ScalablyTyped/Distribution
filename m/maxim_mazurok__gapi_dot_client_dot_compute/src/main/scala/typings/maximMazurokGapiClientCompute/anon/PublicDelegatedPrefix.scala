...
object PublicDelegatedPrefix {
  ...
  inline def apply(project: String, publicDelegatedPrefix: String): PublicDelegatedPrefix = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], publicDelegatedPrefix = publicDelegatedPrefix.asInstanceOf[js.Any])
