...
trait UploadTypeUploadprotocolUserIp extends StObject {
...
object UploadTypeUploadprotocolUserIp {
  ...
  inline def apply(
    ...
    zone: String
  ): UploadTypeUploadprotocolUserIp = {
    ...
    __obj.asInstanceOf[UploadTypeUploadprotocolUserIp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UploadTypeUploadprotocolUserIp] (val x: Self) extends AnyVal {
