...
trait FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.VpnTunnel
...
object FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion {
  
  inline def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.VpnTunnel
  ): FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion = {
    ...
    __obj.asInstanceOf[FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.VpnTunnel): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
