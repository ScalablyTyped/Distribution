...
@js.native
trait PrettyPrintProjectQuotaUserRegionRequestId extends js.Object {
...
object PrettyPrintProjectQuotaUserRegionRequestId {
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRegionRequestIdOps[Self <: PrettyPrintProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService): Self = this.set("resource", value.asInstanceOf[js.Any])
