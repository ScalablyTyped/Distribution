...
@js.native
trait PrettyPrintProjectQuotaUserRegionRequestId extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object PrettyPrintProjectQuotaUserRegionRequestId {
  
  @scala.inline
  def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService
  ): PrettyPrintProjectQuotaUserRegionRequestId = {
    ...
    __obj.asInstanceOf[PrettyPrintProjectQuotaUserRegionRequestId]
  }
  
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRegionRequestIdMutableBuilder[Self <: PrettyPrintProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
