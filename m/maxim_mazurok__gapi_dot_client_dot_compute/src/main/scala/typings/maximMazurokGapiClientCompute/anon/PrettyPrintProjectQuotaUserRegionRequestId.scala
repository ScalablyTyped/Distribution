...
trait PrettyPrintProjectQuotaUserRegionRequestId extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager
...
object PrettyPrintProjectQuotaUserRegionRequestId {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PrettyPrintProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
