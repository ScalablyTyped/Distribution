...
trait AutoscalerFieldsKey extends StObject {
...
object AutoscalerFieldsKey {
  
  @scala.inline
  def apply(project: String, region: String): AutoscalerFieldsKey = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[AutoscalerFieldsKey]
  }
  
  @scala.inline
  implicit class AutoscalerFieldsKeyMutableBuilder[Self <: AutoscalerFieldsKey] (val x: Self) extends AnyVal {
