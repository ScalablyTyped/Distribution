...
object FieldsKeyNetworkEndpointGroupOauthtoken {
  ...
  inline def apply(networkEndpointGroup: String, project: String, region: String): FieldsKeyNetworkEndpointGroupOauthtoken = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsKeyNetworkEndpointGroupOauthtoken] (val x: Self) extends AnyVal {
