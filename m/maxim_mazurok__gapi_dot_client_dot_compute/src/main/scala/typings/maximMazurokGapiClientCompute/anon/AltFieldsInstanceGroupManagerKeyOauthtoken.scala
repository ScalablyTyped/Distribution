...
@js.native
trait AltFieldsInstanceGroupManagerKeyOauthtoken extends js.Object {
...
object AltFieldsInstanceGroupManagerKeyOauthtoken {
  ...
  @scala.inline
  implicit class AltFieldsInstanceGroupManagerKeyOauthtokenOps[Self <: AltFieldsInstanceGroupManagerKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersAbandonInstancesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
