...
@js.native
trait AltFieldsInstanceGroupManagerKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersAbandonInstancesRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object AltFieldsInstanceGroupManagerKeyOauthtoken {
  ...
  def apply(
  ...
  ): AltFieldsInstanceGroupManagerKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AltFieldsInstanceGroupManagerKeyOauthtoken]
  }
  
  @scala.inline
  implicit class AltFieldsInstanceGroupManagerKeyOauthtokenMutableBuilder[Self <: AltFieldsInstanceGroupManagerKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersAbandonInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
