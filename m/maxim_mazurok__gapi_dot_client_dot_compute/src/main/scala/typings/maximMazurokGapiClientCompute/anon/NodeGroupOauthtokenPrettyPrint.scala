...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroupsSetNodeTemplateRequest
...
object NodeGroupOauthtokenPrettyPrint {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeGroupOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
