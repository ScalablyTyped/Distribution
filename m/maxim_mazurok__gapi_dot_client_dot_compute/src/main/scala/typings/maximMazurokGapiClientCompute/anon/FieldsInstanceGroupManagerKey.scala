...
@js.native
trait FieldsInstanceGroupManagerKey extends js.Object {
  ...
  /** Request body */
  var resource: InstanceGroupManagersCreateInstancesRequest = js.native
...
object FieldsInstanceGroupManagerKey {
  ...
  @scala.inline
  implicit class FieldsInstanceGroupManagerKeyOps[Self <: FieldsInstanceGroupManagerKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersCreateInstancesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
