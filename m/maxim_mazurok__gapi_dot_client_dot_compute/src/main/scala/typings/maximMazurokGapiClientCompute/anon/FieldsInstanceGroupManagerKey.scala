...
object FieldsInstanceGroupManagerKey {
  ...
  @scala.inline
  implicit class FieldsInstanceGroupManagerKeyMutableBuilder[Self <: FieldsInstanceGroupManagerKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersCreateInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
