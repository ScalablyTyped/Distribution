...
object PrettyPrintPriority {
  ...
  inline def apply(firewallPolicy: String, resource: FirewallPolicyRule): PrettyPrintPriority = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PrettyPrintPriority] (val x: Self) extends AnyVal {
