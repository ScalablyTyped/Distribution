...
object PrettyPrintProjectString {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap): PrettyPrintProjectString = {
  ...
  extension [Self <: PrettyPrintProjectString](x: Self) {
