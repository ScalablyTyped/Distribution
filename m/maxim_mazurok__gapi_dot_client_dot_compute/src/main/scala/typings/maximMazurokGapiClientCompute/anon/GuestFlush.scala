...
@js.native
trait GuestFlush extends js.Object {
...
object GuestFlush {
  ...
  @scala.inline
  implicit class GuestFlushOps[Self <: GuestFlush] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot): Self = this.set("resource", value.asInstanceOf[js.Any])
