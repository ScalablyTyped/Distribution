...
@js.native
trait GuestFlush extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot = js.native
...
object GuestFlush {
  ...
  def apply(
    ...
    __obj.asInstanceOf[GuestFlush]
  }
  
  @scala.inline
  implicit class GuestFlushMutableBuilder[Self <: GuestFlush] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
