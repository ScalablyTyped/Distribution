...
object ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslPolicy): ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol] (val x: Self) extends AnyVal {
