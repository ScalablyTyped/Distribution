...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.CacheInvalidationRule
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait RequestIdResourceUrlMap extends js.Object {
  ...
  /** Request body */
  var resource: CacheInvalidationRule = js.native
...
object RequestIdResourceUrlMap {
  ...
  @scala.inline
  implicit class RequestIdResourceUrlMapOps[Self <: RequestIdResourceUrlMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CacheInvalidationRule): Self = this.set("resource", value.asInstanceOf[js.Any])
