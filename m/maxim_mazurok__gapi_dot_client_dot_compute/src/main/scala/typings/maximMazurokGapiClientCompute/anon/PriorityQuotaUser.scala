...
trait PriorityQuotaUser extends StObject {
...
object PriorityQuotaUser {
  
  inline def apply(firewallPolicy: String): PriorityQuotaUser = {
    val __obj = js.Dynamic.literal(firewallPolicy = firewallPolicy.asInstanceOf[js.Any])
    __obj.asInstanceOf[PriorityQuotaUser]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PriorityQuotaUser] (val x: Self) extends AnyVal {
