...
trait AccesstokenAltCallback extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Firewall
...
object AccesstokenAltCallback {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Firewall): AccesstokenAltCallback = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AccesstokenAltCallback] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Firewall): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
