...
@js.native
trait KeyNodeGroup extends StObject {
  ...
  var nodeGroup: String = js.native
...
object KeyNodeGroup {
  ...
  @scala.inline
  def apply(nodeGroup: String, project: String, zone: String): KeyNodeGroup = {
    val __obj = js.Dynamic.literal(nodeGroup = nodeGroup.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyNodeGroup]
  }
  
  @scala.inline
  implicit class KeyNodeGroupMutableBuilder[Self <: KeyNodeGroup] (val x: Self) extends AnyVal {
