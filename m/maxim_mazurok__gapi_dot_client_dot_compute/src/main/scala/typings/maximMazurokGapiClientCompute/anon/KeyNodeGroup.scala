...
object KeyNodeGroup {
  ...
  inline def apply(nodeGroup: String, project: String, zone: String): KeyNodeGroup = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyNodeGroup] (val x: Self) extends AnyVal {
