...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetPoolsRemoveHealthCheckRequest
...
object RequestIdResourceTargetPool {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestIdResourceTargetPool] (val x: Self) extends AnyVal {
