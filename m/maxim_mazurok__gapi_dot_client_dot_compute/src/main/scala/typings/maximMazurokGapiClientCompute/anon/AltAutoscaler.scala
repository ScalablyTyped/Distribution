...
trait AltAutoscaler extends StObject {
...
object AltAutoscaler {
  ...
  inline def apply(autoscaler: String, project: String, region: String): AltAutoscaler = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AltAutoscaler] (val x: Self) extends AnyVal {
