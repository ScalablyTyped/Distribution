...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicyReference
...
trait OauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: SecurityPolicyReference
...
object OauthtokenPrettyPrint {
  ...
  inline def apply(backendService: String, project: String, resource: SecurityPolicyReference): OauthtokenPrettyPrint = {
  ...
  implicit open class MutableBuilder[Self <: OauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: SecurityPolicyReference): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
