...
trait ProjectQuotaUserRequestId extends StObject {
...
object ProjectQuotaUserRequestId {
  
  @scala.inline
  def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule
  ): ProjectQuotaUserRequestId = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectQuotaUserRequestId]
  }
  
  @scala.inline
  implicit class ProjectQuotaUserRequestIdMutableBuilder[Self <: ProjectQuotaUserRequestId] (val x: Self) extends AnyVal {
