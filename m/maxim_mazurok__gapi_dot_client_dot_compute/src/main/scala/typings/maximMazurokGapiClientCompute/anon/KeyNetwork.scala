...
trait KeyNetwork extends StObject {
...
object KeyNetwork {
  ...
  inline def apply(network: String, project: String): KeyNetwork = {
    val __obj = js.Dynamic.literal(network = network.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyNetwork]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyNetwork] (val x: Self) extends AnyVal {
