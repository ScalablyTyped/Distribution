...
object OauthtokenPrettyPrintProject {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck): OauthtokenPrettyPrintProject = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
