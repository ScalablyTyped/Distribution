...
object FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap): FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId] (val x: Self) extends AnyVal {
