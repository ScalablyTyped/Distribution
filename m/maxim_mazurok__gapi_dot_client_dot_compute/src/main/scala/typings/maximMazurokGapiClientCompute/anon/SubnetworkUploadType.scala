...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.SubnetworksSetPrivateIpGoogleAccessRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait SubnetworkUploadType extends StObject {
  ...
  /** Request body */
  var resource: SubnetworksSetPrivateIpGoogleAccessRequest
...
object SubnetworkUploadType {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[SubnetworkUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SubnetworkUploadType] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: SubnetworksSetPrivateIpGoogleAccessRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
