...
@js.native
trait QuotaUserRegionUserIp extends StObject {
...
object QuotaUserRegionUserIp {
  
  @scala.inline
  def apply(disk: String, project: String, region: String): QuotaUserRegionUserIp = {
    ...
    __obj.asInstanceOf[QuotaUserRegionUserIp]
  }
  
  @scala.inline
  implicit class QuotaUserRegionUserIpMutableBuilder[Self <: QuotaUserRegionUserIp] (val x: Self) extends AnyVal {
