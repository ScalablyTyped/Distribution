...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstancesRemoveResourcePoliciesRequest
...
object FieldsInstanceKey {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsInstanceKey] (val x: Self) extends AnyVal {
