...
trait RequestIdResourceUploadTypeUploadprotocolUserIp extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.PublicAdvertisedPrefix
...
object RequestIdResourceUploadTypeUploadprotocolUserIp {
  ...
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.PublicAdvertisedPrefix
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestIdResourceUploadTypeUploadprotocolUserIp] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.PublicAdvertisedPrefix): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
