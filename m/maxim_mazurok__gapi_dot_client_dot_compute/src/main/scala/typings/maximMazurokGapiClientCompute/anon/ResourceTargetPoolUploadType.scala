...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetPoolsRemoveInstanceRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ResourceTargetPoolUploadType extends StObject {
  ...
  /** Request body */
  var resource: TargetPoolsRemoveInstanceRequest
...
object ResourceTargetPoolUploadType {
  
  inline def apply(project: String, region: String, resource: TargetPoolsRemoveInstanceRequest, targetPool: String): ResourceTargetPoolUploadType = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], targetPool = targetPool.asInstanceOf[js.Any])
    __obj.asInstanceOf[ResourceTargetPoolUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceTargetPoolUploadType] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: TargetPoolsRemoveInstanceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
