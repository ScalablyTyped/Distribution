...
@js.native
trait FieldsKeyNetwork extends js.Object {
...
object FieldsKeyNetwork {
  ...
  @scala.inline
  implicit class FieldsKeyNetworkOps[Self <: FieldsKeyNetwork] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Network): Self = this.set("resource", value.asInstanceOf[js.Any])
