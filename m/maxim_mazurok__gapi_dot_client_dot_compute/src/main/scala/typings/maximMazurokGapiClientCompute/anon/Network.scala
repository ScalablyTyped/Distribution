...
trait Network extends StObject {
  ...
  /** Request body */
  var resource: NetworksAddPeeringRequest = js.native
...
object Network {
  ...
  @scala.inline
  def apply(network: String, project: String, resource: NetworksAddPeeringRequest): Network = {
  ...
  implicit class NetworkMutableBuilder[Self <: Network] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NetworksAddPeeringRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
