...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworksAddPeeringRequest
...
trait Network extends StObject {
  ...
  /** Request body */
  var resource: NetworksAddPeeringRequest
...
object Network {
  ...
  inline def apply(network: String, project: String, resource: NetworksAddPeeringRequest): Network = {
  ...
  extension [Self <: Network](x: Self) {
    ...
    inline def setResource(value: NetworksAddPeeringRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
