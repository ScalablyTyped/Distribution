...
trait RegionRequestIdUploadType extends StObject {
...
object RegionRequestIdUploadType {
  
  inline def apply(instanceGroupManager: String, project: String, region: String): RegionRequestIdUploadType = {
    ...
    __obj.asInstanceOf[RegionRequestIdUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RegionRequestIdUploadType] (val x: Self) extends AnyVal {
