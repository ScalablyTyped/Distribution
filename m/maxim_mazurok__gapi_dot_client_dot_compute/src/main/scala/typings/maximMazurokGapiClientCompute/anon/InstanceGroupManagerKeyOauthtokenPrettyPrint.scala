...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersRecreateInstancesRequest
...
@js.native
trait InstanceGroupManagerKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersRecreateInstancesRequest = js.native
...
object InstanceGroupManagerKeyOauthtokenPrettyPrint {
  ...
  def apply(
    ...
    zone: String
  ): InstanceGroupManagerKeyOauthtokenPrettyPrint = {
  ...
  @scala.inline
  implicit class InstanceGroupManagerKeyOauthtokenPrettyPrintMutableBuilder[Self <: InstanceGroupManagerKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersRecreateInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
