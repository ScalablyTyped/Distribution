...
@js.native
trait InstanceGroupManagerKeyOauthtokenPrettyPrint extends js.Object {
...
object InstanceGroupManagerKeyOauthtokenPrettyPrint {
  ...
  @scala.inline
  implicit class InstanceGroupManagerKeyOauthtokenPrettyPrintOps[Self <: InstanceGroupManagerKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersRecreateInstancesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
