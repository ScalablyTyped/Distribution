...
trait InstanceGroupManagerKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagerDeleteInstanceConfigReq
...
object InstanceGroupManagerKeyOauthtokenPrettyPrint {
  ...
  implicit open class MutableBuilder[Self <: InstanceGroupManagerKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: RegionInstanceGroupManagerDeleteInstanceConfigReq): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
