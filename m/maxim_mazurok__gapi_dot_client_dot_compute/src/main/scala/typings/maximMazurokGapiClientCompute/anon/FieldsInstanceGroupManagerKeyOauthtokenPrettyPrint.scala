...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersSetTemplateRequest
...
trait FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersSetTemplateRequest
...
object FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: RegionInstanceGroupManagersSetTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
