...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpsProxiesSetQuicOverrideRequest
...
object ResourceTargetHttpsProxyUploadType {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceTargetHttpsProxyUploadType] (val x: Self) extends AnyVal {
