...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetMachineResourcesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AltCallbackFieldsInstance extends StObject {
  ...
  /** Request body */
  var resource: InstancesSetMachineResourcesRequest
...
object AltCallbackFieldsInstance {
  
  inline def apply(instance: String, project: String, resource: InstancesSetMachineResourcesRequest, zone: String): AltCallbackFieldsInstance = {
    ...
    __obj.asInstanceOf[AltCallbackFieldsInstance]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AltCallbackFieldsInstance] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: InstancesSetMachineResourcesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
