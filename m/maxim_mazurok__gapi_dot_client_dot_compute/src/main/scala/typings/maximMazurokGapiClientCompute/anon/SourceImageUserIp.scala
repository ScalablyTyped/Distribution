...
trait SourceImageUserIp extends StObject {
...
object SourceImageUserIp {
  
  @scala.inline
  def apply(project: String, region: String): SourceImageUserIp = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[SourceImageUserIp]
  }
  
  @scala.inline
  implicit class SourceImageUserIpMutableBuilder[Self <: SourceImageUserIp] (val x: Self) extends AnyVal {
