...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxiesSetProxyHeaderRequest
...
object TargetSslProxyUploadType {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetSslProxyUploadType] (val x: Self) extends AnyVal {
