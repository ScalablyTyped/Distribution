...
object KeyOauthtokenPrettyPrintProjectQuotaUserRequestIdResource {
  ...
  inline def apply(project: String, resource: UsageExportLocation): KeyOauthtokenPrettyPrintProjectQuotaUserRequestIdResource = {
  ...
  extension [Self <: KeyOauthtokenPrettyPrintProjectQuotaUserRequestIdResource](x: Self) {
