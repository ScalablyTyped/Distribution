...
trait UserIpValidateOnly extends StObject {
...
object UserIpValidateOnly {
  
  inline def apply(project: String, region: String): UserIpValidateOnly = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[UserIpValidateOnly]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UserIpValidateOnly] (val x: Self) extends AnyVal {
