...
@js.native
trait RegionTargetPool extends js.Object {
...
object RegionTargetPool {
  ...
  @scala.inline
  def apply(project: String, region: String, targetPool: String): RegionTargetPool = {
  ...
  @scala.inline
  implicit class RegionTargetPoolOps[Self <: RegionTargetPool] (val x: Self) extends AnyVal {
