...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.ProjectsDisableXpnResourceRequest
...
object FieldsKeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  inline def apply(project: String, resource: ProjectsDisableXpnResourceRequest): FieldsKeyOauthtokenPrettyPrintProjectQuotaUser = {
