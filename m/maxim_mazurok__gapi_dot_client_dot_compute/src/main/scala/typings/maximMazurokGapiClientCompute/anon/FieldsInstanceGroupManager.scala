...
@js.native
trait FieldsInstanceGroupManager extends js.Object {
...
object FieldsInstanceGroupManager {
  ...
  @scala.inline
  def apply(instanceGroupManager: String, project: String, zone: String): FieldsInstanceGroupManager = {
  ...
  @scala.inline
  implicit class FieldsInstanceGroupManagerOps[Self <: FieldsInstanceGroupManager] (val x: Self) extends AnyVal {
