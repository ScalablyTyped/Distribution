...
@js.native
trait OrderByPageToken extends StObject {
...
object OrderByPageToken {
  
  @scala.inline
  def apply(instanceGroup: String, project: String, region: String): OrderByPageToken = {
  ...
  @scala.inline
  implicit class OrderByPageTokenMutableBuilder[Self <: OrderByPageToken] (val x: Self) extends AnyVal {
