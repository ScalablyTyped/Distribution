...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceMoveRequest
...
@js.native
trait PrettyPrintProjectQuotaUserRequestIdResourceUserIp extends StObject {
  ...
  /** Request body */
  var resource: InstanceMoveRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object PrettyPrintProjectQuotaUserRequestIdResourceUserIp {
  
  @scala.inline
  def apply(project: String, resource: InstanceMoveRequest): PrettyPrintProjectQuotaUserRequestIdResourceUserIp = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[PrettyPrintProjectQuotaUserRequestIdResourceUserIp]
  }
  
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRequestIdResourceUserIpMutableBuilder[Self <: PrettyPrintProjectQuotaUserRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceMoveRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
