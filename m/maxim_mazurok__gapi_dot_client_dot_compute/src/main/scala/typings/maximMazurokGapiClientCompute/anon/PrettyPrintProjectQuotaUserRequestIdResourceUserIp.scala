...
@js.native
trait PrettyPrintProjectQuotaUserRequestIdResourceUserIp extends js.Object {
...
object PrettyPrintProjectQuotaUserRequestIdResourceUserIp {
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRequestIdResourceUserIpOps[Self <: PrettyPrintProjectQuotaUserRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceMoveRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
