...
object PrettyPrintProjectQuotaUserRequestIdResourceUserIp {
  ...
  inline def apply(project: String, resource: InstanceMoveRequest): PrettyPrintProjectQuotaUserRequestIdResourceUserIp = {
  ...
  extension [Self <: PrettyPrintProjectQuotaUserRequestIdResourceUserIp](x: Self) {
