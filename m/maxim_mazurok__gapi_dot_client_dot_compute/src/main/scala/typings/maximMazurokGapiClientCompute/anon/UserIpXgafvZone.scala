...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersSetTargetPoolsRequest
...
object UserIpXgafvZone {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UserIpXgafvZone] (val x: Self) extends AnyVal {
