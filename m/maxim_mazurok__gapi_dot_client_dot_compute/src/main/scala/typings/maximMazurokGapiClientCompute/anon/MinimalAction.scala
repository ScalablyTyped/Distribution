...
@js.native
trait MinimalAction extends js.Object {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Instance = js.native
...
object MinimalAction {
  ...
  def apply(
    instance: String,
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Instance,
    zone: String
  ): MinimalAction = {
  ...
  @scala.inline
  implicit class MinimalActionOps[Self <: MinimalAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Instance): Self = this.set("resource", value.asInstanceOf[js.Any])
