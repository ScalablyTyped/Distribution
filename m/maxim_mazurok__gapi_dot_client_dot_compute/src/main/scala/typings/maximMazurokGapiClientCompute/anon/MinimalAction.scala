...
object MinimalAction {
  ...
  extension [Self <: MinimalAction](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Instance): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
