...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionDisksRemoveResourcePoliciesRequest
...
trait DiskFieldsKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: RegionDisksRemoveResourcePoliciesRequest
...
object DiskFieldsKeyOauthtoken {
  ...
  inline def apply(disk: String, project: String, region: String, resource: RegionDisksRemoveResourcePoliciesRequest): DiskFieldsKeyOauthtoken = {
  ...
  extension [Self <: DiskFieldsKeyOauthtoken](x: Self) {
    ...
    inline def setResource(value: RegionDisksRemoveResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
