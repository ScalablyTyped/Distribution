...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicyRule
...
object FieldsFirewallPolicy {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsFirewallPolicy] (val x: Self) extends AnyVal {
