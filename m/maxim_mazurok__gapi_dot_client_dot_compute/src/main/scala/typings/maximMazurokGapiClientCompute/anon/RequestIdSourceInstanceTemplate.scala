...
@js.native
trait RequestIdSourceInstanceTemplate extends js.Object {
...
object RequestIdSourceInstanceTemplate {
  ...
  @scala.inline
  implicit class RequestIdSourceInstanceTemplateOps[Self <: RequestIdSourceInstanceTemplate] (val x: Self) extends AnyVal {
