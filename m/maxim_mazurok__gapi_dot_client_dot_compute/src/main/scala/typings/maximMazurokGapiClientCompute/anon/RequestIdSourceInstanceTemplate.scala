...
object RequestIdSourceInstanceTemplate {
  ...
  inline def apply(project: String, zone: String): RequestIdSourceInstanceTemplate = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestIdSourceInstanceTemplate] (val x: Self) extends AnyVal {
