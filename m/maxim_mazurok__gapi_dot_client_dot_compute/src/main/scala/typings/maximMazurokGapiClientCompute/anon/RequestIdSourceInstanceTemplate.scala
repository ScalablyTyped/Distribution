...
trait RequestIdSourceInstanceTemplate extends StObject {
...
object RequestIdSourceInstanceTemplate {
  
  @scala.inline
  def apply(project: String, zone: String): RequestIdSourceInstanceTemplate = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdSourceInstanceTemplate]
  }
  
  @scala.inline
  implicit class RequestIdSourceInstanceTemplateMutableBuilder[Self <: RequestIdSourceInstanceTemplate] (val x: Self) extends AnyVal {
