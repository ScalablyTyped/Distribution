...
trait AccesstokenAltAutoscaler extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler
...
object AccesstokenAltAutoscaler {
  
  inline def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler
  ): AccesstokenAltAutoscaler = {
    ...
    __obj.asInstanceOf[AccesstokenAltAutoscaler]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AccesstokenAltAutoscaler] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
