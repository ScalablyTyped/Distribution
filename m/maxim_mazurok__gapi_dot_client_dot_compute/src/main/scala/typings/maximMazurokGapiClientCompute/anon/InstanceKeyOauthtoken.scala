...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetLabelsRequest
...
object InstanceKeyOauthtoken {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceKeyOauthtoken] (val x: Self) extends AnyVal {
