...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupsSetNamedPortsRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AltCallbackFieldsInstanceGroup extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupsSetNamedPortsRequest
...
object AltCallbackFieldsInstanceGroup {
  ...
  inline def apply(
  ...
  ): AltCallbackFieldsInstanceGroup = {
    ...
    __obj.asInstanceOf[AltCallbackFieldsInstanceGroup]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AltCallbackFieldsInstanceGroup] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: RegionInstanceGroupsSetNamedPortsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
