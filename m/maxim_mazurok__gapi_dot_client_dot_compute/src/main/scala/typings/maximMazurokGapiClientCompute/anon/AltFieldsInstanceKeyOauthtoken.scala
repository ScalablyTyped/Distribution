...
object AltFieldsInstanceKeyOauthtoken {
  ...
  inline def apply(instance: String, project: String, resource: InstancesSetServiceAccountRequest, zone: String): AltFieldsInstanceKeyOauthtoken = {
  ...
  extension [Self <: AltFieldsInstanceKeyOauthtoken](x: Self) {
