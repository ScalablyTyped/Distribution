...
@js.native
trait AltFieldsInstanceKeyOauthtoken extends js.Object {
...
object AltFieldsInstanceKeyOauthtoken {
  ...
  @scala.inline
  implicit class AltFieldsInstanceKeyOauthtokenOps[Self <: AltFieldsInstanceKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetServiceAccountRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
