...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetServiceAccountRequest
...
@js.native
trait AltFieldsInstanceKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: InstancesSetServiceAccountRequest = js.native
...
object AltFieldsInstanceKeyOauthtoken {
  
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesSetServiceAccountRequest, zone: String): AltFieldsInstanceKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AltFieldsInstanceKeyOauthtoken]
  }
  
  @scala.inline
  implicit class AltFieldsInstanceKeyOauthtokenMutableBuilder[Self <: AltFieldsInstanceKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetServiceAccountRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
