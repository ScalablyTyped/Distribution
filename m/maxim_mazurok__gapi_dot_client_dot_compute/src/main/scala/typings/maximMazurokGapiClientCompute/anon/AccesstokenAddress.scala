...
trait AccesstokenAddress extends StObject {
...
object AccesstokenAddress {
  
  inline def apply(address: String, project: String): AccesstokenAddress = {
    val __obj = js.Dynamic.literal(address = address.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AccesstokenAddress]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AccesstokenAddress] (val x: Self) extends AnyVal {
