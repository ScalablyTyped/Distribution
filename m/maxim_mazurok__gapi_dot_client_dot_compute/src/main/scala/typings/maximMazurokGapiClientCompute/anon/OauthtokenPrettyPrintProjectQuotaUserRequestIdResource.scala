...
object OauthtokenPrettyPrintProjectQuotaUserRequestIdResource {
  ...
  ): OauthtokenPrettyPrintProjectQuotaUserRequestIdResource = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OauthtokenPrettyPrintProjectQuotaUserRequestIdResource] (val x: Self) extends AnyVal {
