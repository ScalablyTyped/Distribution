...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.DiskMoveRequest
...
object OauthtokenPrettyPrintProjectQuotaUserRequestIdResource {
  ...
  inline def apply(project: String, resource: DiskMoveRequest): OauthtokenPrettyPrintProjectQuotaUserRequestIdResource = {
  ...
  extension [Self <: OauthtokenPrettyPrintProjectQuotaUserRequestIdResource](x: Self) {
    ...
    inline def setResource(value: DiskMoveRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
