...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersAbandonInstancesRequest
...
trait InstanceGroupManager extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersAbandonInstancesRequest = js.native
...
object InstanceGroupManager {
  ...
  implicit class InstanceGroupManagerMutableBuilder[Self <: InstanceGroupManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersAbandonInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
