...
trait InstanceGroupManager extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersAbandonInstancesRequest
...
object InstanceGroupManager {
  ...
  extension [Self <: InstanceGroupManager](x: Self) {
    ...
    inline def setResource(value: InstanceGroupManagersAbandonInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
