...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstancesAddResourcePoliciesRequest
...
trait FieldsInstance extends StObject {
  ...
  /** Request body */
  var resource: InstancesAddResourcePoliciesRequest = js.native
...
object FieldsInstance {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesAddResourcePoliciesRequest, zone: String): FieldsInstance = {
  ...
  implicit class FieldsInstanceMutableBuilder[Self <: FieldsInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesAddResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
