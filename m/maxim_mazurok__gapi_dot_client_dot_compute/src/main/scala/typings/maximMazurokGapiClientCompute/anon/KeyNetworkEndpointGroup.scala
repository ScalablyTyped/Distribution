...
object KeyNetworkEndpointGroup {
  ...
  inline def apply(networkEndpointGroup: String, project: String): KeyNetworkEndpointGroup = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyNetworkEndpointGroup] (val x: Self) extends AnyVal {
