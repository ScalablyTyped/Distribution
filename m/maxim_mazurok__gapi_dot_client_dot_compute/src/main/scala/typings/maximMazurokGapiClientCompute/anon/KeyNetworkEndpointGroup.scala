...
@js.native
trait KeyNetworkEndpointGroup extends StObject {
...
object KeyNetworkEndpointGroup {
  
  @scala.inline
  def apply(networkEndpointGroup: String, project: String): KeyNetworkEndpointGroup = {
    ...
    __obj.asInstanceOf[KeyNetworkEndpointGroup]
  }
  
  @scala.inline
  implicit class KeyNetworkEndpointGroupMutableBuilder[Self <: KeyNetworkEndpointGroup] (val x: Self) extends AnyVal {
