...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersAbandonInstancesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AltCallbackFieldsInstanceGroupManager extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersAbandonInstancesRequest
...
object AltCallbackFieldsInstanceGroupManager {
  ...
  inline def apply(
  ...
  ): AltCallbackFieldsInstanceGroupManager = {
    ...
    __obj.asInstanceOf[AltCallbackFieldsInstanceGroupManager]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AltCallbackFieldsInstanceGroupManager] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: RegionInstanceGroupManagersAbandonInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
