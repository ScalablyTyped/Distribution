...
object OptionsRequestedPolicyVersionPrettyPrint {
  ...
  inline def apply(project: String, region: String, resource: String): OptionsRequestedPolicyVersionPrettyPrint = {
  ...
  extension [Self <: OptionsRequestedPolicyVersionPrettyPrint](x: Self) {
