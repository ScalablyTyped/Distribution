...
object OptionsRequestedPolicyVersionPrettyPrint {
  ...
  inline def apply(project: String, resource: String): OptionsRequestedPolicyVersionPrettyPrint = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OptionsRequestedPolicyVersionPrettyPrint] (val x: Self) extends AnyVal {
