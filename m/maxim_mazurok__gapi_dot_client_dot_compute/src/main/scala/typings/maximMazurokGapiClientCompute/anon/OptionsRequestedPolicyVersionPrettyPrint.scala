...
@js.native
trait OptionsRequestedPolicyVersionPrettyPrint extends js.Object {
...
object OptionsRequestedPolicyVersionPrettyPrint {
  ...
  @scala.inline
  implicit class OptionsRequestedPolicyVersionPrettyPrintOps[Self <: OptionsRequestedPolicyVersionPrettyPrint] (val x: Self) extends AnyVal {
