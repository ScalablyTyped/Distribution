...
trait AutoscalerFields extends StObject {
...
object AutoscalerFields {
  ...
  inline def apply(autoscaler: String, project: String, region: String): AutoscalerFields = {
  ...
  extension [Self <: AutoscalerFields](x: Self) {
