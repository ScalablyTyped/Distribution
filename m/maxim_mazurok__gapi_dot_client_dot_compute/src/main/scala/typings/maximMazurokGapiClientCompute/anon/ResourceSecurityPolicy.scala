...
@js.native
trait ResourceSecurityPolicy extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicy = js.native
...
object ResourceSecurityPolicy {
  
  @scala.inline
  def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicy,
    securityPolicy: String
  ): ResourceSecurityPolicy = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], securityPolicy = securityPolicy.asInstanceOf[js.Any])
    __obj.asInstanceOf[ResourceSecurityPolicy]
  }
  
  @scala.inline
  implicit class ResourceSecurityPolicyMutableBuilder[Self <: ResourceSecurityPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
