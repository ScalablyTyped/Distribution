...
@js.native
trait ResourceSecurityPolicy extends js.Object {
...
object ResourceSecurityPolicy {
  ...
  @scala.inline
  implicit class ResourceSecurityPolicyOps[Self <: ResourceSecurityPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicy): Self = this.set("resource", value.asInstanceOf[js.Any])
