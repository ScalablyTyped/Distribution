...
object ResourceSecurityPolicy {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceSecurityPolicy] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
