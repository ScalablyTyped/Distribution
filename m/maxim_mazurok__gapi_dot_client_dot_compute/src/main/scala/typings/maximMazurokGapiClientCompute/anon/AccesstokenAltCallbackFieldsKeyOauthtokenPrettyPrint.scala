...
trait AccesstokenAltCallbackFieldsKeyOauthtokenPrettyPrint extends StObject {
...
object AccesstokenAltCallbackFieldsKeyOauthtokenPrettyPrint {
  
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpsProxy
  ): AccesstokenAltCallbackFieldsKeyOauthtokenPrettyPrint = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AccesstokenAltCallbackFieldsKeyOauthtokenPrettyPrint]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AccesstokenAltCallbackFieldsKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpsProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
