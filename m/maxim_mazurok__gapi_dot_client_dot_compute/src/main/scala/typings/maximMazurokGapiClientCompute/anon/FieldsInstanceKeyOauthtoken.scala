...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetMachineTypeRequest
...
@js.native
trait FieldsInstanceKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: InstancesSetMachineTypeRequest = js.native
...
object FieldsInstanceKeyOauthtoken {
  
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesSetMachineTypeRequest, zone: String): FieldsInstanceKeyOauthtoken = {
    ...
    __obj.asInstanceOf[FieldsInstanceKeyOauthtoken]
  }
  
  @scala.inline
  implicit class FieldsInstanceKeyOauthtokenMutableBuilder[Self <: FieldsInstanceKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetMachineTypeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
