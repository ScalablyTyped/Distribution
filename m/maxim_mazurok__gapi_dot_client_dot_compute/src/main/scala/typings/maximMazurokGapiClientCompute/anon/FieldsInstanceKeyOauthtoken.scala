...
object FieldsInstanceKeyOauthtoken {
  ...
  inline def apply(instance: String, project: String, resource: InstancesSetMachineTypeRequest, zone: String): FieldsInstanceKeyOauthtoken = {
  ...
  extension [Self <: FieldsInstanceKeyOauthtoken](x: Self) {
    ...
    inline def setResource(value: InstancesSetMachineTypeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
