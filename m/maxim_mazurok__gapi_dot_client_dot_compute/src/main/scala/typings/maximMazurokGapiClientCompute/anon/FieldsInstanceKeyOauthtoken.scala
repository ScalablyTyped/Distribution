...
@js.native
trait FieldsInstanceKeyOauthtoken extends js.Object {
...
object FieldsInstanceKeyOauthtoken {
  ...
  @scala.inline
  implicit class FieldsInstanceKeyOauthtokenOps[Self <: FieldsInstanceKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetMachineTypeRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
