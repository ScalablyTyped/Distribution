...
object FieldsInstanceKeyOauthtoken {
  ...
  inline def apply(instance: String, project: String, resource: Metadata, zone: String): FieldsInstanceKeyOauthtoken = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsInstanceKeyOauthtoken] (val x: Self) extends AnyVal {
