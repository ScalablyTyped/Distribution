...
trait Alt extends StObject {
  ...
  /**
    ...
    */
  var includeAllScopes: js.UndefOr[Boolean] = js.native
...
object Alt {
  ...
  implicit class AltMutableBuilder[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeAllScopes(value: Boolean): Self = StObject.set(x, "includeAllScopes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIncludeAllScopesUndefined: Self = StObject.set(x, "includeAllScopes", js.undefined)
