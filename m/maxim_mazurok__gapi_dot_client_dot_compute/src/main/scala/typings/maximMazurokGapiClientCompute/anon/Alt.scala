...
object Alt {
  ...
  implicit class AltOps[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeAllScopes(value: Boolean): Self = this.set("includeAllScopes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIncludeAllScopes: Self = this.set("includeAllScopes", js.undefined)
