...
@js.native
trait UserIpZone extends js.Object {
...
object UserIpZone {
  ...
  @scala.inline
  implicit class UserIpZoneOps[Self <: UserIpZone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DisksResizeRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
