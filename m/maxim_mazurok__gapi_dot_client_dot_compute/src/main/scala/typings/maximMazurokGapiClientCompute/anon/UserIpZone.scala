...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.DisksResizeRequest
...
@js.native
trait UserIpZone extends StObject {
  ...
  /** Request body */
  var resource: DisksResizeRequest = js.native
...
object UserIpZone {
  ...
  @scala.inline
  def apply(disk: String, project: String, resource: DisksResizeRequest, zone: String): UserIpZone = {
    ...
    __obj.asInstanceOf[UserIpZone]
  }
  
  @scala.inline
  implicit class UserIpZoneMutableBuilder[Self <: UserIpZone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DisksResizeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
