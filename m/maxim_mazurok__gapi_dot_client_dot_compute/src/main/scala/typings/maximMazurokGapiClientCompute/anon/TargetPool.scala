...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetPoolsAddHealthCheckRequest
...
trait TargetPool extends StObject {
  ...
  /** Request body */
  var resource: TargetPoolsAddHealthCheckRequest = js.native
...
object TargetPool {
  ...
  @scala.inline
  def apply(project: String, region: String, resource: TargetPoolsAddHealthCheckRequest, targetPool: String): TargetPool = {
  ...
  implicit class TargetPoolMutableBuilder[Self <: TargetPool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TargetPoolsAddHealthCheckRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
