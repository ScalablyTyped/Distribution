...
@js.native
trait AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser extends js.Object {
...
object AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  @scala.inline
  implicit class AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserOps[Self <: AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Metadata): Self = this.set("resource", value.asInstanceOf[js.Any])
