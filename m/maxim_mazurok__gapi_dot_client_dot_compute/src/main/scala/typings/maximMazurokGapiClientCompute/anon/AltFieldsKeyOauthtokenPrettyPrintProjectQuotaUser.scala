...
@js.native
trait AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: Metadata = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser {
  
  @scala.inline
  def apply(project: String, resource: Metadata): AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser]
  }
  
  @scala.inline
  implicit class AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserMutableBuilder[Self <: AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Metadata): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
