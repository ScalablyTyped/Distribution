...
object AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  inline def apply(project: String, resource: Metadata): AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser = {
  ...
  extension [Self <: AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser](x: Self) {
