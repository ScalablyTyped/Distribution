...
trait UploadprotocolUserIpXgafvZone extends StObject {
...
object UploadprotocolUserIpXgafvZone {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[UploadprotocolUserIpXgafvZone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UploadprotocolUserIpXgafvZone] (val x: Self) extends AnyVal {
