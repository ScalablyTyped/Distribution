...
object FieldsInitialNodeCount {
  ...
  inline def apply(initialNodeCount: Double, project: String, zone: String): FieldsInitialNodeCount = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsInitialNodeCount] (val x: Self) extends AnyVal {
