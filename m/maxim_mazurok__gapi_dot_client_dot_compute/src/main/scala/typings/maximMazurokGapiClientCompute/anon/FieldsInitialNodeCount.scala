...
@js.native
trait FieldsInitialNodeCount extends StObject {
  ...
  var initialNodeCount: Double = js.native
...
object FieldsInitialNodeCount {
  
  @scala.inline
  def apply(initialNodeCount: Double, project: String, zone: String): FieldsInitialNodeCount = {
    val __obj = js.Dynamic.literal(initialNodeCount = initialNodeCount.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsInitialNodeCount]
  }
  
  @scala.inline
  implicit class FieldsInitialNodeCountMutableBuilder[Self <: FieldsInitialNodeCount] (val x: Self) extends AnyVal {
