...
@js.native
trait ResourceTargetTcpProxy extends js.Object {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy = js.native
...
object ResourceTargetTcpProxy {
  ...
  def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy
  ): ResourceTargetTcpProxy = {
  ...
  @scala.inline
  implicit class ResourceTargetTcpProxyOps[Self <: ResourceTargetTcpProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy): Self = this.set("resource", value.asInstanceOf[js.Any])
