...
object ResourceTargetTcpProxy {
  ...
  @scala.inline
  implicit class ResourceTargetTcpProxyMutableBuilder[Self <: ResourceTargetTcpProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
