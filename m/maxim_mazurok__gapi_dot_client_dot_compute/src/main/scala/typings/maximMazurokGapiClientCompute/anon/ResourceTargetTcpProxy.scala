...
object ResourceTargetTcpProxy {
  ...
  extension [Self <: ResourceTargetTcpProxy](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
