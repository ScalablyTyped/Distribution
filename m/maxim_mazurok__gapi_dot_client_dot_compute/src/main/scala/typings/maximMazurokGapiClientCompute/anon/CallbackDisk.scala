...
trait CallbackDisk extends StObject {
...
object CallbackDisk {
  ...
  inline def apply(disk: String, project: String, zone: String): CallbackDisk = {
    ...
    __obj.asInstanceOf[CallbackDisk]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackDisk] (val x: Self) extends AnyVal {
