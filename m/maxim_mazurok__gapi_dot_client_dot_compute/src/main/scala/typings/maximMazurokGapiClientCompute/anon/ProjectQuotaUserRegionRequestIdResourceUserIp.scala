...
object ProjectQuotaUserRegionRequestIdResourceUserIp {
  ...
  extension [Self <: ProjectQuotaUserRegionRequestIdResourceUserIp](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
