...
@js.native
trait ProjectQuotaUserRegionRequestIdResourceUserIp extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object ProjectQuotaUserRegionRequestIdResourceUserIp {
  
  @scala.inline
  def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint
  ): ProjectQuotaUserRegionRequestIdResourceUserIp = {
    ...
    __obj.asInstanceOf[ProjectQuotaUserRegionRequestIdResourceUserIp]
  }
  
  @scala.inline
  implicit class ProjectQuotaUserRegionRequestIdResourceUserIpMutableBuilder[Self <: ProjectQuotaUserRegionRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
