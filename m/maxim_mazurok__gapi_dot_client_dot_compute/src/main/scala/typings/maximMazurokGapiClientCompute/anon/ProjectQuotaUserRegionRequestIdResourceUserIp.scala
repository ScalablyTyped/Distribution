...
@js.native
trait ProjectQuotaUserRegionRequestIdResourceUserIp extends js.Object {
...
object ProjectQuotaUserRegionRequestIdResourceUserIp {
  ...
  @scala.inline
  implicit class ProjectQuotaUserRegionRequestIdResourceUserIpOps[Self <: ProjectQuotaUserRegionRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint): Self = this.set("resource", value.asInstanceOf[js.Any])
