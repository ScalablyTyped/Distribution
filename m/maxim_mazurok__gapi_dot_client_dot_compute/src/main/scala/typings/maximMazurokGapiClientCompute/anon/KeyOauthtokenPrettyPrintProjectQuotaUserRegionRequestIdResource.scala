...
trait KeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdResource extends StObject {
...
object KeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdResource {
  ...
  def apply(
  ...
  ): KeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdResource = {
    ...
    __obj.asInstanceOf[KeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdResource]
  }
  
  @scala.inline
  implicit class KeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdResourceMutableBuilder[Self <: KeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
