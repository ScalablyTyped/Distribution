...
trait FieldsInstanceGroupKeyOauthtoken extends StObject {
...
object FieldsInstanceGroupKeyOauthtoken {
  
  @scala.inline
  def apply(instanceGroup: String, project: String, region: String): FieldsInstanceGroupKeyOauthtoken = {
    ...
    __obj.asInstanceOf[FieldsInstanceGroupKeyOauthtoken]
  }
  
  @scala.inline
  implicit class FieldsInstanceGroupKeyOauthtokenMutableBuilder[Self <: FieldsInstanceGroupKeyOauthtoken] (val x: Self) extends AnyVal {
