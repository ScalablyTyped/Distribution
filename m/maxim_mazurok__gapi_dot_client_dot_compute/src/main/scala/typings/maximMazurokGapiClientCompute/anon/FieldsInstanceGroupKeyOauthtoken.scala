...
@js.native
trait FieldsInstanceGroupKeyOauthtoken extends js.Object {
...
object FieldsInstanceGroupKeyOauthtoken {
  ...
  @scala.inline
  implicit class FieldsInstanceGroupKeyOauthtokenOps[Self <: FieldsInstanceGroupKeyOauthtoken] (val x: Self) extends AnyVal {
