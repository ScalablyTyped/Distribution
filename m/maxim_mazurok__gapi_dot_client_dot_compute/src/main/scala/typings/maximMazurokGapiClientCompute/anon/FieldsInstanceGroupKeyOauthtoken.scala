...
object FieldsInstanceGroupKeyOauthtoken {
  ...
  inline def apply(instanceGroup: String, project: String, region: String): FieldsInstanceGroupKeyOauthtoken = {
  ...
  extension [Self <: FieldsInstanceGroupKeyOauthtoken](x: Self) {
