...
object Address {
  ...
  inline def apply(address: String, project: String, region: String): Address = {
    val __obj = js.Dynamic.literal(address = address.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
