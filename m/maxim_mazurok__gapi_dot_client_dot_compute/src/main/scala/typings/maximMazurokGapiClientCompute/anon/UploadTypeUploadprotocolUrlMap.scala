...
trait UploadTypeUploadprotocolUrlMap extends StObject {
...
object UploadTypeUploadprotocolUrlMap {
  
  inline def apply(project: String, region: String, resource: RegionUrlMapsValidateRequest, urlMap: String): UploadTypeUploadprotocolUrlMap = {
    ...
    __obj.asInstanceOf[UploadTypeUploadprotocolUrlMap]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UploadTypeUploadprotocolUrlMap] (val x: Self) extends AnyVal {
