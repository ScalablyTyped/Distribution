...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.DisksRemoveResourcePoliciesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ProjectQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: DisksRemoveResourcePoliciesRequest
...
object ProjectQuotaUser {
  
  inline def apply(disk: String, project: String, resource: DisksRemoveResourcePoliciesRequest, zone: String): ProjectQuotaUser = {
    ...
    __obj.asInstanceOf[ProjectQuotaUser]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: DisksRemoveResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
