...
object RegionRequestId {
  ...
  inline def apply(project: String, region: String, resource: String): RegionRequestId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RegionRequestId] (val x: Self) extends AnyVal {
