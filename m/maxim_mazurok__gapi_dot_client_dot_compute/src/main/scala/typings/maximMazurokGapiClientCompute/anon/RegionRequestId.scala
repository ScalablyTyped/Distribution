...
@js.native
trait RegionRequestId extends StObject {
...
object RegionRequestId {
  
  @scala.inline
  def apply(project: String, region: String): RegionRequestId = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[RegionRequestId]
  }
  
  @scala.inline
  implicit class RegionRequestIdMutableBuilder[Self <: RegionRequestId] (val x: Self) extends AnyVal {
