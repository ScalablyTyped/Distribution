...
@js.native
trait QuotaUserRegionRequestId extends StObject {
...
object QuotaUserRegionRequestId {
  ...
  def apply(
    ...
    __obj.asInstanceOf[QuotaUserRegionRequestId]
  }
  
  @scala.inline
  implicit class QuotaUserRegionRequestIdMutableBuilder[Self <: QuotaUserRegionRequestId] (val x: Self) extends AnyVal {
