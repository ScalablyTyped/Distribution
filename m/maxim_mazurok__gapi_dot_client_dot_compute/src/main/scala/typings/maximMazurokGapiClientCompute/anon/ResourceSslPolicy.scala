...
object ResourceSslPolicy {
  ...
  extension [Self <: ResourceSslPolicy](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
