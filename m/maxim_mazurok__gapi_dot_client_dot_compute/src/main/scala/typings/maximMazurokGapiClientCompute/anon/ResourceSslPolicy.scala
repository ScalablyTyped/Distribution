...
@js.native
trait ResourceSslPolicy extends js.Object {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslPolicy = js.native
...
object ResourceSslPolicy {
  ...
  def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslPolicy,
    sslPolicy: String
  ): ResourceSslPolicy = {
  ...
  @scala.inline
  implicit class ResourceSslPolicyOps[Self <: ResourceSslPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslPolicy): Self = this.set("resource", value.asInstanceOf[js.Any])
