...
object ResourceTargetHttpProxy {
  ...
  inline def apply(project: String, region: String, resource: UrlMapReference, targetHttpProxy: String): ResourceTargetHttpProxy = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceTargetHttpProxy] (val x: Self) extends AnyVal {
