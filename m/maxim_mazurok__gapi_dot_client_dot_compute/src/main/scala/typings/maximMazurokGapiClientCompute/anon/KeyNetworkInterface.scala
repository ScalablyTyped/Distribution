...
@js.native
trait KeyNetworkInterface extends js.Object {
...
object KeyNetworkInterface {
  ...
  @scala.inline
  implicit class KeyNetworkInterfaceOps[Self <: KeyNetworkInterface] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface): Self = this.set("resource", value.asInstanceOf[js.Any])
