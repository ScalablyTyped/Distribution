...
@js.native
trait KeyNetworkInterface extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface = js.native
...
object KeyNetworkInterface {
  ...
  def apply(
    ...
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface,
    zone: String
  ): KeyNetworkInterface = {
    val __obj = js.Dynamic.literal(instance = instance.asInstanceOf[js.Any], networkInterface = networkInterface.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyNetworkInterface]
  }
  
  @scala.inline
  implicit class KeyNetworkInterfaceMutableBuilder[Self <: KeyNetworkInterface] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
