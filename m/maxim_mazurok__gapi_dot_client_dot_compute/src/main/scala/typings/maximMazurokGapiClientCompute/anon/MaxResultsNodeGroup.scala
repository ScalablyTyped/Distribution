...
object MaxResultsNodeGroup {
  ...
  inline def apply(nodeGroup: String, project: String, zone: String): MaxResultsNodeGroup = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MaxResultsNodeGroup] (val x: Self) extends AnyVal {
