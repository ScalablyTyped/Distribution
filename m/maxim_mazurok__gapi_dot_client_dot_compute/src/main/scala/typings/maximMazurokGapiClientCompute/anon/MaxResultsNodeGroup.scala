...
@js.native
trait MaxResultsNodeGroup extends StObject {
...
object MaxResultsNodeGroup {
  
  @scala.inline
  def apply(nodeGroup: String, project: String, zone: String): MaxResultsNodeGroup = {
    ...
    __obj.asInstanceOf[MaxResultsNodeGroup]
  }
  
  @scala.inline
  implicit class MaxResultsNodeGroupMutableBuilder[Self <: MaxResultsNodeGroup] (val x: Self) extends AnyVal {
