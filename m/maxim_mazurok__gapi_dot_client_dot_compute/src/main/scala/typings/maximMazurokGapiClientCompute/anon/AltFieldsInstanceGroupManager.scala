...
object AltFieldsInstanceGroupManager {
  ...
  inline def apply(instanceGroupManager: String, project: String, zone: String): AltFieldsInstanceGroupManager = {
  ...
  extension [Self <: AltFieldsInstanceGroupManager](x: Self) {
