...
@js.native
trait AltFieldsInstanceGroupManager extends StObject {
...
object AltFieldsInstanceGroupManager {
  
  @scala.inline
  def apply(instanceGroupManager: String, project: String, zone: String): AltFieldsInstanceGroupManager = {
    ...
    __obj.asInstanceOf[AltFieldsInstanceGroupManager]
  }
  
  @scala.inline
  implicit class AltFieldsInstanceGroupManagerMutableBuilder[Self <: AltFieldsInstanceGroupManager] (val x: Self) extends AnyVal {
