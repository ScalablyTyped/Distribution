...
@js.native
trait AltFieldsInstanceGroupManager extends js.Object {
...
object AltFieldsInstanceGroupManager {
  ...
  @scala.inline
  implicit class AltFieldsInstanceGroupManagerOps[Self <: AltFieldsInstanceGroupManager] (val x: Self) extends AnyVal {
