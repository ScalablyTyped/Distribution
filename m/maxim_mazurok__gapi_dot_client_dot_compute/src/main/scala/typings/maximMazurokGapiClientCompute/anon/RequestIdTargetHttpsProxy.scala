...
@js.native
trait RequestIdTargetHttpsProxy extends js.Object {
...
object RequestIdTargetHttpsProxy {
  ...
  @scala.inline
  def apply(project: String, targetHttpsProxy: String): RequestIdTargetHttpsProxy = {
  ...
  @scala.inline
  implicit class RequestIdTargetHttpsProxyOps[Self <: RequestIdTargetHttpsProxy] (val x: Self) extends AnyVal {
