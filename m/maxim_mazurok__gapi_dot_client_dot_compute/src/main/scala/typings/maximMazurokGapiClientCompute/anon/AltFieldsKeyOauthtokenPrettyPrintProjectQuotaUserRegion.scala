...
object AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  extension [Self <: AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.ResourcePolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
