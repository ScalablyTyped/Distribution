...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.DisplayDevice
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait RequestIdResourceUploadTypeUploadprotocol extends StObject {
...
object RequestIdResourceUploadTypeUploadprotocol {
  
  inline def apply(instance: String, project: String, resource: DisplayDevice, zone: String): RequestIdResourceUploadTypeUploadprotocol = {
    ...
    __obj.asInstanceOf[RequestIdResourceUploadTypeUploadprotocol]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestIdResourceUploadTypeUploadprotocol] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: DisplayDevice): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
