...
object QuotaUserRequestIdResourceUserIp {
  ...
  inline def apply(instance: String, project: String, resource: InstancesSetMinCpuPlatformRequest, zone: String): QuotaUserRequestIdResourceUserIp = {
  ...
  extension [Self <: QuotaUserRequestIdResourceUserIp](x: Self) {
