...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxiesSetProxyHeaderRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TargetTcpProxyUploadType extends StObject {
  ...
  /** Request body */
  var resource: TargetTcpProxiesSetProxyHeaderRequest
  
  /** Name of the TargetTcpProxy resource whose ProxyHeader is to be set. */
  var targetTcpProxy: String
...
object TargetTcpProxyUploadType {
  
  inline def apply(project: String, resource: TargetTcpProxiesSetProxyHeaderRequest, targetTcpProxy: String): TargetTcpProxyUploadType = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], targetTcpProxy = targetTcpProxy.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: TargetTcpProxyUploadType] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: TargetTcpProxiesSetProxyHeaderRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
