...
object TargetVpnGateway {
  ...
  inline def apply(project: String, region: String, targetVpnGateway: String): TargetVpnGateway = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetVpnGateway] (val x: Self) extends AnyVal {
