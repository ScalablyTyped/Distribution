...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.DeprecationStatus
...
object FieldsImage {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsImage] (val x: Self) extends AnyVal {
