...
@js.native
trait DrainTimeoutSeconds extends js.Object {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Subnetwork = js.native
...
object DrainTimeoutSeconds {
  ...
  @scala.inline
  implicit class DrainTimeoutSecondsOps[Self <: DrainTimeoutSeconds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Subnetwork): Self = this.set("resource", value.asInstanceOf[js.Any])
