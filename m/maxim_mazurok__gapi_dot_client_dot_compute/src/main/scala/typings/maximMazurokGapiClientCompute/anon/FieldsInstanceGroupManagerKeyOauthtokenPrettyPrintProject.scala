...
@js.native
trait FieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProject extends js.Object {
...
object FieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit class FieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProjectOps[Self <: FieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersRecreateRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
