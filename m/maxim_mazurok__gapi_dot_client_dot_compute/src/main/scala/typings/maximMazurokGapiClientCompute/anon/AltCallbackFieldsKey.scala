...
trait AltCallbackFieldsKey extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroup
...
object AltCallbackFieldsKey {
  ...
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroup,
    zone: String
  ): AltCallbackFieldsKey = {
  ...
  extension [Self <: AltCallbackFieldsKey](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
