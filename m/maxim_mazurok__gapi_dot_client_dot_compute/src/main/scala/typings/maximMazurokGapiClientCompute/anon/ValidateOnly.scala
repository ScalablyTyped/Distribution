...
trait ValidateOnly extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment
...
object ValidateOnly {
  ...
  extension [Self <: ValidateOnly](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
