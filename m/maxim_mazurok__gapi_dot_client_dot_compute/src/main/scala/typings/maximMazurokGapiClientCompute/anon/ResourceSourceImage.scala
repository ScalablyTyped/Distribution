...
trait ResourceSourceImage extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Disk
...
object ResourceSourceImage {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Disk
  ): ResourceSourceImage = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceSourceImage] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Disk): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
