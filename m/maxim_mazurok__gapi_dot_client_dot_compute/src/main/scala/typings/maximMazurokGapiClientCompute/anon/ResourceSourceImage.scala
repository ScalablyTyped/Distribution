...
trait ResourceSourceImage extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Disk = js.native
...
object ResourceSourceImage {
  ...
  implicit class ResourceSourceImageMutableBuilder[Self <: ResourceSourceImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Disk): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
