...
object InstanceGroupManagerKeyOauthtoken {
  ...
  @scala.inline
  implicit class InstanceGroupManagerKeyOauthtokenMutableBuilder[Self <: InstanceGroupManagerKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersDeleteInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
