...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersDeleteInstancesRequest
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait InstanceGroupManagerKeyOauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: InstanceGroupManagersDeleteInstancesRequest = js.native
...
object InstanceGroupManagerKeyOauthtoken {
  ...
  @scala.inline
  implicit class InstanceGroupManagerKeyOauthtokenOps[Self <: InstanceGroupManagerKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersDeleteInstancesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
