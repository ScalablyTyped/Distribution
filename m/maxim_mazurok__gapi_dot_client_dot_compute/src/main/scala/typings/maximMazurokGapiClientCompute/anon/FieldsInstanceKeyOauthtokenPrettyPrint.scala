...
object FieldsInstanceKeyOauthtokenPrettyPrint {
  ...
  inline def apply(instance: String, project: String, resource: ShieldedInstanceIntegrityPolicy, zone: String): FieldsInstanceKeyOauthtokenPrettyPrint = {
  ...
  extension [Self <: FieldsInstanceKeyOauthtokenPrettyPrint](x: Self) {
