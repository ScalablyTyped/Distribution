...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.ShieldedInstanceIntegrityPolicy
...
@js.native
trait FieldsInstanceKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: ShieldedInstanceIntegrityPolicy = js.native
...
object FieldsInstanceKeyOauthtokenPrettyPrint {
  
  @scala.inline
  def apply(instance: String, project: String, resource: ShieldedInstanceIntegrityPolicy, zone: String): FieldsInstanceKeyOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[FieldsInstanceKeyOauthtokenPrettyPrint]
  }
  
  @scala.inline
  implicit class FieldsInstanceKeyOauthtokenPrettyPrintMutableBuilder[Self <: FieldsInstanceKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ShieldedInstanceIntegrityPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
