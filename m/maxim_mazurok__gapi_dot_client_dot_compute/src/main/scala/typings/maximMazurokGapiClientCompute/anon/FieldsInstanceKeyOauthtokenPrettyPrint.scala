...
@js.native
trait FieldsInstanceKeyOauthtokenPrettyPrint extends js.Object {
...
object FieldsInstanceKeyOauthtokenPrettyPrint {
  ...
  @scala.inline
  implicit class FieldsInstanceKeyOauthtokenPrettyPrintOps[Self <: FieldsInstanceKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ShieldedInstanceIntegrityPolicy): Self = this.set("resource", value.asInstanceOf[js.Any])
