...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetReference
...
object FieldsForwardingRuleKey {
  ...
  inline def apply(forwardingRule: String, project: String, resource: TargetReference): FieldsForwardingRuleKey = {
  ...
  implicit open class MutableBuilder[Self <: FieldsForwardingRuleKey] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: TargetReference): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
