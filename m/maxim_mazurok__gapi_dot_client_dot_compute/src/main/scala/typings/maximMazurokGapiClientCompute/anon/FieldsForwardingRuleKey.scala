...
@js.native
trait FieldsForwardingRuleKey extends StObject {
  ...
  var forwardingRule: String = js.native
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object FieldsForwardingRuleKey {
  
  @scala.inline
  def apply(
    forwardingRule: String,
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule
  ): FieldsForwardingRuleKey = {
    val __obj = js.Dynamic.literal(forwardingRule = forwardingRule.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsForwardingRuleKey]
  }
  
  @scala.inline
  implicit class FieldsForwardingRuleKeyMutableBuilder[Self <: FieldsForwardingRuleKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
