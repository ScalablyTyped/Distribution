...
object FieldsForwardingRuleKey {
  ...
  extension [Self <: FieldsForwardingRuleKey](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
