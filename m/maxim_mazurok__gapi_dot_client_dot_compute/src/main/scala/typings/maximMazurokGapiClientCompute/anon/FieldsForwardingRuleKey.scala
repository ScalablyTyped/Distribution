...
@js.native
trait FieldsForwardingRuleKey extends js.Object {
...
object FieldsForwardingRuleKey {
  ...
  @scala.inline
  implicit class FieldsForwardingRuleKeyOps[Self <: FieldsForwardingRuleKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule): Self = this.set("resource", value.asInstanceOf[js.Any])
