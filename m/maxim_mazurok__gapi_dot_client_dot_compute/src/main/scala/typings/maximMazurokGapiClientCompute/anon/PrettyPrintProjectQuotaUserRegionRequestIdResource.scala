...
object PrettyPrintProjectQuotaUserRegionRequestIdResource {
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRegionRequestIdResourceMutableBuilder[Self <: PrettyPrintProjectQuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
