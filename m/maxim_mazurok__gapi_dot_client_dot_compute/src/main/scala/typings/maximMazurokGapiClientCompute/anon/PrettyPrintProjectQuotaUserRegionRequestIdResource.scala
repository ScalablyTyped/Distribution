...
@js.native
trait PrettyPrintProjectQuotaUserRegionRequestIdResource extends js.Object {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroup = js.native
...
object PrettyPrintProjectQuotaUserRegionRequestIdResource {
  ...
  def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroup
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRegionRequestIdResourceOps[Self <: PrettyPrintProjectQuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroup): Self = this.set("resource", value.asInstanceOf[js.Any])
