...
object TargetHttpsProxyUserIp {
  ...
  inline def apply(project: String, region: String, resource: UrlMapReference, targetHttpsProxy: String): TargetHttpsProxyUserIp = {
  ...
  extension [Self <: TargetHttpsProxyUserIp](x: Self) {
