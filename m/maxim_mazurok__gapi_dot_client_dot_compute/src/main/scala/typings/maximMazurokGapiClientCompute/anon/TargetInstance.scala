...
object TargetInstance {
  ...
  inline def apply(project: String, targetInstance: String, zone: String): TargetInstance = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetInstance] (val x: Self) extends AnyVal {
