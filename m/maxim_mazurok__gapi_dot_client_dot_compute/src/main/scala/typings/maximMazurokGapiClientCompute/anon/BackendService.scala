...
trait BackendService extends StObject {
  ...
  /** Request body */
  var resource: SignedUrlKey = js.native
...
object BackendService {
  ...
  @scala.inline
  def apply(backendService: String, project: String, resource: SignedUrlKey): BackendService = {
  ...
  implicit class BackendServiceMutableBuilder[Self <: BackendService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SignedUrlKey): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
