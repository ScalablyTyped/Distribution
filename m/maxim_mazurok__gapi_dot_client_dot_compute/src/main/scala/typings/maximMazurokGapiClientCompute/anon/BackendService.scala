...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.SignedUrlKey
...
object BackendService {
  ...
  inline def apply(backendService: String, project: String, resource: SignedUrlKey): BackendService = {
  ...
  implicit open class MutableBuilder[Self <: BackendService] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: SignedUrlKey): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
