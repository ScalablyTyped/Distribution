...
@js.native
trait InstanceGroupManagerKeyOauthtokenPrettyPrintProject extends js.Object {
...
object InstanceGroupManagerKeyOauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit class InstanceGroupManagerKeyOauthtokenPrettyPrintProjectOps[Self <: InstanceGroupManagerKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersDeleteInstancesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
