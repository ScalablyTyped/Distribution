...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersDeleteInstancesRequest
...
@js.native
trait InstanceGroupManagerKeyOauthtokenPrettyPrintProject extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersDeleteInstancesRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object InstanceGroupManagerKeyOauthtokenPrettyPrintProject {
  ...
  def apply(
  ...
  ): InstanceGroupManagerKeyOauthtokenPrettyPrintProject = {
    ...
    __obj.asInstanceOf[InstanceGroupManagerKeyOauthtokenPrettyPrintProject]
  }
  
  @scala.inline
  implicit class InstanceGroupManagerKeyOauthtokenPrettyPrintProjectMutableBuilder[Self <: InstanceGroupManagerKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersDeleteInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
