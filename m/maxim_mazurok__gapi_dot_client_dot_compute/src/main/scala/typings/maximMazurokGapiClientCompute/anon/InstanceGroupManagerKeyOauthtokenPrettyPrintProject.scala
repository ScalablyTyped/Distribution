...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersSetTargetPoolsRequest
...
trait InstanceGroupManagerKeyOauthtokenPrettyPrintProject extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersSetTargetPoolsRequest
...
object InstanceGroupManagerKeyOauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceGroupManagerKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: RegionInstanceGroupManagersSetTargetPoolsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
