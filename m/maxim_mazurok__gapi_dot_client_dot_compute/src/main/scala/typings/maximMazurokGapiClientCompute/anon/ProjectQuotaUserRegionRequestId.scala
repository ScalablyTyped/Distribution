...
object ProjectQuotaUserRegionRequestId {
  ...
  @scala.inline
  implicit class ProjectQuotaUserRegionRequestIdMutableBuilder[Self <: ProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Commitment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
