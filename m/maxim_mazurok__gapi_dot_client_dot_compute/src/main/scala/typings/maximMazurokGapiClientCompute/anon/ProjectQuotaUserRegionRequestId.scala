...
@js.native
trait ProjectQuotaUserRegionRequestId extends js.Object {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Commitment = js.native
...
object ProjectQuotaUserRegionRequestId {
  ...
  @scala.inline
  implicit class ProjectQuotaUserRegionRequestIdOps[Self <: ProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Commitment): Self = this.set("resource", value.asInstanceOf[js.Any])
