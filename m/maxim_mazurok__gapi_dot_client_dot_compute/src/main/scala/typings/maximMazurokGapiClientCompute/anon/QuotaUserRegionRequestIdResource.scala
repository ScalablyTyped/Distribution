...
trait QuotaUserRegionRequestIdResource extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Commitment
...
object QuotaUserRegionRequestIdResource {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Commitment
  ): QuotaUserRegionRequestIdResource = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Commitment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
