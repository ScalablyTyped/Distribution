...
@js.native
trait QuotaUserRegionRequestIdResource extends js.Object {
...
object QuotaUserRegionRequestIdResource {
  ...
  @scala.inline
  implicit class QuotaUserRegionRequestIdResourceOps[Self <: QuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionDisksResizeRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
