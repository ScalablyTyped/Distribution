...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionDisksResizeRequest
...
@js.native
trait QuotaUserRegionRequestIdResource extends StObject {
  ...
  /** Request body */
  var resource: RegionDisksResizeRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object QuotaUserRegionRequestIdResource {
  
  @scala.inline
  def apply(disk: String, project: String, region: String, resource: RegionDisksResizeRequest): QuotaUserRegionRequestIdResource = {
    ...
    __obj.asInstanceOf[QuotaUserRegionRequestIdResource]
  }
  
  @scala.inline
  implicit class QuotaUserRegionRequestIdResourceMutableBuilder[Self <: QuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionDisksResizeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
