...
object QuotaUserRegionRequestIdResource {
  ...
  inline def apply(disk: String, project: String, region: String, resource: RegionDisksResizeRequest): QuotaUserRegionRequestIdResource = {
  ...
  extension [Self <: QuotaUserRegionRequestIdResource](x: Self) {
    ...
    inline def setResource(value: RegionDisksResizeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
