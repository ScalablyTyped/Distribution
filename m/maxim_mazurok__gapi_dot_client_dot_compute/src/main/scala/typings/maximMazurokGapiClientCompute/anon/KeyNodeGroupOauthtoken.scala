...
object KeyNodeGroupOauthtoken {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyNodeGroupOauthtoken] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
