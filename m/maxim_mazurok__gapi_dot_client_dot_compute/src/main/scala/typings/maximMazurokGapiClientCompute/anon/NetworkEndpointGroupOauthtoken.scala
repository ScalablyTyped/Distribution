...
object NetworkEndpointGroupOauthtoken {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NetworkEndpointGroupOauthtoken] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: GlobalNetworkEndpointGroupsDetachEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
