...
@js.native
trait NetworkEndpointGroupOauthtoken extends js.Object {
...
object NetworkEndpointGroupOauthtoken {
  ...
  @scala.inline
  implicit class NetworkEndpointGroupOauthtokenOps[Self <: NetworkEndpointGroupOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GlobalNetworkEndpointGroupsDetachEndpointsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
