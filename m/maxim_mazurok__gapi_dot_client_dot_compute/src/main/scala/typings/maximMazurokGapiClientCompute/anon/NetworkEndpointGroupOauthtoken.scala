...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.GlobalNetworkEndpointGroupsDetachEndpointsRequest
...
@js.native
trait NetworkEndpointGroupOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: GlobalNetworkEndpointGroupsDetachEndpointsRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object NetworkEndpointGroupOauthtoken {
  ...
  def apply(
  ...
  ): NetworkEndpointGroupOauthtoken = {
    ...
    __obj.asInstanceOf[NetworkEndpointGroupOauthtoken]
  }
  
  @scala.inline
  implicit class NetworkEndpointGroupOauthtokenMutableBuilder[Self <: NetworkEndpointGroupOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GlobalNetworkEndpointGroupsDetachEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
