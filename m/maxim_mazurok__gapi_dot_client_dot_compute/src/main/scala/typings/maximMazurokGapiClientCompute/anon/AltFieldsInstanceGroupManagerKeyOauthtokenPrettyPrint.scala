...
@js.native
trait AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint extends js.Object {
...
object AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint {
  ...
  @scala.inline
  implicit class AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintOps[Self <: AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagerPatchInstanceConfigReq): Self = this.set("resource", value.asInstanceOf[js.Any])
