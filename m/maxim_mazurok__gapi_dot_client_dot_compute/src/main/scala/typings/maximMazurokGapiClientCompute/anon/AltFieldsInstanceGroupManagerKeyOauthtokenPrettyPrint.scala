...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagerPatchInstanceConfigReq
...
@js.native
trait AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagerPatchInstanceConfigReq = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint {
  ...
  def apply(
  ...
  ): AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint]
  }
  
  @scala.inline
  implicit class AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintMutableBuilder[Self <: AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagerPatchInstanceConfigReq): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
