...
@js.native
trait RequestIdSourceImage extends js.Object {
...
object RequestIdSourceImage {
  ...
  @scala.inline
  def apply(project: String, zone: String): RequestIdSourceImage = {
  ...
  @scala.inline
  implicit class RequestIdSourceImageOps[Self <: RequestIdSourceImage] (val x: Self) extends AnyVal {
