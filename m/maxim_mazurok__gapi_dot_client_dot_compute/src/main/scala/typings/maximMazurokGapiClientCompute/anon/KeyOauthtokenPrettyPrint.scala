...
trait KeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.PublicDelegatedPrefix
...
object KeyOauthtokenPrettyPrint {
  ...
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.PublicDelegatedPrefix
  ): KeyOauthtokenPrettyPrint = {
  ...
  implicit open class MutableBuilder[Self <: KeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.PublicDelegatedPrefix): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
