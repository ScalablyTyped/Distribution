...
trait AltFields extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket
...
object AltFields {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket): AltFields = {
  ...
  extension [Self <: AltFields](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
