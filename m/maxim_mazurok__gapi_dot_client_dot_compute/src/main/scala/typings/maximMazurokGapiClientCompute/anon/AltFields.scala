...
trait AltFields extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket = js.native
...
object AltFields {
  ...
  @scala.inline
  def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket): AltFields = {
  ...
  implicit class AltFieldsMutableBuilder[Self <: AltFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
