...
@js.native
trait FieldsKeyOauthtokenPrettyPrintProject extends js.Object {
...
object FieldsKeyOauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit class FieldsKeyOauthtokenPrettyPrintProjectOps[Self <: FieldsKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
