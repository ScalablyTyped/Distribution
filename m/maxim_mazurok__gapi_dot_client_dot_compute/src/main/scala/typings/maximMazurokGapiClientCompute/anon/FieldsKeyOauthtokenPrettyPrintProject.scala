...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.ProjectsEnableXpnResourceRequest
...
trait FieldsKeyOauthtokenPrettyPrintProject extends StObject {
  ...
  /** Request body */
  var resource: ProjectsEnableXpnResourceRequest
...
object FieldsKeyOauthtokenPrettyPrintProject {
  ...
  inline def apply(project: String, resource: ProjectsEnableXpnResourceRequest): FieldsKeyOauthtokenPrettyPrintProject = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ProjectsEnableXpnResourceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
