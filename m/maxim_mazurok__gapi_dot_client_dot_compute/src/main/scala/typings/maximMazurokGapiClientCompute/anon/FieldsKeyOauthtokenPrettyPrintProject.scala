...
@js.native
trait FieldsKeyOauthtokenPrettyPrintProject extends StObject {
...
object FieldsKeyOauthtokenPrettyPrintProject {
  
  @scala.inline
  def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect): FieldsKeyOauthtokenPrettyPrintProject = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsKeyOauthtokenPrettyPrintProject]
  }
  
  @scala.inline
  implicit class FieldsKeyOauthtokenPrettyPrintProjectMutableBuilder[Self <: FieldsKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
