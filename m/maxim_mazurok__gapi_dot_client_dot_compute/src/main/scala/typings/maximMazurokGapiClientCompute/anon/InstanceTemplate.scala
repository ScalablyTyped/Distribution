...
object InstanceTemplate {
  ...
  inline def apply(instanceTemplate: String, project: String): InstanceTemplate = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceTemplate] (val x: Self) extends AnyVal {
