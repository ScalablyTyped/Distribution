...
trait InstanceTemplate extends js.Object {
  ...
  var instanceTemplate: String = js.native
...
object InstanceTemplate {
  ...
  @scala.inline
  def apply(instanceTemplate: String, project: String): InstanceTemplate = {
    val __obj = js.Dynamic.literal(instanceTemplate = instanceTemplate.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[InstanceTemplate]
  }
  
  @scala.inline
  implicit class InstanceTemplateOps[Self <: InstanceTemplate] (val x: Self) extends AnyVal {
