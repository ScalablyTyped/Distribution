...
object HttpsHealthCheckKey {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HttpsHealthCheckKey] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.HttpsHealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
