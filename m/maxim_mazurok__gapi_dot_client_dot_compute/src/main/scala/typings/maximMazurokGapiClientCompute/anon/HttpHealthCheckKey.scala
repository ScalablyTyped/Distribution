...
object HttpHealthCheckKey {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HttpHealthCheckKey] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.HttpHealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
