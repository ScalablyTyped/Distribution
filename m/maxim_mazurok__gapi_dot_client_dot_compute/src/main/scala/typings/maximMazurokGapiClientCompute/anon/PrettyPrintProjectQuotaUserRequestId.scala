...
trait PrettyPrintProjectQuotaUserRequestId extends StObject {
...
object PrettyPrintProjectQuotaUserRequestId {
  
  inline def apply(instance: String, project: String, resource: ShieldedInstanceIntegrityPolicy, zone: String): PrettyPrintProjectQuotaUserRequestId = {
    ...
    __obj.asInstanceOf[PrettyPrintProjectQuotaUserRequestId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PrettyPrintProjectQuotaUserRequestId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ShieldedInstanceIntegrityPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
