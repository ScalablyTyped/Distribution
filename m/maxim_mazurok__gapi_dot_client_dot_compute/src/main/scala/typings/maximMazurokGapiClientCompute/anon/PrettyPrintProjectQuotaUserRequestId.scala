...
trait PrettyPrintProjectQuotaUserRequestId extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersUpdatePerInstanceConfigsReq = js.native
...
object PrettyPrintProjectQuotaUserRequestId {
  ...
  def apply(
    ...
    zone: String
  ): PrettyPrintProjectQuotaUserRequestId = {
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRequestIdMutableBuilder[Self <: PrettyPrintProjectQuotaUserRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersUpdatePerInstanceConfigsReq): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
