...
@js.native
trait PrettyPrintProjectQuotaUserRequestId extends js.Object {
...
object PrettyPrintProjectQuotaUserRequestId {
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRequestIdOps[Self <: PrettyPrintProjectQuotaUserRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersUpdatePerInstanceConfigsReq): Self = this.set("resource", value.asInstanceOf[js.Any])
