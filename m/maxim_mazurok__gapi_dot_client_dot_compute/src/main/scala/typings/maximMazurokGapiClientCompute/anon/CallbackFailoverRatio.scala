...
trait CallbackFailoverRatio extends StObject {
...
object CallbackFailoverRatio {
  
  inline def apply(project: String, region: String, targetPool: String): CallbackFailoverRatio = {
    ...
    __obj.asInstanceOf[CallbackFailoverRatio]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackFailoverRatio] (val x: Self) extends AnyVal {
