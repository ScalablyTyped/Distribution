...
@js.native
trait PrettyPrintProjectQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Address = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object PrettyPrintProjectQuotaUser {
  
  @scala.inline
  def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Address): PrettyPrintProjectQuotaUser = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[PrettyPrintProjectQuotaUser]
  }
  
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserMutableBuilder[Self <: PrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Address): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
