...
@js.native
trait PrettyPrintProjectQuotaUser extends js.Object {
...
object PrettyPrintProjectQuotaUser {
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserOps[Self <: PrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Address): Self = this.set("resource", value.asInstanceOf[js.Any])
