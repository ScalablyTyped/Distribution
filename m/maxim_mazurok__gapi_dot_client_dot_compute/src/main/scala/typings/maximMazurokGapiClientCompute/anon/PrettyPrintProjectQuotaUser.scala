...
object PrettyPrintProjectQuotaUser {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Address): PrettyPrintProjectQuotaUser = {
  ...
  extension [Self <: PrettyPrintProjectQuotaUser](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Address): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
