...
@js.native
trait FilterInstanceGroupManager extends StObject {
...
object FilterInstanceGroupManager {
  
  @scala.inline
  def apply(instanceGroupManager: String, project: String, region: String): FilterInstanceGroupManager = {
  ...
  @scala.inline
  implicit class FilterInstanceGroupManagerMutableBuilder[Self <: FilterInstanceGroupManager] (val x: Self) extends AnyVal {
