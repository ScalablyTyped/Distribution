...
@js.native
trait FilterInstanceGroupManager extends js.Object {
...
object FilterInstanceGroupManager {
  ...
  @scala.inline
  implicit class FilterInstanceGroupManagerOps[Self <: FilterInstanceGroupManager] (val x: Self) extends AnyVal {
