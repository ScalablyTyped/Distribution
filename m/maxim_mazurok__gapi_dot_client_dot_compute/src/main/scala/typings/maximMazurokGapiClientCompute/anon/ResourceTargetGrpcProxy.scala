...
object ResourceTargetGrpcProxy {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceTargetGrpcProxy] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetGrpcProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
