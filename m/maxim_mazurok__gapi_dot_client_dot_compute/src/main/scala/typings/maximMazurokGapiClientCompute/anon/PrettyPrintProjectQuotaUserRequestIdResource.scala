...
object PrettyPrintProjectQuotaUserRequestIdResource {
  ...
  inline def apply(project: String, resource: Metadata): PrettyPrintProjectQuotaUserRequestIdResource = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PrettyPrintProjectQuotaUserRequestIdResource] (val x: Self) extends AnyVal {
