...
object PrettyPrintProjectQuotaUserRequestIdResource {
  ...
  inline def apply(instance: String, project: String, resource: ShieldedInstanceConfig, zone: String): PrettyPrintProjectQuotaUserRequestIdResource = {
  ...
  extension [Self <: PrettyPrintProjectQuotaUserRequestIdResource](x: Self) {
