...
trait PublicDelegatedPrefixQuotaUser extends StObject {
...
object PublicDelegatedPrefixQuotaUser {
  
  inline def apply(
    project: String,
    publicDelegatedPrefix: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.PublicDelegatedPrefix
  ): PublicDelegatedPrefixQuotaUser = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], publicDelegatedPrefix = publicDelegatedPrefix.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[PublicDelegatedPrefixQuotaUser]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PublicDelegatedPrefixQuotaUser] (val x: Self) extends AnyVal {
