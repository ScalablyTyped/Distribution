...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagerUpdateInstanceConfigReq
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ProjectQuotaUserRegionRequestIdResource extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagerUpdateInstanceConfigReq
...
object ProjectQuotaUserRegionRequestIdResource {
  ...
  inline def apply(
  ...
  ): ProjectQuotaUserRegionRequestIdResource = {
    ...
    __obj.asInstanceOf[ProjectQuotaUserRegionRequestIdResource]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectQuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: RegionInstanceGroupManagerUpdateInstanceConfigReq): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
