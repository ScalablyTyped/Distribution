...
@js.native
trait ProjectQuotaUserRegionRequestIdResource extends js.Object {
...
object ProjectQuotaUserRegionRequestIdResource {
  ...
  @scala.inline
  implicit class ProjectQuotaUserRegionRequestIdResourceOps[Self <: ProjectQuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager): Self = this.set("resource", value.asInstanceOf[js.Any])
