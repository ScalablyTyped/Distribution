...
trait ProjectQuotaUserRegionRequestIdResource extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager = js.native
...
object ProjectQuotaUserRegionRequestIdResource {
  ...
  @scala.inline
  implicit class ProjectQuotaUserRegionRequestIdResourceMutableBuilder[Self <: ProjectQuotaUserRegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
