...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstancesStartWithEncryptionKeyRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait QuotaUserRequestIdResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: InstancesStartWithEncryptionKeyRequest
...
object QuotaUserRequestIdResourceUploadType {
  
  inline def apply(instance: String, project: String, resource: InstancesStartWithEncryptionKeyRequest, zone: String): QuotaUserRequestIdResourceUploadType = {
    ...
    __obj.asInstanceOf[QuotaUserRequestIdResourceUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserRequestIdResourceUploadType] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: InstancesStartWithEncryptionKeyRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
