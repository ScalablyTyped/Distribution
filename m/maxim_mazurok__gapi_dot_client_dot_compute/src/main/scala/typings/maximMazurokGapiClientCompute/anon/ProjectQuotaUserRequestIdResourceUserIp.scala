...
trait ProjectQuotaUserRequestIdResourceUserIp extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.License
...
object ProjectQuotaUserRequestIdResourceUserIp {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.License): ProjectQuotaUserRequestIdResourceUserIp = {
  ...
  extension [Self <: ProjectQuotaUserRequestIdResourceUserIp](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.License): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
