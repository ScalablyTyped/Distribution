...
trait ProjectQuotaUserRequestIdResourceUserIp extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.License = js.native
...
object ProjectQuotaUserRequestIdResourceUserIp {
  ...
  @scala.inline
  def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.License): ProjectQuotaUserRequestIdResourceUserIp = {
  ...
  implicit class ProjectQuotaUserRequestIdResourceUserIpMutableBuilder[Self <: ProjectQuotaUserRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.License): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
