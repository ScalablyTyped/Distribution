...
object AltFieldsKeyOauthtokenPrettyPrintProject {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Network): AltFieldsKeyOauthtokenPrettyPrintProject = {
  ...
  extension [Self <: AltFieldsKeyOauthtokenPrettyPrintProject](x: Self) {
