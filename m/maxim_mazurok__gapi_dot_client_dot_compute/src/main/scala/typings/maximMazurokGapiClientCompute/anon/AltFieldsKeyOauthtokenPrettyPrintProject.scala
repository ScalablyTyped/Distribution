...
@js.native
trait AltFieldsKeyOauthtokenPrettyPrintProject extends StObject {
...
object AltFieldsKeyOauthtokenPrettyPrintProject {
  
  @scala.inline
  def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Network): AltFieldsKeyOauthtokenPrettyPrintProject = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltFieldsKeyOauthtokenPrettyPrintProject]
  }
  
  @scala.inline
  implicit class AltFieldsKeyOauthtokenPrettyPrintProjectMutableBuilder[Self <: AltFieldsKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
