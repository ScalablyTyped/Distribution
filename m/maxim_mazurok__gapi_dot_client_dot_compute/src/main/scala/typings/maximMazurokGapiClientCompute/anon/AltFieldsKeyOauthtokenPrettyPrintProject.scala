...
@js.native
trait AltFieldsKeyOauthtokenPrettyPrintProject extends js.Object {
...
object AltFieldsKeyOauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit class AltFieldsKeyOauthtokenPrettyPrintProjectOps[Self <: AltFieldsKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
