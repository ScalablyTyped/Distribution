...
object TargetHttpProxy {
  ...
  @scala.inline
  def apply(project: String, region: String, targetHttpProxy: String): TargetHttpProxy = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], targetHttpProxy = targetHttpProxy.asInstanceOf[js.Any])
    __obj.asInstanceOf[TargetHttpProxy]
  }
  
  @scala.inline
  implicit class TargetHttpProxyOps[Self <: TargetHttpProxy] (val x: Self) extends AnyVal {
