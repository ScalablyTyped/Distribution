...
object TargetHttpProxy {
  ...
  inline def apply(project: String, region: String, targetHttpProxy: String): TargetHttpProxy = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetHttpProxy] (val x: Self) extends AnyVal {
