...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.Scheduling
...
object KeyOauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
