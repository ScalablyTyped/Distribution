...
trait AltFieldsKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate = js.native
...
object AltFieldsKeyOauthtokenPrettyPrint {
  ...
  implicit class AltFieldsKeyOauthtokenPrettyPrintMutableBuilder[Self <: AltFieldsKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
