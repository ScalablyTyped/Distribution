...
trait FieldsKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate
...
object FieldsKeyOauthtokenPrettyPrint {
  ...
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate
  ...
  extension [Self <: FieldsKeyOauthtokenPrettyPrint](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
