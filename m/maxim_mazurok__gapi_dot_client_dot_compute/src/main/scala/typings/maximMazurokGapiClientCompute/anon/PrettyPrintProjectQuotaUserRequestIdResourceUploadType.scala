...
trait PrettyPrintProjectQuotaUserRequestIdResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslCertificate
...
object PrettyPrintProjectQuotaUserRequestIdResourceUploadType {
  
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslCertificate
  ): PrettyPrintProjectQuotaUserRequestIdResourceUploadType = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[PrettyPrintProjectQuotaUserRequestIdResourceUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PrettyPrintProjectQuotaUserRequestIdResourceUploadType] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.SslCertificate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
