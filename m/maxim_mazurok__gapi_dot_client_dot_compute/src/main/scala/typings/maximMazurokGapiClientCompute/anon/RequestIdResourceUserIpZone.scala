...
object RequestIdResourceUserIpZone {
  ...
  inline def apply(instance: String, project: String, resource: Scheduling, zone: String): RequestIdResourceUserIpZone = {
  ...
  extension [Self <: RequestIdResourceUserIpZone](x: Self) {
