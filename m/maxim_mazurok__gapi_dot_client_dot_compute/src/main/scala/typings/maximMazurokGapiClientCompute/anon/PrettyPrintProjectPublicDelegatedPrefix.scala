...
trait PrettyPrintProjectPublicDelegatedPrefix extends StObject {
  ...
  var publicDelegatedPrefix: String
...
object PrettyPrintProjectPublicDelegatedPrefix {
  
  inline def apply(project: String, publicDelegatedPrefix: String, region: String): PrettyPrintProjectPublicDelegatedPrefix = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], publicDelegatedPrefix = publicDelegatedPrefix.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[PrettyPrintProjectPublicDelegatedPrefix]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PrettyPrintProjectPublicDelegatedPrefix] (val x: Self) extends AnyVal {
