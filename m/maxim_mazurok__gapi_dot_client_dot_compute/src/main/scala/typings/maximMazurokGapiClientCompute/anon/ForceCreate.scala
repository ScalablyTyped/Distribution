...
object ForceCreate {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Image): ForceCreate = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ForceCreate] (val x: Self) extends AnyVal {
