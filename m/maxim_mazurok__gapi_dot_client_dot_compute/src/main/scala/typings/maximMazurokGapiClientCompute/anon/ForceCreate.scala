...
trait ForceCreate extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Image = js.native
...
object ForceCreate {
  ...
  @scala.inline
  def apply(project: String, resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Image): ForceCreate = {
  ...
  implicit class ForceCreateMutableBuilder[Self <: ForceCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Image): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
