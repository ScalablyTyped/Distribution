...
@js.native
trait AltBackendServiceFields extends StObject {
...
object AltBackendServiceFields {
  
  @scala.inline
  def apply(backendService: String, project: String, region: String): AltBackendServiceFields = {
    val __obj = js.Dynamic.literal(backendService = backendService.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltBackendServiceFields]
  }
  
  @scala.inline
  implicit class AltBackendServiceFieldsMutableBuilder[Self <: AltBackendServiceFields] (val x: Self) extends AnyVal {
