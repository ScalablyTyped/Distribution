...
@js.native
trait SubnetworkUserIp extends StObject {
  ...
  /** Request body */
  var resource: SubnetworksSetPrivateIpGoogleAccessRequest = js.native
...
object SubnetworkUserIp {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SubnetworkUserIp]
  }
  
  @scala.inline
  implicit class SubnetworkUserIpMutableBuilder[Self <: SubnetworkUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SubnetworksSetPrivateIpGoogleAccessRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
