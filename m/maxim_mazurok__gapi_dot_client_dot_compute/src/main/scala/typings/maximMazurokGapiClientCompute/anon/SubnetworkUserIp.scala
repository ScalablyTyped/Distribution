...
@js.native
trait SubnetworkUserIp extends js.Object {
...
object SubnetworkUserIp {
  ...
  @scala.inline
  implicit class SubnetworkUserIpOps[Self <: SubnetworkUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SubnetworksSetPrivateIpGoogleAccessRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
