...
@js.native
trait AltFieldsInstanceKey extends js.Object {
...
object AltFieldsInstanceKey {
  ...
  @scala.inline
  implicit class AltFieldsInstanceKeyOps[Self <: AltFieldsInstanceKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetMachineResourcesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
