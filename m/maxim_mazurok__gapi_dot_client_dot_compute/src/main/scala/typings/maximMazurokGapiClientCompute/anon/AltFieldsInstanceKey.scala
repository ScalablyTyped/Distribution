...
object AltFieldsInstanceKey {
  ...
  inline def apply(instance: String, project: String, resource: InstancesSetMachineResourcesRequest, zone: String): AltFieldsInstanceKey = {
  ...
  extension [Self <: AltFieldsInstanceKey](x: Self) {
