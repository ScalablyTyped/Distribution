...
@js.native
trait AltFieldsInstanceKey extends StObject {
  ...
  /** Request body */
  var resource: InstancesSetMachineResourcesRequest = js.native
...
object AltFieldsInstanceKey {
  
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesSetMachineResourcesRequest, zone: String): AltFieldsInstanceKey = {
    ...
    __obj.asInstanceOf[AltFieldsInstanceKey]
  }
  
  @scala.inline
  implicit class AltFieldsInstanceKeyMutableBuilder[Self <: AltFieldsInstanceKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetMachineResourcesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
