...
@js.native
trait RequestIdTargetPool extends js.Object {
...
object RequestIdTargetPool {
  ...
  @scala.inline
  def apply(project: String, region: String, targetPool: String): RequestIdTargetPool = {
  ...
  @scala.inline
  implicit class RequestIdTargetPoolOps[Self <: RequestIdTargetPool] (val x: Self) extends AnyVal {
