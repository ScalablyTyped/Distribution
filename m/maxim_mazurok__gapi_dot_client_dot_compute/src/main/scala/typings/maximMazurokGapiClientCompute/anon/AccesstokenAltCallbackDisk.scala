...
trait AccesstokenAltCallbackDisk extends StObject {
...
object AccesstokenAltCallbackDisk {
  
  inline def apply(disk: String, project: String, region: String, resource: RegionDisksRemoveResourcePoliciesRequest): AccesstokenAltCallbackDisk = {
