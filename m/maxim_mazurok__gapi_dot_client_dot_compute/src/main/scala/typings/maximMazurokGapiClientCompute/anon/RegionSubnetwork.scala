...
object RegionSubnetwork {
  ...
  inline def apply(project: String, region: String, subnetwork: String): RegionSubnetwork = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RegionSubnetwork] (val x: Self) extends AnyVal {
