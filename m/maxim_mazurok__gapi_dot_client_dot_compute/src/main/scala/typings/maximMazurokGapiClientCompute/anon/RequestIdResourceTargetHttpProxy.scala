...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.UrlMapReference
...
@js.native
trait RequestIdResourceTargetHttpProxy extends StObject {
  ...
  /** Request body */
  var resource: UrlMapReference = js.native
  
  /** Name of the TargetHttpProxy to set a URL map for. */
  var targetHttpProxy: String = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object RequestIdResourceTargetHttpProxy {
  
  @scala.inline
  def apply(project: String, resource: UrlMapReference, targetHttpProxy: String): RequestIdResourceTargetHttpProxy = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], targetHttpProxy = targetHttpProxy.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdResourceTargetHttpProxy]
  }
  
  @scala.inline
  implicit class RequestIdResourceTargetHttpProxyMutableBuilder[Self <: RequestIdResourceTargetHttpProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UrlMapReference): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
