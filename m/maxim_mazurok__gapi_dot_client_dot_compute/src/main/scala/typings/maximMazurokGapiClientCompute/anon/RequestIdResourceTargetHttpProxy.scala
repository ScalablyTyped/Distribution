...
@js.native
trait RequestIdResourceTargetHttpProxy extends js.Object {
...
object RequestIdResourceTargetHttpProxy {
  ...
  @scala.inline
  implicit class RequestIdResourceTargetHttpProxyOps[Self <: RequestIdResourceTargetHttpProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UrlMapReference): Self = this.set("resource", value.asInstanceOf[js.Any])
