...
object RequestIdResourceTargetHttpProxy {
  ...
  inline def apply(project: String, resource: UrlMapReference, targetHttpProxy: String): RequestIdResourceTargetHttpProxy = {
  ...
  extension [Self <: RequestIdResourceTargetHttpProxy](x: Self) {
    ...
    inline def setResource(value: UrlMapReference): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
