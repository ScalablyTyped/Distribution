...
@js.native
trait AltBackendBucket extends StObject {
...
object AltBackendBucket {
  
  @scala.inline
  def apply(backendBucket: String, project: String): AltBackendBucket = {
    val __obj = js.Dynamic.literal(backendBucket = backendBucket.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltBackendBucket]
  }
  
  @scala.inline
  implicit class AltBackendBucketMutableBuilder[Self <: AltBackendBucket] (val x: Self) extends AnyVal {
