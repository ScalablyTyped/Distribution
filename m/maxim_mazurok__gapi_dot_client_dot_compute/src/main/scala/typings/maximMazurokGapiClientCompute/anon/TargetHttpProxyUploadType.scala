...
trait TargetHttpProxyUploadType extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpProxy
...
object TargetHttpProxyUploadType {
  
  inline def apply(
    project: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpProxy,
    targetHttpProxy: String
  ): TargetHttpProxyUploadType = {
    ...
    __obj.asInstanceOf[TargetHttpProxyUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetHttpProxyUploadType] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
