...
trait AutoscalerCallback extends StObject {
...
object AutoscalerCallback {
  
  inline def apply(autoscaler: String, project: String, region: String): AutoscalerCallback = {
    ...
    __obj.asInstanceOf[AutoscalerCallback]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AutoscalerCallback] (val x: Self) extends AnyVal {
