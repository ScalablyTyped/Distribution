...
object ResourceTargetSslProxyUserIp {
  ...
  inline def apply(project: String, resource: SslPolicyReference, targetSslProxy: String): ResourceTargetSslProxyUserIp = {
  ...
  extension [Self <: ResourceTargetSslProxyUserIp](x: Self) {
