...
@js.native
trait ResourceTargetSslProxyUserIp extends js.Object {
...
object ResourceTargetSslProxyUserIp {
  ...
  @scala.inline
  implicit class ResourceTargetSslProxyUserIpOps[Self <: ResourceTargetSslProxyUserIp] (val x: Self) extends AnyVal {
