...
@js.native
trait ResourceTargetSslProxyUserIp extends StObject {
...
object ResourceTargetSslProxyUserIp {
  
  @scala.inline
  def apply(project: String, resource: SslPolicyReference, targetSslProxy: String): ResourceTargetSslProxyUserIp = {
    ...
    __obj.asInstanceOf[ResourceTargetSslProxyUserIp]
  }
  
  @scala.inline
  implicit class ResourceTargetSslProxyUserIpMutableBuilder[Self <: ResourceTargetSslProxyUserIp] (val x: Self) extends AnyVal {
