...
trait RequestIdSecurityPolicy extends StObject {
...
object RequestIdSecurityPolicy {
  
  @scala.inline
  def apply(project: String, securityPolicy: String): RequestIdSecurityPolicy = {
  ...
  @scala.inline
  implicit class RequestIdSecurityPolicyMutableBuilder[Self <: RequestIdSecurityPolicy] (val x: Self) extends AnyVal {
