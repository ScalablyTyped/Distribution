...
@js.native
trait RequestIdSslCertificate extends js.Object {
...
object RequestIdSslCertificate {
  ...
  @scala.inline
  def apply(project: String, sslCertificate: String): RequestIdSslCertificate = {
  ...
  @scala.inline
  implicit class RequestIdSslCertificateOps[Self <: RequestIdSslCertificate] (val x: Self) extends AnyVal {
