...
object InstanceKeyOauthtokenPrettyPrintProject {
  ...
  inline def apply(instance: String, project: String, resource: Tags, zone: String): InstanceKeyOauthtokenPrettyPrintProject = {
  ...
  extension [Self <: InstanceKeyOauthtokenPrettyPrintProject](x: Self) {
    ...
    inline def setResource(value: Tags): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
