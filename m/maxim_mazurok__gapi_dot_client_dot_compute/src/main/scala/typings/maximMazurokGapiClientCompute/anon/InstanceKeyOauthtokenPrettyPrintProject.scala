...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.Tags
...
@js.native
trait InstanceKeyOauthtokenPrettyPrintProject extends StObject {
...
object InstanceKeyOauthtokenPrettyPrintProject {
  
  @scala.inline
  def apply(instance: String, project: String, resource: Tags, zone: String): InstanceKeyOauthtokenPrettyPrintProject = {
    ...
    __obj.asInstanceOf[InstanceKeyOauthtokenPrettyPrintProject]
  }
  
  @scala.inline
  implicit class InstanceKeyOauthtokenPrettyPrintProjectMutableBuilder[Self <: InstanceKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Tags): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
