...
@js.native
trait InstanceKeyOauthtokenPrettyPrintProject extends js.Object {
...
object InstanceKeyOauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit class InstanceKeyOauthtokenPrettyPrintProjectOps[Self <: InstanceKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Tags): Self = this.set("resource", value.asInstanceOf[js.Any])
