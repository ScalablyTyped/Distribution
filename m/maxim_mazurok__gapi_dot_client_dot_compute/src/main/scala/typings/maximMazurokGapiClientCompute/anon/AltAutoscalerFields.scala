...
@js.native
trait AltAutoscalerFields extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object AltAutoscalerFields {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AltAutoscalerFields]
  }
  
  @scala.inline
  implicit class AltAutoscalerFieldsMutableBuilder[Self <: AltAutoscalerFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
