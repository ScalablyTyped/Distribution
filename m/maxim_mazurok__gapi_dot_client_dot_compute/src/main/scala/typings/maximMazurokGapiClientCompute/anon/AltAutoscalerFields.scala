...
@js.native
trait AltAutoscalerFields extends js.Object {
...
object AltAutoscalerFields {
  ...
  @scala.inline
  implicit class AltAutoscalerFieldsOps[Self <: AltAutoscalerFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler): Self = this.set("resource", value.asInstanceOf[js.Any])
