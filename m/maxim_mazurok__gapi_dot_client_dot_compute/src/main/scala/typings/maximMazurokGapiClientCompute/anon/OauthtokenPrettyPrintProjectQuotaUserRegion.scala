...
object OauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OauthtokenPrettyPrintProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
