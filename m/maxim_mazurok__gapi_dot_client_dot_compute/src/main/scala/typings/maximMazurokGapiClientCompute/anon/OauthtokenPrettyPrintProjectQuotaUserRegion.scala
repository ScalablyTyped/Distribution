...
object OauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  extension [Self <: OauthtokenPrettyPrintProjectQuotaUserRegion](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
