...
@js.native
trait OauthtokenPrettyPrintProjectQuotaUserRegion extends js.Object {
...
object OauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserRegionOps[Self <: OauthtokenPrettyPrintProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck): Self = this.set("resource", value.asInstanceOf[js.Any])
