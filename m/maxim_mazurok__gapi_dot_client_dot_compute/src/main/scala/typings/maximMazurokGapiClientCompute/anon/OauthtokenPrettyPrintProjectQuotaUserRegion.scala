...
@js.native
trait OauthtokenPrettyPrintProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object OauthtokenPrettyPrintProjectQuotaUserRegion {
  
  @scala.inline
  def apply(
    project: String,
    region: String,
    resource: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck
  ): OauthtokenPrettyPrintProjectQuotaUserRegion = {
    ...
    __obj.asInstanceOf[OauthtokenPrettyPrintProjectQuotaUserRegion]
  }
  
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserRegionMutableBuilder[Self <: OauthtokenPrettyPrintProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
