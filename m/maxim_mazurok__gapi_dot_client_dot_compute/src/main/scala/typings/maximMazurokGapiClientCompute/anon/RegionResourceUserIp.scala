...
@js.native
trait RegionResourceUserIp extends js.Object {
...
object RegionResourceUserIp {
  ...
  @scala.inline
  implicit class RegionResourceUserIpOps[Self <: RegionResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagerDeleteInstanceConfigReq): Self = this.set("resource", value.asInstanceOf[js.Any])
