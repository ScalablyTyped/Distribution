...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.BulkInsertInstanceResource
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait QuotaUserRegionRequestIdResourceUploadType extends StObject {
...
object QuotaUserRegionRequestIdResourceUploadType {
  
  inline def apply(project: String, region: String, resource: BulkInsertInstanceResource): QuotaUserRegionRequestIdResourceUploadType = {
    ...
    __obj.asInstanceOf[QuotaUserRegionRequestIdResourceUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserRegionRequestIdResourceUploadType] (val x: Self) extends AnyVal {
