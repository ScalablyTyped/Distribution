...
import typings.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupsRemoveInstancesRequest
...
@js.native
trait AltFieldsInstanceGroup extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupsRemoveInstancesRequest = js.native
...
object AltFieldsInstanceGroup {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AltFieldsInstanceGroup]
  }
  
  @scala.inline
  implicit class AltFieldsInstanceGroupMutableBuilder[Self <: AltFieldsInstanceGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupsRemoveInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
