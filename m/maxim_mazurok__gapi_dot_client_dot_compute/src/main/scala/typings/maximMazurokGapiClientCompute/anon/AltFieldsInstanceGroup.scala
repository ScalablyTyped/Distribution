...
@js.native
trait AltFieldsInstanceGroup extends js.Object {
...
object AltFieldsInstanceGroup {
  ...
  @scala.inline
  implicit class AltFieldsInstanceGroupOps[Self <: AltFieldsInstanceGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupsRemoveInstancesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
