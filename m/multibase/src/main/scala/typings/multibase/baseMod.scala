...
object baseMod {
  ...
  object Base {
    ...
    implicit class BaseMutableBuilder[Self <: Base] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCode(value: typings.multibase.typesMod.BaseCode): Self = StObject.set(x, "code", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCodeBuf(value: Uint8Array): Self = StObject.set(x, "codeBuf", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setName(value: typings.multibase.typesMod.BaseName): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
