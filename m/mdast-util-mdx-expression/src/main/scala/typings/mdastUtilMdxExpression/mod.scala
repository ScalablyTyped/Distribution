...
object mod {
  ...
  type MdxFlowExpression = typings.mdastUtilMdxExpression.complexTypesMod.MdxFlowExpression
  
  type MdxTextExpression = typings.mdastUtilMdxExpression.complexTypesMod.MdxTextExpression
