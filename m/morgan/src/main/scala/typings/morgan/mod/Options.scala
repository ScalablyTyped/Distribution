...
object Options {
  @scala.inline
  def apply[/* <: typings.node.httpMod.IncomingMessage */ Request, /* <: typings.node.httpMod.ServerResponse */ Response](): Options[Request, Response] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[Request, Response]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_, _], /* <: typings.node.httpMod.IncomingMessage */ Request, /* <: typings.node.httpMod.ServerResponse */ Response] (val x: Self with (Options[Request, Response])) extends AnyVal {
    @scala.inline
