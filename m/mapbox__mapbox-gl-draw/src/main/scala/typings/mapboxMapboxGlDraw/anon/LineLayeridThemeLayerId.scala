...
import typings.mapboxGl.mod.LineLayout
import typings.mapboxGl.mod.LinePaint
import typings.mapboxMapboxGlDraw.mapboxMapboxGlDrawStrings.line
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined mapbox-gl.mapbox-gl.LineLayer & {  id :@mapbox/mapbox-gl-draw.@mapbox/mapbox-gl-draw.ThemeLayerId} */
trait LineLayeridThemeLayerId extends StObject {
...
object LineLayeridThemeLayerId {
  
  inline def apply(id: String): LineLayeridThemeLayerId = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("line")
    __obj.asInstanceOf[LineLayeridThemeLayerId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LineLayeridThemeLayerId] (val x: Self) extends AnyVal {
