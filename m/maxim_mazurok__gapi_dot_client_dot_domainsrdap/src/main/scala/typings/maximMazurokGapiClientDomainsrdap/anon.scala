...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(autnumId: String): Accesstoken = {
  ...
  object Alt {
    ...
    inline def apply(domainName: String): Alt = {
  ...
  object Callback {
    ...
    inline def apply(entityId: String): Callback = {
  ...
  object Fields {
    ...
    inline def apply(ipId: String, ipId1: String): Fields = {
  ...
  object Key {
    ...
    inline def apply(nameserverId: String): Key = {
