...
object TargetOptions {
  @scala.inline
  def apply[/* <: org.scalablytyped.runtime.StringDictionary[js.Any] */ TargetObjectType](target: TargetObjectType, deep: js.UndefOr[Boolean] = js.undefined): TargetOptions[TargetObjectType] = {
