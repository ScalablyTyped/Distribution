...
object getosMod {
  ...
  */
  ...
  object AnyOS {
    ...
    inline def LinuxOS(dist: String, release: String): typings.mongodbMemoryServerCore.getosMod.LinuxOS = {
    ...
    inline def OtherOS(os: aix | android | darwin | freebsd | openbsd | sunos | win32 | cygwin | String): typings.mongodbMemoryServerCore.getosMod.OtherOS = {
