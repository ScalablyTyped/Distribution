...
import typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstance
...
object mongoMemoryServerMod {
  ...
  - typings.mongodbMemoryServerCore.utilsMod.ManagerAdvanced because Inheritance from two classes. Inlined getUri, getUri, getUri, cleanup, cleanup */ @JSImport("mongodb-memory-server-core/lib/MongoMemoryServer", "MongoMemoryServer")
  @js.native
  /**
    * Create an Mongo-Memory-Sever Instance
    * @param opts Mongo-Memory-Sever Options
  ...
  object MongoMemoryServerEvents extends StObject {
    ...
    /* "stateChange" */ val stateChange: typings.mongodbMemoryServerCore.mongoMemoryServerMod.MongoMemoryServerEvents.stateChange & String = js.native
  }
  ...
  object MongoMemoryServerStates extends StObject {
    ...
    /* "new" */ val `new`: typings.mongodbMemoryServerCore.mongoMemoryServerMod.MongoMemoryServerStates.`new` & String = js.native
    
    @js.native
    sealed trait running
      extends StObject
         with MongoMemoryServerStates
    /* "running" */ val running: typings.mongodbMemoryServerCore.mongoMemoryServerMod.MongoMemoryServerStates.running & String = js.native
    
    @js.native
    sealed trait starting
      extends StObject
         with MongoMemoryServerStates
    /* "starting" */ val starting: typings.mongodbMemoryServerCore.mongoMemoryServerMod.MongoMemoryServerStates.starting & String = js.native
    
    @js.native
    sealed trait stopped
      extends StObject
         with MongoMemoryServerStates
    /* "stopped" */ val stopped: typings.mongodbMemoryServerCore.mongoMemoryServerMod.MongoMemoryServerStates.stopped & String = js.native
  }
