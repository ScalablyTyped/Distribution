...
object libUtilLockfileMod {
  ...
  object LockFileEvents extends StObject {
    ...
    sealed trait lock
      extends StObject
         with LockFileEvents
    /* "lock" */ val lock: typings.mongodbMemoryServerCore.libUtilLockfileMod.LockFileEvents.lock & String = js.native
    
    @js.native
    sealed trait unlock
      extends StObject
         with LockFileEvents
    /* "unlock" */ val unlock: typings.mongodbMemoryServerCore.libUtilLockfileMod.LockFileEvents.unlock & String = js.native
  }
  ...
  object LockFileStatus extends StObject {
    ...
    sealed trait available
      extends StObject
         with LockFileStatus
    /* 0 */ val available: typings.mongodbMemoryServerCore.libUtilLockfileMod.LockFileStatus.available & Double = js.native
    ...
    sealed trait availableInstance
      extends StObject
         with LockFileStatus
    /* 1 */ val availableInstance: typings.mongodbMemoryServerCore.libUtilLockfileMod.LockFileStatus.availableInstance & Double = js.native
    ...
    sealed trait lockedDifferent
      extends StObject
         with LockFileStatus
    /* 3 */ val lockedDifferent: typings.mongodbMemoryServerCore.libUtilLockfileMod.LockFileStatus.lockedDifferent & Double = js.native
    ...
    sealed trait lockedSelf
      extends StObject
         with LockFileStatus
    /* 2 */ val lockedSelf: typings.mongodbMemoryServerCore.libUtilLockfileMod.LockFileStatus.lockedSelf & Double = js.native
  }
