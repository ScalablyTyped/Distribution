...
import typings.mongodbMemoryServerCore.mongoMemoryServerMod.MongoMemoryServer
import typings.mongodbMemoryServerCore.utilsMod.Cleanup
...
object mongoMemoryReplSetMod {
  ...
  - typings.mongodbMemoryServerCore.utilsMod.ManagerBase because Inheritance from two classes. Inlined start, start, stop, stop
  - typings.mongodbMemoryServerCore.utilsMod.ManagerAdvanced because Inheritance from two classes. Inlined getUri, getUri, getUri, cleanup, cleanup */ @JSImport("mongodb-memory-server-core/lib/MongoMemoryReplSet", "MongoMemoryReplSet")
  @js.native
  ...
  object MongoMemoryReplSetEvents extends StObject {
    ...
    /* "stateChange" */ val stateChange: typings.mongodbMemoryServerCore.mongoMemoryReplSetMod.MongoMemoryReplSetEvents.stateChange & String = js.native
  }
  ...
  object MongoMemoryReplSetStates extends StObject {
    ...
    /* "init" */ val init: typings.mongodbMemoryServerCore.mongoMemoryReplSetMod.MongoMemoryReplSetStates.init & String = js.native
    
    @js.native
    sealed trait running
      extends StObject
         with MongoMemoryReplSetStates
    /* "running" */ val running: typings.mongodbMemoryServerCore.mongoMemoryReplSetMod.MongoMemoryReplSetStates.running & String = js.native
    
    @js.native
    sealed trait stopped
      extends StObject
         with MongoMemoryReplSetStates
    /* "stopped" */ val stopped: typings.mongodbMemoryServerCore.mongoMemoryReplSetMod.MongoMemoryReplSetStates.stopped & String = js.native
  }
