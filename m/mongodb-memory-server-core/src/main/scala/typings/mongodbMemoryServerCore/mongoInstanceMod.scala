...
object mongoInstanceMod {
  ...
  - typings.mongodbMemoryServerCore.utilsMod.ManagerBase because Inheritance from two classes. Inlined start, start, stop, stop */ @JSImport("mongodb-memory-server-core/lib/util/MongoInstance", "MongoInstance")
  @js.native
  ...
  object MongoInstanceEvents extends StObject {
    ...
    /* "instanceClosed" */ val instanceClosed: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceClosed & String = js.native
    ...
    sealed trait instanceError
      extends StObject
         with MongoInstanceEvents
    /* "instanceError" */ val instanceError: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceError & String = js.native
    
    @js.native
    sealed trait instanceLaunched
      extends StObject
         with MongoInstanceEvents
    /* "instanceLaunched" */ val instanceLaunched: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceLaunched & String = js.native
    
    @js.native
    sealed trait instancePrimary
      extends StObject
         with MongoInstanceEvents
    /* "instancePrimary" */ val instancePrimary: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instancePrimary & String = js.native
    ...
    sealed trait instanceRawError
      extends StObject
         with MongoInstanceEvents
    /* "instanceRawError" */ val instanceRawError: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceRawError & String = js.native
    
    @js.native
    sealed trait instanceReady
      extends StObject
         with MongoInstanceEvents
    /* "instanceReady" */ val instanceReady: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceReady & String = js.native
    
    @js.native
    sealed trait instanceReplState
      extends StObject
         with MongoInstanceEvents
    /* "instanceReplState" */ val instanceReplState: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceReplState & String = js.native
    
    @js.native
    sealed trait instanceSTDERR
      extends StObject
         with MongoInstanceEvents
    /* "instanceSTDERR" */ val instanceSTDERR: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceSTDERR & String = js.native
    
    @js.native
    sealed trait instanceSTDOUT
      extends StObject
         with MongoInstanceEvents
    /* "instanceSTDOUT" */ val instanceSTDOUT: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceSTDOUT & String = js.native
    
    @js.native
    sealed trait instanceStarted
      extends StObject
         with MongoInstanceEvents
    /* "instanceStarted" */ val instanceStarted: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.instanceStarted & String = js.native
    
    @js.native
    sealed trait killerLaunched
      extends StObject
         with MongoInstanceEvents
    /* "killerLaunched" */ val killerLaunched: typings.mongodbMemoryServerCore.mongoInstanceMod.MongoInstanceEvents.killerLaunched & String = js.native
  }
