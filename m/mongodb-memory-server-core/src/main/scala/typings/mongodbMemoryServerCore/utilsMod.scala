...
object utilsMod {
  ...
  @JSImport("mongodb-memory-server-core/lib/util/utils", "ManagerAdvanced")
  @js.native
  abstract class ManagerAdvanced () extends ManagerBase {
  ...
  @JSImport("mongodb-memory-server-core/lib/util/utils", "ManagerBase")
  @js.native
  abstract class ManagerBase () extends StObject {
