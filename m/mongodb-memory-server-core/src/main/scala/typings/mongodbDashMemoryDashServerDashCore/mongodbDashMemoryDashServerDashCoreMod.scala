...
object mongodbDashMemoryDashServerDashCoreMod extends js.Object {
  @js.native
  class MongoBinary ()
    extends typings.mongodbDashMemoryDashServerDashCore.libUtilMongoBinaryMod.default
  
  @js.native
  class MongoInstance protected ()
    extends typings.mongodbDashMemoryDashServerDashCore.libUtilMongoInstanceMod.default {
    def this(opts: MongodOps) = this()
  }
  
  @js.native
  class MongoMemoryReplSet ()
    extends typings.mongodbDashMemoryDashServerDashCore.libMongoMemoryReplSetMod.default {
