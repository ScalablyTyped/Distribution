...
object NamespaceId {
  ...
  @scala.inline
  implicit class NamespaceIdMutableBuilder[Self <: NamespaceId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Namespace): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
