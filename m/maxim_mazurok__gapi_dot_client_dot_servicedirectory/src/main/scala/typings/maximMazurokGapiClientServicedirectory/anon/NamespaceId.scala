...
import typings.maximMazurokGapiClientServicedirectory.gapi.client.servicedirectory.Namespace
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait NamespaceId extends js.Object {
  ...
  /** Request body */
  var resource: Namespace = js.native
...
object NamespaceId {
  ...
  @scala.inline
  def apply(parent: String, resource: Namespace): NamespaceId = {
  ...
  @scala.inline
  implicit class NamespaceIdOps[Self <: NamespaceId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Namespace): Self = this.set("resource", value.asInstanceOf[js.Any])
