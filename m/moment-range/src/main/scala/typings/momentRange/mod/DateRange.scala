...
import typings.momentRange.AnonStep
...
class DateRange () extends js.Object {
  ...
  def reverseBy(interval: Diff, options: AnonStep): Iterable[Moment] = js.native
  ...
  def reverseByRange(interval: DateRange, options: AnonStep): Iterable[Moment] = js.native
