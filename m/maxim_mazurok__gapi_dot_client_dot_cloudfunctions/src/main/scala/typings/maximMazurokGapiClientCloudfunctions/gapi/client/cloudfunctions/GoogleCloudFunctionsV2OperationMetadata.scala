...
trait GoogleCloudFunctionsV2OperationMetadata extends StObject {
  ...
  {[ P in string ]: any}
    */ typings.maximMazurokGapiClientCloudfunctions.maximMazurokGapiClientCloudfunctionsStrings.GoogleCloudFunctionsV2OperationMetadata & TopLevel[Any]
  ] = js.undefined
  
  /** Mechanism for reporting in-progress stages */
  var stages: js.UndefOr[js.Array[GoogleCloudFunctionsV2Stage]] = js.undefined
...
object GoogleCloudFunctionsV2OperationMetadata {
  ...
  inline def apply(): GoogleCloudFunctionsV2OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudFunctionsV2OperationMetadata]
  }
  
  extension [Self <: GoogleCloudFunctionsV2OperationMetadata](x: Self) {
    ...
    inline def setStages(value: js.Array[GoogleCloudFunctionsV2Stage]): Self = StObject.set(x, "stages", value.asInstanceOf[js.Any])
    
    inline def setStagesUndefined: Self = StObject.set(x, "stages", js.undefined)
    
    inline def setStagesVarargs(value: GoogleCloudFunctionsV2Stage*): Self = StObject.set(x, "stages", js.Array(value*))
