...
trait AnonReasonStringServerReference extends js.Object {
...
object AnonReasonStringServerReference {
  @scala.inline
  def apply(
  ...
  ): AnonReasonStringServerReference = {
    ...
    __obj.asInstanceOf[AnonReasonStringServerReference]
  }
}
