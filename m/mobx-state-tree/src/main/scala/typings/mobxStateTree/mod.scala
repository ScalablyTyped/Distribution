...
object mod {
  ...
  @JSImport("mobx-state-tree", "applyAction")
  @js.native
  ...
  @JSImport("mobx-state-tree", "applyPatch")
  @js.native
  ...
  @JSImport("mobx-state-tree", "castFlowReturn")
  @js.native
  def castFlowReturn[T](`val`: T): T = js.native
  
  @JSImport("mobx-state-tree", "castToReferenceSnapshot")
  @js.native
  def castToReferenceSnapshot[I](instance: I): ReferenceIdentifier | I = js.native
  
  @JSImport("mobx-state-tree", "castToSnapshot")
  @js.native
  ...
  @JSImport("mobx-state-tree", "clone")
  @js.native
  ...
  @JSImport("mobx-state-tree", "createActionTrackingMiddleware")
  @js.native
  def createActionTrackingMiddleware[T](hooks: IActionTrackingMiddlewareHooks[T]): IMiddlewareHandler = js.native
  
  @JSImport("mobx-state-tree", "createActionTrackingMiddleware2")
  @js.native
  ...
  @JSImport("mobx-state-tree", "decorate")
  @js.native
  ...
  @JSImport("mobx-state-tree", "getChildType")
  @js.native
  ...
  @JSImport("mobx-state-tree", "getParentOfType")
  @js.native
  ...
  @JSImport("mobx-state-tree", "getRunningActionContext")
  @js.native
  def getRunningActionContext(): js.UndefOr[IActionContext] = js.native
  
  @JSImport("mobx-state-tree", "getSnapshot")
  @js.native
  ...
  @JSImport("mobx-state-tree", "getType")
  @js.native
  def getType(`object`: IAnyStateTreeNode): IAnyComplexType = js.native
  
  @JSImport("mobx-state-tree", "hasParent")
  @js.native
  ...
  @JSImport("mobx-state-tree", "hasParentOfType")
  @js.native
  def hasParentOfType(target: IAnyStateTreeNode, `type`: IAnyComplexType): Boolean = js.native
  
  @JSImport("mobx-state-tree", "isActionContextChildOf")
  @js.native
  ...
  @JSImport("mobx-state-tree", "isActionContextThisOrChildOf")
  @js.native
  ...
  @JSImport("mobx-state-tree", "isAlive")
  @js.native
  def isAlive(target: IAnyStateTreeNode): Boolean = js.native
  
  @JSImport("mobx-state-tree", "isArrayType")
  @js.native
  ...
  @JSImport("mobx-state-tree", "isFrozenType")
  @js.native
  def isFrozenType[IT /* <: IType[T | _, T, T] */, T](`type`: IT): /* is IT */ Boolean = js.native
  
  @JSImport("mobx-state-tree", "isIdentifierType")
  @js.native
  ...
  @JSImport("mobx-state-tree", "joinJsonPath")
  @js.native
  def joinJsonPath(path: js.Array[String]): String = js.native
  
  @JSImport("mobx-state-tree", "onAction")
  @js.native
  ...
  @JSImport("mobx-state-tree", "onPatch")
  @js.native
  def onPatch(
    target: IAnyStateTreeNode,
  ...
  @JSImport("mobx-state-tree", "protect")
  @js.native
  def protect(target: IAnyStateTreeNode): Unit = js.native
  
  @JSImport("mobx-state-tree", "recordActions")
  @js.native
  ...
  @JSImport("mobx-state-tree", "recordPatches")
  @js.native
  ...
  @JSImport("mobx-state-tree", "resolveIdentifier")
  @js.native
  ...
  @JSImport("mobx-state-tree", "tryReference")
  @js.native
  ...
  @JSImport("mobx-state-tree", "tryResolve")
  @js.native
  def tryResolve(target: IAnyStateTreeNode, path: String): js.Any = js.native
  
  @JSImport("mobx-state-tree", "typecheck")
  @js.native
  ...
  @JSImport("mobx-state-tree", "unescapeJsonPath")
  @js.native
  def unescapeJsonPath(path: String): String = js.native
  
  @JSImport("mobx-state-tree", "unprotect")
  @js.native
  def unprotect(target: IAnyStateTreeNode): Unit = js.native
  
  @JSImport("mobx-state-tree", "walk")
  @js.native
