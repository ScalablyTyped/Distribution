...
object mp {
  ...
  */
  ...
  object LogLevel {
    ...
    inline def debug: typings.mpvScript.mpvScriptStrings.debug = "debug".asInstanceOf[typings.mpvScript.mpvScriptStrings.debug]
    
    inline def error: typings.mpvScript.mpvScriptStrings.error = "error".asInstanceOf[typings.mpvScript.mpvScriptStrings.error]
    
    inline def fatal: typings.mpvScript.mpvScriptStrings.fatal = "fatal".asInstanceOf[typings.mpvScript.mpvScriptStrings.fatal]
    
    inline def info: typings.mpvScript.mpvScriptStrings.info = "info".asInstanceOf[typings.mpvScript.mpvScriptStrings.info]
    
    inline def trace: typings.mpvScript.mpvScriptStrings.trace = "trace".asInstanceOf[typings.mpvScript.mpvScriptStrings.trace]
    
    inline def v: typings.mpvScript.mpvScriptStrings.v = "v".asInstanceOf[typings.mpvScript.mpvScriptStrings.v]
    
    inline def warn: typings.mpvScript.mpvScriptStrings.warn = "warn".asInstanceOf[typings.mpvScript.mpvScriptStrings.warn]
  }
  ...
  object OSDOverlay {
    ...
    inline def apply(data: String, remove: () => Unit, res_x: Double, res_y: Double, update: () => Unit, z: Double): OSDOverlay = {
