...
object utilsNs extends js.Object {
  def addQueryParams(url: java.lang.String, params: ScalablyTyped.runtime.StringDictionary[js.Any]): java.lang.String = js.native
  ...
  type TextAlignment = mjmlDashReactLib.mjmlDashReactLibStrings.left | mjmlDashReactLib.mjmlDashReactLibStrings.right | mjmlDashReactLib.mjmlDashReactLibStrings.center | mjmlDashReactLib.mjmlDashReactLibStrings.justify | mjmlDashReactLib.mjmlDashReactLibStrings.inherit
}
