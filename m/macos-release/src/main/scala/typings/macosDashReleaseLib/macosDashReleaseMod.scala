...
object macosDashReleaseMod extends js.Object {
  ...
  // export = macosRelease;
  @JSName("default")
  var default_Original: macosDashReleaseLib.Anon_Default = js.native
  /**
  ...
  def apply(release: java.lang.String): java.lang.String = js.native
  /**
  	Get the name and version of a macOS release from the Darwin version.
  	@param release - By default, the current operating system is used, but you can supply a custom [Darwin kernel version](http://en.wikipedia.org/wiki/Darwin_%28operating_system%29#Release_history), which is the output of [`os.release()`](https://nodejs.org/api/os.html#os_os_release).
  	@example
  ...
  def default(release: java.lang.String): java.lang.String = js.native
}
