...
object QuotaUser {
  ...
  inline def apply(name: String, resource: GoogleAnalyticsAdminV1alphaAccount): QuotaUser = {
  ...
  extension [Self <: QuotaUser](x: Self) {
    ...
    inline def setResource(value: GoogleAnalyticsAdminV1alphaAccount): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
