...
trait PrettyPrintQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: GoogleAnalyticsAdminV1alphaEnhancedMeasurementSettings = js.native
...
object PrettyPrintQuotaUser {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleAnalyticsAdminV1alphaEnhancedMeasurementSettings): PrettyPrintQuotaUser = {
  ...
  implicit class PrettyPrintQuotaUserMutableBuilder[Self <: PrettyPrintQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleAnalyticsAdminV1alphaEnhancedMeasurementSettings): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
