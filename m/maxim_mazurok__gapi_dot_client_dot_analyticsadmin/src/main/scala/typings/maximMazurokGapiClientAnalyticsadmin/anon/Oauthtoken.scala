...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: GoogleAnalyticsAdminV1alphaBatchUpdateUserLinksRequest = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: GoogleAnalyticsAdminV1alphaBatchUpdateUserLinksRequest): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleAnalyticsAdminV1alphaBatchUpdateUserLinksRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
