...
trait KeyName extends StObject {
  ...
  /** Request body */
  var resource: GoogleAnalyticsAdminV1alphaGoogleAdsLink = js.native
...
object KeyName {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleAnalyticsAdminV1alphaGoogleAdsLink): KeyName = {
  ...
  implicit class KeyNameMutableBuilder[Self <: KeyName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleAnalyticsAdminV1alphaGoogleAdsLink): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
