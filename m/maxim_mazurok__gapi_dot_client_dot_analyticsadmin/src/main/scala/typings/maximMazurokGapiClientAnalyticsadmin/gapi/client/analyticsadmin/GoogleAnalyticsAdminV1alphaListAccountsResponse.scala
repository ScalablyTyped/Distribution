...
object GoogleAnalyticsAdminV1alphaListAccountsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleAnalyticsAdminV1alphaListAccountsResponse] (val x: Self) extends AnyVal {
    ...
    inline def setAccountsVarargs(value: GoogleAnalyticsAdminV1alphaAccount*): Self = StObject.set(x, "accounts", js.Array(value*))
