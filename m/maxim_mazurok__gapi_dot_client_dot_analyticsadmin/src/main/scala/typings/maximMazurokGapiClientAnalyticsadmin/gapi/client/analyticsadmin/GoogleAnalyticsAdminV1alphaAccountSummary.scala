...
object GoogleAnalyticsAdminV1alphaAccountSummary {
  ...
  inline def apply(): GoogleAnalyticsAdminV1alphaAccountSummary = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleAnalyticsAdminV1alphaAccountSummary]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleAnalyticsAdminV1alphaAccountSummary] (val x: Self) extends AnyVal {
    ...
    inline def setPropertySummaries(value: js.Array[GoogleAnalyticsAdminV1alphaPropertySummary]): Self = StObject.set(x, "propertySummaries", value.asInstanceOf[js.Any])
