...
import typings.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.BackupRun
...
trait Alt extends StObject {
  ...
  /** Request body */
  var resource: BackupRun = js.native
...
object Alt {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: BackupRun): Alt = {
  ...
  implicit class AltMutableBuilder[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BackupRun): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
