...
trait DatabaseVersion extends StObject {
...
object DatabaseVersion {
  ...
  @scala.inline
  def apply(): DatabaseVersion = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DatabaseVersion]
  }
  
  @scala.inline
  implicit class DatabaseVersionMutableBuilder[Self <: DatabaseVersion] (val x: Self) extends AnyVal {
