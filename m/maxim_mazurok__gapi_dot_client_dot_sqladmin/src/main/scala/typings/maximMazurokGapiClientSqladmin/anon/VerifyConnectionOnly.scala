...
@js.native
trait VerifyConnectionOnly extends js.Object {
...
object VerifyConnectionOnly {
  ...
  @scala.inline
  implicit class VerifyConnectionOnlyOps[Self <: VerifyConnectionOnly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVerifyConnectionOnly(value: Boolean): Self = this.set("verifyConnectionOnly", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteVerifyConnectionOnly: Self = this.set("verifyConnectionOnly", js.undefined)
  }
}
