...
trait Project extends StObject {
  ...
  /** Request body */
  var resource: InstancesExportRequest = js.native
...
object Project {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesExportRequest): Project = {
  ...
  implicit class ProjectMutableBuilder[Self <: Project] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesExportRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
