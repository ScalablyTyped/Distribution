...
trait Key extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.Database = js.native
...
object Key {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.Database): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
