...
trait CallbackFields extends StObject {
  ...
  /** Request body */
  var resource: InstancesTruncateLogRequest = js.native
...
object CallbackFields {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesTruncateLogRequest): CallbackFields = {
  ...
  implicit class CallbackFieldsMutableBuilder[Self <: CallbackFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesTruncateLogRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
