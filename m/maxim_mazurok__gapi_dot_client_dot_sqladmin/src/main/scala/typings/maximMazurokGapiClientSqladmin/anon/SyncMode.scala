...
@js.native
trait SyncMode extends js.Object {
...
object SyncMode {
  ...
  @scala.inline
  def apply(instance: String, project: String): SyncMode = {
    val __obj = js.Dynamic.literal(instance = instance.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[SyncMode]
  }
  
  @scala.inline
  implicit class SyncModeOps[Self <: SyncMode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSyncMode(value: String): Self = this.set("syncMode", value.asInstanceOf[js.Any])
