...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: InstancesImportRequest = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesImportRequest): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesImportRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
