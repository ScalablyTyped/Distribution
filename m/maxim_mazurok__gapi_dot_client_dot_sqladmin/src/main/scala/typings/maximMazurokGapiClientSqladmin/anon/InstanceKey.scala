...
@js.native
trait InstanceKey extends StObject {
  ...
  /** Request body */
  var resource: SslCertsCreateEphemeralRequest = js.native
...
object InstanceKey {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: SslCertsCreateEphemeralRequest): InstanceKey = {
  ...
  @scala.inline
  implicit class InstanceKeyMutableBuilder[Self <: InstanceKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SslCertsCreateEphemeralRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
