...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: InstancesFailoverRequest = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesFailoverRequest): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesFailoverRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
