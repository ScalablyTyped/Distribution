...
trait AltCallback extends StObject {
  ...
  /** Request body */
  var resource: InstancesRotateServerCaRequest = js.native
...
object AltCallback {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesRotateServerCaRequest): AltCallback = {
  ...
  implicit class AltCallbackMutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesRotateServerCaRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
