...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: InstancesDemoteMasterRequest = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesDemoteMasterRequest): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesDemoteMasterRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
