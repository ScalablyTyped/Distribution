...
object Config {
  ...
  def apply(
    ...
    if (!js.isUndefined(arrowMarkerAbsolute)) __obj.updateDynamic("arrowMarkerAbsolute")(arrowMarkerAbsolute.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(startOnLoad)) __obj.updateDynamic("startOnLoad")(startOnLoad.get.asInstanceOf[js.Any])
