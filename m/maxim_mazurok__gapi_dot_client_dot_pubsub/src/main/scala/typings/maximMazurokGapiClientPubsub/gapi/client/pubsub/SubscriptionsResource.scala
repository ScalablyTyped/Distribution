...
import typings.maximMazurokGapiClientPubsub.anon.KeyOauthtoken
...
trait SubscriptionsResource extends StObject {
  ...
  /**
    ...
    */
  def acknowledge(request: typings.maximMazurokGapiClientPubsub.anon.Subscription): Request[js.Object] = js.native
