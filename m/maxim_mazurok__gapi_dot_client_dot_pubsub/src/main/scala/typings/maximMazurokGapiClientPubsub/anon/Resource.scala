...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientPubsub.gapi.client.pubsub.Subscription = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(name: String, resource: typings.maximMazurokGapiClientPubsub.gapi.client.pubsub.Subscription): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientPubsub.gapi.client.pubsub.Subscription): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
