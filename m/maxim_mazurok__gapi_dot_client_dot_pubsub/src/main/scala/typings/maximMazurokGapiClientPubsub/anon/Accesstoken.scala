...
trait Accesstoken extends StObject {
  ...
  /** Request body */
  var resource: CreateSnapshotRequest = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(name: String, resource: CreateSnapshotRequest): Accesstoken = {
  ...
  implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreateSnapshotRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
