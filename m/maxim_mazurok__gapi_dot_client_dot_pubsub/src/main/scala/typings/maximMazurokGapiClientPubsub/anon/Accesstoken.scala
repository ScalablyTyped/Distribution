...
import typings.maximMazurokGapiClientPubsub.gapi.client.pubsub.Schema
...
trait Accesstoken extends StObject {
  ...
  /**
    * The ID to use for the schema, which will become the final component of the schema's resource name. See https://cloud.google.com/pubsub/docs/admin#resource_names for resource
    * name constraints.
    */
...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: Schema): Accesstoken = {
  ...
  extension [Self <: Accesstoken](x: Self) {
    ...
    inline def setResource(value: Schema): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
