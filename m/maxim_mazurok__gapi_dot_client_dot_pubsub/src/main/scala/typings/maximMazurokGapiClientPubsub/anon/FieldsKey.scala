...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: PublishRequest = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(resource: PublishRequest, topic: String): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PublishRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
