...
trait Subscription extends StObject {
  ...
  /** Request body */
  var resource: ModifyAckDeadlineRequest = js.native
...
object Subscription {
  ...
  @scala.inline
  def apply(resource: ModifyAckDeadlineRequest, subscription: String): Subscription = {
  ...
  implicit class SubscriptionMutableBuilder[Self <: Subscription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ModifyAckDeadlineRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
