...
import typings.maximMazurokGapiClientPubsub.gapi.client.pubsub.AcknowledgeRequest
...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: AcknowledgeRequest = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(resource: AcknowledgeRequest, subscription: String): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AcknowledgeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
