...
@js.native
trait ResponseValueRenderOption extends StObject {
...
object ResponseValueRenderOption {
  
  @scala.inline
  def apply(range: String, spreadsheetId: String): ResponseValueRenderOption = {
    val __obj = js.Dynamic.literal(range = range.asInstanceOf[js.Any], spreadsheetId = spreadsheetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ResponseValueRenderOption]
  }
  
  @scala.inline
  implicit class ResponseValueRenderOptionMutableBuilder[Self <: ResponseValueRenderOption] (val x: Self) extends AnyVal {
