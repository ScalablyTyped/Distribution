...
object ResponseValueRenderOption {
  ...
  inline def apply(range: String, spreadsheetId: String): ResponseValueRenderOption = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseValueRenderOption] (val x: Self) extends AnyVal {
