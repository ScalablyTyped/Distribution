...
object Accesstoken {
  ...
  inline def apply(metadataId: Double, spreadsheetId: String): Accesstoken = {
    val __obj = js.Dynamic.literal(metadataId = metadataId.asInstanceOf[js.Any], spreadsheetId = spreadsheetId.asInstanceOf[js.Any])
