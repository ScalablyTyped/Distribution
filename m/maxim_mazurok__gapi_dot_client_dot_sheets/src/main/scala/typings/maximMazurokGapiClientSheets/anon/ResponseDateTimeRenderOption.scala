...
object ResponseDateTimeRenderOption {
  ...
  inline def apply(range: String, resource: ValueRange, spreadsheetId: String): ResponseDateTimeRenderOption = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDateTimeRenderOption] (val x: Self) extends AnyVal {
