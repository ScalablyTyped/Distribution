...
object IncludeGridData {
  ...
  @scala.inline
  implicit class IncludeGridDataMutableBuilder[Self <: IncludeGridData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRanges(value: String | js.Array[String]): Self = StObject.set(x, "ranges", value.asInstanceOf[js.Any])
