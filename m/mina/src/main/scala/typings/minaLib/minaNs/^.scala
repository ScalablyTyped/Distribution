...
object ^ extends js.Object {
  def backin(n: scala.Double): scala.Double = js.native
  def backout(n: scala.Double): scala.Double = js.native
  def bounce(n: scala.Double): scala.Double = js.native
  def easein(n: scala.Double): scala.Double = js.native
