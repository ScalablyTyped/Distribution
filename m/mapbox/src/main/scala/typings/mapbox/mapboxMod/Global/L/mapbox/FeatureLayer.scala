...
object FeatureLayer {
  ...
  def apply(
    ...
    setGeoJSON: js.Any => FeatureLayer
  ): FeatureLayer = {
...
object featureLayer extends js.Object {
  ...
  /**
  		 ...
  		 */
  def apply(): FeatureLayer = js.native
  def apply(idOrGeoJson: js.Any): FeatureLayer = js.native
  def apply(idOrGeoJson: js.Any, options: FeatureLayerOptions): FeatureLayer = js.native
}
