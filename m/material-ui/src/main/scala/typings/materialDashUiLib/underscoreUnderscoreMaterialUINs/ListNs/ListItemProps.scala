...
trait ListItemProps
  ...
  var leftAvatar: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
  var leftCheckbox: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
  var leftIcon: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
  var nestedItems: js.UndefOr[js.Array[reactLib.reactMod.ReactElement]] = js.undefined
  ...
  var rightAvatar: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
  var rightIcon: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
  var rightIconButton: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
  var rightToggle: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
...
object ListItemProps {
  ...
  def apply(
    ...
    leftAvatar: reactLib.reactMod.ReactElement = null,
    leftCheckbox: reactLib.reactMod.ReactElement = null,
    leftIcon: reactLib.reactMod.ReactElement = null,
    nestedItems: js.Array[reactLib.reactMod.ReactElement] = null,
    ...
    rightAvatar: reactLib.reactMod.ReactElement = null,
    rightIcon: reactLib.reactMod.ReactElement = null,
    rightIconButton: reactLib.reactMod.ReactElement = null,
    rightToggle: reactLib.reactMod.ReactElement = null,
