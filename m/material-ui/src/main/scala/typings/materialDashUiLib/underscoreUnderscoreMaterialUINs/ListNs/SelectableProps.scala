...
trait SelectableProps extends js.Object {
  ...
  var selectedItemStyle: js.UndefOr[reactLib.reactMod.CSSProperties] = js.undefined
...
object SelectableProps {
  @scala.inline
  def apply(
    onChange: (/* e */ reactLib.reactMod.SyntheticEvent[js.Object, reactLib.Event], /* value */ js.Any) => scala.Unit = null,
    selectedItemStyle: reactLib.reactMod.CSSProperties = null,
    value: js.Any = null
  ): SelectableProps = {
