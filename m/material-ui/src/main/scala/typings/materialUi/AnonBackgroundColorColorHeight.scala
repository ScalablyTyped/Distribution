...
trait AnonBackgroundColorColorHeight extends js.Object {
...
object AnonBackgroundColorColorHeight {
  @scala.inline
  def apply(
  ...
  ): AnonBackgroundColorColorHeight = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorColorHeight]
  }
}
