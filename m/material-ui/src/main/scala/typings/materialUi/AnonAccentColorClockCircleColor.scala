...
trait AnonAccentColorClockCircleColor extends js.Object {
...
object AnonAccentColorClockCircleColor {
  @scala.inline
  def apply(
  ...
  ): AnonAccentColorClockCircleColor = {
    ...
    __obj.asInstanceOf[AnonAccentColorClockCircleColor]
  }
}
