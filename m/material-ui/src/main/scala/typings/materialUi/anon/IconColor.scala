...
object IconColor {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IconColor] (val x: Self) extends AnyVal {
    ...
    inline def setMenuHoverColor(value: String): Self = StObject.set(x, "menuHoverColor", value.asInstanceOf[js.Any])
    
    inline def setMenuHoverColorUndefined: Self = StObject.set(x, "menuHoverColor", js.undefined)
    
    inline def setSeparatorColor(value: String): Self = StObject.set(x, "separatorColor", value.asInstanceOf[js.Any])
    
    inline def setSeparatorColorUndefined: Self = StObject.set(x, "separatorColor", js.undefined)
