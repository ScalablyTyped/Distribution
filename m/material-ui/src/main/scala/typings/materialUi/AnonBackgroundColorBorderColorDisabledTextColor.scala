...
trait AnonBackgroundColorBorderColorDisabledTextColor extends js.Object {
...
object AnonBackgroundColorBorderColorDisabledTextColor {
  @scala.inline
  def apply(
  ...
  ): AnonBackgroundColorBorderColorDisabledTextColor = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorBorderColorDisabledTextColor]
  }
}
