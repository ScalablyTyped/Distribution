...
trait AnonBackgroundColorConnectorLineColor extends js.Object {
...
object AnonBackgroundColorConnectorLineColor {
  @scala.inline
  def apply(
  ...
  ): AnonBackgroundColorConnectorLineColor = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorConnectorLineColor]
  }
}
