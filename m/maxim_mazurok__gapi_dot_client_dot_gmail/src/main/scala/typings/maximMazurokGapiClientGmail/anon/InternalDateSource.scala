...
@js.native
trait InternalDateSource extends js.Object {
...
object InternalDateSource {
  ...
  @scala.inline
  def apply(userId: String): InternalDateSource = {
    val __obj = js.Dynamic.literal(userId = userId.asInstanceOf[js.Any])
    __obj.asInstanceOf[InternalDateSource]
  }
  
  @scala.inline
  implicit class InternalDateSourceOps[Self <: InternalDateSource] (val x: Self) extends AnyVal {
