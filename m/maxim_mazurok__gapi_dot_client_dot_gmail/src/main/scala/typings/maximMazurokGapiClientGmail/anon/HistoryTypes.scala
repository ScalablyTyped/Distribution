...
trait HistoryTypes extends js.Object {
  ...
  var historyTypes: js.UndefOr[String | js.Array[String]] = js.native
...
object HistoryTypes {
  ...
  implicit class HistoryTypesOps[Self <: HistoryTypes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHistoryTypes(value: String | js.Array[String]): Self = this.set("historyTypes", value.asInstanceOf[js.Any])
