...
object HistoryTypes {
  ...
  inline def apply(userId: String): HistoryTypes = {
    val __obj = js.Dynamic.literal(userId = userId.asInstanceOf[js.Any])
    __obj.asInstanceOf[HistoryTypes]
  }
  
  extension [Self <: HistoryTypes](x: Self) {
    ...
    inline def setHistoryTypes(value: String | js.Array[String]): Self = StObject.set(x, "historyTypes", value.asInstanceOf[js.Any])
