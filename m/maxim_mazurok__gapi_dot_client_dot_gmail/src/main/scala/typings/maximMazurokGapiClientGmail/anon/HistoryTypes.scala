...
trait HistoryTypes extends StObject {
  ...
  var historyTypes: js.UndefOr[String | js.Array[String]] = js.undefined
...
object HistoryTypes {
  ...
  @scala.inline
  implicit class HistoryTypesMutableBuilder[Self <: HistoryTypes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHistoryTypes(value: String | js.Array[String]): Self = StObject.set(x, "historyTypes", value.asInstanceOf[js.Any])
