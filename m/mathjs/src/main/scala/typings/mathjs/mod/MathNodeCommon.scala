...
@js.native
trait MathNodeCommon extends StObject {
  ...
  def filter(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  callback: js.Function3[/* node */ MathNode, /* path */ String, /* parent */ MathNode, Any]
  ...
  /**
    ...
    */
  def map(callback: js.Function3[/* node */ MathNode, /* path */ String, /* parent */ MathNode, MathNode]): MathNode = js.native
  ...
  /**
    ...
    * ```
    */
  def transform[TResult](callback: js.Function3[/* node */ this.type, /* path */ String, /* parent */ MathNode, TResult]): TResult = js.native
  ...
  /**
    ...
    * ```
    */
  def traverse(callback: js.Function3[/* node */ MathNode, /* path */ String, /* parent */ MathNode, scala.Unit]): Any = js.native
