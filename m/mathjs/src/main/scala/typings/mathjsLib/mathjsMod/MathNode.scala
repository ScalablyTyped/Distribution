...
trait MathNode extends js.Object {
  ...
  var fn: js.UndefOr[java.lang.String] = js.native
  var isAccessorNode: js.UndefOr[scala.Boolean] = js.native
  var isArrayNode: js.UndefOr[scala.Boolean] = js.native
  var isAssignmentNode: js.UndefOr[scala.Boolean] = js.native
  var isBlockNode: js.UndefOr[scala.Boolean] = js.native
  var isConditionalnode: js.UndefOr[scala.Boolean] = js.native
  var isConstantNode: js.UndefOr[scala.Boolean] = js.native
  var isFunctionAssignmentNode: js.UndefOr[scala.Boolean] = js.native
  var isFunctionNode: js.UndefOr[scala.Boolean] = js.native
  var isIndexNode: js.UndefOr[scala.Boolean] = js.native
  var isNode: scala.Boolean = js.native
  var isObjectNode: js.UndefOr[scala.Boolean] = js.native
  var isOperatorNode: js.UndefOr[scala.Boolean] = js.native
  var isParenthesisNode: js.UndefOr[scala.Boolean] = js.native
  var isRangeNode: js.UndefOr[scala.Boolean] = js.native
  var isSymbolNode: js.UndefOr[scala.Boolean] = js.native
  var isUpdateNode: js.UndefOr[scala.Boolean] = js.native
  var name: js.UndefOr[java.lang.String] = js.native
  var op: js.UndefOr[java.lang.String] = js.native
  ...
  /**
    ...
    */
  def filter(
    callback: js.Function3[/* node */ this.type, /* path */ java.lang.String, /* parent */ this.type, _]
  ...
  /**
    ...
    */
  def map(
    callback: js.Function3[/* node */ this.type, /* path */ java.lang.String, /* parent */ this.type, this.type]
  ): MathNode = js.native
  /**
    * Get a HTML representation of the parsed expression.
    */
  def toHtml(): java.lang.String = js.native
  def toHtml(options: js.Object): java.lang.String = js.native
  def toString(options: js.Object): java.lang.String = js.native
  /**
    * Get a LaTeX representation of the expression.
    */
  def toTex(): java.lang.String = js.native
  def toTex(options: js.Object): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def traverse(
    callback: js.Function3[/* node */ this.type, /* path */ java.lang.String, /* parent */ this.type, scala.Unit]
  ): js.Any = js.native
}
