...
trait Anon_Coefficients extends js.Object {
  var coefficients: js.Array[mathjsLib.mathjsMod.MathType]
  var expression: mathjsLib.mathjsMod.MathNode | java.lang.String
...
object Anon_Coefficients {
  @scala.inline
  def apply(
    coefficients: js.Array[mathjsLib.mathjsMod.MathType],
    expression: mathjsLib.mathjsMod.MathNode | java.lang.String,
