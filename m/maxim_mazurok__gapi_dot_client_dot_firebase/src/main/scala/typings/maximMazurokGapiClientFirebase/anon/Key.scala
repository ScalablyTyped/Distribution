...
import typings.maximMazurokGapiClientFirebase.gapi.client.firebase.AndroidApp
...
trait Key extends StObject {
  ...
  /** Request body */
  var resource: AndroidApp = js.native
...
object Key {
  ...
  @scala.inline
  def apply(parent: String, resource: AndroidApp): Key = {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AndroidApp): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
