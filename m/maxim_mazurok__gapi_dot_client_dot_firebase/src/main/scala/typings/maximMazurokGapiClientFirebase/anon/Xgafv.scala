...
import typings.maximMazurokGapiClientFirebase.gapi.client.firebase.AddGoogleAnalyticsRequest
...
trait Xgafv extends js.Object {
  ...
  /** Request body */
  var resource: AddGoogleAnalyticsRequest = js.native
...
object Xgafv {
  ...
  @scala.inline
  def apply(parent: String, resource: AddGoogleAnalyticsRequest): Xgafv = {
  ...
  implicit class XgafvOps[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AddGoogleAnalyticsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
