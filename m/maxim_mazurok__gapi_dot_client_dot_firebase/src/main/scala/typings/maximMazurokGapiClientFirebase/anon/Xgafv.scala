...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: AddGoogleAnalyticsRequest
...
object Xgafv {
  ...
  inline def apply(parent: String, resource: AddGoogleAnalyticsRequest): Xgafv = {
  ...
  extension [Self <: Xgafv](x: Self) {
    ...
    inline def setResource(value: AddGoogleAnalyticsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
