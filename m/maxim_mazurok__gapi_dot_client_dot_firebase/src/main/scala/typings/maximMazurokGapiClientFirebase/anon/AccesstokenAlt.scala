...
import typings.maximMazurokGapiClientFirebase.gapi.client.firebase.FirebaseProject
...
trait AccesstokenAlt extends js.Object {
  ...
  /** Request body */
  var resource: FirebaseProject = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(name: String, resource: FirebaseProject): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltOps[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: FirebaseProject): Self = this.set("resource", value.asInstanceOf[js.Any])
