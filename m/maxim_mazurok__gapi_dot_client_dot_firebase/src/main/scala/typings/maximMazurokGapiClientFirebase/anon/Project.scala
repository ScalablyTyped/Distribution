...
import typings.maximMazurokGapiClientFirebase.gapi.client.firebase.AddFirebaseRequest
...
trait Project extends StObject {
  ...
  /** Request body */
  var resource: AddFirebaseRequest = js.native
...
object Project {
  ...
  @scala.inline
  def apply(project: String, resource: AddFirebaseRequest): Project = {
  ...
  implicit class ProjectMutableBuilder[Self <: Project] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AddFirebaseRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
