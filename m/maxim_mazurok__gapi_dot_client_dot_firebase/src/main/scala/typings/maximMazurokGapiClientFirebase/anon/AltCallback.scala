...
trait AltCallback extends StObject {
  ...
  /** Request body */
  var resource: RemoveAnalyticsRequest = js.native
...
object AltCallback {
  ...
  @scala.inline
  def apply(parent: String, resource: RemoveAnalyticsRequest): AltCallback = {
  ...
  implicit class AltCallbackMutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RemoveAnalyticsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
