...
import typings.maximMazurokGapiClientFirebase.gapi.client.firebase.ShaCertificate
...
trait Callback extends StObject {
  ...
  /** Request body */
  var resource: ShaCertificate = js.native
...
object Callback {
  ...
  @scala.inline
  def apply(parent: String, resource: ShaCertificate): Callback = {
  ...
  implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ShaCertificate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
