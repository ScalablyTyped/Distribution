...
import typings.maximMazurokGapiClientFirebase.gapi.client.firebase.FinalizeDefaultLocationRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: FinalizeDefaultLocationRequest
...
object Parent {
  ...
  inline def apply(parent: String, resource: FinalizeDefaultLocationRequest): Parent = {
  ...
  implicit open class MutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: FinalizeDefaultLocationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
