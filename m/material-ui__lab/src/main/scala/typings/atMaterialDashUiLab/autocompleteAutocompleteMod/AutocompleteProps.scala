...
trait AutocompleteProps extends js.Object {
  ...
  /**
    ...
    * @returns {ReactNode}
    */
  var renderGroup: js.UndefOr[js.Function1[/* params */ RenderGroupParams, ReactNode]] = js.undefined
  /**
    ...
    * @returns {ReactNode}
    */
  var renderOption: js.UndefOr[js.Function2[/* option */ js.Any, /* state */ RenderOptionState, ReactNode]] = js.undefined
  /**
  ...
  /**
    ...
    * @returns {ReactNode}
    */
  def renderInput(params: RenderInputParams): ReactNode
}
