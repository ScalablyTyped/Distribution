...
import typings.atMaterialDashUiLab.PartialClassNameMapToggleButtonGroupClassKey
...
object ToggleButtonGroupProps {
  ...
  def apply(
    ...
    onChange: (/* event */ MouseEvent[HTMLElement, NativeMouseEvent], /* value */ js.Any) => Unit = null,
