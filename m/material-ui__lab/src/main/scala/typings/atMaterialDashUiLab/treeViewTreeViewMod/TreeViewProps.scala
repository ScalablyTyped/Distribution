...
import typings.atMaterialDashUiLab.PartialClassNameMapTreeViewClassKey
...
object TreeViewProps {
  ...
  def apply(
    ...
    defaultCollapseIcon: ReactNode = null,
    defaultEndIcon: ReactNode = null,
    ...
    if (defaultExpanded != null) __obj.updateDynamic("defaultExpanded")(defaultExpanded)
