...
import typings.materialUiLab.anon.Index
import typings.materialUiLab.anon.PartialClassNameMapAutoco
...
import typings.materialUiLab.materialUiLabStrings.`inline`
import typings.materialUiLab.materialUiLabStrings.`removals additions`
import typings.materialUiLab.materialUiLabStrings.`removals text`
import typings.materialUiLab.materialUiLabStrings.`text additions`
import typings.materialUiLab.materialUiLabStrings.`text removals`
import typings.materialUiLab.materialUiLabStrings.additions
import typings.materialUiLab.materialUiLabStrings.all
import typings.materialUiLab.materialUiLabStrings.ascending
import typings.materialUiLab.materialUiLabStrings.assertive
import typings.materialUiLab.materialUiLabStrings.auto
import typings.materialUiLab.materialUiLabStrings.both
import typings.materialUiLab.materialUiLabStrings.copy
import typings.materialUiLab.materialUiLabStrings.date
import typings.materialUiLab.materialUiLabStrings.decimal
import typings.materialUiLab.materialUiLabStrings.descending
import typings.materialUiLab.materialUiLabStrings.dialog
import typings.materialUiLab.materialUiLabStrings.email
import typings.materialUiLab.materialUiLabStrings.execute
import typings.materialUiLab.materialUiLabStrings.grammar
import typings.materialUiLab.materialUiLabStrings.grid
import typings.materialUiLab.materialUiLabStrings.horizontal
import typings.materialUiLab.materialUiLabStrings.inherit
import typings.materialUiLab.materialUiLabStrings.link
import typings.materialUiLab.materialUiLabStrings.list
import typings.materialUiLab.materialUiLabStrings.listbox
import typings.materialUiLab.materialUiLabStrings.location
import typings.materialUiLab.materialUiLabStrings.medium
import typings.materialUiLab.materialUiLabStrings.menu
import typings.materialUiLab.materialUiLabStrings.mixed
import typings.materialUiLab.materialUiLabStrings.mouse
import typings.materialUiLab.materialUiLabStrings.move
import typings.materialUiLab.materialUiLabStrings.no
import typings.materialUiLab.materialUiLabStrings.none
import typings.materialUiLab.materialUiLabStrings.numeric
import typings.materialUiLab.materialUiLabStrings.off
import typings.materialUiLab.materialUiLabStrings.on
import typings.materialUiLab.materialUiLabStrings.other
import typings.materialUiLab.materialUiLabStrings.page
import typings.materialUiLab.materialUiLabStrings.polite
import typings.materialUiLab.materialUiLabStrings.popup
import typings.materialUiLab.materialUiLabStrings.removals
import typings.materialUiLab.materialUiLabStrings.search
import typings.materialUiLab.materialUiLabStrings.small
import typings.materialUiLab.materialUiLabStrings.spelling
import typings.materialUiLab.materialUiLabStrings.step
import typings.materialUiLab.materialUiLabStrings.tel
import typings.materialUiLab.materialUiLabStrings.text
import typings.materialUiLab.materialUiLabStrings.time
import typings.materialUiLab.materialUiLabStrings.touch
import typings.materialUiLab.materialUiLabStrings.tree
...
import typings.materialUiLab.useAutocompleteUseAutocompleteMod.AutocompleteChangeDetails
import typings.materialUiLab.useAutocompleteUseAutocompleteMod.AutocompleteChangeReason
import typings.materialUiLab.useAutocompleteUseAutocompleteMod.AutocompleteCloseReason
import typings.materialUiLab.useAutocompleteUseAutocompleteMod.AutocompleteFreeSoloValueMapping
import typings.materialUiLab.useAutocompleteUseAutocompleteMod.AutocompleteHighlightChangeReason
import typings.materialUiLab.useAutocompleteUseAutocompleteMod.AutocompleteInputChangeReason
...
object autocompleteAutocompleteMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiLab.materialUiLabStrings.focused
    - typings.materialUiLab.materialUiLabStrings.tag
    - typings.materialUiLab.materialUiLabStrings.tagSizeSmall
    - typings.materialUiLab.materialUiLabStrings.inputRoot
    - typings.materialUiLab.materialUiLabStrings.input
    - typings.materialUiLab.materialUiLabStrings.inputFocused
    - typings.materialUiLab.materialUiLabStrings.endAdornment
    - typings.materialUiLab.materialUiLabStrings.clearIndicator
    - typings.materialUiLab.materialUiLabStrings.clearIndicatorDirty
    - typings.materialUiLab.materialUiLabStrings.popupIndicator
    - typings.materialUiLab.materialUiLabStrings.popupIndicatorOpen
    - typings.materialUiLab.materialUiLabStrings.popper
    - typings.materialUiLab.materialUiLabStrings.popperDisablePortal
    - typings.materialUiLab.materialUiLabStrings.paper
    - typings.materialUiLab.materialUiLabStrings.listbox
    - typings.materialUiLab.materialUiLabStrings.loading
    - typings.materialUiLab.materialUiLabStrings.noOptions
    - typings.materialUiLab.materialUiLabStrings.option
    - typings.materialUiLab.materialUiLabStrings.groupLabel
    - typings.materialUiLab.materialUiLabStrings.groupUl
  */
  trait AutocompleteClassKey extends StObject
  object AutocompleteClassKey {
    
    @scala.inline
    def clearIndicator: typings.materialUiLab.materialUiLabStrings.clearIndicator = "clearIndicator".asInstanceOf[typings.materialUiLab.materialUiLabStrings.clearIndicator]
    
    @scala.inline
    def clearIndicatorDirty: typings.materialUiLab.materialUiLabStrings.clearIndicatorDirty = "clearIndicatorDirty".asInstanceOf[typings.materialUiLab.materialUiLabStrings.clearIndicatorDirty]
    
    @scala.inline
    def endAdornment: typings.materialUiLab.materialUiLabStrings.endAdornment = "endAdornment".asInstanceOf[typings.materialUiLab.materialUiLabStrings.endAdornment]
    
    @scala.inline
    def focused: typings.materialUiLab.materialUiLabStrings.focused = "focused".asInstanceOf[typings.materialUiLab.materialUiLabStrings.focused]
    
    @scala.inline
    def groupLabel: typings.materialUiLab.materialUiLabStrings.groupLabel = "groupLabel".asInstanceOf[typings.materialUiLab.materialUiLabStrings.groupLabel]
    
    @scala.inline
    def groupUl: typings.materialUiLab.materialUiLabStrings.groupUl = "groupUl".asInstanceOf[typings.materialUiLab.materialUiLabStrings.groupUl]
    ...
    @scala.inline
    def inputFocused: typings.materialUiLab.materialUiLabStrings.inputFocused = "inputFocused".asInstanceOf[typings.materialUiLab.materialUiLabStrings.inputFocused]
    
    @scala.inline
    def inputRoot: typings.materialUiLab.materialUiLabStrings.inputRoot = "inputRoot".asInstanceOf[typings.materialUiLab.materialUiLabStrings.inputRoot]
    
    @scala.inline
    def listbox: typings.materialUiLab.materialUiLabStrings.listbox = "listbox".asInstanceOf[typings.materialUiLab.materialUiLabStrings.listbox]
    
    @scala.inline
    def loading: typings.materialUiLab.materialUiLabStrings.loading = "loading".asInstanceOf[typings.materialUiLab.materialUiLabStrings.loading]
    
    @scala.inline
    def noOptions: typings.materialUiLab.materialUiLabStrings.noOptions = "noOptions".asInstanceOf[typings.materialUiLab.materialUiLabStrings.noOptions]
    
    @scala.inline
    def option: typings.materialUiLab.materialUiLabStrings.option = "option".asInstanceOf[typings.materialUiLab.materialUiLabStrings.option]
    
    @scala.inline
    def paper: typings.materialUiLab.materialUiLabStrings.paper = "paper".asInstanceOf[typings.materialUiLab.materialUiLabStrings.paper]
    
    @scala.inline
    def popper: typings.materialUiLab.materialUiLabStrings.popper = "popper".asInstanceOf[typings.materialUiLab.materialUiLabStrings.popper]
    
    @scala.inline
    def popperDisablePortal: typings.materialUiLab.materialUiLabStrings.popperDisablePortal = "popperDisablePortal".asInstanceOf[typings.materialUiLab.materialUiLabStrings.popperDisablePortal]
    
    @scala.inline
    def popupIndicator: typings.materialUiLab.materialUiLabStrings.popupIndicator = "popupIndicator".asInstanceOf[typings.materialUiLab.materialUiLabStrings.popupIndicator]
    
    @scala.inline
    def popupIndicatorOpen: typings.materialUiLab.materialUiLabStrings.popupIndicatorOpen = "popupIndicatorOpen".asInstanceOf[typings.materialUiLab.materialUiLabStrings.popupIndicatorOpen]
    ...
    @scala.inline
    def tag: typings.materialUiLab.materialUiLabStrings.tag = "tag".asInstanceOf[typings.materialUiLab.materialUiLabStrings.tag]
    
    @scala.inline
    def tagSizeSmall: typings.materialUiLab.materialUiLabStrings.tagSizeSmall = "tagSizeSmall".asInstanceOf[typings.materialUiLab.materialUiLabStrings.tagSizeSmall]
  }
  ...
  object AutocompleteProps {
    ...
    @scala.inline
    def apply[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */](options: js.Array[T], renderInput: AutocompleteRenderInputParams => ReactNode): AutocompleteProps[T, Multiple, DisableClearable, FreeSolo] = {
    ...
    implicit class AutocompletePropsMutableBuilder[Self <: AutocompleteProps[?, ?, ?, ?], T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] (val x: Self & (AutocompleteProps[T, Multiple, DisableClearable, FreeSolo])) extends AnyVal {
      ...
      @scala.inline
      def setChipProps(value: js.Object): Self = StObject.set(x, "ChipProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapAutoco): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setGetLimitTagsText(value: /* more */ Double => ReactNode): Self = StObject.set(x, "getLimitTagsText", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setListboxComponent(value: ComponentType[HTMLAttributes[HTMLElement]]): Self = StObject.set(x, "ListboxComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setListboxComponentUndefined: Self = StObject.set(x, "ListboxComponent", js.undefined)
      
      @scala.inline
      def setListboxProps(value: js.Object): Self = StObject.set(x, "ListboxProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLoadingText(value: ReactNode): Self = StObject.set(x, "loadingText", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNoOptionsText(value: ReactNode): Self = StObject.set(x, "noOptionsText", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPaperComponent(value: ComponentType[HTMLAttributes[HTMLElement]]): Self = StObject.set(x, "PaperComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPopperComponent(value: ComponentType[PopperProps]): Self = StObject.set(x, "PopperComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPopperComponentUndefined: Self = StObject.set(x, "PopperComponent", js.undefined)
      
      @scala.inline
      def setPopupIcon(value: ReactNode): Self = StObject.set(x, "popupIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRenderGroup(value: /* params */ AutocompleteRenderGroupParams => ReactNode): Self = StObject.set(x, "renderGroup", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRenderGroupUndefined: Self = StObject.set(x, "renderGroup", js.undefined)
      
      @scala.inline
      def setRenderInput(value: AutocompleteRenderInputParams => ReactNode): Self = StObject.set(x, "renderInput", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRenderOption(value: (/* option */ T, /* state */ AutocompleteRenderOptionState) => ReactNode): Self = StObject.set(x, "renderOption", js.Any.fromFunction2(value))
      
      @scala.inline
      def setRenderOptionUndefined: Self = StObject.set(x, "renderOption", js.undefined)
      
      @scala.inline
      def setRenderTags(value: (/* value */ js.Array[T], /* getTagProps */ AutocompleteGetTagProps) => ReactNode): Self = StObject.set(x, "renderTags", js.Any.fromFunction2(value))
  ...
  object AutocompleteRenderInputParams {
    ...
    implicit class AutocompleteRenderInputParamsMutableBuilder[Self <: AutocompleteRenderInputParams] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInputLabelProps(value: js.Object): Self = StObject.set(x, "InputLabelProps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInputProps(value: ClassName): Self = StObject.set(x, "InputProps", value.asInstanceOf[js.Any])
