...
object autocompleteAutocompleteMod {
  ...
  */
  ...
  object AutocompleteClassKey {
    ...
    inline def clearIndicator: typings.materialUiLab.materialUiLabStrings.clearIndicator = "clearIndicator".asInstanceOf[typings.materialUiLab.materialUiLabStrings.clearIndicator]
    
    inline def clearIndicatorDirty: typings.materialUiLab.materialUiLabStrings.clearIndicatorDirty = "clearIndicatorDirty".asInstanceOf[typings.materialUiLab.materialUiLabStrings.clearIndicatorDirty]
    
    inline def endAdornment: typings.materialUiLab.materialUiLabStrings.endAdornment = "endAdornment".asInstanceOf[typings.materialUiLab.materialUiLabStrings.endAdornment]
    
    inline def focused: typings.materialUiLab.materialUiLabStrings.focused = "focused".asInstanceOf[typings.materialUiLab.materialUiLabStrings.focused]
    
    inline def groupLabel: typings.materialUiLab.materialUiLabStrings.groupLabel = "groupLabel".asInstanceOf[typings.materialUiLab.materialUiLabStrings.groupLabel]
    
    inline def groupUl: typings.materialUiLab.materialUiLabStrings.groupUl = "groupUl".asInstanceOf[typings.materialUiLab.materialUiLabStrings.groupUl]
    ...
    inline def inputFocused: typings.materialUiLab.materialUiLabStrings.inputFocused = "inputFocused".asInstanceOf[typings.materialUiLab.materialUiLabStrings.inputFocused]
    
    inline def inputRoot: typings.materialUiLab.materialUiLabStrings.inputRoot = "inputRoot".asInstanceOf[typings.materialUiLab.materialUiLabStrings.inputRoot]
    
    inline def listbox: typings.materialUiLab.materialUiLabStrings.listbox = "listbox".asInstanceOf[typings.materialUiLab.materialUiLabStrings.listbox]
    
    inline def loading: typings.materialUiLab.materialUiLabStrings.loading = "loading".asInstanceOf[typings.materialUiLab.materialUiLabStrings.loading]
    
    inline def noOptions: typings.materialUiLab.materialUiLabStrings.noOptions = "noOptions".asInstanceOf[typings.materialUiLab.materialUiLabStrings.noOptions]
    
    inline def option: typings.materialUiLab.materialUiLabStrings.option = "option".asInstanceOf[typings.materialUiLab.materialUiLabStrings.option]
    
    inline def paper: typings.materialUiLab.materialUiLabStrings.paper = "paper".asInstanceOf[typings.materialUiLab.materialUiLabStrings.paper]
    
    inline def popper: typings.materialUiLab.materialUiLabStrings.popper = "popper".asInstanceOf[typings.materialUiLab.materialUiLabStrings.popper]
    
    inline def popperDisablePortal: typings.materialUiLab.materialUiLabStrings.popperDisablePortal = "popperDisablePortal".asInstanceOf[typings.materialUiLab.materialUiLabStrings.popperDisablePortal]
    
    inline def popupIndicator: typings.materialUiLab.materialUiLabStrings.popupIndicator = "popupIndicator".asInstanceOf[typings.materialUiLab.materialUiLabStrings.popupIndicator]
    
    inline def popupIndicatorOpen: typings.materialUiLab.materialUiLabStrings.popupIndicatorOpen = "popupIndicatorOpen".asInstanceOf[typings.materialUiLab.materialUiLabStrings.popupIndicatorOpen]
    ...
    inline def tag: typings.materialUiLab.materialUiLabStrings.tag = "tag".asInstanceOf[typings.materialUiLab.materialUiLabStrings.tag]
  ...
  object AutocompleteProps {
    ...
    inline def apply[T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */](options: js.Array[T], renderInput: AutocompleteRenderInputParams => ReactNode): AutocompleteProps[T, Multiple, DisableClearable, FreeSolo] = {
    ...
    extension [Self <: AutocompleteProps[?, ?, ?, ?], T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */](x: Self & (AutocompleteProps[T, Multiple, DisableClearable, FreeSolo])) {
      ...
      inline def setGetLimitTagsText(value: /* more */ Double => ReactNode): Self = StObject.set(x, "getLimitTagsText", js.Any.fromFunction1(value))
      ...
      inline def setPopupIcon(value: ReactNode): Self = StObject.set(x, "popupIcon", value.asInstanceOf[js.Any])
      ...
      inline def setRenderInput(value: AutocompleteRenderInputParams => ReactNode): Self = StObject.set(x, "renderInput", js.Any.fromFunction1(value))
      
      inline def setRenderOption(value: (/* option */ T, /* state */ AutocompleteRenderOptionState) => ReactNode): Self = StObject.set(x, "renderOption", js.Any.fromFunction2(value))
      
      inline def setRenderOptionUndefined: Self = StObject.set(x, "renderOption", js.undefined)
      
      inline def setRenderTags(value: (/* value */ js.Array[T], /* getTagProps */ AutocompleteGetTagProps) => ReactNode): Self = StObject.set(x, "renderTags", js.Any.fromFunction2(value))
