...
@js.native
trait TimelineOppositeContentProps extends js.Object {
  /**
...
object TimelineOppositeContentProps {
  ...
  @scala.inline
  implicit class TimelineOppositeContentPropsOps[Self <: TimelineOppositeContentProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTimeliAlignRight): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
