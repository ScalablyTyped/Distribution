package typings.materialUiLab.timelineContentTimelineContentMod
...
@js.native
trait TimelineContentProps extends js.Object {
  /**
...
object TimelineContentProps {
  ...
  @scala.inline
  implicit class TimelineContentPropsOps[Self <: TimelineContentProps] (val x: Self) extends AnyVal {
    @scala.inline
