...
object alertTitleAlertTitleMod {
  ...
  @JSImport("@material-ui/lab/AlertTitle/AlertTitle", JSImport.Default)
  @js.native
  def default(props: AlertTitleProps): Element = js.native
  ...
  trait AlertTitleProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapAlertT] = js.native
