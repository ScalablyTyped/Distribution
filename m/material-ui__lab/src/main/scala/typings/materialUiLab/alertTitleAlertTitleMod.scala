...
import typings.materialUiLab.anon.PartialClassNameMapAlertT
...
object alertTitleAlertTitleMod {
  
  @JSImport("@material-ui/lab/AlertTitle/AlertTitle", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(props: AlertTitleProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  type AlertTitleClassKey = root
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/lab.@material-ui/lab/AlertTitle/AlertTitle.AlertTitleClassKey, never> */
  trait AlertTitleProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapAlertT] = js.undefined
  ...
  object AlertTitleProps {
    
    @scala.inline
    def apply(): AlertTitleProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AlertTitleProps]
    }
    
    @scala.inline
    implicit class AlertTitlePropsMutableBuilder[Self <: AlertTitleProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapAlertT): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
