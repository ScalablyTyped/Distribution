...
object tabPanelTabPanelMod {
  
  @JSImport("@material-ui/lab/TabPanel/TabPanel", JSImport.Namespace)
  @js.native
  ...
  trait TabPanelProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapTabPan] = js.undefined
  ...
  object TabPanelProps {
    ...
    inline def apply(value: String): TabPanelProps = {
    ...
    extension [Self <: TabPanelProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapTabPan): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
