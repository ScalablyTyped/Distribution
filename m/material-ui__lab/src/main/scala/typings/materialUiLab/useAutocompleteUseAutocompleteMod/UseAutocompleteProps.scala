...
object UseAutocompleteProps {
  @scala.inline
  def apply[T, /* <: js.UndefOr[scala.Boolean] */ Multiple, /* <: js.UndefOr[scala.Boolean] */ DisableClearable, /* <: js.UndefOr[scala.Boolean] */ FreeSolo](options: js.Array[T]): UseAutocompleteProps[T, Multiple, DisableClearable, FreeSolo] = {
    val __obj = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    __obj.asInstanceOf[UseAutocompleteProps[T, Multiple, DisableClearable, FreeSolo]]
  }
  @scala.inline
  implicit class UseAutocompletePropsOps[Self <: UseAutocompleteProps[_, _, _, _], T, /* <: js.UndefOr[scala.Boolean] */ Multiple, /* <: js.UndefOr[scala.Boolean] */ DisableClearable, /* <: js.UndefOr[scala.Boolean] */ FreeSolo] (val x: Self with (UseAutocompleteProps[T, Multiple, DisableClearable, FreeSolo])) extends AnyVal {
    @scala.inline
