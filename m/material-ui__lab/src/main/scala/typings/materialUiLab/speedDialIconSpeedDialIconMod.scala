...
object speedDialIconSpeedDialIconMod {
  ...
  @scala.inline
  def default(props: SpeedDialIconProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  */
  ...
  object SpeedDialIconClassKey {
    ...
    @scala.inline
    def iconOpen: typings.materialUiLab.materialUiLabStrings.iconOpen = "iconOpen".asInstanceOf[typings.materialUiLab.materialUiLabStrings.iconOpen]
    
    @scala.inline
    def iconWithOpenIconOpen: typings.materialUiLab.materialUiLabStrings.iconWithOpenIconOpen = "iconWithOpenIconOpen".asInstanceOf[typings.materialUiLab.materialUiLabStrings.iconWithOpenIconOpen]
    
    @scala.inline
    def openIcon: typings.materialUiLab.materialUiLabStrings.openIcon = "openIcon".asInstanceOf[typings.materialUiLab.materialUiLabStrings.openIcon]
    
    @scala.inline
    def openIconOpen: typings.materialUiLab.materialUiLabStrings.openIconOpen = "openIconOpen".asInstanceOf[typings.materialUiLab.materialUiLabStrings.openIconOpen]
  ...
  object SpeedDialIconProps {
    ...
    implicit class SpeedDialIconPropsMutableBuilder[Self <: SpeedDialIconProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapSpeedDIcon): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
