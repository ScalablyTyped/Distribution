...
import typings.materialUiLab.anon.PartialClassNameMapAlertC
import typings.materialUiLab.anon.PartialRecordColorReactNo
...
import typings.materialUiLab.materialUiLabStrings.filled
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/Paper.PaperProps, @material-ui/lab.@material-ui/lab/Alert/Alert.AlertClassKey, 'variant'> */
@js.native
trait AlertProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapAlertC] = js.native
  /**
  ...
  /**
    ...
    */
  var icon: js.UndefOr[ReactNode | `false`] = js.native
  /**
    ...
    */
  var iconMapping: js.UndefOr[PartialRecordColorReactNo] = js.native
  ...
  /**
    ...
    */
  var onClose: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Element, Event], Unit]] = js.native
  ...
  /**
    ...
    */
  var severity: js.UndefOr[Color] = js.native
...
object AlertProps {
  ...
  implicit class AlertPropsOps[Self <: AlertProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapAlertC): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIcon(value: ReactNode | `false`): Self = this.set("icon", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIcon: Self = this.set("icon", js.undefined)
    @scala.inline
    def setIconMapping(value: PartialRecordColorReactNo): Self = this.set("iconMapping", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIconMapping: Self = this.set("iconMapping", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setOnClose(value: /* event */ SyntheticEvent[Element, Event] => Unit): Self = this.set("onClose", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSeverity(value: Color): Self = this.set("severity", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setVariant(value: standard | filled | outlined): Self = this.set("variant", value.asInstanceOf[js.Any])
    @scala.inline
