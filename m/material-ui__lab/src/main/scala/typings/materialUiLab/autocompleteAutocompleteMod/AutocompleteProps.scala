...
object AutocompleteProps {
  ...
  @scala.inline
  implicit class AutocompletePropsOps[Self <: AutocompleteProps[_, _, _, _], T, Multiple /* <: js.UndefOr[Boolean] */, DisableClearable /* <: js.UndefOr[Boolean] */, FreeSolo /* <: js.UndefOr[Boolean] */] (val x: Self with (AutocompleteProps[T, Multiple, DisableClearable, FreeSolo])) extends AnyVal {
