package typings.materialUiLab.toggleButtonGroupToggleButtonGroupMod

import typings.materialUiLab.anon.PartialClassNameMapToggle
...
object ToggleButtonGroupProps {
  ...
  implicit class ToggleButtonGroupPropsOps[Self <: ToggleButtonGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: (/* event */ MouseEvent[HTMLElement, NativeMouseEvent], /* value */ js.Any) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
