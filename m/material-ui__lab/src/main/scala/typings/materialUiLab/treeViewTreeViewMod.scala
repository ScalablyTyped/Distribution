...
import typings.materialUiLab.anon.PartialClassNameMapTreeVi
...
object treeViewTreeViewMod {
  ...
  object MultiSelectTreeViewProps {
    ...
    extension [Self <: MultiSelectTreeViewProps](x: Self) {
      ...
      inline def setOnNodeSelect(value: (/* event */ ChangeEvent[js.Object], /* nodeIds */ js.Array[String]) => Unit): Self = StObject.set(x, "onNodeSelect", js.Any.fromFunction2(value))
  ...
  trait SingleSelectTreeViewProps
    ...
    /**
      ...
      * this is an array of strings; when false (default) a string.
      */
    var onNodeSelect: js.UndefOr[js.Function2[/* event */ ChangeEvent[js.Object], /* nodeIds */ String, Unit]] = js.undefined
  ...
  object SingleSelectTreeViewProps {
    ...
    extension [Self <: SingleSelectTreeViewProps](x: Self) {
      ...
      inline def setOnNodeSelect(value: (/* event */ ChangeEvent[js.Object], /* nodeIds */ String) => Unit): Self = StObject.set(x, "onNodeSelect", js.Any.fromFunction2(value))
  ...
  */
  ...
  object TreeViewProps {
    ...
    inline def MultiSelectTreeViewProps(): typings.materialUiLab.treeViewTreeViewMod.MultiSelectTreeViewProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.materialUiLab.treeViewTreeViewMod.MultiSelectTreeViewProps]
    }
    
    inline def SingleSelectTreeViewProps(): typings.materialUiLab.treeViewTreeViewMod.SingleSelectTreeViewProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.materialUiLab.treeViewTreeViewMod.SingleSelectTreeViewProps]
    }
  }
  ...
  object TreeViewPropsBase {
    ...
    extension [Self <: TreeViewPropsBase](x: Self) {
      ...
      inline def setDefaultCollapseIcon(value: ReactNode): Self = StObject.set(x, "defaultCollapseIcon", value.asInstanceOf[js.Any])
      
      inline def setDefaultCollapseIconUndefined: Self = StObject.set(x, "defaultCollapseIcon", js.undefined)
      
      inline def setDefaultEndIcon(value: ReactNode): Self = StObject.set(x, "defaultEndIcon", value.asInstanceOf[js.Any])
      
      inline def setDefaultEndIconUndefined: Self = StObject.set(x, "defaultEndIcon", js.undefined)
      
      inline def setDefaultExpandIcon(value: ReactNode): Self = StObject.set(x, "defaultExpandIcon", value.asInstanceOf[js.Any])
      ...
      inline def setDefaultExpandedVarargs(value: String*): Self = StObject.set(x, "defaultExpanded", js.Array(value :_*))
      
      inline def setDefaultParentIcon(value: ReactNode): Self = StObject.set(x, "defaultParentIcon", value.asInstanceOf[js.Any])
      ...
      inline def setOnNodeToggle(value: (/* event */ ChangeEvent[js.Object], /* nodeIds */ js.Array[String]) => Unit): Self = StObject.set(x, "onNodeToggle", js.Any.fromFunction2(value))
