...
object RatingProps {
  ...
  implicit class RatingPropsOps[Self <: RatingProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIconContainerComponent(value: ElementType[IconContainerProps]): Self = this.set("IconContainerComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIconContainerComponent: Self = this.set("IconContainerComponent", js.undefined)
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapRating): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEmptyIcon(value: ReactNode): Self = this.set("emptyIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEmptyIcon: Self = this.set("emptyIcon", js.undefined)
    
    @scala.inline
    def setEmptyLabelText(value: ReactNode): Self = this.set("emptyLabelText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEmptyLabelText: Self = this.set("emptyLabelText", js.undefined)
    
    @scala.inline
    def setGetLabelText(value: /* value */ Double => String): Self = this.set("getLabelText", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteGetLabelText: Self = this.set("getLabelText", js.undefined)
    ...
    @scala.inline
    def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* value */ Double | Null) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnChange: Self = this.set("onChange", js.undefined)
    
    @scala.inline
    def setOnChangeActive(value: (/* event */ ChangeEvent[js.Object], /* value */ Double) => Unit): Self = this.set("onChangeActive", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnChangeActive: Self = this.set("onChangeActive", js.undefined)
