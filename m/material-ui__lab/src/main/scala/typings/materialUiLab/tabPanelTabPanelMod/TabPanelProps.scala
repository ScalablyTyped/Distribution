package typings.materialUiLab.tabPanelTabPanelMod

import typings.materialUiLab.anon.PartialClassNameMapTabPan
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/lab.@material-ui/lab/TabPanel/TabPanel.TabPanelClassKey, never> */
@js.native
trait TabPanelProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapTabPan] = js.native
...
object TabPanelProps {
  ...
  @scala.inline
  def apply(value: String): TabPanelProps = {
  ...
  implicit class TabPanelPropsOps[Self <: TabPanelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTabPan): Self = this.set("classes", value.asInstanceOf[js.Any])
