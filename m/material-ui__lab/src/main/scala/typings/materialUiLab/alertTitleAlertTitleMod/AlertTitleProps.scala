package typings.materialUiLab.alertTitleAlertTitleMod
...
@js.native
trait AlertTitleProps extends js.Object {
...
object AlertTitleProps {
  ...
  @scala.inline
  implicit class AlertTitlePropsOps[Self <: AlertTitleProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapAlertT): Self = this.set("classes", value.asInstanceOf[js.Any])
