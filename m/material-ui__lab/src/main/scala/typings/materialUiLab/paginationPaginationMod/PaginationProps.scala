...
object PaginationProps {
  ...
  implicit class PaginationPropsOps[Self <: PaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapPagina): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): Self = this.set("getItemAriaLabel", js.Any.fromFunction3(value))
    @scala.inline
    def deleteGetItemAriaLabel: Self = this.set("getItemAriaLabel", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setRenderItem(value: /* params */ PaginationRenderItemParams => ReactNode): Self = this.set("renderItem", js.Any.fromFunction1(value))
    @scala.inline
