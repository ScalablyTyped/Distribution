package typings.materialUiLab.avatarGroupAvatarGroupMod

import typings.materialUiLab.anon.PartialClassNameMapAvatar
...
@js.native
trait AvatarGroupProps extends js.Object {
...
object AvatarGroupProps {
  ...
  @scala.inline
  implicit class AvatarGroupPropsOps[Self <: AvatarGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapAvatar): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSpacing(value: small | medium | Double): Self = this.set("spacing", value.asInstanceOf[js.Any])
