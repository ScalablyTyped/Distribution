...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/lab.@material-ui/lab/Alert/Alert.AlertClassKey>> */
...
object PartialClassNameMapAlertC {
  ...
  inline def apply(): PartialClassNameMapAlertC = {
