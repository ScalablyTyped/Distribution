...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/lab.@material-ui/lab/SpeedDialAction/SpeedDialAction.SpeedDialActionClassKey>> */
trait PartialClassNameMapSpeedDFab extends StObject {
...
object PartialClassNameMapSpeedDFab {
  
  inline def apply(): PartialClassNameMapSpeedDFab = {
