...
import typings.materialUiLab.materialUiLabStrings.extended
...
import typings.materialUiLab.materialUiLabStrings.reset
...
import typings.materialUiLab.materialUiLabStrings.submit
...
trait PartialFabProps extends StObject {
  ...
  var color: js.UndefOr[typings.materialUiCore.mod.PropTypes.Color] = js.native
...
object PartialFabProps {
  ...
  implicit class PartialFabPropsMutableBuilder[Self <: PartialFabProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: typings.materialUiCore.mod.PropTypes.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
