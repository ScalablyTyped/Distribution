...
object paginationPaginationMod {
  ...
  */
  ...
  object PaginationClassKey {
    ...
    @scala.inline
    def ul: typings.materialUiLab.materialUiLabStrings.ul = "ul".asInstanceOf[typings.materialUiLab.materialUiLabStrings.ul]
  }
  ...
  object PaginationProps {
    ...
    implicit class PaginationPropsMutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderItem(value: /* params */ PaginationRenderItemParams => ReactNode): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
