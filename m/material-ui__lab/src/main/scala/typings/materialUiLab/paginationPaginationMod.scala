...
import typings.materialUiLab.anon.PartialClassNameMapPagina
...
object paginationPaginationMod {
  ...
  @JSImport("@material-ui/lab/Pagination/Pagination", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiLab.materialUiLabStrings.ul
  */
  ...
  object PaginationClassKey {
    ...
    inline def ul: typings.materialUiLab.materialUiLabStrings.ul = "ul".asInstanceOf[typings.materialUiLab.materialUiLabStrings.ul]
  }
  ...
  trait PaginationProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapPagina] = js.undefined
    ...
    /**
      ...
      * @returns {ReactNode}
      */
    var renderItem: js.UndefOr[js.Function1[/* params */ PaginationRenderItemParams, ReactNode]] = js.undefined
  ...
  object PaginationProps {
    ...
    extension [Self <: PaginationProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapPagina): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setRenderItem(value: /* params */ PaginationRenderItemParams => ReactNode): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
