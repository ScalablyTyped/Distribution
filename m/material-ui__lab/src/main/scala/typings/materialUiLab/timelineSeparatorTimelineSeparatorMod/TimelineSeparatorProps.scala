package typings.materialUiLab.timelineSeparatorTimelineSeparatorMod
...
@js.native
trait TimelineSeparatorProps extends js.Object {
...
object TimelineSeparatorProps {
  ...
  @scala.inline
  implicit class TimelineSeparatorPropsOps[Self <: TimelineSeparatorProps] (val x: Self) extends AnyVal {
