...
import typings.materialUiLab.anon.PartialClassNameMapSpeedD
...
object speedDialActionSpeedDialActionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiLab.materialUiLabStrings.fabClosed
    - typings.materialUiLab.materialUiLabStrings.staticTooltip
    - typings.materialUiLab.materialUiLabStrings.staticTooltipClosed
    - typings.materialUiLab.materialUiLabStrings.staticTooltipLabel
    - typings.materialUiLab.materialUiLabStrings.tooltipPlacementLeft
  */
  ...
  object SpeedDialActionClassKey {
    ...
    inline def fabClosed: typings.materialUiLab.materialUiLabStrings.fabClosed = "fabClosed".asInstanceOf[typings.materialUiLab.materialUiLabStrings.fabClosed]
    
    inline def staticTooltip: typings.materialUiLab.materialUiLabStrings.staticTooltip = "staticTooltip".asInstanceOf[typings.materialUiLab.materialUiLabStrings.staticTooltip]
    
    inline def staticTooltipClosed: typings.materialUiLab.materialUiLabStrings.staticTooltipClosed = "staticTooltipClosed".asInstanceOf[typings.materialUiLab.materialUiLabStrings.staticTooltipClosed]
    
    inline def staticTooltipLabel: typings.materialUiLab.materialUiLabStrings.staticTooltipLabel = "staticTooltipLabel".asInstanceOf[typings.materialUiLab.materialUiLabStrings.staticTooltipLabel]
    
    inline def tooltipPlacementLeft: typings.materialUiLab.materialUiLabStrings.tooltipPlacementLeft = "tooltipPlacementLeft".asInstanceOf[typings.materialUiLab.materialUiLabStrings.tooltipPlacementLeft]
  }
  ...
  trait SpeedDialActionProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapSpeedD] = js.undefined
  ...
  object SpeedDialActionProps {
    ...
    extension [Self <: SpeedDialActionProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapSpeedD): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setTooltipTitle(value: ReactNode): Self = StObject.set(x, "tooltipTitle", value.asInstanceOf[js.Any])
