...
object TreeItemProps {
  ...
  implicit class TreeItemPropsOps[Self <: TreeItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCollapseIcon(value: ReactNode): Self = this.set("collapseIcon", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnIconClick(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = this.set("onIconClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnLabelClick(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = this.set("onLabelClick", js.Any.fromFunction1(value))
    @scala.inline
