...
object toggleButtonGroupToggleButtonGroupMod {
  ...
  */
  ...
  object ToggleButtonGroupClassKey {
    ...
    inline def grouped: typings.materialUiLab.materialUiLabStrings.grouped = "grouped".asInstanceOf[typings.materialUiLab.materialUiLabStrings.grouped]
    
    inline def groupedHorizontal: typings.materialUiLab.materialUiLabStrings.groupedHorizontal = "groupedHorizontal".asInstanceOf[typings.materialUiLab.materialUiLabStrings.groupedHorizontal]
    
    inline def groupedVertical: typings.materialUiLab.materialUiLabStrings.groupedVertical = "groupedVertical".asInstanceOf[typings.materialUiLab.materialUiLabStrings.groupedVertical]
    ...
    inline def vertical: typings.materialUiLab.materialUiLabStrings.vertical = "vertical".asInstanceOf[typings.materialUiLab.materialUiLabStrings.vertical]
  }
  ...
  trait ToggleButtonGroupProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapToggle] = js.undefined
    ...
    var onChange: js.UndefOr[
        js.Function2[/* event */ MouseEvent[HTMLElement, NativeMouseEvent], /* value */ Any, Unit]
      ] = js.undefined
  ...
  object ToggleButtonGroupProps {
    ...
    extension [Self <: ToggleButtonGroupProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapToggle): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: (/* event */ MouseEvent[HTMLElement, NativeMouseEvent], /* value */ Any) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
