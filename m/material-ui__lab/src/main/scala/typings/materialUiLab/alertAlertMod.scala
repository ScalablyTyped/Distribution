...
object alertAlertMod {
  ...
  */
  ...
  object AlertProps {
    ...
    implicit class AlertPropsMutableBuilder[Self <: AlertProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIcon(value: ReactNode | `false`): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnClose(value: /* event */ SyntheticEvent[typings.std.Element, Event] => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
  ...
  */
  ...
  object Color {
    ...
    @scala.inline
    def error: typings.materialUiLab.materialUiLabStrings.error = "error".asInstanceOf[typings.materialUiLab.materialUiLabStrings.error]
    
    @scala.inline
    def info: typings.materialUiLab.materialUiLabStrings.info = "info".asInstanceOf[typings.materialUiLab.materialUiLabStrings.info]
    
    @scala.inline
    def success: typings.materialUiLab.materialUiLabStrings.success = "success".asInstanceOf[typings.materialUiLab.materialUiLabStrings.success]
    
    @scala.inline
    def warning: typings.materialUiLab.materialUiLabStrings.warning = "warning".asInstanceOf[typings.materialUiLab.materialUiLabStrings.warning]
  }
}
