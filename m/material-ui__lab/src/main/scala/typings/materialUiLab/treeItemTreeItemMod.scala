...
object treeItemTreeItemMod {
  ...
  */
  ...
  object TreeItemClassKey {
    ...
    inline def content: typings.materialUiLab.materialUiLabStrings.content = "content".asInstanceOf[typings.materialUiLab.materialUiLabStrings.content]
    
    inline def expanded: typings.materialUiLab.materialUiLabStrings.expanded = "expanded".asInstanceOf[typings.materialUiLab.materialUiLabStrings.expanded]
    
    inline def group: typings.materialUiLab.materialUiLabStrings.group = "group".asInstanceOf[typings.materialUiLab.materialUiLabStrings.group]
    
    inline def iconContainer: typings.materialUiLab.materialUiLabStrings.iconContainer = "iconContainer".asInstanceOf[typings.materialUiLab.materialUiLabStrings.iconContainer]
  ...
  object TreeItemProps {
    ...
    inline def apply(nodeId: String): TreeItemProps = {
    ...
    extension [Self <: TreeItemProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapTreeIt): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      inline def setCollapseIcon(value: ReactNode): Self = StObject.set(x, "collapseIcon", value.asInstanceOf[js.Any])
      ...
      inline def setOnIconClick(value: MouseEvent[typings.std.Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onIconClick", js.Any.fromFunction1(value))
      
      inline def setOnIconClickUndefined: Self = StObject.set(x, "onIconClick", js.undefined)
      ...
      inline def setOnLabelClick(value: MouseEvent[typings.std.Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onLabelClick", js.Any.fromFunction1(value))
