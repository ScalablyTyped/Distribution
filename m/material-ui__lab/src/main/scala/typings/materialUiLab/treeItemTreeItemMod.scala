...
object treeItemTreeItemMod {
  ...
  @scala.inline
  def default(props: TreeItemProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Rewritten from type alias, can be one of: 
    - typings.materialUiLab.materialUiLabStrings.root
    - typings.materialUiLab.materialUiLabStrings.expanded
    - typings.materialUiLab.materialUiLabStrings.selected
    - typings.materialUiLab.materialUiLabStrings.group
    - typings.materialUiLab.materialUiLabStrings.content
    - typings.materialUiLab.materialUiLabStrings.iconContainer
    - typings.materialUiLab.materialUiLabStrings.label
  */
  trait TreeItemClassKey extends StObject
  object TreeItemClassKey {
    
    @scala.inline
    def content: typings.materialUiLab.materialUiLabStrings.content = "content".asInstanceOf[typings.materialUiLab.materialUiLabStrings.content]
    
    @scala.inline
    def expanded: typings.materialUiLab.materialUiLabStrings.expanded = "expanded".asInstanceOf[typings.materialUiLab.materialUiLabStrings.expanded]
    
    @scala.inline
    def group: typings.materialUiLab.materialUiLabStrings.group = "group".asInstanceOf[typings.materialUiLab.materialUiLabStrings.group]
    
    @scala.inline
    def iconContainer: typings.materialUiLab.materialUiLabStrings.iconContainer = "iconContainer".asInstanceOf[typings.materialUiLab.materialUiLabStrings.iconContainer]
  ...
  trait TreeItemProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapTreeIt] = js.undefined
    ...
    /**
      ...
      */
    var onIconClick: js.UndefOr[MouseEventHandler[typings.std.Element]] = js.undefined
    ...
    /**
      ...
      */
    var onLabelClick: js.UndefOr[MouseEventHandler[typings.std.Element]] = js.undefined
  ...
  object TreeItemProps {
    ...
    @scala.inline
    def apply(nodeId: String): TreeItemProps = {
    ...
    implicit class TreeItemPropsMutableBuilder[Self <: TreeItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapTreeIt): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      @scala.inline
      def setCollapseIcon(value: ReactNode): Self = StObject.set(x, "collapseIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnIconClick(value: MouseEvent[typings.std.Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onIconClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnIconClickUndefined: Self = StObject.set(x, "onIconClick", js.undefined)
      ...
      @scala.inline
      def setOnLabelClick(value: MouseEvent[typings.std.Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "onLabelClick", js.Any.fromFunction1(value))
