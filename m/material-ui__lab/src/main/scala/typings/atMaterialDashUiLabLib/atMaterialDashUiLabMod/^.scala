...
object ^ extends js.Object {
  val Rating: reactLib.reactMod.ComponentType[atMaterialDashUiLabLib.ratingRatingMod.RatingProps] = js.native
  ...
  val ToggleButtonGroup: reactLib.reactMod.ComponentType[
