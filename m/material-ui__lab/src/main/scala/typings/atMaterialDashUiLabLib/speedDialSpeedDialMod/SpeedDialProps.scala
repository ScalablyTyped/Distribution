...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement> & std.Partial<@material-ui/core.@material-ui/core/transitions/transition.TransitionHandlerProps>, @material-ui/lab.@material-ui/lab/SpeedDial/SpeedDial.SpeedDialClassKey, never> */
trait SpeedDialProps extends js.Object {
  ...
  var classes: js.UndefOr[
    stdLib.Partial[atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[SpeedDialClassKey]]
  ] = js.undefined
  ...
  var unselectable: js.UndefOr[
    atMaterialDashUiLabLib.atMaterialDashUiLabLibStrings.on | atMaterialDashUiLabLib.atMaterialDashUiLabLibStrings.off
  ] = js.undefined
...
object SpeedDialProps {
  ...
  def apply(
    ...
    unselectable: atMaterialDashUiLabLib.atMaterialDashUiLabLibStrings.on | atMaterialDashUiLabLib.atMaterialDashUiLabLibStrings.off = null,
