...
object anon {
  ...
  object PartialMDCSliderAdapter {
    ...
    extension [Self <: PartialMDCSliderAdapter](x: Self) {
      ...
      inline def setFocusThumb(value: /* thumb */ Thumb => Unit): Self = StObject.set(x, "focusThumb", js.Any.fromFunction1(value))
      
      inline def setFocusThumbUndefined: Self = StObject.set(x, "focusThumb", js.undefined)
      ...
      inline def setGetThumbAttribute(value: (/* attribute */ String, /* thumb */ Thumb) => String | Null): Self = StObject.set(x, "getThumbAttribute", js.Any.fromFunction2(value))
      
      inline def setGetThumbAttributeUndefined: Self = StObject.set(x, "getThumbAttribute", js.undefined)
      
      inline def setGetThumbBoundingClientRect(value: /* thumb */ Thumb => ClientRect): Self = StObject.set(x, "getThumbBoundingClientRect", js.Any.fromFunction1(value))
      ...
      inline def setIsThumbFocused(value: /* thumb */ Thumb => Boolean): Self = StObject.set(x, "isThumbFocused", js.Any.fromFunction1(value))
      
      inline def setIsThumbFocusedUndefined: Self = StObject.set(x, "isThumbFocused", js.undefined)
      ...
      inline def setSetThumbAttribute(value: (/* attribute */ String, /* value */ String, /* thumb */ Thumb) => Unit): Self = StObject.set(x, "setThumbAttribute", js.Any.fromFunction3(value))
      
      inline def setSetThumbAttributeUndefined: Self = StObject.set(x, "setThumbAttribute", js.undefined)
