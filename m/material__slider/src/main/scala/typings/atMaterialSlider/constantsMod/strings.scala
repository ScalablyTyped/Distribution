...
import typings.atMaterialSlider.atMaterialSliderStrings.MDCSliderColonchange
import typings.atMaterialSlider.atMaterialSliderStrings.MDCSliderColoninput
...
import typings.atMaterialSlider.atMaterialSliderStrings.`Dotmdc-slider__track-markerColonlast-child`
