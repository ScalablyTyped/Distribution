...
object TaskOptions {
  @scala.inline
  def apply[/* <: js.Array[_] */ A, R](): TaskOptions[A, R] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TaskOptions[A, R]]
  }
  @scala.inline
  implicit class TaskOptionsOps[Self <: TaskOptions[_, _], /* <: js.Array[_] */ A, R] (val x: Self with (TaskOptions[A, R])) extends AnyVal {
    @scala.inline
