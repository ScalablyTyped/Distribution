...
object GoogleCloudVideointelligenceV1LogoRecognitionAnnotation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1LogoRecognitionAnnotation] (val x: Self) extends AnyVal {
    ...
    inline def setSegmentsVarargs(value: GoogleCloudVideointelligenceV1VideoSegment*): Self = StObject.set(x, "segments", js.Array(value*))
