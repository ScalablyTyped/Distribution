...
object GoogleCloudVideointelligenceV1p2beta1Track {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1p2beta1Track](x: Self) {
    ...
    inline def setAttributesVarargs(value: GoogleCloudVideointelligenceV1p2beta1DetectedAttribute*): Self = StObject.set(x, "attributes", js.Array(value :_*))
    ...
    inline def setTimestampedObjectsVarargs(value: GoogleCloudVideointelligenceV1p2beta1TimestampedObject*): Self = StObject.set(x, "timestampedObjects", js.Array(value :_*))
  }
}
