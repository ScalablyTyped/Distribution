...
@js.native
trait GoogleCloudVideointelligenceV1ExplicitContentFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1ExplicitContentFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1ExplicitContentFrameOps[Self <: GoogleCloudVideointelligenceV1ExplicitContentFrame] (val x: Self) extends AnyVal {
