...
object GoogleCloudVideointelligenceV1p2beta1TimestampedObject {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1p2beta1TimestampedObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p2beta1TimestampedObject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p2beta1TimestampedObject] (val x: Self) extends AnyVal {
    ...
    inline def setLandmarks(value: js.Array[GoogleCloudVideointelligenceV1p2beta1DetectedLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    inline def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    inline def setLandmarksVarargs(value: GoogleCloudVideointelligenceV1p2beta1DetectedLandmark*): Self = StObject.set(x, "landmarks", js.Array(value*))
