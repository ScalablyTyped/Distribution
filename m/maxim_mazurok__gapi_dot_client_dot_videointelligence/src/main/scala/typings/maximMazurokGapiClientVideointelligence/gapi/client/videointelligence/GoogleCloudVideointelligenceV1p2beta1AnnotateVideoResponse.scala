...
object GoogleCloudVideointelligenceV1p2beta1AnnotateVideoResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p2beta1AnnotateVideoResponse] (val x: Self) extends AnyVal {
    ...
    inline def setAnnotationResultsVarargs(value: GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults*): Self = StObject.set(x, "annotationResults", js.Array(value*))
  }
}
