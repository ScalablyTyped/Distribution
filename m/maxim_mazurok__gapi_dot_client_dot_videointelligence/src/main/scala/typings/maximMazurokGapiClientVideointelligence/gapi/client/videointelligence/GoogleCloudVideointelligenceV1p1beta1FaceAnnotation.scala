...
object GoogleCloudVideointelligenceV1p1beta1FaceAnnotation {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1p1beta1FaceAnnotation](x: Self) {
    ...
    inline def setFramesVarargs(value: GoogleCloudVideointelligenceV1p1beta1FaceFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
    ...
    inline def setSegmentsVarargs(value: GoogleCloudVideointelligenceV1p1beta1FaceSegment*): Self = StObject.set(x, "segments", js.Array(value :_*))
