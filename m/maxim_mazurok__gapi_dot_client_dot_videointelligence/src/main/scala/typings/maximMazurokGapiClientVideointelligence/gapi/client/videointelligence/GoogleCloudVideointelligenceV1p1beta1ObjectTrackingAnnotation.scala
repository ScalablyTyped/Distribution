...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation extends js.Object {
  
  /** Object category's labeling confidence of this track. */
  var confidence: js.UndefOr[Double] = js.native
  
  /** Entity to specify the object category that this track is labeled as. */
  var entity: js.UndefOr[GoogleCloudVideointelligenceV1p1beta1Entity] = js.native
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame]] = js.native
...
object GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation {
  
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotationOps[Self <: GoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntity(value: GoogleCloudVideointelligenceV1p1beta1Entity): Self = this.set("entity", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEntity: Self = this.set("entity", js.undefined)
    
    @scala.inline
    def setFramesVarargs(value: GoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame*): Self = this.set("frames", js.Array(value :_*))
    
    @scala.inline
    def setFrames(value: js.Array[GoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame]): Self = this.set("frames", value.asInstanceOf[js.Any])
