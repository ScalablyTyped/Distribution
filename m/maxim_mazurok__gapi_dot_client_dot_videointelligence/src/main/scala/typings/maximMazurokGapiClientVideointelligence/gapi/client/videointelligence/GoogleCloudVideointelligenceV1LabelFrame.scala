...
@js.native
trait GoogleCloudVideointelligenceV1LabelFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1LabelFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1LabelFrameOps[Self <: GoogleCloudVideointelligenceV1LabelFrame] (val x: Self) extends AnyVal {
