...
trait GoogleCloudVideointelligenceV1p1beta1SpeechTranscription extends StObject {
  ...
  /**
    ...
    */
  var alternatives: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative]] = js.undefined
...
object GoogleCloudVideointelligenceV1p1beta1SpeechTranscription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1SpeechTranscription] (val x: Self) extends AnyVal {
    ...
    inline def setAlternativesVarargs(value: GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value*))
