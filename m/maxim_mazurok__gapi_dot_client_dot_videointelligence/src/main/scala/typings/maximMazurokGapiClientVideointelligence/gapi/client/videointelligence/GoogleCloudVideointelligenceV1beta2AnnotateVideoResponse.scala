...
object GoogleCloudVideointelligenceV1beta2AnnotateVideoResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1beta2AnnotateVideoResponse] (val x: Self) extends AnyVal {
    ...
    inline def setAnnotationResultsVarargs(value: GoogleCloudVideointelligenceV1beta2VideoAnnotationResults*): Self = StObject.set(x, "annotationResults", js.Array(value*))
  }
}
