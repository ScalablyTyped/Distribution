...
object GoogleCloudVideointelligenceV1p1beta1AnnotateVideoProgress {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1AnnotateVideoProgress] (val x: Self) extends AnyVal {
    ...
    inline def setAnnotationProgressVarargs(value: GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress*): Self = StObject.set(x, "annotationProgress", js.Array(value*))
  }
}
