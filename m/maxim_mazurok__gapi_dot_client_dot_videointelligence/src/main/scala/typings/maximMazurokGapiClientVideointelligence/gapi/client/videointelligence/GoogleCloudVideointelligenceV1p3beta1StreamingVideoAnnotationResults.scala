...
object GoogleCloudVideointelligenceV1p3beta1StreamingVideoAnnotationResults {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1p3beta1StreamingVideoAnnotationResults](x: Self) {
    ...
    inline def setLabelAnnotationsVarargs(value: GoogleCloudVideointelligenceV1p3beta1LabelAnnotation*): Self = StObject.set(x, "labelAnnotations", js.Array(value :_*))
