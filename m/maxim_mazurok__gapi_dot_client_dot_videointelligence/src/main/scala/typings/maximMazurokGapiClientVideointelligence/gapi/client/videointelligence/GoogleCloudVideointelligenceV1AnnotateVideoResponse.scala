...
object GoogleCloudVideointelligenceV1AnnotateVideoResponse {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1AnnotateVideoResponse](x: Self) {
    ...
    inline def setAnnotationResultsVarargs(value: GoogleCloudVideointelligenceV1VideoAnnotationResults*): Self = StObject.set(x, "annotationResults", js.Array(value :_*))
  }
}
