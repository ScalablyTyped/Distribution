...
object GoogleCloudVideointelligenceV1beta2ExplicitContentAnnotation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1beta2ExplicitContentAnnotation] (val x: Self) extends AnyVal {
    ...
    inline def setFramesVarargs(value: GoogleCloudVideointelligenceV1beta2ExplicitContentFrame*): Self = StObject.set(x, "frames", js.Array(value*))
