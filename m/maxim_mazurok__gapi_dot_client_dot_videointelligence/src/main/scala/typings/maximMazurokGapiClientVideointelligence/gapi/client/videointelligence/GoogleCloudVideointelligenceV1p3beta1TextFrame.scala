...
object GoogleCloudVideointelligenceV1p3beta1TextFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1TextFrameMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1TextFrame] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setRotatedBoundingBox(value: GoogleCloudVideointelligenceV1p3beta1NormalizedBoundingPoly): Self = StObject.set(x, "rotatedBoundingBox", value.asInstanceOf[js.Any])
