...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1VideoSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1p3beta1VideoSegment {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1VideoSegmentOps[Self <: GoogleCloudVideointelligenceV1p3beta1VideoSegment] (val x: Self) extends AnyVal {
