...
object GoogleCloudVideointelligenceV1p3beta1Track {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1p3beta1Track = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1Track]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p3beta1Track](x: Self) {
    ...
    inline def setAttributesVarargs(value: GoogleCloudVideointelligenceV1p3beta1DetectedAttribute*): Self = StObject.set(x, "attributes", js.Array(value :_*))
    ...
    inline def setTimestampedObjects(value: js.Array[GoogleCloudVideointelligenceV1p3beta1TimestampedObject]): Self = StObject.set(x, "timestampedObjects", value.asInstanceOf[js.Any])
    
    inline def setTimestampedObjectsUndefined: Self = StObject.set(x, "timestampedObjects", js.undefined)
    
    inline def setTimestampedObjectsVarargs(value: GoogleCloudVideointelligenceV1p3beta1TimestampedObject*): Self = StObject.set(x, "timestampedObjects", js.Array(value :_*))
  }
}
