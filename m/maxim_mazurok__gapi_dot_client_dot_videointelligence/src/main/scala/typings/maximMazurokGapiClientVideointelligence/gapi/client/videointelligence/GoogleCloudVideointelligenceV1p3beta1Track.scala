...
object GoogleCloudVideointelligenceV1p3beta1Track {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1Track] (val x: Self) extends AnyVal {
    ...
    inline def setTimestampedObjectsVarargs(value: GoogleCloudVideointelligenceV1p3beta1TimestampedObject*): Self = StObject.set(x, "timestampedObjects", js.Array(value*))
  }
}
