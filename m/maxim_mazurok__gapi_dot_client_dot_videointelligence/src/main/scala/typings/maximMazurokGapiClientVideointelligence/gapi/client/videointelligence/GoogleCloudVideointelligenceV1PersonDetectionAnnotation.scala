...
@js.native
trait GoogleCloudVideointelligenceV1PersonDetectionAnnotation extends js.Object {
...
object GoogleCloudVideointelligenceV1PersonDetectionAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1PersonDetectionAnnotationOps[Self <: GoogleCloudVideointelligenceV1PersonDetectionAnnotation] (val x: Self) extends AnyVal {
