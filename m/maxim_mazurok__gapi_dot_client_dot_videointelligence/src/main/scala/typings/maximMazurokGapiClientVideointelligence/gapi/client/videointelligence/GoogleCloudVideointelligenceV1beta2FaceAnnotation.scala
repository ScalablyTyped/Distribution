...
object GoogleCloudVideointelligenceV1beta2FaceAnnotation {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1beta2FaceAnnotation](x: Self) {
    ...
    inline def setFramesVarargs(value: GoogleCloudVideointelligenceV1beta2FaceFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
    ...
    inline def setSegmentsVarargs(value: GoogleCloudVideointelligenceV1beta2FaceSegment*): Self = StObject.set(x, "segments", js.Array(value :_*))
