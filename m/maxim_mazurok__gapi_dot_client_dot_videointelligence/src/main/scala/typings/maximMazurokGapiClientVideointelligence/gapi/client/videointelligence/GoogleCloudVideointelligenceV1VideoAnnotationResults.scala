...
object GoogleCloudVideointelligenceV1VideoAnnotationResults {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1VideoAnnotationResults](x: Self) {
    ...
    inline def setFaceAnnotationsVarargs(value: GoogleCloudVideointelligenceV1FaceAnnotation*): Self = StObject.set(x, "faceAnnotations", js.Array(value :_*))
    ...
    inline def setFaceDetectionAnnotationsVarargs(value: GoogleCloudVideointelligenceV1FaceDetectionAnnotation*): Self = StObject.set(x, "faceDetectionAnnotations", js.Array(value :_*))
    ...
    inline def setFrameLabelAnnotationsVarargs(value: GoogleCloudVideointelligenceV1LabelAnnotation*): Self = StObject.set(x, "frameLabelAnnotations", js.Array(value :_*))
    ...
    inline def setLogoRecognitionAnnotationsVarargs(value: GoogleCloudVideointelligenceV1LogoRecognitionAnnotation*): Self = StObject.set(x, "logoRecognitionAnnotations", js.Array(value :_*))
    ...
    inline def setObjectAnnotationsVarargs(value: GoogleCloudVideointelligenceV1ObjectTrackingAnnotation*): Self = StObject.set(x, "objectAnnotations", js.Array(value :_*))
    ...
    inline def setPersonDetectionAnnotationsVarargs(value: GoogleCloudVideointelligenceV1PersonDetectionAnnotation*): Self = StObject.set(x, "personDetectionAnnotations", js.Array(value :_*))
    ...
    inline def setSegmentLabelAnnotationsVarargs(value: GoogleCloudVideointelligenceV1LabelAnnotation*): Self = StObject.set(x, "segmentLabelAnnotations", js.Array(value :_*))
    ...
    inline def setSegmentPresenceLabelAnnotationsVarargs(value: GoogleCloudVideointelligenceV1LabelAnnotation*): Self = StObject.set(x, "segmentPresenceLabelAnnotations", js.Array(value :_*))
    ...
    inline def setShotAnnotationsVarargs(value: GoogleCloudVideointelligenceV1VideoSegment*): Self = StObject.set(x, "shotAnnotations", js.Array(value :_*))
    ...
    inline def setShotLabelAnnotationsVarargs(value: GoogleCloudVideointelligenceV1LabelAnnotation*): Self = StObject.set(x, "shotLabelAnnotations", js.Array(value :_*))
    ...
    inline def setShotPresenceLabelAnnotationsVarargs(value: GoogleCloudVideointelligenceV1LabelAnnotation*): Self = StObject.set(x, "shotPresenceLabelAnnotations", js.Array(value :_*))
    ...
    inline def setSpeechTranscriptionsVarargs(value: GoogleCloudVideointelligenceV1SpeechTranscription*): Self = StObject.set(x, "speechTranscriptions", js.Array(value :_*))
    ...
    inline def setTextAnnotationsVarargs(value: GoogleCloudVideointelligenceV1TextAnnotation*): Self = StObject.set(x, "textAnnotations", js.Array(value :_*))
  }
}
