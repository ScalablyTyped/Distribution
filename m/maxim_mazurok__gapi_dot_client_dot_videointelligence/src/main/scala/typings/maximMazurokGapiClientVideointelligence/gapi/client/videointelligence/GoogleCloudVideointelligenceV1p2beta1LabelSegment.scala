...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1LabelSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1p2beta1LabelSegment {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1LabelSegmentOps[Self <: GoogleCloudVideointelligenceV1p2beta1LabelSegment] (val x: Self) extends AnyVal {
