...
object GoogleCloudVideointelligenceV1p3beta1TimestampedObject {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1p3beta1TimestampedObject](x: Self) {
    ...
    inline def setLandmarksVarargs(value: GoogleCloudVideointelligenceV1p3beta1DetectedLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
