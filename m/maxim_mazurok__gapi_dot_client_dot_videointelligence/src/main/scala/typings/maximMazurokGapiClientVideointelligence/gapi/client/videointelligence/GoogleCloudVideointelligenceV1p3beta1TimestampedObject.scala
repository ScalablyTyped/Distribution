...
object GoogleCloudVideointelligenceV1p3beta1TimestampedObject {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1TimestampedObjectMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1TimestampedObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLandmarks(value: js.Array[GoogleCloudVideointelligenceV1p3beta1DetectedLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    @scala.inline
    def setLandmarksVarargs(value: GoogleCloudVideointelligenceV1p3beta1DetectedLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
