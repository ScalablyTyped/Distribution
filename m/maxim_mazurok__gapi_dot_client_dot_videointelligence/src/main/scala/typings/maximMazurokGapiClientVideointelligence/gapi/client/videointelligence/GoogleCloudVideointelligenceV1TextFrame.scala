...
@js.native
trait GoogleCloudVideointelligenceV1TextFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1TextFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1TextFrameOps[Self <: GoogleCloudVideointelligenceV1TextFrame] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRotatedBoundingBox(value: GoogleCloudVideointelligenceV1NormalizedBoundingPoly): Self = this.set("rotatedBoundingBox", value.asInstanceOf[js.Any])
