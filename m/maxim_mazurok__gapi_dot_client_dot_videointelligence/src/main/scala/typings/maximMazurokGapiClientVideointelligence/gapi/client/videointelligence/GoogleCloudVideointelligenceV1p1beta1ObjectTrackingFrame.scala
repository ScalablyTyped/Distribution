...
object GoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrameMutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame] (val x: Self) extends AnyVal {
