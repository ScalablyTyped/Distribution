...
object GoogleCloudVideointelligenceV1p3beta1SpeechTranscription {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1SpeechTranscription] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAlternatives(value: js.Array[GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative]): Self = StObject.set(x, "alternatives", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAlternativesUndefined: Self = StObject.set(x, "alternatives", js.undefined)
    
    @scala.inline
    def setAlternativesVarargs(value: GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value :_*))
