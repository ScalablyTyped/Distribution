...
object GoogleCloudVideointelligenceV1p3beta1SpeechTranscription {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1p3beta1SpeechTranscription = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1SpeechTranscription]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1SpeechTranscription] (val x: Self) extends AnyVal {
    
    inline def setAlternatives(value: js.Array[GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative]): Self = StObject.set(x, "alternatives", value.asInstanceOf[js.Any])
