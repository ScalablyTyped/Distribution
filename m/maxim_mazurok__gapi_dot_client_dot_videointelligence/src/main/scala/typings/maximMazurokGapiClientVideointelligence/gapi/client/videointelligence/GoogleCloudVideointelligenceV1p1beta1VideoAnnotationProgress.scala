...
trait GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress extends StObject {
...
object GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress] (val x: Self) extends AnyVal {
