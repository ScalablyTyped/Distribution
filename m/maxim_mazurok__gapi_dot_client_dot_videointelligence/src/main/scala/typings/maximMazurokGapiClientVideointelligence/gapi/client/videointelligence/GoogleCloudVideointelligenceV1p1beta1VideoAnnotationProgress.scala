...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress extends js.Object {
...
object GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgressOps[Self <: GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress] (val x: Self) extends AnyVal {
