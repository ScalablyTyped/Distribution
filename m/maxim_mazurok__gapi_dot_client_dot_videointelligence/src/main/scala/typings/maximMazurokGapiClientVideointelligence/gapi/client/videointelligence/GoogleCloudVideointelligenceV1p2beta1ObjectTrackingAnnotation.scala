...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation extends js.Object {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame]] = js.native
...
object GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotationOps[Self <: GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFramesVarargs(value: GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame*): Self = this.set("frames", js.Array(value :_*))
    
    @scala.inline
    def setFrames(value: js.Array[GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame]): Self = this.set("frames", value.asInstanceOf[js.Any])
