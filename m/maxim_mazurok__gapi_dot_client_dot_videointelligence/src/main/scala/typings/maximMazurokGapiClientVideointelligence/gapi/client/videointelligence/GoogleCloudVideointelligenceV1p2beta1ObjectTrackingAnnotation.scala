...
object GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotationMutableBuilder[Self <: GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFrames(value: js.Array[GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    @scala.inline
    def setFramesVarargs(value: GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
