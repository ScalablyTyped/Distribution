...
object GoogleCloudVideointelligenceV1p1beta1TextAnnotation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1TextAnnotation] (val x: Self) extends AnyVal {
    ...
    inline def setSegmentsVarargs(value: GoogleCloudVideointelligenceV1p1beta1TextSegment*): Self = StObject.set(x, "segments", js.Array(value*))
