...
object GoogleCloudVideointelligenceV1ObjectTrackingAnnotation {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1ObjectTrackingAnnotation]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    inline def setFrames(value: js.Array[GoogleCloudVideointelligenceV1ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    inline def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    inline def setFramesVarargs(value: GoogleCloudVideointelligenceV1ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value*))
