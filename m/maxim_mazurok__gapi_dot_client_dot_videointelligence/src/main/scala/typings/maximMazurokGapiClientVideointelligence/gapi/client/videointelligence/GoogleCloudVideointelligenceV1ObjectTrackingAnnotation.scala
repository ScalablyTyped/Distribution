...
@js.native
trait GoogleCloudVideointelligenceV1ObjectTrackingAnnotation extends js.Object {
...
object GoogleCloudVideointelligenceV1ObjectTrackingAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1ObjectTrackingAnnotationOps[Self <: GoogleCloudVideointelligenceV1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFramesVarargs(value: GoogleCloudVideointelligenceV1ObjectTrackingFrame*): Self = this.set("frames", js.Array(value :_*))
    
    @scala.inline
    def setFrames(value: js.Array[GoogleCloudVideointelligenceV1ObjectTrackingFrame]): Self = this.set("frames", value.asInstanceOf[js.Any])
