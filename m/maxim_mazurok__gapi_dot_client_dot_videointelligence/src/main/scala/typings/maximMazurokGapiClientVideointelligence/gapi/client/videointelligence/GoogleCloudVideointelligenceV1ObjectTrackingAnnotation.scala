...
trait GoogleCloudVideointelligenceV1ObjectTrackingAnnotation extends StObject {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1ObjectTrackingFrame]] = js.undefined
...
object GoogleCloudVideointelligenceV1ObjectTrackingAnnotation {
  
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1ObjectTrackingAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1ObjectTrackingAnnotationMutableBuilder[Self <: GoogleCloudVideointelligenceV1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFrames(value: js.Array[GoogleCloudVideointelligenceV1ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    @scala.inline
    def setFramesVarargs(value: GoogleCloudVideointelligenceV1ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
