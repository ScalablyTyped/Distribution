...
object GoogleCloudVideointelligenceV1ObjectTrackingAnnotation {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1ObjectTrackingAnnotation](x: Self) {
    ...
    inline def setFramesVarargs(value: GoogleCloudVideointelligenceV1ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
