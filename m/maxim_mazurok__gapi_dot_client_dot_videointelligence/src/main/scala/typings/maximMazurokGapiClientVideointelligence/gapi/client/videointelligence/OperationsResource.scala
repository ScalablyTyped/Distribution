...
import typings.maximMazurokGapiClientVideointelligence.anon.Accesstoken
import typings.maximMazurokGapiClientVideointelligence.anon.Alt
import typings.maximMazurokGapiClientVideointelligence.anon.Callback
