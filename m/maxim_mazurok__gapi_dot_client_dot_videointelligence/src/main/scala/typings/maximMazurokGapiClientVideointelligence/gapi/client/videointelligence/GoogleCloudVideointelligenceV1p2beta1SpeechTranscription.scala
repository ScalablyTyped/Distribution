...
object GoogleCloudVideointelligenceV1p2beta1SpeechTranscription {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1p2beta1SpeechTranscription](x: Self) {
    ...
    inline def setAlternativesVarargs(value: GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value :_*))
