...
object GoogleCloudVideointelligenceV1p3beta1LabelSegment {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1LabelSegmentMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1LabelSegment] (val x: Self) extends AnyVal {
