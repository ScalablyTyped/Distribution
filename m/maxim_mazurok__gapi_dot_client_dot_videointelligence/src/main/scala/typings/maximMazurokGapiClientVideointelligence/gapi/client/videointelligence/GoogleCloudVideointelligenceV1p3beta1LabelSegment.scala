...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1LabelSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1p3beta1LabelSegment {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p3beta1LabelSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1LabelSegment]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1LabelSegmentOps[Self <: GoogleCloudVideointelligenceV1p3beta1LabelSegment] (val x: Self) extends AnyVal {
