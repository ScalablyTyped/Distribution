...
object GoogleCloudVideointelligenceV1AnnotateVideoProgress {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1AnnotateVideoProgress] (val x: Self) extends AnyVal {
    ...
    inline def setAnnotationProgressVarargs(value: GoogleCloudVideointelligenceV1VideoAnnotationProgress*): Self = StObject.set(x, "annotationProgress", js.Array(value*))
  }
}
