...
@js.native
trait GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation extends js.Object {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1beta2ObjectTrackingFrame]] = js.native
...
object GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotationOps[Self <: GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFramesVarargs(value: GoogleCloudVideointelligenceV1beta2ObjectTrackingFrame*): Self = this.set("frames", js.Array(value :_*))
    
    @scala.inline
    def setFrames(value: js.Array[GoogleCloudVideointelligenceV1beta2ObjectTrackingFrame]): Self = this.set("frames", value.asInstanceOf[js.Any])
