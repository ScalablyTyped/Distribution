...
object GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotationMutableBuilder[Self <: GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFrames(value: js.Array[GoogleCloudVideointelligenceV1beta2ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    @scala.inline
    def setFramesVarargs(value: GoogleCloudVideointelligenceV1beta2ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
