...
object GoogleCloudVideointelligenceV1p1beta1ExplicitContentAnnotation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1ExplicitContentAnnotation] (val x: Self) extends AnyVal {
    ...
    inline def setFramesVarargs(value: GoogleCloudVideointelligenceV1p1beta1ExplicitContentFrame*): Self = StObject.set(x, "frames", js.Array(value*))
