...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation extends js.Object {
...
object GoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotationOps[Self <: GoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntity(value: GoogleCloudVideointelligenceV1p2beta1Entity): Self = this.set("entity", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEntity: Self = this.set("entity", js.undefined)
    
    @scala.inline
    def setSegmentsVarargs(value: GoogleCloudVideointelligenceV1p2beta1VideoSegment*): Self = this.set("segments", js.Array(value :_*))
    
    @scala.inline
    def setSegments(value: js.Array[GoogleCloudVideointelligenceV1p2beta1VideoSegment]): Self = this.set("segments", value.asInstanceOf[js.Any])
