...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "material__data-table" % "3.2.0-df0333",
  ...
  "org.scalablytyped" %%% "material__icon-button" % "3.2.0-ec94aa",
  ...
  "org.scalablytyped" %%% "material__menu" % "0.35-dt-20191126Z-c39a7c",
  "org.scalablytyped" %%% "material__menu-surface" % "3.2.0-48d079",
  ...
  "org.scalablytyped" %%% "material__switch" % "3.2.0-95dcd6",
  "org.scalablytyped" %%% "material__tab" % "0.35-dt-20191126Z-b11c30",
  "org.scalablytyped" %%% "material__tab-bar" % "3.2.0-66bc33",
