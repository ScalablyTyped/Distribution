...
version := "0.43-dt-20190212Z-0685f3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "material__icon-toggle" % "0.35-dt-20190313Z-7694fd",
  ...
  "org.scalablytyped" %%% "material__tabs" % "0.35-dt-20190313Z-b86e87",
  "org.scalablytyped" %%% "material__textfield" % "0.35-dt-20190313Z-5a5e3f",
  "org.scalablytyped" %%% "material__toolbar" % "0.35-dt-20190313Z-0363f1",
