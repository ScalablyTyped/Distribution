...
object dataTable extends js.Object {
  @js.native
  class MDCDataTable ()
    extends typings.atMaterialDataDashTable.atMaterialDataDashTableMod.MDCDataTable
  
  @js.native
  class MDCDataTableFoundation ()
    extends typings.atMaterialDataDashTable.atMaterialDataDashTableMod.MDCDataTableFoundation {
