...
import typings.atMaterialSwitch.Anon_CHECKED
import typings.atMaterialSwitch.Anon_NATIVECONTROLSELECTOR
...
object switchControl extends js.Object {
  @js.native
  class MDCSwitch ()
    extends typings.atMaterialSwitch.atMaterialSwitchMod.MDCSwitch
  
  @js.native
  class MDCSwitchFoundation ()
    extends typings.atMaterialSwitch.atMaterialSwitchMod.MDCSwitchFoundation {
  ...
  object MDCSwitch extends js.Object {
    def attachTo(root: HTMLElement): typings.atMaterialSwitch.componentMod.MDCSwitch = js.native
  }
