...
object tooltip {
  ...
  @JSImport("material-components-web", "tooltip.default")
  @js.native
  open class default ()
    extends typings.materialTooltip.mod.default {
  ...
  /**
    ...
    */
  @JSImport("material-components-web", "tooltip.PositionWithCaret")
  @js.native
  ...
  @JSImport("material-components-web", "tooltip.XPositionWithCaret")
  @js.native
  ...
  @JSImport("material-components-web", "tooltip.YPositionWithCaret")
  @js.native
  ...
  object attributes {
    ...
    @JSImport("material-components-web", "tooltip.attributes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("material-components-web", "tooltip.attributes.ARIA_EXPANDED")
    @js.native
    ...
    @JSImport("material-components-web", "tooltip.attributes.ARIA_HASPOPUP")
    @js.native
    ...
    @JSImport("material-components-web", "tooltip.attributes.HAS_CARET")
    @js.native
    ...
    @JSImport("material-components-web", "tooltip.attributes.PERSISTENT")
    @js.native
    ...
    @JSImport("material-components-web", "tooltip.attributes.SCROLLABLE_ANCESTOR")
    @js.native
  ...
  object numbers {
    ...
    @JSImport("material-components-web", "tooltip.numbers.ANIMATION_SCALE")
    @js.native
    ...
    @JSImport("material-components-web", "tooltip.numbers.CARET_INDENTATION")
    @js.native
  ...
  object strings {
    ...
    @JSImport("material-components-web", "tooltip.strings")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("material-components-web", "tooltip.strings.BOTTOM")
    @js.native
    ...
    @JSImport("material-components-web", "tooltip.strings.CENTER")
    @js.native
    ...
    @JSImport("material-components-web", "tooltip.strings.TOP")
    @js.native
