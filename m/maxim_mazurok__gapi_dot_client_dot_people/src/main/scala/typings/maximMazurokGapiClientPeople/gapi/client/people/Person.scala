...
object Person {
  ...
  extension [Self <: Person](x: Self) {
    ...
    inline def setCalendarUrlsVarargs(value: CalendarUrl*): Self = StObject.set(x, "calendarUrls", js.Array(value :_*))
    ...
    inline def setClientDataVarargs(value: ClientData*): Self = StObject.set(x, "clientData", js.Array(value :_*))
    ...
    inline def setExternalIdsVarargs(value: ExternalId*): Self = StObject.set(x, "externalIds", js.Array(value :_*))
    ...
    inline def setFileAsesVarargs(value: FileAs*): Self = StObject.set(x, "fileAses", js.Array(value :_*))
    ...
    inline def setMiscKeywordsVarargs(value: MiscKeyword*): Self = StObject.set(x, "miscKeywords", js.Array(value :_*))
