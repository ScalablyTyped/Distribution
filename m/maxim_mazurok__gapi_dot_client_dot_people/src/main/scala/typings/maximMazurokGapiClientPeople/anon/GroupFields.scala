...
trait GroupFields extends StObject {
...
object GroupFields {
  ...
  inline def apply(resourceName: String): GroupFields = {
    val __obj = js.Dynamic.literal(resourceName = resourceName.asInstanceOf[js.Any])
    __obj.asInstanceOf[GroupFields]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GroupFields] (val x: Self) extends AnyVal {
