...
@js.native
trait MergeSources extends js.Object {
...
object MergeSources {
  ...
  @scala.inline
  def apply(): MergeSources = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MergeSources]
  }
  
  @scala.inline
  implicit class MergeSourcesOps[Self <: MergeSources] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMergeSourcesVarargs(value: String*): Self = this.set("mergeSources", js.Array(value :_*))
    
    @scala.inline
    def setMergeSources(value: String | js.Array[String]): Self = this.set("mergeSources", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMergeSources: Self = this.set("mergeSources", js.undefined)
