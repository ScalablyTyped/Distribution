...
@js.native
trait PersonFields extends StObject {
...
object PersonFields {
  ...
  @scala.inline
  def apply(resource: Person): PersonFields = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[PersonFields]
  }
  
  @scala.inline
  implicit class PersonFieldsMutableBuilder[Self <: PersonFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Person): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
