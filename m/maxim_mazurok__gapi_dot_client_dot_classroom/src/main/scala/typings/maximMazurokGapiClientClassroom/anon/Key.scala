...
import typings.maximMazurokGapiClientClassroom.gapi.client.classroom.Announcement
...
object Key {
  ...
  inline def apply(courseId: String, id: String, resource: Announcement): Key = {
  ...
  extension [Self <: Key](x: Self) {
    ...
    inline def setResource(value: Announcement): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
