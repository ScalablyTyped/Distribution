...
@js.native
trait AnnouncementStates extends js.Object {
...
object AnnouncementStates {
  ...
  @scala.inline
  implicit class AnnouncementStatesOps[Self <: AnnouncementStates] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnnouncementStates(value: String | js.Array[String]): Self = this.set("announcementStates", value.asInstanceOf[js.Any])
