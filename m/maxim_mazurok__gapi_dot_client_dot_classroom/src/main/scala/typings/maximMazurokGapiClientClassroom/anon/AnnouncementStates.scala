...
trait AnnouncementStates extends StObject {
...
object AnnouncementStates {
  
  inline def apply(courseId: String): AnnouncementStates = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnnouncementStates]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AnnouncementStates] (val x: Self) extends AnyVal {
    ...
    inline def setAnnouncementStates(value: String | js.Array[String]): Self = StObject.set(x, "announcementStates", value.asInstanceOf[js.Any])
