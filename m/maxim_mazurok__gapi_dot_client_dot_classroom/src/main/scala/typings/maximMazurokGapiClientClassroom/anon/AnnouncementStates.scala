...
object AnnouncementStates {
  ...
  @scala.inline
  def apply(courseId: String): AnnouncementStates = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnnouncementStates]
  }
  
  @scala.inline
  implicit class AnnouncementStatesMutableBuilder[Self <: AnnouncementStates] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnnouncementStates(value: String | js.Array[String]): Self = StObject.set(x, "announcementStates", value.asInstanceOf[js.Any])
