...
import typings.maximMazurokGapiClientClassroom.gapi.client.classroom.CourseWorkMaterial
...
object CourseIdFields {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CourseIdFields] (val x: Self) extends AnyVal {
