...
import typings.maximMazurokGapiClientClassroom.gapi.client.classroom.Student
...
object EnrollmentCode {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EnrollmentCode] (val x: Self) extends AnyVal {
