...
import typings.maximMazurokGapiClientClassroom.gapi.client.classroom.CourseWork
...
trait AltCallback extends StObject {
  ...
  /** Request body */
  var resource: CourseWork = js.native
...
object AltCallback {
  ...
  @scala.inline
  def apply(courseId: String, id: String, resource: CourseWork): AltCallback = {
  ...
  implicit class AltCallbackMutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CourseWork): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
