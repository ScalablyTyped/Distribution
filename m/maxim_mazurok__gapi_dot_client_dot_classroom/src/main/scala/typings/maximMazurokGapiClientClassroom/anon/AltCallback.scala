...
object AltCallback {
  ...
  inline def apply(courseId: String, id: String, resource: CourseWork): AltCallback = {
  ...
  implicit open class MutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: CourseWork): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
