...
@js.native
trait CourseIdEnrollmentCode extends js.Object {
...
object CourseIdEnrollmentCode {
  ...
  @scala.inline
  def apply(courseId: String): CourseIdEnrollmentCode = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CourseIdEnrollmentCode]
  }
  
  @scala.inline
  implicit class CourseIdEnrollmentCodeOps[Self <: CourseIdEnrollmentCode] (val x: Self) extends AnyVal {
