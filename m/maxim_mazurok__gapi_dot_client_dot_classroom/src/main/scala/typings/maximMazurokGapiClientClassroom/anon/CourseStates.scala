...
object CourseStates {
  ...
  @scala.inline
  implicit class CourseStatesOps[Self <: CourseStates] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCourseStates(value: String | js.Array[String]): Self = this.set("courseStates", value.asInstanceOf[js.Any])
