...
object CourseStates {
  ...
  @scala.inline
  def apply(): CourseStates = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CourseStates]
  }
  
  @scala.inline
  implicit class CourseStatesMutableBuilder[Self <: CourseStates] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCourseStates(value: String | js.Array[String]): Self = StObject.set(x, "courseStates", value.asInstanceOf[js.Any])
