...
trait CourseWorkStates extends StObject {
  ...
  var courseWorkStates: js.UndefOr[String | js.Array[String]] = js.undefined
...
object CourseWorkStates {
  ...
  extension [Self <: CourseWorkStates](x: Self) {
    ...
    inline def setCourseWorkStates(value: String | js.Array[String]): Self = StObject.set(x, "courseWorkStates", value.asInstanceOf[js.Any])
    
    inline def setCourseWorkStatesUndefined: Self = StObject.set(x, "courseWorkStates", js.undefined)
    
    inline def setCourseWorkStatesVarargs(value: String*): Self = StObject.set(x, "courseWorkStates", js.Array(value :_*))
