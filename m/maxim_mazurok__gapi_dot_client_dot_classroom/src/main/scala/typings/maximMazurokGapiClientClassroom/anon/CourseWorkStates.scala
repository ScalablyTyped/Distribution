...
object CourseWorkStates {
  ...
  @scala.inline
  implicit class CourseWorkStatesMutableBuilder[Self <: CourseWorkStates] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCourseWorkStates(value: String | js.Array[String]): Self = StObject.set(x, "courseWorkStates", value.asInstanceOf[js.Any])
