...
object UserId {
  ...
  inline def apply(courseId: String, userId: String): UserId = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any], userId = userId.asInstanceOf[js.Any])
