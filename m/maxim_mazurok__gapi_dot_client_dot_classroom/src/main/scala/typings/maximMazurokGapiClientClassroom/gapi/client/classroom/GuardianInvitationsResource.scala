...
import typings.maximMazurokGapiClientClassroom.anon.FieldsInvitationId
import typings.maximMazurokGapiClientClassroom.anon.InvitationId
import typings.maximMazurokGapiClientClassroom.anon.InvitationIdKey
