...
object AchievementDefinitionsListResponse {
  ...
  extension [Self <: AchievementDefinitionsListResponse](x: Self) {
    ...
    inline def setItemsVarargs(value: AchievementDefinition*): Self = StObject.set(x, "items", js.Array(value :_*))
