...
object anon {
  ...
  trait Fields extends StObject {
    ...
    /** Request body */
    var resource: BatchEnableServicesRequest
  ...
  object Fields {
    ...
    inline def apply(parent: String, resource: BatchEnableServicesRequest): Fields = {
    ...
    extension [Self <: Fields](x: Self) {
      ...
      inline def setResource(value: BatchEnableServicesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  trait Name extends StObject {
    ...
    /** Request body */
    var resource: DisableServiceRequest
  ...
  object Name {
    ...
    inline def apply(name: String, resource: DisableServiceRequest): Name = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: Name](x: Self) {
      ...
      inline def setResource(value: DisableServiceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  trait Names extends StObject {
    ...
    /**
      ...
      */
    var names: js.UndefOr[String | js.Array[String]] = js.undefined
  ...
  object Names {
    ...
    inline def apply(parent: String): Names = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    ...
    extension [Self <: Names](x: Self) {
      ...
      inline def setNames(value: String | js.Array[String]): Self = StObject.set(x, "names", value.asInstanceOf[js.Any])
  ...
  object Oauthtoken {
    ...
    inline def apply(name: String, resource: EnableServiceRequest): Oauthtoken = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
