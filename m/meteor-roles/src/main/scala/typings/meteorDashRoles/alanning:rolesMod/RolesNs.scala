package typings.meteorDashRoles.`alanning:rolesMod`
...
import typings.meteorDashRoles.`alanning:rolesMod`.RolesNs.Role
...
object RolesNs extends js.Object {
  ...
  def getUsersInRole(role: String, group: String, options: Anon_Fields): Cursor[User] = js.native
  ...
  def getUsersInRole(role: js.Array[String], group: String, options: Anon_Fields): Cursor[User] = js.native
  /**
