...
trait PasswordSignupFields extends StObject {
...
object PasswordSignupFields {
  ...
  inline def apply(): PasswordSignupFields = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PasswordSignupFields]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PasswordSignupFields] (val x: Self) extends AnyVal {
