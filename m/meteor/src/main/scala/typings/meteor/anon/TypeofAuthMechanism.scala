...
import typings.meteor.meteorStrings.`MONGODB-OIDC`
...
object TypeofAuthMechanism {
  ...
  inline def apply(): TypeofAuthMechanism = {
    val __obj = js.Dynamic.literal(MONGODB_AWS = "MONGODB-AWS", MONGODB_CR = "MONGODB-CR", MONGODB_DEFAULT = "DEFAULT", MONGODB_GSSAPI = "GSSAPI", MONGODB_OIDC = "MONGODB-OIDC", MONGODB_PLAIN = "PLAIN", MONGODB_SCRAM_SHA1 = "SCRAM-SHA-1", MONGODB_SCRAM_SHA256 = "SCRAM-SHA-256", MONGODB_X509 = "MONGODB-X509")
  ...
  implicit open class MutableBuilder[Self <: TypeofAuthMechanism] (val x: Self) extends AnyVal {
    ...
    inline def setMONGODB_OIDC(value: `MONGODB-OIDC`): Self = StObject.set(x, "MONGODB_OIDC", value.asInstanceOf[js.Any])
