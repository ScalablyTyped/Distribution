...
object global {
  ...
  object Assets {
    ...
    @scala.inline
    def getBinary(assetPath: String): js.UndefOr[EJSON] = ^.asInstanceOf[js.Dynamic].applyDynamic("getBinary")(assetPath.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[EJSON]]
    @scala.inline
    def getBinary(assetPath: String, asyncCallback: js.Function): js.UndefOr[EJSON] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBinary")(assetPath.asInstanceOf[js.Any], asyncCallback.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[EJSON]]
    
    @scala.inline
    def getText(assetPath: String): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getText")(assetPath.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
    @scala.inline
    def getText(assetPath: String, asyncCallback: js.Function): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getText")(assetPath.asInstanceOf[js.Any], asyncCallback.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
  }
  ...
  object Blaze {
    ...
    @scala.inline
    def render(templateOrView: typings.meteor.Blaze.Template, parentNode: Node): View = (^.asInstanceOf[js.Dynamic].applyDynamic("render")(templateOrView.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any])).asInstanceOf[View]
    @scala.inline
    def render(templateOrView: typings.meteor.Blaze.Template, parentNode: Node, nextNode: Unit, parentView: View): View = (^.asInstanceOf[js.Dynamic].applyDynamic("render")(templateOrView.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any], nextNode.asInstanceOf[js.Any], parentView.asInstanceOf[js.Any])).asInstanceOf[View]
    @scala.inline
    def render(templateOrView: typings.meteor.Blaze.Template, parentNode: Node, nextNode: Node): View = (^.asInstanceOf[js.Dynamic].applyDynamic("render")(templateOrView.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any], nextNode.asInstanceOf[js.Any])).asInstanceOf[View]
    @scala.inline
    def render(templateOrView: typings.meteor.Blaze.Template, parentNode: Node, nextNode: Node, parentView: View): View = (^.asInstanceOf[js.Dynamic].applyDynamic("render")(templateOrView.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any], nextNode.asInstanceOf[js.Any], parentView.asInstanceOf[js.Any])).asInstanceOf[View]
    @scala.inline
    ...
    @scala.inline
    def renderWithData(templateOrView: typings.meteor.Blaze.Template, data: js.Function, parentNode: Node): View = (^.asInstanceOf[js.Dynamic].applyDynamic("renderWithData")(templateOrView.asInstanceOf[js.Any], data.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any])).asInstanceOf[View]
    @scala.inline
    def renderWithData(
    ...
    @scala.inline
    def renderWithData(templateOrView: typings.meteor.Blaze.Template, data: js.Object, parentNode: Node): View = (^.asInstanceOf[js.Dynamic].applyDynamic("renderWithData")(templateOrView.asInstanceOf[js.Any], data.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any])).asInstanceOf[View]
    @scala.inline
    def renderWithData(
      templateOrView: typings.meteor.Blaze.Template,
      data: js.Object,
    ...
    @scala.inline
    def toHTML(templateOrView: typings.meteor.Blaze.Template): String = ^.asInstanceOf[js.Dynamic].applyDynamic("toHTML")(templateOrView.asInstanceOf[js.Any]).asInstanceOf[String]
    @scala.inline
    ...
    @scala.inline
    def toHTMLWithData(templateOrView: typings.meteor.Blaze.Template, data: js.Function): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toHTMLWithData")(templateOrView.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[String]
    @scala.inline
    def toHTMLWithData(templateOrView: typings.meteor.Blaze.Template, data: js.Object): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toHTMLWithData")(templateOrView.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[String]
    @scala.inline
  ...
  object EJSON {
    ...
    @scala.inline
    def equals_(a: typings.meteor.EJSON, b: typings.meteor.EJSON): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    @scala.inline
    def equals_(a: typings.meteor.EJSON, b: typings.meteor.EJSON, options: KeyOrderSensitive): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    @scala.inline
    def parse(str: String): typings.meteor.EJSON = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.EJSON]
    
    @scala.inline
    def stringify(`val`: typings.meteor.EJSON): String = ^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
    @scala.inline
    def stringify(`val`: typings.meteor.EJSON, options: Canonical): String = (^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`val`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
    
    @scala.inline
    def toJSONValue(`val`: typings.meteor.EJSON): JSONable = ^.asInstanceOf[js.Dynamic].applyDynamic("toJSONValue")(`val`.asInstanceOf[js.Any]).asInstanceOf[JSONable]
  }
  ...
  object Match {
    ...
    @scala.inline
    def Maybe(pattern: String): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[String] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[String] | Null]]]
    @scala.inline
    def Maybe(pattern: Boolean): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Boolean] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Boolean] | Null]]]
    @scala.inline
    def Maybe(pattern: Double): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Double] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Double] | Null]]]
    @scala.inline
    def Maybe(pattern: Null): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Null] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Null] | Null]]]
    @scala.inline
    def Maybe(pattern: Unit): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Unit] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Unit] | Null]]]
    @scala.inline
    def Maybe(pattern: BooleanConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[BooleanConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[BooleanConstructor] | Null]]]
    @scala.inline
    def Maybe(pattern: FunctionConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[FunctionConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[FunctionConstructor] | Null]]]
    @scala.inline
    def Maybe(pattern: NumberConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[NumberConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[NumberConstructor] | Null]]]
    @scala.inline
    def Maybe(pattern: ObjectConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[ObjectConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[ObjectConstructor] | Null]]]
    @scala.inline
    def Maybe(pattern: StringConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[StringConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[StringConstructor] | Null]]]
    @scala.inline
    ...
    @scala.inline
    def ObjectIncluding[T /* <: StringDictionary[Pattern] */](dico: T): typings.meteor.Match.Matcher[PatternMatch[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("ObjectIncluding")(dico.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[PatternMatch[T]]]
    ...
    @scala.inline
    def Optional(pattern: String): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[String]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[String]]]]
    @scala.inline
    def Optional(pattern: Boolean): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Boolean]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Boolean]]]]
    @scala.inline
    def Optional(pattern: Double): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Double]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Double]]]]
    @scala.inline
    def Optional(pattern: Null): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Null]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Null]]]]
    @scala.inline
    def Optional(pattern: Unit): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Unit]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[Unit]]]]
    @scala.inline
    def Optional(pattern: BooleanConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[BooleanConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[BooleanConstructor]]]]
    @scala.inline
    def Optional(pattern: FunctionConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[FunctionConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[FunctionConstructor]]]]
    @scala.inline
    def Optional(pattern: NumberConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[NumberConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[NumberConstructor]]]]
    @scala.inline
    def Optional(pattern: ObjectConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[ObjectConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[ObjectConstructor]]]]
    @scala.inline
    def Optional(pattern: StringConstructor): typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[StringConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.UndefOr[PatternMatch[StringConstructor]]]]
    @scala.inline
    ...
    @scala.inline
    def Where(condition: js.Function1[/* val */ js.Any, Boolean]): typings.meteor.Match.Matcher[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("Where")(condition.asInstanceOf[js.Any]).asInstanceOf[typings.meteor.Match.Matcher[js.Any]]
    
    @scala.inline
    def test(value: js.Any, pattern: String): /* is meteor.Match.PatternMatch<string> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<string> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: Boolean): /* is meteor.Match.PatternMatch<boolean> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<boolean> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: Double): /* is meteor.Match.PatternMatch<number> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<number> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: Null): /* is meteor.Match.PatternMatch<null> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<null> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: Unit): /* is meteor.Match.PatternMatch<undefined> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<undefined> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: BooleanConstructor): /* is meteor.Match.PatternMatch<std.BooleanConstructor> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<std.BooleanConstructor> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: FunctionConstructor): /* is meteor.Match.PatternMatch<std.FunctionConstructor> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<std.FunctionConstructor> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: NumberConstructor): /* is meteor.Match.PatternMatch<std.NumberConstructor> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<std.NumberConstructor> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: ObjectConstructor): /* is meteor.Match.PatternMatch<std.ObjectConstructor> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<std.ObjectConstructor> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: StringConstructor): /* is meteor.Match.PatternMatch<std.StringConstructor> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.Match.PatternMatch<std.StringConstructor> */ Boolean]
    @scala.inline
  ...
  object Meteor {
    ...
    @scala.inline
    def apply[Result /* <: EJSONable | (js.Array[EJSONable | EJSONableProperty]) | EJSONableProperty */](name: String, args: js.Array[EJSONable | EJSONableProperty]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("apply")(name.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[js.Any]
    @scala.inline
    ...
    @scala.inline
    def bindEnvironment[TFunc /* <: js.Function */](func: TFunc): TFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("bindEnvironment")(func.asInstanceOf[js.Any]).asInstanceOf[TFunc]
    ...
    @scala.inline
    def loggingOut(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("loggingOut")().asInstanceOf[Boolean]
    ...
    /** Connection **/
    @scala.inline
    def publish(name: String, func: js.ThisFunction1[/* this */ Subscription, /* repeated */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("publish")(name.asInstanceOf[js.Any], func.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def publish(
      name: String,
    ...
    @scala.inline
    def publish(name: Null, func: js.ThisFunction1[/* this */ Subscription, /* repeated */ js.Any, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("publish")(name.asInstanceOf[js.Any], func.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def publish(
      name: Null,
      func: js.ThisFunction1[/* this */ Subscription, /* repeated */ js.Any, Unit],
  ...
  object Mongo {
    ...
    @scala.inline
    def setConnectionOptions(options: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setConnectionOptions")(options.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
