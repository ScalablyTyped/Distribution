...
import typings.meteor.blazeMod.BlazeNs.EventsMap
import typings.meteor.blazeMod.BlazeNs.HelpersMap
import typings.meteor.blazeMod.BlazeNs.TemplateInstance
import typings.meteor.blazeMod.BlazeNs.TemplateInstanceStatic
import typings.meteor.blazeMod.BlazeNs.View
import typings.meteor.blazeMod.BlazeNs.ViewStatic
...
object BlazeNs extends js.Object {
  trait Template extends js.Object {
    ...
    var head: typings.meteor.blazeMod.BlazeNs.Template
  ...
  @js.native
  class TemplateCls ()
    extends typings.meteor.blazeMod.BlazeNs.Template {
    ...
    /* CompleteClass */
    override var head: typings.meteor.blazeMod.BlazeNs.Template = js.native
    /* CompleteClass */
  ...
  trait TemplateStatic
    extends Instantiable0[typings.meteor.blazeMod.BlazeNs.Template]
       with Instantiable1[/* viewName */ String, typings.meteor.blazeMod.BlazeNs.Template]
       with Instantiable2[
          /* viewName */ String, 
          /* renderFunction */ js.Function, 
          typings.meteor.blazeMod.BlazeNs.Template
        ] {
  ...
  trait View extends js.Object {
    ...
    var template: typings.meteor.blazeMod.BlazeNs.Template
    def autorun(runFunc: js.Function1[/* computation */ Computation, Unit]): Computation
    def firstNode(): Node
    def lastNode(): Node
  ...
  class ViewCls () extends View {
    ...
    /* CompleteClass */
    override var template: typings.meteor.blazeMod.BlazeNs.Template = js.native
    /* CompleteClass */
    override def autorun(runFunc: js.Function1[/* computation */ Computation, Unit]): Computation = js.native
    /* CompleteClass */
  ...
  var Template: typings.meteor.blazeMod.BlazeNs.TemplateStatic = js.native
  ...
  def render(templateOrView: typings.meteor.blazeMod.BlazeNs.Template, parentNode: Node): View = js.native
  def render(templateOrView: typings.meteor.blazeMod.BlazeNs.Template, parentNode: Node, nextNode: Node): View = js.native
  def render(
    templateOrView: typings.meteor.blazeMod.BlazeNs.Template,
    parentNode: Node,
    nextNode: Node,
    parentView: View
  ): View = js.native
  ...
  def renderWithData(templateOrView: typings.meteor.blazeMod.BlazeNs.Template, data: js.Function, parentNode: Node): View = js.native
  def renderWithData(
    templateOrView: typings.meteor.blazeMod.BlazeNs.Template,
    data: js.Function,
    parentNode: Node,
  ...
  def renderWithData(templateOrView: typings.meteor.blazeMod.BlazeNs.Template, data: js.Object, parentNode: Node): View = js.native
  def renderWithData(
    templateOrView: typings.meteor.blazeMod.BlazeNs.Template,
    data: js.Object,
    parentNode: Node,
  ...
  def toHTML(templateOrView: typings.meteor.blazeMod.BlazeNs.Template): String = js.native
  def toHTML(templateOrView: View): String = js.native
  def toHTMLWithData(templateOrView: typings.meteor.blazeMod.BlazeNs.Template, data: js.Function): String = js.native
  def toHTMLWithData(templateOrView: typings.meteor.blazeMod.BlazeNs.Template, data: js.Object): String = js.native
