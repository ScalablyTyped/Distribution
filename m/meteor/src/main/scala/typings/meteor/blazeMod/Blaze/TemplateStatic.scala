...
trait TemplateStatic
  extends Instantiable0[typings.meteor.blazeMod.Blaze.Template]
     with Instantiable1[/* viewName */ String, typings.meteor.blazeMod.Blaze.Template]
     with Instantiable2[
      /* viewName */ String, 
      /* renderFunction */ js.Function, 
      typings.meteor.blazeMod.Blaze.Template
    ] {
