...
object render extends js.Object {
  def apply(templateOrView: typings.meteor.blazeMod.Blaze.Template, parentNode: Node): View = js.native
  def apply(templateOrView: typings.meteor.blazeMod.Blaze.Template, parentNode: Node, nextNode: Node): View = js.native
  def apply(
    templateOrView: typings.meteor.blazeMod.Blaze.Template,
    parentNode: Node,
    nextNode: Node,
    parentView: View
  ): View = js.native
