...
@js.native
class ViewCls ()
  extends typings.meteor.Blaze.View {
  ...
  /* CompleteClass */
  override var parentView: typings.meteor.Blaze.View = js.native
  /* CompleteClass */
  override var renderCount: Double = js.native
  /* CompleteClass */
  override var template: typings.meteor.Blaze.Template = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def templateInstance(): typings.meteor.Blaze.TemplateInstance = js.native
}
