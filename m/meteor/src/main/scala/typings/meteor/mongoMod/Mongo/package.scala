...
package object Mongo {
  ...
  type Modifier[T] = T | typings.meteor.AnonCurrentDate[T]
  type OnlyArrays[T] = T
  type OnlyElementsOfArrays[T] = typings.std.Partial[
    /* import warning: importer.ImportType#apply Failed type conversion: T[0] */ js.Any
  ]
  type OptionalId[TSchema] = (typings.meteor.mongoMod.UnionOmit[TSchema, typings.meteor.meteorStrings._id]) with typings.meteor.AnonId
  ...
  type Query[T] = typings.meteor.meteorStrings.Query with org.scalablytyped.runtime.TopLevel[js.Any] with typings.meteor.AnonAnd with typings.meteor.mongoMod.Mongo.Dictionary[_]
