...
object webappMod {
  ...
  object WebApp {
    ...
    inline def httpServer_=(x: typings.node.httpMod.Server): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("httpServer")(x.asInstanceOf[js.Any])
  ...
  object WebAppInternals {
    ...
    inline def additionalStaticJs_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("additionalStaticJs")(x.asInstanceOf[js.Any])
    
    inline def generateBoilerplate(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("generateBoilerplate")().asInstanceOf[Unit]
    
    inline def generateBoilerplateInstance(arch: String, manifest: js.Any, additionalOptions: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("generateBoilerplateInstance")(arch.asInstanceOf[js.Any], manifest.asInstanceOf[js.Any], additionalOptions.asInstanceOf[js.Any])).asInstanceOf[js.Any]
    ...
    inline def staticFilesMiddleware(staticFiles: StaticFiles, req: IncomingMessage, res: ServerResponse, next: js.Function): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("staticFilesMiddleware")(staticFiles.asInstanceOf[js.Any], req.asInstanceOf[js.Any], res.asInstanceOf[js.Any], next.asInstanceOf[js.Any])).asInstanceOf[Unit]
