...
object ^ extends js.Object {
  var Template: typings.meteor.BlazeNs.TemplateStatic = js.native
  ...
  def render(templateOrView: typings.meteor.BlazeNs.Template, parentNode: Node): View = js.native
  def render(templateOrView: typings.meteor.BlazeNs.Template, parentNode: Node, nextNode: Node): View = js.native
  def render(
    templateOrView: typings.meteor.BlazeNs.Template,
    parentNode: Node,
    nextNode: Node,
    parentView: View
  ): View = js.native
  ...
  def renderWithData(templateOrView: typings.meteor.BlazeNs.Template, data: js.Function, parentNode: Node): View = js.native
  def renderWithData(
    templateOrView: typings.meteor.BlazeNs.Template,
    data: js.Function,
    parentNode: Node,
  ...
  def renderWithData(templateOrView: typings.meteor.BlazeNs.Template, data: js.Object, parentNode: Node): View = js.native
  def renderWithData(templateOrView: typings.meteor.BlazeNs.Template, data: js.Object, parentNode: Node, nextNode: Node): View = js.native
  def renderWithData(
    templateOrView: typings.meteor.BlazeNs.Template,
    data: js.Object,
    parentNode: Node,
  ...
  def toHTML(templateOrView: typings.meteor.BlazeNs.Template): String = js.native
  def toHTML(templateOrView: View): String = js.native
  def toHTMLWithData(templateOrView: typings.meteor.BlazeNs.Template, data: js.Function): String = js.native
  def toHTMLWithData(templateOrView: typings.meteor.BlazeNs.Template, data: js.Object): String = js.native
