...
object checkMod {
  ...
  object Match {
    ...
    @scala.inline
    def Maybe(pattern: String): Matcher[js.UndefOr[PatternMatch[String] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[String] | Null]]]
    @scala.inline
    def Maybe(pattern: Boolean): Matcher[js.UndefOr[PatternMatch[Boolean] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[Boolean] | Null]]]
    @scala.inline
    def Maybe(pattern: Double): Matcher[js.UndefOr[PatternMatch[Double] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[Double] | Null]]]
    @scala.inline
    def Maybe(pattern: Null): Matcher[js.UndefOr[PatternMatch[Null] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[Null] | Null]]]
    @scala.inline
    def Maybe(pattern: Unit): Matcher[js.UndefOr[PatternMatch[Unit] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[Unit] | Null]]]
    @scala.inline
    def Maybe(pattern: BooleanConstructor): Matcher[js.UndefOr[PatternMatch[BooleanConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[BooleanConstructor] | Null]]]
    @scala.inline
    def Maybe(pattern: FunctionConstructor): Matcher[js.UndefOr[PatternMatch[FunctionConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[FunctionConstructor] | Null]]]
    @scala.inline
    def Maybe(pattern: NumberConstructor): Matcher[js.UndefOr[PatternMatch[NumberConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[NumberConstructor] | Null]]]
    @scala.inline
    def Maybe(pattern: ObjectConstructor): Matcher[js.UndefOr[PatternMatch[ObjectConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[ObjectConstructor] | Null]]]
    @scala.inline
    def Maybe(pattern: StringConstructor): Matcher[js.UndefOr[PatternMatch[StringConstructor] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[StringConstructor] | Null]]]
    @scala.inline
    def Maybe[T /* <: (Instantiable1[/* args (repeated) */ js.Any, js.Any]) | js.Array[Pattern] | StringDictionary[Pattern] | Matcher[js.Any] */](pattern: T): Matcher[js.UndefOr[PatternMatch[T] | Null]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Maybe")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[T] | Null]]]
    
    @scala.inline
    def ObjectIncluding[T /* <: StringDictionary[Pattern] */](dico: T): Matcher[PatternMatch[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("ObjectIncluding")(dico.asInstanceOf[js.Any]).asInstanceOf[Matcher[PatternMatch[T]]]
    ...
    @scala.inline
    def Optional(pattern: String): Matcher[js.UndefOr[PatternMatch[String]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[String]]]]
    @scala.inline
    def Optional(pattern: Boolean): Matcher[js.UndefOr[PatternMatch[Boolean]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[Boolean]]]]
    @scala.inline
    def Optional(pattern: Double): Matcher[js.UndefOr[PatternMatch[Double]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[Double]]]]
    @scala.inline
    def Optional(pattern: Null): Matcher[js.UndefOr[PatternMatch[Null]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[Null]]]]
    @scala.inline
    def Optional(pattern: Unit): Matcher[js.UndefOr[PatternMatch[Unit]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[Unit]]]]
    @scala.inline
    def Optional(pattern: BooleanConstructor): Matcher[js.UndefOr[PatternMatch[BooleanConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[BooleanConstructor]]]]
    @scala.inline
    def Optional(pattern: FunctionConstructor): Matcher[js.UndefOr[PatternMatch[FunctionConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[FunctionConstructor]]]]
    @scala.inline
    def Optional(pattern: NumberConstructor): Matcher[js.UndefOr[PatternMatch[NumberConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[NumberConstructor]]]]
    @scala.inline
    def Optional(pattern: ObjectConstructor): Matcher[js.UndefOr[PatternMatch[ObjectConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[ObjectConstructor]]]]
    @scala.inline
    def Optional(pattern: StringConstructor): Matcher[js.UndefOr[PatternMatch[StringConstructor]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[StringConstructor]]]]
    @scala.inline
    def Optional[T /* <: (Instantiable1[/* args (repeated) */ js.Any, js.Any]) | js.Array[Pattern] | StringDictionary[Pattern] | Matcher[js.Any] */](pattern: T): Matcher[js.UndefOr[PatternMatch[T]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("Optional")(pattern.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.UndefOr[PatternMatch[T]]]]
    
    @scala.inline
    def Where(condition: js.Function1[/* val */ js.Any, Boolean]): Matcher[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("Where")(condition.asInstanceOf[js.Any]).asInstanceOf[Matcher[js.Any]]
    
    @scala.inline
    def test(value: js.Any, pattern: String): /* is meteor.meteor/check.Match.PatternMatch<string> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.meteor/check.Match.PatternMatch<string> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: Boolean): /* is meteor.meteor/check.Match.PatternMatch<boolean> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.meteor/check.Match.PatternMatch<boolean> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: Double): /* is meteor.meteor/check.Match.PatternMatch<number> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.meteor/check.Match.PatternMatch<number> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: Null): /* is meteor.meteor/check.Match.PatternMatch<null> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.meteor/check.Match.PatternMatch<null> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: Unit): /* is meteor.meteor/check.Match.PatternMatch<undefined> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.meteor/check.Match.PatternMatch<undefined> */ Boolean]
    @scala.inline
    ...
    @scala.inline
    def test(value: js.Any, pattern: NumberConstructor): /* is meteor.meteor/check.Match.PatternMatch<std.NumberConstructor> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.meteor/check.Match.PatternMatch<std.NumberConstructor> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: ObjectConstructor): /* is meteor.meteor/check.Match.PatternMatch<std.ObjectConstructor> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.meteor/check.Match.PatternMatch<std.ObjectConstructor> */ Boolean]
    @scala.inline
    def test(value: js.Any, pattern: StringConstructor): /* is meteor.meteor/check.Match.PatternMatch<std.StringConstructor> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("test")(value.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[/* is meteor.meteor/check.Match.PatternMatch<std.StringConstructor> */ Boolean]
    @scala.inline
