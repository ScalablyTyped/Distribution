...
object MeteorNs extends js.Object {
  ...
  def publish(
    name: java.lang.String,
    func: js.ThisFunction1[/* this */ meteorLib.meteorMeteorMod.Subscription, /* repeated */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  /** Event **/
  /** Connection **/
  ...
  object absoluteUrl extends js.Object {
    var defaultOptions: meteorLib.meteorMeteorMod.MeteorNs.absoluteUrlOptions = js.native
    def apply(): java.lang.String = js.native
    def apply(path: java.lang.String): java.lang.String = js.native
    def apply(path: java.lang.String, options: meteorLib.meteorMeteorMod.MeteorNs.absoluteUrlOptions): java.lang.String = js.native
  }
