...
object ^ extends js.Object {
  /** User **/
  /** Error **/
  var Error: meteorLib.MeteorNs.ErrorStatic = js.native
  /** Global props **/
  ...
  var settings: meteorLib.MeteorNs.Settings = js.native
  var users: meteorLib.MongoNs.Collection[meteorLib.MeteorNs.User] = js.native
  ...
  def loginWithFacebook(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions): scala.Unit = js.native
  def loginWithFacebook(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions, callback: js.Function): scala.Unit = js.native
  def loginWithGithub(): scala.Unit = js.native
  def loginWithGithub(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions): scala.Unit = js.native
  def loginWithGithub(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions, callback: js.Function): scala.Unit = js.native
  def loginWithGoogle(): scala.Unit = js.native
  def loginWithGoogle(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions): scala.Unit = js.native
  def loginWithGoogle(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions, callback: js.Function): scala.Unit = js.native
  def loginWithMeetup(): scala.Unit = js.native
  def loginWithMeetup(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions): scala.Unit = js.native
  def loginWithMeetup(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions, callback: js.Function): scala.Unit = js.native
  def loginWithMeteorDeveloperAccount(): scala.Unit = js.native
  def loginWithMeteorDeveloperAccount(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions): scala.Unit = js.native
  def loginWithMeteorDeveloperAccount(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions, callback: js.Function): scala.Unit = js.native
  ...
  def loginWithTwitter(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions): scala.Unit = js.native
  def loginWithTwitter(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions, callback: js.Function): scala.Unit = js.native
  def loginWithWeibo(): scala.Unit = js.native
  def loginWithWeibo(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions): scala.Unit = js.native
  def loginWithWeibo(options: meteorLib.MeteorNs.LoginWithExternalServiceOptions, callback: js.Function): scala.Unit = js.native
  ...
  /** Status **/
  /** Pub/Sub **/
  def subscribe(name: java.lang.String, args: js.Any*): meteorLib.MeteorNs.SubscriptionHandle = js.native
