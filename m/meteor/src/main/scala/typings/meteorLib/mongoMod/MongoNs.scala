...
object MongoNs extends js.Object {
  ...
  */
  ...
  trait Collection[T] extends js.Object {
    ...
    def findOne(selector: java.lang.String, options: meteorLib.Anon_FieldsReactiveSkip): js.UndefOr[T] = js.native
    def findOne(selector: ObjectID): js.UndefOr[T] = js.native
    def findOne(selector: ObjectID, options: meteorLib.Anon_FieldsReactiveSkip): js.UndefOr[T] = js.native
    def findOne(selector: Selector[T]): js.UndefOr[T] = js.native
    def findOne(selector: Selector[T], options: meteorLib.Anon_FieldsReactiveSkip): js.UndefOr[T] = js.native
