...
@js.native
trait Anon_CallbackDoc[T] extends js.Object {
  ...
  def find(selector: java.lang.String, options: Anon_DocFieldsLimit): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def find(selector: meteorDashTypingsLib.MongoNs.ObjectID): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def find(selector: meteorDashTypingsLib.MongoNs.ObjectID, options: Anon_DocFieldsLimit): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def find(selector: meteorDashTypingsLib.MongoNs.Selector): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def find(selector: meteorDashTypingsLib.MongoNs.Selector, options: Anon_DocFieldsLimit): meteorDashTypingsLib.MongoNs.Cursor[T] = js.native
  def findOne(): T = js.native
  def findOne(selector: java.lang.String): T = js.native
  def findOne(selector: java.lang.String, options: Anon_DocFieldsReactiveSkip): T = js.native
  def findOne(selector: meteorDashTypingsLib.MongoNs.ObjectID): T = js.native
  def findOne(selector: meteorDashTypingsLib.MongoNs.ObjectID, options: Anon_DocFieldsReactiveSkip): T = js.native
  def findOne(selector: meteorDashTypingsLib.MongoNs.Selector): T = js.native
  def findOne(selector: meteorDashTypingsLib.MongoNs.Selector, options: Anon_DocFieldsReactiveSkip): T = js.native
