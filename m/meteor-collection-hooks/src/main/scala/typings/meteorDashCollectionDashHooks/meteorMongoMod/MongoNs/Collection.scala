package typings.meteorDashCollectionDashHooks.meteorMongoMod.MongoNs
...
import typings.meteorDashCollectionDashHooks.meteorMongoMod.CollectionHooksNs.GlobalHookOptions
