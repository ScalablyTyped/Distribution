...
import typings.meteorCollectionHooks.anon.Find
import typings.meteorCollectionHooks.anon.FindOne
import typings.meteorCollectionHooks.anon.Insert
import typings.meteorCollectionHooks.meteorMongoMod.CollectionHooks.GlobalHookOptions
