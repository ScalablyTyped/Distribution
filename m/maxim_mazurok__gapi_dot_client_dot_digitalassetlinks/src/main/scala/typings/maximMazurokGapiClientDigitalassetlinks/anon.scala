...
import typings.maximMazurokGapiClientDigitalassetlinks.gapi.client.digitalassetlinks.BulkCheckRequest
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(resource: BulkCheckRequest): Accesstoken = {
    ...
    implicit open class MutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      inline def setResource(value: BulkCheckRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
