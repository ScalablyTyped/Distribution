...
trait Anon_IsUnbounded extends js.Object {
  var isUnbounded: js.UndefOr[scala.Boolean] = js.undefined
}

object Anon_IsUnbounded {
  @scala.inline
  def apply(isUnbounded: js.UndefOr[scala.Boolean] = js.undefined): Anon_IsUnbounded = {
