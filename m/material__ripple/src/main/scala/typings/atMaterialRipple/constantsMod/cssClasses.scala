...
import typings.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded--background-focused`
import typings.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded--foreground-activation`
import typings.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded--foreground-deactivation`
import typings.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded--unbounded`
import typings.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded`
