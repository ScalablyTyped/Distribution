...
object mod {
  ...
  /**
  	...
  	```
  	*/
  inline def assert(semverRange: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("assert")(semverRange.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
  	...
  	```
  	*/
  inline def assertGreaterThanOrEqualTo(version: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("assertGreaterThanOrEqualTo")(version.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
  	...
  	```
  	*/
  inline def is(semverRange: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("is")(semverRange.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /**
  	...
  	```
  	*/
  inline def isGreaterThanOrEqualTo(version: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isGreaterThanOrEqualTo")(version.asInstanceOf[js.Any]).asInstanceOf[Boolean]
