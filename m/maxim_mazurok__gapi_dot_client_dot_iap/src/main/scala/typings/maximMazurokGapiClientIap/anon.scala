...
object anon {
  ...
  object Accesstoken {
    ...
    @scala.inline
    def apply(parent: String, resource: IdentityAwareProxyClient): Accesstoken = {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: IdentityAwareProxyClient): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: ResetIdentityAwareProxyClientSecretRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Name {
    ...
    implicit class NameMutableBuilder[Self <: Name] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: IapSettings): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Oauthtoken {
    ...
    implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: Brand): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
