...
import typings.micromarkExtensionMdxjsEsm.libSyntaxMod.Extension
import typings.micromarkExtensionMdxjsEsm.libSyntaxMod.Options
...
object mod {
  ...
  @JSImport("micromark-extension-mdxjs-esm", JSImport.Namespace)
  @js.native
