...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "eventsource" % "1.0-dt-20180522Z-04cfec",
  ...
  "org.scalablytyped" %%% "requestretry" % "1.12-dt-20180214Z-1cc943",
  "org.scalablytyped" %%% "std" % "3.2.2-9ed5ff",
  "org.scalablytyped" %%% "tough-cookie" % "2.3-dt-20181015Z-a8bc3f",
  "org.scalablytyped" %%% "uuid" % "3.4-dt-20180828Z-34dde2",
  "org.scalablytyped" %%% "wolfy87-eventemitter" % "5.2.5-1a3b1a")
