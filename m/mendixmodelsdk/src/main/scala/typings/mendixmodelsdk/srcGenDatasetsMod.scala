...
object srcGenDatasetsMod {
  ...
  object datasets {
    ...
    - typings.mendixmodelsdk.srcGenDatasetsMod.datasets.IDataSet because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined parameters */ @JSImport("mendixmodelsdk/src/gen/datasets", "datasets.DataSet")
    @js.native
    ...
    - typings.mendixmodelsdk.srcGenDatasetsMod.datasets.IDataSetParameter because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsDataSet, name */ @JSImport("mendixmodelsdk/src/gen/datasets", "datasets.DataSetParameter")
    @js.native
