...
object srcGenImagesMod {
  ...
  object images {
    ...
    - typings.mendixmodelsdk.srcGenImagesMod.images.IImage because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsImageCollection, name */ @JSImport("mendixmodelsdk/src/gen/images", "images.Image")
    @js.native
    ...
    - typings.mendixmodelsdk.srcGenImagesMod.images.IImageCollection because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined images */ @JSImport("mendixmodelsdk/src/gen/images", "images.ImageCollection")
    @js.native
