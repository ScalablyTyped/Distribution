...
object AutoNumberAttributeType {
  ...
  /**
    ...
    */
  /* static member */
  inline def createInMessageAttributeUnderAttributeType(container: MessageAttribute): AutoNumberAttributeType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInMessageAttributeUnderAttributeType")(container.asInstanceOf[js.Any]).asInstanceOf[AutoNumberAttributeType]
