...
- typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IAssociationRef because var conflicts: entityRef, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.AssociationRef")
@js.native
