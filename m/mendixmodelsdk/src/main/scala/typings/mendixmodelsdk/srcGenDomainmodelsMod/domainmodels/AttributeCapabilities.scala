...
- typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IAttributeCapabilities because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsAttribute, filterable, sortable */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.AttributeCapabilities")
@js.native
