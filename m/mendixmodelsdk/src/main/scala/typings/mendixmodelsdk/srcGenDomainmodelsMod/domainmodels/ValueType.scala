...
- typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IValueType because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsAttribute */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.ValueType")
@js.native
