...
- typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IIntegerAttributeTypeBase because var conflicts: containerAsAttribute, containerAsEntityKeyPart, containerAsODataKeyPart, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.IntegerAttributeTypeBase")
@js.native
open class IntegerAttributeTypeBase protected () extends NumericAttributeTypeBase {
  def this(
    model: AbstractModel,
...
object IntegerAttributeTypeBase {
  ...
  @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.IntegerAttributeTypeBase")
  @js.native
  val ^ : js.Any = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.IntegerAttributeTypeBase.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.IntegerAttributeTypeBase.versionInfo")
  @js.native
