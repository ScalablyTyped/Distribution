...
- typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IFloatAttributeType because var conflicts: containerAsAttribute, containerAsEntityKeyPart, containerAsODataKeyPart, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.FloatAttributeType")
@js.native
open class FloatAttributeType protected () extends FloatAttributeTypeBase {
  def this(
    model: AbstractModel,
...
object FloatAttributeType {
  ...
  @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.FloatAttributeType")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.FloatAttributeType.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.FloatAttributeType.versionInfo")
  @js.native
