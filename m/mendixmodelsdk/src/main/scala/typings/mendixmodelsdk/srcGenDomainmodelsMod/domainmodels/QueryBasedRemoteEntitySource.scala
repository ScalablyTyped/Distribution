...
- typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IQueryBasedRemoteEntitySource because var conflicts: containerAsEntity, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.QueryBasedRemoteEntitySource")
@js.native
