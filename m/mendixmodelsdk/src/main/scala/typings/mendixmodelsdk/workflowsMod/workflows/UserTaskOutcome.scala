...
- typings.mendixmodelsdk.workflowsMod.workflows.IUserTaskOutcome because var conflicts: containerAsConditionOutcomeActivity, containerAsParallelSplitActivity, containerAsUserTask, flow, id, isLoaded, model, structureTypeName, unit. Inlined name, caption */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.UserTaskOutcome")
@js.native
