...
- typings.mendixmodelsdk.workflowsMod.workflows.IPageReference because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsUserTask, containerAsWorkflow, page, pageQualifiedName */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.PageReference")
@js.native
