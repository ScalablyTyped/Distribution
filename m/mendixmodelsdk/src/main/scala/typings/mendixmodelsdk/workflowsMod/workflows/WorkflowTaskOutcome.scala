...
object WorkflowTaskOutcome {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): WorkflowTaskOutcome = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[WorkflowTaskOutcome]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: WorkflowTask): WorkflowTaskOutcome = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[WorkflowTaskOutcome]
