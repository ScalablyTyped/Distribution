...
- typings.mendixmodelsdk.workflowsMod.workflows.IBooleanConditionOutcome because var conflicts: containerAsConditionOutcomeActivity, id, isLoaded, model, structureTypeName, unit. Inlined value */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.BooleanConditionOutcome")
@js.native
