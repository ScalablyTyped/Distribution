...
- typings.mendixmodelsdk.workflowsMod.workflows.IWorkflowType because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsWorkflow, entity, entityQualifiedName */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.WorkflowType")
@js.native
