...
import typings.mendixmodelsdk.domainmodelsMod.domainmodels.IIndirectEntityRef
...
- typings.mendixmodelsdk.workflowsMod.workflows.IParameter because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsWorkflow, entityRef, entity, entityQualifiedName, name */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.Parameter")
@js.native
