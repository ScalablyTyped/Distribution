...
object srcGenXmlschemasMod {
  ...
  object xmlschemas {
    ...
    - typings.mendixmodelsdk.srcGenXmlschemasMod.xmlschemas.IMxSchema because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/xmlschemas", "xmlschemas.MxSchema")
    @js.native
    ...
    - typings.mendixmodelsdk.srcGenXmlschemasMod.xmlschemas.IXmlSchema because var conflicts: containerAsFolderBase, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/xmlschemas", "xmlschemas.XmlSchema")
    @js.native
