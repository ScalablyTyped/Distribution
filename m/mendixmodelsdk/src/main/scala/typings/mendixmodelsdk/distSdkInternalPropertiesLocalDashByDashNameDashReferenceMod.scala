...
@JSImport("mendixmodelsdk/dist/sdk/internal/properties/local-by-name-reference", JSImport.Namespace)
@js.native
object distSdkInternalPropertiesLocalDashByDashNameDashReferenceMod extends js.Object {
  @js.native
