...
object StaticLabel {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): StaticLabel = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[StaticLabel]
  ...
  /* static member */
  @scala.inline
  def createInDocumentTemplateUnderToplevels(container: DocumentTemplate): StaticLabel = ^.asInstanceOf[js.Dynamic].applyDynamic("createInDocumentTemplateUnderToplevels")(container.asInstanceOf[js.Any]).asInstanceOf[StaticLabel]
  ...
  /* static member */
  @scala.inline
  def createInDropZoneUnderWidget(container: DropZone): StaticLabel = ^.asInstanceOf[js.Dynamic].applyDynamic("createInDropZoneUnderWidget")(container.asInstanceOf[js.Any]).asInstanceOf[StaticLabel]
