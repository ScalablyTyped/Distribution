...
object ConfigurationSettings {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.settingsMod.settings.ConfigurationSettings = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.settingsMod.settings.ConfigurationSettings]
