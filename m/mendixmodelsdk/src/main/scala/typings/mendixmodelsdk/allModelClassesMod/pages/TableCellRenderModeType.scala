...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.TableCellRenderModeType")
@js.native
class TableCellRenderModeType protected ()
...
object TableCellRenderModeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.TableCellRenderModeType.Default")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.TableCellRenderModeType.Header")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.TableCellRenderModeType.Title")
  @js.native
