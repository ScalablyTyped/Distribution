...
object ListViewTemplate extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.pagesMod.pages.ListViewTemplate = js.native
  ...
  /**
    ...
    */
  def createIn(container: typings.mendixmodelsdk.pagesMod.pages.ListView): typings.mendixmodelsdk.pagesMod.pages.ListViewTemplate = js.native
