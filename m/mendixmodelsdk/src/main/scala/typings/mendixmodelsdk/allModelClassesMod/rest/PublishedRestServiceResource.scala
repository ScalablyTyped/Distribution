...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedRestServiceResource")
@js.native
...
object PublishedRestServiceResource {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedRestServiceResource.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedRestServiceResource.versionInfo")
  @js.native
