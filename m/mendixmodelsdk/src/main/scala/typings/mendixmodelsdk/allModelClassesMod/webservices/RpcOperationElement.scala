...
object RpcOperationElement {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.RpcOperationElement.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.RpcOperationElement.createInOperationInfoUnderRequestBodyRpcElement")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.RpcOperationElement.createInOperationInfoUnderRequestHeaderRpcElement")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.RpcOperationElement.createInOperationInfoUnderResponseBodyRpcElement")
  @js.native
