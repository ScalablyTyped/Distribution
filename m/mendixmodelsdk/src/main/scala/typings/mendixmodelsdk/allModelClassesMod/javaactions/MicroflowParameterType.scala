...
object MicroflowParameterType {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.javaactionsMod.javaactions.MicroflowParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.javaactionsMod.javaactions.MicroflowParameterType]
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.MicroflowParameterType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.MicroflowParameterType.versionInfo")
  @js.native
