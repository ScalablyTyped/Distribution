...
object queues {
  ...
  open class BasicQueueConfig protected ()
    extends typings.mendixmodelsdk.queuesMod.queues.BasicQueueConfig {
    def this(
      model: AbstractModel,
  ...
  open class Queue protected ()
    extends typings.mendixmodelsdk.queuesMod.queues.Queue {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class QueueConfig protected ()
    extends typings.mendixmodelsdk.queuesMod.queues.QueueConfig {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueExponentialRetry protected ()
    extends typings.mendixmodelsdk.queuesMod.queues.QueueExponentialRetry {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueFixedRetry protected ()
    extends typings.mendixmodelsdk.queuesMod.queues.QueueFixedRetry {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class QueueRetry protected ()
    extends typings.mendixmodelsdk.queuesMod.queues.QueueRetry {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueRetryIntervalType protected ()
    extends typings.mendixmodelsdk.queuesMod.queues.QueueRetryIntervalType {
  ...
  open class QueueSettings protected ()
    extends typings.mendixmodelsdk.queuesMod.queues.QueueSettings {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
