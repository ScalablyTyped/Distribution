...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataVersion")
@js.native
open class PublishedODataVersion protected ()
  extends typings.mendixmodelsdk.restMod.rest.PublishedODataVersion {
...
object PublishedODataVersion {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataVersion.OData3")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataVersion.OData4")
  @js.native
