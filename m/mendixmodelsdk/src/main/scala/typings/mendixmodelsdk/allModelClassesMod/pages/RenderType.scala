...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.RenderType")
@js.native
...
object RenderType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.RenderType.Button")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.RenderType.Link")
  @js.native
