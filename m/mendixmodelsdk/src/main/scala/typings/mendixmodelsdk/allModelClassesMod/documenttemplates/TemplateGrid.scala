...
class TemplateGrid protected ()
  extends typings.mendixmodelsdk.documenttemplatesMod.documenttemplates.TemplateGrid {
  def this(
    model: AbstractModel,
...
object TemplateGrid {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "documenttemplates.TemplateGrid.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "documenttemplates.TemplateGrid.createInDocumentTemplateUnderToplevels")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "documenttemplates.TemplateGrid.createInDropZoneUnderWidget")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "documenttemplates.TemplateGrid.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "documenttemplates.TemplateGrid.versionInfo")
  @js.native
