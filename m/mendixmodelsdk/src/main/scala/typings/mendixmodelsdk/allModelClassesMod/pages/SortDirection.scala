...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.SortDirection")
@js.native
open class SortDirection protected ()
  extends typings.mendixmodelsdk.pagesMod.pages.SortDirection {
...
object SortDirection {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.SortDirection.Ascending")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.SortDirection.Descending")
  @js.native
