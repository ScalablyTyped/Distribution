...
object ConstantValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "settings.ConstantValue.create")
  @js.native
  def create(model: IModel): typings.mendixmodelsdk.settingsMod.settings.ConstantValue = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "settings.ConstantValue.createIn")
  @js.native
  def createIn(container: typings.mendixmodelsdk.settingsMod.settings.Configuration): typings.mendixmodelsdk.settingsMod.settings.ConstantValue = js.native
