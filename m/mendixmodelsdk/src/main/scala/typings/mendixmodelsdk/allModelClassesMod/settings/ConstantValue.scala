...
object ConstantValue {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.settingsMod.settings.ConstantValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.settingsMod.settings.ConstantValue]
  ...
  /* static member */
  @scala.inline
  def createIn(container: typings.mendixmodelsdk.settingsMod.settings.Configuration): typings.mendixmodelsdk.settingsMod.settings.ConstantValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.settingsMod.settings.ConstantValue]
