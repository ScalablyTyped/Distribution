...
object RetrieveAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.microflowsMod.microflows.RetrieveAction = js.native
  ...
  /**
    ...
    */
  def createIn(container: typings.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typings.mendixmodelsdk.microflowsMod.microflows.RetrieveAction = js.native
