...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.AnnotationFlow")
@js.native
...
object AnnotationFlow {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.AnnotationFlow.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.AnnotationFlow.versionInfo")
  @js.native
