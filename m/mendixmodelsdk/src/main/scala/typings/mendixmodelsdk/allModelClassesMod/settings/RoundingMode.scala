...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "settings.RoundingMode")
@js.native
class RoundingMode protected ()
  extends typings.mendixmodelsdk.settingsMod.settings.RoundingMode {
...
object RoundingMode {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "settings.RoundingMode.HalfEven")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "settings.RoundingMode.HalfUp")
  @js.native
