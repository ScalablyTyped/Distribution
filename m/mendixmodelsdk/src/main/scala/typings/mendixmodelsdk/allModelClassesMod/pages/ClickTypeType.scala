...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ClickTypeType")
@js.native
...
object ClickTypeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ClickTypeType.Double")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ClickTypeType.Single")
  @js.native
