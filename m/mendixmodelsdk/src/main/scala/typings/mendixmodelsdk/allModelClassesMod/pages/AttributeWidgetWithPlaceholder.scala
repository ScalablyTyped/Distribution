...
object AttributeWidgetWithPlaceholder {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AttributeWidgetWithPlaceholder.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AttributeWidgetWithPlaceholder.versionInfo")
  @js.native
