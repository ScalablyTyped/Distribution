...
object UnparsableExpression {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.expressionsMod.expressions.UnparsableExpression = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.expressionsMod.expressions.UnparsableExpression]
