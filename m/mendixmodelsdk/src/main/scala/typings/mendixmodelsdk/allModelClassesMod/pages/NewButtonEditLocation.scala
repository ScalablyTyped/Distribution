...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.NewButtonEditLocation")
@js.native
open class NewButtonEditLocation protected ()
  extends typings.mendixmodelsdk.pagesMod.pages.NewButtonEditLocation {
...
object NewButtonEditLocation {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.NewButtonEditLocation.Form")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.NewButtonEditLocation.InlineAtBottom")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.NewButtonEditLocation.InlineAtTop")
  @js.native
