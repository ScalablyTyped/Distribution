...
class EnumerationType protected ()
  extends typings.mendixmodelsdk.codeactionsMod.codeactions.EnumerationType {
  def this(
    model: AbstractModel,
...
object EnumerationType {
  ...
  @js.native
  def create(model: IModel): typings.mendixmodelsdk.codeactionsMod.codeactions.EnumerationType = js.native
  ...
  @js.native
  def createInBasicParameterTypeUnderType(container: typings.mendixmodelsdk.codeactionsMod.codeactions.BasicParameterType): typings.mendixmodelsdk.codeactionsMod.codeactions.EnumerationType = js.native
  ...
  @js.native
  def createInCodeActionUnderActionReturnType(container: typings.mendixmodelsdk.codeactionsMod.codeactions.CodeAction): typings.mendixmodelsdk.codeactionsMod.codeactions.EnumerationType = js.native
