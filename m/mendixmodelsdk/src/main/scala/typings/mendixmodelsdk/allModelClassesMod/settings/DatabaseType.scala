...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.DatabaseType")
@js.native
open class DatabaseType protected ()
  extends typings.mendixmodelsdk.settingsMod.settings.DatabaseType {
...
object DatabaseType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.DatabaseType.Db2")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.DatabaseType.Hsqldb")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.DatabaseType.MySql")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.DatabaseType.Oracle")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.DatabaseType.PostgreSql")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.DatabaseType.SqlServer")
  @js.native
