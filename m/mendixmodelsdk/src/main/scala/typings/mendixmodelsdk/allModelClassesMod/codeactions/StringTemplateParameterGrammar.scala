...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "codeactions.StringTemplateParameterGrammar")
@js.native
class StringTemplateParameterGrammar protected ()
  extends typings.mendixmodelsdk.codeactionsMod.codeactions.StringTemplateParameterGrammar {
...
object StringTemplateParameterGrammar {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "codeactions.StringTemplateParameterGrammar.Sql")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "codeactions.StringTemplateParameterGrammar.Text")
  @js.native
