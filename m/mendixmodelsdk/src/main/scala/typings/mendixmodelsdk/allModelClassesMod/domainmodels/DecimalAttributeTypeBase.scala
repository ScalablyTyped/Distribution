...
object DecimalAttributeTypeBase {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.DecimalAttributeTypeBase.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.DecimalAttributeTypeBase.versionInfo")
  @js.native
