...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.PageTemplateType")
@js.native
class PageTemplateType protected ()
  extends typings.mendixmodelsdk.pagesMod.pages.PageTemplateType {
...
object PageTemplateType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.PageTemplateType.Edit")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.PageTemplateType.Select")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.PageTemplateType.Standard")
  @js.native
