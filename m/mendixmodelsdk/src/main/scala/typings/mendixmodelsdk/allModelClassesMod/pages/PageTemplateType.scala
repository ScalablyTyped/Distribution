...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.PageTemplateType")
@js.native
...
object PageTemplateType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.PageTemplateType.Edit")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.PageTemplateType.Select")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.PageTemplateType.Standard")
  @js.native
