...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.ThemeConversionStatusEnum")
@js.native
...
object ThemeConversionStatusEnum {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.ThemeConversionStatusEnum.AtlasNotFound")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.ThemeConversionStatusEnum.ChangesInAtlas")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.ThemeConversionStatusEnum.ConvertedChangesInCustom")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.ThemeConversionStatusEnum.ConvertedChangesInVariables")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.ThemeConversionStatusEnum.Done")
  @js.native
