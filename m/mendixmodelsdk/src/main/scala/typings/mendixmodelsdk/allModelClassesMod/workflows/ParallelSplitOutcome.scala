...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.ParallelSplitOutcome")
@js.native
open class ParallelSplitOutcome protected ()
...
object ParallelSplitOutcome {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.workflowsMod.workflows.ParallelSplitOutcome = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.workflowsMod.workflows.ParallelSplitOutcome]
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.ParallelSplitOutcome.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.ParallelSplitOutcome.versionInfo")
  @js.native
