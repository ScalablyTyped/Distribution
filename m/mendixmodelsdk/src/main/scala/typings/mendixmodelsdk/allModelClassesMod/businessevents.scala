...
object businessevents {
  ...
  open class ConsumedBusinessEvent protected ()
    extends typings.mendixmodelsdk.businesseventsMod.businessevents.ConsumedBusinessEvent {
    def this(
      model: AbstractModel,
  ...
  open class ConsumedBusinessEventService protected ()
    extends typings.mendixmodelsdk.businesseventsMod.businessevents.ConsumedBusinessEventService {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedBusinessEventService protected ()
    extends typings.mendixmodelsdk.businesseventsMod.businessevents.PublishedBusinessEventService {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedChannel protected ()
    extends typings.mendixmodelsdk.businesseventsMod.businessevents.PublishedChannel {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedMessage protected ()
    extends typings.mendixmodelsdk.businesseventsMod.businessevents.PublishedMessage {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedMessageAttribute protected ()
    extends typings.mendixmodelsdk.businesseventsMod.businessevents.PublishedMessageAttribute {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
