...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.MasterDetailDetailRegion")
@js.native
...
object MasterDetailDetailRegion {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.MasterDetailDetailRegion.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.MasterDetailDetailRegion.versionInfo")
  @js.native
