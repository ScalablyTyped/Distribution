...
object MasterDetailDetailRegion {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.MasterDetailDetailRegion.create")
  @js.native
  def create(model: IModel): typings.mendixmodelsdk.pagesMod.pages.MasterDetailDetailRegion = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.MasterDetailDetailRegion.createIn")
  @js.native
  def createIn(container: typings.mendixmodelsdk.pagesMod.pages.MasterDetail): typings.mendixmodelsdk.pagesMod.pages.MasterDetailDetailRegion = js.native
