...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.AssociationNavigability")
@js.native
open class AssociationNavigability protected ()
  extends typings.mendixmodelsdk.domainmodelsMod.domainmodels.AssociationNavigability {
...
object AssociationNavigability {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.AssociationNavigability.BothDirections")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.AssociationNavigability.ChildToParent")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.AssociationNavigability.ParentToChild")
  @js.native
