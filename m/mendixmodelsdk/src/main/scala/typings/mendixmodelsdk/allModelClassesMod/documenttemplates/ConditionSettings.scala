...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.ConditionSettings")
@js.native
open class ConditionSettings protected ()
  extends typings.mendixmodelsdk.documenttemplatesMod.documenttemplates.ConditionSettings {
  def this(
    model: AbstractModel,
...
object ConditionSettings {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.ConditionSettings.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.ConditionSettings.versionInfo")
  @js.native
