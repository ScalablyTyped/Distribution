...
class ExportMappingParameterType protected ()
  extends typings.mendixmodelsdk.javaactionsMod.javaactions.ExportMappingParameterType {
  def this(
    model: AbstractModel,
...
object ExportMappingParameterType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.javaactionsMod.javaactions.ExportMappingParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.javaactionsMod.javaactions.ExportMappingParameterType]
