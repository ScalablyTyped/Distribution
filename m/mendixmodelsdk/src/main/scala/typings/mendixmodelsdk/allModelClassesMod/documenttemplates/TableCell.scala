...
class TableCell protected ()
  extends typings.mendixmodelsdk.documenttemplatesMod.documenttemplates.TableCell {
  def this(
    model: AbstractModel,
...
object TableCell {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "documenttemplates.TableCell.create")
  @js.native
  def create(model: IModel): typings.mendixmodelsdk.documenttemplatesMod.documenttemplates.TableCell = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "documenttemplates.TableCell.createIn")
  @js.native
  def createIn(container: typings.mendixmodelsdk.documenttemplatesMod.documenttemplates.TableRow): typings.mendixmodelsdk.documenttemplatesMod.documenttemplates.TableCell = js.native
