...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.ErrorResultHandlingType")
@js.native
...
object ErrorResultHandlingType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.ErrorResultHandlingType.HttpResponse")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.ErrorResultHandlingType.None")
  @js.native
