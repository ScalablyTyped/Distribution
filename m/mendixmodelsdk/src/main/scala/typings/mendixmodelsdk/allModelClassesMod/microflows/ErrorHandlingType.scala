...
object ErrorHandlingType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ErrorHandlingType.Abort")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ErrorHandlingType.Continue")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ErrorHandlingType.Custom")
  @js.native
  def Custom: typings.mendixmodelsdk.microflowsMod.microflows.ErrorHandlingType = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ErrorHandlingType.CustomWithoutRollBack")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ErrorHandlingType.Rollback")
  @js.native
