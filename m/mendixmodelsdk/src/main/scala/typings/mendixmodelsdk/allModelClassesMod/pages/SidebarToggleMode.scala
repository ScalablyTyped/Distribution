...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.SidebarToggleMode")
@js.native
open class SidebarToggleMode protected ()
  extends typings.mendixmodelsdk.pagesMod.pages.SidebarToggleMode {
...
object SidebarToggleMode {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.SidebarToggleMode.PushContentAside")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.SidebarToggleMode.ShrinkContent")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.SidebarToggleMode.SlideOverContent")
  @js.native
