...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.CommitEnum")
@js.native
class CommitEnum protected ()
  extends typings.mendixmodelsdk.microflowsMod.microflows.CommitEnum {
...
object CommitEnum {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.CommitEnum.No")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.CommitEnum.Yes")
  @js.native
  def Yes: typings.mendixmodelsdk.microflowsMod.microflows.CommitEnum = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.CommitEnum.YesWithoutEvents")
  @js.native
