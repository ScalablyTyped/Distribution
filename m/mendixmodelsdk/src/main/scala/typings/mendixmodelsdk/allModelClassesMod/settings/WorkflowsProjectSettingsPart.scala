...
object WorkflowsProjectSettingsPart {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.settingsMod.settings.WorkflowsProjectSettingsPart = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.settingsMod.settings.WorkflowsProjectSettingsPart]
