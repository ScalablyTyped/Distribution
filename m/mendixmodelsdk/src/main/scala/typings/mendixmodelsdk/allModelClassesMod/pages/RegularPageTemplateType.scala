...
/**
  ...
  */
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.RegularPageTemplateType")
@js.native
class RegularPageTemplateType protected ()
  extends typings.mendixmodelsdk.pagesMod.pages.RegularPageTemplateType {
  def this(
    model: AbstractModel,
...
object RegularPageTemplateType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.RegularPageTemplateType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.RegularPageTemplateType.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.RegularPageTemplateType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.RegularPageTemplateType.versionInfo")
  @js.native
