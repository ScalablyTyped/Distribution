...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.UserLibJarLocation")
@js.native
open class UserLibJarLocation protected ()
  extends typings.mendixmodelsdk.settingsMod.settings.UserLibJarLocation {
  def this(
    model: AbstractModel,
...
object UserLibJarLocation {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.UserLibJarLocation.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.UserLibJarLocation.versionInfo")
  @js.native
