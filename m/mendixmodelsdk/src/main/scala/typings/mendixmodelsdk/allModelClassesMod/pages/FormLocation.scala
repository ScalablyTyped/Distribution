...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.FormLocation")
@js.native
open class FormLocation protected ()
  extends typings.mendixmodelsdk.pagesMod.pages.FormLocation {
...
object FormLocation {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.FormLocation.Content")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.FormLocation.ModalPopup")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.FormLocation.Popup")
  @js.native
