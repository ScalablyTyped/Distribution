...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ScrollDirection")
@js.native
...
object ScrollDirection {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ScrollDirection.Horizontal")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ScrollDirection.Vertical")
  @js.native
