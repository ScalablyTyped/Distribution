...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.UseOptimizedClient")
@js.native
open class UseOptimizedClient protected ()
  extends typings.mendixmodelsdk.settingsMod.settings.UseOptimizedClient {
...
object UseOptimizedClient {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.UseOptimizedClient.MigrationMode")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.UseOptimizedClient.No")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.UseOptimizedClient.Yes")
  @js.native
