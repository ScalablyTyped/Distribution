...
@JSImport("mendixmodelsdk/dist/sdk/internal/deltas/delta-processor", JSImport.Namespace)
@js.native
object distSdkInternalDeltasDeltaDashProcessorMod extends js.Object {
  @js.native
