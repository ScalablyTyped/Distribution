...
import typings.mendixmodelsdk.distSdkInternalTransportDashInterfacesMod.LockType
import typings.mendixmodelsdk.distSdkInternalTransportDashInterfacesMod.SuccessAppState
