...
import typings.mendixmodelsdk.distSdkConfigMod.configuration.ICreateWorkingCopyFromTeamServerParameters
import typings.mendixmodelsdk.distSdkConfigMod.configuration.ICreateWorkingCopyParameters
