...
- typings.mendixmodelsdk.srcGenProjectsMod.projects.IModuleSettings because var conflicts: containerAsFolderBase, containerAsModule, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/projects", "projects.ModuleSettings")
@js.native
