...
- typings.mendixmodelsdk.srcGenProjectsMod.projects.IFolderBase because Already inherited
- typings.mendixmodelsdk.srcGenProjectsMod.projects.IFolder because var conflicts: containerAsFolderBase, containerAsProject, documents, folders, id, isLoaded, model, structureTypeName, unit. Inlined name */ @JSImport("mendixmodelsdk/src/gen/projects", "projects.Folder")
@js.native
