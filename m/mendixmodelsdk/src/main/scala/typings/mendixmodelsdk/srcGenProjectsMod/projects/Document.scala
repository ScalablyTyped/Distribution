...
- typings.mendixmodelsdk.srcGenProjectsMod.projects.IDocument because var conflicts: containerAsFolderBase, containerAsModule, id, isLoaded, model, structureTypeName, unit. Inlined name, documentation, excluded */ @JSImport("mendixmodelsdk/src/gen/projects", "projects.Document")
@js.native
