...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/expressions", "expressions.FloatLiteral")
@js.native
open class FloatLiteral protected () extends LiteralExpression {
  def this(
    model: AbstractModel,
...
object FloatLiteral {
  ...
  /**
    ...
    */
  /* static member */
  inline def createInExpressionListOperationUnderExpressionModel(container: ExpressionListOperation): FloatLiteral = ^.asInstanceOf[js.Dynamic].applyDynamic("createInExpressionListOperationUnderExpressionModel")(container.asInstanceOf[js.Any]).asInstanceOf[FloatLiteral]
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/expressions", "expressions.FloatLiteral.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/expressions", "expressions.FloatLiteral.versionInfo")
  @js.native
