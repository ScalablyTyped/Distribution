...
object enumerations {
  ...
  open class Condition protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.enumerations.Condition {
    def this(
  ...
  open class Enumeration protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.enumerations.Enumeration {
    def this(
      model: typings.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class EnumerationValue protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.enumerations.EnumerationValue {
    def this(
      model: typings.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
