...
open class RequiredRuleInfo protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.RequiredRuleInfo {
  def this(
    model: AbstractModel,
...
object RequiredRuleInfo {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RequiredRuleInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RequiredRuleInfo]
