...
object IntegerType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.IntegerType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.IntegerType.createInBasicParameterTypeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.IntegerType.createInCodeActionUnderActionReturnType")
  @js.native
