...
object FileDocumentExport {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.FileDocumentExport.create")
  @js.native
  def create(model: IModel): typings.mendixmodelsdk.microflowsMod.microflows.FileDocumentExport = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.FileDocumentExport.createIn")
  @js.native
  def createIn(container: typings.mendixmodelsdk.microflowsMod.microflows.ExportXmlAction): typings.mendixmodelsdk.microflowsMod.microflows.FileDocumentExport = js.native
