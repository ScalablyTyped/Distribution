...
object GridColumn extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.pagesMod.pages.GridColumn = js.native
  /**
    * Creates and returns a new GridColumn instance in the SDK and on the server.
    ...
    */
  def createIn(container: typings.mendixmodelsdk.pagesMod.pages.ColumnGrid): typings.mendixmodelsdk.pagesMod.pages.GridColumn = js.native
}
