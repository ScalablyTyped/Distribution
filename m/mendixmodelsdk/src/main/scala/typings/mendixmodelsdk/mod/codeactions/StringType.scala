...
object StringType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.StringType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.StringType.createInBasicParameterTypeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.StringType.createInCodeActionUnderActionReturnType")
  @js.native
