...
open class PublishedRestServiceResource protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.rest.PublishedRestServiceResource {
  def this(
    model: AbstractModel,
...
object PublishedRestServiceResource {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenRestMod.rest.PublishedRestServiceResource = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenRestMod.rest.PublishedRestServiceResource]
