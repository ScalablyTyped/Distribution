...
object Table {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.Table.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.Table.createInDocumentTemplateUnderToplevels")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.Table.createInDropZoneUnderWidget")
  @js.native
