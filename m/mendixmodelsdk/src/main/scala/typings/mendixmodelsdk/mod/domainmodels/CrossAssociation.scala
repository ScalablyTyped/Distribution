...
object CrossAssociation extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.domainmodelsMod.domainmodels.CrossAssociation = js.native
  ...
  /**
    ...
    */
  def createIn(container: typings.mendixmodelsdk.domainmodelsMod.domainmodels.DomainModel): typings.mendixmodelsdk.domainmodelsMod.domainmodels.CrossAssociation = js.native
