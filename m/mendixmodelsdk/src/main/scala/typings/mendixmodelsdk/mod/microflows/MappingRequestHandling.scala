...
object MappingRequestHandling {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MappingRequestHandling.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MappingRequestHandling.createInExportXmlActionUnderResultHandling")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MappingRequestHandling.createInRestCallActionUnderRequestHandling")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MappingRequestHandling.createInWebServiceCallActionUnderRequestBodyHandling")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MappingRequestHandling.createInWebServiceCallActionUnderRequestHeaderHandling")
  @js.native
