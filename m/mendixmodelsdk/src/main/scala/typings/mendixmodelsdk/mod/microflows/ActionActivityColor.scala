...
object ActionActivityColor extends js.Object {
  var Blue: typings.mendixmodelsdk.microflowsMod.microflows.ActionActivityColor = js.native
  ...
  var Yellow: typings.mendixmodelsdk.microflowsMod.microflows.ActionActivityColor = js.native
}
