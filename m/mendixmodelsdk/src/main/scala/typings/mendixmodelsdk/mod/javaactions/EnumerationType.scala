...
class EnumerationType protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.javaactions.EnumerationType {
  def this(
    model: AbstractModel,
...
object EnumerationType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.EnumerationType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.EnumerationType.createInBasicParameterTypeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.EnumerationType.createInJavaActionParameterUnderJavaType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.EnumerationType.createInJavaActionUnderJavaReturnType")
  @js.native
