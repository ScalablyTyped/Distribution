...
open class EntityKeyPart protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.EntityKeyPart {
  def this(
    model: AbstractModel,
...
object EntityKeyPart {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.EntityKeyPart = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.EntityKeyPart]
