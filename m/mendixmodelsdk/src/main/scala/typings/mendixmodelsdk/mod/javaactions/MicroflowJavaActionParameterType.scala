...
open class MicroflowJavaActionParameterType protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.javaactions.MicroflowJavaActionParameterType {
  def this(
    model: AbstractModel,
...
object MicroflowJavaActionParameterType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenJavaactionsMod.javaactions.MicroflowJavaActionParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenJavaactionsMod.javaactions.MicroflowJavaActionParameterType]
