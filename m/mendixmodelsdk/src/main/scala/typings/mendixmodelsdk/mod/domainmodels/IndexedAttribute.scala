...
open class IndexedAttribute protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.IndexedAttribute {
  def this(
    model: AbstractModel,
...
object IndexedAttribute {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IndexedAttribute = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IndexedAttribute]
