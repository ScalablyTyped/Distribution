...
object StaticOrDynamicString {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.StaticOrDynamicString.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.StaticOrDynamicString.createInLinkButtonUnderAddress")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.StaticOrDynamicString.createInOpenLinkClientActionUnderAddress")
  @js.native
