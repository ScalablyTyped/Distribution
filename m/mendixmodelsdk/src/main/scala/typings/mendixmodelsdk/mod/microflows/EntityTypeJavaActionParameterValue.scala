...
object EntityTypeJavaActionParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.EntityTypeJavaActionParameterValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.EntityTypeJavaActionParameterValue.createIn")
  @js.native
