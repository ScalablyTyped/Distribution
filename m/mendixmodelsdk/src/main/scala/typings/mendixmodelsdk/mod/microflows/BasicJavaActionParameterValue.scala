...
class BasicJavaActionParameterValue protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.microflows.BasicJavaActionParameterValue {
  def this(
    model: AbstractModel,
...
object BasicJavaActionParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.microflowsMod.microflows.BasicJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.microflowsMod.microflows.BasicJavaActionParameterValue]
