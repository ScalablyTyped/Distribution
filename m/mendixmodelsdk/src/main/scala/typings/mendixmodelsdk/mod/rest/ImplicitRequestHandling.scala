...
/**
  ...
  */
@JSImport("mendixmodelsdk", "rest.ImplicitRequestHandling")
@js.native
open class ImplicitRequestHandling protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.rest.ImplicitRequestHandling {
  def this(
    model: AbstractModel,
...
object ImplicitRequestHandling {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "rest.ImplicitRequestHandling.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "rest.ImplicitRequestHandling.versionInfo")
  @js.native
