...
/**
  ...
  */
@JSImport("mendixmodelsdk", "settings.DistributionSettings")
@js.native
open class DistributionSettings protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.settings.DistributionSettings {
  def this(
    model: AbstractModel,
...
object DistributionSettings {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "settings.DistributionSettings.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "settings.DistributionSettings.versionInfo")
  @js.native
