...
class RangeRuleInfo protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.domainmodels.RangeRuleInfo {
  def this(
    model: AbstractModel,
...
object RangeRuleInfo {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.domainmodelsMod.domainmodels.RangeRuleInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.domainmodelsMod.domainmodels.RangeRuleInfo]
