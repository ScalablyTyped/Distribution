...
@js.native
open class RangeRuleInfo protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.RangeRuleInfo {
  def this(
    model: AbstractModel,
...
object RangeRuleInfo {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RangeRuleInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RangeRuleInfo]
