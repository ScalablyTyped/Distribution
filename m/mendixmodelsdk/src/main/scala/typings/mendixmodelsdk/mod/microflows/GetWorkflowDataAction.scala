...
/**
  ...
  */
@JSImport("mendixmodelsdk", "microflows.GetWorkflowDataAction")
@js.native
open class GetWorkflowDataAction protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.microflows.GetWorkflowDataAction {
  def this(
    model: AbstractModel,
...
object GetWorkflowDataAction {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.GetWorkflowDataAction.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.GetWorkflowDataAction.versionInfo")
  @js.native
