...
open class WidgetValueTypeEnum protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.customwidgets.WidgetValueTypeEnum {
...
object WidgetValueTypeEnum {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "customwidgets.WidgetValueTypeEnum.Selection")
  @js.native
  def Selection: typings.mendixmodelsdk.srcGenCustomwidgetsMod.customwidgets.WidgetValueTypeEnum = js.native
  inline def Selection_=(x: typings.mendixmodelsdk.srcGenCustomwidgetsMod.customwidgets.WidgetValueTypeEnum): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Selection")(x.asInstanceOf[js.Any])
