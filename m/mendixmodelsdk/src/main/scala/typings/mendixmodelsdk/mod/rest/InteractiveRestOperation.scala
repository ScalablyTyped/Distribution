...
/**
  ...
  */
@JSImport("mendixmodelsdk", "rest.InteractiveRestOperation")
@js.native
open class InteractiveRestOperation protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.rest.InteractiveRestOperation {
  def this(
    model: AbstractModel,
...
object InteractiveRestOperation {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "rest.InteractiveRestOperation.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "rest.InteractiveRestOperation.versionInfo")
  @js.native
