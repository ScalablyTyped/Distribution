...
class OperationInfo protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.webservices.OperationInfo {
  def this(
    model: AbstractModel,
...
object OperationInfo {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.webservicesMod.webservices.OperationInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.webservicesMod.webservices.OperationInfo]
