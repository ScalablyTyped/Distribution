...
class SetTaskOutcomeAction protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.microflows.SetTaskOutcomeAction {
  def this(
    model: AbstractModel,
...
object SetTaskOutcomeAction {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.microflowsMod.microflows.SetTaskOutcomeAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.microflowsMod.microflows.SetTaskOutcomeAction]
