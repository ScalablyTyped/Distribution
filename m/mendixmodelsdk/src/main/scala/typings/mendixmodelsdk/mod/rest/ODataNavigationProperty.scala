...
class ODataNavigationProperty protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.rest.ODataNavigationProperty {
  def this(
    model: AbstractModel,
...
object ODataNavigationProperty extends js.Object {
  ...
  /**
    ...
    *  7.22.0 and higher
    */
  def createIn(container: typings.mendixmodelsdk.restMod.rest.ODataEntity): typings.mendixmodelsdk.restMod.rest.ODataNavigationProperty = js.native
}
