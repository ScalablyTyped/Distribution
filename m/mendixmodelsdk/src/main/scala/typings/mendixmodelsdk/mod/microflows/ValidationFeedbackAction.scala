...
object ValidationFeedbackAction {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.microflowsMod.microflows.ValidationFeedbackAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.microflowsMod.microflows.ValidationFeedbackAction]
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ValidationFeedbackAction.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ValidationFeedbackAction.versionInfo")
  @js.native
