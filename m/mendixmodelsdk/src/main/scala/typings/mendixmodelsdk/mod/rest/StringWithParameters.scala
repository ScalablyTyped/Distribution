...
/**
  ...
  */
@JSImport("mendixmodelsdk", "rest.StringWithParameters")
@js.native
open class StringWithParameters protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.rest.StringWithParameters {
  def this(
    model: AbstractModel,
...
object StringWithParameters {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "rest.StringWithParameters.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "rest.StringWithParameters.versionInfo")
  @js.native
