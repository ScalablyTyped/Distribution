...
class ChangeObjectAction protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.microflows.ChangeObjectAction {
  def this(
    model: AbstractModel,
...
object ChangeObjectAction {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.microflowsMod.microflows.ChangeObjectAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.microflowsMod.microflows.ChangeObjectAction]
