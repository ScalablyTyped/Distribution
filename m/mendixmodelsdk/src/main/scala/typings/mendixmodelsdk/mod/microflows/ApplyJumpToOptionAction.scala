...
/**
  ...
  */
@JSImport("mendixmodelsdk", "microflows.ApplyJumpToOptionAction")
@js.native
open class ApplyJumpToOptionAction protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.microflows.ApplyJumpToOptionAction {
  def this(
    model: AbstractModel,
...
object ApplyJumpToOptionAction {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ApplyJumpToOptionAction.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ApplyJumpToOptionAction.versionInfo")
  @js.native
