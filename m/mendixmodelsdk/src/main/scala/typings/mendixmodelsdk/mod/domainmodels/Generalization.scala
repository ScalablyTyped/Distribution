...
open class Generalization protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.Generalization {
  def this(
    model: AbstractModel,
...
object Generalization {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.Generalization = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.Generalization]
