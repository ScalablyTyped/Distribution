...
class AssociationSource protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.pages.AssociationSource {
  def this(
    model: AbstractModel,
...
object AssociationSource {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.AssociationSource.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.AssociationSource.createIn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.AssociationSource.createInEntityWidgetUnderDataSource")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.AssociationSource.createInWidgetValueUnderDataSource")
  @js.native
