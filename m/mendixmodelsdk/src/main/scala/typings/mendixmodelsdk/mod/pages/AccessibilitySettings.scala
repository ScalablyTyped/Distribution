...
/**
  ...
  */
@JSImport("mendixmodelsdk", "pages.AccessibilitySettings")
@js.native
open class AccessibilitySettings protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.pages.AccessibilitySettings {
  def this(
    model: AbstractModel,
...
object AccessibilitySettings {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.AccessibilitySettings.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "pages.AccessibilitySettings.versionInfo")
  @js.native
