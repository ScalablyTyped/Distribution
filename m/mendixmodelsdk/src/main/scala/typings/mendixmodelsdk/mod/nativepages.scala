...
object nativepages {
  ...
  open class BottomBarItem protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.BottomBarItem {
    def this(
  ...
  open class NativeLayout protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativeLayout {
    def this(
      model: typings.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NativeLayoutCallArgument protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativeLayoutCallArgument {
    def this(
      model: typings.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NativePage protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativePage {
    def this(
      model: typings.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NativePageClientAction protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativePageClientAction {
    def this(
      model: typings.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NativePlaceholder protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativePlaceholder {
    def this(
      model: typings.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
