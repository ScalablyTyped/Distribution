...
open class BooleanAttributeType protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.BooleanAttributeType {
  def this(
    model: AbstractModel,
...
object BooleanAttributeType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.BooleanAttributeType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.BooleanAttributeType]
