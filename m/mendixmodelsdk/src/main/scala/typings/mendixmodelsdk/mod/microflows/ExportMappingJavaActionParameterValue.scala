...
object ExportMappingJavaActionParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ExportMappingJavaActionParameterValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ExportMappingJavaActionParameterValue.createIn")
  @js.native
