...
object CustomRange {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.CustomRange.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.CustomRange.createInDatabaseRetrieveSourceUnderRange")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.CustomRange.createInImportMappingCallUnderRange")
  @js.native
