...
object JavaActionsSettings {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "settings.JavaActionsSettings.create")
  @js.native
  def create(model: IModel): typings.mendixmodelsdk.settingsMod.settings.JavaActionsSettings = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "settings.JavaActionsSettings.createIn")
  @js.native
  def createIn(container: typings.mendixmodelsdk.settingsMod.settings.ProjectSettings): typings.mendixmodelsdk.settingsMod.settings.JavaActionsSettings = js.native
