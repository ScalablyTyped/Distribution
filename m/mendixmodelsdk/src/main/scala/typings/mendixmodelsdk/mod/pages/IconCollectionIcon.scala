...
/**
  ...
  */
@JSImport("mendixmodelsdk", "pages.IconCollectionIcon")
@js.native
open class IconCollectionIcon protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.pages.IconCollectionIcon {
  def this(
    model: AbstractModel,
...
object IconCollectionIcon {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.IconCollectionIcon.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "pages.IconCollectionIcon.versionInfo")
  @js.native
