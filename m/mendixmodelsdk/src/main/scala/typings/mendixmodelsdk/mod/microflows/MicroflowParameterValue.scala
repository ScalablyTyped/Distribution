...
object MicroflowParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MicroflowParameterValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MicroflowParameterValue.createInJavaActionParameterMappingUnderParameterValue")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MicroflowParameterValue.createInJavaScriptActionParameterMappingUnderParameterValue")
  @js.native
