...
package object mod {
  ...
  def sendListChangeDeltas[T, P](
    property: (typings.mendixmodelsdk.abstractPropertyMod.AbstractProperty[js.Array[T], typings.mendixmodelsdk.instancesMod.IList[P]]) with typings.mendixmodelsdk.anon.ToRawChangeValue[P],
