...
inline def MAX_METAMODEL_VERSION: java.lang.String = typings.mendixmodelsdk.mod.^.asInstanceOf[js.Dynamic].selectDynamic("MAX_METAMODEL_VERSION").asInstanceOf[java.lang.String]

inline def SDK_VERSION: java.lang.String = typings.mendixmodelsdk.mod.^.asInstanceOf[js.Dynamic].selectDynamic("SDK_VERSION").asInstanceOf[java.lang.String]
...
inline def createModelUnitFromJSON(
...
inline def runInTransaction[T](model: typings.mendixmodelsdk.abstractModelMod.IAbstractModel, action: js.Function0[js.Promise[T]]): js.Promise[T] = (typings.mendixmodelsdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("runInTransaction")(model.asInstanceOf[js.Any], action.asInstanceOf[js.Any])).asInstanceOf[js.Promise[T]]
inline def runInTransaction[T](
  model: typings.mendixmodelsdk.abstractModelMod.IAbstractModel,
  options: typings.mendixmodelsdk.transactionManagerMod.ITransactionOptions,
...
inline def runInTransaction_T_T[T](model: typings.mendixmodelsdk.abstractModelMod.IAbstractModel, action: js.Function0[T]): T = (typings.mendixmodelsdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("runInTransaction")(model.asInstanceOf[js.Any], action.asInstanceOf[js.Any])).asInstanceOf[T]
inline def runInTransaction_T_T[T](
  model: typings.mendixmodelsdk.abstractModelMod.IAbstractModel,
  options: typings.mendixmodelsdk.transactionManagerMod.ITransactionOptions,
