...
object Nanoflow {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.Nanoflow.createIn")
  @js.native
  def createIn(container: IFolderBase): typings.mendixmodelsdk.microflowsMod.microflows.Nanoflow = js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.Nanoflow.versionInfo")
  @js.native
