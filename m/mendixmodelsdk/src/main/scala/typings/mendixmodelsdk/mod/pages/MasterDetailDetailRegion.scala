...
object MasterDetailDetailRegion {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.MasterDetailDetailRegion.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.MasterDetailDetailRegion.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.MasterDetailDetailRegion.versionInfo")
  @js.native
