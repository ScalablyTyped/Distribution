...
object customicons {
  ...
  /**
    ...
    */
  @JSImport("mendixmodelsdk", "customicons.CustomIcon")
  @js.native
  open class CustomIcon protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.customicons.CustomIcon {
    def this(
  ...
  object CustomIcon {
    ...
    /* static member */
    @JSImport("mendixmodelsdk", "customicons.CustomIcon.structureTypeName")
    @js.native
    def structureTypeName: String = js.native
    inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
    
    /* static member */
    @JSImport("mendixmodelsdk", "customicons.CustomIcon.versionInfo")
    @js.native
  ...
  /**
    ...
    * In version 9.20.0: introduced
    */
  @JSImport("mendixmodelsdk", "customicons.CustomIconCollection")
  @js.native
  open class CustomIconCollection protected ()
    extends typings.mendixmodelsdk.srcGenAllModelClassesMod.customicons.CustomIconCollection {
    def this(
      model: typings.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  object CustomIconCollection {
    ...
    /* static member */
    @JSImport("mendixmodelsdk", "customicons.CustomIconCollection.structureTypeName")
    @js.native
    def structureTypeName: String = js.native
    inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
    
    /* static member */
    @JSImport("mendixmodelsdk", "customicons.CustomIconCollection.versionInfo")
    @js.native
    def versionInfo: typings.mendixmodelsdk.srcGenCustomiconsMod.StructureVersionInfo = js.native
    inline def versionInfo_=(x: typings.mendixmodelsdk.srcGenCustomiconsMod.StructureVersionInfo): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("versionInfo")(x.asInstanceOf[js.Any])
  }
