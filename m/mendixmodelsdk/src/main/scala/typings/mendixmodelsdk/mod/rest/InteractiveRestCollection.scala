...
/**
  ...
  */
@JSImport("mendixmodelsdk", "rest.InteractiveRestCollection")
@js.native
open class InteractiveRestCollection protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.rest.InteractiveRestCollection {
  def this(
    model: AbstractModel,
...
object InteractiveRestCollection {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "rest.InteractiveRestCollection.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "rest.InteractiveRestCollection.versionInfo")
  @js.native
