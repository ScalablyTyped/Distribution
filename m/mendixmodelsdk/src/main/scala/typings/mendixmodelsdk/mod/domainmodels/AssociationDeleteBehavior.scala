...
class AssociationDeleteBehavior protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.domainmodels.AssociationDeleteBehavior {
  def this(
    model: AbstractModel,
...
object AssociationDeleteBehavior {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.domainmodelsMod.domainmodels.AssociationDeleteBehavior = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.domainmodelsMod.domainmodels.AssociationDeleteBehavior]
