...
object LoopedActivity {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): typings.mendixmodelsdk.microflowsMod.microflows.LoopedActivity = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.microflowsMod.microflows.LoopedActivity]
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.LoopedActivity.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.LoopedActivity.versionInfo")
  @js.native
