...
open class EnumerationAttributeType protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.EnumerationAttributeType {
  def this(
    model: AbstractModel,
...
object EnumerationAttributeType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.EnumerationAttributeType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.EnumerationAttributeType]
