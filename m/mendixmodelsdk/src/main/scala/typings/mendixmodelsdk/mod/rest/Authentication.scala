...
/**
  ...
  */
@JSImport("mendixmodelsdk", "rest.Authentication")
@js.native
open class Authentication protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.rest.Authentication {
  def this(
    model: AbstractModel,
...
object Authentication {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "rest.Authentication.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "rest.Authentication.versionInfo")
  @js.native
