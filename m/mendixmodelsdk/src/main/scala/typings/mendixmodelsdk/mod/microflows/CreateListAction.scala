...
class CreateListAction protected ()
  extends typings.mendixmodelsdk.allModelClassesMod.microflows.CreateListAction {
  def this(
    model: AbstractModel,
...
object CreateListAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.microflowsMod.microflows.CreateListAction = js.native
  ...
  /**
    ...
    */
  def createIn(container: typings.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typings.mendixmodelsdk.microflowsMod.microflows.CreateListAction = js.native
