...
/**
  ...
  */
@JSImport("mendixmodelsdk", "rest.CallMicroflowToRead")
@js.native
open class CallMicroflowToRead protected ()
  extends typings.mendixmodelsdk.srcGenAllModelClassesMod.rest.CallMicroflowToRead {
  def this(
    model: AbstractModel,
...
object CallMicroflowToRead {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "rest.CallMicroflowToRead.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "rest.CallMicroflowToRead.versionInfo")
  @js.native
