...
object ServiceInfo {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "webservices.ServiceInfo.create")
  @js.native
  def create(model: IModel): typings.mendixmodelsdk.webservicesMod.webservices.ServiceInfo = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "webservices.ServiceInfo.createIn")
  @js.native
  def createIn(container: typings.mendixmodelsdk.webservicesMod.webservices.WsdlDescription): typings.mendixmodelsdk.webservicesMod.webservices.ServiceInfo = js.native
