...
object ConstantValue {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): ConstantValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[ConstantValue]
  ...
  /* static member */
  @scala.inline
  def createIn(container: Configuration): ConstantValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[ConstantValue]
