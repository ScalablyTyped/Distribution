...
import typings.mendixmodelsdk.distGenNanoflowsMod.StructureVersionInfo
import typings.mendixmodelsdk.distGenNanoflowsMod.nanoflows.NanoflowParameterValue
