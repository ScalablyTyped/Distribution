...
object projectsNs extends js.Object {
  ...
  abstract class Document protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.Document {
    def this(
      model: AbstractModel,
  ...
  class Folder protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.Folder {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class FolderBase protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.FolderBase {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Module protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.Module {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ModuleDocument protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.ModuleDocument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class OneTimeConversionMarker protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.OneTimeConversionMarker {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Project protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.Project {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ProjectConversion protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.ProjectConversion {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ProjectDocument protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projectsNs.ProjectDocument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
