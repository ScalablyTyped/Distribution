...
class NoCase protected ()
  extends typings.mendixmodelsdk.distGenMicroflowsMod.microflows.NoCase {
  def this(
    model: AbstractModel,
...
object NoCase extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.NoCase = js.native
  /**
    * Creates and returns a new NoCase instance in the SDK and on the server.
    ...
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.SequenceFlow): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.NoCase = js.native
}
