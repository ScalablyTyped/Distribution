...
class BooleanAttributeType protected ()
  extends typings.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.BooleanAttributeType {
  def this(
    model: AbstractModel,
...
object BooleanAttributeType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.BooleanAttributeType = js.native
  /**
    * Creates and returns a new BooleanAttributeType instance in the SDK and on the server.
    * The new BooleanAttributeType will be automatically stored in the 'type' property
    * of the parent Attribute element passed as argument.
    */
  def createIn(container: typings.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.Attribute): typings.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.BooleanAttributeType = js.native
}
