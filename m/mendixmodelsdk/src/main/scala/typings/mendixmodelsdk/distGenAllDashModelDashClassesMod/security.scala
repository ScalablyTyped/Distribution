...
object security extends js.Object {
  ...
  abstract class AccessRuleContainerBase protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.AccessRuleContainerBase {
    def this(
      model: AbstractModel,
  ...
  class DemoUser protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.DemoUser {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class FileDocumentAccessRuleContainer protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.FileDocumentAccessRuleContainer {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ImageAccessRuleContainer protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.ImageAccessRuleContainer {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ModuleRole protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.ModuleRole {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ModuleSecurity protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.ModuleSecurity {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class PasswordPolicySettings protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.PasswordPolicySettings {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ProjectSecurity protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.ProjectSecurity {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  @js.native
  class SecurityLevel ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.SecurityLevel
  ...
  class UserRole protected ()
    extends typings.mendixmodelsdk.distGenSecurityMod.security.UserRole {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
