...
class CommitAction protected ()
  extends typings.mendixmodelsdk.distGenMicroflowsMod.microflows.CommitAction {
  def this(
    model: AbstractModel,
...
object CommitAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.CommitAction = js.native
  /**
    * Creates and returns a new CommitAction instance in the SDK and on the server.
    * The new CommitAction will be automatically stored in the 'action' property
    * of the parent ActionActivity element passed as argument.
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.ActionActivity): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.CommitAction = js.native
}
