...
class ListViewXPathSource protected ()
  extends typings.mendixmodelsdk.distGenPagesMod.pages.ListViewXPathSource {
  def this(
    model: AbstractModel,
...
object ListViewXPathSource extends js.Object {
  ...
  /**
    ...
    * of the parent EntityWidget element passed as argument.
    */
  def createInEntityWidgetUnderDataSource(container: typings.mendixmodelsdk.distGenPagesMod.pages.EntityWidget): typings.mendixmodelsdk.distGenPagesMod.pages.ListViewXPathSource = js.native
  /**
    * Creates and returns a new ListViewXPathSource instance in the SDK and on the server.
    * The new ListViewXPathSource will be automatically stored in the 'dataSource' property
    ...
    *  8.3.0 and higher
    */
  def createInWidgetValueUnderDataSource(container: WidgetValue): typings.mendixmodelsdk.distGenPagesMod.pages.ListViewXPathSource = js.native
}
