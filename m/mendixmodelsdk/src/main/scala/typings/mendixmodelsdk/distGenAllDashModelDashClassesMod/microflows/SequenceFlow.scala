...
class SequenceFlow protected ()
  extends typings.mendixmodelsdk.distGenMicroflowsMod.microflows.SequenceFlow {
  def this(
    model: AbstractModel,
...
object SequenceFlow extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.SequenceFlow = js.native
  /**
    * Creates and returns a new SequenceFlow instance in the SDK and on the server.
    ...
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.MicroflowBase): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.SequenceFlow = js.native
}
