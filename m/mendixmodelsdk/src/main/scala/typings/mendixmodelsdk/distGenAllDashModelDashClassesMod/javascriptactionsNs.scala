...
object javascriptactionsNs extends js.Object {
  ...
  class JavaScriptAction protected ()
    extends typings.mendixmodelsdk.distGenJavascriptactionsMod.javascriptactionsNs.JavaScriptAction {
    def this(
      model: AbstractModel,
  ...
  class JavaScriptActionParameter protected ()
    extends typings.mendixmodelsdk.distGenJavascriptactionsMod.javascriptactionsNs.JavaScriptActionParameter {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
