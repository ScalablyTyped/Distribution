...
class PushToClientAction protected ()
  extends typings.mendixmodelsdk.distGenMicroflowsMod.microflows.PushToClientAction {
  def this(
    model: AbstractModel,
...
object PushToClientAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.PushToClientAction = js.native
  /**
    * Creates and returns a new PushToClientAction instance in the SDK and on the server.
    ...
    *  8.4.0 and higher
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.ActionActivity): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.PushToClientAction = js.native
}
