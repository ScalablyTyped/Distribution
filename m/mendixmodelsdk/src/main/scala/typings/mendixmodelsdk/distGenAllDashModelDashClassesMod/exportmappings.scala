...
object exportmappings extends js.Object {
  ...
  class ExportMapping protected ()
    extends typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportMapping {
    def this(
      model: AbstractModel,
  ...
  class ExportObjectMappingElement protected ()
    extends typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportObjectMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ExportValueMappingElement protected ()
    extends typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportValueMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
