...
object menusNs extends js.Object {
  ...
  class MenuDocument protected ()
    extends typings.mendixmodelsdk.distGenMenusMod.menusNs.MenuDocument {
    def this(
      model: AbstractModel,
  ...
  class MenuItem protected ()
    extends typings.mendixmodelsdk.distGenMenusMod.menusNs.MenuItem {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class MenuItemCollection protected ()
    extends typings.mendixmodelsdk.distGenMenusMod.menusNs.MenuItemCollection {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class MenuItemContainer protected ()
    extends typings.mendixmodelsdk.distGenMenusMod.menusNs.MenuItemContainer {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
