...
object enumerationsNs extends js.Object {
  ...
  class Condition protected ()
    extends typings.mendixmodelsdk.distGenEnumerationsMod.enumerationsNs.Condition {
    def this(
      model: AbstractModel,
  ...
  class Enumeration protected ()
    extends typings.mendixmodelsdk.distGenEnumerationsMod.enumerationsNs.Enumeration {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class EnumerationValue protected ()
    extends typings.mendixmodelsdk.distGenEnumerationsMod.enumerationsNs.EnumerationValue {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
