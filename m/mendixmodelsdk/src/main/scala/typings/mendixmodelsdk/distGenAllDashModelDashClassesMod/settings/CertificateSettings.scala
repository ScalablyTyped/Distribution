...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "settings.CertificateSettings")
@js.native
class CertificateSettings protected ()
  extends typings.mendixmodelsdk.distGenSettingsMod.settings.CertificateSettings {
  def this(
    model: AbstractModel,
