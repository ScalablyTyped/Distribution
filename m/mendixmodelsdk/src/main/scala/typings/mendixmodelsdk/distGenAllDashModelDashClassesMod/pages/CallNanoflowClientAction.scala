...
/**
  ...
  */
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.CallNanoflowClientAction")
@js.native
class CallNanoflowClientAction protected ()
  extends typings.mendixmodelsdk.distGenPagesMod.pages.CallNanoflowClientAction {
  def this(
    model: AbstractModel,
