...
object jsonstructuresNs extends js.Object {
  ...
  class JsonElement protected ()
    extends typings.mendixmodelsdk.distGenJsonstructuresMod.jsonstructuresNs.JsonElement {
    def this(
      model: AbstractModel,
  ...
  class JsonStructure protected ()
    extends typings.mendixmodelsdk.distGenJsonstructuresMod.jsonstructuresNs.JsonStructure {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  object JsonElement extends js.Object {
    ...
    /**
      ...
      *  6.6.0 and higher
      */
    def createInElementUnderChildren(container: Element): typings.mendixmodelsdk.distGenJsonstructuresMod.jsonstructuresNs.JsonElement = js.native
    /**
      * Creates and returns a new JsonElement instance in the SDK and on the server.
