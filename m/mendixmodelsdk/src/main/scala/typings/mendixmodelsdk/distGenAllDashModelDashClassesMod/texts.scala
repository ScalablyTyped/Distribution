...
object texts extends js.Object {
  ...
  class SystemText protected ()
    extends typings.mendixmodelsdk.distGenTextsMod.texts.SystemText {
    def this(
      model: AbstractModel,
  ...
  class SystemTextCollection protected ()
    extends typings.mendixmodelsdk.distGenTextsMod.texts.SystemTextCollection {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Text protected ()
    extends typings.mendixmodelsdk.distGenTextsMod.texts.Text {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Translation protected ()
    extends typings.mendixmodelsdk.distGenTextsMod.texts.Translation {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
