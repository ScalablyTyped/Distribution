...
class DataGridColumn protected ()
  extends typings.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DataGridColumn {
  def this(
    model: AbstractModel,
...
object DataGridColumn extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DataGridColumn = js.native
  /**
    * Creates and returns a new DataGridColumn instance in the SDK and on the server.
    ...
    */
  def createIn(container: typings.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DataGrid): typings.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DataGridColumn = js.native
}
