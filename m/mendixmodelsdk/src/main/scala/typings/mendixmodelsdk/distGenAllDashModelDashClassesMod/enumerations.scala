...
object enumerations extends js.Object {
  ...
  class Condition protected ()
    extends typings.mendixmodelsdk.distGenEnumerationsMod.enumerations.Condition {
    def this(
      model: AbstractModel,
  ...
  class Enumeration protected ()
    extends typings.mendixmodelsdk.distGenEnumerationsMod.enumerations.Enumeration {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class EnumerationValue protected ()
    extends typings.mendixmodelsdk.distGenEnumerationsMod.enumerations.EnumerationValue {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
