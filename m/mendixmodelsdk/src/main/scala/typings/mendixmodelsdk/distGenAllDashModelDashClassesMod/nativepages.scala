...
object nativepages extends js.Object {
  ...
  class BottomBarItem protected ()
    extends typings.mendixmodelsdk.distGenNativepagesMod.nativepages.BottomBarItem {
    def this(
      model: AbstractModel,
  ...
  class NativeLayout protected ()
    extends typings.mendixmodelsdk.distGenNativepagesMod.nativepages.NativeLayout {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativeLayoutCallArgument protected ()
    extends typings.mendixmodelsdk.distGenNativepagesMod.nativepages.NativeLayoutCallArgument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePage protected ()
    extends typings.mendixmodelsdk.distGenNativepagesMod.nativepages.NativePage {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePageClientAction protected ()
    extends typings.mendixmodelsdk.distGenNativepagesMod.nativepages.NativePageClientAction {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePlaceholder protected ()
    extends typings.mendixmodelsdk.distGenNativepagesMod.nativepages.NativePlaceholder {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
