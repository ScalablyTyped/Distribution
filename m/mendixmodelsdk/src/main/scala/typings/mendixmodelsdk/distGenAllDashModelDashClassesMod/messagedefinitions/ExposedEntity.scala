...
class ExposedEntity protected ()
  extends typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedEntity {
  def this(
    model: AbstractModel,
...
object ExposedEntity extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedEntity = js.native
  /**
    * Creates and returns a new ExposedEntity instance in the SDK and on the server.
    ...
    *  7.6.0 and higher
    */
  def createInElementUnderChildren(container: Element): typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedEntity = js.native
  /**
    * Creates and returns a new ExposedEntity instance in the SDK and on the server.
  ...
  def createInEntityMessageDefinitionUnderExposedEntity(
    container: typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.EntityMessageDefinition
  ): typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedEntity = js.native
  /**
    * Creates and returns a new ExposedEntity instance in the SDK and on the server.
    ...
    *  7.6.0 and higher
    */
  def createInJsonStructureUnderElements(container: JsonStructure): typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedEntity = js.native
}
