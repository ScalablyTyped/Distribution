...
class TypeParameter protected ()
  extends typings.mendixmodelsdk.distGenJavaactionsMod.javaactions.TypeParameter {
  def this(
    model: AbstractModel,
...
object TypeParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenJavaactionsMod.javaactions.TypeParameter = js.native
  /**
    * Creates and returns a new TypeParameter instance in the SDK and on the server.
    ...
    *  6.6.0 to 7.20.0
    */
  def createIn(container: typings.mendixmodelsdk.distGenJavaactionsMod.javaactions.JavaAction): typings.mendixmodelsdk.distGenJavaactionsMod.javaactions.TypeParameter = js.native
}
