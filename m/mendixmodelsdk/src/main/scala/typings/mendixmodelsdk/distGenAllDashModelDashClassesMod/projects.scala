...
object projects extends js.Object {
  ...
  abstract class Document protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.Document {
    def this(
      model: AbstractModel,
  ...
  class Folder protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.Folder {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class FolderBase protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.FolderBase {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Module protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.Module {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ModuleDocument protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.ModuleDocument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class OneTimeConversionMarker protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.OneTimeConversionMarker {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Project protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.Project {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ProjectConversion protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.ProjectConversion {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ProjectDocument protected ()
    extends typings.mendixmodelsdk.distGenProjectsMod.projects.ProjectDocument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
