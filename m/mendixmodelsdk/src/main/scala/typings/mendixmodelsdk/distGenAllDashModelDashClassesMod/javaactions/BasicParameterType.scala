...
/**
  ...
  */
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.BasicParameterType")
@js.native
class BasicParameterType protected ()
  extends typings.mendixmodelsdk.distGenJavaactionsMod.javaactions.BasicParameterType {
  def this(
    model: AbstractModel,
