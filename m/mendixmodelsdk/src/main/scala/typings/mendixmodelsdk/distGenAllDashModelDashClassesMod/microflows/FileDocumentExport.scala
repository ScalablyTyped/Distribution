...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.FileDocumentExport")
@js.native
class FileDocumentExport protected ()
  extends typings.mendixmodelsdk.distGenMicroflowsMod.microflows.FileDocumentExport {
  def this(
    model: AbstractModel,
