...
/**
  ...
  */
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "codeactions.IntegerType")
@js.native
class IntegerType protected ()
  extends typings.mendixmodelsdk.distGenCodeactionsMod.codeactions.IntegerType {
  def this(
    model: AbstractModel,
