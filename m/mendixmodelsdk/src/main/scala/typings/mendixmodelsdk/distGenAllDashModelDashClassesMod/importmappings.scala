...
object importmappings extends js.Object {
  ...
  class ImportMapping protected ()
    extends typings.mendixmodelsdk.distGenImportmappingsMod.importmappings.ImportMapping {
    def this(
      model: AbstractModel,
  ...
  class ImportObjectMappingElement protected ()
    extends typings.mendixmodelsdk.distGenImportmappingsMod.importmappings.ImportObjectMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ImportValueMappingElement protected ()
    extends typings.mendixmodelsdk.distGenImportmappingsMod.importmappings.ImportValueMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
