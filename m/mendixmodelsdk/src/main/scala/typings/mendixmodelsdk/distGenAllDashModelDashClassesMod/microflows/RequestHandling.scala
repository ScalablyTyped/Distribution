...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.RequestHandling")
@js.native
abstract class RequestHandling protected ()
  extends typings.mendixmodelsdk.distGenMicroflowsMod.microflows.RequestHandling {
  def this(
    model: AbstractModel,
