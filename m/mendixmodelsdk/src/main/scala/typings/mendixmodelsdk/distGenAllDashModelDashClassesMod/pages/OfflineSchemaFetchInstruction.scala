...
class OfflineSchemaFetchInstruction protected ()
  extends typings.mendixmodelsdk.distGenPagesMod.pages.OfflineSchemaFetchInstruction {
  def this(
    model: AbstractModel,
...
object OfflineSchemaFetchInstruction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenPagesMod.pages.OfflineSchemaFetchInstruction = js.native
}
