...
class Index protected ()
  extends typings.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.Index {
  def this(
    model: AbstractModel,
...
object Index extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.Index = js.native
  /**
    * Creates and returns a new Index instance in the SDK and on the server.
    * The new Index will be automatically stored in the 'indexes' property
    * of the parent Entity element passed as argument.
    */
  def createIn(container: typings.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.Entity): typings.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.Index = js.native
}
