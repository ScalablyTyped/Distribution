...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "rest")
@js.native
object restNs extends js.Object {
  ...
  class ConsumedODataService protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.ConsumedODataService {
    def this(
      model: AbstractModel,
  ...
  class CorsConfiguration protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.CorsConfiguration {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ODataEntity protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.ODataEntity {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ODataNavigationProperty protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.ODataNavigationProperty {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class PublishedODataService protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.PublishedODataService {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class PublishedRestResource protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.PublishedRestResource {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class PublishedRestService protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.PublishedRestService {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class PublishedRestServiceOperation protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.PublishedRestServiceOperation {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class PublishedRestServiceResource protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.PublishedRestServiceResource {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class RestAuthenticationType ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.RestAuthenticationType
  ...
  class RestOperationParameter protected ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.RestOperationParameter {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class RestOperationParameterType ()
    extends typings.mendixmodelsdk.distGenRestMod.restNs.RestOperationParameterType
