...
object mappings extends js.Object {
  ...
  abstract class Element protected ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.Element {
    def this(
      model: AbstractModel,
  ...
  @js.native
  class ElementType ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.ElementType
  ...
  abstract class MappingDocument protected ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.MappingDocument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class MappingElement protected ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.MappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class MappingMicroflowCall protected ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.MappingMicroflowCall {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class MappingMicroflowParameter protected ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.MappingMicroflowParameter {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ObjectHandlingBackupEnum ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.ObjectHandlingBackupEnum
  
  @js.native
  class ObjectHandlingEnum ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.ObjectHandlingEnum
  
  @js.native
  abstract class ObjectMappingElement protected ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.ObjectMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ValueMappingElement protected ()
    extends typings.mendixmodelsdk.distGenMappingsMod.mappings.ValueMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
