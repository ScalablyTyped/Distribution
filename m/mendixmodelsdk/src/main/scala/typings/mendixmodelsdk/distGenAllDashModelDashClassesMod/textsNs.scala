...
object textsNs extends js.Object {
  ...
  class SystemText protected ()
    extends typings.mendixmodelsdk.distGenTextsMod.textsNs.SystemText {
    def this(
      model: AbstractModel,
  ...
  class SystemTextCollection protected ()
    extends typings.mendixmodelsdk.distGenTextsMod.textsNs.SystemTextCollection {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Text protected ()
    extends typings.mendixmodelsdk.distGenTextsMod.textsNs.Text {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Translation protected ()
    extends typings.mendixmodelsdk.distGenTextsMod.textsNs.Translation {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
