...
class MicroflowSource protected ()
  extends typings.mendixmodelsdk.distGenPagesMod.pages.MicroflowSource {
  def this(
    model: AbstractModel,
...
object MicroflowSource extends js.Object {
  ...
  /**
    ...
    * of the parent EntityWidget element passed as argument.
    */
  def createInEntityWidgetUnderDataSource(container: typings.mendixmodelsdk.distGenPagesMod.pages.EntityWidget): typings.mendixmodelsdk.distGenPagesMod.pages.MicroflowSource = js.native
  /**
    * Creates and returns a new MicroflowSource instance in the SDK and on the server.
    * The new MicroflowSource will be automatically stored in the 'dataSource' property
    ...
    *  8.3.0 and higher
    */
  def createInWidgetValueUnderDataSource(container: WidgetValue): typings.mendixmodelsdk.distGenPagesMod.pages.MicroflowSource = js.native
}
