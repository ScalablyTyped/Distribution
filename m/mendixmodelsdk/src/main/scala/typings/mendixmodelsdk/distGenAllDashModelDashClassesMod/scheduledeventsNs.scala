...
object scheduledeventsNs extends js.Object {
  @js.native
  class IntervalType ()
    extends typings.mendixmodelsdk.distGenScheduledeventsMod.scheduledeventsNs.IntervalType
  ...
  class ScheduledEvent protected ()
    extends typings.mendixmodelsdk.distGenScheduledeventsMod.scheduledeventsNs.ScheduledEvent {
    def this(
      model: AbstractModel,
  ...
  @js.native
  class TimeZoneEnum ()
    extends typings.mendixmodelsdk.distGenScheduledeventsMod.scheduledeventsNs.TimeZoneEnum
