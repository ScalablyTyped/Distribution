...
class Head protected ()
  extends typings.mendixmodelsdk.distGenMicroflowsMod.microflows.Head {
  def this(
    model: AbstractModel,
...
object Head extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.Head = js.native
  /**
    * Creates and returns a new Head instance in the SDK and on the server.
    * The new Head will be automatically stored in the 'operation' property
    * of the parent ListOperationAction element passed as argument.
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.ListOperationAction): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.Head = js.native
}
