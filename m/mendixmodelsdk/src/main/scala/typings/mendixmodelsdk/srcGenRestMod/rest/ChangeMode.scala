...
@js.native
open class ChangeMode protected () extends Element[IModel] {
  def this(
    model: AbstractModel,
...
object ChangeMode {
  ...
  @JSImport("mendixmodelsdk/src/gen/rest", "rest.ChangeMode")
  @js.native
  val ^ : js.Any = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/rest", "rest.ChangeMode.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/rest", "rest.ChangeMode.versionInfo")
  @js.native
