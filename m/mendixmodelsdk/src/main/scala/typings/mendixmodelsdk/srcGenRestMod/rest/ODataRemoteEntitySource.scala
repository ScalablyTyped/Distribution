...
import typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.QueryBasedRemoteEntitySource
...
- typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IQueryBasedRemoteEntitySource because Already inherited
- typings.mendixmodelsdk.srcGenRestMod.rest.IODataRemoteEntitySource because var conflicts: containerAsEntity, id, isLoaded, model, structureTypeName, unit. Inlined key, countable */ @JSImport("mendixmodelsdk/src/gen/rest", "rest.ODataRemoteEntitySource")
@js.native
