...
/* Rewritten from type alias, can be one of: 
  - typings.mendixmodelsdk.srcSdkInternalTransportInterfacesMod.ICommitToGitTeamServerOptions
  - typings.mendixmodelsdk.srcSdkInternalTransportInterfacesMod.ICommitToSVNTeamServerOptions
*/
...
object ICommitToTeamServerOptions {
  ...
  inline def ICommitToGitTeamServerOptions(
    ...
    __obj.asInstanceOf[typings.mendixmodelsdk.srcSdkInternalTransportInterfacesMod.ICommitToGitTeamServerOptions]
  }
  ...
  inline def ICommitToSVNTeamServerOptions(
    ...
    __obj.asInstanceOf[typings.mendixmodelsdk.srcSdkInternalTransportInterfacesMod.ICommitToSVNTeamServerOptions]
  }
}
