...
object srcGenQueuesMod {
  ...
  object queues {
    ...
    - typings.mendixmodelsdk.srcGenQueuesMod.queues.IQueue because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/queues", "queues.Queue")
    @js.native
    ...
    /**
      ...
      * In version 8.16.0: introduced
      */
    /* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/queues", "queues.QueueConfig")
    @js.native
    open class QueueConfig protected () extends Element[IModel] {
      def this(
        model: AbstractModel,
        structureTypeName: String,
        id: String,
    ...
    /**
      * In version 9.10.0: introduced
      */
    /* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/queues", "queues.QueueRetry")
    @js.native
    open class QueueRetry protected () extends Element[IModel] {
      def this(
        model: AbstractModel,
        structureTypeName: String,
        id: String,
