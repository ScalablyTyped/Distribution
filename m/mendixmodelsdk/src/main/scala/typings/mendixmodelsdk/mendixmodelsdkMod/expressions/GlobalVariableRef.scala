...
class GlobalVariableRef protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.expressions.GlobalVariableRef {
  def this(
    model: AbstractModel,
...
object GlobalVariableRef extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenExpressionsMod.expressions.GlobalVariableRef = js.native
  /**
    * Creates and returns a new GlobalVariableRef instance in the SDK and on the server.
    ...
    *  7.9.0 and higher
    */
  def createIn(container: typings.mendixmodelsdk.distGenExpressionsMod.expressions.VariableRefExpression): typings.mendixmodelsdk.distGenExpressionsMod.expressions.GlobalVariableRef = js.native
}
