...
class EntityElement protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.messagedefinitions.EntityElement {
  def this(
...
object EntityElement extends js.Object {
  ...
  /**
    ...
    *  7.6.0 and higher
    */
  def createInElementUnderChildren(container: typings.mendixmodelsdk.distGenMappingsMod.mappings.Element): typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.EntityElement = js.native
  /**
    * Creates and returns a new EntityElement instance in the SDK and on the server.
