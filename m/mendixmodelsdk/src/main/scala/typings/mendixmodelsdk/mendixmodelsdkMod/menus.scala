...
object menus extends js.Object {
  ...
  class MenuDocument protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.menus.MenuDocument {
    def this(
  ...
  class MenuItem protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.menus.MenuItem {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class MenuItemCollection protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.menus.MenuItemCollection {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class MenuItemContainer protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.menus.MenuItemContainer {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
