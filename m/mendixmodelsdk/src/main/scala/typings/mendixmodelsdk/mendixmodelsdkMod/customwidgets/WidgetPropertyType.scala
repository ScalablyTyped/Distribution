...
class WidgetPropertyType protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.customwidgets.WidgetPropertyType {
  def this(
...
object WidgetPropertyType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetPropertyType = js.native
  /**
    * Creates and returns a new WidgetPropertyType instance in the SDK and on the server.
    ...
    */
  def createIn(container: typings.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetObjectType): typings.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetPropertyType = js.native
}
