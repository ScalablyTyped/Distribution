...
class EntityTypeJavaActionParameterValue protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.EntityTypeJavaActionParameterValue {
  def this(
...
object EntityTypeJavaActionParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue = js.native
  /**
    * Creates and returns a new EntityTypeJavaActionParameterValue instance in the SDK and on the server.
    ...
    *  6.8.0 to 7.20.0
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaActionParameterMapping): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue = js.native
}
