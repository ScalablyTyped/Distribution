...
class NanoflowCallAction protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.NanoflowCallAction {
  def this(
...
object NanoflowCallAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.NanoflowCallAction = js.native
  /**
    * Creates and returns a new NanoflowCallAction instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.ActionActivity): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.NanoflowCallAction = js.native
}
