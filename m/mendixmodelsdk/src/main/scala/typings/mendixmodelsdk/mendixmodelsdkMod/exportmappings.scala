...
object exportmappings extends js.Object {
  ...
  class ExportMapping protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.exportmappings.ExportMapping {
    def this(
  ...
  class ExportObjectMappingElement protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.exportmappings.ExportObjectMappingElement {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ExportValueMappingElement protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.exportmappings.ExportValueMappingElement {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  object ExportMapping extends js.Object {
    ...
    /**
      ...
      */
    def createIn(container: IFolderBase): typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportMapping = js.native
  }
  ...
  object ExportObjectMappingElement extends js.Object {
    ...
    /**
      ...
      */
    def create(model: IModel): typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportObjectMappingElement = js.native
    /**
      * Creates and returns a new ExportObjectMappingElement instance in the SDK and on the server.
      * The new ExportObjectMappingElement will be automatically stored in the 'rootMappingElements' property
      * of the parent mappings.MappingDocument element passed as argument.
      */
    def createInMappingDocumentUnderRootMappingElements(container: MappingDocument): typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportObjectMappingElement = js.native
    /**
      * Creates and returns a new ExportObjectMappingElement instance in the SDK and on the server.
      * The new ExportObjectMappingElement will be automatically stored in the 'children' property
      * of the parent mappings.ObjectMappingElement element passed as argument.
      */
    def createInObjectMappingElementUnderChildren(container: ObjectMappingElement): typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportObjectMappingElement = js.native
  }
  ...
  object ExportValueMappingElement extends js.Object {
    ...
    /**
      ...
      * After creation, assign or add this instance to a property that accepts this kind of objects.
      */
    def create(model: IModel): typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportValueMappingElement = js.native
    /**
      * Creates and returns a new ExportValueMappingElement instance in the SDK and on the server.
      * The new ExportValueMappingElement will be automatically stored in the 'children' property
      * of the parent mappings.ObjectMappingElement element passed as argument.
      */
    def createIn(container: ObjectMappingElement): typings.mendixmodelsdk.distGenExportmappingsMod.exportmappings.ExportValueMappingElement = js.native
  }
