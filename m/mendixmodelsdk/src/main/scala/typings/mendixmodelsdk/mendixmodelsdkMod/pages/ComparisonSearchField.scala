...
class ComparisonSearchField protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.ComparisonSearchField {
  def this(
    model: AbstractModel,
...
object ComparisonSearchField extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenPagesMod.pages.ComparisonSearchField = js.native
  /**
    * Creates and returns a new ComparisonSearchField instance in the SDK and on the server.
    * The new ComparisonSearchField will be automatically stored in the 'items' property
    * of the parent ControlBar element passed as argument.
    */
  def createIn(container: typings.mendixmodelsdk.distGenPagesMod.pages.ControlBar): typings.mendixmodelsdk.distGenPagesMod.pages.ComparisonSearchField = js.native
}
