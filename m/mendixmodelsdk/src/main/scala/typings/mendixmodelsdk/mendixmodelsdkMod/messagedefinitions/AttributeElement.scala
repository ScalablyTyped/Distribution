...
object AttributeElement extends js.Object {
  ...
  /**
    ...
    *  7.6.0 and higher
    */
  def createInElementUnderChildren(container: typings.mendixmodelsdk.distGenMappingsMod.mappings.Element): typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.AttributeElement = js.native
  /**
    * Creates and returns a new AttributeElement instance in the SDK and on the server.
