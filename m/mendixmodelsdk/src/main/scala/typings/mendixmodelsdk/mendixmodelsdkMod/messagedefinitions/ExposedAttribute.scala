...
class ExposedAttribute protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.messagedefinitions.ExposedAttribute {
  def this(
...
object ExposedAttribute extends js.Object {
  ...
  /**
    ...
    *  7.6.0 and higher
    */
  def createInElementUnderChildren(container: typings.mendixmodelsdk.distGenMappingsMod.mappings.Element): typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedAttribute = js.native
  /**
    * Creates and returns a new ExposedAttribute instance in the SDK and on the server.
