...
class FormDataPart protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.FormDataPart {
  def this(
...
object FormDataPart extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.FormDataPart = js.native
  /**
    * Creates and returns a new FormDataPart instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.FormDataRequestHandling): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.FormDataPart = js.native
}
