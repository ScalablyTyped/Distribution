...
class RetrievalQuery protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.RetrievalQuery {
  def this(
    model: AbstractModel,
...
object RetrievalQuery extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenPagesMod.pages.RetrievalQuery = js.native
}
