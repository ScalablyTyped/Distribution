...
class AppServiceCallParameterMapping protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.AppServiceCallParameterMapping {
  def this(
    model: AbstractModel,
...
object AppServiceCallParameterMapping extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.AppServiceCallParameterMapping = js.native
  /**
    * Creates and returns a new AppServiceCallParameterMapping instance in the SDK and on the server.
    ...
    */
  def createIn(container: typings.mendixmodelsdk.distGenMicroflowsMod.microflows.AppServiceCallAction): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.AppServiceCallParameterMapping = js.native
}
