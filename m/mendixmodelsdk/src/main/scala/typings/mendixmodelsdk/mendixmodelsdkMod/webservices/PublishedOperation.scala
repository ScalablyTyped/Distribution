...
class PublishedOperation protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.webservices.PublishedOperation {
  def this(
    model: AbstractModel,
...
object PublishedOperation extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenWebservicesMod.webservices.PublishedOperation = js.native
  /**
    * Creates and returns a new PublishedOperation instance in the SDK and on the server.
    ...
    */
  def createIn(container: typings.mendixmodelsdk.distGenWebservicesMod.webservices.VersionedService): typings.mendixmodelsdk.distGenWebservicesMod.webservices.PublishedOperation = js.native
}
