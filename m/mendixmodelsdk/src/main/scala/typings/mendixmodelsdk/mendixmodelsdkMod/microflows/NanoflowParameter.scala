...
class NanoflowParameter protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.NanoflowParameter {
  def this(
    model: AbstractModel,
...
object NanoflowParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.NanoflowParameter = js.native
}
