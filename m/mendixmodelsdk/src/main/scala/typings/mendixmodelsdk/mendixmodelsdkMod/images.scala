...
object images extends js.Object {
  ...
  class Image protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.images.Image {
    def this(
  ...
  class ImageCollection protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.images.ImageCollection {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
