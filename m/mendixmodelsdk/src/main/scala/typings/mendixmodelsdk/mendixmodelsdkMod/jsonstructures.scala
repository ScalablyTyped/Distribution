...
object jsonstructures extends js.Object {
  ...
  class JsonElement protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.jsonstructures.JsonElement {
    def this(
  ...
  class JsonStructure protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.jsonstructures.JsonStructure {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  object JsonElement extends js.Object {
    ...
    /**
      ...
      *  6.6.0 and higher
      */
    def createInElementUnderChildren(container: typings.mendixmodelsdk.distGenMappingsMod.mappings.Element): typings.mendixmodelsdk.distGenJsonstructuresMod.jsonstructures.JsonElement = js.native
    /**
      * Creates and returns a new JsonElement instance in the SDK and on the server.
