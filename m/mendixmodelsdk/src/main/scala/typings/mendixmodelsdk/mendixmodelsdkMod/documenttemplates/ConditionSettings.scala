...
class ConditionSettings protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.documenttemplates.ConditionSettings {
  def this(
    model: AbstractModel,
...
object ConditionSettings extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typings.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.ConditionSettings = js.native
  /**
    * Creates and returns a new ConditionSettings instance in the SDK and on the server.
    * The new ConditionSettings will be automatically stored in the 'conditionSettings' property
    * of the parent TableRow element passed as argument.
    */
  def createIn(container: typings.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.TableRow): typings.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.ConditionSettings = js.native
}
