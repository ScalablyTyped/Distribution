...
object exportmappingsNs extends js.Object {
  ...
  class ExportMapping protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.exportmappingsNs.ExportMapping {
    def this(
  ...
  class ExportObjectMappingElement protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.exportmappingsNs.ExportObjectMappingElement {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ExportValueMappingElement protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.exportmappingsNs.ExportValueMappingElement {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
