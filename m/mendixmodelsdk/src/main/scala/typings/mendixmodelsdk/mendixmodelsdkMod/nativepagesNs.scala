...
object nativepagesNs extends js.Object {
  ...
  class BottomBarItem protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepagesNs.BottomBarItem {
    def this(
  ...
  class NativeLayout protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepagesNs.NativeLayout {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativeLayoutCallArgument protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepagesNs.NativeLayoutCallArgument {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePage protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepagesNs.NativePage {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePageClientAction protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepagesNs.NativePageClientAction {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePlaceholder protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepagesNs.NativePlaceholder {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
