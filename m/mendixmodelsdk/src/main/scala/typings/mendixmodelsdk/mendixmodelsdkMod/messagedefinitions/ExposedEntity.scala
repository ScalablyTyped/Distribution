...
class ExposedEntity protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.messagedefinitions.ExposedEntity {
  def this(
...
object ExposedEntity extends js.Object {
  ...
  /**
    ...
    *  7.6.0 and higher
    */
  def createInElementUnderChildren(container: typings.mendixmodelsdk.distGenMappingsMod.mappings.Element): typings.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedEntity = js.native
  /**
    * Creates and returns a new ExposedEntity instance in the SDK and on the server.
