...
object importmappingsNs extends js.Object {
  ...
  class ImportMapping protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.importmappingsNs.ImportMapping {
    def this(
  ...
  class ImportObjectMappingElement protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.importmappingsNs.ImportObjectMappingElement {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ImportValueMappingElement protected ()
    extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.importmappingsNs.ImportValueMappingElement {
    def this(
      model: typings.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
