...
class Microflow protected ()
  extends typings.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.Microflow {
  def this(
...
object Microflow extends js.Object {
  ...
  /**
    ...
    */
  def createIn(container: IFolderBase): typings.mendixmodelsdk.distGenMicroflowsMod.microflows.Microflow = js.native
}
