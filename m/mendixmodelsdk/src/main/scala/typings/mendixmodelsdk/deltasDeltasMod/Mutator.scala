...
object Mutator {
  ...
  inline def IAddMutator(value: PrimitiveValue): typings.mendixmodelsdk.deltasDeltasMod.IAddMutator = {
  ...
  inline def IChangeMutator(): typings.mendixmodelsdk.deltasDeltasMod.IChangeMutator = {
  ...
  inline def IRemoveMutator(removalIndex: Double): typings.mendixmodelsdk.deltasDeltasMod.IRemoveMutator = {
