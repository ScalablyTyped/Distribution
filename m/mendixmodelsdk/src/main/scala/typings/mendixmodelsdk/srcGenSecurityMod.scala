...
object srcGenSecurityMod {
  ...
  object security {
    ...
    /**
      ...
      */
    /* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/security", "security.AccessRuleContainerBase")
    @js.native
    open class AccessRuleContainerBase protected () extends Element[IModel] {
      def this(
        model: AbstractModel,
    ...
    - typings.mendixmodelsdk.srcGenSecurityMod.security.IModuleRole because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsModuleSecurity, name */ @JSImport("mendixmodelsdk/src/gen/security", "security.ModuleRole")
    @js.native
    ...
    - typings.mendixmodelsdk.srcGenSecurityMod.security.IProjectSecurity because var conflicts: containerAsProject, id, isLoaded, model, structureTypeName, unit. Inlined userRoles */ @JSImport("mendixmodelsdk/src/gen/security", "security.ProjectSecurity")
    @js.native
    ...
    - typings.mendixmodelsdk.srcSdkInternalElementsMod.IAbstractElement because Already inherited
    - typings.mendixmodelsdk.srcSdkInternalElementsMod.IElement because Already inherited
    - typings.mendixmodelsdk.srcGenSecurityMod.security.IUserRole because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsProjectSecurity, name */ @JSImport("mendixmodelsdk/src/gen/security", "security.UserRole")
    @js.native
