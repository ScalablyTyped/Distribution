...
object ImportedWebService {
  ...
  /* static member */
  @scala.inline
  def createIn(container: IFolderBase): ImportedWebService = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[ImportedWebService]
