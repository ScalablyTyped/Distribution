...
object srcGenMenusMod {
  ...
  object menus {
    ...
    - typings.mendixmodelsdk.srcGenMenusMod.menus.IMenuDocument because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/menus", "menus.MenuDocument")
    @js.native
