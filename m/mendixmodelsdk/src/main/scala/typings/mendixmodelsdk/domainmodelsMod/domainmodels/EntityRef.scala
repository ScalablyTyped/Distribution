...
- typings.mendixmodelsdk.domainmodelsMod.domainmodels.IEntityRef because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsMemberRef, containerAsParameter */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.EntityRef")
@js.native
