...
- typings.mendixmodelsdk.domainmodelsMod.domainmodels.IRemoteEntitySource because var conflicts: containerAsEntity, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.RemoteEntitySource")
@js.native
