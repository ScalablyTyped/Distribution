...
object AssociationCapabilities {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): AssociationCapabilities = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[AssociationCapabilities]
  ...
  /* static member */
  @scala.inline
  def createIn(container: AssociationBase): AssociationCapabilities = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[AssociationCapabilities]
