...
@JSImport("mendixmodelsdk/dist/sdk/internal/properties/by-name-reference", JSImport.Namespace)
@js.native
object distSdkInternalPropertiesByDashNameDashReferenceMod extends js.Object {
  @js.native
