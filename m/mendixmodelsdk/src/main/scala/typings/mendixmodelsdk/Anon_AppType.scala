...
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.IBuildError
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.IEnvironmentStatus
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.IProblem
...
trait Anon_AppType extends IEnvironmentStatus {
