...
import typings.mendixmodelsdk.srcGenPagesMod.pages.AlignmentEnum
...
object srcGenReportsMod {
  ...
  object reports {
    ...
    /* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/reports", "reports.ReportParameter")
    @js.native
    open class ReportParameter protected () extends Widget {
      def this(
        model: AbstractModel,
        structureTypeName: String,
        id: String,
    ...
    /**
      ...
      */
    /* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/reports", "reports.ReportWidget")
    @js.native
    open class ReportWidget protected () extends Widget {
      def this(
        model: AbstractModel,
        structureTypeName: String,
        id: String,
