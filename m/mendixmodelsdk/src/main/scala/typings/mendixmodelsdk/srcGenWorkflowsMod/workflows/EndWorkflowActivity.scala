...
- typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.IEndWorkflowActivity because var conflicts: caption, containerAsFlow, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.EndWorkflowActivity")
@js.native
