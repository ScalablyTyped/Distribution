...
object srcGenAppservicesMod {
  ...
  object appservices {
    ...
    - typings.mendixmodelsdk.srcGenAppservicesMod.appservices.IAppServiceAction because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsConsumedAppService, name, parameters */ @JSImport("mendixmodelsdk/src/gen/appservices", "appservices.AppServiceAction")
    @js.native
    ...
    - typings.mendixmodelsdk.srcSdkInternalElementsMod.IAbstractElement because Already inherited
    - typings.mendixmodelsdk.srcSdkInternalElementsMod.IElement because Already inherited
    - typings.mendixmodelsdk.srcGenAppservicesMod.appservices.IAppServiceActionParameter because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsAppServiceAction, name */ @JSImport("mendixmodelsdk/src/gen/appservices", "appservices.AppServiceActionParameter")
    @js.native
    ...
    - typings.mendixmodelsdk.srcGenAppservicesMod.appservices.IConsumedAppService because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined actions */ @JSImport("mendixmodelsdk/src/gen/appservices", "appservices.ConsumedAppService")
    @js.native
