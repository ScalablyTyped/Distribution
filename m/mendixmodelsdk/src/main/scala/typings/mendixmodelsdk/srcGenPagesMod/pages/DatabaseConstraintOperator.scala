...
@JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator")
@js.native
open class DatabaseConstraintOperator protected () extends AbstractEnum {
...
object DatabaseConstraintOperator {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator.Contains")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator.Equals")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator.GreaterThan")
  @js.native
  def GreaterThan: DatabaseConstraintOperator = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator.GreaterThanOrEquals")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator.LessThan")
  @js.native
  def LessThan: DatabaseConstraintOperator = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator.LessThanOrEquals")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator.NotContains")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DatabaseConstraintOperator.NotEquals")
  @js.native
