...
- typings.mendixmodelsdk.srcGenPagesMod.pages.IPageTemplate because var conflicts: containerAsFolderBase, displayName, documentationUrl, id, isLoaded, model, structureTypeName, templateCategory, templateCategoryWeight, unit. Inlined `type`, layoutCall, templateType */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.PageTemplate")
@js.native
