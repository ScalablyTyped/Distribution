...
- typings.mendixmodelsdk.srcGenPagesMod.pages.IWorkflowTemplateType because var conflicts: containerAsPageTemplate, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.WorkflowTemplateType")
@js.native
