...
- typings.mendixmodelsdk.srcGenPagesMod.pages.ILayoutContent because Already inherited
- typings.mendixmodelsdk.srcGenPagesMod.pages.INativeLayoutContent because var conflicts: containerAsLayout, id, isLoaded, model, structureTypeName, unit. Inlined layoutType */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.NativeLayoutContent")
@js.native
