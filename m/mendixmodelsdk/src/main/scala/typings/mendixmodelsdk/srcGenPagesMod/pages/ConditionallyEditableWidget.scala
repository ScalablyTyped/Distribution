...
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.ConditionallyEditableWidget")
@js.native
open class ConditionallyEditableWidget protected () extends ConditionallyVisibleWidget {
  def this(
    model: AbstractModel,
