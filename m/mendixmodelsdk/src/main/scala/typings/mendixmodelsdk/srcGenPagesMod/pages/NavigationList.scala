...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/pages", "pages.NavigationList")
@js.native
open class NavigationList protected () extends ConditionallyVisibleWidget {
  def this(
    model: AbstractModel,
...
object NavigationList {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.NavigationList.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.NavigationList.versionInfo")
  @js.native
