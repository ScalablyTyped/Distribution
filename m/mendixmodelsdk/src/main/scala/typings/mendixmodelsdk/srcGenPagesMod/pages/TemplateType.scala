...
- typings.mendixmodelsdk.srcGenPagesMod.pages.ITemplateType because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsPageTemplate */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.TemplateType")
@js.native
