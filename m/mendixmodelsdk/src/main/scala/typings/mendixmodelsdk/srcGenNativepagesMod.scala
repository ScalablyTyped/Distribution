...
import typings.mendixmodelsdk.srcGenPagesMod.pages.FormBase
...
object srcGenNativepagesMod {
  ...
  object nativepages {
    ...
    - typings.mendixmodelsdk.srcGenNativepagesMod.nativepages.INativeLayout because var conflicts: containerAsFolderBase, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/nativepages", "nativepages.NativeLayout")
    @js.native
    ...
    - typings.mendixmodelsdk.srcGenProjectsMod.projects.IDocument because Already inherited
    - typings.mendixmodelsdk.srcGenPagesMod.pages.IFormBase because Already inherited
    - typings.mendixmodelsdk.srcGenNativepagesMod.nativepages.INativePage because var conflicts: containerAsFolderBase, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/nativepages", "nativepages.NativePage")
    @js.native
