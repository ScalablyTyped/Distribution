...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ExportMappingParameterValue")
@js.native
open class ExportMappingParameterValue protected () extends ExpressionBasedCodeActionParameterValue {
  def this(
    model: AbstractModel,
...
object ExportMappingParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): ExportMappingParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[ExportMappingParameterValue]
  ...
  /**
    ...
    */
  /* static member */
  inline def createInJavaActionParameterMappingUnderParameterValue(container: JavaActionParameterMapping): ExportMappingParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createInJavaActionParameterMappingUnderParameterValue")(container.asInstanceOf[js.Any]).asInstanceOf[ExportMappingParameterValue]
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ExportMappingParameterValue.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ExportMappingParameterValue.versionInfo")
  @js.native
