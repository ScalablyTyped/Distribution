...
import typings.mendixmodelsdk.distSdkConfigurationMod.configuration.ICreateWorkingCopyFromTeamServerParameters
import typings.mendixmodelsdk.distSdkConfigurationMod.configuration.ICreateWorkingCopyParameters
...
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.ICommitToTeamServerOptions
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.IDeployJobStatus
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.IEnvironmentStatus
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.ILockWorkingCopyOptions
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.ILockWorkingCopyResponse
import typings.mendixmodelsdk.distSdkInternalTransportInterfacesMod.IWorkingCopy
...
@js.native
object distModelSdkClientImplMod extends js.Object {
  @js.native
  class ModelSdkClientImpl[IT /* <: IAbstractModel */, CT /* <: AbstractModel with IT */] protected () extends js.Object {
    def this(connectionConfig: ISdkConfig, modelConstructor: Anon_Client[CT]) = this()
