...
@JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ErrorHandlingType")
@js.native
open class ErrorHandlingType protected () extends AbstractEnum {
...
object ErrorHandlingType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ErrorHandlingType.Abort")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ErrorHandlingType.Continue")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ErrorHandlingType.Custom")
  @js.native
  def Custom: ErrorHandlingType = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ErrorHandlingType.CustomWithoutRollBack")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ErrorHandlingType.Rollback")
  @js.native
