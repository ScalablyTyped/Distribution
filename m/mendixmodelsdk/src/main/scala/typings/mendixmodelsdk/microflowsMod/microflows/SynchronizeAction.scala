...
object SynchronizeAction {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): SynchronizeAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[SynchronizeAction]
  ...
  /* static member */
  @scala.inline
  def createIn(container: ActionActivity): SynchronizeAction = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[SynchronizeAction]
