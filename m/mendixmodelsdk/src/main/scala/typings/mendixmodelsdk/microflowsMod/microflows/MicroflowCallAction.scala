...
object MicroflowCallAction {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): MicroflowCallAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[MicroflowCallAction]
  ...
  /* static member */
  @scala.inline
  def createIn(container: ActionActivity): MicroflowCallAction = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[MicroflowCallAction]
