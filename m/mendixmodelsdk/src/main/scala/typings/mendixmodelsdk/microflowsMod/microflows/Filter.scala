...
object Filter {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): Filter = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[Filter]
  ...
  /* static member */
  @scala.inline
  def createIn(container: ListOperationAction): Filter = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[Filter]
