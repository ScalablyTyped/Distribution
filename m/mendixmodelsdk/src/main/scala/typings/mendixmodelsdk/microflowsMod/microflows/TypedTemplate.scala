...
object TypedTemplate {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): TypedTemplate = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[TypedTemplate]
  ...
  /* static member */
  @scala.inline
  def createIn(container: StringTemplateParameterValue): TypedTemplate = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[TypedTemplate]
