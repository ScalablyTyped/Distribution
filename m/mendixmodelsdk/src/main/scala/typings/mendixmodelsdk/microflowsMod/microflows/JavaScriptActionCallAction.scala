...
object JavaScriptActionCallAction {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): JavaScriptActionCallAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[JavaScriptActionCallAction]
  ...
  /* static member */
  @scala.inline
  def createIn(container: ActionActivity): JavaScriptActionCallAction = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[JavaScriptActionCallAction]
