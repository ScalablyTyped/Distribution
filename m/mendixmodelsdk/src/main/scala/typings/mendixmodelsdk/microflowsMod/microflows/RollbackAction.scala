...
object RollbackAction {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): RollbackAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[RollbackAction]
  ...
  /* static member */
  @scala.inline
  def createIn(container: ActionActivity): RollbackAction = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[RollbackAction]
