...
object BasicJavaActionParameterValue {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): BasicJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[BasicJavaActionParameterValue]
  ...
  /* static member */
  @scala.inline
  def createIn(container: JavaActionParameterMapping): BasicJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[BasicJavaActionParameterValue]
