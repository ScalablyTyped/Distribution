...
object AssociationRetrieveSource {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): AssociationRetrieveSource = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[AssociationRetrieveSource]
  ...
  /* static member */
  @scala.inline
  def createIn(container: RetrieveAction): AssociationRetrieveSource = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[AssociationRetrieveSource]
