...
object AppServiceCallAction {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): AppServiceCallAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[AppServiceCallAction]
  ...
  /* static member */
  @scala.inline
  def createIn(container: ActionActivity): AppServiceCallAction = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[AppServiceCallAction]
