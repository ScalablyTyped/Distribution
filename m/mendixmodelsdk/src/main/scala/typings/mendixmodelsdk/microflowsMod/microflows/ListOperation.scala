...
object ListOperation {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.ListOperation.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.ListOperation.versionInfo")
  @js.native
