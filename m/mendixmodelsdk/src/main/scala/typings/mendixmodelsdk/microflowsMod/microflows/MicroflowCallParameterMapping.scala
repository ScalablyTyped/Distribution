...
object MicroflowCallParameterMapping {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): MicroflowCallParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[MicroflowCallParameterMapping]
  ...
  /* static member */
  @scala.inline
  def createIn(container: MicroflowCall): MicroflowCallParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[MicroflowCallParameterMapping]
