...
object EndEvent {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): EndEvent = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[EndEvent]
  ...
  /* static member */
  @scala.inline
  def createIn(container: MicroflowObjectCollection): EndEvent = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[EndEvent]
