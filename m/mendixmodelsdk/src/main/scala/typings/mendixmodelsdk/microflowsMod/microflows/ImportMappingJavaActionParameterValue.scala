...
object ImportMappingJavaActionParameterValue {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): ImportMappingJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[ImportMappingJavaActionParameterValue]
  ...
  /* static member */
  @scala.inline
  def createIn(container: JavaActionParameterMapping): ImportMappingJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[ImportMappingJavaActionParameterValue]
