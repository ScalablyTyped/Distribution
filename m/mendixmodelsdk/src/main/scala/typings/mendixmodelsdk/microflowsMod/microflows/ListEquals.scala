...
object ListEquals {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): ListEquals = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[ListEquals]
  ...
  /* static member */
  @scala.inline
  def createIn(container: ListOperationAction): ListEquals = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[ListEquals]
