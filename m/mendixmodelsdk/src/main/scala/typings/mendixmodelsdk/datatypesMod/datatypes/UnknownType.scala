...
- typings.mendixmodelsdk.datatypesMod.datatypes.IUnknownType because var conflicts: containerAsAppServiceAction, containerAsAppServiceActionParameter, containerAsConstant, containerAsDataSetParameter, containerAsDocumentTemplateParameter, containerAsImportMapping, containerAsMicroflowBase, containerAsMicroflowParameterBase, containerAsPageParameter, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.UnknownType")
@js.native
open class UnknownType protected () extends DataType {
  def this(
    model: AbstractModel,
  ...
  def containerAsPageParameter_MUnknownType: PageParameter = js.native
}
object UnknownType {
  
  @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.UnknownType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  inline def createInMLModelCallParameterMappingUnderParameterType(container: MLModelCallParameterMapping): UnknownType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInMLModelCallParameterMappingUnderParameterType")(container.asInstanceOf[js.Any]).asInstanceOf[UnknownType]
  ...
  /**
    ...
    */
  /* static member */
  inline def createInPageParameterUnderParameterType(container: PageParameter): UnknownType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInPageParameterUnderParameterType")(container.asInstanceOf[js.Any]).asInstanceOf[UnknownType]
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.UnknownType.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.UnknownType.versionInfo")
  @js.native
