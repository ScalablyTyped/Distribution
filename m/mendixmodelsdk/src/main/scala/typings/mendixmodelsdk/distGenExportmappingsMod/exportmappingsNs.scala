package typings.mendixmodelsdk.distGenExportmappingsMod

import typings.mendixmodelsdk.distGenBaseDashModelMod.IModel
import typings.mendixmodelsdk.distGenExportmappingsMod.exportmappingsNs.ExportMapping
import typings.mendixmodelsdk.distGenExportmappingsMod.exportmappingsNs.ExportObjectMappingElement
import typings.mendixmodelsdk.distGenExportmappingsMod.exportmappingsNs.ExportValueMappingElement
...
object exportmappingsNs extends js.Object {
  ...
  - typings.mendixmodelsdk.distGenExportmappingsMod.exportmappingsNs.IExportMapping because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined  */ @js.native
