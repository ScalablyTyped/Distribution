...
object LayoutCallArgument {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): LayoutCallArgument = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[LayoutCallArgument]
