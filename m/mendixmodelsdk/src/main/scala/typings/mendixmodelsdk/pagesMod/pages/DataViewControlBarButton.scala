...
object DataViewControlBarButton {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataViewControlBarButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataViewControlBarButton.versionInfo")
  @js.native
