...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/pages", "pages.DivContainer")
@js.native
open class DivContainer protected () extends ConditionallyVisibleWidget {
  def this(
    model: AbstractModel,
...
object DivContainer {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DivContainer.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DivContainer.versionInfo")
  @js.native
