...
object NanoflowParameterMapping {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): NanoflowParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[NanoflowParameterMapping]
  ...
  /* static member */
  @scala.inline
  def createInCallNanoflowClientActionUnderParameterMappings(container: CallNanoflowClientAction): NanoflowParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("createInCallNanoflowClientActionUnderParameterMappings")(container.asInstanceOf[js.Any]).asInstanceOf[NanoflowParameterMapping]
  ...
  /* static member */
  @scala.inline
  def createInNanoflowSourceUnderParameterMappings(container: NanoflowSource): NanoflowParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("createInNanoflowSourceUnderParameterMappings")(container.asInstanceOf[js.Any]).asInstanceOf[NanoflowParameterMapping]
