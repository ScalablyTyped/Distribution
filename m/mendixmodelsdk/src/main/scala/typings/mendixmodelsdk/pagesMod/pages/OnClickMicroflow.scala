...
object OnClickMicroflow {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): OnClickMicroflow = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[OnClickMicroflow]
  ...
  /* static member */
  @scala.inline
  def createIn(container: DynamicImageViewer): OnClickMicroflow = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[OnClickMicroflow]
