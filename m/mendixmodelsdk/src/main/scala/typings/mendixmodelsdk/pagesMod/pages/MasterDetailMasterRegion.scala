...
object MasterDetailMasterRegion {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.MasterDetailMasterRegion.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.MasterDetailMasterRegion.createIn")
  @js.native
