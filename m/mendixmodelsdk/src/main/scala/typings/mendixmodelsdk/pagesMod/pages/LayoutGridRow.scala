...
object LayoutGridRow {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): LayoutGridRow = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[LayoutGridRow]
  ...
  /* static member */
  @scala.inline
  def createIn(container: LayoutGrid): LayoutGridRow = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[LayoutGridRow]
