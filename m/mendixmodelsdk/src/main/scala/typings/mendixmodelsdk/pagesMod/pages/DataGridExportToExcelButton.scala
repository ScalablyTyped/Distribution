...
object DataGridExportToExcelButton {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): DataGridExportToExcelButton = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[DataGridExportToExcelButton]
  ...
  /* static member */
  @scala.inline
  def createIn(container: ControlBar): DataGridExportToExcelButton = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[DataGridExportToExcelButton]
