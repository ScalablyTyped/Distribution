...
object Layout {
  ...
  /* static member */
  @scala.inline
  def createIn(container: IFolderBase): Layout = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[Layout]
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.Layout.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.Layout.versionInfo")
  @js.native
