...
object WorkflowTemplateType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.WorkflowTemplateType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.WorkflowTemplateType.versionInfo")
  @js.native
