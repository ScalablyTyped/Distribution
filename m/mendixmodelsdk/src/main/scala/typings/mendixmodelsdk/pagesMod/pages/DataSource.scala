...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/pages", "pages.DataSource")
@js.native
...
object DataSource {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DataSource.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DataSource.versionInfo")
  @js.native
