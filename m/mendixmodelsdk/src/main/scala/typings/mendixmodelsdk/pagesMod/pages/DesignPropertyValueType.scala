...
@JSImport("mendixmodelsdk/src/gen/pages", "pages.DesignPropertyValueType")
@js.native
open class DesignPropertyValueType protected () extends AbstractEnum {
...
object DesignPropertyValueType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DesignPropertyValueType.DropDown")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.DesignPropertyValueType.Toggle")
  @js.native
