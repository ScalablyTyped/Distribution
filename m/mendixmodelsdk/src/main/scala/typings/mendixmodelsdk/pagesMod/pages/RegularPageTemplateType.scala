...
object RegularPageTemplateType {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): RegularPageTemplateType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[RegularPageTemplateType]
  ...
  /* static member */
  @scala.inline
  def createIn(container: PageTemplate): RegularPageTemplateType = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[RegularPageTemplateType]
