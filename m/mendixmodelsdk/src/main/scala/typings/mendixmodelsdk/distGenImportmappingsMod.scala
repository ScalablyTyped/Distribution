...
import typings.mendixmodelsdk.distGenImportmappingsMod.StructureVersionInfo
import typings.mendixmodelsdk.distGenImportmappingsMod.importmappings.ImportMapping
import typings.mendixmodelsdk.distGenImportmappingsMod.importmappings.ImportObjectMappingElement
import typings.mendixmodelsdk.distGenImportmappingsMod.importmappings.ImportValueMappingElement
