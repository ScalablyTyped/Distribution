...
object mlmappingsMod {
  ...
  object mlmappings {
    ...
    - typings.mendixmodelsdk.mlmappingsMod.mlmappings.IMLMappingDocument because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/mlmappings", "mlmappings.MLMappingDocument")
    @js.native
