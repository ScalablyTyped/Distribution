...
- typings.mendixmodelsdk.srcGenCodeactionsMod.codeactions.IBasicParameterType because var conflicts: containerAsCodeActionParameter, id, isLoaded, model, structureTypeName, unit. Inlined `type` */ @JSImport("mendixmodelsdk/src/gen/codeactions", "codeactions.BasicParameterType")
@js.native
