...
- typings.mendixmodelsdk.srcGenCodeactionsMod.codeactions.IPrimitiveType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, containerAsListType, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/codeactions", "codeactions.PrimitiveType")
@js.native
