...
- typings.mendixmodelsdk.srcGenCodeactionsMod.codeactions.IBooleanType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/codeactions", "codeactions.BooleanType")
@js.native
