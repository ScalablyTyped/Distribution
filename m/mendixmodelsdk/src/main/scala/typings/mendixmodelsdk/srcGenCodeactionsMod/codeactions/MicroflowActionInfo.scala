...
- typings.mendixmodelsdk.srcGenCodeactionsMod.codeactions.IMicroflowActionInfo because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsCodeAction, containerAsMicroflow, caption, category, icon, iconQualifiedName, imageData */ @JSImport("mendixmodelsdk/src/gen/codeactions", "codeactions.MicroflowActionInfo")
@js.native
