...
- typings.mendixmodelsdk.srcGenCodeactionsMod.codeactions.IStringType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/codeactions", "codeactions.StringType")
@js.native
