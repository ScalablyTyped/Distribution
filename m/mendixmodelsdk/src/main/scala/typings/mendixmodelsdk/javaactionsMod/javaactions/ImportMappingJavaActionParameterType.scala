...
object ImportMappingJavaActionParameterType {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): ImportMappingJavaActionParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[ImportMappingJavaActionParameterType]
