...
object ImportMappingParameterType {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): ImportMappingParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[ImportMappingParameterType]
  ...
  /* static member */
  @scala.inline
  def createIn(container: JavaActionParameter): ImportMappingParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[ImportMappingParameterType]
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.ImportMappingParameterType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.ImportMappingParameterType.versionInfo")
  @js.native
