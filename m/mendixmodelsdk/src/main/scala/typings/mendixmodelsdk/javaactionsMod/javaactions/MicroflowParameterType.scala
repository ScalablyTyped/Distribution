...
object MicroflowParameterType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): MicroflowParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[MicroflowParameterType]
