...
- typings.mendixmodelsdk.javaactionsMod.javaactions.IMicroflowJavaActionParameterType because var conflicts: containerAsCodeActionParameter, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.MicroflowJavaActionParameterType")
@js.native
...
object MicroflowJavaActionParameterType {
  ...
  /* static member */
  @scala.inline
  def create(model: IModel): MicroflowJavaActionParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[MicroflowJavaActionParameterType]
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.MicroflowJavaActionParameterType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.MicroflowJavaActionParameterType.versionInfo")
  @js.native
