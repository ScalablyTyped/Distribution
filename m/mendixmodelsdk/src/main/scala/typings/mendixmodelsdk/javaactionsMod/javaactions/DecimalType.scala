...
object DecimalType {
  ...
  /* static member */
  @scala.inline
  def createInBasicParameterTypeUnderType(container: BasicParameterType): DecimalType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInBasicParameterTypeUnderType")(container.asInstanceOf[js.Any]).asInstanceOf[DecimalType]
  ...
  /* static member */
  @scala.inline
  def createInJavaActionParameterUnderJavaType(container: JavaActionParameter): DecimalType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInJavaActionParameterUnderJavaType")(container.asInstanceOf[js.Any]).asInstanceOf[DecimalType]
  ...
  /* static member */
  @scala.inline
  def createInJavaActionUnderJavaReturnType(container: JavaAction): DecimalType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInJavaActionUnderJavaReturnType")(container.asInstanceOf[js.Any]).asInstanceOf[DecimalType]
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.DecimalType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.DecimalType.versionInfo")
  @js.native
