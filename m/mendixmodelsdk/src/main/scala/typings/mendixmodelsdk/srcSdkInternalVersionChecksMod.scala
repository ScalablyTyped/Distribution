...
object srcSdkInternalVersionChecksMod {
  ...
  /* note: abstract class */ @JSImport("mendixmodelsdk/src/sdk/internal/versionChecks", "VersionInfo")
  @js.native
  open class VersionInfo () extends StObject {
