...
object srcGenMappingsMod {
  ...
  object mappings {
    ...
    - typings.mendixmodelsdk.srcGenMappingsMod.mappings.IMappingDocument because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/mappings", "mappings.MappingDocument")
    @js.native
