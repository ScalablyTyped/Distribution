...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.NewButton")
@js.native
open class NewButton protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.NewButton {
  def this(
    model: AbstractModel,
...
object NewButton {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.NewButton.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.NewButton.versionInfo")
  @js.native
