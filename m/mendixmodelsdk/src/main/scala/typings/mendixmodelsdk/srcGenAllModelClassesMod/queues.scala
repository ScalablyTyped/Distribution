...
object queues {
  ...
  open class BasicQueueConfig protected ()
    extends typings.mendixmodelsdk.srcGenQueuesMod.queues.BasicQueueConfig {
    def this(
      model: AbstractModel,
  ...
  open class Queue protected ()
    extends typings.mendixmodelsdk.srcGenQueuesMod.queues.Queue {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueConfig protected ()
    extends typings.mendixmodelsdk.srcGenQueuesMod.queues.QueueConfig {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueExponentialRetry protected ()
    extends typings.mendixmodelsdk.srcGenQueuesMod.queues.QueueExponentialRetry {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueFixedRetry protected ()
    extends typings.mendixmodelsdk.srcGenQueuesMod.queues.QueueFixedRetry {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueRetry protected ()
    extends typings.mendixmodelsdk.srcGenQueuesMod.queues.QueueRetry {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueRetryIntervalType protected ()
    extends typings.mendixmodelsdk.srcGenQueuesMod.queues.QueueRetryIntervalType {
  ...
  open class QueueSettings protected ()
    extends typings.mendixmodelsdk.srcGenQueuesMod.queues.QueueSettings {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
