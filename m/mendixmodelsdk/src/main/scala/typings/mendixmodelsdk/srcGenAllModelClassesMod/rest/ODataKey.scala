...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ODataKey")
@js.native
open class ODataKey protected ()
  extends typings.mendixmodelsdk.srcGenRestMod.rest.ODataKey {
  def this(
    model: AbstractModel,
...
object ODataKey {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ODataKey.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ODataKey.versionInfo")
  @js.native
