...
open class HashedStringAttributeType protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.HashedStringAttributeType {
  def this(
    model: AbstractModel,
...
object HashedStringAttributeType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.HashedStringAttributeType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.HashedStringAttributeType]
