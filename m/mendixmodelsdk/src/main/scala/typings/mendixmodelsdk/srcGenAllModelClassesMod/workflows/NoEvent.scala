...
open class NoEvent protected ()
  extends typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.NoEvent {
  def this(
    model: AbstractModel,
...
object NoEvent {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.NoEvent = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.NoEvent]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.UserTask): typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.NoEvent = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.NoEvent]
