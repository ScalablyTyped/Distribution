...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataEnumeration")
@js.native
open class PublishedODataEnumeration protected ()
  extends typings.mendixmodelsdk.srcGenRestMod.rest.PublishedODataEnumeration {
  def this(
    model: AbstractModel,
...
object PublishedODataEnumeration {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataEnumeration.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataEnumeration.versionInfo")
  @js.native
