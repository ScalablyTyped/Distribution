...
open class GridSortBar protected ()
  extends typings.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar {
  def this(
    model: AbstractModel,
...
object GridSortBar {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typings.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.Grid): typings.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar]
