...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.BinaryAttributeType")
@js.native
open class BinaryAttributeType protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.BinaryAttributeType {
  def this(
    model: AbstractModel,
...
object BinaryAttributeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.BinaryAttributeType.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.BinaryAttributeType.versionInfo")
  @js.native
