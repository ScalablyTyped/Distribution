...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ImageIcon")
@js.native
open class ImageIcon protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.ImageIcon {
  def this(
    model: AbstractModel,
...
object ImageIcon {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ImageIcon.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ImageIcon.versionInfo")
  @js.native
