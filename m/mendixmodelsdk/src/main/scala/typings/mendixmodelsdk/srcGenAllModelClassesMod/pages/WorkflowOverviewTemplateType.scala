...
open class WorkflowOverviewTemplateType protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.WorkflowOverviewTemplateType {
  def this(
    model: AbstractModel,
...
object WorkflowOverviewTemplateType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenPagesMod.pages.WorkflowOverviewTemplateType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenPagesMod.pages.WorkflowOverviewTemplateType]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typings.mendixmodelsdk.srcGenPagesMod.pages.PageTemplate): typings.mendixmodelsdk.srcGenPagesMod.pages.WorkflowOverviewTemplateType = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenPagesMod.pages.WorkflowOverviewTemplateType]
