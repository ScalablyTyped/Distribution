...
open class ConstantValue protected ()
  extends typings.mendixmodelsdk.srcGenSettingsMod.settings.ConstantValue {
  def this(
    model: AbstractModel,
...
object ConstantValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenSettingsMod.settings.ConstantValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenSettingsMod.settings.ConstantValue]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typings.mendixmodelsdk.srcGenSettingsMod.settings.Configuration): typings.mendixmodelsdk.srcGenSettingsMod.settings.ConstantValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenSettingsMod.settings.ConstantValue]
