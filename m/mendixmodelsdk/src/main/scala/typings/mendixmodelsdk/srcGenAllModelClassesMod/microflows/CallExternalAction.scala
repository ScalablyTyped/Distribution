...
open class CallExternalAction protected ()
  extends typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.CallExternalAction {
  def this(
    model: AbstractModel,
...
object CallExternalAction {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.CallExternalAction.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.CallExternalAction.versionInfo")
  @js.native
