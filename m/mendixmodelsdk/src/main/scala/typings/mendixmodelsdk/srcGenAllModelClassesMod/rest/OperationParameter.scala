...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.OperationParameter")
@js.native
open class OperationParameter protected ()
  extends typings.mendixmodelsdk.srcGenRestMod.rest.OperationParameter {
  def this(
    model: AbstractModel,
...
object OperationParameter {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.OperationParameter.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.OperationParameter.versionInfo")
  @js.native
