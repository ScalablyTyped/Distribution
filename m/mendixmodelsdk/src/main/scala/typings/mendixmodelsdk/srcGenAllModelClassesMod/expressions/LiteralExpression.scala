...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/all-model-classes", "expressions.LiteralExpression")
@js.native
open class LiteralExpression protected ()
  extends typings.mendixmodelsdk.srcGenExpressionsMod.expressions.LiteralExpression {
  def this(
    model: AbstractModel,
