...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.AbsoluteAmountUserInput")
@js.native
open class AbsoluteAmountUserInput protected ()
  extends typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.AbsoluteAmountUserInput {
  def this(
    model: AbstractModel,
...
object AbsoluteAmountUserInput {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.AbsoluteAmountUserInput.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.AbsoluteAmountUserInput.versionInfo")
  @js.native
