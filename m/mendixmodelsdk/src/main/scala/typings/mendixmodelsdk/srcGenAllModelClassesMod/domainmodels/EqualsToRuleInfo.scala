...
open class EqualsToRuleInfo protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.EqualsToRuleInfo {
  def this(
    model: AbstractModel,
...
object EqualsToRuleInfo {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.EqualsToRuleInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.EqualsToRuleInfo]
