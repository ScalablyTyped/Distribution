...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.TemplateFormBase")
@js.native
open class TemplateFormBase protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.TemplateFormBase {
  def this(
    model: AbstractModel,
