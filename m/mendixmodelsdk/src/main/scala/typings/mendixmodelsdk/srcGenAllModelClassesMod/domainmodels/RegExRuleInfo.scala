...
open class RegExRuleInfo protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RegExRuleInfo {
  def this(
    model: AbstractModel,
...
object RegExRuleInfo {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RegExRuleInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RegExRuleInfo]
