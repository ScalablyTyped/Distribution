...
object texts {
  ...
  open class SystemText protected ()
    extends typings.mendixmodelsdk.srcGenTextsMod.texts.SystemText {
    def this(
      model: AbstractModel,
  ...
  open class SystemTextCollection protected ()
    extends typings.mendixmodelsdk.srcGenTextsMod.texts.SystemTextCollection {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class Text protected ()
    extends typings.mendixmodelsdk.srcGenTextsMod.texts.Text {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class Translation protected ()
    extends typings.mendixmodelsdk.srcGenTextsMod.texts.Translation {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
