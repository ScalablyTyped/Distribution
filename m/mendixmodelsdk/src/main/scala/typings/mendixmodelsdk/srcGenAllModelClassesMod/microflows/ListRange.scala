...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.ListRange")
@js.native
open class ListRange protected ()
  extends typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.ListRange {
  def this(
    model: AbstractModel,
...
object ListRange {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.ListRange.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.ListRange.versionInfo")
  @js.native
