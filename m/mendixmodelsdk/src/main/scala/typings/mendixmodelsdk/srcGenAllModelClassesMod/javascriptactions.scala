...
object javascriptactions {
  ...
  open class JavaScriptAction protected ()
    extends typings.mendixmodelsdk.srcGenJavascriptactionsMod.javascriptactions.JavaScriptAction {
    def this(
      model: AbstractModel,
  ...
  open class JavaScriptActionParameter protected ()
    extends typings.mendixmodelsdk.srcGenJavascriptactionsMod.javascriptactions.JavaScriptActionParameter {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NanoflowJavaScriptActionParameterType protected ()
    extends typings.mendixmodelsdk.srcGenJavascriptactionsMod.javascriptactions.NanoflowJavaScriptActionParameterType {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
