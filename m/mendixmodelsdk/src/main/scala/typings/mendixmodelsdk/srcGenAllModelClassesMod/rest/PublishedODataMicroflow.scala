...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataMicroflow")
@js.native
open class PublishedODataMicroflow protected ()
  extends typings.mendixmodelsdk.srcGenRestMod.rest.PublishedODataMicroflow {
  def this(
    model: AbstractModel,
...
object PublishedODataMicroflow {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataMicroflow.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataMicroflow.versionInfo")
  @js.native
