...
object mlmappings {
  ...
  open class MLMappingDocument protected ()
    extends typings.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.MLMappingDocument {
    def this(
      model: AbstractModel,
  ...
  open class MLModelEntityMappings protected ()
    extends typings.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.MLModelEntityMappings {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class MLModelMappings protected ()
    extends typings.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.MLModelMappings {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  /**
    ...
    */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "mlmappings.MLModelMetadata")
  @js.native
  open class MLModelMetadata protected ()
    extends typings.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.MLModelMetadata {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  object MLModelMetadata {
    ...
    /* static member */
    @JSImport("mendixmodelsdk/src/gen/all-model-classes", "mlmappings.MLModelMetadata.structureTypeName")
    @js.native
    def structureTypeName: String = js.native
    inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
    
    /* static member */
    @JSImport("mendixmodelsdk/src/gen/all-model-classes", "mlmappings.MLModelMetadata.versionInfo")
    @js.native
    def versionInfo: typings.mendixmodelsdk.srcGenMlmappingsMod.StructureVersionInfo = js.native
    inline def versionInfo_=(x: typings.mendixmodelsdk.srcGenMlmappingsMod.StructureVersionInfo): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("versionInfo")(x.asInstanceOf[js.Any])
  }
  ...
  open class TensorDimension protected ()
    extends typings.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.TensorDimension {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class TensorMappingElement protected ()
    extends typings.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.TensorMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class TensorType protected ()
    extends typings.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.TensorType {
