...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataContract")
@js.native
open class PublishedODataContract protected ()
  extends typings.mendixmodelsdk.srcGenRestMod.rest.PublishedODataContract {
  def this(
    model: AbstractModel,
...
object PublishedODataContract {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataContract.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.PublishedODataContract.versionInfo")
  @js.native
