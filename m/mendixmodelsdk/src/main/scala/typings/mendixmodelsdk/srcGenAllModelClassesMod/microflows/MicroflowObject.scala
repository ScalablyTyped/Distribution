...
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.MicroflowObject")
@js.native
open class MicroflowObject protected ()
  extends typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.MicroflowObject {
  def this(
    model: AbstractModel,
