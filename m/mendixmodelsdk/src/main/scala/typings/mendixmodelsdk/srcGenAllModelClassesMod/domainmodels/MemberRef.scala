...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.MemberRef")
@js.native
open class MemberRef protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.MemberRef {
  def this(
    model: AbstractModel,
