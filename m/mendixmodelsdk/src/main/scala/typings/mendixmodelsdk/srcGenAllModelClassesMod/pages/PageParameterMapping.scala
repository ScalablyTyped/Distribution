...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.PageParameterMapping")
@js.native
open class PageParameterMapping protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.PageParameterMapping {
  def this(
    model: AbstractModel,
...
object PageParameterMapping {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.PageParameterMapping.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.PageParameterMapping.versionInfo")
  @js.native
