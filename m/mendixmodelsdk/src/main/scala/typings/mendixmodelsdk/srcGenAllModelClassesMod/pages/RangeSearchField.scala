...
open class RangeSearchField protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.RangeSearchField {
  def this(
    model: AbstractModel,
...
object RangeSearchField {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenPagesMod.pages.RangeSearchField = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenPagesMod.pages.RangeSearchField]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typings.mendixmodelsdk.srcGenPagesMod.pages.ControlBar): typings.mendixmodelsdk.srcGenPagesMod.pages.RangeSearchField = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenPagesMod.pages.RangeSearchField]
