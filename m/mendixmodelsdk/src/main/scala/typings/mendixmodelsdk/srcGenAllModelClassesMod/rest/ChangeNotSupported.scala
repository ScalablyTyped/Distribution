...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ChangeNotSupported")
@js.native
open class ChangeNotSupported protected ()
  extends typings.mendixmodelsdk.srcGenRestMod.rest.ChangeNotSupported {
  def this(
    model: AbstractModel,
...
object ChangeNotSupported {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ChangeNotSupported.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ChangeNotSupported.versionInfo")
  @js.native
