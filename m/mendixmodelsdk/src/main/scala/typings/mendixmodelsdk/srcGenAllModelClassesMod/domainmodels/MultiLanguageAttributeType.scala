...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.MultiLanguageAttributeType")
@js.native
open class MultiLanguageAttributeType protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.MultiLanguageAttributeType {
  def this(
    model: AbstractModel,
...
object MultiLanguageAttributeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.MultiLanguageAttributeType.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.MultiLanguageAttributeType.versionInfo")
  @js.native
