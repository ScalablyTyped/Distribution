...
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.RuleInfo")
@js.native
open class RuleInfo protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RuleInfo {
  def this(
    model: AbstractModel,
