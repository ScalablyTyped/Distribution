...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.RemoteAssociationSource")
@js.native
open class RemoteAssociationSource protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RemoteAssociationSource {
  def this(
    model: AbstractModel,
