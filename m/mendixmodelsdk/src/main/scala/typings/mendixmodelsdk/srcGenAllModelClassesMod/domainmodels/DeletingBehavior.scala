...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.DeletingBehavior")
@js.native
open class DeletingBehavior protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.DeletingBehavior {
...
object DeletingBehavior {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.DeletingBehavior.DeleteMeAndReferences")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.DeletingBehavior.DeleteMeButKeepReferences")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.DeletingBehavior.DeleteMeIfNoReferences")
  @js.native
