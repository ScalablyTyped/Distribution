...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.DecimalAttributeType")
@js.native
open class DecimalAttributeType protected ()
  extends typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.DecimalAttributeType {
  def this(
    model: AbstractModel,
...
object DecimalAttributeType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.DecimalAttributeType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.DecimalAttributeType]
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.DecimalAttributeType.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.DecimalAttributeType.versionInfo")
  @js.native
