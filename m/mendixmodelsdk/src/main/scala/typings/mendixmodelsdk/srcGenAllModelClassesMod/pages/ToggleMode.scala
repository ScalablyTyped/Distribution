...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ToggleMode")
@js.native
open class ToggleMode protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.ToggleMode {
...
object ToggleMode {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ToggleMode.None")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ToggleMode.PushContentAside")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ToggleMode.ShrinkContentInitiallyClosed")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ToggleMode.ShrinkContentInitiallyOpen")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ToggleMode.SlideOverContent")
  @js.native
