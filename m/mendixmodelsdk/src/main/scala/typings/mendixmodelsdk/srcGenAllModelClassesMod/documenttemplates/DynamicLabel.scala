...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.DynamicLabel")
@js.native
open class DynamicLabel protected ()
  extends typings.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.DynamicLabel {
  def this(
    model: AbstractModel,
...
object DynamicLabel {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.DynamicLabel.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.DynamicLabel.versionInfo")
  @js.native
