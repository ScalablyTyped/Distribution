...
open class ThemeModuleEntry protected ()
  extends typings.mendixmodelsdk.srcGenSettingsMod.settings.ThemeModuleEntry {
  def this(
    model: AbstractModel,
...
object ThemeModuleEntry {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenSettingsMod.settings.ThemeModuleEntry = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenSettingsMod.settings.ThemeModuleEntry]
