...
open class AppServiceCallParameterMapping protected ()
  extends typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.AppServiceCallParameterMapping {
  def this(
    model: AbstractModel,
...
object AppServiceCallParameterMapping {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.AppServiceCallParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.AppServiceCallParameterMapping]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.AppServiceCallAction): typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.AppServiceCallParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.AppServiceCallParameterMapping]
