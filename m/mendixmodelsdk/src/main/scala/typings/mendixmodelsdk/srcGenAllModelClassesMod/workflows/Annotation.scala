...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.Annotation")
@js.native
open class Annotation protected ()
  extends typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.Annotation {
  def this(
    model: AbstractModel,
...
object Annotation {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.Annotation.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.Annotation.versionInfo")
  @js.native
