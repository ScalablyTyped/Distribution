...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.UserRoleSet")
@js.native
open class UserRoleSet protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.UserRoleSet {
  def this(
    model: AbstractModel,
...
object UserRoleSet {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.UserRoleSet.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.UserRoleSet.versionInfo")
  @js.native
