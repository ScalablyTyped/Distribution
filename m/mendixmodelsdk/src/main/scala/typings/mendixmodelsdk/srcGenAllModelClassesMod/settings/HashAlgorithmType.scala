...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.HashAlgorithmType")
@js.native
open class HashAlgorithmType protected ()
  extends typings.mendixmodelsdk.srcGenSettingsMod.settings.HashAlgorithmType {
...
object HashAlgorithmType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.HashAlgorithmType.BCrypt")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.HashAlgorithmType.MD5")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.HashAlgorithmType.SHA256")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.HashAlgorithmType.SSHA256")
  @js.native
