...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.Tail")
@js.native
open class Tail protected ()
  extends typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.Tail {
  def this(
    model: AbstractModel,
...
object Tail {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.Tail.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.Tail.versionInfo")
  @js.native
