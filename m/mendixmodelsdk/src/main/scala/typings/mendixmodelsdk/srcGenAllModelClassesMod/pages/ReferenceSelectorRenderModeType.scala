...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ReferenceSelectorRenderModeType")
@js.native
open class ReferenceSelectorRenderModeType protected ()
  extends typings.mendixmodelsdk.srcGenPagesMod.pages.ReferenceSelectorRenderModeType {
...
object ReferenceSelectorRenderModeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ReferenceSelectorRenderModeType.DropDown")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "pages.ReferenceSelectorRenderModeType.Form")
  @js.native
