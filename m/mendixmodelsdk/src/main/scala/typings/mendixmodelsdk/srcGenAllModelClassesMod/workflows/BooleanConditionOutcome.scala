...
open class BooleanConditionOutcome protected ()
  extends typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.BooleanConditionOutcome {
  def this(
    model: AbstractModel,
...
object BooleanConditionOutcome {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.BooleanConditionOutcome = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.BooleanConditionOutcome]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.ConditionOutcomeActivity): typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.BooleanConditionOutcome = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.BooleanConditionOutcome]
