...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.CallMicroflowTask")
@js.native
open class CallMicroflowTask protected ()
  extends typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.CallMicroflowTask {
  def this(
    model: AbstractModel,
...
object CallMicroflowTask {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.CallMicroflowTask.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "workflows.CallMicroflowTask.versionInfo")
  @js.native
