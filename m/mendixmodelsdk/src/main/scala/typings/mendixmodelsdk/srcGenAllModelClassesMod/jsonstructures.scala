...
object jsonstructures {
  ...
  open class JsonElement protected ()
    extends typings.mendixmodelsdk.srcGenJsonstructuresMod.jsonstructures.JsonElement {
    def this(
      model: AbstractModel,
  ...
  object JsonElement {
    ...
    /**
      ...
      */
    /* static member */
    inline def createInElementUnderChildren(container: Element): typings.mendixmodelsdk.srcGenJsonstructuresMod.jsonstructures.JsonElement = ^.asInstanceOf[js.Dynamic].applyDynamic("createInElementUnderChildren")(container.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenJsonstructuresMod.jsonstructures.JsonElement]
  ...
  open class JsonStructure protected ()
    extends typings.mendixmodelsdk.srcGenJsonstructuresMod.jsonstructures.JsonStructure {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
