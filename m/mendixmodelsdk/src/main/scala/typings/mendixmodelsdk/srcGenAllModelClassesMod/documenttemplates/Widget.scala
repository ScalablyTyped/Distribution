...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.Widget")
@js.native
open class Widget protected ()
  extends typings.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.Widget {
  def this(
    model: AbstractModel,
