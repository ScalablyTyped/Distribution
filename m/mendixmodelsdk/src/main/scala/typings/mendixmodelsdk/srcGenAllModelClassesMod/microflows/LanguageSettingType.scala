...
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.LanguageSettingType")
@js.native
open class LanguageSettingType protected ()
  extends typings.mendixmodelsdk.srcGenMicroflowsMod.microflows.LanguageSettingType {
...
object LanguageSettingType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.LanguageSettingType.CurrentUser")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.LanguageSettingType.ProjectDefault")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "microflows.LanguageSettingType.Variable")
  @js.native
