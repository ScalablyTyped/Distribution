...
open class WorkflowCallParameterMapping protected ()
  extends typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.WorkflowCallParameterMapping {
  def this(
    model: AbstractModel,
...
object WorkflowCallParameterMapping {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.WorkflowCallParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typings.mendixmodelsdk.srcGenWorkflowsMod.workflows.WorkflowCallParameterMapping]
