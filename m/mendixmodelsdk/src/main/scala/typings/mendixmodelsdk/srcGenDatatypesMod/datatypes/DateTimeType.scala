...
- typings.mendixmodelsdk.srcGenDatatypesMod.datatypes.IDateTimeType because var conflicts: containerAsAppServiceAction, containerAsAppServiceActionParameter, containerAsConstant, containerAsDataSetParameter, containerAsDocumentTemplateParameter, containerAsImportMapping, containerAsMicroflowBase, containerAsMicroflowParameterBase, containerAsOperationParameter, containerAsPageParameter, containerAsSnippetParameter, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.DateTimeType")
@js.native
open class DateTimeType protected () extends DataType {
  ...
  def containerAsOperationParameter_MDateTimeType: OperationParameter = js.native
  ...
  def containerAsSnippetParameter_MDateTimeType: SnippetParameter = js.native
}
object DateTimeType {
  ...
  /**
    ...
    */
  /* static member */
  inline def createInOperationParameterUnderDataType(container: OperationParameter): DateTimeType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInOperationParameterUnderDataType")(container.asInstanceOf[js.Any]).asInstanceOf[DateTimeType]
  ...
  /**
    ...
    */
  /* static member */
  inline def createInQueryParameterUnderDataType(container: QueryParameter): DateTimeType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInQueryParameterUnderDataType")(container.asInstanceOf[js.Any]).asInstanceOf[DateTimeType]
  ...
  /**
    ...
    */
  /* static member */
  inline def createInSnippetParameterUnderParameterType(container: SnippetParameter): DateTimeType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInSnippetParameterUnderParameterType")(container.asInstanceOf[js.Any]).asInstanceOf[DateTimeType]
