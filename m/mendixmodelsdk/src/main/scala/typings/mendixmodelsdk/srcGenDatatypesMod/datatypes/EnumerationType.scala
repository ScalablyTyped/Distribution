...
- typings.mendixmodelsdk.srcGenDatatypesMod.datatypes.IEnumerationType because var conflicts: containerAsAppServiceAction, containerAsAppServiceActionParameter, containerAsConstant, containerAsDataSetParameter, containerAsDocumentTemplateParameter, containerAsImportMapping, containerAsMicroflowBase, containerAsMicroflowParameterBase, containerAsOperationParameter, containerAsPageParameter, containerAsSnippetParameter, id, isLoaded, model, structureTypeName, unit. Inlined enumeration, enumerationQualifiedName */ @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.EnumerationType")
@js.native
open class EnumerationType protected () extends DataType {
  ...
  def containerAsOperationParameter_MEnumerationType: OperationParameter = js.native
  ...
  def containerAsSnippetParameter_MEnumerationType: SnippetParameter = js.native
...
object EnumerationType {
  ...
  /**
    ...
    */
  /* static member */
  inline def createInOperationParameterUnderDataType(container: OperationParameter): EnumerationType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInOperationParameterUnderDataType")(container.asInstanceOf[js.Any]).asInstanceOf[EnumerationType]
  ...
  /**
    ...
    */
  /* static member */
  inline def createInQueryParameterUnderDataType(container: QueryParameter): EnumerationType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInQueryParameterUnderDataType")(container.asInstanceOf[js.Any]).asInstanceOf[EnumerationType]
  ...
  /**
    ...
    */
  /* static member */
  inline def createInSnippetParameterUnderParameterType(container: SnippetParameter): EnumerationType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInSnippetParameterUnderParameterType")(container.asInstanceOf[js.Any]).asInstanceOf[EnumerationType]
