...
object businesseventsMod {
  ...
  object businessevents {
    ...
    - typings.mendixmodelsdk.businesseventsMod.businessevents.IConsumedBusinessEventService because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/businessevents", "businessevents.ConsumedBusinessEventService")
    @js.native
    ...
    - typings.mendixmodelsdk.projectsMod.projects.IModuleDocument because Already inherited
    - typings.mendixmodelsdk.projectsMod.projects.IDocument because Already inherited
    - typings.mendixmodelsdk.businesseventsMod.businessevents.IPublishedBusinessEventService because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/businessevents", "businessevents.PublishedBusinessEventService")
    @js.native
