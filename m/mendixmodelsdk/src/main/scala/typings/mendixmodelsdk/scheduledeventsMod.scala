...
object scheduledeventsMod {
  ...
  object scheduledevents {
    ...
    @js.native
    abstract class MonthSchedule protected () extends Schedule {
      def this(
        model: AbstractModel,
        structureTypeName: String,
        id: String,
    ...
    @js.native
    abstract class Schedule protected () extends Element[IModel] {
      def this(
        model: AbstractModel,
        structureTypeName: String,
        id: String,
    ...
    - typings.mendixmodelsdk.scheduledeventsMod.scheduledevents.IScheduledEvent because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/scheduledevents", "scheduledevents.ScheduledEvent")
    @js.native
    ...
    @js.native
    abstract class YearSchedule protected () extends Schedule {
      def this(
        model: AbstractModel,
        structureTypeName: String,
        id: String,
