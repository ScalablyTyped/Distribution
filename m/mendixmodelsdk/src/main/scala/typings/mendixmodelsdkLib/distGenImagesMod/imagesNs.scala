...
object imagesNs extends js.Object {
  ...
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenImagesMod.imagesNs.IImage because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       * See: {@link https://docs.mendix.com/refguide7/images relevant section in reference guide}
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenImagesMod.imagesNs.IImageCollection because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
