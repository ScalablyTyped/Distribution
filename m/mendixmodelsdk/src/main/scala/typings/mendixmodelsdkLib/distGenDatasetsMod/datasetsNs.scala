...
object datasetsNs extends js.Object {
  ...
  - mendixmodelsdkLib.distGenDatasetsMod.datasetsNs.IDataSet because var conflicts: id, isLoaded, model, name, structureTypeName, unit. Inlined parameters */ @js.native
