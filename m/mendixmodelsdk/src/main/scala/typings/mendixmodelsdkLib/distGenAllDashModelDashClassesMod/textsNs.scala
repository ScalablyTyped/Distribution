...
object textsNs extends js.Object {
  ...
  class SystemText protected ()
    extends mendixmodelsdkLib.distGenTextsMod.textsNs.SystemText {
  ...
  class SystemTextCollection protected ()
    extends mendixmodelsdkLib.distGenTextsMod.textsNs.SystemTextCollection {
  ...
  class Text protected ()
    extends mendixmodelsdkLib.distGenTextsMod.textsNs.Text {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
  
  @js.native
  class Translation protected ()
    extends mendixmodelsdkLib.distGenTextsMod.textsNs.Translation {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
