...
object mappingsNs extends js.Object {
  ...
  @js.native
  class ElementType ()
    extends mendixmodelsdkLib.distGenMappingsMod.mappingsNs.ElementType
  ...
  abstract class MappingElement protected ()
    extends mendixmodelsdkLib.distGenMappingsMod.mappingsNs.MappingElement {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
  
  @js.native
  class MappingMicroflowCall protected ()
    extends mendixmodelsdkLib.distGenMappingsMod.mappingsNs.MappingMicroflowCall {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
  
  @js.native
  class MappingMicroflowParameter protected ()
    extends mendixmodelsdkLib.distGenMappingsMod.mappingsNs.MappingMicroflowParameter {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
  
  @js.native
  class ObjectHandlingBackupEnum ()
    extends mendixmodelsdkLib.distGenMappingsMod.mappingsNs.ObjectHandlingBackupEnum
  
  @js.native
  class ObjectHandlingEnum ()
    extends mendixmodelsdkLib.distGenMappingsMod.mappingsNs.ObjectHandlingEnum
