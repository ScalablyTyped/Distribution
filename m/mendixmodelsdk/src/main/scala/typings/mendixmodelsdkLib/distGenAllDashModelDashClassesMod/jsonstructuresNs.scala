...
object jsonstructuresNs extends js.Object {
  ...
  class JsonElement protected ()
    extends mendixmodelsdkLib.distGenJsonstructuresMod.jsonstructuresNs.JsonElement {
  ...
  class JsonStructure protected ()
    extends mendixmodelsdkLib.distGenJsonstructuresMod.jsonstructuresNs.JsonStructure {
