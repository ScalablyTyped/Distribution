...
object enumerationsNs extends js.Object {
  ...
  class Condition protected ()
    extends mendixmodelsdkLib.distGenEnumerationsMod.enumerationsNs.Condition {
  ...
  class Enumeration protected ()
    extends mendixmodelsdkLib.distGenEnumerationsMod.enumerationsNs.Enumeration {
  ...
  class EnumerationValue protected ()
    extends mendixmodelsdkLib.distGenEnumerationsMod.enumerationsNs.EnumerationValue {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
