...
object regularexpressionsNs extends js.Object {
  ...
  - mendixmodelsdkLib.distGenRegularexpressionsMod.regularexpressionsNs.IRegularExpression because var conflicts: id, isLoaded, model, name, structureTypeName, unit. Inlined  */ @js.native
