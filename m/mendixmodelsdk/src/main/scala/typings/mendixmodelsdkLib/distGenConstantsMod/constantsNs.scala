...
object constantsNs extends js.Object {
  /**
       ...
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenConstantsMod.constantsNs.IConstant because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
