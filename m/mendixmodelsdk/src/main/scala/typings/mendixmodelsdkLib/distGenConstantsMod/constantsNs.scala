...
object constantsNs extends js.Object {
  /**
    ...
    */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenConstantsMod.constantsNs.IConstant because Would inherit conflicting mutable fields List(id, isLoaded, model, structureTypeName, unit))*/
  @js.native
