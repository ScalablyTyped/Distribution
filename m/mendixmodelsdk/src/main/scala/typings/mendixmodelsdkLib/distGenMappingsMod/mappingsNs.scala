...
object mappingsNs extends js.Object {
  ...
  - mendixmodelsdkLib.distGenMappingsMod.mappingsNs.IMappingDocument because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined asLoaded, load, load, load, load */ @js.native
