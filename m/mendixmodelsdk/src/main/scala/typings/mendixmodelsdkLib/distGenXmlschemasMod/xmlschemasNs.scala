...
object xmlschemasNs extends js.Object {
  ...
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenXmlschemasMod.xmlschemasNs.IMxSchema because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       * See: {@link https://docs.mendix.com/refguide7/xml-schemas relevant section in reference guide}
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenXmlschemasMod.xmlschemasNs.IXmlSchema because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
