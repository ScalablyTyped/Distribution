...
object exportmappingsNs extends js.Object {
  ...
  - mendixmodelsdkLib.distGenExportmappingsMod.exportmappingsNs.IExportMapping because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined  */ @js.native
