...
object exportmappingsNs extends js.Object {
  /**
       ...
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenExportmappingsMod.exportmappingsNs.IExportMapping because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
