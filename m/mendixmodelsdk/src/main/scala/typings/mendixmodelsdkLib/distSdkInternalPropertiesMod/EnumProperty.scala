...
@js.native
class EnumProperty[T /* <: mendixmodelsdkLib.distSdkInternalInstancesMod.AbstractEnum */] protected ()
  extends mendixmodelsdkLib.distSdkInternalPropertiesPrimitivesMod.EnumProperty[T] {
