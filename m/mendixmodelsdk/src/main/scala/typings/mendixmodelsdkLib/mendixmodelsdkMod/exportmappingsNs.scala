...
object exportmappingsNs extends js.Object {
  ...
  class ExportMapping protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.exportmappingsNs.ExportMapping {
  ...
  class ExportObjectMappingElement protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.exportmappingsNs.ExportObjectMappingElement {
  ...
  class ExportValueMappingElement protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.exportmappingsNs.ExportValueMappingElement {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
