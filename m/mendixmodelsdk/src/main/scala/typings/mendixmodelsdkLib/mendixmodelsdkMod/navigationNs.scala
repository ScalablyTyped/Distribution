...
@JSImport("mendixmodelsdk", "navigation")
@js.native
object navigationNs extends js.Object {
  @js.native
  class DeviceType ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.navigationNs.DeviceType
  
  @js.native
  class HomePage protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.navigationNs.HomePage {
  ...
  abstract class HomePageBase protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.navigationNs.HomePageBase {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
  ...
  class NavigationDocument protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.navigationNs.NavigationDocument {
  ...
  @js.native
  class ProfileKind ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.navigationNs.ProfileKind
  
  @js.native
  class ProfileType ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.navigationNs.ProfileType
  
  @js.native
  class RoleBasedHomePage protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.navigationNs.RoleBasedHomePage {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
