...
object jsonstructuresNs extends js.Object {
  ...
  class JsonElement protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.jsonstructuresNs.JsonElement {
  ...
  class JsonStructure protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.jsonstructuresNs.JsonStructure {
