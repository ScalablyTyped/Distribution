...
object javascriptactionsNs extends js.Object {
  ...
  class JavaScriptAction protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.javascriptactionsNs.JavaScriptAction {
  ...
  class JavaScriptActionParameter protected ()
    extends mendixmodelsdkLib.distGenAllDashModelDashClassesMod.javascriptactionsNs.JavaScriptActionParameter {
