...
@js.native
class LocalByNameReferenceProperty[T /* <: mendixmodelsdkLib.distSdkInternalPropertiesLocalDashByDashNameDashReferenceMod.INamedElement */] protected ()
  extends mendixmodelsdkLib.distSdkInternalPropertiesMod.LocalByNameReferenceProperty[T] {
