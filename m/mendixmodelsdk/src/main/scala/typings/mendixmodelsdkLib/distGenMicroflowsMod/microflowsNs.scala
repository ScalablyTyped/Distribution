...
object microflowsNs extends js.Object {
  ...
  /**
       * See: {@link https://docs.mendix.com/refguide7/microflows relevant section in reference guide}
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.IMicroflow because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.IMicroflowBase because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       * See: {@link https://docs.mendix.com/refguide7/parameter relevant section in reference guide}
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.IMicroflowParameter because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  class MicroflowParameter protected () extends MicroflowParameterBase {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
  }
  
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.IMicroflowParameterBase because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       ...
       * In version 7.10.0: introduced
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.INanoflow because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       * In version 7.19.0: introduced
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.INanoflowParameter because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       * See: {@link https://docs.mendix.com/refguide7/rules relevant section in reference guide}
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.IRule because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       * See: {@link https://docs.mendix.com/refguide7/parameter relevant section in reference guide}
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.IRuleParameter because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMicroflowsMod.microflowsNs.IServerSideMicroflow because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
