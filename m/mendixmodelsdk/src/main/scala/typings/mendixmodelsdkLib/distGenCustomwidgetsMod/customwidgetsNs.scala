package typings
package mendixmodelsdkLib.distGenCustomwidgetsMod
...
object customwidgetsNs extends js.Object {
  ...
  class CustomWidget protected ()
    ...
    var `object`: WidgetObject | scala.Null = js.native
    var `type`: CustomWidgetType | scala.Null = js.native
  }
  ...
  class CustomWidgetType protected ()
    ...
    var needsEntityContext: scala.Boolean = js.native
  ...
  class WidgetEnumerationValue protected ()
    ...
    @JSName("model")
    var model_WidgetEnumerationValue: mendixmodelsdkLib.distGenBaseDashModelMod.IModel = js.native
  }
  ...
  class WidgetObjectType protected ()
    ...
    val containerAsWidgetValueType: WidgetValueType = js.native
    @JSName("model")
    var model_WidgetObjectType: mendixmodelsdkLib.distGenBaseDashModelMod.IModel = js.native
    val propertyTypes: mendixmodelsdkLib.distSdkInternalInstancesMod.IList[WidgetPropertyType] = js.native
  }
  ...
  class WidgetReturnType protected ()
    ...
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
    val containerAsWidgetValueType: WidgetValueType = js.native
    var entityProperty: java.lang.String = js.native
    var isList: scala.Boolean = js.native
    @JSName("model")
    var model_WidgetReturnType: mendixmodelsdkLib.distGenBaseDashModelMod.IModel = js.native
  ...
  class WidgetTranslation protected ()
    ...
    @JSName("model")
    var model_WidgetTranslation: mendixmodelsdkLib.distGenBaseDashModelMod.IModel = js.native
  ...
  class WidgetValueType protected ()
    extends mendixmodelsdkLib.distSdkInternalMod.Element {
    def this(model: mendixmodelsdkLib.distSdkInternalMod.AbstractModel, structureTypeName: java.lang.String, id: java.lang.String, isPartial: scala.Boolean, unit: mendixmodelsdkLib.distSdkInternalMod.ModelUnit, container: mendixmodelsdkLib.distSdkInternalMod.AbstractElement) = this()
    var allowNonPersistableEntities: scala.Boolean = js.native
    val attributeTypes: mendixmodelsdkLib.distSdkInternalInstancesMod.IList[CustomWidgetAttributeType] = js.native
    val containerAsWidgetPropertyType: WidgetPropertyType = js.native
    var defaultValue: java.lang.String = js.native
    var entityProperty: java.lang.String = js.native
    val enumerationValues: mendixmodelsdkLib.distSdkInternalInstancesMod.IList[WidgetEnumerationValue] = js.native
    var isList: scala.Boolean = js.native
    var isPath: IsPath = js.native
    @JSName("model")
    var model_WidgetValueType: mendixmodelsdkLib.distGenBaseDashModelMod.IModel = js.native
    var multiline: scala.Boolean = js.native
    var objectType: WidgetObjectType | scala.Null = js.native
    var parameterIsList: scala.Boolean = js.native
    var pathType: PathType = js.native
    var required: scala.Boolean = js.native
    var returnType: WidgetReturnType | scala.Null = js.native
    val translations: mendixmodelsdkLib.distSdkInternalInstancesMod.IList[WidgetTranslation] = js.native
