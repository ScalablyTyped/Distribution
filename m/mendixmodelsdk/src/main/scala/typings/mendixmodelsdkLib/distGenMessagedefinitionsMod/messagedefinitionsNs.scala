...
object messagedefinitionsNs extends js.Object {
  ...
  /**
       * In version 7.6.0: introduced
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMessagedefinitionsMod.messagedefinitionsNs.IEntityMessageDefinition because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       * In version 7.6.0: introduced
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMessagedefinitionsMod.messagedefinitionsNs.IMessageDefinition because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
  ...
  /**
       ...
       * In version 7.6.0: introduced
       */
  /* RemoveMultipleInheritance: Dropped parents List(mendixmodelsdkLib.distGenMessagedefinitionsMod.messagedefinitionsNs.IMessageDefinitionCollection because Would inherit conflicting mutable fields List(model, structureTypeName, id, unit, isLoaded))*/
  @js.native
