...
import typings.maximMazurokGapiClientAdsensehost.gapi.client.adsensehost.CustomChannel
...
object UserIp {
  ...
  implicit class UserIpOps[Self <: UserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CustomChannel): Self = this.set("resource", value.asInstanceOf[js.Any])
