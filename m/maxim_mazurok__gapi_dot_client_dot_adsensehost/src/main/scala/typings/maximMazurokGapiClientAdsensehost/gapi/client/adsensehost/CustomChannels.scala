...
object CustomChannels {
  ...
  @scala.inline
  implicit class CustomChannelsOps[Self <: CustomChannels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: CustomChannel*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[CustomChannel]): Self = this.set("items", value.asInstanceOf[js.Any])
