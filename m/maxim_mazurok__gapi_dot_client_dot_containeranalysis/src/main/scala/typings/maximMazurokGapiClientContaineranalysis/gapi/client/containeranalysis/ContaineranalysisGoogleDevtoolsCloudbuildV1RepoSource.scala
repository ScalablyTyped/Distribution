...
trait ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientContaineranalysis.maximMazurokGapiClientContaineranalysisStrings.ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource & TopLevel[Any]
  ] = js.undefined
  
  /** Regex matching tags to build. The syntax of the regular expressions accepted is the syntax accepted by RE2 and described at https://github.com/google/re2/wiki/Syntax */
  var tagName: js.UndefOr[String] = js.undefined
}
object ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource {
  
  inline def apply(): ContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource = {
