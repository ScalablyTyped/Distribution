...
trait ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions extends StObject {
  ...
  /**
    ...
    * more information.
    */
  var pool: js.UndefOr[ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptionsPoolOption] = js.undefined
...
object ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions {
  ...
  inline def apply(): ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions = {
  ...
  extension [Self <: ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions](x: Self) {
    ...
    inline def setPool(value: ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptionsPoolOption): Self = StObject.set(x, "pool", value.asInstanceOf[js.Any])
