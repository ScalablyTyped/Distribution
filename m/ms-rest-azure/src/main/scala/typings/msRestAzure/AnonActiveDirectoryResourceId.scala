...
trait AnonActiveDirectoryResourceId extends js.Object {
...
object AnonActiveDirectoryResourceId {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonActiveDirectoryResourceId]
  }
}
