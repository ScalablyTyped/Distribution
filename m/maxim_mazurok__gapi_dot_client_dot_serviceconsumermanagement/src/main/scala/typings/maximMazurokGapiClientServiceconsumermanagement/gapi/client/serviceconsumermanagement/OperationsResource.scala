...
import typings.maximMazurokGapiClientServiceconsumermanagement.anon.Accesstoken
import typings.maximMazurokGapiClientServiceconsumermanagement.anon.Alt
import typings.maximMazurokGapiClientServiceconsumermanagement.anon.Callback
