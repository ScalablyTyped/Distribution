...
@js.native
trait RemoveTenantProjectRequest extends js.Object {
...
object RemoveTenantProjectRequest {
  ...
  @scala.inline
  implicit class RemoveTenantProjectRequestOps[Self <: RemoveTenantProjectRequest] (val x: Self) extends AnyVal {
