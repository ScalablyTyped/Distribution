...
@js.native
trait DeleteTenantProjectRequest extends js.Object {
...
object DeleteTenantProjectRequest {
  ...
  @scala.inline
  implicit class DeleteTenantProjectRequestOps[Self <: DeleteTenantProjectRequest] (val x: Self) extends AnyVal {
