...
import typings.maximMazurokGapiClientServiceconsumermanagement.gapi.client.serviceconsumermanagement.CreateTenancyUnitRequest
...
trait Parent extends js.Object {
  ...
  /** Request body */
  var resource: CreateTenancyUnitRequest = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: CreateTenancyUnitRequest): Parent = {
  ...
  implicit class ParentOps[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreateTenancyUnitRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
