...
object set extends js.Object {
  ...
  def apply[V](obj: typings.mobx.observablemapMod.ObservableMap[PropertyKey, V], values: StringDictionary[V]): js.Any = js.native
  def apply[T](obj: typings.mobx.observablesetMod.ObservableSet[T], value: T): js.Any = js.native
  def apply[K, V](obj: typings.mobx.observablemapMod.ObservableMap[K, V], key: K, value: V): js.Any = js.native
}
