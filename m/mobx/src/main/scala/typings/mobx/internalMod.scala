...
object internalMod {
  ...
  inline def asObservableObject(target: js.Any): typings.mobx.observableobjectMod.ObservableObjectAdministration = ^.asInstanceOf[js.Dynamic].applyDynamic("asObservableObject")(target.asInstanceOf[js.Any]).asInstanceOf[typings.mobx.observableobjectMod.ObservableObjectAdministration]
  ...
  inline def createDynamicObservableObject(base: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("createDynamicObservableObject")(base.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  inline def getObservers(observable: IObservable): typings.std.Set[IDerivation] = ^.asInstanceOf[js.Dynamic].applyDynamic("getObservers")(observable.asInstanceOf[js.Any]).asInstanceOf[typings.std.Set[IDerivation]]
  ...
  inline def globalState_=(x: typings.mobx.globalstateMod.MobXGlobals): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("globalState")(x.asInstanceOf[js.Any])
  ...
  inline def intercept[V](observableMap: ObservableSet[V], handler: IInterceptor[ISetWillChange[V]]): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("intercept")(observableMap.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Lambda]
  ...
  inline def interceptReads(`object`: js.Object, property: String, handler: ReadInterceptor[js.Any]): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("interceptReads")(`object`.asInstanceOf[js.Any], property.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Lambda]
  ...
  object observable {
    ...
    inline def apply[T](value: typings.std.Set[T]): ObservableSet[T] = ^.asInstanceOf[js.Dynamic].apply(value.asInstanceOf[js.Any]).asInstanceOf[ObservableSet[T]]
    inline def apply[T](value: typings.std.Set[T], options: CreateObservableOptions): ObservableSet[T] = (^.asInstanceOf[js.Dynamic].apply(value.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ObservableSet[T]]
  ...
  inline def onBecomeObserved(value: ObservableMap[js.Any, js.Any], listener: Lambda): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("onBecomeObserved")(value.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Lambda]
  inline def onBecomeObserved(value: ObservableSet[js.Any], listener: Lambda): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("onBecomeObserved")(value.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Lambda]
  ...
  inline def onBecomeUnobserved(value: ObservableMap[js.Any, js.Any], listener: Lambda): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("onBecomeUnobserved")(value.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Lambda]
  inline def onBecomeUnobserved(value: ObservableSet[js.Any], listener: Lambda): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("onBecomeUnobserved")(value.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Lambda]
