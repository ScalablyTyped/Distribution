...
import typings.mobx.spyMod.PureSpyEvent
...
object internalMod {
  ...
  object IDerivationState extends StObject {
    ...
    /* -1 */ val NOT_TRACKING_ : typings.mobx.derivationMod.IDerivationState.NOT_TRACKING_ & Double = js.native
    
    /* 1 */ val POSSIBLY_STALE_ : typings.mobx.derivationMod.IDerivationState.POSSIBLY_STALE_ & Double = js.native
    
    /* 2 */ val STALE_ : typings.mobx.derivationMod.IDerivationState.STALE_ & Double = js.native
    
    /* 0 */ val UP_TO_DATE_ : typings.mobx.derivationMod.IDerivationState.UP_TO_DATE_ & Double = js.native
  }
  ...
  open class ObservableArrayAdministration protected ()
    extends typings.mobx.observablearrayMod.ObservableArrayAdministration {
  ...
  inline def recordAnnotationApplied(
    adm: typings.mobx.observableobjectMod.ObservableObjectAdministration,
    annotation: Annotation,
    key: PropertyKey
