...
import typings.mobx.internalMod.ObservableObjectAdministration
...
object annotationMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.mobx.annotationMod.Annotation
    - typings.mobx.mobxBooleans.`true`
    - typings.mobx.mobxBooleans.`false`
  */
  trait AnnotationMapEntry extends StObject
  
  type AnnotationsMap[T, AdditionalFields /* <: PropertyKey */] = typings.mobx.mobxStrings.AnnotationsMap & TopLevel[Any] & (Record[AdditionalFields, AnnotationMapEntry])
