...
trait AnonConfigurableEnumerable extends js.Object {
...
object AnonConfigurableEnumerable {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonConfigurableEnumerable]
  }
}
