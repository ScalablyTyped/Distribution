...
object mod {
  ...
  @scala.inline
  def jDaysInMonth(year: Double, month: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("jDaysInMonth")(year.asInstanceOf[js.Any], month.asInstanceOf[js.Any])).asInstanceOf[Double]
  
  @scala.inline
  def jIsLeapYear(year: Double): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("jIsLeapYear")(year.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  @scala.inline
  def loadPersian(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("loadPersian")().asInstanceOf[Unit]
  @scala.inline
  def loadPersian(options: LoadPersianOptions): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("loadPersian")(options.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object momentAugmentingMod {
    ...
    /**
      ...
      */
    @scala.inline
    def loadPersian(options: js.UndefOr[LoadPersianOptions]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("loadPersian")(options.asInstanceOf[js.Any]).asInstanceOf[Unit]
