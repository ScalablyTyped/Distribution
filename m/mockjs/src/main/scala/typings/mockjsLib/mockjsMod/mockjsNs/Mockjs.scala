...
trait Mockjs extends js.Object {
  ...
  def mock(rurl: stdLib.RegExp, rtype: S, template: js.Any): Mockjs = js.native
  def mock(rurl: stdLib.RegExp, template: js.Any): Mockjs = js.native
  def mock(template: js.Any): js.Any = js.native
  def setup(settings: MockjsSetupSettings): scala.Unit = js.native
