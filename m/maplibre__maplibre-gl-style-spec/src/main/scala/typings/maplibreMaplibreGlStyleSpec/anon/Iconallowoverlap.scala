...
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`bottom-left`
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`bottom-right`
...
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`line-center`
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`line-progress`
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`top-left`
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`top-right`
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`viewport-glyph`
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`viewport-y`
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.accumulated
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.always
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.auto
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.both
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.bottom
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.center
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.cooperative
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.height
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.horizontal
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.id
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.left
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.line
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.ln2
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.lowercase
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.map
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.never
...
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.point_
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.properties
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.right
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.source
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.top
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.uppercase
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.vertical
...
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.width
...
import typings.maplibreMaplibreGlStyleSpec.mod.FormattedSpecification
import typings.maplibreMaplibreGlStyleSpec.mod.PaddingSpecification
...
trait Iconallowoverlap extends StObject {
  ...
  var `symbol-z-order`: js.UndefOr[PropertyValueSpecification[auto | `viewport-y` | source]] = js.undefined
...
object Iconallowoverlap {
  ...
  implicit open class MutableBuilder[Self <: Iconallowoverlap] (val x: Self) extends AnyVal {
    ...
    inline def `setSymbol-z-order`(value: PropertyValueSpecification[auto | `viewport-y` | source]): Self = StObject.set(x, "symbol-z-order", value.asInstanceOf[js.Any])
