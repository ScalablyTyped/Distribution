...
import typings.maplibreMaplibreGlStyleSpec.anon.Id
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecInts.`8`
...
trait StyleSpecification extends StObject {
  ...
  var sprite: js.UndefOr[SpriteSpecification] = js.undefined
...
object StyleSpecification {
  ...
  implicit open class MutableBuilder[Self <: StyleSpecification] (val x: Self) extends AnyVal {
    ...
    inline def setSprite(value: SpriteSpecification): Self = StObject.set(x, "sprite", value.asInstanceOf[js.Any])
    
    inline def setSpriteUndefined: Self = StObject.set(x, "sprite", js.undefined)
    
    inline def setSpriteVarargs(value: Id*): Self = StObject.set(x, "sprite", js.Array(value*))
