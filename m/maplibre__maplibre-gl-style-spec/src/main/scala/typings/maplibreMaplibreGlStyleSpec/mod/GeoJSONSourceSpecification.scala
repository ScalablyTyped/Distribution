...
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.geojson
...
object GeoJSONSourceSpecification {
  ...
  inline def apply(data: Any): GeoJSONSourceSpecification = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GeoJSONSourceSpecification] (val x: Self) extends AnyVal {
