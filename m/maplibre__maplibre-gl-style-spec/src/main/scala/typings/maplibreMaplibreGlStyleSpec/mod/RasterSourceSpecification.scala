...
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.raster
...
object RasterSourceSpecification {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RasterSourceSpecification] (val x: Self) extends AnyVal {
