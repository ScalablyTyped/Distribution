...
import typings.maplibreMaplibreGlStyleSpec.anon.FnCallValueSpecification
import typings.maplibreMaplibreGlStyleSpec.anon.TypeofStylePropertyFuncti
...
object expression {
  ...
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.StyleExpression")
  @js.native
  def StyleExpression: Instantiable2[
    /* expression */ Expression_, 
    /* propertySpec */ js.UndefOr[StylePropertySpecification | Null], 
    typings.maplibreMaplibreGlStyleSpec.mod.StyleExpression
  ] = js.native
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.StyleExpression")
  @js.native
  open class StyleExpressionCls protected () extends StyleExpression {
  ...
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.StylePropertyFunction")
  @js.native
  def StylePropertyFunction: TypeofStylePropertyFuncti = js.native
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.StylePropertyFunction")
  @js.native
  open class StylePropertyFunctionCls[T] protected () extends StylePropertyFunction[T] {
    def this(
  ...
  inline def StylePropertyFunction_=(x: TypeofStylePropertyFuncti): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("StylePropertyFunction")(x.asInstanceOf[js.Any])
  
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.ZoomConstantExpression")
  @js.native
  def ZoomConstantExpression: Instantiable2[
    /* import warning: RewrittenClass.unapply cls was tparam Kind */ /* kind */ Any, 
    /* expression */ StyleExpression, 
    typings.maplibreMaplibreGlStyleSpec.mod.ZoomConstantExpression[EvaluationKind]
  ] = js.native
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.ZoomConstantExpression")
  @js.native
  open class ZoomConstantExpressionCls[Kind /* <: EvaluationKind */] protected () extends ZoomConstantExpression[Kind] {
    def this(
  ...
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.ZoomDependentExpression")
  @js.native
  def ZoomDependentExpression: Instantiable4[
    ...
    typings.maplibreMaplibreGlStyleSpec.mod.ZoomDependentExpression[EvaluationKind]
  ] = js.native
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.ZoomDependentExpression")
  @js.native
  open class ZoomDependentExpressionCls[Kind /* <: EvaluationKind */] protected () extends ZoomDependentExpression[Kind] {
    def this(
      kind: /* import warning: RewrittenClass.unapply cls was tparam Kind */ Any,
      expression: StyleExpression,
      zoomStops: js.Array[Double]
  ...
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.createExpression")
  @js.native
  ...
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.createPropertyExpression")
  @js.native
  ...
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.isExpression")
  @js.native
  ...
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.isExpressionFilter")
  @js.native
  def isExpressionFilter: js.Function1[
    /* filter */ Any, 
    /* is @maplibre/maplibre-gl-style-spec.@maplibre/maplibre-gl-style-spec.ExpressionFilterSpecification */ Boolean
  ] = js.native
  inline def isExpressionFilter(filter: Any): /* is @maplibre/maplibre-gl-style-spec.@maplibre/maplibre-gl-style-spec.ExpressionFilterSpecification */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isExpressionFilter")(filter.asInstanceOf[js.Any]).asInstanceOf[/* is @maplibre/maplibre-gl-style-spec.@maplibre/maplibre-gl-style-spec.ExpressionFilterSpecification */ Boolean]
  ...
  @JSImport("@maplibre/maplibre-gl-style-spec", "expression.normalizePropertyExpression")
  @js.native
  def normalizePropertyExpression: FnCallValueSpecification = js.native
  ...
  inline def normalizePropertyExpression_=(x: FnCallValueSpecification): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("normalizePropertyExpression")(x.asInstanceOf[js.Any])
}
