...
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`raster-dem`
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.mapbox
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.terrarium
...
object RasterDEMSourceSpecification {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RasterDEMSourceSpecification] (val x: Self) extends AnyVal {
