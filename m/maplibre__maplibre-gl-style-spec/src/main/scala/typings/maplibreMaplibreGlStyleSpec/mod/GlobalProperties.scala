...
/* Inlined std.Readonly<{  zoom :number,   heatmapDensity :number | undefined,   lineProgress :number | undefined,   isSupportedScript :(_ : string): boolean | undefined,   accumulated :@maplibre/maplibre-gl-style-spec.@maplibre/maplibre-gl-style-spec.Value | undefined}> */
