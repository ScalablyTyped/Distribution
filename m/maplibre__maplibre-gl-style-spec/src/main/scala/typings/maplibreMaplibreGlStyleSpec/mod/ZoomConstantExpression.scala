...
@JSImport("@maplibre/maplibre-gl-style-spec", "ZoomConstantExpression")
@js.native
open class ZoomConstantExpression[Kind /* <: EvaluationKind */] protected () extends StObject {
  def this(kind: Kind, expression: StyleExpression) = this()
