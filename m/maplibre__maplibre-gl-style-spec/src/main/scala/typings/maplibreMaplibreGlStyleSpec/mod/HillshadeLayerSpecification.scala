...
import typings.maplibreMaplibreGlStyleSpec.anon.Hillshadeaccentcolor
import typings.maplibreMaplibreGlStyleSpec.anon.Visibility
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.hillshade
...
trait HillshadeLayerSpecification
  ...
  var paint: js.UndefOr[Hillshadeaccentcolor] = js.undefined
...
object HillshadeLayerSpecification {
  ...
  implicit open class MutableBuilder[Self <: HillshadeLayerSpecification] (val x: Self) extends AnyVal {
    ...
    inline def setPaint(value: Hillshadeaccentcolor): Self = StObject.set(x, "paint", value.asInstanceOf[js.Any])
