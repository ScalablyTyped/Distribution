...
import typings.maplibreMaplibreGlStyleSpec.anon.Fillextrusionbase
import typings.maplibreMaplibreGlStyleSpec.anon.Visibility
import typings.maplibreMaplibreGlStyleSpec.maplibreMaplibreGlStyleSpecStrings.`fill-extrusion`
