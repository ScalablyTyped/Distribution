...
trait Static extends Hyperscript {
  @JSName("jsonp")
  var jsonp_Original: js.Function2[
    /* url */ java.lang.String, 
    /* options */ js.UndefOr[JsonpOptions], 
    stdLib.Promise[_]
  ] = js.native
  @JSName("mount")
  ...
  def buildQueryString(values: ScalablyTyped.runtime.StringDictionary[js.Any]): java.lang.String = js.native
  def jsonp[T](url: java.lang.String): stdLib.Promise[T] = js.native
  def jsonp[T](url: java.lang.String, options: JsonpOptions): stdLib.Promise[T] = js.native
  ...
  def parseQueryString(queryString: java.lang.String): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  def redraw(): scala.Unit = js.native
  def render(el: stdLib.Element, vnodes: Children): scala.Unit = js.native
  def request[T](url: java.lang.String): stdLib.Promise[T] = js.native
  def request[T](url: java.lang.String, options: RequestOptions[T]): stdLib.Promise[T] = js.native
