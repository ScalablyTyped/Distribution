...
trait Hyperscript extends StObject {
  ...
  def apply(selector: String, attributes: Attributes, children: Children*): Vnode[js.Any, js.Any] = js.native
  /** Creates a virtual element (Vnode). */
  def apply(selector: String, children: Children*): Vnode[js.Any, js.Any] = js.native
  /** Creates a virtual element (Vnode). */
  ...
  def apply[Attrs, State](
    ...
    attributes: Attrs & (Lifecycle[Attrs, State]) & Key,
    args: Children*
  ): Vnode[Attrs, State] = js.native
  
  /** Creates a fragment virtual element (Vnode). */
  def fragment(attrs: Lifecycleanyanykeystringa, children: ChildArrayOrPrimitive): Vnode[js.Any, js.Any] = js.native
  
  /** Turns an HTML string into a virtual element (Vnode). Do not use trust on unsanitized user input. */
  def trust(html: String): Vnode[js.Any, js.Any] = js.native
}
