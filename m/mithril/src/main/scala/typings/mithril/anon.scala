...
object anon {
  ...
  object Lifecycleanyanykeystringa {
    ...
    inline def apply(): Lifecycleanyanykeystringa = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[Lifecycleanyanykeystringa]
    }
    
    extension [Self <: Lifecycleanyanykeystringa](x: Self) {
      ...
      inline def setOncreate(value: js.ThisFunction1[/* this */ js.Any, /* vnode */ VnodeDOM[js.Any, js.Any], js.Any]): Self = StObject.set(x, "oncreate", value.asInstanceOf[js.Any])
      
      inline def setOncreateUndefined: Self = StObject.set(x, "oncreate", js.undefined)
      
      inline def setOninit(value: js.ThisFunction1[/* this */ js.Any, /* vnode */ Vnode[js.Any, js.Any], js.Any]): Self = StObject.set(x, "oninit", value.asInstanceOf[js.Any])
      
      inline def setOninitUndefined: Self = StObject.set(x, "oninit", js.undefined)
      
      inline def setOnremove(value: js.ThisFunction1[/* this */ js.Any, /* vnode */ VnodeDOM[js.Any, js.Any], js.Any]): Self = StObject.set(x, "onremove", value.asInstanceOf[js.Any])
      
      inline def setOnremoveUndefined: Self = StObject.set(x, "onremove", js.undefined)
      
      inline def setOnupdate(value: js.ThisFunction1[/* this */ js.Any, /* vnode */ VnodeDOM[js.Any, js.Any], js.Any]): Self = StObject.set(x, "onupdate", value.asInstanceOf[js.Any])
