...
trait Route extends js.Object {
  ...
  def link(options: RouteOptions): js.Function1[/* vnode */ Vnode[_, _], js.Function1[/* e */ js.UndefOr[Event], _]] = js.native
  /** This method is meant to be used in conjunction with an <a> Vnode's oncreate/onupdate hooks. */
  def link(vnode: Vnode[_, _]): js.Function1[/* e */ js.UndefOr[Event], _] = js.native
  ...
  def prefix(urlFragment: String): Unit = js.native
