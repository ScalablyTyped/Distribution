...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: AdvertiserGroup = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(id: String, profileId: String, resource: AdvertiserGroup): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AdvertiserGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
