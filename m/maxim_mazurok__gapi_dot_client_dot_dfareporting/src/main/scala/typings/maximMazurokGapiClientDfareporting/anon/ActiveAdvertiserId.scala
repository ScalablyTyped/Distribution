...
@js.native
trait ActiveAdvertiserId extends js.Object {
...
object ActiveAdvertiserId {
  ...
  @scala.inline
  def apply(advertiserId: String, profileId: String): ActiveAdvertiserId = {
  ...
  @scala.inline
  implicit class ActiveAdvertiserIdOps[Self <: ActiveAdvertiserId] (val x: Self) extends AnyVal {
