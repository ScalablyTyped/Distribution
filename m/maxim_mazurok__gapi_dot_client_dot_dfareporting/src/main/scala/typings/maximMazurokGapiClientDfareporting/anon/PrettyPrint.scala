...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: AccountUserProfile = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(id: String, profileId: String, resource: AccountUserProfile): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AccountUserProfile): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
