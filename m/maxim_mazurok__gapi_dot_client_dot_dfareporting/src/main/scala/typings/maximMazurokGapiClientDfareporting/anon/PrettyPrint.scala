...
import typings.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.AccountUserProfile
...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: AccountUserProfile
...
object PrettyPrint {
  ...
  inline def apply(id: String, profileId: String, resource: AccountUserProfile): PrettyPrint = {
  ...
  implicit open class MutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: AccountUserProfile): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
