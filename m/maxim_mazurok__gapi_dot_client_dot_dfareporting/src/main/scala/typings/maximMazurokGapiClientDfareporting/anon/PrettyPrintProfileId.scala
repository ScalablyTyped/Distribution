...
object PrettyPrintProfileId {
  ...
  @scala.inline
  implicit class PrettyPrintProfileIdMutableBuilder[Self <: PrettyPrintProfileId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreativeField): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
