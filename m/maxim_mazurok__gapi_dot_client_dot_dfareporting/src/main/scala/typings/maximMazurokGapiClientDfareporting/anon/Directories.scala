...
trait Directories extends StObject {
  ...
  var directories: js.UndefOr[String | js.Array[String]] = js.undefined
...
object Directories {
  ...
  inline def apply(profileId: String): Directories = {
  ...
  implicit open class MutableBuilder[Self <: Directories] (val x: Self) extends AnyVal {
    ...
    inline def setDirectories(value: String | js.Array[String]): Self = StObject.set(x, "directories", value.asInstanceOf[js.Any])
