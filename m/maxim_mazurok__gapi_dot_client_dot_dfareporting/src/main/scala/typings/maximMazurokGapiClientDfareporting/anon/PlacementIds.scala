...
object PlacementIds {
  ...
  @scala.inline
  def apply(profileId: String): PlacementIds = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlacementIds]
  }
  
  @scala.inline
  implicit class PlacementIdsMutableBuilder[Self <: PlacementIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagFormats(value: String | js.Array[String]): Self = StObject.set(x, "tagFormats", value.asInstanceOf[js.Any])
