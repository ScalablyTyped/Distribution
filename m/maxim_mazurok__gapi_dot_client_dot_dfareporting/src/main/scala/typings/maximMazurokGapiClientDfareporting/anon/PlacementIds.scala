...
trait PlacementIds extends StObject {
  ...
  var tagFormats: js.UndefOr[String | js.Array[String]] = js.undefined
...
object PlacementIds {
  ...
  inline def apply(profileId: String): PlacementIds = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlacementIds]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlacementIds] (val x: Self) extends AnyVal {
    ...
    inline def setTagFormats(value: String | js.Array[String]): Self = StObject.set(x, "tagFormats", value.asInstanceOf[js.Any])
