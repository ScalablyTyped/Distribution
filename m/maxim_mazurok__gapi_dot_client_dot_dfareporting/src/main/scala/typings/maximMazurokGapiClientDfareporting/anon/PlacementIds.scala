...
@js.native
trait PlacementIds extends js.Object {
...
object PlacementIds {
  ...
  @scala.inline
  implicit class PlacementIdsOps[Self <: PlacementIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagFormats(value: String | js.Array[String]): Self = this.set("tagFormats", value.asInstanceOf[js.Any])
