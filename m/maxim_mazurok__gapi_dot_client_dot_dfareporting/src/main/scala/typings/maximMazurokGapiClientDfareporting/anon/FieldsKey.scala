...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: ContentCategory = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(profileId: String, resource: ContentCategory): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ContentCategory): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
