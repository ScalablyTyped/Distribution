...
object InPlan {
  ...
  inline def apply(profileId: String, projectId: String): InPlan = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InPlan] (val x: Self) extends AnyVal {
    ...
    inline def setOrderId(value: String | js.Array[String]): Self = StObject.set(x, "orderId", value.asInstanceOf[js.Any])
