...
trait InPlan extends js.Object {
  ...
  var orderId: js.UndefOr[String | js.Array[String]] = js.native
  ...
  var siteId: js.UndefOr[String | js.Array[String]] = js.native
...
object InPlan {
  ...
  @scala.inline
  implicit class InPlanOps[Self <: InPlan] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOrderId(value: String | js.Array[String]): Self = this.set("orderId", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSiteId(value: String | js.Array[String]): Self = this.set("siteId", value.asInstanceOf[js.Any])
