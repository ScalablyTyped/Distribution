...
object IdsKey {
  ...
  inline def apply(profileId: String): IdsKey = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdsKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IdsKey] (val x: Self) extends AnyVal {
