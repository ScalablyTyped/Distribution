...
trait Synchronous extends StObject {
...
object Synchronous {
  ...
  @scala.inline
  def apply(profileId: String, reportId: String): Synchronous = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any], reportId = reportId.asInstanceOf[js.Any])
    __obj.asInstanceOf[Synchronous]
  }
  
  @scala.inline
  implicit class SynchronousMutableBuilder[Self <: Synchronous] (val x: Self) extends AnyVal {
