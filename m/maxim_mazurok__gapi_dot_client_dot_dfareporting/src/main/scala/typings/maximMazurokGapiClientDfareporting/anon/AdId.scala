...
object AdId {
  ...
  @scala.inline
  implicit class AdIdMutableBuilder[Self <: AdId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventTagTypes(value: String | js.Array[String]): Self = StObject.set(x, "eventTagTypes", value.asInstanceOf[js.Any])
