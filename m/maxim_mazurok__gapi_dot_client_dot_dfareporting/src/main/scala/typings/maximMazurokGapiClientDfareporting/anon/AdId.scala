...
trait AdId extends js.Object {
  ...
  /**
    ...
    */
  var eventTagTypes: js.UndefOr[String | js.Array[String]] = js.native
...
object AdId {
  ...
  @scala.inline
  def apply(profileId: String): AdId = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AdId]
  }
  
  @scala.inline
  implicit class AdIdOps[Self <: AdId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventTagTypes(value: String | js.Array[String]): Self = this.set("eventTagTypes", value.asInstanceOf[js.Any])
