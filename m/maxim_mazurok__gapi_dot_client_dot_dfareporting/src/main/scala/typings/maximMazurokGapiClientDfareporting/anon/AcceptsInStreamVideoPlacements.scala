...
object AcceptsInStreamVideoPlacements {
  ...
  inline def apply(profileId: String): AcceptsInStreamVideoPlacements = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AcceptsInStreamVideoPlacements]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AcceptsInStreamVideoPlacements] (val x: Self) extends AnyVal {
