...
trait QuotaUserResource extends StObject {
  ...
  /** Request body */
  var resource: CreativeFieldValue = js.native
...
object QuotaUserResource {
  ...
  @scala.inline
  def apply(creativeFieldId: String, id: String, profileId: String, resource: CreativeFieldValue): QuotaUserResource = {
  ...
  implicit class QuotaUserResourceMutableBuilder[Self <: QuotaUserResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreativeFieldValue): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
