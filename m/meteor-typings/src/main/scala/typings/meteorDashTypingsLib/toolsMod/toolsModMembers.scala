...
object toolsModMembers extends js.Object {
  ...
  def execFileAsync(command: java.lang.String, args: js.Array[_], options: meteorDashTypingsLib.Anon_Stdio): js.Any = js.native
  ...
  def execFileSync(command: java.lang.String, args: js.Array[_], options: meteorDashTypingsLib.Anon_Stdio): java.lang.String = js.native
}
