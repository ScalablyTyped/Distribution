...
object AccountsNs extends js.Object {
  ...
  var emailTemplates: meteorDashTypingsLib.meteorAccountsDashBaseMod.EmailTemplates = js.native
  var urls: meteorDashTypingsLib.meteorAccountsDashBaseMod.URLS = js.native
  ...
  def config(options: meteorDashTypingsLib.Anon_ForbidClientAccountCreation): scala.Unit = js.native
  def createUser(options: meteorDashTypingsLib.Anon_Email): java.lang.String = js.native
  def createUser(options: meteorDashTypingsLib.Anon_Email, callback: js.Function): java.lang.String = js.native
  ...
  def forgotPassword(options: meteorDashTypingsLib.Anon_EmailString): scala.Unit = js.native
  def forgotPassword(options: meteorDashTypingsLib.Anon_EmailString, callback: js.Function): scala.Unit = js.native
  ...
  object ui extends js.Object {
    def config(options: meteorDashTypingsLib.Anon_ForceApprovalPrompt): scala.Unit = js.native
  }
