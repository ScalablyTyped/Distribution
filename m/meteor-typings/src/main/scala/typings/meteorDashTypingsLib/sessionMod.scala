...
object sessionMod extends js.Object {
  ...
  object SessionNs extends js.Object {
    ...
    def set(key: java.lang.String, value: meteorDashTypingsLib.EJSONable): scala.Unit = js.native
    def setDefault(key: java.lang.String, value: js.Any): scala.Unit = js.native
    def setDefault(key: java.lang.String, value: meteorDashTypingsLib.EJSONable): scala.Unit = js.native
  }
