...
object ^ extends js.Object {
  ...
  def execFileAsync(command: java.lang.String, args: js.Array[_], options: meteorDashTypingsLib.Anon_Cwd): js.Any = js.native
  ...
  def execFileSync(command: java.lang.String, args: js.Array[_], options: meteorDashTypingsLib.Anon_Cwd): java.lang.String = js.native
}
