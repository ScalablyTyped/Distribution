...
@JSGlobalScope
@js.native
object meteorDashTypingsLibMembers extends js.Object {
  ...
  def execFileSync(command: java.lang.String, args: js.Array[_], options: Anon_Stdio): java.lang.String = js.native
}
