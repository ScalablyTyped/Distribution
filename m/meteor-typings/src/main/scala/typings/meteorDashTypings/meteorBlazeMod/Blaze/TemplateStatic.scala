...
trait TemplateStatic
  extends Instantiable0[typings.meteorDashTypings.meteorBlazeMod.Blaze.Template]
     with Instantiable1[/* viewName */ String, typings.meteorDashTypings.meteorBlazeMod.Blaze.Template]
     with Instantiable2[
      /* viewName */ String, 
      /* renderFunction */ js.Function, 
      typings.meteorDashTypings.meteorBlazeMod.Blaze.Template
    ] {
