...
trait Anon_AttachmentsBcc extends js.Object {
  ...
  var mailComposer: js.UndefOr[typings.meteorDashTypings.meteorEmailMod.MailComposer] = js.undefined
...
object Anon_AttachmentsBcc {
  ...
  def apply(
    ...
    html: String = null,
    mailComposer: typings.meteorDashTypings.meteorEmailMod.MailComposer = null,
