...
trait View extends js.Object {
  ...
  var template: typings.meteorDashTypings.BlazeNs.Template
...
class ViewCls () extends View {
  ...
  /* CompleteClass */
  override var template: typings.meteorDashTypings.BlazeNs.Template = js.native
  /* CompleteClass */
...
object View {
  ...
  def apply(
    ...
    parentView: View,
    renderCount: Double,
    template: typings.meteorDashTypings.BlazeNs.Template,
