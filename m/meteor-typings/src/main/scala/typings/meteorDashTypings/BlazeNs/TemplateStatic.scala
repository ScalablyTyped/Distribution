...
trait TemplateStatic
  extends Instantiable0[typings.meteorDashTypings.BlazeNs.Template]
     with Instantiable1[/* viewName */ String, typings.meteorDashTypings.BlazeNs.Template]
     with Instantiable2[
      /* viewName */ String, 
      /* renderFunction */ js.Function, 
      typings.meteorDashTypings.BlazeNs.Template
    ] {
