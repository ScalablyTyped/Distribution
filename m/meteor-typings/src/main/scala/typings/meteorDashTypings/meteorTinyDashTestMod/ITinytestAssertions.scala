...
trait ITinytestAssertions extends js.Object {
  ...
  def length(obj: typings.meteorDashTypings.meteorTinyDashTestMod.ILengthAble, expected_length: Double): Unit = js.native
  def length(
    obj: typings.meteorDashTypings.meteorTinyDashTestMod.ILengthAble,
    expected_length: Double,
    msg: String
  ): Unit = js.native
