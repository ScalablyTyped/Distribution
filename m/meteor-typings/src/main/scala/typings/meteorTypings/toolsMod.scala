...
object toolsMod {
  ...
  object Package {
    ...
    inline def onTest(func: js.Function1[/* api */ typings.meteorTypings.toolsMod.PackageAPI, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onTest")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    inline def onUse(func: js.Function1[/* api */ typings.meteorTypings.toolsMod.PackageAPI, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onUse")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
