...
object meteorEmailMod {
  ...
  open class MailComposerCls protected ()
    extends StObject
       with typings.meteorTypings.meteorEmailMod.MailComposer {
    def this(options: typings.meteorTypings.meteorEmailMod.MailComposerOptions) = this()
  ...
  object MailComposerOptions {
    ...
    inline def apply(
      ...
      keepBcc: Boolean
    ): typings.meteorTypings.meteorEmailMod.MailComposerOptions = {
  ...
  trait MailComposerStatic
    extends StObject
       with Instantiable1[
          /* options */ typings.meteorTypings.meteorEmailMod.MailComposerOptions, 
          typings.meteorTypings.meteorEmailMod.MailComposer
        ]
}
