...
object mod {
  ...
  object Accounts {
    ...
    inline def emailTemplates_=(x: typings.meteorTypings.mod.EmailTemplates): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("emailTemplates")(x.asInstanceOf[js.Any])
    ...
    inline def urls_=(x: typings.meteorTypings.mod.URLS): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("urls")(x.asInstanceOf[js.Any])
  ...
  object EmailFields {
    ...
    inline def apply(): typings.meteorTypings.mod.EmailFields = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.meteorTypings.mod.EmailFields]
    }
    
    extension [Self <: typings.meteorTypings.mod.EmailFields](x: Self) {
  ...
  object EmailTemplates {
    ...
    extension [Self <: typings.meteorTypings.mod.EmailTemplates](x: Self) {
      
      inline def setEnrollAccount(value: typings.meteorTypings.mod.EmailFields): Self = StObject.set(x, "enrollAccount", value.asInstanceOf[js.Any])
      
      inline def setFrom(value: String): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
      
      inline def setHeaders(value: typings.meteorTypings.mod.Header): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
      
      inline def setHeadersUndefined: Self = StObject.set(x, "headers", js.undefined)
      
      inline def setResetPassword(value: typings.meteorTypings.mod.EmailFields): Self = StObject.set(x, "resetPassword", value.asInstanceOf[js.Any])
      
      inline def setSiteName(value: String): Self = StObject.set(x, "siteName", value.asInstanceOf[js.Any])
      
      inline def setVerifyEmail(value: typings.meteorTypings.mod.EmailFields): Self = StObject.set(x, "verifyEmail", value.asInstanceOf[js.Any])
    }
  }
  ...
  object URLS {
    ...
    inline def apply(enrollAccount: String => String, resetPassword: String => String, verifyEmail: String => String): typings.meteorTypings.mod.URLS = {
    ...
    extension [Self <: typings.meteorTypings.mod.URLS](x: Self) {
