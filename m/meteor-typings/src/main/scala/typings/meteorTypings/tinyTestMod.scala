...
object tinyTestMod {
  ...
  object Tinytest {
    ...
    def add(
      description: String,
      func: js.Function1[/* test */ typings.meteorTypings.tinyTestMod.ITinytestAssertions, Unit]
  ...
  object ILengthAble {
    ...
    @scala.inline
    def apply(length: Double): typings.meteorTypings.tinyTestMod.ILengthAble = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.meteorTypings.tinyTestMod.ILengthAble]
    }
    
    @scala.inline
    implicit class ILengthAbleMutableBuilder[Self <: typings.meteorTypings.tinyTestMod.ILengthAble] (val x: Self) extends AnyVal {
  ...
  trait ITinytestAssertions extends StObject {
    ...
    def length(obj: typings.meteorTypings.tinyTestMod.ILengthAble, expected_length: Double): Unit = js.native
    def length(obj: typings.meteorTypings.tinyTestMod.ILengthAble, expected_length: Double, msg: String): Unit = js.native
