...
object meteorTemplatingMod {
  ...
  @JSImport("meteor/templating", "Template")
  @js.native
  def Template: typings.meteorTypings.meteorTemplatingMod.TemplateStatic = js.native
  inline def Template_=(x: typings.meteorTypings.meteorTemplatingMod.TemplateStatic): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Template")(x.asInstanceOf[js.Any])
