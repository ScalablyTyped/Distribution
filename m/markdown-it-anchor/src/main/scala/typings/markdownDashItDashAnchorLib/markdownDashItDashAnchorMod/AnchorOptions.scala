...
trait AnchorOptions extends js.Object {
  var callback: js.UndefOr[
    js.Function2[
      /* token */ markdownDashItLib.libTokenMod.^, 
  ...
  var renderPermalink: js.UndefOr[
    js.Function4[
      ...
      /* opts */ this.type, 
      /* state */ markdownDashItLib.libParserUnderscoreCoreMod.^, 
      /* idx */ scala.Double, 
      scala.Unit
    ]
  ] = js.undefined
...
object AnchorOptions {
  @scala.inline
  def apply(
    callback: (/* token */ markdownDashItLib.libTokenMod.^, /* anchor_info */ AnchorInfo) => scala.Unit = null,
    ...
    renderPermalink: (/* slug */ java.lang.String, AnchorOptions, /* state */ markdownDashItLib.libParserUnderscoreCoreMod.^, /* idx */ scala.Double) => scala.Unit = null,
