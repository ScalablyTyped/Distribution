...
@js.native
trait GoogleExampleLibraryagentV1Book extends js.Object {
...
object GoogleExampleLibraryagentV1Book {
  ...
  @scala.inline
  implicit class GoogleExampleLibraryagentV1BookOps[Self <: GoogleExampleLibraryagentV1Book] (val x: Self) extends AnyVal {
