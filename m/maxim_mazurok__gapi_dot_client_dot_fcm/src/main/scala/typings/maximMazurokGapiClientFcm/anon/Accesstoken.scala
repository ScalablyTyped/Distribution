package typings.maximMazurokGapiClientFcm.anon

import typings.maximMazurokGapiClientFcm.gapi.client.fcm.SendMessageRequest
...
trait Accesstoken extends js.Object {
  ...
  /** Request body */
  var resource: SendMessageRequest = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(parent: String, resource: SendMessageRequest): Accesstoken = {
  ...
  implicit class AccesstokenOps[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SendMessageRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
