...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest = js.native
  ...
  object Accesstoken {
    ...
    @scala.inline
    def apply(name: String, resource: GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest): Accesstoken = {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
