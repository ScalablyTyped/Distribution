...
import typings.maximMazurokGapiClientSmartdevicemanagement.gapi.client.smartdevicemanagement.GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest
  ...
  object Accesstoken {
    ...
    inline def apply(name: String, resource: GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
