...
import typings.maximMazurokGapiClientStreetviewpublish.gapi.client.streetviewpublish.PhotoSequence
...
object InputType {
  ...
  inline def apply(resource: PhotoSequence): InputType = {
  ...
  extension [Self <: InputType](x: Self) {
    ...
    inline def setResource(value: PhotoSequence): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
