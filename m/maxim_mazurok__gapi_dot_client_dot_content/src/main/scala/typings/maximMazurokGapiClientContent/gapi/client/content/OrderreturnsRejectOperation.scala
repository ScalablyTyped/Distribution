...
@js.native
trait OrderreturnsRejectOperation extends js.Object {
...
object OrderreturnsRejectOperation {
  ...
  @scala.inline
  implicit class OrderreturnsRejectOperationOps[Self <: OrderreturnsRejectOperation] (val x: Self) extends AnyVal {
