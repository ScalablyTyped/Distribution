...
@js.native
trait ReturnpolicyCustomBatchResponseEntry extends js.Object {
...
object ReturnpolicyCustomBatchResponseEntry {
  ...
  @scala.inline
  implicit class ReturnpolicyCustomBatchResponseEntryOps[Self <: ReturnpolicyCustomBatchResponseEntry] (val x: Self) extends AnyVal {
