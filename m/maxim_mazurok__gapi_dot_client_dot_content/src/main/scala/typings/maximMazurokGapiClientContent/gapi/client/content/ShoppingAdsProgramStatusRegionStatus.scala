...
trait ShoppingAdsProgramStatusRegionStatus extends StObject {
  ...
  var reviewIneligibilityReasonDetails: js.UndefOr[ShoppingAdsProgramStatusReviewIneligibilityReasonDetails] = js.undefined
...
object ShoppingAdsProgramStatusRegionStatus {
  ...
  inline def apply(): ShoppingAdsProgramStatusRegionStatus = {
  ...
  extension [Self <: ShoppingAdsProgramStatusRegionStatus](x: Self) {
    ...
    inline def setReviewIneligibilityReasonDetails(value: ShoppingAdsProgramStatusReviewIneligibilityReasonDetails): Self = StObject.set(x, "reviewIneligibilityReasonDetails", value.asInstanceOf[js.Any])
