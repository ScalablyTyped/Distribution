...
object SettlementreportsListResponse {
  ...
  extension [Self <: SettlementreportsListResponse](x: Self) {
    ...
    inline def setResourcesVarargs(value: SettlementReport*): Self = StObject.set(x, "resources", js.Array(value :_*))
  }
}
