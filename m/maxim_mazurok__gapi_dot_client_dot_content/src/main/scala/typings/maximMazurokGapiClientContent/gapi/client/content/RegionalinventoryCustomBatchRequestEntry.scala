...
@js.native
trait RegionalinventoryCustomBatchRequestEntry extends js.Object {
...
object RegionalinventoryCustomBatchRequestEntry {
  ...
  @scala.inline
  implicit class RegionalinventoryCustomBatchRequestEntryOps[Self <: RegionalinventoryCustomBatchRequestEntry] (val x: Self) extends AnyVal {
