...
object OrderreturnsListResponse {
  ...
  implicit class OrderreturnsListResponseOps[Self <: OrderreturnsListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourcesVarargs(value: MerchantOrderReturn*): Self = this.set("resources", js.Array(value :_*))
    
    @scala.inline
    def setResources(value: js.Array[MerchantOrderReturn]): Self = this.set("resources", value.asInstanceOf[js.Any])
