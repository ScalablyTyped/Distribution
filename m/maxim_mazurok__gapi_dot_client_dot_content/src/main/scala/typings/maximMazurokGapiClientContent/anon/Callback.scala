...
object Callback {
  ...
  inline def apply(accountId: String, labelId: String): Callback = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], labelId = labelId.asInstanceOf[js.Any])
