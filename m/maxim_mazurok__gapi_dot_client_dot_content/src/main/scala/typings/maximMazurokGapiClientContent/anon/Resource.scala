...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: AccountsLinkRequest = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(accountId: String, merchantId: String, resource: AccountsLinkRequest): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AccountsLinkRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
