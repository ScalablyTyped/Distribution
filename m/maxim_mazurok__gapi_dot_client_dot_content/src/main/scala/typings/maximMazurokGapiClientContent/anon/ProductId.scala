...
import typings.maximMazurokGapiClientContent.gapi.client.content.LocalInventory
...
object ProductId {
  ...
  inline def apply(merchantId: String, productId: String, resource: LocalInventory): ProductId = {
  ...
  implicit open class MutableBuilder[Self <: ProductId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: LocalInventory): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
