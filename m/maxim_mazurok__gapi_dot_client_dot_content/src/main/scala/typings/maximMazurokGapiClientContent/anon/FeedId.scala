...
object FeedId {
  ...
  inline def apply(merchantId: String, productId: String): FeedId = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any], productId = productId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FeedId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FeedId] (val x: Self) extends AnyVal {
