...
trait MerchantIdOauthtokenOrderIdPrettyPrint extends StObject {
...
object MerchantIdOauthtokenOrderIdPrettyPrint {
  
  inline def apply(merchantId: String, orderId: String, resource: OrdersUpdateLineItemShippingDetailsRequest): MerchantIdOauthtokenOrderIdPrettyPrint = {
    ...
    __obj.asInstanceOf[MerchantIdOauthtokenOrderIdPrettyPrint]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MerchantIdOauthtokenOrderIdPrettyPrint] (val x: Self) extends AnyVal {
