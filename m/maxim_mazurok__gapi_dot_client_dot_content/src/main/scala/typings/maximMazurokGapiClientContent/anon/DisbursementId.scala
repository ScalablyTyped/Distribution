...
object DisbursementId {
  ...
  inline def apply(disbursementId: String, merchantId: String): DisbursementId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DisbursementId] (val x: Self) extends AnyVal {
