...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: AccountsCustomBatchRequest = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(resource: AccountsCustomBatchRequest): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AccountsCustomBatchRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
