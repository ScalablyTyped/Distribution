...
trait RegionIdResource extends StObject {
...
object RegionIdResource {
  
  inline def apply(merchantId: String, regionId: String, resource: Region): RegionIdResource = {
    ...
    __obj.asInstanceOf[RegionIdResource]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RegionIdResource] (val x: Self) extends AnyVal {
