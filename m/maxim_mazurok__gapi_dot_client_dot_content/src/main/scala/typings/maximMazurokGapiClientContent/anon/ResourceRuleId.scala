...
@js.native
trait ResourceRuleId extends js.Object {
...
object ResourceRuleId {
  ...
  @scala.inline
  implicit class ResourceRuleIdOps[Self <: ResourceRuleId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RepricingRule): Self = this.set("resource", value.asInstanceOf[js.Any])
