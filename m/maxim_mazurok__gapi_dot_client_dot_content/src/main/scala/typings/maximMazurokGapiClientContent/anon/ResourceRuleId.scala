...
@js.native
trait ResourceRuleId extends StObject {
  ...
  /** Request body */
  var resource: RepricingRule = js.native
...
object ResourceRuleId {
  ...
  @scala.inline
  def apply(merchantId: String, resource: RepricingRule, ruleId: String): ResourceRuleId = {
  ...
  @scala.inline
  implicit class ResourceRuleIdMutableBuilder[Self <: ResourceRuleId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RepricingRule): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
