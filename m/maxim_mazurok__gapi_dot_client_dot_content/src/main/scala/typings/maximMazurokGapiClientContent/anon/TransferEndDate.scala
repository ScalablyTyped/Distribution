...
trait TransferEndDate extends StObject {
...
object TransferEndDate {
  ...
  @scala.inline
  implicit class TransferEndDateMutableBuilder[Self <: TransferEndDate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransferEndDate(value: String): Self = StObject.set(x, "transferEndDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTransferEndDateUndefined: Self = StObject.set(x, "transferEndDate", js.undefined)
    
    @scala.inline
    def setTransferStartDate(value: String): Self = StObject.set(x, "transferStartDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTransferStartDateUndefined: Self = StObject.set(x, "transferStartDate", js.undefined)
