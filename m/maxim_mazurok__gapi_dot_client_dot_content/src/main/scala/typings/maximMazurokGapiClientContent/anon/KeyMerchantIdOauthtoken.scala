...
object KeyMerchantIdOauthtoken {
  ...
  inline def apply(merchantId: String, orderId: String, resource: OrdersAcknowledgeRequest): KeyMerchantIdOauthtoken = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyMerchantIdOauthtoken] (val x: Self) extends AnyVal {
