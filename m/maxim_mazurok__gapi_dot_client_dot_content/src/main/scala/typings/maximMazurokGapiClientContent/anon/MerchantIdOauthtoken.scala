...
@js.native
trait MerchantIdOauthtoken extends js.Object {
...
object MerchantIdOauthtoken {
  ...
  @scala.inline
  implicit class MerchantIdOauthtokenOps[Self <: MerchantIdOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiaSettings): Self = this.set("resource", value.asInstanceOf[js.Any])
