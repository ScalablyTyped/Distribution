...
trait MerchantIdOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: LiaSettings = js.native
...
object MerchantIdOauthtoken {
  ...
  @scala.inline
  def apply(accountId: String, merchantId: String, resource: LiaSettings): MerchantIdOauthtoken = {
  ...
  @scala.inline
  implicit class MerchantIdOauthtokenMutableBuilder[Self <: MerchantIdOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiaSettings): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
