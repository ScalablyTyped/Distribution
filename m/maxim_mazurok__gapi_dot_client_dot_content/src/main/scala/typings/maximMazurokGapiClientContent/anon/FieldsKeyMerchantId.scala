...
object FieldsKeyMerchantId {
  ...
  inline def apply(merchantId: String, orderId: String, resource: OrdersInStoreRefundLineItemRequest): FieldsKeyMerchantId = {
  ...
  extension [Self <: FieldsKeyMerchantId](x: Self) {
