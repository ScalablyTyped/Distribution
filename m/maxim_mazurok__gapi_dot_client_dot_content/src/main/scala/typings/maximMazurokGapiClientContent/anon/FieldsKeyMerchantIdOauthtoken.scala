...
@js.native
trait FieldsKeyMerchantIdOauthtoken extends js.Object {
...
object FieldsKeyMerchantIdOauthtoken {
  ...
  @scala.inline
  implicit class FieldsKeyMerchantIdOauthtokenOps[Self <: FieldsKeyMerchantIdOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ReturnPolicy): Self = this.set("resource", value.asInstanceOf[js.Any])
