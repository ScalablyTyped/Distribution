...
@js.native
trait FieldsKeyMerchantIdOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: ReturnPolicy = js.native
...
object FieldsKeyMerchantIdOauthtoken {
  ...
  @scala.inline
  def apply(merchantId: String, resource: ReturnPolicy): FieldsKeyMerchantIdOauthtoken = {
  ...
  @scala.inline
  implicit class FieldsKeyMerchantIdOauthtokenMutableBuilder[Self <: FieldsKeyMerchantIdOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ReturnPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
