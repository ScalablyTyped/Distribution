...
trait PrettyPrintQuotaUserResource extends StObject {
  ...
  /** Request body */
  var resource: OrdersSetLineItemMetadataRequest = js.native
...
object PrettyPrintQuotaUserResource {
  ...
  @scala.inline
  def apply(merchantId: String, orderId: String, resource: OrdersSetLineItemMetadataRequest): PrettyPrintQuotaUserResource = {
  ...
  implicit class PrettyPrintQuotaUserResourceMutableBuilder[Self <: PrettyPrintQuotaUserResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: OrdersSetLineItemMetadataRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
