...
@js.native
trait RegionId extends js.Object {
...
object RegionId {
  ...
  @scala.inline
  def apply(merchantId: String, resource: Region): RegionId = {
  ...
  @scala.inline
  implicit class RegionIdOps[Self <: RegionId] (val x: Self) extends AnyVal {
