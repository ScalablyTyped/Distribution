...
@js.native
trait AccesstokenAccountIdAlt extends js.Object {
...
object AccesstokenAccountIdAlt {
  ...
  @scala.inline
  implicit class AccesstokenAccountIdAltOps[Self <: AccesstokenAccountIdAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ShippingSettings): Self = this.set("resource", value.asInstanceOf[js.Any])
