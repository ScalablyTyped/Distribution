...
@js.native
trait AccesstokenAccountIdAlt extends StObject {
  ...
  /** Request body */
  var resource: ShippingSettings = js.native
...
object AccesstokenAccountIdAlt {
  ...
  @scala.inline
  def apply(accountId: String, merchantId: String, resource: ShippingSettings): AccesstokenAccountIdAlt = {
  ...
  @scala.inline
  implicit class AccesstokenAccountIdAltMutableBuilder[Self <: AccesstokenAccountIdAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ShippingSettings): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
