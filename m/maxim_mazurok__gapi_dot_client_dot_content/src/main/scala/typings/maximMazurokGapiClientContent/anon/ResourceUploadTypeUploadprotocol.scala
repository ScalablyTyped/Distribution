...
@js.native
trait ResourceUploadTypeUploadprotocol extends js.Object {
...
object ResourceUploadTypeUploadprotocol {
  ...
  @scala.inline
  implicit class ResourceUploadTypeUploadprotocolOps[Self <: ResourceUploadTypeUploadprotocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: OrdersUpdateLineItemShippingDetailsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
