...
trait ResourceUploadTypeUploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: OrdersUpdateLineItemShippingDetailsRequest = js.native
...
object ResourceUploadTypeUploadprotocol {
  ...
  @scala.inline
  def apply(merchantId: String, orderId: String, resource: OrdersUpdateLineItemShippingDetailsRequest): ResourceUploadTypeUploadprotocol = {
  ...
  @scala.inline
  implicit class ResourceUploadTypeUploadprotocolMutableBuilder[Self <: ResourceUploadTypeUploadprotocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: OrdersUpdateLineItemShippingDetailsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
