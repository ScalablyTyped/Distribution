...
trait AccesstokenAltCallbackFields extends StObject {
  ...
  /** Request body */
  var resource: OrdersUpdateShipmentRequest = js.native
...
object AccesstokenAltCallbackFields {
  ...
  @scala.inline
  def apply(merchantId: String, orderId: String, resource: OrdersUpdateShipmentRequest): AccesstokenAltCallbackFields = {
  ...
  @scala.inline
  implicit class AccesstokenAltCallbackFieldsMutableBuilder[Self <: AccesstokenAltCallbackFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: OrdersUpdateShipmentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
