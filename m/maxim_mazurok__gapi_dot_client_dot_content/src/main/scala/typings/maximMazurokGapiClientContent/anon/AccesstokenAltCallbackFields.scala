...
@js.native
trait AccesstokenAltCallbackFields extends js.Object {
...
object AccesstokenAltCallbackFields {
  ...
  @scala.inline
  implicit class AccesstokenAltCallbackFieldsOps[Self <: AccesstokenAltCallbackFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: OrdersUpdateShipmentRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
