...
trait OrderIdPrettyPrintQuotaUserResource extends StObject {
...
object OrderIdPrettyPrintQuotaUserResource {
  
  inline def apply(merchantId: String, orderId: String, resource: OrdersUpdateShipmentRequest): OrderIdPrettyPrintQuotaUserResource = {
    ...
    __obj.asInstanceOf[OrderIdPrettyPrintQuotaUserResource]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OrderIdPrettyPrintQuotaUserResource] (val x: Self) extends AnyVal {
