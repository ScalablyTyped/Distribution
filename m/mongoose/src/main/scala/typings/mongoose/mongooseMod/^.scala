...
object ^ extends js.Object {
  ...
  var Model: typings.mongoose.mongooseMod.Model[js.Any, js.Object] = js.native
  ...
  def plugin(fn: js.Function): Typeofmongoose = js.native
  def plugin[T](fn: js.Function, opts: T): Typeofmongoose = js.native
