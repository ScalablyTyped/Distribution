...
trait SchemaOptions extends js.Object {
  ...
  /** defaults to false */
  var capped: js.UndefOr[Boolean | Double | Anon_AutoIndexId] = js.undefined
  ...
  /** defaults to true. */
  var safe: js.UndefOr[Boolean | Anon_J] = js.undefined
  /**
...
object SchemaOptions {
  ...
  def apply(
    ...
    capped: Boolean | Double | Anon_AutoIndexId = null,
