...
import typings.mongoose.Anon_IncludeArrayIndex
import typings.mongoose.Fn_OnfulfilledOnrejected
...
trait Aggregate[T] extends js.Object {
  ...
  @JSName("then")
  var then_Original: Fn_OnfulfilledOnrejected[T] = js.native
  /** Adds a cursor flag */
  ...
  def session(session: typings.mongodb.mongodbMod.ClientSession): this.type = js.native
  /**
  ...
  /**
    ...
    * new in mongodb 3.2
    */
  def unwind(fields: (Anon_IncludeArrayIndex | String)*): this.type = js.native
}
