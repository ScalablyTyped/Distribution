...
import typings.mongoose.anon.ChangeStreamOptionssessio
import typings.mongoose.anon.DeletedCount
import typings.mongoose.anon.Lean
...
import typings.mongoose.anon.orderedbooleanundefinedra
