...
/* Inlined mongodb.mongodb.ChangeStreamOptions & {  session :mongoose.mongoose.ClientSession | undefined} */
@js.native
...
object ChangeStreamOptionssessio {
  ...
  implicit class ChangeStreamOptionssessioOps[Self <: ChangeStreamOptionssessio] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFullDocument(value: default | updateLookup): Self = this.set("fullDocument", value.asInstanceOf[js.Any])
    @scala.inline
