...
@js.native
trait rawResulttrueQueryFindOneArrayFilters extends js.Object {
  /**
...
object rawResulttrueQueryFindOneArrayFilters {
  @scala.inline
  def apply(rawResult: `true` with js.UndefOr[Boolean]): rawResulttrueQueryFindOneArrayFilters = {
  ...
  @scala.inline
  implicit class rawResulttrueQueryFindOneArrayFiltersOps[Self <: rawResulttrueQueryFindOneArrayFilters] (val x: Self) extends AnyVal {
    @scala.inline
