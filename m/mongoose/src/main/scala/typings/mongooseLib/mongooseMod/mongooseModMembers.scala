...
object mongooseModMembers extends js.Object {
  ...
  var Mongoose: org.scalablytyped.runtime.Instantiable1[/* args (repeated) */ js.Any, mongooseLib.Anon_Plugin] = js.native
  var Promise: js.Any = js.native
  var PromiseProvider: js.Any = js.native
  var STATES: js.Any = js.native
  var SchemaTypes: mongooseLib.Anon_Decimal128 = js.native
  var connection: Connection = js.native
  var mongo: mongooseLib.Anon_Decimal128Bytes = js.native
  ...
  def plugin(fn: js.Function): mongooseLib.Anon_Plugin = js.native
  def plugin[T](fn: js.Function, opts: T): mongooseLib.Anon_Plugin = js.native
