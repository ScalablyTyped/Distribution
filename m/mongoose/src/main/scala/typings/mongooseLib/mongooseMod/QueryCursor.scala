...
trait QueryCursor[T /* <: Document */]
  ...
  /** Marks this cursor as closed. Will stop streaming and subsequent calls to next() will error. */
  def close(callback: js.Function2[/* error */ js.Any, /* result */ js.Any, scala.Unit]): js.Promise[_] = js.native
  /**
  ...
  /**
       ...
       * @param callback Executed when all docs have been processed
       */
  def eachAsync(fn: js.Function1[/* doc */ T, _], callback: js.Function1[/* err */ js.Any, scala.Unit]): js.Promise[T] = js.native
  /**
       * Execute fn for every document in the cursor. If fn returns a promise,
       * will wait for the promise to resolve before iterating on to the next one.
       * Returns a promise that resolves when done.
  ...
  /**
       ...
       * no documents left.
       */
  def next(callback: js.Function2[/* err */ js.Any, /* doc */ js.UndefOr[T], scala.Unit]): js.Promise[_] = js.native
}
