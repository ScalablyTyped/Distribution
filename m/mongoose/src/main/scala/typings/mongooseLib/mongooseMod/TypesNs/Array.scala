...
@js.native
trait Array[T]
  extends stdLib.ArrayConstructor {
  /**
  ...
  /**
    ...
    */
  def indexOf(obj: js.Any): scala.Double = js.native
  ...
  /**
    ...
    */
  def nonAtomicPush(args: js.Any*): scala.Double = js.native
  /**
  ...
  /**
    ...
    * @returns new length of the array
    */
  def push(args: js.Any*): scala.Double = js.native
  /** Alias of pull */
  def remove(args: js.Any*): this.type = js.native
  /** Sets the casted val at index i and marks the array modified. */
  def set(i: scala.Double, `val`: js.Any): this.type = js.native
  /**
  ...
  /**
    ...
    * and when you save it.
    */
  def unshift(args: js.Any*): scala.Double = js.native
}
