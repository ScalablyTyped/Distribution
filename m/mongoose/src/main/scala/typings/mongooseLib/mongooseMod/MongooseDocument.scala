...
trait MongooseDocument extends MongooseDocumentOptionals {
  ...
  /** Checks if a path is set to its default. */
  @JSName("$isDefault")
  def $isDefault(path: java.lang.String): scala.Boolean = js.native
  ...
  /**
       ...
       * If the path was not populated, this is a no-op.
       */
  def depopulate(path: java.lang.String): this.type = js.native
  /**
       ...
       */
  def equals(doc: MongooseDocument): scala.Boolean = js.native
  /**
  ...
  /**
       ...
       * @param type optionally specify a type for on-the-fly attributes
       */
  def get(path: java.lang.String, `type`: js.Any): js.Any = js.native
  /**
  ...
  def isDirectModified(path: java.lang.String): scala.Boolean = js.native
  /** Checks if path was explicitly selected. If no projection, always returns true. */
  def isDirectSelected(path: java.lang.String): scala.Boolean = js.native
  /** Checks if path was initialized */
  def isInit(path: java.lang.String): scala.Boolean = js.native
  /**
  ...
  /**
       ...
       * chain has been modified.
       */
  def isModified(path: java.lang.String): scala.Boolean = js.native
  /** Checks if path was selected in the source query which initialized this document. */
  def isSelected(path: java.lang.String): scala.Boolean = js.native
  /**
       * Marks the path as having pending changes to write to the db.
       * Very helpful when using Mixed types.
       * @param path the path to mark modified
       */
  def markModified(path: java.lang.String): scala.Unit = js.native
  /** Returns the list of paths that have been modified. */
  def modifiedPaths(): js.Array[java.lang.String] = js.native
  /**
       ...
       */
  def populate(callback: js.Function2[/* err */ js.Any, /* res */ this.type, scala.Unit]): this.type = js.native
  ...
  def populate(path: java.lang.String, callback: js.Function2[/* err */ js.Any, /* res */ this.type, scala.Unit]): this.type = js.native
  def populate(path: java.lang.String, names: java.lang.String): this.type = js.native
  def populate(
  ...
  /**
       ...
       */
  def set(path: java.lang.String, `val`: js.Any): this.type = js.native
  /**
       * Sets the value of a path, or many paths.
       * @param path path or object of key/vals to set
       * @param val the value to set
       ...
       * @param options optionally specify options that modify the behavior of the set
       */
  def set(path: java.lang.String, `val`: js.Any, options: js.Any): this.type = js.native
  def set(path: java.lang.String, `val`: js.Any, `type`: js.Any, options: js.Any): this.type = js.native
  ...
  /**
       ...
       */
  def unmarkModified(path: java.lang.String): scala.Unit = js.native
