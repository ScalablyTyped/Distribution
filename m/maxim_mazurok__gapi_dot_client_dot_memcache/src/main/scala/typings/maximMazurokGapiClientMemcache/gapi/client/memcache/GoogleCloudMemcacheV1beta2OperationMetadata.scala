...
@js.native
trait GoogleCloudMemcacheV1beta2OperationMetadata extends js.Object {
...
object GoogleCloudMemcacheV1beta2OperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudMemcacheV1beta2OperationMetadataOps[Self <: GoogleCloudMemcacheV1beta2OperationMetadata] (val x: Self) extends AnyVal {
