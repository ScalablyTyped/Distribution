...
@js.native
trait GoogleCloudMemcacheV1beta2OperationMetadata extends StObject {
...
object GoogleCloudMemcacheV1beta2OperationMetadata {
  
  @scala.inline
  def apply(): GoogleCloudMemcacheV1beta2OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudMemcacheV1beta2OperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudMemcacheV1beta2OperationMetadataMutableBuilder[Self <: GoogleCloudMemcacheV1beta2OperationMetadata] (val x: Self) extends AnyVal {
