...
trait GoogleCloudMemcacheV1OperationMetadata extends StObject {
...
object GoogleCloudMemcacheV1OperationMetadata {
  
  inline def apply(): GoogleCloudMemcacheV1OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudMemcacheV1OperationMetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudMemcacheV1OperationMetadata] (val x: Self) extends AnyVal {
