...
trait GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.memcache.gapi.client.memcache.GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility}
    */ typings.maximMazurokGapiClientMemcache.maximMazurokGapiClientMemcacheStrings.GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility & TopLevel[Any]
  ] = js.undefined
}
