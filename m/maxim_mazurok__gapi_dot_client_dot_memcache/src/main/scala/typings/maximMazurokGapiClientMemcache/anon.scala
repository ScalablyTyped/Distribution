...
object anon {
  ...
  object Accesstoken {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: ApplyParametersRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Callback {
    ...
    @scala.inline
    def apply(parent: String, resource: Instance): Callback = {
  ...
  object Oauthtoken {
    ...
    implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: UpdateParametersRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
