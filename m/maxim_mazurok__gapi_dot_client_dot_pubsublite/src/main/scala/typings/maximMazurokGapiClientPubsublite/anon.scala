...
object anon {
  ...
  object Key {
    ...
    @scala.inline
    def apply(name: String, resource: Subscription): Key = {
  ...
  trait Parent extends StObject {
    ...
    /** Request body */
    var resource: typings.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic
  ...
  object Parent {
    ...
    @scala.inline
    def apply(parent: String, resource: typings.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic): Parent = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: typings.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object QuotaUser {
    ...
    @scala.inline
    def apply(name: String, resource: typings.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic): QuotaUser = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  object Resource {
    ...
    implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: ComputeMessageStatsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
