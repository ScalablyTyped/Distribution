package typings.maximMazurokGapiClientPubsublite.anon

import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait SkipBacklog extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Subscription
...
object SkipBacklog {
  ...
  inline def apply(
    parent: String,
    resource: typings.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Subscription
  ): SkipBacklog = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[SkipBacklog]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SkipBacklog] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Subscription): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
