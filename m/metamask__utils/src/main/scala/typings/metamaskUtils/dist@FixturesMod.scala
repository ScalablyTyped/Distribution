...
object `dist@FixturesMod` {
  
  @JSImport("@metamask/utils/dist/@/fixtures", "ARRAY_OF_DIFFRENT_KINDS_OF_NUMBERS")
  @js.native
  val ARRAY_OF_DIFFRENT_KINDS_OF_NUMBERS: js.Array[Double] = js.native
  
  @JSImport("@metamask/utils/dist/@/fixtures", "ARRAY_OF_MIXED_SPECIAL_OBJECTS")
  @js.native
  val ARRAY_OF_MIXED_SPECIAL_OBJECTS: js.Array[js.UndefOr[Null]] = js.native
  
  object COMPLEX_OBJECT {
    
    @JSImport("@metamask/utils/dist/@/fixtures", "COMPLEX_OBJECT")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "COMPLEX_OBJECT.data")
    @js.native
  ...
  object JSON_FIXTURES {
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_FIXTURES")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_FIXTURES.invalid")
    @js.native
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_FIXTURES.valid")
    @js.native
  ...
  object JSON_RPC_FAILURE_FIXTURES {
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_FAILURE_FIXTURES")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_FAILURE_FIXTURES.invalid")
    @js.native
    def invalid: js.Array[
        js.UndefOr[
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_FAILURE_FIXTURES.valid")
    @js.native
  ...
  object JSON_RPC_NOTIFICATION_FIXTURES {
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_NOTIFICATION_FIXTURES")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_NOTIFICATION_FIXTURES.invalid")
    @js.native
    def invalid: js.Array[
        js.UndefOr[
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_NOTIFICATION_FIXTURES.valid")
    @js.native
  ...
  object JSON_RPC_REQUEST_FIXTURES {
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_REQUEST_FIXTURES")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_REQUEST_FIXTURES.invalid")
    @js.native
    def invalid: js.Array[
        js.UndefOr[
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_REQUEST_FIXTURES.valid")
    @js.native
  ...
  object JSON_RPC_RESPONSE_FIXTURES {
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_RESPONSE_FIXTURES")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_RESPONSE_FIXTURES.invalid")
    @js.native
    def invalid: js.Array[
        js.UndefOr[
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_RESPONSE_FIXTURES.valid")
    @js.native
    def valid: js.Array[
  ...
  object JSON_RPC_SUCCESS_FIXTURES {
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_SUCCESS_FIXTURES")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_SUCCESS_FIXTURES.invalid")
    @js.native
    def invalid: js.Array[
        js.UndefOr[
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "JSON_RPC_SUCCESS_FIXTURES.valid")
    @js.native
  ...
  object NON_SERIALIZABLE_NESTED_OBJECT {
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "NON_SERIALIZABLE_NESTED_OBJECT")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "NON_SERIALIZABLE_NESTED_OBJECT.levelOne")
    @js.native
  ...
  object OBJECT_MIXED_WITH_UNDEFINED_VALUES {
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "OBJECT_MIXED_WITH_UNDEFINED_VALUES")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@metamask/utils/dist/@/fixtures", "OBJECT_MIXED_WITH_UNDEFINED_VALUES.a")
    @js.native
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "OBJECT_MIXED_WITH_UNDEFINED_VALUES.b")
    @js.native
    def b: String = js.native
    inline def b_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("b")(x.asInstanceOf[js.Any])
    
    @JSImport("@metamask/utils/dist/@/fixtures", "OBJECT_MIXED_WITH_UNDEFINED_VALUES.c")
    @js.native
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "OBJECT_MIXED_WITH_UNDEFINED_VALUES.d")
    @js.native
    def d: String = js.native
    inline def d_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("d")(x.asInstanceOf[js.Any])
    
    @JSImport("@metamask/utils/dist/@/fixtures", "OBJECT_MIXED_WITH_UNDEFINED_VALUES.e")
    @js.native
    ...
    @JSImport("@metamask/utils/dist/@/fixtures", "OBJECT_MIXED_WITH_UNDEFINED_VALUES.f")
    @js.native
