...
object fixturesJsonMod {
  ...
  object OBJECT_MIXED_WITH_UNDEFINED_VALUES {
    ...
    inline def a_=(x: Unit): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("a")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def c: Unit = js.native
    inline def c_=(x: Unit): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("c")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def e: Unit = js.native
    inline def e_=(x: Unit): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("e")(x.asInstanceOf[js.Any])
