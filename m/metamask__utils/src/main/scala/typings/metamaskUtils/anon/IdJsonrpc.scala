...
trait IdJsonrpc extends StObject {
...
object IdJsonrpc {
  ...
  inline def apply(id: Double, jsonrpc: String, method: String, params: Unit): IdJsonrpc = {
    ...
    __obj.asInstanceOf[IdJsonrpc]
  }
  
  extension [Self <: IdJsonrpc](x: Self) {
