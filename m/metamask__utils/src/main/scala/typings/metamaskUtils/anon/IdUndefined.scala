...
object IdUndefined {
  ...
  inline def apply(id: Unit, jsonrpc: String, method: Null, params: Unit): IdUndefined = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IdUndefined] (val x: Self) extends AnyVal {
