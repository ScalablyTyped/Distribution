...
trait RunPipelineRequest extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientGenomics.maximMazurokGapiClientGenomicsStrings.RunPipelineRequest & TopLevel[Any]
  ] = js.undefined
  ...
  /**
    * The name of an existing Pub/Sub topic. The server will publish messages to this topic whenever the status of the operation changes. The Genomics Service Agent account must have
