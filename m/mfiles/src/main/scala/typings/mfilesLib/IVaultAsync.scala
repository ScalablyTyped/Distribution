...
object IVaultAsync {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ClassGroupOperations = ClassGroupOperations, ClassOperations = ClassOperations, ClientOperations = ClientOperations, CustomApplicationManagementOperations = CustomApplicationManagementOperations, DataSetOperations = DataSetOperations, ElectronicSignatureOperations = ElectronicSignatureOperations, EventLogOperations = EventLogOperations, ExtensionMethodOperations = ExtensionMethodOperations, ExternalObjectOperations = ExternalObjectOperations, LoginAccountOperations = LoginAccountOperations, ManagementOperations = ManagementOperations, NamedACLOperations = NamedACLOperations, NamedValueStorageOperations = NamedValueStorageOperations, NotificationOperations = NotificationOperations, ObjectFileOperations = ObjectFileOperations, ObjectOperations = ObjectOperations, ObjectPropertyOperations = ObjectPropertyOperations, ObjectSearchOperations = ObjectSearchOperations, ObjectTypeOperations = ObjectTypeOperations, PropertyDefOperations = PropertyDefOperations, ScheduledJobManagementOperations = ScheduledJobManagementOperations, ServerDataPushOperations = ServerDataPushOperations, SharedLinkOperations = SharedLinkOperations, TraditionalFolderOperations = TraditionalFolderOperations, UserGroupOperations = UserGroupOperations, UserOperations = UserOperations, UserSettingOperations = UserSettingOperations, ValueListItemOperations = ValueListItemOperations, ValueListOperations = ValueListOperations, ViewOperations = ViewOperations, WorkflowOperations = WorkflowOperations)
