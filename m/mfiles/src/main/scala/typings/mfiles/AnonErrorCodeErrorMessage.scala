...
trait AnonErrorCodeErrorMessage extends js.Object {
...
object AnonErrorCodeErrorMessage {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonErrorCodeErrorMessage]
  }
}
