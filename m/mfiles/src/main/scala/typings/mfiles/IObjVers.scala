...
object IObjVers {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IObjVers] (val x: Self) extends AnyVal {
    
    inline def setAdd(value: (Double, IObjVer) => Unit): Self = StObject.set(x, "Add", js.Any.fromFunction2(value))
    
    inline def setClone(value: () => IObjVers): Self = StObject.set(x, "Clone", js.Any.fromFunction0(value))
    
    inline def setCount(value: Double): Self = StObject.set(x, "Count", value.asInstanceOf[js.Any])
    
    inline def setGetAllDistinctObjIDs(value: () => IObjIDs): Self = StObject.set(x, "GetAllDistinctObjIDs", js.Any.fromFunction0(value))
