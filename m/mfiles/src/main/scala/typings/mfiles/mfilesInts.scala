...
import typings.mfiles.MFiles.ListingEmptinessState
import typings.mfiles.MFiles.MFACLComponentOverrideAccess
...
import typings.mfiles.MFiles.MFApplicationLicenseStatus
...
import typings.mfiles.MFiles.MFFolderColumnId
...
import typings.mfiles.MFiles.SearchFeature
...
object mfilesInts {
  ...
  sealed trait `-1000001`
    extends StObject
       with MFFolderColumnId
  inline def `-1000001`: `-1000001` = -1000001.asInstanceOf[`-1000001`]
  ...
  sealed trait `-9000`
    extends StObject
       with MFBuiltInView
  inline def `-9000`: `-9000` = -9000.asInstanceOf[`-9000`]
  
  @js.native
  sealed trait `-9001`
    extends StObject
       with MFBuiltInView
  inline def `-9001`: `-9001` = -9001.asInstanceOf[`-9001`]
  ...
  sealed trait `268435455`
    extends StObject
       with BuiltinCommand
       with CommandLocation
  inline def `268435455`: `268435455` = 268435455.asInstanceOf[`268435455`]
  ...
  sealed trait `30001`
    extends StObject
       with MFPredefinedSearchFilterType
  inline def `30001`: `30001` = 30001.asInstanceOf[`30001`]
  
  @js.native
  sealed trait `30002`
    extends StObject
       with MFPredefinedSearchFilterType
  inline def `30002`: `30002` = 30002.asInstanceOf[`30002`]
  
  @js.native
  sealed trait `30003`
    extends StObject
       with MFPredefinedSearchFilterType
  inline def `30003`: `30003` = 30003.asInstanceOf[`30003`]
  
  @js.native
  sealed trait `30004`
    extends StObject
       with MFPredefinedSearchFilterType
  inline def `30004`: `30004` = 30004.asInstanceOf[`30004`]
  
  @js.native
  sealed trait `30005`
    extends StObject
       with MFPredefinedSearchFilterType
  inline def `30005`: `30005` = 30005.asInstanceOf[`30005`]
  
  @js.native
  sealed trait `30006`
    extends StObject
       with MFPredefinedSearchFilterType
  inline def `30006`: `30006` = 30006.asInstanceOf[`30006`]
  
  @js.native
  sealed trait `30007`
    extends StObject
       with MFPredefinedSearchFilterType
  inline def `30007`: `30007` = 30007.asInstanceOf[`30007`]
  
  @js.native
  sealed trait `3078`
    extends StObject
       with MFUserAccountVaultRole
  inline def `3078`: `3078` = 3078.asInstanceOf[`3078`]
