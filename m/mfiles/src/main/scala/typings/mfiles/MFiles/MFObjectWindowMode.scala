...
object MFObjectWindowMode {
  ...
  inline def EditApplicationModal: `4` = 4.asInstanceOf[`4`]
  
  inline def Insert: `0` = 0.asInstanceOf[`0`]
  
  inline def InsertSaveAsType: `2` = 2.asInstanceOf[`2`]
  
  inline def InsertSourceFiles: `1` = 1.asInstanceOf[`1`]
}
