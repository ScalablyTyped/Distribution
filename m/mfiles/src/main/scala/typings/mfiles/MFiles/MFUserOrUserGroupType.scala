...
object MFUserOrUserGroupType {
  ...
  inline def PropertyBasedPseudoUser: `4` = 4.asInstanceOf[`4`]
  
  inline def PseudoUser: `3` = 3.asInstanceOf[`3`]
  
  inline def Unknown: `0` = 0.asInstanceOf[`0`]
  
  inline def UserAccount: `1` = 1.asInstanceOf[`1`]
  
  inline def UserGroup: `2` = 2.asInstanceOf[`2`]
}
