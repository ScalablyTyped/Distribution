...
object MFPermissionsExpressionType {
  @scala.inline
  def ACL: `0` = this.cast(0)
  @scala.inline
  def DeletableBy: `5` = this.cast(5)
  @scala.inline
  def EditableBy: `2` = this.cast(2)
  @scala.inline
  def FullControlBy: `4` = this.cast(4)
  @scala.inline
  def ObjectsAttachableToThisItemBy: `6` = this.cast(6)
  @scala.inline
  def PermissionsChangeableBy: `3` = this.cast(3)
  @scala.inline
  def VisibleTo: `1` = this.cast(1)
  @scala.inline
