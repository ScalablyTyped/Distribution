...
*/
trait MFAutoStateTransitionMode extends StObject
object MFAutoStateTransitionMode {
  
  inline def AllowedByScript: `5` = 5.asInstanceOf[`5`]
  
  inline def AssignmentComplete: `6` = 6.asInstanceOf[`6`]
  
  inline def AssignmentCompleteAll: `3` = 3.asInstanceOf[`3`]
  
  inline def AssignmentCompleteOne: `2` = 2.asInstanceOf[`2`]
  
  inline def AssignmentRejected: `7` = 7.asInstanceOf[`7`]
  
  inline def CriteriaFulfilled: `4` = 4.asInstanceOf[`4`]
  
  inline def None: `0` = 0.asInstanceOf[`0`]
  
  inline def RelativeTime: `1` = 1.asInstanceOf[`1`]
}
