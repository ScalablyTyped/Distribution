...
object MFAutoStateTransitionMode {
  ...
  @scala.inline
  def AllowedByScript: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def AssignmentComplete: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def AssignmentCompleteAll: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def AssignmentCompleteOne: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def AssignmentRejected: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def CriteriaFulfilled: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def None: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def RelativeTime: `1` = 1.asInstanceOf[`1`]
}
