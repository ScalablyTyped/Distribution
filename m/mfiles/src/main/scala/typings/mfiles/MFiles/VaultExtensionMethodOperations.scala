...
@js.native
class VaultExtensionMethodOperations () extends IVaultExtensionMethodOperations {
  /* CompleteClass */
...
@JSGlobal("MFiles.VaultExtensionMethodOperations")
@js.native
object VaultExtensionMethodOperations extends Instantiable0[IVaultExtensionMethodOperations]
