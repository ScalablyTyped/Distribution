...
*/
trait MFAuthType extends StObject
object MFAuthType {
  
  inline def LoggedOnWindowsUser: `1` = 1.asInstanceOf[`1`]
  
  inline def SpecificMFilesUser: `3` = 3.asInstanceOf[`3`]
  
  inline def SpecificWindowsUser: `2` = 2.asInstanceOf[`2`]
