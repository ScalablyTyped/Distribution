...
object MFFolderListingAlgorithm {
  ...
  inline def GetValuesByDistinctUse: `2` = 2.asInstanceOf[`2`]
  
  inline def None: `0` = 0.asInstanceOf[`0`]
  
  inline def TestEachValue: `1` = 1.asInstanceOf[`1`]
  
  inline def TestEachValueWithSeparateQueries: `3` = 3.asInstanceOf[`3`]
}
