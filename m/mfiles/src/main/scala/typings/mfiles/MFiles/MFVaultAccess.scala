...
object MFVaultAccess {
  ...
  inline def ChangeAssignments: `8388608` = 8388608.asInstanceOf[`8388608`]
  
  inline def ChangeDocSecurity: `32` = 32.asInstanceOf[`32`]
  
  inline def ChangeFullControlRole: `256` = 256.asInstanceOf[`256`]
  
  inline def ChangeMetaDataStructure: `64` = 64.asInstanceOf[`64`]
  
  inline def ChangeObjectStates: `4194304` = 4194304.asInstanceOf[`4194304`]
  
  inline def CreateDocs: `1` = 1.asInstanceOf[`1`]
  
  inline def DestroyDocs: `8` = 8.asInstanceOf[`8`]
  
  inline def EditAllDocs: `2048` = 2048.asInstanceOf[`2048`]
  
  inline def ExportContent: `8192` = 8192.asInstanceOf[`8192`]
  
  inline def ForceUndoCheckout: `16` = 16.asInstanceOf[`16`]
  
  inline def ImportContent: `16384` = 16384.asInstanceOf[`16384`]
  
  inline def LicenseAllowsModifications: `262144` = 262144.asInstanceOf[`262144`]
  
  inline def ManageCommonNotificationRules: `134217728` = 134217728.asInstanceOf[`134217728`]
  
  inline def ManageCommonUISettings: `33554432` = 33554432.asInstanceOf[`33554432`]
  
  inline def ManageCommonViews: `16777216` = 16777216.asInstanceOf[`16777216`]
  
  inline def ManageEvents: `524288` = 524288.asInstanceOf[`524288`]
  
  inline def ManageExternalLocations: `131072` = 131072.asInstanceOf[`131072`]
  
  inline def ManageTraditionalFolders: `1048576` = 1048576.asInstanceOf[`1048576`]
  
  inline def ManageUserAccounts: `128` = 128.asInstanceOf[`128`]
  
  inline def ManageVLItemsFromClient: `65536` = 65536.asInstanceOf[`65536`]
  
  inline def MateriakizeViews: `536870912` = 536870912.asInstanceOf[`536870912`]
  
  inline def MaterializeViews: `536870912` = 536870912.asInstanceOf[`536870912`]
  
  inline def None: `0` = 0.asInstanceOf[`0`]
  
  inline def SeeAllDocs: `2` = 2.asInstanceOf[`2`]
  
  inline def SeeDeletedDocs: `268435456` = 268435456.asInstanceOf[`268435456`]
  
  inline def UndeleteDocs: `4` = 4.asInstanceOf[`4`]
  
  inline def VerifyVault: `1024` = 1024.asInstanceOf[`1024`]
}
