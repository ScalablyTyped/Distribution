...
*/
trait MFAutoStateTransitionMode extends js.Object

object MFAutoStateTransitionMode {
  @scala.inline
  def AllowedByScript: `5` = this.cast(5)
  @scala.inline
  def AssignmentComplete: `6` = this.cast(6)
  @scala.inline
  def AssignmentCompleteAll: `3` = this.cast(3)
  @scala.inline
  def AssignmentCompleteOne: `2` = this.cast(2)
  @scala.inline
  def AssignmentRejected: `7` = this.cast(7)
  @scala.inline
  def CriteriaFulfilled: `4` = this.cast(4)
  @scala.inline
  def None: `0` = this.cast(0)
  @scala.inline
  def RelativeTime: `1` = this.cast(1)
  @scala.inline
