...
object IShellFrameEvents {
  ...
  inline def apply(Register: (Event, js.Function) => Double, Unregister: Double => Unit): IShellFrameEvents = {
    val __obj = js.Dynamic.literal(Register = js.Any.fromFunction2(Register), Unregister = js.Any.fromFunction1(Unregister))
    __obj.asInstanceOf[IShellFrameEvents]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IShellFrameEvents] (val x: Self) extends AnyVal {
