...
object IVaultUIEvents {
  ...
  inline def apply(Register: (Event, js.Function) => Double, Unregister: Double => Unit): IVaultUIEvents = {
    val __obj = js.Dynamic.literal(Register = js.Any.fromFunction2(Register), Unregister = js.Any.fromFunction1(Unregister))
    __obj.asInstanceOf[IVaultUIEvents]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IVaultUIEvents] (val x: Self) extends AnyVal {
