...
trait AnonErrorCodeErrorMessageErrorStackFinally extends js.Object {
...
object AnonErrorCodeErrorMessageErrorStackFinally {
  @scala.inline
  def apply(
    Finally: () => Unit = null,
  ...
  ): AnonErrorCodeErrorMessageErrorStackFinally = {
    ...
    __obj.asInstanceOf[AnonErrorCodeErrorMessageErrorStackFinally]
  }
}
