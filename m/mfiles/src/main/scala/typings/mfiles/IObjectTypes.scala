...
object IObjectTypes {
  ...
  implicit class IObjectTypesOps[Self <: IObjectTypes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClone(value: () => IObjectTypes): Self = this.set("Clone", js.Any.fromFunction0(value))
    @scala.inline
    def setCount(value: Double): Self = this.set("Count", value.asInstanceOf[js.Any])
    @scala.inline
    def setItem(value: Double => IObjectType): Self = this.set("Item", js.Any.fromFunction1(value))
  }
