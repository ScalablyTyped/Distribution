...
object IVault {
  ...
  extension [Self <: IVault](x: Self) {
    ...
    inline def setGetAllTranslations(value: () => String): Self = StObject.set(x, "GetAllTranslations", js.Any.fromFunction0(value))
    
    inline def setGetGUID(value: () => String): Self = StObject.set(x, "GetGUID", js.Any.fromFunction0(value))
    
    inline def setGetMFilesURLForVaultRoot(value: () => String): Self = StObject.set(x, "GetMFilesURLForVaultRoot", js.Any.fromFunction0(value))
    ...
    inline def setGetMetadataStructureVersionID(value: () => Double): Self = StObject.set(x, "GetMetadataStructureVersionID", js.Any.fromFunction0(value))
    
    inline def setGetServerLicenseStatus(value: () => ILicenseStatus): Self = StObject.set(x, "GetServerLicenseStatus", js.Any.fromFunction0(value))
    
    inline def setGetServerVersionOfVault(value: () => IMFilesVersion): Self = StObject.set(x, "GetServerVersionOfVault", js.Any.fromFunction0(value))
    
    inline def setLogOutSilent(value: () => Unit): Self = StObject.set(x, "LogOutSilent", js.Any.fromFunction0(value))
    ...
    inline def setTestConnectionToServer(value: () => Unit): Self = StObject.set(x, "TestConnectionToServer", js.Any.fromFunction0(value))
    
    inline def setTestConnectionToVault(value: () => Unit): Self = StObject.set(x, "TestConnectionToVault", js.Any.fromFunction0(value))
    
    inline def setTestConnectionToVaultWithTimeout(value: Double => Unit): Self = StObject.set(x, "TestConnectionToVaultWithTimeout", js.Any.fromFunction1(value))
