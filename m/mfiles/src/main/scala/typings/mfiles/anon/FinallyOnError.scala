...
@js.native
trait FinallyOnError extends js.Object {
...
object FinallyOnError {
  ...
  @scala.inline
  implicit class FinallyOnErrorOps[Self <: FinallyOnError] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnSuccess(value: /* objectVersions */ IObjectVersions => Unit): Self = this.set("OnSuccess", js.Any.fromFunction1(value))
    @scala.inline
