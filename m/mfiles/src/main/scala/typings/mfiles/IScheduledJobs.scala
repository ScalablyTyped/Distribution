...
object IScheduledJobs {
  ...
  @scala.inline
  implicit class IScheduledJobsOps[Self <: IScheduledJobs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItem(value: Double => IScheduledJob): Self = this.set("Item", js.Any.fromFunction1(value))
  }
}
