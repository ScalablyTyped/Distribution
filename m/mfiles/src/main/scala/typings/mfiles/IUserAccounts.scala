...
object IUserAccounts {
  ...
  @scala.inline
  implicit class IUserAccountsOps[Self <: IUserAccounts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItem(value: Double => IUserAccount): Self = this.set("Item", js.Any.fromFunction1(value))
  }
}
