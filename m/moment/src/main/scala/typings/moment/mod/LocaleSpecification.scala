...
/* x */ StringDictionary[js.Any] {
  ...
  var eras: js.UndefOr[js.Array[EraSpec]] = js.native
...
object LocaleSpecification {
  ...
  implicit class LocaleSpecificationMutableBuilder[Self <: LocaleSpecification] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEras(value: js.Array[EraSpec]): Self = StObject.set(x, "eras", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setErasUndefined: Self = StObject.set(x, "eras", js.undefined)
    
    @scala.inline
    def setErasVarargs(value: EraSpec*): Self = StObject.set(x, "eras", js.Array(value :_*))
