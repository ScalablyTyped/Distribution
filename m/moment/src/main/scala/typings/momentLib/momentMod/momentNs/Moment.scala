...
trait Moment
  ...
  def diff(b: MomentInput, unitOfTime: momentLib.momentMod.momentNs.unitOfTimeNs.Diff): scala.Double = js.native
  def diff(b: MomentInput, unitOfTime: momentLib.momentMod.momentNs.unitOfTimeNs.Diff, precise: scala.Boolean): scala.Double = js.native
  def endOf(unitOfTime: momentLib.momentMod.momentNs.unitOfTimeNs.StartOf): Moment = js.native
  ...
  def get(unit: momentLib.momentMod.momentNs.unitOfTimeNs.All): scala.Double = js.native
  ...
  def isAfter(inp: MomentInput, granularity: momentLib.momentMod.momentNs.unitOfTimeNs.StartOf): scala.Boolean = js.native
  def isBefore(): scala.Boolean = js.native
  def isBefore(inp: MomentInput): scala.Boolean = js.native
  def isBefore(inp: MomentInput, granularity: momentLib.momentMod.momentNs.unitOfTimeNs.StartOf): scala.Boolean = js.native
  def isBetween(a: MomentInput, b: MomentInput): scala.Boolean = js.native
  def isBetween(a: MomentInput, b: MomentInput, granularity: momentLib.momentMod.momentNs.unitOfTimeNs.StartOf): scala.Boolean = js.native
  @JSName("isBetween")
  def `isBetween_()`(
    a: MomentInput,
    b: MomentInput,
    granularity: momentLib.momentMod.momentNs.unitOfTimeNs.StartOf,
  ...
  def isSame(inp: MomentInput, granularity: momentLib.momentMod.momentNs.unitOfTimeNs.StartOf): scala.Boolean = js.native
  def isSameOrAfter(): scala.Boolean = js.native
  def isSameOrAfter(inp: MomentInput): scala.Boolean = js.native
  def isSameOrAfter(inp: MomentInput, granularity: momentLib.momentMod.momentNs.unitOfTimeNs.StartOf): scala.Boolean = js.native
  ...
  def set(unit: momentLib.momentMod.momentNs.unitOfTimeNs.All, value: scala.Double): Moment = js.native
  def startOf(unitOfTime: momentLib.momentMod.momentNs.unitOfTimeNs.StartOf): Moment = js.native
