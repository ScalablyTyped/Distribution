...
import typings.maximMazurokGapiClientCloudtasks.gapi.client.cloudtasks.Queue
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: Queue): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Queue): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
