...
object mod {
  ...
  @scala.inline
  def clear(cancel: CancelToken): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("clear")(cancel.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  @scala.inline
  def run[TArgs /* <: js.Array[js.Any] */](
