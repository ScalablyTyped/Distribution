...
object MediationReportSpec {
  ...
  extension [Self <: MediationReportSpec](x: Self) {
    ...
    inline def setDimensionFiltersVarargs(value: MediationReportSpecDimensionFilter*): Self = StObject.set(x, "dimensionFilters", js.Array(value :_*))
    ...
    inline def setSortConditionsVarargs(value: MediationReportSpecSortCondition*): Self = StObject.set(x, "sortConditions", js.Array(value :_*))
