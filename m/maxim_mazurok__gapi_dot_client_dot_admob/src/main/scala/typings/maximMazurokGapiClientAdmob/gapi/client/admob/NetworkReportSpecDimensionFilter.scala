...
@js.native
trait NetworkReportSpecDimensionFilter extends js.Object {
...
object NetworkReportSpecDimensionFilter {
  ...
  @scala.inline
  implicit class NetworkReportSpecDimensionFilterOps[Self <: NetworkReportSpecDimensionFilter] (val x: Self) extends AnyVal {
