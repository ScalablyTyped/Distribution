...
@js.native
trait MediationReportSpecSortCondition extends js.Object {
...
object MediationReportSpecSortCondition {
  ...
  @scala.inline
  implicit class MediationReportSpecSortConditionOps[Self <: MediationReportSpecSortCondition] (val x: Self) extends AnyVal {
