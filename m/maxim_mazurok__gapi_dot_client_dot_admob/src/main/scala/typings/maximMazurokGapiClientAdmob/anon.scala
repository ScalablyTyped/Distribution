...
import typings.maximMazurokGapiClientAdmob.gapi.client.admob.GenerateMediationReportRequest
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: GenerateMediationReportRequest = js.native
  ...
  object Accesstoken {
    ...
    @scala.inline
    def apply(parent: String, resource: GenerateMediationReportRequest): Accesstoken = {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: GenerateMediationReportRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Callback {
    ...
    implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: GenerateNetworkReportRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
