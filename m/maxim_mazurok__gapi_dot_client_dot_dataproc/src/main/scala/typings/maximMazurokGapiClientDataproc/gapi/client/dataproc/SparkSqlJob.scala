...
trait SparkSqlJob extends js.Object {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientDataproc.maximMazurokGapiClientDataprocStrings.SparkSqlJob with TopLevel[js.Any]
  ] = js.native
...
object SparkSqlJob {
  ...
  implicit class SparkSqlJobOps[Self <: SparkSqlJob] (val x: Self) extends AnyVal {
    ...
    {[ P in string ]: string}
      */ typings.maximMazurokGapiClientDataproc.maximMazurokGapiClientDataprocStrings.SparkSqlJob with TopLevel[js.Any]
    ): Self = this.set("scriptVariables", value.asInstanceOf[js.Any])
