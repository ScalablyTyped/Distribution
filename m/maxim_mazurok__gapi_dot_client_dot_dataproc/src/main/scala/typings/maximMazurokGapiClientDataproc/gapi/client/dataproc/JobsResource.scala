...
import typings.maximMazurokGapiClientDataproc.anon.AccesstokenAlt
import typings.maximMazurokGapiClientDataproc.anon.AltCallback
...
import typings.maximMazurokGapiClientDataproc.anon.Xgafv
