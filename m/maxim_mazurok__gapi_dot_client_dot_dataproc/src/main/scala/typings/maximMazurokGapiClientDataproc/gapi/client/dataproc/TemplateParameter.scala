...
trait TemplateParameter extends StObject {
  ...
  var validation: js.UndefOr[ParameterValidation] = js.undefined
}
object TemplateParameter {
  ...
  extension [Self <: TemplateParameter](x: Self) {
    ...
    inline def setValidation(value: ParameterValidation): Self = StObject.set(x, "validation", value.asInstanceOf[js.Any])
