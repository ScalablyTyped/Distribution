...
import typings.maximMazurokGapiClientDataproc.anon.ActionOnFailedPrimaryWorkers
...
import typings.maximMazurokGapiClientDataproc.anon.Project
...
trait ClustersResource extends StObject {
  ...
  def injectCredentials(request: typings.maximMazurokGapiClientDataproc.anon.Cluster): Request[Operation] = js.native
