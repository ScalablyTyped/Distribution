...
import typings.maximMazurokGapiClientDataproc.gapi.client.dataproc.AutoscalingPolicy
...
object Name {
  ...
  inline def apply(name: String, resource: AutoscalingPolicy): Name = {
  ...
  extension [Self <: Name](x: Self) {
    ...
    inline def setResource(value: AutoscalingPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
