...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: DiagnoseClusterRequest = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(clusterName: String, projectId: String, region: String, resource: DiagnoseClusterRequest): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DiagnoseClusterRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
