...
import typings.maximMazurokGapiClientDataproc.gapi.client.dataproc.Batch
...
object BatchId {
  ...
  inline def apply(parent: String, resource: Batch): BatchId = {
  ...
  extension [Self <: BatchId](x: Self) {
    ...
    inline def setResource(value: Batch): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
