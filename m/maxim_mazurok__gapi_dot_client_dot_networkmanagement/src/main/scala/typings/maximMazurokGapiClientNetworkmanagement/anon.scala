...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: ConnectivityTest = js.native
  ...
  object Accesstoken {
    ...
    @scala.inline
    def apply(parent: String, resource: ConnectivityTest): Accesstoken = {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: ConnectivityTest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    @scala.inline
    def apply(name: String, resource: ConnectivityTest): Key = {
  ...
  trait Oauthtoken extends StObject {
    ...
    /** Request body */
    var resource: RerunConnectivityTestRequest = js.native
  ...
  object Oauthtoken {
    ...
    @scala.inline
    def apply(name: String, resource: RerunConnectivityTestRequest): Oauthtoken = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: RerunConnectivityTestRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
