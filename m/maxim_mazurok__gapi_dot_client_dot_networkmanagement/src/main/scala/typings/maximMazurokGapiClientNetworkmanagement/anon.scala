...
import typings.maximMazurokGapiClientNetworkmanagement.gapi.client.networkmanagement.CancelOperationRequest
import typings.maximMazurokGapiClientNetworkmanagement.gapi.client.networkmanagement.ConnectivityTest
import typings.maximMazurokGapiClientNetworkmanagement.gapi.client.networkmanagement.RerunConnectivityTestRequest
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(parent: String, resource: ConnectivityTest): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: ConnectivityTest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    inline def apply(name: String, resource: ConnectivityTest): Key = {
  ...
  trait Oauthtoken extends StObject {
    ...
    /** Request body */
    var resource: RerunConnectivityTestRequest
  ...
  object Oauthtoken {
    ...
    inline def apply(name: String, resource: RerunConnectivityTestRequest): Oauthtoken = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: Oauthtoken](x: Self) {
      ...
      inline def setResource(value: RerunConnectivityTestRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object QuotaUser {
    ...
    inline def apply(name: String, resource: CancelOperationRequest): QuotaUser = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
