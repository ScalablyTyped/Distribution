...
import typings.maximMazurokGapiClientYoutubeanalytics.gapi.client.youtubeanalytics.Group
import typings.maximMazurokGapiClientYoutubeanalytics.gapi.client.youtubeanalytics.GroupItem
...
object anon {
  ...
  trait Alt extends StObject {
    ...
    /** Request body */
    var resource: GroupItem = js.native
  ...
  object Alt {
    ...
    @scala.inline
    def apply(resource: GroupItem): Alt = {
    ...
    implicit class AltMutableBuilder[Self <: Alt] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: GroupItem): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: Group): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
