...
object anon {
  ...
  object Alt {
    ...
    inline def apply(resource: GroupItem): Alt = {
    ...
    extension [Self <: Alt](x: Self) {
      ...
      inline def setResource(value: GroupItem): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    inline def apply(resource: Group): Key = {
      val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: Key](x: Self) {
      ...
      inline def setResource(value: Group): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
