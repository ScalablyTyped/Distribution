...
@js.native
trait GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings extends js.Object {
...
object GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings {
  ...
  @scala.inline
  implicit class GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsOps[Self <: GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings] (val x: Self) extends AnyVal {
