...
@js.native
trait GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings extends js.Object {
...
object GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings {
  ...
  @scala.inline
  implicit class GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsOps[Self <: GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings] (val x: Self) extends AnyVal {
