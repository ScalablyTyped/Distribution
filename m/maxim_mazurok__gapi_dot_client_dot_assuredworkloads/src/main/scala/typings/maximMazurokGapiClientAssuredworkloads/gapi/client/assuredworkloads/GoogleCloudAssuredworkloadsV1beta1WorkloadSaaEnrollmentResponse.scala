...
trait GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse extends StObject {
...
object GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse {
  
  inline def apply(): GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse] (val x: Self) extends AnyVal {
