...
@js.native
trait GoogleCloudAssuredworkloadsV1WorkloadResourceInfo extends js.Object {
...
object GoogleCloudAssuredworkloadsV1WorkloadResourceInfo {
  ...
  @scala.inline
  implicit class GoogleCloudAssuredworkloadsV1WorkloadResourceInfoOps[Self <: GoogleCloudAssuredworkloadsV1WorkloadResourceInfo] (val x: Self) extends AnyVal {
