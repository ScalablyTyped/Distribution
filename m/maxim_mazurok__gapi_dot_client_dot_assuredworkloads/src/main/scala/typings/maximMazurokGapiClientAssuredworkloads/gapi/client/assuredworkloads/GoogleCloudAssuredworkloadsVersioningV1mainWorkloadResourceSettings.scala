...
trait GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceSettings extends StObject {
...
object GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceSettings {
  
  inline def apply(): GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceSettings = {
