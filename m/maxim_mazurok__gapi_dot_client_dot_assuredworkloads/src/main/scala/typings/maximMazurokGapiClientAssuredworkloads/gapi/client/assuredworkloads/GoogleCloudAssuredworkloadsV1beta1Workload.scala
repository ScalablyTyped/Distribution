...
trait GoogleCloudAssuredworkloadsV1beta1Workload extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientAssuredworkloads.maximMazurokGapiClientAssuredworkloadsStrings.GoogleCloudAssuredworkloadsV1beta1Workload with TopLevel[js.Any]
  ] = js.native
