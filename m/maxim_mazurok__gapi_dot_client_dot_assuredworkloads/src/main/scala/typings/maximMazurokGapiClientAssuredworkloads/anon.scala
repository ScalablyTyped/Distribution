...
import typings.maximMazurokGapiClientAssuredworkloads.gapi.client.assuredworkloads.GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesRequest
import typings.maximMazurokGapiClientAssuredworkloads.gapi.client.assuredworkloads.GoogleCloudAssuredworkloadsV1Workload
