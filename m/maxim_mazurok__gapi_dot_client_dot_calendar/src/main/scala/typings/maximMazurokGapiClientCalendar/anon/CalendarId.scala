...
object CalendarId {
  ...
  @scala.inline
  implicit class CalendarIdMutableBuilder[Self <: CalendarId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AclRule): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
