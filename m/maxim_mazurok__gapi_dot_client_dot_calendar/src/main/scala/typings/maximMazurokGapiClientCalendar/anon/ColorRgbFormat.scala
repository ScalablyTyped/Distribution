...
object ColorRgbFormat {
  ...
  inline def apply(resource: CalendarListEntry): ColorRgbFormat = {
  ...
  extension [Self <: ColorRgbFormat](x: Self) {
    ...
    inline def setResource(value: CalendarListEntry): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
