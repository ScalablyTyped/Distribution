...
import typings.maximMazurokGapiClientCalendar.gapi.client.calendar.CalendarListEntry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ColorRgbFormat extends StObject {
...
object ColorRgbFormat {
  ...
  @scala.inline
  implicit class ColorRgbFormatMutableBuilder[Self <: ColorRgbFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CalendarListEntry): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
