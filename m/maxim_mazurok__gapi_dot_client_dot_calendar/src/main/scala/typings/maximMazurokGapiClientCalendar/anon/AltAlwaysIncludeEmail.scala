...
object AltAlwaysIncludeEmail {
  ...
  inline def apply(calendarId: String, eventId: String): AltAlwaysIncludeEmail = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AltAlwaysIncludeEmail] (val x: Self) extends AnyVal {
