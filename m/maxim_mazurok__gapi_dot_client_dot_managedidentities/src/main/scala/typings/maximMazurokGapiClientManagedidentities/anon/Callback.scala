...
object Callback {
  ...
  @scala.inline
  def apply(parent: String, resource: Domain): Callback = {
  ...
  implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Domain): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
