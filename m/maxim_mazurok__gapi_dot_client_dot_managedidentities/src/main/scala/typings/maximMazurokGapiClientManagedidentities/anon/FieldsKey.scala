...
import typings.maximMazurokGapiClientManagedidentities.gapi.client.managedidentities.Peering
...
object FieldsKey {
  ...
  inline def apply(name: String, resource: Peering): FieldsKey = {
  ...
  extension [Self <: FieldsKey](x: Self) {
    ...
    inline def setResource(value: Peering): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
