...
trait GoogleCloudSaasacceleratorManagementProvidersV1Instance extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientManagedidentities.maximMazurokGapiClientManagedidentitiesStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance & TopLevel[Any]
  ] = js.undefined
  ...
  var maintenanceSchedules: js.UndefOr[
    /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in string ]: @maxim_mazurok/gapi.client.managedidentities.gapi.client.managedidentities.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule}
    */ typings.maximMazurokGapiClientManagedidentities.maximMazurokGapiClientManagedidentitiesStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance & TopLevel[Any]
  ] = js.undefined
  ...
  var notificationParameters: js.UndefOr[
    /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in string ]: @maxim_mazurok/gapi.client.managedidentities.gapi.client.managedidentities.GoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter}
    */ typings.maximMazurokGapiClientManagedidentities.maximMazurokGapiClientManagedidentitiesStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance & TopLevel[Any]
  ] = js.undefined
