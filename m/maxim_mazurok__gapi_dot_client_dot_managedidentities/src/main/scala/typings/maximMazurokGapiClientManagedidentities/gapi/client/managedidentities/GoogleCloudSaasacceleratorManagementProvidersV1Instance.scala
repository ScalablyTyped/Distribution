...
trait GoogleCloudSaasacceleratorManagementProvidersV1Instance extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientManagedidentities.maximMazurokGapiClientManagedidentitiesStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance & TopLevel[js.Any]
  ] = js.undefined
