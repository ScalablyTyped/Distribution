...
@js.native
trait GoogleCloudManagedidentitiesV1alpha1OpMetadata extends js.Object {
...
object GoogleCloudManagedidentitiesV1alpha1OpMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudManagedidentitiesV1alpha1OpMetadataOps[Self <: GoogleCloudManagedidentitiesV1alpha1OpMetadata] (val x: Self) extends AnyVal {
