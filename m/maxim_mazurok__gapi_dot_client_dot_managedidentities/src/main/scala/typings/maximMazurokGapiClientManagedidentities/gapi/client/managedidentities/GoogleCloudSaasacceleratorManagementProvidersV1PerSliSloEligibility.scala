...
trait GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility extends StObject {
  ...
  var eligibilities: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.managedidentities.gapi.client.managedidentities.GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility} */ js.Any
  ] = js.undefined
}
