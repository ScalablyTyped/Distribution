...
@js.native
trait GoogleCloudManagedidentitiesV1beta1OpMetadata extends js.Object {
...
object GoogleCloudManagedidentitiesV1beta1OpMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudManagedidentitiesV1beta1OpMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudManagedidentitiesV1beta1OpMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudManagedidentitiesV1beta1OpMetadataOps[Self <: GoogleCloudManagedidentitiesV1beta1OpMetadata] (val x: Self) extends AnyVal {
