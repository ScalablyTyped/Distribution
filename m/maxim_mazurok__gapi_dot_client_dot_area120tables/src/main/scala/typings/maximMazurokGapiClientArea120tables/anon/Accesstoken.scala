package typings.maximMazurokGapiClientArea120tables.anon
...
trait Accesstoken extends js.Object {
  ...
  /** Request body */
  var resource: BatchCreateRowsRequest = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(parent: String, resource: BatchCreateRowsRequest): Accesstoken = {
  ...
  implicit class AccesstokenOps[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BatchCreateRowsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
