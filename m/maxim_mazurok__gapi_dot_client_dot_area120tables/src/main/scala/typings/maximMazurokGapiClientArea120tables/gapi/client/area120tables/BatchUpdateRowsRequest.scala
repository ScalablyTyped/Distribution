...
object BatchUpdateRowsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BatchUpdateRowsRequest] (val x: Self) extends AnyVal {
    ...
    inline def setRequestsVarargs(value: UpdateRowRequest*): Self = StObject.set(x, "requests", js.Array(value*))
  }
}
