...
@JSImport("mirada/dist/src/types/opencv/_hacks", "InputOutputArrayOfArrays")
@js.native
/**
...
open class InputOutputArrayOfArrays ()
  extends typings.mirada.distSrcTypesOpencvMatMod.Mat {
  /**
...
object InputOutputArrayOfArrays {
  ...
  /**
    ...
    * @param type Created matrix type.
    */
  inline def eye(size: typings.mirada.distSrcTypesOpencvTypesMod.Size, `type`: int): MatExpr = (^.asInstanceOf[js.Dynamic].applyDynamic("eye")(size.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[MatExpr]
  ...
  /**
    ...
    * @param type Created matrix type.
    */
  inline def ones(size: typings.mirada.distSrcTypesOpencvTypesMod.Size, `type`: int): MatExpr = (^.asInstanceOf[js.Dynamic].applyDynamic("ones")(size.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[MatExpr]
  ...
  /**
    ...
    * @param type Created matrix type.
    */
  inline def zeros(size: typings.mirada.distSrcTypesOpencvTypesMod.Size, `type`: int): MatExpr = (^.asInstanceOf[js.Dynamic].applyDynamic("zeros")(size.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[MatExpr]
}
