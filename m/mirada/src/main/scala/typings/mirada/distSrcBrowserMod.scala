...
object distSrcBrowserMod {
  ...
  @JSImport("mirada/dist/src/browser", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("mirada/dist/src/browser", "CameraHelper")
  @js.native
  ...
  @JSImport("mirada/dist/src/browser", "VideoReader")
  @js.native
  ...
  object VideoReader {
    ...
    @JSImport("mirada/dist/src/browser", "VideoReader.defaultOptions")
    @js.native
  ...
  object browser {
    ...
    @JSImport("mirada/dist/src/browser", "browser")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("mirada/dist/src/browser", "browser.CameraHelper")
    @js.native
    ...
    @JSImport("mirada/dist/src/browser", "browser.VideoReader")
    @js.native
  ...
  inline def getHtmlImageData(img: typings.mirada.distSrcTypesOpencvMod.Mat): ImageData = ^.asInstanceOf[js.Dynamic].applyDynamic("getHtmlImageData")(img.asInstanceOf[js.Any]).asInstanceOf[ImageData]
  ...
  inline def renderInCanvas(
    mat: typings.mirada.distSrcTypesOpencvMod.Mat,
    options: typings.mirada.distSrcBrowserCanvasRenderMod.Options
  ): HTMLCanvasElement = (^.asInstanceOf[js.Dynamic].applyDynamic("renderInCanvas")(mat.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLCanvasElement]
}
