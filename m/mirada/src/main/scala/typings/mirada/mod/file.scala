...
object file {
  ...
  @JSImport("mirada", "file")
  @js.native
  val ^ : js.Any = js.native
  
  object fileUtil {
    
    @JSImport("mirada", "file.fileUtil")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("mirada", "file.fileUtil.getFileName")
    @js.native
    ...
    @JSImport("mirada", "file.fileUtil.getFilePath")
    @js.native
    ...
    @JSImport("mirada", "file.fileUtil.isDir")
    @js.native
    ...
    @JSImport("mirada", "file.fileUtil.isFile")
    @js.native
    ...
    @JSImport("mirada", "file.fileUtil.readFile")
    @js.native
    ...
    @JSImport("mirada", "file.fileUtil.removeFile")
    @js.native
    ...
    @JSImport("mirada", "file.fileUtil.writeFile")
    @js.native
