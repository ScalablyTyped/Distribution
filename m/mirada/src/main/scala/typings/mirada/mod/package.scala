...
import typings.mirada.distSrcBrowserCanvasRenderMod.Options
...
inline def FS_ROOT: /* "/work" */ String = ^.asInstanceOf[js.Dynamic].selectDynamic("FS_ROOT").asInstanceOf[/* "/work" */ String]
...
inline def asImageData: js.Function1[/* img */ typings.mirada.distSrcTypesOpencvMod.Mat, Data] = ^.asInstanceOf[js.Dynamic].selectDynamic("asImageData").asInstanceOf[js.Function1[/* img */ typings.mirada.distSrcTypesOpencvMod.Mat, Data]]

inline def asMat(f: File): typings.mirada.distSrcTypesOpencvMod.Mat = ^.asInstanceOf[js.Dynamic].applyDynamic("asMat")(f.asInstanceOf[js.Any]).asInstanceOf[typings.mirada.distSrcTypesOpencvMod.Mat]
inline def asMat(f: typings.mirada.distSrcTypesOpencvMod.Mat): typings.mirada.distSrcTypesOpencvMod.Mat = ^.asInstanceOf[js.Dynamic].applyDynamic("asMat")(f.asInstanceOf[js.Any]).asInstanceOf[typings.mirada.distSrcTypesOpencvMod.Mat]
...
inline def compareL2(f1: File, f2: typings.mirada.distSrcTypesOpencvMod.Mat): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareL2")(f1.asInstanceOf[js.Any], f2.asInstanceOf[js.Any])).asInstanceOf[Double]
inline def compareL2(f1: File, f2: typings.mirada.distSrcTypesOpencvMod.Mat, destroyBoth: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareL2")(f1.asInstanceOf[js.Any], f2.asInstanceOf[js.Any], destroyBoth.asInstanceOf[js.Any])).asInstanceOf[Double]
inline def compareL2(f1: typings.mirada.distSrcTypesOpencvMod.Mat, f2: File): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareL2")(f1.asInstanceOf[js.Any], f2.asInstanceOf[js.Any])).asInstanceOf[Double]
inline def compareL2(f1: typings.mirada.distSrcTypesOpencvMod.Mat, f2: File, destroyBoth: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareL2")(f1.asInstanceOf[js.Any], f2.asInstanceOf[js.Any], destroyBoth.asInstanceOf[js.Any])).asInstanceOf[Double]
inline def compareL2(f1: typings.mirada.distSrcTypesOpencvMod.Mat, f2: typings.mirada.distSrcTypesOpencvMod.Mat): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareL2")(f1.asInstanceOf[js.Any], f2.asInstanceOf[js.Any])).asInstanceOf[Double]
inline def compareL2(
  f1: typings.mirada.distSrcTypesOpencvMod.Mat,
  f2: typings.mirada.distSrcTypesOpencvMod.Mat,
  destroyBoth: Boolean
): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareL2")(f1.asInstanceOf[js.Any], f2.asInstanceOf[js.Any], destroyBoth.asInstanceOf[js.Any])).asInstanceOf[Double]
...
inline def data2mat(d: MatData): typings.mirada.distSrcTypesOpencvMod.Mat = ^.asInstanceOf[js.Dynamic].applyDynamic("data2mat")(d.asInstanceOf[js.Any]).asInstanceOf[typings.mirada.distSrcTypesOpencvMod.Mat]
...
inline def decodeOrThrow(buffer: js.typedarray.ArrayBuffer): js.Promise[typings.mirada.distSrcTypesOpencvMod.ImageData] = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeOrThrow")(buffer.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.mirada.distSrcTypesOpencvMod.ImageData]]
inline def decodeOrThrow(buffer: js.typedarray.ArrayBuffer, format: String): js.Promise[typings.mirada.distSrcTypesOpencvMod.ImageData] = (^.asInstanceOf[js.Dynamic].applyDynamic("decodeOrThrow")(buffer.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.mirada.distSrcTypesOpencvMod.ImageData]]
...
inline def del(m: typings.mirada.distSrcTypesOpencvMod.EmscriptenEmbindInstance*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("del")(m.asInstanceOf[Seq[js.Any]]*).asInstanceOf[Unit]
...
inline def encodeOrThrow(data: typings.mirada.distSrcTypesOpencvMod.ImageData, format: String): js.Promise[js.typedarray.ArrayBuffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeOrThrow")(data.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.typedarray.ArrayBuffer]]
inline def encodeOrThrow(data: typings.mirada.distSrcTypesOpencvMod.ImageData, format: String, quality: Double): js.Promise[js.typedarray.ArrayBuffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeOrThrow")(data.asInstanceOf[js.Any], format.asInstanceOf[js.Any], quality.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.typedarray.ArrayBuffer]]
...
inline def fromArrayBuffer(a: js.typedarray.ArrayBuffer): js.Promise[typings.mirada.distSrcTypesOpencvMod.Mat] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromArrayBuffer")(a.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.mirada.distSrcTypesOpencvMod.Mat]]

inline def fromFile(f: String): js.Promise[typings.mirada.distSrcTypesOpencvMod.Mat] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromFile")(f.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.mirada.distSrcTypesOpencvMod.Mat]]

inline def fromInputFileElement(a: HTMLInputElement): js.Promise[js.Array[typings.mirada.distSrcTypesOpencvMod.Mat]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromInputFileElement")(a.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typings.mirada.distSrcTypesOpencvMod.Mat]]]

inline def fromUrl(f: String): js.Promise[typings.mirada.distSrcTypesOpencvMod.Mat] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromUrl")(f.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.mirada.distSrcTypesOpencvMod.Mat]]
...
inline def get(m: typings.mirada.distSrcTypesOpencvMod.Mat, x: Double, y: Double): js.Array[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(m.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any])).asInstanceOf[js.Array[Any]]
...
inline def getHtmlImageData(img: typings.mirada.distSrcTypesOpencvMod.Mat): typings.std.ImageData = ^.asInstanceOf[js.Dynamic].applyDynamic("getHtmlImageData")(img.asInstanceOf[js.Any]).asInstanceOf[typings.std.ImageData]
...
inline def map(
  mat: typings.mirada.distSrcTypesOpencvMod.Mat,
  dst: typings.mirada.distSrcTypesOpencvMod.Mat,
  fn: js.Function3[
  /* p */ typings.mirada.distSrcTypesOpencvMod.Scalar, 
  /* x */ Double, 
  /* y */ Double, 
  typings.mirada.distSrcTypesOpencvMod.Scalar
]
): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("map")(mat.asInstanceOf[js.Any], dst.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[Unit]

inline def mat2data(m: typings.mirada.distSrcTypesOpencvMod.Mat): MatData = ^.asInstanceOf[js.Dynamic].applyDynamic("mat2data")(m.asInstanceOf[js.Any]).asInstanceOf[MatData]
...
inline def noArray(): typings.mirada.distSrcTypesOpencvMod.Mat = ^.asInstanceOf[js.Dynamic].applyDynamic("noArray")().asInstanceOf[typings.mirada.distSrcTypesOpencvMod.Mat]
...
inline def pointToSize(p: typings.mirada.distSrcTypesOpencvMod.Point): typings.mirada.distSrcTypesOpencvMod.Size = ^.asInstanceOf[js.Dynamic].applyDynamic("pointToSize")(p.asInstanceOf[js.Any]).asInstanceOf[typings.mirada.distSrcTypesOpencvMod.Size]
...
inline def renderInCanvas(mat: typings.mirada.distSrcTypesOpencvMod.Mat): HTMLCanvasElement = ^.asInstanceOf[js.Dynamic].applyDynamic("renderInCanvas")(mat.asInstanceOf[js.Any]).asInstanceOf[HTMLCanvasElement]
inline def renderInCanvas(mat: typings.mirada.distSrcTypesOpencvMod.Mat, options: Options): HTMLCanvasElement = (^.asInstanceOf[js.Dynamic].applyDynamic("renderInCanvas")(mat.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLCanvasElement]
...
inline def set(
  m: typings.mirada.distSrcTypesOpencvMod.Mat,
  x: Double,
  y: Double,
  `val`: typings.mirada.distSrcTypesOpencvMod.Scalar
): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("set")(m.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], `val`.asInstanceOf[js.Any])).asInstanceOf[Unit]
...
inline def sizeToPoint(s: typings.mirada.distSrcTypesOpencvMod.Size): typings.mirada.distSrcTypesOpencvMod.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("sizeToPoint")(s.asInstanceOf[js.Any]).asInstanceOf[typings.mirada.distSrcTypesOpencvMod.Point]
...
inline def toImageData(img: typings.mirada.distSrcTypesOpencvMod.Mat): Data = ^.asInstanceOf[js.Dynamic].applyDynamic("toImageData")(img.asInstanceOf[js.Any]).asInstanceOf[Data]

inline def toRgba(mat: typings.mirada.distSrcTypesOpencvMod.Mat): typings.mirada.distSrcTypesOpencvMod.Mat = ^.asInstanceOf[js.Dynamic].applyDynamic("toRgba")(mat.asInstanceOf[js.Any]).asInstanceOf[typings.mirada.distSrcTypesOpencvMod.Mat]
inline def toRgba(mat: typings.mirada.distSrcTypesOpencvMod.Mat, dst: typings.mirada.distSrcTypesOpencvMod.Mat): typings.mirada.distSrcTypesOpencvMod.Mat = (^.asInstanceOf[js.Dynamic].applyDynamic("toRgba")(mat.asInstanceOf[js.Any], dst.asInstanceOf[js.Any])).asInstanceOf[typings.mirada.distSrcTypesOpencvMod.Mat]
