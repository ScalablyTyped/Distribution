...
import typings.mirada.anon.TypeofInputArray
...
open class InputArray ()
  extends typings.mirada.distSrcTypesOpencvTypesMod.InputArray
object InputArray {
  
  inline def apply: TypeofInputArray = ^.asInstanceOf[js.Dynamic].selectDynamic("InputArray").asInstanceOf[TypeofInputArray]
}
