...
import typings.mirada.anon.TypeofInputOutputArray
...
object InputOutputArray {
  ...
  inline def apply: TypeofInputOutputArray = ^.asInstanceOf[js.Dynamic].selectDynamic("InputOutputArray").asInstanceOf[TypeofInputOutputArray]
}
