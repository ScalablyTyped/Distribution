...
@JSGlobal("cv.OutputArrayOfArrays")
@js.native
/**
...
object OutputArrayOfArrays {
  ...
  inline def apply: TypeofOutputArrayOfArrays = ^.asInstanceOf[js.Dynamic].selectDynamic("OutputArrayOfArrays").asInstanceOf[TypeofOutputArrayOfArrays]
}
