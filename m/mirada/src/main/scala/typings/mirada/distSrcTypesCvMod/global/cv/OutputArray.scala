...
open class OutputArray ()
  extends typings.mirada.distSrcTypesOpencvTypesMod.OutputArray
object OutputArray {
  
  inline def apply: TypeofOutputArray = ^.asInstanceOf[js.Dynamic].selectDynamic("OutputArray").asInstanceOf[TypeofOutputArray]
}
