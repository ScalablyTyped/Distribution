...
import typings.mirada.anon.TypeofMat
...
/**
  ...
  */
open class Mat ()
  extends typings.mirada.distSrcTypesOpencvTypesMod.Mat
object Mat {
  
  inline def apply: TypeofMat = ^.asInstanceOf[js.Dynamic].selectDynamic("Mat").asInstanceOf[TypeofMat]
}
