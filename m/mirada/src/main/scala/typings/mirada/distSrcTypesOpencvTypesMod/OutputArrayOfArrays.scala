...
@JSImport("mirada/dist/src/types/opencv/_types", "OutputArrayOfArrays")
@js.native
/**
...
open class OutputArrayOfArrays ()
  extends typings.mirada.distSrcTypesOpencvHacksMod.OutputArrayOfArrays {
  /**
  ...
  /**
    ...
    */
  def this(m: typings.mirada.distSrcTypesOpencvMatMod.Mat, roi: Rect) = this()
  /**
    *   This is an overloaded member function, provided for convenience. It differs from the above
    * function only in what argument(s) it accepts.
    *
