...
@js.native
trait IgnoreWarnings extends js.Object {
...
object IgnoreWarnings {
  
  @scala.inline
  def apply(name: String, resource: AppProfile): IgnoreWarnings = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[IgnoreWarnings]
  }
  
  @scala.inline
  implicit class IgnoreWarningsOps[Self <: IgnoreWarnings] (val x: Self) extends AnyVal {
