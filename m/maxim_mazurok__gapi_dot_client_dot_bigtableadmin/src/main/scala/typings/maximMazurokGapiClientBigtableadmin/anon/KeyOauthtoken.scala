...
import typings.maximMazurokGapiClientBigtableadmin.gapi.client.bigtableadmin.CreateInstanceRequest
...
trait KeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: CreateInstanceRequest = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: CreateInstanceRequest): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreateInstanceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
