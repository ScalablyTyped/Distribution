...
@js.native
trait AppProfileId extends js.Object {
...
object AppProfileId {
  ...
  @scala.inline
  implicit class AppProfileIdOps[Self <: AppProfileId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AppProfile): Self = this.set("resource", value.asInstanceOf[js.Any])
