...
object AppProfileId {
  ...
  inline def apply(parent: String, resource: AppProfile): AppProfileId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AppProfileId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: AppProfile): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
