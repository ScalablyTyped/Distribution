...
import typings.maximMazurokGapiClientBigtableadmin.gapi.client.bigtableadmin.AppProfile
...
@js.native
trait AppProfileId extends StObject {
  ...
  /** Request body */
  var resource: AppProfile = js.native
...
object AppProfileId {
  ...
  @scala.inline
  def apply(parent: String, resource: AppProfile): AppProfileId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AppProfileId]
  }
  
  @scala.inline
  implicit class AppProfileIdMutableBuilder[Self <: AppProfileId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AppProfile): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
