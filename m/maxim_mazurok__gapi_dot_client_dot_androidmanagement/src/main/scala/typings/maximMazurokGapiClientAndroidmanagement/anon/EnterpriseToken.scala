...
trait EnterpriseToken extends js.Object {
  ...
  /** Request body */
  var resource: Enterprise = js.native
...
object EnterpriseToken {
  ...
  @scala.inline
  def apply(resource: Enterprise): EnterpriseToken = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[EnterpriseToken]
  }
  
  @scala.inline
  implicit class EnterpriseTokenOps[Self <: EnterpriseToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Enterprise): Self = this.set("resource", value.asInstanceOf[js.Any])
