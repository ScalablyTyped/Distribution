...
object EnterpriseToken {
  ...
  @scala.inline
  implicit class EnterpriseTokenMutableBuilder[Self <: EnterpriseToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Enterprise): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
