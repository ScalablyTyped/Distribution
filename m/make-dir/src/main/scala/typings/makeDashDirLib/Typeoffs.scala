...
trait Typeoffs extends js.Object {
  ...
  @JSName("mkdtempSync")
  def mkdtempSync_buffer(prefix: java.lang.String, options: makeDashDirLib.makeDashDirLibStrings.buffer): nodeLib.Buffer = js.native
  /**
    * Asynchronously creates a unique temporary directory.
    * Generates six random characters to be appended behind a required prefix to create a unique temporary directory.
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
  ...
  def mkdtemp_buffer(
    prefix: java.lang.String,
    options: makeDashDirLib.makeDashDirLibStrings.buffer,
    callback: js.Function2[
      /* err */ nodeLib.NodeJSNs.ErrnoException | scala.Null, 
      /* folder */ nodeLib.Buffer, 
      scala.Unit
  ...
  @JSName("readdirSync")
  def readdirSync_buffer(path: nodeLib.fsMod.PathLike, options: makeDashDirLib.makeDashDirLibStrings.buffer): js.Array[nodeLib.Buffer] = js.native
  @JSName("readdir")
  def readdir_buffer(
    path: nodeLib.fsMod.PathLike,
    options: makeDashDirLib.makeDashDirLibStrings.buffer,
  ...
  @JSName("readlinkSync")
  def readlinkSync_buffer(path: nodeLib.fsMod.PathLike, options: makeDashDirLib.makeDashDirLibStrings.buffer): nodeLib.Buffer = js.native
  @JSName("readlink")
  def readlink_buffer(
    path: nodeLib.fsMod.PathLike,
    options: makeDashDirLib.makeDashDirLibStrings.buffer,
  ...
  @JSName("realpathSync")
  def realpathSync_buffer(path: nodeLib.fsMod.PathLike, options: makeDashDirLib.makeDashDirLibStrings.buffer): nodeLib.Buffer = js.native
  @JSName("realpath")
  def realpath_buffer(
    path: nodeLib.fsMod.PathLike,
    options: makeDashDirLib.makeDashDirLibStrings.buffer,
  ...
  @JSName("watch")
  def watch_buffer(filename: nodeLib.fsMod.PathLike, options: makeDashDirLib.makeDashDirLibStrings.buffer): nodeLib.fsMod.FSWatcher = js.native
  @JSName("watch")
  def watch_buffer(
    filename: nodeLib.fsMod.PathLike,
    options: makeDashDirLib.makeDashDirLibStrings.buffer,
