...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(resource: CheckRequest, serviceName: String): Accesstoken = {
    ...
    implicit open class MutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      inline def setResource(value: CheckRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Alt {
    ...
    inline def apply(serviceName: String): Alt = {
  ...
  object Callback {
    ...
    inline def apply(resource: ReportRequest, serviceName: String): Callback = {
      val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any], serviceName = serviceName.asInstanceOf[js.Any])
