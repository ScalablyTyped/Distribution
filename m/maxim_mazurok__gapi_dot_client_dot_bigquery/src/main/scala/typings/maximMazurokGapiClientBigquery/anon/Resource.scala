...
import typings.maximMazurokGapiClientBigquery.gapi.client.bigquery.Routine
...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: Routine = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(datasetId: String, projectId: String, resource: Routine): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Routine): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
