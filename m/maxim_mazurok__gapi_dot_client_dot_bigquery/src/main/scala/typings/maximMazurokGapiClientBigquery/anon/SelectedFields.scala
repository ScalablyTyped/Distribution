...
object SelectedFields {
  ...
  inline def apply(datasetId: String, projectId: String, tableId: String): SelectedFields = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SelectedFields] (val x: Self) extends AnyVal {
