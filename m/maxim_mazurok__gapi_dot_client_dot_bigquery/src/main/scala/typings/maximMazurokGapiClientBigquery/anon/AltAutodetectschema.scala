...
trait AltAutodetectschema extends StObject {
...
object AltAutodetectschema {
  
  inline def apply(datasetId: String, projectId: String, tableId: String): AltAutodetectschema = {
    ...
    __obj.asInstanceOf[AltAutodetectschema]
  }
  
  extension [Self <: AltAutodetectschema](x: Self) {
