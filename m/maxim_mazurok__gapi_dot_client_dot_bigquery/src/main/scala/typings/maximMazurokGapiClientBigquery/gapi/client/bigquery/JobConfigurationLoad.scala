...
object JobConfigurationLoad {
  ...
  implicit class JobConfigurationLoadOps[Self <: JobConfigurationLoad] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDecimalTargetTypesVarargs(value: String*): Self = this.set("decimalTargetTypes", js.Array(value :_*))
    
    @scala.inline
    def setDecimalTargetTypes(value: js.Array[String]): Self = this.set("decimalTargetTypes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDecimalTargetTypes: Self = this.set("decimalTargetTypes", js.undefined)
