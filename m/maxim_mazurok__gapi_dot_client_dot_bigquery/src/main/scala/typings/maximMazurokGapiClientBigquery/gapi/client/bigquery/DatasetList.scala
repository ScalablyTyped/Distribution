...
trait DatasetList extends js.Object {
  ...
  /**
    ...
    */
  var datasets: js.UndefOr[js.Array[typings.maximMazurokGapiClientBigquery.anon.DatasetReference]] = js.native
...
object DatasetList {
  ...
  implicit class DatasetListOps[Self <: DatasetList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDatasetsVarargs(value: typings.maximMazurokGapiClientBigquery.anon.DatasetReference*): Self = this.set("datasets", js.Array(value :_*))
    
    @scala.inline
    def setDatasets(value: js.Array[typings.maximMazurokGapiClientBigquery.anon.DatasetReference]): Self = this.set("datasets", value.asInstanceOf[js.Any])
