...
object Table {
  ...
  implicit class TableMutableBuilder[Self <: Table] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSnapshotDefinition(value: SnapshotDefinition): Self = StObject.set(x, "snapshotDefinition", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSnapshotDefinitionUndefined: Self = StObject.set(x, "snapshotDefinition", js.undefined)
