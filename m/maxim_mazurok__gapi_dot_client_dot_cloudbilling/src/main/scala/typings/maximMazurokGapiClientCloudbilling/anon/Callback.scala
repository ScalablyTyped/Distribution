...
trait Callback extends js.Object {
  ...
  /** Request body */
  var resource: ProjectBillingInfo = js.native
...
object Callback {
  ...
  @scala.inline
  def apply(name: String, resource: ProjectBillingInfo): Callback = {
  ...
  implicit class CallbackOps[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ProjectBillingInfo): Self = this.set("resource", value.asInstanceOf[js.Any])
