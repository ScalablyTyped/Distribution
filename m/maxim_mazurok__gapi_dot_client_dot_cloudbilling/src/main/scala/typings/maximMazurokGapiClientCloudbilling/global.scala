...
object global {
  ...
  object gapi {
    ...
    object client {
      ...
      inline def load(name: cloudbilling, version: v1): PromiseLike[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(name.asInstanceOf[js.Any], version.asInstanceOf[js.Any])).asInstanceOf[PromiseLike[Unit]]
