...
object libRulesInlineStateInlineMod {
  ...
  open class ^ protected ()
    extends StObject
       with StateInline {
    def this(src: String, md: MarkdownIt, env: Any, outTokens: js.Array[typings.markdownIt.libTokenMod.^]) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def pushPending(): typings.markdownIt.libTokenMod.^ = js.native
  ...
  trait StateInline extends StObject {
    ...
    /**
      * Flush pending text
      */
    def pushPending(): typings.markdownIt.libTokenMod.^
  ...
  object StateInline {
    ...
    inline def apply(
      ...
      pushPending: () => typings.markdownIt.libTokenMod.^,
    ...
    implicit open class MutableBuilder[Self <: StateInline] (val x: Self) extends AnyVal {
      ...
      inline def setPushPending(value: () => typings.markdownIt.libTokenMod.^): Self = StObject.set(x, "pushPending", js.Any.fromFunction0(value))
