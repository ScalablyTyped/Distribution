...
import typings.markdownIt.AnonArrayReplaceAt
...
trait MarkdownIt extends js.Object {
  var block: typings.markdownIt.parserBlockMod.^ = js.native
  var core: typings.markdownIt.parserCoreMod.^ = js.native
  var helpers: js.Any = js.native
  var `inline`: typings.markdownIt.parserInlineMod.^ = js.native
  var linkify: LinkifyIt = js.native
  var renderer: typings.markdownIt.rendererMod.^ = js.native
