...
object libRendererMod {
  ...
  open class ^ ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def render(tokens: js.Array[typings.markdownIt.libTokenMod.^], options: Options, env: Any): String = js.native
    
    /**
      * Render token attributes to string.
      */
    /* CompleteClass */
    override def renderAttrs(token: typings.markdownIt.libTokenMod.^): String = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def renderInline(tokens: js.Array[typings.markdownIt.libTokenMod.^], options: Options, env: Any): String = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def renderInlineAsText(tokens: js.Array[typings.markdownIt.libTokenMod.^], options: Options, env: Any): String = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def renderToken(tokens: js.Array[typings.markdownIt.libTokenMod.^], idx: Double, options: Options): String = js.native
  ...
  trait Renderer extends StObject {
    ...
    /**
      ...
      * @param env additional data from parsed input (references, for example)
      */
    def render(tokens: js.Array[typings.markdownIt.libTokenMod.^], options: Options, env: Any): String
    
    /**
      * Render token attributes to string.
      */
    def renderAttrs(token: typings.markdownIt.libTokenMod.^): String
    ...
    /**
      ...
      * @param env additional data from parsed input (references, for example)
      */
    def renderInline(tokens: js.Array[typings.markdownIt.libTokenMod.^], options: Options, env: Any): String
    ...
    /**
      ...
      * @param env additional data from parsed input (references, for example)
      */
    def renderInlineAsText(tokens: js.Array[typings.markdownIt.libTokenMod.^], options: Options, env: Any): String
    ...
    /**
      ...
      * @param options params of parser instance
      */
    def renderToken(tokens: js.Array[typings.markdownIt.libTokenMod.^], idx: Double, options: Options): String
  ...
  object Renderer {
    ...
    inline def apply(
      render: (js.Array[typings.markdownIt.libTokenMod.^], Options, Any) => String,
      renderAttrs: typings.markdownIt.libTokenMod.^ => String,
      renderInline: (js.Array[typings.markdownIt.libTokenMod.^], Options, Any) => String,
      renderInlineAsText: (js.Array[typings.markdownIt.libTokenMod.^], Options, Any) => String,
      renderToken: (js.Array[typings.markdownIt.libTokenMod.^], Double, Options) => String,
    ...
    implicit open class MutableBuilder[Self <: Renderer] (val x: Self) extends AnyVal {
      ...
      inline def setRenderAttrs(value: typings.markdownIt.libTokenMod.^ => String): Self = StObject.set(x, "renderAttrs", js.Any.fromFunction1(value))
      
      inline def setRenderInline(value: (js.Array[typings.markdownIt.libTokenMod.^], Options, Any) => String): Self = StObject.set(x, "renderInline", js.Any.fromFunction3(value))
      
      inline def setRenderInlineAsText(value: (js.Array[typings.markdownIt.libTokenMod.^], Options, Any) => String): Self = StObject.set(x, "renderInlineAsText", js.Any.fromFunction3(value))
      
      inline def setRenderToken(value: (js.Array[typings.markdownIt.libTokenMod.^], Double, Options) => String): Self = StObject.set(x, "renderToken", js.Any.fromFunction3(value))
