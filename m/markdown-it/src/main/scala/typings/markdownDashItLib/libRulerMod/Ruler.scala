...
@js.native
trait Ruler[S /* <: markdownDashItLib.libRulesUnderscoreCoreStateUnderscoreCoreMod.namespaced */] extends js.Object {
  def after(
    afterName: java.lang.String,
    ruleName: java.lang.String,
    rule: markdownDashItLib.libMod.MarkdownItNs.Rule[S]
  ...
  def at(name: java.lang.String, rule: markdownDashItLib.libMod.MarkdownItNs.Rule[S]): scala.Unit = js.native
  def at(name: java.lang.String, rule: markdownDashItLib.libMod.MarkdownItNs.Rule[S], options: js.Any): scala.Unit = js.native
  def before(
  ...
  def getRules(chain: java.lang.String): js.Array[markdownDashItLib.libMod.MarkdownItNs.Rule[S]] = js.native
  def push(ruleName: java.lang.String, rule: markdownDashItLib.libMod.MarkdownItNs.Rule[S]): scala.Unit = js.native
  def push(ruleName: java.lang.String, rule: markdownDashItLib.libMod.MarkdownItNs.Rule[S], options: js.Any): scala.Unit = js.native
}
