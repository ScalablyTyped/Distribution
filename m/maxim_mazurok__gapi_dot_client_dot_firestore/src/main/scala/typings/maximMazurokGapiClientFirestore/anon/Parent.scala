...
import typings.maximMazurokGapiClientFirestore.gapi.client.firestore.ListCollectionIdsRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: ListCollectionIdsRequest = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: ListCollectionIdsRequest): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ListCollectionIdsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
