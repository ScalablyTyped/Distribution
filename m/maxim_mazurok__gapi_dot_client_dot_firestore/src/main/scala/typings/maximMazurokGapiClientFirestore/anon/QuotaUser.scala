...
import typings.maximMazurokGapiClientFirestore.gapi.client.firestore.BatchWriteRequest
...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: BatchWriteRequest
...
object QuotaUser {
  ...
  inline def apply(database: String, resource: BatchWriteRequest): QuotaUser = {
  ...
  implicit open class MutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: BatchWriteRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
