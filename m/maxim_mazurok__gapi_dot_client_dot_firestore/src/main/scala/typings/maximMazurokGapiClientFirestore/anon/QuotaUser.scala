...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: BatchWriteRequest = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(database: String, resource: BatchWriteRequest): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BatchWriteRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
