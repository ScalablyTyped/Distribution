...
import typings.maximMazurokGapiClientFirestore.gapi.client.firestore.PartitionQueryRequest
...
object Xgafv {
  ...
  @scala.inline
  def apply(parent: String, resource: PartitionQueryRequest): Xgafv = {
