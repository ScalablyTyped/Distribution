...
import typings.maximMazurokGapiClientFirestore.gapi.client.firestore.GoogleFirestoreAdminV1Field
...
trait Callback extends StObject {
  ...
  /** Request body */
  var resource: GoogleFirestoreAdminV1Field = js.native
...
object Callback {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleFirestoreAdminV1Field): Callback = {
  ...
  implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleFirestoreAdminV1Field): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
