...
@js.native
trait MaskfieldPaths extends js.Object {
...
object MaskfieldPaths {
  ...
  @scala.inline
  def apply(name: String): MaskfieldPaths = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[MaskfieldPaths]
  }
  
  @scala.inline
  implicit class MaskfieldPathsOps[Self <: MaskfieldPaths] (val x: Self) extends AnyVal {
