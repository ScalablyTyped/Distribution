...
@js.native
trait GoogleFirestoreAdminV1Index extends js.Object {
...
object GoogleFirestoreAdminV1Index {
  ...
  @scala.inline
  implicit class GoogleFirestoreAdminV1IndexOps[Self <: GoogleFirestoreAdminV1Index] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldsVarargs(value: GoogleFirestoreAdminV1IndexField*): Self = this.set("fields", js.Array(value :_*))
    
    @scala.inline
    def setFields(value: js.Array[GoogleFirestoreAdminV1IndexField]): Self = this.set("fields", value.asInstanceOf[js.Any])
