...
object GoogleLongrunningListOperationsResponse {
  ...
  inline def apply(): GoogleLongrunningListOperationsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleLongrunningListOperationsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleLongrunningListOperationsResponse] (val x: Self) extends AnyVal {
    
    inline def setNextPageToken(value: String): Self = StObject.set(x, "nextPageToken", value.asInstanceOf[js.Any])
    
    inline def setNextPageTokenUndefined: Self = StObject.set(x, "nextPageToken", js.undefined)
    
    inline def setOperations(value: js.Array[GoogleLongrunningOperation]): Self = StObject.set(x, "operations", value.asInstanceOf[js.Any])
