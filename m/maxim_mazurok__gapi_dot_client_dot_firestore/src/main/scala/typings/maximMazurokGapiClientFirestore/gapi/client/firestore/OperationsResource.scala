...
import typings.maximMazurokGapiClientFirestore.anon.CallbackFields
...
trait OperationsResource extends js.Object {
  ...
  def list(request: typings.maximMazurokGapiClientFirestore.anon.Filter): Request[GoogleLongrunningListOperationsResponse] = js.native
}
