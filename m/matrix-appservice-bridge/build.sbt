...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "express-rate-limit" % "6.6.0-402cf6",
  "org.scalablytyped" %%% "express-serve-static-core" % "0.1.1-87e3cc",
  "org.scalablytyped" %%% "logform" % "2.4.2-2366c7",
  "org.scalablytyped" %%% "matrix-appservice" % "1.1.0-283d78",
  "org.scalablytyped" %%% "matrix-bot-sdk" % "0.6.2-90730c",
  "org.scalablytyped" %%% "matrix-org__matrix-sdk-crypto-nodejs" % "0.1.0-beta.1-c52c4a",
  "org.scalablytyped" %%% "mime" % "3.0-dt-20220804Z-3b1911",
  "org.scalablytyped" %%% "nedb" % "1.8-dt-20211202Z-b0ca81",
