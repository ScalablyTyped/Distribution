...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "express-rate-limit" % "6.6.0-868535",
  "org.scalablytyped" %%% "express-serve-static-core" % "0.1.1-c34bb1",
  "org.scalablytyped" %%% "logform" % "2.4.2-c14d43",
  "org.scalablytyped" %%% "matrix-appservice" % "1.1.0-7be935",
  "org.scalablytyped" %%% "mime" % "3.0-dt-20220804Z-21c0d6",
  "org.scalablytyped" %%% "nedb" % "1.8-dt-20211202Z-3595fc",
