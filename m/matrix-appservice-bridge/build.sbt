...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "express-rate-limit" % "6.6.0-8f4efe",
  "org.scalablytyped" %%% "express-serve-static-core" % "0.1.1-ed8fc0",
  "org.scalablytyped" %%% "logform" % "2.4.2-2366c7",
  "org.scalablytyped" %%% "matrix-appservice" % "1.1.0-d385e3",
  "org.scalablytyped" %%% "matrix-bot-sdk" % "0.6.2-519a06",
  "org.scalablytyped" %%% "matrix-org__matrix-sdk-crypto-nodejs" % "0.1.0-beta.1-c52c4a",
  "org.scalablytyped" %%% "mime" % "3.0-dt-20220804Z-3b1911",
  "org.scalablytyped" %%% "nedb" % "1.8-dt-20211202Z-6c69fa",
