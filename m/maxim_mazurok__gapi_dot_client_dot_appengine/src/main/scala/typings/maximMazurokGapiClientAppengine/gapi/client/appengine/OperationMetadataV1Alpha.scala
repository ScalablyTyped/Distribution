...
trait OperationMetadataV1Alpha extends js.Object {
  ...
  var createVersionMetadata: js.UndefOr[CreateVersionMetadataV1Alpha] = js.native
...
object OperationMetadataV1Alpha {
  ...
  implicit class OperationMetadataV1AlphaOps[Self <: OperationMetadataV1Alpha] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateVersionMetadata(value: CreateVersionMetadataV1Alpha): Self = this.set("createVersionMetadata", value.asInstanceOf[js.Any])
