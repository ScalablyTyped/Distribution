...
trait OperationMetadataV1Beta extends StObject {
  
  var createVersionMetadata: js.UndefOr[CreateVersionMetadataV1Beta] = js.undefined
...
object OperationMetadataV1Beta {
  ...
  @scala.inline
  implicit class OperationMetadataV1BetaMutableBuilder[Self <: OperationMetadataV1Beta] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCreateVersionMetadata(value: CreateVersionMetadataV1Beta): Self = StObject.set(x, "createVersionMetadata", value.asInstanceOf[js.Any])
