...
import typings.maximMazurokGapiClientAppengine.gapi.client.appengine.Service
...
object MigrateTraffic {
  ...
  @scala.inline
  def apply(appsId: String, resource: Service, servicesId: String): MigrateTraffic = {
  ...
  @scala.inline
  implicit class MigrateTrafficMutableBuilder[Self <: MigrateTraffic] (val x: Self) extends AnyVal {
