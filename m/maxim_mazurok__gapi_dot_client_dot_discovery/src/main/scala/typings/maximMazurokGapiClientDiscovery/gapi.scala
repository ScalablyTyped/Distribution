    ...
    object discovery {
      ...
      trait RestDescription extends StObject {
        ...
        {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.RestMethod}
          */ typings.maximMazurokGapiClientDiscovery.maximMazurokGapiClientDiscoveryStrings.RestDescription with TopLevel[js.Any]
              ] = js.native
      ...
      trait RestResource extends StObject {
        ...
        var methods: js.UndefOr[
                /* import warning: importer.ImportType#apply c Unsupported type mapping: 
        {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.RestMethod}
          */ typings.maximMazurokGapiClientDiscovery.maximMazurokGapiClientDiscoveryStrings.RestResource with TopLevel[js.Any]
              ] = js.native
