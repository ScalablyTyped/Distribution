...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: RegisterDomainRequest = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: RegisterDomainRequest): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegisterDomainRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
