...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientDomains.gapi.client.domains.Registration = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(name: String, resource: typings.maximMazurokGapiClientDomains.gapi.client.domains.Registration): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientDomains.gapi.client.domains.Registration): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
