...
import typings.maximMazurokGapiClientJobs.gapi.client.jobs.BatchCreateJobsRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: BatchCreateJobsRequest
...
object Parent {
  ...
  inline def apply(parent: String, resource: BatchCreateJobsRequest): Parent = {
  ...
  implicit open class MutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: BatchCreateJobsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
