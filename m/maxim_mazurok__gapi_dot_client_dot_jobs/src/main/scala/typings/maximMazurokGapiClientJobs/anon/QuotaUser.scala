...
import typings.maximMazurokGapiClientJobs.gapi.client.jobs.SearchJobsRequest
...
trait QuotaUser extends js.Object {
  ...
  /** Request body */
  var resource: SearchJobsRequest = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(parent: String, resource: SearchJobsRequest): QuotaUser = {
  ...
  implicit class QuotaUserOps[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SearchJobsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
