...
import typings.maximMazurokGapiClientJobs.gapi.client.jobs.BatchUpdateJobsRequest
...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: BatchUpdateJobsRequest
...
object QuotaUser {
  ...
  inline def apply(parent: String, resource: BatchUpdateJobsRequest): QuotaUser = {
  ...
  extension [Self <: QuotaUser](x: Self) {
    ...
    inline def setResource(value: BatchUpdateJobsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
