...
import typings.maximMazurokGapiClientJobs.gapi.client.jobs.ClientEvent
...
object Alt {
  ...
  inline def apply(parent: String, resource: ClientEvent): Alt = {
  ...
  implicit open class MutableBuilder[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ClientEvent): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
