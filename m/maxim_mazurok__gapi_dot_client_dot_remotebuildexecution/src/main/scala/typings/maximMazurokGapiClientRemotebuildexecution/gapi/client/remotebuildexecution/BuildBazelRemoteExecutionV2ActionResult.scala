...
trait BuildBazelRemoteExecutionV2ActionResult extends StObject {
  ...
  var executionMetadata: js.UndefOr[BuildBazelRemoteExecutionV2ExecutedActionMetadata] = js.undefined
  ...
  /**
    ...
    */
  var outputDirectories: js.UndefOr[js.Array[BuildBazelRemoteExecutionV2OutputDirectory]] = js.undefined
  ...
  /**
    ...
    */
  var outputDirectorySymlinks: js.UndefOr[js.Array[BuildBazelRemoteExecutionV2OutputSymlink]] = js.undefined
  ...
  /**
    ...
    * `output_symlinks`.
    */
  var outputFileSymlinks: js.UndefOr[js.Array[BuildBazelRemoteExecutionV2OutputSymlink]] = js.undefined
  ...
  /**
    ...
    * sorted.
    */
  var outputFiles: js.UndefOr[js.Array[BuildBazelRemoteExecutionV2OutputFile]] = js.undefined
  ...
  /**
    ...
    */
  var outputSymlinks: js.UndefOr[js.Array[BuildBazelRemoteExecutionV2OutputSymlink]] = js.undefined
  ...
  var stderrDigest: js.UndefOr[BuildBazelRemoteExecutionV2Digest] = js.undefined
  ...
  var stdoutDigest: js.UndefOr[BuildBazelRemoteExecutionV2Digest] = js.undefined
...
object BuildBazelRemoteExecutionV2ActionResult {
  ...
  inline def apply(): BuildBazelRemoteExecutionV2ActionResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BuildBazelRemoteExecutionV2ActionResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BuildBazelRemoteExecutionV2ActionResult] (val x: Self) extends AnyVal {
    
    inline def setExecutionMetadata(value: BuildBazelRemoteExecutionV2ExecutedActionMetadata): Self = StObject.set(x, "executionMetadata", value.asInstanceOf[js.Any])
    ...
    inline def setOutputDirectories(value: js.Array[BuildBazelRemoteExecutionV2OutputDirectory]): Self = StObject.set(x, "outputDirectories", value.asInstanceOf[js.Any])
    ...
    inline def setStdoutDigest(value: BuildBazelRemoteExecutionV2Digest): Self = StObject.set(x, "stdoutDigest", value.asInstanceOf[js.Any])
