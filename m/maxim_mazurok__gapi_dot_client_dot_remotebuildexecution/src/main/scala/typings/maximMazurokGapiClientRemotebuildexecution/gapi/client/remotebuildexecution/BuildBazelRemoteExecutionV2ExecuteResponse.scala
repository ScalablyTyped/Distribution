...
@js.native
trait BuildBazelRemoteExecutionV2ExecuteResponse extends js.Object {
...
object BuildBazelRemoteExecutionV2ExecuteResponse {
  ...
  @scala.inline
  implicit class BuildBazelRemoteExecutionV2ExecuteResponseOps[Self <: BuildBazelRemoteExecutionV2ExecuteResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResult(value: BuildBazelRemoteExecutionV2ActionResult): Self = this.set("result", value.asInstanceOf[js.Any])
    ...
    {[ P in string ]: @maxim_mazurok/gapi.client.remotebuildexecution.gapi.client.remotebuildexecution.BuildBazelRemoteExecutionV2LogFile}
      */ typings.maximMazurokGapiClientRemotebuildexecution.maximMazurokGapiClientRemotebuildexecutionStrings.BuildBazelRemoteExecutionV2ExecuteResponse with TopLevel[js.Any]
    ): Self = this.set("serverLogs", value.asInstanceOf[js.Any])
