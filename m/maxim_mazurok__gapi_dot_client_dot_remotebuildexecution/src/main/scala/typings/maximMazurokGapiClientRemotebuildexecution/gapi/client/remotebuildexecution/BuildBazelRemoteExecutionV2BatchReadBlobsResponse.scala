...
object BuildBazelRemoteExecutionV2BatchReadBlobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BuildBazelRemoteExecutionV2BatchReadBlobsResponse] (val x: Self) extends AnyVal {
    ...
    inline def setResponsesVarargs(value: BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse*): Self = StObject.set(x, "responses", js.Array(value*))
  }
}
