...
@js.native
trait GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts extends js.Object {
...
object GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts {
  ...
  @scala.inline
  implicit class GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeoutsOps[Self <: GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts] (val x: Self) extends AnyVal {
