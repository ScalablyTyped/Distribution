...
trait Oauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest = js.native
...
object Oauthtoken {
  ...
  implicit class OauthtokenOps[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
