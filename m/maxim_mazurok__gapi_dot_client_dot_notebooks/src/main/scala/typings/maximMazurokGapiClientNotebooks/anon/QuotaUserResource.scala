...
import typings.maximMazurokGapiClientNotebooks.gapi.client.notebooks.CancelOperationRequest
...
object QuotaUserResource {
  ...
  inline def apply(name: String, resource: CancelOperationRequest): QuotaUserResource = {
