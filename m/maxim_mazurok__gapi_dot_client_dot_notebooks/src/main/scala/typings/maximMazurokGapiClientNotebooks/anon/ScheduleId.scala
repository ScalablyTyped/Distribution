...
import typings.maximMazurokGapiClientNotebooks.gapi.client.notebooks.Schedule
...
object ScheduleId {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ScheduleId] (val x: Self) extends AnyVal {
