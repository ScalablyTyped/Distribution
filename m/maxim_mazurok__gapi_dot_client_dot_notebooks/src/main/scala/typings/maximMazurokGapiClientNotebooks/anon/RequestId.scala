...
import typings.maximMazurokGapiClientNotebooks.gapi.client.notebooks.Runtime
...
object RequestId {
  ...
  inline def apply(parent: String, resource: Runtime): RequestId = {
  ...
  extension [Self <: RequestId](x: Self) {
    ...
    inline def setResource(value: Runtime): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
