...
@js.native
trait GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimSearchResponse extends js.Object {
...
object GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimSearchResponse {
  ...
  @scala.inline
  implicit class GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimSearchResponseOps[Self <: GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimSearchResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClaimsVarargs(value: GoogleFactcheckingFactchecktoolsV1alpha1Claim*): Self = this.set("claims", js.Array(value :_*))
    
    @scala.inline
    def setClaims(value: js.Array[GoogleFactcheckingFactchecktoolsV1alpha1Claim]): Self = this.set("claims", value.asInstanceOf[js.Any])
