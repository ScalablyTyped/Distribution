...
object ClientOperationId {
  ...
  inline def apply(dnsKeyId: String, managedZone: String, project: String): ClientOperationId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ClientOperationId] (val x: Self) extends AnyVal {
