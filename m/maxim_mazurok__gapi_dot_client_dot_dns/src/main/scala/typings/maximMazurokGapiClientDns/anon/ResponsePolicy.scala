...
object ResponsePolicy {
  ...
  inline def apply(project: String, responsePolicy: String): ResponsePolicy = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], responsePolicy = responsePolicy.asInstanceOf[js.Any])
