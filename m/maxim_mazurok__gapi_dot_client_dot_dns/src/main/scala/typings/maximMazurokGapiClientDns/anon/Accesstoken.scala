...
object Accesstoken {
  ...
  inline def apply(managedZone: String, project: String, resource: Change): Accesstoken = {
  ...
  implicit open class MutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: Change): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
