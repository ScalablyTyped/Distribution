...
object Key {
  ...
  inline def apply(managedZone: String, operation: String, project: String): Key = {
    val __obj = js.Dynamic.literal(managedZone = managedZone.asInstanceOf[js.Any], operation = operation.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
