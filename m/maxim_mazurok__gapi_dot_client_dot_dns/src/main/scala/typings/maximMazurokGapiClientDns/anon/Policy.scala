...
object Policy {
  ...
  inline def apply(policy: String, project: String): Policy = {
    val __obj = js.Dynamic.literal(policy = policy.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
