...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientDns.gapi.client.dns.ManagedZone = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(project: String, resource: typings.maximMazurokGapiClientDns.gapi.client.dns.ManagedZone): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typings.maximMazurokGapiClientDns.gapi.client.dns.ManagedZone): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
