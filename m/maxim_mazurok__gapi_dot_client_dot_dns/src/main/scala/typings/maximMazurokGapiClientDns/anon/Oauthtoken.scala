...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: typings.maximMazurokGapiClientDns.gapi.client.dns.ManagedZone
...
object Oauthtoken {
  ...
  inline def apply(project: String, resource: typings.maximMazurokGapiClientDns.gapi.client.dns.ManagedZone): Oauthtoken = {
  ...
  extension [Self <: Oauthtoken](x: Self) {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientDns.gapi.client.dns.ManagedZone): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
