...
object ResponsePolicyRule {
  ...
  inline def apply(project: String, responsePolicy: String, responsePolicyRule: String): ResponsePolicyRule = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], responsePolicy = responsePolicy.asInstanceOf[js.Any], responsePolicyRule = responsePolicyRule.asInstanceOf[js.Any])
