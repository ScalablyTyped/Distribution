...
@js.native
trait DnsKeysListResponse extends js.Object {
  
  /** The requested resources. */
  var dnsKeys: js.UndefOr[js.Array[DnsKey]] = js.native
...
object DnsKeysListResponse {
  ...
  @scala.inline
  implicit class DnsKeysListResponseOps[Self <: DnsKeysListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDnsKeysVarargs(value: DnsKey*): Self = this.set("dnsKeys", js.Array(value :_*))
    
    @scala.inline
    def setDnsKeys(value: js.Array[DnsKey]): Self = this.set("dnsKeys", value.asInstanceOf[js.Any])
