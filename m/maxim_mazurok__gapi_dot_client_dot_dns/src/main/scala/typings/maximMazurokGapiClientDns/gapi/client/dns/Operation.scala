...
trait Operation extends StObject {
  ...
  var dnsKeyContext: js.UndefOr[OperationDnsKeyContext] = js.undefined
  ...
  var zoneContext: js.UndefOr[OperationManagedZoneContext] = js.undefined
}
object Operation {
  ...
  implicit open class MutableBuilder[Self <: Operation] (val x: Self) extends AnyVal {
    ...
    inline def setDnsKeyContext(value: OperationDnsKeyContext): Self = StObject.set(x, "dnsKeyContext", value.asInstanceOf[js.Any])
    ...
    inline def setZoneContext(value: OperationManagedZoneContext): Self = StObject.set(x, "zoneContext", value.asInstanceOf[js.Any])
