...
@js.native
trait ManagedZoneForwardingConfigNameServerTarget extends js.Object {
...
object ManagedZoneForwardingConfigNameServerTarget {
  ...
  @scala.inline
  implicit class ManagedZoneForwardingConfigNameServerTargetOps[Self <: ManagedZoneForwardingConfigNameServerTarget] (val x: Self) extends AnyVal {
