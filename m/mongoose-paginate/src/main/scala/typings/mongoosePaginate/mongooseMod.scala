...
object mongooseMod {
  ...
  object PaginateOptions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PaginateOptions] (val x: Self) extends AnyVal {
  ...
  object PaginateResult {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PaginateResult[?], T] (val x: Self & PaginateResult[T]) extends AnyVal {
  ...
  object QueryPopulateOptions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: QueryPopulateOptions] (val x: Self) extends AnyVal {
