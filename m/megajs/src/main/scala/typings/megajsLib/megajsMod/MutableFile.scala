...
class MutableFile protected () extends File {
  ...
  def importFile(
    ...
    cb: js.Function2[/* err */ js.UndefOr[stdLib.Error], /* file */ this.type, scala.Unit]
  ): nodeLib.streamMod.Readable = js.native
  def importFile(file: File, cb: js.Function2[/* err */ js.UndefOr[stdLib.Error], /* file */ this.type, scala.Unit]): nodeLib.streamMod.Readable = js.native
  def link(
  ...
  def moveTo(target: java.lang.String, cb: js.Function1[/* err */ js.UndefOr[stdLib.Error], scala.Unit]): nodeLib.streamMod.Readable = js.native
  def moveTo(target: MutableFile, cb: js.Function1[/* err */ js.UndefOr[stdLib.Error], scala.Unit]): nodeLib.streamMod.Readable = js.native
  def rename(newFileName: java.lang.String, cb: js.Function1[/* err */ js.UndefOr[stdLib.Error], scala.Unit]): nodeLib.streamMod.Readable = js.native
  def setAttributes(attributes: js.Object, cb: js.Function1[/* err */ js.UndefOr[stdLib.Error], scala.Unit]): nodeLib.streamMod.Readable = js.native
  def setFavorite(isFavorite: scala.Boolean, cb: js.Function1[/* err */ js.UndefOr[stdLib.Error], scala.Unit]): nodeLib.streamMod.Readable = js.native
  def setLabel(label: java.lang.String, cb: js.Function1[/* err */ js.UndefOr[stdLib.Error], scala.Unit]): nodeLib.streamMod.Readable = js.native
  def shareFolder(
    options: js.UndefOr[scala.Nothing],
    cb: js.Function2[/* err */ js.UndefOr[stdLib.Error], /* url */ java.lang.String, scala.Unit]
  ): nodeLib.streamMod.Readable = js.native
