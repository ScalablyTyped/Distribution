...
object anon {
  ...
  object Accesstoken {
    ...
    @scala.inline
    def apply(pageObjectId: String, presentationId: String): Accesstoken = {
  ...
  object Alt {
    ...
    @scala.inline
    def apply(pageObjectId: String, presentationId: String): Alt = {
      val __obj = js.Dynamic.literal(pageObjectId = pageObjectId.asInstanceOf[js.Any], presentationId = presentationId.asInstanceOf[js.Any])
  ...
  trait Callback extends StObject {
    ...
    /** Request body */
    var resource: BatchUpdatePresentationRequest = js.native
  ...
  object Callback {
    ...
    @scala.inline
    def apply(presentationId: String, resource: BatchUpdatePresentationRequest): Callback = {
    ...
    implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: BatchUpdatePresentationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Fields {
    ...
    @scala.inline
    def apply(presentationId: String): Fields = {
  ...
  trait Key extends StObject {
    ...
    /** Request body */
    var resource: Presentation = js.native
  ...
  object Key {
    ...
    @scala.inline
    def apply(resource: Presentation): Key = {
    ...
    implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: Presentation): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
