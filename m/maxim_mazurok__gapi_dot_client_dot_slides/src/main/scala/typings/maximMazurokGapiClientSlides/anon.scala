...
import typings.maximMazurokGapiClientSlides.gapi.client.slides.BatchUpdatePresentationRequest
import typings.maximMazurokGapiClientSlides.gapi.client.slides.Presentation
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(pageObjectId: String, presentationId: String): Accesstoken = {
      val __obj = js.Dynamic.literal(pageObjectId = pageObjectId.asInstanceOf[js.Any], presentationId = presentationId.asInstanceOf[js.Any])
  ...
  object Alt {
    ...
    inline def apply(pageObjectId: String, presentationId: String): Alt = {
      val __obj = js.Dynamic.literal(pageObjectId = pageObjectId.asInstanceOf[js.Any], presentationId = presentationId.asInstanceOf[js.Any])
  ...
  trait Callback extends StObject {
    ...
    /** Request body */
    var resource: BatchUpdatePresentationRequest
  ...
  object Callback {
    ...
    inline def apply(presentationId: String, resource: BatchUpdatePresentationRequest): Callback = {
      val __obj = js.Dynamic.literal(presentationId = presentationId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: Callback](x: Self) {
      ...
      inline def setResource(value: BatchUpdatePresentationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Fields {
    ...
    inline def apply(presentationId: String): Fields = {
      val __obj = js.Dynamic.literal(presentationId = presentationId.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    inline def apply(resource: Presentation): Key = {
    ...
    extension [Self <: Key](x: Self) {
      ...
      inline def setResource(value: Presentation): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
