...
Instantiable1[/* elements */ elementType, typings.mediumDashEditor.MediumEditor.MediumEditor]
     with Instantiable2[
      /* elements */ elementType, 
      /* options */ CoreOptions, 
      typings.mediumDashEditor.MediumEditor.MediumEditor
    ] {
  // Properties
  ...
  // Selection Functions
  def checkSelection(): typings.mediumDashEditor.MediumEditor.MediumEditor = js.native
  ...
  // Static Function
  def getEditorFromElement(element: HTMLElement): typings.mediumDashEditor.MediumEditor.MediumEditor = js.native
  ...
  def off(
    ...
    useCapture: Boolean
  ): typings.mediumDashEditor.MediumEditor.MediumEditor = js.native
  def off(
    targets: NodeList,
    event: String,
    listener: EventListenerOrEventListenerObject,
  ...
  def subscribe(name: String, listener: js.Function2[/* data */ js.Any, /* editable */ HTMLElement, Unit]): typings.mediumDashEditor.MediumEditor.MediumEditor = js.native
  def trigger(name: String, data: js.Any, editable: HTMLElement): typings.mediumDashEditor.MediumEditor.MediumEditor = js.native
  def unsubscribe(name: String, listener: js.Function2[/* data */ js.Any, /* editable */ HTMLElement, Unit]): typings.mediumDashEditor.MediumEditor.MediumEditor = js.native
}
