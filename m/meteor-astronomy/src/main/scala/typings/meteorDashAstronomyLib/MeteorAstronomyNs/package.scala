...
package object MeteorAstronomyNs {
  ...
  type FunctionPropertyNames[T] = /* import warning: ImportType.apply Failed type conversion: {typemapped}[keyof T] */ js.Any
  ...
  type NonFunctionPropertyNames[T] = /* import warning: ImportType.apply Failed type conversion: {typemapped}[keyof T] */ js.Any
