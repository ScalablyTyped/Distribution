...
@js.native
trait Anon_GetModifiedValues[T] extends js.Object {
  ...
  def getModifiedValues(options: Anon_Raw): stdLib.Partial[T] = js.native
  ...
  def set(fields: stdLib.Partial[T], options: Anon_Merge): scala.Unit = js.native
