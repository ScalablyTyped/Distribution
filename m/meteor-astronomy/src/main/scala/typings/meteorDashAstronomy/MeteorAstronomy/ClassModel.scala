...
import typings.meteorDashAstronomy.Anon_Insert
import typings.meteorDashAstronomy.meteorDashAstronomyStrings._id
...
trait ClassModel[T] extends js.Object {
  ...
  var name: String
  var secured: js.UndefOr[Anon_Insert | Boolean] = js.undefined
}
