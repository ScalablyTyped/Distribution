...
object ListInstanceConfigsResponse {
  ...
  extension [Self <: ListInstanceConfigsResponse](x: Self) {
    ...
    inline def setInstanceConfigsVarargs(value: InstanceConfig*): Self = StObject.set(x, "instanceConfigs", js.Array(value :_*))
