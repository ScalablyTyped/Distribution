...
trait CallbackFields extends StObject {
  ...
  /** Request body */
  var resource: PartitionReadRequest = js.native
...
object CallbackFields {
  ...
  @scala.inline
  def apply(resource: PartitionReadRequest, session: String): CallbackFields = {
  ...
  implicit class CallbackFieldsMutableBuilder[Self <: CallbackFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PartitionReadRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
