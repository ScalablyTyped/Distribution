...
trait EncryptionConfigencryptionType extends StObject {
...
object EncryptionConfigencryptionType {
  
  inline def apply(parent: String): EncryptionConfigencryptionType = {
