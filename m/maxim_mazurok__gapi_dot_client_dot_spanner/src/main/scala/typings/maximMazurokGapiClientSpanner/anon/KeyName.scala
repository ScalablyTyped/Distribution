...
import typings.maximMazurokGapiClientSpanner.gapi.client.spanner.UpdateInstanceRequest
...
trait KeyName extends StObject {
  ...
  /** Request body */
  var resource: UpdateInstanceRequest
...
object KeyName {
  ...
  inline def apply(name: String, resource: UpdateInstanceRequest): KeyName = {
  ...
  extension [Self <: KeyName](x: Self) {
    ...
    inline def setResource(value: UpdateInstanceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
