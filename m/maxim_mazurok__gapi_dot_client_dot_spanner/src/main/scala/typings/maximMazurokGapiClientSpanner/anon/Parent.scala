...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: CreateDatabaseRequest = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: CreateDatabaseRequest): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreateDatabaseRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
