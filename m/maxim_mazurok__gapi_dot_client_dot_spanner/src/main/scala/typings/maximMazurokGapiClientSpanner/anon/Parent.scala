...
import typings.maximMazurokGapiClientSpanner.gapi.client.spanner.CreateDatabaseRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: CreateDatabaseRequest
...
object Parent {
  ...
  inline def apply(parent: String, resource: CreateDatabaseRequest): Parent = {
  ...
  extension [Self <: Parent](x: Self) {
    ...
    inline def setResource(value: CreateDatabaseRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
