...
class Rectangle protected ()
  ...
  /**
    ...
    */
  def this(measurement: makerDotJsLib.MakerJsNs.IMeasure) = this()
  /**
    ...
    */
  def this(modelToSurround: makerDotJsLib.MakerJsNs.IModel) = this()
  ...
  @JSName("origin")
  var origin_Rectangle: makerDotJsLib.MakerJsNs.IPoint = js.native
  @JSName("paths")
  var paths_Rectangle: makerDotJsLib.MakerJsNs.IPathMap = js.native
}
