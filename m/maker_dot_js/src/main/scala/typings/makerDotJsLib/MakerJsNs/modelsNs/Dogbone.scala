...
class Dogbone protected ()
  ...
  def this(width: scala.Double, height: scala.Double, radius: scala.Double, style: scala.Double) = this()
  def this(width: scala.Double, height: scala.Double, radius: scala.Double, style: scala.Double, bottomless: scala.Boolean) = this()
  @JSName("paths")
  var paths_Dogbone: makerDotJsLib.MakerJsNs.IPathMap = js.native
}
