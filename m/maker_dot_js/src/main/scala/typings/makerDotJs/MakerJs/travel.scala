...
object travel extends js.Object {
  /**
    ...
    */
  def apply(modelContext: IModel, routeKeyOrRoute: String): Anon_Offset = js.native
  def apply(modelContext: IModel, routeKeyOrRoute: js.Array[String]): Anon_Offset = js.native
}
