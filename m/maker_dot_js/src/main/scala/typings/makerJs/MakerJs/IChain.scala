...
object IChain {
  ...
  inline def apply(links: js.Array[IChainLink], pathLength: Double): IChain = {
  ...
  extension [Self <: IChain](x: Self) {
    ...
    inline def setLinksVarargs(value: IChainLink*): Self = StObject.set(x, "links", js.Array(value :_*))
