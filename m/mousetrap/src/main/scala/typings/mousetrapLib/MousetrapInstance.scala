...
trait MousetrapInstance extends js.Object {
  ...
  def trigger(keys: java.lang.String): this.type = js.native
  def trigger(keys: java.lang.String, action: java.lang.String): this.type = js.native
  def unbind(keys: java.lang.String): this.type = js.native
  def unbind(keys: java.lang.String, action: java.lang.String): this.type = js.native
  def unbind(keys: js.Array[java.lang.String]): this.type = js.native
  def unbind(keys: js.Array[java.lang.String], action: java.lang.String): this.type = js.native
}
