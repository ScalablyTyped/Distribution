...
@JSImport("monocle-ts/es6", "Optional")
@js.native
...
object Optional extends js.Object {
  ...
  def fromNullableProp[S](): js.Function1[
    /* k */ java.lang.String, 
    monocleDashTsLib.es6Mod.Optional[
      S, 
      stdLib.NonNullable[/* import warning: ImportType.apply Failed type conversion: S[keyof S] */ js.Any]
    ]
  ] = js.native
  def fromNullableProp[S, A /* <: /* import warning: ImportType.apply Failed type conversion: S[K] */ js.Any */, K /* <: java.lang.String */](k: K): monocleDashTsLib.es6Mod.Optional[
    S, 
  ...
  def fromOptionProp[S](): js.Function1[
    /* prop */ monocleDashTsLib.es6Mod.OptionPropertyNames[S], 
    monocleDashTsLib.es6Mod.Optional[
      S, 
      monocleDashTsLib.es6Mod.OptionPropertyType[S, monocleDashTsLib.es6Mod.OptionPropertyNames[S]]
    ]
  ] = js.native
  def fromOptionProp[S](prop: monocleDashTsLib.es6Mod.OptionPropertyNames[S]): monocleDashTsLib.es6Mod.Optional[
    S, 
    monocleDashTsLib.es6Mod.OptionPropertyType[S, /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof prop */ _]
  ] = js.native
}
