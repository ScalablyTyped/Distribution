...
object Lens extends js.Object {
  ...
  def fromNullableProp[S](): js.Function2[
    ...
    monocleDashTsLib.es6Mod.Lens[
      S, 
      stdLib.NonNullable[/* import warning: ImportType.apply Failed type conversion: S[keyof S] */ js.Any]
    ]
  ] = js.native
  def fromNullableProp[S, A /* <: /* import warning: ImportType.apply Failed type conversion: S[K] */ js.Any */, K /* <: java.lang.String */](k: K, defaultValue: A): monocleDashTsLib.es6Mod.Lens[
    S, 
  ...
  /**
    ...
    */
  def fromPath[S](): monocleDashTsLib.es6Mod.LensFromPath[S] = js.native
  def fromPath[S, K1 /* <: java.lang.String */](path: js.Array[K1]): monocleDashTsLib.es6Mod.Lens[S, /* import warning: ImportType.apply Failed type conversion: S[K1] */ js.Any] = js.native
  def fromPath[S, K1 /* <: java.lang.String */, K2 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1] */ js.Any */](path: js.Tuple2[K1, K2]): monocleDashTsLib.es6Mod.Lens[S, /* import warning: ImportType.apply Failed type conversion: S[K1][K2] */ js.Any] = js.native
  def fromPath[S, K1 /* <: java.lang.String */, K2 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1] */ js.Any */, K3 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1][K2] */ js.Any */](path: js.Tuple3[K1, K2, K3]): monocleDashTsLib.es6Mod.Lens[
    S, 
    /* import warning: ImportType.apply Failed type conversion: S[K1][K2][K3] */ js.Any
  ] = js.native
  def fromPath[S, K1 /* <: java.lang.String */, K2 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1] */ js.Any */, K3 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1][K2] */ js.Any */, K4 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1][K2][K3] */ js.Any */](path: js.Tuple4[K1, K2, K3, K4]): monocleDashTsLib.es6Mod.Lens[
    S, 
    /* import warning: ImportType.apply Failed type conversion: S[K1][K2][K3][K4] */ js.Any
  ] = js.native
  def fromPath[S, K1 /* <: java.lang.String */, K2 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1] */ js.Any */, K3 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1][K2] */ js.Any */, K4 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1][K2][K3] */ js.Any */, K5 /* <: /* import warning: ImportType.apply Failed type conversion: keyof S[K1][K2][K3][K4] */ js.Any */](path: js.Tuple5[K1, K2, K3, K4, K5]): monocleDashTsLib.es6Mod.Lens[
    S, 
  ...
  def fromProp[S, P /* <: java.lang.String */](prop: P): monocleDashTsLib.es6Mod.Lens[S, /* import warning: ImportType.apply Failed type conversion: S[P] */ js.Any] = js.native
  /**
