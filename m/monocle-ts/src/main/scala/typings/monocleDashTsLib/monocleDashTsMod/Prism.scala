...
object Prism extends js.Object {
  def fromPredicate[A](predicate: fpDashTsLib.libFunctionMod.Predicate[A]): monocleDashTsLib.monocleDashTsMod.Prism[A, A] = js.native
  @JSName("fromPredicate")
  def fromPredicate_SAS[S, A /* <: S */](refinement: fpDashTsLib.libFunctionMod.Refinement[S, A]): monocleDashTsLib.monocleDashTsMod.Prism[S, A] = js.native
  /**
    * Use `fromPredicate` instead
    * @deprecated
    */
  def fromRefinement[S, A /* <: S */](refinement: fpDashTsLib.libFunctionMod.Refinement[S, A]): monocleDashTsLib.monocleDashTsMod.Prism[S, A] = js.native
  def some[A](): monocleDashTsLib.monocleDashTsMod.Prism[fpDashTsLib.libOptionMod.Option[A], A] = js.native
}
