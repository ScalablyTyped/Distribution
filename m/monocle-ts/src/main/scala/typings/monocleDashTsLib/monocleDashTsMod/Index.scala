...
object Index extends js.Object {
  def fromAt[T, J, B](at: monocleDashTsLib.monocleDashTsMod.At[T, J, fpDashTsLib.libOptionMod.Option[B]]): monocleDashTsLib.monocleDashTsMod.Index[T, J, B] = js.native
}
