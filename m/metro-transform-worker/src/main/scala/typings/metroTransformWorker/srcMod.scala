...
object srcMod {
  ...
  @JSImport("metro-transform-worker/src", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashmodule
    - typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashmoduleSlashasset
    - typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashscript
  */
  trait BytecodeFileType extends StObject
  object BytecodeFileType {
    
    inline def bytecodeSlashmodule: typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashmodule = "bytecode/module".asInstanceOf[typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashmodule]
    
    inline def bytecodeSlashmoduleSlashasset: typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashmoduleSlashasset = "bytecode/module/asset".asInstanceOf[typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashmoduleSlashasset]
    
    inline def bytecodeSlashscript: typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashscript = "bytecode/script".asInstanceOf[typings.metroTransformWorker.metroTransformWorkerStrings.bytecodeSlashscript]
  }
  ...
  */
  ...
  /* Inlined std.Readonly<{  data :std.Readonly<{  code :string,   lineCount :number,   map :std.Array</ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify MetroSourceMapSegmentTuple * / any>,   functionMap :/ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FBSourceFunctionMap * / any | null}>,   type :metro-transform-worker.metro-transform-worker/src.JSFileType}> */
  ...
  /* Inlined std.Readonly<{  customTransformOptions :/ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CustomTransformOptions * / any | undefined,   dev :boolean,   experimentalImportSupport :boolean | undefined,   hot :boolean,   inlinePlatform :boolean,   inlineRequires :boolean,   minify :boolean,   nonInlinedRequires :std.ReadonlyArray<string> | undefined,   platform :string | undefined,   runtimeBytecodeVersion :number | undefined,   type :metro-transform-worker.metro-transform-worker/src.Type,   unstable_disableES6Transforms :boolean | undefined,   unstable_transformProfile :/ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TransformProfile * / any}> */
  trait JsTransformOptions extends StObject {
    
    val customTransformOptions: js.UndefOr[
  ...
  trait JsTransformerConfig extends StObject {
    ...
    val unstable_allowRequireContext: Boolean
  ...
  object JsTransformerConfig {
    ...
    implicit open class MutableBuilder[Self <: JsTransformerConfig] (val x: Self) extends AnyVal {
      ...
      inline def setUnstable_allowRequireContext(value: Boolean): Self = StObject.set(x, "unstable_allowRequireContext", value.asInstanceOf[js.Any])
  ...
  type Minifier = js.Function1[/* options */ MinifierOptions, MinifierResult | js.Promise[MinifierResult]]
  ...
  trait MinifierOptions extends StObject {
    ...
    var map: js.UndefOr[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify BasicSourceMap */ Any
      ] = js.undefined
  ...
  object MinifierOptions {
    ...
    implicit open class MutableBuilder[Self <: MinifierOptions] (val x: Self) extends AnyVal {
      ...
      inline def setMap(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify BasicSourceMap */ Any
  ...
  /* Inlined std.Readonly<{  dependencies :std.ReadonlyArray</ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TransformResultDependency * / any>,   output :std.ReadonlyArray<metro-transform-worker.metro-transform-worker/src.JsOutput | metro-transform-worker.metro-transform-worker/src.BytecodeOutput>}> */
