...
object MigrationJobId {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MigrationJobId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: typings.maximMazurokGapiClientDatamigration.gapi.client.datamigration.MigrationJob): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
