...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: ConnectionProfile): Accesstoken = {
  ...
  extension [Self <: Accesstoken](x: Self) {
    ...
    inline def setResource(value: ConnectionProfile): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
