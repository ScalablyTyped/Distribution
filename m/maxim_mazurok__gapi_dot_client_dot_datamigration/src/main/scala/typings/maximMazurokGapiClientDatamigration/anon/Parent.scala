...
trait Parent extends StObject {
  ...
  var migrationJobId: js.UndefOr[String] = js.native
...
object Parent {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMigrationJobId(value: String): Self = StObject.set(x, "migrationJobId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMigrationJobIdUndefined: Self = StObject.set(x, "migrationJobId", js.undefined)
