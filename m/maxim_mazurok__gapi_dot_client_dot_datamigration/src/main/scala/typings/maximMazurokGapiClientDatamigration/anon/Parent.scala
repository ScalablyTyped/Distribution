...
object Parent {
  ...
  implicit class ParentOps[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMigrationJobId(value: String): Self = this.set("migrationJobId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMigrationJobId: Self = this.set("migrationJobId", js.undefined)
