...
trait GoogleCloudClouddmsV1OperationMetadata extends StObject {
...
object GoogleCloudClouddmsV1OperationMetadata {
  
  inline def apply(): GoogleCloudClouddmsV1OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudClouddmsV1OperationMetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudClouddmsV1OperationMetadata] (val x: Self) extends AnyVal {
