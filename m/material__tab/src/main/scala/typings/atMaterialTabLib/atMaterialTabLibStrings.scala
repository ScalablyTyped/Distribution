package typings
package atMaterialTabLib

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object atMaterialTabLibStrings {
  @js.native
  sealed trait `aria-selected` extends js.Object
  
  @js.native
  sealed trait `mdc-tab--active` extends js.Object
  
  @js.native
  sealed trait `mdc-tab--animating-activate` extends js.Object
