...
import typings.materialTab.materialTabStrings.`mdc-tab--active`
import typings.materialTab.materialTabStrings.`mdc-tab--animating-activate`
import typings.materialTab.materialTabStrings.`mdc-tab--animating-deactivate`
