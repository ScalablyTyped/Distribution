...
trait AccesstokenAlt extends js.Object {
  ...
  /** Request body */
  var resource: GoogleCloudDatacatalogV1beta1TagTemplateField = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudDatacatalogV1beta1TagTemplateField): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltOps[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDatacatalogV1beta1TagTemplateField): Self = this.set("resource", value.asInstanceOf[js.Any])
