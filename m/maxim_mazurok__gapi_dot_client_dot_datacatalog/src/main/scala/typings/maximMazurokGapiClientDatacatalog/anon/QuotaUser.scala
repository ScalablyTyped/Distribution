...
import typings.maximMazurokGapiClientDatacatalog.gapi.client.datacatalog.GoogleCloudDatacatalogV1Entry
...
object QuotaUser {
  ...
  inline def apply(name: String, resource: GoogleCloudDatacatalogV1Entry): QuotaUser = {
