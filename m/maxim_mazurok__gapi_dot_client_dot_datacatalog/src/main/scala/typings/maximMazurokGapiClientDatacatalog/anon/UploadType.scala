...
trait UploadType extends StObject {
  ...
  /**
    ...
    * characters.
    */
  var entryGroupId: js.UndefOr[String] = js.native
...
object UploadType {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntryGroupId(value: String): Self = StObject.set(x, "entryGroupId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEntryGroupIdUndefined: Self = StObject.set(x, "entryGroupId", js.undefined)
