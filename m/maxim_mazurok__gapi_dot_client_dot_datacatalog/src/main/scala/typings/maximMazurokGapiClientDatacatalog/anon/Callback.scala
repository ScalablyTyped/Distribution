...
object Callback {
  ...
  implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSqlResource(value: String): Self = StObject.set(x, "sqlResource", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSqlResourceUndefined: Self = StObject.set(x, "sqlResource", js.undefined)
