...
trait Callback extends js.Object {
  ...
  /**
    ...
    */
  var sqlResource: js.UndefOr[String] = js.native
...
object Callback {
  ...
  implicit class CallbackOps[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSqlResource(value: String): Self = this.set("sqlResource", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSqlResource: Self = this.set("sqlResource", js.undefined)
