...
object SerializedTaxonomies {
  ...
  inline def apply(parent: String): SerializedTaxonomies = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[SerializedTaxonomies]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SerializedTaxonomies] (val x: Self) extends AnyVal {
    ...
    inline def setTaxonomies(value: String | js.Array[String]): Self = StObject.set(x, "taxonomies", value.asInstanceOf[js.Any])
