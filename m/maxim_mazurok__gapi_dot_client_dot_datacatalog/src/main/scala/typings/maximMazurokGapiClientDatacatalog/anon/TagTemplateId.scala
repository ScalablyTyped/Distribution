...
trait TagTemplateId extends StObject {
...
object TagTemplateId {
  ...
  @scala.inline
  implicit class TagTemplateIdMutableBuilder[Self <: TagTemplateId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDatacatalogV1beta1TagTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTagTemplateId(value: String): Self = StObject.set(x, "tagTemplateId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTagTemplateIdUndefined: Self = StObject.set(x, "tagTemplateId", js.undefined)
