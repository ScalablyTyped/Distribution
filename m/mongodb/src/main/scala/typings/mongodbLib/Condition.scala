...
trait Condition[T, P /* <: java.lang.String */]
  ...
  var $and: js.UndefOr[
    js.Array[
      _ | (/* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(P))) */js.Any)
    ]
  ] = js.undefined
  @JSName("$bitsAllClear")
  ...
  @JSName("$text")
  var $text: js.UndefOr[Anon_Search] = js.undefined
  @JSName("$where")
  var $where: js.Object
}
