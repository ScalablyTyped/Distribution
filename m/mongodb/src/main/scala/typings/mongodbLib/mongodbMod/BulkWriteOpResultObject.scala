...
object BulkWriteOpResultObject {
  ...
  def apply(
    ...
    insertedCount: scala.Int | scala.Double = null,
    insertedIds: js.Any = null,
    matchedCount: scala.Int | scala.Double = null,
    modifiedCount: scala.Int | scala.Double = null,
    result: js.Any = null,
    upsertedCount: scala.Int | scala.Double = null,
