...
import typings.mongodb.Anon_BatchSizeReadPreference
import typings.mongodb.Anon_BypassDocumentValidation
import typings.mongodb.Anon_DropTargetSession
import typings.mongodb.Anon_FullSession
import typings.mongodb.Anon_MaxTimeMSNumber
import typings.mongodb.Anon_MaxTimeMSReadPreference
import typings.mongodb.Anon_MaxTimeMSSession
import typings.mongodb.Anon_Multi
...
trait Collection[TSchema] extends js.Object {
  ...
  def deleteOne(filter: FilterQuery[TSchema], options: CommonOptions with Anon_BypassDocumentValidation): js.Promise[DeleteWriteOpResultObject] = js.native
  def deleteOne(
    filter: FilterQuery[TSchema],
  ...
  def distinct(
    ...
    options: Anon_MaxTimeMSReadPreference,
    callback: MongoCallback[_]
  ): Unit = js.native
  ...
  def group(
    ...
    finalize: js.Function,
    command: Boolean,
    options: Anon_ReadPreferenceSession
  ): js.Promise[_] = js.native
  def group(
    keys: js.Array[_],
    condition: js.Object,
  ...
  def indexInformation(options: Anon_FullSession): js.Promise[_] = js.native
  def indexInformation(options: Anon_FullSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def rename(newName: String, options: Anon_DropTargetSession): js.Promise[Collection[TSchema]] = js.native
  def rename(newName: String, options: Anon_DropTargetSession, callback: MongoCallback[Collection[TSchema]]): Unit = js.native
