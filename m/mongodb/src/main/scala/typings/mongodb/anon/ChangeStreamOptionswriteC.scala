...
import typings.mongodb.mod.CollationOptions
import typings.mongodb.mod.ExplainVerbosityLike
import typings.mongodb.mod.Hint
import typings.mongodb.mod.OperationTime
import typings.mongodb.mod.ReadConcernLike
import typings.mongodb.mod.ReadPreferenceLike
import typings.mongodb.mod.ResumeToken
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined mongodb.mongodb.ChangeStreamOptions & {  writeConcern :never | undefined} */
trait ChangeStreamOptionswriteC extends StObject {
  ...
  var writeConcern: js.UndefOr[scala.Nothing] = js.undefined
}
object ChangeStreamOptionswriteC {
  
  inline def apply(): ChangeStreamOptionswriteC = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChangeStreamOptionswriteC]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChangeStreamOptionswriteC] (val x: Self) extends AnyVal {
