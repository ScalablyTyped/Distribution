...
object `5` {
  @scala.inline
  def apply[/* <: org.scalablytyped.runtime.StringDictionary[js.Any] */ TSchema](_id: ExtractIdType[TSchema]): `5`[TSchema] = {
    val __obj = js.Dynamic.literal(_id = _id.asInstanceOf[js.Any])
    __obj.asInstanceOf[`5`[TSchema]]
  }
  @scala.inline
  implicit class `5Ops`[Self <: `5`[_], /* <: org.scalablytyped.runtime.StringDictionary[js.Any] */ TSchema] (val x: Self with `5`[TSchema]) extends AnyVal {
    @scala.inline
