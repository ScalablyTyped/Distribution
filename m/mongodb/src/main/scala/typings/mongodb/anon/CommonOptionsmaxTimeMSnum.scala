...
trait CommonOptionsmaxTimeMSnum extends StObject {
...
object CommonOptionsmaxTimeMSnum {
  ...
  @scala.inline
  implicit class CommonOptionsmaxTimeMSnumMutableBuilder[Self <: CommonOptionsmaxTimeMSnum] (val x: Self) extends AnyVal {
