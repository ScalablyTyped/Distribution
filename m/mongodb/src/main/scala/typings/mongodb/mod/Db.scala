...
class Db protected () extends EventEmitter {
  ...
  def executeDbAdminCommand(command: js.Object, options: typings.mongodb.anon.ReadPreference): js.Promise[_] = js.native
  def executeDbAdminCommand(command: js.Object, options: typings.mongodb.anon.ReadPreference, callback: MongoCallback[_]): Unit = js.native
