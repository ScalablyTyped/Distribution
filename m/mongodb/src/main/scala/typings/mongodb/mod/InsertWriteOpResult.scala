...
object InsertWriteOpResult {
  @scala.inline
  def apply[/* <: typings.mongodb.anon.IdAny */ TSchema](
    connection: js.Any,
  ...
  @scala.inline
  implicit class InsertWriteOpResultOps[Self <: InsertWriteOpResult[_], /* <: typings.mongodb.anon.IdAny */ TSchema] (val x: Self with InsertWriteOpResult[TSchema]) extends AnyVal {
    @scala.inline
