...
object ChangeEvent {
  ...
  inline def ChangeEventCR[TSchema /* <: js.Object */](
    _id: ResumeToken,
  ...
  inline def ChangeEventDelete[TSchema /* <: js.Object */](_id: ResumeToken, clusterTime: typings.bson.mod.Timestamp, documentKey: `5`[TSchema], ns: Coll): typings.mongodb.mod.ChangeEventDelete[TSchema] = {
  ...
  inline def ChangeEventInvalidate[TSchema /* <: js.Object */](_id: ResumeToken, clusterTime: typings.bson.mod.Timestamp): typings.mongodb.mod.ChangeEventInvalidate[TSchema] = {
  ...
  inline def ChangeEventOther[TSchema /* <: js.Object */](
    _id: ResumeToken,
    clusterTime: typings.bson.mod.Timestamp,
    ns: Coll,
  ...
  inline def ChangeEventRename[TSchema /* <: js.Object */](_id: ResumeToken, clusterTime: typings.bson.mod.Timestamp, ns: Coll, to: Coll): typings.mongodb.mod.ChangeEventRename[TSchema] = {
  ...
  inline def ChangeEventUpdate[TSchema /* <: js.Object */](
    _id: ResumeToken,
    clusterTime: typings.bson.mod.Timestamp,
    documentKey: `5`[TSchema],
    ns: Coll,
