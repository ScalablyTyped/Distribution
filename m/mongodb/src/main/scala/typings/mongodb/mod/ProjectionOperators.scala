...
object ProjectionOperators {
  ...
  inline def apply(): ProjectionOperators = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectionOperators]
  }
  
  extension [Self <: ProjectionOperators](x: Self) {
    ...
    inline def set$meta(value: MetaProjectionOperators): Self = StObject.set(x, "$meta", value.asInstanceOf[js.Any])
    
    inline def set$metaUndefined: Self = StObject.set(x, "$meta", js.undefined)
    
    inline def set$slice(value: scala.Double | (js.Tuple2[scala.Double, scala.Double])): Self = StObject.set(x, "$slice", value.asInstanceOf[js.Any])
