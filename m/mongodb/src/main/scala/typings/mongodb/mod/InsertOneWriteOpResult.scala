...
object InsertOneWriteOpResult {
  ...
  @scala.inline
  implicit class InsertOneWriteOpResultOps[Self <: InsertOneWriteOpResult[_], /* <: typings.mongodb.anon.IdAny */ TSchema] (val x: Self with InsertOneWriteOpResult[TSchema]) extends AnyVal {
    @scala.inline
