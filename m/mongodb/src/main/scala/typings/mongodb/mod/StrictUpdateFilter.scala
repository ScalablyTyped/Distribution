...
trait StrictUpdateFilter[TSchema]
  extends StObject
     with Document {
  ...
  @JSName("$max")
  var $max: js.UndefOr[StrictMatchKeysAndValues[TSchema]] = js.undefined
  
  @JSName("$min")
  var $min: js.UndefOr[StrictMatchKeysAndValues[TSchema]] = js.undefined
  ...
  @JSName("$set")
  var $set: js.UndefOr[StrictMatchKeysAndValues[TSchema]] = js.undefined
  
  @JSName("$setOnInsert")
  var $setOnInsert: js.UndefOr[StrictMatchKeysAndValues[TSchema]] = js.undefined
  
  @JSName("$unset")
  var $unset: js.UndefOr[OnlyFieldsOfType[TSchema, Any, _empty | `true` | `1`]] = js.undefined
}
object StrictUpdateFilter {
  
  inline def apply[TSchema](): StrictUpdateFilter[TSchema] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StrictUpdateFilter[TSchema]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StrictUpdateFilter[?], TSchema] (val x: Self & StrictUpdateFilter[TSchema]) extends AnyVal {
    ...
    inline def set$max(value: StrictMatchKeysAndValues[TSchema]): Self = StObject.set(x, "$max", value.asInstanceOf[js.Any])
    
    inline def set$maxUndefined: Self = StObject.set(x, "$max", js.undefined)
    
    inline def set$min(value: StrictMatchKeysAndValues[TSchema]): Self = StObject.set(x, "$min", value.asInstanceOf[js.Any])
    ...
    inline def set$set(value: StrictMatchKeysAndValues[TSchema]): Self = StObject.set(x, "$set", value.asInstanceOf[js.Any])
    
    inline def set$setOnInsert(value: StrictMatchKeysAndValues[TSchema]): Self = StObject.set(x, "$setOnInsert", value.asInstanceOf[js.Any])
