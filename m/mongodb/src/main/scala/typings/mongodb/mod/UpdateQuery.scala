...
object UpdateQuery {
  ...
  inline def apply[TSchema](): UpdateQuery[TSchema] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateQuery[TSchema]]
  }
  
  extension [Self <: UpdateQuery[?], TSchema](x: Self & UpdateQuery[TSchema]) {
    ...
    inline def set$bit(value: StringDictionary[typings.mongodb.mongodbStrings.UpdateQuery & TopLevel[js.Any]]): Self = StObject.set(x, "$bit", value.asInstanceOf[js.Any])
    
    inline def set$bitUndefined: Self = StObject.set(x, "$bit", js.undefined)
    
    inline def set$currentDate(value: OnlyFieldsOfType[TSchema, Date, `true` | Type]): Self = StObject.set(x, "$currentDate", value.asInstanceOf[js.Any])
    
    inline def set$currentDateUndefined: Self = StObject.set(x, "$currentDate", js.undefined)
    
    inline def set$inc(value: OnlyFieldsOfType[TSchema, js.UndefOr[NumericTypes], js.UndefOr[NumericTypes]]): Self = StObject.set(x, "$inc", value.asInstanceOf[js.Any])
    ...
    inline def set$mul(value: OnlyFieldsOfType[TSchema, js.UndefOr[NumericTypes], js.UndefOr[NumericTypes]]): Self = StObject.set(x, "$mul", value.asInstanceOf[js.Any])
    
    inline def set$mulUndefined: Self = StObject.set(x, "$mul", js.undefined)
    
    inline def set$pop(value: OnlyFieldsOfType[TSchema, js.Array[js.Any], `1` | `-1`]): Self = StObject.set(x, "$pop", value.asInstanceOf[js.Any])
    ...
    inline def set$rename(value: StringDictionary[String]): Self = StObject.set(x, "$rename", value.asInstanceOf[js.Any])
    ...
    inline def set$unset(value: OnlyFieldsOfType[TSchema, js.Any, _empty | `1` | `true`]): Self = StObject.set(x, "$unset", value.asInstanceOf[js.Any])
