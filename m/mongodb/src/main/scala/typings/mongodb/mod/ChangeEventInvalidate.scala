...
object ChangeEventInvalidate {
  @scala.inline
  def apply[/* <: org.scalablytyped.runtime.StringDictionary[js.Any] */ TSchema](_id: ResumeToken, clusterTime: typings.bson.mod.Timestamp, operationType: invalidate): ChangeEventInvalidate[TSchema] = {
  ...
  @scala.inline
  implicit class ChangeEventInvalidateOps[Self <: ChangeEventInvalidate[_], /* <: org.scalablytyped.runtime.StringDictionary[js.Any] */ TSchema] (val x: Self with ChangeEventInvalidate[TSchema]) extends AnyVal {
    @scala.inline
