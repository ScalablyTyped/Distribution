...
import typings.mongodb.AnonBatchSizeReadPreference
import typings.mongodb.AnonBypassDocumentValidation
import typings.mongodb.AnonDropTargetSession
import typings.mongodb.AnonFullSession
import typings.mongodb.AnonMaxTimeMSNumber
import typings.mongodb.AnonMaxTimeMSReadPreference
import typings.mongodb.AnonMaxTimeMSSession
import typings.mongodb.AnonMulti
import typings.mongodb.AnonReadPreferenceSession
import typings.mongodb.AnonScaleSession
import typings.mongodb.AnonSession
import typings.mongodb.AnonSessionClientSession
import typings.mongodb.AnonSingle
...
trait Collection[TSchema /* <: StringDictionary[js.Any] */] extends js.Object {
  ...
  def createIndexes(indexSpecs: js.Array[IndexSpecification], options: AnonSession): js.Promise[_] = js.native
  def createIndexes(indexSpecs: js.Array[IndexSpecification], options: AnonSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def deleteOne(filter: FilterQuery[TSchema], options: CommonOptions with AnonBypassDocumentValidation): js.Promise[DeleteWriteOpResultObject] = js.native
  def deleteOne(
    filter: FilterQuery[TSchema],
    options: CommonOptions with AnonBypassDocumentValidation,
    callback: MongoCallback[DeleteWriteOpResultObject]
  ): Unit = js.native
  ...
  def drop(options: AnonSessionClientSession): js.Promise[_] = js.native
  def drop(options: AnonSessionClientSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def dropIndex(indexName: String, options: CommonOptions with AnonMaxTimeMSNumber): js.Promise[_] = js.native
  def dropIndex(indexName: String, options: CommonOptions with AnonMaxTimeMSNumber, callback: MongoCallback[_]): Unit = js.native
  ...
  def group(
    ...
    finalize: js.Function,
    command: Boolean,
    options: AnonReadPreferenceSession
  ): js.Promise[_] = js.native
  def group(
    keys: js.Array[_],
    condition: js.Object,
  ...
  def indexExists(indexes: String, options: AnonSessionClientSession): js.Promise[Boolean] = js.native
  def indexExists(indexes: String, options: AnonSessionClientSession, callback: MongoCallback[Boolean]): Unit = js.native
  ...
  def indexExists(indexes: js.Array[String], options: AnonSessionClientSession): js.Promise[Boolean] = js.native
  def indexExists(indexes: js.Array[String], options: AnonSessionClientSession, callback: MongoCallback[Boolean]): Unit = js.native
  ...
  def indexes(options: AnonSessionClientSession): js.Promise[_] = js.native
  def indexes(options: AnonSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def isCapped(options: AnonSessionClientSession): js.Promise[_] = js.native
  def isCapped(options: AnonSessionClientSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def options(options: AnonSessionClientSession): js.Promise[_] = js.native
  def options(options: AnonSessionClientSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def reIndex(options: AnonSessionClientSession): js.Promise[_] = js.native
  def reIndex(options: AnonSessionClientSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def remove(selector: js.Object, options: CommonOptions with AnonSingle): Unit = js.native
  def remove(
    selector: js.Object,
    options: CommonOptions with AnonSingle,
  ...
  @JSName("remove")
  def remove_Promise(selector: js.Object, options: CommonOptions with AnonSingle): js.Promise[WriteOpResult] = js.native
  ...
  def update(
    filter: FilterQuery[TSchema],
    update: UpdateQuery[TSchema],
    options: UpdateOneOptions with AnonMulti
  ...
  def update(filter: FilterQuery[TSchema], update: Partial[TSchema], options: UpdateOneOptions with AnonMulti): js.Promise[WriteOpResult] = js.native
  def update(
    filter: FilterQuery[TSchema],
