...
open class Collection[TSchema /* <: Document */] () extends StObject {
  ...
  def count(filter: Unit, options: CountOptions): js.Promise[scala.Double] = js.native
  ...
  def countDocuments(filter: Unit, options: CountDocumentsOptions): js.Promise[scala.Double] = js.native
  def countDocuments(filter: Document): js.Promise[scala.Double] = js.native
  def countDocuments(filter: Document, options: CountDocumentsOptions): js.Promise[scala.Double] = js.native
  ...
  /**
    ...
    * @param options - Optional settings for the command
    */
  def deleteMany(): js.Promise[DeleteResult] = js.native
  def deleteMany(filter: Unit, options: DeleteOptions): js.Promise[DeleteResult] = js.native
  ...
  /**
    ...
    * @param options - Optional settings for the command
    */
  def deleteOne(): js.Promise[DeleteResult] = js.native
  def deleteOne(filter: Unit, options: DeleteOptions): js.Promise[DeleteResult] = js.native
  def deleteOne(filter: Filter[TSchema]): js.Promise[DeleteResult] = js.native
  def deleteOne(filter: Filter[TSchema], options: DeleteOptions): js.Promise[DeleteResult] = js.native
  ...
  /**
    ...
    * @param options - Optional settings for the command
    */
  def replaceOne(filter: Filter[TSchema], replacement: WithoutId[TSchema]): js.Promise[UpdateResult[TSchema] | Document] = js.native
  def replaceOne(filter: Filter[TSchema], replacement: WithoutId[TSchema], options: ReplaceOptions): js.Promise[UpdateResult[TSchema] | Document] = js.native
  ...
  /**
    ...
    * @param options - Optional settings for the command
    */
  def updateMany(filter: Filter[TSchema], update: UpdateFilter[TSchema]): js.Promise[UpdateResult[TSchema]] = js.native
  def updateMany(filter: Filter[TSchema], update: UpdateFilter[TSchema], options: UpdateOptions): js.Promise[UpdateResult[TSchema]] = js.native
  ...
  /**
    ...
    * @param options - Optional settings for the command
    */
  def updateOne(filter: Filter[TSchema], update: UpdateFilter[TSchema]): js.Promise[UpdateResult[TSchema]] = js.native
  def updateOne(filter: Filter[TSchema], update: UpdateFilter[TSchema], options: UpdateOptions): js.Promise[UpdateResult[TSchema]] = js.native
  def updateOne(filter: Filter[TSchema], update: Partial[TSchema]): js.Promise[UpdateResult[TSchema]] = js.native
  def updateOne(filter: Filter[TSchema], update: Partial[TSchema], options: UpdateOptions): js.Promise[UpdateResult[TSchema]] = js.native
