...
import typings.mongodb.AnonMaxTimeMS
import typings.mongodb.AnonNameOnly
...
trait Admin extends js.Object {
  ...
  def buildInfo(options: AnonSession): js.Promise[_] = js.native
  def buildInfo(options: AnonSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def ping(options: AnonSession): js.Promise[_] = js.native
  def ping(options: AnonSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def replSetGetStatus(options: AnonSession): js.Promise[_] = js.native
  def replSetGetStatus(options: AnonSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def serverStatus(options: AnonSession): js.Promise[_] = js.native
  def serverStatus(options: AnonSession, callback: MongoCallback[_]): Unit = js.native
