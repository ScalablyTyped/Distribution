...
object ChangeEventUpdate {
  ...
  @scala.inline
  implicit class ChangeEventUpdateOps[Self <: ChangeEventUpdate[_], /* <: org.scalablytyped.runtime.StringDictionary[js.Any] */ TSchema] (val x: Self with ChangeEventUpdate[TSchema]) extends AnyVal {
    @scala.inline
