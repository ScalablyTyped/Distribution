...
class Senders protected () extends js.Object {
  ...
  /**
    ...
    * @param {Function} onerror an optional callback to execute when the API call errors out - defaults to throwing the error as an exception
    */
  def verifyDomain(params: js.Any): scala.Unit = js.native
  def verifyDomain(params: js.Any, onsuccess: ICallback): scala.Unit = js.native
  def verifyDomain(params: js.Any, onsuccess: ICallback, onerror: ICallback): scala.Unit = js.native
}
