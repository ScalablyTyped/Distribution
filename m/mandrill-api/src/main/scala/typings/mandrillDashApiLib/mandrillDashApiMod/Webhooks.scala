...
class Webhooks protected () extends js.Object {
  ...
  /**
    ...
    * @param {Function} onerror an optional callback to execute when the API call errors out - defaults to throwing the error as an exception
    */
  def delete(params: mandrillDashApiLib.Anon_Id): scala.Unit = js.native
  def delete(params: mandrillDashApiLib.Anon_Id, onsuccess: ICallback): scala.Unit = js.native
  def delete(params: mandrillDashApiLib.Anon_Id, onsuccess: ICallback, onerror: ICallback): scala.Unit = js.native
  /**
