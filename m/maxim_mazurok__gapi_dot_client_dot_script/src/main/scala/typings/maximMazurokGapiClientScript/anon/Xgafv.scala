...
import typings.maximMazurokGapiClientScript.gapi.client.script.ExecutionRequest
...
object Xgafv {
  ...
  inline def apply(resource: ExecutionRequest, scriptId: String): Xgafv = {
  ...
  implicit open class MutableBuilder[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ExecutionRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
