...
object DeploymentId {
  ...
  @scala.inline
  def apply(deploymentId: String, scriptId: String): DeploymentId = {
    val __obj = js.Dynamic.literal(deploymentId = deploymentId.asInstanceOf[js.Any], scriptId = scriptId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeploymentId]
  }
  
  @scala.inline
  implicit class DeploymentIdMutableBuilder[Self <: DeploymentId] (val x: Self) extends AnyVal {
