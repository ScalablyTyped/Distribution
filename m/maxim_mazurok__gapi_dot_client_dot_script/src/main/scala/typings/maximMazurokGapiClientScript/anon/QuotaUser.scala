...
object QuotaUser {
  ...
  inline def apply(scriptId: String, versionNumber: Double): QuotaUser = {
    val __obj = js.Dynamic.literal(scriptId = scriptId.asInstanceOf[js.Any], versionNumber = versionNumber.asInstanceOf[js.Any])
