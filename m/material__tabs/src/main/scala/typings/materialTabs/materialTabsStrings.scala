...
object materialTabsStrings {
  ...
  @js.native
  sealed trait `mdc-tab--active` extends js.Object
  
  @js.native
  sealed trait `mdc-tab-bar-scroller__indicator--back` extends js.Object
  
  @js.native
  sealed trait `mdc-tab-bar-scroller__indicator--enabled` extends js.Object
  
  @js.native
  sealed trait `mdc-tab-bar-scroller__indicator--forward` extends js.Object
  ...
  @scala.inline
  def `mdc-tab-bar-scroller__indicator--back`: `mdc-tab-bar-scroller__indicator--back` = "mdc-tab-bar-scroller__indicator--back".asInstanceOf[`mdc-tab-bar-scroller__indicator--back`]
  @scala.inline
  def `mdc-tab-bar-scroller__indicator--enabled`: `mdc-tab-bar-scroller__indicator--enabled` = "mdc-tab-bar-scroller__indicator--enabled".asInstanceOf[`mdc-tab-bar-scroller__indicator--enabled`]
  @scala.inline
  def `mdc-tab-bar-scroller__indicator--forward`: `mdc-tab-bar-scroller__indicator--forward` = "mdc-tab-bar-scroller__indicator--forward".asInstanceOf[`mdc-tab-bar-scroller__indicator--forward`]
  @scala.inline
  def `mdc-tab-bar-upgraded`: `mdc-tab-bar-upgraded` = "mdc-tab-bar-upgraded".asInstanceOf[`mdc-tab-bar-upgraded`]
}
