...
object tabBarScrollerIndexMod {
  ...
  @js.native
  open class default ()
    extends typings.materialTabs.tabBarScrollerFoundationMod.default {
  ...
  open class MDCTabBarScroller protected ()
    extends typings.materialTabs.tabBarScrollerComponentMod.MDCTabBarScroller {
  ...
  open class MDCTabBarScrollerFoundation ()
    extends typings.materialTabs.tabBarScrollerFoundationMod.MDCTabBarScrollerFoundation {
    def this(adapter: PartialMDCTabBarScrollerA) = this()
  }
  /* static members */
