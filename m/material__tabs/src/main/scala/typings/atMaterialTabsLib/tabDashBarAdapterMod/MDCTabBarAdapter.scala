...
trait MDCTabBarAdapter extends js.Object {
  ...
  def setTabActiveAtIndex_true(index: scala.Double, isActive: atMaterialTabsLib.atMaterialTabsLibNumbers.`true`): scala.Unit
