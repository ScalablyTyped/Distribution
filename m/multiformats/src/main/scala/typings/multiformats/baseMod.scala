...
import typings.multiformats.interfaceMod.BaseDecoder
import typings.multiformats.interfaceMod.BaseEncoder
import typings.multiformats.interfaceMod.CombobaseDecoder
import typings.multiformats.interfaceMod.Multibase
import typings.multiformats.interfaceMod.MultibaseCodec
import typings.multiformats.interfaceMod.MultibaseDecoder
import typings.multiformats.interfaceMod.MultibaseEncoder
import typings.multiformats.interfaceMod.UnibaseDecoder
...
object baseMod {
  ...
  - typings.multiformats.interfaceMod.MultibaseEncoder because var conflicts: name, prefix. Inlined encode */ @JSImport("multiformats/dist/types/src/bases/base", "Codec")
  @js.native
