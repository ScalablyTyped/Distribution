...
trait CidValue[T /* <: Any */, C /* <: Double */, A /* <: Double */, V /* <: typings.multiformats.linkInterfaceMod.Version */] extends StObject {
...
object CidValue {
  ...
  inline def apply[T /* <: Any */, C /* <: Double */, A /* <: Double */, V /* <: typings.multiformats.linkInterfaceMod.Version */](bytes: ByteView[T], cid: CID[T, C, A, V], value: T): CidValue[T, C, A, V] = {
  ...
  extension [Self <: CidValue[?, ?, ?, ?], T /* <: Any */, C /* <: Double */, A /* <: Double */, V /* <: typings.multiformats.linkInterfaceMod.Version */](x: Self & (CidValue[T, C, A, V])) {
