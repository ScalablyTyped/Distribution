...
trait Hash[Format /* <: Double */, Version /* <: typings.multiformats.distTypesSrcLinkInterfaceMod.Version */] extends StObject {
...
object Hash {
  ...
  inline def apply[Format /* <: Double */, Version /* <: typings.multiformats.distTypesSrcLinkInterfaceMod.Version */](code: Format, hash: js.typedarray.Uint8Array, version: Version): Hash[Format, Version] = {
