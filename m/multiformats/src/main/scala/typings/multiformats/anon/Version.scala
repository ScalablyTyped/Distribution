...
trait Version[V /* <: typings.multiformats.linkInterfaceMod.Version */, Format /* <: Double */] extends StObject {
...
object Version {
  ...
  inline def apply[V /* <: typings.multiformats.linkInterfaceMod.Version */, Format /* <: Double */](code: Format, hash: js.typedarray.Uint8Array, version: V): Version[V, Format] = {
  ...
  extension [Self <: Version[?, ?], V /* <: typings.multiformats.linkInterfaceMod.Version */, Format /* <: Double */](x: Self & (Version[V, Format])) {
