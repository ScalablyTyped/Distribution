...
import typings.maximMazurokGapiClientReseller.gapi.client.reseller.Customer
...
object CustomerAuthToken {
  ...
  inline def apply(resource: Customer): CustomerAuthToken = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CustomerAuthToken]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CustomerAuthToken] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: Customer): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
