...
import typings.maximMazurokGapiClientAccesscontextmanager.gapi.client.accesscontextmanager.GcpUserAccessBinding
...
trait AltCallback extends StObject {
  ...
  /** Request body */
  var resource: GcpUserAccessBinding = js.native
...
object AltCallback {
  ...
  @scala.inline
  def apply(name: String, resource: GcpUserAccessBinding): AltCallback = {
  ...
  implicit class AltCallbackMutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GcpUserAccessBinding): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
