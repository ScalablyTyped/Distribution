...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: CommitServicePerimetersRequest = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: CommitServicePerimetersRequest): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CommitServicePerimetersRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
