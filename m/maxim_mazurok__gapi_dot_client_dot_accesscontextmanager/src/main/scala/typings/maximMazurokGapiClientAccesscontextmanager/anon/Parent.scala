...
import typings.maximMazurokGapiClientAccesscontextmanager.gapi.client.accesscontextmanager.CommitServicePerimetersRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: CommitServicePerimetersRequest
...
object Parent {
  ...
  inline def apply(parent: String, resource: CommitServicePerimetersRequest): Parent = {
  ...
  implicit open class MutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: CommitServicePerimetersRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
