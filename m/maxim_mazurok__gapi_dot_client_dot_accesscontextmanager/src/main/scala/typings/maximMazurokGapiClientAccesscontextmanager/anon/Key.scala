...
import typings.maximMazurokGapiClientAccesscontextmanager.gapi.client.accesscontextmanager.AccessLevel
...
trait Key extends StObject {
  ...
  /** Request body */
  var resource: AccessLevel = js.native
...
object Key {
  ...
  @scala.inline
  def apply(name: String, resource: AccessLevel): Key = {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AccessLevel): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
