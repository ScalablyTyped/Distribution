...
import typings.maximMazurokGapiClientAccesscontextmanager.gapi.client.accesscontextmanager.ReplaceAccessLevelsRequest
...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: ReplaceAccessLevelsRequest
...
object Oauthtoken {
  ...
  inline def apply(parent: String, resource: ReplaceAccessLevelsRequest): Oauthtoken = {
  ...
  implicit open class MutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ReplaceAccessLevelsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
