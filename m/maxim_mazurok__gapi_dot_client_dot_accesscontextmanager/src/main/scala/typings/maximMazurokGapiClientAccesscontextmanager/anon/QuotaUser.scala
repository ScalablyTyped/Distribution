...
import typings.maximMazurokGapiClientAccesscontextmanager.gapi.client.accesscontextmanager.ServicePerimeter
...
object QuotaUser {
  ...
  inline def apply(parent: String, resource: ServicePerimeter): QuotaUser = {
  ...
  implicit open class MutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ServicePerimeter): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
