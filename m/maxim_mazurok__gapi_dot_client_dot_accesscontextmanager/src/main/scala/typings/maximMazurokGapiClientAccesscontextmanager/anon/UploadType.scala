...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: AccessPolicy = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(resource: AccessPolicy): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AccessPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
