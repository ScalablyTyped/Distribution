...
/* Rewritten from type alias, can be one of: 
  - typings.maxmind.responseMod.CountryResponse
  - typings.maxmind.responseMod.CityResponse
  - typings.maxmind.responseMod.AnonymousIPResponse
  - typings.maxmind.responseMod.AsnResponse
  - typings.maxmind.responseMod.ConnectionTypeResponse
  - typings.maxmind.responseMod.DomainResponse
  - typings.maxmind.responseMod.IspResponse
*/
