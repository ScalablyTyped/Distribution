...
/* Rewritten from type alias, can be one of: 
  - typings.microsoftGraph.microsoftGraphStrings.event
  - typings.microsoftGraph.microsoftGraphStrings.message
  - typings.microsoftGraph.microsoftGraphStrings.driveItem
  - typings.microsoftGraph.microsoftGraphStrings.externalItem
  - typings.microsoftGraph.microsoftGraphStrings.site
