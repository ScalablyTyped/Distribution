...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftGraph.microsoftGraphStrings.notAllowedByPolicy
...
object AuthenticationMethodSignInState {
  ...
  inline def phoneNumberNotUnique: typings.microsoftGraph.microsoftGraphStrings.phoneNumberNotUnique = "phoneNumberNotUnique".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.phoneNumberNotUnique]
  
  inline def ready: typings.microsoftGraph.microsoftGraphStrings.ready = "ready".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.ready]
