...
object Modality {
  ...
  inline def audio: typings.microsoftGraph.microsoftGraphStrings.audio = "audio".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.audio]
  ...
  inline def videoBasedScreenSharing: typings.microsoftGraph.microsoftGraphStrings.videoBasedScreenSharing = "videoBasedScreenSharing".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.videoBasedScreenSharing]
}
