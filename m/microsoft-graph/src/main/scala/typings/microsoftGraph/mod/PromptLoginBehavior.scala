...
object PromptLoginBehavior {
  ...
  inline def translateToFreshPasswordAuthentication: typings.microsoftGraph.microsoftGraphStrings.translateToFreshPasswordAuthentication = "translateToFreshPasswordAuthentication".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.translateToFreshPasswordAuthentication]
