...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftGraph.microsoftGraphStrings.shift
  - typings.microsoftGraph.microsoftGraphStrings.swapRequest
  - typings.microsoftGraph.microsoftGraphStrings.userShiftPreferences
