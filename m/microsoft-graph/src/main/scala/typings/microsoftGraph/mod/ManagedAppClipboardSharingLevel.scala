...
object ManagedAppClipboardSharingLevel {
  ...
  inline def managedAppsWithPasteIn: typings.microsoftGraph.microsoftGraphStrings.managedAppsWithPasteIn = "managedAppsWithPasteIn".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.managedAppsWithPasteIn]
}
