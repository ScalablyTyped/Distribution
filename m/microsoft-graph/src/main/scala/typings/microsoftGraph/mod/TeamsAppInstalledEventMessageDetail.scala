...
trait TeamsAppInstalledEventMessageDetail
  extends StObject
...
object TeamsAppInstalledEventMessageDetail {
  
  inline def apply(): TeamsAppInstalledEventMessageDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TeamsAppInstalledEventMessageDetail]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TeamsAppInstalledEventMessageDetail] (val x: Self) extends AnyVal {
