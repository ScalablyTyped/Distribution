...
trait DeviceConfigurationDeviceOverview
  extends StObject
     with Entity {
...
object DeviceConfigurationDeviceOverview {
  ...
  inline def apply(): DeviceConfigurationDeviceOverview = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeviceConfigurationDeviceOverview]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeviceConfigurationDeviceOverview] (val x: Self) extends AnyVal {
