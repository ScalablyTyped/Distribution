...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftGraph.microsoftGraphStrings.allowFalsePositiveOverride
  - typings.microsoftGraph.microsoftGraphStrings.allowOverrideWithoutJustification
  - typings.microsoftGraph.microsoftGraphStrings.allowOverrideWithJustification
*/
