...
object BitLockerRemovableDrivePolicy {
  ...
  def apply(
    ...
    if (!js.isUndefined(blockCrossOrganizationWriteAccess)) __obj.updateDynamic("blockCrossOrganizationWriteAccess")(blockCrossOrganizationWriteAccess.get.asInstanceOf[js.Any])
    if (encryptionMethod != null) __obj.updateDynamic("encryptionMethod")(encryptionMethod.asInstanceOf[js.Any])
    if (!js.isUndefined(requireEncryptionForWriteAccess)) __obj.updateDynamic("requireEncryptionForWriteAccess")(requireEncryptionForWriteAccess.get.asInstanceOf[js.Any])
