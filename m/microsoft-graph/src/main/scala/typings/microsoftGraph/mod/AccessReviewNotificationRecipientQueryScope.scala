...
trait AccessReviewNotificationRecipientQueryScope
  extends StObject
     with AccessReviewNotificationRecipientScope {
...
object AccessReviewNotificationRecipientQueryScope {
  
  inline def apply(): AccessReviewNotificationRecipientQueryScope = {
