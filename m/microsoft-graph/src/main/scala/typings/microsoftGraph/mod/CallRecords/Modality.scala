...
object Modality {
  ...
  @scala.inline
  def screenSharing: typings.microsoftGraph.microsoftGraphStrings.screenSharing = "screenSharing".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.screenSharing]
