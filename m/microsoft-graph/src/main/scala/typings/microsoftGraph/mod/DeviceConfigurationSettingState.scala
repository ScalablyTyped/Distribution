...
@js.native
trait DeviceConfigurationSettingState extends StObject {
...
object DeviceConfigurationSettingState {
  ...
  @scala.inline
  implicit class DeviceConfigurationSettingStateMutableBuilder[Self <: DeviceConfigurationSettingState] (val x: Self) extends AnyVal {
