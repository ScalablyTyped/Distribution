...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftGraph.microsoftGraphStrings.children
  - typings.microsoftGraph.microsoftGraphStrings.childrenAbove8
...
*/
trait RatingCanadaTelevisionType extends js.Object
