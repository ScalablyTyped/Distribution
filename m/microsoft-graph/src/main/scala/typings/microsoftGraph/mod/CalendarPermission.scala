...
trait CalendarPermission extends Entity {
  /**
    ...
    */
  var allowedRoles: js.UndefOr[js.Array[CalendarRoleType]] = js.native
  /**
  ...
  var isInsideOrganization: js.UndefOr[Boolean] = js.native
  /**
  ...
  var role: js.UndefOr[CalendarRoleType] = js.native
}
...
object CalendarPermission {
  ...
  implicit class CalendarPermissionOps[Self <: CalendarPermission] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowedRoles(value: js.Array[CalendarRoleType]): Self = this.set("allowedRoles", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIsInsideOrganization(value: Boolean): Self = this.set("isInsideOrganization", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRole(value: CalendarRoleType): Self = this.set("role", value.asInstanceOf[js.Any])
    @scala.inline
