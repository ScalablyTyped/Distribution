...
object NetworkConnectionType {
  ...
  inline def tunnel: typings.microsoftGraph.microsoftGraphStrings.tunnel = "tunnel".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.tunnel]
  ...
  inline def wired: typings.microsoftGraph.microsoftGraphStrings.wired = "wired".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.wired]
}
