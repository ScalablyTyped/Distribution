...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftGraph.microsoftGraphStrings.doesNotExist
...
object Win32LobAppRegistryRuleOperationType {
  ...
  @scala.inline
  def doesNotExist: typings.microsoftGraph.microsoftGraphStrings.doesNotExist = "doesNotExist".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.doesNotExist]
