...
/* Rewritten from type alias, can be one of: 
  - typings.microsoftGraph.microsoftGraphStrings.endDate
  - typings.microsoftGraph.microsoftGraphStrings.noEnd
  - typings.microsoftGraph.microsoftGraphStrings.numbered
*/
