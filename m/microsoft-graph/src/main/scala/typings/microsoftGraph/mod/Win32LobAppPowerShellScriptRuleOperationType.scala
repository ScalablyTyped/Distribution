...
object Win32LobAppPowerShellScriptRuleOperationType {
  ...
  inline def float: typings.microsoftGraph.microsoftGraphStrings.float = "float".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.float]
  
  inline def integer: typings.microsoftGraph.microsoftGraphStrings.integer = "integer".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.integer]
