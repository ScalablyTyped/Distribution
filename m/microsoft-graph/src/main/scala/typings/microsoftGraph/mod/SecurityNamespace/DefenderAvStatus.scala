...
object DefenderAvStatus {
  ...
  inline def notUpdated: typings.microsoftGraph.microsoftGraphStrings.notUpdated = "notUpdated".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.notUpdated]
