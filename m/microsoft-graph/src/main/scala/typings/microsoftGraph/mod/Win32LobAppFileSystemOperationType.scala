...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftGraph.microsoftGraphStrings.exists
  - typings.microsoftGraph.microsoftGraphStrings.modifiedDate
  - typings.microsoftGraph.microsoftGraphStrings.createdDate
  - typings.microsoftGraph.microsoftGraphStrings.version
  - typings.microsoftGraph.microsoftGraphStrings.sizeInMB
*/
