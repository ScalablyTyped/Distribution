...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftGraph.microsoftGraphStrings.enforceComponentsAndStoreApps
  - typings.microsoftGraph.microsoftGraphStrings.auditComponentsAndStoreApps
  - typings.microsoftGraph.microsoftGraphStrings.enforceComponentsStoreAppsAndSmartlocker
