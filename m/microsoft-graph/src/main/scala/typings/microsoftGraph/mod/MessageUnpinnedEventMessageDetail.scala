...
trait MessageUnpinnedEventMessageDetail
  extends StObject
...
object MessageUnpinnedEventMessageDetail {
  
  inline def apply(): MessageUnpinnedEventMessageDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MessageUnpinnedEventMessageDetail]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MessageUnpinnedEventMessageDetail] (val x: Self) extends AnyVal {
