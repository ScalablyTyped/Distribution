...
/* Rewritten from type alias, can be one of: 
  - typings.microsoftGraph.microsoftGraphStrings.missed
  - typings.microsoftGraph.microsoftGraphStrings.subscriptionRemoved
  - typings.microsoftGraph.microsoftGraphStrings.reauthorizationRequired
*/
