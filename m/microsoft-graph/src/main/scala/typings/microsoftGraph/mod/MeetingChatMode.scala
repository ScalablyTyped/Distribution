...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftGraph.microsoftGraphStrings.limited
  - typings.microsoftGraph.microsoftGraphStrings.unknownFutureValue_
*/
trait MeetingChatMode extends StObject
object MeetingChatMode {
  ...
  inline def limited: typings.microsoftGraph.microsoftGraphStrings.limited = "limited".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.limited]
