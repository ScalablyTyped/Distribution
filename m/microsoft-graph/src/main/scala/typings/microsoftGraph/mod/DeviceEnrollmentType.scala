...
object DeviceEnrollmentType {
  ...
  inline def userEnrollment: typings.microsoftGraph.microsoftGraphStrings.userEnrollment = "userEnrollment".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.userEnrollment]
  ...
  inline def windowsBulkUserless: typings.microsoftGraph.microsoftGraphStrings.windowsBulkUserless = "windowsBulkUserless".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.windowsBulkUserless]
  
  inline def windowsCoManagement: typings.microsoftGraph.microsoftGraphStrings.windowsCoManagement = "windowsCoManagement".asInstanceOf[typings.microsoftGraph.microsoftGraphStrings.windowsCoManagement]
}
