...
object PasswordProfile {
  ...
  implicit class PasswordProfileOps[Self <: PasswordProfile] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForceChangePasswordNextSignIn(value: Boolean): Self = this.set("forceChangePasswordNextSignIn", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteForceChangePasswordNextSignIn: Self = this.set("forceChangePasswordNextSignIn", js.undefined)
    @scala.inline
    def setForceChangePasswordNextSignInWithMfa(value: Boolean): Self = this.set("forceChangePasswordNextSignInWithMfa", value.asInstanceOf[js.Any])
    @scala.inline
