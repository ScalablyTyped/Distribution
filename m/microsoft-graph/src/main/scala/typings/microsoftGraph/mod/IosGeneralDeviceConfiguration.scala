...
object IosGeneralDeviceConfiguration {
  ...
  def apply(
    ...
    if (!js.isUndefined(accountBlockModification)) __obj.updateDynamic("accountBlockModification")(accountBlockModification.asInstanceOf[js.Any])
    if (!js.isUndefined(activationLockAllowWhenSupervised)) __obj.updateDynamic("activationLockAllowWhenSupervised")(activationLockAllowWhenSupervised.asInstanceOf[js.Any])
    if (!js.isUndefined(airDropBlocked)) __obj.updateDynamic("airDropBlocked")(airDropBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(airDropForceUnmanagedDropTarget)) __obj.updateDynamic("airDropForceUnmanagedDropTarget")(airDropForceUnmanagedDropTarget.asInstanceOf[js.Any])
    if (!js.isUndefined(airPlayForcePairingPasswordForOutgoingRequests)) __obj.updateDynamic("airPlayForcePairingPasswordForOutgoingRequests")(airPlayForcePairingPasswordForOutgoingRequests.asInstanceOf[js.Any])
    if (!js.isUndefined(appStoreBlockAutomaticDownloads)) __obj.updateDynamic("appStoreBlockAutomaticDownloads")(appStoreBlockAutomaticDownloads.asInstanceOf[js.Any])
    if (!js.isUndefined(appStoreBlockInAppPurchases)) __obj.updateDynamic("appStoreBlockInAppPurchases")(appStoreBlockInAppPurchases.asInstanceOf[js.Any])
    if (!js.isUndefined(appStoreBlockUIAppInstallation)) __obj.updateDynamic("appStoreBlockUIAppInstallation")(appStoreBlockUIAppInstallation.asInstanceOf[js.Any])
    if (!js.isUndefined(appStoreBlocked)) __obj.updateDynamic("appStoreBlocked")(appStoreBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(appStoreRequirePassword)) __obj.updateDynamic("appStoreRequirePassword")(appStoreRequirePassword.asInstanceOf[js.Any])
    if (!js.isUndefined(appleNewsBlocked)) __obj.updateDynamic("appleNewsBlocked")(appleNewsBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(appleWatchBlockPairing)) __obj.updateDynamic("appleWatchBlockPairing")(appleWatchBlockPairing.asInstanceOf[js.Any])
    if (!js.isUndefined(appleWatchForceWristDetection)) __obj.updateDynamic("appleWatchForceWristDetection")(appleWatchForceWristDetection.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(bluetoothBlockModification)) __obj.updateDynamic("bluetoothBlockModification")(bluetoothBlockModification.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(cellularBlockGlobalBackgroundFetchWhileRoaming)) __obj.updateDynamic("cellularBlockGlobalBackgroundFetchWhileRoaming")(cellularBlockGlobalBackgroundFetchWhileRoaming.asInstanceOf[js.Any])
    if (!js.isUndefined(cellularBlockPerAppDataModification)) __obj.updateDynamic("cellularBlockPerAppDataModification")(cellularBlockPerAppDataModification.asInstanceOf[js.Any])
    if (!js.isUndefined(cellularBlockPersonalHotspot)) __obj.updateDynamic("cellularBlockPersonalHotspot")(cellularBlockPersonalHotspot.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(certificatesBlockUntrustedTlsCertificates)) __obj.updateDynamic("certificatesBlockUntrustedTlsCertificates")(certificatesBlockUntrustedTlsCertificates.asInstanceOf[js.Any])
    if (!js.isUndefined(classroomAppBlockRemoteScreenObservation)) __obj.updateDynamic("classroomAppBlockRemoteScreenObservation")(classroomAppBlockRemoteScreenObservation.asInstanceOf[js.Any])
    if (!js.isUndefined(classroomAppForceUnpromptedScreenObservation)) __obj.updateDynamic("classroomAppForceUnpromptedScreenObservation")(classroomAppForceUnpromptedScreenObservation.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(configurationProfileBlockChanges)) __obj.updateDynamic("configurationProfileBlockChanges")(configurationProfileBlockChanges.asInstanceOf[js.Any])
    if (createdDateTime != null) __obj.updateDynamic("createdDateTime")(createdDateTime.asInstanceOf[js.Any])
    if (!js.isUndefined(definitionLookupBlocked)) __obj.updateDynamic("definitionLookupBlocked")(definitionLookupBlocked.asInstanceOf[js.Any])
    if (description != null) __obj.updateDynamic("description")(description.asInstanceOf[js.Any])
    if (!js.isUndefined(deviceBlockEnableRestrictions)) __obj.updateDynamic("deviceBlockEnableRestrictions")(deviceBlockEnableRestrictions.asInstanceOf[js.Any])
    if (!js.isUndefined(deviceBlockEraseContentAndSettings)) __obj.updateDynamic("deviceBlockEraseContentAndSettings")(deviceBlockEraseContentAndSettings.asInstanceOf[js.Any])
    if (!js.isUndefined(deviceBlockNameModification)) __obj.updateDynamic("deviceBlockNameModification")(deviceBlockNameModification.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(diagnosticDataBlockSubmissionModification)) __obj.updateDynamic("diagnosticDataBlockSubmissionModification")(diagnosticDataBlockSubmissionModification.asInstanceOf[js.Any])
    if (displayName != null) __obj.updateDynamic("displayName")(displayName.asInstanceOf[js.Any])
    if (!js.isUndefined(documentsBlockManagedDocumentsInUnmanagedApps)) __obj.updateDynamic("documentsBlockManagedDocumentsInUnmanagedApps")(documentsBlockManagedDocumentsInUnmanagedApps.asInstanceOf[js.Any])
    if (!js.isUndefined(documentsBlockUnmanagedDocumentsInManagedApps)) __obj.updateDynamic("documentsBlockUnmanagedDocumentsInManagedApps")(documentsBlockUnmanagedDocumentsInManagedApps.asInstanceOf[js.Any])
    if (emailInDomainSuffixes != null) __obj.updateDynamic("emailInDomainSuffixes")(emailInDomainSuffixes.asInstanceOf[js.Any])
    if (!js.isUndefined(enterpriseAppBlockTrust)) __obj.updateDynamic("enterpriseAppBlockTrust")(enterpriseAppBlockTrust.asInstanceOf[js.Any])
    if (!js.isUndefined(enterpriseAppBlockTrustModification)) __obj.updateDynamic("enterpriseAppBlockTrustModification")(enterpriseAppBlockTrustModification.asInstanceOf[js.Any])
    if (!js.isUndefined(faceTimeBlocked)) __obj.updateDynamic("faceTimeBlocked")(faceTimeBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(findMyFriendsBlocked)) __obj.updateDynamic("findMyFriendsBlocked")(findMyFriendsBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(gameCenterBlocked)) __obj.updateDynamic("gameCenterBlocked")(gameCenterBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(gamingBlockGameCenterFriends)) __obj.updateDynamic("gamingBlockGameCenterFriends")(gamingBlockGameCenterFriends.asInstanceOf[js.Any])
    if (!js.isUndefined(gamingBlockMultiplayer)) __obj.updateDynamic("gamingBlockMultiplayer")(gamingBlockMultiplayer.asInstanceOf[js.Any])
    if (!js.isUndefined(hostPairingBlocked)) __obj.updateDynamic("hostPairingBlocked")(hostPairingBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(iBooksStoreBlockErotica)) __obj.updateDynamic("iBooksStoreBlockErotica")(iBooksStoreBlockErotica.asInstanceOf[js.Any])
    if (!js.isUndefined(iBooksStoreBlocked)) __obj.updateDynamic("iBooksStoreBlocked")(iBooksStoreBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(iCloudBlockActivityContinuation)) __obj.updateDynamic("iCloudBlockActivityContinuation")(iCloudBlockActivityContinuation.asInstanceOf[js.Any])
    if (!js.isUndefined(iCloudBlockBackup)) __obj.updateDynamic("iCloudBlockBackup")(iCloudBlockBackup.asInstanceOf[js.Any])
    if (!js.isUndefined(iCloudBlockDocumentSync)) __obj.updateDynamic("iCloudBlockDocumentSync")(iCloudBlockDocumentSync.asInstanceOf[js.Any])
    if (!js.isUndefined(iCloudBlockManagedAppsSync)) __obj.updateDynamic("iCloudBlockManagedAppsSync")(iCloudBlockManagedAppsSync.asInstanceOf[js.Any])
    if (!js.isUndefined(iCloudBlockPhotoLibrary)) __obj.updateDynamic("iCloudBlockPhotoLibrary")(iCloudBlockPhotoLibrary.asInstanceOf[js.Any])
    if (!js.isUndefined(iCloudBlockPhotoStreamSync)) __obj.updateDynamic("iCloudBlockPhotoStreamSync")(iCloudBlockPhotoStreamSync.asInstanceOf[js.Any])
    if (!js.isUndefined(iCloudBlockSharedPhotoStream)) __obj.updateDynamic("iCloudBlockSharedPhotoStream")(iCloudBlockSharedPhotoStream.asInstanceOf[js.Any])
    if (!js.isUndefined(iCloudRequireEncryptedBackup)) __obj.updateDynamic("iCloudRequireEncryptedBackup")(iCloudRequireEncryptedBackup.asInstanceOf[js.Any])
    if (!js.isUndefined(iTunesBlockExplicitContent)) __obj.updateDynamic("iTunesBlockExplicitContent")(iTunesBlockExplicitContent.asInstanceOf[js.Any])
    if (!js.isUndefined(iTunesBlockMusicService)) __obj.updateDynamic("iTunesBlockMusicService")(iTunesBlockMusicService.asInstanceOf[js.Any])
    if (!js.isUndefined(iTunesBlockRadio)) __obj.updateDynamic("iTunesBlockRadio")(iTunesBlockRadio.asInstanceOf[js.Any])
    if (id != null) __obj.updateDynamic("id")(id.asInstanceOf[js.Any])
    if (!js.isUndefined(keyboardBlockAutoCorrect)) __obj.updateDynamic("keyboardBlockAutoCorrect")(keyboardBlockAutoCorrect.asInstanceOf[js.Any])
    if (!js.isUndefined(keyboardBlockDictation)) __obj.updateDynamic("keyboardBlockDictation")(keyboardBlockDictation.asInstanceOf[js.Any])
    if (!js.isUndefined(keyboardBlockPredictive)) __obj.updateDynamic("keyboardBlockPredictive")(keyboardBlockPredictive.asInstanceOf[js.Any])
    if (!js.isUndefined(keyboardBlockShortcuts)) __obj.updateDynamic("keyboardBlockShortcuts")(keyboardBlockShortcuts.asInstanceOf[js.Any])
    if (!js.isUndefined(keyboardBlockSpellCheck)) __obj.updateDynamic("keyboardBlockSpellCheck")(keyboardBlockSpellCheck.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowAssistiveSpeak)) __obj.updateDynamic("kioskModeAllowAssistiveSpeak")(kioskModeAllowAssistiveSpeak.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowAssistiveTouchSettings)) __obj.updateDynamic("kioskModeAllowAssistiveTouchSettings")(kioskModeAllowAssistiveTouchSettings.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowAutoLock)) __obj.updateDynamic("kioskModeAllowAutoLock")(kioskModeAllowAutoLock.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowColorInversionSettings)) __obj.updateDynamic("kioskModeAllowColorInversionSettings")(kioskModeAllowColorInversionSettings.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowRingerSwitch)) __obj.updateDynamic("kioskModeAllowRingerSwitch")(kioskModeAllowRingerSwitch.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowScreenRotation)) __obj.updateDynamic("kioskModeAllowScreenRotation")(kioskModeAllowScreenRotation.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowSleepButton)) __obj.updateDynamic("kioskModeAllowSleepButton")(kioskModeAllowSleepButton.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowTouchscreen)) __obj.updateDynamic("kioskModeAllowTouchscreen")(kioskModeAllowTouchscreen.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowVoiceOverSettings)) __obj.updateDynamic("kioskModeAllowVoiceOverSettings")(kioskModeAllowVoiceOverSettings.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowVolumeButtons)) __obj.updateDynamic("kioskModeAllowVolumeButtons")(kioskModeAllowVolumeButtons.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeAllowZoomSettings)) __obj.updateDynamic("kioskModeAllowZoomSettings")(kioskModeAllowZoomSettings.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(kioskModeRequireAssistiveTouch)) __obj.updateDynamic("kioskModeRequireAssistiveTouch")(kioskModeRequireAssistiveTouch.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeRequireColorInversion)) __obj.updateDynamic("kioskModeRequireColorInversion")(kioskModeRequireColorInversion.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeRequireMonoAudio)) __obj.updateDynamic("kioskModeRequireMonoAudio")(kioskModeRequireMonoAudio.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeRequireVoiceOver)) __obj.updateDynamic("kioskModeRequireVoiceOver")(kioskModeRequireVoiceOver.asInstanceOf[js.Any])
    if (!js.isUndefined(kioskModeRequireZoom)) __obj.updateDynamic("kioskModeRequireZoom")(kioskModeRequireZoom.asInstanceOf[js.Any])
    if (lastModifiedDateTime != null) __obj.updateDynamic("lastModifiedDateTime")(lastModifiedDateTime.asInstanceOf[js.Any])
    if (!js.isUndefined(lockScreenBlockControlCenter)) __obj.updateDynamic("lockScreenBlockControlCenter")(lockScreenBlockControlCenter.asInstanceOf[js.Any])
    if (!js.isUndefined(lockScreenBlockNotificationView)) __obj.updateDynamic("lockScreenBlockNotificationView")(lockScreenBlockNotificationView.asInstanceOf[js.Any])
    if (!js.isUndefined(lockScreenBlockPassbook)) __obj.updateDynamic("lockScreenBlockPassbook")(lockScreenBlockPassbook.asInstanceOf[js.Any])
    if (!js.isUndefined(lockScreenBlockTodayView)) __obj.updateDynamic("lockScreenBlockTodayView")(lockScreenBlockTodayView.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(messagesBlocked)) __obj.updateDynamic("messagesBlocked")(messagesBlocked.asInstanceOf[js.Any])
    if (networkUsageRules != null) __obj.updateDynamic("networkUsageRules")(networkUsageRules.asInstanceOf[js.Any])
    if (!js.isUndefined(notificationsBlockSettingsModification)) __obj.updateDynamic("notificationsBlockSettingsModification")(notificationsBlockSettingsModification.asInstanceOf[js.Any])
    if (!js.isUndefined(passcodeBlockFingerprintModification)) __obj.updateDynamic("passcodeBlockFingerprintModification")(passcodeBlockFingerprintModification.asInstanceOf[js.Any])
    if (!js.isUndefined(passcodeBlockFingerprintUnlock)) __obj.updateDynamic("passcodeBlockFingerprintUnlock")(passcodeBlockFingerprintUnlock.asInstanceOf[js.Any])
    if (!js.isUndefined(passcodeBlockModification)) __obj.updateDynamic("passcodeBlockModification")(passcodeBlockModification.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(podcastsBlocked)) __obj.updateDynamic("podcastsBlocked")(podcastsBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(safariBlockAutofill)) __obj.updateDynamic("safariBlockAutofill")(safariBlockAutofill.asInstanceOf[js.Any])
    if (!js.isUndefined(safariBlockJavaScript)) __obj.updateDynamic("safariBlockJavaScript")(safariBlockJavaScript.asInstanceOf[js.Any])
    if (!js.isUndefined(safariBlockPopups)) __obj.updateDynamic("safariBlockPopups")(safariBlockPopups.asInstanceOf[js.Any])
    if (!js.isUndefined(safariBlocked)) __obj.updateDynamic("safariBlocked")(safariBlocked.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(safariRequireFraudWarning)) __obj.updateDynamic("safariRequireFraudWarning")(safariRequireFraudWarning.asInstanceOf[js.Any])
    if (!js.isUndefined(screenCaptureBlocked)) __obj.updateDynamic("screenCaptureBlocked")(screenCaptureBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(siriBlockUserGeneratedContent)) __obj.updateDynamic("siriBlockUserGeneratedContent")(siriBlockUserGeneratedContent.asInstanceOf[js.Any])
    if (!js.isUndefined(siriBlocked)) __obj.updateDynamic("siriBlocked")(siriBlocked.asInstanceOf[js.Any])
    if (!js.isUndefined(siriBlockedWhenLocked)) __obj.updateDynamic("siriBlockedWhenLocked")(siriBlockedWhenLocked.asInstanceOf[js.Any])
    if (!js.isUndefined(siriRequireProfanityFilter)) __obj.updateDynamic("siriRequireProfanityFilter")(siriRequireProfanityFilter.asInstanceOf[js.Any])
    if (!js.isUndefined(spotlightBlockInternetResults)) __obj.updateDynamic("spotlightBlockInternetResults")(spotlightBlockInternetResults.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(wallpaperBlockModification)) __obj.updateDynamic("wallpaperBlockModification")(wallpaperBlockModification.asInstanceOf[js.Any])
    if (!js.isUndefined(wiFiConnectOnlyToConfiguredNetworks)) __obj.updateDynamic("wiFiConnectOnlyToConfiguredNetworks")(wiFiConnectOnlyToConfiguredNetworks.asInstanceOf[js.Any])
