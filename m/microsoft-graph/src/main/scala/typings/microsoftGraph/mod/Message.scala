...
object Message {
  ...
  def apply(
    ...
    if (!js.isUndefined(isDeliveryReceiptRequested)) __obj.updateDynamic("isDeliveryReceiptRequested")(isDeliveryReceiptRequested.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isReadReceiptRequested)) __obj.updateDynamic("isReadReceiptRequested")(isReadReceiptRequested.get.asInstanceOf[js.Any])
