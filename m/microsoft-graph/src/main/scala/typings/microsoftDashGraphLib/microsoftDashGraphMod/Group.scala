...
trait Group extends DirectoryObject {
  ...
  var preferredDataLocation: js.UndefOr[java.lang.String] = js.undefined
  /**
...
object Group {
  ...
  def apply(
    ...
    preferredDataLocation: java.lang.String = null,
    ...
    if (preferredDataLocation != null) __obj.updateDynamic("preferredDataLocation")(preferredDataLocation)
