...
object MessageRuleActions {
  @scala.inline
  def apply(
    assignCategories: js.Array[java.lang.String] = null,
    copyToFolder: java.lang.String = null,
    ...
    markAsRead: js.UndefOr[scala.Boolean] = js.undefined,
    markImportance: Importance = null,
    moveToFolder: java.lang.String = null,
    permanentDelete: js.UndefOr[scala.Boolean] = js.undefined,
    redirectTo: js.Array[Recipient] = null,
    stopProcessingRules: js.UndefOr[scala.Boolean] = js.undefined
  ): MessageRuleActions = {
