...
object Windows10EndpointProtectionConfiguration {
  ...
  def apply(
    ...
    applicationGuardAllowPersistence: js.UndefOr[scala.Boolean] = js.undefined,
    applicationGuardAllowPrintToLocalPrinters: js.UndefOr[scala.Boolean] = js.undefined,
    applicationGuardAllowPrintToNetworkPrinters: js.UndefOr[scala.Boolean] = js.undefined,
    applicationGuardAllowPrintToPDF: js.UndefOr[scala.Boolean] = js.undefined,
    applicationGuardAllowPrintToXPS: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    applicationGuardBlockNonEnterpriseContent: js.UndefOr[scala.Boolean] = js.undefined,
    applicationGuardEnabled: js.UndefOr[scala.Boolean] = js.undefined,
    applicationGuardForceAuditing: js.UndefOr[scala.Boolean] = js.undefined,
    assignments: js.Array[DeviceConfigurationAssignment] = null,
    bitLockerDisableWarningForOtherDiskEncryption: js.UndefOr[scala.Boolean] = js.undefined,
    bitLockerEnableStorageCardEncryptionOnMobile: js.UndefOr[scala.Boolean] = js.undefined,
    bitLockerEncryptDevice: js.UndefOr[scala.Boolean] = js.undefined,
    bitLockerRemovableDrivePolicy: BitLockerRemovableDrivePolicy = null,
    createdDateTime: java.lang.String = null,
    defenderAdditionalGuardedFolders: js.Array[java.lang.String] = null,
    defenderAttackSurfaceReductionExcludedPaths: js.Array[java.lang.String] = null,
    defenderExploitProtectionXml: scala.Int | scala.Double = null,
    defenderExploitProtectionXmlFileName: java.lang.String = null,
    defenderGuardedFoldersAllowedAppPaths: js.Array[java.lang.String] = null,
    defenderSecurityCenterBlockExploitProtectionOverride: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    firewallBlockStatefulFTP: js.UndefOr[scala.Boolean] = js.undefined,
    firewallCertificateRevocationListCheckMethod: FirewallCertificateRevocationListCheckMethodType = null,
    firewallIPSecExemptionsAllowDHCP: js.UndefOr[scala.Boolean] = js.undefined,
    firewallIPSecExemptionsAllowICMP: js.UndefOr[scala.Boolean] = js.undefined,
    firewallIPSecExemptionsAllowNeighborDiscovery: js.UndefOr[scala.Boolean] = js.undefined,
    firewallIPSecExemptionsAllowRouterDiscovery: js.UndefOr[scala.Boolean] = js.undefined,
    firewallIdleTimeoutForSecurityAssociationInSeconds: scala.Int | scala.Double = null,
    firewallMergeKeyingModuleSettings: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    smartScreenBlockOverrideForFiles: js.UndefOr[scala.Boolean] = js.undefined,
    smartScreenEnableInShell: js.UndefOr[scala.Boolean] = js.undefined,
