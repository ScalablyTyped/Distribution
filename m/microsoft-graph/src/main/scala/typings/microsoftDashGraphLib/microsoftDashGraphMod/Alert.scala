...
trait Alert extends Entity {
  ...
  var activityGroupName: js.UndefOr[java.lang.String] = js.undefined
  // Name of the analyst the alert is assigned to for triage, investigation, or remediation (supports update).
  var assignedTo: js.UndefOr[java.lang.String] = js.undefined
  // Azure subscription ID, present if this alert is related to an Azure resource.
  var azureSubscriptionId: js.UndefOr[java.lang.String] = js.undefined
  ...
  /**
    ...
    * update).
    */
  var closedDateTime: js.UndefOr[java.lang.String] = js.undefined
  ...
  var detectionIds: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  /**
  ...
  /**
    ...
    * reimage host).
    */
  var recommendedActions: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  ...
  /**
    ...
    * search, etc.
    */
  var sourceMaterials: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  /**
...
object Alert {
  @scala.inline
  def apply(
    activityGroupName: java.lang.String = null,
    assignedTo: java.lang.String = null,
    azureSubscriptionId: java.lang.String = null,
    azureTenantId: java.lang.String = null,
    category: java.lang.String = null,
    closedDateTime: java.lang.String = null,
    ...
    detectionIds: js.Array[java.lang.String] = null,
    ...
    recommendedActions: js.Array[java.lang.String] = null,
    registryKeyStates: js.Array[RegistryKeyState] = null,
    severity: AlertSeverity = null,
    sourceMaterials: js.Array[java.lang.String] = null,
    ...
    if (activityGroupName != null) __obj.updateDynamic("activityGroupName")(activityGroupName)
    if (assignedTo != null) __obj.updateDynamic("assignedTo")(assignedTo)
    if (azureSubscriptionId != null) __obj.updateDynamic("azureSubscriptionId")(azureSubscriptionId)
    if (azureTenantId != null) __obj.updateDynamic("azureTenantId")(azureTenantId)
    if (category != null) __obj.updateDynamic("category")(category)
    if (closedDateTime != null) __obj.updateDynamic("closedDateTime")(closedDateTime)
    if (cloudAppStates != null) __obj.updateDynamic("cloudAppStates")(cloudAppStates)
    if (comments != null) __obj.updateDynamic("comments")(comments)
    if (confidence != null) __obj.updateDynamic("confidence")(confidence.asInstanceOf[js.Any])
    if (createdDateTime != null) __obj.updateDynamic("createdDateTime")(createdDateTime)
    if (description != null) __obj.updateDynamic("description")(description)
    if (detectionIds != null) __obj.updateDynamic("detectionIds")(detectionIds)
    ...
    if (fileStates != null) __obj.updateDynamic("fileStates")(fileStates)
    if (historyStates != null) __obj.updateDynamic("historyStates")(historyStates)
    if (hostStates != null) __obj.updateDynamic("hostStates")(hostStates)
    if (id != null) __obj.updateDynamic("id")(id)
    if (lastModifiedDateTime != null) __obj.updateDynamic("lastModifiedDateTime")(lastModifiedDateTime)
    if (malwareStates != null) __obj.updateDynamic("malwareStates")(malwareStates)
    if (networkConnections != null) __obj.updateDynamic("networkConnections")(networkConnections)
    if (processes != null) __obj.updateDynamic("processes")(processes)
    if (recommendedActions != null) __obj.updateDynamic("recommendedActions")(recommendedActions)
    if (registryKeyStates != null) __obj.updateDynamic("registryKeyStates")(registryKeyStates)
    if (severity != null) __obj.updateDynamic("severity")(severity)
    if (sourceMaterials != null) __obj.updateDynamic("sourceMaterials")(sourceMaterials)
    ...
    if (vulnerabilityStates != null) __obj.updateDynamic("vulnerabilityStates")(vulnerabilityStates)
