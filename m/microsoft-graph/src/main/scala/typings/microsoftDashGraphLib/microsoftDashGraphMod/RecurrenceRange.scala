...
trait RecurrenceRange extends js.Object {
  ...
  var numberOfOccurrences: js.UndefOr[scala.Double] = js.undefined
  /** Time zone for the startDate and endDate properties. Optional. If not specified, the time zone of the event is used. */
  var recurrenceTimeZone: js.UndefOr[java.lang.String] = js.undefined
  /**
...
object RecurrenceRange {
  ...
  def apply(
    ...
    numberOfOccurrences: scala.Int | scala.Double = null,
    recurrenceTimeZone: java.lang.String = null,
