...
trait User extends DirectoryObject {
  ...
  /**
    ...
    */
  var signInSessionsValidFromDateTime: js.UndefOr[java.lang.String] = js.undefined
...
object User {
  ...
  def apply(
    ...
    signInSessionsValidFromDateTime: java.lang.String = null,
    ...
    if (signInSessionsValidFromDateTime != null) __obj.updateDynamic("signInSessionsValidFromDateTime")(signInSessionsValidFromDateTime)
