...
@js.native
trait NameOauthtokenPrettyPrint extends js.Object {
...
object NameOauthtokenPrettyPrint {
  ...
  @scala.inline
  def apply(name: String): NameOauthtokenPrettyPrint = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[NameOauthtokenPrettyPrint]
  }
  
  @scala.inline
  implicit class NameOauthtokenPrettyPrintOps[Self <: NameOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
