...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: SetNodePoolManagementRequest = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(name: String, resource: SetNodePoolManagementRequest): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetNodePoolManagementRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
