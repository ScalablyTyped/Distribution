...
@js.native
trait ProjectIdQuotaUserUploadType extends js.Object {
...
object ProjectIdQuotaUserUploadType {
  ...
  @scala.inline
  def apply(projectId: String, zone: String): ProjectIdQuotaUserUploadType = {
  ...
  @scala.inline
  implicit class ProjectIdQuotaUserUploadTypeOps[Self <: ProjectIdQuotaUserUploadType] (val x: Self) extends AnyVal {
