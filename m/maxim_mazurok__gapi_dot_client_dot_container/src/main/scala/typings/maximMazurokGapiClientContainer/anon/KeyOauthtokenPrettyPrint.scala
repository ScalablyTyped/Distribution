...
import typings.maximMazurokGapiClientContainer.gapi.client.container.UpdateMasterRequest
...
object KeyOauthtokenPrettyPrint {
  ...
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: UpdateMasterRequest, zone: String): KeyOauthtokenPrettyPrint = {
