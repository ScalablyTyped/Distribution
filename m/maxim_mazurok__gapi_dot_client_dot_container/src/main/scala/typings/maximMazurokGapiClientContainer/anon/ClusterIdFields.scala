...
trait ClusterIdFields extends StObject {
...
object ClusterIdFields {
  ...
  @scala.inline
  def apply(name: String): ClusterIdFields = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClusterIdFields]
  }
  
  @scala.inline
  implicit class ClusterIdFieldsMutableBuilder[Self <: ClusterIdFields] (val x: Self) extends AnyVal {
