...
object NameOauthtokenOperationId {
  ...
  inline def apply(operationId: String, projectId: String, zone: String): NameOauthtokenOperationId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NameOauthtokenOperationId] (val x: Self) extends AnyVal {
