...
@js.native
trait CallbackClusterId extends js.Object {
...
object CallbackClusterId {
  ...
  @scala.inline
  implicit class CallbackClusterIdOps[Self <: CallbackClusterId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateNodePoolRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
