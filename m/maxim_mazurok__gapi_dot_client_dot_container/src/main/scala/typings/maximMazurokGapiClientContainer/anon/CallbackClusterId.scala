...
object CallbackClusterId {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackClusterId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: SetNodePoolSizeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
