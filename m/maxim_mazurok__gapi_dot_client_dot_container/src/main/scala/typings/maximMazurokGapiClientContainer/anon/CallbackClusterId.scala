...
@js.native
trait CallbackClusterId extends StObject {
  ...
  /** Request body */
  var resource: UpdateNodePoolRequest = js.native
...
object CallbackClusterId {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CallbackClusterId]
  }
  
  @scala.inline
  implicit class CallbackClusterIdMutableBuilder[Self <: CallbackClusterId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateNodePoolRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
