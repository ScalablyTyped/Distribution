...
trait ProjectIdQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: CompleteIPRotationRequest
...
object ProjectIdQuotaUser {
  ...
  inline def apply(clusterId: String, projectId: String, resource: CompleteIPRotationRequest, zone: String): ProjectIdQuotaUser = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectIdQuotaUser] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: CompleteIPRotationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
