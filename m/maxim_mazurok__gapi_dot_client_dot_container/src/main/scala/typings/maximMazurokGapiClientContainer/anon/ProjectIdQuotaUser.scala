...
@js.native
trait ProjectIdQuotaUser extends js.Object {
...
object ProjectIdQuotaUser {
  ...
  @scala.inline
  implicit class ProjectIdQuotaUserOps[Self <: ProjectIdQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CompleteIPRotationRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
