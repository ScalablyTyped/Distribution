...
import typings.maximMazurokGapiClientContainer.gapi.client.container.CompleteIPRotationRequest
...
@js.native
trait ProjectIdQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: CompleteIPRotationRequest = js.native
...
object ProjectIdQuotaUser {
  
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: CompleteIPRotationRequest, zone: String): ProjectIdQuotaUser = {
    ...
    __obj.asInstanceOf[ProjectIdQuotaUser]
  }
  
  @scala.inline
  implicit class ProjectIdQuotaUserMutableBuilder[Self <: ProjectIdQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CompleteIPRotationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
