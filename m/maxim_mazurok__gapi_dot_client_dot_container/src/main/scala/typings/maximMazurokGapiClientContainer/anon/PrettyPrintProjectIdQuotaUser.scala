...
@js.native
trait PrettyPrintProjectIdQuotaUser extends js.Object {
...
object PrettyPrintProjectIdQuotaUser {
  ...
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: SetLabelsRequest, zone: String): PrettyPrintProjectIdQuotaUser = {
  ...
  @scala.inline
  implicit class PrettyPrintProjectIdQuotaUserOps[Self <: PrettyPrintProjectIdQuotaUser] (val x: Self) extends AnyVal {
