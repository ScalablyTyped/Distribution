...
import typings.maximMazurokGapiClientContainer.gapi.client.container.SetLoggingServiceRequest
...
trait FieldsKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: SetLoggingServiceRequest
...
object FieldsKeyOauthtoken {
  ...
  inline def apply(clusterId: String, projectId: String, resource: SetLoggingServiceRequest, zone: String): FieldsKeyOauthtoken = {
  ...
  implicit open class MutableBuilder[Self <: FieldsKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: SetLoggingServiceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
