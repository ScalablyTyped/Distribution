...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: SetNodePoolAutoscalingRequest = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(name: String, resource: SetNodePoolAutoscalingRequest): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetNodePoolAutoscalingRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
