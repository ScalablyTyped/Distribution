...
import typings.maximMazurokGapiClientContainer.gapi.client.container.UpdateClusterRequest
...
@js.native
trait UploadprotocolXgafvZone extends StObject {
  ...
  /** Request body */
  var resource: UpdateClusterRequest = js.native
...
object UploadprotocolXgafvZone {
  
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: UpdateClusterRequest, zone: String): UploadprotocolXgafvZone = {
    ...
    __obj.asInstanceOf[UploadprotocolXgafvZone]
  }
  
  @scala.inline
  implicit class UploadprotocolXgafvZoneMutableBuilder[Self <: UploadprotocolXgafvZone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateClusterRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
