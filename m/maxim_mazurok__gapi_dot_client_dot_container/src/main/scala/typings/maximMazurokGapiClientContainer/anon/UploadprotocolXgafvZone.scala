...
@js.native
trait UploadprotocolXgafvZone extends js.Object {
...
object UploadprotocolXgafvZone {
  ...
  @scala.inline
  implicit class UploadprotocolXgafvZoneOps[Self <: UploadprotocolXgafvZone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateClusterRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
