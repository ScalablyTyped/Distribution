...
object UploadprotocolXgafvZone {
  ...
  inline def apply(clusterId: String, projectId: String, resource: UpdateClusterRequest, zone: String): UploadprotocolXgafvZone = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UploadprotocolXgafvZone] (val x: Self) extends AnyVal {
