...
@js.native
trait OauthtokenPrettyPrintProjectId extends js.Object {
...
object OauthtokenPrettyPrintProjectId {
  ...
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectIdOps[Self <: OauthtokenPrettyPrintProjectId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetMonitoringServiceRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
