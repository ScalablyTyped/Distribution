...
import typings.maximMazurokGapiClientContainer.gapi.client.container.SetMonitoringServiceRequest
...
@js.native
trait OauthtokenPrettyPrintProjectId extends StObject {
  ...
  /** Request body */
  var resource: SetMonitoringServiceRequest = js.native
...
object OauthtokenPrettyPrintProjectId {
  
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: SetMonitoringServiceRequest, zone: String): OauthtokenPrettyPrintProjectId = {
    ...
    __obj.asInstanceOf[OauthtokenPrettyPrintProjectId]
  }
  
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectIdMutableBuilder[Self <: OauthtokenPrettyPrintProjectId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetMonitoringServiceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
