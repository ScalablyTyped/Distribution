...
trait PrettyPrintProjectId extends StObject {
  ...
  /** Request body */
  var resource: SetAddonsConfigRequest = js.native
...
object PrettyPrintProjectId {
  ...
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: SetAddonsConfigRequest, zone: String): PrettyPrintProjectId = {
  ...
  implicit class PrettyPrintProjectIdMutableBuilder[Self <: PrettyPrintProjectId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetAddonsConfigRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
