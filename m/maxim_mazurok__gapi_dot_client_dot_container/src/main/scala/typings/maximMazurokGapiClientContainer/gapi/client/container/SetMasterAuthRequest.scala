...
object SetMasterAuthRequest {
  ...
  @scala.inline
  implicit class SetMasterAuthRequestMutableBuilder[Self <: SetMasterAuthRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUpdate(value: MasterAuth): Self = StObject.set(x, "update", value.asInstanceOf[js.Any])
