...
class PreparedStatement () extends EventEmitter {
  ...
  def execute(values: js.Object): js.Promise[IProcedureResult[js.Any]] = js.native
  def execute(
    values: js.Object,
    callback: js.Function2[/* err */ js.UndefOr[Error], /* result */ js.UndefOr[IProcedureResult[js.Any]], Unit]
  ): Request = js.native
  @JSName("execute")
  ...
  def prepare(statement: Unit, callback: js.Function1[/* err */ js.UndefOr[Error], Unit]): PreparedStatement = js.native
  @JSName("prepare")
