...
trait IBulkOptions extends js.Object {
  ...
  var checkConstraints: js.UndefOr[scala.Boolean] = js.undefined
  /** Honors insert triggers during bulk load, using the T-SQL FIRE_TRIGGERS. (default: false) */
  var fireTriggers: js.UndefOr[scala.Boolean] = js.undefined
  /** Honors null value passed, ignores the default values set on table, using T-SQL KEEP_NULLS. (default: false) */
  var keepNulls: js.UndefOr[scala.Boolean] = js.undefined
  /** Places a bulk update(BU) lock on table while performing bulk load, using T-SQL TABLOCK. (default: false) */
  var tableLock: js.UndefOr[scala.Boolean] = js.undefined
}

object IBulkOptions {
  @scala.inline
  def apply(
    checkConstraints: js.UndefOr[scala.Boolean] = js.undefined,
    fireTriggers: js.UndefOr[scala.Boolean] = js.undefined,
    keepNulls: js.UndefOr[scala.Boolean] = js.undefined,
    tableLock: js.UndefOr[scala.Boolean] = js.undefined
  ): IBulkOptions = {
