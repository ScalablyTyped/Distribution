...
trait GoogleCloudDialogflowCxV3FormParameter extends StObject {
  ...
  var fillBehavior: js.UndefOr[GoogleCloudDialogflowCxV3FormParameterFillBehavior] = js.undefined
...
object GoogleCloudDialogflowCxV3FormParameter {
  
  inline def apply(): GoogleCloudDialogflowCxV3FormParameter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3FormParameter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowCxV3FormParameter] (val x: Self) extends AnyVal {
    ...
    inline def setFillBehavior(value: GoogleCloudDialogflowCxV3FormParameterFillBehavior): Self = StObject.set(x, "fillBehavior", value.asInstanceOf[js.Any])
