...
@js.native
trait GoogleCloudDialogflowV2IntentMessageColumnProperties extends js.Object {
...
object GoogleCloudDialogflowV2IntentMessageColumnProperties {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2IntentMessageColumnPropertiesOps[Self <: GoogleCloudDialogflowV2IntentMessageColumnProperties] (val x: Self) extends AnyVal {
