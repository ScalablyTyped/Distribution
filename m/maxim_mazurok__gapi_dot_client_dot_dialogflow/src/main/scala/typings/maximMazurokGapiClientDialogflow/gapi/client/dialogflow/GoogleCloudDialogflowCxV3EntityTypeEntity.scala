...
trait GoogleCloudDialogflowCxV3EntityTypeEntity extends StObject {
...
object GoogleCloudDialogflowCxV3EntityTypeEntity {
  
  inline def apply(): GoogleCloudDialogflowCxV3EntityTypeEntity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3EntityTypeEntity]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowCxV3EntityTypeEntity] (val x: Self) extends AnyVal {
