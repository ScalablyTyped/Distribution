...
trait GoogleCloudDialogflowV2FaqAnswer extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowV2FaqAnswer & TopLevel[Any]
  ] = js.undefined
...
object GoogleCloudDialogflowV2FaqAnswer {
  ...
  extension [Self <: GoogleCloudDialogflowV2FaqAnswer](x: Self) {
