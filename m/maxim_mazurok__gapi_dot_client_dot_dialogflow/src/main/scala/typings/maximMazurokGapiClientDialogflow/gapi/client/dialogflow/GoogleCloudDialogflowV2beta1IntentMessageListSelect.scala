...
object GoogleCloudDialogflowV2beta1IntentMessageListSelect {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowV2beta1IntentMessageListSelect] (val x: Self) extends AnyVal {
    ...
    inline def setItemsVarargs(value: GoogleCloudDialogflowV2beta1IntentMessageListSelectItem*): Self = StObject.set(x, "items", js.Array(value*))
