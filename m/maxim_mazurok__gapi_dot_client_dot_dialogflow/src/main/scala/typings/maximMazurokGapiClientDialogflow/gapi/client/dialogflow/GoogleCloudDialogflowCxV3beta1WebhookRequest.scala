...
@js.native
trait GoogleCloudDialogflowCxV3beta1WebhookRequest extends js.Object {
...
object GoogleCloudDialogflowCxV3beta1WebhookRequest {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowCxV3beta1WebhookRequestOps[Self <: GoogleCloudDialogflowCxV3beta1WebhookRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFulfillmentInfo(value: GoogleCloudDialogflowCxV3beta1WebhookRequestFulfillmentInfo): Self = this.set("fulfillmentInfo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFulfillmentInfo: Self = this.set("fulfillmentInfo", js.undefined)
    
    @scala.inline
    def setIntentInfo(value: GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo): Self = this.set("intentInfo", value.asInstanceOf[js.Any])
