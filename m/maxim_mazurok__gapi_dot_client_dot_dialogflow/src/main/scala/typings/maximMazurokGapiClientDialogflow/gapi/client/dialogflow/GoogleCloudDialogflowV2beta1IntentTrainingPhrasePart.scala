...
@js.native
trait GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart extends js.Object {
...
object GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart {
  ...
  @scala.inline
  def apply(): GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart]
  }
  
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentTrainingPhrasePartOps[Self <: GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart] (val x: Self) extends AnyVal {
