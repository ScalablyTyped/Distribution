...
trait GoogleCloudDialogflowCxV3TransitionRoute extends StObject {
...
object GoogleCloudDialogflowCxV3TransitionRoute {
  
  inline def apply(): GoogleCloudDialogflowCxV3TransitionRoute = {
