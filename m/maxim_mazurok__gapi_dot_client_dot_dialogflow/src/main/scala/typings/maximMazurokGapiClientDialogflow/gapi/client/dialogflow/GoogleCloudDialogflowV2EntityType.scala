...
trait GoogleCloudDialogflowV2EntityType extends StObject {
...
object GoogleCloudDialogflowV2EntityType {
  ...
  inline def apply(): GoogleCloudDialogflowV2EntityType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2EntityType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowV2EntityType] (val x: Self) extends AnyVal {
    ...
    inline def setEntitiesVarargs(value: GoogleCloudDialogflowV2EntityTypeEntity*): Self = StObject.set(x, "entities", js.Array(value*))
