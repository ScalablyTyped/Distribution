...
trait GoogleCloudDialogflowV2beta1FaqAnswer extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowV2beta1FaqAnswer & TopLevel[Any]
  ] = js.undefined
...
object GoogleCloudDialogflowV2beta1FaqAnswer {
  
  inline def apply(): GoogleCloudDialogflowV2beta1FaqAnswer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2beta1FaqAnswer]
  }
  
  extension [Self <: GoogleCloudDialogflowV2beta1FaqAnswer](x: Self) {
