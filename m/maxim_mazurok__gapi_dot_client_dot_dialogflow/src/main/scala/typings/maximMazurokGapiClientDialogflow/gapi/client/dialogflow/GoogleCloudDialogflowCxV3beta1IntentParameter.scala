...
trait GoogleCloudDialogflowCxV3beta1IntentParameter extends StObject {
...
object GoogleCloudDialogflowCxV3beta1IntentParameter {
  
  inline def apply(): GoogleCloudDialogflowCxV3beta1IntentParameter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3beta1IntentParameter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowCxV3beta1IntentParameter] (val x: Self) extends AnyVal {
