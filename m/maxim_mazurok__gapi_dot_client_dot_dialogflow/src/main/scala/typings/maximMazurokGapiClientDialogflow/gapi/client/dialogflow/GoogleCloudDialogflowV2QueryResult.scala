...
trait GoogleCloudDialogflowV2QueryResult extends StObject {
  ...
  {[ P in string ]: any}
    */ typings.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowV2QueryResult with TopLevel[js.Any]
  ] = js.native
  ...
  var sentimentAnalysisResult: js.UndefOr[GoogleCloudDialogflowV2SentimentAnalysisResult] = js.native
...
object GoogleCloudDialogflowV2QueryResult {
  ...
  implicit class GoogleCloudDialogflowV2QueryResultMutableBuilder[Self <: GoogleCloudDialogflowV2QueryResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSentimentAnalysisResult(value: GoogleCloudDialogflowV2SentimentAnalysisResult): Self = StObject.set(x, "sentimentAnalysisResult", value.asInstanceOf[js.Any])
