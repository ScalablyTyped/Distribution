...
trait GoogleCloudDialogflowV2beta1Message extends StObject {
  ...
  var messageAnnotation: js.UndefOr[GoogleCloudDialogflowV2beta1MessageAnnotation] = js.undefined
  ...
  var sentimentAnalysis: js.UndefOr[GoogleCloudDialogflowV2beta1SentimentAnalysisResult] = js.undefined
}
object GoogleCloudDialogflowV2beta1Message {
  
  inline def apply(): GoogleCloudDialogflowV2beta1Message = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2beta1Message]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowV2beta1Message] (val x: Self) extends AnyVal {
    ...
    inline def setMessageAnnotation(value: GoogleCloudDialogflowV2beta1MessageAnnotation): Self = StObject.set(x, "messageAnnotation", value.asInstanceOf[js.Any])
    ...
    inline def setSentimentAnalysis(value: GoogleCloudDialogflowV2beta1SentimentAnalysisResult): Self = StObject.set(x, "sentimentAnalysis", value.asInstanceOf[js.Any])
