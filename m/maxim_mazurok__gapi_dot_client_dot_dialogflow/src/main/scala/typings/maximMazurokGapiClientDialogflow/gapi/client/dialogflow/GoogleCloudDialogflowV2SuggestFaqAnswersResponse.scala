...
trait GoogleCloudDialogflowV2SuggestFaqAnswersResponse extends StObject {
  ...
  var faqAnswers: js.UndefOr[js.Array[GoogleCloudDialogflowV2FaqAnswer]] = js.undefined
...
object GoogleCloudDialogflowV2SuggestFaqAnswersResponse {
  
  inline def apply(): GoogleCloudDialogflowV2SuggestFaqAnswersResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2SuggestFaqAnswersResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowV2SuggestFaqAnswersResponse] (val x: Self) extends AnyVal {
    ...
    inline def setFaqAnswers(value: js.Array[GoogleCloudDialogflowV2FaqAnswer]): Self = StObject.set(x, "faqAnswers", value.asInstanceOf[js.Any])
    
    inline def setFaqAnswersUndefined: Self = StObject.set(x, "faqAnswers", js.undefined)
    
    inline def setFaqAnswersVarargs(value: GoogleCloudDialogflowV2FaqAnswer*): Self = StObject.set(x, "faqAnswers", js.Array(value*))
