...
@js.native
trait GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem extends js.Object {
...
object GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItemOps[Self <: GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInfo(value: GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo): Self = this.set("info", value.asInstanceOf[js.Any])
