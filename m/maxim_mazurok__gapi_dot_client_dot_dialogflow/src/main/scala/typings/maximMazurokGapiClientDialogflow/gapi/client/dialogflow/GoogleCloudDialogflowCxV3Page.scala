...
trait GoogleCloudDialogflowCxV3Page extends StObject {
  
  /** Required. The human-readable name of the page, unique within the flow. */
  var displayName: js.UndefOr[String] = js.undefined
  
  /** The fulfillment to call when the session is entering the page. */
  var entryFulfillment: js.UndefOr[GoogleCloudDialogflowCxV3Fulfillment] = js.undefined
  ...
  var form: js.UndefOr[GoogleCloudDialogflowCxV3Form] = js.undefined
...
object GoogleCloudDialogflowCxV3Page {
  
  inline def apply(): GoogleCloudDialogflowCxV3Page = {
  ...
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowCxV3Page] (val x: Self) extends AnyVal {
    ...
    inline def setEntryFulfillment(value: GoogleCloudDialogflowCxV3Fulfillment): Self = StObject.set(x, "entryFulfillment", value.asInstanceOf[js.Any])
    ...
    inline def setForm(value: GoogleCloudDialogflowCxV3Form): Self = StObject.set(x, "form", value.asInstanceOf[js.Any])
