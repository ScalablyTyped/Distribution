...
trait GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior extends StObject {
  ...
  var initialPromptFulfillment: js.UndefOr[GoogleCloudDialogflowCxV3beta1Fulfillment] = js.undefined
  ...
  /**
    ...
    * re-prompted.
    */
  var repromptEventHandlers: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3beta1EventHandler]] = js.undefined
}
object GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior {
  
  inline def apply(): GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior] (val x: Self) extends AnyVal {
    
    inline def setInitialPromptFulfillment(value: GoogleCloudDialogflowCxV3beta1Fulfillment): Self = StObject.set(x, "initialPromptFulfillment", value.asInstanceOf[js.Any])
    
    inline def setInitialPromptFulfillmentUndefined: Self = StObject.set(x, "initialPromptFulfillment", js.undefined)
    
    inline def setRepromptEventHandlers(value: js.Array[GoogleCloudDialogflowCxV3beta1EventHandler]): Self = StObject.set(x, "repromptEventHandlers", value.asInstanceOf[js.Any])
    
    inline def setRepromptEventHandlersUndefined: Self = StObject.set(x, "repromptEventHandlers", js.undefined)
    
    inline def setRepromptEventHandlersVarargs(value: GoogleCloudDialogflowCxV3beta1EventHandler*): Self = StObject.set(x, "repromptEventHandlers", js.Array(value*))
  }
}
