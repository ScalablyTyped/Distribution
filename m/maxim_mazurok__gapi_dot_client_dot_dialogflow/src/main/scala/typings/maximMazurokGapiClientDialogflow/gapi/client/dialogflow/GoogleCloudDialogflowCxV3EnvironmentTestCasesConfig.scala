...
trait GoogleCloudDialogflowCxV3EnvironmentTestCasesConfig extends StObject {
...
object GoogleCloudDialogflowCxV3EnvironmentTestCasesConfig {
  
  inline def apply(): GoogleCloudDialogflowCxV3EnvironmentTestCasesConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3EnvironmentTestCasesConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowCxV3EnvironmentTestCasesConfig] (val x: Self) extends AnyVal {
