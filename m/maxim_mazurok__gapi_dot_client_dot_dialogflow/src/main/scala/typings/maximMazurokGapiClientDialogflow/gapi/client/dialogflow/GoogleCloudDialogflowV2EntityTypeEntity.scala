...
@js.native
trait GoogleCloudDialogflowV2EntityTypeEntity extends js.Object {
...
object GoogleCloudDialogflowV2EntityTypeEntity {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2EntityTypeEntityOps[Self <: GoogleCloudDialogflowV2EntityTypeEntity] (val x: Self) extends AnyVal {
