...
trait GoogleCloudDialogflowV2beta1SmartReplyAnswer extends StObject {
...
object GoogleCloudDialogflowV2beta1SmartReplyAnswer {
  
  inline def apply(): GoogleCloudDialogflowV2beta1SmartReplyAnswer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2beta1SmartReplyAnswer]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowV2beta1SmartReplyAnswer] (val x: Self) extends AnyVal {
