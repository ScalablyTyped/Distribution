...
@js.native
trait GoogleCloudDialogflowV2ExportAgentResponse extends js.Object {
...
object GoogleCloudDialogflowV2ExportAgentResponse {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2ExportAgentResponseOps[Self <: GoogleCloudDialogflowV2ExportAgentResponse] (val x: Self) extends AnyVal {
