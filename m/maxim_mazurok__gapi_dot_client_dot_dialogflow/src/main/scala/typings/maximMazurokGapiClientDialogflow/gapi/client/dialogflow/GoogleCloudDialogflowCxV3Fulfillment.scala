...
trait GoogleCloudDialogflowCxV3Fulfillment extends StObject {
  
  /** Conditional cases for this fulfillment. */
  var conditionalCases: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3FulfillmentConditionalCases]] = js.undefined
  ...
  var setParameterActions: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3FulfillmentSetParameterAction]] = js.undefined
...
object GoogleCloudDialogflowCxV3Fulfillment {
  
  inline def apply(): GoogleCloudDialogflowCxV3Fulfillment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3Fulfillment]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowCxV3Fulfillment] (val x: Self) extends AnyVal {
    
    inline def setConditionalCases(value: js.Array[GoogleCloudDialogflowCxV3FulfillmentConditionalCases]): Self = StObject.set(x, "conditionalCases", value.asInstanceOf[js.Any])
    
    inline def setConditionalCasesUndefined: Self = StObject.set(x, "conditionalCases", js.undefined)
    
    inline def setConditionalCasesVarargs(value: GoogleCloudDialogflowCxV3FulfillmentConditionalCases*): Self = StObject.set(x, "conditionalCases", js.Array(value*))
    ...
    inline def setSetParameterActions(value: js.Array[GoogleCloudDialogflowCxV3FulfillmentSetParameterAction]): Self = StObject.set(x, "setParameterActions", value.asInstanceOf[js.Any])
    
    inline def setSetParameterActionsUndefined: Self = StObject.set(x, "setParameterActions", js.undefined)
    
    inline def setSetParameterActionsVarargs(value: GoogleCloudDialogflowCxV3FulfillmentSetParameterAction*): Self = StObject.set(x, "setParameterActions", js.Array(value*))
