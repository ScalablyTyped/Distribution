...
trait GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput extends StObject {
  ...
  {[ P in string ]: any}
    */ typings.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput & TopLevel[Any]
  ] = js.undefined
...
object GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput {
  ...
  extension [Self <: GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput](x: Self) {
