...
@js.native
trait GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse extends js.Object {
...
object GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentMessageSimpleResponseOps[Self <: GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse] (val x: Self) extends AnyVal {
