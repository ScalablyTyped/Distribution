...
trait GoogleCloudDialogflowCxV3beta1Intent extends StObject {
  ...
  {[ P in string ]: string}
    */ typings.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowCxV3beta1Intent & TopLevel[Any]
  ] = js.undefined
  ...
  var parameters: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3beta1IntentParameter]] = js.undefined
  ...
  var trainingPhrases: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase]] = js.undefined
}
object GoogleCloudDialogflowCxV3beta1Intent {
  
  inline def apply(): GoogleCloudDialogflowCxV3beta1Intent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3beta1Intent]
  }
  
  extension [Self <: GoogleCloudDialogflowCxV3beta1Intent](x: Self) {
    ...
    inline def setParameters(value: js.Array[GoogleCloudDialogflowCxV3beta1IntentParameter]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setParametersUndefined: Self = StObject.set(x, "parameters", js.undefined)
    
    inline def setParametersVarargs(value: GoogleCloudDialogflowCxV3beta1IntentParameter*): Self = StObject.set(x, "parameters", js.Array(value*))
    
    inline def setPriority(value: Double): Self = StObject.set(x, "priority", value.asInstanceOf[js.Any])
    
    inline def setPriorityUndefined: Self = StObject.set(x, "priority", js.undefined)
    
    inline def setTrainingPhrases(value: js.Array[GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase]): Self = StObject.set(x, "trainingPhrases", value.asInstanceOf[js.Any])
    
    inline def setTrainingPhrasesUndefined: Self = StObject.set(x, "trainingPhrases", js.undefined)
    
    inline def setTrainingPhrasesVarargs(value: GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase*): Self = StObject.set(x, "trainingPhrases", js.Array(value*))
  }
}
