...
trait GoogleCloudDialogflowCxV3beta1InputAudioConfig extends StObject {
...
object GoogleCloudDialogflowCxV3beta1InputAudioConfig {
  ...
  inline def apply(): GoogleCloudDialogflowCxV3beta1InputAudioConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3beta1InputAudioConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleCloudDialogflowCxV3beta1InputAudioConfig] (val x: Self) extends AnyVal {
