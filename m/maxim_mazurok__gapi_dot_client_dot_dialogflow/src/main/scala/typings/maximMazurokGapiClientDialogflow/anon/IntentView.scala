...
@js.native
trait IntentView extends js.Object {
...
object IntentView {
  ...
  @scala.inline
  implicit class IntentViewOps[Self <: IntentView] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDialogflowV2Intent): Self = this.set("resource", value.asInstanceOf[js.Any])
