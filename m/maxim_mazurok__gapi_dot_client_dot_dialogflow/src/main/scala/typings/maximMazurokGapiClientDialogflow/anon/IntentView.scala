...
import typings.maximMazurokGapiClientDialogflow.gapi.client.dialogflow.GoogleCloudDialogflowV2Intent
...
@js.native
trait IntentView extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDialogflowV2Intent = js.native
...
object IntentView {
  ...
  @scala.inline
  def apply(parent: String, resource: GoogleCloudDialogflowV2Intent): IntentView = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[IntentView]
  }
  
  @scala.inline
  implicit class IntentViewMutableBuilder[Self <: IntentView] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDialogflowV2Intent): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
