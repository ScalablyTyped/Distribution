...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDialogflowV2Context = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudDialogflowV2Context): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDialogflowV2Context): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
