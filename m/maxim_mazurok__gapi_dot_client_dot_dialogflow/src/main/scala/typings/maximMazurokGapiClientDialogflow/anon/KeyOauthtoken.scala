...
trait KeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDialogflowV2ExportAgentRequest = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: GoogleCloudDialogflowV2ExportAgentRequest): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDialogflowV2ExportAgentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
