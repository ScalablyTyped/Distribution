...
object LanguageCode {
  ...
  @scala.inline
  implicit class LanguageCodeOps[Self <: LanguageCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDialogflowV2EntityType): Self = this.set("resource", value.asInstanceOf[js.Any])
