...
trait LanguageCode extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDialogflowV2EntityType = js.native
...
object LanguageCode {
  ...
  @scala.inline
  def apply(parent: String, resource: GoogleCloudDialogflowV2EntityType): LanguageCode = {
  ...
  implicit class LanguageCodeMutableBuilder[Self <: LanguageCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDialogflowV2EntityType): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
