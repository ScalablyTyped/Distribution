...
trait LanguageCodeOauthtoken extends StObject {
...
object LanguageCodeOauthtoken {
  
  inline def apply(parent: String, resource: GoogleCloudDialogflowCxV3TransitionRouteGroup): LanguageCodeOauthtoken = {
