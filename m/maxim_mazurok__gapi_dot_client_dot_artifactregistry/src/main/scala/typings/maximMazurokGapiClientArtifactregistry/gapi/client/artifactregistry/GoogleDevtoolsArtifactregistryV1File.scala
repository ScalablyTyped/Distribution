...
trait GoogleDevtoolsArtifactregistryV1File extends StObject {
...
object GoogleDevtoolsArtifactregistryV1File {
  
  inline def apply(): GoogleDevtoolsArtifactregistryV1File = {
