...
import typings.atMaterialSnackbar.atMaterialSnackbarStrings.MDCSnackbarColonhide
import typings.atMaterialSnackbar.atMaterialSnackbarStrings.MDCSnackbarColonshow
