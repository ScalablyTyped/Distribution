...
object RelativeTimeKey {
  ...
  @scala.inline
  def MM: typings.momentMini.momentMiniStrings.MM = "MM".asInstanceOf[typings.momentMini.momentMiniStrings.MM]
  
  @scala.inline
  def d: d_ = "d".asInstanceOf[d_]
  
  @scala.inline
  def dd: typings.momentMini.momentMiniStrings.dd = "dd".asInstanceOf[typings.momentMini.momentMiniStrings.dd]
  
  @scala.inline
  def h: typings.momentMini.momentMiniStrings.h = "h".asInstanceOf[typings.momentMini.momentMiniStrings.h]
  
  @scala.inline
  def hh: typings.momentMini.momentMiniStrings.hh = "hh".asInstanceOf[typings.momentMini.momentMiniStrings.hh]
  ...
  @scala.inline
  def ss: typings.momentMini.momentMiniStrings.ss = "ss".asInstanceOf[typings.momentMini.momentMiniStrings.ss]
  
  @scala.inline
  def y: typings.momentMini.momentMiniStrings.y = "y".asInstanceOf[typings.momentMini.momentMiniStrings.y]
  
  @scala.inline
  def yy: typings.momentMini.momentMiniStrings.yy = "yy".asInstanceOf[typings.momentMini.momentMiniStrings.yy]
}
