...
object Query extends js.Object {
  ...
  def count(query: js.Object): stdLib.Promise[scala.Double] = js.native
  ...
  def find[T /* <: mongoritoLib.mongoritoMod.Model */](`this`: mongoritoLib.mongoritoMod.Class[T]): stdLib.Promise[js.Array[T]] = js.native
  def find[T /* <: mongoritoLib.mongoritoMod.Model */](`this`: mongoritoLib.mongoritoMod.Class[T], query: js.Object): stdLib.Promise[js.Array[T]] = js.native
  def findById[T /* <: mongoritoLib.mongoritoMod.Model */](`this`: mongoritoLib.mongoritoMod.Class[T], id: java.lang.String): stdLib.Promise[T | scala.Null] = js.native
  def findById[T /* <: mongoritoLib.mongoritoMod.Model */](`this`: mongoritoLib.mongoritoMod.Class[T], id: js.Object): stdLib.Promise[T | scala.Null] = js.native
  def findOne[T /* <: mongoritoLib.mongoritoMod.Model */](`this`: mongoritoLib.mongoritoMod.Class[T]): stdLib.Promise[T | scala.Null] = js.native
  def findOne[T /* <: mongoritoLib.mongoritoMod.Model */](`this`: mongoritoLib.mongoritoMod.Class[T], query: js.Object): stdLib.Promise[T | scala.Null] = js.native
   // TODO best parameter type
  ...
  def include(query: js.Object): mongoritoLib.mongoritoMod.Query = js.native
   // TODO best parameter type
  def remove(): stdLib.Promise[js.Object] = js.native
   // TODO best parameter type
  def remove(query: js.Object): stdLib.Promise[js.Object] = js.native
