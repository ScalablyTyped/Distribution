...
import typings.mongodb.mod.DropIndexesOptions
...
@js.native
open class Model () extends Query {
  ...
  def getCollection(): js.Promise[Collection[Any]] = js.native
...
object Model {
  ...
  /**
    ...
    */
  inline def createIndex(fieldOrSpec: Any): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("createIndex")(fieldOrSpec.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  inline def createIndex(fieldOrSpec: Any, options: CreateIndexesOptions): js.Promise[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("createIndex")(fieldOrSpec.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[String]]
  ...
  inline def dropIndex(indexName: String, options: DropIndexesOptions): js.Promise[js.Object] = (^.asInstanceOf[js.Dynamic].applyDynamic("dropIndex")(indexName.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Object]]
  ...
  /**
    ...
    */
  inline def getCollection(): js.Promise[Collection[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getCollection")().asInstanceOf[js.Promise[Collection[Any]]]
  ...
  /**
    ...
    */
  inline def listIndexes(): js.Promise[js.Array[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listIndexes")().asInstanceOf[js.Promise[js.Array[Any]]]
  inline def listIndexes(options: BatchSize): js.Promise[js.Array[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listIndexes")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[Any]]]
  ...
  inline def query(method: String, query: js.Array[js.Tuple2[String, Any]]): js.Promise[js.Array[js.Object]] = (^.asInstanceOf[js.Dynamic].applyDynamic("query")(method.asInstanceOf[js.Any], query.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[js.Object]]]
