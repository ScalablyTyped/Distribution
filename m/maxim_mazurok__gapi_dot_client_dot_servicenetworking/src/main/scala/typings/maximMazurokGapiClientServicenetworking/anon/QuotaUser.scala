...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: AddDnsZoneRequest = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(parent: String, resource: AddDnsZoneRequest): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AddDnsZoneRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
