...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: AddDnsRecordSetRequest = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: AddDnsRecordSetRequest): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AddDnsRecordSetRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
