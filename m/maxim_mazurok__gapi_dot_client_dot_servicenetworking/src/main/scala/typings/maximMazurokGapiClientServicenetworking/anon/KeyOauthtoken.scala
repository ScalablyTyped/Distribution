...
import typings.maximMazurokGapiClientServicenetworking.gapi.client.servicenetworking.ValidateConsumerConfigRequest
...
object KeyOauthtoken {
  ...
  inline def apply(parent: String, resource: ValidateConsumerConfigRequest): KeyOauthtoken = {
