...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: SearchRangeRequest = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(parent: String, resource: SearchRangeRequest): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SearchRangeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
