...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: RemoveDnsRecordSetRequest = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: RemoveDnsRecordSetRequest): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RemoveDnsRecordSetRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
