...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: UpdateDnsRecordSetRequest = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(parent: String, resource: UpdateDnsRecordSetRequest): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateDnsRecordSetRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
