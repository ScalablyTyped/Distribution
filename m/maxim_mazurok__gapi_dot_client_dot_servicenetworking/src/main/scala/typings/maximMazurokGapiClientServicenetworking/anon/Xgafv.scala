...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: AddRolesRequest = js.native
...
object Xgafv {
  ...
  @scala.inline
  def apply(parent: String, resource: AddRolesRequest): Xgafv = {
  ...
  implicit class XgafvMutableBuilder[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AddRolesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
