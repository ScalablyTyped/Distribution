...
trait IncludeUsedIpRanges extends StObject {
...
object IncludeUsedIpRanges {
  
  inline def apply(name: String): IncludeUsedIpRanges = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[IncludeUsedIpRanges]
  }
  
  extension [Self <: IncludeUsedIpRanges](x: Self) {
