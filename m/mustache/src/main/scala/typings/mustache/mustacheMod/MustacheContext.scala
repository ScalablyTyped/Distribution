...
object MustacheContext {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(lookup = js.Any.fromFunction1(lookup), parentContext = parentContext.asInstanceOf[js.Any], push = js.Any.fromFunction1(push), view = view.asInstanceOf[js.Any])
