...
object KeyMetricName {
  ...
  @scala.inline
  implicit class KeyMetricNameMutableBuilder[Self <: KeyMetricName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LogMetric): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
