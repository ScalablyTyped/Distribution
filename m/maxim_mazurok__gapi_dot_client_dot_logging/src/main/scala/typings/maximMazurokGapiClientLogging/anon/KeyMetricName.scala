...
@js.native
trait KeyMetricName extends js.Object {
  ...
  /** Request body */
  var resource: LogMetric = js.native
...
object KeyMetricName {
  ...
  @scala.inline
  def apply(metricName: String, resource: LogMetric): KeyMetricName = {
  ...
  @scala.inline
  implicit class KeyMetricNameOps[Self <: KeyMetricName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LogMetric): Self = this.set("resource", value.asInstanceOf[js.Any])
