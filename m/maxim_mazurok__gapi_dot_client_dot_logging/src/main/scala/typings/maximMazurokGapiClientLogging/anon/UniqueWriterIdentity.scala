...
import typings.maximMazurokGapiClientLogging.gapi.client.logging.LogSink
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait UniqueWriterIdentity extends js.Object {
...
object UniqueWriterIdentity {
  ...
  @scala.inline
  def apply(parent: String, resource: LogSink): UniqueWriterIdentity = {
  ...
  @scala.inline
  implicit class UniqueWriterIdentityOps[Self <: UniqueWriterIdentity] (val x: Self) extends AnyVal {
