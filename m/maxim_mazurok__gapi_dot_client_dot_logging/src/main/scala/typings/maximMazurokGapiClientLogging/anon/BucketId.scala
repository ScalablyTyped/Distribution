...
trait BucketId extends StObject {
  ...
  /** Request body */
  var resource: LogBucket = js.native
...
object BucketId {
  ...
  @scala.inline
  def apply(parent: String, resource: LogBucket): BucketId = {
  ...
  implicit class BucketIdMutableBuilder[Self <: BucketId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LogBucket): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
