...
trait LogName extends StObject {
...
object LogName {
  ...
  inline def apply(logName: String): LogName = {
    val __obj = js.Dynamic.literal(logName = logName.asInstanceOf[js.Any])
    __obj.asInstanceOf[LogName]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LogName] (val x: Self) extends AnyVal {
