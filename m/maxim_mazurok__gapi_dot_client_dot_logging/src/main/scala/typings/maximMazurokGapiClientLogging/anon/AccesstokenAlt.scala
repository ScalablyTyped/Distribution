...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: ListLogEntriesRequest = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(resource: ListLogEntriesRequest): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ListLogEntriesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
