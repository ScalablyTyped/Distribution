...
trait NameOauthtoken extends StObject {
  ...
  /**
    ...
    * "billingAccounts/[BILLING_ACCOUNT_ID]/cmekSettings" "folders/[FOLDER_ID]/cmekSettings" For example:"organizations/12345/cmekSettings"Note: CMEK for the Log Router can currently
    * only be configured for Google Cloud organizations. Once configured, it applies to all projects and folders in the Google Cloud organization.
    */
  var name: String
  ...
  /**
    ...
    * cannot be updated.See FieldMask for more information.For example: "updateMask=kmsKeyName"
    */
...
object NameOauthtoken {
  ...
  inline def apply(name: String, resource: CmekSettings): NameOauthtoken = {
