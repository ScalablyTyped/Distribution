...
object RequestLog {
  ...
  extension [Self <: RequestLog](x: Self) {
    ...
    inline def setLine(value: js.Array[LogLine]): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
    ...
    inline def setSourceReference(value: js.Array[SourceReference]): Self = StObject.set(x, "sourceReference", value.asInstanceOf[js.Any])
