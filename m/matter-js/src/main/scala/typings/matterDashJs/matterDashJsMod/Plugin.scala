...
import typings.matterDashJs.Anon_
import typings.matterDashJs.Anon_IsRange
import typings.matterDashJs.Anon_Name
import typings.matterDashJs.Anon_Uses
...
object Plugin extends js.Object {
  ...
  /**
    ...
    */
  def dependencyParse(dependency: Dependency): Anon_Name = js.native
  /**
    ...
    */
  def isFor(plugin: Plugin, module: Anon_): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def use(module: Anon_Uses, plugins: js.Array[Plugin | String]): Unit = js.native
  /**
    ...
    */
  def versionParse(range: String): Anon_IsRange = js.native
  /**
