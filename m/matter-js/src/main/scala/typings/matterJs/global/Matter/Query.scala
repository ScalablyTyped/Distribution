...
object Query {
  ...
  /**
    ...
    */
  inline def collides(body: typings.matterJs.mod.Body, bodies: js.Array[typings.matterJs.mod.Body]): js.Array[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("collides")(body.asInstanceOf[js.Any], bodies.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Any]]
  ...
  ): js.Array[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("ray")(bodies.asInstanceOf[js.Any], startPoint.asInstanceOf[js.Any], endPoint.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Any]]
  inline def ray(
    bodies: js.Array[typings.matterJs.mod.Body],
    startPoint: typings.matterJs.mod.Vector,
    endPoint: typings.matterJs.mod.Vector,
    rayWidth: Double
  ): js.Array[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("ray")(bodies.asInstanceOf[js.Any], startPoint.asInstanceOf[js.Any], endPoint.asInstanceOf[js.Any], rayWidth.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Any]]
