...
object mobservableDashReactMod extends js.Object {
  ...
  def observer[P](renderFunction: js.Function1[/* props */ P, reactLib.reactMod.ReactNs.ReactElement[_]]): reactLib.reactMod.ReactNs.ClassicComponentClass[P] = js.native
