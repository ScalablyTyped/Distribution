...
import typings.maximMazurokGapiClientMl.gapi.client.ml.GoogleCloudMlV1Version
...
trait UpdateMask extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudMlV1Version
...
object UpdateMask {
  ...
  inline def apply(name: String, resource: GoogleCloudMlV1Version): UpdateMask = {
  ...
  implicit open class MutableBuilder[Self <: UpdateMask] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: GoogleCloudMlV1Version): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
