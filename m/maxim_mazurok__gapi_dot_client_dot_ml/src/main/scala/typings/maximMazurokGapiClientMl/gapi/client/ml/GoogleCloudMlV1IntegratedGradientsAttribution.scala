...
@js.native
trait GoogleCloudMlV1IntegratedGradientsAttribution extends js.Object {
...
object GoogleCloudMlV1IntegratedGradientsAttribution {
  ...
  @scala.inline
  implicit class GoogleCloudMlV1IntegratedGradientsAttributionOps[Self <: GoogleCloudMlV1IntegratedGradientsAttribution] (val x: Self) extends AnyVal {
