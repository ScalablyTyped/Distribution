...
@js.native
trait GoogleCloudMlV1EnvVar extends js.Object {
...
object GoogleCloudMlV1EnvVar {
  ...
  @scala.inline
  def apply(): GoogleCloudMlV1EnvVar = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudMlV1EnvVar]
  }
  
  @scala.inline
  implicit class GoogleCloudMlV1EnvVarOps[Self <: GoogleCloudMlV1EnvVar] (val x: Self) extends AnyVal {
