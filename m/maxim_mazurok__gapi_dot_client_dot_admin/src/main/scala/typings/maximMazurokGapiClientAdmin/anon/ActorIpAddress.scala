...
trait ActorIpAddress extends StObject {
...
object ActorIpAddress {
  ...
  inline def apply(applicationName: String, resource: Channel, userKey: String): ActorIpAddress = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ActorIpAddress] (val x: Self) extends AnyVal {
