...
import typings.msportalfxMock.libSrcArmProxyMockModelsMockModelMod.NestedResource
import typings.msportalfxMock.libSrcArmProxyModelsArmEventMod.EventData
import typings.msportalfxMock.libSrcArmProxyModelsArmLocationMod.Location
import typings.msportalfxMock.libSrcArmProxyModelsArmProviderMod.Provider
import typings.msportalfxMock.libSrcArmProxyModelsArmResourceGroupMod.ResourceGroup
import typings.msportalfxMock.libSrcArmProxyModelsArmResourceMod.Resource
import typings.msportalfxMock.libSrcArmProxyModelsArmSubscriptionMod.Subscription
...
object libSrcArmProxyArmManagerMod {
  ...
  object ArmManager {
    ...
    open class Manager () extends StObject {
      ...
      def getResourceData(subscriptionId: String, resourceGroupId: String, `type`: String, resourceName: String): typings.msportalfxMock.libSrcArmProxyMockModelsMockModelMod.Resource = js.native
      ...
      def getResourceGroupData(subscriptionId: String, resourceGroupId: String): typings.msportalfxMock.libSrcArmProxyMockModelsMockModelMod.ResourceGroup = js.native
      ...
      def getSubscriptionData(subscriptionId: String): typings.msportalfxMock.libSrcArmProxyMockModelsMockModelMod.Subscription = js.native
    ...
    trait MockData extends StObject {
      ...
      var subscriptions: js.UndefOr[
            js.Array[typings.msportalfxMock.libSrcArmProxyMockModelsMockModelMod.Subscription]
          ] = js.undefined
    }
    object MockData {
      ...
      implicit open class MutableBuilder[Self <: MockData] (val x: Self) extends AnyVal {
        ...
        inline def setSubscriptions(value: js.Array[typings.msportalfxMock.libSrcArmProxyMockModelsMockModelMod.Subscription]): Self = StObject.set(x, "subscriptions", value.asInstanceOf[js.Any])
        
        inline def setSubscriptionsUndefined: Self = StObject.set(x, "subscriptions", js.undefined)
        
        inline def setSubscriptionsVarargs(value: typings.msportalfxMock.libSrcArmProxyMockModelsMockModelMod.Subscription*): Self = StObject.set(x, "subscriptions", js.Array(value*))
      }
    }
  }
}
