...
object expressServeStaticCoreMod {
  
  @js.native
  trait Application
    extends IRouter[Application]
       with typings.msportalfxMock.Express.Application {
    
    /* InferMemberOverrides */
    override def apply(arg1: /* req */ Request, arg2: /* res */ Response, arg3: /* next */ NextFunction): js.Any = js.native
  ...
  trait IRoute extends StObject {
    ...
    def head(handler: RequestHandler*): IRoute
  ...
  object IRoute {
    ...
    inline def apply(
      ...
      head: /* repeated */ RequestHandler => IRoute,
  ...
  trait IRouter[T] extends RequestHandler {
    ...
    def head(name: String, handlers: RequestHandler*): T = js.native
    def head(name: RegExp, handlers: RequestHandler*): T = js.native
    @JSName("head")
    var head_Original: IRouterMatcher[T] = js.native
    ...
    def use(path: String, handler: RequestHandler): T = js.native
    def use(path: String, router: Router): T = js.native
    def use(path: js.Array[String], handler: RequestHandler*): T = js.native
    def use(path: js.Array[String], handler: ErrorRequestHandler): T = js.native
    def use(path: RegExp, handler: RequestHandler*): T = js.native
    def use(path: RegExp, handler: ErrorRequestHandler): T = js.native
  }
  
  type IRouterMatcher[T] = js.Function2[/* name */ String | RegExp, /* repeated */ RequestHandler, T]
  ...
  trait Request
    extends StObject
       with typings.msportalfxMock.Express.Request {
    ...
    def acceptsCharsets(charset: String): js.Array[String] = js.native
    def acceptsCharsets(charset: js.Array[String]): js.Array[String] = js.native
    ...
    def acceptsEncodings(encoding: String): js.Array[String] = js.native
    def acceptsEncodings(encoding: js.Array[String]): js.Array[String] = js.native
    ...
    def acceptsLanguages(lang: String): js.Array[String] = js.native
    def acceptsLanguages(lang: js.Array[String]): js.Array[String] = js.native
  ...
  trait Response
    extends ServerResponse
       with typings.msportalfxMock.Express.Response {
