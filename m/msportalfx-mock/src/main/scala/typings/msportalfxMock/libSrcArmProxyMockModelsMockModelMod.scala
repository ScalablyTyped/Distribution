...
import typings.msportalfxMock.libSrcArmProxyModelsArmLockMod.ArmLockData
import typings.msportalfxMock.libSrcArmProxyModelsArmLockMod.LockProperties
...
object libSrcArmProxyMockModelsMockModelMod {
  ...
  trait NestedResource
    extends StObject
       with MappedArmData[typings.msportalfxMock.libSrcArmProxyModelsArmResourceMod.Resource] {
  ...
  trait ResourceGroup
    extends StObject
       with MappedArmData[typings.msportalfxMock.libSrcArmProxyModelsArmResourceGroupMod.ResourceGroup] {
  ...
  trait Subscription
    extends StObject
       with MappedArmData[typings.msportalfxMock.libSrcArmProxyModelsArmSubscriptionMod.Subscription] {
