...
trait UserNaturalData
  ...
  var IncomeRange: typings.mangopay2NodejsSdk.typingsModelsUserMod.user.IncomeRange
...
object UserNaturalData {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UserNaturalData] (val x: Self) extends AnyVal {
