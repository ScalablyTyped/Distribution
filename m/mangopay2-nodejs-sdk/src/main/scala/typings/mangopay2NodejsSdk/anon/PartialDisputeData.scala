...
object PartialDisputeData {
  @scala.inline
  def apply(
    ContestDeadlineDate: js.UndefOr[Timestamp] = js.undefined,
    ...
    if (!js.isUndefined(ContestDeadlineDate)) __obj.updateDynamic("ContestDeadlineDate")(ContestDeadlineDate.get.asInstanceOf[js.Any])
