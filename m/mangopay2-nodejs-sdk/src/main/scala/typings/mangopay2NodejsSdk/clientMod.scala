  ...
  object client {
    ...
    */
    ...
    trait ClientData
      ...
      /**
        ...
        */
      var PlatformCategorization: typings.mangopay2NodejsSdk.clientMod.client.PlatformCategorization
    ...
    trait PlatformCategorization extends StObject {
      ...
      var BusinessType: typings.mangopay2NodejsSdk.clientMod.client.BusinessType
      
      var Sector: typings.mangopay2NodejsSdk.clientMod.client.Sector
    }
    ...
    */
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.LOAN
      - typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.EQUITY
      - typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.PROPERTY_EQUITY
      - typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.REWARDS_CHARITY
      - typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.POOL_GROUP_PAYMENT
      - typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.FRANCHISE_
      - typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.OTHER_
    */
    ...
    object Sector {
      ...
      inline def EQUITY: typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.EQUITY = "EQUITY".asInstanceOf[typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.EQUITY]
      ...
      inline def FRANCHISE_ : typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.FRANCHISE_ = "FRANCHISE_".asInstanceOf[typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.FRANCHISE_]
      ...
      inline def LOAN: typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.LOAN = "LOAN".asInstanceOf[typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.LOAN]
      
      inline def OTHER_ : typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.OTHER_ = "OTHER_".asInstanceOf[typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.OTHER_]
      
      inline def POOL_GROUP_PAYMENT: typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.POOL_GROUP_PAYMENT = "POOL_GROUP_PAYMENT".asInstanceOf[typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.POOL_GROUP_PAYMENT]
      
      inline def PROPERTY_EQUITY: typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.PROPERTY_EQUITY = "PROPERTY_EQUITY".asInstanceOf[typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.PROPERTY_EQUITY]
      ...
      inline def REWARDS_CHARITY: typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.REWARDS_CHARITY = "REWARDS_CHARITY".asInstanceOf[typings.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.REWARDS_CHARITY]
    ...
    trait UpdateClient extends StObject {
      ...
      /**
        ...
        */
      var PlatformType: js.UndefOr[typings.mangopay2NodejsSdk.clientMod.client.PlatformType] = js.undefined
