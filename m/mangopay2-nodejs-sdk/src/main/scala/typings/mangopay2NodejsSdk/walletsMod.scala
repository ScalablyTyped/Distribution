...
import typings.mangopay2NodejsSdk.modelsMod.Models.Wallet
import typings.mangopay2NodejsSdk.transactionMod.transaction.TransactionData
import typings.mangopay2NodejsSdk.walletMod.wallet.CreateWallet
import typings.mangopay2NodejsSdk.walletMod.wallet.UpdateWallet
...
object walletsMod {
  ...
  @JSImport("mangopay2-nodejs-sdk/typings/services/Wallets", "Wallets")
  @js.native
  open class Wallets () extends StObject {
