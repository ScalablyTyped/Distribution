...
import typings.mangopay2NodejsSdk.addressMod.address._AddressType
...
import typings.mangopay2NodejsSdk.userMod.user.PersonType
...
object modelsMod {
  ...
  object Models {
    ...
    @js.native
    open class Model[T] protected ()
      extends StObject
         with ModelMethods[T] {
      def this(data: T) = this()
      
      def setData(attribute: Any): this.type = js.native
