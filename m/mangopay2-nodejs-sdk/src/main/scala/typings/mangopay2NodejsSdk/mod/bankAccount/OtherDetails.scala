...
object OtherDetails {
  ...
  inline def apply(AccountNumber: String, BIC: String, Country: String, OwnerAddress: AddressType, OwnerName: String): OtherDetails = {
  ...
  extension [Self <: OtherDetails](x: Self) {
