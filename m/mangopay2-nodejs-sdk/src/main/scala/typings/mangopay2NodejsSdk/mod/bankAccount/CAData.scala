...
- typings.mangopay2NodejsSdk.mod.bankAccount.CADetails because var conflicts: OwnerAddress, OwnerName, Type. Inlined BranchCode, InstitutionNumber, AccountNumber, BankName */ trait CAData
  extends StObject
     with BaseData
     with Data
