...
class PayIn protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ExecutionType: typings.mangopay2NodejsSdk.mod.payIn.PayInExecutionType = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var PaymentType: typings.mangopay2NodejsSdk.mod.payIn.PayInPaymentType = js.native
  /**
    * The result code
    */
  /* CompleteClass */
