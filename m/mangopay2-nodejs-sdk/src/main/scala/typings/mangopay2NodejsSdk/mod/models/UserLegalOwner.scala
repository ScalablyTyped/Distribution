...
import typings.mangopay2NodejsSdk.anon.MakeKeysRequiredPartialUsCreationDate
...
@JSImport("mangopay2-nodejs-sdk", "models.UserLegalOwner")
@js.native
open class UserLegalOwner protected ()
  extends EntityBase[UserLegalData]
     with UserLegalData {
  def this(data: MakeKeysRequiredPartialUsCreationDate) = this()
  ...
  @JSName("UserCategory")
  var UserCategory_UserLegalOwner: OWNER = js.native
