...
- typings.mangopay2NodejsSdk.mod.bankAccount.OtherDetails because var conflicts: OwnerAddress, OwnerName, Type. Inlined Country, BIC, AccountNumber */ trait OtherData
  extends StObject
     with BaseData
     with Data
