...
import typings.mangopay2NodejsSdk.anon.MakeKeysRequiredPartialUsBirthday
...
@JSImport("mangopay2-nodejs-sdk", "models.UserNaturalPayer")
@js.native
open class UserNaturalPayer protected ()
  extends EntityBase[UserNaturalData]
     with UserNaturalData {
  def this(data: MakeKeysRequiredPartialUsBirthday) = this()
  ...
  @JSName("UserCategory")
  var UserCategory_UserNaturalPayer: PAYER = js.native
