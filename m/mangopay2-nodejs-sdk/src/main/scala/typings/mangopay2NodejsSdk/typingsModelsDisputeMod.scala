  ...
  object dispute {
    ...
    trait DisputeData
      ...
      /**
        ...
        */
      var DisputeReason: typings.mangopay2NodejsSdk.typingsModelsDisputeMod.dispute.DisputeReason
      
      /**
        * The type of dispute
        */
      var DisputeType: typings.mangopay2NodejsSdk.typingsModelsDisputeMod.dispute.DisputeType
    ...
    trait DisputeReason extends StObject {
      ...
      var DisputeReasonType: typings.mangopay2NodejsSdk.typingsModelsDisputeMod.dispute.DisputeReasonType
    }
