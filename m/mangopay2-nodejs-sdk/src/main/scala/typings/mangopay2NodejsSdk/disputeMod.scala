  ...
  object dispute {
    ...
    trait DisputeData
      ...
      /**
        ...
        */
      var DisputeReason: typings.mangopay2NodejsSdk.disputeMod.dispute.DisputeReason
      
      /**
        * The type of dispute
        */
      var DisputeType: typings.mangopay2NodejsSdk.disputeMod.dispute.DisputeType
    ...
    trait DisputeReason extends StObject {
      ...
      var DisputeReasonType: typings.mangopay2NodejsSdk.disputeMod.dispute.DisputeReasonType
    }
