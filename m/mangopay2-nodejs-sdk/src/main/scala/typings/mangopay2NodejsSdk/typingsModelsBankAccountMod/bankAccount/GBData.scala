...
- typings.mangopay2NodejsSdk.typingsModelsBankAccountMod.bankAccount.GBDetails because var conflicts: OwnerAddress, OwnerName, Type. Inlined SortCode, AccountNumber */ trait GBData
  extends StObject
     with BaseData
     with Data
