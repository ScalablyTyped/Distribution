...
object typingsModelsCountryAuthorizationMod {
  ...
  object countryAuthorization {
    ...
    trait AuthorizationData extends StObject {
      ...
      var BlockPayout: Boolean
      
      var BlockUserCreation: Boolean
    }
    object AuthorizationData {
      
      inline def apply(BlockBankAccountCreation: Boolean, BlockPayout: Boolean, BlockUserCreation: Boolean): AuthorizationData = {
      ...
      implicit open class MutableBuilder[Self <: AuthorizationData] (val x: Self) extends AnyVal {
        ...
        inline def setBlockPayout(value: Boolean): Self = StObject.set(x, "BlockPayout", value.asInstanceOf[js.Any])
