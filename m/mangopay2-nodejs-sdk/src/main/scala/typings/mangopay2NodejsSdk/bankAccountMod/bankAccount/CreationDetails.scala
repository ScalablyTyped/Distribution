...
/* Rewritten from type alias, can be one of: 
  - typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.OtherDetails
  - typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.CADetails
  - typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.GBDetails
  - typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.IBANDetails
  - typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.USDetails
*/
...
object CreationDetails {
  ...
  inline def CADetails(
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.CADetails]
  }
  
  inline def GBDetails(AccountNumber: String, OwnerAddress: AddressType, OwnerName: String, SortCode: String): typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.GBDetails = {
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.GBDetails]
  }
  
  inline def IBANDetails(IBAN: String, OwnerAddress: AddressType, OwnerName: String): typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.IBANDetails = {
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.IBANDetails]
  }
  ...
  inline def OtherDetails(
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.OtherDetails]
  }
  
  inline def USDetails(ABA: String, AccountNumber: String, OwnerAddress: AddressType, OwnerName: String): typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.USDetails = {
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.USDetails]
  }
}
