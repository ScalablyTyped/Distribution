...
- typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.USDetails because var conflicts: OwnerAddress, OwnerName, Type. Inlined AccountNumber, ABA, DepositAccountType */ trait USData
  extends StObject
     with BaseData
     with Data
