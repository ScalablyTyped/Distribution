...
- typings.mangopay2NodejsSdk.bankAccountMod.bankAccount.CADetails because var conflicts: OwnerAddress, OwnerName, Type. Inlined BranchCode, InstitutionNumber, AccountNumber, BankName */ trait CAData
  extends StObject
     with BaseData
     with Data
