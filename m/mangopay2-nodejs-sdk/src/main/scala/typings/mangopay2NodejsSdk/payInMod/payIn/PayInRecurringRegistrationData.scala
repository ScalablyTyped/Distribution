...
import typings.mangopay2NodejsSdk.billingMod.billing.BillingOrShippingRecurringPayInData
...
trait PayInRecurringRegistrationData
  ...
  var RecurringType: typings.mangopay2NodejsSdk.payInMod.payIn.RecurringType
...
object PayInRecurringRegistrationData {
  ...
  extension [Self <: PayInRecurringRegistrationData](x: Self) {
