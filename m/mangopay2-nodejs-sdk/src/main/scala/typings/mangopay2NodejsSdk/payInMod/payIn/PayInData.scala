...
/* Rewritten from type alias, can be one of: 
  - typings.mangopay2NodejsSdk.payInMod.payIn.CardDirectPayInData
  - typings.mangopay2NodejsSdk.payInMod.payIn.CardPreAuthorizedPayInData
  - typings.mangopay2NodejsSdk.payInMod.payIn.CardWebPayInData
  - typings.mangopay2NodejsSdk.payInMod.payIn.BankWireDirectPayInData
  - typings.mangopay2NodejsSdk.payInMod.payIn.PayconiqWebPayInData
  - typings.mangopay2NodejsSdk.payInMod.payIn.DirectDebitDirectPayInData
*/
...
object PayInData {
  ...
  inline def BankWireDirectPayInData(
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.payInMod.payIn.BankWireDirectPayInData]
  }
  ...
  inline def CardDirectPayInData(
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.payInMod.payIn.CardDirectPayInData]
  }
  ...
  inline def CardPreAuthorizedPayInData(
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.payInMod.payIn.CardPreAuthorizedPayInData]
  }
  ...
  inline def CardWebPayInData(
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.payInMod.payIn.CardWebPayInData]
  }
  ...
  inline def DirectDebitDirectPayInData(
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.payInMod.payIn.DirectDebitDirectPayInData]
  }
  ...
  inline def PayconiqWebPayInData(
    ...
    __obj.asInstanceOf[typings.mangopay2NodejsSdk.payInMod.payIn.PayconiqWebPayInData]
  }
}
