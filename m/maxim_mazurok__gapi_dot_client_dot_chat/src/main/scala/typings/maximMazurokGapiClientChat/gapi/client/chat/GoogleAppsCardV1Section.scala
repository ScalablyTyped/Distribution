...
trait GoogleAppsCardV1Section extends StObject {
  ...
  var widgets: js.UndefOr[js.Array[GoogleAppsCardV1Widget]] = js.undefined
}
object GoogleAppsCardV1Section {
  
  inline def apply(): GoogleAppsCardV1Section = {
  ...
  extension [Self <: GoogleAppsCardV1Section](x: Self) {
    ...
    inline def setWidgets(value: js.Array[GoogleAppsCardV1Widget]): Self = StObject.set(x, "widgets", value.asInstanceOf[js.Any])
    
    inline def setWidgetsUndefined: Self = StObject.set(x, "widgets", js.undefined)
    
    inline def setWidgetsVarargs(value: GoogleAppsCardV1Widget*): Self = StObject.set(x, "widgets", js.Array(value*))
  }
}
