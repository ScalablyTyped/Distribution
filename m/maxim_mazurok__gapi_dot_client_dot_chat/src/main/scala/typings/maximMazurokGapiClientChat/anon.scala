...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(parent: String, resource: Message): Accesstoken = {
  ...
  object Callback {
    ...
    inline def apply(resourceName: String): Callback = {
  ...
  object Fields {
    ...
    inline def apply(name: String): Fields = {
  ...
  object Name {
    ...
    inline def apply(name: String, resource: Message): Name = {
