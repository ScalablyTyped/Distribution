...
object anon {
  ...
  object Accesstoken {
    ...
    @scala.inline
    def apply(resourceName: String): Accesstoken = {
  ...
  object Fields {
    ...
    implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: Message): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Name {
    ...
    @scala.inline
    def apply(name: String, resource: Message): Name = {
