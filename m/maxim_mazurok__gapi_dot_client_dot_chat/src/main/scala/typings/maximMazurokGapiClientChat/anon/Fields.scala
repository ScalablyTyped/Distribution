package typings.maximMazurokGapiClientChat.anon

import typings.maximMazurokGapiClientChat.gapi.client.chat.Message
...
trait Fields extends js.Object {
  ...
  /** Request body */
  var resource: Message = js.native
...
object Fields {
  ...
  @scala.inline
  def apply(parent: String, resource: Message): Fields = {
  ...
  implicit class FieldsOps[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Message): Self = this.set("resource", value.asInstanceOf[js.Any])
