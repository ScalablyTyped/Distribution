package typings.maximMazurokGapiClientDatafusion.anon
...
object InstanceId {
  ...
  inline def apply(parent: String, resource: Instance): InstanceId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceId] (val x: Self) extends AnyVal {
