...
import typings.maximMazurokGapiClientTranslate.anon.QuotaUser
import typings.maximMazurokGapiClientTranslate.anon.Resource
...
trait OperationsResource extends StObject {
  ...
  /**
    ...
    */
  def wait(request: Resource): Request[Operation] = js.native
}
