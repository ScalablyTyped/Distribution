...
@js.native
trait DisplayLanguageCode extends js.Object {
  ...
  var displayLanguageCode: js.UndefOr[String] = js.native
...
object DisplayLanguageCode {
  ...
  @scala.inline
  def apply(parent: String): DisplayLanguageCode = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[DisplayLanguageCode]
  }
  
  @scala.inline
  implicit class DisplayLanguageCodeOps[Self <: DisplayLanguageCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisplayLanguageCode(value: String): Self = this.set("displayLanguageCode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDisplayLanguageCode: Self = this.set("displayLanguageCode", js.undefined)
