...
@scala.inline
def escape(value: js.Any, stringifyObjects: scala.Unit, timeZone: java.lang.String): java.lang.String = (typings.mysql.mod.^.asInstanceOf[js.Dynamic].applyDynamic("escape")(value.asInstanceOf[js.Any], stringifyObjects.asInstanceOf[js.Any], timeZone.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
...
@scala.inline
def format(sql: java.lang.String, values: js.Array[js.Any]): java.lang.String = (typings.mysql.mod.^.asInstanceOf[js.Dynamic].applyDynamic("format")(sql.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
@scala.inline
def format(sql: java.lang.String, values: js.Array[js.Any], stringifyObjects: scala.Boolean): java.lang.String = (typings.mysql.mod.^.asInstanceOf[js.Dynamic].applyDynamic("format")(sql.asInstanceOf[js.Any], values.asInstanceOf[js.Any], stringifyObjects.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
@scala.inline
def format(
