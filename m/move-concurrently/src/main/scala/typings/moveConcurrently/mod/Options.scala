...
object Options {
  @scala.inline
  def apply[/* <: js.Thenable[scala.Unit] */ T](): Options[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[T]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_], /* <: js.Thenable[scala.Unit] */ T] (val x: Self with Options[T]) extends AnyVal {
    @scala.inline
