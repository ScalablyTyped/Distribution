...
import typings.maximMazurokGapiClientServicemanagement.gapi.client.servicemanagement.Rollout
...
object QuotaUser {
  ...
  inline def apply(resource: Rollout, serviceName: String): QuotaUser = {
  ...
  implicit open class MutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: Rollout): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
