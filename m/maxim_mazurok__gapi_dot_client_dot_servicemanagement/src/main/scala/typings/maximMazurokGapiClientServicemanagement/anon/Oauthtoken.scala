...
import typings.maximMazurokGapiClientServicemanagement.gapi.client.servicemanagement.SubmitConfigSourceRequest
...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: SubmitConfigSourceRequest = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(resource: SubmitConfigSourceRequest, serviceName: String): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SubmitConfigSourceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
