...
object Oauthtoken {
  ...
  inline def apply(resource: SubmitConfigSourceRequest, serviceName: String): Oauthtoken = {
  ...
  implicit open class MutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: SubmitConfigSourceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
