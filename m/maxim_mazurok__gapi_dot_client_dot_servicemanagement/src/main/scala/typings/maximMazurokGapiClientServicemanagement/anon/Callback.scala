...
import typings.maximMazurokGapiClientServicemanagement.gapi.client.servicemanagement.Service
...
object Callback {
  ...
  inline def apply(resource: Service, serviceName: String): Callback = {
