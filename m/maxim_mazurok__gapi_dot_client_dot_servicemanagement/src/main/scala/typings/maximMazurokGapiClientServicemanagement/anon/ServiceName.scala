...
@js.native
trait ServiceName extends js.Object {
...
object ServiceName {
  ...
  @scala.inline
  def apply(resource: EnableServiceRequest, serviceName: String): ServiceName = {
  ...
  @scala.inline
  implicit class ServiceNameOps[Self <: ServiceName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: EnableServiceRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
