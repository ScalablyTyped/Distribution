...
trait cssClasses
  ...
  var ACCEPT_BTN: atMaterialDialogLib.atMaterialDialogLibStrings.`mdc-dialog__footer__button--accept`
  var ANIMATING: atMaterialDialogLib.atMaterialDialogLibStrings.`mdc-dialog--animating`
  var BACKDROP: atMaterialDialogLib.atMaterialDialogLibStrings.`mdc-dialog__backdrop`
  var CANCEL_BTN: atMaterialDialogLib.atMaterialDialogLibStrings.`mdc-dialog__footer__button--cancel`
  var OPEN: atMaterialDialogLib.atMaterialDialogLibStrings.`mdc-dialog--open`
  var ROOT: atMaterialDialogLib.atMaterialDialogLibStrings.`mdc-dialog`
