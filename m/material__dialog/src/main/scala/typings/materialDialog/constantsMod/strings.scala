...
import typings.materialDialog.materialDialogStrings.MDCDialogColonaccept
import typings.materialDialog.materialDialogStrings.MDCDialogColoncancel
import typings.materialDialog.materialDialogStrings.`Dotmdc-dialog--open`
import typings.materialDialog.materialDialogStrings.`Dotmdc-dialog__footer__button--accept`
import typings.materialDialog.materialDialogStrings.`Dotmdc-dialog__surface`
