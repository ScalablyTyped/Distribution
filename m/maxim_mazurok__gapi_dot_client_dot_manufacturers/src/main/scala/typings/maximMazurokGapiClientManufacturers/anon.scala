...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(name: String, parent: String): Accesstoken = {
  ...
  object Alt {
    ...
    inline def apply(name: String, parent: String): Alt = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any])
  ...
  object Fields {
    ...
    inline def apply(name: String, parent: String, resource: Attributes): Fields = {
    ...
    implicit open class MutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
      ...
      inline def setResource(value: Attributes): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
