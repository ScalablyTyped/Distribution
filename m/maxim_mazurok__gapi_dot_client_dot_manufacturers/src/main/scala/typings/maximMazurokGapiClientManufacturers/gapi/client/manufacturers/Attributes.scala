...
object Attributes {
  ...
  implicit class AttributesOps[Self <: Attributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdditionalImageLinkVarargs(value: Image*): Self = this.set("additionalImageLink", js.Array(value :_*))
    
    @scala.inline
    def setAdditionalImageLink(value: js.Array[Image]): Self = this.set("additionalImageLink", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFeatureDescriptionVarargs(value: FeatureDescription*): Self = this.set("featureDescription", js.Array(value :_*))
    
    @scala.inline
    def setFeatureDescription(value: js.Array[FeatureDescription]): Self = this.set("featureDescription", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setImageLink(value: Image): Self = this.set("imageLink", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProductDetailVarargs(value: ProductDetail*): Self = this.set("productDetail", js.Array(value :_*))
    
    @scala.inline
    def setProductDetail(value: js.Array[ProductDetail]): Self = this.set("productDetail", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRichProductContentVarargs(value: String*): Self = this.set("richProductContent", js.Array(value :_*))
    
    @scala.inline
    def setRichProductContent(value: js.Array[String]): Self = this.set("richProductContent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRichProductContent: Self = this.set("richProductContent", js.undefined)
    ...
    @scala.inline
    def setSuggestedRetailPrice(value: Price): Self = this.set("suggestedRetailPrice", value.asInstanceOf[js.Any])
