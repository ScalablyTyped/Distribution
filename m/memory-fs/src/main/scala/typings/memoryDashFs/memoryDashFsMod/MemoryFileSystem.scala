package typings.memoryDashFs.memoryDashFsMod

import typings.memoryDashFs.Anon_End
import typings.memoryDashFs.Anon_IsBlockDevice
...
trait MemoryFileSystem extends js.Object {
  ...
  def createReadStream(path: String, options: Anon_End): js.Any = js.native
  ...
  def statSync(_path: String): Anon_IsBlockDevice = js.native
  def unlink(
    path: String,
    callback: js.Function2[/* err */ Error | Null, /* result */ js.UndefOr[js.Any], Unit]
  ): Unit = js.native
