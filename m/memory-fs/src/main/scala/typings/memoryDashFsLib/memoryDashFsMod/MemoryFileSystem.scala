...
trait MemoryFileSystem extends js.Object {
  ...
  def mkdir(path: java.lang.String, callback: js.Function1[/* err */ stdLib.Error | scala.Null, scala.Unit]): scala.Unit = js.native
  def mkdir(
    path: java.lang.String,
    optArg: js.Object,
    callback: js.Function2[/* err */ stdLib.Error | scala.Null, /* result */ js.UndefOr[js.Any], scala.Unit]
  ): scala.Unit = js.native
