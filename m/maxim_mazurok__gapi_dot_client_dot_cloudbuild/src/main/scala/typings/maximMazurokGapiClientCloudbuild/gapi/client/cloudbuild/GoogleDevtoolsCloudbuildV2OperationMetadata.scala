...
trait GoogleDevtoolsCloudbuildV2OperationMetadata extends StObject {
...
object GoogleDevtoolsCloudbuildV2OperationMetadata {
  
  inline def apply(): GoogleDevtoolsCloudbuildV2OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleDevtoolsCloudbuildV2OperationMetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleDevtoolsCloudbuildV2OperationMetadata] (val x: Self) extends AnyVal {
