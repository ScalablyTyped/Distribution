...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: BuildTrigger = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(projectId: String, resource: BuildTrigger): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BuildTrigger): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
