...
trait Name extends StObject {
  ...
  /** Request body */
  var resource: CancelBuildRequest = js.native
...
object Name {
  ...
  @scala.inline
  def apply(name: String, resource: CancelBuildRequest): Name = {
  ...
  implicit class NameMutableBuilder[Self <: Name] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CancelBuildRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
