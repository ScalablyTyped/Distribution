...
import typings.maximMazurokGapiClientCloudbuild.gapi.client.cloudbuild.WorkerPool
...
object PrettyPrintQuotaUser {
  ...
  inline def apply(name: String, resource: WorkerPool): PrettyPrintQuotaUser = {
