...
import typings.maximMazurokGapiClientCloudbuild.gapi.client.cloudbuild.CancelOperationRequest
...
object Callback {
  ...
  inline def apply(name: String, resource: CancelOperationRequest): Callback = {
