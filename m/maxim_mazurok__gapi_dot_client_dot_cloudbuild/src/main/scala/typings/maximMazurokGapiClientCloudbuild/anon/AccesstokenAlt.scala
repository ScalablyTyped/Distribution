...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: RepoSource = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(projectId: String, resource: RepoSource, triggerId: String): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RepoSource): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
