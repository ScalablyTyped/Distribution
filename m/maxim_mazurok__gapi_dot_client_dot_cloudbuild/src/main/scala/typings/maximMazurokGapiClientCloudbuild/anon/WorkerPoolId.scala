...
trait WorkerPoolId extends StObject {
...
object WorkerPoolId {
  ...
  inline def apply(parent: String): WorkerPoolId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[WorkerPoolId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WorkerPoolId] (val x: Self) extends AnyVal {
