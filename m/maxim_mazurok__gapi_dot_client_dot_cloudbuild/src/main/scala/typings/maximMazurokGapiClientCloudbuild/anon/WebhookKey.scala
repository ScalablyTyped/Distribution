...
trait WebhookKey extends StObject {
...
object WebhookKey {
  ...
  inline def apply(resource: HttpBody): WebhookKey = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[WebhookKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WebhookKey] (val x: Self) extends AnyVal {
