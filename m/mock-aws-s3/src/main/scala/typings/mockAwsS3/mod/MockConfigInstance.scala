...
- typings.awsSdk.configServicePlaceholdersMod.ConfigurationServicePlaceholders because Inheritance from two classes. Inlined connectparticipant, sesv2, kms, dataexchange, personalizeevents, lightsail, appconfig, ssooidc, schemas, route53resolver, storagegateway, eks, marketplacecommerceanalytics, cloudformation, applicationautoscaling, servicequotas, s3outposts, cognitoidentityserviceprovider, timestreamquery, robomaker, applicationinsights, servicecatalogappregistry, qldb, migrationhubconfig, outposts, acm, configservice, codeguruprofiler, kinesisvideomedia, apigateway, resourcegroups, mediatailor, codeartifact, pi, mediastoredata, codedeploy, acmpca, elbv2, transfer, sso, codebuild, databrew, cloudhsmv2, macie2, batch, computeoptimizer, redshift, forecastservice, mediaconnect, macie, rds, identitystore, secretsmanager, emr, sagemaker, iotthingsgraph, eventbridge, codepipeline, elb, xray, codecommit, appstream, codestar, servicediscovery, globalaccelerator, apigatewayv2, cloudsearchdomain, cloudtrail, augmentedairuntime, iam, es, elasticbeanstalk, forecastqueryservice, cloudsearch, dax, wafregional, elasticache, ec2, support, licensemanager, medialive, sts, athena, cloud9, amplify, codegurureviewer, appmesh, chime, appsync, iotdata, timestreamwrite, detective, devicefarm, signer, directoryservice, workspaces, quicksight, sms, organizations, ssoadmin, kendra, pinpointsmsvoice, iotevents, polly, resourcegroupstaggingapi, rekognition, worklink, elasticinference, comprehendmedical, iotsecuretunneling, personalize, accessanalyzer, managedblockchain, waf, pinpoint, pricing, comprehend, apigatewaymanagementapi, cloudwatch, iotjobsdataplane, shield, synthetics, mturk, redshiftdata, lexmodelbuildingservice, route53domains, kinesis, kinesisanalyticsv2, frauddetector, networkfirewall, inspector, cur, servicecatalog, serverlessapplicationrepository, marketplacecatalog, simpledb, dms, kafka, autoscalingplans, budgets, gamelift, datasync, opsworks, clouddirectory, codestarnotifications, networkmanager, neptune, glacier, costexplorer, codestarconnections, translate, mobile, efs, dynamodb, marketplaceentitlementservice, appflow, iot1clickprojects, discovery, securityhub, directconnect, cloudhsm, kinesisanalytics, honeycode, iot1clickdevicesservice, braket, connect, iot, docdb, autoscaling, workmail, mediapackage, imagebuilder, cloudwatchlogs, ram, iotsitewise, textract, glue, datapipeline, sagemakerruntime, ebs, backup, route53, lexruntime, ec2instanceconnect, greengrass, dlm, lambda, savingsplans, swf, personalizeruntime, transcribeservice, sns, firehose, rdsdataservice, cognitosync, alexaforbusiness, kinesisvideosignalingchannels, cloudwatchevents, iotanalytics, s3, mediapackagevod, s3control, workmailmessageflow, kinesisvideoarchivedmedia, ecr, dynamodbstreams, stepfunctions, cognitoidentity, ivs, ssm, migrationhub, cloudfront, qldbsession, mediastore, health, wafv2, sqs, fsx, kinesisvideo, machinelearning, ecs, ioteventsdata, importexport, groundstation, guardduty, fms, workdocs, ses, opsworkscm, pinpointemail, mediaconvert, elastictranscoder, mobileanalytics, mq, lakeformation, snowball, marketplacemetering */ @js.native
