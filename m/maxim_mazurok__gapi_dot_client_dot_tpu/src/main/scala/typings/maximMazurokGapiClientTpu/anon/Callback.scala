...
import typings.maximMazurokGapiClientTpu.gapi.client.tpu.Node
...
object Callback {
  ...
  @scala.inline
  def apply(parent: String, resource: Node): Callback = {
  ...
  implicit class CallbackOps[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Node): Self = this.set("resource", value.asInstanceOf[js.Any])
