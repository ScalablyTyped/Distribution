...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def stubFailure(method: java.lang.String, urlOrRegExp: java.lang.String, response: Item): js.Promise[scala.Unit] = js.native
  def stubFailure(method: java.lang.String, urlOrRegExp: stdLib.RegExp, response: Item): js.Promise[scala.Unit] = js.native
  /**
    ...
    * @param response The response to use when a match is made
    */
  def stubOnce(method: java.lang.String, urlOrRegExp: java.lang.String, response: Item): js.Promise[scala.Unit] = js.native
  def stubOnce(method: java.lang.String, urlOrRegExp: stdLib.RegExp, response: Item): js.Promise[scala.Unit] = js.native
  /**
    ...
    * @param response The response to use when a match is made
    */
  def stubRequest(urlOrRegExp: java.lang.String, response: Item): scala.Unit = js.native
  def stubRequest(urlOrRegExp: stdLib.RegExp, response: Item): scala.Unit = js.native
  /**
