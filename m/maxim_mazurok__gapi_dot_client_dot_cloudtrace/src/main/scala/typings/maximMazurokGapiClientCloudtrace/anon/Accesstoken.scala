package typings.maximMazurokGapiClientCloudtrace.anon

import typings.maximMazurokGapiClientCloudtrace.gapi.client.cloudtrace.Span
...
object Accesstoken {
  ...
  @scala.inline
  def apply(name: String, resource: Span): Accesstoken = {
  ...
  implicit class AccesstokenOps[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Span): Self = this.set("resource", value.asInstanceOf[js.Any])
