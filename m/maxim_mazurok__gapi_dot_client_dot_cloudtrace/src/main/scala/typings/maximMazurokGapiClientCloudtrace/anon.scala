...
object anon {
  ...
  object Accesstoken {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: Span): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  trait Callback extends StObject {
    ...
    /** Request body */
    var resource: BatchWriteSpansRequest = js.native
  ...
  object Callback {
    ...
    @scala.inline
    def apply(name: String, resource: BatchWriteSpansRequest): Callback = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: BatchWriteSpansRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
