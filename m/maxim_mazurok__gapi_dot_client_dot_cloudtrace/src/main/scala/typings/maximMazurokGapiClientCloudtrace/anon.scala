...
import typings.maximMazurokGapiClientCloudtrace.gapi.client.cloudtrace.BatchWriteSpansRequest
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(name: String, resource: Span): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: Span): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  trait Callback extends StObject {
    ...
    /** Request body */
    var resource: BatchWriteSpansRequest
  ...
  object Callback {
    ...
    inline def apply(name: String, resource: BatchWriteSpansRequest): Callback = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: Callback](x: Self) {
      ...
      inline def setResource(value: BatchWriteSpansRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
