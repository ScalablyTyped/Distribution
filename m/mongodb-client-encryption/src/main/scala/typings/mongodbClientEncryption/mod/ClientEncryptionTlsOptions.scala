...
trait ClientEncryptionTlsOptions extends StObject {
...
object ClientEncryptionTlsOptions {
  
  inline def apply(): ClientEncryptionTlsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClientEncryptionTlsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ClientEncryptionTlsOptions] (val x: Self) extends AnyVal {
