...
import typings.maximMazurokGapiClientTagmanager.gapi.client.tagmanager.Entity
...
object PrettyPrintQuotaUser {
  ...
  @scala.inline
  def apply(path: String, resource: Entity): PrettyPrintQuotaUser = {
  ...
  @scala.inline
  implicit class PrettyPrintQuotaUserMutableBuilder[Self <: PrettyPrintQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Entity): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
