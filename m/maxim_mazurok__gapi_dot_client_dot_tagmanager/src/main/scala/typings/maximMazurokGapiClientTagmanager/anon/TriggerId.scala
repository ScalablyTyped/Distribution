...
trait TriggerId extends js.Object {
  ...
  var tagId: js.UndefOr[String | js.Array[String]] = js.native
  
  /** The triggers to be moved to the folder. */
  var triggerId: js.UndefOr[String | js.Array[String]] = js.native
  ...
  var variableId: js.UndefOr[String | js.Array[String]] = js.native
}
object TriggerId {
  ...
  implicit class TriggerIdOps[Self <: TriggerId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagId(value: String | js.Array[String]): Self = this.set("tagId", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTriggerId(value: String | js.Array[String]): Self = this.set("triggerId", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVariableId(value: String | js.Array[String]): Self = this.set("variableId", value.asInstanceOf[js.Any])
