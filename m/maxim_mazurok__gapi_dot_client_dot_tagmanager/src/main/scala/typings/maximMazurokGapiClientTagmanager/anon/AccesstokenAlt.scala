...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: CustomTemplate = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(parent: String, resource: CustomTemplate): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CustomTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
