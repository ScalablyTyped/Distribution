...
object FieldsFingerprint {
  ...
  inline def apply(path: String, resource: CustomTemplate): FieldsFingerprint = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsFingerprint] (val x: Self) extends AnyVal {
