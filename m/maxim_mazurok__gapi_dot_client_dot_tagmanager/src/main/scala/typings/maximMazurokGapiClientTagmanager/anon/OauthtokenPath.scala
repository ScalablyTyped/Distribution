...
object OauthtokenPath {
  ...
  @scala.inline
  def apply(path: String, resource: Zone): OauthtokenPath = {
  ...
  @scala.inline
  implicit class OauthtokenPathMutableBuilder[Self <: OauthtokenPath] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Zone): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
