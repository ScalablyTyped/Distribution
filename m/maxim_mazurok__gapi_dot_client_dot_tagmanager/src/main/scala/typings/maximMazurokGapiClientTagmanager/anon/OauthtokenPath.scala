...
@js.native
trait OauthtokenPath extends js.Object {
...
object OauthtokenPath {
  ...
  @scala.inline
  implicit class OauthtokenPathOps[Self <: OauthtokenPath] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Zone): Self = this.set("resource", value.asInstanceOf[js.Any])
