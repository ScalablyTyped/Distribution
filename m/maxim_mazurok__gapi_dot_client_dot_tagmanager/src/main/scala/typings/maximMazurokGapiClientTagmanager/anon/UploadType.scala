...
object UploadType {
  ...
  @scala.inline
  def apply(path: String, resource: Folder): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Folder): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
