...
@JSImport("mojang-minecraft", "EntityNavigationFloatComponent")
@js.native
/* protected */ open class EntityNavigationFloatComponent () extends IEntityComponent {
...
/* static members */
object EntityNavigationFloatComponent {
  
  /**
    * Identifier of this component. Should always be
    * minecraft:navigation.float.
    */
  @JSImport("mojang-minecraft", "EntityNavigationFloatComponent.id")
  @js.native
  val id: /* "minecraft:navigation.float" */ String = js.native
}
