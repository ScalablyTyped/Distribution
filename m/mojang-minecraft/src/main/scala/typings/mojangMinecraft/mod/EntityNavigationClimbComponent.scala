...
@JSImport("mojang-minecraft", "EntityNavigationClimbComponent")
@js.native
/* protected */ open class EntityNavigationClimbComponent () extends IEntityComponent {
...
/* static members */
object EntityNavigationClimbComponent {
  
  /**
    * Identifier of this component. Should always be
    * minecraft:navigation.climb.
    */
  @JSImport("mojang-minecraft", "EntityNavigationClimbComponent.id")
  @js.native
  val id: /* "minecraft:navigation.climb" */ String = js.native
}
