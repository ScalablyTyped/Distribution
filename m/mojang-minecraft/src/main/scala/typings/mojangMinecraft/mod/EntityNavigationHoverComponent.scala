...
@JSImport("mojang-minecraft", "EntityNavigationHoverComponent")
@js.native
/* protected */ open class EntityNavigationHoverComponent () extends IEntityComponent {
...
/* static members */
object EntityNavigationHoverComponent {
  
  /**
    * Identifier of this component. Should always be
    * minecraft:navigation.hover.
    */
  @JSImport("mojang-minecraft", "EntityNavigationHoverComponent.id")
  @js.native
  val id: /* "minecraft:navigation.hover" */ String = js.native
}
