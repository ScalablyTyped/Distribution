...
trait KeyName extends StObject {
  ...
  /** Request body */
  var resource: PatchServiceAccountRequest = js.native
...
object KeyName {
  ...
  @scala.inline
  def apply(name: String, resource: PatchServiceAccountRequest): KeyName = {
  ...
  implicit class KeyNameMutableBuilder[Self <: KeyName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PatchServiceAccountRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
