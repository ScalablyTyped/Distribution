...
@js.native
trait OptionsrequestedPolicyVersion extends js.Object {
...
object OptionsrequestedPolicyVersion {
  ...
  @scala.inline
  implicit class OptionsrequestedPolicyVersionOps[Self <: OptionsrequestedPolicyVersion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptionsDotrequestedPolicyVersion(value: Double): Self = this.set("options.requestedPolicyVersion", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOptionsDotrequestedPolicyVersion: Self = this.set("options.requestedPolicyVersion", js.undefined)
