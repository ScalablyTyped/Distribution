...
trait WorkloadIdentityPoolId extends StObject {
...
object WorkloadIdentityPoolId {
  
  inline def apply(parent: String, resource: WorkloadIdentityPool): WorkloadIdentityPoolId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[WorkloadIdentityPoolId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WorkloadIdentityPoolId] (val x: Self) extends AnyVal {
