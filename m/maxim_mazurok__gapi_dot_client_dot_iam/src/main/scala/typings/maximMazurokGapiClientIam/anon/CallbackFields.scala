...
trait CallbackFields extends StObject {
  ...
  /** Request body */
  var resource: DisableServiceAccountRequest = js.native
...
object CallbackFields {
  ...
  @scala.inline
  def apply(name: String, resource: DisableServiceAccountRequest): CallbackFields = {
  ...
  implicit class CallbackFieldsMutableBuilder[Self <: CallbackFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DisableServiceAccountRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
