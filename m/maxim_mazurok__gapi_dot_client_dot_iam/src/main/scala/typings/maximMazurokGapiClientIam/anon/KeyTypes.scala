...
trait KeyTypes extends StObject {
  ...
  var keyTypes: js.UndefOr[String | js.Array[String]] = js.undefined
...
object KeyTypes {
  ...
  inline def apply(name: String): KeyTypes = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyTypes]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyTypes] (val x: Self) extends AnyVal {
    ...
    inline def setKeyTypes(value: String | js.Array[String]): Self = StObject.set(x, "keyTypes", value.asInstanceOf[js.Any])
