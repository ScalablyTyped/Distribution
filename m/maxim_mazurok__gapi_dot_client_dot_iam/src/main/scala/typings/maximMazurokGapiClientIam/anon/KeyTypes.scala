...
@js.native
trait KeyTypes extends js.Object {
  ...
  var keyTypes: js.UndefOr[String | js.Array[String]] = js.native
...
object KeyTypes {
  ...
  @scala.inline
  def apply(name: String): KeyTypes = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyTypes]
  }
  
  @scala.inline
  implicit class KeyTypesOps[Self <: KeyTypes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeyTypes(value: String | js.Array[String]): Self = this.set("keyTypes", value.asInstanceOf[js.Any])
