...
object KeyTypes {
  ...
  @scala.inline
  implicit class KeyTypesMutableBuilder[Self <: KeyTypes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeyTypes(value: String | js.Array[String]): Self = StObject.set(x, "keyTypes", value.asInstanceOf[js.Any])
