...
object OauthtokenPrettyPrint {
  ...
  @scala.inline
  def apply(name: String, resource: SignJwtRequest): OauthtokenPrettyPrint = {
  ...
  implicit class OauthtokenPrettyPrintOps[Self <: OauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SignJwtRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
