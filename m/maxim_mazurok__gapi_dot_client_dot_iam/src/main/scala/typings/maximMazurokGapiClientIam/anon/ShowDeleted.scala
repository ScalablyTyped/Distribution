...
trait ShowDeleted extends StObject {
...
object ShowDeleted {
  ...
  inline def apply(): ShowDeleted = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ShowDeleted]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ShowDeleted] (val x: Self) extends AnyVal {
