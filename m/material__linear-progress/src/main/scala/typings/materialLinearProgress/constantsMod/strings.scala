...
import typings.materialLinearProgress.materialLinearProgressStrings.`Dotmdc-linear-progress__buffer`
import typings.materialLinearProgress.materialLinearProgressStrings.`Dotmdc-linear-progress__primary-bar`
