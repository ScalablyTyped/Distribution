...
object constantsMod {
  ...
  object animationDimensionPercentages {
    ...
    @JSImport("@material/linear-progress/constants", "animationDimensionPercentages")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/linear-progress/constants", "animationDimensionPercentages.PRIMARY_FULL")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "animationDimensionPercentages.PRIMARY_HALF")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "animationDimensionPercentages.SECONDARY_FULL")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "animationDimensionPercentages.SECONDARY_HALF")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "animationDimensionPercentages.SECONDARY_QUARTER")
    @js.native
  ...
  object cssClasses {
    ...
    @JSImport("@material/linear-progress/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/linear-progress/constants", "cssClasses.ANIMATION_READY_CLASS")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "cssClasses.CLOSED_ANIMATION_OFF_CLASS")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "cssClasses.CLOSED_CLASS")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "cssClasses.INDETERMINATE_CLASS")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "cssClasses.REVERSED_CLASS")
    @js.native
  ...
  object strings {
    ...
    @JSImport("@material/linear-progress/constants", "strings")
    @js.native
    val ^ : js.Any = js.native
    ...
    @JSImport("@material/linear-progress/constants", "strings.BUFFER_BAR_SELECTOR")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "strings.FLEX_BASIS")
    @js.native
    ...
    @JSImport("@material/linear-progress/constants", "strings.PRIMARY_BAR_SELECTOR")
    @js.native
