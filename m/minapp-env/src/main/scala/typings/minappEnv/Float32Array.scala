...
trait Float32Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any]): Float32Array = js.native
  def filter(
  ...
  val toStringTag: typings.minappEnv.minappEnvStrings.Float32Array = js.native
