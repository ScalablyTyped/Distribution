...
trait ProxyHandler[T /* <: js.Object */] extends js.Object {
  ...
  var enumerate: js.UndefOr[js.Function1[/* target */ T, Array[PropertyKey]]] = js.native
  ...
  var ownKeys: js.UndefOr[js.Function1[/* target */ T, Array[PropertyKey]]] = js.native
...
object ProxyHandler {
  ...
  @scala.inline
  implicit class ProxyHandlerOps[Self <: ProxyHandler[_], T /* <: js.Object */] (val x: Self with ProxyHandler[T]) extends AnyVal {
    ...
    @scala.inline
    def setEnumerate(value: /* target */ T => Array[PropertyKey]): Self = this.set("enumerate", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOwnKeys(value: /* target */ T => Array[PropertyKey]): Self = this.set("ownKeys", js.Any.fromFunction1(value))
