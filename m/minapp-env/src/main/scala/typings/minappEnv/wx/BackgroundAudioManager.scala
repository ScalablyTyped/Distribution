...
object BackgroundAudioManager {
  ...
  implicit open class MutableBuilder[Self <: BackgroundAudioManager] (val x: Self) extends AnyVal {
    ...
    inline def setOnCanplay(value: BackgroundAudioManagerOnCanplayCallback => Unit): Self = StObject.set(x, "onCanplay", js.Any.fromFunction1(value))
    
    inline def setOnEnded(value: BackgroundAudioManagerOnEndedCallback => Unit): Self = StObject.set(x, "onEnded", js.Any.fromFunction1(value))
    
    inline def setOnError(value: BackgroundAudioManagerOnErrorCallback => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction1(value))
    
    inline def setOnNext(value: OnNextCallback => Unit): Self = StObject.set(x, "onNext", js.Any.fromFunction1(value))
    
    inline def setOnPause(value: BackgroundAudioManagerOnPauseCallback => Unit): Self = StObject.set(x, "onPause", js.Any.fromFunction1(value))
    
    inline def setOnPlay(value: BackgroundAudioManagerOnPlayCallback => Unit): Self = StObject.set(x, "onPlay", js.Any.fromFunction1(value))
    
    inline def setOnPrev(value: OnPrevCallback => Unit): Self = StObject.set(x, "onPrev", js.Any.fromFunction1(value))
    
    inline def setOnSeeked(value: BackgroundAudioManagerOnSeekedCallback => Unit): Self = StObject.set(x, "onSeeked", js.Any.fromFunction1(value))
    
    inline def setOnSeeking(value: BackgroundAudioManagerOnSeekingCallback => Unit): Self = StObject.set(x, "onSeeking", js.Any.fromFunction1(value))
    
    inline def setOnStop(value: BackgroundAudioManagerOnStopCallback => Unit): Self = StObject.set(x, "onStop", js.Any.fromFunction1(value))
    
    inline def setOnTimeUpdate(value: BackgroundAudioManagerOnTimeUpdateCallback => Unit): Self = StObject.set(x, "onTimeUpdate", js.Any.fromFunction1(value))
    
    inline def setOnWaiting(value: BackgroundAudioManagerOnWaitingCallback => Unit): Self = StObject.set(x, "onWaiting", js.Any.fromFunction1(value))
