...
object GetScaleOption {
  ...
  inline def apply(): GetScaleOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetScaleOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetScaleOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetScaleSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
