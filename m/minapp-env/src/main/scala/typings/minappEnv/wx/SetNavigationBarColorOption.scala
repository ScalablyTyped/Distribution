...
object SetNavigationBarColorOption {
  ...
  inline def apply(animation: AnimationOption, backgroundColor: String, frontColor: String): SetNavigationBarColorOption = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SetNavigationBarColorOption] (val x: Self) extends AnyVal {
