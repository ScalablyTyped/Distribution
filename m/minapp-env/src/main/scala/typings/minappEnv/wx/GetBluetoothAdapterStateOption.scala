...
object GetBluetoothAdapterStateOption {
  ...
  @scala.inline
  implicit class GetBluetoothAdapterStateOptionOps[Self <: GetBluetoothAdapterStateOption] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetBluetoothAdapterStateSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
