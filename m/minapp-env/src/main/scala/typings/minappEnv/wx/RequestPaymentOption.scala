...
object RequestPaymentOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestPaymentOption] (val x: Self) extends AnyVal {
    ...
    inline def setSignType(value: MD5 | `HMAC-SHA256`): Self = StObject.set(x, "signType", value.asInstanceOf[js.Any])
