...
object GetUserInfoOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetUserInfoOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetUserInfoSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
