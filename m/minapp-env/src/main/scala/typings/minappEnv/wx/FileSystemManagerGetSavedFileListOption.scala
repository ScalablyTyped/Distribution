...
trait FileSystemManagerGetSavedFileListOption extends StObject {
  ...
  var complete: js.UndefOr[FileSystemManagerGetSavedFileListCompleteCallback] = js.native
  
  /** 接口调用失败的回调函数 */
  var fail: js.UndefOr[FileSystemManagerGetSavedFileListFailCallback] = js.native
