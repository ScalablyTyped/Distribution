...
object GetBluetoothDevicesOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBluetoothDevicesOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetBluetoothDevicesSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
