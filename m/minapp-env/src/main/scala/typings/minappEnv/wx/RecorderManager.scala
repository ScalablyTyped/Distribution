...
object RecorderManager {
  ...
  extension [Self <: RecorderManager](x: Self) {
    ...
    inline def setOnError(value: RecorderManagerOnErrorCallback => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction1(value))
    ...
    inline def setOnPause(value: RecorderManagerOnPauseCallback => Unit): Self = StObject.set(x, "onPause", js.Any.fromFunction1(value))
