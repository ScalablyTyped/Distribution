...
object StartHCEOption {
  ...
  inline def apply(aid_list: Array[String]): StartHCEOption = {
    val __obj = js.Dynamic.literal(aid_list = aid_list.asInstanceOf[js.Any])
    __obj.asInstanceOf[StartHCEOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StartHCEOption] (val x: Self) extends AnyVal {
    
    inline def setAid_list(value: Array[String]): Self = StObject.set(x, "aid_list", value.asInstanceOf[js.Any])
