...
@js.native
trait ShowNavigationBarLoadingOption extends js.Object {
...
object ShowNavigationBarLoadingOption {
  ...
  @scala.inline
  implicit class ShowNavigationBarLoadingOptionOps[Self <: ShowNavigationBarLoadingOption] (val x: Self) extends AnyVal {
