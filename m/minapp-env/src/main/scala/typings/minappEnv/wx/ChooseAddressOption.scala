...
object ChooseAddressOption {
  ...
  @scala.inline
  implicit class ChooseAddressOptionOps[Self <: ChooseAddressOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ ChooseAddressSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
