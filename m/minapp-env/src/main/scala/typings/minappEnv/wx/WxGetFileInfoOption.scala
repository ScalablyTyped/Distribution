...
object WxGetFileInfoOption {
  ...
  implicit class WxGetFileInfoOptionOps[Self <: WxGetFileInfoOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDigestAlgorithm(value: md5_ | sha1): Self = this.set("digestAlgorithm", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ WxGetFileInfoSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
