...
@js.native
trait GetExtConfigOption extends js.Object {
...
object GetExtConfigOption {
  ...
  @scala.inline
  implicit class GetExtConfigOptionOps[Self <: GetExtConfigOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetExtConfigSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
