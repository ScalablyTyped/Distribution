...
object GetSettingOption {
  ...
  @scala.inline
  implicit class GetSettingOptionOps[Self <: GetSettingOption] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetSettingSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
