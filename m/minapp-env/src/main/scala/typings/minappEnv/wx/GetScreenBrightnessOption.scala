...
object GetScreenBrightnessOption {
  ...
  inline def apply(): GetScreenBrightnessOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetScreenBrightnessOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetScreenBrightnessOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* option */ GetScreenBrightnessSuccessCallbackOption => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
