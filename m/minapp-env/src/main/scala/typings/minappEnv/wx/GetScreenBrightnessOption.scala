...
object GetScreenBrightnessOption {
  ...
  @scala.inline
  implicit class GetScreenBrightnessOptionOps[Self <: GetScreenBrightnessOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* option */ GetScreenBrightnessSuccessCallbackOption => Unit): Self = this.set("success", js.Any.fromFunction1(value))
