...
trait Uint8ClampedArray
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any]): Uint8ClampedArray = js.native
  def filter(
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def map(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Double]): Uint8ClampedArray = js.native
  def map(
  ...
  def slice(start: Unit, end: Double): Uint8ClampedArray = js.native
  ...
  val toStringTag: typings.minappEnv.minappEnvStrings.Uint8ClampedArray = js.native
