...
object minappEnvStrings {
  ...
  @js.native
  sealed trait arraybuffer_ extends StObject
  inline def arraybuffer_ : arraybuffer_ = "arraybuffer".asInstanceOf[arraybuffer_]
  ...
  inline def byteLength: byteLength = "byteLength".asInstanceOf[byteLength]
  ...
  @js.native
  sealed trait json_ extends StObject
  ...
  @js.native
  sealed trait `ucs2Slashucs-2Slashutf16leSlashutf-16le` extends StObject
  inline def `ucs2Slashucs-2Slashutf16leSlashutf-16le`: `ucs2Slashucs-2Slashutf16leSlashutf-16le` = "ucs2/ucs-2/utf16le/utf-16le".asInstanceOf[`ucs2Slashucs-2Slashutf16leSlashutf-16le`]
  ...
  @js.native
  sealed trait `utf-8Slashutf8` extends StObject
  inline def `utf-8Slashutf8`: `utf-8Slashutf8` = "utf-8/utf8".asInstanceOf[`utf-8Slashutf8`]
