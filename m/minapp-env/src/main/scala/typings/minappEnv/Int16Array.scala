...
trait Int16Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any]): Int16Array = js.native
  def filter(
  ...
  val toStringTag: typings.minappEnv.minappEnvStrings.Int16Array = js.native
