...
trait CallableFunction extends Function {
  ...
  @JSName("apply")
  def apply[T, A /* <: Array[_] */, R](`this`: js.ThisFunction1[/* this */ T, /* args */ A, R], thisArg: T, args: A): R = js.native
  /**
  ...
  def bind[T, A0, A /* <: Array[_] */, R](`this`: js.ThisFunction2[/* this */ T, /* arg0 */ A0, /* args */ A, R], thisArg: T, arg0: A0): js.Function1[/* args */ A, R] = js.native
  def bind[T, A0, A1, A /* <: Array[_] */, R](
    `this`: js.ThisFunction3[/* this */ T, /* arg0 */ A0, /* arg1 */ A1, /* args */ A, R],
    thisArg: T,
    arg0: A0,
    arg1: A1
  ): js.Function1[/* args */ A, R] = js.native
  def bind[T, A0, A1, A2, A /* <: Array[_] */, R](
  ...
  def bind[T, A0, A1, A2, A3, A /* <: Array[_] */, R](
