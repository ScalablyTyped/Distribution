...
trait NewableFunction extends Function {
  ...
  @JSName("apply")
  def apply[T, A /* <: Array[_] */](`this`: Instantiable1[/* args */ A, T], thisArg: T, args: A): Unit = js.native
  /**
  ...
  def bind[A0, A /* <: Array[_] */, R](`this`: Instantiable2[/* arg0 */ A0, /* args */ A, R], thisArg: js.Any, arg0: A0): Instantiable1[/* args */ A, R] = js.native
