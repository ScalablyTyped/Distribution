...
import typings.miniprogramWxs.DateConstructor
...
import typings.miniprogramWxs.RangeErrorConstructor
import typings.miniprogramWxs.ReferenceErrorConstructor
import typings.miniprogramWxs.SyntaxErrorConstructor
import typings.miniprogramWxs.TypeErrorConstructor
import typings.miniprogramWxs.URIErrorConstructor
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  var JSON: typings.miniprogramWxs.JSON = js.native
  
  /** An intrinsic object that provides basic mathematics functionality and constants. */
  var Math: typings.miniprogramWxs.Math = js.native
