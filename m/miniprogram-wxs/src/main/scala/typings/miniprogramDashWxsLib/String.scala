...
trait String
  ...
  def localeCompare(that: java.lang.String, locales: Array[java.lang.String]): scala.Double = js.native
  def localeCompare(
    that: java.lang.String,
    locales: Array[java.lang.String],
    options: miniprogramDashWxsLib.IntlNs.CollatorOptions
  ): scala.Double = js.native
  /**
  ...
  def split(separator: java.lang.String, limit: scala.Double): Array[java.lang.String] = js.native
  def split(separator: RegExp): Array[java.lang.String] = js.native
  def split(separator: RegExp, limit: scala.Double): Array[java.lang.String] = js.native
  // IE extensions
  /**
