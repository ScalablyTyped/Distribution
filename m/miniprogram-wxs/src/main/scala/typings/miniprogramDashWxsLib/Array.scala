...
trait Array[T]
  ...
  /**
    ...
    */
  def every(callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ Array[T], _]): scala.Boolean = js.native
  def every(
  ...
  /**
    ...
    * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
    */
  def some(callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ Array[T], _]): scala.Boolean = js.native
  def some(
    callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ Array[T], _],
    thisArg: js.Any
  ): scala.Boolean = js.native
