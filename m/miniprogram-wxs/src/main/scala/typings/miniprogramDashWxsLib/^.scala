...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  var JSON: miniprogramDashWxsLib.JSON = js.native
  /** An intrinsic object that provides basic mathematics functionality and constants. */
  var Math: miniprogramDashWxsLib.Math = js.native
  /////////////////////////////
  /// ECMAScript APIs
  /////////////////////////////
  ...
  /**
    ...
    */
  def getDate(value: scala.Double): Date = js.native
  def getDate(year: scala.Double, month: scala.Double): Date = js.native
  def getDate(year: scala.Double, month: scala.Double, date: scala.Double): Date = js.native
  def getDate(year: scala.Double, month: scala.Double, date: scala.Double, hours: scala.Double): Date = js.native
  def getDate(
    year: scala.Double,
    month: scala.Double,
    date: scala.Double,
