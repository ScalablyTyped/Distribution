...
]] = typings.muiDatatables.mod.^.asInstanceOf[js.Dynamic].applyDynamic("debounceSearchRender")().asInstanceOf[js.UndefOr[
js.Function4[
  /* searchText */ java.lang.String, 
  /* handleSearch */ js.Function1[/* text */ java.lang.String, scala.Unit], 
  /* hideSearch */ js.Function0[scala.Unit], 
...
js.Function4[
  ...
  /* options */ js.Any, 
  (typings.react.mod.Component[js.Object, js.Object, js.Any]) | typings.react.mod.global.JSX.Element
]] = typings.muiDatatables.mod.^.asInstanceOf[js.Dynamic].applyDynamic("debounceSearchRender")(debounceWait.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[
js.Function4[
  /* searchText */ java.lang.String, 
  /* handleSearch */ js.Function1[/* text */ java.lang.String, scala.Unit], 
  /* hideSearch */ js.Function0[scala.Unit], 
