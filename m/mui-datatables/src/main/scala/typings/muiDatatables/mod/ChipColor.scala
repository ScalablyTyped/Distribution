...
/* Rewritten from type alias, can be one of: 
  - typings.muiDatatables.muiDatatablesStrings.primary
  - typings.muiDatatables.muiDatatablesStrings.secondary
  - typings.muiDatatables.muiDatatablesStrings.default
*/
