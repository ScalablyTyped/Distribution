...
object MUIDataTableToolbar {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MUIDataTableToolbar] (val x: Self) extends AnyVal {
    ...
    inline def setResetFilters(value: () => Any): Self = StObject.set(x, "resetFilters", js.Any.fromFunction0(value))
    
    inline def setResetFiltersUndefined: Self = StObject.set(x, "resetFilters", js.undefined)
    
    inline def setSearchClose(value: () => Any): Self = StObject.set(x, "searchClose", js.Any.fromFunction0(value))
