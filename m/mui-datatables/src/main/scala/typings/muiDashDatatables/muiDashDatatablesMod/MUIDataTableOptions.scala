...
object MUIDataTableOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(searchOpen)) __obj.updateDynamic("searchOpen")(searchOpen)
    ...
    if (!js.isUndefined(selectableRowsHeader)) __obj.updateDynamic("selectableRowsHeader")(selectableRowsHeader)
    ...
    if (serverSideFilterList != null) __obj.updateDynamic("serverSideFilterList")(serverSideFilterList)
