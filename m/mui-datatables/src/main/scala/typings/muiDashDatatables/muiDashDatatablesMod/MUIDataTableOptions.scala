...
object MUIDataTableOptions {
  ...
  def apply(
    ...
    customToolbarSelect: (/* selectedRows */ Anon_DataKey, /* displayData */ js.Array[Anon_DataDataIndex], /* setSelectedRows */ js.Function1[/* rows */ js.Array[Double], Unit]) => ReactNode = null,
