package typings.maximMazurokGapiClientPagespeedonline.anon
...
object Accesstoken {
  ...
  implicit class AccesstokenOps[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCaptchaToken(value: String): Self = this.set("captchaToken", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCaptchaToken: Self = this.set("captchaToken", js.undefined)
