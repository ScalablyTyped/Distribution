...
@js.native
trait AltAnnotationId extends StObject {
...
object AltAnnotationId {
  ...
  @scala.inline
  def apply(): AltAnnotationId = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AltAnnotationId]
  }
  
  @scala.inline
  implicit class AltAnnotationIdMutableBuilder[Self <: AltAnnotationId] (val x: Self) extends AnyVal {
