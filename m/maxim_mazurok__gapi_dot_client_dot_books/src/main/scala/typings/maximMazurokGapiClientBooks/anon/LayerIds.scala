...
trait LayerIds extends StObject {
  ...
  var layerIds: js.UndefOr[String | js.Array[String]] = js.undefined
...
object LayerIds {
  ...
  inline def apply(): LayerIds = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LayerIds]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LayerIds] (val x: Self) extends AnyVal {
