...
trait AllowWebDefinitions extends StObject {
...
object AllowWebDefinitions {
  ...
  inline def apply(annotationDataId: String, contentVersion: String, layerId: String, volumeId: String): AllowWebDefinitions = {
