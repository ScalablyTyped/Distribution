...
object ShowOnlySummaryInResponse {
  ...
  @scala.inline
  def apply(resource: Annotation): ShowOnlySummaryInResponse = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ShowOnlySummaryInResponse]
  }
  
  @scala.inline
  implicit class ShowOnlySummaryInResponseMutableBuilder[Self <: ShowOnlySummaryInResponse] (val x: Self) extends AnyVal {
