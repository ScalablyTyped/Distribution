...
object AnnotationId {
  ...
  inline def apply(annotationId: String, layerId: String, volumeId: String): AnnotationId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AnnotationId] (val x: Self) extends AnyVal {
