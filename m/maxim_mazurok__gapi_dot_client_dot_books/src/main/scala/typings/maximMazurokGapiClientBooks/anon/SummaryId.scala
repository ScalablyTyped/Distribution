...
trait SummaryId extends StObject {
...
object SummaryId {
  ...
  inline def apply(summaryId: String, volumeId: String): SummaryId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SummaryId] (val x: Self) extends AnyVal {
