...
object Volumeannotations {
  ...
  implicit class VolumeannotationsOps[Self <: Volumeannotations] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Volumeannotation*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Volumeannotation]): Self = this.set("items", value.asInstanceOf[js.Any])
