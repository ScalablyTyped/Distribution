...
@js.native
trait GeoAnnotationdata extends js.Object {
...
object GeoAnnotationdata {
  ...
  @scala.inline
  def apply(): GeoAnnotationdata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GeoAnnotationdata]
  }
  
  @scala.inline
  implicit class GeoAnnotationdataOps[Self <: GeoAnnotationdata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: Geolayerdata): Self = this.set("data", value.asInstanceOf[js.Any])
