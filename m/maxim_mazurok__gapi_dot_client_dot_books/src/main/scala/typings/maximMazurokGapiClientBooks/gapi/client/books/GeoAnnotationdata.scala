...
object GeoAnnotationdata {
  ...
  @scala.inline
  implicit class GeoAnnotationdataMutableBuilder[Self <: GeoAnnotationdata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: Geolayerdata): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
