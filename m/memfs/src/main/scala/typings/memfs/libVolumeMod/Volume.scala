...
import typings.memfs.libNodeMod.File
...
open class Volume () extends StObject {
  ...
  var FSWatcher: Instantiable0[typings.memfs.libVolumeMod.FSWatcher] = js.native
  
  var ReadStream: Instantiable1[/* args (repeated) */ Any, IReadStream] = js.native
  
  var StatWatcher: Instantiable0[typings.memfs.libVolumeMod.StatWatcher] = js.native
  ...
  def readdir(path: PathLike, callback: TCallback[js.Array[TDataOut | typings.memfs.libDirentMod.default]]): Any = js.native
  def readdir(
    path: PathLike,
    options: String,
    callback: TCallback[js.Array[TDataOut | typings.memfs.libDirentMod.default]]
  ): Any = js.native
  def readdir(
    path: PathLike,
  ...
  def readdirSync(path: PathLike): js.Array[TDataOut | typings.memfs.libDirentMod.default] = js.native
  def readdirSync(path: PathLike, options: String): js.Array[TDataOut | typings.memfs.libDirentMod.default] = js.native
  def readdirSync(path: PathLike, options: IReaddirOptions): js.Array[TDataOut | typings.memfs.libDirentMod.default] = js.native
