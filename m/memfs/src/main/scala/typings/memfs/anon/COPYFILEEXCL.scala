...
@js.native
trait COPYFILEEXCL extends js.Object {
...
object COPYFILEEXCL {
  ...
  @scala.inline
  implicit class COPYFILEEXCLOps[Self <: COPYFILEEXCL] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUV_FS_COPYFILE_EXCL(value: Double): Self = this.set("UV_FS_COPYFILE_EXCL", value.asInstanceOf[js.Any])
    @scala.inline
    def setUV_FS_COPYFILE_FICLONE(value: Double): Self = this.set("UV_FS_COPYFILE_FICLONE", value.asInstanceOf[js.Any])
    @scala.inline
    def setUV_FS_COPYFILE_FICLONE_FORCE(value: Double): Self = this.set("UV_FS_COPYFILE_FICLONE_FORCE", value.asInstanceOf[js.Any])
    @scala.inline
    def setUV_FS_SYMLINK_DIR(value: Double): Self = this.set("UV_FS_SYMLINK_DIR", value.asInstanceOf[js.Any])
    @scala.inline
    def setUV_FS_SYMLINK_JUNCTION(value: Double): Self = this.set("UV_FS_SYMLINK_JUNCTION", value.asInstanceOf[js.Any])
    @scala.inline
