...
class Volume () extends js.Object {
  ...
  def fstatSync(fd: Double, options: `0`): default[BigInt] = js.native
  ...
  def lstatSync(path: PathLike, options: `0`): default[BigInt] = js.native
  ...
  def statSync(path: PathLike, options: `0`): default[BigInt] = js.native
