...
import typings.memfs.libEncodingMod.TDataOut
import typings.memfs.libStatsMod.TStatNumber
import typings.memfs.libStatsMod.default
import typings.memfs.libVolumeMod.IAppendFileOptions
import typings.memfs.libVolumeMod.IFStatOptions
import typings.memfs.libVolumeMod.IMkdirOptions
import typings.memfs.libVolumeMod.IOptions
import typings.memfs.libVolumeMod.IReadFileOptions
import typings.memfs.libVolumeMod.IReaddirOptions
import typings.memfs.libVolumeMod.IRealpathOptions
import typings.memfs.libVolumeMod.IRmOptions
import typings.memfs.libVolumeMod.IStatOptions
import typings.memfs.libVolumeMod.IWriteFileOptions
import typings.memfs.libVolumeMod.TData
import typings.memfs.libVolumeMod.TFlags
import typings.memfs.libVolumeMod.TFlagsCopy
import typings.memfs.libVolumeMod.TMode
import typings.memfs.libVolumeMod.TTime
import typings.memfs.libVolumeMod.Volume
...
object libPromisesMod {
  ...
  trait IPromisesAPI extends StObject {
    ...
    def readdir(path: PathLike): js.Promise[js.Array[TDataOut | typings.memfs.libDirentMod.default]] = js.native
    def readdir(path: PathLike, options: String): js.Promise[js.Array[TDataOut | typings.memfs.libDirentMod.default]] = js.native
    def readdir(path: PathLike, options: IReaddirOptions): js.Promise[js.Array[TDataOut | typings.memfs.libDirentMod.default]] = js.native
