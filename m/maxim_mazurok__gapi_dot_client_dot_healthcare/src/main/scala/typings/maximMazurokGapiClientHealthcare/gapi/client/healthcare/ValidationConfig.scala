...
trait ValidationConfig extends StObject {
  ...
  /**
    ...
    */
  var disableFhirpathValidation: js.UndefOr[Boolean] = js.undefined
  ...
  var disableProfileValidation: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * enforced.
    */
  var disableReferenceTypeValidation: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * enforced.
    */
  var disableRequiredFieldValidation: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * return an error.
    */
  var enabledImplementationGuides: js.UndefOr[js.Array[String]] = js.undefined
}
object ValidationConfig {
  
  inline def apply(): ValidationConfig = {
