...
import typings.maximMazurokGapiClientHealthcare.anon.AccesstokenAltCallback
...
import typings.maximMazurokGapiClientHealthcare.anon.UpdateMaskUploadType
import typings.maximMazurokGapiClientHealthcare.anon.UploadprotocolXgafv
