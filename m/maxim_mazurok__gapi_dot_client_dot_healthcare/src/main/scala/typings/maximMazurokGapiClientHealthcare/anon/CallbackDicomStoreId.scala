...
trait CallbackDicomStoreId extends StObject {
...
object CallbackDicomStoreId {
  
  inline def apply(parent: String): CallbackDicomStoreId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackDicomStoreId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackDicomStoreId] (val x: Self) extends AnyVal {
