...
import typings.maximMazurokGapiClientHealthcare.gapi.client.healthcare.UserDataMapping
...
object AccesstokenAlt {
  ...
  inline def apply(parent: String, resource: UserDataMapping): AccesstokenAlt = {
