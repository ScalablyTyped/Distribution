...
object Fields {
  ...
  implicit class FieldsOps[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DeidentifyDicomStoreRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSourceStore(value: String): Self = this.set("sourceStore", value.asInstanceOf[js.Any])
