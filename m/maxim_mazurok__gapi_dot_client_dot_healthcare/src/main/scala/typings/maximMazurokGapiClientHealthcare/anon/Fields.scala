...
trait Fields extends StObject {
  ...
  /** Request body */
  var resource: DeidentifyDicomStoreRequest = js.native
  ...
  var sourceStore: String = js.native
...
object Fields {
  ...
  @scala.inline
  def apply(resource: DeidentifyDicomStoreRequest, sourceStore: String): Fields = {
  ...
  implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DeidentifyDicomStoreRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSourceStore(value: String): Self = StObject.set(x, "sourceStore", value.asInstanceOf[js.Any])
