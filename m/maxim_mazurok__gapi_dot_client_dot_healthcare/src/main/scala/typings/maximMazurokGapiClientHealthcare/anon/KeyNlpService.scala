...
trait KeyNlpService extends StObject {
...
object KeyNlpService {
  
  inline def apply(nlpService: String): KeyNlpService = {
    val __obj = js.Dynamic.literal(nlpService = nlpService.asInstanceOf[js.Any])
