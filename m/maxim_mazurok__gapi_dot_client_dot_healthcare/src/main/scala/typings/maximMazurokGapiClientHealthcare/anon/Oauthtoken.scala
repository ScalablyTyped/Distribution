...
import typings.maximMazurokGapiClientHealthcare.gapi.client.healthcare.ExportDicomDataRequest
...
object Oauthtoken {
  ...
  inline def apply(name: String, resource: ExportDicomDataRequest): Oauthtoken = {
