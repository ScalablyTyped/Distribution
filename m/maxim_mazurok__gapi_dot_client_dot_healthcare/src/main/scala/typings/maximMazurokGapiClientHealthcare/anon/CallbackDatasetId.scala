...
@js.native
trait CallbackDatasetId extends StObject {
...
object CallbackDatasetId {
  
  @scala.inline
  def apply(parent: String): CallbackDatasetId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackDatasetId]
  }
  
  @scala.inline
  implicit class CallbackDatasetIdMutableBuilder[Self <: CallbackDatasetId] (val x: Self) extends AnyVal {
