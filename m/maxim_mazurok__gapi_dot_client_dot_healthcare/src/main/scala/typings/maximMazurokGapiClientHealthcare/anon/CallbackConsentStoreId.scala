...
trait CallbackConsentStoreId extends StObject {
...
object CallbackConsentStoreId {
  
  inline def apply(parent: String): CallbackConsentStoreId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackConsentStoreId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackConsentStoreId] (val x: Self) extends AnyVal {
