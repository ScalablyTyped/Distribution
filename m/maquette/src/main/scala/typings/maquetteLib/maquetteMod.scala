...
object maquetteMod extends js.Object {
  ...
  object dom extends js.Object {
    /**
      ...
      */
    def append(parentNode: stdLib.Element, vnode: maquetteLib.distInterfacesMod.VNode): maquetteLib.distInterfacesMod.Projection = js.native
    def append(
      parentNode: stdLib.Element,
      vnode: maquetteLib.distInterfacesMod.VNode,
      projectionOptions: maquetteLib.distInterfacesMod.ProjectionOptions
    ): maquetteLib.distInterfacesMod.Projection = js.native
    /**
      ...
      */
    def create(vnode: maquetteLib.distInterfacesMod.VNode): maquetteLib.distInterfacesMod.Projection = js.native
    def create(
      vnode: maquetteLib.distInterfacesMod.VNode,
      projectionOptions: maquetteLib.distInterfacesMod.ProjectionOptions
    ): maquetteLib.distInterfacesMod.Projection = js.native
    /**
      ...
      * @returns The [[Projection]] that was created.
      */
    def insertBefore(beforeNode: stdLib.Element, vnode: maquetteLib.distInterfacesMod.VNode): maquetteLib.distInterfacesMod.Projection = js.native
    def insertBefore(
      beforeNode: stdLib.Element,
      vnode: maquetteLib.distInterfacesMod.VNode,
      projectionOptions: maquetteLib.distInterfacesMod.ProjectionOptions
    ): maquetteLib.distInterfacesMod.Projection = js.native
    /**
      ...
      * @returns The [[Projection]] that was created.
      */
    def merge(element: stdLib.Element, vnode: maquetteLib.distInterfacesMod.VNode): maquetteLib.distInterfacesMod.Projection = js.native
    def merge(
    ...
    /**
      ...
      * @returns The [[Projection]] that was created.
      */
    def replace(element: stdLib.Element, vnode: maquetteLib.distInterfacesMod.VNode): maquetteLib.distInterfacesMod.Projection = js.native
    def replace(
      element: stdLib.Element,
      vnode: maquetteLib.distInterfacesMod.VNode,
      projectionOptions: maquetteLib.distInterfacesMod.ProjectionOptions
