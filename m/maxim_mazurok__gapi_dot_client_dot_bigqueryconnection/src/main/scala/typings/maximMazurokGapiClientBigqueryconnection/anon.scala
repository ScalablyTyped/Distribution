...
import typings.maximMazurokGapiClientBigqueryconnection.gapi.client.bigqueryconnection.Connection
import typings.maximMazurokGapiClientBigqueryconnection.gapi.client.bigqueryconnection.ConnectionCredential
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: Connection = js.native
  ...
  object Accesstoken {
    ...
    @scala.inline
    def apply(parent: String, resource: Connection): Accesstoken = {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: Connection): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Name {
    ...
    @scala.inline
    def apply(name: String, resource: Connection): Name = {
  ...
  object Oauthtoken {
    ...
    @scala.inline
    def apply(name: String): Oauthtoken = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
  ...
  trait PrettyPrint extends StObject {
    ...
    /** Request body */
    var resource: ConnectionCredential = js.native
  ...
  object PrettyPrint {
    ...
    @scala.inline
    def apply(name: String, resource: ConnectionCredential): PrettyPrint = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: ConnectionCredential): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
