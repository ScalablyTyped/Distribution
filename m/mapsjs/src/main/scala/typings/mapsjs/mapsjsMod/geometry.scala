...
class geometry () extends js.Object {
  ...
  /**
  	 ...
  	 */
  def addPointToLastSet(pt: point): Anon_Idx = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def findNearestSegment(pt: point): Anon_Distance = js.native
  def findNearestSegment(pt: point, close: Boolean): Anon_Distance = js.native
  /**
  	 ...
  	 * is the distance of the point to the reference point in map units.
  	 */
  def findNearestVertex(pt: point): Anon_Distance = js.native
  /**
