...
object maximMazurokGapiClientRedisStrings {
  
  @js.native
  sealed trait GoogleCloudRedisV1LocationMetadata extends StObject
  @scala.inline
  def GoogleCloudRedisV1LocationMetadata: GoogleCloudRedisV1LocationMetadata = "GoogleCloudRedisV1LocationMetadata".asInstanceOf[GoogleCloudRedisV1LocationMetadata]
