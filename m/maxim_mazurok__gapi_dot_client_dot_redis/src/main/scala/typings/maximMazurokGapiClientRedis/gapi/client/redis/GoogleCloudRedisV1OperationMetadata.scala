...
@js.native
trait GoogleCloudRedisV1OperationMetadata extends js.Object {
...
object GoogleCloudRedisV1OperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudRedisV1OperationMetadataOps[Self <: GoogleCloudRedisV1OperationMetadata] (val x: Self) extends AnyVal {
