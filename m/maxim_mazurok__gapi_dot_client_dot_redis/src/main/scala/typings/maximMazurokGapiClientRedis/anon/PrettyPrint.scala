package typings.maximMazurokGapiClientRedis.anon

import typings.maximMazurokGapiClientRedis.gapi.client.redis.Instance
...
object PrettyPrint {
  ...
  implicit class PrettyPrintOps[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Instance): Self = this.set("resource", value.asInstanceOf[js.Any])
