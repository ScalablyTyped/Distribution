...
object atMaterialTopDashAppDashBarStrings {
  ...
  @js.native
  sealed trait `mdc-top-app-bar--fixed-scrolled` extends js.Object
  
  @js.native
  sealed trait `mdc-top-app-bar--short` extends js.Object
  
  @js.native
  sealed trait `mdc-top-app-bar--short-collapsed` extends js.Object
  ...
  @scala.inline
  def `mdc-top-app-bar--fixed-scrolled`: `mdc-top-app-bar--fixed-scrolled` = "mdc-top-app-bar--fixed-scrolled".asInstanceOf[`mdc-top-app-bar--fixed-scrolled`]
  @scala.inline
  def `mdc-top-app-bar--short`: `mdc-top-app-bar--short` = "mdc-top-app-bar--short".asInstanceOf[`mdc-top-app-bar--short`]
  @scala.inline
  def `mdc-top-app-bar--short-collapsed`: `mdc-top-app-bar--short-collapsed` = "mdc-top-app-bar--short-collapsed".asInstanceOf[`mdc-top-app-bar--short-collapsed`]
  @scala.inline
  def `mdc-top-app-bar--short-has-action-item`: `mdc-top-app-bar--short-has-action-item` = "mdc-top-app-bar--short-has-action-item".asInstanceOf[`mdc-top-app-bar--short-has-action-item`]
}
