...
object numbers {
  ...
  def apply(
    ...
    __obj.updateDynamic("DEBOUNCE_THROTTLE_RESIZE_TIME_MS")(DEBOUNCE_THROTTLE_RESIZE_TIME_MS)
    __obj.updateDynamic("MAX_TOP_APP_BAR_HEIGHT")(MAX_TOP_APP_BAR_HEIGHT)
