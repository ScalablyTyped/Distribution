package typings.maximMazurokGapiClientFirebasedatabase.anon

import typings.maximMazurokGapiClientFirebasedatabase.gapi.client.firebasedatabase.DatabaseInstance
...
object Accesstoken {
  ...
  implicit class AccesstokenOps[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DatabaseInstance): Self = this.set("resource", value.asInstanceOf[js.Any])
