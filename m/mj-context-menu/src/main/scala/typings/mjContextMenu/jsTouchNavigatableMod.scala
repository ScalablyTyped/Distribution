...
object jsTouchNavigatableMod {
  
  object TOUCH {
    
    @JSImport("mj-context-menu/js/touch_navigatable", "TOUCH")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("mj-context-menu/js/touch_navigatable", "TOUCH.CANCEL")
    @js.native
