...
object cjsMod {
  ...
  @JSImport("mj-context-menu/cjs", "ContextMenu")
  @js.native
  ...
  object CssStyles {
    ...
    @JSImport("mj-context-menu/cjs", "CssStyles")
    @js.native
    val ^ : js.Any = js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/cjs", "Info")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/cjs", "Parser")
  @js.native
  open class Parser ()
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/cjs", "ParserFactory")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/cjs", "Popup")
  @js.native
  ...
  object Popup {
    ...
    @JSImport("mj-context-menu/cjs", "Popup.popupSettings")
    @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/cjs", "SelectionBox")
  @js.native
  ...
  object SelectionBox {
    ...
    @JSImport("mj-context-menu/cjs", "SelectionBox.chunkSize")
    @js.native
    ...
    @JSImport("mj-context-menu/cjs", "SelectionBox.orderMethod")
    @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/cjs", "Variable")
  @js.native
  ...
  @JSImport("mj-context-menu/cjs", "version")
  @js.native
