...
object cjsMouseNavigatableMod {
  
  object MOUSE {
    
    @JSImport("mj-context-menu/cjs/mouse_navigatable", "MOUSE")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("mj-context-menu/cjs/mouse_navigatable", "MOUSE.CLICK")
    @js.native
    ...
    @JSImport("mj-context-menu/cjs/mouse_navigatable", "MOUSE.DBLCLICK")
    @js.native
    ...
    @JSImport("mj-context-menu/cjs/mouse_navigatable", "MOUSE.SELECTSTART")
    @js.native
    ...
    @JSImport("mj-context-menu/cjs/mouse_navigatable", "MOUSE.UP")
    @js.native
