...
import typings.mjContextMenu.cjsAbstractNavigatableMod.AbstractNavigatable
...
object cjsMenuElementMod {
  
  /* note: abstract class */ @JSImport("mj-context-menu/cjs/menu_element", "MenuElement")
  @js.native
