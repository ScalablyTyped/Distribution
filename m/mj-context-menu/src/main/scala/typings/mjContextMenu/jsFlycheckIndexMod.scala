...
object jsFlycheckIndexMod {
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/js/flycheck_index", "ContextMenu")
  @js.native
  ...
  object CssStyles {
    ...
    @JSImport("mj-context-menu/js/flycheck_index", "CssStyles")
    @js.native
    val ^ : js.Any = js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/js/flycheck_index", "Info")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/js/flycheck_index", "Parser")
  @js.native
  open class Parser ()
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/js/flycheck_index", "ParserFactory")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/js/flycheck_index", "Popup")
  @js.native
  ...
  object Popup {
    ...
    @JSImport("mj-context-menu/js/flycheck_index", "Popup.popupSettings")
    @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/js/flycheck_index", "SelectionBox")
  @js.native
  ...
  object SelectionBox {
    ...
    @JSImport("mj-context-menu/js/flycheck_index", "SelectionBox.chunkSize")
    @js.native
    ...
    @JSImport("mj-context-menu/js/flycheck_index", "SelectionBox.orderMethod")
    @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("mj-context-menu/js/flycheck_index", "Variable")
  @js.native
  ...
  @JSImport("mj-context-menu/js/flycheck_index", "version")
  @js.native
