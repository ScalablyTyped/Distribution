...
import typings.mjContextMenu.jsInfoMod.Info
...
object jsSelectionBoxMod {
  
  @JSImport("mj-context-menu/js/selection_box", "SelectionBox")
  @js.native
  ...
  object SelectionBox {
    ...
    @JSImport("mj-context-menu/js/selection_box", "SelectionBox.chunkSize")
    @js.native
    ...
    inline def fromJson(factory: ParserFactory, param1: Order, ctxt: ContextMenu): SelectionBox = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJson")(factory.asInstanceOf[js.Any], param1.asInstanceOf[js.Any], ctxt.asInstanceOf[js.Any])).asInstanceOf[SelectionBox]
    
    @JSImport("mj-context-menu/js/selection_box", "SelectionBox.orderMethod")
    @js.native
  ...
  @JSImport("mj-context-menu/js/selection_box", "SelectionMenu")
  @js.native
