...
object jsKeyNavigatableMod {
  
  @js.native
  sealed trait KEY extends StObject
  @JSImport("mj-context-menu/js/key_navigatable", "KEY")
  @js.native
  object KEY extends StObject {
    ...
    sealed trait DOWN
      extends StObject
         with KEY
    /* 40 */ val DOWN: typings.mjContextMenu.jsKeyNavigatableMod.KEY.DOWN & Double = js.native
    
    @js.native
    sealed trait ESCAPE
      extends StObject
         with KEY
    /* 27 */ val ESCAPE: typings.mjContextMenu.jsKeyNavigatableMod.KEY.ESCAPE & Double = js.native
    
    @js.native
    sealed trait LEFT
      extends StObject
         with KEY
    /* 37 */ val LEFT: typings.mjContextMenu.jsKeyNavigatableMod.KEY.LEFT & Double = js.native
    
    @js.native
    sealed trait RETURN
      extends StObject
         with KEY
    /* 13 */ val RETURN: typings.mjContextMenu.jsKeyNavigatableMod.KEY.RETURN & Double = js.native
    
    @js.native
    sealed trait RIGHT
      extends StObject
         with KEY
    /* 39 */ val RIGHT: typings.mjContextMenu.jsKeyNavigatableMod.KEY.RIGHT & Double = js.native
    
    @js.native
    sealed trait SPACE
      extends StObject
         with KEY
    /* 32 */ val SPACE: typings.mjContextMenu.jsKeyNavigatableMod.KEY.SPACE & Double = js.native
    
    @js.native
    sealed trait UP
      extends StObject
         with KEY
    /* 38 */ val UP: typings.mjContextMenu.jsKeyNavigatableMod.KEY.UP & Double = js.native
  }
