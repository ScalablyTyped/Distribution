...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.marked.mod.Tokens.ListStart
  - typings.marked.mod.Tokens.LooseItemStart
  - typings.marked.mod.Tokens.ListItemStart
  - typings.marked.mod.Tokens.ListItemEnd
  - typings.marked.mod.Tokens.ListEnd
