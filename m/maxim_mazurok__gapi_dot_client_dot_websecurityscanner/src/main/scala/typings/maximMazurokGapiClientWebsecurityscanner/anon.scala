...
import typings.maximMazurokGapiClientWebsecurityscanner.gapi.client.websecurityscanner.ScanConfig
import typings.maximMazurokGapiClientWebsecurityscanner.gapi.client.websecurityscanner.StartScanRunRequest
import typings.maximMazurokGapiClientWebsecurityscanner.gapi.client.websecurityscanner.StopScanRunRequest
...
object anon {
  ...
  trait Key extends StObject {
    ...
    /** Request body */
    var resource: StopScanRunRequest
  ...
  object Key {
    ...
    inline def apply(name: String, resource: StopScanRunRequest): Key = {
    ...
    extension [Self <: Key](x: Self) {
      ...
      inline def setResource(value: StopScanRunRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Name {
    ...
    inline def apply(name: String, resource: ScanConfig): Name = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: Name](x: Self) {
      ...
      inline def setResource(value: ScanConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Oauthtoken {
    ...
    inline def apply(parent: String, resource: ScanConfig): Oauthtoken = {
  ...
  trait QuotaUser extends StObject {
    ...
    /** Request body */
    var resource: StartScanRunRequest
  ...
  object QuotaUser {
    ...
    inline def apply(name: String, resource: StartScanRunRequest): QuotaUser = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: QuotaUser](x: Self) {
      ...
      inline def setResource(value: StartScanRunRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
