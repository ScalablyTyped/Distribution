...
@js.native
trait PrettyPrintProjectId extends js.Object {
...
object PrettyPrintProjectId {
  ...
  @scala.inline
  def apply(jobId: String, location: String, projectId: String, resource: SnapshotJobRequest): PrettyPrintProjectId = {
  ...
  @scala.inline
  implicit class PrettyPrintProjectIdOps[Self <: PrettyPrintProjectId] (val x: Self) extends AnyVal {
