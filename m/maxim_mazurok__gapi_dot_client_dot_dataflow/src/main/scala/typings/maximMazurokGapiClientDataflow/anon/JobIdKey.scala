...
@js.native
trait JobIdKey extends StObject {
...
object JobIdKey {
  ...
  @scala.inline
  def apply(jobId: String, projectId: String): JobIdKey = {
  ...
  @scala.inline
  implicit class JobIdKeyMutableBuilder[Self <: JobIdKey] (val x: Self) extends AnyVal {
