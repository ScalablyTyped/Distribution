...
trait KeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: CreateJobFromTemplateRequest = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(projectId: String, resource: CreateJobFromTemplateRequest): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreateJobFromTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
