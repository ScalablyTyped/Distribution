...
trait QuotaUserSnapshotId extends StObject {
...
object QuotaUserSnapshotId {
  ...
  @scala.inline
  def apply(projectId: String, snapshotId: String): QuotaUserSnapshotId = {
  ...
  @scala.inline
  implicit class QuotaUserSnapshotIdMutableBuilder[Self <: QuotaUserSnapshotId] (val x: Self) extends AnyVal {
