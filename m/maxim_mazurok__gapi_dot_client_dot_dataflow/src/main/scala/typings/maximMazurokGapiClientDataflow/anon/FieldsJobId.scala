...
@js.native
trait FieldsJobId extends js.Object {
...
object FieldsJobId {
  ...
  @scala.inline
  def apply(jobId: String, projectId: String, resource: Job): FieldsJobId = {
  ...
  @scala.inline
  implicit class FieldsJobIdOps[Self <: FieldsJobId] (val x: Self) extends AnyVal {
