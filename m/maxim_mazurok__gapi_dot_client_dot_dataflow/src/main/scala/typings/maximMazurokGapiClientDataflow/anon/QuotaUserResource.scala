...
trait QuotaUserResource extends StObject {
  ...
  /** Request body */
  var resource: LaunchFlexTemplateRequest = js.native
...
object QuotaUserResource {
  ...
  @scala.inline
  def apply(location: String, projectId: String, resource: LaunchFlexTemplateRequest): QuotaUserResource = {
  ...
  implicit class QuotaUserResourceMutableBuilder[Self <: QuotaUserResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LaunchFlexTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
