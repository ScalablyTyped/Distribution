...
trait ProjectId extends StObject {
  ...
  /** Request body */
  var resource: SendDebugCaptureRequest = js.native
...
object ProjectId {
  ...
  @scala.inline
  def apply(jobId: String, projectId: String, resource: SendDebugCaptureRequest): ProjectId = {
  ...
  implicit class ProjectIdMutableBuilder[Self <: ProjectId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SendDebugCaptureRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
