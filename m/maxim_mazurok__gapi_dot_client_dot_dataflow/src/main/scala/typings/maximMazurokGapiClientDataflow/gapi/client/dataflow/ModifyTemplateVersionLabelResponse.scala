...
@js.native
trait ModifyTemplateVersionLabelResponse extends js.Object {
...
object ModifyTemplateVersionLabelResponse {
  ...
  @scala.inline
  implicit class ModifyTemplateVersionLabelResponseOps[Self <: ModifyTemplateVersionLabelResponse] (val x: Self) extends AnyVal {
