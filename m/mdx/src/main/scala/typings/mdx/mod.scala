...
object mod {
  ...
  type MDXComponents = NestedMDXComponents & typings.mdx.mdxStrings.MDXComponents & (TopLevel[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify JSX.IntrinsicElements */ Any
  ]) & Wrapper
