...
@js.native
trait SubscriptionPurchasesAcknowledgeRequest extends js.Object {
...
object SubscriptionPurchasesAcknowledgeRequest {
  ...
  @scala.inline
  implicit class SubscriptionPurchasesAcknowledgeRequestOps[Self <: SubscriptionPurchasesAcknowledgeRequest] (val x: Self) extends AnyVal {
