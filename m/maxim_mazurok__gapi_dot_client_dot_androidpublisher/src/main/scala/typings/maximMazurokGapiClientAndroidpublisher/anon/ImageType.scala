...
object ImageType {
  ...
  inline def apply(editId: String, imageType: String, language: String, packageName: String): ImageType = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ImageType] (val x: Self) extends AnyVal {
