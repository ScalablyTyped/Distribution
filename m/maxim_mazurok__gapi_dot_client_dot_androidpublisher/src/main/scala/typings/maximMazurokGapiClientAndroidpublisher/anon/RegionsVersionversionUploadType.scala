...
trait RegionsVersionversionUploadType extends StObject {
...
object RegionsVersionversionUploadType {
  
  inline def apply(packageName: String): RegionsVersionversionUploadType = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[RegionsVersionversionUploadType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RegionsVersionversionUploadType] (val x: Self) extends AnyVal {
