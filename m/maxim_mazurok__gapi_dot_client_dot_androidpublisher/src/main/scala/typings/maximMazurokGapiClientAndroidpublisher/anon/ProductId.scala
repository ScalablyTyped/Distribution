...
trait ProductId extends StObject {
  ...
  /** Request body */
  var resource: ProductPurchasesAcknowledgeRequest = js.native
...
object ProductId {
  ...
  implicit class ProductIdMutableBuilder[Self <: ProductId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ProductPurchasesAcknowledgeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
