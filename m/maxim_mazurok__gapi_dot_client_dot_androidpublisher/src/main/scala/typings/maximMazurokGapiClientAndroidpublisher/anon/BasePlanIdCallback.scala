...
trait BasePlanIdCallback extends StObject {
...
object BasePlanIdCallback {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(basePlanId = basePlanId.asInstanceOf[js.Any], offerId = offerId.asInstanceOf[js.Any], packageName = packageName.asInstanceOf[js.Any], productId = productId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
