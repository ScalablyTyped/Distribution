...
trait AltCallback extends StObject {
  ...
  /** Request body */
  var resource: SubscriptionPurchasesDeferRequest = js.native
...
object AltCallback {
  ...
  implicit class AltCallbackMutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SubscriptionPurchasesDeferRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
