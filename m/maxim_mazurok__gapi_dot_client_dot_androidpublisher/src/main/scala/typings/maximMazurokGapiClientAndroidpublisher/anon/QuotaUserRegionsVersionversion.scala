...
import typings.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.Subscription
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait QuotaUserRegionsVersionversion extends StObject {
...
object QuotaUserRegionsVersionversion {
  
  inline def apply(packageName: String, resource: Subscription): QuotaUserRegionsVersionversion = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserRegionsVersionversion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserRegionsVersionversion] (val x: Self) extends AnyVal {
