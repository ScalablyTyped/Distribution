...
trait RegionsVersionversionUpdateMask extends StObject {
...
object RegionsVersionversionUpdateMask {
  
  inline def apply(packageName: String, productId: String): RegionsVersionversionUpdateMask = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any], productId = productId.asInstanceOf[js.Any])
