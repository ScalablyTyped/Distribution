...
trait ExpansionFileType extends StObject {
  ...
  /** Request body */
  var resource: ExpansionFile = js.native
...
object ExpansionFileType {
  ...
  @scala.inline
  implicit class ExpansionFileTypeMutableBuilder[Self <: ExpansionFileType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ExpansionFile): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
