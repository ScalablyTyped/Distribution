...
object EditId {
  ...
  @scala.inline
  def apply(apkVersionCode: Double, editId: String, expansionFileType: String, packageName: String): EditId = {
  ...
  @scala.inline
  implicit class EditIdMutableBuilder[Self <: EditId] (val x: Self) extends AnyVal {
