...
trait RegionsVersionversion extends StObject {
...
object RegionsVersionversion {
  
  inline def apply(basePlanId: String, packageName: String, productId: String): RegionsVersionversion = {
    ...
    __obj.asInstanceOf[RegionsVersionversion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RegionsVersionversion] (val x: Self) extends AnyVal {
