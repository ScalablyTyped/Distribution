...
trait AllowUnknownDevices extends StObject {
...
object AllowUnknownDevices {
  
  inline def apply(packageName: String): AllowUnknownDevices = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AllowUnknownDevices]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AllowUnknownDevices] (val x: Self) extends AnyVal {
