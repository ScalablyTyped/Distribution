...
trait AutoConvertMissingPricesCallback extends StObject {
...
object AutoConvertMissingPricesCallback {
  
  inline def apply(packageName: String, resource: InAppProduct, sku: String): AutoConvertMissingPricesCallback = {
