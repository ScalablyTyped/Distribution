...
trait DownloadId extends StObject {
...
object DownloadId {
  ...
  inline def apply(downloadId: String, packageName: String, versionCode: Double): DownloadId = {
    val __obj = js.Dynamic.literal(downloadId = downloadId.asInstanceOf[js.Any], packageName = packageName.asInstanceOf[js.Any], versionCode = versionCode.asInstanceOf[js.Any])
    __obj.asInstanceOf[DownloadId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DownloadId] (val x: Self) extends AnyVal {
