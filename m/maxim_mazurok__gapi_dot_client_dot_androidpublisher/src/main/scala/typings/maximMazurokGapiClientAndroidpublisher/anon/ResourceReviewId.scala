...
trait ResourceReviewId extends StObject {
...
object ResourceReviewId {
  
  inline def apply(packageName: String, resource: ReviewsReplyRequest, reviewId: String): ResourceReviewId = {
    ...
    __obj.asInstanceOf[ResourceReviewId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceReviewId] (val x: Self) extends AnyVal {
