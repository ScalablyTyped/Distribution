...
object OfferId {
  ...
  inline def apply(basePlanId: String, offerId: String, packageName: String, productId: String): OfferId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OfferId] (val x: Self) extends AnyVal {
