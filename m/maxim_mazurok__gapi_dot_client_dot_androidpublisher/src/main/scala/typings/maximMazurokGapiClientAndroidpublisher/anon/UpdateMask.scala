...
import typings.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.Grant
...
object UpdateMask {
  ...
  inline def apply(name: String, resource: Grant): UpdateMask = {
  ...
  extension [Self <: UpdateMask](x: Self) {
    ...
    inline def setResource(value: Grant): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
