...
trait QuotaUserReviewId extends StObject {
...
object QuotaUserReviewId {
  
  inline def apply(packageName: String, reviewId: String): QuotaUserReviewId = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any], reviewId = reviewId.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserReviewId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserReviewId] (val x: Self) extends AnyVal {
