package typings
package atMaterialListLib

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object atMaterialListLibStrings {
  @js.native
  ...
  @js.native
  sealed trait `mdc-list-item` extends js.Object
  
  @js.native
  sealed trait `mdc-list-item--activated` extends js.Object
  ...
  @scala.inline
  def `mdc-list-item`: `mdc-list-item` = "mdc-list-item".asInstanceOf[`mdc-list-item`]
  @scala.inline
  def `mdc-list-item--activated`: `mdc-list-item--activated` = "mdc-list-item--activated".asInstanceOf[`mdc-list-item--activated`]
  @scala.inline
