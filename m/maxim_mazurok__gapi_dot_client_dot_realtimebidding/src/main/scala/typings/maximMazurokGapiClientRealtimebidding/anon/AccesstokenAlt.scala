...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: RemoveTargetedPublishersRequest = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(pretargetingConfig: String, resource: RemoveTargetedPublishersRequest): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RemoveTargetedPublishersRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
