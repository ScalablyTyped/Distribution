...
import typings.maximMazurokGapiClientRealtimebidding.gapi.client.realtimebidding.AddTargetedAppsRequest
...
trait PretargetingConfig extends StObject {
  ...
  var pretargetingConfig: String = js.native
  ...
  /** Request body */
  var resource: AddTargetedAppsRequest = js.native
...
object PretargetingConfig {
  ...
  @scala.inline
  def apply(pretargetingConfig: String, resource: AddTargetedAppsRequest): PretargetingConfig = {
  ...
  implicit class PretargetingConfigMutableBuilder[Self <: PretargetingConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPretargetingConfig(value: String): Self = StObject.set(x, "pretargetingConfig", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setResource(value: AddTargetedAppsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
