...
object PretargetingConfig {
  ...
  implicit class PretargetingConfigOps[Self <: PretargetingConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPretargetingConfig(value: String): Self = this.set("pretargetingConfig", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResource(value: AddTargetedAppsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
