...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: RemoveTargetedAppsRequest = js.native
...
object Xgafv {
  ...
  @scala.inline
  def apply(pretargetingConfig: String, resource: RemoveTargetedAppsRequest): Xgafv = {
  ...
  implicit class XgafvMutableBuilder[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RemoveTargetedAppsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
