...
import typings.maximMazurokGapiClientRealtimebidding.gapi.client.realtimebidding.WatchCreativesRequest
...
trait Alt extends StObject {
  ...
  /** Request body */
  var resource: WatchCreativesRequest
...
object Alt {
  ...
  inline def apply(parent: String, resource: WatchCreativesRequest): Alt = {
  ...
  implicit open class MutableBuilder[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: WatchCreativesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
