...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: CloseUserListRequest = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(name: String, resource: CloseUserListRequest): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CloseUserListRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
