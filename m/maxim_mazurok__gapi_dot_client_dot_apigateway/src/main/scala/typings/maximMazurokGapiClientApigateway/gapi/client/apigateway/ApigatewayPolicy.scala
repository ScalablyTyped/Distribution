...
@js.native
trait ApigatewayPolicy extends js.Object {
...
object ApigatewayPolicy {
  ...
  @scala.inline
  implicit class ApigatewayPolicyOps[Self <: ApigatewayPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuditConfigsVarargs(value: ApigatewayAuditConfig*): Self = this.set("auditConfigs", js.Array(value :_*))
    
    @scala.inline
    def setAuditConfigs(value: js.Array[ApigatewayAuditConfig]): Self = this.set("auditConfigs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAuditConfigs: Self = this.set("auditConfigs", js.undefined)
    
    @scala.inline
    def setBindingsVarargs(value: ApigatewayBinding*): Self = this.set("bindings", js.Array(value :_*))
    
    @scala.inline
    def setBindings(value: js.Array[ApigatewayBinding]): Self = this.set("bindings", value.asInstanceOf[js.Any])
