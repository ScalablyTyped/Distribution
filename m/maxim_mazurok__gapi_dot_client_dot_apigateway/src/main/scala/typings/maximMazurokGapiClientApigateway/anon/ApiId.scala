...
object ApiId {
  ...
  inline def apply(parent: String, resource: ApigatewayApi): ApiId = {
  ...
  extension [Self <: ApiId](x: Self) {
    ...
    inline def setResource(value: ApigatewayApi): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
