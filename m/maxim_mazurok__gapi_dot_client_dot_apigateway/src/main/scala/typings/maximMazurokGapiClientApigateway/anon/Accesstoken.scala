...
import typings.maximMazurokGapiClientApigateway.gapi.client.apigateway.ApigatewayApiConfig
...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: ApigatewayApiConfig): Accesstoken = {
  ...
  extension [Self <: Accesstoken](x: Self) {
    ...
    inline def setResource(value: ApigatewayApiConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
