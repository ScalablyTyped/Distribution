...
object ^ extends js.Object {
  var Minimatch: minimatchLib.minimatchMod.MNs.IMinimatchStatic = js.native
  ...
  def filter(pattern: java.lang.String, options: minimatchLib.minimatchMod.MNs.IOptions): js.Function3[
    /* element */ java.lang.String, 
    /* indexed */ scala.Double, 
    /* array */ js.Array[java.lang.String], 
    scala.Boolean
  ...
  def makeRe(pattern: java.lang.String, options: minimatchLib.minimatchMod.MNs.IOptions): stdLib.RegExp = js.native
  /**
