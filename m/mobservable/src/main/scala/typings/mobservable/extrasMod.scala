...
object extrasMod {
  ...
  inline def getDNode(thing: js.Any): DataNode = ^.asInstanceOf[js.Dynamic].applyDynamic("getDNode")(thing.asInstanceOf[js.Any]).asInstanceOf[DataNode]
  inline def getDNode(thing: js.Any, property: String): DataNode = (^.asInstanceOf[js.Dynamic].applyDynamic("getDNode")(thing.asInstanceOf[js.Any], property.asInstanceOf[js.Any])).asInstanceOf[DataNode]
  ...
  inline def reportTransition(node: DataNode, state: String, changed: Boolean, newValue: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("reportTransition")(node.asInstanceOf[js.Any], state.asInstanceOf[js.Any], changed.asInstanceOf[js.Any], newValue.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def reportTransition(node: DataNode, state: String, changed: Unit, newValue: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("reportTransition")(node.asInstanceOf[js.Any], state.asInstanceOf[js.Any], changed.asInstanceOf[js.Any], newValue.asInstanceOf[js.Any])).asInstanceOf[Unit]
