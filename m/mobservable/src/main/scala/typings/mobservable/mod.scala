...
object mod {
  ...
  inline def extendReactive[A /* <: js.Object */, B /* <: js.Object */](target: A, properties: B*): A & B = (^.asInstanceOf[js.Dynamic].applyDynamic("extendReactive")(target.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[A & B]
  ...
  object extras {
    ...
    inline def getDNode(thing: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getDNode")(thing.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  inline def isReactive(value: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isReactive")(value.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def isReactive(value: js.Any, property: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isReactive")(value.asInstanceOf[js.Any], property.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def makeReactive(target: js.Object, key: String): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("makeReactive")(target.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  inline def makeReactive(target: js.Object, key: String, baseDescriptor: PropertyDescriptor): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("makeReactive")(target.asInstanceOf[js.Any], key.asInstanceOf[js.Any], baseDescriptor.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def makeReactive(value: Date): IObservableValue[Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("makeReactive")(value.asInstanceOf[js.Any]).asInstanceOf[IObservableValue[Date]]
  inline def makeReactive(value: RegExp): IObservableValue[RegExp] = ^.asInstanceOf[js.Dynamic].applyDynamic("makeReactive")(value.asInstanceOf[js.Any]).asInstanceOf[IObservableValue[RegExp]]
  ...
  inline def observeAsync(func: Lambda, delay: Double, scope: js.Any): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("observeAsync")(func.asInstanceOf[js.Any], delay.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Lambda]
  inline def observeAsync(func: Lambda, delay: Unit, scope: js.Any): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("observeAsync")(func.asInstanceOf[js.Any], delay.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Lambda]
  ...
  inline def observeAsync[T](view: js.Function0[T], effect: js.Function1[/* latestValue */ T, Unit], delay: Unit, scope: js.Any): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("observeAsync")(view.asInstanceOf[js.Any], effect.asInstanceOf[js.Any], delay.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Lambda]
  ...
  inline def observeUntil(predicate: js.Function0[Boolean], effect: Lambda, scope: js.Any): Lambda = (^.asInstanceOf[js.Dynamic].applyDynamic("observeUntil")(predicate.asInstanceOf[js.Any], effect.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Lambda]
