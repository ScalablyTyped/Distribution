...
object libCoreMod {
  ...
  object ValueMode extends StObject {
    ...
    sealed trait Flat
      extends StObject
         with ValueMode
    /* 3 */ val Flat: typings.mobservable.libCoreMod.ValueMode.Flat & Double = js.native
    
    @js.native
    sealed trait Recursive
      extends StObject
         with ValueMode
    /* 0 */ val Recursive: typings.mobservable.libCoreMod.ValueMode.Recursive & Double = js.native
    
    @js.native
    sealed trait Reference
      extends StObject
         with ValueMode
    /* 1 */ val Reference: typings.mobservable.libCoreMod.ValueMode.Reference & Double = js.native
    
    @js.native
    sealed trait Structure
      extends StObject
         with ValueMode
    /* 2 */ val Structure: typings.mobservable.libCoreMod.ValueMode.Structure & Double = js.native
  }
  ...
  object ValueType extends StObject {
    ...
    sealed trait Array
      extends StObject
         with ValueType
    /* 3 */ val Array: typings.mobservable.libCoreMod.ValueType.Array & Double = js.native
    
    @js.native
    sealed trait ComplexFunction
      extends StObject
         with ValueType
    /* 5 */ val ComplexFunction: typings.mobservable.libCoreMod.ValueType.ComplexFunction & Double = js.native
    
    @js.native
    sealed trait ComplexObject
      extends StObject
         with ValueType
    /* 2 */ val ComplexObject: typings.mobservable.libCoreMod.ValueType.ComplexObject & Double = js.native
    
    @js.native
    sealed trait PlainObject
      extends StObject
         with ValueType
    /* 1 */ val PlainObject: typings.mobservable.libCoreMod.ValueType.PlainObject & Double = js.native
    
    @js.native
    sealed trait Reference
      extends StObject
         with ValueType
    /* 0 */ val Reference: typings.mobservable.libCoreMod.ValueType.Reference & Double = js.native
    
    @js.native
    sealed trait ViewFunction
      extends StObject
         with ValueType
    /* 4 */ val ViewFunction: typings.mobservable.libCoreMod.ValueType.ViewFunction & Double = js.native
  }
