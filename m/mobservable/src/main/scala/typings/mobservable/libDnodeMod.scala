...
object libDnodeMod {
  ...
  object NodeState extends StObject {
    ...
    sealed trait PENDING
      extends StObject
         with NodeState
    /* 1 */ val PENDING: typings.mobservable.libDnodeMod.NodeState.PENDING & Double = js.native
    
    @js.native
    sealed trait READY
      extends StObject
         with NodeState
    /* 2 */ val READY: typings.mobservable.libDnodeMod.NodeState.READY & Double = js.native
    
    @js.native
    sealed trait STALE
      extends StObject
         with NodeState
    /* 0 */ val STALE: typings.mobservable.libDnodeMod.NodeState.STALE & Double = js.native
  }
