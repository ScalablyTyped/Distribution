...
class Suite_ protected ()
  extends typings.mocha.Mocha_.Suite_ {
  def this(title: String) = this()
  def this(title: String, parentContext: typings.mocha.Mocha_.Context) = this()
...
object Suite_ extends js.Object {
  ...
  /**
    ...
    */
  def create(parent: typings.mocha.Mocha_.Suite_, title: String): typings.mocha.Mocha_.Suite_ = js.native
}
