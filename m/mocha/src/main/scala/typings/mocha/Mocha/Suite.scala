...
class Suite protected () extends EventEmitter {
  ...
  def addListener_postrequire(
    event: `post-require`,
    listener: js.Function3[/* context */ MochaGlobals, /* file */ String, /* mocha */ typings.mocha.Mocha, Unit]
  ): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_prerequire(name: `pre-require`, context: MochaGlobals, file: String, mocha: typings.mocha.Mocha): Boolean = js.native
  @JSName("emit")
