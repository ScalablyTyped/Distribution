...
import typings.mocha.MochaNs.IContext
import typings.mocha.MochaNs.ISuite
...
class Suite protected ()
  extends typings.mocha.MochaNs.Suite {
  def this(title: String) = this()
  def this(title: String, parentContext: typings.mocha.MochaNs.Context) = this()
...
object Suite extends js.Object {
  ...
  def create(parent: ISuite, title: String): typings.mocha.MochaNs.Suite = js.native
  /**
    ...
    */
  def create(parent: typings.mocha.MochaNs.Suite, title: String): typings.mocha.MochaNs.Suite = js.native
}
