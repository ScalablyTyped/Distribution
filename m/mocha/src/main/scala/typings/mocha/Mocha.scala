...
import typings.mocha.MochaNs.MochaInstanceOptions
...
class Mocha () extends js.Object {
  ...
  def reporter(reporter: typings.mocha.MochaNs.ReporterConstructor): this.type = js.native
  def reporter(reporter: typings.mocha.MochaNs.ReporterConstructor, reporterOptions: js.Any): this.type = js.native
