...
trait TestFunction extends js.Object {
  ...
  /**
    ...
    * - _Only available when invoked via the mocha CLI._
    */
  def only(title: java.lang.String): Test = js.native
  def only(title: java.lang.String, fn: AsyncFunc): Test = js.native
  def only(title: java.lang.String, fn: Func): Test = js.native
  /**
  ...
  /**
    ...
    * - _Only available when invoked via the mocha CLI._
    */
  def skip(title: java.lang.String): Test = js.native
  def skip(title: java.lang.String, fn: AsyncFunc): Test = js.native
  def skip(title: java.lang.String, fn: Func): Test = js.native
}
