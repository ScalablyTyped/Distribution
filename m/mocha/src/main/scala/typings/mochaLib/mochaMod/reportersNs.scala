...
object reportersNs extends js.Object {
  ...
  // value-only aliases
  val base: mochaLib.Anon_Window = js.native
  val doc: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.Doc] = js.native
  val dot: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.Dot] = js.native
  val html: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.HTML] = js.native
  val json: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.JSON] = js.native
  val landing: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.Landing] = js.native
  val list: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.List] = js.native
  val markdown: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.Markdown] = js.native
  val nyan: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.Nyan] = js.native
  val spec: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.Spec] = js.native
  val tap: ScalablyTyped.runtime.Instantiable0[mochaLib.MochaNs.reportersNs.TAP] = js.native
  @JSName("Base")
  @js.native
