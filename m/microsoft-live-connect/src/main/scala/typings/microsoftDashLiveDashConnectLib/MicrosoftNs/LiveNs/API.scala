...
trait API extends js.Object {
  ...
  /**
           ...
           *   corresponding WL.api method, respectively.
           */
  def api[T](properties: IAPIProperties, callback: js.Function1[/* response */ js.Any, scala.Unit]): IPromise[T] = js.native
  /**
  ...
  /**
           ...
           *   corresponding WL.backgroudUpload method, respectively.
           */
  def backgroundUpload[T](properties: IBackgroundUploadProperties, callback: js.Function1[/* response */ js.Any, scala.Unit]): IPromise[T] = js.native
  /**
           ...
           */
  def canLogout(): scala.Boolean = js.native
  /**
           * Makes a call to download a file from Microsoft SkyDrive.
           *
           ...
           */
  def download(properties: IDownloadProperties): IPromise[scala.Unit] = js.native
  /**
           * Makes a call to download a file from Microsoft SkyDrive.
           *
           * **Important**: WL.download is supported only for use with web apps.
           ...
           *   to the corresponding WL.download method.
           */
  def download(properties: IDownloadProperties, callback: js.Function1[/* response */ js.Any, scala.Unit]): IPromise[scala.Unit] = js.native
  /**
  ...
  /**
           ...
           *   method, respectively.
           */
  def fileDialog(properties: IFileDialogProperties, callback: js.Function1[/* response */ js.Any, scala.Unit]): IPromise[IFilePickerResult] = js.native
  /**
  ...
  /**
           ...
           *   which contains the user's sign-in status and the session object.
           */
  def getLoginStatus(callback: js.Function1[/* status */ ILoginStatus, scala.Unit]): IPromise[ILoginStatus] = js.native
  /**
           * Returns the sign-in status of the current user. If the user is signed
           * in and connected to your app, this function returns the session
           * object. This is an asynchronous function that returns the user's
           ...
           *   which contains the user's sign-in status and the session object.
           */
  def getLoginStatus(callback: js.Function1[/* status */ ILoginStatus, scala.Unit], force: scala.Boolean): IPromise[ILoginStatus] = js.native
  /**
  ...
  /**
           ...
           *   corresponding WL.login method, respectively.
           */
  def login(properties: ILoginProperties, callback: js.Function1[/* status */ js.Any, scala.Unit]): IPromise[ILoginStatus] = js.native
  /**
  ...
  /**
           ...
           *   corresponding WL.logout method, respectively.
           */
  def logout(callback: js.Function1[/* status */ ILoginStatus, scala.Unit]): IPromise[ILoginStatus] = js.native
  /**
           ...
           */
  def ui(properties: IUIProperties): scala.Unit = js.native
  /**
           * Displays either the Live Connect sign-in button or the Microsoft
           * SkyDrive file picker button. The sign-in button either prompts the
           * user for his or her Microsoft account credentials if he or she is not
           ...
           *   properties as previously described.
           */
  def ui(properties: IUIProperties, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Makes a call to upload a file to Microsoft SkyDrive.
           *
  ...
  /**
           ...
           *   Explorer 10 only.
           */
  def upload[T](properties: IUploadProperties, callback: js.Function1[/* response */ js.Any, scala.Unit]): IPromise[T] = js.native
}
