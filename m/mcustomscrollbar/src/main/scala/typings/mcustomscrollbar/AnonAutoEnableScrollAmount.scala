...
trait AnonAutoEnableScrollAmount extends js.Object {
  /**
...
object AnonAutoEnableScrollAmount {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAutoEnableScrollAmount]
  }
}
