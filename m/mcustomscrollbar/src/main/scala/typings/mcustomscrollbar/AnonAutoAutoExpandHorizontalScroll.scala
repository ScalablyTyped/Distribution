...
trait AnonAutoAutoExpandHorizontalScroll extends js.Object {
  /**
...
object AnonAutoAutoExpandHorizontalScroll {
  @scala.inline
  def apply(
  ...
  ): AnonAutoAutoExpandHorizontalScroll = {
    ...
    __obj.asInstanceOf[AnonAutoAutoExpandHorizontalScroll]
  }
}
