...
object AutoExpandHorizontalScroll {
  ...
  def apply(
    ...
    autoUpdateTimeout: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(autoExpandHorizontalScroll)) __obj.updateDynamic("autoExpandHorizontalScroll")(autoExpandHorizontalScroll.get.asInstanceOf[js.Any])
    if (autoScrollOnFocus != null) __obj.updateDynamic("autoScrollOnFocus")(autoScrollOnFocus.asInstanceOf[js.Any])
    if (!js.isUndefined(autoUpdateTimeout)) __obj.updateDynamic("autoUpdateTimeout")(autoUpdateTimeout.get.asInstanceOf[js.Any])
    if (extraDraggableSelectors != null) __obj.updateDynamic("extraDraggableSelectors")(extraDraggableSelectors.asInstanceOf[js.Any])
    if (!js.isUndefined(normalizeMouseWheelDelta)) __obj.updateDynamic("normalizeMouseWheelDelta")(normalizeMouseWheelDelta.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(updateOnBrowserResize)) __obj.updateDynamic("updateOnBrowserResize")(updateOnBrowserResize.get.asInstanceOf[js.Any])
    if (!js.isUndefined(updateOnContentResize)) __obj.updateDynamic("updateOnContentResize")(updateOnContentResize.get.asInstanceOf[js.Any])
