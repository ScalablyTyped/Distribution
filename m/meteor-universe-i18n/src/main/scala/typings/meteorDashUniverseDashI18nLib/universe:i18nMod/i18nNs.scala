...
object i18nNs extends js.Object {
  ...
  def `__`(
    ...
    params: meteorDashUniverseDashI18nLib.`universe:i18nMod`.GetTranslationParams
  ...
  ): meteorDashUniverseDashI18nLib.`universe:i18nMod`.Translator = js.native
  ...
  def loadLocale(
    locale: java.lang.String,
    params: meteorDashUniverseDashI18nLib.`universe:i18nMod`.LoadLocaleParams
  ): scala.Unit = js.native
  // events
  ...
  // options setter
  def setOptions(options: meteorDashUniverseDashI18nLib.`universe:i18nMod`.i18nOptions): scala.Unit = js.native
}
