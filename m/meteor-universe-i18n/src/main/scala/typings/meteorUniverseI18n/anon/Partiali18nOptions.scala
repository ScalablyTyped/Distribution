...
object Partiali18nOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(hideMissing)) __obj.updateDynamic("hideMissing")(hideMissing.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(sameLocaleOnServerConnection)) __obj.updateDynamic("sameLocaleOnServerConnection")(sameLocaleOnServerConnection.get.asInstanceOf[js.Any])
