...
trait BundleDetails
  ...
  var bundleDetails: typings.metro.libReportingMod.BundleDetails
  
  var `type`: bundle_build_started
}
object BundleDetails {
  
  inline def apply(buildID: String, bundleDetails: typings.metro.libReportingMod.BundleDetails): BundleDetails = {
  ...
  extension [Self <: BundleDetails](x: Self) {
    ...
    inline def setBundleDetails(value: typings.metro.libReportingMod.BundleDetails): Self = StObject.set(x, "bundleDetails", value.asInstanceOf[js.Any])
