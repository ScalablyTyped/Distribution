...
object global {
  ...
  object gapi {
    ...
    object client {
      ...
      inline def load(name: doubleclickbidmanager, version: v2): js.Thenable[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(name.asInstanceOf[js.Any], version.asInstanceOf[js.Any])).asInstanceOf[js.Thenable[Unit]]
