package typings.maximMazurokGapiClientDoubleclickbidmanager.anon
...
object PrettyPrint {
  ...
  implicit class PrettyPrintOps[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RunQueryRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
