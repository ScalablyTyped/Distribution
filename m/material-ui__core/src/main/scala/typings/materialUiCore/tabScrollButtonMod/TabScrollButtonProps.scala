...
import typings.materialUiCore.anon.PartialClassNameMapTabScr
...
object TabScrollButtonProps {
  ...
  @scala.inline
  def apply(): TabScrollButtonProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TabScrollButtonProps]
  }
  
  @scala.inline
  implicit class TabScrollButtonPropsOps[Self <: TabScrollButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTabScr): Self = this.set("classes", value.asInstanceOf[js.Any])
