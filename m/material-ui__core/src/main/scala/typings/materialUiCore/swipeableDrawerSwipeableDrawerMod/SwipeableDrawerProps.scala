package typings.materialUiCore.swipeableDrawerSwipeableDrawerMod
...
object SwipeableDrawerProps {
  ...
  implicit class SwipeableDrawerPropsOps[Self <: SwipeableDrawerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnOpen(value: SyntheticEvent[js.Object, Event] => Unit): Self = this.set("onOpen", js.Any.fromFunction1(value))
    @scala.inline
