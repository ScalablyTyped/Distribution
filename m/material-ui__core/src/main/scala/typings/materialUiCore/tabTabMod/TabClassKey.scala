...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.materialUiCore.materialUiCoreStrings.labelContainer
  - typings.materialUiCore.materialUiCoreStrings.label
  - typings.materialUiCore.materialUiCoreStrings.labelWrapped
*/
trait TabClassKey extends js.Object
object TabClassKey {
