...
import typings.materialUiCore.anon.PartialClassNameMapBadgeC
...
object BadgeProps {
  ...
  implicit class BadgePropsOps[Self <: BadgeProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapBadgeC): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    @scala.inline
    def setColor(value: Color | error): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteColor: Self = this.set("color", js.undefined)
    @scala.inline
    def setComponent(value: ReactType[BadgeProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setVariant(value: standard | dot): Self = this.set("variant", value.asInstanceOf[js.Any])
    @scala.inline
