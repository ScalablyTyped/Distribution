...
object tabScrollButtonMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[TabScrollButtonProps] = js.native
  ...
  object TabScrollButtonProps {
    ...
    inline def apply(): TabScrollButtonProps = {
  ...
  type _To = ComponentType[TabScrollButtonProps]
  
  /* This means you don't have to write `default`, but can instead just say `tabScrollButtonMod.foo` */
  override def _to: ComponentType[TabScrollButtonProps] = default
}
