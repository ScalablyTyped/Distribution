...
object LinkProps {
  ...
  implicit class LinkPropsOps[Self <: LinkProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypographyClasses(value: PartialClassNameMapTypogr): Self = this.set("TypographyClasses", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTypographyClasses: Self = this.set("TypographyClasses", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapLinkCl): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponent(value: ReactType[LinkProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setUnderline(value: none | hover | always): Self = this.set("underline", value.asInstanceOf[js.Any])
    @scala.inline
