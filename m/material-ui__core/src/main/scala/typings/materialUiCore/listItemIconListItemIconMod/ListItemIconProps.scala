...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/ListItemIcon/ListItemIcon.ListItemIconClassKey, never> */
@js.native
...
object ListItemIconProps {
  @scala.inline
  def apply(children: ReactElement): ListItemIconProps = {
