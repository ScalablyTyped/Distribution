...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/BottomNavigation.BottomNavigationProps> */
@js.native
trait PartialBottomNavigationProps extends js.Object {
...
object PartialBottomNavigationProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    __obj.asInstanceOf[PartialBottomNavigationProps]
  }
}
