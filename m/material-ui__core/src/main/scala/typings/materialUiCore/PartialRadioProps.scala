...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Radio.RadioProps> */
@js.native
trait PartialRadioProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapRadioClassKey] = js.native
...
object PartialRadioProps {
  ...
  def apply(
    ...
    classes: PartialClassNameMapRadioClassKey = null,
