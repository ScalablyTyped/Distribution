...
import typings.materialUiCore.anon.PartialClassNameMapCardMe
...
object cardMediaCardMediaMod extends Shortcut {
  ...
  */
  ...
  object CardMediaClassKey {
    ...
    @scala.inline
    def media: typings.materialUiCore.materialUiCoreStrings.media = "media".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.media]
  ...
  trait CardMediaProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapCardMe] = js.undefined
  ...
  object CardMediaProps {
    ...
    implicit class CardMediaPropsMutableBuilder[Self <: CardMediaProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapCardMe): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[CardMediaProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
