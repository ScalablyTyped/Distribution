...
object tableFooterTableFooterMod extends Shortcut {
  ...
  object TableFooterProps {
    ...
    implicit class TableFooterPropsMutableBuilder[Self <: TableFooterProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapTableF): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[TableFooterBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
