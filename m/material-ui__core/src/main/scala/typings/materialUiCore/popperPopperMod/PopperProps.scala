...
import typings.materialUiCore.AnonPlacement
...
trait PopperProps extends HTMLAttributes[HTMLDivElement] {
  ...
  @JSName("children")
  var children_PopperProps: ReactNode | (js.Function1[/* props */ AnonPlacement, ReactNode]) = js.native
...
object PopperProps {
  ...
  def apply(
    ...
    children: ReactNode | (js.Function1[/* props */ AnonPlacement, ReactNode]) = null,
