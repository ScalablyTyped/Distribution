package typings.materialUiCore.toolbarToolbarMod
...
object ToolbarProps {
  ...
  implicit class ToolbarPropsOps[Self <: ToolbarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapToolba): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setVariant(value: regular | dense): Self = this.set("variant", value.asInstanceOf[js.Any])
    @scala.inline
