...
object circularProgressCircularProgressMod extends Shortcut {
  ...
  @JSImport("@material-ui/core/CircularProgress/CircularProgress", JSImport.Default)
  @js.native
  val default: ComponentType[CircularProgressProps] = js.native
  ...
  */
  ...
  object CircularProgressClassKey {
    ...
    @scala.inline
    def circle: typings.materialUiCore.materialUiCoreStrings.circle = "circle".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.circle]
    
    @scala.inline
    def circleDisableShrink: typings.materialUiCore.materialUiCoreStrings.circleDisableShrink = "circleDisableShrink".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.circleDisableShrink]
    
    @scala.inline
    def circleIndeterminate: typings.materialUiCore.materialUiCoreStrings.circleIndeterminate = "circleIndeterminate".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.circleIndeterminate]
    
    @scala.inline
    def circleStatic: typings.materialUiCore.materialUiCoreStrings.circleStatic = "circleStatic".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.circleStatic]
    ...
    @scala.inline
    def static: typings.materialUiCore.materialUiCoreStrings.static = "static".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.static]
    
    @scala.inline
    def svg: typings.materialUiCore.materialUiCoreStrings.svg = "svg".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.svg]
  }
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/CircularProgress/CircularProgress.CircularProgressClassKey, never> */
  @js.native
  trait CircularProgressProps extends StObject {
    ...
    var variant: js.UndefOr[determinate | indeterminate | static] = js.native
  ...
  object CircularProgressProps {
    ...
    implicit class CircularProgressPropsMutableBuilder[Self <: CircularProgressProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapCircul): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      @scala.inline
      def setColor(value: primary | secondary | inherit): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVariant(value: determinate | indeterminate | static): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
