...
import typings.materialUiCore.anon.PartialClassNameMapInputA
...
object InputAdornmentProps {
  @scala.inline
  def apply(position: start | end): InputAdornmentProps = {
    val __obj = js.Dynamic.literal(position = position.asInstanceOf[js.Any])
    __obj.asInstanceOf[InputAdornmentProps]
  }
  @scala.inline
  implicit class InputAdornmentPropsOps[Self <: InputAdornmentProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapInputA): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponent(value: ReactType[InputAdornmentProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
