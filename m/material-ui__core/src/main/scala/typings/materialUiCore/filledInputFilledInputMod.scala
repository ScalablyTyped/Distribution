...
object filledInputFilledInputMod extends Shortcut {
  ...
  */
  ...
  object FilledInputClassKey {
    ...
    @scala.inline
    def underline: typings.materialUiCore.materialUiCoreStrings.underline = "underline".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.underline]
  }
  ...
  trait FilledInputProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapFilled] = js.native
  ...
  object FilledInputProps {
    ...
    @scala.inline
    def apply(): FilledInputProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FilledInputProps]
    }
    
    @scala.inline
    implicit class FilledInputPropsMutableBuilder[Self <: FilledInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapFilled): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
