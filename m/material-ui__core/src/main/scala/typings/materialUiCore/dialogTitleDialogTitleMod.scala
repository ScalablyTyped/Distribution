...
import typings.materialUiCore.anon.PartialClassNameMapDialog0
...
object dialogTitleDialogTitleMod {
  
  @JSImport("@material-ui/core/DialogTitle/DialogTitle", JSImport.Namespace)
  @js.native
  ...
  trait DialogTitleProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapDialog0] = js.undefined
  ...
  object DialogTitleProps {
    ...
    extension [Self <: DialogTitleProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapDialog0): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
