...
import typings.materialUiCore.anon.PartialClassNameMapDialogRoot
...
object dialogTitleDialogTitleMod extends Shortcut {
  ...
  @JSImport("@material-ui/core/DialogTitle/DialogTitle", JSImport.Default)
  @js.native
  val default: ComponentType[DialogTitleProps] = js.native
  
  type DialogTitleClassKey = root
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/DialogTitle/DialogTitle.DialogTitleClassKey, never> */
  trait DialogTitleProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapDialogRoot] = js.undefined
  ...
  object DialogTitleProps {
    ...
    implicit class DialogTitlePropsMutableBuilder[Self <: DialogTitleProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapDialogRoot): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
