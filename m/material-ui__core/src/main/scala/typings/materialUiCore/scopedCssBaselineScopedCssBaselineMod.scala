...
import typings.materialUiCore.anon.PartialClassNameMapScoped
...
object scopedCssBaselineScopedCssBaselineMod {
  
  @JSImport("@material-ui/core/ScopedCssBaseline/ScopedCssBaseline", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(props: ScopedCssBaselineProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  type ScopedCssBaselineClassKey = root
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/ScopedCssBaseline/ScopedCssBaseline.ScopedCssBaselineClassKey, never> */
  trait ScopedCssBaselineProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapScoped] = js.undefined
  ...
  object ScopedCssBaselineProps {
    
    inline def apply(): ScopedCssBaselineProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ScopedCssBaselineProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ScopedCssBaselineProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialClassNameMapScoped): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
