...
object radioGroupRadioGroupMod extends Shortcut {
  ...
  object RadioGroupProps {
    ...
    extension [Self <: RadioGroupProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapRadioG): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* value */ String) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
