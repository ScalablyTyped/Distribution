...
import typings.materialUiCore.anon.PartialClassNameMapRadioG
...
object radioGroupRadioGroupMod extends Shortcut {
  ...
  @JSImport("@material-ui/core/RadioGroup/RadioGroup", JSImport.Default)
  @js.native
  ...
  trait RadioGroupProps extends StObject {
    ...
    var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[js.Object], /* value */ String, Unit]] = js.native
  ...
  object RadioGroupProps {
    ...
    implicit class RadioGroupPropsMutableBuilder[Self <: RadioGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapRadioG): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* value */ String) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
