...
object TableBodyProps {
  ...
  implicit class TableBodyPropsOps[Self <: TableBodyProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTableB): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponent(value: ReactType[TableBodyBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
