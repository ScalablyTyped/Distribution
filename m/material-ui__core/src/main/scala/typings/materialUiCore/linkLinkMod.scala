  ...
  */
  ...
  object LinkProps {
    ...
    extension [Self <: LinkProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapLinkCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponent(value: ReactType[LinkProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setTypographyClasses(value: PartialClassNameMapTypogr): Self = StObject.set(x, "TypographyClasses", value.asInstanceOf[js.Any])
