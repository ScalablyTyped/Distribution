...
object InputLabelProps {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onEmptied: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onEnded: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onError: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    ...
    onPause: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onPlay: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onPlaying: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    ...
    onStalled: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onSubmit: FormEvent[HTMLLabelElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLLabelElement, Event_] => Unit = null,
