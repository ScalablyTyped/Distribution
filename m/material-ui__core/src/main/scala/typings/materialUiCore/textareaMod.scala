...
object textareaMod extends Shortcut {
  ...
  */
  ...
  trait TextareaProps extends StObject {
    ...
    var textareaRef: js.UndefOr[Ref[_] | RefObject[_]] = js.native
  ...
  object TextareaProps {
    ...
    implicit class TextareaPropsMutableBuilder[Self <: TextareaProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTextareaRef(value: Ref[_] | RefObject[_]): Self = StObject.set(x, "textareaRef", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTextareaRefFunction1(value: /* instance */ _ | Null => Unit): Self = StObject.set(x, "textareaRef", js.Any.fromFunction1(value))
