  ...
  */
  ...
  object TextareaProps {
    ...
    implicit class TextareaPropsMutableBuilder[Self <: TextareaProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapTextar): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTextareaRef(value: Ref[js.Any] | RefObject[js.Any]): Self = StObject.set(x, "textareaRef", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTextareaRefFunction1(value: /* instance */ js.Any | Null => Unit): Self = StObject.set(x, "textareaRef", js.Any.fromFunction1(value))
      
      @scala.inline
      def setTextareaRefNull: Self = StObject.set(x, "textareaRef", null)
      
      @scala.inline
      def setTextareaRefUndefined: Self = StObject.set(x, "textareaRef", js.undefined)
