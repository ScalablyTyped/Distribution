...
import typings.materialUiCore.anon.PartialClassNameMapTextar
...
object textareaMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[TextareaProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.materialUiCore.materialUiCoreStrings.root
    - typings.materialUiCore.materialUiCoreStrings.shadow
    - typings.materialUiCore.materialUiCoreStrings.textarea
  */
  trait TextareaClassKey extends StObject
  object TextareaClassKey {
    
    inline def root: typings.materialUiCore.materialUiCoreStrings.root = "root".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.root]
    
    inline def shadow: typings.materialUiCore.materialUiCoreStrings.shadow = "shadow".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.shadow]
    
    inline def textarea: typings.materialUiCore.materialUiCoreStrings.textarea = "textarea".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.textarea]
  }
  ...
  trait TextareaProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapTextar] = js.undefined
    ...
    var textareaRef: js.UndefOr[Ref[js.Any] | RefObject[js.Any]] = js.undefined
  ...
  object TextareaProps {
    ...
    extension [Self <: TextareaProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapTextar): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setTextareaRef(value: Ref[js.Any] | RefObject[js.Any]): Self = StObject.set(x, "textareaRef", value.asInstanceOf[js.Any])
      
      inline def setTextareaRefFunction1(value: /* instance */ js.Any | Null => Unit): Self = StObject.set(x, "textareaRef", js.Any.fromFunction1(value))
      
      inline def setTextareaRefNull: Self = StObject.set(x, "textareaRef", null)
      
      inline def setTextareaRefUndefined: Self = StObject.set(x, "textareaRef", js.undefined)
  ...
  type _To = ComponentType[TextareaProps]
  
  /* This means you don't have to write `default`, but can instead just say `textareaMod.foo` */
  override def _to: ComponentType[TextareaProps] = default
}
