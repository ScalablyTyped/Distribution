  ...
  */
  ...
  object ButtonProps {
    ...
    implicit class ButtonPropsMutableBuilder[Self <: ButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapButton): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[ButtonProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVariant(value: text | flat | outlined | contained | raised | fab | extendedFab): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
