...
import typings.materialUiCore.anon.PartialClassNameMapExpansAction
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/ExpansionPanelActions/ExpansionPanelActions.ExpansionPanelActionsClassKey, never> */
@js.native
trait ExpansionPanelActionsProps extends js.Object {
...
object ExpansionPanelActionsProps {
  
  @scala.inline
  def apply(): ExpansionPanelActionsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExpansionPanelActionsProps]
  }
  
  @scala.inline
  implicit class ExpansionPanelActionsPropsOps[Self <: ExpansionPanelActionsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapExpansAction): Self = this.set("classes", value.asInstanceOf[js.Any])
