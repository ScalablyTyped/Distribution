...
object gridListTileGridListTileMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[GridListTileProps] = js.native
  ...
  */
  ...
  trait GridListTileProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapGridLiImgFullHeight] = js.undefined
  ...
  object GridListTileProps {
    ...
    inline def apply(): GridListTileProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[GridListTileProps]
    }
    
    extension [Self <: GridListTileProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapGridLiImgFullHeight): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponent(value: ReactType[GridListTileProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
