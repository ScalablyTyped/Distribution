...
object stepContentStepContentMod extends Shortcut {
  ...
  */
  ...
  object StepContentClasskey {
    ...
    inline def last: typings.materialUiCore.materialUiCoreStrings.last = "last".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.last]
    
    inline def root: typings.materialUiCore.materialUiCoreStrings.root = "root".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.root]
    
    inline def transition: typings.materialUiCore.materialUiCoreStrings.transition = "transition".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.transition]
  }
  ...
  object StepContentProps {
    ...
    extension [Self <: StepContentProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapStepCoLast): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
