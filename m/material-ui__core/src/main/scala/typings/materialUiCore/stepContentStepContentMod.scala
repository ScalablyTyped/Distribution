...
import typings.materialUiCore.anon.PartialClassNameMapStepCoLast
...
object stepContentStepContentMod extends Shortcut {
  
  @JSImport("@material-ui/core/StepContent/StepContent", JSImport.Default)
  @js.native
  val default: ComponentType[StepContentProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.materialUiCore.materialUiCoreStrings.root
    - typings.materialUiCore.materialUiCoreStrings.last
    - typings.materialUiCore.materialUiCoreStrings.transition
  */
  trait StepContentClasskey extends StObject
  object StepContentClasskey {
    
    @scala.inline
    def last: typings.materialUiCore.materialUiCoreStrings.last = "last".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.last]
    ...
    @scala.inline
    def transition: typings.materialUiCore.materialUiCoreStrings.transition = "transition".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.transition]
  }
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/StepContent/StepContent.StepContentClasskey, never> */
  @js.native
  ...
  object StepContentProps {
    ...
    implicit class StepContentPropsMutableBuilder[Self <: StepContentProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAlternativeLabel(value: Boolean): Self = StObject.set(x, "alternativeLabel", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapStepCoLast): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
  ...
  type _To = ComponentType[StepContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `stepContentStepContentMod.foo` */
  override def _to: ComponentType[StepContentProps] = default
}
