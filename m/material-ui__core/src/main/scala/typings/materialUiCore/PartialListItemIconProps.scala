...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/ListItemIcon.ListItemIconProps> */
@js.native
trait PartialListItemIconProps extends js.Object {
...
object PartialListItemIconProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    __obj.asInstanceOf[PartialListItemIconProps]
  }
}
