package typings.materialUiCore.expansionPanelDetailsExpansionPanelDetailsMod
...
object ExpansionPanelDetailsProps {
  ...
  @scala.inline
  implicit class ExpansionPanelDetailsPropsOps[Self <: ExpansionPanelDetailsProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapExpansRoot): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
