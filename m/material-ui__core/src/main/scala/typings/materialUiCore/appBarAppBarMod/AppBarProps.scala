...
import typings.materialUiCore.anon.PartialClassNameMapAppBar
import typings.materialUiCore.materialUiCoreStrings.`additions text`
import typings.materialUiCore.materialUiCoreStrings.`inline`
import typings.materialUiCore.materialUiCoreStrings.absolute
...
import typings.materialUiCore.materialUiCoreStrings.relative
...
import typings.materialUiCore.materialUiCoreStrings.sticky
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/Paper.PaperProps, @material-ui/core.@material-ui/core/AppBar/AppBar.AppBarClassKey, never> */
@js.native
trait AppBarProps extends js.Object {
  ...
  var position: js.UndefOr[fixed | absolute | sticky | static | relative] = js.native
...
object AppBarProps {
  ...
  implicit class AppBarPropsOps[Self <: AppBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapAppBar): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponent(value: ReactType[PaperProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPosition(value: fixed | absolute | sticky | static | relative): Self = this.set("position", value.asInstanceOf[js.Any])
    @scala.inline
