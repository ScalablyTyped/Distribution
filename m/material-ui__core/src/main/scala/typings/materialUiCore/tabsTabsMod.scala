...
import typings.materialUiCore.anon.PartialClassNameMapTabsCl
import typings.materialUiCore.anon.PartialTabIndicatorProps
...
object tabsTabsMod extends Shortcut {
  ...
  object TabsActions {
    ...
    inline def apply(updateIndicator: () => Unit): TabsActions = {
  ...
  */
  ...
  object TabsClassKey {
    ...
    inline def scrollButtonsAuto: typings.materialUiCore.materialUiCoreStrings.scrollButtonsAuto = "scrollButtonsAuto".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.scrollButtonsAuto]
  ...
  object TabsProps {
    ...
    inline def apply(value: js.Any): TabsProps = {
