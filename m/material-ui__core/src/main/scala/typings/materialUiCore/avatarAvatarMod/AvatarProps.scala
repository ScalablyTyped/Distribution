...
object AvatarProps {
  ...
  implicit class AvatarPropsOps[Self <: AvatarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponent(value: ReactType[AvatarProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setImgProps(value: HtmlHTMLAttributes[HTMLImageElement]): Self = this.set("imgProps", value.asInstanceOf[js.Any])
    @scala.inline
