...
object textareaAutosizeTextareaAutosizeMod {
  ...
  object TextareaAutosizeProps {
    ...
    implicit open class MutableBuilder[Self <: TextareaAutosizeProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnBlur(value: FocusEvent[HTMLTextAreaElement, typings.std.Element] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnFocus(value: FocusEvent[HTMLTextAreaElement, typings.std.Element] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
