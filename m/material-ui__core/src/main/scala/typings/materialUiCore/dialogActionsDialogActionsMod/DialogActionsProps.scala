...
object DialogActionsProps {
  ...
  def apply(
    ...
    classes: PartialClassNameMapDialogAction = null,
    color: String = null,
    ...
    if (!js.isUndefined(disableActionSpacing)) __obj.updateDynamic("disableActionSpacing")(disableActionSpacing.get.asInstanceOf[js.Any])
