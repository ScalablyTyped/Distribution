...
import typings.materialUiCore.PartialClassNameMapDialogActionsClassKey
...
trait DialogActionsProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapDialogActionsClassKey] = js.native
...
object DialogActionsProps {
  ...
  def apply(
    ...
    classes: PartialClassNameMapDialogActionsClassKey = null,
    color: String = null,
    ...
    if (!js.isUndefined(disableActionSpacing)) __obj.updateDynamic("disableActionSpacing")(disableActionSpacing.asInstanceOf[js.Any])
