package typings.materialUiCore.dialogActionsDialogActionsMod

import typings.materialUiCore.anon.PartialClassNameMapDialogAction
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/DialogActions/DialogActions.DialogActionsClassKey, never> */
@js.native
trait DialogActionsProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapDialogAction] = js.native
...
object DialogActionsProps {
  ...
  implicit class DialogActionsPropsOps[Self <: DialogActionsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapDialogAction): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDisableActionSpacing(value: Boolean): Self = this.set("disableActionSpacing", value.asInstanceOf[js.Any])
