...
object expansionPanelActionsExpansionPanelActionsMod {
  
  @JSImport("@material-ui/core/ExpansionPanelActions/ExpansionPanelActions", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(props: ExpansionPanelActionsProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  /* Rewritten from type alias, can be one of: 
    - typings.materialUiCore.materialUiCoreStrings.root
    - typings.materialUiCore.materialUiCoreStrings.spacing
  */
  trait ExpansionPanelActionsClassKey extends StObject
  ...
  trait ExpansionPanelActionsProps extends StObject {
  ...
  object ExpansionPanelActionsProps {
    ...
    inline def apply(): ExpansionPanelActionsProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ExpansionPanelActionsProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ExpansionPanelActionsProps] (val x: Self) extends AnyVal {
