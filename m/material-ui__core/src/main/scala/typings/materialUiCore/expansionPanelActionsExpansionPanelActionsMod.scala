...
object expansionPanelActionsExpansionPanelActionsMod extends Shortcut {
  
  @JSImport("@material-ui/core/ExpansionPanelActions/ExpansionPanelActions", JSImport.Default)
  @js.native
  ...
  */
  ...
  trait ExpansionPanelActionsProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapExpansAction] = js.undefined
  ...
  object ExpansionPanelActionsProps {
    ...
    extension [Self <: ExpansionPanelActionsProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapExpansAction): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `default`, but can instead just say `expansionPanelActionsExpansionPanelActionsMod.foo` */
