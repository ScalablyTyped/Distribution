...
import typings.materialUiCore.anon.`13`
...
import typings.materialUiCore.materialUiCoreStrings.theme
  ...
  type ComponentCreator[Component /* <: ElementType[Any] */] = js.Function2[
    ...
    ComponentType[
      (Omit[
        ...
        classes | className
      ]) & StyledComponentProps[root] & `12` & (js.Object | ((Omit[js.Object, theme]) & `13`[Any]))
    ]
  ]
