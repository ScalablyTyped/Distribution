  ...
  */
  ...
  trait StepLabelProps extends StObject {
    ...
    /**
      ...
      */
    var StepIconComponent: js.UndefOr[ElementType[Any]] = js.undefined
  ...
  object StepLabelProps {
    ...
    extension [Self <: StepLabelProps](x: Self) {
      ...
      inline def setStepIconComponent(value: ElementType[Any]): Self = StObject.set(x, "StepIconComponent", value.asInstanceOf[js.Any])
