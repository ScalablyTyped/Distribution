...
trait CSSProperties
  extends StandardLonghandProperties[Double | String, String with js.Object]
     ...
     with VendorLonghandProperties[Double | String, String with js.Object]
     with VendorShorthandProperties[Double | String, String with js.Object]
     with ObsoleteProperties[Double | String, String with js.Object]
     with // Allow pseudo selectors and media queries
/* k */ StringDictionary[
      js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 526 */ js.Any
      ]
    ] {
