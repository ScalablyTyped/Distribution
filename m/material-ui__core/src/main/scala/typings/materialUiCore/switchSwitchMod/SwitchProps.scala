package typings.materialUiCore.switchSwitchMod

import typings.materialUiCore.anon.PartialClassNameMapSwitch
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/internal/SwitchBase.SwitchBaseProps, @material-ui/core.@material-ui/core/Switch/Switch.SwitchClassKey, 'checkedIcon' | 'color' | 'icon'> */
@js.native
...
object SwitchProps {
  ...
  implicit class SwitchPropsOps[Self <: SwitchProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: primary | secondary | typings.materialUiCore.materialUiCoreStrings.default): Self = this.set("color", value.asInstanceOf[js.Any])
