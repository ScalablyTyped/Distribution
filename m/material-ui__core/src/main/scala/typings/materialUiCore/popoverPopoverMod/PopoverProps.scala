...
object PopoverProps {
  ...
  def apply(
    ...
    anchorEl: js.UndefOr[Null | HTMLElement | (js.Function1[/* element */ HTMLElement, HTMLElement])] = js.undefined,
    ...
    getContentAnchorEl: js.UndefOr[Null | (/* element */ HTMLElement => HTMLElement)] = js.undefined,
    ...
    if (!js.isUndefined(getContentAnchorEl)) __obj.updateDynamic("getContentAnchorEl")(if (getContentAnchorEl != null) js.Any.fromFunction1(getContentAnchorEl.asInstanceOf[/* element */ HTMLElement => HTMLElement]) else null)
