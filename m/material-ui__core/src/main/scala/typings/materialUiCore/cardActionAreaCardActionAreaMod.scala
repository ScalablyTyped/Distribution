...
import typings.materialUiCore.anon.PartialClassNameMapCardAc
...
object cardActionAreaCardActionAreaMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[CardActionAreaProps] = js.native
  ...
  */
  ...
  object CardActionAreaClassKey {
    ...
    @scala.inline
    def focusHighlight: typings.materialUiCore.materialUiCoreStrings.focusHighlight = "focusHighlight".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.focusHighlight]
  ...
  trait CardActionAreaProps extends StObject {
  ...
  object CardActionAreaProps {
    ...
    @scala.inline
    implicit class CardActionAreaPropsMutableBuilder[Self <: CardActionAreaProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapCardAc): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
