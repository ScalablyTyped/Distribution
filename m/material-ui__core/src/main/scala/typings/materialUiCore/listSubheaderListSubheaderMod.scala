...
import typings.materialUiCore.anon.PartialClassNameMapListSu
...
object listSubheaderListSubheaderMod extends Shortcut {
  ...
  */
  ...
  trait ListSubheaderProps extends StObject {
    ...
    var color: js.UndefOr[typings.materialUiCore.materialUiCoreStrings.default | primary | inherit] = js.undefined
  ...
  object ListSubheaderProps {
    ...
    extension [Self <: ListSubheaderProps](x: Self) {
      ...
      inline def setColor(value: typings.materialUiCore.materialUiCoreStrings.default | primary | inherit): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
