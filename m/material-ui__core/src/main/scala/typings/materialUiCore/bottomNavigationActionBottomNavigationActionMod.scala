...
import typings.materialUiCore.anon.PartialClassNameMapBottomIconOnly
...
object bottomNavigationActionBottomNavigationActionMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[BottomNavigationActionProps] = js.native
  ...
  */
  ...
  @js.native
  trait BottomNavigationActionProps extends StObject {
  ...
  object BottomNavigationActionProps {
    ...
    @scala.inline
    def apply(): BottomNavigationActionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[BottomNavigationActionProps]
    }
    
    @scala.inline
    implicit class BottomNavigationActionPropsMutableBuilder[Self <: BottomNavigationActionProps] (val x: Self) extends AnyVal {
