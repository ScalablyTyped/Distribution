  ...
  */
  ...
  object AvatarProps {
    ...
    extension [Self <: AvatarProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapAvatar): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponent(value: ReactType[AvatarProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setImgProps(value: HtmlHTMLAttributes[HTMLImageElement]): Self = StObject.set(x, "imgProps", value.asInstanceOf[js.Any])
