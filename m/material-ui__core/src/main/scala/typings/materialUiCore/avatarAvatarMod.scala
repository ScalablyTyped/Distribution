...
import typings.materialUiCore.anon.PartialClassNameMapAvatar
...
object avatarAvatarMod extends Shortcut {
  ...
  */
  ...
  object AvatarClassKey {
    ...
    @scala.inline
    def colorDefault: typings.materialUiCore.materialUiCoreStrings.colorDefault = "colorDefault".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.colorDefault]
    
    @scala.inline
    def img: typings.materialUiCore.materialUiCoreStrings.img = "img".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.img]
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/Avatar/Avatar.AvatarClassKey, never> */
  trait AvatarProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapAvatar] = js.undefined
    
    var color: js.UndefOr[String] = js.undefined
    
    var component: js.UndefOr[ReactType[AvatarProps]] = js.undefined
    ...
    var imgProps: js.UndefOr[HtmlHTMLAttributes[HTMLImageElement]] = js.undefined
  ...
  object AvatarProps {
    ...
    implicit class AvatarPropsMutableBuilder[Self <: AvatarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapAvatar): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[AvatarProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setImgProps(value: HtmlHTMLAttributes[HTMLImageElement]): Self = StObject.set(x, "imgProps", value.asInstanceOf[js.Any])
