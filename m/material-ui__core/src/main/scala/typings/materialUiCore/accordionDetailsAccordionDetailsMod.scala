...
import typings.materialUiCore.anon.PartialClassNameMapAccord0
...
object accordionDetailsAccordionDetailsMod {
  ...
  @JSImport("@material-ui/core/AccordionDetails/AccordionDetails", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/AccordionDetails/AccordionDetails.AccordionDetailsClassKey, never> */
  trait AccordionDetailsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapAccord0] = js.undefined
  ...
  object AccordionDetailsProps {
    ...
    implicit open class MutableBuilder[Self <: AccordionDetailsProps] (val x: Self) extends AnyVal {
      ...
      inline def setClasses(value: PartialClassNameMapAccord0): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
