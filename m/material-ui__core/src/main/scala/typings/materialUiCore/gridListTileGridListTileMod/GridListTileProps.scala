...
import typings.materialUiCore.anon.PartialClassNameMapGridLiImgFullHeight
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLLIElement>, @material-ui/core.@material-ui/core/GridListTile/GridListTile.GridListTileClassKey, never> */
@js.native
trait GridListTileProps extends js.Object {
...
object GridListTileProps {
  ...
  @scala.inline
  def apply(): GridListTileProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GridListTileProps]
  }
  
  @scala.inline
  implicit class GridListTilePropsOps[Self <: GridListTileProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapGridLiImgFullHeight): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[GridListTileProps]): Self = this.set("component", value.asInstanceOf[js.Any])
