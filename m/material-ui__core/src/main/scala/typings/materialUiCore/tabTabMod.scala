...
object tabTabMod extends Shortcut {
  ...
  */
  ...
  object TabClassKey {
    ...
    inline def labelWrapped: typings.materialUiCore.materialUiCoreStrings.labelWrapped = "labelWrapped".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.labelWrapped]
