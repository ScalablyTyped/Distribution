...
object dialogActionsDialogActionsMod extends Shortcut {
  ...
  */
  ...
  trait DialogActionsProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapDialogAction] = js.undefined
  ...
  object DialogActionsProps {
    ...
    extension [Self <: DialogActionsProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapDialogAction): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
