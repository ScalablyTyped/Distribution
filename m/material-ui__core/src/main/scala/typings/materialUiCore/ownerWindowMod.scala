...
object ownerWindowMod {
  ...
  @scala.inline
  def default(node: Node, fallback: Window): Window = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(node.asInstanceOf[js.Any], fallback.asInstanceOf[js.Any])).asInstanceOf[Window]
}
