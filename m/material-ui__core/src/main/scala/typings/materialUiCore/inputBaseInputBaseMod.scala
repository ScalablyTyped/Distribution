...
object inputBaseInputBaseMod extends Shortcut {
  ...
  */
  ...
  object InputBaseClassKey {
    ...
    inline def inputDisabled: typings.materialUiCore.materialUiCoreStrings.inputDisabled = "inputDisabled".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.inputDisabled]
