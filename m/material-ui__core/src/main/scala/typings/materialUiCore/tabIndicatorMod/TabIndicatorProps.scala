...
import typings.materialUiCore.anon.Left
import typings.materialUiCore.anon.PartialClassNameMapTabInd
...
object TabIndicatorProps {
  ...
  @scala.inline
  implicit class TabIndicatorPropsOps[Self <: TabIndicatorProps] (val x: Self) extends AnyVal {
    @scala.inline
