...
@js.native
trait PartialStyleRulesTypographyClassKey extends js.Object {
...
object PartialStyleRulesTypographyClassKey {
  @scala.inline
  def apply(
  ...
  ): PartialStyleRulesTypographyClassKey = {
    ...
    __obj.asInstanceOf[PartialStyleRulesTypographyClassKey]
  }
}
