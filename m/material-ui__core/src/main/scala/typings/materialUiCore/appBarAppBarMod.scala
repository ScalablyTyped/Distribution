...
object appBarAppBarMod {
  ...
  */
  ...
  object AppBarClassKey {
    ...
    inline def positionAbsolute: typings.materialUiCore.materialUiCoreStrings.positionAbsolute = "positionAbsolute".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.positionAbsolute]
    
    inline def positionFixed: typings.materialUiCore.materialUiCoreStrings.positionFixed = "positionFixed".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.positionFixed]
    
    inline def positionRelative: typings.materialUiCore.materialUiCoreStrings.positionRelative = "positionRelative".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.positionRelative]
    ...
    inline def positionSticky: typings.materialUiCore.materialUiCoreStrings.positionSticky = "positionSticky".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.positionSticky]
  ...
  trait AppBarProps extends StObject {
    ...
    /**
      ...
      */
    var color: js.UndefOr[Color | transparent] = js.undefined
  ...
  object AppBarProps {
    ...
    extension [Self <: AppBarProps](x: Self) {
      ...
      inline def setColor(value: Color | transparent): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
