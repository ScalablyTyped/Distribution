...
import typings.materialUiCore.anon.PartialClassNameMapCardCl
...
object cardCardMod extends Shortcut {
  ...
  @JSImport("@material-ui/core/Card/Card", JSImport.Default)
  @js.native
  ...
  trait CardProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapCardCl] = js.undefined
  ...
  object CardProps {
    ...
    implicit class CardPropsMutableBuilder[Self <: CardProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapCardCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
