...
object cardCardMod {
  ...
  @JSImport("@material-ui/core/Card/Card", JSImport.Namespace)
  @js.native
  ...
  object CardProps {
    ...
    extension [Self <: CardProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapCardCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
