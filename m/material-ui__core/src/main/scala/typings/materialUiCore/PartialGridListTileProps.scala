...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/GridListTile.GridListTileProps> */
@js.native
trait PartialGridListTileProps extends js.Object {
...
object PartialGridListTileProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    __obj.asInstanceOf[PartialGridListTileProps]
  }
}
