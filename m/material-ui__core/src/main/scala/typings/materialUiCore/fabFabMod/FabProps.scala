...
object FabProps {
  ...
  implicit class FabPropsOps[Self <: FabProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapFabCla): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[FabProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVariant(value: round | extended): Self = this.set("variant", value.asInstanceOf[js.Any])
