...
import typings.materialUiCore.anon.PartialClassNameMapDialogDividers
...
object dialogContentDialogContentMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiCore.materialUiCoreStrings.dividers
  */
  trait DialogContentClassKey extends StObject
  object DialogContentClassKey {
    
    inline def dividers: typings.materialUiCore.materialUiCoreStrings.dividers = "dividers".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.dividers]
