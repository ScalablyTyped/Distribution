...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/StepConnector.StepConnectorProps> */
@js.native
trait PartialStepConnectorProps extends js.Object {
...
object PartialStepConnectorProps {
  @scala.inline
  def apply(
    about: String = null,
