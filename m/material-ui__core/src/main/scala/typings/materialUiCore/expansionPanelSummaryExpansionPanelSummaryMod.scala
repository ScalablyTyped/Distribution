...
object expansionPanelSummaryExpansionPanelSummaryMod extends Shortcut {
  ...
  */
  ...
  object ExpansionPanelSummaryProps {
    ...
    inline def apply(): ExpansionPanelSummaryProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ExpansionPanelSummaryProps]
    }
    
    extension [Self <: ExpansionPanelSummaryProps](x: Self) {
      ...
      inline def setAction(value: /* actions */ ButtonBaseActions => Unit): Self = StObject.set(x, "action", js.Any.fromFunction1(value))
      ...
      inline def setButtonRef(value: Ref[js.Any] | RefObject[js.Any]): Self = StObject.set(x, "buttonRef", value.asInstanceOf[js.Any])
      
      inline def setButtonRefFunction1(value: /* instance */ js.Any | Null => Unit): Self = StObject.set(x, "buttonRef", js.Any.fromFunction1(value))
      ...
      inline def setClasses(value: PartialClassNameMapExpansContent): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponent(value: ReactType[ButtonBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setIconButtonProps(value: PartialIconButtonProps): Self = StObject.set(x, "IconButtonProps", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: SyntheticEvent[js.Object, Event] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setOnFocusVisible(value: FocusEvent[js.Any] => Unit): Self = StObject.set(x, "onFocusVisible", js.Any.fromFunction1(value))
      ...
      inline def setTouchRippleProps(value: Partial[TouchRippleProps]): Self = StObject.set(x, "TouchRippleProps", value.asInstanceOf[js.Any])
