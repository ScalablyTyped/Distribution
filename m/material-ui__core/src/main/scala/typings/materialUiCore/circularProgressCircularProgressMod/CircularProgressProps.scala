...
object CircularProgressProps {
  ...
  implicit class CircularProgressPropsOps[Self <: CircularProgressProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCircul): Self = this.set("classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    
    @scala.inline
    def setColor(value: primary | secondary | inherit): Self = this.set("color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVariant(value: determinate | indeterminate | static): Self = this.set("variant", value.asInstanceOf[js.Any])
