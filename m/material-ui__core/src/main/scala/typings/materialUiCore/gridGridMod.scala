...
object gridGridMod extends Shortcut {
  ...
  */
  ...
  trait GridTypeMap[P, D /* <: ElementType[Any] */] extends StObject {
    ...
    var classKey: GridClassKey
    
    var defaultComponent: D
    
    var props: P & AlignContent
  }
  object GridTypeMap {
    
    inline def apply[P, D /* <: ElementType[Any] */](classKey: GridClassKey, defaultComponent: D, props: P & AlignContent): GridTypeMap[P, D] = {
      val __obj = js.Dynamic.literal(classKey = classKey.asInstanceOf[js.Any], defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[GridTypeMap[P, D]]
    }
    
    extension [Self <: GridTypeMap[?, ?], P, D /* <: ElementType[Any] */](x: Self & (GridTypeMap[P, D])) {
      
      inline def setClassKey(value: GridClassKey): Self = StObject.set(x, "classKey", value.asInstanceOf[js.Any])
      
      inline def setDefaultComponent(value: D): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
      
      inline def setProps(value: P & AlignContent): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
