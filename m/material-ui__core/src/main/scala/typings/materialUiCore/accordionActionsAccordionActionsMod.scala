...
import typings.materialUiCore.anon.PartialClassNameMapAccordRoot
...
object accordionActionsAccordionActionsMod {
  ...
  @JSImport("@material-ui/core/AccordionActions/AccordionActions", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiCore.materialUiCoreStrings.spacing
  */
  trait AccordionActionsClassKey extends StObject
  object AccordionActionsClassKey {
    
    inline def root: typings.materialUiCore.materialUiCoreStrings.root = "root".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.root]
    
    inline def spacing: typings.materialUiCore.materialUiCoreStrings.spacing = "spacing".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.spacing]
  }
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/AccordionActions/AccordionActions.AccordionActionsClassKey, never> */
  trait AccordionActionsProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapAccordRoot] = js.undefined
  ...
  object AccordionActionsProps {
    ...
    extension [Self <: AccordionActionsProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapAccordRoot): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
