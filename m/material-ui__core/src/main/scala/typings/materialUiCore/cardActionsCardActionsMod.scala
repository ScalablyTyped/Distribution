...
import typings.materialUiCore.anon.PartialClassNameMapCardAcAction
...
object cardActionsCardActionsMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[CardActionsProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.materialUiCore.materialUiCoreStrings.root
    - typings.materialUiCore.materialUiCoreStrings.disableActionSpacing
  ...
  */
  ...
  object CardActionsClassKey {
    ...
    inline def disableActionSpacing: typings.materialUiCore.materialUiCoreStrings.disableActionSpacing = "disableActionSpacing".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.disableActionSpacing]
