...
object snackbarContentSnackbarContentMod extends Shortcut {
  ...
  */
  ...
  object SnackbarContentClassKey {
    ...
    inline def message: typings.materialUiCore.materialUiCoreStrings.message = "message".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.message]
  ...
  object SnackbarContentProps {
    ...
    inline def apply(): SnackbarContentProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SnackbarContentProps]
    }
    
    extension [Self <: SnackbarContentProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapSnackb): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponent(value: ReactType[PaperProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
