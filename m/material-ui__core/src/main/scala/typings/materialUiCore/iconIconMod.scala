...
import typings.materialUiCore.anon.PartialClassNameMapIconCl
...
object iconIconMod extends Shortcut {
  ...
  */
  ...
  trait IconProps extends StObject {
    ...
    var fontSize: js.UndefOr[inherit | typings.materialUiCore.materialUiCoreStrings.default | small | large] = js.undefined
  ...
  object IconProps {
    ...
    extension [Self <: IconProps](x: Self) {
      ...
      inline def setFontSize(value: inherit | typings.materialUiCore.materialUiCoreStrings.default | small | large): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
