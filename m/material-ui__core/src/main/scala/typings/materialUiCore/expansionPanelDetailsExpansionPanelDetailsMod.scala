...
import typings.materialUiCore.anon.PartialClassNameMapExpansRoot
...
object expansionPanelDetailsExpansionPanelDetailsMod extends Shortcut {
  
  @JSImport("@material-ui/core/ExpansionPanelDetails/ExpansionPanelDetails", JSImport.Default)
  @js.native
  val default: ComponentType[ExpansionPanelDetailsProps] = js.native
  
  type ExpansionPanelDetailsClassKey = root
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/ExpansionPanelDetails/ExpansionPanelDetails.ExpansionPanelDetailsClassKey, never> */
  trait ExpansionPanelDetailsProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapExpansRoot] = js.undefined
  ...
  object ExpansionPanelDetailsProps {
    
    @scala.inline
    def apply(): ExpansionPanelDetailsProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ExpansionPanelDetailsProps]
    }
    
    @scala.inline
    implicit class ExpansionPanelDetailsPropsMutableBuilder[Self <: ExpansionPanelDetailsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapExpansRoot): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
  ...
  type _To = ComponentType[ExpansionPanelDetailsProps]
  
  /* This means you don't have to write `default`, but can instead just say `expansionPanelDetailsExpansionPanelDetailsMod.foo` */
  override def _to: ComponentType[ExpansionPanelDetailsProps] = default
}
