...
object expansionPanelDetailsExpansionPanelDetailsMod extends Shortcut {
  ...
  object ExpansionPanelDetailsProps {
    ...
    inline def apply(): ExpansionPanelDetailsProps = {
    ...
    extension [Self <: ExpansionPanelDetailsProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapExpansRoot): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
