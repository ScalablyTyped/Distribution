...
import typings.materialUiCore.anon.PartialClassNameMapExpans0
...
object expansionPanelDetailsExpansionPanelDetailsMod {
  
  @JSImport("@material-ui/core/ExpansionPanelDetails/ExpansionPanelDetails", JSImport.Namespace)
  @js.native
