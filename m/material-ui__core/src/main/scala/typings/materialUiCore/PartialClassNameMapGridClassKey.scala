...
@js.native
trait PartialClassNameMapGridClassKey extends js.Object {
...
object PartialClassNameMapGridClassKey {
  @scala.inline
  def apply(
  ...
  ): PartialClassNameMapGridClassKey = {
    ...
    __obj.asInstanceOf[PartialClassNameMapGridClassKey]
  }
}
