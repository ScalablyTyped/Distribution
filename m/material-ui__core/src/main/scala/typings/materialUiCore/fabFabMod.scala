  ...
  */
  ...
  object FabProps {
    ...
    extension [Self <: FabProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapFabCla): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponent(value: ReactType[FabProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setVariant(value: round | extended): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
