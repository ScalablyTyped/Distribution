...
import typings.materialUiCore.anon.PartialClassNameMapFabCla
...
import typings.materialUiCore.materialUiCoreStrings.reset
...
import typings.materialUiCore.materialUiCoreStrings.submit
...
object fabFabMod extends Shortcut {
  ...
  */
  ...
  trait FabProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapFabCla] = js.undefined
  ...
  object FabProps {
    ...
    implicit class FabPropsMutableBuilder[Self <: FabProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapFabCla): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[FabProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVariant(value: round | extended): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
