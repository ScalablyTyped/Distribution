  ...
  */
  ...
  object MobileStepperProps {
    ...
    implicit class MobileStepperPropsMutableBuilder[Self <: MobileStepperProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapMobile): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLinearProgressProps(value: PartialLinearProgressProp): Self = StObject.set(x, "LinearProgressProps", value.asInstanceOf[js.Any])
