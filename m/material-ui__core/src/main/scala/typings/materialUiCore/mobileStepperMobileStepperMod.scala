...
import typings.materialUiCore.anon.PartialClassNameMapMobile
...
import typings.materialUiCore.materialUiCoreStrings.dots
...
import typings.materialUiCore.materialUiCoreStrings.progress
...
object mobileStepperMobileStepperMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiCore.materialUiCoreStrings.dots
    - typings.materialUiCore.materialUiCoreStrings.dot
    - typings.materialUiCore.materialUiCoreStrings.dotActive
  ...
  */
  ...
  object MobileStepperClassKey {
    ...
    inline def dotActive: typings.materialUiCore.materialUiCoreStrings.dotActive = "dotActive".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.dotActive]
    
    inline def dots: typings.materialUiCore.materialUiCoreStrings.dots = "dots".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.dots]
    ...
    inline def positionStatic: typings.materialUiCore.materialUiCoreStrings.positionStatic = "positionStatic".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.positionStatic]
    ...
    inline def progress: typings.materialUiCore.materialUiCoreStrings.progress = "progress".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.progress]
  ...
  /* This means you don't have to write `default`, but can instead just say `mobileStepperMobileStepperMod.foo` */
