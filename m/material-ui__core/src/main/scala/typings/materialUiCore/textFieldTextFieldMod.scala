...
object textFieldTextFieldMod extends Shortcut {
  ...
  object BaseTextFieldProps {
    ...
    extension [Self <: BaseTextFieldProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapTextFi): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setFormHelperTextProps(value: PartialFormHelperTextProp): Self = StObject.set(x, "FormHelperTextProps", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: ChangeEvent[HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setSelectProps(value: PartialSelectProps): Self = StObject.set(x, "SelectProps", value.asInstanceOf[js.Any])
