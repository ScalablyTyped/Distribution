...
object textFieldTextFieldMod extends Shortcut {
  ...
  trait BaseTextFieldProps extends StObject {
    ...
    var FormHelperTextProps: js.UndefOr[PartialFormHelperTextProp] = js.undefined
    ...
    var classes: js.UndefOr[PartialClassNameMapTextFi] = js.undefined
  ...
  object BaseTextFieldProps {
    ...
    implicit class BaseTextFieldPropsMutableBuilder[Self <: BaseTextFieldProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapTextFi): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFormHelperTextProps(value: PartialFormHelperTextProp): Self = StObject.set(x, "FormHelperTextProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: ChangeEvent[HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSelectProps(value: PartialSelectProps): Self = StObject.set(x, "SelectProps", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object TextFieldProps {
    ...
    @scala.inline
    def FilledTextFieldProps(): typings.materialUiCore.textFieldTextFieldMod.FilledTextFieldProps = {
      val __obj = js.Dynamic.literal(variant = "filled")
      __obj.asInstanceOf[typings.materialUiCore.textFieldTextFieldMod.FilledTextFieldProps]
    }
    
    @scala.inline
    def OutlinedTextFieldProps(): typings.materialUiCore.textFieldTextFieldMod.OutlinedTextFieldProps = {
      val __obj = js.Dynamic.literal(variant = "outlined")
      __obj.asInstanceOf[typings.materialUiCore.textFieldTextFieldMod.OutlinedTextFieldProps]
    }
    
    @scala.inline
    def StandardTextFieldProps(): typings.materialUiCore.textFieldTextFieldMod.StandardTextFieldProps = {
      val __obj = js.Dynamic.literal()
  ...
  /* This means you don't have to write `default`, but can instead just say `textFieldTextFieldMod.foo` */
