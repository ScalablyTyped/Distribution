...
object textFieldTextFieldMod extends Shortcut {
  ...
  */
  ...
  object TextFieldProps {
    ...
    @scala.inline
    def FilledTextFieldProps(variant: filled): typings.materialUiCore.textFieldTextFieldMod.FilledTextFieldProps = {
      val __obj = js.Dynamic.literal(variant = variant.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.materialUiCore.textFieldTextFieldMod.FilledTextFieldProps]
    }
    
    @scala.inline
    def OutlinedTextFieldProps(variant: outlined): typings.materialUiCore.textFieldTextFieldMod.OutlinedTextFieldProps = {
      val __obj = js.Dynamic.literal(variant = variant.asInstanceOf[js.Any])
