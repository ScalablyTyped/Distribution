...
import typings.materialUiCore.anon.PartialClassNameMapToolba
...
object toolbarToolbarMod extends Shortcut {
  ...
  */
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/Toolbar/Toolbar.ToolbarClassKey, never> */
  trait ToolbarProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapToolba] = js.undefined
  ...
  object ToolbarProps {
    ...
    implicit class ToolbarPropsMutableBuilder[Self <: ToolbarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapToolba): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVariant(value: regular | dense): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
