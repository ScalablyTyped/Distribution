...
import typings.materialUiCore.anon.PartialClassNameMapSteppe
...
object stepperStepperMod extends Shortcut {
  ...
  */
  ...
  trait StepperProps extends StObject {
    ...
    var connector: js.UndefOr[ReactElement | ReactNode] = js.undefined
  ...
  object StepperProps {
    ...
    extension [Self <: StepperProps](x: Self) {
      ...
      inline def setConnector(value: ReactElement | ReactNode): Self = StObject.set(x, "connector", value.asInstanceOf[js.Any])
