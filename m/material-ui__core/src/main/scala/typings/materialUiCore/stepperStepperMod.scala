  ...
  */
  ...
  object StepperProps {
    ...
    implicit class StepperPropsMutableBuilder[Self <: StepperProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapSteppe): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setConnector(value: ReactElement | ReactNode): Self = StObject.set(x, "connector", value.asInstanceOf[js.Any])
