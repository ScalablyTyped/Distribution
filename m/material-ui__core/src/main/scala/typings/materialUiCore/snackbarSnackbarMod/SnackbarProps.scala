...
import typings.materialUiCore.PartialClassNameMapSnackbarClassKey
import typings.materialUiCore.PartialClickAwayListenerProps
import typings.materialUiCore.PartialSnackbarContentProps
