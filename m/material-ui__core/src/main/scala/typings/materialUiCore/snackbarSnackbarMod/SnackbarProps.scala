...
import typings.materialUiCore.anon.PartialClassNameMapSnackbAnchorOriginBottomCenter
import typings.materialUiCore.anon.PartialClickAwayListenerP
...
trait SnackbarProps extends js.Object {
  ...
  var onClose: js.UndefOr[js.Function2[/* event */ SyntheticEvent[_, Event], /* reason */ String, Unit]] = js.native
...
object SnackbarProps {
  ...
  implicit class SnackbarPropsOps[Self <: SnackbarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClose(value: (/* event */ SyntheticEvent[_, Event], /* reason */ String) => Unit): Self = this.set("onClose", js.Any.fromFunction2(value))
    @scala.inline
