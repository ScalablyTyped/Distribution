...
import typings.materialUiCore.PartialClassNameMapSnackbAnchorOriginBottomCenter
import typings.materialUiCore.PartialClickAwayListenerP
import typings.materialUiCore.PartialSnackbarContentPro
...
trait SnackbarProps extends js.Object {
  ...
  var onClose: js.UndefOr[js.Function2[/* event */ SyntheticEvent[_, Event_], /* reason */ String, Unit]] = js.native
...
object SnackbarProps {
  ...
  def apply(
    ...
    onClose: (/* event */ SyntheticEvent[_, Event_], /* reason */ String) => Unit = null,
