  ...
  */
  ...
  object StepButtonProps {
    ...
    extension [Self <: StepButtonProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapStepBu): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setIcon(value: StepButtonIcon): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
