...
import typings.materialUiCore.anon.PartialClassNameMapStepBu
...
object stepButtonStepButtonMod extends Shortcut {
  ...
  */
  ...
  type StepButtonIcon = ReactElement | String | Double | Null
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/ButtonBase.ButtonBaseProps, @material-ui/core.@material-ui/core/StepButton/StepButton.StepButtonClasskey, never> */
  trait StepButtonProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapStepBu] = js.undefined
  ...
  object StepButtonProps {
    ...
    implicit class StepButtonPropsMutableBuilder[Self <: StepButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapStepBu): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIcon(value: StepButtonIcon): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOptional(value: ReactNode): Self = StObject.set(x, "optional", value.asInstanceOf[js.Any])
