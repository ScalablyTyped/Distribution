...
import typings.materialUiCore.anon.PartialClassNameMapRadioC
...
object radioRadioMod extends Shortcut {
  ...
  */
  ...
  trait RadioProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapRadioC] = js.undefined
    
    var color: js.UndefOr[primary | secondary | typings.materialUiCore.materialUiCoreStrings.default] = js.undefined
  ...
  object RadioProps {
    ...
    extension [Self <: RadioProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapRadioC): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      inline def setColor(value: primary | secondary | typings.materialUiCore.materialUiCoreStrings.default): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
