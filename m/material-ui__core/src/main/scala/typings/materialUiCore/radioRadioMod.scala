  ...
  */
  ...
  object RadioProps {
    ...
    implicit class RadioPropsMutableBuilder[Self <: RadioProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapRadioC): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      @scala.inline
      def setColor(value: primary | secondary | typings.materialUiCore.materialUiCoreStrings.default): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
