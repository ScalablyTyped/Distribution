...
object outlinedInputOutlinedInputMod extends Shortcut {
  ...
  */
  ...
  object OutlinedInputClassKey {
    ...
    inline def notchedOutline: typings.materialUiCore.materialUiCoreStrings.notchedOutline = "notchedOutline".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.notchedOutline]
  ...
  object OutlinedInputProps {
    ...
    extension [Self <: OutlinedInputProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapOutlin): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setOnKeyDown(value: KeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      ...
      inline def setOnKeyUp(value: KeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onKeyUp", js.Any.fromFunction1(value))
