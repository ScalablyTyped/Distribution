...
object outlinedInputOutlinedInputMod {
  
  @JSImport("@material-ui/core/OutlinedInput/OutlinedInput", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(props: OutlinedInputProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  */
  ...
  object OutlinedInputProps {
    ...
    inline def apply(): OutlinedInputProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OutlinedInputProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OutlinedInputProps] (val x: Self) extends AnyVal {
