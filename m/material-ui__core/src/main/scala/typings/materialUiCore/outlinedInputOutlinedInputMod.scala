...
import typings.materialUiCore.anon.PartialClassNameMapOutlin
...
object outlinedInputOutlinedInputMod extends Shortcut {
  
  @JSImport("@material-ui/core/OutlinedInput/OutlinedInput", JSImport.Default)
  @js.native
  val default: ComponentType[OutlinedInputProps] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiCore.materialUiCoreStrings.notchedOutline
  ...
  */
  ...
  object OutlinedInputClassKey {
    
    @scala.inline
    def adornedEnd: typings.materialUiCore.materialUiCoreStrings.adornedEnd = "adornedEnd".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.adornedEnd]
    
    @scala.inline
    def adornedStart: typings.materialUiCore.materialUiCoreStrings.adornedStart = "adornedStart".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.adornedStart]
    ...
    @scala.inline
    def inputAdornedEnd: typings.materialUiCore.materialUiCoreStrings.inputAdornedEnd = "inputAdornedEnd".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.inputAdornedEnd]
    
    @scala.inline
    def inputAdornedStart: typings.materialUiCore.materialUiCoreStrings.inputAdornedStart = "inputAdornedStart".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.inputAdornedStart]
    ...
    @scala.inline
    def notchedOutline: typings.materialUiCore.materialUiCoreStrings.notchedOutline = "notchedOutline".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.notchedOutline]
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/InputBase.InputBaseProps, @material-ui/core.@material-ui/core/OutlinedInput/OutlinedInput.OutlinedInputClassKey, never> */
  @js.native
  trait OutlinedInputProps extends StObject {
    ...
    var renderPrefix: js.UndefOr[js.Function1[/* state */ Disabled, ReactNode]] = js.native
  ...
  object OutlinedInputProps {
    ...
    @scala.inline
    def apply(labelWidth: Double): OutlinedInputProps = {
      val __obj = js.Dynamic.literal(labelWidth = labelWidth.asInstanceOf[js.Any])
      __obj.asInstanceOf[OutlinedInputProps]
    }
    
    @scala.inline
    implicit class OutlinedInputPropsMutableBuilder[Self <: OutlinedInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapOutlin): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDefaultValue(value: (js.Array[String | Double | Boolean | js.Object]) | String | Double | Boolean | js.Object): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDefaultValueUndefined: Self = StObject.set(x, "defaultValue", js.undefined)
      
      @scala.inline
      def setDefaultValueVarargs(value: (String | Double | Boolean | js.Object)*): Self = StObject.set(x, "defaultValue", js.Array(value :_*))
      ...
      @scala.inline
      def setInputComponent(value: ReactType[InputBaseComponentProps]): Self = StObject.set(x, "inputComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setInputRef(value: Ref[_] | RefObject[_]): Self = StObject.set(x, "inputRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNotched(value: Boolean): Self = StObject.set(x, "notched", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNotchedUndefined: Self = StObject.set(x, "notched", js.undefined)
      ...
      @scala.inline
      def setOnChange(value: ChangeEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnFilledUndefined: Self = StObject.set(x, "onFilled", js.undefined)
      ...
      @scala.inline
      def setOnKeyDown(value: KeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnKeyUp(value: KeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onKeyUp", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRenderPrefix(value: /* state */ Disabled => ReactNode): Self = StObject.set(x, "renderPrefix", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRowsMax(value: String | Double): Self = StObject.set(x, "rowsMax", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setValue(value: (js.Array[String | Double | Boolean | js.Object]) | String | Double | Boolean | js.Object): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValueUndefined: Self = StObject.set(x, "value", js.undefined)
      
      @scala.inline
      def setValueVarargs(value: (String | Double | Boolean | js.Object)*): Self = StObject.set(x, "value", js.Array(value :_*))
  ...
  type _To = ComponentType[OutlinedInputProps]
  
  /* This means you don't have to write `default`, but can instead just say `outlinedInputOutlinedInputMod.foo` */
  override def _to: ComponentType[OutlinedInputProps] = default
}
