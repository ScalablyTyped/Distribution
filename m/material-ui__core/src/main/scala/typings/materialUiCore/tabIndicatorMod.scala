...
object tabIndicatorMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[TabIndicatorProps] = js.native
  ...
  */
  ...
  object TabIndicatorProps {
    ...
    inline def apply(color: secondary | primary | String, style: Left): TabIndicatorProps = {
    ...
    extension [Self <: TabIndicatorProps](x: Self) {
  ...
  type _To = ComponentType[TabIndicatorProps]
  
  /* This means you don't have to write `default`, but can instead just say `tabIndicatorMod.foo` */
  override def _to: ComponentType[TabIndicatorProps] = default
}
