...
object badgeBadgeMod extends Shortcut {
  ...
  */
  ...
  trait BadgeProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapBadgeC] = js.undefined
  ...
  object BadgeProps {
    ...
    extension [Self <: BadgeProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapBadgeC): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      inline def setColor(value: Color | error): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      
      inline def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
      
      inline def setComponent(value: ReactType[BadgeProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
