...
import typings.materialUiCore.anon.typeinStylestring
...
object dialogContentTextDialogContentTextMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[DialogContentTextProps] = js.native
  ...
  @js.native
  trait DialogContentTextProps extends StObject {
  ...
  object DialogContentTextProps {
    ...
    @scala.inline
    implicit class DialogContentTextPropsMutableBuilder[Self <: DialogContentTextProps] (val x: Self) extends AnyVal {
