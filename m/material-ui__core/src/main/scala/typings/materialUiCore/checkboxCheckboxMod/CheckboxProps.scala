...
import typings.materialUiCore.anon.PartialClassNameMapCheckb
...
object CheckboxProps {
  ...
  implicit class CheckboxPropsOps[Self <: CheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIndeterminateIcon(value: ReactNode): Self = this.set("indeterminateIcon", value.asInstanceOf[js.Any])
    @scala.inline
