...
import typings.materialUiCore.anon.PartialClassNameMapExpans
...
object expansionPanelExpansionPanelMod {
  
  @JSImport("@material-ui/core/ExpansionPanel/ExpansionPanel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(props: ExpansionPanelProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  */
  ...
  trait ExpansionPanelProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapExpans] = js.undefined
  ...
  object ExpansionPanelProps {
    ...
    inline def apply(children: NonNullable[ReactNode]): ExpansionPanelProps = {
    ...
    extension [Self <: ExpansionPanelProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapExpans): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
