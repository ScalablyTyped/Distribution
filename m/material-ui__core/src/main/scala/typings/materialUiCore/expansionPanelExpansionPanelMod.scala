  ...
  */
  ...
  object ExpansionPanelProps {
    ...
    extension [Self <: ExpansionPanelProps](x: Self) {
      ...
      inline def setCollapseProps(value: PartialCollapseProps): Self = StObject.set(x, "CollapseProps", value.asInstanceOf[js.Any])
      
      inline def setCollapsePropsUndefined: Self = StObject.set(x, "CollapseProps", js.undefined)
