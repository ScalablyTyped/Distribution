...
object gridListGridListMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[GridListProps] = js.native
  ...
  object GridListProps {
    ...
    extension [Self <: GridListProps](x: Self) {
      ...
      inline def setComponent(value: ReactType[GridListProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
