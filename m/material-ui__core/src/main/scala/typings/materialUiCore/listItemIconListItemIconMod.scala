...
import typings.materialUiCore.anon.PartialClassNameMapListItAlignItemsFlexStart
...
object listItemIconListItemIconMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiCore.materialUiCoreStrings.alignItemsFlexStart
  */
  trait ListItemIconClassKey extends StObject
  object ListItemIconClassKey {
    
    inline def alignItemsFlexStart: typings.materialUiCore.materialUiCoreStrings.alignItemsFlexStart = "alignItemsFlexStart".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.alignItemsFlexStart]
