...
@js.native
trait PartialClassNameMapCheckb extends js.Object {
...
object PartialClassNameMapCheckb {
  @scala.inline
  def apply(
    checked: String = null,
    ...
    __obj.asInstanceOf[PartialClassNameMapCheckb]
  }
}
