...
object chipChipMod extends Shortcut {
  ...
  */
  ...
  trait ChipProps extends StObject {
    ...
    var variant: js.UndefOr[typings.materialUiCore.materialUiCoreStrings.default | outlined] = js.native
  ...
  object ChipProps {
    ...
    implicit class ChipPropsMutableBuilder[Self <: ChipProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnDelete(value: _ => Unit): Self = StObject.set(x, "onDelete", js.Any.fromFunction1(value))
