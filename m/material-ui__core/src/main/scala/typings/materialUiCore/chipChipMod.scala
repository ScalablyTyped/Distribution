...
import typings.materialUiCore.anon.PartialClassNameMapChipCl
...
object chipChipMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.materialUiCore.materialUiCoreStrings.clickablePrimary
    - typings.materialUiCore.materialUiCoreStrings.clickableSecondary
    - typings.materialUiCore.materialUiCoreStrings.deletable
    - typings.materialUiCore.materialUiCoreStrings.deletablePrimary
    - typings.materialUiCore.materialUiCoreStrings.deletableSecondary
    ...
    - typings.materialUiCore.materialUiCoreStrings.avatarPrimary
    - typings.materialUiCore.materialUiCoreStrings.avatarSecondary
    - typings.materialUiCore.materialUiCoreStrings.avatarChildren
    - typings.materialUiCore.materialUiCoreStrings.label
    - typings.materialUiCore.materialUiCoreStrings.deleteIcon
    - typings.materialUiCore.materialUiCoreStrings.deleteIconPrimary
    - typings.materialUiCore.materialUiCoreStrings.deleteIconSecondary
  ...
  */
  ...
  object ChipClassKey {
    ...
    @scala.inline
    def avatarChildren: typings.materialUiCore.materialUiCoreStrings.avatarChildren = "avatarChildren".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.avatarChildren]
    
    @scala.inline
    def avatarPrimary: typings.materialUiCore.materialUiCoreStrings.avatarPrimary = "avatarPrimary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.avatarPrimary]
    
    @scala.inline
    def avatarSecondary: typings.materialUiCore.materialUiCoreStrings.avatarSecondary = "avatarSecondary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.avatarSecondary]
    
    @scala.inline
    def clickable: typings.materialUiCore.materialUiCoreStrings.clickable = "clickable".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.clickable]
    
    @scala.inline
    def clickablePrimary: typings.materialUiCore.materialUiCoreStrings.clickablePrimary = "clickablePrimary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.clickablePrimary]
    
    @scala.inline
    def clickableSecondary: typings.materialUiCore.materialUiCoreStrings.clickableSecondary = "clickableSecondary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.clickableSecondary]
    ...
    @scala.inline
    def deletable: typings.materialUiCore.materialUiCoreStrings.deletable = "deletable".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.deletable]
    
    @scala.inline
    def deletablePrimary: typings.materialUiCore.materialUiCoreStrings.deletablePrimary = "deletablePrimary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.deletablePrimary]
    
    @scala.inline
    def deletableSecondary: typings.materialUiCore.materialUiCoreStrings.deletableSecondary = "deletableSecondary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.deletableSecondary]
    
    @scala.inline
    def deleteIcon: typings.materialUiCore.materialUiCoreStrings.deleteIcon = "deleteIcon".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.deleteIcon]
    
    @scala.inline
    def deleteIconOutlinedColorPrimary: typings.materialUiCore.materialUiCoreStrings.deleteIconOutlinedColorPrimary = "deleteIconOutlinedColorPrimary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.deleteIconOutlinedColorPrimary]
    
    @scala.inline
    def deleteIconOutlinedColorSecondary: typings.materialUiCore.materialUiCoreStrings.deleteIconOutlinedColorSecondary = "deleteIconOutlinedColorSecondary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.deleteIconOutlinedColorSecondary]
    
    @scala.inline
    def deleteIconPrimary: typings.materialUiCore.materialUiCoreStrings.deleteIconPrimary = "deleteIconPrimary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.deleteIconPrimary]
    
    @scala.inline
    def deleteIconSecondary: typings.materialUiCore.materialUiCoreStrings.deleteIconSecondary = "deleteIconSecondary".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.deleteIconSecondary]
  ...
  trait ChipProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapChipCl] = js.undefined
    ...
    var onDelete: js.UndefOr[EventHandler[js.Any]] = js.undefined
    ...
    var variant: js.UndefOr[typings.materialUiCore.materialUiCoreStrings.default | outlined] = js.undefined
  ...
  object ChipProps {
    ...
    implicit class ChipPropsMutableBuilder[Self <: ChipProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapChipCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[ChipProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnDelete(value: js.Any => Unit): Self = StObject.set(x, "onDelete", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setVariant(value: typings.materialUiCore.materialUiCoreStrings.default | outlined): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
