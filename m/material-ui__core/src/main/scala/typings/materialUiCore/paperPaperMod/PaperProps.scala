...
import typings.materialUiCore.anon.PartialClassNameMapPaperC
...
object PaperProps {
  ...
  implicit class PaperPropsOps[Self <: PaperProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapPaperC): Self = this.set("classes", value.asInstanceOf[js.Any])
