...
import typings.materialUiCore.materialUiCoreStrings.persistent
...
import typings.materialUiCore.materialUiCoreStrings.temporary
...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/SwipeableDrawer.SwipeableDrawerProps> */
trait PartialSwipeableDrawerPro extends StObject {
  ...
  var ModalProps: js.UndefOr[PartialModalPropsAbout] = js.undefined
  ...
  var classes: js.UndefOr[PartialClassNameMapDrawer] = js.undefined
  ...
  var disableBackdropTransition: js.UndefOr[Boolean] = js.undefined
  
  var disableDiscovery: js.UndefOr[Boolean] = js.undefined
  ...
  var onOpen: js.UndefOr[ReactEventHandler[js.Object]] = js.undefined
...
object PartialSwipeableDrawerPro {
  
  inline def apply(): PartialSwipeableDrawerPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSwipeableDrawerPro]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSwipeableDrawerPro] (val x: Self) extends AnyVal {
    ...
    inline def setBackdropProps(value: PartialBackdropProps): Self = StObject.set(x, "BackdropProps", value.asInstanceOf[js.Any])
    ...
    inline def setClasses(value: PartialClassNameMapDrawer): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setDisableBackdropClick(value: Boolean): Self = StObject.set(x, "disableBackdropClick", value.asInstanceOf[js.Any])
    
    inline def setDisableBackdropClickUndefined: Self = StObject.set(x, "disableBackdropClick", js.undefined)
    
    inline def setDisableBackdropTransition(value: Boolean): Self = StObject.set(x, "disableBackdropTransition", value.asInstanceOf[js.Any])
    
    inline def setDisableBackdropTransitionUndefined: Self = StObject.set(x, "disableBackdropTransition", js.undefined)
    
    inline def setDisableDiscovery(value: Boolean): Self = StObject.set(x, "disableDiscovery", value.asInstanceOf[js.Any])
    
    inline def setDisableDiscoveryUndefined: Self = StObject.set(x, "disableDiscovery", js.undefined)
    ...
    inline def setMinFlingVelocity(value: Double): Self = StObject.set(x, "minFlingVelocity", value.asInstanceOf[js.Any])
    ...
    inline def setOnBackdropClick(value: SyntheticEvent[js.Object, Event] => Unit): Self = StObject.set(x, "onBackdropClick", js.Any.fromFunction1(value))
    ...
    inline def setOnEscapeKeyDown(value: SyntheticEvent[js.Object, Event] => Unit): Self = StObject.set(x, "onEscapeKeyDown", js.Any.fromFunction1(value))
    ...
    inline def setOnOpen(value: SyntheticEvent[js.Object, Event] => Unit): Self = StObject.set(x, "onOpen", js.Any.fromFunction1(value))
    ...
    inline def setPaperProps(value: PartialPaperProps): Self = StObject.set(x, "PaperProps", value.asInstanceOf[js.Any])
    ...
    inline def setSlideProps(value: PartialSlideProps): Self = StObject.set(x, "SlideProps", value.asInstanceOf[js.Any])
    
    inline def setSlidePropsUndefined: Self = StObject.set(x, "SlideProps", js.undefined)
    ...
    inline def setSwipeAreaProps(value: js.Object): Self = StObject.set(x, "SwipeAreaProps", value.asInstanceOf[js.Any])
    
    inline def setSwipeAreaPropsUndefined: Self = StObject.set(x, "SwipeAreaProps", js.undefined)
