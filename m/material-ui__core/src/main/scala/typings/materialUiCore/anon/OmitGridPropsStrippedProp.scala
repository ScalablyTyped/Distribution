...
trait OmitGridPropsStrippedProp extends StObject {
...
object OmitGridPropsStrippedProp {
  ...
  @scala.inline
  implicit class OmitGridPropsStrippedPropMutableBuilder[Self <: OmitGridPropsStrippedProp] (val x: Self) extends AnyVal {
