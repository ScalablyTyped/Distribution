...
object PartialListItemProps {
  ...
  implicit class PartialListItemPropsOps[Self <: PartialListItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapListIt): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponent(value: ReactType[ListItemProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
