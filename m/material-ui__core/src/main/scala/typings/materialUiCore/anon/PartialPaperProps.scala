...
trait PartialPaperProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapPaperC] = js.undefined
...
object PartialPaperProps {
  ...
  inline def apply(): PartialPaperProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaperProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialPaperProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialClassNameMapPaperC): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
