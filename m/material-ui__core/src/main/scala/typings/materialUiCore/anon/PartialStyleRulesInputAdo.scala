...
trait PartialStyleRulesInputAdo extends StObject {
  ...
  var disablePointerEvents: js.UndefOr[
  ...
  var positionEnd: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
  
  var positionStart: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
...
object PartialStyleRulesInputAdo {
  ...
  implicit open class MutableBuilder[Self <: PartialStyleRulesInputAdo] (val x: Self) extends AnyVal {
    ...
    ): Self = StObject.set(x, "disablePointerEvents", value.asInstanceOf[js.Any])
    
    inline def setDisablePointerEventsFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "disablePointerEvents", js.Any.fromFunction1(value))
    ...
    inline def setHiddenLabel(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "hiddenLabel", value.asInstanceOf[js.Any])
    
    inline def setHiddenLabelFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "hiddenLabel", js.Any.fromFunction1(value))
    ...
    inline def setPositionEnd(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "positionEnd", value.asInstanceOf[js.Any])
    
    inline def setPositionEndFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "positionEnd", js.Any.fromFunction1(value))
    
    inline def setPositionEndUndefined: Self = StObject.set(x, "positionEnd", js.undefined)
    
    inline def setPositionStart(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "positionStart", value.asInstanceOf[js.Any])
    
    inline def setPositionStartFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "positionStart", js.Any.fromFunction1(value))
