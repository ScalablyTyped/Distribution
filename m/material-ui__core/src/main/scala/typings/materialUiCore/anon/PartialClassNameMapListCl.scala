...
@js.native
trait PartialClassNameMapListCl extends StObject {
...
object PartialClassNameMapListCl {
  ...
  @scala.inline
  implicit class PartialClassNameMapListClMutableBuilder[Self <: PartialClassNameMapListCl] (val x: Self) extends AnyVal {
