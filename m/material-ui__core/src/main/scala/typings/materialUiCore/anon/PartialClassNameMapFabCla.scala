...
@js.native
trait PartialClassNameMapFabCla extends StObject {
...
object PartialClassNameMapFabCla {
  ...
  @scala.inline
  implicit class PartialClassNameMapFabClaMutableBuilder[Self <: PartialClassNameMapFabCla] (val x: Self) extends AnyVal {
