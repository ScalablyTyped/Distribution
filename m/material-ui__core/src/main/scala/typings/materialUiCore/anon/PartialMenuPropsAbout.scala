...
object PartialMenuPropsAbout {
  ...
  implicit class PartialMenuPropsAboutOps[Self <: PartialMenuPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMenuListProps(value: PartialMenuListPropsAbout): Self = this.set("MenuListProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPaperProps(value: PartialPaperPropsAbout): Self = this.set("PaperProps", value.asInstanceOf[js.Any])
