...
object ClassKeyTabClassKeyDefaultComponent {
  ...
  inline def apply(classKey: TabClassKey, props: js.Object & FullWidth): ClassKeyTabClassKeyDefaultComponent = {
  ...
  extension [Self <: ClassKeyTabClassKeyDefaultComponent](x: Self) {
