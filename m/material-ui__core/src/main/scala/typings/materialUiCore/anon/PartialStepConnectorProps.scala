...
object PartialStepConnectorProps {
  ...
  @scala.inline
  implicit class PartialStepConnectorPropsOps[Self <: PartialStepConnectorProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapStepCo): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
