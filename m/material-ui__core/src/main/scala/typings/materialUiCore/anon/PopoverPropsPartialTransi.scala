...
/* Inlined @material-ui/core.@material-ui/core/Popover.PopoverProps & std.Partial<@material-ui/core.@material-ui/core/transitions/transition.TransitionHandlerProps> */
trait PopoverPropsPartialTransi extends StObject {
...
object PopoverPropsPartialTransi {
  
  inline def apply(open: Boolean): PopoverPropsPartialTransi = {
    val __obj = js.Dynamic.literal(open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[PopoverPropsPartialTransi]
  }
  
  extension [Self <: PopoverPropsPartialTransi](x: Self) {
