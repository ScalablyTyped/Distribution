...
trait PartialTypographyProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapTypogr] = js.undefined
...
object PartialTypographyProps {
  ...
  extension [Self <: PartialTypographyProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapTypogr): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    
    inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
    
    inline def setColor(value: Color | textPrimary | textSecondary | error): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    
    inline def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
    
    inline def setComponent(value: ReactType[TypographyProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    inline def setHeadlineMapping(value: typeinStylestring): Self = StObject.set(x, "headlineMapping", value.asInstanceOf[js.Any])
    
    inline def setHeadlineMappingUndefined: Self = StObject.set(x, "headlineMapping", js.undefined)
    ...
    inline def setVariant(value: Style | inherit): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
