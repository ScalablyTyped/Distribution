...
object PartialTableProps {
  ...
  implicit class PartialTablePropsOps[Self <: PartialTableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTableC): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[TableBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
