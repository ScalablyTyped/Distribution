...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/ExpansionPanel/ExpansionPanel.ExpansionPanelClassKey>> */
...
object PartialClassNameMapExpans {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialClassNameMapExpans] (val x: Self) extends AnyVal {
