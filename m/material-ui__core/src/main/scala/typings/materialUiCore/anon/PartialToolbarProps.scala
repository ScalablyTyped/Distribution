...
@js.native
trait PartialToolbarProps extends StObject {
...
object PartialToolbarProps {
  ...
  @scala.inline
  def apply(): PartialToolbarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialToolbarProps]
  }
  
  @scala.inline
  implicit class PartialToolbarPropsMutableBuilder[Self <: PartialToolbarProps] (val x: Self) extends AnyVal {
