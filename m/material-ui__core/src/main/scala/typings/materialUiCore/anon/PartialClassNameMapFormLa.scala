...
trait PartialClassNameMapFormLa extends StObject {
...
object PartialClassNameMapFormLa {
  ...
  @scala.inline
  implicit class PartialClassNameMapFormLaMutableBuilder[Self <: PartialClassNameMapFormLa] (val x: Self) extends AnyVal {
