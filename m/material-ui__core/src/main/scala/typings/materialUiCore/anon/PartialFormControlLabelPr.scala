...
object PartialFormControlLabelPr {
  ...
  inline def apply(): PartialFormControlLabelPr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFormControlLabelPr]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialFormControlLabelPr] (val x: Self) extends AnyVal {
    ...
    inline def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* checked */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
