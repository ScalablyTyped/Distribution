...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/ListItemText.ListItemTextProps<'span', 'p'>> */
trait PartialListItemTextPropss extends StObject {
  ...
  var primaryTypographyProps: js.UndefOr[TypographyProps[span, `11`]] = js.undefined
  ...
  var secondaryTypographyProps: js.UndefOr[TypographyProps[p, `10`]] = js.undefined
...
object PartialListItemTextPropss {
  
  inline def apply(): PartialListItemTextPropss = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemTextPropss]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialListItemTextPropss] (val x: Self) extends AnyVal {
    ...
    inline def setPrimaryTypographyProps(value: TypographyProps[span, `11`]): Self = StObject.set(x, "primaryTypographyProps", value.asInstanceOf[js.Any])
    ...
    inline def setSecondaryTypographyProps(value: TypographyProps[p, `10`]): Self = StObject.set(x, "secondaryTypographyProps", value.asInstanceOf[js.Any])
