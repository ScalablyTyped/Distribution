...
trait PartialClassNameMapIconBu extends StObject {
...
object PartialClassNameMapIconBu {
  ...
  @scala.inline
  implicit class PartialClassNameMapIconBuMutableBuilder[Self <: PartialClassNameMapIconBu] (val x: Self) extends AnyVal {
