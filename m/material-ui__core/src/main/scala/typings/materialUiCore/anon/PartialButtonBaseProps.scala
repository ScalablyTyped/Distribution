...
trait PartialButtonBaseProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapButtonDisabled] = js.undefined
...
object PartialButtonBaseProps {
  ...
  @scala.inline
  implicit class PartialButtonBasePropsMutableBuilder[Self <: PartialButtonBaseProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapButtonDisabled): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
