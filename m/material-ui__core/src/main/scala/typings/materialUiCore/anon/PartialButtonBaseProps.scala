...
object PartialButtonBaseProps {
  ...
  inline def apply(): PartialButtonBaseProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialButtonBaseProps]
  }
  
  extension [Self <: PartialButtonBaseProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapButtonDisabled): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
