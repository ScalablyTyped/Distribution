...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/ButtonBase.ButtonBaseProps> */
@js.native
trait PartialButtonBaseProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapButtonDisabled] = js.native
...
object PartialButtonBaseProps {
  @scala.inline
  def apply(): PartialButtonBaseProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialButtonBaseProps]
  }
  @scala.inline
  implicit class PartialButtonBasePropsOps[Self <: PartialButtonBaseProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapButtonDisabled): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
