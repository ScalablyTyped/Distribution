...
object PartialBackdropPropsAbout {
  ...
  @scala.inline
  def apply(): PartialBackdropPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBackdropPropsAbout]
  }
  
  @scala.inline
  implicit class PartialBackdropPropsAboutMutableBuilder[Self <: PartialBackdropPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: Partial[ClassNameMap[BackdropClassKey]]): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClick(value: SyntheticEvent[js.Object, Event] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
