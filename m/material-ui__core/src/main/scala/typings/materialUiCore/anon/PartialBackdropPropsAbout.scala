...
object PartialBackdropPropsAbout {
  ...
  @scala.inline
  implicit class PartialBackdropPropsAboutOps[Self <: PartialBackdropPropsAbout] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: Partial[ClassNameMap[BackdropClassKey]]): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnClick(value: SyntheticEvent[js.Object, Event] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
    @scala.inline
