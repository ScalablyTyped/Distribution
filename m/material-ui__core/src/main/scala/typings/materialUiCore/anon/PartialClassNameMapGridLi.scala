...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/GridListTileBar/GridListTileBar.GridListTileBarClassKey>> */
...
object PartialClassNameMapGridLi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialClassNameMapGridLi] (val x: Self) extends AnyVal {
    ...
    inline def setTitlePositionBottom(value: String): Self = StObject.set(x, "titlePositionBottom", value.asInstanceOf[js.Any])
    
    inline def setTitlePositionBottomUndefined: Self = StObject.set(x, "titlePositionBottom", js.undefined)
    
    inline def setTitlePositionTop(value: String): Self = StObject.set(x, "titlePositionTop", value.asInstanceOf[js.Any])
