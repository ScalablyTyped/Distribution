...
/* Inlined react.react.HTMLAttributes<std.HTMLDivElement> & std.Partial<@material-ui/core.@material-ui/core/transitions/transition.TransitionHandlerProps> */
trait HTMLAttributesHTMLDivElemAbout extends StObject {
...
object HTMLAttributesHTMLDivElemAbout {
  
  inline def apply(): HTMLAttributesHTMLDivElemAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributesHTMLDivElemAbout]
  }
  
  extension [Self <: HTMLAttributesHTMLDivElemAbout](x: Self) {
