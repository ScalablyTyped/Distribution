...
/* Inlined react.react.HTMLAttributes<std.HTMLDivElement> & std.Partial<@material-ui/core.@material-ui/core.Omit<@material-ui/core.@material-ui/core/Fade.FadeProps, 'children'>> */
trait HTMLAttributesHTMLDivElem extends StObject {
...
object HTMLAttributesHTMLDivElem {
  
  inline def apply(): HTMLAttributesHTMLDivElem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributesHTMLDivElem]
  }
  
  extension [Self <: HTMLAttributesHTMLDivElem](x: Self) {
