...
object PartialDialogProps {
  ...
  @scala.inline
  implicit class PartialDialogPropsOps[Self <: PartialDialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPaperComponent(value: ComponentType[PaperProps]): Self = this.set("PaperComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePaperComponent: Self = this.set("PaperComponent", js.undefined)
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapDialog): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxWidth(value: xs | sm | md | lg | xl | `false`): Self = this.set("maxWidth", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setScroll(value: body | paper): Self = this.set("scroll", value.asInstanceOf[js.Any])
