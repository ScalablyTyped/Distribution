...
@js.native
trait PartialDialogProps extends StObject {
  ...
  var PaperComponent: js.UndefOr[ComponentType[PaperProps]] = js.native
  
  var PaperProps: js.UndefOr[PartialPaperProps] = js.native
  
  var TransitionComponent: js.UndefOr[ComponentType[TransitionProps]] = js.native
  ...
  var maxWidth: js.UndefOr[xs | sm | md | lg | xl | `false`] = js.native
  ...
  var scroll: js.UndefOr[body | paper] = js.native
...
object PartialDialogProps {
  
  @scala.inline
  def apply(): PartialDialogProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogProps]
  }
  
  @scala.inline
  implicit class PartialDialogPropsMutableBuilder[Self <: PartialDialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackdropProps(value: PartialBackdropProps): Self = StObject.set(x, "BackdropProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapDialog): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxWidth(value: xs | sm | md | lg | xl | `false`): Self = StObject.set(x, "maxWidth", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBackdropClick(value: SyntheticEvent[js.Object, Event] => Unit): Self = StObject.set(x, "onBackdropClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnClose(value: SyntheticEvent[js.Object, Event] => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnEscapeKeyDown(value: SyntheticEvent[js.Object, Event] => Unit): Self = StObject.set(x, "onEscapeKeyDown", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPaperComponent(value: ComponentType[PaperProps]): Self = StObject.set(x, "PaperComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPaperComponentUndefined: Self = StObject.set(x, "PaperComponent", js.undefined)
    
    @scala.inline
    def setPaperProps(value: PartialPaperProps): Self = StObject.set(x, "PaperProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setScroll(value: body | paper): Self = StObject.set(x, "scroll", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTransitionComponent(value: ComponentType[TransitionProps]): Self = StObject.set(x, "TransitionComponent", value.asInstanceOf[js.Any])
