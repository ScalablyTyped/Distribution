...
object PartialDialogProps {
  ...
  inline def apply(): PartialDialogProps = {
  ...
  extension [Self <: PartialDialogProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapDialog): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setPaperComponent(value: ComponentType[PaperProps]): Self = StObject.set(x, "PaperComponent", value.asInstanceOf[js.Any])
