...
trait PartialStyleRulesIconButt extends StObject {
  ...
  var edgeEnd: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
  
  var edgeStart: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
...
object PartialStyleRulesIconButt {
  ...
  inline def apply(): PartialStyleRulesIconButt = {
  ...
  implicit open class MutableBuilder[Self <: PartialStyleRulesIconButt] (val x: Self) extends AnyVal {
    ...
    inline def setEdgeEnd(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "edgeEnd", value.asInstanceOf[js.Any])
    
    inline def setEdgeEndFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "edgeEnd", js.Any.fromFunction1(value))
    
    inline def setEdgeEndUndefined: Self = StObject.set(x, "edgeEnd", js.undefined)
    
    inline def setEdgeStart(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "edgeStart", value.asInstanceOf[js.Any])
    
    inline def setEdgeStartFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "edgeStart", js.Any.fromFunction1(value))
