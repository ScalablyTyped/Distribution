...
trait PartialPopperProps extends StObject {
  ...
  var children: js.UndefOr[ReactNode | (js.Function1[/* props */ Placement, ReactNode])] = js.undefined
  ...
  var popperRef: js.UndefOr[typings.react.mod.Ref[default]] = js.undefined
...
object PartialPopperProps {
  ...
  extension [Self <: PartialPopperProps](x: Self) {
    ...
    inline def setAnchorElFunction0(value: () => ReferenceObject): Self = StObject.set(x, "anchorEl", js.Any.fromFunction0(value))
    ...
    inline def setPopperRef(value: typings.react.mod.Ref[default]): Self = StObject.set(x, "popperRef", value.asInstanceOf[js.Any])
    
    inline def setPopperRefFunction1(value: /* instance */ default | Null => Unit): Self = StObject.set(x, "popperRef", js.Any.fromFunction1(value))
