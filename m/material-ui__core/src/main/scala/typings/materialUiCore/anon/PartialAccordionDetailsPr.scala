...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/AccordionDetails.AccordionDetailsProps> */
trait PartialAccordionDetailsPr extends StObject {
...
object PartialAccordionDetailsPr {
  
  inline def apply(): PartialAccordionDetailsPr = {
