...
trait PartialCheckboxProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapCheckb] = js.undefined
...
object PartialCheckboxProps {
  ...
  extension [Self <: PartialCheckboxProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapCheckb): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
