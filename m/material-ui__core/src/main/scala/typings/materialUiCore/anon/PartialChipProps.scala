...
trait PartialChipProps extends StObject {
...
object PartialChipProps {
  ...
  @scala.inline
  def apply(): PartialChipProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialChipProps]
  }
  
  @scala.inline
  implicit class PartialChipPropsMutableBuilder[Self <: PartialChipProps] (val x: Self) extends AnyVal {
