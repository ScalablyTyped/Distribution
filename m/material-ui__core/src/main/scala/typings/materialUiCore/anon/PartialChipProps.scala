...
object PartialChipProps {
  ...
  @scala.inline
  implicit class PartialChipPropsOps[Self <: PartialChipProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setVariant(value: default | outlined): Self = this.set("variant", value.asInstanceOf[js.Any])
    @scala.inline
