...
object PartialListSubheaderProps {
  ...
  @scala.inline
  implicit class PartialListSubheaderPropsOps[Self <: PartialListSubheaderProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setColor(value: default | primary | inherit): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
