...
object PartialListSubheaderProps {
  ...
  inline def apply(): PartialListSubheaderProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListSubheaderProps]
  }
  
  extension [Self <: PartialListSubheaderProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapListSu): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[ListSubheaderProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
