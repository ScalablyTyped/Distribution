...
trait PartialListSubheaderProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapListSu] = js.undefined
...
object PartialListSubheaderProps {
  ...
  @scala.inline
  def apply(): PartialListSubheaderProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListSubheaderProps]
  }
  
  @scala.inline
  implicit class PartialListSubheaderPropsMutableBuilder[Self <: PartialListSubheaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapListSu): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[ListSubheaderProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
