...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/StepLabel/StepLabel.StepLabelClasskey>> */
...
object PartialClassNameMapStepLa {
  ...
  inline def apply(): PartialClassNameMapStepLa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialClassNameMapStepLa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialClassNameMapStepLa] (val x: Self) extends AnyVal {
