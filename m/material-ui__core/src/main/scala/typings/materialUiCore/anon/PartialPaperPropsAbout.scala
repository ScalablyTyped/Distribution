...
object PartialPaperPropsAbout {
  ...
  inline def apply(): PartialPaperPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaperPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialPaperPropsAbout] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: Partial[ClassNameMap[PaperClassKey]]): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
