...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Paper.PaperProps> */
trait PartialPaperPropsAbout extends StObject {
  ...
  var classes: js.UndefOr[Partial[ClassNameMap[PaperClassKey]]] = js.undefined
...
object PartialPaperPropsAbout {
  
  @scala.inline
  def apply(): PartialPaperPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaperPropsAbout]
  }
  
  @scala.inline
  implicit class PartialPaperPropsAboutMutableBuilder[Self <: PartialPaperPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: Partial[ClassNameMap[PaperClassKey]]): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
