...
@js.native
trait PartialPaperPropsAbout extends js.Object {
...
object PartialPaperPropsAbout {
  ...
  @scala.inline
  implicit class PartialPaperPropsAboutOps[Self <: PartialPaperPropsAbout] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: Partial[ClassNameMap[PaperClassKey]]): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
