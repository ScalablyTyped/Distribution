...
trait PartialTablePaginationPro extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapTableP] = js.undefined
  ...
  var labelDisplayedRows: js.UndefOr[js.Function1[/* paginationInfo */ LabelDisplayedRowsArgs, ReactNode]] = js.undefined
  
  var labelRowsPerPage: js.UndefOr[ReactNode] = js.undefined
...
object PartialTablePaginationPro {
  ...
  inline def apply(): PartialTablePaginationPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTablePaginationPro]
  }
  
  extension [Self <: PartialTablePaginationPro](x: Self) {
    ...
    inline def setActionsComponent(value: ReactType[TablePaginationActionsProps]): Self = StObject.set(x, "ActionsComponent", value.asInstanceOf[js.Any])
    ...
    inline def setBackIconButtonProps(value: PartialIconButtonProps): Self = StObject.set(x, "backIconButtonProps", value.asInstanceOf[js.Any])
    ...
    inline def setClasses(value: PartialClassNameMapTableP): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[TablePaginationBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    inline def setLabelDisplayedRows(value: /* paginationInfo */ LabelDisplayedRowsArgs => ReactNode): Self = StObject.set(x, "labelDisplayedRows", js.Any.fromFunction1(value))
    
    inline def setLabelDisplayedRowsUndefined: Self = StObject.set(x, "labelDisplayedRows", js.undefined)
    
    inline def setLabelRowsPerPage(value: ReactNode): Self = StObject.set(x, "labelRowsPerPage", value.asInstanceOf[js.Any])
    ...
    inline def setNextIconButtonProps(value: PartialIconButtonProps): Self = StObject.set(x, "nextIconButtonProps", value.asInstanceOf[js.Any])
    ...
    inline def setOnChangePage(
      value: (/* event */ (MouseEvent[HTMLButtonElement, NativeMouseEvent]) | Null, /* page */ Double) => Unit
    ): Self = StObject.set(x, "onChangePage", js.Any.fromFunction2(value))
    
    inline def setOnChangePageUndefined: Self = StObject.set(x, "onChangePage", js.undefined)
    
    inline def setOnChangeRowsPerPage(value: ChangeEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onChangeRowsPerPage", js.Any.fromFunction1(value))
