...
object PartialTablePaginationPro {
  ...
  implicit class PartialTablePaginationProMutableBuilder[Self <: PartialTablePaginationPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelDisplayedRows(value: /* paginationInfo */ LabelDisplayedRowsArgs => ReactNode): Self = StObject.set(x, "labelDisplayedRows", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLabelDisplayedRowsUndefined: Self = StObject.set(x, "labelDisplayedRows", js.undefined)
    
    @scala.inline
    def setLabelRowsPerPage(value: ReactNode): Self = StObject.set(x, "labelRowsPerPage", value.asInstanceOf[js.Any])
