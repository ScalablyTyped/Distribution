...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/DialogTitle.DialogTitleProps> */
trait PartialDialogTitleProps extends StObject {
...
object PartialDialogTitleProps {
  
  @scala.inline
  def apply(): PartialDialogTitleProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogTitleProps]
  }
  
  @scala.inline
  implicit class PartialDialogTitlePropsMutableBuilder[Self <: PartialDialogTitleProps] (val x: Self) extends AnyVal {
