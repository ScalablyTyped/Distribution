...
@js.native
trait PartialDialogTitleProps extends js.Object {
...
object PartialDialogTitleProps {
  ...
  @scala.inline
  implicit class PartialDialogTitlePropsOps[Self <: PartialDialogTitleProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapDialogRoot): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
