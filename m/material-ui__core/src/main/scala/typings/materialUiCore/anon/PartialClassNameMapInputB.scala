...
object PartialClassNameMapInputB {
  ...
  @scala.inline
  implicit class PartialClassNameMapInputBMutableBuilder[Self <: PartialClassNameMapInputB] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputDisabled(value: String): Self = StObject.set(x, "inputDisabled", value.asInstanceOf[js.Any])
