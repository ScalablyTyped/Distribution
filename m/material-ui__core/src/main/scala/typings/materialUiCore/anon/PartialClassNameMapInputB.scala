...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/InputBase/InputBase.InputBaseClassKey>> */
trait PartialClassNameMapInputB extends StObject {
  ...
  var inputHiddenLabel: js.UndefOr[String] = js.undefined
...
object PartialClassNameMapInputB {
  ...
  inline def apply(): PartialClassNameMapInputB = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialClassNameMapInputB]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialClassNameMapInputB] (val x: Self) extends AnyVal {
    
    inline def setAdornedEnd(value: String): Self = StObject.set(x, "adornedEnd", value.asInstanceOf[js.Any])
    
    inline def setAdornedEndUndefined: Self = StObject.set(x, "adornedEnd", js.undefined)
    ...
    inline def setInputAdornedEndUndefined: Self = StObject.set(x, "inputAdornedEnd", js.undefined)
    
    inline def setInputAdornedStart(value: String): Self = StObject.set(x, "inputAdornedStart", value.asInstanceOf[js.Any])
    
    inline def setInputAdornedStartUndefined: Self = StObject.set(x, "inputAdornedStart", js.undefined)
    
    inline def setInputHiddenLabel(value: String): Self = StObject.set(x, "inputHiddenLabel", value.asInstanceOf[js.Any])
    
    inline def setInputHiddenLabelUndefined: Self = StObject.set(x, "inputHiddenLabel", js.undefined)
