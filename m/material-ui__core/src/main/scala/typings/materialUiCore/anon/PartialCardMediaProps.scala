...
trait PartialCardMediaProps extends StObject {
...
object PartialCardMediaProps {
  ...
  @scala.inline
  def apply(): PartialCardMediaProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardMediaProps]
  }
  
  @scala.inline
  implicit class PartialCardMediaPropsMutableBuilder[Self <: PartialCardMediaProps] (val x: Self) extends AnyVal {
