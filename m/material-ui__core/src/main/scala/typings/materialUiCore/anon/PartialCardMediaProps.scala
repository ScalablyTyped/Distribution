...
object PartialCardMediaProps {
  ...
  inline def apply(): PartialCardMediaProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardMediaProps]
  }
  
  extension [Self <: PartialCardMediaProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapCardMe): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[CardMediaProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
