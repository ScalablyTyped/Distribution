...
/* Inlined @material-ui/core.@material-ui/core/Modal.ModalProps & std.Partial<@material-ui/core.@material-ui/core/transitions/transition.TransitionHandlerProps> */
trait ModalPropsPartialTransiti extends StObject {
...
object ModalPropsPartialTransiti {
  
  inline def apply(children: ReactElement, open: Boolean): ModalPropsPartialTransiti = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[ModalPropsPartialTransiti]
  }
  
  extension [Self <: ModalPropsPartialTransiti](x: Self) {
