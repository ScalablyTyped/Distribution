...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Switch.SwitchProps> */
@js.native
trait PartialSwitchProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapSwitch] = js.native
...
object PartialSwitchProps {
  ...
  implicit class PartialSwitchPropsOps[Self <: PartialSwitchProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSwitch): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    @scala.inline
    def setColor(value: primary | secondary | default): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
