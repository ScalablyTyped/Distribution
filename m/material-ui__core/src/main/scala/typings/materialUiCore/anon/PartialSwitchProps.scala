...
trait PartialSwitchProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapSwitch] = js.undefined
...
object PartialSwitchProps {
  ...
  implicit class PartialSwitchPropsMutableBuilder[Self <: PartialSwitchProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSwitch): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
    
    @scala.inline
    def setColor(value: primary | secondary | default): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
