...
trait PartialCardHeaderProps extends StObject {
  ...
  var subheaderTypographyProps: js.UndefOr[PartialTypographyPropsAbout] = js.undefined
  ...
  var titleTypographyProps: js.UndefOr[PartialTypographyPropsAbout] = js.undefined
...
object PartialCardHeaderProps {
  ...
  inline def apply(): PartialCardHeaderProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardHeaderProps]
  }
  
  extension [Self <: PartialCardHeaderProps](x: Self) {
    ...
    inline def setSubheaderTypographyProps(value: PartialTypographyPropsAbout): Self = StObject.set(x, "subheaderTypographyProps", value.asInstanceOf[js.Any])
    ...
    inline def setTitleTypographyProps(value: PartialTypographyPropsAbout): Self = StObject.set(x, "titleTypographyProps", value.asInstanceOf[js.Any])
