...
@js.native
trait PartialStyleRulesSelectCl extends js.Object {
...
object PartialStyleRulesSelectCl {
  @scala.inline
  def apply(): PartialStyleRulesSelectCl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStyleRulesSelectCl]
  }
  @scala.inline
  implicit class PartialStyleRulesSelectClOps[Self <: PartialStyleRulesSelectCl] (val x: Self) extends AnyVal {
    @scala.inline
