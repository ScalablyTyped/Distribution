...
object PartialInputProps {
  ...
  @scala.inline
  implicit class PartialInputPropsOps[Self <: PartialInputProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapInputC): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
