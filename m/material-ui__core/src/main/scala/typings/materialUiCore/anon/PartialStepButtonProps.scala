...
@js.native
trait PartialStepButtonProps extends StObject {
...
object PartialStepButtonProps {
  ...
  @scala.inline
  def apply(): PartialStepButtonProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepButtonProps]
  }
  
  @scala.inline
  implicit class PartialStepButtonPropsMutableBuilder[Self <: PartialStepButtonProps] (val x: Self) extends AnyVal {
