...
trait PartialClassNameMapSwitchChecked extends StObject {
...
object PartialClassNameMapSwitchChecked {
  ...
  @scala.inline
  implicit class PartialClassNameMapSwitchCheckedMutableBuilder[Self <: PartialClassNameMapSwitchChecked] (val x: Self) extends AnyVal {
