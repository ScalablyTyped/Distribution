...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/TableCell/TableCell.TableCellClassKey>> */
trait PartialClassNameMapTableC extends StObject {
...
object PartialClassNameMapTableC {
  ...
  inline def apply(): PartialClassNameMapTableC = {
  ...
  extension [Self <: PartialClassNameMapTableC](x: Self) {
    ...
    inline def setAlignJustifyUndefined: Self = StObject.set(x, "alignJustify", js.undefined)
