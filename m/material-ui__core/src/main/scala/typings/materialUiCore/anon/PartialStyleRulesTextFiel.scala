...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/styles/withStyles.StyleRules<@material-ui/core.@material-ui/core/TextField.TextFieldClassKey, {}>> */
trait PartialStyleRulesTextFiel extends StObject {
  
  var root: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
}
object PartialStyleRulesTextFiel {
  
  inline def apply(): PartialStyleRulesTextFiel = {
