...
trait PartialSvgIconProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapSvgIco] = js.undefined
...
object PartialSvgIconProps {
  ...
  inline def apply(): PartialSvgIconProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSvgIconProps]
  }
  
  extension [Self <: PartialSvgIconProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapSvgIco): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[SvgIconProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    inline def setNativeColor(value: String): Self = StObject.set(x, "nativeColor", value.asInstanceOf[js.Any])
    
    inline def setNativeColorUndefined: Self = StObject.set(x, "nativeColor", js.undefined)
