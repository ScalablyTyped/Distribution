...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/OutlinedInput.OutlinedInputProps> */
@js.native
trait PartialOutlinedInputProps extends StObject {
...
object PartialOutlinedInputProps {
  
  @scala.inline
  def apply(): PartialOutlinedInputProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialOutlinedInputProps]
  }
  
  @scala.inline
  implicit class PartialOutlinedInputPropsMutableBuilder[Self <: PartialOutlinedInputProps] (val x: Self) extends AnyVal {
