...
@js.native
trait PartialOutlinedInputProps extends js.Object {
...
object PartialOutlinedInputProps {
  ...
  @scala.inline
  implicit class PartialOutlinedInputPropsOps[Self <: PartialOutlinedInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapOutlin): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInputComponent(value: ReactType[InputBaseComponentProps]): Self = this.set("inputComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInputProps(value: InputBaseComponentProps): Self = this.set("inputProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInputRef(value: Ref[_] | RefObject[_]): Self = this.set("inputRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMargin(value: dense | none): Self = this.set("margin", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteNotched: Self = this.set("notched", js.undefined)
    ...
    @scala.inline
    def setOnChange(value: ChangeEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def deleteOnFilled: Self = this.set("onFilled", js.undefined)
    ...
    @scala.inline
    def setOnKeyDown(value: KeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnKeyUp(value: KeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit): Self = this.set("onKeyUp", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderPrefix(value: /* state */ Disabled => ReactNode): Self = this.set("renderPrefix", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRows(value: String | Double): Self = this.set("rows", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRows: Self = this.set("rows", js.undefined)
    
    @scala.inline
    def setRowsMax(value: String | Double): Self = this.set("rowsMax", value.asInstanceOf[js.Any])
