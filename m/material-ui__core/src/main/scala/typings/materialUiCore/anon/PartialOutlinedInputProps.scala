...
object PartialOutlinedInputProps {
  ...
  def apply(
    ...
    inputRef: js.UndefOr[Null | Ref[_] | RefObject[_]] = js.undefined,
    is: String = null,
    itemID: String = null,
    ...
    renderPrefix: /* state */ Disabled => ReactNode = null,
    ...
    if (!js.isUndefined(notched)) __obj.updateDynamic("notched")(notched.get.asInstanceOf[js.Any])
