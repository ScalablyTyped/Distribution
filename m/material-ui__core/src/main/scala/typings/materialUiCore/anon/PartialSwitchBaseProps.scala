...
trait PartialSwitchBaseProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapSwitchChecked] = js.undefined
...
object PartialSwitchBaseProps {
  ...
  @scala.inline
  implicit class PartialSwitchBasePropsMutableBuilder[Self <: PartialSwitchBaseProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChecked(value: Boolean | String): Self = StObject.set(x, "checked", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSwitchChecked): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInputProps(value: InputHTMLAttributes[HTMLInputElement]): Self = StObject.set(x, "inputProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: (/* event */ ChangeEvent[HTMLInputElement], /* checked */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
