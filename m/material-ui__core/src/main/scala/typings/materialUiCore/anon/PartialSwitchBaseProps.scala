...
object PartialSwitchBaseProps {
  ...
  inline def apply(): PartialSwitchBaseProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSwitchBaseProps]
  }
  
  extension [Self <: PartialSwitchBaseProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapSwitchChecked): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
