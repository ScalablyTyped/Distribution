...
object PartialMenuProps {
  ...
  def apply(
    ...
    ModalClasses: PartialClassNameMapModalC = null,
    PaperProps: PartialPaperProps = null,
    PopoverClasses: PartialClassNameMapPopove = null,
    ...
    classes: PartialClassNameMapMenuCl = null,
    ...
    if (MenuListProps != null) __obj.updateDynamic("MenuListProps")(MenuListProps.asInstanceOf[js.Any])
    ...
    if (PopoverClasses != null) __obj.updateDynamic("PopoverClasses")(PopoverClasses.asInstanceOf[js.Any])
    ...
    if (anchorReference != null) __obj.updateDynamic("anchorReference")(anchorReference.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(closeAfterTransition)) __obj.updateDynamic("closeAfterTransition")(closeAfterTransition.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(disableAutoFocusItem)) __obj.updateDynamic("disableAutoFocusItem")(disableAutoFocusItem.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disableBackdropClick)) __obj.updateDynamic("disableBackdropClick")(disableBackdropClick.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disableEnforceFocus)) __obj.updateDynamic("disableEnforceFocus")(disableEnforceFocus.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disableEscapeKeyDown)) __obj.updateDynamic("disableEscapeKeyDown")(disableEscapeKeyDown.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disablePortal)) __obj.updateDynamic("disablePortal")(disablePortal.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disableRestoreFocus)) __obj.updateDynamic("disableRestoreFocus")(disableRestoreFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(hideBackdrop)) __obj.updateDynamic("hideBackdrop")(hideBackdrop.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(keepMounted)) __obj.updateDynamic("keepMounted")(keepMounted.get.asInstanceOf[js.Any])
    if (lang != null) __obj.updateDynamic("lang")(lang.asInstanceOf[js.Any])
    if (manager != null) __obj.updateDynamic("manager")(manager.asInstanceOf[js.Any])
    if (manifest != null) __obj.updateDynamic("manifest")(manifest.asInstanceOf[js.Any])
    if (!js.isUndefined(marginThreshold)) __obj.updateDynamic("marginThreshold")(marginThreshold.get.asInstanceOf[js.Any])
