...
object PartialMenuProps {
  ...
  extension [Self <: PartialMenuProps](x: Self) {
    ...
    inline def setAnchorOrigin(value: PopoverOrigin): Self = StObject.set(x, "anchorOrigin", value.asInstanceOf[js.Any])
    
    inline def setAnchorOriginUndefined: Self = StObject.set(x, "anchorOrigin", js.undefined)
    
    inline def setAnchorPosition(value: PopoverPosition): Self = StObject.set(x, "anchorPosition", value.asInstanceOf[js.Any])
    
    inline def setAnchorPositionUndefined: Self = StObject.set(x, "anchorPosition", js.undefined)
    
    inline def setAnchorReference(value: PopoverReference): Self = StObject.set(x, "anchorReference", value.asInstanceOf[js.Any])
    
    inline def setAnchorReferenceUndefined: Self = StObject.set(x, "anchorReference", js.undefined)
    ...
    inline def setDisableAutoFocusItem(value: Boolean): Self = StObject.set(x, "disableAutoFocusItem", value.asInstanceOf[js.Any])
    
    inline def setDisableAutoFocusItemUndefined: Self = StObject.set(x, "disableAutoFocusItem", js.undefined)
    ...
    inline def setGetContentAnchorElUndefined: Self = StObject.set(x, "getContentAnchorEl", js.undefined)
    ...
    inline def setTransformOrigin(value: PopoverOrigin): Self = StObject.set(x, "transformOrigin", value.asInstanceOf[js.Any])
