...
trait PartialMenuProps extends StObject {
  ...
  var MenuListProps: js.UndefOr[PartialMenuListProps] = js.native
...
object PartialMenuProps {
  ...
  @scala.inline
  def apply(): PartialMenuProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuProps]
  }
  
  @scala.inline
  implicit class PartialMenuPropsMutableBuilder[Self <: PartialMenuProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMenuListProps(value: PartialMenuListProps): Self = StObject.set(x, "MenuListProps", value.asInstanceOf[js.Any])
