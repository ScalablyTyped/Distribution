...
object PartialStyleRulesFabClass {
  ...
  implicit open class MutableBuilder[Self <: PartialStyleRulesFabClass] (val x: Self) extends AnyVal {
    ...
    inline def setExtended(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "extended", value.asInstanceOf[js.Any])
    
    inline def setExtendedFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "extended", js.Any.fromFunction1(value))
    ...
    inline def setSizeMedium(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "sizeMedium", value.asInstanceOf[js.Any])
    
    inline def setSizeMediumFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "sizeMedium", js.Any.fromFunction1(value))
