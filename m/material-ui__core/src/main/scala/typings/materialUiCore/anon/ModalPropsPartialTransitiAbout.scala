...
trait ModalPropsPartialTransitiAbout extends StObject {
...
object ModalPropsPartialTransitiAbout {
  
  inline def apply(children: ReactElement, open: Boolean): ModalPropsPartialTransitiAbout = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[ModalPropsPartialTransitiAbout]
  }
  
  extension [Self <: ModalPropsPartialTransitiAbout](x: Self) {
