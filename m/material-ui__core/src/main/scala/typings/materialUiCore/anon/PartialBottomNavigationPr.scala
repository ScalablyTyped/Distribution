...
trait PartialBottomNavigationPr extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapBottom] = js.undefined
...
object PartialBottomNavigationPr {
  ...
  inline def apply(): PartialBottomNavigationPr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBottomNavigationPr]
  }
  
  extension [Self <: PartialBottomNavigationPr](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapBottom): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[BottomNavigationProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
