...
object PartialBottomNavigationPr {
  ...
  @scala.inline
  implicit class PartialBottomNavigationPrMutableBuilder[Self <: PartialBottomNavigationPr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapBottom): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[BottomNavigationProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
