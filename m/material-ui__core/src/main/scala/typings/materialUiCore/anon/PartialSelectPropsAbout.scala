...
trait PartialSelectPropsAbout extends StObject {
  
  var IconComponent: js.UndefOr[ReactType[js.Any]] = js.undefined
  
  var MenuProps: js.UndefOr[PartialMenuPropsAccessKey] = js.undefined
...
object PartialSelectPropsAbout {
  ...
  @scala.inline
  def apply(): PartialSelectPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSelectPropsAbout]
  }
  
  @scala.inline
  implicit class PartialSelectPropsAboutMutableBuilder[Self <: PartialSelectPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSelect): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInput(value: ReactNode): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMenuProps(value: PartialMenuPropsAccessKey): Self = StObject.set(x, "MenuProps", value.asInstanceOf[js.Any])
