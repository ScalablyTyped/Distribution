...
object PartialSelectPropsAbout {
  ...
  inline def apply(): PartialSelectPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSelectPropsAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSelectPropsAbout] (val x: Self) extends AnyVal {
    ...
    inline def setMenuProps(value: PartialMenuPropsAccessKey): Self = StObject.set(x, "MenuProps", value.asInstanceOf[js.Any])
