...
object PartialSelectPropsAbout {
  ...
  @scala.inline
  implicit class PartialSelectPropsAboutOps[Self <: PartialSelectPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMenuProps(value: PartialMenuPropsAccessKey): Self = this.set("MenuProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSelect): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInput(value: ReactNode): Self = this.set("input", value.asInstanceOf[js.Any])
