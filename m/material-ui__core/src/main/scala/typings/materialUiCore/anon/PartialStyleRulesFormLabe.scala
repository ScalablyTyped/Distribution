...
trait PartialStyleRulesFormLabe extends StObject {
...
object PartialStyleRulesFormLabe {
  ...
  inline def apply(): PartialStyleRulesFormLabe = {
  ...
  implicit open class MutableBuilder[Self <: PartialStyleRulesFormLabe] (val x: Self) extends AnyVal {
    ...
    ): Self = StObject.set(x, "asterisk", value.asInstanceOf[js.Any])
    
    inline def setAsteriskFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "asterisk", js.Any.fromFunction1(value))
    ...
    inline def setFilled(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "filled", value.asInstanceOf[js.Any])
    
    inline def setFilledFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "filled", js.Any.fromFunction1(value))
    ...
    inline def setRequiredFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "required", js.Any.fromFunction1(value))
