...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/OutlinedInput/NotchedOutline.NotchedOutlineClassKey>> */
...
object PartialClassNameMapNotche {
  ...
  inline def apply(): PartialClassNameMapNotche = {
