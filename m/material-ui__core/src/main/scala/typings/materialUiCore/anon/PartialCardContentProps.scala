...
object PartialCardContentProps {
  ...
  inline def apply(): PartialCardContentProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardContentProps]
  }
  
  extension [Self <: PartialCardContentProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapCardCo): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[CardContentProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
