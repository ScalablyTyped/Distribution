...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/CardContent.CardContentProps> */
trait PartialCardContentProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapCardCo] = js.undefined
  
  var color: js.UndefOr[String] = js.undefined
  
  var component: js.UndefOr[ReactType[CardContentProps]] = js.undefined
...
object PartialCardContentProps {
  
  @scala.inline
  def apply(): PartialCardContentProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardContentProps]
  }
  
  @scala.inline
  implicit class PartialCardContentPropsMutableBuilder[Self <: PartialCardContentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCardCo): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[CardContentProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
