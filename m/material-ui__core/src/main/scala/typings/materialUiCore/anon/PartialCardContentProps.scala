...
@js.native
trait PartialCardContentProps extends js.Object {
...
object PartialCardContentProps {
  ...
  @scala.inline
  implicit class PartialCardContentPropsOps[Self <: PartialCardContentProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCardCo): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponent(value: ReactType[CardContentProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
