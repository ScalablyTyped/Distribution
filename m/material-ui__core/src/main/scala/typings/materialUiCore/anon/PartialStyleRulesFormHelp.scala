...
object PartialStyleRulesFormHelp {
  ...
  inline def apply(): PartialStyleRulesFormHelp = {
  ...
  extension [Self <: PartialStyleRulesFormHelp](x: Self) {
    ...
    inline def setContained(value: CSSProperties): Self = StObject.set(x, "contained", value.asInstanceOf[js.Any])
    ...
    inline def setRequired(value: CSSProperties): Self = StObject.set(x, "required", value.asInstanceOf[js.Any])
