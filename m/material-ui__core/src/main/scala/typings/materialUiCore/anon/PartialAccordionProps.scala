...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Accordion.AccordionProps> */
trait PartialAccordionProps extends StObject {
  ...
  var children: js.UndefOr[NonNullable[ReactNode]] = js.undefined
  
  var className: js.UndefOr[String] = js.undefined
  
  var classes: js.UndefOr[PartialClassNameMapAccord] = js.undefined
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[js.Object], /* expanded */ Boolean, Unit]] = js.undefined
...
object PartialAccordionProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAccordionProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialClassNameMapAccord): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* expanded */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
