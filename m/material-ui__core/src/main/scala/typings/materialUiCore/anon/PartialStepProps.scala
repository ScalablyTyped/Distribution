...
trait PartialStepProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapStepCl] = js.undefined
...
object PartialStepProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialStepProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialClassNameMapStepCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
