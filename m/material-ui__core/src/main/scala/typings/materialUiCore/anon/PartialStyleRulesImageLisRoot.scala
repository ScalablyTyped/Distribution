...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/styles/withStyles.StyleRules<@material-ui/core.@material-ui/core/ImageList.ImageListClassKey, {}>> */
trait PartialStyleRulesImageLisRoot extends StObject {
  
  var root: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
}
object PartialStyleRulesImageLisRoot {
  
  inline def apply(): PartialStyleRulesImageLisRoot = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStyleRulesImageLisRoot]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialStyleRulesImageLisRoot] (val x: Self) extends AnyVal {
