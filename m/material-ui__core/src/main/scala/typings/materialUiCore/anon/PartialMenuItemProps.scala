...
object PartialMenuItemProps {
  ...
  inline def apply(): PartialMenuItemProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuItemProps]
  }
  
  extension [Self <: PartialMenuItemProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapMenuIt): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[MenuItemProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    inline def setComponentUndefined: Self = StObject.set(x, "component", js.undefined)
    
    inline def setContainerComponent(value: ReactType[HTMLAttributes[HTMLDivElement]]): Self = StObject.set(x, "ContainerComponent", value.asInstanceOf[js.Any])
