...
trait PartialMenuItemProps extends StObject {
  
  var ContainerComponent: js.UndefOr[ReactType[HTMLAttributes[HTMLDivElement]]] = js.undefined
  ...
  var classes: js.UndefOr[PartialClassNameMapMenuIt] = js.undefined
...
object PartialMenuItemProps {
  ...
  @scala.inline
  implicit class PartialMenuItemPropsMutableBuilder[Self <: PartialMenuItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapMenuIt): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[MenuItemProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
