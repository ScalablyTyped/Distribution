...
object PartialMenuItemProps {
  ...
  @scala.inline
  def apply(): PartialMenuItemProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuItemProps]
  }
  
  @scala.inline
  implicit class PartialMenuItemPropsOps[Self <: PartialMenuItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainerComponent(value: ReactType[HTMLAttributes[HTMLDivElement]]): Self = this.set("ContainerComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteContainerComponent: Self = this.set("ContainerComponent", js.undefined)
    
    @scala.inline
    def setContainerProps(value: HTMLAttributes[HTMLDivElement]): Self = this.set("ContainerProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAlignItems(value: `flex-start` | center): Self = this.set("alignItems", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapMenuIt): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[MenuItemProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDisableGutters(value: Boolean): Self = this.set("disableGutters", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDisableGutters: Self = this.set("disableGutters", js.undefined)
