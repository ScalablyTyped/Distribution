...
object PartialMenuListPropsAbout {
  ...
  inline def apply(): PartialMenuListPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuListPropsAbout]
  }
  
  extension [Self <: PartialMenuListPropsAbout](x: Self) {
    ...
    inline def setClasses(value: Partial[ClassNameMap[MenuListClassKey]]): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
