...
trait PartialMenuListPropsAbout extends StObject {
  ...
  var classes: js.UndefOr[Partial[ClassNameMap[MenuListClassKey]]] = js.undefined
...
object PartialMenuListPropsAbout {
  ...
  @scala.inline
  def apply(): PartialMenuListPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuListPropsAbout]
  }
  
  @scala.inline
  implicit class PartialMenuListPropsAboutMutableBuilder[Self <: PartialMenuListPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: Partial[ClassNameMap[MenuListClassKey]]): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
