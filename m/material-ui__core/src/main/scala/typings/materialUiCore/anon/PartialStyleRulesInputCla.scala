...
trait PartialStyleRulesInputCla extends StObject {
  ...
  var inputMarginDense: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
  
  var inputMultiline: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
  
  var inputTypeSearch: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
...
object PartialStyleRulesInputCla {
  ...
  inline def apply(): PartialStyleRulesInputCla = {
  ...
  extension [Self <: PartialStyleRulesInputCla](x: Self) {
    ...
    inline def setFormControl(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "formControl", value.asInstanceOf[js.Any])
    
    inline def setFormControlFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "formControl", js.Any.fromFunction1(value))
    ...
    inline def setInputMarginDense(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "inputMarginDense", value.asInstanceOf[js.Any])
    
    inline def setInputMarginDenseFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "inputMarginDense", js.Any.fromFunction1(value))
    
    inline def setInputMarginDenseUndefined: Self = StObject.set(x, "inputMarginDense", js.undefined)
    
    inline def setInputMultiline(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "inputMultiline", value.asInstanceOf[js.Any])
    
    inline def setInputMultilineFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "inputMultiline", js.Any.fromFunction1(value))
    
    inline def setInputMultilineUndefined: Self = StObject.set(x, "inputMultiline", js.undefined)
    
    inline def setInputTypeSearch(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "inputTypeSearch", value.asInstanceOf[js.Any])
    
    inline def setInputTypeSearchFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "inputTypeSearch", js.Any.fromFunction1(value))
    ...
    inline def setUnderlineFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "underline", js.Any.fromFunction1(value))
