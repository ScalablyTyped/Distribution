...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/InputBase.InputBaseProps> */
trait PartialInputBaseProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapInputB] = js.undefined
...
object PartialInputBaseProps {
  ...
  extension [Self <: PartialInputBaseProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapInputB): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
