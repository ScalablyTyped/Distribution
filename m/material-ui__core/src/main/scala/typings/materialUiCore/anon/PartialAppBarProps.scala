...
import typings.materialUiCore.materialUiCoreStrings.transparent
...
trait PartialAppBarProps extends StObject {
  ...
  var color: js.UndefOr[typings.materialUiCore.mod.PropTypes.Color | transparent] = js.undefined
...
object PartialAppBarProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAppBarProps] (val x: Self) extends AnyVal {
    ...
    inline def setColor(value: typings.materialUiCore.mod.PropTypes.Color | transparent): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
