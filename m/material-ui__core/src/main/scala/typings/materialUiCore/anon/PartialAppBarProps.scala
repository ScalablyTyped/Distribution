...
object PartialAppBarProps {
  ...
  @scala.inline
  def apply(): PartialAppBarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAppBarProps]
  }
  
  @scala.inline
  implicit class PartialAppBarPropsMutableBuilder[Self <: PartialAppBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapAppBar): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
