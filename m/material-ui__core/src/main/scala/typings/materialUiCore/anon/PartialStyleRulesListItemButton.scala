...
trait PartialStyleRulesListItemButton extends StObject {
  ...
  var secondaryAction: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
...
object PartialStyleRulesListItemButton {
  ...
  inline def apply(): PartialStyleRulesListItemButton = {
  ...
  extension [Self <: PartialStyleRulesListItemButton](x: Self) {
    ...
    inline def setDefaultFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "default", js.Any.fromFunction1(value))
    ...
    inline def setDividerFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "divider", js.Any.fromFunction1(value))
    ...
    inline def setSecondaryAction(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "secondaryAction", value.asInstanceOf[js.Any])
    
    inline def setSecondaryActionFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "secondaryAction", js.Any.fromFunction1(value))
