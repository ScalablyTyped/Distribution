...
trait PartialStyleRulesStepConn extends StObject {
  ...
  var lineHorizontal: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
  
  var lineVertical: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
...
object PartialStyleRulesStepConn {
  ...
  inline def apply(): PartialStyleRulesStepConn = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStyleRulesStepConn]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialStyleRulesStepConn] (val x: Self) extends AnyVal {
    ...
    inline def setLineFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "line", js.Any.fromFunction1(value))
    
    inline def setLineHorizontal(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "lineHorizontal", value.asInstanceOf[js.Any])
    
    inline def setLineHorizontalFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "lineHorizontal", js.Any.fromFunction1(value))
    
    inline def setLineHorizontalUndefined: Self = StObject.set(x, "lineHorizontal", js.undefined)
    
    inline def setLineUndefined: Self = StObject.set(x, "line", js.undefined)
    
    inline def setLineVertical(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "lineVertical", value.asInstanceOf[js.Any])
    
    inline def setLineVerticalFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "lineVertical", js.Any.fromFunction1(value))
