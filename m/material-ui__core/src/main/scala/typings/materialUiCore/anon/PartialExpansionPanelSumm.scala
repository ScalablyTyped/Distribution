...
@js.native
trait PartialExpansionPanelSumm extends js.Object {
...
object PartialExpansionPanelSumm {
  @scala.inline
  def apply(): PartialExpansionPanelSumm = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialExpansionPanelSumm]
  }
  @scala.inline
  implicit class PartialExpansionPanelSummOps[Self <: PartialExpansionPanelSumm] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setIconButtonProps(value: PartialIconButtonProps): Self = this.set("IconButtonProps", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapExpansContent): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[js.Object, Event] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    @scala.inline
