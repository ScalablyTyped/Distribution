...
@js.native
trait PartialExpansionPanelSumm extends StObject {
...
object PartialExpansionPanelSumm {
  ...
  @scala.inline
  implicit class PartialExpansionPanelSummMutableBuilder[Self <: PartialExpansionPanelSumm] (val x: Self) extends AnyVal {
