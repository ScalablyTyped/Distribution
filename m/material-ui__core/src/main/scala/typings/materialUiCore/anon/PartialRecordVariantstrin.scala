...
/* Inlined std.Partial<std.Record<@material-ui/core.@material-ui/core/Typography/Typography.Variant, string>> */
trait PartialRecordVariantstrin extends StObject {
...
object PartialRecordVariantstrin {
  
  inline def apply(): PartialRecordVariantstrin = {
  ...
  implicit open class MutableBuilder[Self <: PartialRecordVariantstrin] (val x: Self) extends AnyVal {
    ...
    inline def setSrOnly(value: String): Self = StObject.set(x, "srOnly", value.asInstanceOf[js.Any])
