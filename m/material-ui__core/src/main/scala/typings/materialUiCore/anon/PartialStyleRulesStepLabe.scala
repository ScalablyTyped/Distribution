...
object PartialStyleRulesStepLabe {
  ...
  inline def apply(): PartialStyleRulesStepLabe = {
  ...
  extension [Self <: PartialStyleRulesStepLabe](x: Self) {
    ...
    inline def setIconContainerFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "iconContainer", js.Any.fromFunction1(value))
    ...
    inline def setLabelContainer(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "labelContainer", value.asInstanceOf[js.Any])
    
    inline def setLabelContainerFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "labelContainer", js.Any.fromFunction1(value))
