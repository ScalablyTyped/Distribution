...
object PartialBottomNavigationAc {
  ...
  implicit class PartialBottomNavigationAcOps[Self <: PartialBottomNavigationAc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapBottomIconOnly): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClick(value: SyntheticEvent[_, Event] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
