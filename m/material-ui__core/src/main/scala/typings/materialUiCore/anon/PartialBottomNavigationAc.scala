...
object PartialBottomNavigationAc {
  ...
  @scala.inline
  implicit class PartialBottomNavigationAcMutableBuilder[Self <: PartialBottomNavigationAc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapBottomIconOnly): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClick(value: SyntheticEvent[js.Any, Event] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
