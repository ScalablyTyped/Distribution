...
trait PartialBottomNavigationAc extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapBottomIconOnly] = js.undefined
  ...
  var onClick: js.UndefOr[ReactEventHandler[js.Any]] = js.undefined
...
object PartialBottomNavigationAc {
  ...
  inline def apply(): PartialBottomNavigationAc = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBottomNavigationAc]
  }
  
  extension [Self <: PartialBottomNavigationAc](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapBottomIconOnly): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setOnClick(value: SyntheticEvent[js.Any, Event] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
