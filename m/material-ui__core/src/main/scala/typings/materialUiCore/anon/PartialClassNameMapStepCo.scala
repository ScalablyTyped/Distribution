...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/StepConnector/StepConnector.StepConnectorClasskey>> */
trait PartialClassNameMapStepCo extends StObject {
...
object PartialClassNameMapStepCo {
  ...
  inline def apply(): PartialClassNameMapStepCo = {
  ...
  extension [Self <: PartialClassNameMapStepCo](x: Self) {
    ...
    inline def setLineHorizontalUndefined: Self = StObject.set(x, "lineHorizontal", js.undefined)
    
    inline def setLineUndefined: Self = StObject.set(x, "line", js.undefined)
    
    inline def setLineVertical(value: String): Self = StObject.set(x, "lineVertical", value.asInstanceOf[js.Any])
    
    inline def setLineVerticalUndefined: Self = StObject.set(x, "lineVertical", js.undefined)
