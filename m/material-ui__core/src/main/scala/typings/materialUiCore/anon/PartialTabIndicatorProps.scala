...
trait PartialTabIndicatorProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapTabInd] = js.undefined
  ...
  var style: js.UndefOr[Left] = js.undefined
...
object PartialTabIndicatorProps {
  ...
  inline def apply(): PartialTabIndicatorProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabIndicatorProps]
  }
  
  extension [Self <: PartialTabIndicatorProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapTabInd): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    
    inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
    
    inline def setColor(value: secondary | primary | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
