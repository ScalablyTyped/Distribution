...
trait PartialTabIndicatorProps extends js.Object {
  ...
  var style: js.UndefOr[Left] = js.native
...
object PartialTabIndicatorProps {
  @scala.inline
  def apply(): PartialTabIndicatorProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabIndicatorProps]
  }
  @scala.inline
  implicit class PartialTabIndicatorPropsOps[Self <: PartialTabIndicatorProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTabInd): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    @scala.inline
    def setColor(value: secondary | primary | String): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
