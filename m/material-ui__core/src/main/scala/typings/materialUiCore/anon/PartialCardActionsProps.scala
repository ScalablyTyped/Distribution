...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/CardActions.CardActionsProps> */
trait PartialCardActionsProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapCardAcAction] = js.undefined
...
object PartialCardActionsProps {
  
  @scala.inline
  def apply(): PartialCardActionsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardActionsProps]
  }
  
  @scala.inline
  implicit class PartialCardActionsPropsMutableBuilder[Self <: PartialCardActionsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCardAcAction): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDisableActionSpacing(value: Boolean): Self = StObject.set(x, "disableActionSpacing", value.asInstanceOf[js.Any])
