...
trait PartialCardActionsProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapCardAc] = js.undefined
  ...
  var disableSpacing: js.UndefOr[Boolean] = js.undefined
...
object PartialCardActionsProps {
  ...
  inline def apply(): PartialCardActionsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCardActionsProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialCardActionsProps] (val x: Self) extends AnyVal {
    ...
    inline def setClasses(value: PartialClassNameMapCardAc): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setDisableSpacing(value: Boolean): Self = StObject.set(x, "disableSpacing", value.asInstanceOf[js.Any])
    
    inline def setDisableSpacingUndefined: Self = StObject.set(x, "disableSpacing", js.undefined)
