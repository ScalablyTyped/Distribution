...
object PartialCardActionsProps {
  ...
  extension [Self <: PartialCardActionsProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapCardAcAction): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setDisableActionSpacing(value: Boolean): Self = StObject.set(x, "disableActionSpacing", value.asInstanceOf[js.Any])
