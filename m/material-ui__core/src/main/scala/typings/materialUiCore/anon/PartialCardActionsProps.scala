...
@js.native
trait PartialCardActionsProps extends js.Object {
...
object PartialCardActionsProps {
  ...
  @scala.inline
  implicit class PartialCardActionsPropsOps[Self <: PartialCardActionsProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCardAcAction): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
