...
object PartialGridProps {
  ...
  inline def apply(): PartialGridProps = {
  ...
  extension [Self <: PartialGridProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapGridCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: String | ComponentType[OmitGridPropsStrippedProp]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
