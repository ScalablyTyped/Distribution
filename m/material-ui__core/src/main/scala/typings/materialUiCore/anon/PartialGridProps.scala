...
@js.native
trait PartialGridProps extends StObject {
...
object PartialGridProps {
  ...
  @scala.inline
  implicit class PartialGridPropsMutableBuilder[Self <: PartialGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlignContent(value: GridContentAlignment): Self = StObject.set(x, "alignContent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAlignContentUndefined: Self = StObject.set(x, "alignContent", js.undefined)
    
    @scala.inline
    def setAlignItems(value: GridItemsAlignment): Self = StObject.set(x, "alignItems", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapGridCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: String | ComponentType[OmitGridPropsStrippedProp]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJustify(value: GridJustification): Self = StObject.set(x, "justify", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSpacing(value: GridSpacing): Self = StObject.set(x, "spacing", value.asInstanceOf[js.Any])
