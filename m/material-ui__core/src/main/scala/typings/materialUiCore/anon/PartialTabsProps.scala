...
trait PartialTabsProps extends StObject {
  ...
  var ScrollButtonComponent: js.UndefOr[ReactType[js.Any]] = js.undefined
  ...
  var classes: js.UndefOr[PartialClassNameMapTabsCl] = js.undefined
...
object PartialTabsProps {
  ...
  extension [Self <: PartialTabsProps](x: Self) {
    ...
    inline def setAction(value: /* actions */ TabsActions => Unit): Self = StObject.set(x, "action", js.Any.fromFunction1(value))
    ...
    inline def setClasses(value: PartialClassNameMapTabsCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[TabsProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    inline def setIndicatorColor(value: secondary | primary | String): Self = StObject.set(x, "indicatorColor", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* value */ js.Any) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
    ...
    inline def setScrollButtonComponent(value: ReactType[js.Any]): Self = StObject.set(x, "ScrollButtonComponent", value.asInstanceOf[js.Any])
    
    inline def setScrollButtonComponentUndefined: Self = StObject.set(x, "ScrollButtonComponent", js.undefined)
    
    inline def setScrollButtons(value: auto | on | off): Self = StObject.set(x, "scrollButtons", value.asInstanceOf[js.Any])
    ...
    inline def setTabIndicatorProps(value: PartialTabIndicatorProps): Self = StObject.set(x, "TabIndicatorProps", value.asInstanceOf[js.Any])
    ...
    inline def setTextColor(value: secondary | primary | inherit | String): Self = StObject.set(x, "textColor", value.asInstanceOf[js.Any])
