...
object PartialExpansionPanelProp {
  ...
  implicit class PartialExpansionPanelPropOps[Self <: PartialExpansionPanelProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCollapseProps(value: PartialCollapseProps): Self = this.set("CollapseProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCollapseProps: Self = this.set("CollapseProps", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapExpans): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* expanded */ Boolean) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    @scala.inline
