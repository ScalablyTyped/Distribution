...
trait PartialExpansionPanelProp extends StObject {
...
object PartialExpansionPanelProp {
  ...
  @scala.inline
  implicit class PartialExpansionPanelPropMutableBuilder[Self <: PartialExpansionPanelProp] (val x: Self) extends AnyVal {
