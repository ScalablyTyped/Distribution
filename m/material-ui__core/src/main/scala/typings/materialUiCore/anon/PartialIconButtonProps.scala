...
object PartialIconButtonProps {
  ...
  inline def apply(): PartialIconButtonProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconButtonProps]
  }
  
  extension [Self <: PartialIconButtonProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapIconBu): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
