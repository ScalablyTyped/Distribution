...
trait PartialIconButtonProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapIconBu] = js.undefined
...
object PartialIconButtonProps {
  ...
  @scala.inline
  def apply(): PartialIconButtonProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconButtonProps]
  }
  
  @scala.inline
  implicit class PartialIconButtonPropsMutableBuilder[Self <: PartialIconButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapIconBu): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
