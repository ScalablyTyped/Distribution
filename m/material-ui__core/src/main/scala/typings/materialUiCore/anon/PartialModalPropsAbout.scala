...
object PartialModalPropsAbout {
  ...
  @scala.inline
  implicit class PartialModalPropsAboutOps[Self <: PartialModalPropsAbout] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBackdropProps(value: PartialBackdropPropsAbout): Self = this.set("BackdropProps", value.asInstanceOf[js.Any])
    @scala.inline
