...
trait PartialModalPropsAbout extends StObject {
...
object PartialModalPropsAbout {
  
  @scala.inline
  def apply(): PartialModalPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialModalPropsAbout]
  }
  
  @scala.inline
  implicit class PartialModalPropsAboutMutableBuilder[Self <: PartialModalPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapModalC): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
