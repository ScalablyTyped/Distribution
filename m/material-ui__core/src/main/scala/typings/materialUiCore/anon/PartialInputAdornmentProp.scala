...
object PartialInputAdornmentProp {
  ...
  inline def apply(): PartialInputAdornmentProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInputAdornmentProp]
  }
  
  extension [Self <: PartialInputAdornmentProp](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapInputA): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[InputAdornmentProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
