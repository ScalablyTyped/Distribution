...
trait PartialInputAdornmentProp extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapInputA] = js.undefined
...
object PartialInputAdornmentProp {
  ...
  @scala.inline
  implicit class PartialInputAdornmentPropMutableBuilder[Self <: PartialInputAdornmentProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapInputA): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[InputAdornmentProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
