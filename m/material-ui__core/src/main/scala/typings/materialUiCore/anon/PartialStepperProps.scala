...
object PartialStepperProps {
  ...
  @scala.inline
  implicit class PartialStepperPropsOps[Self <: PartialStepperProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSteppe): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setConnector(value: ReactElement | ReactNode): Self = this.set("connector", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNonLinear(value: Boolean): Self = this.set("nonLinear", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteNonLinear: Self = this.set("nonLinear", js.undefined)
    @scala.inline
