...
object PartialStyleRulesSwitchCl {
  ...
  @scala.inline
  def apply(): PartialStyleRulesSwitchCl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStyleRulesSwitchCl]
  }
  
  @scala.inline
  implicit class PartialStyleRulesSwitchClMutableBuilder[Self <: PartialStyleRulesSwitchCl] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBar(value: CSSProperties): Self = StObject.set(x, "bar", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIconChecked(value: CSSProperties): Self = StObject.set(x, "iconChecked", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSwitchBase(value: CSSProperties): Self = StObject.set(x, "switchBase", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSwitchBaseUndefined: Self = StObject.set(x, "switchBase", js.undefined)
  }
}
