...
trait PartialStyleRulesSwitchCl extends StObject {
  ...
  var sizeSmall: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
  
  var switchBase: js.UndefOr[
    CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
  ] = js.undefined
...
object PartialStyleRulesSwitchCl {
  ...
  inline def apply(): PartialStyleRulesSwitchCl = {
  ...
  extension [Self <: PartialStyleRulesSwitchCl](x: Self) {
    ...
    inline def setSizeSmall(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "sizeSmall", value.asInstanceOf[js.Any])
    
    inline def setSizeSmallFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "sizeSmall", js.Any.fromFunction1(value))
    
    inline def setSizeSmallUndefined: Self = StObject.set(x, "sizeSmall", js.undefined)
    
    inline def setSwitchBase(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "switchBase", value.asInstanceOf[js.Any])
    
    inline def setSwitchBaseFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "switchBase", js.Any.fromFunction1(value))
    
    inline def setSwitchBaseUndefined: Self = StObject.set(x, "switchBase", js.undefined)
    
    inline def setThumb(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "thumb", value.asInstanceOf[js.Any])
    
    inline def setThumbFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "thumb", js.Any.fromFunction1(value))
    ...
    inline def setTrackFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "track", js.Any.fromFunction1(value))
