...
object PartialNativeSelectProps {
  ...
  @scala.inline
  implicit class PartialNativeSelectPropsOps[Self <: PartialNativeSelectProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapNative): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
