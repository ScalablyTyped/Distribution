...
trait PartialTableSortLabelProp extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapTableS] = js.undefined
...
object PartialTableSortLabelProp {
  ...
  inline def apply(): PartialTableSortLabelProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTableSortLabelProp]
  }
  
  extension [Self <: PartialTableSortLabelProp](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapTableS): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setIconComponent(value: ComponentType[SvgIconProps]): Self = StObject.set(x, "IconComponent", value.asInstanceOf[js.Any])
