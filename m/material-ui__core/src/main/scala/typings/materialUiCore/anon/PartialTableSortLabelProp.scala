...
object PartialTableSortLabelProp {
  ...
  @scala.inline
  implicit class PartialTableSortLabelPropMutableBuilder[Self <: PartialTableSortLabelProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIconComponent(value: ComponentType[SvgIconProps]): Self = StObject.set(x, "IconComponent", value.asInstanceOf[js.Any])
