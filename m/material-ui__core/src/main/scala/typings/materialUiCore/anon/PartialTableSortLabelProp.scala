...
object PartialTableSortLabelProp {
  ...
  implicit class PartialTableSortLabelPropOps[Self <: PartialTableSortLabelProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIconComponent(value: ComponentType[SvgIconProps]): Self = this.set("IconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTableS): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setHideSortIcon(value: Boolean): Self = this.set("hideSortIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteHideSortIcon: Self = this.set("hideSortIcon", js.undefined)
    @scala.inline
