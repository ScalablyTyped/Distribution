...
trait PartialTypographyPropsAbout extends StObject {
  ...
  {[ type in @material-ui/core.@material-ui/core/Typography/Typography.Style ]: string}
    */ typings.materialUiCore.materialUiCoreStrings.PartialTypographyPropsAbout & TopLevel[js.Any]
  ] = js.undefined
...
object PartialTypographyPropsAbout {
  ...
  inline def apply(): PartialTypographyPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTypographyPropsAbout]
  }
  
  extension [Self <: PartialTypographyPropsAbout](x: Self) {
