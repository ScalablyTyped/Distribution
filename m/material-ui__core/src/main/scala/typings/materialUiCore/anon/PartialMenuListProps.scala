...
object PartialMenuListProps {
  ...
  @scala.inline
  implicit class PartialMenuListPropsOps[Self <: PartialMenuListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapMenuLi): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[ListProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnKeyDown(value: SyntheticEvent[KeyboardEvent[_], Event] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
