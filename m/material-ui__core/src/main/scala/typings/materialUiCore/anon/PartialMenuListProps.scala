...
object PartialMenuListProps {
  ...
  inline def apply(): PartialMenuListProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuListProps]
  }
  
  extension [Self <: PartialMenuListProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapMenuLi): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setComponent(value: ReactType[ListProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    inline def setOnKeyDown(value: SyntheticEvent[KeyboardEvent[js.Any], Event] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
