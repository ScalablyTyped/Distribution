...
trait PartialMenuListProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapMenuLi] = js.undefined
  ...
  var onKeyDown: js.UndefOr[ReactEventHandler[KeyboardEvent[js.Any]]] = js.undefined
...
object PartialMenuListProps {
  ...
  implicit class PartialMenuListPropsMutableBuilder[Self <: PartialMenuListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnKeyDown(value: SyntheticEvent[KeyboardEvent[js.Any], Event] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
