...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/FormControl.FormControlProps> */
@js.native
trait PartialFormControlProps extends StObject {
  ...
  var onBlur: js.UndefOr[EventHandler[_]] = js.native
  ...
  var onFocus: js.UndefOr[EventHandler[_]] = js.native
...
object PartialFormControlProps {
  
  @scala.inline
  def apply(): PartialFormControlProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFormControlProps]
  }
  
  @scala.inline
  implicit class PartialFormControlPropsMutableBuilder[Self <: PartialFormControlProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapFormCo): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[FormControlProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBlur(value: _ => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnFocus(value: _ => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
