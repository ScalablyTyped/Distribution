...
object PartialFormControlProps {
  ...
  inline def apply(): PartialFormControlProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFormControlProps]
  }
  
  extension [Self <: PartialFormControlProps](x: Self) {
    ...
    inline def setComponent(value: ReactType[FormControlProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
