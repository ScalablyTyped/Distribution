...
@js.native
trait PartialFormControlProps extends js.Object {
...
object PartialFormControlProps {
  ...
  @scala.inline
  implicit class PartialFormControlPropsOps[Self <: PartialFormControlProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapFormCo): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[FormControlProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBlur(value: _ => Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnFocus(value: _ => Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
