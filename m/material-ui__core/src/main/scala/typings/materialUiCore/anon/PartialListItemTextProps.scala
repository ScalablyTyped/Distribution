...
object PartialListItemTextProps {
  ...
  inline def apply(): PartialListItemTextProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemTextProps]
  }
  
  extension [Self <: PartialListItemTextProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapListItDense): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setPrimary(value: ReactNode): Self = StObject.set(x, "primary", value.asInstanceOf[js.Any])
    
    inline def setPrimaryTypographyProps(value: PartialTypographyPropsAbout): Self = StObject.set(x, "primaryTypographyProps", value.asInstanceOf[js.Any])
    ...
    inline def setSecondary(value: ReactNode): Self = StObject.set(x, "secondary", value.asInstanceOf[js.Any])
    
    inline def setSecondaryTypographyProps(value: PartialTypographyPropsAbout): Self = StObject.set(x, "secondaryTypographyProps", value.asInstanceOf[js.Any])
