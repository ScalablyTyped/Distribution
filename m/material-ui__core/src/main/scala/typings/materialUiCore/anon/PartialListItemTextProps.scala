...
object PartialListItemTextProps {
  ...
  def apply(
    ...
    if (primaryTypographyProps != null) __obj.updateDynamic("primaryTypographyProps")(primaryTypographyProps.asInstanceOf[js.Any])
    ...
    if (secondaryTypographyProps != null) __obj.updateDynamic("secondaryTypographyProps")(secondaryTypographyProps.asInstanceOf[js.Any])
