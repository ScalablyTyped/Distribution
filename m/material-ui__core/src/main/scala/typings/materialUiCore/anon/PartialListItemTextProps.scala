...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/ListItemText.ListItemTextProps> */
trait PartialListItemTextProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapListItDense] = js.undefined
  ...
  var primary: js.UndefOr[ReactNode] = js.undefined
  
  var primaryTypographyProps: js.UndefOr[PartialTypographyPropsAbout] = js.undefined
  ...
  var secondary: js.UndefOr[ReactNode] = js.undefined
  
  var secondaryTypographyProps: js.UndefOr[PartialTypographyPropsAbout] = js.undefined
...
object PartialListItemTextProps {
  
  @scala.inline
  def apply(): PartialListItemTextProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemTextProps]
  }
  
  @scala.inline
  implicit class PartialListItemTextPropsMutableBuilder[Self <: PartialListItemTextProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapListItDense): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrimary(value: ReactNode): Self = StObject.set(x, "primary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPrimaryTypographyProps(value: PartialTypographyPropsAbout): Self = StObject.set(x, "primaryTypographyProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPrimaryTypographyPropsUndefined: Self = StObject.set(x, "primaryTypographyProps", js.undefined)
    ...
    @scala.inline
    def setSecondary(value: ReactNode): Self = StObject.set(x, "secondary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSecondaryTypographyProps(value: PartialTypographyPropsAbout): Self = StObject.set(x, "secondaryTypographyProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSecondaryTypographyPropsUndefined: Self = StObject.set(x, "secondaryTypographyProps", js.undefined)
