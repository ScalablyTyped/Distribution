...
object PartialIconProps {
  ...
  implicit class PartialIconPropsMutableBuilder[Self <: PartialIconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapIconCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: ReactType[IconProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFontSize(value: inherit | default | small | large): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
