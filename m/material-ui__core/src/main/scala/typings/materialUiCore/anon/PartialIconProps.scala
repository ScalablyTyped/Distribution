...
object PartialIconProps {
  ...
  implicit class PartialIconPropsOps[Self <: PartialIconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapIconCl): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponent(value: ReactType[IconProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
