...
trait PartialIconProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapIconCl] = js.undefined
  
  var color: js.UndefOr[Color | action | disabled | error] = js.undefined
  
  var component: js.UndefOr[ReactType[IconProps]] = js.undefined
...
object PartialIconProps {
  ...
  extension [Self <: PartialIconProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapIconCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    
    inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
    
    inline def setColor(value: Color | action | disabled | error): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    
    inline def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
    
    inline def setComponent(value: ReactType[IconProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    inline def setFontSize(value: inherit | default | small | large): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
