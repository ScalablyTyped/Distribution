...
trait PartialTabProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapTabCla] = js.undefined
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[Checked], /* value */ js.Any, Unit]] = js.undefined
  
  var onClick: js.UndefOr[EventHandler[js.Any]] = js.undefined
...
object PartialTabProps {
  ...
  extension [Self <: PartialTabProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapTabCla): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: (/* event */ ChangeEvent[Checked], /* value */ js.Any) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
