...
trait PartialStyleRulesOutlined extends StObject {
...
object PartialStyleRulesOutlined {
  ...
  inline def apply(): PartialStyleRulesOutlined = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStyleRulesOutlined]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialStyleRulesOutlined] (val x: Self) extends AnyVal {
    ...
    inline def setNotchedOutline(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "notchedOutline", value.asInstanceOf[js.Any])
    
    inline def setNotchedOutlineFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "notchedOutline", js.Any.fromFunction1(value))
