...
object PartialStyleRulesOutlined {
  ...
  @scala.inline
  implicit class PartialStyleRulesOutlinedMutableBuilder[Self <: PartialStyleRulesOutlined] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotchedOutline(value: CSSProperties): Self = StObject.set(x, "notchedOutline", value.asInstanceOf[js.Any])
