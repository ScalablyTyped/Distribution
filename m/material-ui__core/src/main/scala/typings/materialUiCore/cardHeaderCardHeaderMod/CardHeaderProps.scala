...
object CardHeaderProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableTypography)) __obj.updateDynamic("disableTypography")(disableTypography.get.asInstanceOf[js.Any])
    ...
    if (subheaderTypographyProps != null) __obj.updateDynamic("subheaderTypographyProps")(subheaderTypographyProps.asInstanceOf[js.Any])
    ...
    if (titleTypographyProps != null) __obj.updateDynamic("titleTypographyProps")(titleTypographyProps.asInstanceOf[js.Any])
