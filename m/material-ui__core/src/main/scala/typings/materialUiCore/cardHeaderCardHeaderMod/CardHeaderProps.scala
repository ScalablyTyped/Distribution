...
import typings.materialUiCore.anon.PartialClassNameMapCardHe
import typings.materialUiCore.anon.PartialTypographyProps
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/CardHeader/CardHeader.CardHeaderClassKey, 'title'> */
@js.native
...
object CardHeaderProps {
  ...
  implicit class CardHeaderPropsOps[Self <: CardHeaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCardHe): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponent(value: ReactType[CardHeaderProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSubheader(value: ReactNode): Self = this.set("subheader", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSubheader: Self = this.set("subheader", js.undefined)
    @scala.inline
    def setSubheaderTypographyProps(value: PartialTypographyProps): Self = this.set("subheaderTypographyProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSubheaderTypographyProps: Self = this.set("subheaderTypographyProps", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setTitleTypographyProps(value: PartialTypographyProps): Self = this.set("titleTypographyProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTitleTypographyProps: Self = this.set("titleTypographyProps", js.undefined)
    @scala.inline
