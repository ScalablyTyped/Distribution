  ...
  */
  ...
  object CardHeaderProps {
    ...
    extension [Self <: CardHeaderProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapCardHe): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponent(value: ReactType[CardHeaderProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setSubheaderTypographyProps(value: PartialTypographyProps): Self = StObject.set(x, "subheaderTypographyProps", value.asInstanceOf[js.Any])
      ...
      inline def setTitleTypographyProps(value: PartialTypographyProps): Self = StObject.set(x, "titleTypographyProps", value.asInstanceOf[js.Any])
