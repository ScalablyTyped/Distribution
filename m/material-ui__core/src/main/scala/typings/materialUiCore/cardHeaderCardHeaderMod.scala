...
object cardHeaderCardHeaderMod extends Shortcut {
  ...
  */
  ...
  trait CardHeaderProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapCardHe] = js.undefined
  ...
  object CardHeaderProps {
    ...
    implicit class CardHeaderPropsMutableBuilder[Self <: CardHeaderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapCardHe): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[CardHeaderProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSubheader(value: ReactNode): Self = StObject.set(x, "subheader", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSubheaderTypographyProps(value: PartialTypographyProps): Self = StObject.set(x, "subheaderTypographyProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTitleTypographyProps(value: PartialTypographyProps): Self = StObject.set(x, "titleTypographyProps", value.asInstanceOf[js.Any])
