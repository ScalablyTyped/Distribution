...
object formLabelFormLabelMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[FormLabelProps] = js.native
  ...
  */
  ...
  trait FormLabelProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapFormLa] = js.undefined
  ...
  object FormLabelProps {
    ...
    extension [Self <: FormLabelProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapFormLa): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setComponent(value: ReactType[FormLabelBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
