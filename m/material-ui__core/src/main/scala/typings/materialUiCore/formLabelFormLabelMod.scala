  ...
  */
  ...
  object FormLabelProps {
    ...
    implicit class FormLabelPropsMutableBuilder[Self <: FormLabelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapFormLa): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[FormLabelBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
