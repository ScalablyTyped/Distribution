...
object PartialTablePaginationProps {
  ...
  def apply(
    ...
    labelDisplayedRows: /* paginationInfo */ LabelDisplayedRowsArgs => ReactNode = null,
    labelRowsPerPage: ReactNode = null,
    lang: String = null,
    nextIconButtonProps: PartialIconButtonProps = null,
    numeric: js.UndefOr[Boolean] = js.undefined,
    onAbort: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onChange: FormEvent[HTMLTableHeaderCellElement] => Unit = null,
    onChangePage: (/* event */ (MouseEvent[HTMLButtonElement, NativeMouseEvent]) | Null, /* page */ Double) => Unit = null,
    ...
    onDurationChange: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onEmptied: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onEnded: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onError: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    ...
    onPause: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onPlay: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onPlaying: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    ...
    onStalled: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onSubmit: FormEvent[HTMLTableHeaderCellElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
    onWaiting: SyntheticEvent[HTMLTableHeaderCellElement, Event_] => Unit = null,
