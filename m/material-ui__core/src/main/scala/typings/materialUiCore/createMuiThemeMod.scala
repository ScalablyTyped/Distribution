...
object createMuiThemeMod {
  ...
  inline def default(options: ThemeOptions): Theme = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(options.asInstanceOf[js.Any]).asInstanceOf[Theme]
  ...
  */
  ...
  object Theme {
    ...
    extension [Self <: Theme](x: Self) {
      ...
      inline def setShadowsVarargs(value: js.Any*): Self = StObject.set(x, "shadows", js.Array(value :_*))
