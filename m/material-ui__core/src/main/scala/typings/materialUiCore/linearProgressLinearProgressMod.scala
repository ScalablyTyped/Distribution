  ...
  */
  ...
  object LinearProgressProps {
    ...
    extension [Self <: LinearProgressProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapLinear): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setValueBuffer(value: Double): Self = StObject.set(x, "valueBuffer", value.asInstanceOf[js.Any])
      
      inline def setValueBufferUndefined: Self = StObject.set(x, "valueBuffer", js.undefined)
