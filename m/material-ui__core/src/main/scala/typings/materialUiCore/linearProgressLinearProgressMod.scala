...
object linearProgressLinearProgressMod extends Shortcut {
  ...
  @JSImport("@material-ui/core/LinearProgress/LinearProgress", JSImport.Default)
  @js.native
  ...
  */
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/LinearProgress/LinearProgress.LinearProgressClassKey, never> */
  trait LinearProgressProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapLinear] = js.undefined
    ...
    var valueBuffer: js.UndefOr[Double] = js.undefined
  ...
  object LinearProgressProps {
    ...
    @scala.inline
    implicit class LinearProgressPropsMutableBuilder[Self <: LinearProgressProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapLinear): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      @scala.inline
      def setColor(value: primary | secondary): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setValueBuffer(value: Double): Self = StObject.set(x, "valueBuffer", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValueBufferUndefined: Self = StObject.set(x, "valueBuffer", js.undefined)
      
      @scala.inline
      def setValueUndefined: Self = StObject.set(x, "value", js.undefined)
      
      @scala.inline
      def setVariant(value: determinate | indeterminate | buffer | query): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
