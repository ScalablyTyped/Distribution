...
*/
trait GridJustification extends js.Object
object GridJustification {
  ...
  @scala.inline
  def `space-evenly`: typings.materialUiCore.materialUiCoreStrings.`space-evenly` = "space-evenly".asInstanceOf[typings.materialUiCore.materialUiCoreStrings.`space-evenly`]
}
