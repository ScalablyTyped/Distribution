...
object inputLabelInputLabelMod {
  ...
  */
  ...
  trait InputLabelProps extends StObject {
    ...
    var FormLabelClasses: js.UndefOr[PartialClassNameMapFormLa] = js.undefined
    ...
    var classes: js.UndefOr[PartialClassNameMapInputL] = js.undefined
  ...
  object InputLabelProps {
    ...
    extension [Self <: InputLabelProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapInputL): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setFormLabelClasses(value: PartialClassNameMapFormLa): Self = StObject.set(x, "FormLabelClasses", value.asInstanceOf[js.Any])
      
      inline def setFormLabelClassesUndefined: Self = StObject.set(x, "FormLabelClasses", js.undefined)
