...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Tab.TabProps> */
@js.native
trait PartialTabProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[AnonChecked], /* value */ js.Any, Unit]] = js.native
  var onClick: js.UndefOr[EventHandler[_]] = js.native
  ...
  var textColor: js.UndefOr[String | secondary | primary | inherit] = js.native
...
object PartialTabProps {
  ...
  def apply(
    ...
    onChange: (/* event */ ChangeEvent[AnonChecked], /* value */ js.Any) => Unit = null,
    onClick: _ => Unit = null,
