...
@js.native
trait PartialStyleRulesDialogClassKey extends js.Object {
...
object PartialStyleRulesDialogClassKey {
  @scala.inline
  def apply(
  ...
  ): PartialStyleRulesDialogClassKey = {
    ...
    __obj.asInstanceOf[PartialStyleRulesDialogClassKey]
  }
}
