...
@js.native
trait PartialClassNameMapChipClassKey extends js.Object {
...
object PartialClassNameMapChipClassKey {
  @scala.inline
  def apply(
    avatar: String = null,
    ...
    root: String = null
  ): PartialClassNameMapChipClassKey = {
    ...
    __obj.asInstanceOf[PartialClassNameMapChipClassKey]
  }
}
