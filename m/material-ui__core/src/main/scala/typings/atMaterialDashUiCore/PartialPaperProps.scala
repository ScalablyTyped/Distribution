...
trait PartialPaperProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapPaperClassKey] = js.undefined
...
object PartialPaperProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PartialPaperProps]
  }
}
