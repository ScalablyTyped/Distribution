package typings.atMaterialDashUiCore.backdropBackdropMod

import typings.atMaterialDashUiCore.PartialClassNameMapBackdropClassKey
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement> & std.Partial<@material-ui/core.@material-ui/core/Fade.FadeProps>, @material-ui/core.@material-ui/core/Backdrop/Backdrop.BackdropClassKey, never> */
@js.native
trait BackdropProps extends js.Object {
  ...
  var onClick: js.UndefOr[ReactEventHandler[js.Object]] = js.native
  ...
  var transitionDuration: js.UndefOr[Double | Anon_Appear] = js.native
...
object BackdropProps {
  ...
  def apply(
    ...
    onClick: SyntheticEvent[js.Object, Event] => Unit = null,
