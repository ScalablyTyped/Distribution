...
import typings.atMaterialDashUiCore.iconButtonMod.default
...
object IconButton
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.iconButtonMod.default].asInstanceOf[String | js.Object]
  def apply(
