...
import typings.atMaterialDashUiCore.outlinedInputMod.default
...
object OutlinedInput
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.outlinedInputMod.default].asInstanceOf[String | js.Object]
  def apply(
    labelWidth: Double,
