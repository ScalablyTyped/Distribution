...
import typings.atMaterialDashUiCore.PartialClassNameMapSwitchBaseClassKey
...
import typings.atMaterialDashUiCore.internalSwitchBaseMod.SwitchBaseProps
import typings.atMaterialDashUiCore.internalSwitchBaseMod.default
...
object SwitchBase
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.internalSwitchBaseMod.default].asInstanceOf[String | js.Object]
  def apply(
    checkedIcon: TagMod[Any],
    icon: TagMod[Any],
    ...
    val __obj = js.Dynamic.literal(checkedIcon = checkedIcon, icon = icon)
