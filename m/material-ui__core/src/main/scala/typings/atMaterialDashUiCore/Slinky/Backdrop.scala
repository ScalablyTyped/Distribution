...
import typings.atMaterialDashUiCore.backdropMod.default
...
object Backdrop
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.backdropMod.default].asInstanceOf[String | js.Object]
  def apply(
