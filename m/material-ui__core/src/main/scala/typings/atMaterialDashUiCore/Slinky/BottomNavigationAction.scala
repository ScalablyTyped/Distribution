...
import typings.atMaterialDashUiCore.PartialClassNameMapBottomNavigationActionClassKey
import typings.atMaterialDashUiCore.bottomNavigationActionBottomNavigationActionMod.BottomNavigationActionProps
import typings.atMaterialDashUiCore.bottomNavigationActionMod.default
...
object BottomNavigationAction
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.bottomNavigationActionMod.default].asInstanceOf[String | js.Object]
  def apply(
    ...
    onClick: SyntheticEvent[_, Event] => Unit = null,
