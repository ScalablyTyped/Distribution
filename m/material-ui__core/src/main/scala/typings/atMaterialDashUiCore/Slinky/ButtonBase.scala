...
import typings.atMaterialDashUiCore.buttonBaseMod.default
...
object ButtonBase
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.buttonBaseMod.default].asInstanceOf[String | js.Object]
  def apply(
