...
import typings.atMaterialDashUiCore.formControlLabelFormControlLabelMod.FormControlLabelProps
import typings.atMaterialDashUiCore.formControlLabelMod.default
...
object FormControlLabel
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(control = control, label = label)
