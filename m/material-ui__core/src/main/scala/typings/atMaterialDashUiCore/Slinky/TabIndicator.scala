...
import typings.atMaterialDashUiCore.Anon_Left
import typings.atMaterialDashUiCore.PartialClassNameMapTabIndicatorClassKey
...
import typings.atMaterialDashUiCore.tabsTabIndicatorMod.TabIndicatorProps
import typings.atMaterialDashUiCore.tabsTabIndicatorMod.default
