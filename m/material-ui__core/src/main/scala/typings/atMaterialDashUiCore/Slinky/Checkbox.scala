...
import typings.atMaterialDashUiCore.checkboxMod.default
...
object Checkbox
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.checkboxMod.default].asInstanceOf[String | js.Object]
  def apply(
