...
import typings.atMaterialDashUiCore.PartialClassNameMapExpansionPanelClassKey
import typings.atMaterialDashUiCore.PartialCollapseProps
import typings.atMaterialDashUiCore.expansionPanelExpansionPanelMod.ExpansionPanelProps
import typings.atMaterialDashUiCore.expansionPanelMod.default
...
object ExpansionPanel
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.expansionPanelMod.default].asInstanceOf[String | js.Object]
  def apply(
    CollapseProps: PartialCollapseProps = null,
    classes: PartialClassNameMapExpansionPanelClassKey = null,
    ...
    onChange: (/* event */ ChangeEvent[js.Object], /* expanded */ Boolean) => Unit = null,
