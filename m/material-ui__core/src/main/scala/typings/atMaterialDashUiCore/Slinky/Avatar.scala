...
import typings.atMaterialDashUiCore.PartialClassNameMapAvatarClassKey
import typings.atMaterialDashUiCore.avatarAvatarMod.AvatarProps
import typings.atMaterialDashUiCore.avatarMod.default
