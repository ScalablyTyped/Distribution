...
import typings.atMaterialDashUiCore.PartialClassNameMapStepIconClasskey
import typings.atMaterialDashUiCore.stepIconMod.default
import typings.atMaterialDashUiCore.stepIconStepIconMod.StepIconProps
...
object StepIcon
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.stepIconMod.default].asInstanceOf[String | js.Object]
  def apply(
    icon: TagMod[Any],
