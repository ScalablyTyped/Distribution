...
import typings.atMaterialDashUiCore.menuMod.default
...
object Menu
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.menuMod.default].asInstanceOf[String | js.Object]
  def apply(
