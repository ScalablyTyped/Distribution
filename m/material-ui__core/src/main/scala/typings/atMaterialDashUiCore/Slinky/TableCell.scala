...
import typings.atMaterialDashUiCore.tableCellMod.default
...
object TableCell
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.tableCellMod.default].asInstanceOf[String | js.Object]
  def apply(
