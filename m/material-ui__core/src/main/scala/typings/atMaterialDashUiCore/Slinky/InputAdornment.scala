...
import typings.atMaterialDashUiCore.PartialClassNameMapInputAdornmentClassKey
...
import typings.atMaterialDashUiCore.inputAdornmentMod.default
...
object InputAdornment
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.inputAdornmentMod.default].asInstanceOf[String | js.Object]
  def apply(
    position: start | end,
