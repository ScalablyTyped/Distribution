...
import typings.atMaterialDashUiCore.PartialClassNameMapAppBarClassKey
import typings.atMaterialDashUiCore.appBarAppBarMod.AppBarProps
import typings.atMaterialDashUiCore.appBarMod.default
import typings.atMaterialDashUiCore.atMaterialDashUiCoreMod.PropTypesNs.Color
import typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.absolute
import typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.fixed
import typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.relative
import typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.static
import typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.sticky
...
object AppBar
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.appBarMod.default].asInstanceOf[String | js.Object]
  def apply(
    classes: PartialClassNameMapAppBarClassKey = null,
    color: Color = null,
    component: ReactComponentClass[PaperProps] = null,
    elevation: Int | Double = null,
    innerRef: Ref[_] | RefObject[_] = null,
    position: fixed | absolute | sticky | static | relative = null,
