...
import typings.atMaterialDashUiCore.menuItemMod.default
...
object MenuItem
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.menuItemMod.default].asInstanceOf[String | js.Object]
  def apply(
