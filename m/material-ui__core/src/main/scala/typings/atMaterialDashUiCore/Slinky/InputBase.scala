...
import typings.atMaterialDashUiCore.inputBaseMod.default
...
object InputBase
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.inputBaseMod.default].asInstanceOf[String | js.Object]
  def apply(
