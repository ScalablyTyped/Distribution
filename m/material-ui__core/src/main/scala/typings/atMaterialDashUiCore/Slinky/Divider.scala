...
import typings.atMaterialDashUiCore.dividerMod.default
...
object Divider
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.dividerMod.default].asInstanceOf[String | js.Object]
  def apply(
