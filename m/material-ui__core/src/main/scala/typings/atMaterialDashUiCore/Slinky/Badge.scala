...
import typings.atMaterialDashUiCore.badgeMod.default
...
object Badge
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.badgeMod.default].asInstanceOf[String | js.Object]
  def apply(
    ...
    if (badgeContent != null) __obj.updateDynamic("badgeContent")(badgeContent)
