...
import typings.atMaterialDashUiCore.stepButtonMod.default
...
object StepButton
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.stepButtonMod.default].asInstanceOf[String | js.Object]
  def apply(
