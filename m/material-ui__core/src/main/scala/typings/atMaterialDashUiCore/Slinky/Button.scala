...
import typings.atMaterialDashUiCore.buttonMod.default
...
object Button
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.buttonMod.default].asInstanceOf[String | js.Object]
  def apply(
