...
import typings.atMaterialDashUiCore.zoomMod.default
...
object Zoom
  ...
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.zoomMod.default].asInstanceOf[String | js.Object]
  def apply(
