...
import typings.atMaterialDashUiCore.slideMod.default
...
/* The following DOM/SVG props were specified: style, direction */
object Slide
  extends ExternalComponentWithAttributesWithRefType[tag.type, default] {
  override val component: String | js.Object = js.constructorOf[typings.atMaterialDashUiCore.slideMod.default].asInstanceOf[String | js.Object]
  def apply(
