package typings.atMaterialDashUiCore.stepButtonStepButtonMod

import typings.atMaterialDashUiCore.PartialClassNameMapStepButtonClasskey
...
@js.native
trait StepButtonProps extends js.Object {
...
object StepButtonProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(alternativeLabel)) __obj.updateDynamic("alternativeLabel")(alternativeLabel.asInstanceOf[js.Any])
