...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/ExpansionPanelActions.ExpansionPanelActionsProps> */
trait PartialExpansionPanelActionsProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapExpansionPanelActionsClassKey] = js.undefined
...
object PartialExpansionPanelActionsProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    vocab: String = null
  ): PartialExpansionPanelActionsProps = {
    ...
    __obj.asInstanceOf[PartialExpansionPanelActionsProps]
  }
}
