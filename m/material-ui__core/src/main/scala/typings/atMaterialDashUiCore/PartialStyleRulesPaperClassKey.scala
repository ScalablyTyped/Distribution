...
@js.native
trait PartialStyleRulesPaperClassKey extends js.Object {
...
object PartialStyleRulesPaperClassKey {
  @scala.inline
  def apply(
  ...
  ): PartialStyleRulesPaperClassKey = {
    ...
    __obj.asInstanceOf[PartialStyleRulesPaperClassKey]
  }
}
