...
import typings.atMaterialDashUiCore.PartialClassNameMapCheckboxClassKey
...
trait CheckboxProps extends js.Object {
  ...
  var color: js.UndefOr[
    primary | secondary | typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.default
  ] = js.undefined
