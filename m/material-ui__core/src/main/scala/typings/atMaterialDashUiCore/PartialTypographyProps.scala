...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Typography.TypographyProps> */
trait PartialTypographyProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapTypographyClassKey] = js.undefined
