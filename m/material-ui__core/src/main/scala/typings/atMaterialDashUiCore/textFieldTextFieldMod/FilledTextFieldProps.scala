...
@js.native
trait FilledTextFieldProps extends TextFieldProps {
  ...
  var onChange: js.UndefOr[ChangeEventHandler[HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement]] = js.native
