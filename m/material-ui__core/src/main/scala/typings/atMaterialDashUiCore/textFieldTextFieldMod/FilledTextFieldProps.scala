package typings.atMaterialDashUiCore.textFieldTextFieldMod
...
trait FilledTextFieldProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapTextFieldClassKey] = js.undefined
  ...
  var onChange: js.UndefOr[ChangeEventHandler[HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement]] = js.undefined
...
object FilledTextFieldProps {
  ...
  def apply(
    ...
    onBlur: EventHandler[_] = null,
    onCanPlay: ReactEventHandler[HTMLDivElement] = null,
    onCanPlayThrough: ReactEventHandler[HTMLDivElement] = null,
    onChange: ChangeEventHandler[HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement] = null,
