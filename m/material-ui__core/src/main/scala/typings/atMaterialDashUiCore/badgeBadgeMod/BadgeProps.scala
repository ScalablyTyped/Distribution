package typings.atMaterialDashUiCore.badgeBadgeMod

import typings.atMaterialDashUiCore.PartialClassNameMapBadgeClassKey
...
import typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.dot
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/Badge/Badge.BadgeClassKey, never> */
trait BadgeProps extends js.Object {
  ...
  var color: js.UndefOr[Color | error] = js.undefined
  var component: js.UndefOr[ReactType[BadgeProps]] = js.undefined
