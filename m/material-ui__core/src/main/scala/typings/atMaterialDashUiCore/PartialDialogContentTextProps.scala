...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/DialogContentText.DialogContentTextProps> */
trait PartialDialogContentTextProps extends js.Object {
  ...
  var color: js.UndefOr[Color | textPrimary | textSecondary | error] = js.undefined
  var component: js.UndefOr[ReactType[TypographyProps]] = js.undefined
...
object PartialDialogContentTextProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    if (!js.isUndefined(gutterBottom)) __obj.updateDynamic("gutterBottom")(gutterBottom.asInstanceOf[js.Any])
    if (headlineMapping != null) __obj.updateDynamic("headlineMapping")(headlineMapping.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(paragraph)) __obj.updateDynamic("paragraph")(paragraph.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[PartialDialogContentTextProps]
  }
}
