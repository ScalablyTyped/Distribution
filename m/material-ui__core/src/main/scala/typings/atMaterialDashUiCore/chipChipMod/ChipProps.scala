package typings.atMaterialDashUiCore.chipChipMod
...
trait ChipProps extends js.Object {
  ...
  var variant: js.UndefOr[typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.default | outlined] = js.undefined
