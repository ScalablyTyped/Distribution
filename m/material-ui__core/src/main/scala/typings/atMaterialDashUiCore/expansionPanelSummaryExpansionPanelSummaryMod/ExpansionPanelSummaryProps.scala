package typings.atMaterialDashUiCore.expansionPanelSummaryExpansionPanelSummaryMod

import typings.atMaterialDashUiCore.PartialClassNameMapExpansionPanelSummaryClassKey
...
object ExpansionPanelSummaryProps {
  ...
  def apply(
    ...
    onChange: SyntheticEvent[js.Object, Event] => Unit = null,
