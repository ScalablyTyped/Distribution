package typings.atMaterialDashUiCore.tabsTabsMod
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/ButtonBase/ButtonBase.ButtonBaseProps, @material-ui/core.@material-ui/core/Tabs/Tabs.TabsClassKey, 'onChange' | 'action' | 'component'> */
@js.native
trait TabsProps extends js.Object {
  var ScrollButtonComponent: js.UndefOr[ReactType[_]] = js.native
  var TabIndicatorProps: js.UndefOr[PartialTabIndicatorProps] = js.native
  ...
  var action: js.UndefOr[js.Function1[/* actions */ TabsActions, Unit]] = js.native
  ...
  var classes: js.UndefOr[PartialClassNameMapTabsClassKey] = js.native
  var color: js.UndefOr[String] = js.native
  var component: js.UndefOr[ReactType[TabsProps]] = js.native
  ...
  var indicatorColor: js.UndefOr[secondary | primary | String] = js.native
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[js.Object], /* value */ js.Any, Unit]] = js.native
  ...
  var scrollButtons: js.UndefOr[auto | on | off] = js.native
  ...
  var textColor: js.UndefOr[secondary | primary | inherit | String] = js.native
...
object TabsProps {
  ...
  def apply(
    value: js.Any,
    ScrollButtonComponent: ReactType[_] = null,
    ...
    color: String = null,
    component: ReactType[TabsProps] = null,
    ...
    if (TabIndicatorProps != null) __obj.updateDynamic("TabIndicatorProps")(TabIndicatorProps.asInstanceOf[js.Any])
