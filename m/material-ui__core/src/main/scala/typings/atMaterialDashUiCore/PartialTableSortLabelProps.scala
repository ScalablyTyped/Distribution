...
import typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.asc
...
import typings.atMaterialDashUiCore.atMaterialDashUiCoreStrings.desc
...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/TableSortLabel.TableSortLabelProps> */
@js.native
trait PartialTableSortLabelProps extends js.Object {
  var IconComponent: js.UndefOr[ComponentType[SvgIconProps]] = js.native
...
object PartialTableSortLabelProps {
  @scala.inline
  def apply(
    ...
    if (!js.isUndefined(hideSortIcon)) __obj.updateDynamic("hideSortIcon")(hideSortIcon.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[PartialTableSortLabelProps]
  }
}
