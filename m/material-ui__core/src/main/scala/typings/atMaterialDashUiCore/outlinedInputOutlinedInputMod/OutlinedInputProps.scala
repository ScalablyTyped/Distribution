package typings.atMaterialDashUiCore.outlinedInputOutlinedInputMod

import typings.atMaterialDashUiCore.Anon_Dense
import typings.atMaterialDashUiCore.PartialClassNameMapOutlinedInputClassKey
...
trait OutlinedInputProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapOutlinedInputClassKey] = js.undefined
  ...
  var renderPrefix: js.UndefOr[js.Function1[/* state */ Anon_Dense, ReactNode]] = js.undefined
...
object OutlinedInputProps {
  ...
  def apply(
    ...
    onChange: ChangeEventHandler[HTMLTextAreaElement | HTMLInputElement] = null,
    ...
    onKeyDown: KeyboardEventHandler[HTMLTextAreaElement | HTMLInputElement] = null,
    onKeyPress: KeyboardEventHandler[HTMLDivElement] = null,
    onKeyUp: KeyboardEventHandler[HTMLTextAreaElement | HTMLInputElement] = null,
    ...
    renderPrefix: /* state */ Anon_Dense => ReactNode = null,
