...
trait PartialTabProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[Anon_Checked], /* value */ js.Any, Unit]] = js.undefined
  var onChangeCapture: js.UndefOr[FormEventHandler[HTMLElement]] = js.undefined
  var onClick: js.UndefOr[EventHandler[_]] = js.undefined
