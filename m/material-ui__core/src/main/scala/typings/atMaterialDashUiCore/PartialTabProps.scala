...
trait PartialTabProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[Anon_Checked], /* value */ js.Any, Unit]] = js.native
...
object PartialTabProps {
  ...
  def apply(
    ...
    onChange: (/* event */ ChangeEvent[Anon_Checked], /* value */ js.Any) => Unit = null,
    onClick: _ => Unit = null,
