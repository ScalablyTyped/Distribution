...
trait PartialTabsProps extends js.Object {
  ...
  var action: js.UndefOr[
    js.Function1[/* actions */ atMaterialDashUiCoreLib.tabsTabsMod.TabsActions, scala.Unit]
  ] = js.undefined
...
object PartialTabsProps {
  ...
  def apply(
    ...
    action: /* actions */ atMaterialDashUiCoreLib.tabsTabsMod.TabsActions => scala.Unit = null,
