...
trait RadioProps extends js.Object {
  ...
  var checked: js.UndefOr[scala.Boolean | java.lang.String]
  ...
  var classes: js.UndefOr[
    stdLib.Partial[atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[RadioClassKey]]
  ] = js.undefined
  ...
  var disableRipple: js.UndefOr[scala.Boolean]
  ...
  var inputProps: js.UndefOr[reactLib.reactMod.InputHTMLAttributes[stdLib.HTMLInputElement]]
  var inputRef: js.UndefOr[reactLib.reactMod.Ref[_]]
  ...
  var value: js.UndefOr[java.lang.String | scala.Double | scala.Boolean]
...
object RadioProps {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(action = action, onChange = onChange)
