...
trait FormLabelProps extends js.Object {
  ...
  var classes: js.UndefOr[atMaterialDashUiCoreLib.PartialClassNameMapFormLabelClassKey] = js.undefined
...
object FormLabelProps {
  ...
  def apply(
    ...
    classes: atMaterialDashUiCoreLib.PartialClassNameMapFormLabelClassKey = null,
