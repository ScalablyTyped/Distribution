...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/LinearProgress.LinearProgressProps> */
trait PartialLinearProgressProps extends js.Object {
  ...
  var classes: js.UndefOr[
    stdLib.Partial[
      atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[atMaterialDashUiCoreLib.linearProgressLinearProgressMod.LinearProgressClassKey]
    ]
  ] = js.undefined
...
object PartialLinearProgressProps {
  @scala.inline
  def apply(
