...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLAttributes<react.HTMLHRElement>, 'classes' | never> ]: react.react.HTMLAttributes<react.HTMLHRElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<react.HTMLHRElement>, @material-ui/core.@material-ui/core/Divider/Divider.DividerClassKey, never>) */ trait DividerProps
