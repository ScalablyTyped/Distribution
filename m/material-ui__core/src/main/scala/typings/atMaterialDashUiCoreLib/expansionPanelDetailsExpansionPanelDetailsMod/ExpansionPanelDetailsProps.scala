...
trait ExpansionPanelDetailsProps extends js.Object {
  ...
  var classes: js.UndefOr[atMaterialDashUiCoreLib.PartialClassNameMapExpansionPanelDetailsClassKey] = js.undefined
...
object ExpansionPanelDetailsProps {
  ...
  def apply(
    ...
    classes: atMaterialDashUiCoreLib.PartialClassNameMapExpansionPanelDetailsClassKey = null,
