...
trait PartialNativeSelectProps extends js.Object {
  ...
  var classes: js.UndefOr[
    stdLib.Partial[
      atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[atMaterialDashUiCoreLib.nativeSelectNativeSelectMod.NativeSelectClassKey]
    ]
  ] = js.undefined
  ...
  var inputComponent: js.UndefOr[
    reactLib.reactMod.ReactType[atMaterialDashUiCoreLib.inputBaseInputBaseMod.InputBaseComponentProps]
  ] = js.undefined
  ...
  var renderPrefix: js.UndefOr[js.Function1[/* state */ Anon_Dense, reactLib.reactMod.ReactNode]] = js.undefined
...
object PartialNativeSelectProps {
  @scala.inline
  def apply(
    ...
    inputComponent: reactLib.reactMod.ReactType[atMaterialDashUiCoreLib.inputBaseInputBaseMod.InputBaseComponentProps] = null,
    ...
    renderPrefix: /* state */ Anon_Dense => reactLib.reactMod.ReactNode = null,
    ...
    __obj.asInstanceOf[PartialNativeSelectProps]
  }
}
