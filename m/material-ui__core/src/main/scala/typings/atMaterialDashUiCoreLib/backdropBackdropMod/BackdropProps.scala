...
trait BackdropProps extends js.Object {
  ...
  var classes: js.UndefOr[
    stdLib.Partial[atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[BackdropClassKey]]
  ] = js.undefined
  ...
  var theme: js.UndefOr[atMaterialDashUiCoreLib.stylesCreateMuiThemeMod.Theme]
  var timeout: js.UndefOr[scala.Double | reactDashTransitionDashGroupLib.Anon_Enter]
