...
- Dropped {[ P in std.Exclude<keyof react.react.React.HTMLAttributes<std.HTMLDivElement>, 'classes' | 'title'> ]: react.react.React.HTMLAttributes<std.HTMLDivElement>[P]} */ trait TooltipProps
