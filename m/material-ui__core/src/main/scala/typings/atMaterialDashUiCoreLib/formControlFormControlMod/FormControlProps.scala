...
trait FormControlProps extends js.Object {
  ...
  var classes: js.UndefOr[atMaterialDashUiCoreLib.PartialClassNameMapFormControlClassKey] = js.undefined
...
object FormControlProps {
  ...
  def apply(
    ...
    classes: atMaterialDashUiCoreLib.PartialClassNameMapFormControlClassKey = null,
