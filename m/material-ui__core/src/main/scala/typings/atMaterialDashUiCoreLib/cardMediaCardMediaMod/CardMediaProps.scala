...
trait CardMediaProps extends js.Object {
  ...
  var classes: js.UndefOr[atMaterialDashUiCoreLib.PartialClassNameMapCardMediaClassKey] = js.undefined
...
object CardMediaProps {
  ...
  def apply(
    ...
    classes: atMaterialDashUiCoreLib.PartialClassNameMapCardMediaClassKey = null,
