...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Tabs/TabIndicator.TabIndicatorProps> */
trait PartialTabIndicatorProps extends js.Object {
  ...
  var classes: js.UndefOr[
    stdLib.Partial[
      atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[atMaterialDashUiCoreLib.tabsTabIndicatorMod.TabIndicatorClassKey]
    ]
  ] = js.undefined
  ...
  var style: js.UndefOr[Anon_Left] = js.undefined
...
object PartialTabIndicatorProps {
  @scala.inline
  def apply(
    ...
    color: atMaterialDashUiCoreLib.atMaterialDashUiCoreLibStrings.secondary | atMaterialDashUiCoreLib.atMaterialDashUiCoreLibStrings.primary | java.lang.String = null,
    ...
    __obj.asInstanceOf[PartialTabIndicatorProps]
  }
}
