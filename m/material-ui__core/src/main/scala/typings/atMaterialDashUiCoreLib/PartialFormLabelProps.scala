...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/FormLabel.FormLabelProps> */
trait PartialFormLabelProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapFormLabelClassKey] = js.undefined
...
object PartialFormLabelProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PartialFormLabelProps]
  }
}
