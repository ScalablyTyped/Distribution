...
trait NativeSelectProps extends js.Object {
  ...
  var autoComplete: js.UndefOr[java.lang.String]
  var autoCorrect: js.UndefOr[java.lang.String]
  var autoFocus: js.UndefOr[scala.Boolean]
  ...
  var classes: js.UndefOr[
    stdLib.Partial[atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[NativeSelectClassKey]]
  ] = js.undefined
  ...
  var disableUnderline: js.UndefOr[scala.Boolean]
  var disabled: js.UndefOr[scala.Boolean]
  var draggable: js.UndefOr[scala.Boolean]
  var endAdornment: js.UndefOr[reactLib.reactMod.ReactNode]
  var error: js.UndefOr[scala.Boolean]
  var fullWidth: js.UndefOr[scala.Boolean]
  ...
  var inputProps: js.UndefOr[atMaterialDashUiCoreLib.inputBaseInputBaseMod.InputBaseComponentProps]
  var inputRef: js.UndefOr[reactLib.reactMod.Ref[_] | reactLib.reactMod.RefObject[_]]
  ...
  var multiline: js.UndefOr[scala.Boolean]
  ...
  var readOnly: js.UndefOr[scala.Boolean]
  var renderPrefix: js.Any
  var required: js.UndefOr[scala.Boolean]
  var resource: js.UndefOr[java.lang.String]
  var results: js.UndefOr[scala.Double]
  var role: js.UndefOr[java.lang.String]
  var rows: js.UndefOr[java.lang.String | scala.Double]
  var rowsMax: js.UndefOr[java.lang.String | scala.Double]
  var security: js.UndefOr[java.lang.String]
  var slot: js.UndefOr[java.lang.String]
  var spellCheck: js.UndefOr[scala.Boolean]
  var startAdornment: js.UndefOr[reactLib.reactMod.ReactNode]
...
object NativeSelectProps {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(onChange = onChange, onFilled = onFilled)
