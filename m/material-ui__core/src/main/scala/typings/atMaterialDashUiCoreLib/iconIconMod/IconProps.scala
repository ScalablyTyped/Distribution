...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLAttributes<react.HTMLSpanElement>, 'classes' | never> ]: react.react.HTMLAttributes<react.HTMLSpanElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<react.HTMLSpanElement>, @material-ui/core.@material-ui/core/Icon/Icon.IconClassKey, never>) */ trait IconProps
