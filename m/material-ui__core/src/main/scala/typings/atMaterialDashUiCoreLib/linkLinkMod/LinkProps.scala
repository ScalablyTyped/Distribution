...
- Dropped {[ P in std.Exclude<keyof react.react.AnchorHTMLAttributes<react.HTMLAnchorElement> & @material-ui/core.@material-ui/core/Typography.TypographyProps, 'classes' | 'component'> ]: react.react.AnchorHTMLAttributes<react.HTMLAnchorElement> & @material-ui/core.@material-ui/core/Typography.TypographyProps[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.AnchorHTMLAttributes<react.HTMLAnchorElement> & @material-ui/core.@material-ui/core/Typography.TypographyProps, @material-ui/core.@material-ui/core/Link/Link.LinkClassKey, 'component'>) */ trait LinkProps
