...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/StepContent.StepContentProps> */
trait PartialStepContentProps extends js.Object {
  ...
  var classes: js.UndefOr[
    stdLib.Partial[
      atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[atMaterialDashUiCoreLib.stepContentStepContentMod.StepContentClasskey]
    ]
  ] = js.undefined
...
object PartialStepContentProps {
  @scala.inline
  def apply(
