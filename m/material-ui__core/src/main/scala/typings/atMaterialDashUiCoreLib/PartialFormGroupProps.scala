...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/FormGroup.FormGroupProps> */
trait PartialFormGroupProps extends js.Object {
  ...
  var classes: js.UndefOr[
    stdLib.Partial[
      atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[atMaterialDashUiCoreLib.formGroupFormGroupMod.FormGroupClassKey]
    ]
  ] = js.undefined
