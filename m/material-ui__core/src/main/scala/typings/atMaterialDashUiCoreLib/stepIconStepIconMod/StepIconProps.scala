...
trait StepIconProps extends js.Object {
  ...
  var classes: js.UndefOr[atMaterialDashUiCoreLib.PartialClassNameMapStepIconClasskey] = js.undefined
...
object StepIconProps {
  ...
  def apply(
    ...
    classes: atMaterialDashUiCoreLib.PartialClassNameMapStepIconClasskey = null,
