...
- Lifted 3 members from Set(std.Pick<@material-ui/core.@material-ui/core/transitions/transition.TransitionProps, std.Exclude<keyof @material-ui/core.@material-ui/core/transitions/transition.TransitionProps, 'classes' | 'timeout'>>, @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/transitions/transition.TransitionProps, @material-ui/core.@material-ui/core/Collapse/Collapse.CollapseClassKey, 'timeout'>) */ trait CollapseProps
