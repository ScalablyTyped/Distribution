...
trait DialogTitleProps extends js.Object {
  ...
  var classes: js.UndefOr[atMaterialDashUiCoreLib.PartialClassNameMapDialogTitleClassKey] = js.undefined
...
object DialogTitleProps {
  ...
  def apply(
    ...
    classes: atMaterialDashUiCoreLib.PartialClassNameMapDialogTitleClassKey = null,
