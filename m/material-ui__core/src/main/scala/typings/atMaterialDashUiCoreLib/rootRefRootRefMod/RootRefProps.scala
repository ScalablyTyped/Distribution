...
trait RootRefProps[T] extends js.Object {
  var rootRef: js.UndefOr[
    (js.Function1[/* instance */ T | scala.Null, scala.Unit]) | reactLib.reactMod.RefObject[T]
  ] = js.undefined
}
...
object RootRefProps {
  @scala.inline
  def apply[T](
    rootRef: (js.Function1[/* instance */ T | scala.Null, scala.Unit]) | reactLib.reactMod.RefObject[T] = null
  ): RootRefProps[T] = {
