...
trait InputBaseProps extends js.Object {
  ...
  var classes: js.UndefOr[atMaterialDashUiCoreLib.PartialClassNameMapInputBaseClassKey] = js.undefined
...
object InputBaseProps {
  ...
  def apply(
    ...
    classes: atMaterialDashUiCoreLib.PartialClassNameMapInputBaseClassKey = null,
