...
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<react.HTMLDivElement>, @material-ui/core.@material-ui/core/CardActions/CardActions.CardActionsClassKey, never>) */ trait CardActionsProps
