...
trait TypographyStyle extends js.Object {
  var color: js.UndefOr[csstypeLib.csstypeMod.ColorProperty]
  var fontFamily: js.UndefOr[csstypeLib.csstypeMod.FontFamilyProperty]
  var fontSize: js.UndefOr[csstypeLib.csstypeMod.FontSizeProperty[scala.Double | java.lang.String]]
  var fontWeight: js.UndefOr[csstypeLib.csstypeMod.FontWeightProperty]
