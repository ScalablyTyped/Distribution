...
- Dropped {[ P in std.Exclude<keyof react.react.AnchorHTMLAttributes<std.HTMLElement> & react.react.ButtonHTMLAttributes<std.HTMLElement>, 'classes' | never> ]: react.react.AnchorHTMLAttributes<std.HTMLElement> & react.react.ButtonHTMLAttributes<std.HTMLElement>[P]} */ trait ButtonBaseProps
  ...
  var component: js.UndefOr[reactLib.reactMod.ReactType[ButtonBaseProps]] = js.undefined
...
object ButtonBaseProps {
  ...
  def apply(
    ...
    component: reactLib.reactMod.ReactType[ButtonBaseProps] = null,
