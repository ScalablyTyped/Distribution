...
- Dropped {[ P in std.Exclude<keyof react.react.AnchorHTMLAttributes<std.HTMLElement> & react.react.ButtonHTMLAttributes<std.HTMLElement>, 'classes' | never> ]: react.react.AnchorHTMLAttributes<std.HTMLElement> & react.react.ButtonHTMLAttributes<std.HTMLElement>[P]}
- Lifted 2 members from Set(@material-ui/core.@material-ui/core.StandardProps<react.react.AnchorHTMLAttributes<std.HTMLElement> & react.react.ButtonHTMLAttributes<std.HTMLElement>, @material-ui/core.@material-ui/core/ButtonBase/ButtonBase.ButtonBaseClassKey, never>) */ trait ButtonBaseProps
