...
trait OutlinedInputProps extends js.Object {
  ...
  var classes: js.UndefOr[
    stdLib.Partial[atMaterialDashUiCoreLib.stylesWithStylesMod.ClassNameMap[OutlinedInputClassKey]]
  ] = js.undefined
...
object OutlinedInputProps {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(labelWidth = labelWidth, onFilled = onFilled)
