...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/CardMedia.CardMediaProps> */
trait PartialCardMediaProps extends js.Object {
...
object PartialCardMediaProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PartialCardMediaProps]
  }
}
