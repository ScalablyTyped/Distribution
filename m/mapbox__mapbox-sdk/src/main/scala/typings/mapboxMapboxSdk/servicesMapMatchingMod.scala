...
import typings.mapboxMapboxSdk.servicesDirectionsMod.Leg
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object servicesMapMatchingMod {
  ...
  inline def default(config: typings.mapboxMapboxSdk.libClassesMapiClientMod.default): MapMatchingService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[MapMatchingService]
