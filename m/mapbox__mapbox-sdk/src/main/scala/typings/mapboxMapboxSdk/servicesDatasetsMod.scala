...
object servicesDatasetsMod {
  ...
  inline def default(config: typings.mapboxMapboxSdk.libClassesMapiClientMod.default): DatasetsService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[DatasetsService]
