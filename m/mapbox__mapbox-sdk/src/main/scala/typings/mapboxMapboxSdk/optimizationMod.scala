...
object optimizationMod {
  ...
  inline def default(config: typings.mapboxMapboxSdk.mod.default): OptimizationService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[OptimizationService]
  ...
  object OptimizationRequest {
    ...
    inline def apply(profile: MapboxProfile, waypoints: js.Array[OptimizationWaypoint]): OptimizationRequest = {
    ...
    extension [Self <: OptimizationRequest](x: Self) {
      ...
      inline def setAnnotations(value: duration | speed | distance): Self = StObject.set(x, "annotations", value.asInstanceOf[js.Any])
      ...
      inline def setDistributions(value: js.Array[Double]): Self = StObject.set(x, "distributions", value.asInstanceOf[js.Any])
      
      inline def setDistributionsUndefined: Self = StObject.set(x, "distributions", js.undefined)
      
      inline def setDistributionsVarargs(value: Double*): Self = StObject.set(x, "distributions", js.Array(value :_*))
      ...
      inline def setWaypoints(value: js.Array[OptimizationWaypoint]): Self = StObject.set(x, "waypoints", value.asInstanceOf[js.Any])
      
      inline def setWaypointsVarargs(value: OptimizationWaypoint*): Self = StObject.set(x, "waypoints", js.Array(value :_*))
    }
  }
  ...
  object OptimizationService {
    ...
    inline def apply(getContours: OptimizationRequest => MapiRequest): OptimizationService = {
    ...
    extension [Self <: OptimizationService](x: Self) {
      ...
      inline def setGetContours(value: OptimizationRequest => MapiRequest): Self = StObject.set(x, "getContours", js.Any.fromFunction1(value))
    }
  }
  ...
  object OptimizationWaypoint {
    ...
    inline def apply(coordinates: Double): OptimizationWaypoint = {
      val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
      __obj.asInstanceOf[OptimizationWaypoint]
    }
    
    extension [Self <: OptimizationWaypoint](x: Self) {
      ...
      inline def setCoordinates(value: Double): Self = StObject.set(x, "coordinates", value.asInstanceOf[js.Any])
