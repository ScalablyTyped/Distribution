...
object servicesStylesMod {
  ...
  inline def default(config: typings.mapboxMapboxSdk.libClassesMapiClientMod.default): StylesService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[StylesService]
