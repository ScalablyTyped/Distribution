...
object servicesGeocodingMod {
  ...
  inline def default(config: typings.mapboxMapboxSdk.libClassesMapiClientMod.default): GeocodeService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[GeocodeService]
