...
object servicesTokensMod {
  ...
  inline def default(config: typings.mapboxMapboxSdk.libClassesMapiClientMod.default): TokensService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[TokensService]
