...
/* Rewritten from type alias, can be one of: 
  - typings.mapboxMapboxSdk.mapboxMapboxSdkStrings.full
  - typings.mapboxMapboxSdk.mapboxMapboxSdkStrings.simplified
  - typings.mapboxMapboxSdk.mapboxMapboxSdkStrings.`false`
*/
trait DirectionsOverview extends StObject
object DirectionsOverview {
  
  inline def `false`: typings.mapboxMapboxSdk.mapboxMapboxSdkStrings.`false` = "false".asInstanceOf[typings.mapboxMapboxSdk.mapboxMapboxSdkStrings.`false`]
