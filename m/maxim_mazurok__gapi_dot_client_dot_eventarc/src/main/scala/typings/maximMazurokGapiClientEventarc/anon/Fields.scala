package typings.maximMazurokGapiClientEventarc.anon
...
object Fields {
  ...
  @scala.inline
  def apply(parent: String, resource: Trigger): Fields = {
  ...
  implicit class FieldsOps[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Trigger): Self = this.set("resource", value.asInstanceOf[js.Any])
