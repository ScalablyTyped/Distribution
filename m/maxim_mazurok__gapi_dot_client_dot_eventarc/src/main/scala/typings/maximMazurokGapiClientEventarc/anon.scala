...
import typings.maximMazurokGapiClientEventarc.gapi.client.eventarc.CancelOperationRequest
...
object anon {
  ...
  object Fields {
    ...
    inline def apply(parent: String, resource: Trigger): Fields = {
  ...
  object Name {
    ...
    inline def apply(name: String, resource: Trigger): Name = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
