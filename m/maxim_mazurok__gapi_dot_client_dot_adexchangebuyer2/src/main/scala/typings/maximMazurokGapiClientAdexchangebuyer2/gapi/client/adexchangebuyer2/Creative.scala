...
trait Creative extends js.Object {
  ...
  var adTechnologyProviders: js.UndefOr[AdTechnologyProviders] = js.native
  ...
  var corrections: js.UndefOr[js.Array[Correction]] = js.native
  ...
  /**
    ...
    */
  var servingRestrictions: js.UndefOr[js.Array[ServingRestriction]] = js.native
...
object Creative {
  ...
  implicit class CreativeOps[Self <: Creative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdTechnologyProviders(value: AdTechnologyProviders): Self = this.set("adTechnologyProviders", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAdTechnologyProviders: Self = this.set("adTechnologyProviders", js.undefined)
    ...
    @scala.inline
    def setCorrectionsVarargs(value: Correction*): Self = this.set("corrections", js.Array(value :_*))
    
    @scala.inline
    def setCorrections(value: js.Array[Correction]): Self = this.set("corrections", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setServingRestrictionsVarargs(value: ServingRestriction*): Self = this.set("servingRestrictions", js.Array(value :_*))
    
    @scala.inline
    def setServingRestrictions(value: js.Array[ServingRestriction]): Self = this.set("servingRestrictions", value.asInstanceOf[js.Any])
