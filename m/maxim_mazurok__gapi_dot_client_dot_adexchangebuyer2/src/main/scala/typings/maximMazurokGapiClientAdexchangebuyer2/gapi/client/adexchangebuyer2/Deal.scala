...
object Deal {
  ...
  @scala.inline
  implicit class DealMutableBuilder[Self <: Deal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreativeRestrictions(value: CreativeRestrictions): Self = StObject.set(x, "creativeRestrictions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDealTerms(value: DealTerms): Self = StObject.set(x, "dealTerms", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTargeting(value: MarketplaceTargeting): Self = StObject.set(x, "targeting", value.asInstanceOf[js.Any])
