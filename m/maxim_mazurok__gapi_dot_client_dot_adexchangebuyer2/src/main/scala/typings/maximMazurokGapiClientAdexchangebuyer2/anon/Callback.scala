...
object Callback {
  ...
  inline def apply(accountId: String, clientAccountId: String): Callback = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], clientAccountId = clientAccountId.asInstanceOf[js.Any])
