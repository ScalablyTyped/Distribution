...
import typings.maximMazurokGapiClientAdexchangebuyer2.gapi.client.adexchangebuyer2.Creative
...
object Xgafv {
  ...
  inline def apply(accountId: String, creativeId: String, resource: Creative): Xgafv = {
