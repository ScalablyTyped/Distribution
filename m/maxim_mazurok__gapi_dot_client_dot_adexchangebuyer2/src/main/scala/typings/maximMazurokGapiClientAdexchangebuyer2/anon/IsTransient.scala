...
import typings.maximMazurokGapiClientAdexchangebuyer2.gapi.client.adexchangebuyer2.FilterSet
...
trait IsTransient extends StObject {
  ...
  /** Request body */
  var resource: FilterSet = js.native
...
object IsTransient {
  ...
  @scala.inline
  def apply(ownerName: String, resource: FilterSet): IsTransient = {
  ...
  @scala.inline
  implicit class IsTransientMutableBuilder[Self <: IsTransient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: FilterSet): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
