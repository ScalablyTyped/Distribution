...
trait QuotaUserResource extends StObject {
  ...
  /** Request body */
  var resource: Proposal = js.native
...
object QuotaUserResource {
  ...
  @scala.inline
  def apply(accountId: String, proposalId: String, resource: Proposal): QuotaUserResource = {
  ...
  implicit class QuotaUserResourceMutableBuilder[Self <: QuotaUserResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Proposal): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
