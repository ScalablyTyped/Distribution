...
import typings.maximMazurokGapiClientAdexchangebuyer2.gapi.client.adexchangebuyer2.Client
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(accountId: String, clientAccountId: String, resource: Client): PrettyPrint = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], clientAccountId = clientAccountId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Client): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
