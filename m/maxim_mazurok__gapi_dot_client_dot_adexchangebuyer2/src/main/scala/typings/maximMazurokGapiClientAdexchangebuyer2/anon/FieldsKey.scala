...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: CancelNegotiationRequest = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(accountId: String, proposalId: String, resource: CancelNegotiationRequest): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CancelNegotiationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
