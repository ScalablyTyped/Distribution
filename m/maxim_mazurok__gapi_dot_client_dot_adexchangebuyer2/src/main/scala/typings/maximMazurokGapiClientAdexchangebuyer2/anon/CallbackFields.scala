...
object CallbackFields {
  ...
  inline def apply(accountId: String, proposalId: String, resource: AddNoteRequest): CallbackFields = {
  ...
  extension [Self <: CallbackFields](x: Self) {
    ...
    inline def setResource(value: AddNoteRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
