...
object QueryOptions {
  ...
  implicit class QueryOptionsOps[Self <: QueryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypeCast(value: js.Any): Self = this.set("typeCast", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValues(value: js.Any | js.Array[_] | StringDictionary[js.Any]): Self = this.set("values", value.asInstanceOf[js.Any])
