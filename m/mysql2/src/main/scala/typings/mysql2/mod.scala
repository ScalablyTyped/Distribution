...
object mod {
  ...
  trait Pool
    ...
    def getConnection(callback: js.Function2[/* err */ ErrnoException, /* connection */ PoolConnection, Any]): Unit = js.native
  ...
  - typings.mysql2.typingsMysqlLibConnectionMod.Connection because Already inherited
  - typings.mysql2.typingsMysqlLibConnectionMod.^ because Already inherited
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.mysql2.typingsMysqlLibConnectionMod.ConnectionOptions because Already inherited
