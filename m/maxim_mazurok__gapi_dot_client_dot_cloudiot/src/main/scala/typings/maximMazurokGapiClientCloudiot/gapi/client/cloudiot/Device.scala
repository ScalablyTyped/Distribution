...
object Device {
  ...
  extension [Self <: Device](x: Self) {
    ...
    inline def setConfig(value: DeviceConfig): Self = StObject.set(x, "config", value.asInstanceOf[js.Any])
    
    inline def setConfigUndefined: Self = StObject.set(x, "config", js.undefined)
    
    inline def setCredentials(value: js.Array[DeviceCredential]): Self = StObject.set(x, "credentials", value.asInstanceOf[js.Any])
    ...
    inline def setLastErrorStatus(value: Status): Self = StObject.set(x, "lastErrorStatus", value.asInstanceOf[js.Any])
