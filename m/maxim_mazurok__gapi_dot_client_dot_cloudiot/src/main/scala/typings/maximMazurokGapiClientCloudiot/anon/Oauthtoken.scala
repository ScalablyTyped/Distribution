...
import typings.maximMazurokGapiClientCloudiot.gapi.client.cloudiot.Device
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(name: String, resource: Device): Oauthtoken = {
  ...
  implicit class OauthtokenOps[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Device): Self = this.set("resource", value.asInstanceOf[js.Any])
