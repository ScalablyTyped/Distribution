...
import typings.maximMazurokGapiClientDocs.gapi.client.docs.BatchUpdateDocumentRequest
...
object anon {
  ...
  object Accesstoken {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: BatchUpdateDocumentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
