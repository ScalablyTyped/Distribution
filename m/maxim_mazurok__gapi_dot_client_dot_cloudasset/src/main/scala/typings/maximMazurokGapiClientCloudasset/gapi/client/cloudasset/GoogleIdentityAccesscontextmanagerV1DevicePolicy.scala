...
trait GoogleIdentityAccesscontextmanagerV1DevicePolicy extends StObject {
  ...
  var osConstraints: js.UndefOr[js.Array[GoogleIdentityAccesscontextmanagerV1OsConstraint]] = js.undefined
...
object GoogleIdentityAccesscontextmanagerV1DevicePolicy {
  ...
  inline def apply(): GoogleIdentityAccesscontextmanagerV1DevicePolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleIdentityAccesscontextmanagerV1DevicePolicy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleIdentityAccesscontextmanagerV1DevicePolicy] (val x: Self) extends AnyVal {
    ...
    inline def setOsConstraints(value: js.Array[GoogleIdentityAccesscontextmanagerV1OsConstraint]): Self = StObject.set(x, "osConstraints", value.asInstanceOf[js.Any])
    
    inline def setOsConstraintsUndefined: Self = StObject.set(x, "osConstraints", js.undefined)
    
    inline def setOsConstraintsVarargs(value: GoogleIdentityAccesscontextmanagerV1OsConstraint*): Self = StObject.set(x, "osConstraints", js.Array(value*))
