...
@js.native
trait WindowsUpdatePackage extends js.Object {
  
  /** The categories that are associated with this update package. */
  var categories: js.UndefOr[js.Array[WindowsUpdateCategory]] = js.native
...
object WindowsUpdatePackage {
  ...
  @scala.inline
  implicit class WindowsUpdatePackageOps[Self <: WindowsUpdatePackage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCategoriesVarargs(value: WindowsUpdateCategory*): Self = this.set("categories", js.Array(value :_*))
    
    @scala.inline
    def setCategories(value: js.Array[WindowsUpdateCategory]): Self = this.set("categories", value.asInstanceOf[js.Any])
