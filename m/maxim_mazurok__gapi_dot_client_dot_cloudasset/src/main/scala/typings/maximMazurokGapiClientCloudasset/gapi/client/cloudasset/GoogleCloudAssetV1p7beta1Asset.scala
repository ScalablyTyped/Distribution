...
trait GoogleCloudAssetV1p7beta1Asset extends StObject {
  ...
  var relatedAssets: js.UndefOr[GoogleCloudAssetV1p7beta1RelatedAssets] = js.undefined
  
  /** A representation of the resource. */
  var resource: js.UndefOr[GoogleCloudAssetV1p7beta1Resource] = js.undefined
...
object GoogleCloudAssetV1p7beta1Asset {
  
  inline def apply(): GoogleCloudAssetV1p7beta1Asset = {
  ...
  extension [Self <: GoogleCloudAssetV1p7beta1Asset](x: Self) {
    ...
    inline def setRelatedAssets(value: GoogleCloudAssetV1p7beta1RelatedAssets): Self = StObject.set(x, "relatedAssets", value.asInstanceOf[js.Any])
    
    inline def setRelatedAssetsUndefined: Self = StObject.set(x, "relatedAssets", js.undefined)
    
    inline def setResource(value: GoogleCloudAssetV1p7beta1Resource): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
