...
@js.native
trait GoogleIdentityAccesscontextmanagerV1ServicePerimeter extends js.Object {
  ...
  /**
    ...
    */
  var spec: js.UndefOr[GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig] = js.native
  
  /** Current ServicePerimeter configuration. Specifies sets of resources, restricted services and access levels that determine perimeter content and boundaries. */
  var status: js.UndefOr[GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig] = js.native
...
object GoogleIdentityAccesscontextmanagerV1ServicePerimeter {
  ...
  @scala.inline
  implicit class GoogleIdentityAccesscontextmanagerV1ServicePerimeterOps[Self <: GoogleIdentityAccesscontextmanagerV1ServicePerimeter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpec(value: GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig): Self = this.set("spec", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSpec: Self = this.set("spec", js.undefined)
    
    @scala.inline
    def setStatus(value: GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig): Self = this.set("status", value.asInstanceOf[js.Any])
