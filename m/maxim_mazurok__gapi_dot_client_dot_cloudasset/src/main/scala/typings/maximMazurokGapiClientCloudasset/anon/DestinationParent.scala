...
trait DestinationParent extends StObject {
...
object DestinationParent {
  ...
  inline def apply(resource: String): DestinationParent = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[DestinationParent]
  }
  
  extension [Self <: DestinationParent](x: Self) {
