...
object atMaterialIconDashButtonMod extends js.Object {
  ...
  class MDCIconButtonToggle ()
    extends typings.atMaterialIconDashButton.componentMod.MDCIconButtonToggle
  
  @js.native
  class MDCIconButtonToggleFoundation ()
    extends typings.atMaterialIconDashButton.foundationMod.MDCIconButtonToggleFoundation {
