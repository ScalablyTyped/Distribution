...
object componentMod {
  ...
  object MDCIconButtonToggle {
    ...
    @scala.inline
    def attachTo(root: HTMLElement): MDCIconButtonToggle = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCIconButtonToggle]
  }
}
