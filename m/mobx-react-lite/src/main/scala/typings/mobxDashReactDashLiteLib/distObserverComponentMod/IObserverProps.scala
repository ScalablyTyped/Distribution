...
trait IObserverProps extends js.Object {
  var children: js.UndefOr[js.Function0[reactLib.reactMod.ReactElement[_]]] = js.undefined
  var render: js.UndefOr[js.Function0[reactLib.reactMod.ReactElement[_]]] = js.undefined
}
...
object IObserverProps {
  ...
  def apply(
    ...
    render: () => reactLib.reactMod.ReactElement[_] = null
  ): IObserverProps = {
