...
trait UpdateMask extends StObject {
  ...
  /** Request body */
  var resource: CryptoKey = js.native
...
object UpdateMask {
  ...
  @scala.inline
  def apply(name: String, resource: CryptoKey): UpdateMask = {
  ...
  implicit class UpdateMaskMutableBuilder[Self <: UpdateMask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CryptoKey): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
