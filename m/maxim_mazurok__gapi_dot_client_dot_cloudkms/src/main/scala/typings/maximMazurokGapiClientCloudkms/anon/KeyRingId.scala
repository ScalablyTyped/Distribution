...
import typings.maximMazurokGapiClientCloudkms.gapi.client.cloudkms.KeyRing
...
@js.native
trait KeyRingId extends StObject {
  ...
  /** Request body */
  var resource: KeyRing = js.native
...
object KeyRingId {
  ...
  @scala.inline
  def apply(parent: String, resource: KeyRing): KeyRingId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyRingId]
  }
  
  @scala.inline
  implicit class KeyRingIdMutableBuilder[Self <: KeyRingId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: KeyRing): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
