...
@js.native
trait KeyRingId extends js.Object {
...
object KeyRingId {
  ...
  @scala.inline
  implicit class KeyRingIdOps[Self <: KeyRingId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: KeyRing): Self = this.set("resource", value.asInstanceOf[js.Any])
