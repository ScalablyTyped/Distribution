...
object KeyRingId {
  ...
  inline def apply(parent: String, resource: KeyRing): KeyRingId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyRingId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: KeyRing): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
