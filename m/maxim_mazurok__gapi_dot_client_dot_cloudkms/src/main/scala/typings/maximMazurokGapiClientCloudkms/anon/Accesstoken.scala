...
trait Accesstoken extends StObject {
  ...
  /** Request body */
  var resource: AsymmetricDecryptRequest = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(name: String, resource: AsymmetricDecryptRequest): Accesstoken = {
  ...
  implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AsymmetricDecryptRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
