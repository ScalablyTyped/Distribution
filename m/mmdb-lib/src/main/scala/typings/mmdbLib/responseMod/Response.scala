...
object Response {
  ...
  inline def AnonymousIPResponse(): typings.mmdbLib.responseMod.AnonymousIPResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typings.mmdbLib.responseMod.AnonymousIPResponse]
  }
  
  inline def AsnResponse(autonomous_system_number: Double, autonomous_system_organization: String): typings.mmdbLib.responseMod.AsnResponse = {
  ...
  inline def CityResponse(): typings.mmdbLib.responseMod.CityResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typings.mmdbLib.responseMod.CityResponse]
  }
  
  inline def ConnectionTypeResponse(connection_type: String): typings.mmdbLib.responseMod.ConnectionTypeResponse = {
  ...
  inline def CountryResponse(): typings.mmdbLib.responseMod.CountryResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typings.mmdbLib.responseMod.CountryResponse]
  }
  
  inline def DomainResponse(domain: String): typings.mmdbLib.responseMod.DomainResponse = {
