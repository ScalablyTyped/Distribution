...
object AnonymousIPResponse {
  ...
  inline def apply(): AnonymousIPResponse = {
  ...
  extension [Self <: AnonymousIPResponse](x: Self) {
    ...
    inline def setIs_residential_proxy(value: Boolean): Self = StObject.set(x, "is_residential_proxy", value.asInstanceOf[js.Any])
    
    inline def setIs_residential_proxyUndefined: Self = StObject.set(x, "is_residential_proxy", js.undefined)
