...
object deprecatedConstantsMod {
  
  object cssClasses {
    
    @JSImport("@material/switch/deprecated/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    /** Class used for a switch that is in the "checked" (on) position. */
    @JSImport("@material/switch/deprecated/constants", "cssClasses.CHECKED")
    @js.native
    ...
    @JSImport("@material/switch/deprecated/constants", "cssClasses.DISABLED")
    @js.native
  ...
  object strings {
    ...
    @JSImport("@material/switch/deprecated/constants", "strings")
    @js.native
    val ^ : js.Any = js.native
    
    /** Aria attribute for checked or unchecked state of switch */
    @JSImport("@material/switch/deprecated/constants", "strings.ARIA_CHECKED_ATTR")
    @js.native
    ...
    @JSImport("@material/switch/deprecated/constants", "strings.NATIVE_CONTROL_SELECTOR")
    @js.native
    ...
    @JSImport("@material/switch/deprecated/constants", "strings.RIPPLE_SURFACE_SELECTOR")
    @js.native
