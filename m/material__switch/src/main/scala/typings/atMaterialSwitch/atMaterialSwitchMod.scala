...
@js.native
object atMaterialSwitchMod extends js.Object {
  @js.native
  class MDCSwitch ()
    extends typings.atMaterialSwitch.componentMod.MDCSwitch
  
  @js.native
  class MDCSwitchFoundation ()
    extends typings.atMaterialSwitch.foundationMod.MDCSwitchFoundation {
