...
object forward30RoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Forward30Rounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `forward30RoundedMod.foo` */
