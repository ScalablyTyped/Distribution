...
object pauseCircleFilledRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PauseCircleFilledRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `pauseCircleFilledRoundedMod.foo` */
