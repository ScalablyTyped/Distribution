...
object desktopAccessDisabledOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/DesktopAccessDisabledOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `desktopAccessDisabledOutlinedMod.foo` */
