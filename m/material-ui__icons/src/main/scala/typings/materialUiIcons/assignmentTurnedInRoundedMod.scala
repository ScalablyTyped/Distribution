...
object assignmentTurnedInRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AssignmentTurnedInRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `assignmentTurnedInRoundedMod.foo` */
