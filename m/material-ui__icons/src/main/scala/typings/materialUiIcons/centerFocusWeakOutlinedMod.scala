...
object centerFocusWeakOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CenterFocusWeakOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `centerFocusWeakOutlinedMod.foo` */
