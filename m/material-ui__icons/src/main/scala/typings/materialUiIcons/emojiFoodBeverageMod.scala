...
object emojiFoodBeverageMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/EmojiFoodBeverage", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `emojiFoodBeverageMod.foo` */
