...
object twoWheelerMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/TwoWheeler", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `twoWheelerMod.foo` */
