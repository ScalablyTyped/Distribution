...
object signalCellular0BarOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SignalCellular0BarOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `signalCellular0BarOutlinedMod.foo` */
