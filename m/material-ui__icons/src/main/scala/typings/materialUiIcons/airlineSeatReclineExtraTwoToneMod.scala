...
object airlineSeatReclineExtraTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AirlineSeatReclineExtraTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `airlineSeatReclineExtraTwoToneMod.foo` */
