...
object flipCameraAndroidMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FlipCameraAndroid", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `flipCameraAndroidMod.foo` */
