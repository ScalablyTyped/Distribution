...
object looks4SharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Looks4Sharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `looks4SharpMod.foo` */
