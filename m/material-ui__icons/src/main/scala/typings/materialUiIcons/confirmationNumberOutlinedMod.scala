...
object confirmationNumberOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/ConfirmationNumberOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `confirmationNumberOutlinedMod.foo` */
