...
object fireplaceMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Fireplace", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `fireplaceMod.foo` */
