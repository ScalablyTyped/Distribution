...
object exposureNeg1TwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/ExposureNeg1TwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `exposureNeg1TwoToneMod.foo` */
