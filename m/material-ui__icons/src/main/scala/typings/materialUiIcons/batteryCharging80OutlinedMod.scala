...
object batteryCharging80OutlinedMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `batteryCharging80OutlinedMod.foo` */
