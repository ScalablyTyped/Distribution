...
object settingsInputHdmiTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SettingsInputHdmiTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `settingsInputHdmiTwoToneMod.foo` */
