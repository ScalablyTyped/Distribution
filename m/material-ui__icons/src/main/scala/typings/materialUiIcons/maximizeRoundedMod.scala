...
object maximizeRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/MaximizeRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `maximizeRoundedMod.foo` */
