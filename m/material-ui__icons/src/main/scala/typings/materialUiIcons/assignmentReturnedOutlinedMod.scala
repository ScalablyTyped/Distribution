...
object assignmentReturnedOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AssignmentReturnedOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `assignmentReturnedOutlinedMod.foo` */
