...
object replay30RoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Replay30Rounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `replay30RoundedMod.foo` */
