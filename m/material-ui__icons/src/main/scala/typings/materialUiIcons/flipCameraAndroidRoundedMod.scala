...
object flipCameraAndroidRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FlipCameraAndroidRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `flipCameraAndroidRoundedMod.foo` */
