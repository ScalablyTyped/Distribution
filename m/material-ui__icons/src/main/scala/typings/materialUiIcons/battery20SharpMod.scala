...
object battery20SharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Battery20Sharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `battery20SharpMod.foo` */
