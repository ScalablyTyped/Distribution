...
object screenLockLandscapeSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/ScreenLockLandscapeSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `screenLockLandscapeSharpMod.foo` */
