...
object accountBalanceWalletOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AccountBalanceWalletOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `accountBalanceWalletOutlinedMod.foo` */
