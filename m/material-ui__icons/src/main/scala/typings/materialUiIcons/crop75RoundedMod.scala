...
object crop75RoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Crop75Rounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `crop75RoundedMod.foo` */
