...
object keyboardArrowRightRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/KeyboardArrowRightRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `keyboardArrowRightRoundedMod.foo` */
