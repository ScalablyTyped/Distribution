...
object addToHomeScreenSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AddToHomeScreenSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `addToHomeScreenSharpMod.foo` */
