...
object exposureNeg2TwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/ExposureNeg2TwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `exposureNeg2TwoToneMod.foo` */
