...
object cameraEnhanceTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CameraEnhanceTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `cameraEnhanceTwoToneMod.foo` */
