...
object monetizationOnTwoToneMod extends Shortcut {
  
  @JSImport("@material-ui/icons/MonetizationOnTwoTone", JSImport.Default)
  @js.native
  val default: ComponentType[SvgIconProps] = js.native
  
  type _To = ComponentType[SvgIconProps]
  
  /* This means you don't have to write `default`, but can instead just say `monetizationOnTwoToneMod.foo` */
