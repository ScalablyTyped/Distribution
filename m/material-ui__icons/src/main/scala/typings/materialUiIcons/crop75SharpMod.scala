...
object crop75SharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Crop75Sharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `crop75SharpMod.foo` */
