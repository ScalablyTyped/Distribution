...
object sentimentSatisfiedTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SentimentSatisfiedTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `sentimentSatisfiedTwoToneMod.foo` */
