...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet1BarOutlined", JSImport.Namespace)
@js.native
object signalCellularConnectedNoInternet1BarOutlinedMod extends js.Object {
  @js.native
  class default protected ()
    extends typings.materialUiCore.svgIconMod.default {
