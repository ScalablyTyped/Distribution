...
object signalCellularConnectedNoInternet1BarOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SignalCellularConnectedNoInternet1BarOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `signalCellularConnectedNoInternet1BarOutlinedMod.foo` */
