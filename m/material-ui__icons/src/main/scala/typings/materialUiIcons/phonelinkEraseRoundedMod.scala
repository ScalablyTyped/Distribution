...
object phonelinkEraseRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PhonelinkEraseRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `phonelinkEraseRoundedMod.foo` */
