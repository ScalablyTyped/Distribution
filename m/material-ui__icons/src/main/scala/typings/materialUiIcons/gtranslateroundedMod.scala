...
object gtranslateroundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/GTranslateRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `gtranslateroundedMod.foo` */
