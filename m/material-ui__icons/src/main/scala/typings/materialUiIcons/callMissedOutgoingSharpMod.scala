...
object callMissedOutgoingSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CallMissedOutgoingSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `callMissedOutgoingSharpMod.foo` */
