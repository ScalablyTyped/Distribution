...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet2BarSharp", JSImport.Namespace)
@js.native
object signalCellularConnectedNoInternet2BarSharpMod extends js.Object {
  @js.native
