...
object checkCircleOutlineOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CheckCircleOutlineOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `checkCircleOutlineOutlinedMod.foo` */
