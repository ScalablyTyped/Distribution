...
object settingsBrightnessRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SettingsBrightnessRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `settingsBrightnessRoundedMod.foo` */
