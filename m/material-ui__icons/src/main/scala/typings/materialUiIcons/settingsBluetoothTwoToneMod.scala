...
object settingsBluetoothTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SettingsBluetoothTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `settingsBluetoothTwoToneMod.foo` */
