...
object airlineSeatLegroomExtraRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AirlineSeatLegroomExtraRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `airlineSeatLegroomExtraRoundedMod.foo` */
