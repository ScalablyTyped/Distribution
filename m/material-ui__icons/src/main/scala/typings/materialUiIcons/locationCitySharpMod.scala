...
object locationCitySharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/LocationCitySharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `locationCitySharpMod.foo` */
