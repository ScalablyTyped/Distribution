...
object panoramaFishEyeSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PanoramaFishEyeSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `panoramaFishEyeSharpMod.foo` */
