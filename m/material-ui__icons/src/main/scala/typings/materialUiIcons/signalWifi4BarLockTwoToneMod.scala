...
object signalWifi4BarLockTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SignalWifi4BarLockTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `signalWifi4BarLockTwoToneMod.foo` */
