...
object timer3RoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Timer3Rounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `timer3RoundedMod.foo` */
