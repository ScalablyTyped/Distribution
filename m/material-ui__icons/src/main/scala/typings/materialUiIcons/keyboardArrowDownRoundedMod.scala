...
object keyboardArrowDownRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/KeyboardArrowDownRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `keyboardArrowDownRoundedMod.foo` */
