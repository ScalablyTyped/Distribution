...
object pictureAsPdfTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PictureAsPdfTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `pictureAsPdfTwoToneMod.foo` */
