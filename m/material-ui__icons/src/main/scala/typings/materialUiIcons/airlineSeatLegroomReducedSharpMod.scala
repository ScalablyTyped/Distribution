...
object airlineSeatLegroomReducedSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AirlineSeatLegroomReducedSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `airlineSeatLegroomReducedSharpMod.foo` */
