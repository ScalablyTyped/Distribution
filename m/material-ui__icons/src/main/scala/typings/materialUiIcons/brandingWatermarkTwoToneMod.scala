...
object brandingWatermarkTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BrandingWatermarkTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `brandingWatermarkTwoToneMod.foo` */
