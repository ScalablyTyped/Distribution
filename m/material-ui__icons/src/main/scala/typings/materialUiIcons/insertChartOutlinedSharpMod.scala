...
object insertChartOutlinedSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/InsertChartOutlinedSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `insertChartOutlinedSharpMod.foo` */
