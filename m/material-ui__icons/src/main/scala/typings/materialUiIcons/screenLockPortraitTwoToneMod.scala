...
object screenLockPortraitTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/ScreenLockPortraitTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `screenLockPortraitTwoToneMod.foo` */
