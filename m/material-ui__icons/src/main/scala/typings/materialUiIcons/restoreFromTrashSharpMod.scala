...
object restoreFromTrashSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/RestoreFromTrashSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `restoreFromTrashSharpMod.foo` */
