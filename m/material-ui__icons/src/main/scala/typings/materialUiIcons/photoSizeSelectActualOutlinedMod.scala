...
object photoSizeSelectActualOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PhotoSizeSelectActualOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `photoSizeSelectActualOutlinedMod.foo` */
