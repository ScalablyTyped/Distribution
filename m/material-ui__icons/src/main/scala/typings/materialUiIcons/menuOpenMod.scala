...
object menuOpenMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/MenuOpen", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `menuOpenMod.foo` */
