...
object accessibilitySharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AccessibilitySharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `accessibilitySharpMod.foo` */
