...
object batteryCharging90OutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BatteryCharging90Outlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `batteryCharging90OutlinedMod.foo` */
