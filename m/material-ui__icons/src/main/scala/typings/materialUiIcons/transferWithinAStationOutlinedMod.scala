...
object transferWithinAStationOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/TransferWithinAStationOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `transferWithinAStationOutlinedMod.foo` */
