...
object timer10RoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Timer10Rounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `timer10RoundedMod.foo` */
