...
object filter3OutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Filter3Outlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `filter3OutlinedMod.foo` */
