...
object subwaySharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SubwaySharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `subwaySharpMod.foo` */
