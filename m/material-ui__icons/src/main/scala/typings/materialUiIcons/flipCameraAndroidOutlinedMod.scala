...
object flipCameraAndroidOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FlipCameraAndroidOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `flipCameraAndroidOutlinedMod.foo` */
