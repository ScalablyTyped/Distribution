...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet1BarSharp", JSImport.Namespace)
@js.native
object signalCellularConnectedNoInternet1BarSharpMod extends js.Object {
  @js.native
