...
object batteryChargingFullTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BatteryChargingFullTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `batteryChargingFullTwoToneMod.foo` */
