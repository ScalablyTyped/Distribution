...
object airlineSeatReclineNormalTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AirlineSeatReclineNormalTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `airlineSeatReclineNormalTwoToneMod.foo` */
