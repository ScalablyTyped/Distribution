...
object brandingWatermarkSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BrandingWatermarkSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `brandingWatermarkSharpMod.foo` */
