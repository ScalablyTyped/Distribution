...
object airplanemodeInactiveOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AirplanemodeInactiveOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `airplanemodeInactiveOutlinedMod.foo` */
