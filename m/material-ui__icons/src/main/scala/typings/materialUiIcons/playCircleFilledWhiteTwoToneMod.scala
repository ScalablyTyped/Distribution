...
object playCircleFilledWhiteTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PlayCircleFilledWhiteTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `playCircleFilledWhiteTwoToneMod.foo` */
