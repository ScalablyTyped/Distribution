...
object filterCenterFocusSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FilterCenterFocusSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `filterCenterFocusSharpMod.foo` */
