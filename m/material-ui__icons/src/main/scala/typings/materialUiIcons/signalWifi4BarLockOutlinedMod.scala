...
object signalWifi4BarLockOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SignalWifi4BarLockOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `signalWifi4BarLockOutlinedMod.foo` */
