...
@JSImport("@material-ui/icons", "AddPhotoAlternateRounded")
@js.native
class AddPhotoAlternateRounded protected ()
...
@JSImport("@material-ui/icons", "AddPhotoAlternateRounded")
@js.native
object AddPhotoAlternateRounded extends TopLevel[SvgIconComponent]
