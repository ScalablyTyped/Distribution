...
@JSImport("@material-ui/icons", "TextRotationDownOutlined")
@js.native
class TextRotationDownOutlined protected ()
...
@JSImport("@material-ui/icons", "TextRotationDownOutlined")
@js.native
object TextRotationDownOutlined extends TopLevel[SvgIconComponent]
