...
@JSImport("@material-ui/icons", "CastForEducationTwoTone")
@js.native
class CastForEducationTwoTone protected ()
...
@JSImport("@material-ui/icons", "CastForEducationTwoTone")
@js.native
object CastForEducationTwoTone extends TopLevel[SvgIconComponent]
