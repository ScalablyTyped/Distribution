...
@JSImport("@material-ui/icons", "CreateNewFolderTwoTone")
@js.native
class CreateNewFolderTwoTone protected ()
...
@JSImport("@material-ui/icons", "CreateNewFolderTwoTone")
@js.native
object CreateNewFolderTwoTone extends TopLevel[SvgIconComponent]
