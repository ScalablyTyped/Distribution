...
@JSImport("@material-ui/icons", "CompassCalibrationSharp")
@js.native
class CompassCalibrationSharp protected ()
...
@JSImport("@material-ui/icons", "CompassCalibrationSharp")
@js.native
object CompassCalibrationSharp extends TopLevel[SvgIconComponent]
