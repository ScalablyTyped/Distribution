...
@JSImport("@material-ui/icons", "MonochromePhotosRounded")
@js.native
class MonochromePhotosRounded protected ()
...
@JSImport("@material-ui/icons", "MonochromePhotosRounded")
@js.native
object MonochromePhotosRounded extends TopLevel[SvgIconComponent]
