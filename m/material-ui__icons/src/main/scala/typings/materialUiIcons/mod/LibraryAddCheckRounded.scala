...
@JSImport("@material-ui/icons", "LibraryAddCheckRounded")
@js.native
class LibraryAddCheckRounded protected ()
...
@JSImport("@material-ui/icons", "LibraryAddCheckRounded")
@js.native
object LibraryAddCheckRounded extends TopLevel[SvgIconComponent]
