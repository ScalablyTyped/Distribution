...
@JSImport("@material-ui/icons", "RecordVoiceOverRounded")
@js.native
class RecordVoiceOverRounded protected ()
...
@JSImport("@material-ui/icons", "RecordVoiceOverRounded")
@js.native
object RecordVoiceOverRounded extends TopLevel[SvgIconComponent]
