...
@JSImport("@material-ui/icons", "FiberManualRecordTwoTone")
@js.native
class FiberManualRecordTwoTone protected ()
...
@JSImport("@material-ui/icons", "FiberManualRecordTwoTone")
@js.native
object FiberManualRecordTwoTone extends TopLevel[SvgIconComponent]
