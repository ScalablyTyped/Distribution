...
@JSImport("@material-ui/icons", "BatteryCharging60Sharp")
@js.native
class BatteryCharging60Sharp protected ()
...
@JSImport("@material-ui/icons", "BatteryCharging60Sharp")
@js.native
object BatteryCharging60Sharp extends TopLevel[SvgIconComponent]
