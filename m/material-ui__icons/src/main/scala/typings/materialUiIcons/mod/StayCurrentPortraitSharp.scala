...
@JSImport("@material-ui/icons", "StayCurrentPortraitSharp")
@js.native
class StayCurrentPortraitSharp protected ()
...
@JSImport("@material-ui/icons", "StayCurrentPortraitSharp")
@js.native
object StayCurrentPortraitSharp extends TopLevel[SvgIconComponent]
