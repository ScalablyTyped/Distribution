...
@JSImport("@material-ui/icons", "YoutubeSearchedForSharp")
@js.native
class YoutubeSearchedForSharp protected ()
...
@JSImport("@material-ui/icons", "YoutubeSearchedForSharp")
@js.native
object YoutubeSearchedForSharp extends TopLevel[SvgIconComponent]
