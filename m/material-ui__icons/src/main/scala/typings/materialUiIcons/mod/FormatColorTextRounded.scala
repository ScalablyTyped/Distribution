...
@JSImport("@material-ui/icons", "FormatColorTextRounded")
@js.native
class FormatColorTextRounded protected ()
...
@JSImport("@material-ui/icons", "FormatColorTextRounded")
@js.native
object FormatColorTextRounded extends TopLevel[SvgIconComponent]
