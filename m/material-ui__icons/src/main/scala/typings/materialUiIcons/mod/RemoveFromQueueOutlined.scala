...
@JSImport("@material-ui/icons", "RemoveFromQueueOutlined")
@js.native
class RemoveFromQueueOutlined protected ()
...
@JSImport("@material-ui/icons", "RemoveFromQueueOutlined")
@js.native
object RemoveFromQueueOutlined extends TopLevel[SvgIconComponent]
