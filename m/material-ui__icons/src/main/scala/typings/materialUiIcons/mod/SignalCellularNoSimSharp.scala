...
@JSImport("@material-ui/icons", "SignalCellularNoSimSharp")
@js.native
class SignalCellularNoSimSharp protected ()
...
@JSImport("@material-ui/icons", "SignalCellularNoSimSharp")
@js.native
object SignalCellularNoSimSharp extends TopLevel[SvgIconComponent]
