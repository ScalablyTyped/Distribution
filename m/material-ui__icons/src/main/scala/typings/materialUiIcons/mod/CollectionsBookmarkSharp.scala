...
@JSImport("@material-ui/icons", "CollectionsBookmarkSharp")
@js.native
class CollectionsBookmarkSharp protected ()
...
@JSImport("@material-ui/icons", "CollectionsBookmarkSharp")
@js.native
object CollectionsBookmarkSharp extends TopLevel[SvgIconComponent]
