...
@JSImport("@material-ui/icons", "PlayCircleOutlineRounded")
@js.native
class PlayCircleOutlineRounded protected ()
...
@JSImport("@material-ui/icons", "PlayCircleOutlineRounded")
@js.native
object PlayCircleOutlineRounded extends TopLevel[SvgIconComponent]
