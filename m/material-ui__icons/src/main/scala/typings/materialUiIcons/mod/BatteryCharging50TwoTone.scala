...
@JSImport("@material-ui/icons", "BatteryCharging50TwoTone")
@js.native
class BatteryCharging50TwoTone protected ()
...
@JSImport("@material-ui/icons", "BatteryCharging50TwoTone")
@js.native
object BatteryCharging50TwoTone extends TopLevel[SvgIconComponent]
