...
@JSImport("@material-ui/icons", "PlayCircleOutlineTwoTone")
@js.native
class PlayCircleOutlineTwoTone protected ()
...
@JSImport("@material-ui/icons", "PlayCircleOutlineTwoTone")
@js.native
object PlayCircleOutlineTwoTone extends TopLevel[SvgIconComponent]
