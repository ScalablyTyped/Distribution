...
@JSImport("@material-ui/icons", "SettingsOverscanOutlined")
@js.native
class SettingsOverscanOutlined protected ()
...
@JSImport("@material-ui/icons", "SettingsOverscanOutlined")
@js.native
object SettingsOverscanOutlined extends TopLevel[SvgIconComponent]
