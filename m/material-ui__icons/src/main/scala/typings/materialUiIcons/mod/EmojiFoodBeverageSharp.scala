...
@JSImport("@material-ui/icons", "EmojiFoodBeverageSharp")
@js.native
class EmojiFoodBeverageSharp protected ()
...
@JSImport("@material-ui/icons", "EmojiFoodBeverageSharp")
@js.native
object EmojiFoodBeverageSharp extends TopLevel[SvgIconComponent]
