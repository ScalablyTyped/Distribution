...
@JSImport("@material-ui/icons", "AccessibilityNewTwoTone")
@js.native
class AccessibilityNewTwoTone protected ()
...
@JSImport("@material-ui/icons", "AccessibilityNewTwoTone")
@js.native
object AccessibilityNewTwoTone extends TopLevel[SvgIconComponent]
