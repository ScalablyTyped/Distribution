...
@JSImport("@material-ui/icons", "BatteryCharging20TwoTone")
@js.native
class BatteryCharging20TwoTone protected ()
...
@JSImport("@material-ui/icons", "BatteryCharging20TwoTone")
@js.native
object BatteryCharging20TwoTone extends TopLevel[SvgIconComponent]
