...
@JSImport("@material-ui/icons", "PermDataSettingRounded")
@js.native
class PermDataSettingRounded protected ()
...
@JSImport("@material-ui/icons", "PermDataSettingRounded")
@js.native
object PermDataSettingRounded extends TopLevel[SvgIconComponent]
