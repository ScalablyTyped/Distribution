...
@JSImport("@material-ui/icons", "StrikethroughSOutlined")
@js.native
class StrikethroughSOutlined protected ()
...
@JSImport("@material-ui/icons", "StrikethroughSOutlined")
@js.native
object StrikethroughSOutlined extends TopLevel[SvgIconComponent]
