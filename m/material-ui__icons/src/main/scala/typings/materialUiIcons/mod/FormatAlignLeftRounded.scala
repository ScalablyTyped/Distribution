...
@JSImport("@material-ui/icons", "FormatAlignLeftRounded")
@js.native
class FormatAlignLeftRounded protected ()
...
@JSImport("@material-ui/icons", "FormatAlignLeftRounded")
@js.native
object FormatAlignLeftRounded extends TopLevel[SvgIconComponent]
