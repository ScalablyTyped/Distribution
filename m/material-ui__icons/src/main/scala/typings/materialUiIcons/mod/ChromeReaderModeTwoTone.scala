...
@JSImport("@material-ui/icons", "ChromeReaderModeTwoTone")
@js.native
class ChromeReaderModeTwoTone protected ()
...
@JSImport("@material-ui/icons", "ChromeReaderModeTwoTone")
@js.native
object ChromeReaderModeTwoTone extends TopLevel[SvgIconComponent]
