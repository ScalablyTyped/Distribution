...
@JSImport("@material-ui/icons", "DirectionsBikeOutlined")
@js.native
class DirectionsBikeOutlined protected ()
...
@JSImport("@material-ui/icons", "DirectionsBikeOutlined")
@js.native
object DirectionsBikeOutlined extends TopLevel[SvgIconComponent]
