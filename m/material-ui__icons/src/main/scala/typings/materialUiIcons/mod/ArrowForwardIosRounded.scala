...
@JSImport("@material-ui/icons", "ArrowForwardIosRounded")
@js.native
class ArrowForwardIosRounded protected ()
...
@JSImport("@material-ui/icons", "ArrowForwardIosRounded")
@js.native
object ArrowForwardIosRounded extends TopLevel[SvgIconComponent]
