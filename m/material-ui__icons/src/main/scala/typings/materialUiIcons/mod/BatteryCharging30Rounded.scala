...
@JSImport("@material-ui/icons", "BatteryCharging30Rounded")
@js.native
class BatteryCharging30Rounded protected ()
...
@JSImport("@material-ui/icons", "BatteryCharging30Rounded")
@js.native
object BatteryCharging30Rounded extends TopLevel[SvgIconComponent]
