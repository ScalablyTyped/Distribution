...
@JSImport("@material-ui/icons", "PlaylistAddCheckRounded")
@js.native
class PlaylistAddCheckRounded protected ()
...
@JSImport("@material-ui/icons", "PlaylistAddCheckRounded")
@js.native
object PlaylistAddCheckRounded extends TopLevel[SvgIconComponent]
