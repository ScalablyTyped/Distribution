...
@JSImport("@material-ui/icons", "RadioButtonCheckedSharp")
@js.native
class RadioButtonCheckedSharp protected ()
...
@JSImport("@material-ui/icons", "RadioButtonCheckedSharp")
@js.native
object RadioButtonCheckedSharp extends TopLevel[SvgIconComponent]
