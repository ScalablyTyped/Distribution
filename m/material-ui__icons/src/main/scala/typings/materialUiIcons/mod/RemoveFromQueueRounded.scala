...
@JSImport("@material-ui/icons", "RemoveFromQueueRounded")
@js.native
class RemoveFromQueueRounded protected ()
...
@JSImport("@material-ui/icons", "RemoveFromQueueRounded")
@js.native
object RemoveFromQueueRounded extends TopLevel[SvgIconComponent]
