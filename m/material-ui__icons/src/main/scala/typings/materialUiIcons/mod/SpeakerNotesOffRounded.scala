...
@JSImport("@material-ui/icons", "SpeakerNotesOffRounded")
@js.native
class SpeakerNotesOffRounded protected ()
...
@JSImport("@material-ui/icons", "SpeakerNotesOffRounded")
@js.native
object SpeakerNotesOffRounded extends TopLevel[SvgIconComponent]
