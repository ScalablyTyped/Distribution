...
@JSImport("@material-ui/icons", "MarkunreadMailboxSharp")
@js.native
class MarkunreadMailboxSharp protected ()
...
@JSImport("@material-ui/icons", "MarkunreadMailboxSharp")
@js.native
object MarkunreadMailboxSharp extends TopLevel[SvgIconComponent]
