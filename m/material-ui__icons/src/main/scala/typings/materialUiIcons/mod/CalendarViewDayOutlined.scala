...
@JSImport("@material-ui/icons", "CalendarViewDayOutlined")
@js.native
class CalendarViewDayOutlined protected ()
...
@JSImport("@material-ui/icons", "CalendarViewDayOutlined")
@js.native
object CalendarViewDayOutlined extends TopLevel[SvgIconComponent]
