...
@JSImport("@material-ui/icons", "ArrowForwardIosTwoTone")
@js.native
class ArrowForwardIosTwoTone protected ()
...
@JSImport("@material-ui/icons", "ArrowForwardIosTwoTone")
@js.native
object ArrowForwardIosTwoTone extends TopLevel[SvgIconComponent]
