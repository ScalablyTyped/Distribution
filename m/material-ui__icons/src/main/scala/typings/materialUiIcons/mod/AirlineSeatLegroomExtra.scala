...
@JSImport("@material-ui/icons", "AirlineSeatLegroomExtra")
@js.native
class AirlineSeatLegroomExtra protected ()
...
@JSImport("@material-ui/icons", "AirlineSeatLegroomExtra")
@js.native
object AirlineSeatLegroomExtra extends TopLevel[SvgIconComponent]
