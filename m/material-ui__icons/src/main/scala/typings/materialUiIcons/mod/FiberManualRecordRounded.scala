...
@JSImport("@material-ui/icons", "FiberManualRecordRounded")
@js.native
class FiberManualRecordRounded protected ()
...
@JSImport("@material-ui/icons", "FiberManualRecordRounded")
@js.native
object FiberManualRecordRounded extends TopLevel[SvgIconComponent]
