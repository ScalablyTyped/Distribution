...
@JSImport("@material-ui/icons", "PictureInPictureTwoTone")
@js.native
class PictureInPictureTwoTone protected ()
...
@JSImport("@material-ui/icons", "PictureInPictureTwoTone")
@js.native
object PictureInPictureTwoTone extends TopLevel[SvgIconComponent]
