...
@JSImport("@material-ui/icons", "PermDataSettingOutlined")
@js.native
class PermDataSettingOutlined protected ()
...
@JSImport("@material-ui/icons", "PermDataSettingOutlined")
@js.native
object PermDataSettingOutlined extends TopLevel[SvgIconComponent]
