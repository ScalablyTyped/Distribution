...
@JSImport("@material-ui/icons", "MonochromePhotosTwoTone")
@js.native
class MonochromePhotosTwoTone protected ()
...
@JSImport("@material-ui/icons", "MonochromePhotosTwoTone")
@js.native
object MonochromePhotosTwoTone extends TopLevel[SvgIconComponent]
