...
@JSImport("@material-ui/icons", "CenterFocusWeakTwoTone")
@js.native
class CenterFocusWeakTwoTone protected ()
...
@JSImport("@material-ui/icons", "CenterFocusWeakTwoTone")
@js.native
object CenterFocusWeakTwoTone extends TopLevel[SvgIconComponent]
