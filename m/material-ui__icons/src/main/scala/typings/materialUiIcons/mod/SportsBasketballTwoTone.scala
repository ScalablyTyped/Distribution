...
@JSImport("@material-ui/icons", "SportsBasketballTwoTone")
@js.native
class SportsBasketballTwoTone protected ()
...
@JSImport("@material-ui/icons", "SportsBasketballTwoTone")
@js.native
object SportsBasketballTwoTone extends TopLevel[SvgIconComponent]
