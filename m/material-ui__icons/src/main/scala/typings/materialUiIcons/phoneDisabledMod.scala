...
object phoneDisabledMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PhoneDisabled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `phoneDisabledMod.foo` */
