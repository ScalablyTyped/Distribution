...
object slowMotionVideoSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SlowMotionVideoSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `slowMotionVideoSharpMod.foo` */
