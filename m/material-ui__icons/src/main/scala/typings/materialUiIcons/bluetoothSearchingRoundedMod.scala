...
object bluetoothSearchingRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BluetoothSearchingRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `bluetoothSearchingRoundedMod.foo` */
