...
object libraryAddCheckTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/LibraryAddCheckTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libraryAddCheckTwoToneMod.foo` */
