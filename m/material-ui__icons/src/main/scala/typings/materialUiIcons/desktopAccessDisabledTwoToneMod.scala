...
object desktopAccessDisabledTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/DesktopAccessDisabledTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `desktopAccessDisabledTwoToneMod.foo` */
