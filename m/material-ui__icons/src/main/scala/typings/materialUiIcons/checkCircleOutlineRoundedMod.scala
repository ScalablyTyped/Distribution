...
object checkCircleOutlineRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CheckCircleOutlineRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `checkCircleOutlineRoundedMod.foo` */
