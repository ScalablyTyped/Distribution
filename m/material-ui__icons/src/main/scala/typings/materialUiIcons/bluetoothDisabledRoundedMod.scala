...
object bluetoothDisabledRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BluetoothDisabledRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `bluetoothDisabledRoundedMod.foo` */
