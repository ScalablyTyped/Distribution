...
object textRotationAngledownTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/TextRotationAngledownTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `textRotationAngledownTwoToneMod.foo` */
