...
object stayCurrentLandscapeSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/StayCurrentLandscapeSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `stayCurrentLandscapeSharpMod.foo` */
