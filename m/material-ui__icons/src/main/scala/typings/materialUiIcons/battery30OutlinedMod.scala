...
object battery30OutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Battery30Outlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `battery30OutlinedMod.foo` */
