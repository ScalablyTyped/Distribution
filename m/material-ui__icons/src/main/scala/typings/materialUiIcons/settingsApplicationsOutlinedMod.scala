...
object settingsApplicationsOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SettingsApplicationsOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `settingsApplicationsOutlinedMod.foo` */
