...
object assignmentTurnedInOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AssignmentTurnedInOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `assignmentTurnedInOutlinedMod.foo` */
