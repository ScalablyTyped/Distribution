...
object signalCellularConnectedNoInternet3BarOutlinedMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `signalCellularConnectedNoInternet3BarOutlinedMod.foo` */
