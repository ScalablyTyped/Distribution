...
object cancelScheduleSendOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CancelScheduleSendOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `cancelScheduleSendOutlinedMod.foo` */
