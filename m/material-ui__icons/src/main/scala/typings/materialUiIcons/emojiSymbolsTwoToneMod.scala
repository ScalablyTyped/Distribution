...
object emojiSymbolsTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/EmojiSymbolsTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `emojiSymbolsTwoToneMod.foo` */
