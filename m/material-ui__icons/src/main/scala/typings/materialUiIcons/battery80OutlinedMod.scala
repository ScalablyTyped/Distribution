...
object battery80OutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Battery80Outlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `battery80OutlinedMod.foo` */
