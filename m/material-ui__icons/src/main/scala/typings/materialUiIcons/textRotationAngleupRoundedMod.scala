...
object textRotationAngleupRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/TextRotationAngleupRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `textRotationAngleupRoundedMod.foo` */
