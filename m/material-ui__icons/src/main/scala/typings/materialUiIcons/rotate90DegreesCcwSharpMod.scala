...
object rotate90DegreesCcwSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Rotate90DegreesCcwSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `rotate90DegreesCcwSharpMod.foo` */
