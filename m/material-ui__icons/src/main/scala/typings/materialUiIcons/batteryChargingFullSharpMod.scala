...
object batteryChargingFullSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BatteryChargingFullSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `batteryChargingFullSharpMod.foo` */
