...
object filter7OutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Filter7Outlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `filter7OutlinedMod.foo` */
