...
object calendarTodaySharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CalendarTodaySharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `calendarTodaySharpMod.foo` */
