...
object sportsTennisMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SportsTennis", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `sportsTennisMod.foo` */
