...
object supervisedUserCircleRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SupervisedUserCircleRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `supervisedUserCircleRoundedMod.foo` */
