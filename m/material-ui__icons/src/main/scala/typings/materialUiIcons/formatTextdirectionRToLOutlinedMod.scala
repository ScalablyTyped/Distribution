...
object formatTextdirectionRToLOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FormatTextdirectionRToLOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `formatTextdirectionRToLOutlinedMod.foo` */
