...
object crop54Mod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Crop54", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `crop54Mod.foo` */
