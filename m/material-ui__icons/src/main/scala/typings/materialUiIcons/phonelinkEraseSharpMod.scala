...
object phonelinkEraseSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PhonelinkEraseSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `phonelinkEraseSharpMod.foo` */
