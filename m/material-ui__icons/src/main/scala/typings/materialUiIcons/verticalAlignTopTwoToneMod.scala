...
object verticalAlignTopTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/VerticalAlignTopTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `verticalAlignTopTwoToneMod.foo` */
