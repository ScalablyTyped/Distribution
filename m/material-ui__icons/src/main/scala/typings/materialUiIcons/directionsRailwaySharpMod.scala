...
object directionsRailwaySharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/DirectionsRailwaySharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `directionsRailwaySharpMod.foo` */
