...
object panoramaHorizontalTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PanoramaHorizontalTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `panoramaHorizontalTwoToneMod.foo` */
