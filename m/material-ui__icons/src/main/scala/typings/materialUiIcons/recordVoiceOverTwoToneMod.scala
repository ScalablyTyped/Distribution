...
object recordVoiceOverTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/RecordVoiceOverTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `recordVoiceOverTwoToneMod.foo` */
