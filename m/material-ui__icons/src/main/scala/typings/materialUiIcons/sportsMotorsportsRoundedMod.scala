...
object sportsMotorsportsRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SportsMotorsportsRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `sportsMotorsportsRoundedMod.foo` */
