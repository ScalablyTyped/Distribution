package typings.atMaterialDashUiIcons.signalCellularConnectedNoInternet2BarSharpMod
...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet2BarSharp", "default")
@js.native
