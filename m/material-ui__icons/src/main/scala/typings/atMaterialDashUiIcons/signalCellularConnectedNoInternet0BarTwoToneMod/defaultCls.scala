package typings.atMaterialDashUiIcons.signalCellularConnectedNoInternet0BarTwoToneMod
...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet0BarTwoTone", "default")
@js.native
