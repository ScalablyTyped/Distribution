...
@JSImport("@material-ui/icons", "FormatAlignJustifyOutlined")
@js.native
class FormatAlignJustifyOutlined protected ()
...
@JSImport("@material-ui/icons", "FormatAlignJustifyOutlined")
@js.native
object FormatAlignJustifyOutlined extends TopLevel[SvgIconComponent]
