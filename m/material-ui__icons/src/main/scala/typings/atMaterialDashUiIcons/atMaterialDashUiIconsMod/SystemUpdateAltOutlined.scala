...
@JSImport("@material-ui/icons", "SystemUpdateAltOutlined")
@js.native
class SystemUpdateAltOutlined protected ()
...
@JSImport("@material-ui/icons", "SystemUpdateAltOutlined")
@js.native
object SystemUpdateAltOutlined extends TopLevel[SvgIconComponent]
