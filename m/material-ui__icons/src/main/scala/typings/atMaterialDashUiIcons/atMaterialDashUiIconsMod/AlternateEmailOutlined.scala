...
@JSImport("@material-ui/icons", "AlternateEmailOutlined")
@js.native
class AlternateEmailOutlined protected ()
...
@JSImport("@material-ui/icons", "AlternateEmailOutlined")
@js.native
object AlternateEmailOutlined extends TopLevel[SvgIconComponent]
