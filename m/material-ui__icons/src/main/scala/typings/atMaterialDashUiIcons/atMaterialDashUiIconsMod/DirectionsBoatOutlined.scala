...
@JSImport("@material-ui/icons", "DirectionsBoatOutlined")
@js.native
class DirectionsBoatOutlined protected ()
...
@JSImport("@material-ui/icons", "DirectionsBoatOutlined")
@js.native
object DirectionsBoatOutlined extends TopLevel[SvgIconComponent]
