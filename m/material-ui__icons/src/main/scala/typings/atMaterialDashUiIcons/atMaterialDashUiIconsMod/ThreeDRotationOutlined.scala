...
@JSImport("@material-ui/icons", "ThreeDRotationOutlined")
@js.native
class ThreeDRotationOutlined protected ()
...
@JSImport("@material-ui/icons", "ThreeDRotationOutlined")
@js.native
object ThreeDRotationOutlined extends TopLevel[SvgIconComponent]
