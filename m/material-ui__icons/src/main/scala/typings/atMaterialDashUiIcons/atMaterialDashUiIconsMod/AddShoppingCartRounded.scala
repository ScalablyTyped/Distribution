...
@JSImport("@material-ui/icons", "AddShoppingCartRounded")
@js.native
class AddShoppingCartRounded protected ()
...
@JSImport("@material-ui/icons", "AddShoppingCartRounded")
@js.native
object AddShoppingCartRounded extends TopLevel[SvgIconComponent]
