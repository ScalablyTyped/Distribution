...
@JSImport("@material-ui/icons", "MobileFriendlyOutlined")
@js.native
class MobileFriendlyOutlined protected ()
...
@JSImport("@material-ui/icons", "MobileFriendlyOutlined")
@js.native
object MobileFriendlyOutlined extends TopLevel[SvgIconComponent]
