...
@JSImport("@material-ui/icons", "SubdirectoryArrowRightRounded")
@js.native
class SubdirectoryArrowRightRounded protected ()
...
@JSImport("@material-ui/icons", "SubdirectoryArrowRightRounded")
@js.native
object SubdirectoryArrowRightRounded extends TopLevel[SvgIconComponent]
