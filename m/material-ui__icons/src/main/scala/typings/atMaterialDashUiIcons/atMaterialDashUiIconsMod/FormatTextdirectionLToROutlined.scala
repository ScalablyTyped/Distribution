...
@JSImport("@material-ui/icons", "FormatTextdirectionLToROutlined")
@js.native
class FormatTextdirectionLToROutlined protected ()
...
@JSImport("@material-ui/icons", "FormatTextdirectionLToROutlined")
@js.native
object FormatTextdirectionLToROutlined extends TopLevel[SvgIconComponent]
