...
@JSImport("@material-ui/icons", "StayCurrentPortraitRounded")
@js.native
class StayCurrentPortraitRounded protected ()
...
@JSImport("@material-ui/icons", "StayCurrentPortraitRounded")
@js.native
object StayCurrentPortraitRounded extends TopLevel[SvgIconComponent]
