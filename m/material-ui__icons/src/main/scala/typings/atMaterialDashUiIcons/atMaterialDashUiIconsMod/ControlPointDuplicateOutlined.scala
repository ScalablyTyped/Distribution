...
@JSImport("@material-ui/icons", "ControlPointDuplicateOutlined")
@js.native
class ControlPointDuplicateOutlined protected ()
...
@JSImport("@material-ui/icons", "ControlPointDuplicateOutlined")
@js.native
object ControlPointDuplicateOutlined extends TopLevel[SvgIconComponent]
