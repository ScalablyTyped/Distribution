...
@JSImport("@material-ui/icons", "ScreenLockLandscapeOutlined")
@js.native
class ScreenLockLandscapeOutlined protected ()
...
@JSImport("@material-ui/icons", "ScreenLockLandscapeOutlined")
@js.native
object ScreenLockLandscapeOutlined extends TopLevel[SvgIconComponent]
