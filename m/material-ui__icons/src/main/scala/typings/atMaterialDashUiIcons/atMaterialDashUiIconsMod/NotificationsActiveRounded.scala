...
@JSImport("@material-ui/icons", "NotificationsActiveRounded")
@js.native
class NotificationsActiveRounded protected ()
...
@JSImport("@material-ui/icons", "NotificationsActiveRounded")
@js.native
object NotificationsActiveRounded extends TopLevel[SvgIconComponent]
