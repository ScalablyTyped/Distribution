...
@JSImport("@material-ui/icons", "FormatListBulletedRounded")
@js.native
class FormatListBulletedRounded protected ()
...
@JSImport("@material-ui/icons", "FormatListBulletedRounded")
@js.native
object FormatListBulletedRounded extends TopLevel[SvgIconComponent]
