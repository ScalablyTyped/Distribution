...
@JSImport("@material-ui/icons", "SignalWifi2BarOutlined")
@js.native
class SignalWifi2BarOutlined protected ()
...
@JSImport("@material-ui/icons", "SignalWifi2BarOutlined")
@js.native
object SignalWifi2BarOutlined extends TopLevel[SvgIconComponent]
