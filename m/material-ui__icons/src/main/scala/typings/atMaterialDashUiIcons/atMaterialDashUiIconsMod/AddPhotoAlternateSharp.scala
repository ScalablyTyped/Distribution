...
@JSImport("@material-ui/icons", "AddPhotoAlternateSharp")
@js.native
class AddPhotoAlternateSharp protected ()
...
@JSImport("@material-ui/icons", "AddPhotoAlternateSharp")
@js.native
object AddPhotoAlternateSharp extends TopLevel[SvgIconComponent]
