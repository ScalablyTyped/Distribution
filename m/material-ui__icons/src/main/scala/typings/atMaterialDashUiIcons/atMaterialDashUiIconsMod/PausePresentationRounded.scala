...
@JSImport("@material-ui/icons", "PausePresentationRounded")
@js.native
class PausePresentationRounded protected ()
...
@JSImport("@material-ui/icons", "PausePresentationRounded")
@js.native
object PausePresentationRounded extends TopLevel[SvgIconComponent]
