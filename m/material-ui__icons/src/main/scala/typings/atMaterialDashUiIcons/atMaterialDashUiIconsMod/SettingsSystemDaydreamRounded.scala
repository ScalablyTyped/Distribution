...
@JSImport("@material-ui/icons", "SettingsSystemDaydreamRounded")
@js.native
class SettingsSystemDaydreamRounded protected ()
...
@JSImport("@material-ui/icons", "SettingsSystemDaydreamRounded")
@js.native
object SettingsSystemDaydreamRounded extends TopLevel[SvgIconComponent]
