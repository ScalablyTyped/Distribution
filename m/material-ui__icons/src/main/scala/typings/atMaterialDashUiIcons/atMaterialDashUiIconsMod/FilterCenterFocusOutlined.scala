...
@JSImport("@material-ui/icons", "FilterCenterFocusOutlined")
@js.native
class FilterCenterFocusOutlined protected ()
...
@JSImport("@material-ui/icons", "FilterCenterFocusOutlined")
@js.native
object FilterCenterFocusOutlined extends TopLevel[SvgIconComponent]
