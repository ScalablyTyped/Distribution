...
@JSImport("@material-ui/icons", "HorizontalSplitTwoTone")
@js.native
class HorizontalSplitTwoTone protected ()
...
@JSImport("@material-ui/icons", "HorizontalSplitTwoTone")
@js.native
object HorizontalSplitTwoTone extends TopLevel[SvgIconComponent]
