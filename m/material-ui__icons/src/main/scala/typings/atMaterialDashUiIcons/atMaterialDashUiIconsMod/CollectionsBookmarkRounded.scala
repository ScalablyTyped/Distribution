...
@JSImport("@material-ui/icons", "CollectionsBookmarkRounded")
@js.native
class CollectionsBookmarkRounded protected ()
...
@JSImport("@material-ui/icons", "CollectionsBookmarkRounded")
@js.native
object CollectionsBookmarkRounded extends TopLevel[SvgIconComponent]
