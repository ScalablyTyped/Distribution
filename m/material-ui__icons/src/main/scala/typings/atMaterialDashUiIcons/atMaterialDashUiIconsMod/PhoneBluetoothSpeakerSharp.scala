...
@JSImport("@material-ui/icons", "PhoneBluetoothSpeakerSharp")
@js.native
class PhoneBluetoothSpeakerSharp protected ()
...
@JSImport("@material-ui/icons", "PhoneBluetoothSpeakerSharp")
@js.native
object PhoneBluetoothSpeakerSharp extends TopLevel[SvgIconComponent]
