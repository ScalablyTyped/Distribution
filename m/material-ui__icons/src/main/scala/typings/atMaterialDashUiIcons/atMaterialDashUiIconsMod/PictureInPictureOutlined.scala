...
@JSImport("@material-ui/icons", "PictureInPictureOutlined")
@js.native
class PictureInPictureOutlined protected ()
...
@JSImport("@material-ui/icons", "PictureInPictureOutlined")
@js.native
object PictureInPictureOutlined extends TopLevel[SvgIconComponent]
