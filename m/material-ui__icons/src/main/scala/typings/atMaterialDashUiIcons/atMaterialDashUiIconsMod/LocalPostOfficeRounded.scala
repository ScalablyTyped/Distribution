...
@JSImport("@material-ui/icons", "LocalPostOfficeRounded")
@js.native
class LocalPostOfficeRounded protected ()
...
@JSImport("@material-ui/icons", "LocalPostOfficeRounded")
@js.native
object LocalPostOfficeRounded extends TopLevel[SvgIconComponent]
