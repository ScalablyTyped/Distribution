...
@JSImport("@material-ui/icons", "TextRotateVerticalRounded")
@js.native
class TextRotateVerticalRounded protected ()
...
@JSImport("@material-ui/icons", "TextRotateVerticalRounded")
@js.native
object TextRotateVerticalRounded extends TopLevel[SvgIconComponent]
