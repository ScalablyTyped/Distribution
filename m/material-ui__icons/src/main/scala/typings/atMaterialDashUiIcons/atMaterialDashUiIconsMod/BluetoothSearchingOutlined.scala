...
@JSImport("@material-ui/icons", "BluetoothSearchingOutlined")
@js.native
class BluetoothSearchingOutlined protected ()
...
@JSImport("@material-ui/icons", "BluetoothSearchingOutlined")
@js.native
object BluetoothSearchingOutlined extends TopLevel[SvgIconComponent]
