...
@JSImport("@material-ui/icons", "BatteryCharging80Sharp")
@js.native
class BatteryCharging80Sharp protected ()
...
@JSImport("@material-ui/icons", "BatteryCharging80Sharp")
@js.native
object BatteryCharging80Sharp extends TopLevel[SvgIconComponent]
