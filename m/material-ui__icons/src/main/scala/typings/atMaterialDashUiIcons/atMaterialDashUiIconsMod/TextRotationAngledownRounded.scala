...
@JSImport("@material-ui/icons", "TextRotationAngledownRounded")
@js.native
class TextRotationAngledownRounded protected ()
...
@JSImport("@material-ui/icons", "TextRotationAngledownRounded")
@js.native
object TextRotationAngledownRounded extends TopLevel[SvgIconComponent]
