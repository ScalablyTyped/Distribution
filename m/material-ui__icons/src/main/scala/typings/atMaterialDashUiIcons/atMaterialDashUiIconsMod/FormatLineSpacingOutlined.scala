...
@JSImport("@material-ui/icons", "FormatLineSpacingOutlined")
@js.native
class FormatLineSpacingOutlined protected ()
...
@JSImport("@material-ui/icons", "FormatLineSpacingOutlined")
@js.native
object FormatLineSpacingOutlined extends TopLevel[SvgIconComponent]
