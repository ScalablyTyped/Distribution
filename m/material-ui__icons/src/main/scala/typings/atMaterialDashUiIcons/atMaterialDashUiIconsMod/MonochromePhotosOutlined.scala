...
@JSImport("@material-ui/icons", "MonochromePhotosOutlined")
@js.native
class MonochromePhotosOutlined protected ()
...
@JSImport("@material-ui/icons", "MonochromePhotosOutlined")
@js.native
object MonochromePhotosOutlined extends TopLevel[SvgIconComponent]
