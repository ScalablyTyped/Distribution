...
@JSImport("@material-ui/icons", "SettingsApplicationsOutlined")
@js.native
class SettingsApplicationsOutlined protected ()
...
@JSImport("@material-ui/icons", "SettingsApplicationsOutlined")
@js.native
object SettingsApplicationsOutlined extends TopLevel[SvgIconComponent]
