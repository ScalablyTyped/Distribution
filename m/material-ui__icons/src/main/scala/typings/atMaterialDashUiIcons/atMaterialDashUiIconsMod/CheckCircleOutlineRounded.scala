...
@JSImport("@material-ui/icons", "CheckCircleOutlineRounded")
@js.native
class CheckCircleOutlineRounded protected ()
...
@JSImport("@material-ui/icons", "CheckCircleOutlineRounded")
@js.native
object CheckCircleOutlineRounded extends TopLevel[SvgIconComponent]
