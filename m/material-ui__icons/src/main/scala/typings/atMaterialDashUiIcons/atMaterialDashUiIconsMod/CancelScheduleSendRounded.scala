...
@JSImport("@material-ui/icons", "CancelScheduleSendRounded")
@js.native
class CancelScheduleSendRounded protected ()
...
@JSImport("@material-ui/icons", "CancelScheduleSendRounded")
@js.native
object CancelScheduleSendRounded extends TopLevel[SvgIconComponent]
