...
@JSImport("@material-ui/icons", "ChatBubbleOutlineSharp")
@js.native
class ChatBubbleOutlineSharp protected ()
...
@JSImport("@material-ui/icons", "ChatBubbleOutlineSharp")
@js.native
object ChatBubbleOutlineSharp extends TopLevel[SvgIconComponent]
