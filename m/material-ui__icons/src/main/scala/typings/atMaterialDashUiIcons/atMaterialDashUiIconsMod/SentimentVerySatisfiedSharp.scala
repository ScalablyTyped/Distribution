...
@JSImport("@material-ui/icons", "SentimentVerySatisfiedSharp")
@js.native
class SentimentVerySatisfiedSharp protected ()
...
@JSImport("@material-ui/icons", "SentimentVerySatisfiedSharp")
@js.native
object SentimentVerySatisfiedSharp extends TopLevel[SvgIconComponent]
