...
@JSImport("@material-ui/icons", "KeyboardArrowRightRounded")
@js.native
class KeyboardArrowRightRounded protected ()
...
@JSImport("@material-ui/icons", "KeyboardArrowRightRounded")
@js.native
object KeyboardArrowRightRounded extends TopLevel[SvgIconComponent]
