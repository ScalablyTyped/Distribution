...
@JSImport("@material-ui/icons", "LocalConvenienceStoreSharp")
@js.native
class LocalConvenienceStoreSharp protected ()
...
@JSImport("@material-ui/icons", "LocalConvenienceStoreSharp")
@js.native
object LocalConvenienceStoreSharp extends TopLevel[SvgIconComponent]
