...
@JSImport("@material-ui/icons", "AirlineSeatFlatTwoTone")
@js.native
class AirlineSeatFlatTwoTone protected ()
...
@JSImport("@material-ui/icons", "AirlineSeatFlatTwoTone")
@js.native
object AirlineSeatFlatTwoTone extends TopLevel[SvgIconComponent]
