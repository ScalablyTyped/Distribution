...
@JSImport("@material-ui/icons", "BrightnessMediumRounded")
@js.native
class BrightnessMediumRounded protected ()
...
@JSImport("@material-ui/icons", "BrightnessMediumRounded")
@js.native
object BrightnessMediumRounded extends TopLevel[SvgIconComponent]
