...
@JSImport("@material-ui/icons", "FormatTextdirectionRToLRounded")
@js.native
class FormatTextdirectionRToLRounded protected ()
...
@JSImport("@material-ui/icons", "FormatTextdirectionRToLRounded")
@js.native
object FormatTextdirectionRToLRounded extends TopLevel[SvgIconComponent]
