...
@JSImport("@material-ui/icons", "BluetoothDisabledRounded")
@js.native
class BluetoothDisabledRounded protected ()
...
@JSImport("@material-ui/icons", "BluetoothDisabledRounded")
@js.native
object BluetoothDisabledRounded extends TopLevel[SvgIconComponent]
