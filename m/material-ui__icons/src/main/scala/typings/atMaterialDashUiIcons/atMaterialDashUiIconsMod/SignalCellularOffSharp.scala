...
@JSImport("@material-ui/icons", "SignalCellularOffSharp")
@js.native
class SignalCellularOffSharp protected ()
...
@JSImport("@material-ui/icons", "SignalCellularOffSharp")
@js.native
object SignalCellularOffSharp extends TopLevel[SvgIconComponent]
