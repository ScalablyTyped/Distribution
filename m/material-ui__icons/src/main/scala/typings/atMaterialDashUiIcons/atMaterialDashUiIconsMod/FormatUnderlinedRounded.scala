...
@JSImport("@material-ui/icons", "FormatUnderlinedRounded")
@js.native
class FormatUnderlinedRounded protected ()
...
@JSImport("@material-ui/icons", "FormatUnderlinedRounded")
@js.native
object FormatUnderlinedRounded extends TopLevel[SvgIconComponent]
