...
@JSImport("@material-ui/icons", "EnhancedEncryptionOutlined")
@js.native
class EnhancedEncryptionOutlined protected ()
...
@JSImport("@material-ui/icons", "EnhancedEncryptionOutlined")
@js.native
object EnhancedEncryptionOutlined extends TopLevel[SvgIconComponent]
