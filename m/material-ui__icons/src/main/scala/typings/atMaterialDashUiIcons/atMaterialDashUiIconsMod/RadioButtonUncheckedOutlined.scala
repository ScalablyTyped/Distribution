...
@JSImport("@material-ui/icons", "RadioButtonUncheckedOutlined")
@js.native
class RadioButtonUncheckedOutlined protected ()
...
@JSImport("@material-ui/icons", "RadioButtonUncheckedOutlined")
@js.native
object RadioButtonUncheckedOutlined extends TopLevel[SvgIconComponent]
