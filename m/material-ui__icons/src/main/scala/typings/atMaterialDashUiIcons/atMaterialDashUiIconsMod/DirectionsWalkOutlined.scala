...
@JSImport("@material-ui/icons", "DirectionsWalkOutlined")
@js.native
class DirectionsWalkOutlined protected ()
...
@JSImport("@material-ui/icons", "DirectionsWalkOutlined")
@js.native
object DirectionsWalkOutlined extends TopLevel[SvgIconComponent]
