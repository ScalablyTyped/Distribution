...
@JSImport("@material-ui/icons", "NotListedLocationTwoTone")
@js.native
class NotListedLocationTwoTone protected ()
...
@JSImport("@material-ui/icons", "NotListedLocationTwoTone")
@js.native
object NotListedLocationTwoTone extends TopLevel[SvgIconComponent]
