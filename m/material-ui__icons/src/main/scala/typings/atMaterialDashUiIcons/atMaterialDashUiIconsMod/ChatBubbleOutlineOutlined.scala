...
@JSImport("@material-ui/icons", "ChatBubbleOutlineOutlined")
@js.native
class ChatBubbleOutlineOutlined protected ()
...
@JSImport("@material-ui/icons", "ChatBubbleOutlineOutlined")
@js.native
object ChatBubbleOutlineOutlined extends TopLevel[SvgIconComponent]
