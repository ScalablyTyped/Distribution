...
@JSImport("@material-ui/icons", "PanoramaWideAngleTwoTone")
@js.native
class PanoramaWideAngleTwoTone protected ()
...
@JSImport("@material-ui/icons", "PanoramaWideAngleTwoTone")
@js.native
object PanoramaWideAngleTwoTone extends TopLevel[SvgIconComponent]
