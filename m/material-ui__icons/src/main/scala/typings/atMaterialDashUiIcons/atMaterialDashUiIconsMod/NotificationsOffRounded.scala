...
@JSImport("@material-ui/icons", "NotificationsOffRounded")
@js.native
class NotificationsOffRounded protected ()
...
@JSImport("@material-ui/icons", "NotificationsOffRounded")
@js.native
object NotificationsOffRounded extends TopLevel[SvgIconComponent]
