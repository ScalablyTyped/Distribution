...
@JSImport("@material-ui/icons", "PauseCircleFilledRounded")
@js.native
class PauseCircleFilledRounded protected ()
...
@JSImport("@material-ui/icons", "PauseCircleFilledRounded")
@js.native
object PauseCircleFilledRounded extends TopLevel[SvgIconComponent]
