...
@JSImport("@material-ui/icons", "SettingsInputCompositeRounded")
@js.native
class SettingsInputCompositeRounded protected ()
...
@JSImport("@material-ui/icons", "SettingsInputCompositeRounded")
@js.native
object SettingsInputCompositeRounded extends TopLevel[SvgIconComponent]
