...
@JSImport("@material-ui/icons", "PlayCircleFilledTwoTone")
@js.native
class PlayCircleFilledTwoTone protected ()
...
@JSImport("@material-ui/icons", "PlayCircleFilledTwoTone")
@js.native
object PlayCircleFilledTwoTone extends TopLevel[SvgIconComponent]
