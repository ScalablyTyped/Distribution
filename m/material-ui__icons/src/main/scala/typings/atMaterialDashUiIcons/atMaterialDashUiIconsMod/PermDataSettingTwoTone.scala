...
@JSImport("@material-ui/icons", "PermDataSettingTwoTone")
@js.native
class PermDataSettingTwoTone protected ()
...
@JSImport("@material-ui/icons", "PermDataSettingTwoTone")
@js.native
object PermDataSettingTwoTone extends TopLevel[SvgIconComponent]
