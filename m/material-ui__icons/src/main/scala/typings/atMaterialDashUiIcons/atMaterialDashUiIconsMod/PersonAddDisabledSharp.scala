...
@JSImport("@material-ui/icons", "PersonAddDisabledSharp")
@js.native
class PersonAddDisabledSharp protected ()
...
@JSImport("@material-ui/icons", "PersonAddDisabledSharp")
@js.native
object PersonAddDisabledSharp extends TopLevel[SvgIconComponent]
