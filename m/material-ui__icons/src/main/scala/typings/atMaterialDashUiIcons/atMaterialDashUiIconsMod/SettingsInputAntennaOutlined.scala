...
@JSImport("@material-ui/icons", "SettingsInputAntennaOutlined")
@js.native
class SettingsInputAntennaOutlined protected ()
...
@JSImport("@material-ui/icons", "SettingsInputAntennaOutlined")
@js.native
object SettingsInputAntennaOutlined extends TopLevel[SvgIconComponent]
