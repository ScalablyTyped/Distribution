...
@JSImport("@material-ui/icons", "TextRotationNoneTwoTone")
@js.native
class TextRotationNoneTwoTone protected ()
...
@JSImport("@material-ui/icons", "TextRotationNoneTwoTone")
@js.native
object TextRotationNoneTwoTone extends TopLevel[SvgIconComponent]
