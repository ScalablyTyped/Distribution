...
@JSImport("@material-ui/icons", "FormatTextdirectionLToRSharp")
@js.native
class FormatTextdirectionLToRSharp protected ()
...
@JSImport("@material-ui/icons", "FormatTextdirectionLToRSharp")
@js.native
object FormatTextdirectionLToRSharp extends TopLevel[SvgIconComponent]
