...
@JSImport("@material-ui/icons", "AccessibleForwardTwoTone")
@js.native
class AccessibleForwardTwoTone protected ()
...
@JSImport("@material-ui/icons", "AccessibleForwardTwoTone")
@js.native
object AccessibleForwardTwoTone extends TopLevel[SvgIconComponent]
