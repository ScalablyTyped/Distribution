...
@JSImport("@material-ui/icons", "InsertInvitationTwoTone")
@js.native
class InsertInvitationTwoTone protected ()
...
@JSImport("@material-ui/icons", "InsertInvitationTwoTone")
@js.native
object InsertInvitationTwoTone extends TopLevel[SvgIconComponent]
