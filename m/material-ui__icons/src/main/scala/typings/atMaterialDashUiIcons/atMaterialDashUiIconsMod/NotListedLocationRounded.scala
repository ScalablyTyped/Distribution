...
@JSImport("@material-ui/icons", "NotListedLocationRounded")
@js.native
class NotListedLocationRounded protected ()
...
@JSImport("@material-ui/icons", "NotListedLocationRounded")
@js.native
object NotListedLocationRounded extends TopLevel[SvgIconComponent]
