...
@JSImport("@material-ui/icons", "HourglassEmptyOutlined")
@js.native
class HourglassEmptyOutlined protected ()
...
@JSImport("@material-ui/icons", "HourglassEmptyOutlined")
@js.native
object HourglassEmptyOutlined extends TopLevel[SvgIconComponent]
