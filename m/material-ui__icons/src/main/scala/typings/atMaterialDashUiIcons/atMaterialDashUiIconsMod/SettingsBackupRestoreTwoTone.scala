...
@JSImport("@material-ui/icons", "SettingsBackupRestoreTwoTone")
@js.native
class SettingsBackupRestoreTwoTone protected ()
...
@JSImport("@material-ui/icons", "SettingsBackupRestoreTwoTone")
@js.native
object SettingsBackupRestoreTwoTone extends TopLevel[SvgIconComponent]
