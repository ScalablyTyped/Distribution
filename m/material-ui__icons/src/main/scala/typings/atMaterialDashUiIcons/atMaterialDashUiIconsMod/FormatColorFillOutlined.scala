...
@JSImport("@material-ui/icons", "FormatColorFillOutlined")
@js.native
class FormatColorFillOutlined protected ()
...
@JSImport("@material-ui/icons", "FormatColorFillOutlined")
@js.native
object FormatColorFillOutlined extends TopLevel[SvgIconComponent]
