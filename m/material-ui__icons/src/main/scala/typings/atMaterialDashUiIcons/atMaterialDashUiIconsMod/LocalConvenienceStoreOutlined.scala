...
@JSImport("@material-ui/icons", "LocalConvenienceStoreOutlined")
@js.native
class LocalConvenienceStoreOutlined protected ()
...
@JSImport("@material-ui/icons", "LocalConvenienceStoreOutlined")
@js.native
object LocalConvenienceStoreOutlined extends TopLevel[SvgIconComponent]
