...
@JSImport("@material-ui/icons", "ImportContactsOutlined")
@js.native
class ImportContactsOutlined protected ()
...
@JSImport("@material-ui/icons", "ImportContactsOutlined")
@js.native
object ImportContactsOutlined extends TopLevel[SvgIconComponent]
