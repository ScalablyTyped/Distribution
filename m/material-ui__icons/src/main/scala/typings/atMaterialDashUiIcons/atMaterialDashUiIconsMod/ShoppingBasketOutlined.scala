...
@JSImport("@material-ui/icons", "ShoppingBasketOutlined")
@js.native
class ShoppingBasketOutlined protected ()
...
@JSImport("@material-ui/icons", "ShoppingBasketOutlined")
@js.native
object ShoppingBasketOutlined extends TopLevel[SvgIconComponent]
