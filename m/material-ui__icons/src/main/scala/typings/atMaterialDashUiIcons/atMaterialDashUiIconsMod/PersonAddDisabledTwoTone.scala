...
@JSImport("@material-ui/icons", "PersonAddDisabledTwoTone")
@js.native
class PersonAddDisabledTwoTone protected ()
...
@JSImport("@material-ui/icons", "PersonAddDisabledTwoTone")
@js.native
object PersonAddDisabledTwoTone extends TopLevel[SvgIconComponent]
