...
@JSImport("@material-ui/icons", "AirlineSeatReclineExtraTwoTone")
@js.native
class AirlineSeatReclineExtraTwoTone protected ()
...
@JSImport("@material-ui/icons", "AirlineSeatReclineExtraTwoTone")
@js.native
object AirlineSeatReclineExtraTwoTone extends TopLevel[SvgIconComponent]
