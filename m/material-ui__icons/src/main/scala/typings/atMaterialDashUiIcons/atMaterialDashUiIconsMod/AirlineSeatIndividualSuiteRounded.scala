...
@JSImport("@material-ui/icons", "AirlineSeatIndividualSuiteRounded")
@js.native
class AirlineSeatIndividualSuiteRounded protected ()
...
@JSImport("@material-ui/icons", "AirlineSeatIndividualSuiteRounded")
@js.native
object AirlineSeatIndividualSuiteRounded extends TopLevel[SvgIconComponent]
