...
@JSImport("@material-ui/icons", "NotificationsPausedTwoTone")
@js.native
class NotificationsPausedTwoTone protected ()
...
@JSImport("@material-ui/icons", "NotificationsPausedTwoTone")
@js.native
object NotificationsPausedTwoTone extends TopLevel[SvgIconComponent]
