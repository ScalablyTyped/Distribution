...
@JSImport("@material-ui/icons", "StayPrimaryLandscapeOutlined")
@js.native
class StayPrimaryLandscapeOutlined protected ()
...
@JSImport("@material-ui/icons", "StayPrimaryLandscapeOutlined")
@js.native
object StayPrimaryLandscapeOutlined extends TopLevel[SvgIconComponent]
