...
@JSImport("@material-ui/icons", "VerticalAlignBottomSharp")
@js.native
class VerticalAlignBottomSharp protected ()
...
@JSImport("@material-ui/icons", "VerticalAlignBottomSharp")
@js.native
object VerticalAlignBottomSharp extends TopLevel[SvgIconComponent]
