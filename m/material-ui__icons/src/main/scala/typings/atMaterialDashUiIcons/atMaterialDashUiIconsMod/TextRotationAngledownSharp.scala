...
@JSImport("@material-ui/icons", "TextRotationAngledownSharp")
@js.native
class TextRotationAngledownSharp protected ()
...
@JSImport("@material-ui/icons", "TextRotationAngledownSharp")
@js.native
object TextRotationAngledownSharp extends TopLevel[SvgIconComponent]
