...
@JSImport("@material-ui/icons", "CallMissedOutgoingTwoTone")
@js.native
class CallMissedOutgoingTwoTone protected ()
...
@JSImport("@material-ui/icons", "CallMissedOutgoingTwoTone")
@js.native
object CallMissedOutgoingTwoTone extends TopLevel[SvgIconComponent]
