...
@JSImport("@material-ui/icons", "DomainDisabledOutlined")
@js.native
class DomainDisabledOutlined protected ()
...
@JSImport("@material-ui/icons", "DomainDisabledOutlined")
@js.native
object DomainDisabledOutlined extends TopLevel[SvgIconComponent]
