...
@JSImport("@material-ui/icons", "LocationDisabledTwoTone")
@js.native
class LocationDisabledTwoTone protected ()
...
@JSImport("@material-ui/icons", "LocationDisabledTwoTone")
@js.native
object LocationDisabledTwoTone extends TopLevel[SvgIconComponent]
