...
@JSImport("@material-ui/icons", "SignalWifi1BarOutlined")
@js.native
class SignalWifi1BarOutlined protected ()
...
@JSImport("@material-ui/icons", "SignalWifi1BarOutlined")
@js.native
object SignalWifi1BarOutlined extends TopLevel[SvgIconComponent]
