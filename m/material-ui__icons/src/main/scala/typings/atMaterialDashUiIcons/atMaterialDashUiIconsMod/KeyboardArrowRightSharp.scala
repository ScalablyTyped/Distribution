...
@JSImport("@material-ui/icons", "KeyboardArrowRightSharp")
@js.native
class KeyboardArrowRightSharp protected ()
...
@JSImport("@material-ui/icons", "KeyboardArrowRightSharp")
@js.native
object KeyboardArrowRightSharp extends TopLevel[SvgIconComponent]
