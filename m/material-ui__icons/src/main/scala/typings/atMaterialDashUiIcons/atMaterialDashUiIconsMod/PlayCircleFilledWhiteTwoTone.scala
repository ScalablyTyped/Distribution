...
@JSImport("@material-ui/icons", "PlayCircleFilledWhiteTwoTone")
@js.native
class PlayCircleFilledWhiteTwoTone protected ()
...
@JSImport("@material-ui/icons", "PlayCircleFilledWhiteTwoTone")
@js.native
object PlayCircleFilledWhiteTwoTone extends TopLevel[SvgIconComponent]
