...
@JSImport("@material-ui/icons", "PanoramaWideAngleOutlined")
@js.native
class PanoramaWideAngleOutlined protected ()
...
@JSImport("@material-ui/icons", "PanoramaWideAngleOutlined")
@js.native
object PanoramaWideAngleOutlined extends TopLevel[SvgIconComponent]
