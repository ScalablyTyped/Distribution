...
@JSImport("@material-ui/icons", "CheckBoxOutlineBlankTwoTone")
@js.native
class CheckBoxOutlineBlankTwoTone protected ()
...
@JSImport("@material-ui/icons", "CheckBoxOutlineBlankTwoTone")
@js.native
object CheckBoxOutlineBlankTwoTone extends TopLevel[SvgIconComponent]
