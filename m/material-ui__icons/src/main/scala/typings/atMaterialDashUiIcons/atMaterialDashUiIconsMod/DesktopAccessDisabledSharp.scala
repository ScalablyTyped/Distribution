...
@JSImport("@material-ui/icons", "DesktopAccessDisabledSharp")
@js.native
class DesktopAccessDisabledSharp protected ()
...
@JSImport("@material-ui/icons", "DesktopAccessDisabledSharp")
@js.native
object DesktopAccessDisabledSharp extends TopLevel[SvgIconComponent]
