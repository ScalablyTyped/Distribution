...
@JSImport("@material-ui/icons", "RecordVoiceOverOutlined")
@js.native
class RecordVoiceOverOutlined protected ()
...
@JSImport("@material-ui/icons", "RecordVoiceOverOutlined")
@js.native
object RecordVoiceOverOutlined extends TopLevel[SvgIconComponent]
