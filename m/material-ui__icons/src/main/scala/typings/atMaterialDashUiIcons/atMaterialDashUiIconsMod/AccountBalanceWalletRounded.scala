...
@JSImport("@material-ui/icons", "AccountBalanceWalletRounded")
@js.native
class AccountBalanceWalletRounded protected ()
...
@JSImport("@material-ui/icons", "AccountBalanceWalletRounded")
@js.native
object AccountBalanceWalletRounded extends TopLevel[SvgIconComponent]
