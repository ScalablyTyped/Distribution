package typings.atMaterialDashUiIcons.signalCellularConnectedNoInternet3BarRoundedMod
...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet3BarRounded", "default")
@js.native
