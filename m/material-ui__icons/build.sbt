...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "material-ui__core" % "4.12.4-d4b663",
  "org.scalablytyped" %%% "material-ui__styles" % "4.11.5-f3f879",
  "org.scalablytyped" %%% "material-ui__system" % "4.12.2-e7ad33",
