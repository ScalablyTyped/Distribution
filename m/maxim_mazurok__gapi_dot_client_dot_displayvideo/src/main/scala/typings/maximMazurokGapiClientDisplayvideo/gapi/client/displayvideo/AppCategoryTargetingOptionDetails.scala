...
@js.native
trait AppCategoryTargetingOptionDetails extends js.Object {
...
object AppCategoryTargetingOptionDetails {
  ...
  @scala.inline
  implicit class AppCategoryTargetingOptionDetailsOps[Self <: AppCategoryTargetingOptionDetails] (val x: Self) extends AnyVal {
