...
trait ListCampaignAssignedTargetingOptionsResponse extends StObject {
...
object ListCampaignAssignedTargetingOptionsResponse {
  
  inline def apply(): ListCampaignAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListCampaignAssignedTargetingOptionsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListCampaignAssignedTargetingOptionsResponse] (val x: Self) extends AnyVal {
