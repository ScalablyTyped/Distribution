...
@js.native
trait BulkListAdvertiserAssignedTargetingOptionsResponse extends js.Object {
...
object BulkListAdvertiserAssignedTargetingOptionsResponse {
  ...
  @scala.inline
  implicit class BulkListAdvertiserAssignedTargetingOptionsResponseOps[Self <: BulkListAdvertiserAssignedTargetingOptionsResponse] (val x: Self) extends AnyVal {
