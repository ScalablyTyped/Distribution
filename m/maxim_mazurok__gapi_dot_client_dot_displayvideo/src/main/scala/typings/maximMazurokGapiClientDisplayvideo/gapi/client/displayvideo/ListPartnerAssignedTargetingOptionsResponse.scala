...
@js.native
trait ListPartnerAssignedTargetingOptionsResponse extends js.Object {
...
object ListPartnerAssignedTargetingOptionsResponse {
  ...
  @scala.inline
  implicit class ListPartnerAssignedTargetingOptionsResponseOps[Self <: ListPartnerAssignedTargetingOptionsResponse] (val x: Self) extends AnyVal {
