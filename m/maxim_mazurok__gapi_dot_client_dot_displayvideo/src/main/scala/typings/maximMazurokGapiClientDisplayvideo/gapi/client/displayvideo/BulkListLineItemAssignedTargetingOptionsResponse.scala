...
object BulkListLineItemAssignedTargetingOptionsResponse {
  ...
  @scala.inline
  implicit class BulkListLineItemAssignedTargetingOptionsResponseMutableBuilder[Self <: BulkListLineItemAssignedTargetingOptionsResponse] (val x: Self) extends AnyVal {
