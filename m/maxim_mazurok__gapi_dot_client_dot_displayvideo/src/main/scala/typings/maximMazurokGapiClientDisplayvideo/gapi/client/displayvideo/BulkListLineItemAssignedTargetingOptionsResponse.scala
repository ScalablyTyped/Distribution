...
@js.native
trait BulkListLineItemAssignedTargetingOptionsResponse extends js.Object {
...
object BulkListLineItemAssignedTargetingOptionsResponse {
  ...
  @scala.inline
  def apply(): BulkListLineItemAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BulkListLineItemAssignedTargetingOptionsResponse]
  }
  
  @scala.inline
  implicit class BulkListLineItemAssignedTargetingOptionsResponseOps[Self <: BulkListLineItemAssignedTargetingOptionsResponse] (val x: Self) extends AnyVal {
