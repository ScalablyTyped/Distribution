...
@js.native
trait AgeRangeTargetingOptionDetails extends js.Object {
...
object AgeRangeTargetingOptionDetails {
  ...
  @scala.inline
  implicit class AgeRangeTargetingOptionDetailsOps[Self <: AgeRangeTargetingOptionDetails] (val x: Self) extends AnyVal {
