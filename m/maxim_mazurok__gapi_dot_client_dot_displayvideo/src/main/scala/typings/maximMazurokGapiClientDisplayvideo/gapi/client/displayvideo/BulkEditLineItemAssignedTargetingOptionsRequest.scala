...
object BulkEditLineItemAssignedTargetingOptionsRequest {
  ...
  @scala.inline
  implicit class BulkEditLineItemAssignedTargetingOptionsRequestMutableBuilder[Self <: BulkEditLineItemAssignedTargetingOptionsRequest] (val x: Self) extends AnyVal {
