...
@js.native
trait BulkEditLineItemAssignedTargetingOptionsRequest extends js.Object {
...
object BulkEditLineItemAssignedTargetingOptionsRequest {
  ...
  @scala.inline
  def apply(): BulkEditLineItemAssignedTargetingOptionsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BulkEditLineItemAssignedTargetingOptionsRequest]
  }
  
  @scala.inline
  implicit class BulkEditLineItemAssignedTargetingOptionsRequestOps[Self <: BulkEditLineItemAssignedTargetingOptionsRequest] (val x: Self) extends AnyVal {
