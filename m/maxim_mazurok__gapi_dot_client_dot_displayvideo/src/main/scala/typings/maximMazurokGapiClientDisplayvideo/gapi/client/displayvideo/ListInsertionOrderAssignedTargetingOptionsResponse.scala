...
trait ListInsertionOrderAssignedTargetingOptionsResponse extends StObject {
...
object ListInsertionOrderAssignedTargetingOptionsResponse {
  ...
  inline def apply(): ListInsertionOrderAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListInsertionOrderAssignedTargetingOptionsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListInsertionOrderAssignedTargetingOptionsResponse] (val x: Self) extends AnyVal {
