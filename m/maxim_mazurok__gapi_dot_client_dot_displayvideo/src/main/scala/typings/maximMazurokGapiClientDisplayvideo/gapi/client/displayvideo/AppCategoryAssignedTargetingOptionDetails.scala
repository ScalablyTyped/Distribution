...
object AppCategoryAssignedTargetingOptionDetails {
  ...
  inline def apply(): AppCategoryAssignedTargetingOptionDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AppCategoryAssignedTargetingOptionDetails]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AppCategoryAssignedTargetingOptionDetails] (val x: Self) extends AnyVal {
