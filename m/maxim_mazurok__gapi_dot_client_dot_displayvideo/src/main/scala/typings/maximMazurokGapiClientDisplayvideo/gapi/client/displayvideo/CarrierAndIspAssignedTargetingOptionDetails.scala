...
@js.native
trait CarrierAndIspAssignedTargetingOptionDetails extends js.Object {
...
object CarrierAndIspAssignedTargetingOptionDetails {
  ...
  @scala.inline
  implicit class CarrierAndIspAssignedTargetingOptionDetailsOps[Self <: CarrierAndIspAssignedTargetingOptionDetails] (val x: Self) extends AnyVal {
