...
object CarrierAndIspAssignedTargetingOptionDetails {
  ...
  inline def apply(): CarrierAndIspAssignedTargetingOptionDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CarrierAndIspAssignedTargetingOptionDetails]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CarrierAndIspAssignedTargetingOptionDetails] (val x: Self) extends AnyVal {
