...
@js.native
trait ListAdvertiserAssignedTargetingOptionsResponse extends js.Object {
...
object ListAdvertiserAssignedTargetingOptionsResponse {
  ...
  @scala.inline
  implicit class ListAdvertiserAssignedTargetingOptionsResponseOps[Self <: ListAdvertiserAssignedTargetingOptionsResponse] (val x: Self) extends AnyVal {
