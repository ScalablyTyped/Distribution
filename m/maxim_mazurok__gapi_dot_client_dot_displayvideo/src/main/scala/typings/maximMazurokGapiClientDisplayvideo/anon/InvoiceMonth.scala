...
trait InvoiceMonth extends StObject {
...
object InvoiceMonth {
  ...
  inline def apply(advertiserId: String): InvoiceMonth = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any])
    __obj.asInstanceOf[InvoiceMonth]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InvoiceMonth] (val x: Self) extends AnyVal {
