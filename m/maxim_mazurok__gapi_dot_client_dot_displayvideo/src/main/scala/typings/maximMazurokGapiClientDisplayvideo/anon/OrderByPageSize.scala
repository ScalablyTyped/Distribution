...
@js.native
trait OrderByPageSize extends js.Object {
...
object OrderByPageSize {
  ...
  @scala.inline
  def apply(advertiserId: String, lineItemId: String): OrderByPageSize = {
  ...
  @scala.inline
  implicit class OrderByPageSizeOps[Self <: OrderByPageSize] (val x: Self) extends AnyVal {
