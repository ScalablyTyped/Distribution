...
trait FloodlightGroupIdKey extends StObject {
...
object FloodlightGroupIdKey {
  
  @scala.inline
  def apply(floodlightGroupId: String): FloodlightGroupIdKey = {
    val __obj = js.Dynamic.literal(floodlightGroupId = floodlightGroupId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FloodlightGroupIdKey]
  }
  
  @scala.inline
  implicit class FloodlightGroupIdKeyMutableBuilder[Self <: FloodlightGroupIdKey] (val x: Self) extends AnyVal {
