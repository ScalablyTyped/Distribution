...
trait FieldsFirstAndThirdPartyAudienceIdKey extends StObject {
...
object FieldsFirstAndThirdPartyAudienceIdKey {
  
  inline def apply(firstAndThirdPartyAudienceId: String): FieldsFirstAndThirdPartyAudienceIdKey = {
