...
@js.native
trait UpdateMaskUploadType extends js.Object {
...
object UpdateMaskUploadType {
  ...
  @scala.inline
  def apply(advertiserId: String, locationListId: String, resource: LocationList): UpdateMaskUploadType = {
  ...
  @scala.inline
  implicit class UpdateMaskUploadTypeOps[Self <: UpdateMaskUploadType] (val x: Self) extends AnyVal {
