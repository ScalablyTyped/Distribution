...
@js.native
trait PageSizePageToken extends js.Object {
...
object PageSizePageToken {
  ...
  @scala.inline
  def apply(advertiserId: String, locationListId: String): PageSizePageToken = {
  ...
  @scala.inline
  implicit class PageSizePageTokenOps[Self <: PageSizePageToken] (val x: Self) extends AnyVal {
