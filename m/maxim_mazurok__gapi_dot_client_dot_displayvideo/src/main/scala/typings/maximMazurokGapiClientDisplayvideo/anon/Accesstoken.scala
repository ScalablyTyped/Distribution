...
import typings.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.CreateAssetRequest
...
trait Accesstoken extends StObject {
  ...
  /** Request body */
  var resource: CreateAssetRequest = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(advertiserId: String, resource: CreateAssetRequest): Accesstoken = {
  ...
  implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreateAssetRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
