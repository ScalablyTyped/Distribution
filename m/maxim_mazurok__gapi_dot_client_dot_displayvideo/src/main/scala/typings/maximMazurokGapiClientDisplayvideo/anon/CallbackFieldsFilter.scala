...
@js.native
trait CallbackFieldsFilter extends StObject {
...
object CallbackFieldsFilter {
  
  @scala.inline
  def apply(): CallbackFieldsFilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CallbackFieldsFilter]
  }
  
  @scala.inline
  implicit class CallbackFieldsFilterMutableBuilder[Self <: CallbackFieldsFilter] (val x: Self) extends AnyVal {
