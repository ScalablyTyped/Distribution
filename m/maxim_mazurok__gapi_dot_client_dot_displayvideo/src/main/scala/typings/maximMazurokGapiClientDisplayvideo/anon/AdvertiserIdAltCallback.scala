...
@js.native
trait AdvertiserIdAltCallback extends StObject {
...
object AdvertiserIdAltCallback {
  ...
  @scala.inline
  def apply(advertiserId: String, resource: NegativeKeywordList): AdvertiserIdAltCallback = {
  ...
  @scala.inline
  implicit class AdvertiserIdAltCallbackMutableBuilder[Self <: AdvertiserIdAltCallback] (val x: Self) extends AnyVal {
