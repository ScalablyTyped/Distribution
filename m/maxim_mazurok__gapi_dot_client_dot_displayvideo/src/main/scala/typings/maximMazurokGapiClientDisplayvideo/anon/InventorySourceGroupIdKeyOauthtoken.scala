...
@js.native
trait InventorySourceGroupIdKeyOauthtoken extends js.Object {
...
object InventorySourceGroupIdKeyOauthtoken {
  ...
  @scala.inline
  def apply(inventorySourceGroupId: String): InventorySourceGroupIdKeyOauthtoken = {
  ...
  @scala.inline
  implicit class InventorySourceGroupIdKeyOauthtokenOps[Self <: InventorySourceGroupIdKeyOauthtoken] (val x: Self) extends AnyVal {
