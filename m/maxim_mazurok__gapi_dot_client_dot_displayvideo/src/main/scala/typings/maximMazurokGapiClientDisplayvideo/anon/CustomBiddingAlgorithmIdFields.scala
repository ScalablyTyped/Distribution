...
trait CustomBiddingAlgorithmIdFields extends StObject {
...
object CustomBiddingAlgorithmIdFields {
  
  inline def apply(customBiddingAlgorithmId: String): CustomBiddingAlgorithmIdFields = {
