...
@js.native
trait PartnerIdPrettyPrint extends StObject {
...
object PartnerIdPrettyPrint {
  ...
  @scala.inline
  def apply(): PartnerIdPrettyPrint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartnerIdPrettyPrint]
  }
  
  @scala.inline
  implicit class PartnerIdPrettyPrintMutableBuilder[Self <: PartnerIdPrettyPrint] (val x: Self) extends AnyVal {
