...
trait ResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: LocationList = js.native
...
object ResourceUploadType {
  ...
  @scala.inline
  def apply(advertiserId: String, resource: LocationList): ResourceUploadType = {
  ...
  implicit class ResourceUploadTypeMutableBuilder[Self <: ResourceUploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LocationList): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
