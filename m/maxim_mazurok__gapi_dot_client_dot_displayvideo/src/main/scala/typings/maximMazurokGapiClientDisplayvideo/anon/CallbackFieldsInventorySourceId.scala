...
trait CallbackFieldsInventorySourceId extends StObject {
...
object CallbackFieldsInventorySourceId {
  
  inline def apply(inventorySourceId: String, resource: InventorySource): CallbackFieldsInventorySourceId = {
