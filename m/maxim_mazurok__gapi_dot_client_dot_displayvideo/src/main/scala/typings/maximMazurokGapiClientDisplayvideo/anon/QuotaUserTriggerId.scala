...
object QuotaUserTriggerId {
  ...
  inline def apply(advertiserId: String, triggerId: String): QuotaUserTriggerId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserTriggerId] (val x: Self) extends AnyVal {
