...
object FilterInventorySourceGroupId {
  ...
  inline def apply(inventorySourceGroupId: String): FilterInventorySourceGroupId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FilterInventorySourceGroupId] (val x: Self) extends AnyVal {
