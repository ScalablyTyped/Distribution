...
@js.native
trait FilterInventorySourceGroupId extends js.Object {
...
object FilterInventorySourceGroupId {
  ...
  @scala.inline
  implicit class FilterInventorySourceGroupIdOps[Self <: FilterInventorySourceGroupId] (val x: Self) extends AnyVal {
