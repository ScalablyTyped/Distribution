...
@js.native
trait InsertionOrderIdKey extends StObject {
...
object InsertionOrderIdKey {
  ...
  @scala.inline
  def apply(advertiserId: String, insertionOrderId: String): InsertionOrderIdKey = {
  ...
  @scala.inline
  implicit class InsertionOrderIdKeyMutableBuilder[Self <: InsertionOrderIdKey] (val x: Self) extends AnyVal {
