...
trait AssignedTargetingOptionId extends StObject {
...
object AssignedTargetingOptionId {
  ...
  @scala.inline
  implicit class AssignedTargetingOptionIdMutableBuilder[Self <: AssignedTargetingOptionId] (val x: Self) extends AnyVal {
