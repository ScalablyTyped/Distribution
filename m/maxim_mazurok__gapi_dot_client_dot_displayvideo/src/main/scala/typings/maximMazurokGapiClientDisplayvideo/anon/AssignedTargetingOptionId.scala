...
@js.native
trait AssignedTargetingOptionId extends js.Object {
...
object AssignedTargetingOptionId {
  ...
  @scala.inline
  def apply(advertiserId: String, assignedTargetingOptionId: String, lineItemId: String, targetingType: String): AssignedTargetingOptionId = {
  ...
  @scala.inline
  implicit class AssignedTargetingOptionIdOps[Self <: AssignedTargetingOptionId] (val x: Self) extends AnyVal {
