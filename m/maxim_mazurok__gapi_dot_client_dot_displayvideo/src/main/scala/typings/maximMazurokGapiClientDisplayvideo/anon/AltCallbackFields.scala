...
object AltCallbackFields {
  ...
  inline def apply(advertiserId: String, negativeKeywordListId: String, resource: NegativeKeywordList): AltCallbackFields = {
  ...
  extension [Self <: AltCallbackFields](x: Self) {
