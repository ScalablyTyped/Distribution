...
import typings.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.AssignedInventorySource
...
@js.native
trait InventorySourceGroupIdKey extends StObject {
  ...
  /** Request body */
  var resource: AssignedInventorySource = js.native
...
object InventorySourceGroupIdKey {
  
  @scala.inline
  def apply(inventorySourceGroupId: String, resource: AssignedInventorySource): InventorySourceGroupIdKey = {
  ...
  @scala.inline
  implicit class InventorySourceGroupIdKeyMutableBuilder[Self <: InventorySourceGroupIdKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AssignedInventorySource): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
