...
@js.native
trait InventorySourceGroupIdKey extends js.Object {
...
object InventorySourceGroupIdKey {
  ...
  @scala.inline
  implicit class InventorySourceGroupIdKeyOps[Self <: InventorySourceGroupIdKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AssignedInventorySource): Self = this.set("resource", value.asInstanceOf[js.Any])
