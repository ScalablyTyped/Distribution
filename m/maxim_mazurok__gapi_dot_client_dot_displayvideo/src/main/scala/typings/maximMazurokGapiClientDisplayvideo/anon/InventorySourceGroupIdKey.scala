...
object InventorySourceGroupIdKey {
  ...
  inline def apply(inventorySourceGroupId: String, resource: AssignedInventorySource): InventorySourceGroupIdKey = {
  ...
  implicit open class MutableBuilder[Self <: InventorySourceGroupIdKey] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: AssignedInventorySource): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
