...
object InsertionOrderId {
  ...
  inline def apply(advertiserId: String, insertionOrderId: String): InsertionOrderId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InsertionOrderId] (val x: Self) extends AnyVal {
