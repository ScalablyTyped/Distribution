...
trait KeyLocationListIdOauthtoken extends StObject {
...
object KeyLocationListIdOauthtoken {
  
  inline def apply(advertiserId: String, locationListId: String): KeyLocationListIdOauthtoken = {
    ...
    __obj.asInstanceOf[KeyLocationListIdOauthtoken]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyLocationListIdOauthtoken] (val x: Self) extends AnyVal {
