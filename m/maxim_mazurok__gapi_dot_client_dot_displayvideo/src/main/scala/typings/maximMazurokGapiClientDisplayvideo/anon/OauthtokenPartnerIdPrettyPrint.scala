...
trait OauthtokenPartnerIdPrettyPrint extends StObject {
...
object OauthtokenPartnerIdPrettyPrint {
  
  @scala.inline
  def apply(): OauthtokenPartnerIdPrettyPrint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OauthtokenPartnerIdPrettyPrint]
  }
  
  @scala.inline
  implicit class OauthtokenPartnerIdPrettyPrintMutableBuilder[Self <: OauthtokenPartnerIdPrettyPrint] (val x: Self) extends AnyVal {
