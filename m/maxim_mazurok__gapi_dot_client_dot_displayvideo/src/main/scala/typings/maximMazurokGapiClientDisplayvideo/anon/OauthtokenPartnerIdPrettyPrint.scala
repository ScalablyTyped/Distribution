...
@js.native
trait OauthtokenPartnerIdPrettyPrint extends js.Object {
...
object OauthtokenPartnerIdPrettyPrint {
  ...
  @scala.inline
  implicit class OauthtokenPartnerIdPrettyPrintOps[Self <: OauthtokenPartnerIdPrettyPrint] (val x: Self) extends AnyVal {
