...
@js.native
trait CombinedAudienceId extends StObject {
  ...
  var combinedAudienceId: String = js.native
...
object CombinedAudienceId {
  
  @scala.inline
  def apply(combinedAudienceId: String): CombinedAudienceId = {
    val __obj = js.Dynamic.literal(combinedAudienceId = combinedAudienceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CombinedAudienceId]
  }
  
  @scala.inline
  implicit class CombinedAudienceIdMutableBuilder[Self <: CombinedAudienceId] (val x: Self) extends AnyVal {
