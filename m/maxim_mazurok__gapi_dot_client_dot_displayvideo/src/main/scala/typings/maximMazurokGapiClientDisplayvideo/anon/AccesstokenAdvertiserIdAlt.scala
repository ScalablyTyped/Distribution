...
@js.native
trait AccesstokenAdvertiserIdAlt extends js.Object {
...
object AccesstokenAdvertiserIdAlt {
  ...
  @scala.inline
  implicit class AccesstokenAdvertiserIdAltOps[Self <: AccesstokenAdvertiserIdAlt] (val x: Self) extends AnyVal {
