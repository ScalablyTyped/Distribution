...
@js.native
trait TargetingTypeUploadType extends js.Object {
...
object TargetingTypeUploadType {
  ...
  @scala.inline
  def apply(targetingType: String): TargetingTypeUploadType = {
    val __obj = js.Dynamic.literal(targetingType = targetingType.asInstanceOf[js.Any])
    __obj.asInstanceOf[TargetingTypeUploadType]
  }
  
  @scala.inline
  implicit class TargetingTypeUploadTypeOps[Self <: TargetingTypeUploadType] (val x: Self) extends AnyVal {
