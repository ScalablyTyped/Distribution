...
object FieldsInventorySourceGroupIdKey {
  ...
  inline def apply(inventorySourceGroupId: String, resource: InventorySourceGroup): FieldsInventorySourceGroupIdKey = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsInventorySourceGroupIdKey] (val x: Self) extends AnyVal {
