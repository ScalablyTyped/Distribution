...
@js.native
trait LineItemIdOauthtoken extends StObject {
...
object LineItemIdOauthtoken {
  
  @scala.inline
  def apply(advertiserId: String, lineItemId: String): LineItemIdOauthtoken = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], lineItemId = lineItemId.asInstanceOf[js.Any])
    __obj.asInstanceOf[LineItemIdOauthtoken]
  }
  
  @scala.inline
  implicit class LineItemIdOauthtokenMutableBuilder[Self <: LineItemIdOauthtoken] (val x: Self) extends AnyVal {
