...
object LineItemIdOauthtoken {
  ...
  inline def apply(advertiserId: String, lineItemId: String): LineItemIdOauthtoken = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LineItemIdOauthtoken] (val x: Self) extends AnyVal {
