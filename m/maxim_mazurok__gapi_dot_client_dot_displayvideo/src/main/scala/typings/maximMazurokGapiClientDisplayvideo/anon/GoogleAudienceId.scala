...
@js.native
trait GoogleAudienceId extends js.Object {
  ...
  var googleAudienceId: String = js.native
...
object GoogleAudienceId {
  ...
  @scala.inline
  def apply(googleAudienceId: String): GoogleAudienceId = {
    val __obj = js.Dynamic.literal(googleAudienceId = googleAudienceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[GoogleAudienceId]
  }
  
  @scala.inline
  implicit class GoogleAudienceIdOps[Self <: GoogleAudienceId] (val x: Self) extends AnyVal {
