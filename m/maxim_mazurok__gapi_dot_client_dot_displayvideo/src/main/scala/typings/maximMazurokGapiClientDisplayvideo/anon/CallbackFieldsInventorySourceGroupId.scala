...
@js.native
trait CallbackFieldsInventorySourceGroupId extends StObject {
...
object CallbackFieldsInventorySourceGroupId {
  
  @scala.inline
  def apply(inventorySourceGroupId: String): CallbackFieldsInventorySourceGroupId = {
    val __obj = js.Dynamic.literal(inventorySourceGroupId = inventorySourceGroupId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackFieldsInventorySourceGroupId]
  }
  
  @scala.inline
  implicit class CallbackFieldsInventorySourceGroupIdMutableBuilder[Self <: CallbackFieldsInventorySourceGroupId] (val x: Self) extends AnyVal {
