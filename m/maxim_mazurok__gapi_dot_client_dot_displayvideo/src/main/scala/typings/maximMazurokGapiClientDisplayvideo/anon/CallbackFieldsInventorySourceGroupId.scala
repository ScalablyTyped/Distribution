...
@js.native
trait CallbackFieldsInventorySourceGroupId extends js.Object {
...
object CallbackFieldsInventorySourceGroupId {
  ...
  @scala.inline
  implicit class CallbackFieldsInventorySourceGroupIdOps[Self <: CallbackFieldsInventorySourceGroupId] (val x: Self) extends AnyVal {
