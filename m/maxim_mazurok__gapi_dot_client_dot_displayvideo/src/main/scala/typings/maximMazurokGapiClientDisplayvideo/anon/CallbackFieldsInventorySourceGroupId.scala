...
object CallbackFieldsInventorySourceGroupId {
  ...
  inline def apply(inventorySourceGroupId: String): CallbackFieldsInventorySourceGroupId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackFieldsInventorySourceGroupId] (val x: Self) extends AnyVal {
