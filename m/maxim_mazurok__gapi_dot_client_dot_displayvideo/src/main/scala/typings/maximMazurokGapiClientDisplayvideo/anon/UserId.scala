...
import typings.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.BulkEditAssignedUserRolesRequest
...
trait UserId extends StObject {
  ...
  /** Request body */
  var resource: BulkEditAssignedUserRolesRequest
...
object UserId {
  ...
  inline def apply(resource: BulkEditAssignedUserRolesRequest, userId: String): UserId = {
  ...
  implicit open class MutableBuilder[Self <: UserId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: BulkEditAssignedUserRolesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
