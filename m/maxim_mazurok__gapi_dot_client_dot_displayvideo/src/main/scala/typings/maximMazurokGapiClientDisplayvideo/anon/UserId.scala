...
trait UserId extends StObject {
  ...
  /** Request body */
  var resource: BulkEditAssignedUserRolesRequest = js.native
...
object UserId {
  ...
  @scala.inline
  def apply(resource: BulkEditAssignedUserRolesRequest, userId: String): UserId = {
  ...
  implicit class UserIdMutableBuilder[Self <: UserId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BulkEditAssignedUserRolesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
