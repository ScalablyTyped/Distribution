...
object FieldsInsertionOrderId {
  ...
  inline def apply(advertiserId: String, insertionOrderId: String): FieldsInsertionOrderId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsInsertionOrderId] (val x: Self) extends AnyVal {
