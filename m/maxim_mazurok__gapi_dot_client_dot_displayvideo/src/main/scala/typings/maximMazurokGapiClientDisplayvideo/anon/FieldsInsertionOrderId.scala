...
object FieldsInsertionOrderId {
  ...
  inline def apply(advertiserId: String, insertionOrderId: String, resource: InsertionOrder): FieldsInsertionOrderId = {
  ...
  extension [Self <: FieldsInsertionOrderId](x: Self) {
