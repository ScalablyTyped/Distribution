...
trait QuotaUserResourceUpdateMask extends StObject {
...
object QuotaUserResourceUpdateMask {
  
  inline def apply(advertiserId: String, resource: Advertiser): QuotaUserResourceUpdateMask = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserResourceUpdateMask]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: QuotaUserResourceUpdateMask] (val x: Self) extends AnyVal {
