...
object AssignedTargetingOptionIdCallback {
  ...
  inline def apply(assignedTargetingOptionId: String, partnerId: String, targetingType: String): AssignedTargetingOptionIdCallback = {
  ...
  extension [Self <: AssignedTargetingOptionIdCallback](x: Self) {
