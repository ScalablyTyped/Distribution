...
object Callback {
  ...
  inline def apply(advertiserId: String, campaignId: String, targetingType: String): Callback = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], campaignId = campaignId.asInstanceOf[js.Any], targetingType = targetingType.asInstanceOf[js.Any])
