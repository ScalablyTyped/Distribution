...
trait PrettyPrintQuotaUserUploadType extends StObject {
...
object PrettyPrintQuotaUserUploadType {
  ...
  @scala.inline
  def apply(partnerId: String): PrettyPrintQuotaUserUploadType = {
    val __obj = js.Dynamic.literal(partnerId = partnerId.asInstanceOf[js.Any])
    __obj.asInstanceOf[PrettyPrintQuotaUserUploadType]
  }
  
  @scala.inline
  implicit class PrettyPrintQuotaUserUploadTypeMutableBuilder[Self <: PrettyPrintQuotaUserUploadType] (val x: Self) extends AnyVal {
