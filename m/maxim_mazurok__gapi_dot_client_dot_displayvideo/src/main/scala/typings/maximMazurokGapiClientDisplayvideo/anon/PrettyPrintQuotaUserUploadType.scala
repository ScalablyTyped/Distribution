...
@js.native
trait PrettyPrintQuotaUserUploadType extends js.Object {
...
object PrettyPrintQuotaUserUploadType {
  ...
  @scala.inline
  implicit class PrettyPrintQuotaUserUploadTypeOps[Self <: PrettyPrintQuotaUserUploadType] (val x: Self) extends AnyVal {
