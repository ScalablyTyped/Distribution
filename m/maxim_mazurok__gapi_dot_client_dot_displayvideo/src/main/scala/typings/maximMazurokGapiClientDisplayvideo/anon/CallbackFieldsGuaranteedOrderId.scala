...
trait CallbackFieldsGuaranteedOrderId extends StObject {
...
object CallbackFieldsGuaranteedOrderId {
  
  inline def apply(guaranteedOrderId: String, resource: GuaranteedOrder): CallbackFieldsGuaranteedOrderId = {
    val __obj = js.Dynamic.literal(guaranteedOrderId = guaranteedOrderId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackFieldsGuaranteedOrderId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CallbackFieldsGuaranteedOrderId] (val x: Self) extends AnyVal {
