...
object AssignedInventorySourceId {
  ...
  inline def apply(assignedInventorySourceId: String, inventorySourceGroupId: String): AssignedInventorySourceId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AssignedInventorySourceId] (val x: Self) extends AnyVal {
