...
@js.native
trait AltAssignedTargetingOptionId extends StObject {
  ...
  var assignedTargetingOptionId: String = js.native
  ...
  var targetingType: String = js.native
...
object AltAssignedTargetingOptionId {
  
  @scala.inline
  def apply(advertiserId: String, assignedTargetingOptionId: String, targetingType: String): AltAssignedTargetingOptionId = {
    ...
    __obj.asInstanceOf[AltAssignedTargetingOptionId]
  }
  
  @scala.inline
  implicit class AltAssignedTargetingOptionIdMutableBuilder[Self <: AltAssignedTargetingOptionId] (val x: Self) extends AnyVal {
