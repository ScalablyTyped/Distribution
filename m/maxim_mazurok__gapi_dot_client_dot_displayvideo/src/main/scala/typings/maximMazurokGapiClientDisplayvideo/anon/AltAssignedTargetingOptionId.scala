...
@js.native
trait AltAssignedTargetingOptionId extends js.Object {
...
object AltAssignedTargetingOptionId {
  ...
  @scala.inline
  implicit class AltAssignedTargetingOptionIdOps[Self <: AltAssignedTargetingOptionId] (val x: Self) extends AnyVal {
