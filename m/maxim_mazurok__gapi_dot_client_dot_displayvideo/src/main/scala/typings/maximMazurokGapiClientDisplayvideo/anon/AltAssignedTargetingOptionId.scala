...
object AltAssignedTargetingOptionId {
  ...
  inline def apply(advertiserId: String, assignedTargetingOptionId: String, targetingType: String): AltAssignedTargetingOptionId = {
  ...
  extension [Self <: AltAssignedTargetingOptionId](x: Self) {
