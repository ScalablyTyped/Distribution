...
trait NegativeKeywordListIdOauthtokenPrettyPrint extends StObject {
...
object NegativeKeywordListIdOauthtokenPrettyPrint {
  
  inline def apply(advertiserId: String, negativeKeywordListId: String): NegativeKeywordListIdOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[NegativeKeywordListIdOauthtokenPrettyPrint]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NegativeKeywordListIdOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
