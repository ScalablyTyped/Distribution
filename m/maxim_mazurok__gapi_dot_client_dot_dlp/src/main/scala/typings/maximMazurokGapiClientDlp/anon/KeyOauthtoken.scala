...
trait KeyOauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2CreateJobTriggerRequest = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2CreateJobTriggerRequest): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenOps[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2CreateJobTriggerRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
