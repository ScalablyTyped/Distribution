...
trait LocationId extends StObject {
...
object LocationId {
  ...
  inline def apply(parent: String): LocationId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[LocationId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LocationId] (val x: Self) extends AnyVal {
