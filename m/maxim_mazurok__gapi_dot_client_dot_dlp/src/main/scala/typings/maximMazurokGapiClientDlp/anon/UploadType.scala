...
import typings.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2InspectContentRequest
...
object UploadType {
  ...
  inline def apply(parent: String, resource: GooglePrivacyDlpV2InspectContentRequest): UploadType = {
