...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2RedactImageRequest = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2RedactImageRequest): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2RedactImageRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
