...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2UpdateStoredInfoTypeRequest = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(name: String, resource: GooglePrivacyDlpV2UpdateStoredInfoTypeRequest): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2UpdateStoredInfoTypeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
