...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2CancelDlpJobRequest = js.native
...
object Xgafv {
  ...
  @scala.inline
  def apply(name: String, resource: GooglePrivacyDlpV2CancelDlpJobRequest): Xgafv = {
  ...
  implicit class XgafvMutableBuilder[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2CancelDlpJobRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
