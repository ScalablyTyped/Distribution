...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2CreateDlpJobRequest = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2CreateDlpJobRequest): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2CreateDlpJobRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
