...
import typings.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2CreateDeidentifyTemplateRequest
...
trait Callback extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2CreateDeidentifyTemplateRequest = js.native
...
object Callback {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2CreateDeidentifyTemplateRequest): Callback = {
  ...
  implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2CreateDeidentifyTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
