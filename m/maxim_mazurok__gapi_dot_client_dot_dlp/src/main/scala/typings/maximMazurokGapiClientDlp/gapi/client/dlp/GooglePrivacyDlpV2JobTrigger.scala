...
object GooglePrivacyDlpV2JobTrigger {
  ...
  extension [Self <: GooglePrivacyDlpV2JobTrigger](x: Self) {
    ...
    inline def setTriggersVarargs(value: GooglePrivacyDlpV2Trigger*): Self = StObject.set(x, "triggers", js.Array(value :_*))
