...
@js.native
trait GooglePrivacyDlpV2InfoTypeDescription extends js.Object {
...
object GooglePrivacyDlpV2InfoTypeDescription {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2InfoTypeDescriptionOps[Self <: GooglePrivacyDlpV2InfoTypeDescription] (val x: Self) extends AnyVal {
