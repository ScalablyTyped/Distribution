...
@js.native
trait GooglePrivacyDlpV2PartitionId extends js.Object {
...
object GooglePrivacyDlpV2PartitionId {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2PartitionIdOps[Self <: GooglePrivacyDlpV2PartitionId] (val x: Self) extends AnyVal {
