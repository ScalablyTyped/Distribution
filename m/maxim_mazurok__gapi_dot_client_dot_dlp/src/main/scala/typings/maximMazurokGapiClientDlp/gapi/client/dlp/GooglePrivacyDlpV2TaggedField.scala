...
@js.native
trait GooglePrivacyDlpV2TaggedField extends js.Object {
...
object GooglePrivacyDlpV2TaggedField {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2TaggedFieldOps[Self <: GooglePrivacyDlpV2TaggedField] (val x: Self) extends AnyVal {
