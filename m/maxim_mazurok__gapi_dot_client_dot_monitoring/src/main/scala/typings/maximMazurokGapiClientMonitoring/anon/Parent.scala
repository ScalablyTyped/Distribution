...
import typings.maximMazurokGapiClientMonitoring.gapi.client.monitoring.UptimeCheckConfig
...
object Parent {
  ...
  inline def apply(parent: String, resource: UptimeCheckConfig): Parent = {
