...
object ServiceLevelObjectiveId {
  ...
  inline def apply(parent: String, resource: ServiceLevelObjective): ServiceLevelObjectiveId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ServiceLevelObjectiveId] (val x: Self) extends AnyVal {
    ...
    inline def setResource(value: ServiceLevelObjective): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
