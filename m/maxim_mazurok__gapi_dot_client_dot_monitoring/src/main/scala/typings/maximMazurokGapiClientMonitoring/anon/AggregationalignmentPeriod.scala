...
object AggregationalignmentPeriod {
  ...
  inline def apply(name: String): AggregationalignmentPeriod = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[AggregationalignmentPeriod]
  }
  
  extension [Self <: AggregationalignmentPeriod](x: Self) {
    ...
    inline def setSecondaryAggregationDotgroupByFieldsVarargs(value: String*): Self = StObject.set(x, "secondaryAggregation.groupByFields", js.Array(value :_*))
