...
trait MinuteRange extends StObject {
  ...
  /**
    ...
    */
  var endMinutesAgo: js.UndefOr[Double] = js.undefined
  ...
  /**
    ...
    */
  var startMinutesAgo: js.UndefOr[Double] = js.undefined
}
object MinuteRange {
  
  inline def apply(): MinuteRange = {
