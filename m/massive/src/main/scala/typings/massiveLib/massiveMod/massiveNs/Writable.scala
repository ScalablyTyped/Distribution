...
trait Writable extends Readable {
  ...
  def destroy(criteria: AnyObject[_]): stdLib.Promise[js.Array[_]] = js.native
  /** Delete a record or records. */
  def destroy(criteria: AnyObject[_], options: ResultProcessingOptions): stdLib.Promise[js.Array[_]] = js.native
  /**
  ...
  def insert(data: js.Array[AnyObject[_]]): stdLib.Promise[js.Array[AnyObject[_]]] = js.native
  def insert(data: js.Array[AnyObject[_]], options: PersistenceInsertOptions with ResultProcessingOptions): stdLib.Promise[js.Array[AnyObject[_]]] = js.native
  /** Insert a record or records into the table. */
  def insert(data: AnyObject[_]): stdLib.Promise[AnyObject[_]] = js.native
  /** Insert a record or records into the table. */
  def insert(data: AnyObject[_], options: PersistenceInsertOptions with ResultProcessingOptions): stdLib.Promise[AnyObject[_]] = js.native
  /**
           * Saves an object.
           ...
           */
  def save(record: AnyObject[_]): stdLib.Promise[AnyObject[_]] = js.native
  /**
           * Saves an object.
           * If the object does not include a value for the table's primary key, this will emit an INSERT to create a new record.
           * if it does contain the primary key it will emit an UPDATE for the existing record.
  ...
  ): stdLib.Promise[AnyObject[_]] = js.native
  /** Save a document to the database. This function will create or replace the entire document body. */
  def saveDoc(doc: AnyObject[_]): stdLib.Promise[AnyObject[_]] = js.native
  def update(criteria: AnyObject[_], changes: AnyObject[_]): stdLib.Promise[js.Array[AnyObject[_]]] = js.native
  def update(
    criteria: AnyObject[_],
    changes: AnyObject[_],
    options: PersistenceUpdateDocOptions with ResultProcessingOptions
  ): stdLib.Promise[js.Array[AnyObject[_]]] = js.native
  /** Update a record. */
  def update(criteria: UUID, changes: AnyObject[_]): stdLib.Promise[AnyObject[_]] = js.native
  /** Update a record. */
  def update(
    criteria: UUID,
    changes: AnyObject[_],
  ...
  /** Update a record. */
  def update(criteria: scala.Double, changes: AnyObject[_]): stdLib.Promise[AnyObject[_]] = js.native
  /** Update a record. */
  def update(
  ...
  /**
           ...
           */
  def updateDoc(criteria: AnyObject[_], changes: AnyObject[_]): stdLib.Promise[AnyObject[_]] = js.native
  /**
           * Update a document, adding new information and changing existing information.
           * This function can be used with any JSON field, not just document tables; however, only document tables can use criteria objects which directly reference document fields.
           * If calling updateDoc with a criteria object for a non-document table, the criteria will be tested against the entire row (as opposed to the document body as it is for document tables).
  ...
  /**
           ...
           * To test elements of the JSON field in a non-document table with a criteria object, use a JSON path string.
           */
  def updateDoc(criteria: UUID, changes: AnyObject[_]): stdLib.Promise[AnyObject[_]] = js.native
  /**
           * Update a document, adding new information and changing existing information.
           * This function can be used with any JSON field, not just document tables; however, only document tables can use criteria objects which directly reference document fields.
           * If calling updateDoc with a criteria object for a non-document table, the criteria will be tested against the entire row (as opposed to the document body as it is for document tables).
  ...
  /**
           ...
           * To test elements of the JSON field in a non-document table with a criteria object, use a JSON path string.
           */
  def updateDoc(criteria: scala.Double, changes: AnyObject[_]): stdLib.Promise[AnyObject[_]] = js.native
  /**
           * Update a document, adding new information and changing existing information.
           * This function can be used with any JSON field, not just document tables; however, only document tables can use criteria objects which directly reference document fields.
           * If calling updateDoc with a criteria object for a non-document table, the criteria will be tested against the entire row (as opposed to the document body as it is for document tables).
