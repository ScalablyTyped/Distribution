...
object anon {
  ...
  object ANIMCHECKEDINDETERMINATE {
    ...
    @scala.inline
    implicit class ANIMCHECKEDINDETERMINATEMutableBuilder[Self <: ANIMCHECKEDINDETERMINATE] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setANIM_CHECKED_INDETERMINATE(value: String): Self = StObject.set(x, "ANIM_CHECKED_INDETERMINATE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setANIM_CHECKED_UNCHECKED(value: String): Self = StObject.set(x, "ANIM_CHECKED_UNCHECKED", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setANIM_INDETERMINATE_CHECKED(value: String): Self = StObject.set(x, "ANIM_INDETERMINATE_CHECKED", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setANIM_INDETERMINATE_UNCHECKED(value: String): Self = StObject.set(x, "ANIM_INDETERMINATE_UNCHECKED", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setANIM_UNCHECKED_CHECKED(value: String): Self = StObject.set(x, "ANIM_UNCHECKED_CHECKED", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setANIM_UNCHECKED_INDETERMINATE(value: String): Self = StObject.set(x, "ANIM_UNCHECKED_INDETERMINATE", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setCHECKMARK_PATH(value: String): Self = StObject.set(x, "CHECKMARK_PATH", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMIXEDMARK(value: String): Self = StObject.set(x, "MIXEDMARK", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNATIVE_CONTROL(value: String): Self = StObject.set(x, "NATIVE_CONTROL", value.asInstanceOf[js.Any])
  ...
  object ANIMENDLATCHMS {
    ...
    @scala.inline
    implicit class ANIMENDLATCHMSMutableBuilder[Self <: ANIMENDLATCHMS] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setANIM_END_LATCH_MS(value: Double): Self = StObject.set(x, "ANIM_END_LATCH_MS", value.asInstanceOf[js.Any])
    }
  }
  ...
  object ARIACHECKEDATTR {
    ...
    implicit class ARIACHECKEDATTRMutableBuilder[Self <: ARIACHECKEDATTR] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setARIA_CHECKED_INDETERMINATE_VALUE(value: String): Self = StObject.set(x, "ARIA_CHECKED_INDETERMINATE_VALUE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDATA_INDETERMINATE_ATTR(value: String): Self = StObject.set(x, "DATA_INDETERMINATE_ATTR", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNATIVE_CONTROL_SELECTOR(value: String): Self = StObject.set(x, "NATIVE_CONTROL_SELECTOR", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTRANSITION_STATE_CHECKED(value: String): Self = StObject.set(x, "TRANSITION_STATE_CHECKED", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTRANSITION_STATE_INDETERMINATE(value: String): Self = StObject.set(x, "TRANSITION_STATE_INDETERMINATE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTRANSITION_STATE_INIT(value: String): Self = StObject.set(x, "TRANSITION_STATE_INIT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTRANSITION_STATE_UNCHECKED(value: String): Self = StObject.set(x, "TRANSITION_STATE_UNCHECKED", value.asInstanceOf[js.Any])
    }
  }
  ...
  object PartialMDCCheckboxAdapter {
    ...
    @scala.inline
    implicit class PartialMDCCheckboxAdapterMutableBuilder[Self <: PartialMDCCheckboxAdapter] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHasNativeControlUndefined: Self = StObject.set(x, "hasNativeControl", js.undefined)
      
      @scala.inline
      def setIsAttachedToDOM(value: () => Boolean): Self = StObject.set(x, "isAttachedToDOM", js.Any.fromFunction0(value))
      
      @scala.inline
      def setIsAttachedToDOMUndefined: Self = StObject.set(x, "isAttachedToDOM", js.undefined)
      ...
      @scala.inline
      def setRemoveNativeControlAttr(value: /* attr */ String => Unit): Self = StObject.set(x, "removeNativeControlAttr", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRemoveNativeControlAttrUndefined: Self = StObject.set(x, "removeNativeControlAttr", js.undefined)
