...
@js.native
trait GoogleAppsCloudidentityDevicesV1WipeDeviceRequest extends js.Object {
...
object GoogleAppsCloudidentityDevicesV1WipeDeviceRequest {
  ...
  @scala.inline
  implicit class GoogleAppsCloudidentityDevicesV1WipeDeviceRequestOps[Self <: GoogleAppsCloudidentityDevicesV1WipeDeviceRequest] (val x: Self) extends AnyVal {
