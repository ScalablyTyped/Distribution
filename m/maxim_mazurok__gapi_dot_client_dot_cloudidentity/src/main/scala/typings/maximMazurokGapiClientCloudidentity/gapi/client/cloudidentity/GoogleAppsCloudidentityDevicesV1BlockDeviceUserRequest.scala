...
trait GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest extends StObject {
...
object GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest {
  ...
  inline def apply(): GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest] (val x: Self) extends AnyVal {
