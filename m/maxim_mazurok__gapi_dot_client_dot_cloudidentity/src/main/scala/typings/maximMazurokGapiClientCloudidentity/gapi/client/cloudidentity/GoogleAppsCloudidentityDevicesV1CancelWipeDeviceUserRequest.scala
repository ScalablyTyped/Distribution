...
@js.native
trait GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest extends js.Object {
...
object GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest {
  ...
  @scala.inline
  implicit class GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequestOps[Self <: GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest] (val x: Self) extends AnyVal {
