...
trait Uploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: GoogleAppsCloudidentityDevicesV1WipeDeviceRequest = js.native
...
object Uploadprotocol {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleAppsCloudidentityDevicesV1WipeDeviceRequest): Uploadprotocol = {
  ...
  implicit class UploadprotocolMutableBuilder[Self <: Uploadprotocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleAppsCloudidentityDevicesV1WipeDeviceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
