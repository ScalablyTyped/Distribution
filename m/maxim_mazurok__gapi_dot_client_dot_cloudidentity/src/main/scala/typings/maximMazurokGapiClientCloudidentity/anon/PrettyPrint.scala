...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
