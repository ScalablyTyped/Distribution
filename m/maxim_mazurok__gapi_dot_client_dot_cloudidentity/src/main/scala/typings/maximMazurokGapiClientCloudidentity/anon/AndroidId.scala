...
@js.native
trait AndroidId extends js.Object {
...
object AndroidId {
  ...
  @scala.inline
  implicit class AndroidIdOps[Self <: AndroidId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRawResourceId(value: String): Self = this.set("rawResourceId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRawResourceId: Self = this.set("rawResourceId", js.undefined)
