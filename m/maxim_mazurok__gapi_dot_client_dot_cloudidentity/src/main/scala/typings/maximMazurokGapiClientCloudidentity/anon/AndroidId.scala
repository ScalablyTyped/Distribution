...
@js.native
trait AndroidId extends StObject {
  ...
  /**
    ...
    */
  var rawResourceId: js.UndefOr[String] = js.native
...
object AndroidId {
  ...
  @scala.inline
  def apply(parent: String): AndroidId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[AndroidId]
  }
  
  @scala.inline
  implicit class AndroidIdMutableBuilder[Self <: AndroidId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRawResourceId(value: String): Self = StObject.set(x, "rawResourceId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRawResourceIdUndefined: Self = StObject.set(x, "rawResourceId", js.undefined)
