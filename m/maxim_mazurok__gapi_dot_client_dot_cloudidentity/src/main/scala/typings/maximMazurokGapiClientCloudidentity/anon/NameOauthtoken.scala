...
import typings.maximMazurokGapiClientCloudidentity.gapi.client.cloudidentity.SecuritySettings
...
object NameOauthtoken {
  ...
  inline def apply(name: String, resource: SecuritySettings): NameOauthtoken = {
  ...
  extension [Self <: NameOauthtoken](x: Self) {
    ...
    inline def setResource(value: SecuritySettings): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
