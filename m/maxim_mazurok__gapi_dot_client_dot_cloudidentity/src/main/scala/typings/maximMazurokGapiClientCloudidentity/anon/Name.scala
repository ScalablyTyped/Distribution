...
trait Name extends StObject {
  ...
  /** Request body */
  var resource: GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest = js.native
...
object Name {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest): Name = {
  ...
  implicit class NameMutableBuilder[Self <: Name] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
