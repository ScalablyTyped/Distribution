...
trait FieldsInitialGroupConfig extends StObject {
...
object FieldsInitialGroupConfig {
  
  inline def apply(): FieldsInitialGroupConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FieldsInitialGroupConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FieldsInitialGroupConfig] (val x: Self) extends AnyVal {
