...
object childUnderscoreProcessNs extends js.Object {
  ...
  def exec(
    ...
    callback: js.Function3[
      (/* error */ stdLib.Error) | nodeLib.childUnderscoreProcessMod.ExecException | scala.Null, 
  ...
  def execFile(
    ...
    callback: js.Function3[
      (/* error */ stdLib.Error) | nodeLib.Error | scala.Null, 
      nodeLib.Buffer | (/* stdout */ java.lang.String), 
      nodeLib.Buffer | (/* stderr */ java.lang.String), 
      scala.Unit
    ]
  ...
  object execFileNs extends js.Object {
    def __promisify__(file: java.lang.String): nodeLib.childUnderscoreProcessMod.PromiseWithChild[nodeLib.Anon_Stderr] = js.native
    def __promisify__(
      file: java.lang.String,
      args: js.UndefOr[scala.Nothing],
      options: nodeLib.Anon_EncodingNull with nodeLib.childUnderscoreProcessMod.ExecFileOptions
    ...
    def __promisify__(file: java.lang.String, args: js.Array[java.lang.String]): nodeLib.childUnderscoreProcessMod.PromiseWithChild[nodeLib.Anon_Stderr] = js.native
    def __promisify__(
      file: java.lang.String,
      args: js.Array[java.lang.String],
      options: nodeLib.Anon_EncodingNull with nodeLib.childUnderscoreProcessMod.ExecFileOptions
    ...
    def __promisify__(file: java.lang.String, options: nodeLib.childUnderscoreProcessMod.ExecFileOptions): nodeLib.childUnderscoreProcessMod.PromiseWithChild[nodeLib.Anon_Stderr] = js.native
    def __promisify__(
      file: java.lang.String,
      options: nodeLib.childUnderscoreProcessMod.ExecFileOptionsWithBufferEncoding
    ): nodeLib.childUnderscoreProcessMod.PromiseWithChild[nodeLib.Anon_StderrStdout] = js.native
