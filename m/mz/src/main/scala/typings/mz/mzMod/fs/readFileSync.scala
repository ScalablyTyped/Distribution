...
object readFileSync extends js.Object {
  ...
  def apply(path: Double, options: typings.node.Anon_EncodingFlagString): String = js.native
  /**
  ...
  /**
    ...
    */
  def apply(path: PathLike, options: typings.node.Anon_EncodingFlagString): String = js.native
}
