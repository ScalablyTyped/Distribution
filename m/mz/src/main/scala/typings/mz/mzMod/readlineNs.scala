...
import typings.mz.readlineMod.ReadLine
...
object readlineNs extends js.Object {
  ...
  def createInterface(input: ReadableStream, output: WritableStream, completer: typings.mz.readlineMod.Completer): ReadLine = js.native
  def createInterface(
  ...
  def createInterface(options: typings.mz.readlineMod.ReadLineOptions): ReadLine = js.native
