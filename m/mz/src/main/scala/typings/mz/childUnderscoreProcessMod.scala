...
object childUnderscoreProcessMod extends js.Object {
  def exec(command: String): js.Promise[js.Tuple2[Buffer, Buffer]] = js.native
  def exec(
    command: String,
  ...
  def exec(command: String, options: ExecFileOptionsWithStringEncoding): js.Promise[js.Tuple2[Buffer, Buffer]] = js.native
  def exec(command: String, options: ExecOptions): js.Promise[js.Tuple2[Buffer, Buffer]] = js.native
  def exec(command: String, options: ExecOptionsWithBufferEncoding): js.Promise[js.Tuple2[Buffer, Buffer]] = js.native
  def exec(
    command: String,
  ...
  @JSName("execFile")
  def execFile_ChildProcess(file: String): ChildProcess = js.native
  @JSName("execFile")
  def execFile_ChildProcess(file: String, args: js.Array[String]): ChildProcess = js.native
  ...
  // no `options` definitely means stdout/stderr are `string`.
  @JSName("exec")
  def exec_ChildProcess(command: String): ChildProcess = js.native
  // `options` without an `encoding` means stdout/stderr are definitely `string`.
  @JSName("exec")
  def exec_ChildProcess(command: String, options: ExecOptions): ChildProcess = js.native
