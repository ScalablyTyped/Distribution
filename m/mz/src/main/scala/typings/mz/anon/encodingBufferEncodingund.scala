...
@js.native
trait encodingBufferEncodingund extends js.Object {
...
object encodingBufferEncodingund {
  @scala.inline
  def apply(): encodingBufferEncodingund = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[encodingBufferEncodingund]
  }
  @scala.inline
  implicit class encodingBufferEncodingundOps[Self <: encodingBufferEncodingund] (val x: Self) extends AnyVal {
    @scala.inline
