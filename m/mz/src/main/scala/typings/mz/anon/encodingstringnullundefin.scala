...
@js.native
trait encodingstringnullundefin extends js.Object {
...
object encodingstringnullundefin {
  @scala.inline
  def apply(): encodingstringnullundefin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[encodingstringnullundefin]
  }
  @scala.inline
  implicit class encodingstringnullundefinOps[Self <: encodingstringnullundefin] (val x: Self) extends AnyVal {
    @scala.inline
