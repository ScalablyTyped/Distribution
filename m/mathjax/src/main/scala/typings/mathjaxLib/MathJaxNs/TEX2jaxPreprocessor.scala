...
trait TEX2jaxPreprocessor extends js.Object {
  /*This value determines whether tex2jax requires braces to be balanced within math delimiters (which allows for
    ...
    */
  var balanceBraces: js.UndefOr[scala.Boolean] = js.undefined
  ...
  /*When true, tex2jax looks not only for the in-line and display math delimiters, but also for LaTeX environments
    ...
    */
  var processEnvironments: js.UndefOr[scala.Boolean] = js.undefined
  /*When set to true, you may use \$ to represent a literal dollar sign, rather than using it as a math delimiter.
    ...
    */
  var processEscapes: js.UndefOr[scala.Boolean] = js.undefined
...
object TEX2jaxPreprocessor {
  @scala.inline
  def apply(
    balanceBraces: js.UndefOr[scala.Boolean] = js.undefined,
    displayMath: js.Any = null,
    ignoreClass: java.lang.String = null,
    inlineMath: js.Any = null,
    preview: js.Any = null,
    processClass: java.lang.String = null,
    processEnvironments: js.UndefOr[scala.Boolean] = js.undefined,
    processEscapes: js.UndefOr[scala.Boolean] = js.undefined,
