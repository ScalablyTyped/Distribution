...
object SafeRequire {
  ...
  def apply(
    ...
    if (!js.isUndefined(amscd)) __obj.updateDynamic("amscd")(amscd)
    if (!js.isUndefined(amsmath)) __obj.updateDynamic("amsmath")(amsmath)
    if (!js.isUndefined(amssymbols)) __obj.updateDynamic("amssymbols")(amssymbols)
    if (!js.isUndefined(autobold)) __obj.updateDynamic("autobold")(autobold)
    if (!js.isUndefined(`autoload-all`)) __obj.updateDynamic("autoload-all")(`autoload-all`)
    if (!js.isUndefined(bbox)) __obj.updateDynamic("bbox")(bbox)
    if (!js.isUndefined(begingroup)) __obj.updateDynamic("begingroup")(begingroup)
    if (!js.isUndefined(boldsymbol)) __obj.updateDynamic("boldsymbol")(boldsymbol)
    if (!js.isUndefined(cancel)) __obj.updateDynamic("cancel")(cancel)
    if (!js.isUndefined(color)) __obj.updateDynamic("color")(color)
    if (!js.isUndefined(enclose)) __obj.updateDynamic("enclose")(enclose)
    if (!js.isUndefined(extpfeil)) __obj.updateDynamic("extpfeil")(extpfeil)
    if (!js.isUndefined(mathchoice)) __obj.updateDynamic("mathchoice")(mathchoice)
    if (!js.isUndefined(mhchem)) __obj.updateDynamic("mhchem")(mhchem)
    if (!js.isUndefined(newcommand)) __obj.updateDynamic("newcommand")(newcommand)
    if (!js.isUndefined(noErrors)) __obj.updateDynamic("noErrors")(noErrors)
    if (!js.isUndefined(noUndefined)) __obj.updateDynamic("noUndefined")(noUndefined)
    if (!js.isUndefined(unicode)) __obj.updateDynamic("unicode")(unicode)
    if (!js.isUndefined(verb)) __obj.updateDynamic("verb")(verb)
