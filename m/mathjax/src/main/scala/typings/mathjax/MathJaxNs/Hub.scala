...
trait Hub extends js.Object {
  ...
  var Register: js.UndefOr[typings.mathjax.MathJaxNs.Register] = js.undefined
  ...
  def Config(config: typings.mathjax.MathJaxNs.Config): Unit
...
object Hub {
  ...
  def apply(
    ...
    processSectionDelay: Int | Double = null,
    processUpdateDelay: Int | Double = null,
    processUpdateTime: Int | Double = null,
    queue: js.Any = null,
    signal: Signal = null
  ): Hub = {
