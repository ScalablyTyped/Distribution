...
object constantsMod {
  ...
  object cssClasses {
    ...
    @JSImport("@material/floating-label/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/floating-label/constants", "cssClasses.LABEL_FLOAT_ABOVE")
    @js.native
    ...
    @JSImport("@material/floating-label/constants", "cssClasses.LABEL_REQUIRED")
    @js.native
    ...
    @JSImport("@material/floating-label/constants", "cssClasses.LABEL_SHAKE")
    @js.native
    ...
    @JSImport("@material/floating-label/constants", "cssClasses.ROOT")
    @js.native
