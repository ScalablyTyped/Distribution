package typings.miniStore.anon
...
object WrappedComponent {
  ...
  @scala.inline
  implicit class WrappedComponentOps[Self <: WrappedComponent[_], C /* <: ComponentType[_] */] (val x: Self with WrappedComponent[C]) extends AnyVal {
