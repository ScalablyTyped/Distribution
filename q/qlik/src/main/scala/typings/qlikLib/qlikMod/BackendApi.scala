...
trait BackendApi extends js.Object {
  ...
  def applyPatches(qPatches: js.Array[Patch], qSoftPatch: scala.Boolean): js.Promise[_] = js.native
  def clearSelections(): scala.Unit = js.native
  def clearSoftPatches(): js.Promise[_] = js.native
  def collapseLeft(qRow: scala.Double, qCol: scala.Double): js.Promise[_] = js.native
  def collapseLeft(qRow: scala.Double, qCol: scala.Double, qAll: scala.Boolean): js.Promise[_] = js.native
  def collapseTop(qRow: scala.Double, qCol: scala.Double): js.Promise[_] = js.native
  def collapseTop(qRow: scala.Double, qCol: scala.Double, qAll: scala.Boolean): js.Promise[_] = js.native
  def eachDataRow(callback: js.Function2[/* i */ scala.Double, /* d */ NxCellRows, scala.Boolean | scala.Unit]): NxCellRows = js.native
  def expandLeft(qRow: scala.Double, qCol: scala.Double): js.Promise[_] = js.native
  def expandLeft(qRow: scala.Double, qCol: scala.Double, qAll: scala.Boolean): js.Promise[_] = js.native
  def expandTop(qRow: scala.Double, qCol: scala.Double): js.Promise[_] = js.native
  def expandTop(qRow: scala.Double, qCol: scala.Double, qAll: scala.Boolean): js.Promise[_] = js.native
  ...
  def getStackeddata(qPages: js.Array[NxPage], qMaxNbrCells: scala.Double): js.Promise[NxStackPage] = js.native
