...
import typings.qlik.Anon_App
import typings.qlik.Anon_NoInteraction
...
trait App extends js.Object {
  var variable: Anon_App = js.native
  ...
  def getobject(elem: String, id: String, options: Anon_NoInteraction): js.Promise[_] = js.native
  def getobject(elem: HTMLElement): js.Promise[_] = js.native
  def getobject(elem: HTMLElement, id: String): js.Promise[_] = js.native
  def getobject(elem: HTMLElement, id: String, options: Anon_NoInteraction): js.Promise[_] = js.native
  ...
  @JSName("getobject")
  def getobject_CurrentSelections(elem: String, id: CurrentSelections, options: Anon_NoInteraction): js.Promise[_] = js.native
  @JSName("getobject")
  def getobject_CurrentSelections(elem: HTMLElement, id: CurrentSelections): js.Promise[_] = js.native
  @JSName("getobject")
  def getobject_CurrentSelections(elem: HTMLElement, id: CurrentSelections, options: Anon_NoInteraction): js.Promise[_] = js.native
