...
@scala.inline
def callRepository(path: java.lang.String, method: java.lang.String, body: java.lang.String): js.Promise[js.Any] = (typings.qlik.mod.^.asInstanceOf[js.Dynamic].applyDynamic("callRepository")(path.asInstanceOf[js.Any], method.asInstanceOf[js.Any], body.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Any]]
...
@scala.inline
def getExtensionList(callback: js.Array[js.Any]): js.Promise[js.Any] = typings.qlik.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getExtensionList")(callback.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Any]]
