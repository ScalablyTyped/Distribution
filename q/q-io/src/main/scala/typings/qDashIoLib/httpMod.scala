...
object httpMod extends js.Object {
  ...
  def read(request: qDashIoLib.QioHTTPNs.Request): qLib.qMod.Promise[java.lang.String] = js.native
  def read(url: java.lang.String): qLib.qMod.Promise[java.lang.String] = js.native
  def request(request: qDashIoLib.QioHTTPNs.Request): qLib.qMod.Promise[qDashIoLib.QioHTTPNs.Response] = js.native
  def request(url: java.lang.String): qLib.qMod.Promise[qDashIoLib.QioHTTPNs.Response] = js.native
}
