...
trait Observable extends js.Object {
  /**
  	 ...
  	 * @returns
  	 */
  def subscribe(next: js.Function1[/* obj */ Next, scala.Unit]): Subscription = js.native
  /**
  	 * 订阅
  	 *
  	 * @param next 接收上传进度信息
  	 ...
  	 */
  def subscribe(
    next: js.Function1[/* obj */ Next, scala.Unit],
    error: js.Function1[/* err */ Error | java.lang.String, scala.Unit]
  ...
  def subscribe(
    next: js.Function1[/* obj */ Next, scala.Unit],
    error: js.Function1[/* err */ Error | java.lang.String, scala.Unit],
    complete: js.Function1[/* obj */ CompletedResult, scala.Unit]
  ): Subscription = js.native
