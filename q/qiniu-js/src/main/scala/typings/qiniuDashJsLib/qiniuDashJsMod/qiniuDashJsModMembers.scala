...
object qiniuDashJsModMembers extends js.Object {
  def compressImage(file: stdLib.Blob, options: stdLib.Partial[CompressOptions]): js.Promise[qiniuDashJsLib.Anon_Dist] = js.native
  ...
  def exif(key: java.lang.String, domain: java.lang.String): js.Promise[ExtentInfo] = js.native
  ...
  def getUploadUrl(config: stdLib.Partial[Config], token: java.lang.String): js.Promise[java.lang.String] = js.native
  def imageInfo(key: java.lang.String, domain: java.lang.String): js.Promise[ImageInfo] = js.native
