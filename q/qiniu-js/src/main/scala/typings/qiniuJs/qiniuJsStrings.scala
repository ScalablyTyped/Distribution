...
import typings.qiniuJs.esmApiIndexDotmockMod.ApiName
...
object qiniuJsStrings {
  ...
  inline def imageMogr2: imageMogr2 = "imageMogr2".asInstanceOf[imageMogr2]
  
  @js.native
  sealed trait imageView2 extends StObject
