...
import typings.qiniuJs.compressMod.CompressOptions
...
import typings.qiniuJs.poolMod.RunTask
...
object utilsMod {
  ...
  open class Observable[T, E, C] protected ()
    extends typings.qiniuJs.observableMod.Observable[T, E, C] {
    def this(_subscribe: js.Function1[/* subscriber */ typings.qiniuJs.observableMod.Subscriber[T, E, C], TeardownLogic]) = this()
  }
  
  @JSImport("qiniu-js/esm/utils", "Pool")
  @js.native
  open class Pool[T] protected ()
    extends typings.qiniuJs.poolMod.Pool[T] {
  ...
  open class Subscriber[T, E, C] ()
    extends typings.qiniuJs.observableMod.Subscriber[T, E, C] {
