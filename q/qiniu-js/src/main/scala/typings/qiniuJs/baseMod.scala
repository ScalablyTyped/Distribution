...
object baseMod {
  ...
  @JSImport("qiniu-js/esm/upload/base", JSImport.Default)
  @js.native
  abstract class default protected ()
    ...
    def this(
      ...
      hostPool: HostPool,
      logger: typings.qiniuJs.loggerMod.default
    ) = this()
  }
  ...
  trait Base extends StObject {
    ...
    /* protected */ var logger: typings.qiniuJs.loggerMod.default = js.native
