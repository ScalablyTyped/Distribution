...
import typings.qiniuJs.esmApiMod.UploadChunkData
import typings.qiniuJs.esmUploadBaseMod.Extra
...
object esmUploadResumeMod {
  ...
  @js.native
  trait Resume
    extends typings.qiniuJs.esmUploadBaseMod.default {
