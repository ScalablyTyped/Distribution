...
@scala.inline
def filterParams(params: js.Any): js.Array[js.Tuple2[java.lang.String, js.Any]] = typings.qiniuJs.mod.^.asInstanceOf[js.Dynamic].applyDynamic("filterParams")(params.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Tuple2[java.lang.String, js.Any]]]
...
@scala.inline
def watermark(options: typings.qiniuJs.mod.WaterMarkOptions1, key: scala.Unit, domain: java.lang.String): java.lang.String = (typings.qiniuJs.mod.^.asInstanceOf[js.Dynamic].applyDynamic("watermark")(options.asInstanceOf[js.Any], key.asInstanceOf[js.Any], domain.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
@scala.inline
...
@scala.inline
def watermark(options: typings.qiniuJs.mod.WaterMarkOptions2, key: scala.Unit, domain: java.lang.String): java.lang.String = (typings.qiniuJs.mod.^.asInstanceOf[js.Dynamic].applyDynamic("watermark")(options.asInstanceOf[js.Any], key.asInstanceOf[js.Any], domain.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
