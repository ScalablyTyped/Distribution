...
object watermark extends js.Object {
  ...
  def apply(options: WaterMarkOptions1, key: String, domain: String): String = js.native
  def apply(options: WaterMarkOptions2): String = js.native
  def apply(options: WaterMarkOptions2, key: js.UndefOr[scala.Nothing], domain: String): String = js.native
