...
trait ImageView2FopOptions
  extends StObject
     with ImageView2Options {
...
object ImageView2FopOptions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(fop = "imageView2", format = format.asInstanceOf[js.Any], h = h.asInstanceOf[js.Any], mode = mode.asInstanceOf[js.Any], q = q.asInstanceOf[js.Any], w = w.asInstanceOf[js.Any])
