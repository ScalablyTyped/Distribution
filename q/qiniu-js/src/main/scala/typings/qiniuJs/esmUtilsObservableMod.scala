...
object esmUtilsObservableMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.qiniuJs.esmUtilsObservableMod.NextObserver[T, E, C]
    - typings.qiniuJs.esmUtilsObservableMod.ErrorObserver[T, E, C]
    - typings.qiniuJs.esmUtilsObservableMod.CompletionObserver[T, E, C]
  */
  trait PartialObserver[T, E, C] extends StObject
  object PartialObserver {
    
    inline def CompletionObserver[T, E, C](complete: C => Unit): typings.qiniuJs.esmUtilsObservableMod.CompletionObserver[T, E, C] = {
      val __obj = js.Dynamic.literal(complete = js.Any.fromFunction1(complete))
      __obj.asInstanceOf[typings.qiniuJs.esmUtilsObservableMod.CompletionObserver[T, E, C]]
    }
    
    inline def ErrorObserver[T, E, C](error: E => Unit): typings.qiniuJs.esmUtilsObservableMod.ErrorObserver[T, E, C] = {
      val __obj = js.Dynamic.literal(error = js.Any.fromFunction1(error))
      __obj.asInstanceOf[typings.qiniuJs.esmUtilsObservableMod.ErrorObserver[T, E, C]]
    }
    
    inline def NextObserver[T, E, C](next: T => Unit): typings.qiniuJs.esmUtilsObservableMod.NextObserver[T, E, C] = {
      val __obj = js.Dynamic.literal(next = js.Any.fromFunction1(next))
      __obj.asInstanceOf[typings.qiniuJs.esmUtilsObservableMod.NextObserver[T, E, C]]
    }
  }
