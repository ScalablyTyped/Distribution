...
object ^ extends js.Object {
  ...
  def retry[U](process: js.Function0[IPromise[U] | U]): typings.qDashRetry.qDashRetryMod.qMod.Promise[U] = js.native
  def retry[U](process: js.Function0[IPromise[U] | U], limit: Double): typings.qDashRetry.qDashRetryMod.qMod.Promise[U] = js.native
  def retry[U](
  ...
  def retry[U](process: js.Function0[IPromise[U] | U], options: IRetryOptions): typings.qDashRetry.qDashRetryMod.qMod.Promise[U] = js.native
