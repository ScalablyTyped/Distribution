...
import typings.qlikDashEngineapi.Anon_QBookmarkId
import typings.qlikDashEngineapi.Anon_QDownloadInfo
import typings.qlikDashEngineapi.Anon_QFields
import typings.qlikDashEngineapi.Anon_QFormatSpec
import typings.qlikDashEngineapi.Anon_QLineage
...
trait IApp
  ...
  /**
    ...
    */
  def exportReducedData(): js.Promise[Anon_QDownloadInfo] = js.native
  def exportReducedData(qOptions: Anon_QBookmarkId): js.Promise[Anon_QDownloadInfo] = js.native
  /**
  ...
  /**
    ...
    */
  def getFieldOnTheFlyByName(qReadableName: String): js.Promise[Anon_QName] = js.native
  /**
    ...
    */
  def getFileTableFields(qConnectionId: String, qDataFormat: IFileDataFormat, qTable: String): js.Promise[Anon_QFields] = js.native
  def getFileTableFields(qConnectionId: String, qDataFormat: IFileDataFormat, qTable: String, qRelativePath: String): js.Promise[Anon_QFields] = js.native
  /**
    ...
    * @returns - return a Promise <Array of DataField> or <String>.
    */
  def getFileTablePreview(qConnectionId: String, qRelativePath: String, qDataFormat: IFileDataFormat, qTable: String): js.Promise[Anon_QFormatSpec] = js.native
  /**
  ...
  /**
    ...
    */
  def getLineage(): js.Promise[Anon_QLineage] = js.native
  /**
