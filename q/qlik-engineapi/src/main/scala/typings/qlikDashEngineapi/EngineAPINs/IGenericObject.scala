...
import typings.qlikDashEngineapi.Anon_QAxisData
import typings.qlikDashEngineapi.Anon_QAxisDataQDataPages
...
trait IGenericObject extends IGeneratedAPI {
  ...
  /**
    ...
    */
  def getHyperCubeContinuousData(qPath: String, qOptions: js.Array[IContinuousDataOptions]): js.Promise[Anon_QAxisData] = js.native
  /**
  ...
  /**
    ...
    */
  def getListObjectContinuousData(qPath: String, qOptions: IContinuousDataOptions): js.Promise[Anon_QAxisDataQDataPages] = js.native
  /**
