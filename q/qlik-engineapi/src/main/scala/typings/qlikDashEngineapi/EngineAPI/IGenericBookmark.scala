...
import typings.qlikDashEngineapi.Anon_QEndIndex
import typings.qlikDashEngineapi.Anon_QFieldValues
...
trait IGenericBookmark extends js.Object {
  ...
  /**
    ...
    */
  def getFieldValues(qField: String, qGetExcludedValues: Boolean, qDataPage: Anon_QEndIndex): js.Promise[Anon_QFieldValues]
  /**
    * Returns:
    *
...
object IGenericBookmark {
  ...
  def apply(
    ...
    getFieldValues: (String, Boolean, Anon_QEndIndex) => js.Promise[Anon_QFieldValues],
