...
object IDelimiterInfo {
  ...
  inline def apply(qIsMultiple: Boolean, qName: String, qNumber: Double, qScriptCode: String): IDelimiterInfo = {
  ...
  implicit open class MutableBuilder[Self <: IDelimiterInfo] (val x: Self) extends AnyVal {
    ...
    inline def setQScriptCode(value: String): Self = StObject.set(x, "qScriptCode", value.asInstanceOf[js.Any])
  }
}
