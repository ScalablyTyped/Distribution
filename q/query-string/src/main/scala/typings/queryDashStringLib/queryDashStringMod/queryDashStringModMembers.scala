...
object queryDashStringModMembers extends js.Object {
  ...
  def parseUrl(str: java.lang.String): queryDashStringLib.Anon_Url = js.native
  def parseUrl(str: java.lang.String, options: ParseOptions): queryDashStringLib.Anon_Url = js.native
