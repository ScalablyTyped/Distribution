...
object SvgQRCodeProps {
  ...
  @scala.inline
  implicit class SvgQRCodePropsOps[Self <: SvgQRCodeProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRenderAs(value: svg): Self = this.set("renderAs", value.asInstanceOf[js.Any])
    @scala.inline
