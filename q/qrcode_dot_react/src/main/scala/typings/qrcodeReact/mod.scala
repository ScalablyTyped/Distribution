...
object mod {
  ...
  inline def default(props: RootProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  inline def QRCodeCanvas(props: QRPropsCanvas): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("QRCodeCanvas")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  inline def QRCodeSVG(props: QRPropsSVG): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("QRCodeSVG")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  object ImageSettings {
    ...
    inline def apply(excavate: Boolean, height: Double, src: String, width: Double): ImageSettings = {
  ...
  object QRProps {
    ...
    inline def apply(value: String): QRProps = {
  ...
  object QRPropsCanvas {
    ...
    inline def apply(value: String): QRPropsCanvas = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[QRPropsCanvas]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: QRPropsCanvas] (val x: Self) extends AnyVal {
  ...
  object QRPropsSVG {
    ...
    inline def apply(Object: js.Object, QRProps: QRProps): QRPropsSVG = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: QRPropsSVG] (val x: Self) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.qrcodeReact.anon.QRPropsSVGrenderAssvg
    - typings.qrcodeReact.anon.QRPropsCanvasrenderAscanv
  */
  trait RootProps extends StObject
  object RootProps {
    
    inline def QRPropsCanvasrenderAscanv(value: String): typings.qrcodeReact.anon.QRPropsCanvasrenderAscanv = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.qrcodeReact.anon.QRPropsCanvasrenderAscanv]
    }
    
    inline def QRPropsSVGrenderAssvg(value: String): typings.qrcodeReact.anon.QRPropsSVGrenderAssvg = {
      val __obj = js.Dynamic.literal(renderAs = "svg", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.qrcodeReact.anon.QRPropsSVGrenderAssvg]
    }
  }
}
