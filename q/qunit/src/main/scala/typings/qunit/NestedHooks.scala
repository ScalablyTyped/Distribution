...
object NestedHooks {
  ...
  implicit class NestedHooksOps[Self <: NestedHooks] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfter(value: js.Function1[/* assert */ Assert, Unit] => Unit): Self = this.set("after", js.Any.fromFunction1(value))
    @scala.inline
    def setAfterEach(value: js.Function1[/* assert */ Assert, Unit] => Unit): Self = this.set("afterEach", js.Any.fromFunction1(value))
    @scala.inline
    def setBefore(value: js.Function1[/* assert */ Assert, Unit] => Unit): Self = this.set("before", js.Any.fromFunction1(value))
    @scala.inline
    def setBeforeEach(value: js.Function1[/* assert */ Assert, Unit] => Unit): Self = this.set("beforeEach", js.Any.fromFunction1(value))
  }
