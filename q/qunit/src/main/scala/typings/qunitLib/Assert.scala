...
trait Assert extends js.Object {
  ...
  /**
    ...
    */
  def rejects(promise: js.Promise[_]): scala.Unit = js.native
  def rejects(promise: js.Promise[_], expectedMatcher: js.Any): scala.Unit = js.native
  def rejects(promise: js.Promise[_], expectedMatcher: js.Any, message: java.lang.String): scala.Unit = js.native
  def rejects(promise: js.Promise[_], message: java.lang.String): scala.Unit = js.native
  /**
