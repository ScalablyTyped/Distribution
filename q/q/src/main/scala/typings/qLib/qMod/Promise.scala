...
trait Promise[T] extends js.Object {
  ...
  /**
  		 ...
  		 */
  def delay(ms: scala.Double): Promise[T] = js.native
  def delete[U](propertyName: java.lang.String): Promise[U] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def get[U](propertyName: java.lang.String): Promise[U] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def invoke[U](methodName: java.lang.String, args: js.Any*): Promise[U] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def keys(): Promise[js.Array[java.lang.String]] = js.native
  /**
  		 ...
  		 */
  def nodeify(callback: js.Function2[/* reason */ js.Any, /* value */ js.Any, scala.Unit]): Promise[T] = js.native
  /**
  		 ...
  		 */
  def post[U](methodName: java.lang.String, args: js.Array[_]): Promise[U] = js.native
  /**
  		 * A sugar method, equivalent to promise.then(undefined, undefined, onProgress).
  		 */
  def progress(onProgress: js.Function1[/* progress */ js.Any, _]): Promise[T] = js.native
  def set[U](propertyName: java.lang.String, value: js.Any): Promise[U] = js.native
  /**
  ...
  @JSName("then")
  def then_UV[U, V](onFulfill: scala.Null, onReject: js.Function1[/* error */ js.Any, IWhenable[V]]): Promise[U | V] = js.native
  @JSName("then")
  def then_UV[U, V](
    onFulfill: scala.Null,
    onReject: js.Function1[/* error */ js.Any, IWhenable[V]],
  ...
  @JSName("then")
  def then_UV[U, V](onFulfill: scala.Null, onReject: scala.Null, onProgress: js.Function1[/* progress */ js.Any, _]): Promise[U | V] = js.native
  /**
