...
object ConfigOptions {
  ...
  def apply(
    ...
    zone: Zone = null,
    zoneExpire: js.UndefOr[Double] = js.undefined
  ): ConfigOptions = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(useCdnDomain)) __obj.updateDynamic("useCdnDomain")(useCdnDomain.get.asInstanceOf[js.Any])
    if (!js.isUndefined(useHttpsDomain)) __obj.updateDynamic("useHttpsDomain")(useHttpsDomain.get.asInstanceOf[js.Any])
    if (zone != null) __obj.updateDynamic("zone")(zone.asInstanceOf[js.Any])
    if (!js.isUndefined(zoneExpire)) __obj.updateDynamic("zoneExpire")(zoneExpire.get.asInstanceOf[js.Any])
