...
object nodeListMod {
  ...
  @scala.inline
  def toArray(list: NodeList): js.Array[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("toArray")(list.asInstanceOf[js.Any]).asInstanceOf[js.Array[Node]]
  @scala.inline
  def toArray(
  ...
  @scala.inline
  def toArray_E_Element[E /* <: Element */](selectors: NodeListOf[E]): js.Array[E] = ^.asInstanceOf[js.Dynamic].applyDynamic("toArray")(selectors.asInstanceOf[js.Any]).asInstanceOf[js.Array[E]]
}
