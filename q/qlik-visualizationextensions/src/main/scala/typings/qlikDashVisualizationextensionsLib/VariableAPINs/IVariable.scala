...
trait IVariable extends js.Object {
  /**
           ...
           */
  def create(qProp: java.lang.String): angularLib.angularMod.angularNs.IPromise[_] = js.native
  /**
           * Creates a variable.
           * @param qProp - Variable name or properties. Properties:
           * Name | Type | Description
           ...
           * @return - Returns a promise of a variable model.
           */
  def create(qProp: js.Any): angularLib.angularMod.angularNs.IPromise[_] = js.native
  /**
           ...
           */
  def createSessionVariable(qProp: js.Any): angularLib.angularMod.angularNs.IPromise[_] = js.native
  /**
           * Gets a variable by id.
           * @param qId - Variable id.
           * @return - A promise of a variable model.
           */
  def get(qId: java.lang.String): angularLib.angularMod.angularNs.IPromise[_] = js.native
  /**
           * Gets a variable by name.
           * @param qName - Variable name.
           * @return - A promise of a variable model.
           */
  def getByName(qName: java.lang.String): angularLib.angularMod.angularNs.IPromise[_] = js.native
  /**
           ...
           */
  def getContent(name: java.lang.String, callback: js.Any): angularLib.angularMod.angularNs.IPromise[_] = js.native
  /**
           ...
           * @return - A promise of a Qlik engine reply.
           */
  def setContent(name: java.lang.String, content: java.lang.String): angularLib.angularMod.angularNs.IPromise[_] = js.native
  /**
           ...
           * @return - A promise of a Qlik engine reply.
           */
  def setNumValue(qName: java.lang.String, qVal: scala.Double): angularLib.angularMod.angularNs.IPromise[_] = js.native
  /**
           ...
           * @return - A promise of a Qlik engine reply.
           */
  def setStringValue(qName: java.lang.String, qVal: java.lang.String): angularLib.angularMod.angularNs.IPromise[_] = js.native
}
