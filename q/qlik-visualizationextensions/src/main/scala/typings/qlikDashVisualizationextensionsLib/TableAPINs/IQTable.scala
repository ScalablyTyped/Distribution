...
trait IQTable extends js.Object {
  ...
  /**
           ...
           */
  def exportData(): scala.Unit = js.native
  /**
           * Exports data of the underlying hypercube in OOXML or CSV format.
           * @param [options] - Optional. Properties:
           * Name | Type | Description
           ...
           * @param [callback] - Optional. Callback function returning the link to the exported file.
           */
  def exportData(options: js.Any): scala.Unit = js.native
  /**
           * Exports data of the underlying hypercube in OOXML or CSV format.
           * @param [options] - Optional. Properties:
           * Name | Type | Description
           ...
           * @param [callback] - Optional. Callback function returning the link to the exported file.
           */
  def exportData(options: js.Any, callback: js.Any): scala.Unit = js.native
  /**
           ...
           */
  def getColByName(fld: java.lang.String): scala.Double = js.native
  /**
