...
import typings.qlikDashVisualizationextensions.BackendAPINs.DimensionType
import typings.qlikDashVisualizationextensions.BackendAPINs.FieldAttributesType
import typings.qlikDashVisualizationextensions.BackendAPINs.GroupingType
import typings.qlikDashVisualizationextensions.BackendAPINs.PatchType
import typings.qlikDashVisualizationextensions.BackendAPINs.SortIndicatorType
import typings.qlikDashVisualizationextensions.BackendAPINs.StateType
import typings.qlikDashVisualizationextensions.ExtensionAPINs.ExpressionType
import typings.qlikDashVisualizationextensions.ExtensionAPINs.SelectionModeType
import typings.qlikDashVisualizationextensions.NavigationAPINs.NavigationErrorType
import typings.qlikDashVisualizationextensions.NavigationAPINs.NavigationModeType
import typings.qlikDashVisualizationextensions.VisualizationAPINs.VisualizationType
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object qlikDashVisualizationextensionsStrings {
  @js.native
  sealed trait A
  ...
  @scala.inline
  def dimensions: dimensions = "dimensions".asInstanceOf[dimensions]
  @scala.inline
  ...
  @scala.inline
  def measures: measures = "measures".asInstanceOf[measures]
  @scala.inline
