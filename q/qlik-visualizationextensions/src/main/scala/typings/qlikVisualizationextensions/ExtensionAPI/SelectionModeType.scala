...
/* Rewritten from type alias, can be one of: 
  - typings.qlikVisualizationextensions.qlikVisualizationextensionsStrings.CONFIRM
  - typings.qlikVisualizationextensions.qlikVisualizationextensionsStrings.QUICK
*/
